---
TOCTitle: 'MS11-086'
Title: 'Microsoft 보안 공지 MS11-086 - 중요'
ms:assetid: 'ms11-086'
ms:contentKeyID: 61230453
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-086(v=Security.10)'
---


Microsoft 보안 공지 MS11-086 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008(Itanium 제외), Windows 7 및 Windows Server 2008 R2(Itanium 제외) 에디션에 설치된 Active Directory, ADAM 및 AD LDS에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Active Directory가 인증서 해지 목록(CRL)으로 인증서를 확인하는 방식을 변경하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2(영문)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=989cca2d-cce1-4f52-b50e-43152693f240">ADAM(Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=08b27ce7-c32e-41e4-ad04-481c5eab17a7&amp;displaylang=ko">Active Directory</a><br />
(KB2601626)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=de5a74f2-2cc8-4677-b495-3a40fe3d6b9e&amp;displaylang=ko">Active Directory</a><br />
(KB2601626)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB2616310)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 SP2(Itanium 기반 시스템용)(영문)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6&amp;displaylang=ko">Active Directory 및 Active Directory Lightweight Directory Service(AD LDS)</a>\*<br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965&amp;displaylang=ko">Active Directory 및 Active Directory Lightweight Directory Service(AD LDS)</a>\*<br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9&amp;displaylang=ko">Active Directory 및 Active Directory Lightweight Directory Service(AD LDS)</a>\*<br />
(KB2601626)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
...
| Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1<sup>[1]</sup> |
  
<sup>[1]</sup>이러한 Microsoft Windows 에디션은 ADAM, AD LDS 또는 Active Directory 서버 구성 요소를 포함하지 않으므로 영향을 받지 않습니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [11월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-nov)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
LDAPS(LDAP over SSL)를 사용하기 위해 구성된 Active Directory에 권한 상승 취약점이 존재합니다. 공격자는 이전에 해지된 인증서를 사용하여 Active Directory 도메인에 인증을 받고 해당 인증서와 관련되어 있고 승인된 특정 사용자의 권한으로 네트워크 리소스에 액세스하거나 코드를 실행하여 이 취약점을 악용할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2014(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014)를 참조하십시오.

#### LDAPS 인증 우회 취약점(CVE-2011-2014)에 대한 완화 요소
...
#### LDAPS 인증 우회 취약점(CVE-2011-2014)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   해지된 인증서의 영향을 받는 도메인에서 사용자 계정을 제거합니다 .
-   LDAPS를 사용하면서 "Always check CRL(항상 CRL 확인)" 모드에서 IPsec 기반 연결을 사용합니다.

    IPsec으로 CRL 확인을 활성화하는 방법에 대한 자세한 내용은 TechNet 문서 [Certificate revocation list (CRL) verification - an application choice(영문)](https://social.technet.microsoft.com/wiki/contents/articles/964.aspx)를 참조하십시오.

    참고

    1.  CRL 확인과 인증서 인증을 사용하여 LDAPS로의 연결을 암호화하고 보호하려면 IPsec을 사용합니다.
    2.  암호화하지 않고 CRL 확인과 인증서 인증을 사용하여 LDAPS로의 연결을 보호하려면 IPsec을 사용합니다. 이 경우 LDAPS는 암호화를 처리합니다.영향을 받는 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2의 경우 AuthIP(사용자 인증을 허용하는 IPsec 확장)를 사용하여, 공격자가 LDAPS 인증을 수행하기 위해 컴퓨터 인증서를 사용한 뒤 해지된 사용자 인증서를 사용하여 IPsec 인증서를 인증하지 못하도록 할 수 있습니다.
    3.  LDAPS용 NULL 은닉을 사용하여 암호화를 두 번 방지하며, IPsec 수준에서 인증서 인증이 SSL에서 발생하는 인증과 별개라는 점을 인식하지 못하도록 방지합니다. 즉, 각 계층에서 별개의 인증서를 사용하면 만료된 인증서를 통해 LDAPS로의 액세스를 허용할 수 있습니다.

#### LDAPS 인증 우회 취약점(CVE-2011-2014)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 권한 상승 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 승인된 특정 사용자의 권한으로 네트워크 리소스에 액세스하거나 코드를 실행할 수 있습니다.

취약점의 원인은 무엇입니까?  
이 취약점은 Active Directory가 LDAPS를 사용하도록 구성되어 있고 도메인 계정과 관련된 CRL로 SSL 인증서의 해지 상태를 확인하지 못할 때 발생합니다. 그러면 인증 기관(CA)에서 인증서를 해지한 후에도 인증서가 유효한 것으로 인정됩니다.
...
AD LDS(Active Directory Lightweight Directory Services)는 응용 프로그램을 위한 전용 디렉터리 서비스를 제공하는 Active Directory의 독립 모드입니다. AD LDS는 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에서 사용할 수 있습니다. AD LDS는 Windows XP 및 Windows Server 2003에서 사용할 수 있는 ADAM(Active Directory Application Mode)을 대신합니다. AD LDS에 대한 자세한 내용은 TechNet 문서, [Active Directory Lightweight Directory Services(영문)](https://technet.microsoft.com/ko-kr/library/cc731868(ws.10).aspx)를 참조하십시오.

Active Directory Application Mode란 무엇입니까?  
ADAM(Active Directory Application Mode)은 LDAP(Lightweight Directory Access Protocol) 디렉터리 서비스 중 하나이며, 시스템 서비스가 아니라 Windows XP 및 Windows Server 2003을 위한 사용자 서비스로써 실행됩니다. ADAM에 대한 자세한 내용은 TechNet 문서, [ADAM 소개](https://technet.microsoft.com/ko-kr/library/cc780837(ws.10).aspx)를 참조하십시오.
...
CRL은 CA에서 발행한 디지털 서명된 목록이며 CA가 발급하고 해지한 인증서의 목록을 포함합니다. 해지된 각각의 개별 인증서에는 인증서의 일련 번호와 해지 날짜, 해지 이유가 나열됩니다. 응용 프로그램은 표시된 인증서의 해지 상태를 확인하기 위해 CRL 검사를 수행할 수 있습니다. 인증서 해지 검사에 대한 자세한 내용은 TechNet 문서, [인증서 해지 및 상태 검사(영문)](https://technet.microsoft.com/ko-kr/library/ee619730(ws.10).aspx)를 참조하십시오.

LDAPS(LDAP over SSL)란 무엇입니까?  
LDAPS(LDAP over SSL)는 SSL(Secure Sockets Layer)/TLS(Transport Layer Security) 기술을 사용하여 클라이언트 컴퓨터와 서버 컴퓨터 간에 전송되는 트래픽을 암호화합니다.

Active Directory Domain Services란 무엇입니까?  
AD DS(Active Directory Domain Services)는 사용자 로그온 프로세스, 인증 및 디렉터리 검색을 포함하여, 디렉터리 데이터를 저장하고 사용자와 도메인 간의 통신을 관리합니다. Active Directory 도메인 컨트롤러는 AD DS를 실행하는 서버입니다. AD DS에 대한 자세한 내용은 TechNet 문서, [Active Directory Domain Services](https://technet.microsoft.com/ko-kr/library/cc770946(ws.10).aspx)를 참조하십시오.

공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
이 취약점을 성공적으로 악용한 공격자는 승인된 특정 사용자의 권한으로 네트워크 리소스에 액세스하거나 코드를 실행할 수 있습니다. 사용자가 관리자 권한을 가진 경우 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경 또는 삭제하거나 모든 사용자 권한이 있는 새 계정을 만들 수 있습니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
이 취약점을 악용하려면 공격자가 먼저 도메인에서 유효한 계정과 관련되어 있지만 해지된 인증서를 획득해야 합니다. 그러면 공격자는 이전에 해지된 이 인증서를 사용하여 Active Directory 도메인에 인증을 받고 해당 인증서와 관련되어 있고 승인된 특정 사용자의 권한으로 네트워크 리소스에 액세스하거나 코드를 실행하여 이 취약점을 악용할 수 있습니다.

취약점으로 인해 위험에 노출되는 시스템은 주로 무엇입니까?  
Active Directory 서비스가 설치되어 있고 영향을 받는 운영 체제를 실행하는 모든 시스템은 이 취약점의 영향을 받습니다.

업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Active Directory가 CRL로 인증서의 유효성을 확인하는 방식을 변경하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 ADAM(Active Directory Application Mode):<br />
WindowsXP-KB2616310-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 ADAM(Active Directory Application Mode):<br />
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2616310$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2616310">Microsoft 기술 자료 문서 2616310</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 Active Directory:<br />
WindowsServer2003-KB2601626-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 ADAM(Active Directory Application Mode):<br />
WindowsServer2003-KB2616310-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 Active Directory:<br />
WindowsServer2003.WindowsXP-KB2601626-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 ADAM(Active Directory Application Mode):<br />
WindowsServer2003.WindowsXP-KB2616310-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 SP2(Itanium 기반 시스템용)의 Active Directory:<br />
...
<tr class="even">
<td style="border:1px solid black;">제거 정보</td>
<td style="border:1px solid black;">Active Directory의 경우 제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2601626$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM(Active Directory Application Mode)의 경우 제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2616310$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory의 경우 <a href="https://support.microsoft.com/kb/2601626">Microsoft 기술 자료 문서 2601626</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003의 ADAM(Active Directory Application Mode)의 경우 <a href="https://support.microsoft.com/kb/2616310">Microsoft 기술 자료 문서 2616310</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2601626\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003의 ADAM(Active Directory Application Mode):<br />
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2601626">Microsoft 기술 자료 문서 2601626</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 Active Directory 및 AD LDS(Active Directory Lightweight Directory Service):<br />
Windows6.0-KB2601626-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 Active Directory 및 AD LDS(Active Directory Lightweight Directory Service):<br />
Windows6.0-KB2601626-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">AD LDS가 있는 지원 대상인 모든 Windows 7 32비트 에디션:<br />
Windows6.1-KB2601626-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">AD LDS가 있는 지원 대상인 모든 Windows 7 x64 기반 에디션:<br />
...
-   LDAPS 인증 우회 취약점(CVE-2011-2014)을 보고해 주신 Autosécurité의 Xavier Lassoie와 Sébastien Godard
