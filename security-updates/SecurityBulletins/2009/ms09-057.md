...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=b34d94b5-b828-4e16-a636-04344c60d945&displaylang=ko)               | 원격 코드 실행 | 중요        | [MS06-053](https://technet.microsoft.com/security/bulletin/ms06-053) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=768fd74e-0a2f-4353-ac22-65d0d6321739&displaylang=ko) | 원격 코드 실행 | 중요        | [MS06-053](https://technet.microsoft.com/security/bulletin/ms06-053) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=270ec100-5ba1-4f8c-aa36-105d30ad57bf)                 | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=78072164-84d1-44da-8ede-2a9d212d47a9&displaylang=ko)                  | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8aa1f97d-ad53-4450-bb93-4a147dd10a87&displaylang=ko)      | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=fb5678b9-5ef1-42db-902e-c9ea02880e0a)                  | 원격 코드 실행 | 중요        | 없음                                                                |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2507 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2507)을 참조하십시오.
...
Internet Explorer 보안 강화 구성에 대한 자세한 내용은 다음 [웹 사이트](https://www.microsoft.com/oldcprops%20https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)에 있는 Managing Internet Explorer Enhanced Security Configuration 가이드를 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 969059](https://support.microsoft.com/kb/969059) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969059">Microsoft 기술 자료 문서 969059</a> 참조</td>
</tr>
<tr class="even">
...
-   인덱싱 서비스의 메모리 손상 취약점(CVE-2009-2507)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li
