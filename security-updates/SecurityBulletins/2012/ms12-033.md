---
TOCTitle: 'MS12-033'
Title: 'Microsoft 보안 공지 MS12-033 - 중요'
ms:assetid: 'ms12-033'
ms:contentKeyID: 61230500
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-033(v=Security.10)'
---

Microsoft 보안 공지 MS12-033 - 중요
===================================
...
이 보안 업데이트는 Windows Partition Manager가 메모리의 개체를 할당하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
[Windows Vista 서비스 팩 2](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=d9d5e290-dc57-4587-b31d-706b541924ec)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=827b9f15-b67d-4dd4-a39b-7c148bae5041)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=46e6e960-b700-4154-b91d-aca74ea9e5df)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=e4ab05ae-3a1c-4d6b-8c84-1165ed741356)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2a4433e4-7f3f-4083-b3e1-eff2d18483af)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2a4433e4-7f3f-4083-b3e1-eff2d18483af)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용)](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=dfa13df5-9e4e-4cf6-b56d-af7db0a0f5ea)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=dfa13df5-9e4e-4cf6-b56d-af7db0a0f5ea)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=095c20b3-8e6c-4846-9ba1-6ce0af5e9850)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=095c20b3-8e6c-4846-9ba1-6ce0af5e9850)  
(KB2690533)
</td>
<td style="border:1px solid black;">
권한 상승
...
Windows Partition Manager에서 장치 관계 요청을 처리하는 방식에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0178(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0178)을 참조하십시오.

#### 플러그 앤 플레이(PnP) 구성 관리자 취약점(CVE-2012-0178)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### 플러그 앤 플레이(PnP) 구성 관리자 취약점(CVE-2012-0178)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### 플러그 앤 플레이(PnP) 구성 관리자 취약점(CVE-2012-0178)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 권한 상승 취약점입니다.

취약점의 원인은 무엇입니까?  
이 취약점은 둘 이상의 프로세스나 스레드가 플러그 앤 플레이(PnP) 구성 관리자 함수를 동시에 호출할 때 발생합니다.

이 취약점의 영향을 받는 구성 요소는 무엇입니까?  
이 취약점의 영향을 받는 구성 요소는 Windows Partition Manager(partmgr.sys)입니다.

Windows Partition Manager(partmgr.sys)  란 무엇입니까?
Windows Partition Manager는 파티션 검색, 만들기, 삭제 및 관리 기능을 제공합니다. Partition Manager는 디스크 클래스 드라이버에서 만든 디스크 장치 개체에 대한 필터 드라이버로 작동합니다. Partition Manager는 모든 온라인 디스크가 고유한 서명 또는 GUID를 가지도록 합니다.
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Windows Partition Manager가 메모리의 개체를 할당하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2690533">Microsoft 기술 자료 문서 2690533</a> 참조</td>
</tr>
<tr class="odd">
