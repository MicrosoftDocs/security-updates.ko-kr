...
<td style="border:1px solid black;">
[MS12-037](https://go.microsoft.com/fwlink/?linkid=249045)의 KB2699988은 KB2719177로 대체되었습니다.
</td>
</tr>
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트에 대한 해시 정보는 [Microsoft 기술 자료 문서 2719177](https://support.microsoft.com/kb/2719177)을 참조하십시오.
...
예. Windows 8 Consumer Preview 및 Windows Server 2012 Consumer Preview에서 KB2719177 업데이트를 사용할 수 있습니다. Windows 8 Consumer Preview 및 Windows Server 2012 Consumer Preview를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 제공됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1522)(영문)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1524)(영문)를 참조하십시오.
...
#### 특성 제거 원격 코드 실행 취약점(CVE-2012-1524)에 대한 대안
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2719177">Microsoft 기술 자료 문서 2719177</a> 참조</td>
</tr>
<tr class="odd">
...
-   캐시된 개체 원격 코드 실행 취약점(CVE-2012-1522)을 [VeriSign iDefense Labs](https://labs.idefense.com/)(영문)와 협력하여 보고해 주신 spa-s3c.blogspot.com의 Jose A. Vazquez  
-   특성 제거 원격 코드 실행 취약점(CVE-2012-1524)을 [VeriSign iDefense Labs](https://labs.idefense.com/)(영문)와 협력하여 보고해 주신 Omair
...
-   V1.1(2012년 7월 19일): Windows 8 Release Preview 및 Windows Server 2012 Release Candidate을 실행하는 시스템에서의 이 업데이트의 적용 가능성과 관련된 잘못된 업데이트 FAQ를 제거하였습니다. Windows 8 Release Preview 및 Windows Server 2012 Release Candidate은 이 공지에 설명된 취약점의 영향을 받지 않습니다.
