---
TOCTitle: 'MS10-013'
Title: 'Microsoft 보안 공지 MS10-013 - 긴급'
ms:assetid: 'ms10-013'
ms:contentKeyID: 61230273
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-013(v=Security.10)'
---

Microsoft 보안 공지 MS10-013 - 긴급
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Itanium 기반 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2 에디션에 대해 중요이며, 기타 지원 대상인 모든 Microsoft Windows 에디션에 대해 긴급입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 DirectShow가 AVI 파일을 여는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**두 업데이트가 여러 경우에 영향을 받은 동일 운영 체제에 적용되는 이유가 무엇입니까?**  
이 공지는 서로 다른 두 구성 요소에 존재하는 취약점을 해결합니다. 영향을 받는 각 구성 요소에 대해 하나씩 서로 다른 KB 번호의 두 업데이트 패키지를 사용할 수 있습니다. KB977914는 AVI 필터의 취약점을 해결합니다. KB975560은 DirectX의 취약점을 해결합니다. 이러한 두 구성 요소가 존재하는 영향을 받는 운영 체제에는 두 업데이트를 모두 설치해야 합니다.

지원되는 Microsoft Windows 2000, Windows XP 및 Windows Server 2003 에디션의 고객은 이러한 경우에 해당하므로 KB977914 및 KB975560의 두 업데이트 패키지를 모두 적용해야 합니다. 기타 영향을 받는 운영 체제의 고객은 보안 업데이트 패키지 KB975560만 적용하면 됩니다.
...
<tr>
<td style="border:1px solid black;">
Microsoft Windows 2000 서비스 팩 4의 AVI 필터
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 AVI 필터
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 AVI 필터
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 AVI 필터
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 AVI 필터
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 SP2(Itanium 기반 시스템용)의 AVI 필터
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Microsoft Windows 2000 서비스 팩 4의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 SP2(Itanium 기반 시스템용)의 Quartz
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Quartz\*\*
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Quartz\*\*
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2의 Quartz
</td>
<td style="border:1px solid black;">
**중요**  
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용)의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용)의 Quartz
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(Itanium 기반 시스템용)의 Quartz
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
Microsoft DirectShow가 AVI 미디어 파일의 구문을 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 AVI 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0250 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0250)을 참조하십시오.

#### DirectShow 힙 오버플로 취약점(CVE-2010-0250)에 대한 완화 요소
...
#### DirectShow 힙 오버플로 취약점(CVE-2010-0250)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### DirectShow 힙 오버플로 취약점(CVE-2010-0250)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
특수하게 조작된 AVI 파일을 Microsoft DirectShow 구성 요소가 올바르게 처리하지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 DirectShow가 AVI 파일을 여는 방식을 수정하여 문제점을 해결합니다.
...
|-----------------------------------------------------------------------------------------------------------|---------|---------------------|---------------------|----------------------------|
| Microsoft Windows 2000 서비스 팩 4(AVI 필터)                                                              | 예      | 예                  | 예                  | 예                         |
| Microsoft Windows 2000 서비스 팩 4(Quartz)                                                                | 아니요  | 아니요              | 예                  | 예                         |
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3(AVI 필터)                                                | 예      | 예                  | 예                  | 예                         |
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3(Quartz)                                                  | 아니요  | 아니요              | 예                  | 예                         |
| Windows XP Professional x64 Edition 서비스 팩 2                                                           | 아니요  | 아니요              | 예                  | 예                         |
| Windows Server 2003 서비스 팩 2(AVI 필터)                                                                 | 예      | 예                  | 예                  | 예                         |
| Windows Server 2003 서비스 팩 2(Quartz)                                                                   | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;">Microsoft Windows 2000의 AVI 필터:<br />
Windows2000-KB977914-x86-kor /quiet<br />
<br />
또한 다음 중 하나의 Quartz:<br />
<br />
- Microsoft Windows 2000:<br />
Windows2000-KB975560-x86-kor /quiet<br />
<br />
- DirectX 9.0이 설치된 Microsoft Windows 2000:<br />
Windows2000-DirectX9-KB975560-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000의 AVI 필터:<br />
Windows2000-KB977914-x86-kor /norestart<br />
<br />
또한 다음 중 하나의 Quartz:<br />
<br />
- Microsoft Windows 2000:<br />
Windows2000-KB975560-x86-kor /norestart<br />
<br />
- DirectX 9.0이 설치된 Microsoft Windows 2000:<br />
Windows2000-DirectX9-KB975560-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB977914$\Spuninst 폴더 및 %Windir%\$NTUninstallKB975560$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/977914">Microsoft 기술 자료 문서 977914</a> 및 <a href="https://support.microsoft.com/kb/975560">Microsoft 기술 자료 문서 975560</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
WindowsXP-KB977914-x86-kor /quiet<br />
- Quartz:<br />
WindowsXP-KB975560-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
WindowsXP-KB977914-x86-kor /norestart<br />
- Quartz:<br />
WindowsXP-KB975560-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 경우 다음 둘 다 적용:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
WindowsServer2003-KB977914-x86-kor /quiet<br />
- Quartz:<br />
WindowsServer2003-KB975560-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
WindowsServer2003.WindowsXP-KB977914-x64-kor /quiet<br />
- Quartz:<br />
WindowsServer2003.WindowsXP-KB975560-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
...
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
WindowsServer2003-KB977914-x86-kor /norestart<br />
- Quartz:<br />
WindowsServer2003-KB975560-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 경우 다음 둘 다 적용:<br />
- AVI 필터:<br />
WindowsServer2003.WindowsXP-KB977914-x64-kor /norestart<br />
- Quartz:<br />
WindowsServer2003.WindowsXP-KB975560-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 경우 다음 둘 다 적용:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975560">Microsoft 기술 자료 문서 975560</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   DirectShow 힙 오버플로 취약점(CVE-2010-0250)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)
...
-   V1.1(2010년 2월 11일): Quartz(KB975560) 업데이트 패키지에 대한 공지 교체가 수정되었습니다. Microsoft Windows 2000 및 Windows Server 2008을 제외한 모든 플랫폼에서 업데이트에 대한 다시 시작 요구 사항이 수정되었습니다. Windows 7 및 Windows Server 2008 R2에 대한 SMS 2003(ITMU 포함)의 **Systems Management Server** 표 항목이 변경되었습니다. 마지막으로, 지원 대상인 모든 Windows XP x64 기반 에디션에 대한 확인 레지스트리 키가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.
