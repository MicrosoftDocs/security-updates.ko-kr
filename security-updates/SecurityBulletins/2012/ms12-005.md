...
-   어셈블리 실행 취약점(CVE-2012-0013)을 [Beyond Security's SecuriTeam Secure Disclosure(영문)](http://www.beyondsecurity.com/ssd.html) 프로그램과 협력하여 보고해 주신 Yorick Koster
...
[Microsoft MAPP(Active Protections Program) 파트너(영문)](http://go.microsoft.com/fwlink/?linkid=215201)에 나열된 프로그램 파트너가 제공하는 활성 보호 기능 웹 사이트를 참조하십시오.
