...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 963093](https://support.microsoft.com/kb/963093)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|--------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3 | [Windows 검색 4.0](https://www.microsoft.com/download/details.aspx?familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d&displaylang=ko) | 정보 유출      | 보통        | 없음                      |
| Windows XP Professional x64 Edition 서비스 팩 2  | [Windows 검색 4.0](https://www.microsoft.com/download/details.aspx?familyid=50c56dd6-c34d-4632-a779-8bcf8fdb341b)                | 정보 유출      | 보통        | 없음                      |
| Windows Server 2003 서비스 팩 2                  | [Windows 검색 4.0](https://www.microsoft.com/download/details.aspx?familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31&displaylang=ko) | 정보 유출      | 보통        | 없음                      |
| Windows Server 2003 x64 Edition 서비스 팩 2      | [Windows 검색 4.0](https://www.microsoft.com/download/details.aspx?familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240&displaylang=ko) | 정보 유출      | 보통        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0239 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239)를 참조하십시오.
...
**Windows 검색이란 무엇입니까?**    
Windows 검색을 사용하여 전자 메일, 연락처, 일정 약속, 문서, 사진, 멀티미디어, 기타 타사 형식 등의 일반적인 파일 및 데이터 형식을 즉시 검색할 수 있습니다. 이 기능을 통해 소비자와 정보 작업자는 가정 및 기업 환경에서 많은 양의 데이터를 효율적으로 찾고 관리하고 구성할 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 940157](https://support.microsoft.com/kb/940157)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/963093">Microsoft 기술 자료 문서 963093</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 검색의 스크립트 실행 취약점(CVE-2009-0239)을 보고해 주신 [IBM Rational Application Security (영문)](https://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html)의 Yair Amit
