...
<tr>
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d36ecc9e-06eb-4ced-9dcd-2dfd525fce30&displaylang=ko)  
(3000869)
...
<td style="border:1px solid black;">
[MS12-005](https://go.microsoft.com/fwlink/?linkid=230777)의 2584146

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c4e4b38d-faec-4427-8607-a91aee3c2f7a&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5b336925-d094-41bc-9199-3713e14ef114&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6c4ea479-56d3-4dab-9f2d-3792adadf2d9&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7abdc40d-563b-46fe-860f-6cdb51378db4)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=82d2e14b-a0f1-4509-a2b7-74b9fb7a9d03&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=72d3ba69-0b1e-43f1-875c-5018a70a969f&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=50a8384b-1b75-4be6-80f8-5e971e39dbc5&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=054974cd-f7fd-4a4f-b62a-bb08b0cdad44)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b07ec364-29e0-4901-ba5d-e423b005fb40&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows 8(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2a92775a-419b-4840-a77a-6fe616745294&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=6a085a89-1189-4ec8-8b25-7df72f511f25&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=67eca8ea-99ad-4c6e-92bd-b3dc7e26175f&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=bce79d4d-8551-4745-8695-b19f104256ff&displaylang=ko)  
(3000869)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=ec4772b6-6d3b-4ace-9545-3f192c259a42&displaylang=ko)  
(3000869)
...
이전 버전의 소프트웨어에 대한 사용자 지정 지원이 필요한 고객은 자신의 Microsoft 계정 관리 팀 담당자나 TAM(기술 계정 관리자) 또는 해당 Microsoft 파트너 담당자에게 사용자 지정 지원 옵션에 대해 문의하십시오. Alliance, Premier 또는 Authorized Contract가 없는 고객은 해당 지역의 Microsoft 판매처에 문의하십시오. 연락처 정보는 [Microsoft 정보](https://go.microsoft.com/fwlink/?linkid=33329) 웹 사이트를 선택한 다음, 목록에서 국가를 선택하여 전화 번호 목록을 참조하십시오. 전화를 할 경우에는 해당 지역의 프리미어 지원 영업 담당자와 상담을 요청하십시오. 자세한 내용은 [Microsoft 지원 기간 정책 FAQ](https://go.microsoft.com/fwlink/?linkid=169557)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4114](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4114)(영문)를 참조하십시오. 
...
-   **TCP 포트 139 및 445 차단**
    ...
    이 TCP 포트는 영향을 받는 구성 요소와 연결을 시작하는 데 사용할 수 있습니다. 기업 방화벽에서 이러한 인바운드 및 아웃바운드 포트를 모두 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 침입으로부터 보호할 수 있습니다. 다른 포트를 사용하는 공격을 방지하려면 인바운드 원치 않는 인터넷 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 다음 웹 사이트, [TCP 및 UDP 포트 할당](https://go.microsoft.com/fwlink/?linkid=21312)(영문)을 참조하십시오. Windows 방화벽에 대한 자세한 내용은 다음 웹 사이트, [단일 컴퓨터에서 Windows 방화벽을 구성하는 방법](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx)(영문)을 방문하십시오.

    **대안의 영향.**

    TCP 포트 139 및 445는 [CIFS(Common Internet File System)](https://technet.microsoft.com/library/cc939973.aspx)(영문), DNS 관리, NetBT 서비스 세션, 프린터 공유 세션 등을 포함한 부가 서비스에 사용됩니다. 이 포트를 사용하지 않도록 설정하면 해당 서비스의 기능에 영향을 미칠 수 있습니다.

-   **설정 정보 파일을 통해 실행 파일의 시작 차단**

    [설정 정보 파일](https://go.microsoft.com/fwlink/?linkid=157952)(영문)(.INF 파일 확장자)은 "install" 동사를 사용하여 실행 파일의 시작을 지원하는 스크립트입니다. 시스템 레지스트리는 .INF 파일 내에 지정된 install 동사의 실행을 지원하는 명령을 저장합니다. 저장된 명령어를 제거하여 악성 코드를 전달하기 위해 .INF 파일을 사용하는 잠재적 공격 방법을 차단합니다.
...
예. Microsoft PowerPoint 2007 파일을 포함하는 제한적이며 대상이 지정된 공격이 확인되었습니다. Microsoft PowerPoint 프레젠테이션(.PPTX 또는 .PPT 파일 확장자) 및 PowerPoint 쇼(.PPSX 또는 .PPS 파일 확장자) 데이터 파일은 공격 시나리오에서 사용될 수 있습니다. PowerPoint 쇼 파일이 공격 시나리오에서 사용될 경우, 임의의 코드는 [사용자 계정 컨트롤](https://technet.microsoft.com/library/cc709691(v=ws.10).aspx)(UAC) 보안 프롬프트 없이 설치될 수 있습니다.
