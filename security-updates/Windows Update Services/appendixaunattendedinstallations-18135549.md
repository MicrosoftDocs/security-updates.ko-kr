...
ms:contentKeyID: 18135549
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;">Uninstall the product. Also uninstalls the Windows 내부 데이터베이스 instance if it is installed.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Path to Windows 내부 데이터베이스 data directory.</td>
</tr>
<tr class="even">
