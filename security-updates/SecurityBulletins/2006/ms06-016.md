...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 911567](https://support.microsoft.com/kb/911567)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 911567](https://support.microsoft.com/kb/911567)을 참조하십시오.
...
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1에 설치된 Outlook Express 6 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=484de679-5505-4196-bdd8-f7cf325af0f5&displaylang=ko)
-   Microsoft Windows Server 2003 x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=a7b10d8f-d9d7-4423-aa6d-c1c41d23794e)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템)에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=800bf687-bee5-478f-a025-43cd16682f31)
-   Microsoft Windows XP 서비스 팩 2에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=0dd827bc-6fa1-405a-933e-fb422a4e8096&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ff772c0b-6f98-449d-b02e-c9c236068172)
-   Microsoft Windows XP 서비스 팩 1 또는 Microsoft Windows 2000 서비스 팩 4에 설치된 Outlook Express 6 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=cda93501-99cb-4f28-bb73-6438cad081db&displaylang=ko)
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Outlook Express 5.5 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e61a3d64-14fd-4976-bb03-c31ca6ee61e2&displaylang=ko)
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|-------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| Microsoft Outlook Express Windows 주소록 파일 사용 취약점 - [CVE-2006-0014 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0014) | 원격 코드 실행       | 중요                                                              | 중요                                                                                          | 중요                                                            | 중요                                                                                       |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 911567](https://support.microsoft.com/kb/911567)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 911567](https://support.microsoft.com/kb/911567)을 참조하십시오.

-   [Microsoft 기술 자료 문서 917288](https://support.microsoft.com/kb/917288): 누적 보안 업데이트 설치 후 Windows 주소록 또는 Outlook Express를 열 때 오류 메시지가 표시됨
...
|-------------------------------------------------------------------------|-------------------------------------------------------|-----------------------------------------------------------------------------------------------|--------------------------------------------|-----------------------------------------|--------------------------------------------------------------------------|
| [**MS04-018**](https://technet.microsoft.com/security/bulletin/ms04-018) | 대체됨                                                | 대체됨                                                                                        | 해당 사항 없음                             | 대체됨                                  | 해당 사항 없음                                                           |
| [**MS05-030**](https://technet.microsoft.com/security/bulletin/ms05-030) | 대체됨                                                | 대체됨                                                                                        | 해당 사항 없음                             | 대체됨                                  | 해당 사항 없음                                                           |
...
아니요. Windows Millennium Edition에는 영향을 받는 구성 요소가 있지만 취약점이 심각하지는 않습니다. 심각도에 대한 자세한 내용을 보려면 다음 [웹 사이트](https://technet.microsoft.com/security/bulletin/rating)를 방문하십시오.
...
MBSA 1.2.1을 사용하여 이 업데이트가 필요한지 확인할 수 없습니다. MBSA 1.2.1은 MBSA 1.2.1이 지원하는 제품에 업데이트가 필요한지만 확인합니다. MBSA 1.2.1은 Outlook Express 검색을 지원하지 않습니다. MBSA에 대한 자세한 내용은 [MBSA 웹 사이트](https://www.microsoft.com/korea/technet/security/tools/mbsahome.asp)를 참조하십시오. 현재 MBSA 1.2.1이 검색할 수 없는 프로그램에 대한 자세한 내용은 [Microsoft 기술 자료 문서 306460](https://support.microsoft.com/kb/306460)을 참조하십시오. 그러나 Microsoft는 고객들이 이 보안 공지에서 제공된 보안 업데이트의 필요 여부를 확인할 수 있는 Enterprise Scan Tool(EST) 버전을 개발했습니다. "Enterprise Scan Tool(EST)을 사용하여 이 업데이트가 필요한지 확인할 수 있습니까?"를 참조하십시오. 이 도구에 대한 자세한 내용은 FAQ를 참조하십시오.
...
아니요. Windows 98, Windows 98 Second Edition 또는 Windows Millennium Edition에 영향을 받는 구성 요소가 포함되어 있지만 이 취약점은 심각한 수준이 아닙니다. 심각도에 대한 자세한 내용은 다음 [웹 사이트](https://technet.microsoft.com/security/bulletin/rating)를 참조하십시오.
...
-   Microsoft Outlook Express Windows 주소록 파일 사용 취약점 - [CVE-2006-0014 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0014)를 보고해 주신 Stuart Pearson과 협력해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com)
-   Microsoft Outlook Express Windows 주소록 파일 사용 취약점 - [CVE-2006-0014 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0014)와 유사한 동작을 보고해 주신 [ATmaCA](mailto:atmaca@icqmail.com)
