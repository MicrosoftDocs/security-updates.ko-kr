---
TOCTitle: 'MS10-054'
Title: 'Microsoft 보안 공지 MS10-054 - 긴급'
ms:assetid: 'ms10-054'
ms:contentKeyID: 61230315
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-054(v=Security.10)'
---



Microsoft 보안 공지 MS10-054 - 긴급
===================================

SMB 서버의 취약점으로 인한 원격 코드 실행 문제점(982214)
--------------------------------------------------------

게시된 날짜: 2010년 8월 11일 수요일 | 업데이트된 날짜: 2010년 11월 10일 수요일
...
이 보안 업데이트는 Microsoft Windows에서 발견되어 비공개적으로 보고된 여러 취약점을 해결합니다. 가장 위험한 취약점으로 인해 공격자가 특수하게 조작된 SMB 패킷을 만들어 영향을 받는 시스템에 보내는 경우 원격 코드 실행이 허용될 수 있습니다. 방화벽 구성 모범 사례와 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 이 취약점을 악용하려는 공격으로부터 네트워크를 보호할 수 있습니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP 에디션에 대해서는 긴급이며, 지원 대상인 모든 Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해서는 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6e5e16f8-c140-4a1d-b898-8417a6bfd4d8&amp;displaylang=ko">Windows XP 서비스 팩 3</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd6cc359-e72e-46ec-a08b-763934e3e115">Windows XP Professional x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=230e8559-e6df-49d5-acb5-b0cd4bde0bf4&amp;displaylang=ko">Windows Server 2003 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=03804f59-748e-4832-98e4-2d88564bd10a&amp;displaylang=ko">Windows Server 2003 x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e4f4f8b3-7a39-4d77-a46b-02c86ad159c3">Windows Server 2003 with SP2(Itanium 기반 시스템용)</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9087a3aa-aa55-41f6-8c4c-f322e4aa8681&amp;displaylang=ko">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9087a3aa-aa55-41f6-8c4c-f322e4aa8681">Windows Vista 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=10c9d5f1-53ed-459b-a663-e69bdb845a6b">Windows Vista x64 Edition 서비스 팩 1</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms09-001">MS09-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=10c9d5f1-53ed-459b-a663-e69bdb845a6b">Windows Vista x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a94e2e38-116a-4b63-9328-6c33e63bbbfe">Windows Server 2008(32비트 시스템용)</a>*</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms09-001">MS09-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a94e2e38-116a-4b63-9328-6c33e63bbbfe">Windows Server 2008(32비트 시스템용) 서비스 팩 2</a>*</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=602dd3f6-0d09-4546-b1db-d7b6b04edb66">Windows Server 2008(x64 기반 시스템용)</a>*</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms09-001">MS09-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=602dd3f6-0d09-4546-b1db-d7b6b04edb66">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2</a>*</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=24d8f0a3-51a9-46c1-b870-a2239bf600e4">Windows Server 2008(Itanium 기반 시스템용)</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a>,<br />
<a href="https://technet.microsoft.com/security/bulletin/ms09-001">MS09-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=24d8f0a3-51a9-46c1-b870-a2239bf600e4">Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-050">MS09-050</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8d58ebc4-a5f9-4318-a6f1-168c1bcdae3c">Windows 7(32비트 시스템용)</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=155976">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ad1ddf94-d714-4b36-8256-42bf79d03a90">Windows 7(x64 기반 시스템용)</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=155976">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=52642a8d-1081-4496-848e-9b03baf3fdac">Windows Server 2008 R2(x64 기반 시스템용)</a>*</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=155976">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=783fb42c-3698-4b1d-a692-3ff319578931">Windows Server 2008 R2(Itanium 기반 시스템용)</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
...
**이 보안 공지가 2010년 11월 9일에 개정된 이유는 무엇입니까?**     
Microsoft는 이전에 MS10-012로 명명된 대체된 공지를 수정하는 검색 변경 사항을 알리기 위해 이 보안 공지를 다음과 같이 개정하였습니다. 지원 대상인 Windows Vista 서비스 팩 1 및 Windows Server 2008 에디션의 경우 이 업데이트는 보안 공지 MS09-050 및 MS09-001을 대체합니다. 지원 대상인 Windows Vista 서비스 팩 2 및 Windows Server 2008 서비스 팩 2 에디션의 경우 이 업데이트는 보안 공지 MS09-050을 대체합니다. 이 변경 사항은 검색에만 해당됩니다. 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 이 업데이트를 성공적으로 설치한 고객은 다시 설치할 필요가 없습니다.
...
<th style="border:1px solid black;" >SMB 풀 오버플로 취약점(CVE-2010-2550)</th>
<th style="border:1px solid black;" >SMB 변수 유효성 검사 취약점(CVE-2010-2551)</th>
<th style="border:1px solid black;" >SMB 스택 부족 취약점(CVE-2010-2552)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2550 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2550)을 참조하십시오.
  
#### SMB 풀 오버플로 취약점(CVE-2010-2550)에 대한 완화 요소
...
#### SMB 풀 오버플로 취약점(CVE-2010-2550)에 대한 대안
...
#### SMB 풀 오버플로 취약점(CVE-2010-2550)에 대한 FAQ
...
Microsoft SMB(Server Message Block) 프로토콜은 Microsoft Windows에 사용되는 Microsoft 네트워크 파일 공유 프로토콜입니다. 자세한 내용은 [Microsoft SMB 프로토콜 및 CIFS 프로토콜 개요 (영문)](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)를 참조하십시오.
...
공격자는 특수하게 조작한 SMB 패킷을 만들어 영향을 받는 시스템에 보내는 방법으로 취약점 악용을 시도할 수 있습니다. Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 플랫폼에서 공격자는 암호 기반 공유가 사용되지 않도록 설정된 경우가 아니면 이 취약점을 이용하기 위해 인증을 받아야 합니다. 암호 기반 공유가 사용되지 않도록 설정되어 있으면 공격자는 인증 없이 이러한 플랫폼을 이용할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2551 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2551)을 참조하십시오.
  
#### SMB 변수 유효성 검사 취약점(CVE-2010-2551)에 대한 완화 요소
...
#### SMB 변수 유효성 검사 취약점(CVE-2010-2551)에 대한 대안
...
#### SMB 변수 유효성 검사 취약점(CVE-2010-2551)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
취약점은 Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 패킷을 구문 분석할 때 내부 변수의 유효성 검사를 제대로 수행하지 못할 때 발생합니다. 이 취약점은 SMB 버전 1 및 SMB 버전 2에 영향을 줍니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB가 특수하게 조작된 SMB 패킷 내 내부 필드의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 복합 요청을 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 네트워크 메시지를 서버 서비스를 실행하는 컴퓨터로 전송하여 취약점을 악용할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2552 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2552)를 참조하십시오.
  
#### SMB 스택 부족 취약점(CVE-2010-2552)에 대한 완화 요소
...
#### SMB 스택 부족 취약점(CVE-2010-2552)에 대한 대안
...
#### SMB 스택 부족 취약점(CVE-2010-2552)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이것은 서비스 거부 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
취약점은 Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 복합 요청을 충분히 처리하지 못할 때 발생합니다.
...
**이 문제가 SMBv1(Server Message Block 버전 1)에 영향을 미칩니까?**    
아니요. 이 문제는 복합 요청이 SMBv2에 새로 도입된 기능일 때만 SMBv2에 영향을 미칩니다.
  
**SMBv2 복합 요청이란 무엇입니까?**    
SMBv2 복합 요청은 여러 SMBv2 프로토콜 요청 또는 응답을 기본 전송으로 보내기 위한 단일 전송 요청에 결합하는 방법입니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 프로토콜 소프트웨어가 형식이 잘못된 복합 요청을 처리하는 방식을 수정하여 이러한 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB982214$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/982214">Microsoft 기술 자료 문서 982214</a> 참조</td>
</tr>
<tr class="even">
...
-   SMB 풀 오버플로 취약점(CVE-2010-2550)을 보고해 주신 [stratsec (영문)](https://www.stratsec.net)의 Laurent Gaffié  
-   SMB 스택 부족 취약점(CVE-2010-2552)을 보고해 주신 [Sourcefire VRT (영문)](https://www.sourcefire.com/services/sf_vrt.html)의 Todd Wease 및 Richard Johnson  
-   SMB 스택 부족 취약점(CVE-2010-2552)을 보고해 주신 [Codenomicon (영문)](https://www.codenomicon.com/)의 Riku Hietamaki 및 Joshua Morin
...
-   V1.1(2010년 8월 12일): SMB 풀 오버플로 취약점(CVE-2010-2550)에 대한 Windows Server 2003, Windows 7 및 Windows Server 2008 R2의 보안 영향이 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다.  
-   V1.2(2010년 8월 26일): SMB 스택 부족 취약점(CVE-2010-2552)을 위한 해결책의 잘못된 Microsoft Fix it 자동화 솔루션으로의 링크를 삭제 했습니다.  
-   V1.3(2010년 11월 10일): 지원 대상인 Windows Vista 및 Windows Server 2008 에디션에 대한 대체된 공지를 수정하는 검색 변경 사항을 알리기 위해 업데이트 FAQ가 추가되었습니다. 이 변경 사항은 검색에만 해당됩니다. 보안 업데이트 파일에 대한 변경 사항은 없습니다.
