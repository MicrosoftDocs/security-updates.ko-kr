...
**Microsoft 보안 알림 서비스:** [Microsoft 보안 알림 서비스](https://www.microsoft.com/korea/technet/security/bulletin/notify.asp)에 가입하면 Microsoft 보안 공지가 업데이트될 때마다 자동 전자 메일 알림을 받을 수 있습니다.
...
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**그래픽 렌더링 엔진의 취약점으로 인한 원격 코드 실행 문제점(912919)**](https://technet.microsoft.com/security/bulletin/ms06-001)                                    |
...
| **영향을 받는 소프트웨어** | **Windows**. 자세한 내용은 [전문가용 게시판](https://technet.microsoft.com/security/bulletin/ms06-001)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 공지 번호                  | Microsoft 보안 공지 MS06-002                                                                                                                                         |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**포함 웹 글꼴의 취약점으로 인한 원격 코드 실행 문제점(908519)**](https://technet.microsoft.com/security/bulletin/ms06-002)                                          |
| **요약**                   | 포함 웹 글꼴(Embedded Web Fonts)을 볼 때 원격 코드가 실행될 수 있는 취약점이 존재합니다.                                                                             |
| **최대 심각도**            | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                                            |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                       |
| **영향을 받는 소프트웨어** | **Windows**. 자세한 내용은 [전문가용 게시판](https://technet.microsoft.com/security/bulletin/ms06-002)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 공지 번호                  | Microsoft 보안 공지 MS06-003                                                                                                                                                    |
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Outlook 및 Microsoft Exchange의 TNEF 디코딩 취약점으로 인한 원격 코드 실행 문제점(902412)**](https://technet.microsoft.com/security/bulletin/ms06-003)              |
| **요약**                   | TNEF 메시지의 취약점으로 인해 원격 코드가 실행될 수 있습니다.                                                                                                                   |
| **최대 심각도**            | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                                                       |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                                  |
| **영향을 받는 소프트웨어** | **Exchange 및 Office.** 자세한 내용은 [전문가용 게시판](https://technet.microsoft.com/security/bulletin/ms06-003)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
-   [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001)에서 설명한 문제점에 대해 Microsoft와 협력해 주신 [WebSense (영문)](https://websense.com/)의 Dan Hubbard에게 감사드립니다.
-   [MS06-002](https://technet.microsoft.com/security/bulletin/ms06-002)에서 설명한 문제점을 보고해 주신 eEye Digital Security에 감사드립니다.
-   [MS06-003](https://technet.microsoft.com/security/bulletin/ms06-003)에서 설명한 문제점을 보고해 주신 [NGS Software (영문)](https://www.ngssoftware.com/index.htm) 의 John Heasman 및 Mark Litchfield에게 감사드립니다.
