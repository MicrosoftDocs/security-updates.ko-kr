...
**참고**자세한 내용은 이 공지의 FAQ 절에 있는 “MS04-004가 릴리스된 후에 Microsoft 또는 지원 부서로부터 핫픽스를 받았는데 이 핫픽스가 이 보안 업데이트에 포함됩니까?” 질문을 참조하십시오. [MS05-020](http://technet.microsoft.com/security/bulletin/ms05-020) 업데이트가 설치된 시스템에서 Microsoft Security Bulletin [MS04-038](http://technet.microsoft.com/security/bulletin/ms04-038) 이전에 릴리스된 핫픽스를 적용해야 하는 경우 자세한 내용은 [Microsoft 기술 자료 문서 883939](http://support.microsoft.com/kb/883939)를 참조하십시오.
...
-   PNG 이미지 렌더링 메모리 손상 취약점(CAN-2005-1211)을 보고해 주신 [ISS X-Force (영문)](http://www.iss.net/)의 Mark Dowd에게 감사드립니다.
-   이 보안 업데이트에서 Kill Bit를 설정하는 DigWebX ActiveX 컨트롤의 문제점을 보고해 주신 [Next Generation Security Software Ltd. (영문)](http://www.ngssoftware.com/)의 Mark Litchfield에게 감사드립니다.
-   이 보안 업데이트의 일부로 해결된 팝업 차단기 문제점을 보고해 주신 [PivX Solutions, Inc. (영문)](http://www.pivx.com/)의 Thor Larholm에게 감사드립니다.
-   이 보안 업데이트의 일부로 해결된 GIF 및 XBM 렌더링 문제를 보고해 주신 [UK National Infrastructure Security Co-ordination Centre(NISCC) (영문)](http://www.niscc.gov.uk/)에게 감사드립니다.
