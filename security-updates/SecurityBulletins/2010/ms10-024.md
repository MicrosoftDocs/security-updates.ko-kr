---
TOCTitle: 'MS10-024'
Title: 'Microsoft 보안 공지 MS10-024 - 중요'
ms:assetid: 'ms10-024'
ms:contentKeyID: 61230285
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-024(v=Security.10)'
---



Microsoft 보안 공지 MS10-024 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000, Windows XP 및 Windows Server 2003 에디션, 32비트 및 x64 기반 Windows Server 2008 에디션, x64 기반 시스템용 Windows Server 2008 R2, Microsoft Exchange Server 2003에 대해 중요이며 Microsoft Exchange Server 2000에 대해서는 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 SMTP가 MX 레코드를 구문 분석하는 방식과 SMTP가 SMTP 명령 응답을 해석하기 위해 메모리를 할당하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 981832](https://support.microsoft.com/kb/981832)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
[Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=88a0e872-01de-495b-8eec-d105a970daa7&displaylang=ko)  
(KB976323)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<sup>[1]</sup>이 공지에서 설명한 취약점이 이 소프트웨어에 영향을 미치지 않으므로 이 업데이트에는 심각도가 적용되지 않습니다. 그러나 이 소프트웨어의 고객은 SMTP 서비스에 의해 시작되는 DNS 트랜잭션에 원본 포트 엔트로피를 추가하는 심층 보안 대응책이 포함된 이 업데이트를 적용하는 것이 좋습니다. 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**을 참조하십시오.
...
**이 공지가 2010년 7월 14일에 다시 릴리스된 이유는 무엇입니까?**  
Microsoft는 보안 업데이트를 IIS(인터넷 정보 서비스)가 설치된 Windows Server 2008 기반 시스템에 설치하면 SMTP 구성 옵션이 초기화되는 KB976323에 나열된 알려진 문제점을 해결하는 Windows Server 2008 및 Windows Server 2008 R2에 대한 업데이트를 다시 제공하기 위해 이 공지를 다시 릴리스하였습니다. 이 업데이트를 설치하기 전에 설정한 모든 SMTP 구성 옵션은 손실됩니다. 필요한 모든 SMTP 구성 옵션은 이 보안 업데이트를 설치한 후 수동으로 다시 적용해야 합니다.

다시 제공되는 업데이트는 KB976323과 관련된 패키지에만 영향을 미칩니다. 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.

**이 보안 공지가 2010년 4월 16일에 개정된 이유는 무엇입니까?**  
Microsoft는 Microsoft Exchange Server 2000 서비스 팩 3의 검색 변경을 알리기 위해 이 보안 공지를 개정하였습니다. 이 변경 사항은 검색에만 해당됩니다. 수정된 검색은 이전에 이 업데이트에서 제공하지 않았던 보안 업데이트를 영향을 받는 시스템에 제공합니다. 이 공지에서 보안 업데이트 파일에 대한 변경 사항은 없습니다. 해당 시스템에 이미 KB976703 업데이트를 성공적으로 설치한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항의 위치에 대해서는 **보안 업데이트 배포** 섹션에서 참조 표를 참조하십시오.

**Microsoft Exchange Server 2007 및 Microsoft Exchange Server 2010 업데이트가 Microsoft Exchange Server 2000 및 Microsoft Exchange Server 2003 업데이트와 어떻게 다릅니까?**  
Microsoft Exchange 2007이 릴리스됨과 함께 Microsoft Exchange는 새로운 서비스 모델로 전환됩니다. Microsoft Exchange 서비스 모델에 대한 자세한 내용은 TechNet 문서, [Exchange 2007 서비스](https://go.microsoft.com/fwlink/?linkid=89577)를 참조하십시오. 새로운 Microsoft Exchange 서비스 모델과 관련한 질문은 [Microsoft 도움말 및 지원](https://support.microsoft.com/)으로 문의하십시오.
...
예. 이 공지의 취약점 정보 섹션에 나열된 변경 사항 외에도, 이 업데이트에는 OWA(Outlook Web Access)를 사용할 때 중국어 문자 집합 문제를 해결하는 Microsoft Exchange 2000 Server 서비스 팩 3에 대한 심층 보안 변경 사항이 포함되어 있습니다. 이 문제는 Exchange 2000 시스템에만 영향을 미칩니다. Microsoft Exchange 2000 Server 서비스 팩 3용 업데이트를 수행하기 전에 Exchange 2000 Server 서비스 팩 3(SP3) 이후 업데이트 롤업 패치가 필요합니다. 이 보안 공지에서 제공하는 심층 보안 업데이트를 설치하기 전에 Exchange 2000(KB870540)용 업데이트 롤업을 설치해야 합니다. 이 업데이트는 업데이트 롤업이 설치되어 있는지 확인합니다. 업데이트 롤업이 설치되어 있지 않은 경우 다운로드 웹 사이트로 안내를 받게 됩니다. 자세한 내용은 [Microsoft 기술 자료 문서 870540](https://support.microsoft.com/kb/870540)을 참조하십시오. 필수 업데이트를 다운로드하려면 [Exchange 2000용 업데이트 롤업(KB870540)](https://www.microsoft.com/download/details.aspx?familyid=363a57a4-8bed-4bbb-bbe4-abc11ab04611)을 참조하십시오.

이 업데이트에는 SMTP 서비스에 의해 시작된 DNS 트랜잭션에 원본 포트 엔트로피를 추가하는 Microsoft Exchange 2007 및 Microsoft Exchange 2010에 대한 심층 보안 변경 사항도 포함되어 있습니다.

**Windows 및 Exchange 모두에 이 업데이트를 적용해야 합니까?**  
Microsoft Exchange가 설치된 시스템의 경우 Exchange 및 Windows 업데이트를 모두 적용해야 합니다. SMTP 서비스가 사용하도록 설정되어 있지만 Exchange 서비스를 실행하지 않은 경우 Windows 업데이트만 적용하면 됩니다.

**Exchange 2007 또는 Exchange 2010을 실행하고 있습니다. 이 취약점의 영향을 받지 않는데 이 업데이트가 제공되는 이유는 무엇입니까?**  
Microsoft Exchange 2007 및 Microsoft Exchange 2010에 대한 업데이트에는 SMTP 서비스에 의해 시작된 DNS 트랜잭션에 원본 포트 엔트로피를 추가하는 심층 보안 변경 사항만 포함되어 있습니다.

**Exchange Server 2007 기반 서버에 대한 업데이트 롤업을 특정 순서대로 설치해야 합니까?**  
TechNet 문서 [Exchange 2007용 최신 서비스 팩 또는 업데이트 롤업을 설치하는 방법 (영문)](https://technet.microsoft.com/en-us/library/ee221147(exchg.80).aspx)을 참조하십시오.
...
<th style="border:1px solid black;" >
SMTP Server MX 레코드 취약점(CVE-2010-0024)
</th>
<th style="border:1px solid black;" >
SMTP 메모리 할당 취약점(CVE-2010-0025)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Exchange Server 2007 서비스 팩 1(x64 기반 시스템용)
</td>
<td style="border:1px solid black;">
없음<sup>[1]</sup>
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Exchange Server 2010(x64 기반 시스템용)
</td>
<td style="border:1px solid black;">
없음<sup>[1]</sup>
</td>
...
Microsoft Windows SMTP(Simple Mail Transfer Protocol) 구성 요소가 특수하게 조작된 DNS MX(메일 교환) 리소스 레코드를 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 네트워크 메시지를 SMTP 서비스를 실행하는 컴퓨터로 전송하여 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 SMTP 서비스가 다시 시작될 때까지 컴퓨터에서 응답을 중지하도록 만들 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0024 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0024)를 참조하십시오.

#### SMTP Server MX 레코드 취약점(CVE-2010-0024)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   SMTP 구성 요소는 기본적으로 Windows Server 2003, Windows Server 2003 x64 Edition 또는 Windows XP Professional x64 Edition에 설치되지 않습니다.

#### SMTP Server MX 레코드 취약점(CVE-2010-0024)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### SMTP Server MX 레코드 취약점(CVE-2010-0024)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것은 서비스 거부 취약점입니다. 이 취약점을 악용한 공격자는 특수하게 조작된 메시지가 큐에서 제거되고 서비스가 수동으로 다시 시작될 때까지 영향 받는 SMTP 서비스가 응답하지 않도록 할 수 있습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.

**취약점의 원인은 무엇입니까?**  
이 취약점은 Microsoft Windows SMTP(Simple Mail Transfer Protocol) 구성 요소가 특수하게 조작된 DNS MX(메일 교환) 레코드를 잘못 구분 분석하기 때문에 발생합니다.

**SMTP 서비스란 무엇입니까?**  
SMTP(Simple Mail Transfer Protocol) 서비스는 전자 메일을 전송하며, 전자 메일 서비스 또는 IIS(인터넷 정보 서비스)의 일부로 설치되어 있습니다. SMTP는 전자 메일이 전송된 후 인터넷을 통해 대상 서버로 전달되는 방식을 제어합니다. SMTP 서비스는 서버 간에 전자 메일을 보내고 받습니다. 자세한 내용은 TechNet 문서 [SMTP(Simple Mail Transfer Protocol) 서비스 (영문)](https://technet.microsoft.com/en-us/library/cc759281(ws.10).aspx)를 참조하십시오.

**MX 리소스 레코드란 무엇입니까?**  
MX(메일 교환) 리소스 레코드는 DNS 도메인 이름에 대한 메일 교환 서버를 지정합니다. 메일 교환 서버는 DNS 도메인 이름에 대한 메일을 처리하고 전달하는 호스트입니다. 메일을 처리하는 것은 메일을 주소로 전달하거나 다른 유형의 메일 전송으로 전달하는 것을 의미합니다. 메일을 전달하는 것은 메일을 최종 대상 서버로 전송하거나, SMTP(Simple Mail Transfer Protocol)를 사용하여 최종 대상과 가까운 다른 메일 교환 서버로 전송하거나, 지정된 기간 동안 큐에 대기시키는 것을 의미합니다. MX 리소스 레코드에 대한 자세한 내용은 TechNet 문서 [리소스 레코드 형식(영문)](https://technet.microsoft.com/en-us/library/cc958958.aspx)을 참조하십시오.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
이 취약점을 성공적으로 악용한 공격자는 특수하게 조작된 메시지가 큐에서 제거되고 서비스가 수동으로 다시 시작될 때까지 SMTP 서비스가 응답하지 않도록 할 수 있습니다.

**공격자는 이러한 취약점을 어떻게 악용합니까?**  
공격자는 특수하게 조작된 응답을 MX 리소스 레코드 쿼리에 반환하는 악성 DNS 서버를 만들어 이러한 취약점을 악용할 수 있습니다.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
운영 체제의 일부로 제공된 기본 SMTP 구성 요소를 사용하는 모든 운영 체제는 이 취약점으로 인해 위험할 수 있습니다.

**업데이트는 어떤 기능을 수행합니까?**  
보안 업데이트는 SMTP가 SMTP 서비스가 MX 레코드를 구문 분석하는 방식을 수정하여 취약점을 해결합니다.

**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-0024 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0024)가 지정되었습니다.
...
SMTP 구성 요소가 메모리 할당을 처리하는 방식으로 인해 Microsoft Windows SMTP(Simple Mail Transfer Protocol) 구성 요소에 정보 노출 취약점이 존재합니다. 공격자는 영향 받는 서버에 잘못된 명령과 STARTTLS 명령을 전송하여 이 취약점을 악용할 수 있습니다. 이 취약점을 성공적으로 악용한 공격자는 영향 받은 서버에 저장된 임의의 전자 메일 메시지 조각을 읽을 수 있습니다. 이 취약점으로 인해 공격자가 직접 코드를 실행하거나 해당 사용자 권한을 상승시킬 수는 없지만 영향을 받는 시스템의 손상을 악화시키는 데 사용할 수 있는 정보를 빼낼 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0025 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0025)를 참조하십시오.

#### SMTP 메모리 할당 취약점(CVE-2010-0025)에 대한 완화 요소

이 취약점에 대해 확인된 완화 요소가 없습니다.

#### SMTP 메모리 할당 취약점(CVE-2010-0025)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### SMTP 메모리 할당 취약점(CVE-2010-0025)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이는 정보 유출 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 영향 받은 서버에 저장된 임의의 전자 메일 메시지 조각을 읽을 수 있습니다. 이 취약점으로 인해 공격자가 직접 코드를 실행하거나 해당 사용자 권한을 상승시킬 수는 없지만 영향을 받는 시스템의 손상을 악화시키는 데 사용할 수 있는 정보를 빼낼 수 있습니다.

**취약점의 원인은 무엇입니까?**  
이 취약점은 Microsoft Windows SMTP(Simple Mail Transfer Protocol) 구성 요소가 SMTP 명령 응답을 해석할 때 메모리를 적절히 할당하지 못하기 때문에 발생합니다.
...
자세한 내용은 TechNet 문서 [TLS/SSL 작동 방식(영문)](https://technet.microsoft.com/en-us/library/cc783349(ws.10).aspx)을 참조하십시오.

**SSL이란 무엇입니까?**  
SSL(Secure Sockets Layer)은 TLS(Transport Layer Security) 프로토콜의 전신으로, TLS와 동일한 기능을 수행하며 공개 및 비밀 키 기술의 조합을 사용하는 보안 네트워크 통신을 지원합니다. 자세한 내용은 TechNet 문서 [TLS/SSL 작동 방식(영문)](https://technet.microsoft.com/en-us/library/cc783349(ws.10).aspx)을 참조하십시오.

**SChannel 보안 패키지란 무엇입니까?**  
Secure Channel(Schannel) 보안 패키지는 인터넷 표준 인증 프로토콜인 SSL(Secure Sockets Layer) 및 TLS(Transport Layer Security)를 구현하는 SSP(보안 지원 공급자)입니다. 이러한 구성 요소는 웹 탐색과 같은 여러 일반 인터넷과 네트워크 응용 프로그램을 지원하는 보안 통신을 구현하는 데 사용됩니다. SChannel은 클라이언트와 서버 간에 보안 통신을 지원하기 위한 인증 서비스를 제공하는 보안 패키지의 일부입니다. 자세한 내용은 MSDN 문서, [Secure Channel(영문)](https://msdn.microsoft.com/en-us/library/aa380123(vs.85).aspx)을 참조하십시오.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
이 취약점을 성공적으로 악용한 공격자는 영향 받은 서버에서 사용할 수 있는 임의의 전자 메일 메시지 조각에 액세스할 수 있습니다.

**공격자는 이러한 취약점을 어떻게 악용합니까?**  
공격자는 영향 받은 SMTP 서버에 특수하게 조작된 SMTP 명령 모음을 전송하여 취약점을 악용할 수 있습니다. 그런 후 영향 받은 시스템의 메모리에서 정보를 읽을 수 있습니다.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
운영 체제의 일부로 제공된 기본 SMTP 구성 요소를 사용하는 모든 운영 체제는 이 취약점으로 인해 위험할 수 있습니다.

**업데이트는 어떤 기능을 수행합니까?**  
보안 업데이트는 SMTP 구성 요소가 SMTP 명령 응답을 해석하기 위해 메모리를 할당하는 방식을 수정하여 취약점을 해결합니다.
...
| Microsoft Exchange Server 2000 서비스 팩 3                                                   | 예         |
| Microsoft Exchange Server 2003 서비스 팩 2                                                   | 예         |
| Microsoft Exchange Server 2007 서비스 팩 1(x64 기반 시스템용)                                | 예         |
| Microsoft Exchange Server 2007 서비스 팩 2(x64 기반 시스템용)                                | 예         |
| Microsoft Exchange Server 2010(x64 기반 시스템용)                                            | 예         |
...
| Microsoft Exchange Server 2000 서비스 팩 3                                                   | 예      | 예                  | 예                  | 예                         |
| Microsoft Exchange Server 2003 서비스 팩 2                                                   | 예      | 예                  | 예                  | 예                         |
| Microsoft Exchange Server 2007 서비스 팩 1(x64 기반 시스템용)                                | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft Exchange Server 2007 서비스 팩 2(x64 기반 시스템용)                                | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft Exchange Server 2010(x64 기반 시스템용)                                            | 아니요  | 아니요              | 예                  | 예                         |
...
| **배포**                  |                                                                                                                                  |
| 사용자 개입 없이 설치     | Windows2000-KB976323-x86-kor /quiet                                                                                              |
| 다시 시작하지 않고 설치   | Windows2000-KB976323-x86-kor /norestart                                                                                          |
| 로그 파일 업데이트        | KB976323.log                                                                                                                     |
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |
| **다시 시작 요구 사항**   |                                                                                                                                  |
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |
| 핫패칭                    | 해당 사항 없음                                                                                                                   |
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB976323$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |
| **파일 정보**             | [Microsoft 기술 자료 문서 976323](https://support.microsoft.com/kb/976323) 참조                                                   |
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB976323\\Filelist                                        |
...
WindowsXP-KB976323-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB976323-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB976323$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/976323">Microsoft 기술 자료 문서 976323</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB976323-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB976323-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB976323-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB976323-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 32비트 시스템용 Windows Server 2008 에디션:<br />
Windows6.0-KB976323-v2-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 x64 기반 시스템용 Windows Server 2008 에디션:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Exchange2000-KB976703-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Exchange2000-KB976703-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$ExchUninstallKB976703$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/976703">Microsoft 기술 자료 문서 976703</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Exchange2003-kb976702-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Exchange2003-kb976702-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$ExchUninstallKB976702$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/976702">Microsoft 기술 자료 문서 976702</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Microsoft Exchange Server 2007 서비스 팩 1(x64 기반 시스템용):<br />
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Exchange Server 2007 서비스 팩 1(x64 기반 시스템용):<br />
<a href="https://support.microsoft.com/kb/981407">Microsoft 기술 자료 문서 981407</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Exchange Server 2007 서비스 팩 2(x64 기반 시스템용):<br />
<a href="https://support.microsoft.com/kb/981383">Microsoft 기술 자료 문서 981383</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft Exchange Server 2007 서비스 팩 1(x64 기반 시스템용):<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Microsoft Exchange Server 2010(x64 기반 시스템용):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/981401">Microsoft 기술 자료 문서 981401</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft Exchange Server 2010(x64 기반 시스템용):<br />
...
-   V1.1(2010년 4월 15일): Microsoft Exchange 서비스 모델을 설명하기 위해 업데이트 FAQ에 항목이 추가되었습니다. 또한 Microsoft Exchange Server 2000 서비스 팩 3에 대한 Configuration Manager 2007 검색 값과 Microsoft Exchange Server 2000 서비스 팩 3 및 Microsoft Exchange Server 2003 서비스 팩 2에 대한 설치 스위치가 수정되었습니다.
-   V1.2(2010년 4월 16일): Microsoft Exchange Server 2000 서비스 팩 3용 업데이트에 대한 검색 변경을 알리기 위해 업데이트 FAQ에 항목이 추가되었습니다. 이 변경 사항은 검색에만 해당됩니다. 이 공지에서 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 이 업데이트를 성공적으로 설치한 고객은 다시 설치할 필요가 없습니다.
-   V2.0(2010년 7월 14일): KB976323에 나열된 알려진 문제점을 해결하는 Windows Server 2008 및 Windows Server 2008 R2에 대한 업데이트를 다시 제공하기 위해 공지를 다시 릴리스하였습니다.
