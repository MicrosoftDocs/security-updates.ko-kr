...
-   이 누적 보안 업데이트에는 Microsoft 보안 공지 [MS05-052](https://technet.microsoft.com/security/bulletin/ms05-052)에서 다룬 Internet Explorer에서 COM 개체 실행을 허용하기 전 추가 확인도 포함되어 있습니다. 이러한 변경 사항의 목적은 Internet Explorer에서 인스턴스화하도록 설계되지 않은 COM 개체가 Internet Explorer에서 인스턴스화되지 않도록 하는 것입니다.
    ...
    -   [Microsoft 기술 자료 문서 909738](https://support.microsoft.com/kb/909738): 누적 보안 업데이트 896688 (MS05-052)에 추가된 심층 방어 기능으로 인해 사용자 지정 ActiveX 컨트롤을 포함한 웹 페이지가 Internet Explorer에서 제대로 로드되지 않을 수 있습니다.
...
Arpidfix.exe는 보안 업데이트 설치 관리자가 [Microsoft 기술 자료 문서 904630](https://support.microsoft.com/kb/904630)에서 설명된 문제를 해결하는 데 사용합니다. 이 파일은 영향을 받는 시스템에 설치되지 않습니다.
...
-   COM 개체 인스턴스화 메모리 손상 취약점([CAN-2005-2831 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2831))에 설명된 여러 클래스 식별자를 보고해 주신 [CERT/CC (영문)](https://www.cert.org/)의 Will Dormann에게 감사드립니다.
-   파일 다운로드 대화 상자 조작 취약점([CAN-2005-2829 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2829))을 보고해 주신 [Secunia (영문)](https://www.secunia.com/)의 Andreas Sandblad와 Jakob Balle에게 감사드립니다.
