...
-   Microsoft Windows XP 서비스 팩 2 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=81fb6a72-ac8a-4b28-905f-a44691d69432&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=d06fd167-4f3e-4a2c-b52c-7426ddad6828)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=4fee481f-dace-4eac-9afe-bc28add70cc5&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c517fb85-128e-43db-a659-38af32283716)
-   Microsoft Windows Server 2003 x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ff4a1f24-c1e9-4223-965b-14c4793aaf96)
...
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 5.01 서비스 팩 4 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=b1c7f765-772c-4eeb-9438-bc820cb929e1&displaylang=ko)
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 6 서비스 팩 1 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=922a3569-85d1-4584-9b84-4aa7304c69bb&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 2에 설치된 Windows Internet Explorer 7 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=55a0a6ec-fefa-40bb-bb6b-3aab50275a73&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition 및 Microsoft Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Internet Explorer 7 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=b5a8b1f2-6af0-4f03-989c-c8de2eace71d)
-   Microsoft Windows Server 2003 서비스 팩 1 및 Microsoft Windows Server 2003 서비스 팩 2에 설치된 Windows Internet Explorer 7 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=08e5cd2e-55c0-4ac9-859f-1b24497b31ce&displaylang=ko)
-   Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP2(Itanium 기반 시스템용)에 설치된 Windows Internet Explorer 7 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=48b4d271-d494-4a5c-aba8-11b3b4584902)
-   Microsoft Windows Server 2003 x64 Edition 및 Microsoft Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Windows Internet Explorer 7 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f9c3e0de-db66-4d83-829f-c93052bdb1fa)
...
|------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|------------------------|---------------------|---------------------------------|
| VML 버퍼 오버런 취약점 - [CVE-2007-0024 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0024) | 원격 코드 실행       | 긴급                     | 긴급                   | 긴급                | 보통                            |
...
“VGX.DLL의 액세스 제어 목록을 더 엄격하게 수정” 대안을 적용하면 vgx.dll을 재배포하는 소프트웨어가 설치에서 실패할 수 있습니다. 이러한 소프트웨어로는 [Windows Internet Explorer 7](https://www.microsoft.com/korea/windows/products/winfamily/ie/default.mspx)이 있습니다. 이 소프트웨어를 설치하기 전에 vgx.dll의 ACL 구성을 대안 적용 이전으로 되돌려야 합니다.
...
|-------------------------------------------------------------------------|--------------------------|-------------------------------------------------------------------|------------------------|---------------------|---------------------------------|
| [**MS06-055**](https://technet.microsoft.com/security/bulletin/ms06-055) | 대체됨                   | 대체됨                                                            | 대체됨                 | 대체됨              | 대체됨                          |
...
Windows 98, Windows 98 Second Edition 및 Windows Millennium Edition에 대한 지원 기간이 끝났습니다. 이러한 운영 체제 버전을 사용 중인 고객은 이후의 취약점에 노출되지 않도록 지원되는 버전으로 마이그레이션을 우선적으로 고려하십시오. Windows 제품 지원 기간에 대한 자세한 내용은 [Microsoft 지원 기간 정책 웹 사이트](https://go.microsoft.com/fwlink/?linkid=21742)를 참조하십시오. 이러한 운영 체제 버전의 연장된 보안 업데이트 지원 기간에 대한 자세한 내용은 [Microsoft 고객 지원 센터 웹 사이트](https://go.microsoft.com/fwlink/?linkid=33328)를 참조하십시오.
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 인터넷 영역이 바이너리 및 스크립트 동작을 기본적으로 사용하지 않으므로 Windows Server 2003 서비스 팩 1 및 Microsoft Windows Server 2003 서비스 팩 2에서 취약점이 완화됩니다.
...
-   **VGX.DLL의 액세스 제어 목록을 더 엄격하게 수정**
    ...
    **참고** 이 대안을 적용하면 vgx.dll을 재배포하는 소프트웨어가 설치에 실패할 수 있습니다. 이러한 소프트웨어로는 [Internet Explorer 7 출시 후보 1](https://www.microsoft.com/korea/windows/products/winfamily/ie/default.mspx) 및 Microsoft Internet Explorer 7의 이후 버전이 있습니다. 이 소프트웨어를 설치하기 전에 vgx.dll의 ACL 구성을 대안 적용 이전으로 되돌려야 합니다.
...
-   VML 버퍼 오버런 취약점 - CVE-2007-0024를 보고해 주신 [iDEFENSE (영문)](https://www.idefense.com/) Contributor Program에 협력해 주신 Jospeh Moti
