...
Microsoft Works 8.5 (KB967043) 및 Microsoft Works 9 (KB967044)에 대한 이 공지(MS09-024)의 보안 업데이트 패키지는 [MS09-017](http://technet.microsoft.com/security/bulletin/ms09-017)에 설명되어 있는 취약점도 해결합니다. Microsoft Works 8.5 또는 Microsoft Works 9가 설치된 사용자는 이 업데이트 패키지를 한 번만 설치하면 됩니다.

**Microsoft Works 6-9 파일 변환기란 무엇입니까?**  
Microsoft Works 6-9 변환기는 Microsoft Office Word 2003이 Works 버전 6, 7, 8 및 9에서 지원하는 Works Word Processor 파일 형식의 파일을 열고, 편집하고, 저장할 수 있도록 해줍니다. 자세한 내용은 [Microsoft Works 6–9 파일 변환기](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1533 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533)을 참조하십시오.
...
-   Microsoft Office Word 2003은 Works 변환기가 설치된 경우에만 영향을 받습니다. 자세한 내용은 [Microsoft Works 6–9 파일 변환기](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)를 참조하십시오.
...
-   **Microsoft Works 6–9 파일 변환기가 있는**[Word 2003과](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)**Word 2007의 경우 액세스를 제한하여 Works 6-9 변환기를 사용하지 않습니다.**
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/957838">Microsoft 기술 자료 문서 957838</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/957646">Microsoft 기술 자료 문서 957646</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/968326">Microsoft 기술 자료 문서 968326</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969559">Microsoft 기술 자료 문서 969559</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   파일 변환기 버퍼 오버플로 취약점(CVE-2009-1533)을 보고해 주신 [NGS Software (영문)](http://www.ngssoftware.com/)의 Shaun Colley
