...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>Win32k 부적절한 사용자 입력 유효성 검사 취약점(CVE-2011-0086)</th>
<th>Win32k 불충분한 사용자 입력 유효성 검사 취약점(CVE-2011-0087)</th>
<th>Win32k 창 클래스 포인터 혼란 취약점(CVE-2011-0088)</th>
<th>Win32k 창 클래스 부적절한 포인터 유효성 검사 취약점(CVE-2011-0089)</th>
<th>Win32k 메모리 손상 취약점(CVE-2011-0090)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
