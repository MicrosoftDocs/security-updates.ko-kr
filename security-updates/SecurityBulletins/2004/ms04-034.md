...
-   Microsoft Windows XP, Microsoft Windows XP 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=6b70ba00-56d1-4314-8f53-f8355a6861d3&displaylang=ko)
-   Microsoft Windows XP 64-Bit Edition 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=3f6896f3-f055-438d-93ce-cd15f37264cb)
-   Microsoft Windows XP 64-Bit Edition Version 2003 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=4b63ef24-d0e4-4005-8e23-2f5ec24be63f)
-   Microsoft Windows Server 2003 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=0903569e-7f3d-4846-a1dc-78734e77d3a9&displaylang=ko)
-   Microsoft Windows Server 2003 64-Bit Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=4b63ef24-d0e4-4005-8e23-2f5ec24be63f)
...
|--------------------------------------------------------------------------------------------------------|----------------------|------------|---------------------|
| 압축 폴더 취약점 [CAN-2004-0575 (US)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0575) | 원격 코드 실행       | 긴급       | 긴급                |
...
|---------------------------------------------------------------------------------------|------------|---------------------|
| [**MS02-054**](https://www.microsoft.com/korea/technet/security/bulletin/ms02-054.asp) | 대체됨     | 해당 사항 없음      |
...
예. SMS를 사용하면 이 보안 업데이트를 검색하고 배포하는 데 도움이 됩니다. SMS에 대한 내용은 [SMS 웹 사이트](https://www.microsoft.com/korea/smserver/default.asp)를 참조하십시오. SMS는 이 게시판의 보안 업데이트 정보 절에 설명되어 있는 영향을 받는 파일이 있는지 검색할 수 있습니다. 이 보안 게시판에 설명되어 있는 버전 이하의 모든 영향을 받는 파일의 버전을 업데이트하십시오. SMS에 대한 내용은 [SMS 웹 사이트](https://www.microsoft.com/korea/smserver/default.asp)를 참조하십시오.
...
**압축 폴더란 무엇입니까?**  
압축 폴더 기능을 사용하여 사용자는 압축 형식으로 데이터 파일 및 폴더를 저장할 수 있습니다. 압축된 파일 및 폴더는 저장 공간을 덜 차하게 됩니다. 또한 사용자가 압축 파일을 만들고, 압축된 파일에 파일을 추가하며 압축을 해제할 수도 있습니다. 압축 폴더에 대한 자세한 내용은 [여기 (US)](https://www.microsoft.com/windowsxp/home/using/productdoc/en/default.asp?url=/windowsxp/home/using/productdoc/en/vz_ovrvw.asp)를 참조하십시오.
Windows에는 해당 드라이브가 [NTFS 파일 압축 방식](https://support.microsoft.com/default.aspx?scid=kb;ko-kr;307987)인 NTFS로 포맷되어 있는 경우 폴더를 압축할 수 있는 다른 방법을 제공하기도 합니다. 그러나 NTFS 파일 압축은 압축 폴더를 사용하여 파일을 압축하는 방식과는 현저히 다릅니다. NTFS 압축과 압축 폴더 간 유사점과 차이점에 대한 자세한 내용은 [여기 (US)](https://www.microsoft.com/windowsxp/home/using/productdoc/en/default.asp?url=/windowsxp/home/using/productdoc/en/ff_file_compress_overview.asp)를 참조하십시오.
...
-   압축 폴더 취약점(CAN-2004-0575)을 보고해 주신 [eEye Digital Security (US)](https://www.eeye.com/html/)
