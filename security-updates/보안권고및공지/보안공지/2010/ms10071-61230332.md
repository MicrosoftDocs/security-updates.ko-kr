...
<td style="border:1px solid black;">
[Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=93580299-d764-417f-a7fa-ee441fea2bb3&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0808 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0808)을 참조하십시오.
...
자동 완성 기능이란 무엇입니까?  
자동 완성은 양식 필드에 정보를 빠르게 입력하는 데 사용되는 Internet Explorer의 기능입니다. 자세한 내용은 MSDN 문서, [HTML 양식에서 자동 완성 사용 (영문)](http://msdn.microsoft.com/en-us/library/ms533032.aspx)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-0808 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0808)이 지정되었습니다.
...
toStaticHTML API는 사용자 입력의 이벤트 특성 및 스크립트를 HTML로 표시하기 전에 제거하는 데 사용할 수 있습니다. 자세한 내용은 MSDN 라이브러리 문서 [toStaticHTML 메서드 (영문)](http://msdn.microsoft.com/en-us/library/cc848922.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3325 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3325)를 참조하십시오.
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3325 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3325)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3326 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3326)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3327 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3327)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3328 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3328)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3329 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3329)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3330 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3330)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3331 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3331)을 참조하십시오.
...
-   알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 HTML 문서를 열지 못하도록 Microsoft Office 파일 차단 정책 사용
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는 Office 2007 시스템에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2360131">Microsoft 기술 자료 문서</a> 2360131 참조</td>
</tr>
<tr class="even">
...
설치 프로그램에 대한 자세한 내용은 [Microsoft TechNet](http://go.microsoft.com/fwlink/?linkid=38951) 웹 사이트를 방문하십시오.
...
-   HTML 삭제 취약점(CVE-2010-3243)을 보고해 주신 [Google Inc.](http://www.google.com/)의 Sirdarckcat  
-   HTML 삭제 취약점(CVE-2010-3324)을 보고해 주신 Mario Heiderich  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-3326)을 보고해 주신 [IBM ISS X-Force (영문)](http://www.iss.net/)의 Takehiro Takahashi  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-3328)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Peter Vreugdenhil  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-3329)을 보고해 주신 [Core Security Technologies (영문)](http://www.coresecurity.com/)의 Damián Frizza  
-   도메인 간 정보 유출 취약점(CVE-2010-3330)을 보고해 주신 [Cigital (영문)](http://www.cigital.com)의 Aldwin Saugere 및 Radoslav Vasilev  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-3331)을 보고해 주신 [Check Point (영문)](http://www.checkpoint.com/) IPS Research Center의 Rodrigo Rubira Branco
