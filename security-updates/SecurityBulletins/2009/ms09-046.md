...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2519 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519)를 참조하십시오.
...
DHTML Editing Component ActiveX 컨트롤은 소프트웨어에서 동적 웹 사이트 HTML 편집을 지원하는 데 사용할 수 있는 HTML 편집기를 제공합니다. DHTML Editing Component ActiveX 컨트롤에 대한 자세한 내용은 MSDN 문서, [MSHTML Editing 소개 (영문)](https://msdn.microsoft.com/en-us/library/aa753630(vs.85).aspx)에서 "DHTML Editing Component"를 참조하십시오.
  
**Windows Server 2003 또는 Windows Server 2008에서 Internet Explorer를 실행하고 있습니다. 이 경우 취약점이 완화됩니까?**  
예. 기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://go.microsoft.com/fwlink/?linkid=92039)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/956844">Microsoft 기술 자료 문서 956844</a> 참조</td>
</tr>
<tr class="even">
...
-   DHTML Editing Component ActiveX 컨트롤 취약점(CVE-2009-2519)을 보고해 주신 [Google Inc. (영문)](https://www.google.com/)의 Tavis Ormandy
