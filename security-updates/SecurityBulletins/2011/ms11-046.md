---
TOCTitle: 'MS11-046'
Title: 'Microsoft 보안 공지 MS11-046 - 중요'
ms:assetid: 'ms11-046'
ms:contentKeyID: 61230413
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-046(v=Security.10)'
---



Microsoft 보안 공지 MS11-046 - 중요
===================================

Ancillary Function Driver의 취약점으로 인한 권한 상승 문제점(2503665)
---------------------------------------------------------------------

게시된 날짜: 2011년 6월 15일 수요일 | 업데이트된 날짜: 2011년 7월 1일 금요일
...
이 보안 업데이트는 사용자 모드에서 Windows 커널로 입력을 전달하기 전에 AFD에서 입력의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=a1db7736-f3e4-45df-af1d-52746978a0a8&displaylang=ko)                                                                               | 권한 상승      | 중요        | [MS08-066](https://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=71497891-41a2-476d-b524-4eb5cecb9639)                                                                     | 권한 상승      | 중요        | [MS08-066](https://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c614cb8b-223e-4f84-b94c-f15747760aa5&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS08-066](https://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9a951087-25c5-4f5c-8407-a1585491ae0b&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS08-066](https://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=dd48b93b-24fa-45a3-91fb-9f9f9418c49f)                                                                 | 권한 상승      | 중요        | [MS08-066](https://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b69e3bda-940b-4524-a724-0af4ae0ec719&displaylang=ko)                                               | 권한 상승      | 중요        | 없음                                                                |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e3a26bc5-1757-4b38-9cae-419c919f4877&displaylang=ko)                       | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e34e4cf9-cdae-4240-8574-950c0be00822&displaylang=ko)\*           | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a3604f05-26b2-451b-9153-0e718158371e&displaylang=ko)\*       | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e8a82b44-e1d8-45f8-b8b8-b1f74e1efce0)                | 권한 상승      | 중요        | 없음                                                                |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e)                                                                                          | 권한 상승      | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e)                                                                              | 권한 상승      | 중요        | 없음                                                                |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9&displaylang=ko)                             | 권한 상승      | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9)                                                                            | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a)\*                                                             | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441)          | 권한 상승      | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441)                                                           | 권한 상승      | 중요        | 없음                                                                |
...
<th style="border:1px solid black;" >Ancillary Function Driver 권한 상승 취약점(CVE-2011-1249)</th>
...
사용자 모드에서 커널로 전달된 입력의 유효성을 올바르게 검사하지 못하는 경우 Ancillary Function Driver(afd.sys)에 권한 상승 취약점이 존재합니다. 취약점을 통해 공격자가 권한을 상승시키는 코드를 실행할 수 있습니다. 이 취약점 악용에 성공한 로컬 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자는 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1249 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)를 참조하십시오.
  
#### Ancillary Function Driver 권한 상승 취약점(CVE-2011-1249)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### Ancillary Function Driver 권한 상승 취약점(CVE-2011-1249)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Ancillary Function Driver 권한 상승 취약점(CVE-2011-1249)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**      
사용자 모드에서 커널로 데이터를 전달할 때 AFD에서 사용자가 입력하는 입력 내용의 유효성을 제대로 검사하지 못하는 경우 취약점이 발생합니다.
  
**Ancillary Function Driver(AFD)란 무엇입니까?**      
...
**TDI(Transport Driver Interface)란 무엇입니까?**      
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 MSDN 문서, [Transport Driver Interface (영문)](https://msdn.microsoft.com/en-us/library/ff565685.aspx)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-1249 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)가 지정되었습니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-1249 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)가 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2503665$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2503665">Microsoft 기술 자료 문서 2503665</a> 참조</td>
</tr>
<tr class="even">
...
-   Ancillary Function Driver 권한 상승 취약점(CVE-2011-1249)을 보고해 주신 [Shadowserver Foundation (영문)](https://www.shadowserver.org)의 Steven Adair와 Chris S.
...
-   V1.1(2011년 7월 1일): 이 업데이트에 의해 교체되는 공지에 MS10-058이 포함되도록 영향을 받는 소프트웨어 표가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.
