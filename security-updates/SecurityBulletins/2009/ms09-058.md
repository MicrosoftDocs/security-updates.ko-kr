...
**알려진 문제점.**[Microsoft 기술 자료 문서 971486](http://support.microsoft.com/kb/971486) 은 고객이 이 보안 업데이트를 설치할 때 발생하는 알려진 이슈에 대한 자료 입니다. 또한 이 문서는 관련 이슈에 관한 권장 솔루션을 제공합니다. 현재 알려진 이슈 및 권장 솔루션이 특정 소프트웨어의 릴리스 만이 관계가 있을 경우, 이 문서는 추가 문서 링크를 제공합니다.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=bdfa6583-28a2-4d6b-91d2-157a8518b664&displaylang=ko)                                 | 권한 상승      | 중요        | [MS07-022](http://technet.microsoft.com/security/bulletin/ms07-022) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=cece4c55-0756-4357-9d2d-6709e8426068&displaylang=ko)                   | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5459b7d4-1fab-4a04-ab9d-b8323505c1e2)                                   | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e3f3842-f8fd-4969-a2cf-706db38d7580&displaylang=ko)                                    | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=95286b8d-4b53-4e6c-af59-e9e18fad3559&displaylang=ko)                        | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=faef714b-5f46-47f2-bea7-881df05a1bc0)                                    | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97&displaylang=ko)                         | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97&displaylang=ko)                                          | 서비스 거부    | 보통        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434&displaylang=ko) | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434&displaylang=ko)                              | 서비스 거부    | 보통        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423&displaylang=ko)\*                             | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423&displaylang=ko)\*                 | 서비스 거부    | 보통        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94&displaylang=ko)\*                           | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94&displaylang=ko)\*               | 서비스 거부    | 보통        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                                        | 권한 상승      | 중요        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                            | 서비스 거부    | 보통        | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2515 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2515)를 참조하십시오.
...
PAE는 Intel에서 제공하는 메모리 주소 확장으로, 대부분의 32비트(IA-32) Intel Pentium Pro 이상의 플랫폼에 대해 4GB가 넘는 실제 메모리를 지원하도록 합니다. PAE 메모리 지원은 일반적으로 4GB가 넘는 RAM에 대한 지원과 관련이 있지만, PAE는 하드웨어에서 적용되는 [DEP(데이터 실행 방지)](http://www.microsoft.com/korea/technet/prodtechnol/winxppro/maintain/sp2mempr.mspx)를 지원하기 위해 Windows XP SP2, Windows Server 2003 및 32비트 이상의 Windows 버전에서 활성화될 수 있습니다. PAE에 대한 자세한 내용은 [물리 주소 확장 - PAE 메모리 및 Windows(영문)](http://www.microsoft.com/whdc/system/platform/server/pae/paedrv.mspx) 문서를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2516 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2516)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2517 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2517)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 971486](http://support.microsoft.com/kb/971486) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/971486">Microsoft 기술 자료 문서 971486</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 커널 정수 언더플로 취약점(CVE-2009-2515)을 보고해 주신 [Google Inc.](http://www.google.com/)의 Tavis Ormandy와 Neel Mehta  
-   Windows 커널 NULL 포인터 역참조 취약점(CVE-2009-2516)을 보고해 주신 [NSFocus Security Team (영문)](http://www.nsfocus.com/)  
-   Windows 커널 예외 처리기 취약점(CVE-2009-2517)을 보고해 주신 [Google Inc.](http://www.google.com/)의 Tavis Ormandy와 Neel Mehta
