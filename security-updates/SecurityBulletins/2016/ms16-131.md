---
TOCTitle: 'MS16-131'
Title: 'Microsoft 보안 공지 MS16-131 - 긴급'
ms:assetid: 'ms16-131'
ms:contentKeyID: 74240638
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-131(v=Security.10)'
---



Microsoft 보안 공지 MS16-131 - 긴급
===================================

Microsoft 비디오 컨트롤용 보안 업데이트(3199151)
------------------------------------------------
...
이 보안 업데이트의 심각도는 Windows Vista, Windows 7, Windows 8.1 및 Windows 10에 대해 긴급입니다. 자세한 내용은 **영향받는 소프트웨어** 절을 참조하십시오.

이 업데이트는 Microsoft 비디오 컨트롤이 메모리의 개체를 처리하는 방식을 수정하여 취약성을 해결합니다. 이 취약성에 대한 자세한 내용은 **취약성 정보** 절을 참조하십시오.

이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3199151](https://support.microsoft.com/ko-kr/kb/3199151)을 참조하십시오.
...
<td style="border:1px solid black;">
[**Microsoft 비디오 컨트롤 원격 코드 실행 취약성(CVE-2016-7248)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198218)  
(3198218)
...
<td style="border:1px solid black;">
[MS16-122](https://go.microsoft.com/fwlink/?linkid=829051)([3190847](https://support.microsoft.com/ko-kr/kb/3190847))

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 버전 서비스 팩 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198218)  
(3198218)
...
\*대체된 업데이트 열에는 대체된 업데이트 체인의 최신 업데이트만 표시됩니다. 대체된 업데이트의 전체 목록을 확인하려면 [Microsoft Update 카탈로그](https://www.catalog.update.microsoft.com/home.aspx)로 이동하고 업데이트 KB 번호를 검색한 다음 업데이트 세부 정보를 보십시오. 대체된 업데이트 정보는 **패키지세부 정보** 탭에 나와 있습니다.

취약성 정보
-----------

 
Microsoft 비디오 컨트롤 원격 코드 실행 취약성(CVE-2016-7248)(영문)
------------------------------------------------------------------
...
**영향받는 소프트웨어 및 취약성 심각도** 표에서 심각도가 긴급으로 표시된 경우 Outlook 미리 보기 창이 [CVE-2016-0142(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248)에 대한 공격 벡터입니다.
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248">CVE-2016-7248(영문)</a></td>
...
*2016년 12월 12일 11:14-08:00에 페이지가 생성되었습니다.*
