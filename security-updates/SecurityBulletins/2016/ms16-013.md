---
TOCTitle: 'MS16-013'
Title: 'Microsoft 보안 공지 MS16-013 - 긴급'
ms:assetid: 'ms16-013'
ms:contentKeyID: 72238899
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-013(v=Security.10)'
---


Microsoft 보안 공지 MS16-013 - 긴급
===================================

원격 코드 실행을 해결하기 위한 Windows 필기장에 대한 보안 업데이트(3134811)
---------------------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원되는 모든 버전의 Windows Vista, Windows 7, Windows 8.1 및 Windows 10, 지원되는 모든 Itanium 이외 버전의 Windows Server 2008 및 Windows Server 2008 R2, 지원되는 모든 버전의 Windows Server 2012 및 Windows Server 2012 R2에 대해 긴급입니다. 자세한 내용은 **영향받는 소프트웨어** 절을 참조하십시오.

이 업데이트는 Windows 필기장에서 필기장 파일을 구문 분석하는 방식을 수정하여 취약성을 해결합니다. 이 취약성에 대한 자세한 내용은 **취약성 정보** 절을 참조하십시오.

<span id="KBArticle"></span>
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3134811](https://support.microsoft.com/ko-kr/kb/3134811)을 참조하십시오.
...
<td style="border:1px solid black;">
[**Windows 필기장 메모리 손상 취약성(CVE-2016-0038)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0038)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](https://www.microsoft.com/ko-kr/download/details.aspx?id=50835&displaylang=ko)  
(3115858)
...
<td style="border:1px solid black;">
[MS15-114의 3100213](https://technet.microsoft.com/ko-kr/library/security/ms15-114)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/ko-kr/download/details.aspx?id=50878&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/ko-kr/download/details.aspx?id=50953&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/ko-kr/download/details.aspx?id=50921&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/ko-kr/download/details.aspx?id=51006&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/ko-kr/download/details.aspx?id=50930&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/ko-kr/download/details.aspx?id=50855&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1(32비트 시스템용)](https://www.microsoft.com/ko-kr/download/details.aspx?id=50971&displaylang=ko)  
(3115858)
...
<td style="border:1px solid black;">
[MS15-098](https://go.microsoft.com/fwlink/?linkid=3069114)의 3069114

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows 8.1(x64 기반 시스템용)](https://www.microsoft.com/ko-kr/download/details.aspx?id=50913&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/ko-kr/download/details.aspx?id=50844&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/ko-kr/download/details.aspx?id=51068&displaylang=ko)  
(3115858)
...
<tr>
<td style="border:1px solid black;">
[Windows 10 버전 1511(32비트 시스템용)](https://support.microsoft.com/ko-kr/kb/3135173)<sup>[1]</sup>
(3135173)
...
<tr>
<td style="border:1px solid black;">
[Windows 10 버전 1511(x64 기반 시스템용)](https://support.microsoft.com/ko-kr/kb/3135173)<sup>[1]</sup>
(3135173)
...
이 업데이트는 Windows 필기장이 설치된 다음 시스템에만 제공됩니다.

-   지원되는 버전의 Windows Server 2008에서 Windows 필기장은 기본적으로 설치되지 않습니다. [데스크톱 경험](https://support.microsoft.com/ko-kr/kb/947036) 기능이 사용되는 경우에는 설치됩니다. 따라서 데스크톱 경험이 사용되는 경우에만 Windows 필기장의 업데이트가 적용됩니다.
-   지원되는 버전의 Windows Server 2008 R2, Windows Server 2012 및 Windows Server 2012 R2에서 Windows 필기장은 기본적으로 설치되지 않습니다. [잉크 및 필기 서비스](https://technet.microsoft.com/ko-kr/library/dd759248.aspx) 기능이 사용되는 경우에는 설치됩니다. 따라서 잉크 및 필기 서비스가 사용되는 경우에만 Windows 필기장의 업데이트가 적용됩니다.
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0038">CVE-2016-0038(영문)</a></td>
...
- **의심스러운 첨부 파일을 열지 않음**
  ...
  **참고** Windows 8 및 Windows 8.1은 Windows 필기장을 사용하지 않게 설정하기 위한 메커니즘을 제공하지 않습니다.
...
*2016-02-03 12:01-08:00에 페이지가 생성되었습니다.*
