...
**알려진 문제점**. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2783534](http://support.microsoft.com/kb/2783534)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS11-032](http://go.microsoft.com/fwlink/?linkid=212224)의 KB2507618은 KB2753842로 대체되었습니다.  
[MS12-075](http://go.microsoft.com/fwlink/?linkid=270856)의 KB2761226은 KB2779030으로 대체되었습니다.
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=fedee43c-0065-42bf-9714-171b5b74f099)(Server Core 설치)  
(KB2753842)  
[Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=3dfa40ef-86a2-44a0-b523-f4a85c7ac82c)(Server Core 설치)  
(KB2779030)
</td>
<td style="border:1px solid black;">
권한 상승
...
예. KB2753842 및 KB2779030 업데이트는 Windows 8 Release Preview 및 Windows Server 2012 Release Candidate에 사용할 수 있습니다. Windows 8 Release Preview와 Windows Server 2012 출시 후보 버전을 보유한 고객은 시스템에 이 업데이트를 적용하는 것이 좋습니다. 업데이트는 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130)에서만 제공됩니다.
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [12월 공지 요약](http://technet.microsoft.com/security/bulletin/ms12-dec)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4786](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4786)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2753842">Microsoft 기술 자료 문서 2753842</a> 및 <a href="http://support.microsoft.com/kb/2779030">Microsoft 기술 자료 문서 2779030</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
[Microsoft 기술 자료 문서 2753842](http://support.microsoft.com/kb/2753842) 및 [Microsoft 기술 자료 문서 2779030](http://support.microsoft.com/kb/2779030) 참조
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2753842](http://support.microsoft.com/kb/2753842) 및 [Microsoft 기술 자료 문서 2779030](http://support.microsoft.com/kb/2779030) 참조 |
...
-   Windows 글꼴 구문 분석 취약점(CVE-2012-2556)을 Chromium Security Rewards Program과 협력하여 보고해 주신 [Documill](http://www.documill.com)의 Eetu Luodemaa와 Joni Vähämäki
