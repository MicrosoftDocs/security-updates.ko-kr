...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=bfe3f869-08be-4f13-97a1-7274ad44c7fb)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=2d014bac-f03d-474a-a7ab-49e8ead8edb0&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition — [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=cae094e4-64a0-4577-986b-4d6c131806d9)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=21d1e864-4517-4353-8477-b4cd3c6187c0&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) — [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=bc60b6c3-ada8-48ab-a63d-b2f1c9320b0d)
-   Microsoft Windows Server 2003 x64 Edition — [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=9d2ba5d1-6f91-47b4-8cc1-dcd44baaa6ce)
...
|--------------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|--------------------------------------------------|--------------------------------------------------------|
| 하이퍼링크 개체 버퍼 오버플로 취약점 - [CVE-2006-3086 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086) | 원격 코드 실행       | 중요                     | 중요                                             | 중요                                                   |
| 하이퍼링크 개체 함수 취약점 - [CVE-2006-3438 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)          | 원격 코드 실행       | 중요                     | 중요                                             | 중요                                                   |
...
|-------------------------------------------------------------------------|--------------|--------------------------------------------------|---------------------|---------------------------------|
| [**MS05-015**](http://technet.microsoft.com/security/bulletin/ms05-015) | 대체됨       | 대체됨                                           | 대체됨              | 해당 사항 없음                  |
...
하이퍼링크 개체 라이브러리는 응용 프로그램 프로그래밍 인터페이스의 모음입니다. 이러한 인터페이스는 소프트웨어 개발자에게 하이퍼링크 처리를 위한 기능을 제공합니다. 하이퍼링크에 대한 자세한 내용은 [제품 설명서 (영문)](http://msdn.microsoft.com/library/default.asp?url=/workshop/misc/hlink/overview/overview.asp)를 참조하십시오.
...
-   하이퍼링크 개체 버퍼 오버플로 취약점([CVE-2006-3086 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086))을 보고해 주신 [TippingPoint Security Research Team (영문)](http://www.tippingpoint.com/security)의 Pedram Amini
-   하이퍼링크 개체 함수 취약점 - [CVE-2006-3438 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)을 보고해 주신 [CSC Australia Pty Limited (영문)](http://au.country.csc.com/en/)의 Steve Tai
-   **기타 보안 관련 업데이트 받기:**
