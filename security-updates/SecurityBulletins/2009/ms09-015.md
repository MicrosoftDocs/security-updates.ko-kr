---
TOCTitle: 'MS09-015'
Title: 'Microsoft 보안 공지 MS09-015 - 보통'
ms:assetid: 'ms09-015'
ms:contentKeyID: 61230201
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-015(v=Security.10)'
---


Microsoft 보안 공지 MS09-015 - 보통
===================================

SearchPath의 혼합 보안 위협 취약점으로 인한 권한 상승 문제점(959426)
--------------------------------------------------------------------

게시된 날짜: 2009년 4월 15일 수요일 | 업데이트된 날짜: 2009년 4월 16일 목요일
...
이 보안 업데이트의 심각도는 지원되는 모든 Windows XP, Windows Server 2003, Windows Vista 및 Windows Server 2008 에디션에 대해 보통입니다. Microsoft Windows 2000에서 이 업데이트는 심층 방어 변경 사항으로 분류됩니다. 자세한 내용은 **이 보안 업데이트의 자주 제기되는 질문 사항(FAQ)**을 참조하십시오. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows가 데스크톱에서 파일을 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=c4e408d7-6716-4a12-ad3a-8029667f5c84&displaylang=ko)                                                | 없음           | 없음        | 없음                                                                |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=3de0684d-605c-489b-bdc7-08bce9b2d4f6&displaylang=ko)                                  | 권한 상승      | 보통        | [MS07-035](https://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b743a7fe-7bf4-420d-a72e-39471e5659fa)           | 권한 상승      | 보통        | [MS07-035](https://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=992bb0cd-fbc7-4a7c-9088-f7f9d9a3ead0&displaylang=ko)                | 권한 상승      | 보통        | [MS07-035](https://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f0a58e8c-7d63-4d7d-ba95-b3787cf408f0&displaylang=ko)    | 권한 상승      | 보통        | [MS07-035](https://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=00c6479d-f81f-445d-b8e4-7b71d77d540a) | 권한 상승      | 보통        | [MS07-035](https://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=2b672d45-f33b-4edc-9f22-2f2c8c726a8b&displaylang=ko)                                        | 권한 상승      | 보통        | 없음                                                                |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=7576e7d5-5bb1-4a53-b568-1ee0500ce721&displaylang=ko)                | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=6b73cf5e-66fe-4b7d-95fc-91a1c262c1e5&displaylang=ko)\*                                            | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=7e60847c-b341-4c38-bc25-2e3cf2d4ae14&displaylang=ko)\*                                          | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=de1c2b4b-af47-4b9a-8363-720e5527573c)                                                       | 권한 상승      | 보통        | 없음                                                                |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 959426](https://support.microsoft.com/kb/959426)에 나와 있습니다.

**이 업데이트는 MS09-014와 어떤 관련이 있습니까?**  
이 보안 공지에서 설명한 혼합 보안 위협 권한 상승 취약점([CVE-2008-2540 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540))도 Internet Explorer에 영향을 미칩니다. 따라서 사용자는 [MS09-014](https://technet.microsoft.com/security/bulletin/ms09-014), Internet Explorer 누적 보안 업데이트(963027)로 제공되는 보안 업데이트도 설치하는 것이 좋습니다.

**이 업데이트에 기능에 대한 보안 관련 변경 사항이 포함되어 있습니까?**  
예. 이 공지의 **취약점 정보**에 나열된 변경 사항 외에, 이 업데이트에는 SetSearchPathMode라는 새로운 API를 도입하는 심층 방어 변경 사항이 포함되어 있습니다.

**SetSearchPathMode 심층 방어 변경 사항이 무엇을 허용합니까?**  
이 새로운 API는 SearchPath 기능을 사용하여 파일을 찾을 때 프로세스별 모드를 허용합니다. 따라서 응용 프로그램이 응용 프로그램 및 시스템 위치 이후에 현재 디렉터리를 검색할 수 있도록 강제할 수 있습니다.

**이 보안 업데이트를 적용하면 CVE-2008-2540에 설명된 혼합 보안 위협으로부터 완전히 보호됩니까?**  
아니요. Internet Explorer 누적 보안 업데이트([MS09-014](https://technet.microsoft.com/security/bulletin/ms09-014))에서 제공하는 심층 방어 보호도 따로 사용해야 합니다. 하지만 혼합 보안 위협에 대해 이 심층 방어 보호를 사용하는 것이 자신의 사용 환경에서 적합한지 확인해야 합니다.

Internet Explorer에서 심층 방어 보호를 사용하려면 [MS09-014](https://technet.microsoft.com/security/bulletin/ms09-014)에서 이 보안 업데이트와 관련된 자주 제기되는 질문 사항에 설명된 SearchPath 기능 컨트롤 키를 사용하십시오. 혼합 보안 위협 문제점에 대한 자세한 내용은 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-2540 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)을 참조하십시오.

**Microsoft Windows 2000이 영향을 받는 소프트웨어 표에 보안 영향 및 심각도 없이 나열되어 있는 이유는 무엇입니까?**
Microsoft Windows 2000이 보안 영향 및 심각도 없이 나열된 이유는 이 업데이트가 다른 지원되는 Windows 운영 체제에 제공하는 것과 동일한 수정 프로그램을 Microsoft Windows 2000에 제공하지 않기 때문입니다. 대신 이 업데이트는 Microsoft Windows 2000 고유의 심층 방어 보호만 제공합니다.

**Microsoft Windows 2000의 혼합 보안 위협에 대한 수정 프로그램이 다른 플랫폼의 수정 프로그램과 다른 이유는 무엇입니까?**  
Microsoft Windows 2000 시스템에는 SetSearchPathMode 기능을 구현하기 위한 아키텍처가 존재하지 않기 때문에 Microsoft Windows 2000에서 취약점을 제거하는 것이 사실상 불가능합니다. 취약점을 제거하려면 영향을 받는 구성 요소뿐만 아니라 Microsoft Windows 2000 운영 체제의 상당 부분을 다시 설계해야 합니다. 시스템을 다시 설계할 경우 Microsoft Windows 2000과 제대로 호환되지 않을 가능성이 있기 때문에 Microsoft Windows 2000에서 실행되도록 제작된 응용 프로그램이 다시 설계된 시스템에서 계속 작동한다는 보장이 없습니다. 하지만 Microsoft는 Microsoft Windows 2000에서 이 취약점을 노리는 공격 경로가 아직 없는 것으로 파악하고 있습니다.

이러한 아키텍처 변경으로 인해 Microsoft Windows 2000에서는 레지스트리 키, HKLM\\System\\CCS\\control\\Session Manager\\SafeDLLSearchMode를 사용하여 Microsoft Windows 2000 고유의 심층 방어 변경 사항을 사용해야 합니다. 지침은 [Microsoft 기술 자료 문서 959426](https://support.microsoft.com/kb/959426)을 참조하십시오. 자세한 내용은 MSDN 문서, [동적 연결 라이브러리 검색 순서 (영문)](https://msdn.microsoft.com/en-us/library/ms682586.aspx)를 참조하십시오.

**SearchPath 기능이란 무엇입니까?**  
SearchPath 기능은 지정된 경로에서 특정 파일을 검색하는 데 사용됩니다. 자세한 내용은 MSDN 문서, [SearchPath 기능(영문)](https://msdn.microsoft.com/en-us/library/aa365527.aspx)을 참조하십시오.

**LoadLibrary 기능이란 무엇입니까?**  
LoadLibrary 기능은 지정된 모듈을 호출 프로세스의 주소 공간으로 로드합니다. 지정된 모듈로 인해 다른 모듈이 로드될 수 있습니다. 자세한 내용은 MSDN 문서, [LoadLibrary 기능(영문)](https://msdn.microsoft.com/en-us/library/ms684175(vs.85).aspx)을 참조하십시오.
...
<th style="border:1px solid black;" >혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)</th>
...
**\*\*Windows Server 2008 Server Core 설치는 영향을 받지 않습니다.** Windows Server 2008 Server Core 설치는 영향을 받지 않습니다. Server Core 설치 옵션을 사용하여 Windows Server 2008이 설치된 경우 이 업데이트에서 해결하는 취약점은 지원되는 모든 Windows Server 2008 에디션에 영향을 주지 않습니다. 이 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교(영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
  
혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)  
----------------------------------------------
  
Windows의 SearchPath 기능이 시스템에서 파일을 찾고 여는 방식에 혼합 보안 위협 권한 상승 취약점이 존재합니다. 공격자는 특수하게 조작된 파일을 특정 위치에 다운로드한 후에 특정 상황에서 해당 파일을 로드할 수 있는 응용 프로그램을 열도록 사용자를 유도함으로써 이 취약점을 악용할 수 있습니다.
...
#### 혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)에 대한 완화 요소
  
이 취약점에 대해 확인된 완화 요소가 없습니다.
  
#### 혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### 혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이는 혼합 보안 위협 권한 상승 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
...
공격자는 특수하게 조작된 파일을 만들어서 사용자가 해당 파일을 바탕 화면에 다운로드하도록 유도할 수 있습니다. 그 이후에 사용자가 응용 프로그램을 시작하여 이 특수하게 조작된 파일을 열어야 합니다. 하지만 공격자가 사용자에게 이러한 파일을 다운로드하고 바탕 화면에 놓도록 강제할 수 있는 방법은 없습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
사용자가 파일을 다운로드하고 응용 프로그램을 실행할 수 있는 워크스테이션, 터미널 서버와 같은 모든 시스템이 이 취약점으로 인한 위험에 노출됩니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 응용 프로그램의 검색 순서를 수정하여 현재 작업 디렉터리를 검색하기 전에 시스템 디렉터리를 검색하도록 합니다. 또한 업데이트는 심층 방어 변경 사항을 제공합니다. 즉, SetSearchPathMode라는 새로운 API를 제공하여 고급 사용자가 SearchPath 기능의 검색 순서를 원하는 대로 설정할 수 있도록 해줍니다. 이 심층 방어 변경 사항에 대한 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항** 섹션도 참조하십시오.
  
**MS09-014, Internet Explorer 누적 보안 업데이트(963027)에서 이 취약점과 혼합 보안 위협 원격 코드 실행 취약점에 동일한 CVE 번호(CVE-2008-2540)가 지정된 이유는 무엇입니까?**  
[CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)은 Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3용 Internet Explorer 7, Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 Internet Explorer 7, 그리고 Windows의 SearchPath 기능에 모두 영향을 미칩니다. 따라서 사용자는 [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659), Internet Explorer 누적 보안 업데이트(963027)로 제공되는 보안 업데이트도 설치하는 것이 좋습니다. 이 업데이트의 취약점에 대한 심층 방어 변경 사항(SetSearchPathMode라고 부르는 새로운 API) 또한 [MS09-014](https://go.microsoft.com/fwlink/?linkid=146659)의 픽스에 해당합니다. **이 보안 업데이트와 관련된 자주 제기되는 질문 사항** 섹션에서 FAQ, "이 업데이트에 기능에 대한 보안 관련 변경 사항이 포함되어 있습니까?"를 참조하십시오
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-2540 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 953818](https://technet.microsoft.com/security/advisory/953818)에서 처음 설명되었습니다.
...
Windows2000-kb959426-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-kb959426-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB959426$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/959426">Microsoft 기술 자료 문서 959426</a> 참조</td>
</tr>
<tr class="even">
...
Windowsxp-kb959426-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션:<br />
Windowsxp-kb959426-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB959426$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/959426">Microsoft 기술 자료 문서 959426</a> 참조</td>
...
Windowsserver2003-kb959426-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB959426-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb959426-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB959426-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)을 보고해 주신 [Aviv Raff (영문)](https://aviv.raffon.net)
...
-   V1.1(2009년 4월 15일): 이 공지의 CVE-2008-2540과 MS09-014 사이의 관계를 설명하기 위해 CVE-2008-2540의 취약점 섹션과 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 FAQ가 추가되었습니다. 또한 Microsoft Windows 2000에서 SetSearchPathMode 구현의 지침에 대한 참조로 Microsoft 기술 자료 문서 959426이 추가되었습니다.
