...
<td style="border:1px solid black;">
[MS08-067](http://go.microsoft.com/fwlink/?linkid=130719)의 KB958644는 KB2705219로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-022](http://go.microsoft.com/fwlink/?linkid=141786)의 KB961501은 KB2712808로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2733594](http://support.microsoft.com/kb/2733594)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1850](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1850)(영문)을 참조하십시오.
...
RAP란 무엇입니까?  
RAP(Remote Administration Protocol)는 LAN Manager 서버의 공유 유지 관리 및 프린터 유지 관리 같은 작업을 포함하는 관리 기능을 처리합니다. 자세한 내용은 [\[MS-RAP\]: Remote Administration Protocol 사양(영문)](http://msdn.microsoft.com/en-us/library/cc240191(v=prot.13))을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1851](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1851)(영문)을 참조하십시오.
...
인쇄 스풀러 서비스란 무엇입니까?  
인쇄 스풀러 서비스는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 자세한 내용은 [How Network Printing Works(네트워크 인쇄 작동 방식)](http://technet.microsoft.com/en-us/library/cc783789(v=ws.10).aspx)(영문)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1852](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1852)(영문)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1853](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1853)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2705219">Microsoft 기술 자료 문서 2705219</a> 참조<br />
<a href="http://support.microsoft.com/kb/2712808">Microsoft 기술 자료 문서 2712808</a> 참조</td>
</tr>
<tr class="even">
...
-   원격 관리 프로토콜 서비스 거부 취약점(CVE-2012-1850)을 보고해 주신 [Palo Alto Networks](http://www.paloaltonetworks.com/)(영문)의 Yamata Li  
-   인쇄 스풀러 서비스 형식 문자열 취약점(CVE-2012-1851)을 보고해 주신 [Palo Alto Networks](http://www.paloaltonetworks.com/)(영문)의 Yamata Li  
-   원격 관리 프로토콜 힙 오버플로 취약점(CVE-2012-1852)을 보고해 주신 [Palo Alto Networks](http://www.paloaltonetworks.com/)(영문)의 Yamata Li  
-   원격 관리 프로토콜 스택 오버플로 취약점(CVE-2012-1853)을 보고해 주신 [Palo Alto Networks](http://www.paloaltonetworks.com/)(영문)의 Yamata Li
