...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ko-kr/security/bulletin/ms10-068">MS10-068</a></td>
</tr>
<tr class="even">
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2014(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014)를 참조하십시오.
...
-   LDAPS를 사용하면서 "Always check CRL(항상 CRL 확인)" 모드에서 IPsec 기반 연결을 사용합니다.
    ...
    IPsec으로 CRL 확인을 활성화하는 방법에 대한 자세한 내용은 TechNet 문서 [Certificate revocation list (CRL) verification - an application choice(영문)](http://social.technet.microsoft.com/wiki/contents/articles/964.aspx)를 참조하십시오.
...
AD LDS(Active Directory Lightweight Directory Services)는 응용 프로그램을 위한 전용 디렉터리 서비스를 제공하는 Active Directory의 독립 모드입니다. AD LDS는 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에서 사용할 수 있습니다. AD LDS는 Windows XP 및 Windows Server 2003에서 사용할 수 있는 ADAM(Active Directory Application Mode)을 대신합니다. AD LDS에 대한 자세한 내용은 TechNet 문서, [Active Directory Lightweight Directory Services(영문)](http://technet.microsoft.com/ko-kr/library/cc731868(ws.10).aspx)를 참조하십시오.

Active Directory Application Mode란 무엇입니까?  
ADAM(Active Directory Application Mode)은 LDAP(Lightweight Directory Access Protocol) 디렉터리 서비스 중 하나이며, 시스템 서비스가 아니라 Windows XP 및 Windows Server 2003을 위한 사용자 서비스로써 실행됩니다. ADAM에 대한 자세한 내용은 TechNet 문서, [ADAM 소개](http://technet.microsoft.com/ko-kr/library/cc780837(ws.10).aspx)를 참조하십시오.
...
CRL은 CA에서 발행한 디지털 서명된 목록이며 CA가 발급하고 해지한 인증서의 목록을 포함합니다. 해지된 각각의 개별 인증서에는 인증서의 일련 번호와 해지 날짜, 해지 이유가 나열됩니다. 응용 프로그램은 표시된 인증서의 해지 상태를 확인하기 위해 CRL 검사를 수행할 수 있습니다. 인증서 해지 검사에 대한 자세한 내용은 TechNet 문서, [인증서 해지 및 상태 검사(영문)](http://technet.microsoft.com/ko-kr/library/ee619730(ws.10).aspx)를 참조하십시오.
...
AD DS(Active Directory Domain Services)는 사용자 로그온 프로세스, 인증 및 디렉터리 검색을 포함하여, 디렉터리 데이터를 저장하고 사용자와 도메인 간의 통신을 관리합니다. Active Directory 도메인 컨트롤러는 AD DS를 실행하는 서버입니다. AD DS에 대한 자세한 내용은 TechNet 문서, [Active Directory Domain Services](http://technet.microsoft.com/ko-kr/library/cc770946(ws.10).aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2616310">Microsoft 기술 자료 문서 2616310</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory의 경우 <a href="http://support.microsoft.com/kb/2601626">Microsoft 기술 자료 문서 2601626</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003의 ADAM(Active Directory Application Mode)의 경우 <a href="http://support.microsoft.com/kb/2616310">Microsoft 기술 자료 문서 2616310</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2601626">Microsoft 기술 자료 문서 2601626</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
