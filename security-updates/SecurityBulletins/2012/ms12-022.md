---
TOCTitle: 'MS12-022'
Title: 'Microsoft 보안 공지 MS12-022 - 중요'
ms:assetid: 'ms12-022'
ms:contentKeyID: 61230489
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-022(v=Security.10)'
---

Microsoft 보안 공지 MS12-022 - 중요
===================================

Expression Design의 취약점으로 인한 원격 코드 실행 문제점 (2651018)
-------------------------------------------------------------------

게시된 날짜: 2012년 3월 13일 화요일 | 업데이트된 날짜: 2012년 3월 15일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Expression Design 릴리스에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 Microsoft Expression Design에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2651018](https://support.microsoft.com/kb/2651018)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=49e12f3a-718d-4d54-82be-b78efb372d07">Microsoft Expression Design</a><br />
(KB2675064)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=899c6860-6081-429b-971a-4d689444920f">Microsoft Expression Design 서비스 팩 1</a><br />
(KB2667724)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2ca4fb5a-3ab4-410b-b42b-075eb1d70410">Microsoft Expression Design 2</a><br />
(KB2667725)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=73b44e97-6dda-4e24-9758-e86a1de4c0c8">Microsoft Expression Design 3</a><br />
(KB2667727)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=be56221e-4271-42dc-a6e4-ebf0290e4ad8">Microsoft Expression Design 4</a><br />
(KB2667730)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<th style="border:1px solid black;" >Expression Design의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-0016)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Expression Design 서비스 팩 1</td>
<td style="border:1px solid black;">중요 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
</tr>
...
Microsoft Expression Design에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0016(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0016)을 참조하십시오.
  
#### Expression Design의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-0016)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격에 성공하려면, 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문하거나 이러한 위치에서 취약한 응용 프로그램이 로드되는 합법적인 파일(예: .xpr 또는 .DESIGN 파일)을 열어야 합니다.  
...
#### Expression Design의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-0016)에 대한 대안
...
#### Expression Design의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-0016)에 대한 FAQ
...
취약점의 원인은 무엇입니까?  
이 취약점은 Microsoft Expression Design이 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.
  
Microsoft Expression Design Graphic(.xpr) 파일이란 무엇입니까?  
Microsoft Expression Design Graphic(.xpr) 파일은 Microsoft Expression Design(ED)의 이전 제품인 Microsoft Expression Graphic Design(EGD)에 의해 생성되는 파일 유형으로, 사용자 인터페이스 모형으로 사용될 수 있는 그래픽을 저장합니다. 이 파일 유형은 Expression Design에서 .DESIGN 파일 유형으로 대체되었습니다.
  
Microsoft Expression Design Drawing(.DESIGN) 파일이란 무엇입니까?  
Microsoft Expression Design Drawing(.DESIGN) 파일은 Microsoft Expression Design에 의해 생성되는 파일 유형입니다. 이 파일은 벡터 및 래스터 그래픽을 모두 포함할 수 있고 다중 레이어 및 다양한 이미지 효과도 포함할 수 있습니다.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 Expression Design 관련 파일(예: .xpr 또는 .DESIGN 파일)을 열도록 유도할 수 있습니다. 이렇게 하면 합법적인 파일을 열 때 Expression Design이 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 Expression Design 관련 파일(예: .xpr 또는 .DESIGN 파일)을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 합법적인 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 이렇게 하면 합법적인 파일을 열 때 Expression Design이 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
네트워크 공격 시나리오에서 공격자는 합법적인 Expression Design 관련 파일 및 특수하게 조작된 DLL을 네트워크 공유, UNC 또는 WebDAV 위치에 두고 사용자가 파일을 열도록 유도할 수 있습니다.
  
취약점으로 인해 위험에 노출되는 시스템은 주로 무엇입니까?  
Microsoft Expression Design이 사용되는 워크스테이션, 터미널 서버 같은 시스템이 주로 이 취약점으로 인한 위험에 노출됩니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Microsoft Expression Design이 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다.
...
| 소프트웨어                              | MBSA |  
|-----------------------------------------|------|  
| Microsoft Expression Design             | 예   |  
| Microsoft Expression Design 서비스 팩 1 | 예   |  
| Microsoft Expression Design 2           | 예   |  
| Microsoft Expression Design 3           | 예   |  
| Microsoft Expression Design 4           | 예   |
...
|-----------------------------------------|---------------------|----------------------------|  
| Microsoft Expression Design             | 예                  | 예                         |  
| Microsoft Expression Design 서비스 팩 1 | 예                  | 예                         |  
| Microsoft Expression Design 2           | 예                  | 예                         |  
| Microsoft Expression Design 3           | 예                  | 예                         |  
| Microsoft Expression Design 4           | 예                  | 예                         |
...
#### Microsoft Expression Design(모든 에디션)
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Expression Design 서비스 팩 1:<br />
...
<td style="border:1px solid black;">Microsoft Expression Design:<br />
<a href="https://support.microsoft.com/kb/2675064">Microsoft 기술 자료 문서 2675064</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Expression Design 서비스 팩 1:<br />
<a href="https://support.microsoft.com/kb/2667724">Microsoft 기술 자료 문서 2667724</a> 참조</td>
</tr>
<tr class="even">
...
| 배포                    |                                                                                                                                                                                                                                                                                                                |  
| 사용자 개입 없이 설치   | 해당 사항 없음                                                                                                                                                                                                                                                                                                 |  
| 다시 시작하지 않고 설치 | KB2667725.exe /norestart                                                                                                                                                                                                                                                                                       |  
| 로그 파일 업데이트      | 해당 사항 없음                                                                                                                                                                                                                                                                                                 |  
| 추가 정보               | 검색 및 배포에 대한 자세한 내용은 이전 섹션의 검색, 배포 도구 및 지침을 참조하십시오.                                                                                                                                                                                                                          |  
| 다시 시작 요구 사항     |                                                                                                                                                                                                                                                                                                                |  
| 다시 시작 필요 여부     | 이 업데이트를 적용한 다음 컴퓨터를 다시 시작해야 할 수 있습니다. 설치 프로그램이 필요한 서비스를 중지하고 업데이트를 적용한 다음 서비스를 다시 시작합니다. 그러나 필요한 서비스를 중지할 수 없거나 필수 파일이 사용 중이면 다시 시작해야 합니다. 이러한 경우에는 재시작을 허용해야 한다는 메시지가 표시됩니다. |  
| 핫패칭                  | 해당 사항 없음                                                                                                                                                                                                                                                                                                 |  
| 제거 정보               | 이 업데이트는 설치 제거할 수 없습니다.                                                                                                                                                                                                                                                                         |  
| 파일 정보               | [Microsoft 기술 자료 문서 2667725](https://support.microsoft.com/kb/2667725) 참조                                                                                                                                                                                                                               |  
| 레지스트리 키 확인      | 해당 사항 없음                                                                                                                                                                                                                                                                                                 |
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2667727">Microsoft 기술 자료 문서 2667727</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">32비트 운영 체제의 Microsoft Expression Design 3:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{9981CE5A-87DB-4AB1-99CC-E0D55EB8AA82}<br />
64비트 운영 체제의 Microsoft Expression Design 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2667730">Microsoft 기술 자료 문서 2667730</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">32비트 운영 체제의 Microsoft Expression Design 4:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{84B3B987-43ED-4AF5-B9D9-BD64693EC100}<br />
64비트 운영 체제의 Microsoft Expression Design 4:<br />
...
-   Expression Design의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-0016)을 보고해 주신 [Laplinker(영문)](https://www.laplinker.com)
...
-   V1.1(2012년 3월 15일): 지원 대상인 모든 릴리스에 대해 보안 업데이트 배포 표의 잘못된 설치 스위치 옵션 설명이 제거되었습니다. 이 변경 사항은 정보에만 해당됩니다. 검색 로직이나 업데이트 파일에 대한 변경 사항은 없습니다.
