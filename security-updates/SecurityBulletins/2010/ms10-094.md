---
TOCTitle: 'MS10-094'
Title: 'Microsoft 보안 공지 MS10-094 - 중요'
ms:assetid: 'ms10-094'
ms:contentKeyID: 61230354
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-094(v=Security.10)'
---


Microsoft 보안 공지 MS10-094 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Server 2003(Itanium 제외), Windows Vista 및 Windows Server 2008(Itanium 제외) 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows Media Encoder가 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ef0ada2c-965f-438f-a1d3-bd45db8460c1&amp;displaylang=ko">Windows Media Encoder 9 x86</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=dc777e61-e1e3-43bf-a84d-22c4a69c135d&amp;displaylang=ko">Windows Media Encoder 9 x86</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=550957c2-ce66-439f-95ea-681237513f75&amp;displaylang=ko">Windows Media Encoder 9 x64</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e8a57950-43cd-486f-bd97-70b0ad360a0b&amp;displaylang=ko">Windows Media Encoder 9 x86</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f98c3b96-acb5-49f1-be42-3dd44d316408&amp;displaylang=ko">Windows Media Encoder 9 x86</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=e1054088-f484-4f44-ba0e-5cbd21773c0c&amp;displaylang=ko">Windows Media Encoder 9 x64</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a4ea028f-edfc-4237-8325-7ece11fcf437&amp;displaylang=ko">Windows Media Encoder 9 x86</a>**</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f468d2b5-f02c-4691-9fb5-a7f69752f126&amp;displaylang=ko">Windows Media Encoder 9 x86</a>**<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=533d91d8-0291-421e-9701-3bd86d18bc45&amp;displaylang=ko">Windows Media Encoder 9 x64</a>**</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
Windows XP 서비스 팩 3의 Windows Media Encoder 9 x86
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x86
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x64
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 2의 Windows Media Encoder 9 x86
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x86
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x64
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 Windows Media Encoder 9 x86
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x86 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x64:
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x64:
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Windows Media Encoder 9 x86\*\*
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Windows Media Encoder 9 x86\*\*
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Windows Media Encoder 9 x64\*\*
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
Microsoft Windows에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3965 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965)를 참조하십시오.

#### 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3965)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   공격이 성공하려면 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문한 후 .prx 파일을 열어야 합니다.
-   파일 공유 프로토콜인 SMB(Server Message Block)는 경계 방화벽에서 자주 비활성화됩니다. 이것이 이 취약점의 가능한 공격 경로를 제한합니다.

#### 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3965)에 대한 대안
...
#### 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3965)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 Windows Media Encoder가 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.

**Windows Media Encoder란 무엇입니까?**  
Microsoft Windows Media Encoder는 라이브 및 미리 녹음/녹화한 오디오 및 비디오를 Windows Media 형식으로 변환하기 위한 편리하고 강력한 프로덕션 도구입니다.

**Windows Media 프로필(.prx) 파일이란 무엇입니까?**  
PRX 파일에는 비디오에 대한 인코딩 설정이 포함되어 있습니다. 비트 전송률 및 비디오 크기와 같은 인코딩 설정을 Microsoft Expression Encoder 또는 Microsoft Windows Encoder에 적용한 후 해당 설정을 하드 디스크에 저장하여 PRX 파일을 만듭니다. Windows Encoder에서 특정 설정을 만든 후 저장하면 해당 설정을 Expression Encoder에서도 사용할 수 있으므로 Windows Encoder에서 만든 복잡한 특정 인코딩 세트를 다시 실행할 필요가 없습니다. PRX 파일에 대한 자세한 내용은 MSDN 문서 [PRX 파일 지원](http://msdn.microsoft.com/ko-kr/library/cc294539.aspx)을 참조하십시오.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 .prx 파일을 열도록 유도할 수 있습니다. 이렇게 하면 .prx 파일을 열 때 Windows Media Encoder가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.

전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 .prx 첨부 파일을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 .prx 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 이렇게 하면 .prx 파일을 열 때 Windows Media Encoder가 특수하게 조작된 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.

네트워크 시나리오에서 공격자는 합법적인 .prx 파일 및 특수하게 조작된 DLL을 UNC 또는 WebDAV 위치에 두고 사용자가 .prx 파일을 열도록 유도할 수 있습니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Windows Media Encoder가 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다.

**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3965 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965)가 지정되었습니다.
...
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 Windows Media Encoder 9 x86:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 다음 위치의 Spuninst.exe 유틸리티를 사용하십시오.<br />
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2447961">Microsoft 기술 자료 문서 2447961</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 2003 x64 Edition 서비스 팩 2의 Windows Media Encoder 9 x64:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Encoder\KB2447961_WM10L</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 Windows Media Encoder 9 x86:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Windows Media Encoder 9 x86:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\KB2447961</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Windows Media Encoder 9 x64:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\KB2447961</td>
</tr>
</tbody>
</table>
