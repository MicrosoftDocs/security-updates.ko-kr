...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2423930](https://support.microsoft.com/kb/2423930)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft는 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121), [MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 및 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 보안 공지에서 제공하는 Microsoft Office 2004 for Mac(KB2505924)용 보안 업데이트가 각각의 공지에 설명된 취약점과 함께 이 보안 공지에 설명된 취약점도 해결한다는 사실을 알리기 위해 이 공지를 개정했습니다. 세 개의 개별 보안 공지에서 KB2505924 업데이트 패키지가 제공되지만 Microsoft Office 2004 for Mac이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다. 자세한 내용과 다운로드 링크는 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121), [MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 또는 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206)을 참조하십시오.

**이 보안 공지가 2010년 12월 16일에 개정된 이유는 무엇입니까?**  
Microsoft는 [Microsoft Office 2008 for Mac](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a)(KB2476512) 및 [Open XML File Format Converter for Mac](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676)(KB2476511)용 보안 업데이트 출시를 알리기 위해 이 공지를 개정했습니다. Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac의 사용자는 이 공지에서 설명하는 취약점을 해결하기 위해 가능한 빨리 이 업데이트를 적용하는 것이 좋습니다. Microsoft Office 2004 for Mac용 업데이트는 현재 사용할 수 없습니다.

**이 공지가 2010년 11월 18일에 개정된 이유는 무엇입니까?**  
Microsoft는 [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)을 이 업데이트에서 해결하는 취약점으로 추가하기 위해 이 공지를 개정하였습니다. 또한 Microsoft PowerPoint 2002 및 Microsoft PowerPoint 2003의 경우 CVE-2010-2573은 이 공지(MS10-087)에서 제공하는 Microsoft Office 업데이트로 해결됩니다. 이 변경 사항은 정보에만 해당됩니다. 이미 MS10-087 및 MS10-088 업데이트를 성공적으로 적용한 고객은 추가 조치를 취할 필요가 없습니다.

**MS10-088은 이 공지(MS10-087)와 어떤 관련이 있습니까?**  
[CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)은 이 공지(MS10-087)와 [MS10-088](https://go.microsoft.com/fwlink/?linkid=198186), "Microsoft PowerPoint의 취약점으로 인한 원격 코드 실행 문제점(2293386)" 모두에서 해결됩니다. Microsoft PowerPoint 2002 및 Microsoft PowerPoint 2003의 경우 이 업데이트(MS10-087)가 취약점을 해결합니다. MS10-088은 PowerPoint Viewer 등과 같이 CVE-2010-2573의 영향을 받는 다른 모든 소프트웨어의 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3333 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333)을 참조하십시오.
...
-   **알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 RTF 문서를 열지 못하도록 Microsoft Office 파일 차단 정책 사용**
    ...
    **대안의 영향.** 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 면제 디렉터리(exempt directory)를 구성하지 않았거나 파일을 신뢰할 수 있는 위치로 이동하지 않은 사용자는 Office 2003 또는 2007 Microsoft Office System에서 RTF 파일을 열 수 없습니다. Microsoft Office 2010의 경우, 선택한 열기 동작에 따라 RTF 파일을 열 수 없거나 보호 모드로 열립니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3334 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3335 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3336 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3336)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3337 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3337)을 참조하십시오.
...
예, 이 취약점은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 공지는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2289169">Microsoft 기술 자료 문서 2289169</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2289187">Microsoft 기술 자료 문서 2289187</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2289158">Microsoft 기술 자료 문서 2289158</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Office 2010의 경우 <a href="https://support.microsoft.com/kb/2289161">Microsoft 기술 자료 문서 2289161</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2008 for Mac 12.2.8 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a)에서 다운로드하여 설치하십시오.
...
Microsoft Office for Mac 2011 14.0.1 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=8bd6ca3b-8004-4e8d-a09d-220dcbbce799)에서 다운로드하여 설치하십시오.
...
Open XML File Format Converter for Mac 1.1.8 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676)에서 다운로드하여 설치하십시오.
...
-   PowerPoint 정수 언더플로로 인한 힙 손상 취약점(CVE-2010-2573)을 [TippingPoint](https://www.tippingpoint.com/)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   RTF 스택 버퍼 오버플로 취약점(CVE-2010-3333)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 [team509 (영문)](https://www.team509.com/)  
-   Office Art 그리기 레코드 취약점(CVE-2010-3334)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Dyon Balding  
-   Office Art 그리기 레코드 취약점(CVE-2010-3334)을 보고해 주신 [CERT Coordination Center (영문)](https://www.cert.org)의 Will Dorman  
-   그리기 예외 처리 취약점(CVE-2010-3335)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)  
-   MSO 대형 SPID 읽기 AV 취약점(CVE-2010-3336)을 보고해 주신 [VUPEN Vulnerability Research Team](https://www.vupen.com/)의 Chaouki Bekrar  
-   안전하지 않은 라이브러리 로드 취약점(CVE-2010-3337)을 보고해 주신 [Fortinet’s FortiGuard Labs (영문)](https://www.fortiguard.com/)의 Haifei Li  
-   안전하지 않은 라이브러리 로드 취약점(CVE-2010-3337)을 보고해 주신 [ACROS Security (영문)](https://www.acrossecurity.com)의 Simon Raner
