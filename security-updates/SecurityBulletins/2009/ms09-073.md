...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975539](https://support.microsoft.com/kb/975539)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=50936f51-b0a9-4e94-85bf-93f9ad74fdd1&amp;displaylang=ko">Microsoft Windows 2000 서비스 팩 4</a><br />
(KB973904)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c090c4c2-c277-4d8c-91e1-28286bc5443e&amp;displaylang=ko">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3</a><br />
(KB973904)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4b9bf156-cd34-460f-b4ad-571e37f54659">Windows XP Professional x64 Edition 서비스 팩 2</a><br />
(KB973904)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b9678229-2473-4aae-a814-eca9ea556d17&amp;displaylang=ko">Windows Server 2003 서비스 팩 2</a><br />
(KB973904)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=257facf3-20a1-49e2-ab4c-c1ae67fe05a0&amp;displaylang=ko">Windows Server 2003 x64 Edition 서비스 팩 2</a><br />
(KB973904)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a7784ef-5d25-4de1-a293-f742b5a3473d">Windows Server 2003 SP2(Itanium 기반 시스템용)</a><br />
(KB973904)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
예, 보안 취약점을 해결하는 것 이외에도 이 보안 업데이트는 영향을 받는 플랫폼에서 Windows 구성 요소 및 타사 응용 프로그램이 WordPad Word 6 텍스트 변환기를 사용하여 Word 6.0 및 Write 파일을 열지 못하도록 합니다. WordPad가 Word 6.0 또는 Write 파일을 열려고 하면 파일이 열리지 않고 대화 상자가 표시됩니다. 자세한 내용은 [Microsoft 기술 자료 문서 975539](https://support.microsoft.com/kb/975539)를 참조하십시오.

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 문제점은 무엇입니까?**  
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975539](https://support.microsoft.com/kb/975539)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2506 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2506)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973904">Microsoft 기술 자료 문서 973904</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975008">Microsoft 기술 자료 문서 975008</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/974882">Microsoft 기술 자료 문서 975051</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Works 8.5:<br />
<a href="https://support.microsoft.com/kb/977304">Microsoft 기술 자료 문서 977304</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/974882">Microsoft 기술 자료 문서 974882</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   WordPad 및 Office 텍스트 변환기 메모리 손상 취약점(CVE-2009-2506)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson과 Jun Mao
