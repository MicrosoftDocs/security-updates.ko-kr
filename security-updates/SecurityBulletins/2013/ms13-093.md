---
TOCTitle: 'MS13-093'
Title: 'Microsoft 보안 공지 MS13-093 - 중요'
ms:assetid: 'ms13-093'
ms:contentKeyID: 61230643
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-093(v=Security.10)'
---

Microsoft 보안 공지 MS13-093 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2, Windows 8 및 Windows Server 2012 64비트 에디션에 대해 중요입니다.

이 보안 업데이트는 Windows가 커널 메모리에서 사용자 메모리로 데이터를 복사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
| 기술 자료 문서 | [2875783](https://support.microsoft.com/kb/2875783) |
|----------------|-----------------------------------------------------|
| 파일 정보      | 예                                                  |
| SHA1/SHA2 해시 | 예                                                  |
| 알려진 문제점  | 없음                                                |
...
[Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?  familyid=655e4f83-a85e-460c-a1af-3c408ee0dfab)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?  familyid=b65e8933-0db7-4130-a9ef-015922d38e0b&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?  familyid=5062e679-70d5-4367-b6f6-824ef69bdb46)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?  familyid=d4443a8c-b89a-4aec-9d5a-eccffa0ff261&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?  familyid=2f272057-1a57-4d28-b0b6-685624758675&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?  familyid=3be2bff1-3d9a-413e-b64f-f4de46be7ac6)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?  familyid=8957362e-2cd3-40f0-8356-a27c230025f6&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?  familyid=d35f9a6c-9566-4654-91cd-94e860108b3f&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?  familyid=75a9ec0c-75fb-486a-b24b-5d1cdc3f2716)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?  familyid=96170c61-ac7e-4964-a84d-1c64dd6acc9f&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?  familyid=a99f9261-a357-4033-8f66-77e6554f2dab&displaylang=ko)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?  familyid=2f272057-1a57-4d28-b0b6-685624758675&displaylang=ko)(Server Core 설치)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?  familyid=d35f9a6c-9566-4654-91cd-94e860108b3f&displaylang=ko)(Server Core 설치)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?  familyid=a99f9261-a357-4033-8f66-77e6554f2dab&displaylang=ko)(Server Core 설치)  
(2875783)
</td>
<td style="border:1px solid black;">
정보 유출
...
|--------------------------------------------------------------------|
| Windows XP 서비스 팩 3                                             |
| Windows Server 2003 서비스 팩 2(x86 기반 에디션만 해당)            |
| Windows Vista 서비스 팩 2(x86 기반 에디션만 해당)                  |
...
<span></span>
Windows 8.1 Preview 및 Windows Server 2012 R2 Preview는 이 보안 공지에서 해결된 취약점의영향을 받습니까?    
예. Windows 8.1(x64 기반) RTM 에디션 및 Windows Server 2012 R2는 이 공지에서 해결된 취약점의 영향을 받지 않지만 x64 기반 Preview 에디션은 영향을 받습니다. 따라서 Windows 8.1 Preview(x64 기반) 또는 Windows Server 2012 R2 Preview를 실행하는 고객은 2875783 업데이트를 시스템에 적용하는 것이 좋습니다. 이 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?  linkid=21130)에서 구할 수 있습니다.
...
<span></span>
Windows 커널 모드 드라이버가 커널과 사용자 메모리 사이의 데이터 복사를 부적절하게 처리하는 경우 정보 유출 취약점이 존재합니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-3887](https://www.cve.mitre.org/cgi-bin/cvename.cgi?  name=cve-2013-3887)(영문)을 참조하십시오.
...
-   신뢰할 수 없는 출처의 실행 파일은 열지 않음

    신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 실행 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.
...
취약점의 원인은 무엇입니까?    
이 취약점은 Windows가 커널 메모리에서 사용자 메모리로의 과도한 데이터 복사를 허용할 때 발생합니다.
...
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 MSDN 문서, [Transport Driver Interface](https://msdn.microsoft.com/en-us/library/ff565685.aspx)(영문)를 참조하십시오.
...
이 취약점을 악용하기 위해 공격자는 영향을 받는 시스템에 로컬 사용자로 로그온하고, 더 높은 권한을 가진 계정으로부터 정보를 얻을 수 있도록 설계된 특수하게 조작된 응용 프로그램을 실행해야 합니다.

취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?    
Itanium 및 x64 기반 워크스테이션 및 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

업데이트는 어떤 기능을 수행합니까?    
이 업데이트는 Windows가 커널 메모리에서 사용자 메모리로 데이터를 복사하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2875783$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2875783">Microsoft 기술 자료 문서 2875783</a> 참조</td>
</tr>
<tr class="odd">
