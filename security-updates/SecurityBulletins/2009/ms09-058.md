---
TOCTitle: 'MS09-058'
Title: 'Microsoft 보안 공지 MS09-058 - 중요'
ms:assetid: 'ms09-058'
ms:contentKeyID: 61230244
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-058(v=Security.10)'
---

Microsoft 보안 공지 MS09-058 - 중요
===================================

Windows 커널의 취약점으로 인한 권한 상승 문제점 (971486)
--------------------------------------------------------

게시된 날짜: 2009년 10월 14일 수요일 | 업데이트된 날짜: 2009년 12월 22일 화요일
...
이 보안 업데이트의 심각도는 지원 대상인 Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista 및 Windows Server 2008에 대해 중요이고, Windows Vista 서비스 팩 2 및 Windows Server 2008 서비스 팩 2에 대해 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널이 64비트 값을 올바르게 자르고, 실행 파일 내에서 데이터의 유효성을 올바르게 검사하며, 오류 상태에서 예외를 정리하도록 하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**알려진 문제점.**[Microsoft 기술 자료 문서 971486](https://support.microsoft.com/kb/971486) 은 고객이 이 보안 업데이트를 설치할 때 발생하는 알려진 이슈에 대한 자료 입니다. 또한 이 문서는 관련 이슈에 관한 권장 솔루션을 제공합니다. 현재 알려진 이슈 및 권장 솔루션이 특정 소프트웨어의 릴리스 만이 관계가 있을 경우, 이 문서는 추가 문서 링크를 제공합니다.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=bdfa6583-28a2-4d6b-91d2-157a8518b664&displaylang=ko)                                 | 권한 상승      | 중요        | [MS07-022](https://technet.microsoft.com/security/bulletin/ms07-022) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=cece4c55-0756-4357-9d2d-6709e8426068&displaylang=ko)                   | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5459b7d4-1fab-4a04-ab9d-b8323505c1e2)                                   | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1e3f3842-f8fd-4969-a2cf-706db38d7580&displaylang=ko)                                    | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=95286b8d-4b53-4e6c-af59-e9e18fad3559&displaylang=ko)                        | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=faef714b-5f46-47f2-bea7-881df05a1bc0)                                    | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97&displaylang=ko)                         | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97&displaylang=ko)                                          | 서비스 거부    | 보통        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434&displaylang=ko) | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434&displaylang=ko)                              | 서비스 거부    | 보통        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423&displaylang=ko)\*                             | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423&displaylang=ko)\*                 | 서비스 거부    | 보통        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94&displaylang=ko)\*                           | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94&displaylang=ko)\*               | 서비스 거부    | 보통        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                                        | 권한 상승      | 중요        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                            | 서비스 거부    | 보통        | [MS08-064](https://technet.microsoft.com/security/bulletin/ms08-064) |
...
<th style="border:1px solid black;" >Windows 커널 정수 언더플로 취약점(CVE-2009-2515)</th>
<th style="border:1px solid black;" >Windows 커널 NULL 포인터 역참조 취약점(CVE-2009-2516)</th>
<th style="border:1px solid black;" >Windows 커널 예외 처리기 취약점(CVE-2009-2517)</th>
...
64비트 값이 32비트 값으로 잘못 잘려 Windows 커널에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2515 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2515)를 참조하십시오.
  
#### Windows 커널 정수 언더플로 취약점(CVE-2009-2515)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.  
-   32비트 시스템에서 PAE(물리 주소 확장)가 사용되는 경우에만 이 취약점이 악용될 수 있습니다.
  
#### Windows 커널 정수 언더플로 취약점(CVE-2009-2515)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 정수 언더플로 취약점(CVE-2009-2515)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널이 64비트 값을 32비트 값으로 잘못 자르기 때문입니다. 이로 인해 나중에 다른 값에서 이 값을 뺄 때 정수 언더플로가 발생합니다.
  
**Windows 커널이란 무엇입니까?**    
Windows 커널은 운영 체제의 핵심입니다. 커널에서는 장치 관리 및 메모리 관리 등의 시스템 수준 서비스를 제공하며 프로세스에 프로세서 시간을 할당하고 오류 처리를 관리합니다.
  
**PAE(물리 주소 확장)란 무엇입니까?**    
PAE는 Intel에서 제공하는 메모리 주소 확장으로, 대부분의 32비트(IA-32) Intel Pentium Pro 이상의 플랫폼에 대해 4GB가 넘는 실제 메모리를 지원하도록 합니다. PAE 메모리 지원은 일반적으로 4GB가 넘는 RAM에 대한 지원과 관련이 있지만, PAE는 하드웨어에서 적용되는 [DEP(데이터 실행 방지)](https://www.microsoft.com/korea/technet/prodtechnol/winxppro/maintain/sp2mempr.mspx)를 지원하기 위해 Windows XP SP2, Windows Server 2003 및 32비트 이상의 Windows 버전에서 활성화될 수 있습니다. PAE에 대한 자세한 내용은 [물리 주소 확장 - PAE 메모리 및 Windows(영문)](https://www.microsoft.com/whdc/system/platform/server/pae/paedrv.mspx) 문서를 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows 커널이 64비트 값을 올바르게 자르도록 하여 취약점을 해결합니다.
...
사용자 모드에서 전달된 특정 데이터의 유효성을 충분히 검사하지 않아 Windows 커널에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2516 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2516)을 참조하십시오.
  
#### Windows 커널 NULL 포인터 역참조 취약점(CVE-2009-2516)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 이 취약점을 악용하려면 특수하게 조작한 응용 프로그램을 시스템에 배치할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 NULL 포인터 역참조 취약점(CVE-2009-2516)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 NULL 포인터 역참조 취약점(CVE-2009-2516)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널이 사용자 모드에서 전달된 특정 데이터의 유효성을 제대로 검사하지 못하기 때문입니다.
...
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하려면 공격자는 먼저 특수하게 조작한 응용 프로그램을 대상 시스템에 배치해야 합니다. 사용자가 특수하게 조작된 응용 프로그램이 있는 디렉터리를 검색하면 취약점이 악용되어 영향을 받는 시스템이 완전히 제어당하게 됩니다. 즉, 사용자가 응용 프로그램을 실행할 필요도 없이 조작된 응용 프로그램이 있는 디렉터리를 검색하기만 하면 취약점이 악용됩니다.
  
공격자는 특수하게 조작한 응용 프로그램을 네트워크 공유에 배치할 수도 있습니다. 이 경우 사용자가 네트워크 공유를 검색하면 특수하게 조작된 응용 프로그램이 시스템의 응답을 중지시키고 다시 시작되도록 만듭니다. 즉, 사용자가 응용 프로그램을 실행할 필요도 없이 특수하게 조작된 응용 프로그램이 있는 네트워크 공유를 검색하기만 하면 취약점이 악용됩니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**    
워크스테이션과 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows 커널이 실행 파일 내에 있는 데이터의 유효성을 올바르게 검사하도록 하여 취약점을 해결합니다.
...
Windows 커널이 특정 예외를 처리하는 방식 때문에 Windows 커널에 서비스 거부 취약점이 존재합니다. 공격자는 시스템 다시 시작을 유도하도록 특수하게 조작된 응용 프로그램을 실행하여 취약점을 악용할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2517 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2517)을 참조하십시오.
  
#### Windows 커널 예외 처리기 취약점(CVE-2009-2517)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 예외 처리기 취약점(CVE-2009-2517)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 예외 처리기 취약점(CVE-2009-2517)에 대한 FAQ
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows 커널이 오류 상태에서 예외를 정리하도록 하여 취약점을 해결합니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-kb971486-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-kb971486-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | kb971486.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB971486$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 971486](https://support.microsoft.com/kb/971486) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971486\\Filelist                                        |
...
Windowsxp-kb971486-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb971486-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB971486$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971486">Microsoft 기술 자료 문서 971486</a> 참조</td>
</tr>
<tr class="even">
...
Windowsserver2003-kb971486-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB971486-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb971486-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB971486-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   Windows 커널 정수 언더플로 취약점(CVE-2009-2515)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy와 Neel Mehta  
-   Windows 커널 NULL 포인터 역참조 취약점(CVE-2009-2516)을 보고해 주신 [NSFocus Security Team (영문)](https://www.nsfocus.com/)  
-   Windows 커널 예외 처리기 취약점(CVE-2009-2517)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy와 Neel Mehta
...
-   V1.1(2009년 12월 22일): 요약의 알려진 이슈에 Microsoft 보안 권고(971486)링크가 추가 되었습니다.
