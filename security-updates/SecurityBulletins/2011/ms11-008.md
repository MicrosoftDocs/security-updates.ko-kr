---
TOCTitle: 'MS11-008'
Title: 'Microsoft 보안 공지 MS11-008 - 중요'
ms:assetid: 'ms11-008'
ms:contentKeyID: 61230374
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-008(v=Security.10)'
---

Microsoft 보안 공지 MS11-008 - 중요
===================================
...
이 보안 업데이트는 Microsoft Visio 2002 서비스 팩 2, Microsoft Visio 2003 서비스 팩 3 및 Microsoft Visio 2007 서비스 팩 2에 대해 중요입니다. 자세한 내용은 이 섹션의 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Microsoft Visio가 특수하게 조작된 Visio 파일을 구문 분석할 때 메모리의 손상된 구조 및 개체를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=273d8078-0dc7-43d8-bcae-54c811e49e0e&amp;displaylang=ko">Microsoft Visio 2002 서비스 팩 2</a><br />
(KB2434711)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f1067eaa-d18d-4bff-a02e-1d990c36ca7f&amp;displaylang=ko">Microsoft Visio 2003 서비스 팩 3</a><br />
(KB2434733)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=097a642b-b786-4724-a907-79f37cded836&amp;displaylang=ko">Microsoft Visio 2007 서비스 팩 2</a><br />
(KB2434737)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-036">MS10-036</a></td>
...
<th style="border:1px solid black;" >Visio 개체 메모리 손상 취약점(CVE-2011-0092)</th>
<th style="border:1px solid black;" >Visio 데이터 형식 메모리 손상 취약점(CVE-2011-0093)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
Microsoft Visio에서 특수하게 조작된 Visio 파일을 구문 분석할 때 메모리의 개체의 유효성을 검사하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0092 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0092)를 참조하십시오.
  
#### Visio 개체 메모리 손상 취약점(CVE-2011-0092)에 대한 완화 요소
...
-   웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 특수하게 조작된 Visio 파일이 포함된 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 웹 사이트를 방문하도록 유도해야 하는데, 일반적으로 사용자를 공격자의 웹 사이트로 유인하는 링크를 클릭하도록 하는 방법을 사용합니다. 그 후 공격자는 사용자가 특수하게 조작된 Visio 파일을 열도록 유도합니다.
  
#### Visio 개체 메모리 손상 취약점(CVE-2011-0092)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **ORMELEMS.DLL에 대한 액세스 제한**
    ...
    **참고** &lt;office version&gt;에 대해 Microsoft Visio 2002의 경우 "Office10", Microsoft Visio 2003의 경우 "Office11", Microsoft Visio 2007의 경우 "Office12" 등과 같이 시스템의 해당 Microsoft Office 구성 요소의 버전을 입력합니다. 버전을 확인하려면 이 Microsoft Office 구성 요소를 열고 **도움말**을 클릭하십시오.
    ...
    **대안의 영향.** 사용자가 Visio에서 데이터베이스 모델링 기능을 사용할 수 없게 됩니다.
...
-   **Microsoft Visio 2007에서 추가 기능 비활성화**
  
    Visio 2007을 열고 다음 단계를 수행하십시오.
  
    1.  **도구**를 클릭합니다.  
    2.  **보안 센터**를 클릭합니다.  
    3.  **추가 기능**을 클릭합니다.  
    4.  **모든 응용 프로그램 추가 기능 사용 안 함** 확인란이 선택되어 있는지 확인합니다.  
    5.  **확인**을 클릭하여 설정을 적용합니다.
  
    **대안의 영향.** Visio 추가 기능과 관련된 기능이 작동하지 않게 됩니다.
    ...
    **대안 실행 취소 방법.**
    ...
    2.  **보안 센터**를 클릭합니다.  
    3.  **추가 기능**을 클릭합니다.  
    4.  **모든 응용 프로그램 추가 기능 사용 안 함** 확인란이 선택되지 않았는지 확인합니다.  
    5.  **확인**을 클릭하여 설정을 적용합니다.
...
#### Visio 개체 메모리 손상 취약점(CVE-2011-0092)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
Microsoft Visio가 특수하게 조작된 Visio 파일을 구문 분석할 때 메모리의 개체의 유효성을 올바르게 검사하지 못합니다.
...
이 취약점을 악용하려면 사용자가 영향을 받는 Microsoft Visio 버전에서 특수하게 조작된 Visio 파일을 열어야 합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Visio에서 특수하게 조작된 Visio 파일을 구문 분석할 때 메모리의 개체의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
Microsoft Visio에서 특수하게 조작된 Visio 파일을 처리할 때 특정 구조를 구문 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0093 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0093)을 참조하십시오.
  
#### Visio 데이터 형식 메모리 손상 취약점(CVE-2011-0093)에 대한 완화 요소
...
#### Visio 데이터 형식 메모리 손상 취약점(CVE-2011-0093)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **ELEMENTS.DLL에 대한 액세스 제한**
...
#### Visio 데이터 형식 메모리 손상 취약점(CVE-2011-0093)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**  
Microsoft Visio가 특수하게 조작된 Visio 파일을 열 때 손상된 구조를 올바르게 처리하지 못합니다.
...
웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 특수하게 조작된 Visio 파일이 포함된 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 웹 사이트를 방문하도록 유도해야 하는데, 일반적으로 사용자를 공격자의 사이트로 유인하는 링크를 클릭하도록 하는 방법을 사용합니다. 그 후 공격자는 사용자가 특수하게 조작된 Visio 파일을 열도록 유도합니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
Microsoft Visio가 사용되는 워크스테이션, 터미널 서버 등과 같은 시스템이 주로 이 취약점으로 인한 위험에 노출됩니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Visio에서 특수하게 조작된 Visio 파일을 열 때 손상된 구조의 구문을 분석하는 방식을 수정하여 취약점을 해결합니다.
...
|----------------------------------|---------|---------------------|---------------------|----------------------------|  
| Microsoft Visio 2002 서비스 팩 2 | 아니요  | 아니요              | 예                  | 예                         |  
| Microsoft Visio 2003 서비스 팩 3 | 아니요  | 아니요              | 예                  | 예                         |  
| Microsoft Visio 2007 서비스 팩 2 | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2434711">Microsoft 기술 자료 문서 2434711</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2434733">Microsoft 기술 자료 문서 2434733</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2434737">Microsoft 기술 자료 문서 2434737</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Visio 개체 메모리 손상 취약점(CVE-2011-0092)을 [TippingPoint의 (영문)](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Procyun  
-   Visio 개체 메모리 손상 취약점(CVE-2011-0092)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Xin Ouyang  
-   Visio 데이터 형식 메모리 손상 취약점(CVE-2011-0093)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Xin Ouyang
