...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2566220](https://support.microsoft.com/kb/2566220)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
Windows Vista 서비스 팩 1은 Bluetooth 2.1 기술을 지원하는 시스템에서만 영향을 받습니다. [Windows Vista Feature Pack for Wireless](https://support.microsoft.com/kb/942567)를 설치한 Windows Vista 서비스 팩 1 고객은 Bluetooth 2.1 기술 지원이 제공되므로 이 취약점의 영향을 받습니다. 이러한 고객은 보안 업데이트 KB2561109를 설치해야 합니다. Windows Vista Feature Pack for Wireless를 설치하지 않은 고객은 Bluetooth 2.1 지원을 받지 못하므로 이 취약점의 영향을 받지 않습니다. 자세한 내용은 [Microsoft 기술 자료 문서 2566220](https://support.microsoft.com/kb/2566220)을 참조하십시오.
  
**Windows Vista 서비스 팩 1용 Windows Vista Feature Pack for Wireless를 설치했지만 Windows Vista 서비스 팩 2로 업그레이드했습니다. 어떤 업데이트를 설치해야 합니까?**      
Windows Vista 서비스 팩 1용 [Windows Vista Feature Pack for Wireless](https://support.microsoft.com/kb/942567)를 사용하도록 설정했으며 Windows Vista 서비스 팩 2로 성공적으로 업그레이드한 고객은 보안 업데이트 KB2532531을 설치해야 합니다. 자세한 내용은 [Microsoft 기술 자료 문서 2566220](https://support.microsoft.com/kb/2566220)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1265 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265)를 참조하십시오.
...
**Bluetooth란 무엇입니까?**      
Bluetooth는 컴퓨터, 핸드헬드 장치, 휴대폰 및 기타 장치에서 무선 연결을 구성할 수 있는 업계 표준 프로토콜입니다. 자세한 내용은 MSDN 문서 [Bluetooth (영문)](https://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx)를 참조하십시오.
...
예. Windows Vista 및 Windows 7은 다양한 Bluetooth 라디오 장치를 지원하며 시스템에 이동식 Bluetooth 장치가 추가될 때 Bluetooth 드라이버를 설치합니다. 따라서 지원되는 모든 Windows Vista 및 Windows 7 버전이 영향을 받습니다. 자세한 내용은 MSDN 문서 [Bluetooth 무선 기술 FAQ - 2010 (영문)](https://msdn.microsoft.com/windows/hardware/gg487349.aspx)을 참조하십시오.
...
<a href="https://support.microsoft.com/kb/2561109">Microsoft 기술 자료 문서 2561109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/2532531">Microsoft 기술 자료 문서 2532531</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2532531">Microsoft 기술 자료 문서 2532531</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
