...
권장 사항. 대다수의 고객은 자동 업데이트를 사용하고 있기 때문에 따로 조치를 취할 필요가 없습니다. 이 보안 업데이트가 자동으로 다운로드되고 설치됩니다. 자동 업데이트를 사용하고 있지 않은 고객은 수동으로 업데이트를 확인하고 이 업데이트를 설치해야 합니다. 자동 업데이트의 특정 구성 옵션에 대한 자세한 내용은 [Microsoft 기술 자료 문서 294871](http://support.microsoft.com/kb/294871)을 참조하십시오. 고객이 업데이트 관리 소프트웨어를 사용하거나 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 서비스를 통해 업데이트를 확인하여 업데이트를 최대한 빨리 적용하는 것이 좋습니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                     | 권한 상승      | 중요        | [MS11-080](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS11-080](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-080](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                                      | 권한 상승      | 중요        | [MS11-080](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS11-046](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb&displaylang=ko)\*                                                 | 권한 상승      | 중요        | [MS11-046](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                              | 권한 상승      | 중요        | [MS11-046](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127&displaylang=ko)                             | 권한 상승      | 중요        | [MS11-046](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744&displaylang=ko)\* | 권한 상승      | 중요        | [MS11-046](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc)          | 권한 상승      | 중요        | [MS11-046](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0148(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148)을 참조하십시오.
...
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 MSDN 문서, [Transport Driver Interface(영문)](http://msdn.microsoft.com/ko-kr/library/ff565685.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0149(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2645640">Microsoft 기술 자료 문서 2645640</a> 참조</td>
</tr>
<tr class="even">
...
-   AfdPoll 권한 상승 취약점(CVE-2012-0148)을 보고해 주신 [Azimuth Security(영문)](http://www.azimuthsecurity.com/)의 Tarjei Mandt  
-   AfdPoll 권한 상승 취약점(CVE-2012-0149)을 보고해 주신 [Azimuth Security(영문)](http://www.azimuthsecurity.com/)의 Tarjei Mandt
