---
TOCTitle: 'MS16-002'
Title: 'Microsoft 보안 공지 MS16-002 - 긴급'
ms:assetid: 'ms16-002'
ms:contentKeyID: 72150191
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-002(v=Security.10)'
---


Microsoft 보안 공지 MS16-002 - 긴급
===================================
...
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3124904](https://support.microsoft.com/ko-kr/kb/3124904)를 참조하십시오.
...
<tr>
<td style="border:1px solid black;">
[Windows 10(32비트 시스템용)](https://support.microsoft.com/ko-kr/kb/3124266)<sup>[1]</sup><sup>[2]</sup>
(3124266)
...
<td style="border:1px solid black;">
MS15-125의 [3116869](https://support.microsoft.com/ko-kr/kb/3116869)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows 10(x64 기반 시스템용)](https://support.microsoft.com/ko-kr/kb/3124266)<sup>[1]</sup><sup>[2]</sup>
(3124266)
...
<tr>
<td style="border:1px solid black;">
[Windows 10 버전 1511(32비트 시스템용)](https://support.microsoft.com/ko-kr/kb/3124263)<sup>[1]</sup><sup>[2]</sup>
(3124263)
...
<td style="border:1px solid black;">
MS15-125의 [3116900](https://support.microsoft.com/ko-kr/kb/3116900)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows 10 버전 1511(x64 기반 시스템용)](https://support.microsoft.com/ko-kr/kb/3124263)<sup>[1]</sup><sup>[2]</sup>
(3124263)
...
<sup>[2]</sup>Citrix XenDesktop이 설치된 Windows 10 또는 Windows 10 버전 1511을 실행하는 고객에게는 해당 업데이트가 제공되지 않습니다. XenDesktop 소프트웨어에서의 Citrix 문제로 인해, 해당 업데이트를 설치하는 사용자가 로그인할 수 없게 됩니다. 계속하여 보호를 받으려면, 호환되지 않는 소프트웨어를 제거하고 이 업데이트를 설치하는 것이 좋습니다. 자세한 내용 및 이 XenDesktop 소프트웨어 문제 관련 지원은 Citrix에 문의해야 합니다.
...
Microsoft Edge가 메모리의 개체에 부적절하게 액세스하는 경우 원격 코드 실행 취약성이 존재합니다. 이 취약성으로 인해 메모리가 손상되고 공격자가 현재 사용자의 컨텍스트에서 임의 코드를 실행할 수 있습니다.
...
이 취약성 악용에 성공한 공격자는 현재 사용자와 동일한 권한을 얻을 수 있습니다. 현재 사용자가 관리자 권한으로 로그온한 경우, 이 취약성 악용에 성공한 공격자는 영향받는 시스템을 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치하거나, 데이터를 보거나 변경하거나 삭제하거나, 모든 사용자 권한이 있는 새 계정을 만들 수 있습니다. 이 업데이트는 Microsoft Edge가 메모리에서 개체를 처리하는 방식을 수정하여 취약성을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0003">CVE-2016-0003(영문)</a></td>
...
Microsoft Edge에서 메모리의 개체를 처리할 때 Chakra JavaScript 엔진이 렌더링하는 방식에 원격 코드 실행 취약성이 존재합니다. 이 취약성으로 인해 메모리가 손상되고 공격자가 현재 사용자의 컨텍스트에서 임의 코드를 실행할 수 있습니다.
...
이 업데이트는 Chakra JavaScript 스크립팅 엔진이 메모리에서 개체를 처리하는 방식을 수정하여 취약성을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0024">CVE-2016-0024(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
</tbody>
...
*2016-01-12 12:31-08:00에 페이지가 생성되었습니다.*
