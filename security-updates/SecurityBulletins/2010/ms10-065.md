...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2267960](https://support.microsoft.com/kb/2267960)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[IIS(인터넷 정보 서비스) 7.5](https://www.microsoft.com/download/details.aspx?familyid=66b64374-95e4-4b99-80e6-98dc63cd272b&displaylang=ko)  
(KB2124261)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[IIS(인터넷 정보 서비스) 7.5](https://www.microsoft.com/download/details.aspx?familyid=5f0c0454-cbb6-47ed-9227-98aa45b8cbdb&displaylang=ko)  
(KB2271195)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1899 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1899)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2730 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2730)을 참조하십시오.
...
-   URL 재작성 모듈 설치
    ...
    이 모듈이 설치되면 사용자가 해당 모듈을 사용하는지에 관계없이 사용자는 보호됩니다. URL 재작성에 대한 자세한 내용은 [URL 재작성 (영문)](https://www.iis.net/download/urlrewrite)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2731 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731)을 참조하십시오.
...
-   **URLScan 설치 및 사용**
    ...
    URLScan은 이 공지에서 공개적으로 설명한 문제를 비롯하여, 잘못 형성된 URL로 인해 파생되는 많은 문제로부터 보호합니다. URLScan은 아래의 완화 코드 모듈 또는 global.asax 스크립트만큼 시스템을 보호하지 않습니다. URLScan에 대한 자세한 내용은 TechNet 문서 [UrlScan Security Tool (영문)](https://www.microsoft.com/technet/security/tools/urlscan.mspx)을 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2731 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731)이 지정되었습니다.
...
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 IIS(인터넷 정보 서비스) 5.1 ASP(KB2124261) 및 Windows XP Professional x64 Edition 서비스 팩 2의 IIS(인터넷 정보 서비스) 6.0 ASP(KB2124261)의 경우 <a href="https://support.microsoft.com/kb/2124261">Microsoft 기술 자료 문서 2124261</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 IIS(인터넷 정보 서비스) 5.1 인증(KB2290570)의 경우 <a href="https://support.microsoft.com/kb/2290570">Microsoft 기술 자료 문서 2290570</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2124261">Microsoft 기술 자료 문서 2124261</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<a href="https://support.microsoft.com/kb/2124261">Microsoft 기술 자료 문서 2124261</a> 참조<br />
<br />
...
<a href="https://support.microsoft.com/kb/2271195">Microsoft 기술 자료 문서 2271195</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
