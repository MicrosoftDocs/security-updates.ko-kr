---
TOCTitle: 'MS11-052'
Title: 'Microsoft 보안 공지 MS11-052 - 긴급'
ms:assetid: 'ms11-052'
ms:contentKeyID: 61230419
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-052(v=Security.10)'
---



Microsoft 보안 공지 MS11-052 - 긴급
===================================

벡터 표시 언어의 취약점으로 인한 원격 코드 실행 문제점(2544521)
---------------------------------------------------------------

게시된 날짜: 2011년 6월 15일 수요일 | 업데이트된 날짜: 2011년 7월 13일 수요일
...
이 보안 업데이트는 Microsoft의 VML(벡터 표시 언어) 구현에 대해 비공개적으로 보고된 취약점을 해결합니다. 이 보안 업데이트의 심각도는 Windows 클라이언트의 Internet Explorer 6, Internet Explorer 7 및 Internet Explorer 8에 대해서는 긴급이며, Windows 서버의 Internet Explorer 6, Internet Explorer 7 및 Internet Explorer 8에 대해서는 보통입니다. Internet Explorer 9는 이 취약점의 영향을 받지 않습니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
이 보안 업데이트는 Internet Explorer가 메모리에서 개체를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;">
[Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=6c760c7f-94f1-437f-a645-fd33b50d03f4&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=5dafb455-969e-4be9-8735-d4ee0682d22f&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=e78829d0-8215-4e56-8959-ebd3bc8e9a91&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=0b88f9e9-3439-44e5-92c8-66a3c97cb03d&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=ba3beb80-a921-489e-a6ff-a7b2d665ada6&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=3bec943e-5758-4439-a947-a8fafd30edec&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=e541f1bb-c9bf-4dc8-96ec-58a3de5ba7fd&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=6c7d7162-ef19-49f4-a8fc-5db7415445a4&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=4446121a-0aab-4fbc-ba74-68d7650e8bca&displaylang=ko)\*\*
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=01399fc7-dc2b-461e-a1a5-751a3b61bde0&displaylang=ko)\*\*
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=03b45ad8-cc6b-473b-8112-bd513ed97f5d&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=a8038325-0d14-445b-a5d9-ce7ac1fa44b5&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=5f7bcbad-f647-4fbb-88d4-b19c54db6f00&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=cd059690-52b0-4b37-9fbb-d9906ae46fed&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=256bb26f-df9e-4259-881b-e8313a9fafa8&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=ed089de4-c9ec-4ac7-a711-5f7cb29c05bc&displaylang=ko)\*\*
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=dd32b7c6-daa1-47aa-807f-25a678790cf2&displaylang=ko)\*\*
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=27e767d8-84e3-434f-bb8d-3b2303774ad0&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=747ba56a-0d47-4946-99a4-bae1f11ea748&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=cff7f53d-0fd6-48f8-a9d6-bf19e0a32905&displaylang=ko)\*\*
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
**이 공지가 2011년 7월 12일에 개정된 이유는 무엇입니까?**    
Microsoft는 검색 로직에 대한 변경 사항을 알리고 일부 영향을 받는 구성에 대한 공지 교체 정보를 수정하기 위해 이 공지를 개정하였습니다.

지원 대상인 모든 Windows XP x64 기반 에디션 및 지원 대상인 모든 Windows Server 2003 에디션에서 Internet Explorer 6을 실행하는 고객의 경우 이 릴리스는 검색 로직에 대한 변경 및 공지 교체 정보에 대한 수정에 해당됩니다. 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.

지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션에서 Internet Explorer 7을 실행하는 고객의 경우 이 릴리스는 공지 교체 정보에 대한 수정에만 해당됩니다. 검색 로직이나 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.

**파일 정보 세부 사항은 어디에 있습니까?**    
파일 정보 세부 사항의 위치에 대해서는 **보안 업데이트 배포** 섹션에서 참조 표를 참조하십시오.

**Internet Explorer 7로 업그레이드하기 전에 이 보안 업데이트를 설치하는 경우 Internet Explorer 7로 업그레이드한 다음에도 이 업데이트를 적용해야 합니까?**    
예. Internet Explorer 6이 설치된 시스템에 현재 VML 보안 업데이트를 설치한 고객이 나중에 Internet Explorer 7을 설치하면 이 업데이트의 Internet Explorer 7용 버전이 제공됩니다. Windows Internet Explorer 7과 함께 설치되는 vgx.dll 버전은 Windows XP 또는 Windows Server 2003에 포함된 vgx.dll보다 주요한 버전입니다. Internet Explorer 7이 설치되면 이 보안 업데이트에서 제공하여 Internet Explorer 6에서 업데이트된 vgx.dll이 교체됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1266 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1266)을 참조하십시오.

#### VML 메모리 손상 취약점(CVE-2011-1266)에 대한 완화 요소
...
#### VML 메모리 손상 취약점(CVE-2011-1266)에 대한 대안
...
#### VML 메모리 손상 취약점(CVE-2011-1266)에 대한 FAQ
...
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2544521$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 7:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\ie7updates\KB2544521-IE7\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 8:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\ie8updates\KB2544521-IE8\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2544521">Microsoft 기술 자료 문서 2544521</a> 참조</td>
</tr>
<tr class="even">
...
-   VML 메모리 손상 취약점(CVE-2011-1266)을 [TippingPoint (영문)](https://www.tippingpoint.com/)[Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
...
-   V1.0(2010년 6월 14일): 공지가 게시되었습니다.  
-   V1.1(2011년 7월 13일): 검색 로직에 대한 변경 사항을 알리고 일부 영향을 받는 구성에 대한 공지 교체 정보가 수정되었습니다. 보안 업데이트 파일에 대한 변경 사항은 없습니다. 자세한 내용은 업데이트 FAQ를 참조하십시오.
