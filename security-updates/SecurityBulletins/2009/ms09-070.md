...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 971726](https://support.microsoft.com/kb/971726)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 971726](https://support.microsoft.com/kb/971726)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
Windows Server 2003 R2에 대한 자세한 내용은 [Windows Server 2003 R2 (영문)](https://www.microsoft.com/windowsserver2003/default.mspx) 사이트를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2508 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2508)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2509 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2509)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971726">Microsoft 기술 자료 문서 971726</a> 참조</td>
</tr>
<tr class="even">
