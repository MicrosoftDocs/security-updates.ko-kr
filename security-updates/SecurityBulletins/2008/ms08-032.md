---
TOCTitle: 'MS08-032'
Title: 'Microsoft 보안 공지 MS08-032 - 보통'
ms:assetid: 'ms08-032'
ms:contentKeyID: 61230140
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-032(v=Security.10)'
---
...
이 보안 업데이트는 Microsoft 음성 API에 대해 공개적으로 보고된 취약점을 해결합니다. Windows에서 음성 인식 기능을 사용하도록 설정한 상태에서 사용자가 Internet Explorer를 사용하여 특수하게 조작된 웹 페이지를 보면 취약점을 통해 원격 코드 실행이 허용될 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다. 이 업데이트에는 BackWeb에서 제작한 소프트웨어에 대한 킬(Kill) 비트도 포함되어 있습니다.

이 업데이트의 심각도는 Microsoft Windows 2000 서비스 팩 4, Windows XP의 모든 지원되는 에디션, Windows Vista 원래 버전의 모든 에디션에 대해 보통입니다. 그러나 킬(Kill) 비트 배포에는 Windows Vista 서비스 팩 1도 포함됩니다.

기타 지원되는 모든 Windows 버전에 대해 이 보안 업데이트는 낮음입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=cedfd988-232c-4cba-ac65-beb54b8946e0&displaylang=ko)                                                     | 원격 코드 실행 | 보통        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26&displaylang=ko)                                                                 | 원격 코드 실행 | 보통        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26&displaylang=ko)                                                                 | 원격 코드 실행 | 보통        | 없음                                                                |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=62874096-7d17-4116-9795-4756e2fb6dae&displaylang=ko) | 원격 코드 실행 | 보통        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=dadead99-09cb-4f2b-850d-e98a627cb9f8&displaylang=ko)                     | 원격 코드 실행 | 낮음        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=84f9b533-b0cb-46d1-b4a8-5c9469abbd22&displaylang=ko)         | 원격 코드 실행 | 낮음        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ac35ce19-d761-4529-9f55-1e1b5b2447ad)      | 원격 코드 실행 | 낮음        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=4af6575e-b061-45a6-b3d8-ecb32d76b2d3&displaylang=ko)                                             | 원격 코드 실행 | 보통        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=67576acb-9cb6-4c76-9a72-dc5e5556b658&displaylang=ko)                     | 원격 코드 실행 | 보통        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8a507fba-8c93-4952-91e4-98e9e7affbd2&displaylang=ko)&#42;                                                 | 원격 코드 실행 | 낮음        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1a11499d-a008-407f-9084-a5189fa27015&displaylang=ko)&#42;                                               | 원격 코드 실행 | 낮음        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=59b1689c-e723-4d87-973e-4beac107a6f7)                                                            | 원격 코드 실행 | 낮음        | [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023) |

<strong>&#42;Windows Server 2008 Server Core 설치는 영향을 받지 않지만 이 업데이트는 계속 제공됩니다.</strong> Server Core 설치 옵션을 사용하여 Windows Server 2008이 설치된 경우, 비록 이 취약점의 영향을 받는 파일이 시스템에 존재해도 이 업데이트에서 해결하는 취약점은 지원되는 Windows Server 2008 에디션에 영향을 주지 않습니다. 그러나 현재 시스템에 있는 파일보다 업데이트 파일이 최신이므로(버전 번호가 높음) 영향을 받는 파일을 가진 사용자에게 이 업데이트가 제공됩니다. 이 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오.  
참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교(영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.

**영향을 받는 소프트웨어에 대한 참고 사항**  Microsoft는 이 업데이트가 킬(Kill) 비트를 설정하는 타사 컨트롤에 대해 심각도 등급을 지정하지 않습니다. 그러나 Microsoft 소프트웨어 취약점에 의한 영향을 받지 않는 플랫폼을 포함하여, 모든 플랫폼에 킬(Kill) 비트가 배포됩니다. 자세한 내용은 “타사 킬(Kill) 비트”를 참조하십시오.
...
예. Microsoft는 다른 조직에서 소유하고 취약점을 발견한 컨트롤에 대해 킬(Kill) 비트 설정 요청을 받았습니다.
...
운영 체제에 따라 취약점에 적용되는 완화 조치가 서로 다르므로, 이 업데이트의 심각도는 달라집니다. 그러한 완화 조치 중 하나로써, Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다.

**Windows Server 2008 Server Core 설치를 사용하는 사용자가 이 업데이트를 설치해야 합니까?**  
Windows Server 2008 Server Core 설치를 사용하는 사용자에게 이 업데이트가 제공되지만 설치할 필요는 없습니다. Server Core 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오.  
참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교(영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >음성 API 취약점 - CVE-2007-0675</th>
...
음성 API 취약점 - CVE-2007-0675  
-------------------------------
  

음성 구성 요소인 SAPI에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 취약점 악용을 시도할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 사용자가 Windows에서 음성 인식 기능을 사용하도록 설정했어야 합니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 컨트롤은 Internet Explorer에서 인스턴스화하지 않도록 설계되었습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-0675 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0675)를 참조하십시오.
  
#### 음성 API 취약점(CVE-2007-0675)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   기본적으로 Windows Vista에서는 음성 인식 기능이 사용하도록 설정되어 있지 않습니다.  
...
#### 음성 API 취약점(CVE-2007-0675)에 대한 대안
...
-   **Internet Explorer에서 COM 개체가 실행되지 않도록 설정**
    ...
    **참고** ActiveX 개체가 포함된 클래스 식별자 및 해당 파일은 "음성 API 취약점(CVE-2007-0675)에 대한 FAQ" 섹션의 "업데이트는 어떤 기능을 수행합니까?"에 나와 있습니다.아래 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}를 해당 섹션에 나와 있는 클래스 식별자로 바꾸십시오.
...
#### 음성 API 취약점(CVE-2007-0675)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것은 원격 코드 실행 취약점입니다. 사용자가 Windows에서 음성 인식 기능을 사용하도록 설정했어야 합니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
...
**취약점의 원인은 무엇입니까?**  
음성 인식 기능이 활성화 및 구성되어 있는 경우 Internet Explorer에서 오디오 파일을 재생함으로써 명령을 실행하여 공격자가 임의 코드를 실행할 수 있습니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
관리자 자격 증명으로 UAC 프롬프트에 응답하지 않으면, 음성 명령을 사용하여 시스템에서 사용자 생성과 같이 사용 권한이 필요한 기능을 수행할 수 없습니다. 기본적으로 UAC 프롬프트는 음성 명령으로 조작할 수 없습니다. 또한 스피커나 마이크의 배치, 마이크의 응답성, 받아쓰기의 선명도와 같이 공격을 어렵게 만드는 추가적인 장벽이 있습니다.
...
**이 업데이트에 Windows** **Vista** **서비스 팩 1이 포함되지 않는 이유는 무엇입니까?**  
이 업데이트는 Windows Vista 서비스 팩 1에 킬(Kill) 비트를 설정하지 않습니다. CVE-2007-0675에서 설명한 취약점이 이미 서비스 팩 업데이트를 통해 해결되었기 때문입니다.
  
**SAPI란 무엇입니까?**  
SAPI는 Microsoft 음성 응용 프로그래밍 인터페이스(Speech Application Programming Interface)를 지칭하며, 개발자가 응용 프로그램에 음성 인식 및 음성 텍스트 변환 기능을 추가할 때 사용됩니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 CVE-2007-0675가 지정되었습니다. 규모가 더 큰 보안 커뮤니티에서는 "Vista Speech Recognition"이라는 이름도 지정되었습니다.
...
-   BackWeb은 취약점을 해결하기 위한 [보안 공지 (영문)](https://backweb.com/news_events/press_releases/051608.php) 및 업데이트를 발표했습니다. 자세한 정보 및 다운로드 위치는 [BackWeb (영문)](https://backweb.com/news_events/press_releases/051608.php)의 보안 공지를 참조하십시오. 이 킬(Kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 컨트롤과 관련하여 지원이 필요한 고객은 [BackWeb (영문)](https://backweb.com/news_events/press_releases/051608.php)에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
...
Windows2000-KB950760-x86-KOR /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-KB950760-x86-KOR /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB950760$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
...
Windowsxp-kb950760-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB950760-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb950760-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB950760-x64-kor / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">지원되는 모든 Windows XP 및 Windows XP Professional 에디션:<br />
KB950760.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">추가 정보</td>
...
Windowsserver2003-kb950760-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2:<br />
Windowsserver2003-kb950760-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2:<br />
...
-   V1.1(2009년 4월 2일): 영향을 받는 소프트웨어 및 심각도 표 아래의 각주에 Windows Server 2008 Server Core 설치는 이 공지에서 설명한 취약점의 영향을 받지 않지만 이 업데이트는 계속 제공된다는 설명이 추가되었습니다. 해당 설치에는 이 업데이트를 설치할 필요가 없음을 다시 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목이 추가되었습니다.
