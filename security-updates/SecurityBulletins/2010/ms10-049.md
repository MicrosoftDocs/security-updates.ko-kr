---
TOCTitle: 'MS10-049'
Title: 'Microsoft 보안 공지 MS10-049 - 긴급'
ms:assetid: 'ms10-049'
ms:contentKeyID: 61230310
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-049(v=Security.10)'
---



Microsoft 보안 공지 MS10-049 - 긴급
===================================

SChannel의 취약점으로 인한 원격 코드 실행 문제점(980436)
--------------------------------------------------------

게시된 날짜: 2010년 8월 11일 수요일 | 업데이트된 날짜: 2010년 9월 1일 수요일
...
이 보안 업데이트는 Windows의 Secure Channel(SChannel) 보안 패키지의 공개된 취약점 1건과 비공개적으로 보고된 취약점 1건을 해결합니다. 가장 위험한 취약점으로 인해 사용자가 인터넷 웹 브라우저를 통해 이 취약점을 악용하도록 설계된 특수하게 조작된 웹 사이트를 방문할 경우 원격 코드 실행이 허용될 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션에 대해서는 긴급이며, 지원 대상인 모든 Windows Vista, Windows Server2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해서는 중요입니다. 자세한 내용은 이 섹션의 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 RFC 5746를 구현하거나 서버에서 반환한 SSL 응답에 대해 추가적인 유효성 확인을 수행하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 977377](https://technet.microsoft.com/security/advisory/977377)에서 처음 설명한 취약점도 해결합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=ff00381c-e74b-48e5-9dd9-34dbedd906a2&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=eaffa70c-6f2b-4e66-b1bc-64bdbbbcd34f)                                                               | 원격 코드 실행 | 긴급        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f76d68df-97e5-489c-a5f6-0c378c1f62ae&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4543bcf0-3505-407b-a5a9-6250ece6fbac&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9ef992c3-96e9-4533-b844-07424a6054b3)                                                           | 원격 코드 실행 | 긴급        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=aca69406-f795-4398-968f-959fe3a74e89)                                                                                     | 스푸핑         | 중요        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=aca69406-f795-4398-968f-959fe3a74e89&displaylang=ko)                                         | 스푸핑         | 중요        | 없음                                                                |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e2835ed1-5ca6-4347-8ff1-e694b1ac49ff&displaylang=ko)                 | 스푸핑         | 중요        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e2835ed1-5ca6-4347-8ff1-e694b1ac49ff)                                                                         | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e0253d4-f0c0-4f28-ba08-6907c2fcb339&displaylang=ko)\*     | 스푸핑         | 중요        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e0253d4-f0c0-4f28-ba08-6907c2fcb339)\*                                                            | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a96891ff-8771-47b3-81bb-8640adb6c098&displaylang=ko)\* | 스푸핑         | 중요        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a96891ff-8771-47b3-81bb-8640adb6c098)\*                                                          | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b16a422-0ee9-4eab-9cfe-e7688ffa0d76)          | 스푸핑         | 중요        | [MS09-007](https://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b16a422-0ee9-4eab-9cfe-e7688ffa0d76)                                                        | 스푸핑         | 중요        | 없음                                                                |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=71716507-7080-4102-991e-6afc7cc377d5&displaylang=ko)                                                                     | 스푸핑         | 중요        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c457d8ec-83b7-446f-b77c-e47d4187e616&displaylang=ko)                                                                   | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c9aeea25-ca14-4b42-9018-a27c9d8899c4)\*                                                                   | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b7c2e91f-ca8a-4237-99c8-ca53c91cf73e)                                                                 | 스푸핑         | 중요        | 없음                                                                |
...
<th style="border:1px solid black;" >TLS/SSL 재협상 취약점(CVE-2009-3555)</th>
<th style="border:1px solid black;" >SChannel 조작된 형식의 인증서 요청 원격 코드 실행 취약점(CVE-2010-2566)</th>
...
Microsoft Windows SChannel 인증 구성 요소에 구현된 TLS/SSL 프로토콜에 스푸핑 취약점이 존재합니다. 이 취약점을 악용한 공격자는 TLS/SSL 보호된 연결에 정보를 적용할 수 있으며, 이를 통해 트래픽을 효과적으로 보내 인증된 클라이언트에 스푸핑을 시도할 수 있습니다. 이 보안은 [Microsoft 보안 권고 977377](https://technet.microsoft.com/security/advisory/977377)에서 이미 설명한 취약점을 해결합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3555 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3555)를 참조하십시오.
  
#### TLS/SSL 재협상 취약점(CVE-2009-3555)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   SSL을 통한 콘텐츠는 호스팅하지 않지만 HTTP(일반 텍스트) 연결을 통한 서버 콘텐츠는 호스팅하는 웹 사이트는 영향을 받지 않습니다.  
-   IIS(인터넷 정보 서비스) 6 및 IIS 7은 클라이언트에서 시작되는 재협상을 허용하지 않습니다. 이 경우 공격 영역이 상당히 감소됩니다. 사용자가 사용자 이름 및 암호를 입력하는 SSL 사이트는 취약하지 않습니다. IIS 6 및 IIS 7에서 스푸핑을 허용하는 가장 가능성이 높은 시나리오는 상호 인증 수행을 위해 클라이언트쪽 인증서를 사용하는 경우입니다. 이는 일반적인 시나리오가 아닙니다.  
-   이러한 고객은 공격자가 로컬 서브넷 공격 또는 DNS 스푸핑과 같은 다른 취약점을 악용하여 MITM(Man-in-the-Middle) 공격을 수행할 수 있는 경우에만 영향을 받습니다.
  
#### TLS/SSL 재협상 취약점(CVE-2009-3555)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **IIS 6 이상에서 SSLAlwaysNegoClientCert 사용**
  
    IIS 6 이상을 실행하는 웹 서버는 클라이언트 인증서를 요청하는 상호 인증의 요구로 인해 영향을 받으며, SSLAlwaysNegoClientCert 설정을 사용하여 보안을 강화할 수 있습니다. 따라서 처음 연결하면 IIS에 클라이언트 인증을 요구하는 대화 상자가 표시되고, 서버에서 시작하는 재협상은 요구하지 않습니다.
  
    **대안의 영향:** 이 플래그를 설정하면 SSL 보호 웹 사이트에서 모든 요소를 로드하기 전에 클라이언트에서 인증을 해야 합니다. 이로 인해 브라우저에는 SSL 보호 웹 사이트에 연결 시 클라이언트 인증을 묻는 대화 상자가 항상 표시됩니다. SSL 보호 콘텐츠에 상호 인증이 필요하지 *않은* 경우, 인증서를 선택하라는 메시지가 표시된 사용자는 인증할 클라이언트 인증서를 선택하지 않고 대화 상자를 닫아 SSL 연결을 통해 콘텐츠를 볼 수 있습니다.
  
    **IIS 6:**
  
    향상된 권한의 관리자 명령 프롬프트의 "c:\\inetpub\\adminscripts" 폴더에서 다음 명령을 실행합니다.
  
    `adsutil.vbs SET w3svc/<N>/SSLAlwaysNegoClientCert true`
  
    여기에서 &lt;N&gt;은 구성할 웹 사이트의 번호를 나타냅니다(즉 '기본 웹 사이트'가 1이면 다음 웹 사이트는 2가 됨). 예를 들어 IIS에서 만든 '기본 웹 사이트'를 보호하기 위해 다음 명령을 사용할 수 있습니다.
  
    `adsutil.vbs SET w3svc/1/SSLAlwaysNegoClientCert true`
  
    **IIS 7:**
  
    "Enable\_SSL\_Renegotiate\_Workaround.js"라는 파일에 다음 텍스트를 저장합니다.
  
    `var vdirObj=GetObject("IIS://localhost/W3svc/1");// 이 행의 1을 구성할 웹 사이트의 번호로 교체WScript.Echo("Value of SSLAlwaysNegoClientCert Before: " + vdirObj.SSLAlwaysNegoClientCert);vdirObj.Put("SSLAlwaysNegoClientCert", true);vdirObj.SetInfo();WScript.Echo("Value of SSLAlwaysNegoClientCert After: " + vdirObj.SSLAlwaysNegoClientCert);`
  
    향상된 권한의 관리자 명령 프롬프트에서 다음 명령을 실행합니다.
  
    `cscript.exe enable_ssl_renegotiate_workaround.js`
  
#### TLS/SSL 재협상 취약점(CVE-2009-3555)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 스푸핑 취약점입니다. 이 취약점을 악용한 공격자는 TLS/SSL 보호된 연결에 정보를 적용할 수 있으며, 이를 통해 트래픽을 효과적으로 보내 인증된 클라이언트에 스푸핑을 시도할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
TLS 프로토콜(RFC 2246의 설명 참조)은 재협상의 기능을 설명하며, 이를 통해 각 피어는 한 시점에서 보호된 연결의 매개 변수를 다시 협상할 수 있습니다. 이러한 연결에서 MITM(Man-in-the-Middle) 공격을 위해 DNS 스푸핑 또는 로컬 서브넷 공격과 같은 다른 공격을 이용할 수 있는 공격자는, 설정되어 있는 유효한 TLS 세션에 응용 프로그램 특정 명령을 추가하기 위해 이와 같은 재협상 기능을 악용할 수 있습니다.
  
특정 시나리오의 경우, 서버는 TLS/SSL 인증 클라이언트 컨텍스트에서 해당 명령을 실행할 수 있습니다. Windows에서 TLS 및 SSL은 Secure Channel(SChannel) 보안 패키지를 통해 구현됩니다.
  
**IIS 6.0 이상의 기본 설치가 이 취약점의 영향을 받지 않는 이유는 무엇입니까?**    
이 취약점은 각 연결 피어가 TLS/SSL 매개 변수를 다시 협상할 수 있도록 허용된 경우에만 악용될 수 있습니다. IIS는 클라이언트에서 시작되는 TLS/SSL 재협상을 방지합니다. 또한 IIS는 인증서 기반의 상호 인증(기본이 아닌 설정) 사용하도록 구성된 경우 서버쪽 재협상 시도만 시작하게 됩니다.
  
실제 TLS/SSL 연결이 IIS 서버에서 바로 종료되지 않고 타사 SSL 종결자 또는 리버스 프록시에서 종료되는 배포 환경에서 해당 연결은 여전히 이 취약점의 영향을 받게 될 수 있습니다.
  
**MITM(Man-in-the-Middle) 공격이란 무엇입니까?**    
MITM(Man-in-the-Middle) 공격은 두 통신 사용자가 알지 못하게 공격자가 공격자의 컴퓨터를 통해 두 사용자 사이의 통신을 다시 라우팅할 때 발생합니다. 이러한 통신에서 각 사용자는 의도한 상대방과만 통신 중이라고 생각하면서 자신도 모르게 공격자와 트래픽을 주고 받게 됩니다. 이 취약점의 경우 MITM(Man-in-the-Middle) 공격자는 클라이언트와 서버 사이에서 암호화된 통신을 읽거나, 해독하거나 변경할 수 없습니다. MITM(Man-in-the-Middle) 공격자는 클라이언트 컨텍스트에서 실행되는 TLS 세션에 요청을 만들 수 있습니다.
  
**상호 인증이란 무엇입니까?**    
상호 인증이란 모든 응용 프로그램 트래픽이 클라이언트와 서버 간 연결을 통해 전송되기 전에, 클라이언트 프로세스를 통해 서버에게 자신의 ID를 입증하고 서버는 클라이언트에게 자신의 ID를 입증하는 보안 기능입니다.
  
상호 인증을 사용하려면 모든 응용 프로그램 기능을 실행하기 전에 클라이언트 및 서버는 각자의 ID를 서로 입증해야 합니다. ID는 공개 키 인프라 및 디지털 인증과 마찬가지로 암호를 통해 입증할 수 있습니다.
...
**SSL이란 무엇입니까?**    
SSL이란 TLS(Transport Layer Security) 프로토콜의 선행 작업으로, TLS와 동일한 기능을 수행하며 공개 및 비밀 키 기술의 조합을 사용하는 보안 네트워크 통신을 지원합니다.
  
자세한 내용은 TechNet 문서 [How TLS/SSL works(TLS/SSL 작동 방식) (영문)](https://technet.microsoft.com/en-us/library/cc783349(ws.10).aspx)를 참조하십시오.
  
**TLS/SSL 재협상이란 무엇입니까?**    
재협상이란 TLS 및 SSL 프로토콜 기능으로, 이를 통해 각 피어는 보안 키 등 암호 연결용 매개 변수를 다시 협상할 수 있습니다.
...
취약한 배포 환경에서 공격자는 이 취약점을 이용하여 유효한 TLS/SSL 인증 세션의 컨텍스트에서 클라이언트에서 서버로 전송되는 합법적인 요청에 내용을 추가할 수 있습니다. 이 취약점을 사용하여 공격자가 클라이언트와 서버 사이에서 암호화된 트래픽을 읽거나, 해독하거나 변경할 수는 없습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 클라이언트와 서버 간에 MITM(Man-in-the-Middle) 공격을 설정하여 이 취약점을 악용할 수 있으며, 이에 따라 SSL 재협상 시도가 발생하는 즉시 연결이 중단될 수 있습니다. 이 시점에서 공격자는 보호된 경로에 제한된 데이터 집합을 적용할 수 있으며, 이 때 서버는 이를 신뢰할 수 있는 클라이언트에서 발생하는 것으로 해석할 수 있습니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**    
이 취약점은 주로 웹 브라우저 및 해당 웹 서버에 대해 사용되는 클라이언트에 영향을 미치지만, 이 공격의 일부는 기타 TLS/SSL 보호 프로토콜에 영향을 미칠 수 있습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 RFC 5746을 구현하여 이 취약성을 해결합니다. 이 RFC는 TLS 재협상을 재협상이 수행된 원본 TLS 연결에 암호화로 연결한 TLS 확장을 소개합니다. 이를 통해 인증을 수행한 후 검증하여 공격을 방지할 수 있습니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3555 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3555)가 지정되었습니다.
...
클라이언트 컴퓨터의 SChannel이 서버에서 보낸 인증서 요청 메시지를 검증하는 방식에 원격 코드 실행 취약점이 존재합니다. 공격자는 인터넷 웹 브라우저를 통해 이 취약점을 악용하도록 설계된 특수하게 조작된 웹 사이트를 호스팅한 다음 사용자가 이 웹 사이트를 보도록 유도할 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2566 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2566)을 참조하십시오.
  
#### SChannel 조작된 형식의 인증서 요청 원격 코드 실행 취약점(CVE-2010-2566)에 대한 완화 요소
  
이 취약점에 대해 확인된 완화 요소가 없습니다.
  
#### SChannel 조작된 형식의 인증서 요청 원격 코드 실행 취약점(CVE-2010-2566)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### SChannel 조작된 형식의 인증서 요청 원격 코드 실행 취약점(CVE-2010-2566)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 이 취약점을 악용하면 원격 코드 실행보다는 서비스 거부 조건이 발생할 가능성이 큽니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 SChannel에서 서버가 보낸 인증서 요청 메시지에 대한 유효성 검사를 충분히 수행하지 못해 발생합니다.
...
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점을 악용한 공격자는 이론적으로는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 그러나 이 취약점을 악용하려는 시도의 대부분은 서비스 거부를 유발합니다. 시스템을 다시 시작하기 전까지는 시스템에서 SSL 또는 TLS를 사용하는 웹 사이트나 리소스에 연결할 수 없습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 인터넷 웹 브라우저를 통해 이 취약점을 악용하도록 설계된 특수하게 조작된 웹 사이트를 호스팅한 다음 사용자가 이 웹 사이트를 보도록 유도할 수 있습니다. 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 할 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 요청의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 서버에서 반환한 SSL 응답에 대한 추가 유효성 검사를 수행합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB980436$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980436">Microsoft 기술 자료 문서 980436</a> 참조</td>
</tr>
<tr class="even">
...
-   TLS/SSL 재협상 취약점(CVE-2009-3555)을 보고해 주신 [PhoneFactor (영문)](https://www.phonefactor.com)의 Marsh Ray 및 Steve Dispensa
...
-   V1.1(2010년 9월 2일): 이 업데이트에 대한 공지 교체 정보가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 검색 로직이나 업데이트 파일에 대한 변경 사항은 없습니다.
