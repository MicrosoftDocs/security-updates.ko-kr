---
TOCTitle: 'MS11-MAY'
Title: 2011 년 5 월 Microsoft 보안 공지 요약
ms:assetid: 'ms11-may'
ms:contentKeyID: 61230740
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-may(v=Security.10)'
---


2011 년 5 월 Microsoft 보안 공지 요약
=====================================

게시된 날짜: 2011년 5월 11일 수요일 | 업데이트된 날짜: 2011년 6월 15일 수요일

**버전:** 1.2

이 공지 요약 목록에는 2011년 5월 발표된 보안 공지가 포함되어 있습니다.

2011년 5월 보안 공지 발표와 함께 이 공지 요약이 2011년 5월 5일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](https://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](https://go.microsoft.com/fwlink/?linkid=21163)을 참조하십시오.

Microsoft는 2011년 5월 11일 수요일 오전 11:00(태평양 표준시, 미국 및 캐나다)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [5월 보안 공지 웹캐스트에 지금 등록하십시오](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?culture=en-us&eventid=1032455071&eventcategory=4). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약](https://technet.microsoft.com/security/bulletin/summary) 및 웹캐스트를 참조하십시오.
...
<td style="border:1px solid black;"><strong>WINS의 취약점으로 인한 원격 코드 실행 문제점(2524426)</strong> <br />
<br />
이 보안 업데이트는 비공개적으로 보고된 WINS(Windows Internet Name Service)의 취약점 1건을 해결합니다. 이러한 취약점은 사용자가 WINS 서비스가 실행되는 영향 받은 시스템에서 특수하게 조작된 WINS 복제 패킷을 수신할 경우에 원격 코드가 실행되도록 합니다. 기본적으로 WINS는 영향을 받는 운영 체제에 설치되지 않으며, 이 구성 요소를 수동으로 설치한 고객만 이 문제의 영향을 받습니다.</td>
...
<td style="border:1px solid black;"><strong>Microsoft Office의 취약점으로 인한 원격 코드 실행 문제점(2545814)</strong> <br />
<br />
이 보안 업데이트는 Microsoft PowerPoint에서 발견되어 비공개적으로 보고된 2건의 취약점을 해결합니다. 이러한 취약점으로 인해 사용자가 특수하게 조작된 PowerPoint 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 이러한 취약점 중 하나를 성공적으로 악용한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다. 의심되는 파일을 열지 못하도록 Office 파일 유효성 검사(OFV)를 설치하고 구성하면 CVE-2011-1269 및 CVE-2011-1270에 설명된 취약점을 악용하는 공격 경로가 차단됩니다.</td>
...
|---------------------------------------------------------------------|-------------------------------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|------------------------------|-----------|  
| [MS11-036](https://technet.microsoft.com/security/bulletin/ms11-036) | 프레젠테이션 메모리 손상 RCE 취약점 | [CVE-2011-1269 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269) | 영향 받지 않음                                                                       | [1](https://technet.microsoft.com/security/cc998259.aspx) - 일관적인 악용 코드 가능   | 해당 사항 없음               | (없음)    |  
| [MS11-035](https://technet.microsoft.com/security/bulletin/ms11-035) | WINS 서비스 응답 실패 취약점        | [CVE-2011-1248 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1248) | [2](https://technet.microsoft.com/security/cc998259.aspx) – 비일관적인 악용 코드 가능 | [2](https://technet.microsoft.com/security/cc998259.aspx) – 비일관적인 악용 코드 가능 | 임시                         | (없음)    |  
| [MS11-036](https://technet.microsoft.com/security/bulletin/ms11-036) | 프레젠테이션 버퍼 오버런 RCE 취약점 | [CVE-2011-1270 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270) | 영향 받지 않음                                                                       | [3](https://technet.microsoft.com/security/cc998259.aspx) – 악용 코드 기능 불가능     | 해당 사항 없음               | (없음)    |
...
<td style="border:1px solid black;">
[Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0d289146-8470-45dd-a886-d1b35a2c6d4b&displaylang=ko)  
(긴급)
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0d3e85a9-42ff-447b-ab8c-095a1c0b224c&displaylang=ko)  
(긴급)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4c388fe8-883a-4118-a7ff-50f1e9d0a071)  
(긴급)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9019a3ff-d953-4b0b-8c7a-05aa9cf65c92&displaylang=ko)\*  
(긴급)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=841130fa-4522-4079-b7eb-f8466ac3ef12&displaylang=ko)\*  
(긴급)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=8732b41e-2f25-4ee1-a8b7-a8b8b9e22d08&displaylang=ko)\*  
(긴급)
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2002 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=2e8a30ac-bcfe-4535-8ceb-723c25b43d5f&displaylang=ko)  
(KB2535802)  
(중요)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=fc1cfcac-64cc-484a-97f2-3dcfe84cfdcd&displaylang=ko)  
(KB2535812)  
(중요)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9a181739-709a-4c0d-a97f-f9891c45c04c&displaylang=ko)  
(KB2535818)  
(중요)
</td>
</tr>
...
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=5be09069-1cac-4b1e-ac94-4fb7024fb4ac&displaylang=ko)  
(KB2540162)  
(중요)
</td>
</tr>
...
<sup>[1]</sup>Microsoft Office 2004 for Mac(KB2555786), Microsoft Office 2008 for Mac(KB2555785) 및 Open XML File Format Converter for Mac(KB2555787)에 대한 보안 업데이트는 2011년 6월 14일부터 사용할 수 있습니다. 자세한 내용은 보안 공지를 참조하십시오.
...
-   MS11-035에서 설명한 문제점을 [TippingPoint's (영문)](https://www.tippingpoint.com/) [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Luigi Auriemma
-   MS11-036에서 설명한 두 가지 문제점을 해결하기 위해 협력해 주신 [CERT/CC (영문)](https://www.cert.org/)의 Will Dormann
...
-   V1.0(2011년 5월 11일): 공지 요약이 게시되었습니다.
-   V1.1(2011년 5월 18일): MS11-036에서 Microsoft PowerPoint 2007 서비스 팩 2에 대한 보안 업데이트 KB2535818 및 KB2540162와 관련하여 영향을 받는 소프트웨어 표에서 잘못된 항목이 제거되었습니다.
-   V1.2(2011년 6월 14일): MS11-036에서 Microsoft Office 2004 for Mac(KB2555786), Microsoft Office 2008 for Mac(KB2555785) 및 Open XML File Format Converter for Mac(KB2555787)에 대한 보안 업데이트가 제공됨을 알리기 위해 이 공지 요약을 개정하였습니다. 자세한 내용은 MS11-036을 참조하십시오.
