---
TOCTitle: 'MS10-046'
Title: 'Microsoft 보안 공지 MS10-046 - 긴급'
ms:assetid: 'ms10-046'
ms:contentKeyID: 61230307
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-046(v=Security.10)'
---



Microsoft 보안 공지 MS10-046 - 긴급
===================================

Windows 셸의 취약점으로 인한 원격 코드 실행 문제점(2286198)
-----------------------------------------------------------

게시된 날짜: 2010년 8월 3일 화요일 | 업데이트된 날짜: 2010년 8월 25일 수요일
...
이 보안 업데이트는 Windows 셸의 공개된 취약점을 해결합니다. 특수하게 조작된 바로 가기 아이콘이 표시되는 경우 이 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션에 대해 긴급입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 바로 가기 아이콘 참조에 대한 유효성 검사를 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 2286198](https://technet.microsoft.com/security/advisory/2286198)에서 처음 설명한 취약점을 해결합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=12361875-b453-45e8-852b-90f2727894fd&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b44bd67-48e2-497f-9165-42a702e2cc0d)                                                               | 원격 코드 실행 | 긴급        | [MS07-061](https://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=32fe91ef-5a8d-4095-90ee-2ca216696b09&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS07-061](https://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=923de214-c4fa-41e6-8307-2c5a37f13e8e&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | [MS07-061](https://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=63aa5f8a-fe47-4892-b905-b54e4f3b6580)                                                           | 원격 코드 실행 | 긴급        | [MS07-061](https://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=52748886-6280-4247-8cbd-f64db229ee66&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=37648e95-05c2-4802-9a0f-660200baa229&displaylang=ko)                 | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3aabd189-7d4c-4c9f-8854-f33127b1c309&displaylang=ko)\*     | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=29c6fc2d-d318-4a63-9ab2-82e84272aaf2&displaylang=ko)\* | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cfe227b5-6660-49f8-9d71-a997dd83de0b)          | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=22e62b5c-e4c1-47d0-ae4a-8bd2d70d0a0a&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9499f771-c388-4de3-a5c7-8cc8b00b4395&displaylang=ko)                                                                   | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0d9dd09b-db40-462b-88b0-4dbb8180e81f&displaylang=ko)\*                                                    | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ce2bb5d4-f661-44e3-ac28-0b81f7b72670)                                                                 | 원격 코드 실행 | 긴급        | 없음                                                                |
...
**2010년 8월 24일에 본 보안 공지가 수정된 이유는 무엇입니까?**  
Microsoft는 감지 기능의 변경을 알리기 위해 본 보안 공지를 수정했습니다. 감지 기능이 변경됨에 따라 Windows XP Professional x64 Edition 서비스 팩 2 및 지원 가능한 모든 Windows Server 2003 버전에 대해 MS07-061 업데이트가 MS10-046 업데이트로 교체됩니다. 이번 변경은 감지 기능에만 해당됩니다. 이 공지에서 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 이 업데이트를 설치한 고객은 다시 설치할 필요가 없습니다.

**Server Core 설치 옵션으로 프로그램을 설치했을 때 본 취약점이 Windows Server 2008이나 Windows Server 2008 R2에 영향을 주는 이유는 무엇입니까?**  
타사 응용 프로그램을 비롯한 일부 응용 프로그램은 Server Core 설치를 통해 실행되며 동적 아이콘을 로드하는 특정 API(응용 프로그래밍 인터페이스) 호출을 계속 사용합니다. 이러한 시나리오가 기본적인 것은 아니며 Server Core 설치에도 별다른 영향을 주지 않습니다. 그러나 취약한 코드가 여전히 있기 때문에 이런 코드를 계속 사용할 수 밖에 없습니다. 이러한 이유로 인해 Server Core 설치 업데이트가 제공되었습니다.
...
<th style="border:1px solid black;" >바로 가기 아이콘 로드 취약점(CVE-2010-2568)</th>
...
바로 가기 아이콘 로드 취약점(CVE-2010-2568)  
-------------------------------------------
  

영향을 받는 Microsoft Windows 버전에 원격 코드 실행 취약점이 있습니다. 이 취약점은 바로 가기에 대한 Windows의 잘못된 구문 분석으로 인해 발생하며 운영 체제에 악성 바로 가기 파일의 아이콘이 표시될 때 악성 코드가 실행될 수 있습니다. 이 취약점을 악용에 성공한 공격자는 로그온한 사용자 자격으로 임의 코드를 실행할 수 있습니다. 이 업데이트는 [Microsoft 보안 권고 2286198](https://technet.microsoft.com/security/advisory/2286198)에서 이미 다룬 취약점을 해결합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2568 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)을 참조하십시오.
  
#### 바로 가기 아이콘 로드 취약점(CVE-2010-2568)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.  
-   USB 이동식 장치 공격 경로의 경우, 자동 실행 기능을 사용하지 않도록 설정되어 있으면 사용자는 수동으로 Windows 탐색기 또는 유사한 응용 프로그램을 실행하고 이동식 디스크의 영향을 받는 폴더를 찾아야 합니다.
  
#### 바로 가기 아이콘 로드 취약점(CVE-2010-2568)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **바로 가기 아이콘 표시 사용 안 함**
  
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2286198](https://support.microsoft.com/kb/2286198)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오. 이 Fix it 솔루션을 적용하기 위해서는 완료되는 대로 다시 시작해야 합니다. 이 Fix it 솔루션에서 배포하는 대안은 모든 사용자에게 영향을 미칩니다. 따라서 관리자는 이 Fix it 솔루션을 배포하기 전에 해당 KB 문서를 면밀히 검토하는 것이 좋습니다.
    ...
    **참고** 레지스트리 편집기를 잘못 사용하면 시스템 전체에 심각한 문제가 발생할 수 있으며 운영 체제를 다시 설치해야 할 수도 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결을 보증하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다. 레지스트리를 편집하는 방법에 대한 자세한 내용은 레지스트리 편집기(Regedit.exe)의 "키와 값 변경" 도움말 항목 또는 Regedt32.exe의 "레지스트리의 정보 추가와 삭제" 및 "레지스트리 정보 편집" 도움말 항목을 참조하십시오.
    ...
    5.  레지스트리 편집기의 오른쪽 창에서 값**(기본)**을 선택합니다. **Enter** 키를 눌러 값을 편집합니다. 값을 삭제하여 값이 비어지면 **Enter** 키를 누릅니다.  
    ...
    8.  **레지스트리 파일 내보내기** 대화 상자에 **PIF\_Icon\_Backup.reg**를 입력하고 **저장**을 클릭합니다.  
        **참고** 이렇게 하면 이 레지스트리 키의 백업이 기본적으로 '내 문서' 폴더에 만들어집니다.  
    9.  레지스트리 편집기의 오른쪽 창에서 값**(기본)**을 선택합니다. **Enter** 키를 눌러 값을 편집합니다. 값을 삭제하여 값이 비어지면 **Enter** 키를 누릅니다.  
    10. 모든 사용자를 로그오프 후 다시 로그인하거나 컴퓨터를 다시 시작합니다.
  
    **대안의 영향.** 바로 가기를 표시하는 아이콘을 사용하지 않으면 영향을 받는 시스템에서 문제가 악용되는 것을 방지할 수 있습니다. 이 대안이 구현되면, 시스템에서 대부분의 아이콘을 "흰색" 기본 개체 아이콘으로 표시하므로 사용 편의성이 저하될 수 있습니다. 시스템 관리자는 이 대안을 배포하기 전에 철저히 테스트하는 것이 좋습니다. 대안을 실행 취소하면 모든 아이콘이 다시 표시됩니다.
...
-   **인터넷에서 LNK 및 PIF 파일 다운로드 차단**
  
    인터넷 게이트웨이에서 LNK 및 PIF 파일 다운로드를 차단하면 이 공격의 원격 악용으로부터 보호할 수 있습니다. WebDAV를 통해서도 파일이 전송될 수 있으므로 모든 차단 솔루션은 해당 프로토콜도 고려해야 합니다.
  
-   **경계 방화벽에서 아웃바운드 SMB 연결 차단**  
    경계 방화벽에서 아웃바운드 SMB 연결을 차단하면 파일 공유를 사용하는 원격 악용의 위험이 감소됩니다.
  
#### 바로 가기 아이콘 로드 취약점(CVE-2010-2568)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
바로 가기 아이콘을 로드할 때 Windows 셸이 바로 가기의 특정 매개 변수를 올바르게 확인하지 못합니다.
...
**바로 가기란 무엇입니까?**    
바로 가기는 파일이나 프로그램에 대한 링크로서 아이콘으로 표시됩니다. 바로 가기를 두 번 클릭하면 파일이나 프로그램이 열립니다. 바로 가기는 폴더나 데스크톱과 같이 자주 사용하는 단일 파일이 있는 위치에 쉽게 액세스하기 위해 종종 사용되는 메커니즘입니다. 바로 가기는 LNK 확장명의 파일로 구현됩니다. 또한 바로 가기가 MS-DOS 프로그램과 관련된 경우 PIF 파일로 나타날 수도 있습니다.
  
**이 보안 업데이트는 이미 구현한 대안 또는 Microsoft Fix it 솔루션을 비활성화합니까?**    
아니요. 대안 및 Microsoft Fix it 솔루션은 보안 업데이트와 별도로 작동합니다. 대안을 적용한 사용자는 보안 업데이트를 구현한 후 해당 대안을 실행 취소해야 합니다.
...
공격자는 사용자에게 악성 바로 가기 파일 및 관련 악성 바이너리가 담긴 이동식 드라이브를 제시할 수 있습니다. 사용자가 Windows 탐색기에서 드라이브 또는 바로 가기 아이콘의 구문을 분석하는 다른 응용 프로그램을 열 때 악성 바이너리가 대상 시스템에서 공격자가 선택한 코드를 실행할 수 있습니다.
  
또한 공격자는 악성 웹 사이트 또는 원격 네트워크 공유를 설정하고 해당 원격 위치에 악성 구성 요소를 배치할 수도 있습니다. 사용자가 Internet Explorer와 같은 웹 브라우저나 Windows 탐색기와 같은 파일 관리자로 웹 사이트를 탐색할 때 Windows가 바로 가기 파일의 아이콘을 로드하면 악성 바이너리가 호출될 수 있습니다. 또한 공격자는 포함된 바로 가기를 지원하는 문서 또는 브라우저 컨트롤을 호스팅하는 문서(예: Microsoft Office 문서)에 취약점을 포함시킬 수도 있습니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**    
신뢰할 수 없는 네트워크 공유 또는 신뢰할 수 없는 웹 사이트를 검색하는 데 사용되는 데스크톱 시스템이 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 바로 가기 아이콘 참조를 올바르게 검사하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2568 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
보안 공지가 릴리스된 시점에서 이 취약점은 다양한 맬웨어 변종군에 의해 악용되고 있었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2286198$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2286198">Microsoft 기술 자료 문서 2286198</a> 참조</td>
</tr>
<tr class="even">
...
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 보고해 주신 [VirusBlokAda (영문)](https://www.anti-virus.by/)의 Sergey I. Ulasen 및 Uleg Kopreev  
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 보고해 주신 [AV-Test (영문)](https://www.av-test.org/)의 Andreas Marx 및 Maik Morgenstern  
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 해결하기 위해 협력해 주신 [CERT/CC (영문)](https://www.cert.org)의 Will Dormann  
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 해결하기 위해 협력해 주신 Niels Teusink  
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 해결하기 위해 협력해 주신 Stefan Kanthak
...
-   V1.0(2010년 8월 3일): 공지가 게시되었습니다.  
-   V1.1(2010년 8월 4일): 보안 업데이트와 관련 하여**자주 하는 질문 (FAQ)**에 Server Core 설치 옵션으로 프로그램을 설치했을 영향을 받는 이유에 대한 설명이 추가 되었습니다.  
-   V1.2(2010년 8월 25일): 검색 변경에 따라 **자주 하는 질문 (FAQ)**에 추가 되었습니다.검색 변경 사항에 해당됩니다. 본 보안 공지에서 다른 변경사항도 없습니다. 이미 성곡적으로 설치하신 고객이라면 다시 설치하실 필요는 없습니다.
