...
-   파일 형식 구문 분석 취약점(CVE-2008-4265)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Joshua J. Drake  
-   파일 형식 구문 분석 취약점(CVE-2008-4264)을 보고해 주신 [signedness.org (영문)](http://www.signedness.org/)의 Claes M Nyberg  
-   Excel 글로벌 배열 메모리 손상 취약점(CVE-2008-4266)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Dyon Balding
