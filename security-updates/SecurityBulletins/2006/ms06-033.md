...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 917283](https://support.microsoft.com/kb/917283)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 917283](https://support.microsoft.com/kb/917283)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------|
| .NET 2.0 응용 프로그램 폴더 정보 유출 취약점 - [CVE-2006-1300 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1300) | 정보 유출            | 중요               |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 917283](https://support.microsoft.com/kb/917283)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 917283](https://support.microsoft.com/kb/917283)을 참조하십시오.
...
-   [기술 자료 문서 815155](https://support.microsoft.com/kb/815155)의 ASP.NET 웹 응용 프로그램 강화 지침을 따른 URLScan 사용 고객은 이 취약점으로 인한 위험이 적습니다.
...
4.  각 ASP.NET 2.0 '응용 프로그램 폴더'에 대해 폴더를 마우스 오른쪽 단추로 클릭하고 '**속성**'을 선택합니다.
    ASP.NET 2.0 '응용 프로그램 폴더'의 전체 목록을 보려면 이 [웹 사이트 (영문)](https://msdn2.microsoft.com/en-us/library/ex526337.aspx)를 방문하십시오.
...
**ASP.NET란 무엇입니까?**  
[ASP.NET (영문)](https://www.asp.net/)는 .NET Framework 내에서 개발자가 웹 응용 프로그램 및 XML 웹 서비스를 구축하는 데 사용하는 기술 모음입니다.
...
-   NET 2.0 응용 프로그램 폴더 정보 유출 취약점 - [CVE-2006-1300 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1300)을 보고해 주신 [PRISMA Informatik (영문)](https://www.prismanet.ch)의 Urs Eichmann.
