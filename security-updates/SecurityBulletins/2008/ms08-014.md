...
이 보안 업데이트는 [Microsoft 보안 권고 947563](https://technet.microsoft.com/security/advisory/947563)에서 처음 설명한 취약점도 해결합니다.

**권장 사항.** 고객은 업데이트를 즉시 적용하는 것이 좋습니다.

**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 949029](https://support.microsoft.com/kb/949029)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f7f90c30-1bfd-406b-a77f-612443e30185&amp;displaylang=ko">Excel 2000 서비스 팩 3</a><br />
(KB946979)</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0111 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0111)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0112 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0112)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0114 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0114)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0115 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0115)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0116 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0116)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0117 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0117)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0081 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0081)을 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**     
예. 이 보안 공지가 처음 게시되었을 때 이 취약점은 공개되어 있었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE--2008-0081 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0081)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 947563](https://technet.microsoft.com/security/advisory/947563)에서 처음 설명되었습니다.
...
Microsoft Office 2008 for Mac 12.0.1 업데이트의 해당 언어 버전을 [Microsoft Mactopia 웹 사이트](https://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)에서 다운로드하여 설치하십시오.
...
-   매크로 유효성 검사 취약점(CVE-2008-0081)을 보고해 주신 [SAIC (영문)](https://www.saic.com/)의 Mike Scott  
-   매크로 유효성 검사 취약점(CVE-2008-0081)을 보고해 주신 [VeriSign (영문)](https://www.verisign.com/)의 Matt Richard  
-   Excel 데이터 유효성 검사 레코드 취약점(CVE-2008-0111)을 보고해 주신 [iDefense Labs (영문)](https://labs.idefense.com/)의 Greg MacManus  
-   Excel 파일 가져오기 취약점(CVE-2008-0112)을 보고해 주신 [JFE Systems (영문)](https://www.jfe-systems.com/)의 Yoshiya Sasaki  
-   Excel Style 레코드 취약점(CVE-2008-0114)을 보고해 주신 [Fortinet (영문)](https://www.fortinet.com/)의 Bing Liu  
-   Excel 수식 분석 취약점(CVE-2008-0115)을 보고해 주신 [iDefense Labs (영문)](https://labs.idefense.com/)  
-   Excel 서식 있는 텍스트 유효성 검사 취약점(CVE-2008-0116)을 보고해 주신 [TippingPoint DVLabs (영문)](https://dvlabs.tippingpoint.com)의 Cody Pierce  
-   Excel 조건부 서식 취약점(CVE-2008-0117)을 보고해 주신 [Websense Security Labs (영문)](https://www.websense.com/)의 Moti Joseph 및 Dan Hubbard
