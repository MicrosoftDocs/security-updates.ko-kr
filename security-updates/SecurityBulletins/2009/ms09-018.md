---
TOCTitle: 'MS09-018'
Title: 'Microsoft 보안 공지 MS09-018 - 긴급'
ms:assetid: 'ms09-018'
ms:contentKeyID: 61230204
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-018(v=Security.10)'
---


Microsoft 보안 공지 MS09-018 - 긴급
===================================
...
이 보안 업데이트의 심각도는 지원되는 모든 Microsoft Windows 2000 Server 에디션에 대해 긴급이며, 지원되는 Windows XP Professional 및 Windows Server 2003 버전에 대해 중요입니다. 자세한 내용은 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bba6e20a-0345-46ae-a6f1-fd27fdee7c21&amp;displaylang=ko">Active Directory</a><br />
(KB969805)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cb2c9b76-0c65-4754-9941-d45a7c74a29a&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB970437)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2ef3aaf0-a2a9-4c17-99ab-a0dc3d3f7e86">ADAM(Active Directory Application Mode)</a><br />
(KB970437)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d814ce65-a193-4027-a6cd-106d388830a6&amp;displaylang=ko">Active Directory</a><br />
(KB969805)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f6f99957-f74f-4446-8734-a468283eebae&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB970437)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0d1f23c8-06eb-4996-92eb-0eb635fd6a42&amp;displaylang=ko">Active Directory</a><br />
(KB969805)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a2badc7-c0a5-4032-a009-73ebe9d76313&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB970437)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
<th style="border:1px solid black;" >Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)</th>
<th style="border:1px solid black;" >Active Directory 메모리 누수 취약점(CVE-2009-1139)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional 서비스 팩 2 및 Windows XP Professional 서비스 팩 3에 설치된 ADAM(Active Directory Application Mode)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
서비스 거부</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2에 설치된 ADAM(Active Directory Application Mode)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
서비스 거부</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2에 설치된 ADAM(Active Directory Application Mode)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
서비스 거부</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 ADAM(Active Directory Application Mode)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
서비스 거부</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
...
Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)  
---------------------------------------------------------
  
Microsoft Windows 2000 Server에서의 Active Directory 구현에 원격 코드 실행 취약점이 있습니다. 이 취약점은 특수하게 조작된 LDAP 또는 LDAPS 요청을 처리할 때 메모리 해제가 정확하지 않아 발생합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1138 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1138)을 참조하십시오.
  
#### Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)에 대한 완화 요소
...
#### Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **방화벽에서 TCP 포트 389, 636, 3268 및 3269를 차단**
  
    방화벽에서 다음 항목을 차단합니다.
  
    TCP 포트 389, 636, 3268 및 3269
  
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 기업 방화벽의 들어오는 방향과 나가는 방향 모두에서 이들 포트를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 침입을 예방할 수 있습니다. 포트 389 및 636은 각각 LDAP와 보안 LDAP 서비스를 제공하는 반면, 포트 3268 및 3269는 LDAP 요청도 처리하는 Global Catalog 서버에서 사용됩니다.
  
    기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오. Windows 방화벽에 대한 자세한 내용은 [단일 컴퓨터에서 Windows 방화벽을 구성하는 방법 (영문)](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx)을 참조하십시오.
  
-   **Microsoft Windows 2000 서버에서 익명 LDAP 액세스 사용 안 함**
  
    Microsoft Windows 2000 서버에서 익명 LDAP 액세스를 사용하지 않으면 인증된 사용자만 이 취약점을 이용할 수 있게 됩니다. 사용하지 않을 때의 영향에 대한 설명 등 LDAP NULL 기본(익명) 연결에 대한 자세한 내용은 [Microsoft 기술 자료 문서 837964](https://support.microsoft.com/kb/837964)를 참조하십시오.
  
#### Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
LDAP 서비스가 특수하게 조작된 LDAP 또는 LDAPS 요청을 처리할 때 메모리를 잘못 해제합니다.
...
기본적으로 LDAP 트래픽은 보안되지 않은 상태로 전송됩니다. 그러나 SSL(Secure Sockets Layer)과 TLS(Transport Layer Security)를 활용하여 LDAP 트래픽의 기밀을 유지하고 수정을 방지할 수 있습니다. 관리자는 Microsoft 인증 기관(CA)이나 Microsoft 이외의 CA가 발행한 올바른 형식의 인증서를 설치하여 LDAPS(LDAP over SSL)를 활성화할 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 321051](https://support.microsoft.com/kb/321051)을 참조하십시오.
...
**서버에서 LDAP 서비스를 실행하고 있는지 어떻게 확인할 수 있습니까**?    
서버의 LDAP나 LDAPS 쿼리 수신 대기 여부를 확인하려면 관리자 명령 프롬프트에서 다음 명령을 실행하여 LDAP 포트(389) 또는 LDAPS 포트(636)에서 수신 대기 중인지 아니면 Global Catalog 서비스 포트(3268 또는 3269) 중 하나에서 대기 중인지 확인하십시오.  
netstat –a  
...
공격자는 특수하게 조작된 LDAP 또는 LDAPS 패킷을 Microsoft Windows 2000 실행 도메인 컨트롤러로 보내 이 취약점의 악용을 시도할 수 있습니다. 대상 네트워크에 액세스할 수 있는 익명 사용자가 특수하게 조작한 네트워크 패킷을 영향을 받는 시스템에 전달하여 이 취약점을 악용할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
LDAP는 Active Directory의 필수 요구 사항입니다. Windows 2000 Server를 실행하면서 Active Directory 서버 역할을 하는 모든 서버가 이 취약점의 영향을 받습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 LDAP 서비스가 특수하게 조작된 클라이언트 LDAP 또는 LDAPS 요청을 처리하는 동안 메모리를 해제하는 방식을 수정하여 취약점을 해결합니다.
...
Active Directory 메모리 누수 취약점(CVE-2009-1139)  
--------------------------------------------------
  
Microsoft Windows 2000 Server 및 Windows Server 2003에 구현된 Active Directory에 서비스 거부 취약점이 존재하며, Windows XP 및 Windows Server 2003에 설치된 ADAM(Active Directory Application Mode) 구현에도 취약점이 존재합니다. 이 취약점은 특정 유형의 LDAP 또는 LDAPS 요청을 실행하는 동안의 부적절한 메모리 관리로 인해 발생합니다. 취약점 악용에 성공한 공격자는 영향을 받는 서버가 응답을 중지하도록 만들 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1139 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1139)를 참조하십시오.
  
#### Active Directory 메모리 누수 취약점(CVE-2009-1139)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.
  
#### Active Directory 메모리 누수 취약점(CVE-2009-1139)에 대한 대안
...
#### Active Directory 메모리 누수 취약점(CVE-2009-1139)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이것은 서비스 거부 취약점입니다. 공격자는 이 취약점을 악용하여 영향을 받는 시스템이 응답을 중지하고 다시 시작되도록 만들 수 있습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
LDAP 서비스가 특정 OID 필터를 포함하고 있는 LDAP 또는 LDAPS 요청을 실행하는 동안 메모리를 부적절하게 관리합니다.
  
**LDAP란 무엇입니까?**    
LDAP(Lightweight Directory Access Protocol)는 분산형 디렉터리에 액세스를 제공하기 위해 설계된 개방형 네트워크 프로토콜 표준입니다.
  
**LDAPS(LDAP over SSL)란 무엇입니까?**    
기본적으로 LDAP 트래픽은 보안되지 않은 상태로 전송됩니다. 그러나 SSL(Secure Sockets Layer)과 TLS(Transport Layer Security)를 활용하여 LDAP 트래픽의 기밀과 보안을 유지할 수 있습니다. 관리자는 Microsoft 인증 기관(CA)이나 Microsoft 이외의 CA가 발행한 올바른 형식의 인증서를 설치하여 LDAPS(LDAP over SSL)를 활성화할 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 321051](https://support.microsoft.com/kb/321051)을 참조하십시오.
...
**OID 필터란 무엇입니까?**    
OID 또는 개체 ID는 LDAP 개체를 명명하는 데 사용됩니다. LDAP 쿼리에는 LDAP 네임스페이스에서 특정 OID와 일치하는 데이터만 선택하기 위한 필터가 포함되어 있을 수 있습니다.
  
**ADAM(Active Directory Application Mode)이란 무엇입니까?**    
ADAM은 시스템 서비스가 아닌 사용자 서비스로 실행되는 LDAP(Lightweight Directory Access Protocol) 디렉터리 서비스입니다. 자세한 내용은 TechNet 문서, [ADAM 개념(영문)](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true)을 참조하십시오.
  
**AD LDS(Active Directory Lightweight Directory Service)가 이 취약점의 영향을 받습니까?**    
Active Directory Lightweight Directory Services는 응용 프로그램을 위한 전용 디렉터리 서비스를 제공하는 독립 모드의 Active Directory입니다. 현재 AD LDS는 Microsoft Windows Server 2008 운영 체제에만 사용할 수 있으며 이 취약점의 영향을 받지 않습니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점 악용에 성공한 공격자는 영향을 받는 시스템에서 응답을 중지하거나 다시 시작하도록 만들 수 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 특수하게 조작한 LDAP 또는 LDAPS 패킷을 Active Directory 또는 ADAM 서버에 보내는 방법으로 취약점 악용을 시도할 수 있습니다. Microsoft Windows 2000 Server의 경우 대상 네트워크에 액세스할 수 있는 익명 사용자가 특수하게 조작한 네트워크 패킷을 영향을 받는 시스템에 전달하여 이 취약점을 악용할 수 있습니다. Windows Server 2003 또는 ADAM이 설치된 시스템에서 공격자가 이 취약점을 악용하려면 유효한 인증 자격 증명이 있어야 합니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
LDAP(Lightweight Directory Access Protocol)는 Active Directory 및 ADAM에 반드시 필요합니다. 따라서 Active Directory 또는 ADAM 서버로 실행 중인 시스템이 이 취약점의 영향을 받습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 LDAP 서비스가 특수하게 조작된 LDAP 또는 LDAPS 요청을 처리하는 동안 메모리를 할당하는 방식을 수정하여 취약점을 해결합니다.
...
#### Active Directory가 있는 Windows 2000 Server 서비스 팩 4
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-KB969805-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-KB969805-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | kb969805.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB969805$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 969805](https://support.microsoft.com/kb/969805) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969805\\Filelist                                        |
...
#### ADAM(Active Directory Application Mode)이 있는 Windows XP Professional(모든 에디션)
...
WindowsXP-KB970437-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM이 있는 Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB970437-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">ADAM이 있는 Windows XP Professional 서비스 팩 2 및 ADAM이 있는 Windows XP Professional 서비스 팩 3:<br />
WindowsXP-KB970437-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM이 있는 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB970437$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/970437">Microsoft 기술 자료 문서 970437</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">ADAM이 있는 지원 대상인 모든 Windows XP 32비트 에디션:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB970437\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM이 있는 지원 대상인 모든 Windows XP x64 기반 에디션:<br />
...
WindowsServer2003-KB969805-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Active Directory가 있는 지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB969805-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Active Directory가 있는 지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB969805-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Active Directory가 있는 지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB969805-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Active Directory가 있는 지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB969805$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969805">Microsoft 기술 자료 문서 969805</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
#### ADAM(Active Directory Application Mode)이 있는 Windows Server 2003(모든 에디션)
...
WindowsServer2003-KB970437-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM이 있는 지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB970437-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">ADAM이 있는 지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB970437-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM이 있는 지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB970437-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">KB970437.log</td>
...
-   Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Joshua J. Drake
-   Active Directory 메모리 누수 취약점(CVE-2009-1139)을 보고해 주신 [Beaverton School District (영문)](https://www.beaverton.k12.or.us/home/)의 Justin Wyatt
...
-   V1.1(2009년 6월 18일): Microsoft Windows 2000 Professional 서비스 팩 4, 지원되는 모든 Windows Vista 에디션, 지원되는 모든 Windows Server 2008(Itanium 기반 시스템용) 버전이 영향을 받지 않는 소프트웨어로 나열되었습니다. 또한 CVE-2009-1139의 TCP 포트 차단 대안에서 Global Catalog 서버에서 사용하는 포트에 대한 설명이 추가되었습니다. 이 변경 사항은 정보에만 해당됩니다.
