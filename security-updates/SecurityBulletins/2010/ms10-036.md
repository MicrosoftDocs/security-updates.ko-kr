...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 983235](http://support.microsoft.com/kb/983235)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft Office Excel 2003(KB982133) 및 Microsoft Office Excel 2007(KB982308)에 대한 이 공지(MS10-036)의 보안 업데이트 패키지는 [MS10-038](http://technet.microsoft.com/security/bulletin/ms10-038)에서 설명한 취약점도 해결합니다. Microsoft Office Excel 2003 또는 Microsoft Office Excel 2007을 설치한 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다. 또한 사용자는 공지 MS10-036에서 설명한 취약점으로부터 보호하기 위해 이 공지에서 제공되는 Microsoft Office 업데이트(KB982311 또는 KB982312)도 설치해야 합니다.

**이 업데이트에 기능에 대한 다른 비보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 보안과 관련이 없는 기능 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 983632](http://support.microsoft.com/kb/983632)를 참조하십시오.
...
이 완화 조치는 [Microsoft 보안 권고(973882)](http://technet.microsoft.com/security/advisory/973882) 및 [MS09-035](http://technet.microsoft.com/security/bulletin/ms09-035)에 설명되어 있는 ATL 취약점을 해결합니다. 변경 사항은 영향을 받는 모든 플랫폼에 기본적으로 적용되며 Microsoft에서 작성하지 않은 컨트롤을 포함하여 Microsoft Office에 로드되는 모든 컨트롤에서 ATL 취약점을 차단합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1263 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1263)을 참조하십시오.
...
**COM이란 무엇입니까?**  
Microsoft Windows 운영 체제의 Microsoft COM(Component Object Model) 기술을 통해 소프트웨어 구성 요소가 서로 통신할 수 있습니다. 개발자는 다시 사용할 수 있는 소프트웨어 구성 요소를 만들 때, 구성 요소를 연결하여 응용 프로그램을 구축할 때, 그리고 Windows 서비스를 활용할 때 COM을 사용합니다. COM에 대한 자세한 내용은 Microsoft 문서 [COM이란 무엇입니까? (영문)](http://www.microsoft.com/com/default.mspx)를 참조하십시오.
...
<td style="border:1px solid black;">Microsoft Office 2003 서비스 팩 3:<br />
<a href="http://support.microsoft.com/kb/982311">Microsoft 기술 자료 문서 982311</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 서비스 팩 3:<br />
<a href="http://support.microsoft.com/kb/982133">Microsoft 기술 자료 문서 982133</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 서비스 팩 3:<br />
<a href="http://support.microsoft.com/kb/982157">Microsoft 기술 자료 문서 982157</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 서비스 팩 3:<br />
<a href="http://support.microsoft.com/kb/982122">Microsoft 기술 자료 문서 982122</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 서비스 팩 3:<br />
<a href="http://support.microsoft.com/kb/982126">Microsoft 기술 자료 문서 982126</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 서비스 팩 3:<br />
<a href="http://support.microsoft.com/kb/982134">Microsoft 기술 자료 문서 982134</a> 참조</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">2007 Microsoft Office System 서비스 팩 1 및 2007 Microsoft Office System 서비스 팩 2:<br />
<a href="http://support.microsoft.com/kb/982312">Microsoft 기술 자료 문서 982312</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 서비스 팩 1 및 Microsoft Office PowerPoint 2007 서비스 팩 2:<br />
<a href="http://support.microsoft.com/kb/982158">Microsoft 기술 자료 문서 982158</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2007 서비스 팩 1 및 Microsoft Office Publisher 2007 서비스 팩 2:<br />
<a href="http://support.microsoft.com/kb/982124">Microsoft 기술 자료 문서 982124</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2007 서비스 팩 1 및 Microsoft Office Visio 2007 서비스 팩 2:<br />
<a href="http://support.microsoft.com/kb/982127">Microsoft 기술 자료 문서 982127</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2007 서비스 팩 1 및 Microsoft Office Word 2007 서비스 팩 2:<br />
<a href="http://support.microsoft.com/kb/982135">Microsoft 기술 자료 문서 982135</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   이 공지에서 해결한 심층 보안 변경 사항에 대해 협력해 주신 [IBM ISS X-Force (영문)](http://www.iss.net/)의 David Dewey 및 [Accuvant (영문)](http://www.accuvant.com/)(이전 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)) Ryan Smith
