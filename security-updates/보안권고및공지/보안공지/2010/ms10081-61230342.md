...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1&displaylang=ko)                                                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                                 | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45&displaylang=ko)                                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb&displaylang=ko)                                                      | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                             | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd&displaylang=ko)                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb&displaylang=ko)                   | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c&displaylang=ko)\*\*     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da&displaylang=ko)\*\* | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6)            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c&displaylang=ko)                                                                       | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28&displaylang=ko)                                                                     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                                   | 원격 코드 실행 | 중요        | 없음                      |
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](http://technet.microsoft.com/ko-kr/security/bulletin/ms10-oct)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](http://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2746 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746)을 참조하십시오.
...
공용 컨트롤은 Windows 운영 체제에 포함되어 있는 DLL인 공용 컨트롤 라이브러리 Comctl32.dll로 구현되는 창 집합입니다. 다른 컨트롤 창과 마찬가지로 공용 컨트롤은 사용자와 상호 작용을 위해 응용 프로그램에서 다른 창과 함께 사용하는 하위 창입니다. 이러한 라이브러리에 대한 자세한 내용은 MSDN 문서, [공용 컨트롤 정보 (영문)](http://msdn.microsoft.com/ko-kr/library/bb775493(vs.85).aspx)를 참조하십시오.
  
기본 Windows 구성에서 이 문제점을 악용할 수 있습니까?    
아니요. 취약점이 발생하기 위해서는 SVG(scalable vector graphics)를 렌더링하는 타사 응용 프로그램이 시스템에 설치되어야 합니다. Microsoft는 시스템에 타사 뷰어가 설치되지 않은 상태에서 공격 경로를 확인하지 못했습니다. SVG 구현 목록은 W3C(World Wide Web Consortium)의 [SVG 구현 (영문)](http://www.w3.org/graphics/svg/wg/wiki/implementations) 목록을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2296011">Microsoft 기술 자료 문서 2296011</a> 참조</td>
</tr>
<tr class="even">
...
-   Comctl32 힙 오버플로 취약점(CVE-2010-2746)을 [Secunia (영문)](http://secunia.com/)와 협력하여 보고해 주신 Krystian Kloskowski(h07)
