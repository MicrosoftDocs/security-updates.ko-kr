...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 955047](http://support.microsoft.com/kb/955047)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3007 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3007)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/955047">Microsoft Knowledge Base Article 955047</a> 참조</td>
</tr>
<tr class="even">
...
-   URL 유효성 검사 오류 취약점(CVE-2008-3007)을 보고해 주신 [Insomnia Security (영문)](http://www.insomniasec.com/)의 Brett Moore
