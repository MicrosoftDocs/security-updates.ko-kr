...
2011년 5월 보안 공지 발표와 함께 이 공지 요약이 2011년 5월 5일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](http://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](http://go.microsoft.com/fwlink/?linkid=21163)을 참조하십시오.

Microsoft는 2011년 5월 11일 수요일 오전 11:00(태평양 표준시, 미국 및 캐나다)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [5월 보안 공지 웹캐스트에 지금 등록하십시오](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?culture=en-us&eventid=1032455071&eventcategory=4). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약](http://technet.microsoft.com/security/bulletin/summary) 및 웹캐스트를 참조하십시오.
...
|---------------------------------------------------------------------|-------------------------------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|------------------------------|-----------|  
| [MS11-036](http://technet.microsoft.com/security/bulletin/ms11-036) | 프레젠테이션 메모리 손상 RCE 취약점 | [CVE-2011-1269 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269) | 영향 받지 않음                                                                       | [1](http://technet.microsoft.com/security/cc998259.aspx) - 일관적인 악용 코드 가능   | 해당 사항 없음               | (없음)    |  
| [MS11-035](http://technet.microsoft.com/security/bulletin/ms11-035) | WINS 서비스 응답 실패 취약점        | [CVE-2011-1248 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1248) | [2](http://technet.microsoft.com/security/cc998259.aspx) – 비일관적인 악용 코드 가능 | [2](http://technet.microsoft.com/security/cc998259.aspx) – 비일관적인 악용 코드 가능 | 임시                         | (없음)    |  
| [MS11-036](http://technet.microsoft.com/security/bulletin/ms11-036) | 프레젠테이션 버퍼 오버런 RCE 취약점 | [CVE-2011-1270 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270) | 영향 받지 않음                                                                       | [3](http://technet.microsoft.com/security/cc998259.aspx) – 악용 코드 기능 불가능     | 해당 사항 없음               | (없음)    |
...
-   MS11-035에서 설명한 문제점을 [TippingPoint's (영문)](http://www.tippingpoint.com/) [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Luigi Auriemma
-   MS11-036에서 설명한 두 가지 문제점을 해결하기 위해 협력해 주신 [CERT/CC (영문)](http://www.cert.org/)의 Will Dormann
