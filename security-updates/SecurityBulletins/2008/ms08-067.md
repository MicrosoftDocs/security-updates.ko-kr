...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=e22eb3ae-1295-4fe2-9775-6f43c5c2aed3&displaylang=ko)                                 | 원격 코드 실행 | 긴급        | [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0d5f9b6e-9265-44b9-a376-2067b73d6a03&displaylang=ko)                                             | 원격 코드 실행 | 긴급        | [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=0d5f9b6e-9265-44b9-a376-2067b73d6a03&displaylang=ko)                                             | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows XP Professional x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=4c16a372-7bf8-4571-b982-dac6b2992b25)                                               | 원격 코드 실행 | 긴급        | [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4c16a372-7bf8-4571-b982-dac6b2992b25)                                   | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=f26d395d-2459-4e40-8c92-3de1c52c390d&displaylang=ko)                                    | 원격 코드 실행 | 긴급        | [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f26d395d-2459-4e40-8c92-3de1c52c390d&displaylang=ko)                                    | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=c04d2afb-f9d0-4e42-9e1f-4b944a2de400&displaylang=ko)                                    | 원격 코드 실행 | 긴급        | [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c04d2afb-f9d0-4e42-9e1f-4b944a2de400&displaylang=ko)                        | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 with SP1(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ab590756-f11f-43c9-9dcc-a85a43077acf)                               | 원격 코드 실행 | 긴급        | [MS06-040](https://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ab590756-f11f-43c9-9dcc-a85a43077acf)                               | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=18fdff67-c723-42bd-ac5c-cac7d8713b21&displaylang=ko)                         | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=a976999d-264f-4e6a-9bd6-3ad9d214a4bd&displaylang=ko) | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 (32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=25c17b07-1efe-43d7-9b01-3dfdf1ce0bd7&displaylang=ko)\*                            | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 (x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=7b12018e-0cc1-4136-a68c-be4e1633c8df&displaylang=ko)\*                          | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2bcf89ef-6446-406c-9c53-222e0f0baf7a)                                       | 원격 코드 실행 | 중요        | 없음                                                                |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 958644](https://support.microsoft.com/kb/958644)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4250 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4250)을 참조하십시오.
...
-   **서버 및 컴퓨터 브라우저 서비스 사용 안 함**
    ...
    **대안의 영향**. 컴퓨터 브라우저 서비스 기능을 비활성화하면 명시적으로 컴퓨터 브라우저 서비스에 종속된 모든 서비스에 대해 시스템 이벤트 로그에 오류 메시지가 기록될 수 있습니다. 컴퓨터 브라우저 서비스에 대한 자세한 내용은 [Microsoft 기술 자료 문서 188001](https://support.microsoft.com/kb/188001)을 참조하십시오. 서버 서비스 기능을 해제하면 컴퓨터에서 파일 또는 프린터를 공유할 수 없습니다. 그러나 다른 시스템의 파일 공유 및 프린터 리소스는 계속 보거나 사용할 수 있습니다.
...
-   **방화벽에서 TCP 포트 139 및 445 차단**
    ...
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 TCP 포트 139 및 445를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
...
예. 이 보안 업데이트는 현재 악용되고 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-4250 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4250)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/958644">Microsoft 기술 자료 문서 958644</a> 참조</td>
</tr>
<tr class="even">
