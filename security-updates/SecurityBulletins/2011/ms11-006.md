...
이 보안 업데이트는 [Microsoft 보안 권고 2490606](https://technet.microsoft.com/security/advisory/2490606)에서 처음 설명한 취약점도 해결합니다.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57)                                                                 | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf&displaylang=ko)                                                                  | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398&displaylang=ko)                                                      | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)                                                             | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8&displaylang=ko)                                           | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d&displaylang=ko)                   | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb&displaylang=ko)\*\*     | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c&displaylang=ko)\*\* | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b)            | 원격 코드 실행 | 긴급        | [MS10-046](https://technet.microsoft.com/security/bulletin/ms10-046) |
...
예. 이 보안 업데이트를 설치하기 전에 시스템에서 이전에 적용한 "Windows XP 및 Windows Server 2003 시스템에서 shimgvw.dll ACL(액세스 제어 목록) 수정" 대안의 실행을 취소해야 합니다. 이 대안을 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2483185](https://support.microsoft.com/kb/2483185)를 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3970 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)을 참조하십시오.
...
-   **Windows XP 및 Windows Server 2003 시스템에서 shimgvw.dll ACL(액세스 제어 목록) 수정**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2483185](https://support.microsoft.com/kb/2483185)를 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3970 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2490606](https://technet.microsoft.com/security/advisory/2490606)에서 설명되었습니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3970 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2483185">Microsoft 기술 자료 문서 2483185</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 셸 그래픽 처리 오버런 취약점(CVE-2010-3970)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 Kobi Pariente 및 Yaniv Miron
