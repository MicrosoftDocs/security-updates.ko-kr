...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3965 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965)를 참조하십시오.
...
PRX 파일에는 비디오에 대한 인코딩 설정이 포함되어 있습니다. 비트 전송률 및 비디오 크기와 같은 인코딩 설정을 Microsoft Expression Encoder 또는 Microsoft Windows Encoder에 적용한 후 해당 설정을 하드 디스크에 저장하여 PRX 파일을 만듭니다. Windows Encoder에서 특정 설정을 만든 후 저장하면 해당 설정을 Expression Encoder에서도 사용할 수 있으므로 Windows Encoder에서 만든 복잡한 특정 인코딩 세트를 다시 실행할 필요가 없습니다. PRX 파일에 대한 자세한 내용은 MSDN 문서 [PRX 파일 지원](https://msdn.microsoft.com/ko-kr/library/cc294539.aspx)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3965 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965)가 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2447961">Microsoft 기술 자료 문서 2447961</a> 참조</td>
</tr>
<tr class="even">
