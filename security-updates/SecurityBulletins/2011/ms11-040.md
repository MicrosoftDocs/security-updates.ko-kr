...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Forefront Threat Management Gateway 2010 클라이언트](https://www.microsoft.com/download/details.aspx?familyid=d1c85acd-a6df-4634-9cd4-c562ad92097e&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1889 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1889)를 참조하십시오.
...
Forefront TMG 클라이언트에 대한 자세한 내용은 TechNet 문서, [방화벽 클라이언트 기본 사항: ISA Server 방화벽 클라이언트 및 Forefront TMG 클라이언트 소개(영문)](https://technet.microsoft.com/en-us/library/ee291341.aspx)를 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2520426](https://support.microsoft.com/kb/2520426) 참조                                                                  |  
