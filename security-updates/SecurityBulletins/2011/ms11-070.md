...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1e6ac3b2-752e-49a0-84e5-5a8dfe955299&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS11-035](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-035) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f9378339-c58e-4e84-9427-85aeb35b0d99&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-035](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-035) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c35c71a8-13b4-47a6-9763-06f6f65327b1)                                                                      | 권한 상승      | 중요        | [MS11-035](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-035) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a9039660-3cc2-470d-a0a5-a70f78074495&displaylang=ko)\*                                                   | 권한 상승      | 중요        | [MS11-035](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-035) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5ea78a9b-b1f7-4e94-b69e-c984e1622ae9&displaylang=ko)\*                                                 | 권한 상승      | 중요        | [MS11-035](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-035) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=f58cf343-946c-4e74-bd9c-40ac934a4986&displaylang=ko)\* | 권한 상승      | 중요        | [MS11-035](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-035) |
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [9월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-sep)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1984 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1984)를 참조하십시오.
...
WINS란 무엇입니까?    
WINS(Windows Internet Name Service)는 NetBT(NetBIOS over TCP/IP)를 지원하도록 특수하게 고안되었습니다. 사용자가 리소스에 액세스하는 데 NetBIOS 이름이 필요한 모든 환경에서는 WINS가 필수적입니다. 그러한 네트워크에서 WINS를 사용하지 않으면, 원격 네트워크 리소스에 연결하거나 파일 및 인쇄 공유 연결을 구성하기 위해 LMHOSTS 파일을 사용해야 합니다. 자세한 내용은 TechNet 문서 [WINS란 무엇입니까?(영문)](https://technet.microsoft.com/en-us/library/cc784180.aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2571621">Microsoft 기술 자료 문서 2571621</a> 참조</td>
</tr>
<tr class="even">
...
-   WINS 로컬 권한 상승 취약점(CVE-2011-1984)을 보고해 주신 [Core Security Technologies (영문)](https://www.coresecurity.com/)의 Nicolas Economou
