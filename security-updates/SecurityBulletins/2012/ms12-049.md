...
<td style="border:1px solid black;">
[MS10-049](http://go.microsoft.com/fwlink/?linkid=197104)의 KB980436은 KB2655992로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-006](http://go.microsoft.com/fwlink/?linkid=232510)의 KB2585542는 KB2655992로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-085](http://go.microsoft.com/fwlink/?linkid=201705)의 KB2207566은 KB2655992로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트에 관련된 해시 정보는 [Microsoft 기술 자료 문서 2655992](http://support.microsoft.com/kb/2655992)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [7월 공지 요약](http://technet.microsoft.com/security/bulletin/ms12-jul)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870)을 참조하십시오.
...
-   **Windows Vista, Windows Server 2008, Windows 7 또는 Windows Server 2008 R2 버전을 실행하는 시스템의 서버 소프트웨어에서 RC4 알고리즘의 우선 순위를 설정**
    ...
    공격은 AES와 같이 CBC 모드의 대칭 암호화 알고리즘을 사용하는 암호 그룹에만 영향을 미치며 RC4 알고리즘에는 영향을 미치지 않습니다. CBC 대신 RC4를 사용하여 보안 통신을 원활하게 하기 위해 서버 소프트웨어에서 RC4 알고리즘의 우선 순위를 정할 수 있습니다. 이 작업을 수행하는 방법은 이 MSDN 문서 [Schannel 암호 그룹 우선 순위 설정](http://msdn.microsoft.com/en-us/library/bb870930%28v=vs.85%29.aspx)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2655992">Microsoft 기술 자료 문서 2655992</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
[Microsoft 기술 자료 문서 2655992](http://support.microsoft.com/kb/2655992) 참조
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
