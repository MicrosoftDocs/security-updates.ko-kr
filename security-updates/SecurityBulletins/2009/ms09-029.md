---
TOCTitle: 'MS09-029'
Title: 'Microsoft 보안 공지 MS09-029 - 긴급'
ms:assetid: 'ms09-029'
ms:contentKeyID: 61230215
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-029(v=Security.10)'
---


Microsoft 보안 공지 MS09-029 - 긴급
===================================

Embedded OpenType 글꼴 엔진의 취약점으로 인한 원격 코드 실행 문제점(961371)
---------------------------------------------------------------------------

게시된 날짜: 2009년 7월 15일 수요일 | 업데이트된 날짜: 2009년 8월 26일 수요일
...
이 업데이트는 Microsoft Windows EOT 구성 요소가 포함 글꼴을 포함하는 파일과 콘텐츠의 구문을 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 961371](https://support.microsoft.com/kb/961371)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=1efbbd95-cd72-43df-b1ce-7e2b0c0cb9e2&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS06-002](https://technet.microsoft.com/security/bulletin/ms06-002) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b&displaylang=ko)                                                                                    | 원격 코드 실행 | 긴급        | [MS06-002](https://technet.microsoft.com/security/bulletin/ms06-002) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b&displaylang=ko)                                                                                    | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b8b019e-e6d8-4ce2-8f1f-3a6399b252d1)                                                                          | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=018ef53d-f78e-4084-940d-7c86bf59d83c&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7f5fc902-f5d8-4a87-a73f-68632f9a0935&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=7df0fce2-543c-4e82-85e6-012bfc8bf130)                                                                           | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c67d85c4-25c5-4821-8db9-91764888f893&displaylang=ko)                                     | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3f8ae651-59f7-48e1-9e8c-8e07c6806964&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=91f6ee68-0e39-4ec3-b4cd-45f05404e2fb&displaylang=ko)\*                | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5cdc3014-97b3-47b5-a6b7-cd0e12ec60e4&displaylang=ko)\*            | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=03330a14-9cfa-4146-a3d3-4b7a76975d2d)                     | 원격 코드 실행 | 긴급        | 없음                                                                |
...
**이 보안 공지가 2009년 8월 26일에 개정된 이유는 무엇입니까?**
Microsoft는 인쇄 스풀러의 응답을 중지하도록 만들 수 있는 품질 문제를 해결하는 지원 대상인 모든 Windows XP 에디션에 대한 일본어 업데이트가 다시 발표되었음을 알리기 위해 이 공지를 개정하였습니다. 위에서 설명한 스풀러 문제를 해결하고 이 공지에서 설명하는 취약점을 해결하기 위해 Windows XP 서비스 팩 2, Windows XP 서비스 팩 3 또는 Windows XP Professional x64 Edition 서비스 팩 2에 대한 업데이트를 설치한 고객은 자동으로 다시 제공되는 업데이트를 설치해야 합니다. 기타 업데이트 또는 로캘은 이 발표의 영향을 받지 않습니다.

**이 공지가 2009년 8월 12일에 다시 릴리스된 이유는 무엇입니까?**
Microsoft는 다음 플랫폼에 대한 업데이트를 다시 제공하기 위해 이 공지를 다시 릴리스했습니다.

-   Microsoft Windows 2000 서비스 팩 4
-   Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3
-   Windows XP Professional x64 Edition 서비스 팩 2
-   Windows Server 2003 서비스 팩 2
-   Windows Server 2003 x64 Edition 서비스 팩
-   Windows Server 2003 SP2(Itanium 기반 시스템용)

수정된 업데이트는 특정 상황에서 인쇄 스풀러의 응답을 중지하도록 하는 원본 업데이트의 문제점을 수정합니다. 수정된 업데이트는 자동 업데이트, Windows Update 및 Windows Server Update Services를 포함하여 원본 업데이트와 동일한 배포 채널을 통해 제공됩니다. 그러나 이미 원본 업데이트를 설치한 Windows XP 고객에게는 개정된 업데이트가 자동으로 제공되지 않으므로 Microsoft 다운로드 센터에서 새 업데이트를 수동으로 설치해야 합니다. Microsoft Windows 2000 및 Windows Server 2003 고객은 이전에 원본 업데이트를 설치했더라도 새 업데이트가 자동으로 제공됩니다. 영향을 받는 소프트웨어 플랫폼을 실행하는 고객은 수동으로 신규 업데이트를 다운로드하여 설치할 수 있습니다. 고객은 업데이트를 즉시 적용하는 것이 좋습니다.

이 알려진 문제점에 대한 자세한 내용은 [Microsoft 기술 자료 문서 961371](https://support.microsoft.com/kb/961371)을 참조하십시오.
...
**Windows 7 베타 버전도 이 취약점의 영향을 받습니까?**  
예. 이 취약점은 Windows 7 베타의 출시 이후 보고되었습니다. 이 플랫폼을 실행하는 고객은 이 업데이트를 다운로드하여 시스템에 적용하는 것이 좋습니다.

보안 업데이트는 Microsoft Update 및 Windows Update를 통해 제공됩니다.
...
<th style="border:1px solid black;" >Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)</th>
<th style="border:1px solid black;" >Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2009-0232)</th>
...
Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)  
--------------------------------------------------------
  
Microsoft Windows EOT(Embedded OpenType) 글꼴 기술이 특수하게 조작된 포함 글꼴에 있는 데이터 레코드의 구문을 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0231 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231)을 참조하십시오.
  
#### Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)에 대한 완화 요소
...
#### Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)에 대한 대안
...
-   [핵심 그룹 정책 도구 및 설정 (영문)](https://technet2.microsoft.com/windowsserver/en/library/e926577a-5619-4912-b5d9-e73d4bdc94911033.mspx?mfr=true)
    ...
    1.  그룹 정책 관리 콘솔을 열고 해당 그룹 정책 개체(예: 로컬 컴퓨터, OU 또는 도메인 GPO)와 작동하도록 구성합니다.  
    2.  다음 노드로 이동합니다.  
    ...
    5.  **인터넷 속성** 대화 상자에서 **인터넷** 영역이 선택되었는지 확인하고 **사용자 지정 수준**을 누릅니다.  
    6.  **다운로드** 항목으로 스크롤하여 **글꼴 다운로드**를 **확인** 또는 **사용 안 함**으로 설정합니다.  
    7.  **확인**을 눌러 인터넷 속성 대화 상자로 돌아갑니다.  
    8.  **로컬 인트라넷** 영역에 대해서도 이 단계를 반복합니다.  
    9.  **확인**을 세 번 눌러 그룹 정책 관리 콘솔로 돌아갑니다.  
    ...
    **관리되는 배포 스크립트 사용**
    ...
    인터넷 및 로컬 인트라넷 영역에 대해 이 설정을 '확인'으로 설정하려면 다음 텍스트를 .REG 파일에 붙여넣은 다음 관리되는 컴퓨터에서 조직의 관리되는 배포 프로세스의 일부로 .REG 파일을 가져옵니다.
    ...
    인터넷 및 로컬 인트라넷 영역에 대해 이 설정을 '사용 안 함'으로 설정하려면 다음 텍스트를 .REG 파일에 붙여넣은 다음 관리되는 컴퓨터에서 조직의 관리되는 배포 프로세스의 일부로 .REG 파일을 가져옵니다.
    ...
    **대안의 영향.** 포함 글꼴 기술을 사용하는 웹 사이트가 제대로 표시되지 않습니다.
...
-   **T2EMBED.DLL 액세스 거부**
    ...
    **WindowsVista** **및 Windows Server 2008:**
...
#### Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점의 원인은 Microsoft Windows 구성 요소인 Embeded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 특수하게 조작된 파일과 콘텐츠에 있는 이름 테이블의 구문을 분석할 때 발생하는 버퍼 오버플로입니다.
  
**EOT(Embedded OpenType) 글꼴이란 무엇입니까?**    
EOT(Embedded OpenType) 글꼴은 웹 페이지에 사용하도록 설계된 압축 형태의 글꼴로, 문서에 포함될 수 있습니다. EOT 글꼴을 사용할 경우 사용자는 작성자가 의도한 대로 정확히 문서를 보게 됩니다. 웹 작성자는 WEFT(Web Embedding Fonts Tool)를 사용하여 브라우저를 통해 본 페이지가 글꼴 개체에 포함된 스타일로 표시되도록 웹 페이지에 연결된 글꼴 개체를 만들 수 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](https://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 플랫폼은 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
이 취약점을 악용하려면 사용자가 특수하게 조작된 EOT 글꼴로 렌더링된 콘텐츠를 봐야 합니다.
  
전자 메일을 통한 공격의 경우 공격자는 문서에 포함된 특수하게 조작된 EOT 글꼴을 포함하는 Microsoft Word 또는 PowerPoint 파일이 첨부된 전자 메일 메시지를 사용자에게 보내고 파일을 열거나 미리 보도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.
  
웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 특수하게 조작된 포함 글꼴을 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 인스턴트 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Embedded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 파일과 콘텐츠의 구문을 분석하는 방식을 수정하여 문제점을 해결합니다.
...
Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2009-0232)  
----------------------------------------------------------
  
Microsoft Windows EOT(Embedded OpenType) 글꼴 기술이 특수하게 조작된 포함 글꼴에 있는 이름 테이블의 구문을 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0232 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0232)를 참조하십시오.
  
#### Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2009-0232)에 대한 완화 요소
...
#### Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2009-0232)에 대한 대안
...
#### Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2009-0232)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점의 원인은 Microsoft Windows 구성 요소인 Embeded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 특수하게 조작된 파일과 콘텐츠에 있는 이름 테이블의 구문을 분석할 때 발생하는 정수 오버플로입니다.
  
**EOT(Embedded OpenType) 글꼴이란 무엇입니까?**    
EOT(Embedded OpenType) 글꼴은 웹 페이지에 사용하도록 설계된 압축 형태의 글꼴로, 문서에 포함될 수 있습니다. 따라서 사용자는 작성자가 의도한 대로 정확히 문서를 보게 됩니다. 웹 작성자는 WEFT(Web Embedding Fonts Tool)를 사용하여 브라우저를 통해 본 페이지가 글꼴 개체에 포함된 스타일로 표시되도록 웹 페이지에 연결된 글꼴 개체를 만들 수 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](https://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 플랫폼은 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
전자 메일을 통한 공격의 경우 공격자는 특수하게 조작된 EOT 글꼴을 포함하는 Microsoft Word 또는 PowerPoint 파일이 첨부된 전자 메일 메시지를 사용자에게 보내고 파일을 열거나 미리 보도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.
...
<td style="border:1px solid black;">Windows2000-KB961371-v2-x86-KOR /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-KB961371-v2-x86-KOR /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB961371$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/961371">Microsoft 기술 자료 문서 961371</a> 참조</td>
</tr>
<tr class="even">
...
WindowsXP-KB961371-v2-x86-KOR /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB961371-v2-x86-KOR /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
WindowsServer2003-KB961371-v2-x86-KOR /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB961371-v2-x64-KOR /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB961371-v2-x86-KOR /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB961371-v2-x64-KOR /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)  
-   Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2009-0232)을 보고해 주신 Thomas Garnier
...
-   V1.1(2009년 7월 16일): 일부 경우 이 업데이트를 설치한 후 다시 시작할 필요가 없음을 알리기 위해 **업데이트 정보** 섹션에 있는 모든 업데이트에 대한 다시 시작 요구 사항 설명이 업데이트되었습니다.  
-   V1.2 (2009년 8월 5일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 961371 링크가 추가되고, 두 취약점의 대안 섹션에서 "수정" 솔루션에 대한 참조가 제거되었습니다.  
-   V2.0(2009년 8월 12일): 지원되는 모든 Microsoft Windows 2000, Windows XP 및 Windows Server 2003에 대한 업데이트를 다시 제공하기 위해 공지가 다시 릴리스되었습니다. 이 업데이트는 해당 플랫폼에 대해 원본 업데이트와 관련된 알려진 문제점을 해결합니다. 고객은 업데이트를 즉시 적용하는 것이 좋습니다.  
-   V2.1(2009년 8월 14일): **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에서 "이 보안 공지가 2009년 8월 11일에 개정된 이유는 무엇입니까?" 항목을 설명하고 **보안 업데이트 배포** 섹션에서 다시 발표된 업데이트에 대한 파일 이름을 수정하기 위해 공지가 개정되었습니다.  
-   V3.0(2009년 8월 26일): Windows XP 서비스 팩 2, Windows XP 서비스 팩 3 및 Windows XP Professional x64 Edition 서비스 팩 2에 대한 일본어 업데이트가 다시 발표되었음을 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목을 추가하였습니다. 일본어 업데이트가 필요한 고객은 다시 발표된 업데이트를 설치해야 합니다. 기타 업데이트 또는 로캘은 이 발표의 영향을 받지 않습니다.
