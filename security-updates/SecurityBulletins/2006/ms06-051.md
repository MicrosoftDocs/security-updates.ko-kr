...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=83e0c6fb-a542-463a-88fd-dc388605a8ae&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=71e96afc-bc4d-4666-998b-49857007e539&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=a6fe5b95-11d1-42cd-995c-c8cef8a27aef)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=7d0f888b-df35-40df-baff-0bae2b921aef&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=df365b0b-f97f-4df1-9105-d81b68a110eb)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=3f750ad5-5bfb-4421-a316-ae66f0557eac)
...
|--------------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| 사용자 프로필 권한 상승 취약점 - [CVE-2006-3443 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3443) | 권한 상승            | 중요         | 낮음                   | 낮음                   | 낮음                | 낮음                            |
| 처리되지 않은 예외 취약점 - [CVE-2006-3648 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3648)      | 원격 코드 실행       | 긴급         | 긴급                   | 긴급                   | 긴급                | 긴급                            |
...
Windows 2000에서 응용 프로그램을 시작하는 방식에 [권한 상승](https://www.microsoft.com/korea/security/glossary.mspx) 취약점이 있습니다. 이 취약점을 통해 로그온한 사용자가 시스템에 대한 전체 제어 권한을 얻을 수 있습니다.
...
-   **SafeDllSearchMode를 1로 설정합니다.**
    레지스트리에서 SafeDllSearchMode를 1로 설정하면 DLL 검색 경로 순서는 시스템 디렉터리가 현재 실행 중인 디렉터리 또는 사용자 프로필 디렉터리 앞에 오도록 합니다. 동적 연결 라이브러리 검색 순서에 대한 자세한 내용은 [MSDN 문서 (영문)](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dllproc/base/dynamic-link_library_search_order.asp)를 읽어보십시오.  
...
이 취약점은 [권한 상승](https://www.microsoft.com/korea/security/glossary.mspx) 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 취약점을 악용하려면 공격자가 로컬로 시스템에 로그온하고 프로그램을 실행할 수 있어야 합니다.
...
-   **내 컴퓨터 영역에서 액티브 스크립팅을 사용 안 함**
    ...
    이 대안이 수정하는 값에 대한 자세한 내용은 다음 [웹 사이트](https://support.microsoft.com/default.aspx?scid=182569)에서 제공합니다. 두 가지 방법으로 이 대안을 배포할 수 있습니다.  
...
-   사용자 프로필 권한 상승 취약점(CVE-2006-3443)을 보고해 주신 [Canaudit, Inc (영문)](https://www.canaudit.com/)의 [Reed Arvin](mailto:reed@canaudit.com)
-   처리되지 않은 예외 취약점(CVE-2006-3684)을 보고해 주신 Ken Johnson 및 협력해 주신 [Leviathan Security Group (영문)](https://www.leviathansecurity.com)의 Matt Miller
