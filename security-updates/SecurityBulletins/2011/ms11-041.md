...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=035d5115-54b6-41d3-b9f0-890041ead178)                                                                     | 권한 상승      | 중요        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa8c003-0353-4a5b-8aea-c01a103af393&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=2e07b5fa-c9fa-495b-9352-c07ce46a7e8b)                                                                 | 권한 상승      | 중요        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=a519a5d7-bfe3-4e53-99e9-d85f7e34237f&displaylang=ko)                       | 원격 코드 실행 | 긴급        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd8f3713-b408-4db6-aecd-7eed2176a715&displaylang=ko)\*       | 원격 코드 실행 | 긴급        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a61f888-c81e-4b8a-8932-2fe67df4b2ad)                | 원격 코드 실행 | 긴급        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=e7f52b13-5b3d-438c-ae14-86da50c8b67a&displaylang=ko)                             | 원격 코드 실행 | 긴급        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=b77e5be6-d3eb-4e3a-9be2-831578f0447c&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=c00a33bc-c874-4693-b0f7-5034c5df9424)          | 원격 코드 실행 | 긴급        | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
