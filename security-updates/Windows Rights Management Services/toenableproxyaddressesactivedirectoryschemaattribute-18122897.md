...
ms:contentKeyID: 18122897
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc720282(v=WS.10)'
---
...
| ![](images/Cc720282.Important(WS.10).gif)중요                                                                   |
|----------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720282.note(WS.10).gif)참고                                                                                    |
|----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
2.  Insert the Windows Server 2003 product CD and navigate to Support\\Tools.
    ...
    | ![](images/Cc720282.Caution(WS.10).gif)주의                                                                  |
    |-------------------------------------------------------------------------------------------------------------------------------------------|
