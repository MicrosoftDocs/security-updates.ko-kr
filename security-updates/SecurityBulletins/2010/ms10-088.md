...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2293386](http://support.microsoft.com/kb/2293386)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft는 Microsoft PowerPoint 2002 및 Microsoft PowerPoint 2003을 사용하는 고객이 CVE-2010-2573에서 설명하는 취약점으로부터 보호하기 위해 [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241), "Microsoft Office의 취약점으로 인한 원격 코드 실행 문제점(2423930)"에서 제공하는 Microsoft Office 업데이트도 설치해야 한다는 것을 설명하기 위해 이 공지를 개정했습니다. 이 변경 사항은 정보에만 해당됩니다. 이미 MS10-087 및 MS10-088 업데이트를 성공적으로 적용한 고객은 추가 조치를 취할 필요가 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2572 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572)를 참조하십시오.
...
-   기본적으로 PowerPoint 95 파일은 Microsoft PowerPoint 2003 서비스 팩 3에서 열 수 없게 차단되어 있습니다. Microsoft Office 2003 서비스 팩 3 설치 후에 차단된 파일 형식에 대한 자세한 내용은 [Microsoft 기술 자료 문서 938810](http://support.microsoft.com/kb/938810/)을 참조하십시오.
...
-   **모든 Microsoft PowerPoint 2002 사용자의 pp7x32.dll 액세스 제한**
    ...
    **대안 실행 취소 방법:**
    ...
    4.  **보안** 탭을 클릭합니다.  
        **참고** 속성 대화 상자에 보안 탭이 없는 경우 [Microsoft 기술 자료 문서 307874](http://support.microsoft.com/kb/307874/)에서 "단순 파일 공유를 해제하는 방법" 절의 단계에 따라 보안 탭을 확인하십시오.
    5.  **고급**을 클릭합니다.
    6.  **소유자** 탭을 클릭합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2573 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2413272">Microsoft 기술 자료 문서 2413272</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2413304">Microsoft 기술 자료 문서 2413304</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2413381">Microsoft 기술 자료 문서 2413381</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   PowerPoint 구문 분석 버퍼 오버플로 취약점(CVE-2010-2572)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Alin Rad Pop  
-   PowerPoint 정수 언더플로로 인한 힙 손상 취약점(CVE-2010-2573)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
