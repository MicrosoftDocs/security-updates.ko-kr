...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1266 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1266)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2544521">Microsoft 기술 자료 문서 2544521</a> 참조</td>
</tr>
<tr class="even">
...
-   VML 메모리 손상 취약점(CVE-2011-1266)을 [TippingPoint (영문)](http://www.tippingpoint.com/)[Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
