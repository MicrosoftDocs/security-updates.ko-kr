...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 973965](https://support.microsoft.com/kb/973965)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Visio Viewer 2007 서비스 팩 1 및 Microsoft Office Visio Viewer 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d20004c5-dd01-459e-8120-5f127e20c085&displaylang=ko)  
(KB973709)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
**\***Microsoft Visio Viewer 2002 및 Microsoft Visio Viewer 2003 사용자는 [Microsoft Office Visio Viewer 2007 서비스 팩 2](https://office.microsoft.com/en-us/downloads/cd102071301033.aspx)로 업그레이드하는 것이 좋습니다.
...
예. Microsoft Office Outlook 2007 서비스 팩 1 및 Microsoft Office Outlook 2007 서비스 팩 2(KB972363)에 대한 업데이트 패키지에는 [Microsoft 기술 자료 문서 969907](https://support.microsoft.com/kb/969907)에 설명되어 있는 Outlook 2007에 대한 변경 사항이 포함되어 있습니다.
...
-   [Microsoft Office 2003](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=f8079643-6e06-48d3-b581-db179e1f18f8) 업데이트(KB974554)
-   [Microsoft Office XP](https://www.microsoft.com/download/details.aspx?familyid=4974495c-70c5-4c7a-8bd3-56c9505f8283&displaylang=en) 업데이트(KB974556)
-   [2007 Microsoft Office System](https://www.microsoft.com/download/details.aspx?familyid=ec802723-f2b2-400a-a24d-8d8d9092f9ea&displaylang=en) 업데이트(KB974234)

[Microsoft 기술 자료 문서 973965](https://support.microsoft.com/kb/973965)에도 이러한 Microsoft 기술 자료 문서 링크가 포함되어 있습니다.
...
Microsoft Visio Viewer 2002 및 Microsoft Visio Viewer 2003의 모든 사용자는 최신 버전의 [Microsoft Visio Viewer 2007](https://office.microsoft.com/en-us/downloads/cd102071301033.aspx)로 업그레이드하여 이 취약점을 해결하는 것이 좋습니다. 업그레이드할 수 없는 사용자는 [MS09-034](https://go.microsoft.com/fwlink/?linkid=158199)에서 업데이트를 적용해야 합니다. MS09-034 Internet Explorer 업데이트는 영향을 받는 Visio Viewer 플랫폼의 공격 경로를 완화합니다. 이러한 컨트롤의 킬(Kill) 비트는 이후의 ActiveX 킬(Kill) 비트 누적 보안 업데이트에 포함될 예정입니다.
...
예. 타사에서 업데이트된 컨트롤을 릴리스하는 경우 해당 컨트롤을 설치해야 합니다. [MS09-034](https://technet.microsoft.com/security/bulletin/ms09-034) Internet Explorer 완화 조치는 ATL(액티브 템플릿 라이브러리)로 개발된 특정 구성 요소와 컨트롤의 근본적인 취약점을 해결하지 못합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973702">Microsoft 기술 자료 문서 973702</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973705">Microsoft 기술 자료 문서 973705</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 Outlook 2007 에디션:<br />
<a href="https://support.microsoft.com/kb/972363">Microsoft 기술 자료 문서 972363</a> 참조<br />
<br />
지원 대상인 모든 Visio Viewer 2007 에디션:<br />
<a href="https://support.microsoft.com/kb/973709">Microsoft 기술 자료 문서 973709</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
