...
이 보안 업데이트는 [Microsoft 보안 권고 2488013](https://technet.microsoft.com/security/advisory/2488013)에서 처음 설명한 취약점도 해결합니다.
...
Internet Explorer 9 베타는 이 공지에 설명된 취약점의 영향을 받습니다. 이러한 베타 릴리스를 실행하는 고객은 이 업데이트를 다운로드하여 시스템에 적용하는 것이 좋습니다. 보안 업데이트는 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 및 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)를 통해 제공됩니다. 이 베타 버전의 보안 업데이트는 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink/?linkid=21129)에서 다운로드할 수도 있습니다.
...
이 보안 업데이트를 설치하기 전에 시스템에서 이전에 적용한 "Internet Explorer에서 CSS 스타일 시트의 반복적인 로드 방지" 대안의 실행을 취소하는 것이 좋습니다. 이 대안을 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2482017](https://support.microsoft.com/kb/2482017)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.

**이 업데이트는 Microsoft 보안 권고 2269637과 관련이 있습니까?**  
예, 이 업데이트에서 해결하는 취약점([CVE-2011-0038 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038))은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
...
이전 버전의 소프트웨어에 대한 사용자 지정 지원이 필요한 고객은 자신의 Microsoft 계정 관리 팀 담당자나 TAM(기술 계정 관리자) 또는 해당 Microsoft 파트너 담당자에게 사용자 지정 지원 옵션에 대해 문의하십시오. Alliance, Premier 또는 Authorized Contract가 없는 고객은 해당 지역의 Microsoft 판매처에 문의하십시오. 연락처 정보는 [Microsoft 정보 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=33329)를 방문하여 Contact Information 목록에서 국가를 선택한 다음 **Go**를 클릭하면 나타나는 전화 번호 목록을 참조하십시오. 전화를 할 경우에는 해당 지역의 프리미어 지원 영업 담당자와 상담을 요청하십시오. 자세한 내용은 [Microsoft 지원 기간 정책 FAQ](https://go.microsoft.com/fwlink/?linkid=169557)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [2월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-feb)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3971 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](https://technet.microsoft.com/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 섹션을 참조하십시오.
...
-   **Internet Explorer에서 CSS(Cascading Style Sheet)의 반복적인 로드 방지**
    ...
    이 대안은 **Microsoft Fix it** 솔루션을 통해서만 제공됩니다. 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2482017](https://support.microsoft.com/kb/2482017)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.

    **참고** [MS10-090](https://technet.microsoft.com/security/bulletin/ms10-090) 업데이트를 아직 적용하지 않은 Internet Explorer 고객은 이 대안을 사용하기 전에 MS10-090 업데이트를 적용해야 합니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3971 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2488013](https://technet.microsoft.com/security/advisory/2488013)에서 설명되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0035 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0036 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0038 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)을 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0038 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2482017">Microsoft 기술 자료 문서 2482017</a> 참조</td>
</tr>
<tr class="even">
...
-   초기화되지 않은 메모리 손상 취약점(CVE-2011-0035)을 보고해 주신 [Trend Micro (영문)](https://www.trendmicro.com)의 Yuki Chen  
-   초기화되지 않은 메모리 손상 취약점(CVE-2011-0036)을 보고해 주신 [Google Inc.](https://www.google.com/)의 SkyLined  
-   Internet Explorer의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0038)을 보고해 주신 [Fortinet’s FortiGuard Labs (영문)](https://www.fortiguard.com/)의 Haifei Li
