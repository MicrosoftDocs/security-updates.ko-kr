...
영향을 받는 Microsoft Exchange Server 에디션을 실행하는 관리자는 영향을 받지 않는 Microsoft Exchange Server 버전으로 업그레이드해야 합니다. [Microsoft Exchange Server 2007 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=1687160b-634a-43cb-a65a-f355cff0afa6) 및 [Microsoft Exchange Server 2010](http://www.microsoft.com/exchange/2010)은 이 취약점의 영향을 받지 않습니다.
