...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 981997](http://support.microsoft.com/kb/981997)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b211664b-434d-4626-816f-c77510cfd44d&amp;displaylang=ko">Movie Maker 2.1</a>[1]</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8aded9dd-08d6-4b19-955f-0d8414868cf9&amp;displaylang=ko">Movie Maker 6.0</a>[1]<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=a1d8ed0d-a3b5-416a-ab8b-77501da62132&amp;displaylang=ko">Movie Maker 2.6</a>[2]</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-016">MS10-016</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4baff9ae-dd25-4942-b45e-f281d0e1f4ac&amp;displaylang=ko">Movie Maker 6.0</a>[1]<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=0a226592-8f98-4f67-ac60-1d00cbc56598&amp;displaylang=ko">Movie Maker 2.6</a>[2]</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-016">MS10-016</a></td>
</tr>
...
Windows 7 사용자의 경우 Microsoft는 Windows Live Movie Maker를 권장합니다. Windows Live Movie Maker는 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=741ce3ed-baa2-4610-9f7d-42ab694e2b15)에서 다운로드할 수 있으며 이 공지에서 설명하는 취약점의 영향을 받지 않습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2564 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2564)를 참조하십시오.
...
-   **Movie Maker .MSWMM 파일 연결 제거**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 981997](http://support.microsoft.com/kb/981997)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오. 이 Fix it 솔루션에서 배포하는 대안은 모든 사용자에게 영향을 미칩니다. 따라서 관리자는 이 Fix it 솔루션을 배포하기 전에 해당 KB 문서를 면밀히 검토하는 것이 좋습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/981997">Microsoft 기술 자료 문서 981997</a> 참조</td>
</tr>
<tr class="even">
...
-   Movie Maker 메모리 손상 취약점(CVE-2010-2564)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Dyon Balding
