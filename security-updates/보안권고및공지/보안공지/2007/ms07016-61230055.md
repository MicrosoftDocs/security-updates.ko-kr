...
-   Windows Server 2003 x64 Edition용 Microsoft Internet Explorer 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=c18db204-0f2c-4dd4-b29c-0938ff1bfd7b)
...
-   COM 개체 인스턴스화 메모리 손상 취약점(CVE-2007-0219)에 설명된 5개 클래스 식별자를 보고해 주신 [BreakingPoint Systems (영문)](http://www.bpointsys.com/)의 H D Moore
-   FTP 서버 응답 구문 분석 메모리 손상 취약점(CVE-2007-0217)을 보고해 주신[iDefense (영문)](http://idefense.com/)
