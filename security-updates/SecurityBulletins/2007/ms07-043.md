...
이 보안 업데이트의 영향을 받는 유일한 개발 플랫폼은 Visual Basic 6.0입니다. 이 공지는 Visual Basic 6.0 서비스 팩 6의 업데이트를 [다운로드](https://www.microsoft.com/download/details.aspx?familyid=)할 수 있는 링크를 제공합니다. 개발자는 공유 구성 요소를 사용할 경우 가장 권장되는 방법을 따르는 것이 좋습니다. 공유 구성 요소 사용의 최선책에 대한 자세한 내용은 [Microsoft 기술 자료 문서 835322](http://support.microsoft.com/kb/835322)에서 격리된 응용 프로그램을 참조하십시오.
