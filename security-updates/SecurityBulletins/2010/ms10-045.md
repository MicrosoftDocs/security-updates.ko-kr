---
TOCTitle: 'MS10-045'
Title: 'Microsoft 보안 공지 MS10-045 - 중요'
ms:assetid: 'ms10-045'
ms:contentKeyID: 61230306
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-045(v=Security.10)'
---



Microsoft 보안 공지 MS10-045 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Office Outlook 2002, Microsoft Office Outlook 2003 및 Microsoft Office Outlook 2007 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 업데이트는 Microsoft Office Outlook이 특수하게 조작된 메일 메시지에 포함된 첨부 파일을 확인하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 978212](https://support.microsoft.com/kb/978212)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=daacf400-4aa3-4479-a60f-b8863ba1e16d&amp;displaylang=ko">Microsoft Office Outlook 2002 서비스 팩 3</a><br />
(KB980371)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ef5b0048-96f1-43a6-9848-7f6adccd10b3&amp;displaylang=ko">Microsoft Office Outlook 2003 서비스 팩 3</a><br />
(KB980373)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-060">MS09-060</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4e2e7c49-6665-4135-adbb-8e831a91d0fe&amp;displaylang=ko">Microsoft Office Outlook 2007 서비스 팩 1 및 Microsoft Office Outlook 2007 서비스 팩 2</a><br />
(KB980376)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-060">MS09-060</a></td>
...
| Office 및 기타 소프트웨어                    |  
|----------------------------------------------|  
| Microsoft Office Outlook 2010(32비트 에디션) |  
| Microsoft Office Outlook 2010(64비트 에디션) |
...
예. 이 공지의 취약점 정보 항목에 나열된 변경 사항 이외에 이 업데이트에는 PR\_ATTACH\_METHOD 속성의 ATTACH\_BY\_REFERENCE 값을 사용하여 전자 메일의 첨부 파일을 차단하는 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 2271150](https://support.microsoft.com/kb/2271150)을 참조하십시오.
  
**Outlook Express, Windows Mail 또는 Windows Live Mail이 이 공지에 설명된 취약점의 영향을 받습니까?**    
아니요. Outlook Express, Windows Mail 및 Windows Live Mail은 이 공지에 설명된 취약점의 영향을 받지 않습니다. 이러한 Windows에서 사용할 수 있는 온라인 통신 도구는 Microsoft Office Outlook과 관련이 없습니다.
...
<th style="border:1px solid black;" >Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Outlook 2002 서비스 팩 3</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Outlook 2003 서비스 팩 3</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Outlook 2007 서비스 팩 1 및 Microsoft Office Outlook 2007 서비스 팩 2</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
...
Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)  
-----------------------------------------------------
  

Microsoft Office Outlook이 특수하게 조작된 메일 메시지에 포함된 첨부 파일을 확인하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0266 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0266)을 참조하십시오.
  
#### Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)에 대한 완화 요소
...
#### Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **신뢰할 수 없는 출처에서 받은 전자 메일의 첨부 파일은 열지 않음**
  
    신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 전자 메일의 첨부 파일은 열어보지 마십시오. 사용자가 전자 메일의 첨부 파일을 열 때 이 취약점이 악용될 수 있습니다.
...
#### Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft Office Outlook이 PR\_ATTACH\_METHOD 속성의 ATTACH\_BY\_REFERENCE 값을 사용하여 특수하게 조작된 메일 메시지에 첨부된 첨부 파일을 제대로 확인하지 못해 발생합니다.
...
이 취약점을 악용하려면 사용자가 특수하게 조작된 메일 메시지에 포함된 첨부 파일을 영향을 받는 Microsoft Office Outlook 버전에서 열어야 합니다.
  
전자 메일을 통한 공격의 경우 공격자는 첨부 파일이 포함된 특수하게 조작된 전자 메일을 사용자에게 보내고 첨부 파일을 열도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다. 사용자가 이 첨부 파일을 열려고 할 때 공격자가 지정한 악성 실행 파일이 실행될 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
Microsoft Outlook이 사용되는 워크스테이션 또는 터미널 서버 등의 시스템이 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Microsoft Office Outlook이 특수하게 조작된 메일 메시지에 포함된 첨부 파일을 확인하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">officexp-KB980371-FullFile-kor.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">officexp-KB980371-FullFile-kor.exe /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980371">Microsoft 기술 자료 문서 980371</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">office2003-KB980373-FullFile-kor.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2003-KB980373-FullFile-kor.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980373">Microsoft 기술 자료 문서 980373</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980376">Microsoft 기술 자료 문서 980376</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)을 [SSD/SecuriTeam Secure Disclosure Program (영문)](https://www.beyondsecurity.com/ssd.html)과 협력하여 보고해 주신 Yorick Koster
...
-   V1.1(2010년 7월 15일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 978212 링크가 추가되었습니다.
