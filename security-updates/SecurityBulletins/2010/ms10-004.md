---
TOCTitle: 'MS10-004'
Title: 'Microsoft 보안 공지 MS10-004 - 중요'
ms:assetid: 'ms10-004'
ms:contentKeyID: 61230264
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-004(v=Security.10)'
---

Microsoft 보안 공지 MS10-004 - 중요
===================================

Microsoft Office PowerPoint의 취약점으로 인한 원격 코드 실행 문제점 (975416)
----------------------------------------------------------------------------

게시된 날짜: 2010년 2월 10일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 Microsoft Office Word 2002, Microsoft Office Word 2003, Microsoft Office 2004 for Mac 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Microsoft Office PowerPoint 및 Microsoft PowerPoint Viewer가 특수하게 조작된 PowerPoint 파일을 구문 분석하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975416](https://support.microsoft.com/kb/975416)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2002 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=cfc697b4-2ceb-4030-86c5-be9bc8bfd07c&displaylang=ko)  
(KB973143)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=2291ae24-fa39-4ad8-a7d0-12726b68ad96&displaylang=ko)  
(KB976881)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Microsoft Office 제품군 및 구성 요소                                                                                                                                     |
| Microsoft Office PowerPoint 2007 서비스 팩 1 및 Microsoft Office PowerPoint 2007 서비스 팩 2                                                                             |
| Microsoft Office for Mac                                                                                                                                                 |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975416](https://support.microsoft.com/kb/975416)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.

**Microsoft Office PowerPoint Viewer 2003에서 업데이트 패키지가 제공되지 않는 이유는 무엇입니까?**  
CVE-2010-0033에 대한 취약점 FAQ는 이 업데이트가 Microsoft Office PowerPoint Viewer가 특수하게 조작된 PowerPoint 파일을 구문 분석하는 방식을 변경하여 취약점을 해결한다고 밝힙니다. 하지만 독립 실행형 PowerPoint Viewer 2003에 대한 업데이트 패키지는 제공되지 않습니다.

이는 PowerPoint Viewer 2003의 독립 실행형 설치가 [지원 기간이 끝나서 (영문)](https://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx) 이 업데이트가 제공되지 않기 때문입니다. 대신 이 업데이트는 현재 Microsoft Office PowerPoint 2003 고객에게 제공되어, 해당 고객들이 제작한 자체 프레젠테이션의 업데이트 버전을 PowerPoint Viewer 2003을 사용하는 PowerPoint의 [CD를 위한 프레젠테이션을 패키지로 만들기 기능](https://support.microsoft.com/kb/828504)을 통해 실행할 수 있도록 합니다.

PowerPoint Viewer 2003의 독립 실행형 설치를 사용 중인 고객은 이후의 취약점에 노출되지 않도록 지원되는 버전으로 마이그레이션을 우선적으로 고려하십시오. PowerPoint Viewer 2007은 이 보안 공지에서 설명한 취약점의 영향을 받지 않으며 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en)에서 다운로드할 수 있습니다.

**MS10-003에서도 Microsoft Office 2004 for Mac의 취약점을 설명하고 있습니다. MS10-003은 이 공지(MS10-004)와 어떤 관련이 있습니까?**  
Microsoft Office 2004 for Mac의 누적 서비스 모델의 일부로 Microsoft Office 2004 for Mac에 대한 이 보안 업데이트(KB979674)는 MS10-003에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac이 시스템에 설치된 사용자는 이 보안 업데이트를 한 번만 설치하면 됩니다.
...
Microsoft Office에서 특수하게 조작된 PowerPoint 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0029 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029)를 참조하십시오.

#### PowerPoint 파일 경로 처리 버퍼 오버플로 취약점(CVE-2010-0029)에 대한 완화 요소
...
#### PowerPoint 파일 경로 처리 버퍼 오버플로 취약점(CVE-2010-0029)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### PowerPoint 파일 경로 처리 버퍼 오버플로 취약점(CVE-2010-0029)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
특수하게 조작된 PowerPoint 파일을 열 때 Microsoft Office PowerPoint가 PowerPoint 파일 형식을 구문 분석하는 방식에 취약점이 존재합니다.
...
Microsoft Office PowerPoint를 사용하는 워크스테이션, 터미널 서버 등과 같은 시스템이 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Office PowerPoint가 특수하게 조작된 PowerPoint 파일을 구문 분석하는 방식을 변경하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0030 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030)을 참조하십시오.

#### PowerPoint LinkedSlideAtom 힙 오버플로 취약점(CVE-2010-0030)에 대한 완화 요소
...
#### PowerPoint LinkedSlideAtom 힙 오버플로 취약점(CVE-2010-0030)에 대한 대안
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.**
    ...
    **대안의 영향.** 파일 차단 정책은 구현했으나 Microsoft [기술 자료 문서 922847](https://support.microsoft.com/kb/922847)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는Office 2003 이전 버전의 파일을 열 수 없습니다.
...
#### PowerPoint LinkedSlideAtom 힙 오버플로 취약점(CVE-2010-0030)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0031 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031)을 참조하십시오.

#### PowerPoint OEPlaceholderAtom 'placementId' 잘못된 배열 인덱싱 취약점(CVE-2010-0031)에 대한 완화 요소
...
#### PowerPoint OEPlaceholderAtom 'placementId' 잘못된 배열 인덱싱 취약점(CVE-2010-0031)에 대한 대안
...
#### PowerPoint OEPlaceholderAtom 'placementId' 잘못된 배열 인덱싱 취약점(CVE-2010-0031)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0032 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032)를 참조하십시오.

#### PowerPoint OEPlaceholderAtom 해제 후 사용 취약점(CVE-2010-0032)에 대한 완화 요소
...
#### PowerPoint OEPlaceholderAtom 해제 후 사용 취약점(CVE-2010-0032)에 대한 대안
...
-   **알 수 없거나 신뢰할 수 없는 출처에서 받은 파일을 열 때 MOICE(Microsoft Office Isolated Conversion Environment)를 사용합니다.**
    ...
    [지금 FileFormatConverters.exe 패키지 다운로드](https://www.microsoft.com/download/details.aspx?familyid=941b3470-3ae9-4aee-8f43-c6bb74cd1466)
...
#### PowerPoint OEPlaceholderAtom 해제 후 사용 취약점(CVE-2010-0032)에 대한 FAQ
...
Microsoft Office PowerPoint Viewer가 특수하게 조작된 PowerPoint 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0033 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033)을 참조하십시오.

#### PowerPoint Viewer TextBytesAtom 레코드 스택 오버플로 취약점(CVE-2010-0033)에 대한 완화 요소
...
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 웹 사이트를 방문하도록 유도해야 하는데, 일반적으로 사용자를 공격자의 웹 사이트로 유인하는 전자 메일 메시지 또는 인스턴트 메신저 메시지에 포함된 링크를 클릭하도록 하는 방법을 사용합니다. 그 후 공격자는 사용자가 특수하게 조작된 PowerPoint 파일을 열도록 유도합니다.
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
-   Microsoft Office PowerPoint Viewer 2007은 이 취약점의 영향을 받지 않습니다. 사용자는 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en)에서 Microsoft Office PowerPoint Viewer 2007을 설치할 수 있습니다.

#### PowerPoint Viewer TextBytesAtom 레코드 스택 오버플로 취약점(CVE-2010-0033)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### PowerPoint Viewer TextBytesAtom 레코드 스택 오버플로 취약점(CVE-2010-0033)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

**취약점의 원인은 무엇입니까?**  
특수하게 조작된 PowerPoint 파일을 열 때 Microsoft Office PowerPoint Viewer가 PowerPoint 파일 형식을 구문 분석하는 방식에 취약점이 존재합니다.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
이 취약점을 악용에 성공한 공격자는 로그온한 사용자 자격으로 임의 코드를 실행할 수 있습니다. 사용자가 관리자 권한의 사용자 권한으로 로그온한 경우 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**공격자는 이러한 취약점을 어떻게 악용합니까?**  
이 취약점을 악용하려면 사용자가 특수하게 조작된 PowerPoint 파일을 영향을 받는 Microsoft Office PowerPoint Viewer 버전으로 열어야 합니다.
...
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
Microsoft Office PowerPoint Viewer를 사용하는 워크스테이션, 터미널 서버 등과 같은 시스템이 주로 위험합니다 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Office PowerPoint Viewer가 특수하게 조작된 PowerPoint 파일을 구문 분석하는 방식을 변경하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0034 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034)를 참조하십시오.

#### Office PowerPoint Viewer TextCharsAtom 레코드 스택 오버플로 취약점(CVE-2010-0034)에 대한 완화 요소
...
#### Office PowerPoint Viewer TextCharsAtom 레코드 스택 오버플로 취약점(CVE-2010-0034)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### Office PowerPoint Viewer TextCharsAtom 레코드 스택 오버플로 취약점(CVE-2010-0034)에 대한 FAQ
...
|----------------------------------------------|---------|---------------------|---------------------|----------------------------|
| Microsoft Office PowerPoint 2002 서비스 팩 3 | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft Office PowerPoint 2003 서비스 팩 3 | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;">OfficeXP-kb973143-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">OfficeXP-kb973143-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973143">Microsoft 기술 자료 문서 973143</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Office2003-kb976881-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Office2003-kb976881-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/976881">Microsoft 기술 자료 문서 976881</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.5.7 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=7c985595-00c5-44b8-81c3-59d9967220f8)에서 다운로드하여 설치하십시오.
...
-   바탕 화면에서 Microsoft Office 2004 for Mac 11.5.7 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2004 for Mac 11.5.7 업데이트 볼륨 창에서 Microsoft Office 2004 for Mac 11.5.7 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2004 for Mac 11.5.7 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **11.5.7**이면 업데이트가 설치된 것입니다.
...
-   PowerPoint 파일 경로 처리 버퍼 오버플로 취약점(CVE-2010-0029)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten Eiram  
-   PowerPoint LinkedSlideAtom 힙 오버플로 취약점(CVE-2010-0030)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   PowerPoint OEPlaceholderAtom 'placementId' 잘못된 배열 인덱싱 취약점(CVE-2010-0031)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   PowerPoint OEPlaceholderAtom 해제 후 사용 취약점(CVE-2010-0032)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   PowerPoint Viewer TextBytesAtom 레코드 스택 오버플로 취약점(CVE-2010-0033)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 SkD  
-   Office PowerPoint Viewer TextCharsAtom 레코드 스택 오버플로 취약점(CVE-2010-0034)을 보고해 주신 [TippingPoint DVLabs (영문)](https://dvlabs.tippingpoint.com/)의 Cody Pierce
