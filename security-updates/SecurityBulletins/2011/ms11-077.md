---
TOCTitle: 'MS11-077'
Title: 'Microsoft 보안 공지 MS11-077 - 중요'
ms:assetid: 'ms11-077'
ms:contentKeyID: 61230444
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-077(v=Security.10)'
---


Microsoft 보안 공지 MS11-077 - 중요
===================================
...
이 보안 업데이트는 Windows 커널 모드 드라이버가 사용자 모드에서 전달된 입력의 유효성을 확인하고, TrueType 글꼴 유형을 처리하고, 메모리에 쓰기 전에 적절한 버퍼 크기를 할당하고, 커널 모드 드라이버 개체를 관리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7&displaylang=ko)                                                                               | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                                     | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8&displaylang=ko)                                                                      | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d&displaylang=ko)                                                          | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                                      | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c&displaylang=ko)                                                                            | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc&displaylang=ko)                                                                | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705&displaylang=ko)\*                                                   | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6&displaylang=ko)\*                                                 | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                              | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56&displaylang=ko)                                 | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd&displaylang=ko)                             | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72&displaylang=ko)\* | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e)          | 원격 코드 실행 | 중요        | [MS11-054](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |

\*Server Core 설치가 영향을 받습니다. 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008 또는 Windows Server 2008 R2에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 TechNet 문서, [Server Core 설치 관리(영문)](https://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx) 및 [Server Core 설치 서비스(영문)](https://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008 및 Windows Server 2008 R2의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션에 따른 버전 비교(영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-oct)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >Win32k Null 포인터 역참조 취약점(CVE-2011-1985)</th>
<th style="border:1px solid black;" >Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)</th>
<th style="border:1px solid black;" >글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)</th>
<th style="border:1px solid black;" >Win32k 해제 후 사용 취약점(CVE-2011-2011)</th>
...
Win32k Null 포인터 역참조 취약점(CVE-2011-1985)  
-----------------------------------------------
  
Windows 커널 모드 드라이버가 사용자 모드에서 커널 모드로 제공되는 데이터의 유효성을 검사하는 방식에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1985(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985)를 참조하십시오.
  
#### Win32k Null 포인터 역참조 취약점(CVE-2011-1985)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k Null 포인터 역참조 취약점(CVE-2011-1985)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k Null 포인터 역참조 취약점(CVE-2011-1985)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
32비트 운영 체제에서 이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다. x64 기반 및 Itanium 기반 운영 체제에서 이 취약점은 서비스 거부 취약점입니다.
  
취약점의 원인은 무엇입니까?   
이 취약점은 Windows 커널 모드 드라이버가 사용자 모드에서 전달된 입력의 유효성을 제대로 검사하지 못해 발생합니다.
...
업데이트는 어떤 기능을 수행합니까?   
업데이트는 Windows 커널 모드 드라이버가 사용자 모드에서 전달된 입력의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)  
----------------------------------------------------
  
시스템이 특수하게 조작된 TrueType 글꼴 파일을 부적절하게 처리할 때 Microsoft Windows의 구현에 서비스 거부 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템이 응답을 중지하도록 만듭니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2002(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002)를 참조하십시오.
  
#### Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)에 대한 완화 요소
...
-   파일 공유 프로토콜인 SMB는 경계 방화벽에서 자주 비활성화됩니다. 이것이 이 취약점의 가능한 원격 공격 경로를 제한합니다.
  
#### Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)에 대한 대안
...
#### Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이 취약점은 서비스 거부 취약점입니다.
  
취약점의 원인은 무엇입니까?   
이 취약점은 Windows 커널 모드 드라이버가 TrueType 글꼴 유형을 제대로 처리하지 못할 때 발생합니다.
...
공격자는 이러한 취약점을 어떻게 악용합니까?   
공격자는 네트워크 공유 위치에 특수하게 조작된 TrueType 글꼴 파일을 호스팅할 수 있습니다. 그런 후 사용자가 Windows 탐색기에서 공유로 이동하면 세부 정보 및 미리 보기 창을 통해 영향 받은 제어 경로가 트리거됩니다. 특수하게 조작된 TrueType 글꼴은 이 취약점을 악용하여 시스템이 응답을 중지하도록 할 수 있습니다.
  
취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?   
워크스테이션과 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
업데이트는 어떤 기능을 수행합니까?   
업데이트는 Windows 커널 모드 드라이버가 TrueType 글꼴 유형을 처리하는 방식을 수정하여 이 취약점을 해결합니다.
...
글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)  
------------------------------------------------------
  
Windows 커널에 특수하게 조작된 .fon 글꼴 파일의 부적절한 처리로 인한 원격 코드 실행 취약점이 존재합니다. 이 취약점은 공격자가 커널 모드에서 코드를 실행하고 프로그램을 설치하도록 하며 전체 관리자 권한으로 데이터를 보거나 변경하거나 삭제하고, 새 계정을 만들 수 있도록 합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2003(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003)을 참조하십시오.
  
#### 글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   원격 공격이 성공하려면 사용자는 신뢰할 수 없는 원격 파일 시스템 위치나 WebDAV 공유에 방문하여 .fon 파일과 같은 특수하게 조작된 글꼴 파일을 열거나 해당 파일을 전자 메일 첨부 파일로 열어야 합니다.  
-   파일 공유 프로토콜인 SMB는 경계 방화벽에서 자주 비활성화됩니다. 이것이 이 취약점의 가능한 원격 공격 경로를 제한합니다.
  
#### 글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)에 대한 대안
...
#### 글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
취약점의 원인은 무엇입니까?   
이 취약점은 Windows 커널 모드 드라이버가 버퍼에 쓸 때 적절한 유효성 검사를 수행하지 않을 경우 발생합니다.
...
공격자는 이러한 취약점을 어떻게 악용합니까?   
네트워크 공격 시나리오에서 공격자는 .fon 파일과 같은 특수하게 조작된 글꼴 파일을 네트워크 공유, UNC 또는 WebDAV 위치에 두고 사용자가 파일을 열도록 유도할 수 있습니다.
  
전자 메일 공격 시나리오에서는 공격자가 .fon 파일과 같은 특수하게 조작된 글꼴 첨부 파일을 사용자에게 전송하고 사용자가 해당 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다.
  
취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?   
워크스테이션과 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
업데이트는 어떤 기능을 수행합니까?   
업데이트는 Windows 커널 모드 드라이버가 메모리에 쓰기 전에 적절한 버퍼 크기를 할당하는 방식을 수정하여 이 취약점을 해결합니다.
...
Win32k 해제 후 사용 취약점(CVE-2011-2011)  
-----------------------------------------
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011)(영문)을 참조하십시오.
  
#### Win32k 해제 후 사용 취약점(CVE-2011-2011)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### Win32k 해제 후 사용 취약점(CVE-2011-2011)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 해제 후 사용 취약점(CVE-2011-2011)에 대한 FAQ
...
취약점의 원인은 무엇입니까?   
이 취약점은 커널 모드 드라이버가 커널 모드 드라이버 개체를 부적절하게 관리할 때 발생합니다.
...
TrueType 글꼴이란 무엇입니까?   
TrueType 글꼴 기술은 글꼴 자체에 대한 설명(TrueType 글꼴 파일)과 글꼴 설명을 읽고 글꼴의 비트맵 표시를 생성하는 프로그램(TrueType 래스터라이저)의 두 부분으로 구성됩니다. TrueType 래스터라이저는 운영 체제의 일부로 통합되는 컴퓨터 프로그램입니다.
  
TrueType 글꼴 파일에는 TrueType 래스터라이저 및 운영 체제 소프트웨어에서 글꼴 디자이너의 의도대로 문자가 컴퓨터 화면에 표시되거나 정확히 출력되도록 하기 위해 사용되는 여러 다양한 정보가 포함되어 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](https://msdn.microsoft.com/ko-kr/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 운영 체제는 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
업데이트는 어떤 기능을 수행합니까?   
업데이트는 Windows 커널 모드 드라이버가 커널 모드 드라이버 개체를 관리하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2567053$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2567053">Microsoft 기술 자료 문서 2567053</a> 참조</td>
</tr>
<tr class="even">
...
-   파일 버전 확인
    ...
    6.  마지막으로, 이전 버전 탭을 클릭하여 표시된 이전 파일 버전의 파일 정보를 새 파일 또는 업데이트된 파일 버전의 파일 정보와 비교할 수도 있습니다.
...
-   Win32k 널 포인터 역참조 취약점(CVE-2011-1985)을 보고해 주신 [BitDefender(영문)](https://www.bitdefender.com/)의 Andrei Lutas  
-   Win32k Null 포인터 역참조 취약점(CVE-2011-1985)을 보고해 주신 [Norman(영문)](https://www.norman.com/)의 Tarjei Mandt  
-   Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)을 보고해 주신 Maik Wellmann  
-   글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)을 보고해 주신 [CERT/CC(영문)](https://www.cert.org/)의 Will Dorman
