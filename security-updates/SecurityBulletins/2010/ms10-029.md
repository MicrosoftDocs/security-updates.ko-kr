...
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176&displaylang=ko)                                     | 스푸핑         | 보통        | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36&displaylang=ko) | 스푸핑         | 보통        | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be&displaylang=ko)\*                | 스푸핑         | 보통        | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84&displaylang=ko)\*            | 스푸핑         | 보통        | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842)                     | 스푸핑         | 보통        | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |

**\*Server Core 설치가 영향을 받습니다.** 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 MSDN 문서, [Server Cor (영문)e](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교](http://www.microsoft.com/windowsserver2008/ko/kr/compare-core-installation.aspx)를 참조하십시오.
...
-   **ISATAP 클라이언트의 PRL(Potential Router List):** PRL은 클라이언트가 들어오는 ISATAP 터널링 패킷에 대해 소스 주소 확인을 수행할 수 있도록 해줍니다. PRL은 이 보안 업데이트를 설치할 때 기본적으로 사용되며 CVE-2010-0812에 설명된 ISATAP IPv6 소스 주소 스푸핑 취약점을 해결하는 데 도움이 됩니다. PRL에 대한 자세한 내용은 [Microsoft 기술 자료 문서 978338](http://support.microsoft.com/kb/978338)을 참조하십시오.
-   **ISATAP 인터페이스의 NUD(Neighbor Unreachability Detection):** NUD는 인접 노드에 연결할 수 있는지 여부를 검증하는 데 사용됩니다. NUD는 ISATAP 패킷을 전달하기 전에 ISATAP 노드에 의해 수행됩니다. NUD는 기본적으로 사용되지 않으며 네트워크 관리자가 수동으로 구성해야 합니다. NUD에 대한 자세한 내용과 사용하는 방법은 [Microsoft 기술 자료 문서 978338](http://support.microsoft.com/kb/978338)을 참조하십시오.
...
**참고** PRL은 이들 플랫폼에서 기본적으로 사용되지만, NUD는 그렇지 않으며 네트워크 관리자가 수동으로 구성해야 합니다. 이 기능에 대한 자세한 내용은 [Microsoft 기술 자료 문서 978338](http://support.microsoft.com/kb/978338)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0812 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812)를 참조하십시오.
...
**ISATAP란 무엇입니까?**    
ISATAP(Intra-Site Automatic Tunnel Addressing Protocol)는 IPv4 인트라넷 내에서 IPv6 연결을 제공합니다. ISATAP에 대한 자세한 내용은 [RFC5214: ISATAP(Intra-Site Automatic Tunnel Addressing Protocol) (영문)](http://www.ietf.org/rfc/rfc5214.txt)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/978338">Microsoft 기술 자료 문서 978338</a> 참조</td>
</tr>
<tr class="even">
