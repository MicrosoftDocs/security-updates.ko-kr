---
TOCTitle: 'MS12-045'
Title: 'Microsoft 보안 공지 MS12-045 - 긴급'
ms:assetid: 'ms12-045'
ms:contentKeyID: 61230512
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-045(v=Security.10)'
---

Microsoft 보안 공지 MS12-045 - 긴급
===================================

Microsoft Data Access Components의 취약점으로 인한 원격 코드 실행 문제점 (2698365)
----------------------------------------------------------------------------------

게시된 날짜: 2012년 7월 10일 화요일 | 업데이트된 날짜: 2012년 9월 12일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Vista 및 Windows 7 에디션에 대해 긴급이며, 지원 대상인 모든 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2 에디션에 대해 보통입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft Data Access Components가 메모리에서 개체를 처리하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2698365](https://support.microsoft.com/kb/2698365)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<sup>[1]</sup>또한 KB2698365 업데이트는 Windows Data Access Components 6.1에도 적용됩니다. [KB2640696](https://www.microsoft.com/download/details.aspx?id=28422) 업데이트를 설치한 고객은 Windows Data Access Components 6.1을 자신의 시스템에 설치한 뒤 KB2698365 업데이트를 설치하여 취약점을 해결해야 합니다.

영향을 받지 않는 소프트웨어

| 운영 체제(ServerCore 설치)                                              | 구성 요소                          |
|-------------------------------------------------------------------------|------------------------------------|
| Windows Server 2008(32비트 시스템용) 서비스 팩 2(Server Core 설치)      | Windows Data Access Components 6.0 |
| Windows Server 2008(x64 기반 시스템용) 서비스 팩 2(Server Core 설치)    | Windows Data Access Components 6.0 |
| Windows Server 2008 R2(x64 기반 시스템용)(Server Core 설치)             | Windows Data Access Components 6.0 |
| Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1(Server Core 설치) | Windows Data Access Components 6.0 |
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트에 대한 해시 정보는 [Microsoft 기술 자료 문서 2698365](https://support.microsoft.com/kb/2698365)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [7월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-jul)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
<tr>
<td style="border:1px solid black;">
Windows XP 서비스 팩 3의 Microsoft Data Access Components 2.8 서비스 팩 1
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft Data Access Components 2.8 서비스 팩 2
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 Microsoft Data Access Components 2.8 서비스 팩 2
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Microsoft Data Access Components 2.8 서비스 팩 2
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 SP2(Itanium 기반 시스템용)의 Microsoft Data Access Components 2.8 서비스 팩 2
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista 서비스 팩 2의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition 서비스 팩 2의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1의 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
보통   
원격 코드 실행
...
Microsoft Data Access Components가 제대로 초기화되지 않은 메모리의 개체에 액세스하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 성공적으로 악용한 공격자는 대상 시스템에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891)(영문)을 참조하십시오.

#### ADO Cachesize 힙 오버플로 RCE 취약점(CVE-2012-1891)에 대한 완화 요소
...
#### ADO Cachesize 힙 오버플로 RCE 취약점(CVE-2012-1891)에 대한 대안
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Microsoft Data Access Components가 메모리에서 개체를 처리하는 방식을 변경하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2698365$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2698365">Microsoft 기술 자료 문서 2698365</a> 참조</td>
</tr>
<tr class="even">
...
-   ADO Cachesize 힙 오버플로 RCE 취약점(CVE-2012-1891)을 [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
...
-   V1.1(2012년 7월 31일): Windows Update의 다시 제공 문제를 수정하기 위해 KB2698365에서 Windows Vista 패키지의 검색 변경 사항을 알리고자 공지가 개정되었습니다. 이 변경 사항은 검색에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.  
-   V1.2(2012년 8월 15일): 이 업데이트가 Windows 7 서비스 팩 1 및 Windows Server 2008 R2 서비스 팩 1의 Windows Data Access Components 6.1에 적용된다는 설명이 추가되었습니다. 이 변경 사항은 정보에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.  
-   V1.3(2012년 9월 12일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2698365 링크가 추가되었습니다.
