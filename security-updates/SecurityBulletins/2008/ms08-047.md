...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 953733 (영문)](https://support.microsoft.com/kb/953733)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-2246 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2246)을 참조하십시오.
...
-   "기본 응답 규칙"은 더 이상 Windows Vista 및 Windows Server 2008에서 유효하지 않으며 이전 버전의 Windows에만 적용할 수 있으므로 IPsec 정책을 만드는 동안 이 규칙을 선택하지 않거나 기존 정책에서 이 규칙의 선택을 해제합니다. Windows Vista 및 Windows Server 2008에서 이 규칙을 에뮬레이트하려면 [Microsoft 기술 자료 문서 942964 (영문)](https://support.microsoft.com/kb/942964/)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953733">Microsoft 기술 자료 문서 953733 (영문)</a> 참조</td>
</tr>
<tr class="odd">
