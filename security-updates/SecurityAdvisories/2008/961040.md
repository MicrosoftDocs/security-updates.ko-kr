...
Microsoft는 공개적으로 보고된 이 취약점에 대해 조사를 완료했습니다. 이 문제점을 해결하기 위해 [MS09-004](http://technet.microsoft.com/security/bulletin/ms09-004)가 게시되었습니다. 사용 가능한 보안 업데이트의 다운로드 링크를 포함하여, 이 문제점에 대한 자세한 내용은 [MS09-004](http://go.microsoft.com/fwlink/?linkid=139513)를 검토하십시오. 해결된 취약점은 SQL Server sp\_replwritetovarbin 제한된 메모리 덮어쓰기 취약점([CVE-2008-5416 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-5416))입니다.
