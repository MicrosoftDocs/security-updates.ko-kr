...
[Microsoft Office 2000 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=3ab323ec-9f92-453c-b7c7-9a95a9efcaea&displaylang=ko)  
(KB921595)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=bf566ce6-23da-45e5-9c2b-c47331d30e79&displaylang=ko)  
(KB921596)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e0df2f6e-1102-461d-829f-5f3e2d7eb4b3&displaylang=ko)  
(KB921598)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Project 2002 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=bf566ce6-23da-45e5-9c2b-c47331d30e79&displaylang=ko)  
(KB921596)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 변환 팩](https://www.microsoft.com/download/details.aspx?familyid=199b08c7-6d79-4930-8f0c-31034629c485)  
(KB925256)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 924090 (영문)](https://support.microsoft.com/kb/924090)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3019 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3019)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3018 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3018)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3021 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3021)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3020 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3020)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3460 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3460)을 참조하십시오.
...
-   지원되는 Microsoft Office 2000 버전은 [How to Create an Administrative Installation Point(관리 설치 지점을 만드는 방법) (영문)](https://office.microsoft.com/en-us/ork2000/ha011380221033.aspx)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office 2000 서비스 팩 3(SP3)으로 클라이언트 시스템에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 932889](https://support.microsoft.com/kb/932889)를 참조하십시오.  
    **참고** 업데이트된 관리 이미지를 통해 중앙에서 소프트웨어 업데이트를 관리하려는 경우 [패치된 관리 이미지에서 Office 2000 클라이언트 업데이트 (영문)](https://office.microsoft.com/en-us/ork2000/ha011525661033.aspx?pid=ch102053491033)(영문) 문서에서 자세한 내용을 볼 수 있습니다.  
-   지원되는 Microsoft Office XP 버전은 [Creating an Administrative Installation Point(관리 설치 지점 만들기) (영문)](https://office.microsoft.com/en-us/orkxp/ha011363091033.aspx)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office XP 원래 기준선으로 클라이언트 시스템에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 922665 (영문)](https://support.microsoft.com/kb/922665)를 참조하십시오.  
    **참고** 업데이트된 관리 이미지를 통해 중앙에서 소프트웨어 업데이트를 관리하려는 경우 [패치된 관리 이미지에서 Office XP 클라이언트 업데이트 (영문)](https://office.microsoft.com/en-us/orkxp/ha011525721033.aspx)(영문) 문서에서 자세한 내용을 볼 수 있습니다.  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/921595">Microsoft 기술 자료 문서 921595 (영문)</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/921596">Microsoft 기술 자료 문서 921596 (영문)</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/921598">Microsoft 기술 자료 문서 921598 (영문)</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
*핫픽스*와 같이 이 공지에서 사용하는 용어에 대한 자세한 내용은 [Microsoft 기술 자료 문서 824684 (영문)](https://support.microsoft.com/kb/824684)를 참조하십시오.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/925256">Microsoft 기술 자료 문서 925256 (영문)</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/955428">Microsoft 기술 자료 문서 955428 (영문)</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
고객 보호를 위해 협력해 주신 다음 분들께 [감사 (영문)](https://technet.microsoft.com/security/bulletin/policy)드립니다.
  
-   Microsoft 조작된 PICT 필터 취약점(CVE-2008-3018)을 보고해 주신 [NGS Software (영문)](https://www.nextgenss.com/)의 Shaun Colley.  
-   Microsoft PICT 필터 구문 분석 취약점(CVE-2008-3021)을 보고하기 위해 [Zero Day Initiative(ZDI) (영문)](https://www.zerodayinitiative.com/)와 협력해 주신 Damian Put.  
-   Microsoft 조작된 BMP 필터 취약점(CVE-2008-3020)을 보고하기 위해 [iDefense VCP (영문)](https://labs.idefense.com/)와 협력해 주신 익명의 연구원.  
-   Microsoft Office WPG 이미지 파일 힙 손상 취약점(CVE-2008-3460)을 보고하기 위해 [iDefense VCP (영문)](https://labs.idefense.com/)와 협력해 주신 Damian Put.
