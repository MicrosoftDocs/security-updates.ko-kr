...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1138 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1138)을 참조하십시오.
...
-   **Microsoft Windows 2000 서버에서 익명 LDAP 액세스 사용 안 함**
    ...
    Microsoft Windows 2000 서버에서 익명 LDAP 액세스를 사용하지 않으면 인증된 사용자만 이 취약점을 이용할 수 있게 됩니다. 사용하지 않을 때의 영향에 대한 설명 등 LDAP NULL 기본(익명) 연결에 대한 자세한 내용은 [Microsoft 기술 자료 문서 837964](http://support.microsoft.com/kb/837964)를 참조하십시오.
...
기본적으로 LDAP 트래픽은 보안되지 않은 상태로 전송됩니다. 그러나 SSL(Secure Sockets Layer)과 TLS(Transport Layer Security)를 활용하여 LDAP 트래픽의 기밀을 유지하고 수정을 방지할 수 있습니다. 관리자는 Microsoft 인증 기관(CA)이나 Microsoft 이외의 CA가 발행한 올바른 형식의 인증서를 설치하여 LDAPS(LDAP over SSL)를 활성화할 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 321051](http://support.microsoft.com/kb/321051)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1139 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1139)를 참조하십시오.
...
ADAM은 시스템 서비스가 아닌 사용자 서비스로 실행되는 LDAP(Lightweight Directory Access Protocol) 디렉터리 서비스입니다. 자세한 내용은 TechNet 문서, [ADAM 개념(영문)](http://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 969805](http://support.microsoft.com/kb/969805) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/970437">Microsoft 기술 자료 문서 970437</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969805">Microsoft 기술 자료 문서 969805</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   Active Directory 잘못된 메모리 해제 취약점(CVE-2009-1138)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Joshua J. Drake
-   Active Directory 메모리 누수 취약점(CVE-2009-1139)을 보고해 주신 [Beaverton School District (영문)](http://www.beaverton.k12.or.us/home/)의 Justin Wyatt
