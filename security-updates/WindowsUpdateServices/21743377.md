...
The [WsusDBMaintenance](https://go.microsoft.com/fwlink/?linkid=87027) script (https://go.microsoft.com/fwlink/?LinkId=87027) allows you to re-index any version of the WSUS database, either SQL Server or Windows 내부 데이터베이스.

If you are using Windows 내부 데이터베이스, you will need to use the **sqlcmd** utility. For more information about the **sqlcmd** utility, see [sqlcmd Utility](https://go.microsoft.com/fwlink/?linkid=81183) (https://go.microsoft.com/fwlink/?LinkId=81183).
