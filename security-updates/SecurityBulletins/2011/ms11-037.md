...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|-----------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=ce5bc2d7-9438-4bf0-be5e-be9dd00c3286)                                                                                     | 정보 유출      | 중요        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7b211b02-a005-46a3-ad1d-d4baaeec8289)                                                            | 정보 유출      | 중요        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6427ea5d-05d0-4367-805c-9cb305802b3c)                                                                            | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e7f65891-32c0-4817-b3b2-d8be73145df9)                                                                | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ca8b1d09-9f80-417b-99b1-8f86e86e1f11)                                                             | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ebea38a7-1fbe-4141-a529-52d7a7326d6a)                                                     | 정보 유출      | 중요        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=54833350-a385-4a31-995a-9ddc38798c21)                             | 정보 유출      | 중요        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6a3bbd67-94db-40b2-8786-cb39a493ec92)\*\*               | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4cb870f3-9878-4075-b8fd-2ee90c8e3bc8)\*\*           | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e1243011-00e6-49f2-a676-c04cb805d36a)       | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c3647646-658a-423b-b0cb-bba7613b67e7)                                       | 정보 유출      | 중요        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=7996511d-4b8e-49c3-a0fa-4da907a6c947)                                   | 정보 유출      | 중요        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=40354f73-4f4d-4a4a-abac-f8a3d4c3ae5f)\*\*     | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=22853823-8f63-4258-8991-1ad50e58a0d9) | 정보 유출      | 낮음        | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1894](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894)를 참조하십시오.
...
**MHTML이란 무엇입니까?**    
MHTML(MIME Encapsulation of Aggregate HTML)은 HTML 콘텐츠를 래핑하는 데 사용되는 MIME 구조를 정의하는 인터넷 표준입니다. Windows의 MHTML 프로토콜 처리기는 MHTML로 인코딩된 문서가 응용 프로그램에서 렌더링될 수 있도록 하는 플러그 가능한 프로토콜(MHTML:)을 제공합니다. 자세한 내용은 MSDN 문서, [비동기 플러그 가능한 프로토콜 정보(영문)](https://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-1894](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894)가 지정되었습니다.
...
**참고** Microsoft는 2011년 4월 12일자로 SMS 2.0에 대한 지원을 중단했습니다. 또한 SMS 2003의 경우에도 Microsoft는 2011년 4월 12일자로 SUIT(Security Update Inventory Tool)에 대한 지원을 중단했습니다. 고객은 [System Center Configuration Manager 2007](https://technet.microsoft.com/en-us/library/bb735860.aspx)로 업그레이드할 것을 권장합니다. SMS 2003 서비스 팩 3을 계속 사용하는 고객의 경우 [Inventory Tool for Microsoft Updates](https://technet.microsoft.com/en-us/systemcenter/bb676783.aspx)(ITMU)도 선택 사항입니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2544893">Microsoft 기술 자료 문서 2544893</a> 참조</td>
</tr>
<tr class="even">
...
-   이러한 공지를 변경하는 데 협력해 주신 [Google Security Team](https://www.google.com/)의 Billy Rios와 Eduardo Vela Nava
