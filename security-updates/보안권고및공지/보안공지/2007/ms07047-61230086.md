...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 936782](http://support.microsoft.com/kb/936782)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Windows 2000 서비스 팩 4                        | [Windows Media Player 7.1](http://www.microsoft.com/downloads/details.aspx?familyid=9f46b1fc-ee7b-437f-9492-67d003711021&displaylang=ko) | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows 2000 서비스 팩 4                        | [Windows Media Player 9](http://www.microsoft.com/downloads/details.aspx?familyid=bd4a6474-5fde-415e-840e-7d973cb71c95&displaylang=ko)   | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows XP 서비스 팩 2                          | [Windows Media Player 9](http://www.microsoft.com/downloads/details.aspx?familyid=bd4a6474-5fde-415e-840e-7d973cb71c95&displaylang=ko)   | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows XP 서비스 팩 2                          | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=48f5a9d3-b859-4cb6-a68e-abde76a14782&displaylang=ko)  | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows XP 서비스 팩 3                          | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=48f5a9d3-b859-4cb6-a68e-abde76a14782&displaylang=ko)  | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows XP Professional X64 Edition             | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=949580be-cbb3-4271-8ca0-0ead7f2d8801)                 | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows XP Professional X64 Edition 서비스 팩 2 | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=949580be-cbb3-4271-8ca0-0ead7f2d8801)                 | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows Server 2003 서비스 팩 1                 | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=8d9f1fdf-6d4c-44d4-9b5f-bdbe8ac28d7f&displaylang=ko)  | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows Server 2003 서비스 팩 2                 | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=8d9f1fdf-6d4c-44d4-9b5f-bdbe8ac28d7f&displaylang=ko)  | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows Server 2003 x64 Edition                 | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=2c04c7f2-728e-43bd-8574-26e411fcd129&displaylang=ko)  | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows Server 2003 x64 Edition 서비스 팩 2     | [Windows Media Player 10](http://www.microsoft.com/downloads/details.aspx?familyid=2c04c7f2-728e-43bd-8574-26e411fcd129&displaylang=ko)  | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows XP 서비스 팩 2                          | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=a690d042-1137-4aaf-bd0e-565ea04d1f2b&displaylang=ko)  | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows XP 서비스 팩 3                          | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=a690d042-1137-4aaf-bd0e-565ea04d1f2b&displaylang=ko)  | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows XP Professional X64 Edition             | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=bdc89f34-c1ff-46ab-b52d-c02d51c5c373)                 | 원격 코드 실행 | 중요        | [MS06-024](http://technet.microsoft.com/security/bulletin/ms06-024) |
| Windows XP Professional X64 Edition 서비스 팩 2 | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=bdc89f34-c1ff-46ab-b52d-c02d51c5c373)                 | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows Vista                                   | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=80e5167c-4f75-4ce3-8b15-2f50958deec8&displaylang=ko)  | 원격 코드 실행 | 중요        | 없음                                                                |
| Windows Vista x64 Edition                       | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=bf30b714-d6e7-47ea-b79e-84c18370a661&displaylang=ko)  | 원격 코드 실행 | 중요        | 없음                                                                |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 936782](http://support.microsoft.com/kb/936782)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이전 버전의 소프트웨어를 사용 중인 고객은 이후의 취약점에 노출되지 않도록 지원되는 버전으로 마이그레이션을 우선적으로 고려하십시오. Windows 제품 지원 기간에 대한 자세한 내용은 Microsoft [지원 기간 정책 웹 사이트](http://support.microsoft.com/default.aspx?scid=fh;%5Bln%5D;lifecycle)를 참조하십시오. 이러한 소프트웨어 버전의 연장 보안 업데이트 지원 기간에 대한 자세한 내용은 [Microsoft 고객 지원 센터 웹 사이트](http://go.microsoft.com/fwlink/?linkid=33328)를 참조하십시오.
...
예. 취약점 정보 공지 섹션의 각 취약점 항목에 대한 자주 제기되는 질문 사항(FAQ) 하위 섹션에 나열된 변경 사항 외에, 이 업데이트에는 Windows Media Player에 대한 추가적인 보안 변경 사항이 포함되어 있습니다. 추가적인 보안에 대한 자세한 내용은 [Microsoft 기술 자료 문서 940893](http://support.microsoft.com/kb/940893)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3037 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3037)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3035 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3035)를 참조하십시오.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows Vista의 Windows Media Player 11에 대한 레지스트리 키는 존재하지 않습니다. 이 패치의 적용 여부를 검색하려면 <a href="http://www.microsoft.com/whdc/system/pnppwr/wmi/wmi-intro.mspx">WMI(Windows Management Instrumentation) (영문)</a>를 사용하십시오.</td>
</tr>
</tbody>
</table>
...
-   Windows Media Player 스킨 압축 풀기 코드 실행 취약점(CVE-2007-3035)를 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayintiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 협력해 주신 Piotr Bania
-   Windows Media Player 스킨 구문 분석 코드 실행 취약점(CVE-2007-3037)를 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayintiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 협력해 주신 Piotr Bania
-   [Microsoft 기술 자료 문서 940893](http://support.microsoft.com/kb/940893)에서 설명한 Windows Media Player에 대한 추가적인 보안 변경 사항을 보고해 주신 [IOActive (영문)](http://www.ioactive.com)의 Dan Kaminsky
