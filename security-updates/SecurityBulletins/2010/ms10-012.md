...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=267ce982-54a0-418f-ad52-e4963610f714&displaylang=ko)                                                                        | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=8f7adee3-e68e-41b3-b835-d84691774f31&displaylang=ko)                                                          | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=91ee57f2-81e5-49bd-bdfc-d3e385efc8a5)                                                                          | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d18cbc4-ac48-458c-8aa3-90708fd854ff&displaylang=ko)                                                                           | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d63c95e-311a-446f-8852-dffd217a89f6&displaylang=ko)                                                               | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=ee7f8cc4-f7fd-4dc7-808c-436204ee80cb)                                                                           | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=16494dac-553a-4de9-b751-0d6b51cb43f0&displaylang=ko)                                     | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=cec582b3-e37f-448e-a5c3-6abdcee9e57c&displaylang=ko) | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=597b2310-2cd8-4d0f-8248-781eb8b7450a&displaylang=ko)\*                | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=67119fb6-e517-46f4-ab0b-2351cdc3d670&displaylang=ko)\*            | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f90fc0c8-babe-4224-be07-614ea7ddf102)                     | 원격 코드 실행 | 중요        | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=122fc003-0651-4ad2-a5c8-a21536defad8&displaylang=ko)                                                                                | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=3e096468-db6c-45c6-bee5-eaeaa63500b5&displaylang=ko)                                                                              | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=dc757b6d-f0f8-4e71-ab6f-1417233eedf9&displaylang=ko)\*                                                               | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=d5b0b1eb-24f3-47ec-aba1-c1b95400189e)                                                                            | 원격 코드 실행 | 중요        | 없음                                                                |
...
아니요. Microsoft 보안 공지 [MS10-006](http://technet.microsoft.com/security/bulletin/ms10-006), "SMB 클라이언트의 취약점으로 인한 원격 코드 실행 문제점"은 다른 SMB 구성 요소를 해결합니다. 이 보안 업데이트는 다른 업데이트와 별도로 적용할 수 있습니다.

**MS10-006 업데이트를 설치한 경우에도 여전히 이 업데이트를 설치해야 합니까? **
예. 이 보안 공지 업데이트는 Windows SMB 서버 구성 요소의 취약점을 해결하고, [MS10-006](http://technet.microsoft.com/security/bulletin/ms10-006)는 Windows SMB 클라이언트 구성 요소의 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0020 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0020)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0021 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0021)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0022 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0231 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0231)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 971468](http://support.microsoft.com/kb/971468) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/971468">Microsoft 기술 자료 문서 971468</a> 참조</td>
</tr>
<tr class="even">
...
-   SMB 경로 이름 오버플로 취약점(CVE-2010-0020)을 보고해 주신 [Codenomicon (영문)](http://www.codenomicon.com/)의 Joshua Morin  
-   SMB 메모리 손상 취약점(CVE-2010-0021)을 보고해 주신 [BSI (영문)](http://www.bsi.bund.de/)의 Florian Rienhardt  
