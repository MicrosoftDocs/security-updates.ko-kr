...
ms:contentKeyID: 18135534
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc708482(v=WS.10)'
---
...
-   For step-by-step guidance for getting started, including installing WSUS, setting up a client computer, and deploying your first set of updates, see [Microsoft Windows Server Update Services 3.0 시작을 위한 단계별 가이드](https://technet.microsoft.com/a68a19d2-630e-45d6-b596-d24dac987b64)(http://go.microsoft.com/fwlink/?LinkID=41774).
