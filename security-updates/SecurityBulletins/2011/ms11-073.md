---
TOCTitle: 'MS11-073'
Title: 'Microsoft 보안 공지 MS11-073 - 중요'
ms:assetid: 'ms11-073'
ms:contentKeyID: 61230440
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-073(v=Security.10)'
---


Microsoft 보안 공지 MS11-073 - 중요
===================================

Microsoft Office의 취약점으로 인한 원격 코드 실행 문제점 (2587634)
------------------------------------------------------------------
...
이 보안 업데이트의 심각도는 Microsoft Office 2003, Microsoft Office 2007 및 Microsoft Office 2010의 지원되는 모든 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 Microsoft Office가 외부 라이브러리를 로드하고 개체를 초기화하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 제품군</td>
<td style="border:1px solid black;">Microsoft Office 제품군</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7faa2f90-2e64-4dbf-ac93-bb8cffc9b5fe&amp;displaylang=ko">Microsoft Office 2003 서비스 팩 3</a><br />
(KB2584052)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=34bbee95-0e83-4705-8bfe-02e4fb22f8e7&amp;displaylang=ko">Microsoft Office 2007 서비스 팩 2</a><br />
(KB2584063)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-023">MS11-023</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c8fd04a-9df6-4726-a9bc-811f49665981&amp;displaylang=ko">Microsoft Office 2010(32비트 에디션)</a><br />
(KB2584066)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-087">MS10-087</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c8fd04a-9df6-4726-a9bc-811f49665981&amp;displaylang=ko">Microsoft Office 2010 서비스 팩 1(32비트 에디션)</a><br />
(KB2584066)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=85360dc1-99e7-4e3e-be6f-3795e8a8122f&amp;displaylang=ko">Microsoft Office 2010(64비트 에디션)</a><br />
(KB2584066)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms10-087">MS10-087</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=85360dc1-99e7-4e3e-be6f-3795e8a8122f&amp;displaylang=ko">Microsoft Office 2010 서비스 팩 1(64비트 에디션)</a><br />
(KB2584066)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<th style="border:1px solid black;" >Office 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1980)</th>
<th style="border:1px solid black;" >Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
Office 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1980)  
----------------------------------------------------------------------
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1980 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1980)을 참조하십시오.
  
#### Office 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1980)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격이 성공하려면 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문한 후 Office 관련 파일(.doc 파일 등)을 열어야 합니다.  
...
#### Office 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1980)에 대한 대안
...
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Word\Security\FileOpenBlock]&quot;BinaryFiles&quot;=dword:00000001</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Excel 2003</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]&quot;BinaryFiles&quot;=dword:00000001</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft PowerPoint 2003</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\PowerPoint\Security\FileOpenBlock]&quot;BinaryFiles&quot;=dword:00000001</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2007</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00<br />
<br />
[HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0Word\Security\FileOpenBlock]<br />
<br />
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Word 2003</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Word\Security\FileOpenBlock]&quot;BinaryFiles&quot;=dword:00000000</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Excel 2003</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]&quot;BinaryFiles&quot;=dword:00000000</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft PowerPoint 2003</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\PowerPoint\Security\FileOpenBlock]&quot;BinaryFiles&quot;=dword:00000000</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2007</td>
<td style="border:1px solid black;">Windows 레지스트리 편집기 버전 5.00<br />
...
-   WebClient 서비스 사용 안 함
    ...
    8.  을 클릭합니다.
    9.  WebClient
    10. 서비스를 마우스 오른쪽 단추로 클릭한 다음
    11. 속성
    12. 을 선택합니다.
    13. 시작 유형을 사용 안 함으로 변경합니다. 서비스가 실행 중인 경우 중지를 클릭합니다.
    14. 확인
    15. 을 클릭하고 관리 응용 프로그램을 종료합니다.
    ...
    11. 속성
    12. 을 선택합니다.
    13. 시작 유형을 자동으로 변경합니다. 서비스가 실행 중인 경우 시작을 클릭합니다.
    14. 확인
    15. 을 클릭하고 관리 응용 프로그램을 종료합니다.
...
#### Office 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1980)에 대한 FAQ
...
취약점의 원인은 무엇입니까?  
이 취약점은 Microsoft Office가 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.

Microsoft Office는 어떻게 이 취약점의 영향을 받습니까?  
알려진 공격 경로는 특정 Microsoft Office 바이너리 형식에서만 이용할 수 있지만 취약한 코드는 Microsoft Office의 공유 구성 요소에 존재합니다.
...
이 취약점은 Office 파일 유효성 검사 추가 기능이 설치되어 있지 않을 때 .doc, .xls, .ppt Office 바이너리 형식에만 영향을 미칩니다.

공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 Office 관련 파일(.doc 파일 등)을 열도록 유도할 수 있습니다. 이렇게 하면 합법적인 파일을 열 때 Microsoft Office가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.

전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 Office 관련 첨부 파일(.doc 파일 등)을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 합법적인 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 이렇게 하면 합법적인 파일을 열 때 Microsoft Office가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.

네트워크 공격 시나리오에서 공격자는 합법적인 Office 관련 파일 및 특수하게 조작된 DLL을 네트워크 공유, UNC 또는 WebDAV 위치에 두고 사용자가 파일을 열도록 유도할 수 있습니다.

Microsoft Office 파일 유효성 검사 추가 기능이란 무엇입니까?  
Office 파일 유효성 검사는 Office 2003 및 2007용 보안 추가 기능입니다. Office 파일 유효성 검사는 바이너리 파일 형식 파일이 Microsoft Office 파일 형식에 맞는지 확인하는 데 사용됩니다. 파일이 해당 형식에 맞지 않으면 보안이 위험할 수 있다는 알림이 제공됩니다. 이 추가 기능에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)에서 찾을 수 있습니다.
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Microsoft Office가 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다.

이 취약점은 Microsoft 보안 권고 2269637과 관련이 있습니까?  
예, 이 취약점은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/ko-kr/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
...
Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)
--------------------------------------------------------
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1982 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1982)를 참조하십시오.

#### Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)에 대한 완화 요소
...
#### Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)에 대한 대안
...
Microsoft Word 2010을 열고 다음 단계를 수행하십시오.
...
9.  보안 센터 설정
10. 을 클릭합니다.
11. 보안 센터에서 파일 차단 설정을 클릭합니다.
12. 다음 파일 형식에 대해 열기 확인란이 선택되어 있는지 확인합니다.
Microsoft Word 2010:
- Word 2003 바이너리 문서 및 서식 파일
- Word XP 바이너리 문서 및 서식 파일
- Word 2000 바이너리 문서 및 서식 파일
- Word 97 바이너리 문서 및 서식 파일
- Word 95 바이너리 문서 및 서식 파일
- Word 6.0 바이너리 문서 및 서식 파일
- Word 2 이상 바이너리 문서 및 서식 파일
13. 선택한 파일 형식에 대한 열기 동작에서 "선택한 파일 형식 열지 않음" 또는 "선택한 파일 형식을 제한된 보기에서 열기"를 선택합니다. 두 옵션 모두 취약한 코드에 대한 공격 경로를 차단합니다.
14. 확인
15. 을 클릭하여 파일 차단 설정을 적용합니다.

또는 그룹 정책을 사용하여 파일 차단을 적용할 수 있습니다. 자세한 내용은 TechNet 문서, [Office 2010의 파일 차단 설정 계획 (영문)](https://technet.microsoft.com/en-us/library/cc179230.aspx)을 참조하십시오.
...
10. 을 클릭합니다.
11. 보안 센터에서 파일 차단 설정을 클릭합니다.
12. 이전에 선택한 파일 형식에 대한 열기 확인란의 선택을 취소합니다.
13. 확인
14. 을 클릭하여 파일 차단 설정을 적용합니다.

-   신뢰할 수 없는 출처
-   에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Office 파일을 열지 않음

    신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Office 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)에 대한 FAQ
...
공격자는 이러한 취약점을 어떻게 악용합니까?  
이 취약점을 악용하려면 사용자가 특수하게 조작된 Word 파일을 영향을 받는 Microsoft Office 버전에서 열어야 합니다.
...
취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?  
워크스테이션과 같이 Microsoft Office가 사용되는 시스템이 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

업데이트는 어떤 기능을 수행합니까?  
업데이트는 Microsoft Office가 개체를 초기화하는 방식을 수정하여 이 취약점을 해결합니다.
...
해당 조직에서 서버, 데스크톱, 모바일 시스템에 적용해야 하는 소프트웨어 및 보안 업데이트를 관리합니다. 자세한 내용은 [TechNet Update Management Center](https://technet.microsoft.com/ko-kr/updatemanagement/bb245732)를 참조하십시오. [Microsoft TechNet Security 웹 사이트](https://technet.microsoft.com/ko-kr/security/default.aspx)에서는 Microsoft 제품의 보안에 관한 추가 정보를 제공합니다.
...
SMS에 대한 자세한 내용은 [SMS 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=21158)를 참조하십시오.
...
-   지원 대상인 Microsoft Office 버전에 네트워크 설치 지점을 만드는 방법에 대한 자세한 내용은 [Microsoft Office의 네트워크 설치 지점 만들기 (영문)](https://technet.microsoft.com/en-us/library/cc179063.aspx)를 참조하십시오.
...
<td style="border:1px solid black;">경우에 따라 이 업데이트를 적용한 다음 컴퓨터를 다시 시작할 필요가 없을 수 있습니다. 하지만 필요한 파일이 사용 중이면 이 업데이트를 설치한 후 다시 시작해야 합니다. 이 동작이 발생할 경우 다시 시작하도록 권고하는 메시지가 나타납니다.<br />
<br />
다시 시작이 필요한 상황을 줄이려면 보안 업데이트를 설치하기 전에 영향 받는 모든 서비스를 중지하고 영향을 받는 파일이 사용될 수 있는 모든 응용 프로그램을 닫으십시오. 컴퓨터를 다시 시작하라는 메시지가 나타나는 이유에 대한 자세한 내용은 <a href="https://support.microsoft.com/kb/887012">Microsoft 기술 자료 문서 887012</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판에서 프로그램 추가/제거 도구를 사용하십시오.<br />
<br />
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2584052">Microsoft 기술 자료 문서 2584052</a> 참조</td>
</tr>
<tr class="even">
...
-   파일 버전 확인
    ...
    8.  을 클릭합니다.  
    9.  일반  
    10. 탭에 표시된 파일 크기를 공지 KB 문서에 제공된 파일 정보 표와 비교합니다.  
    11. 세부 정보  
    12. 탭 및 비교 정보를 클릭하여 파일 버전과 수정된 날짜를 공지 KB 문서에 제공된 파일 정보 표와 비교할 수도 있습니다.  
    13. 마지막으로, 이전 버전 탭을 클릭하여 표시된 이전 파일 버전의 파일 정보를 새 파일 또는 업데이트된 파일 버전의 파일 정보와 비교할 수도 있습니다.
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2584063">Microsoft 기술 자료 문서 2584063</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Microsoft Office 2010 및 Microsoft Office 2010 서비스 팩 1(32비트 에디션):<br />
Office2010-kb2584066-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 2010 및 Microsoft Office 2010 서비스 팩 1(64비트 에디션):<br />
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2584066">Microsoft 기술 자료 문서 2584066</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Office 구성 요소 비보안 라이브러리 로드 취약점(CVE-2011-1980)을 [Secunia Research (영문)](https://secunia.com/)와 협력하여 보고해 주신 Parvez Anwar  
-   Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)을 보고해 주신 [CERT/CC (영문)](https://www.cert.org/)의 David Warren
