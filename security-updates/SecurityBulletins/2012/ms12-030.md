...
<td style="border:1px solid black;">
[MS11-096](http://go.microsoft.com/fwlink/?linkid=232696)의 KB2596954는 KB2597086으로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047)의 KB2553073은 KB2597161로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047)의 KB2553070은 KB2597166으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-094](http://go.microsoft.com/fwlink/?linkid=232493)의 KB2644354는 KB2665346으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-089](http://go.microsoft.com/fwlink/?linkid=225739)의 KB2644347은 KB2665351로 대체되었습니다.
</td>
</tr>
<tr>
<th style="border:1px solid black;" colspan="5">
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047)의 KB2553075는 KB2596842로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047)의 KB2553074는 KB2597162로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
이 공지에서 제공하는 Microsoft Office 2008 for Mac(KB2665346) 및 Microsoft Office for Mac 2011(KB2665351)용 보안 업데이트 패키지는 [MS12-029](http://go.microsoft.com/fwlink/?linkid=248419) 보안 공지에서 설명하는 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0141(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0141)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0142(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0142)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0143(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)을 참조하십시오.
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-0143(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0184(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0184)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0185(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0185)를 참조하십시오.
...
-   Excel 2007에서 유효성 검사에 실패하는 파일을 열지 못하도록 Office 파일 유효성 검사 설정
    ...
    참고 이 대안을 적용하기 전에 해당 버전의 Microsoft Office에 대해 Office 파일 유효성 검사를 사용하도록 설정되어 있어야 합니다. Microsoft Office 2007에서 Office 파일 유효성 검사를 사용하도록 설정하는 방법에 대한 자세한 내용은 TechNet 문서 [Office 2003 및 Office 2007용 Office 파일 유효성 검사(영문)](http://technet.microsoft.com/ko-kr/library/gg985445(office.12).aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1847(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1847)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2597086">Microsoft 기술 자료 문서 2597086</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="http://support.microsoft.com/kb/2597161">Microsoft 기술 자료 문서 2597161</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 2007의 경우 <a href="http://support.microsoft.com/kb/2597969">Microsoft 기술 자료 문서 2597969</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="http://support.microsoft.com/kb/2596842">Microsoft 기술 자료 문서 2596842</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 호환 기능 팩의 경우 <a href="http://support.microsoft.com/kb/2597162">Microsoft Knowledge Base Article 2597162</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2597166">Microsoft 기술 자료 문서 2597166</a> 및 <a href="http://support.microsoft.com/kb/2553371">Microsoft 기술 자료 문서 2553371</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Excel 파일 형식 메모리 손상 취약점(CVE-2012-0141)을 보고해 주신 [Omair(영문)](http://krash.in/)  
-   OBJECTLINK 레코드의 Excel 파일 형식 메모리 손상 취약점(CVE-2012-0142)을 보고해 주신 [Omair(영문)](http://krash.in/)  
-   Excel SXLI 레코드 메모리 손상 취약점(CVE-2012-0184)을 [VeriSign iDefense Labs(영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 Omair  
-   Excel MergeCells 레코드 힙 오버플로 취약점(CVE-2012-0185)을 [VeriSign iDefense Labs(영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 Sean Larsson 및 Jun Mao  
-   Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)을 [VeriSign iDefense Labs(영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 Sean Larsson 및 Jun Mao  
-   Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)을 [TippingPoint(영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
