...
-   Microsoft Windows XP 서비스 팩 1 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f6328f82-457e-44cb-95fb-2db0e8c9ee3c)
-   Microsoft Windows XP 서비스 팩 2 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=71022ea1-94cb-4fe9-b89e-46876d068b9a)
-   Microsoft Windows XP Professional x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=a386523e-96ab-43ed-b189-e13af497b685)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=56df0cf2-9214-4b23-9034-c59e8b7126d6)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=5e1b95c3-7e75-4468-829c-1dc7b4ece5d0)
-   Microsoft Windows Server 2003 x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=4dc13b7c-01ab-4bb6-9766-0fe0d02e410d)
...
-   [Windows 2000 AOL 이미지 지원 업데이트 (영문)](https://www.microsoft.com/windows2000/downloads/recommended/aolfix/default.asp)가 설치된 Windows 2000:
    -   Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 5.01 서비스 팩 4 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ae6d8da7-b170-416d-8812-265ffa757301)
    -   Microsoft Windows 2000 서비스 팩 1에 설치된 Internet Explorer 6 서비스 팩 4 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f6328f82-457e-44cb-95fb-2db0e8c9ee3c)
...
|--------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------|--------------|-------------------------------------------------------------|------------------------|------------------------|---------------------|---------------------------------|
| ART 이미지 렌더링 취약점 - [CVE-2006-2378 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2378) | 원격 코드 실행       | 긴급                  | 없음         | 긴급                                                        | 긴급                   | 긴급                   | 긴급                | 긴급                            |
...
예. 이 보안 공지에서 해결된 취약점이 Windows 98, Windows 98 Second Edition 및 Windows Millennium Edition에 심각한 영향을 줍니다. 이러한 플랫폼을 위한 긴급 보안 업데이트가 이 보안 공지의 일부로 제공되며, [Windows Update 웹 사이트](https://windowsupdate.microsoft.com/)에서만 다운로드할 수 있습니다. 심각도에 대한 자세한 내용은 다음 [웹 사이트](https://technet.microsoft.com/security/bulletin/rating)를 참조하십시오.
...
-   Windows 2000에서는 기본적으로 AOL ART 이미지를 지원하지 않습니다. Windows 2000은 [Windows 2000 AOL 이미지 지원 업데이트 (영문)](https://www.microsoft.com/windows2000/downloads/recommended/aolfix/default.asp)가 설치된 경우에만 영향을 받습니다. 이 AOL 이미지 지원 업데이트가 설치되지 않는 Windows 2000 시스템에는 이 보안 업데이트로 업데이트되는 파일이 없습니다.
...
[Microsoft 보안 공지 MS06-021: Internet Explorer 누적 보안 업데이트(916281)](https://technet.microsoft.com/security/bulletin/ms06-021) 설치 후에는 ART 파일이 더 이상 Internet Explorer에 표시되지 않습니다.
...
**참고** [Microsoft 보안 공지 MS06-021: Internet Explorer 누적 보안 업데이트(916281)](https://technet.microsoft.com/security/bulletin/ms06-021) 설치 후에는 ART 파일이 더 이상 Internet Explorer에 표시되지 않습니다. 두 가지 업데이트를 모두 설치할 것을 권장합니다.
...
Windows 2000에서는 기본적으로 AOL ART 이미지를 지원하지 않습니다. Windows 2000은 [Windows 2000 AOL 이미지 지원 업데이트 (영문)](https://www.microsoft.com/windows2000/downloads/recommended/aolfix/default.asp)가 설치된 경우에만 영향을 받습니다.
...
-   ART 이미지 렌더링 취약점(CVE-2006-2378)을 보고해 주신 [iDEFENSE. (영문)](https://www.idefense.com/)
