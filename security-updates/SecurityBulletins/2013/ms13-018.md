---
TOCTitle: 'MS13-018'
Title: 'Microsoft 보안 공지 MS13-018 - 중요'
ms:assetid: 'ms13-018'
ms:contentKeyID: 61230568
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-018(v=Security.10)'
---

Microsoft 보안 공지 MS13-018 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows Server 2008, Windows Server 2008 R2 및 Windows Server 2012에 대해 중요이며, 지원 대상인 모든 Windows Vista, Windows 7, Windows 8 및 Windows RT 에디션에 대해 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows TCP/IP 스택이 연결 종료 시퀀스를 처리하는 방법을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2790655](https://support.microsoft.com/kb/2790655)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=80b766e7-3b7f-4d04-9a80-71864a13df8c)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[MS12-032](https://go.microsoft.com/fwlink/?linkid=246964)의 KB2688338
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=92bad797-5b66-422c-a096-8070d02bb8b2)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c24aa6f3-82a5-4b1f-adc8-4aece948161c)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2738fbe4-2163-4e77-82e6-208a7a08a70c)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=cb4270c4-cec5-49e0-a56b-97539d6352a0)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cb4270c4-cec5-49e0-a56b-97539d6352a0)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5d93cb19-7854-4b49-9743-8d6a11be2dd6)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=5d93cb19-7854-4b49-9743-8d6a11be2dd6)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=e7739ba6-9c62-4180-a095-47fdb6c741e9)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows 8(64비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=dd2042b8-c784-4dfc-8fca-61905693cda5)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c24aa6f3-82a5-4b1f-adc8-4aece948161c)(Server Core 설치)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2738fbe4-2163-4e77-82e6-208a7a08a70c)(Server Core 설치)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01)(Server Core 설치)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01)(Server Core 설치)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=f74a104d-4749-4dd5-b144-2e4ce9c284a2)(Server Core 설치)  
(KB2790655)
</td>
<td style="border:1px solid black;">
서비스 거부
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2790655](https://support.microsoft.com/kb/2790655)를 참조하십시오.
...
<th style="border:1px solid black;" >
TCP FIN WAIT 취약점(CVE-2013-0075)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
Windows TCP/IP 스택에는 대상 시스템에서 응답을 중지하거나 자동으로 다시 시작하도록 만드는 서비스 거부 취약점이 존재합니다. 이 취약점은 TCP/IP 스택이 연결 종료 시퀀스를 부적절하게 처리할 때 발생합니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0075)를 참조하십시오.

#### TCP FIN WAIT 취약점(CVE-2013-0075)에 대한 완화 요소

이 취약점에 대해 확인된 완화 요소가 없습니다.

#### TCP FIN WAIT 취약점(CVE-2013-0075)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### TCP FIN WAIT 취약점(CVE-2013-0075)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 서비스 거부 취약점입니다.

**취약점의 원인은 무엇입니까?**  
이 취약점은 Windows TCP/IP 스택이 연결 종료 시퀀스를 부적절하게 처리할 때 발생합니다.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
이 취약점 악용에 성공한 공격자는 대상 시스템에서 응답을 중지하거나 자동으로 다시 시작하도록 만들 수 있습니다.

**공격자는 이러한** **취약점을 어떻게 악용합니까?**  
인증되지 않은 공격자는 특수하게 조작된 연결 종료 패킷을 서버에 전송하여 이 취약점을 악용할 수 있습니다.

**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
주로 서버가 이 취약점으로 인한 위험에 노출됩니다.

**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Windows TCP/IP 스택이 연결 종료 시퀀스를 처리하는 방법을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2790655">Microsoft 기술 자료 문서 2790655</a> 참조</td>
</tr>
<tr class="odd">
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2790655](https://support.microsoft.com/kb/2790655) 참조                                                  |
...
-   V1.1(2013년 2월 12일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2790655 링크가 추가되었습니다.
