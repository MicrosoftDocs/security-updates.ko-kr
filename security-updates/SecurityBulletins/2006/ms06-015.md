...
**주의 사항:** [Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)에 나와 있습니다. 이 문서에는 이러한 문제점에 대한 권장 해결 방법도 나와 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)를 참조하십시오.
...
|-----------------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| Windows 셸 취약점 - [CVE-2006-0012 (영문)](http://www.microsoft.com/technet/prodtechnol/windows2000serv/howto/grpolwt.mspx) | 원격 코드 실행       | 긴급                  | 긴급         | 긴급                   | 긴급                   | 긴급                | 긴급                            |
...
**참고** MS06-015 업데이트를 적용했지만 [Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)에서 설명한 문제가 발생하지 않은 고객은 조치를 취할 필요가 없습니다.

**개정된 보안 업데이트에는 어떤 변경 사항이 포함되어 있습니까**?  
개정된 보안 업데이트는 최초 보안 업데이트의 바이너리에 대한 변경 사항을 포함하지 않습니다. 설치 도중 개정된 보안 업데이트는 [Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)에 설명되어 있는 다음과 같은 항목을 허용 목록에 추가합니다.
...
검색 로직이 업데이트된 MBSA(Microsoft Baseline Security Analyzer) 1.2.1의 경우 최초 보안 업데이트가 설치되지 않는 컴퓨터에만 개정된 패키지가 제공됩니다. MBSA 1.2.1을 사용하여 확인된 타사 COM 컨트롤이 설치되어 있는지 검색할 수 없습니다. MBSA 1.2.1을 사용하고 있고 이러한 문제가 발생한 고객은 [Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)에서 설명한 대로 그룹 정책 또는 스크립팅을 사용하여 이러한 COM 컨트롤을 허용 목록에 수동으로 추가해야 합니다.

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 현재 알려진 문제점은 무엇입니까?**  
[Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)에 나와 있습니다. 이 문서에는 이러한 문제점에 대한 권장 해결 방법도 나와 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 918165](http://support.microsoft.com/kb/918165)를 참조하십시오.
...
[웹 사이트](http://technet.microsoft.com/security/bulletin/rating)를 참조하십시오.
...
예. MBSA 2.0을 사용하면 이 업데이트의 필요 여부를 확인할 수 있습니다. MBSA 2.0은 Microsoft Update가 지원하는 제품용 보안 업데이트를 검색할 수 있습니다. MBSA에 대한 자세한 내용은 [MBSA 웹 사이트 (영문)](http://www.microsoft.com/korea/technet/security/tools/mbsahome.asp)를 참조하십시오.
...
SMS에서 Security Update Inventory Tool을 사용하여 [Windows Update](http://update.microsoft.com/microsoftupdate)에서 제공하고 [Software Update Services](http://www.microsoft.com/korea/windowsserversystem/updateservices/evaluation/previous/default.mspx)에서 지원하는 보안 업데이트와 MBSA 1.2.1에서 지원하는 다른 보안 업데이트를 검색할 수 있습니다. Security Update Inventory Tool에 대한 자세한 내용은 다음 [Microsoft 웹 사이트](http://www.microsoft.com/smserver/downloads/2003/featurepacks/suspack)를 참조하십시오. Security Update Inventory Tool의 제한 사항에 대한 자세한 내용은 [Microsoft 기술 자료 문서 306460](http://support.microsoft.com/kb/306460)을 참조하십시오.

Microsoft Updates용 SMS 2003 Inventory Tool은 [Microsoft Update](http://update.microsoft.com/microsoftupdate)에서 제공하고 [Windows Server Update Services](http://www.microsoft.com/korea/windowsserversystem/updateservices/evaluation/overview.mspx)에서 지원하는 보안 업데이트를 SMS에서 발견하는 데 사용할 수 있습니다. Microsoft Updates용 SMS 2003 Inventory Tool에 대한 자세한 내용은 다음 [Microsoft 웹 사이트](http://go.microsoft.com/fwlink/?linkid=50757)를 참조하십시오.
...
-   **그룹 정책 설정을 사용하여 이 기능이 필요하지 않은 모든 영향을 받는 시스템에서 웹 클라이언트 서비스를 사용하지 않도록 설정합니다.**  
    ...
    **참고**[Windows Server 2003 보안 가이드 (영문)](http://www.microsoft.com/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx)도 참조하십시오. 이 가이드에는 서비스 비활성화 방법에 대한 정보가 포함되어 있습니다.
...
-   Windows 셸 취약점(CVE-2006-0012)을 보고해 주신 [NISCC (영문)](http://www.niscc.gov.uk/)
