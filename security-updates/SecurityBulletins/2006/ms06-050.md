---
TOCTitle: 'MS06-050'
Title: 'Microsoft 보안 공지 MS06-050 - 중요'
ms:assetid: 'ms06-050'
ms:contentKeyID: 61230011
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms06-050(v=Security.10)'
---

Microsoft 보안 공지 MS06-050 - 중요
===================================

Microsoft Windows 하이퍼링크 개체 라이브러리의 취약점으로 인한 원격 코드 실행 문제점(920670)
--------------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=bfe3f869-08be-4f13-97a1-7274ad44c7fb)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=2d014bac-f03d-474a-a7ab-49e8ead8edb0&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=cae094e4-64a0-4577-986b-4d6c131806d9)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=21d1e864-4517-4353-8477-b4cd3c6187c0&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=bc60b6c3-ada8-48ab-a63d-b2f1c9320b0d)
-   Microsoft Windows Server 2003 x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=9d2ba5d1-6f91-47b4-8cc1-dcd44baaa6ce)
...
이 업데이트는 새로 발견된 두 개의 취약점을 해결합니다. 각 취약점은 이 공지의 "취약점 세부 사항" 섹션의 해당 항목에 설명되어 있습니다.
...
공격자가 이 취약점을 악용하려면 사용자 개입이 필요합니다.

가능한 빨리 이 업데이트를 설치할 것을 권장합니다.

**심각도 및 취약점 확인:**

| 취약점                                                                                                                         | 취약점으로 인한 영향 | Windows 2000 서비스 팩 4 | Windows XP 서비스 팩 1 및 Windows XP 서비스 팩 2 | Windows Server 2003 및 Windows Server 2003 서비스 팩 1 |
|--------------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|--------------------------------------------------|--------------------------------------------------------|
| 하이퍼링크 개체 버퍼 오버플로 취약점 - [CVE-2006-3086 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086) | 원격 코드 실행       | 중요                     | 중요                                             | 중요                                                   |
| 하이퍼링크 개체 함수 취약점 - [CVE-2006-3438 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)          | 원격 코드 실행       | 중요                     | 중요                                             | 중요                                                   |
| **모든 취약점의 전체 심각도**                                                                                                  |                 | **중요**                 | **중요**                                         | **중요**                                               |
...
| 공지 번호                                                               | Windows 2000 | Windows XP 서비스 팩 1 및 Windows XP 서비스 팩 2 | Windows Server 2003 | Windows Server 2003 서비스 팩 1 |
|-------------------------------------------------------------------------|--------------|--------------------------------------------------|---------------------|---------------------------------|
| [**MS05-015**](https://technet.microsoft.com/security/bulletin/ms05-015) | 대체됨       | 대체됨                                           | 대체됨              | 해당 사항 없음                  |
...
#### 하이퍼링크 COM 개체 버퍼 오버플로 취약점 - CVE-2006-3086:

원격 코드 실행 취약점이 하이퍼링크 개체 라이브러리에 존재합니다. 하이퍼링크 처리에 사용되는 코드에서 검사되지 않은 버퍼 때문에 문제점이 존재합니다. 공격자는 사용자가 Office 파일 또는 메일 메시지에 포함된 악의적인 링크를 클릭하면 원격 코드를 실행할 수 있는 악의적인 하이퍼링크를 구성하여 이 취약점을 악용할 수 있습니다. 이 취약점을 성공적으로 악용한 경우 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이 취약점을 악용하려면 사용자 개입이 필요합니다.

#### 하이퍼링크 COM 개체 버퍼 오버플로 취약점 - CVE-2006-3086에 대한 완화 요소:

-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 공격이 성공하려면 사용자가자 전자 메일 메시지를 클릭하거나 Office 파일을 열고 해당 파일 내의 링크를 클릭하도록 공격자가 유도해야 합니다.

#### 하이퍼링크 COM 개체 버퍼 오버플로 취약점 - CVE-2006-3086에 대한 대안:

Microsoft는 다음과 같은 대안을 테스트했습니다. 이러한 대안이 취약점 자체를 해결하지는 않지만 알려진 공격 경로를 차단하는 데 도움이 됩니다. 대안으로 모든 공격 경로를 차단할 수는 없습니다. 대안으로 인해 기능이 저하되는 경우는 아래 섹션에 별도로 표시하였습니다.

-   **모든 사용자가 Hlink.dll에 액세스할 수 없도록 ACL(액세스 제어 목록) 수정**
    Hlink.dll 레지스트리 키를 사용하지 않도록 설정하면 이 취약점을 악용하려는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다. Hlink.dll 레지스트리 키를 수정하려면:

    -   **시작**, **실행**을 차례로 클릭하고 **cacls "%windir%\\system32\\hlink.dll" /d everyone**(따옴표 없이)을 입력한 다음 **확인**을 클릭합니다.

    **대안의 영향:** Office 응용 프로그램 사용자는 하이퍼링크를 편집하거나 Office 문서에 포함된 하이퍼링크를 클릭할 수 없게 됩니다.

-   **HLINK 레지스트리 키를 사용하지 않도록 ACL(액세스 제어 목록) 수정**
    “**HLINK**” 레지스트리 키의 액세스 제어 목록을 수정하면 이 취약점을 악용하려는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다. 레지스트리 키를 수정하려면 다음 절차를 수행하십시오.
    ...
    **참고** 나중에 원래 값으로 복원할 수 있도록 대화 상자에 나열된 사용 권한을 적어 놓으십시오.
    ...
    2.  **HKEY\_CLASSES\_ROOT**, **CLSID**를 차례로 확장한 다음 **{79eac9d0-baf9-11ce-8c82-00aa004ba90b}**를 클릭합니다.
    ...
    **참고** 나중에 원래 값으로 복원할 수 있도록 대화 상자에 나열된 사용 권한을 적어 놓으십시오.
    ...
    6.  이 레지스트리 키에 아무도 액세스할 수 없게 된다는 메시지가 표시됩니다. **예**, **확인**을 차례로 클릭하여 **{79eac9d0-baf9-11ce-8c82-00aa004ba90b} 사용 권한** 대화 상자를 닫습니다.
...
-   **출처를 신뢰할 수 없는 Microsoft Office 문서에 있는 하이퍼링크를 클릭하지 마십시오.**

#### 하이퍼링크 COM 개체 버퍼 오버플로 취약점 - CVE-2006-3086에 대한 FAQ:
...
하이퍼링크 개체 라이브러리는 응용 프로그램 프로그래밍 인터페이스의 모음입니다. 이러한 인터페이스는 소프트웨어 개발자에게 하이퍼링크 처리를 위한 기능을 제공합니다. 하이퍼링크에 대한 자세한 내용은 [제품 설명서 (영문)](https://msdn.microsoft.com/library/default.asp?url=/workshop/misc/hlink/overview/overview.asp)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호CVE-2006-3086이 지정되었습니다. 이 보안 공지에서는 공개 및 비공개적으로 보고된 취약점 및 내부 조사를 통해 발견된 추가적인 문제를 해결합니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 CVE-2006-3086이 지정되었습니다.

#### 하이퍼링크 개체 함수 취약점 - CVE-2006-3438:

원격 코드 실행 취약점이 하이퍼링크 개체 라이브러리에 존재합니다. 이 문제는 하이퍼링크 개체 라이브러리가 하이퍼링크를 처리할 때 조작된 함수를 포함하는 파일을 사용하기 때문에 존재합니다. 공격자는 사용자가 Office 파일 또는 메일 메시지에 포함된 악의적인 링크를 클릭하면 원격 코드를 실행할 수 있는 악의적인 하이퍼링크를 구성하여 이 취약점을 악용할 수 있습니다. 이 취약점을 성공적으로 악용한 경우 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이 취약점을 악용하려면 사용자 개입이 필요합니다.

#### 하이퍼링크 개체 함수 취약점 - CVE-2006-3438에 대한 완화 요소:

-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 공격이 성공하려면 사용자가자 전자 메일 메시지를 클릭하거나 Office 파일을 열고 해당 파일 내의 링크를 클릭하도록 공격자가 유도해야 합니다.

#### 하이퍼링크 개체 함수 취약점 - CVE-2006-3438에 대한 대안:
...
#### 하이퍼링크 개체 함수 취약점 - CVE-2006-3438에 대한 FAQ:
...
**WindowsServer2003-KB920670-x86-KOR /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB920670.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows Server 2003 명령 프롬프트에서 다음 명령을 사용하십시오.

**WindowsServer2003-KB920670-x86-KOR /norestart**
...
시스템 관리자는 Spuninst.exe 유틸리티를 사용하여 이 보안 업데이트를 제거할 수도 있습니다. Spuninst.exe 유틸리티는 %Windir%\\$NTUninstallKB920670$\\Spuninst 폴더에 있습니다.
...
|-----------|---------------|------------|-----------|--------|-----|--------|
| Hlink.dll | 5.2.3790.560  | 2006-07-18 | 오전 7:31 | 71,680 | x86 | RTMGDR |
| Hlink.dll | 5.2.3790.560  | 2006-07-18 | 오전 7:39 | 71,680 | x86 | RTMQFE |
| Hlink.dll | 5.2.3790.2748 | 2006-07-18 | 오전 7:43 | 72,192 | x86 | SP1GDR |
| Hlink.dll | 5.2.3790.2748 | 2006-07-18 | 오전 7:47 | 72,192 | x86 | SP1QFE |
...
-   **레지스트리 키 확인**
    ...
    **참고** 이 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자나 OEM이 920670 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이러한 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
...
**WindowsXP-KB920670-x86-KOR /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB920670.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows XP 명령 프롬프트에서 다음 명령을 사용하십시오.

**WindowsXP-KB920670-x86-KOR /norestart**
...
| 파일 이름 | 버전          | 날짜       | 시간      | 크기   | CPU | 폴더   |
|-----------|---------------|------------|-----------|--------|-----|--------|
| Hlink.dll | 5.2.3790.2748 | 2006-07-21 | 오후 5:31 | 72,192 | x86 | SP1QFE |
| Hlink.dll | 5.2.3790.2748 | 2006-07-21 | 오후 5:25 | 72,192 | x86 | SP2GDR |
| Hlink.dll | 5.2.3790.2748 | 2006-07-21 | 오후 5:28 | 72,192 | x86 | SP2QFE |
...
-   **레지스트리 키 확인**
    ...
    **참고** 이러한 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자나 OEM이 920670 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이러한 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
...
| 파일 이름 | 버전          | 날짜       | 시간      | 크기   |
|-----------|---------------|------------|-----------|--------|
| Hlink.dll | 5.2.3790.2748 | 2006-07-21 | 오후 8:39 | 72,704 |
...
-   하이퍼링크 개체 버퍼 오버플로 취약점([CVE-2006-3086 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086))을 보고해 주신 [TippingPoint Security Research Team (영문)](https://www.tippingpoint.com/security)의 Pedram Amini
-   하이퍼링크 개체 함수 취약점 - [CVE-2006-3438 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)을 보고해 주신 [CSC Australia Pty Limited (영문)](https://au.country.csc.com/en/)의 Steve Tai
-   **기타 보안 관련 업데이트 받기:**
...
-   V1.1 (2006년 9월 14일): 공지의 ‘보안 업데이트 정보’ 항목에서 Windows 2003에 대한 ‘레지스트리 키 확인’이 업데이트되었습니다.
