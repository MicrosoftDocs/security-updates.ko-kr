---
TOCTitle: 'MS11-078'
Title: 'Microsoft 보안 공지 MS11-078 - 긴급'
ms:assetid: 'ms11-078'
ms:contentKeyID: 61230445
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-078(v=Security.10)'
---


Microsoft 보안 공지 MS11-078 - 긴급
===================================

.NET Framework 및 Microsoft Silverlight의 취약점으로 인한 원격 코드 실행 문제점 (2604930)
-----------------------------------------------------------------------------------------

게시된 날짜: 2011년 10월 11일 화요일 | 업데이트된 날짜: 2012년 7월 11일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 및 Microsoft Silverlight 4에서 Microsoft .NET Framework 1.0 서비스 팩 3, Microsoft .NET Framework 1.1 서비스 팩 1, Microsoft .NET Framework 2.0 서비스 팩 2, Microsoft .NET Framework 3.5.1 및 Microsoft .NET Framework 4에 대해 긴급입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 .NET Framework에서 클래스 내의 상속을 제한하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2604930](https://support.microsoft.com/kb/2604930)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS09-061](https://technet.microsoft.com/ko-kr/security/bulletin/ms09-061)의 KB953295는 KB2572066으로 대체되었습니다.  
[MS10-070](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-070)의 KB2416447는 KB2572067로 대체되었습니다.  
[MS10-060](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-060)의 KB983583는 KB2572073로 대체되었습니다.  
KB2572078로 대체된 공지는 없습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-061](https://technet.microsoft.com/ko-kr/security/bulletin/ms09-061)의 KB953298는 KB2572069로 대체되었습니다.  
[MS10-060](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-060)의 KB983583는 KB2572073로 대체되었습니다.  
KB2572078로 대체된 공지는 없습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-070](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-070)의 KB2416447는 KB2572067로 대체되었습니다.  
[MS10-060](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-060)의 KB983589는 KB2572075로 대체되었습니다.  
KB2572078로 대체된 공지는 없습니다.
</td>
</tr>
<tr>
...
이 공지가 최초로 출시되었을 당시 Microsoft Silverlight의 최신 빌드인 Microsoft Silverlight build 4.0.60831은 취약점이 해결되었으며 영향을 받지 않습니다. 4.0.60831 이전의 Microsoft Silverlight 빌드는 영향을 받습니다.
...
이 보안 업데이트와 함께 설치되는 버전은 4.0.60831입니다. 사용 중인 제품 버전 번호가 이 버전 번호보다 높거나 같으면 시스템이 취약하지 않습니다.
...
Silverlight 5 베타 또는 RC(출시 후보) 버전이 이 취약점의 영향을 받습니까?  
아니요, 모든 버전의 Silverlight 5는 이 문제의 영향을 받지 않습니다.

이 공지의 영향을 받는 소프트웨어에 나열되지 않은 버전인 .NET Framework 3.0 서비스 팩 2를 설치했습니다. 이 경우 업데이트를 설치해야 합니까?  
이 공지는 .NET Framework 1.1, .NET Framework 2.0 및 .NET Framework 4 기능 계층의 취약점을 설명합니다. .NET Framework 3.0 서비스 팩 2 설치 프로그램은 .NET Framework 2.0 서비스 팩 2 설치에서 연계되므로 .NET Framework 3.0 서비스 팩 2을 설치하면 .NET Framework 2.0 서비스 팩 2도 설치됩니다. 따라서 .NET Framework 3.0 서비스 팩 2를 설치한 고객은 .NET Framework 2.0 서비스 팩 2용 보안 업데이트를 설치해야 합니다.

.NET Framework 3.5 서비스 팩 1을 설치했습니다. 다른 업데이트를 설치해야 합니까?  
이 공지에서는 .NET Framework 1.1, .NET Framework 2.0 기능 계층 및 .NET Framework 4의 취약점을 설명합니다. .NET Framework 3.5 서비스 팩 1 설치 프로그램은 .NET Framework 2.0 서비스 팩 2 설치 및 .NET Framework 3.0 서비스 팩 2 설치 모두에서 연계됩니다. 따라서 .NET Framework 3.5 서비스 팩 1을 설치한 고객은 .NET Framework 2.0 서비스 팩 2용 보안 업데이트를 설치해야 합니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-oct.mspx)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >
.NET Framework 클래스 상속 취약점(CVE-2011-1253)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
<tr>
<td style="border:1px solid black;">
32비트 시스템용 Windows Server 2008 서비스 팩 2에 설치된 Microsoft .NET Framework 4\*\*<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
x64 기반 시스템용 Windows Server 2008 서비스 팩 2에 설치된 Microsoft .NET Framework 4\*\*<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
긴급   
원격 코드 실행
...
Microsoft .NET Framework 및 Silverlight 프레임워크가 클래스 내의 상속을 제한하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 로그온한 사용자의 보안 컨텍스트에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1253)(영문)을 참조하십시오.

#### .NET Framework 클래스 상속 취약점(CVE-2011-1253)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   웹 탐색을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 보안 강화 구성으로 알려진 제한된 모드로 실행됩니다. 이 모드는 Windows Server 2008 및 Windows Server 2008 R2의 웹 탐색 공격 시나리오에서만 이 취약점을 완화합니다. Internet [Explorer 보안 강화](https://go.microsoft.com/fwlink/?linkid=92039) 구성에 대한 자세한 내용은 이 취약점의 FAQ 섹션을 참조하십시오.
...
#### .NET Framework 클래스 상속 취약점(CVE-2011-1253)에 대한 대안
...
-   Internet Explorer에서 Microsoft Silverlight ActiveX 컨트롤을 사용하지 않도록 임시로 설정(방법 1)
	...
	Windows 레지스트리편집기버전 5.00[HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Internet Explorer\\ActiveX Compatibility\\{DFEAF541-F3E1-4C24-ACAC-99C30715084A}]"Compatibility Flags"=dword:00000400
...
#### .NET Framework 클래스 상속 취약점(CVE-2011-1253)에 대한 FAQ
...
취약점의 원인은 무엇입니까?  
이 취약점은 .NET Framework가 클래스 내의 상속을 부적절하게 제안하기 때문에 발생합니다.
...
**Windows Server 2003 , Windows Server 2008 또는 Windows Server 2008 R2에서 Internet Explorer를실행하고있습니다. 이취약점이완화됩니까?**  
예. 기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. CVE-2011-1253의 경우 보안 강화 구성은 Windows Server 2008 및 Windows Server 2008 R2의 웹 탐색 공격 시나리오에서만 이 취약점을 완화합니다.

업데이트는 어떤 기능을 수행합니까?  
업데이트는 .NET Framework에서 클래스 내의 상속을 제한하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2604930">Microsoft 기술 자료 문서 2604930</a> 참조</td>
</tr>
<tr class="odd">
...
Microsoft .NET Framework 1.0 서비스 팩 3(KB2572066)용 업데이트 설치
...
Microsoft .NET Framework 1.1 서비스 팩 1(KB2572067)용 업데이트 설치
...
Microsoft .NET Framework 2.0 서비스 팩 2용 업데이트(KB2572073) 및 Microsoft .NET Framework 4용 업데이트(KB2572078) 설치
...
Microsoft .NET Framework 1.0 서비스 팩 3용 업데이트***(KB2572066)*** 제거
...
Microsoft .NET Framework 1.1 서비스 팩 1용 업데이트(KB***2572067)*** ***제거***
...
Microsoft .NET Framework 2.0 서비스 팩 2용 업데이트(KB2572073) 및 Microsoft .NET Framework 4.0용 업데이트(KB2572078) 제거
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2에 설치된 Microsoft .NET Framework 2.0 서비스 팩 2:<br />
NDP20SP2-KB2572073-x86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Microsoft .NET Framework 1.1 서비스 팩 1:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Microsoft .NET Framework 2.0 서비스 팩 2:<br />
NDP20SP2-KB2572073-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 Itanium 기반 에디션 서비스 팩 2에 설치된 Microsoft .NET Framework 1.1 서비스 팩 1:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 SP2(Itanium 기반 시스템용)에 설치된 Microsoft .NET Framework 2.0 서비스 팩 2:<br />
...
Windows Server 2003 서비스 팩 2 (KB2572069)***에***** Microsoft .NET Framework 1.1 서비스 팩 1 ***업데이트****설치*****

이 보안 업데이트는 Windows Server 2003 서비스 팩 2(KB2572069)의 Microsoft .NET Framework 1.1 서비스 팩 1에 다음 설치 스위치를 지원합니다.
...
Windows Server 2003 x64 Edition 서비스 팩 2 및 Windows Server 2003 Itanium 기반 에디션 서비스 팩 2 (KB2572067)의 Microsoft .NET Framework 1.1 서비스 팩 1용 업데이트 설치
...
Windows Server 2003 서비스 팩 2(KB2572069)에 Microsoft .NET Framework 1.1 서비스 팩 1 업데이트 제거
...
Windows Server 2003 x64 Edition 서비스 팩 2 및 Windows Server 2003 Itanium 기반 에디션 서비스 팩 2(KB2572067)에 설치된 Microsoft .NET Framework 1.1 서비스 팩 1용 업데이트 제거
...
Microsoft .NET Framework 2.0서비스 팩 2(KB2572075)용 업데이트 설치
...
<td style="border:1px solid black;">
/quiet와 함께 사용하면 설치 완료를 위해 다시 시작이 필수적인 경우에도 시스템이 설치 후 다시 시작되지 않습니다.
</td>
</tr>
</table>
...
Microsoft .NET Framework 4(KB2572078)용 업데이트 설치
...
Microsoft .NET Framework 2.0 서비스 팩 2(KB2572075)용 업데이트 설치
...
-   .NET Framework 클래스 상속 취약점(CVE-2011-1253)을 [Beyond Security's SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 프로그램과 협력하여 보고해 주신 익명 기여자
...
-   V1.0(2011년 10월 11일): 공지가 게시되었습니다.
-   V1.1(2011년 10월 19일): Microsoft .NET Framework 1.1 서비스 팩 1의 다시 시작하지 않고 설치 스위치 정보를 변경하였습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.
-   V1.2(2011년 10월 26일): Windows Server 2008 R2(x64 기반 시스템용)의 .NET Framework 4에 대한 Server Core 설치 적용 가능성이 수정되었습니다.
-   V1.3(2012년 7월 11일): Microsoft .NET Framework 2.0 서비스 팩 2에 대한 KB2572073의 제공 문제를 수정하기 위한 부분적인 검색 변경 사항을 알리기 위해 이 공지가 개정되었습니다. 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.
