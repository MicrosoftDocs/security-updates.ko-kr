...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 956803](http://support.microsoft.com/kb/956803)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9&displaylang=ko)                                    | 권한 상승      | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3)             | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074&displaylang=ko)                  | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25&displaylang=ko)      | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 SP1 (Itanium 기반 시스템용) 및 Windows Server 2003 SP2 (Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517) | 권한 상승      | 중요        | 없음                      |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 956803](http://support.microsoft.com/kb/956803)에 나와 있습니다.

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 문제점은 무엇입니까?**  
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 956803](http://support.microsoft.com/kb/956803)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3464 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464)를 참조하십시오.
...
**AFD 구성 요소란 무엇입니까?**    
AFD 구성 요소는 Windows 소켓 응용 프로그램을 지원하며 afd.sys 파일에 포함되어 있는 "ancillary function driver"를 제공합니다. afd.sys 드라이버는 커널 모드에서 실행되며 Winsock TCP/IP 통신 프로토콜을 관리합니다. 이 Winsock 커널 인터페이스를 통해 TDI 전송을 액세스할 수 있습니다. AFD 구성 요소에 대한 자세한 내용은 [Microsoft 웹 사이트 (영문)](http://msdn.microsoft.com/en-us/library/aa940505.aspx)를 참조하십시오.
  
**TDI 구성 요소란 무엇입니까?**  
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 [Microsoft 웹 사이트 (영문)](http://msdn.microsoft.com/en-us/library/ms801224.aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/956803">Microsoft 기술 자료 문서 956803</a> 참조</td>
</tr>
<tr class="even">
...
-   AFD 커널 덮어쓰기 취약점(CVE-2008-3464)을 보고해 주신 [SkyRecon (영문)](http://www.skyrecon.com/)의 Fabien Le Mentec
