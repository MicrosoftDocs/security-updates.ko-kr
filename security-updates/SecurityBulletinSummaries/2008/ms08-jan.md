...
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Windows TCP/IP의 취약점으로 인한 원격 코드 실행 문제점(941644)**](http://technet.microsoft.com/security/bulletin/ms08-001)                                                                                                                                                                                                           |
...
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**LSASS의 취약점으로 인한 로컬 권한 상승 문제점(943485)**](http://technet.microsoft.com/security/bulletin/ms08-002)                                                                                                                                                                                                                                                                                  |
...
Windows Server Update Services를 사용하여 이 보안 업데이트를 신속하게 배포하는 방법에 대한 자세한 내용은 [Windows Server Update Services (영문)](http://technet.microsoft.com/ko-kr/wsus/bb466208(en-us).aspx)를 참조하십시오.
...
-   [MS08-001](http://technet.microsoft.com/security/bulletin/ms08-001)에서 설명한 문제점을 보고해 주신 Alex Wheeler 및 Ryan Smith의 [IBM Internet Security Systems X-Force (영문)](http://www.iss.net/)
-   [MS08-001](http://technet.microsoft.com/security/bulletin/ms08-001)에서 설명한 문제점을 보고해 주신 Alex Wheeler 및 Ryan Smith의 [IBM Internet Security Systems X-Force (영문)](http://www.iss.net/)
-   [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002)에서 설명한 문제점을 보고해 주신 [SkyRecon (영문)](http://www.skyrecon.com/)의 Thomas Garnier
