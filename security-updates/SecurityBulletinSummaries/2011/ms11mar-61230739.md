...
2011년 3월 보안 공지 발표와 함께 이 공지 요약이 2011년 3월 3일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](http://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](http://go.microsoft.com/fwlink/?linkid=21163)을 참조하십시오.

Microsoft는 2011년 3월 9일 오전 11:00(태평양 표준시, 미국 및 캐나다)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [3월 보안 공지 웹캐스트에 지금 등록하십시오 (영문)](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032455049&eventcategory=4). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약 (영문)](http://technet.microsoft.com/security/bulletin/summary) 및 웹캐스트를 참조하십시오.
...
|---------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|-------------------------------------------------------------|  
| [MS11-016](http://technet.microsoft.com/security/bulletin/ms11-016) | Microsoft Groove의 안전하지 않은 라이브러리 로드 취약점 | [CVE-2010-3146 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146) | [1](http://technet.microsoft.com/security/cc998259.aspx) - 일관적인 악용 코드 가능       | **이 취약점은 공개되었으며 PoC 코드를 사용할 수 있습니다.** |  
| [MS11-017](http://technet.microsoft.com/security/bulletin/ms11-017) | 원격 데스크톱의 안전하지 않은 라이브러리 로드 취약점    | [CVE-2011-0029 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029) | [1](http://technet.microsoft.com/security/cc998259.aspx) - 일관적인 악용 코드 가능       | **이 취약점은 공개되었습니다.**                             |  
| [MS11-015](http://technet.microsoft.com/security/bulletin/ms11-015) | DirectShow의 안전하지 않은 라이브러리 로드 취약점       | [CVE-2011-0032 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032) | [1](http://technet.microsoft.com/security/cc998259.aspx) - 일관적인 악용 코드 가능       | **이 취약점은 공개되었으며 PoC 코드를 사용할 수 있습니다.** |  
| [MS11-015](http://technet.microsoft.com/security/bulletin/ms11-015) | DVR-MS 취약점                                           | [CVE-2011-0042 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0042) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - 일관적인 악용 코드 가능 | (없음)                                                      |
...
-   MS11-015에서 설명한 문제점을 보고해 주신 [Sourcefire VRT (영문)](http://www.sourcefire.com/services/sf_vrt.html)의 Matthew Watchinski
-   MS11-016에서 설명한 문제점을 보고해 주신 [Rapid 7 (영문)](http://www.rapid7.com/)의 HD Moore
-   MS11-017에서 설명한 문제점을 보고해 주신 [Versafe Anti Fraud (영문)](http://www.versafe-login.com/)의 Eyal Gruner
