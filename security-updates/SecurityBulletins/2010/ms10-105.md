---
TOCTitle: 'MS10-105'
Title: 'Microsoft 보안 공지 MS10-105 - 중요'
ms:assetid: 'ms10-105'
ms:contentKeyID: 61230365
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-105(v=Security.10)'
---


Microsoft 보안 공지 MS10-105 - 중요
===================================
...
이 보안 업데이트의 심각도는 Microsoft Works 9, Microsoft Office 변환 팩 및 지원 대상인 Microsoft Office XP 및 Microsoft Office 2003 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 업데이트는 Microsoft Office가 이미지를 렌더링할 때 특정 이미지 형식을 구문 분석하고 데이터 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 968095](https://support.microsoft.com/kb/968095)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Office 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=976857e9-77fc-4667-88ca-7637e57536cd&displaylang=ko)  
(KB2289163)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<sup>[1]</sup>표시된 소프트웨어를 사용하는 고객은 이 공지(MS10-105)에서 설명하는 취약점으로부터 보호하기 위해 MS10-087에서 제공하는 Microsoft Office 업데이트도 설치해야 합니다.
...
**이 공지(MS10-105)에서 설명하는 취약점으로부터 보호하기 위해 MS10-087 업데이트를 적용해야 합니까?**  
Microsoft Office XP 및 Microsoft Office 2003을 사용하는 고객은 이 공지(MS10-105)에서 설명하는 취약점으로부터 보호하기 위해 [MS10-087](https://go.microsoft.com/fwlink/?linkid=203241), Microsoft Office의 취약점으로 인한 원격 코드 실행 문제점(2423930)에서 제공하는 Microsoft Office 업데이트도 설치해야 합니다. MS10-087 및 MS10-105 업데이트를 모두 설치해야 하지만 일정한 순서에 따라 설치할 필요는 없습니다.
...
예. 이 업데이트에는 Microsoft Office 2007 및 Microsoft Office 2010에서 기본적으로 차단되는 변환기 및 필터 목록을 무시하기 위한 지원을 제공하는 비보안 변경 사항이 포함되어 있습니다. Microsoft Office 그래픽 필터용 보안 설정에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2479871](https://support.microsoft.com/kb/2479871)을 참조하십시오.

**이 업데이트에 기능에 대한 보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 Microsoft Office 2007 및 Microsoft Office 2010에서 기본적으로 차단되는 변환기 및 필터 목록을 확장하는 심층 보안 업데이트가 포함되어 있습니다.
...
Microsoft Office 독립 실행형 프로그램은 Microsoft Office 제품군의 해당 구성 요소와 동일한 심각도 등급으로 영향을 받습니다. 예를 들어 독립 실행형 Microsoft Excel, Microsoft Word 또는 Microsoft PowerPoint 설치는 영향을 받는 Microsoft Office 제품군 설치와 동일한 수준의 심각도로 영향을 받습니다.
...
Microsoft Office에서 CGM 이미지 파일을 처리할 때 버퍼 크기를 할당하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 CGM 이미지를 포함하는 Office 문서를 열 경우 원격 코드 실행이 허용될 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3945 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3945)를 참조하십시오.

#### CGM 이미지 변환기 버퍼 오버런 취약점(CVE-2010-3945)에 대한 완화 요소
...
#### CGM 이미지 변환기 버퍼 오버런 취약점(CVE-2010-3945)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **모든 사용자가 cgmimp32.flt에 액세스할 수 없도록 ACL(액세스 제어 목록) 수정**

    관리자로 로그인하여 명령 프롬프트에서 다음 명령을 실행합니다.

    **지원 대상인 모든 Windows XP 및 Windows Server 2003 32비트 에디션:**
    
    ```
    cacls "%CommonProgramFiles%\Microsoft Shared\grphflt\cgmimp32.flt" /E /P everyone:N
    ```

    **지원 대상인 모든 Windows XP 및 Windows Server 2003 64비트 에디션:**
    
    ```
    cacls "%CommonProgramFiles(x86)%\Microsoft Shared\grphflt\cgmimp32.flt" /E /P everyone:N
    ```

    **지원 대상인 모든 Windows** **Vista, Windows Server 2008 및 Windows 7 32비트 에디션:**
    ...
    **지원 대상인 모든 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 64비트 에디션:**
    ...
    **대안의 영향.** Office 응용 프로그램에서 CGM 이미지를 가져올 수 없게 됩니다.
...
#### CGM 이미지 변환기 버퍼 오버런 취약점(CVE-2010-3945)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
Microsoft Office가 메모리의 버퍼 크기를 잘못 할당하면 이 취약점이 발생합니다.
...
전자 메일을 통한 공격의 경우 공격자는 특수하게 조작된 Office 문서를 사용자에게 보내고 파일을 열도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.

웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 Office 문서를 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 Office 문서를 열도록 유도해야 합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Office에서 CGM 이미지를 렌더링할 때 데이터의 유효성을 검사하는 방법을 수정하여 이 취약점을 해결합니다.
...
Microsoft Office에서 PICT 이미지 파일을 처리할 때 버퍼 크기를 할당하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 PICT 이미지를 포함하는 Office 문서를 열 경우 원격 코드 실행이 허용될 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3946 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3946)을 참조하십시오.

#### PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)에 대한 완화 요소
...
#### PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)에 대한 대안
...
-   **모든 사용자가 pictim32.flt에 액세스할 수 없도록 ACL(액세스 제어 목록) 수정**
    ...
    **대안의 영향.** Office 응용 프로그램에서 PICT 이미지를 가져올 수 없게 됩니다.
...
#### PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)에 대한 FAQ
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Office에서 PICT 이미지를 렌더링할 때 데이터의 유효성을 검사하는 방법을 수정하여 이 취약점을 해결합니다.
...
Microsoft Office가 특수하게 조작된 TIFF 이미지 파일을 구문 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 TIFF 이미지를 포함하는 Office 문서를 열 경우 원격 코드 실행이 허용될 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3947 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3947)을 참조하십시오.

#### TIFF 이미지 변환기 힙 오버플로 취약점(CVE-2010-3947)에 대한 완화 요소
...
#### TIFF 이미지 변환기 힙 오버플로 취약점(CVE-2010-3947)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **모든 사용자가 tiffim32.flt에 액세스할 수 없도록 ACL(액세스 제어 목록) 수정**
    ...
    **대안의 영향.** Office 응용 프로그램에서 TIFF 이미지를 가져올 수 없게 됩니다.
...
#### TIFF 이미지 변환기 힙 오버플로 취약점(CVE-2010-3947)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**취약점의 원인은 무엇입니까?**  
Microsoft Office가 TIFF 이미지 파일의 데이터의 유효성을 제대로 검사하지 못하면 이 취약점이 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 TIFF 이미지를 렌더링할 때 Microsoft Office 내의 데이터 유효성 검사를 수정하여 이 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3949 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3949)를 참조하십시오.

#### TIFF 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3949)에 대한 완화 요소
...
#### TIFF 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3949)에 대한 대안
...
-   **모든 사용자가 MSPCORE.DLL에 액세스할 수 없도록 ACL(액세스 제어 목록) 수정**
    ...
    **대안의 영향.** Office Document Imaging 응용 프로그램에서 TIFF 파일을 가져올 수 없게 됩니다.
...
#### TIFF 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3949)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**취약점의 원인은 무엇입니까?**  
Microsoft Office가 TIFF 이미지 파일을 구문 분석하는 동안 데이터를 제대로 변환하지 못하면 이 취약점이 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Office가 TIFF 이미지 파일을 구문 분석하는 동안 데이터를 변환하는 방식을 수정하여 이 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3950 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3950)을 참조하십시오.

#### TIFF 이미지 변환기 메모리 손상 취약점(CVE-2010-3950)에 대한 완화 요소
...
#### TIFF 이미지 변환기 메모리 손상 취약점(CVE-2010-3950)에 대한 대안
...
#### TIFF 이미지 변환기 메모리 손상 취약점(CVE-2010-3950)에 대한 FAQ
...
Microsoft Office가 특수하게 조작된 FlashPix 이미지 파일을 구문 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 FlashPix 이미지를 포함하는 Office 문서를 열 경우 원격 코드 실행이 허용될 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3951 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3951)을 참조하십시오.

#### FlashPix 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3951)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
-   기본적으로 FlashPix 이미지 변환기는 Microsoft Office에 의해 설치되지 않습니다. FlashPix 이미지 변환기가 수동으로 설치된 시스템만 이 취약점의 영향을 받습니다.
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 메일 메시지를 통한 공격에 성공하려면 메일로 보낸 첨부 파일을 사용자가 열어야 합니다.
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 Office 파일을 열도록 유도하는 것이 일반적입니다.

#### FlashPix 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3951)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **모든 사용자가 fpx32.flt에 액세스할 수 없도록 ACL(액세스 제어 목록) 수정**
    ...
    **대안의 영향.** Office 응용 프로그램에서 FlashPix 이미지 파일을 가져올 수 없게 됩니다.
...
#### FlashPix 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3951)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**취약점의 원인은 무엇입니까?**  
Microsoft Office가 FlashPix 이미지 파일의 데이터를 제대로 구문 분석하지 못하면 이 취약점이 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Microsoft Office에서 FlashPix 이미지를 렌더링할 때 데이터의 유효성을 검사하는 방법을 수정하여 이 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3952 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3952)를 참조하십시오.

#### FlashPix 이미지 변환기 힙 손상 취약점(CVE-2010-3952)에 대한 완화 요소
...
#### FlashPix 이미지 변환기 힙 손상 취약점(CVE-2010-3952)에 대한 대안
...
#### FlashPix 이미지 변환기 힙 손상 취약점(CVE-2010-3952)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**취약점의 원인은 무엇입니까?**  
Microsoft Office가 FlashPix 이미지 파일의 데이터를 구문 분석하는 방식에 취약점이 존재합니다.
...
-   지원 대상인 Microsoft Office 버전에 네트워크 설치 지점을 만드는 방법에 대한 자세한 내용은 [Microsoft Office의 네트워크 설치 지점 만들기](https://technet.microsoft.com/en-us/library/cc179063.aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2289162">Microsoft 기술 자료 문서 2289162</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2289163">Microsoft 기술 자료 문서 2289163</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2288931">Microsoft 기술 자료 문서 2288931</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2289078">Microsoft 기술 자료 문서 2289078</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2456849">Microsoft 기술 자료 문서 2456849</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2431831">Microsoft 기술 자료 문서 2431831</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>/quiet</strong> 또는 <strong>/q[n|b|r|f]</strong></td>
...
-   CGM 이미지 변환기 버퍼 오버런 취약점(CVE-2010-3945)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li  
-   PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li  
-   PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Alin Rad Pop  
-   TIFF 이미지 변환기 힙 오버플로 취약점(CVE-2010-3947)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Carsten Eiram  
-   TIFF 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3949)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Carsten Eiram  
-   TIFF 이미지 변환기 메모리 손상 취약점(CVE-2010-3950)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Carsten Eiram  
-   FlashPix 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3951)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Dyon Balding  
-   FlashPix 이미지 변환기 힙 손상 취약점(CVE-2010-3952)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Dyon Balding
...
-   V1.1(2010년 12월 16일): Microsoft Office XP 및 Microsoft Office 2003의 고객은 이 공지(MS10-105)에서 설명하는 취약점으로부터 보호하기 위해 MS10-087에서 제공하는 업데이트를 적용해야 한다는 설명이 추가되었습니다.
