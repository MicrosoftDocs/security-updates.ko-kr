...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/974945">Microsoft 기술 자료 문서 974945</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   VBE6.DLL 스택 메모리 손상 취약점(CVE-2010-0815)을 보고해 주신 [NSFocus Security Team (영문)](http://www.nsfocus.com/)
