...
|-------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=32e5c9ad-b610-4afb-b6f0-bb0b5fbdd1f6) | 원격 코드 실행 | 중요        | 없음                      |
...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>Indeo 코덱의 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3138)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
