...
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=9fd73d12-ff7c-411d-944d-a6f147b20775&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=fc98f55c-520e-4a68-a3c3-0df51c6122bb)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=102591a0-2b58-497b-bc20-593571b96e9c&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=12515d47-134d-4d1f-9ae7-f0a7167ec424)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c5faba34-48f5-4875-a0fa-6b8207f9b276)
...
|----------------------------------------------------------------------------------------------------------------------|----------------------|------------------------|------------------------|---------------------|---------------------------------|
| ICMP 연결 다시 설정 취약점 - [CVE-2004-0790 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0790) | 서비스 거부          | 낮음                   | 낮음                   | 낮음                | 낮음                            |
| TCP 연결 다시 설정 취약점 - [CVE-2004-0230 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0230)  | 서비스 거부          | 낮음                   | 낮음                   | 낮음                | 낮음                            |
| 스푸핑된 연결 요청 취약점 - [CVE-2005-0688 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0688)  | 서비스 거부          | 낮음                   | 낮음                   | 낮음                | 낮음                            |
...
IANA는 새로운 Teredo 접두사 2001:0/32를 Teredo에 할당했습니다. Windows XP 서비스 팩 2 IPv6 가능 호스트 및 Windows Vista 간에 Teredo를 통한 연결을 구성할 수 있도록 모든 Windows XP 시스템에서 Teredo 접두사가 개정되고 있습니다. Teredo에 대한 자세한 내용은 [Microsoft TechNet 설명서 (영문)](https://www.microsoft.com/technet/prodtechnol/winxppro/maintain/teredo.mspx)를 참조하십시오. 새로운 Teredo 접두사에 대한 자세한 내용은 [RFC 설명서 (영문)](https://www.rfc-editor.org/rfc/rfc4380.txt)를 참조하십시오.

**이 보안 업데이트가 TCP/IP의 IPv4 구현을 변경합니까?**  
아니요. 이 공지에서 해결된 보안 문제점은 [MS05-019](https://technet.microsoft.com/security/bulletin/ms05-019)에서 TCP/IP의 IPv4 구현을 통해 이미 해결되었습니다.
...
ICMP(Internet Control Message Protocol)의 IPv6 Windows 구현에 [서비스 거부](https://www.microsoft.com/korea/security/glossary.mspx) 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템에서 기존 TCP 연결이 끊어지도록 만들 수 있습니다.
...
-   **방화벽 또는 라우터에서 모든 ICMP 네트워크 패킷 차단:**
    ...
    **대안의 영향:** 그러나 이 대안은 TCP에서 네트워크 통신을 최적화하지 못하게 하므로 성능에 악영향을 미칠 수도 있습니다. ICMP 네트워크 패킷은 MTU가 다른 네트워크 연결 라우터에서 조각화를 제거할 수 있습니다. 조각화가 발생하면 TCP 처리량이 감소하고 네트워크 정체가 증가합니다.
    참고: Windows XP 서비스 팩 1 방화벽은 IPv6 네트워크 트래픽을 처리할 수 없습니다. 인터넷 연결 방화벽을 사용하여 Windows XP 서비스 팩 1 시스템을 보호하려면 [기술 자료 문서 817778 “Windows XP용 고급 네트워킹 팩 개요”](https://support.microsoft.com/kb/817778)에서 설명하는 업데이트를 적용해야 합니다.
...
Windows의 ICMP(Internet Control Message Protocol) IPv6 구현에 [서비스 거부](https://www.microsoft.com/korea/security/glossary.mspx) 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템에서 기존 TCP 연결이 끊어지도록 만들 수 있습니다.

**취약점의 원인은 무엇입니까?**  
특수하게 조작된 ICMP 패킷이 손실되지 않고 구문 분석되면 기존 연결을 다시 설정됩니다.

**IPv6란 무엇입니까?**  
인터넷의 네트워크 계층을 위한 새로운 표준 프로토콜인 IPv6(Internet Protocol version 6)은 Microsoft Windows XP 이상에 기본적으로 포함되어 있습니다. IPv6는 주소 고갈, 보안, 자동 구성, 확장성과 같이 현재 IP 버전(IPv4라고 함)이 지닌 많은 문제점을 해결하도록 설계되었습니다. IPv6에 대한 자세한 내용은 다음 [Microsoft IPv6에 대한 FAQ (영문)](https://www.microsoft.com/technet/itsolutions/network/ipv6/ipv6faq.mspx)를 참조하십시오.

**TCP/IP란 무엇입니까?**  
TCP/IP는 일련의 네트워킹 프로토콜입니다. TCP/IP는 컴퓨터가 통신하는 방법에 대한 표준과 네트워크를 연결하고 트래픽을 라우팅하는 규칙을 포함하고 있습니다. TCP/IP에 대한 자세한 내용은 [여기 (영문)](https://go.microsoft.com/fwlink/?linkid=40954)를 참조하십시오.
...
TCP의 IPv6 Windows 구현에 [서비스 거부](https://www.microsoft.com/korea/security/glossary.mspx) 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템에서 기존 TCP 연결이 끊어지도록 만들 수 있습니다.
...
Windows TCP/IP의 IPv6 구현에 [서비스 거부](https://www.microsoft.com/korea/security/glossary.mspx) 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템이 응답을 중지하도록 만듭니다.
...
이것은 [서비스 거부](https://www.microsoft.com/korea/security/glossary.mspx) 취약점입니다. 이 취약점 악용에 성공한 공격자는 과도한 CPU 사용율로 인해 영향을 받는 시스템이 제한된 시간 동안 응답을 중지하도록 만들 수 있습니다. 이 시간 동안 영향을 받는 시스템은 요청에 응답할 수 없습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.
...
**IPv6란 무엇입니까?**  
인터넷의 네트워크 계층을 위한 새로운 표준 프로토콜인 IPv6(Internet Protocol version 6)은 Microsoft Windows XP 이상에 기본적으로 포함되어 있습니다. IPv6는 주소 고갈, 보안, 자동 구성, 확장성과 같이 현재 IP 버전(IPv4라고 함)이 지닌 많은 문제점을 해결하도록 설계되었습니다. IPv6에 대한 자세한 내용은 다음 [IPv6에 대한 FAQ (영문)](https://www.microsoft.com/technet/itsolutions/network/ipv6/ipv6faq.mspx)를 참조하십시오.

**TCP/IP란 무엇입니까?**  
TCP/IP는 일련의 네트워킹 프로토콜입니다. TCP/IP는 컴퓨터가 통신하는 방법에 대한 표준과 네트워크를 연결하고 트래픽을 라우팅하는 규칙을 포함하고 있습니다. TCP/IP에 대한 자세한 내용은 다음을 참조하십시오. TCP/IP에 대한 자세한 내용은 [여기 (영문)](https://go.microsoft.com/fwlink/?linkid=40954)를 참조하십시오.
