...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 957173](http://support.microsoft.com/kb/957173)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Word Viewer 2003 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=70de7c3c-519f-4f4a-a03f-027f80b5415c&displaylang=ko)  
(KB956366)
</td>
<td style="border:1px solid black;">
해당 사항 없음 
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Word Viewer](http://www.microsoft.com/downloads/details.aspx?familyid=70de7c3c-519f-4f4a-a03f-027f80b5415c&displaylang=ko)  
(KB956366)
</td>
<td style="border:1px solid black;">
해당 사항 없음 
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=55430121-4476-48b8-9f6f-4a60fa0b2970&displaylang=ko)  
(KB956828)
</td>
<td style="border:1px solid black;">
해당 사항 없음 
...
Microsoft Office Word Viewer는 Word Viewer 2003 및 모든 이전 버전의 Word Viewer를 대체합니다. 최신 Word Viewer를 구하는 벙법은 [Microsoft 기술 자료 문서 891090](http://support.microsoft.com/kb/891090)을 참조하십시오.

**Microsoft Office Word Viewer 2003의 원래 버전을 사용하고 있습니다. 이 보안 업데이트가 적용됩니까?**  
Microsoft Office Word Viewer 2003의 원래 버전에는 취약한 코드가 있습니다. 그러나 이 보안 업데이트를 설치하려면 먼저 Microsoft Office Word Viewer 2003 서비스 팩 3을 설치해야 합니다. 이 서비스 팩을 구하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 934736](http://support.microsoft.com/kb/934736)을 참조하십시오.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 957173](http://support.microsoft.com/kb/957173)에 나와 있습니다.
...
Microsoft는 Works 8.0 사용자에게 Works 8.5 무료 업그레이드를 제공했습니다. 이에 따라 Microsoft Works 8.0, Works Suite 2005 또는 Works Suite 2004를 사용하는 모든 고객은 보안이 강화된 Works 8.5로 업그레이드해야 합니다. 자세한 내용은 [Microsoft Works Update (영문)](http://www.microsoft.com/products/works/international/update_1001.mspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4024 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4024)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4025 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4025)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4026 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4026)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4027 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4027)을 참조하십시오.
...
-   **Word에서 RTF 파일을 로드하지 못하도록 차단**
    ...
    **For Word 2003 Interactive**
    ...
    [보안 업데이트 934181](http://www.microsoft.com/downloads/details.aspx?familyid=6870245d-4618-4504-bffc-878635267059&displaylang=en)을 설치한 경우, Word 2003에서 이 유형의 파일이 로드되지 못하도록 차단할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4030 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4030)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4028 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4028)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4031 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4031)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4837 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4837)을 참조하십시오.
...
MBSA 2.1에 대한 자세한 내용은 [MBSA 2.1 (영문)](http://www.microsoft.com/technet/security/tools/mbsa2/qa.mspx) 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/957173">Microsoft 기술 자료 문서 957173</a> 참조</td>
</tr>
<tr class="even">
...
이 보안 업데이트를 적용하려면 시스템에 [Windows Installer 3.1](http://www.microsoft.com/downloads/details.aspx?familyid=889482fc-5f56-4a38-b838-de776fd4138c&displaylang=en)이 설치되어 있어야 합니다.
...
Microsoft Office 2004 for Mac 11.5.3 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=eca13ad8-62ae-41a8-b308-41e2d1773820)에서 다운로드하여 설치하십시오.
...
Microsoft Office 2004 for Mac 12.1.5 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=ab31a564-43d2-45bd-98bf-19e9ca477b62)에서 다운로드하여 설치하십시오.
...
[Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=edb6cd8f-832c-4123-8982-ac0c601ea0a7)에서 Open XML File Format Converter for Mac 1.0.2 업데이트를 다운로드하여 설치하십시오.
...
-   Word 메모리 손상 취약점(CVE-2008-4024)을 보고해 주신 [Core Security Technologies (영문)](http://www.coresecurity.com/)의 Ricardo Narvaja  
-   Word RTF 개체 구문 분석 취약점(CVE-2008-4025)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Dyon Balding  
-   Word 메모리 손상 취약점(CVE-2008-4026)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Yamata Li  
-   Word RTF 개체 구문 분석 취약점(CVE-2008-4027)을 [TippingPoint](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Wushi  
-   Word RTF 개체 구문 분석 취약점(CVE-2008-4030)을 보고해 주신 [TippingPoint DVLabs (영문)](http://dvlabs.tippingpoint.com/)의 Aaron Portnoy  
-   Word RTF 개체 구문 분석 취약점(CVE-2008-4028)을 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 team509의 [Wushi (영문)](http://www.team509.com/)  
-   Word RTF 개체 구문 분석 취약점(CVE-2008-4031)을 보고해 주신 [TippingPoint DVLabs (영문)](http://dvlabs.tippingpoint.com/)의 Aaron Portnoy  
-   Word 메모리 손상 취약점(CVE-2008-4837)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Wushi 및 Ling
