---
TOCTitle: 'MS12-011'
Title: 'Microsoft 보안 공지 MS12-011 - 중요'
ms:assetid: 'ms12-011'
ms:contentKeyID: 61230478
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-011(v=Security.10)'
---


Microsoft 보안 공지 MS12-011 - 중요
===================================
...
이 보안 업데이트의 심각도는 Microsoft Office SharePoint Server 2010 및 Microsoft SharePoint Foundation 2010에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft SharePoint가 사용자 입력의 유효성을 검사하고 입력한 내용을 삭제하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2663841](https://support.microsoft.com/kb/2663841)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
| Microsoft Office Forms Server 2007 서비스 팩 2 및 Microsoft Office Forms Server 2007 서비스 팩 3(32비트 에디션)             |
| Microsoft Office Forms Server 2007 서비스 팩 2 및 Microsoft Office Forms Server 2007 서비스 팩 3(64비트 에디션)             |
| Microsoft Office SharePoint Server 2007 서비스 팩 2 및 Microsoft Office SharePoint Server 2007 서비스 팩 3(32비트 에디션)   |
| Microsoft Office SharePoint Server 2007 서비스 팩 2 및 Microsoft Office SharePoint Server 2007 서비스 팩 3(64비트 에디션)   |
| Microsoft Office Groove Data Bridge Server 2007 서비스 팩 2 및 Microsoft Office Groove Data Bridge Server 2007 서비스 팩 3  |
| Microsoft Office Groove Management Server 2007 서비스 팩 2 및 Microsoft Office Groove Management Server 2007 서비스 팩 3    |
| Microsoft Groove Server 2010 및 Microsoft Groove Server 2010 서비스 팩 1                                                    |
| Microsoft Windows SharePoint Services 2.0                                                                                   |
| Microsoft Windows SharePoint Services 3.0 서비스 팩 2 및 Microsoft Windows SharePoint Services 3.0 서비스 팩 3(32비트 버전) |
| Microsoft Windows SharePoint Services 3.0 서비스 팩 2 및 Microsoft Windows SharePoint Services 3.0 서비스 팩 3(64비트 버전) |
...
예. 이 공지의 취약점 정보 절에 나열된 변경 내용 외에도, 이 업데이트에는 Microsoft SharePoint의 웹 서비스 액세스 제어를 향상시키는 데 도움이 되는 심층 보안 업데이트가 포함되어 있습니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [2월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-feb)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0017(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0017)을 참조하십시오.

#### inplview.aspx의 XSS 취약점(CVE-2012-0017)에 대한 완화 요소
...
#### inplview.aspx의 XSS 취약점(CVE-2012-0017)에 대한 대안
...
#### inplview.aspx의 XSS 취약점(CVE-2012-0017)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0144(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0144)를 참조하십시오.

#### themeweb.aspx의 XSS 취약점(CVE-2012-0144)에 대한 완화 요소
...
#### themeweb.aspx의 XSS 취약점(CVE-2012-0144)에 대한 대안
...
#### themeweb.aspx의 XSS 취약점(CVE-2012-0144)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0145(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0145)를 참조하십시오.

#### wizardlist.aspx의 XSS 취약점(CVE-2012-0145)에 대한 완화 요소
...
#### wizardlist.aspx의 XSS 취약점(CVE-2012-0145)에 대한 대안
...
#### wizardlist.aspx의 XSS 취약점(CVE-2012-0145)에 대한 FAQ
...
|------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| Microsoft Office SharePoint Server 2010 및 Microsoft Office SharePoint Server 2010 서비스 팩 1 | 예. 아래의 Microsoft Office SharePoint Server 2010에 대한 참고 사항을 참조하십시오. | 예. 아래의 Microsoft Office SharePoint Server 2010에 대한 참고 사항을 참조하십시오. |
...
Microsoft Office SharePoint Server 2010 참고 사항 위에 설명된 검색 테이블은 단일 서버를 이용한 Microsoft Office SharePoint Server 2010의 배포에 기초하고 있습니다. 검색 도구는 다중 시스템 SharePoint 서버 팜의 일부로 구성된 시스템에 대한 업데이트 적용 여부를 검색하지 않습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2597124">Microsoft 기술 자료 문서 2597124</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2553413">Microsoft 기술 자료 문서 2553413</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   themeweb.aspx의 XSS 취약점(CVE-2012-0144)을 보고해 주신 John Hollenberger  
-   wizardlist.aspx의 XSS 취약점(CVE-2012-0145)을 보고해 주신 stratsec의 Rocco Calvi  
-   Microsoft SharePoint에서 웹 서비스 액세스 제어 처리를 향상시키는 데 도움이 되는 심층 보안 업데이트를 위해 협력해 주신 Minded Security의 Giorgio Fedon
