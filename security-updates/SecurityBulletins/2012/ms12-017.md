---
TOCTitle: 'MS12-017'
Title: 'Microsoft 보안 공지 MS12-017 - 중요'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61230484
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-017(v=Security.10)'
---


Microsoft 보안 공지 MS12-017 - 중요
===================================

DNS 서버의 취약점으로 인한 서비스 거부 문제점 (2647170)
-------------------------------------------------------

게시된 날짜: 2012년 3월 13일 화요일 | 업데이트된 날짜: 2012년 4월 19일 목요일
...
이 보안 업데이트의 심각도는 Windows Server 2003의 지원되는 모든 에디션, Windows Server 2008의 32비트 및 x64 기반 에디션과 Windows Server 2008 R2의 x64 기반 에디션에 대해 중요입니다. 자세한 내용은 이 섹션의 하위 섹션, 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 DNS 서버가 메모리에서 개체를 처리하는 방법을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2647170](https://support.microsoft.com/kb/2647170)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b04da098-666f-4760-90da-d2a17e78bf47">Windows Server 2003 서비스 팩 2</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=647eaf09-3959-439e-8418-fd25221eb6b9">Windows Server 2003 x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a>,<br />
<a href="https://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 SP2(Itanium 기반 시스템용)</a></td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a>,<br />
<a href="https://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">Windows Server 2008(32비트 시스템용) 서비스 팩 2</a>\*</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2</a>\*</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1</a>\*</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
...
영향을 받는 소프트웨어 표에 나열된 운영 체제에서 DNS를 사용하도록 설정한 경우에만 업데이트가 설치됩니다. 기본적으로 DNS는 이러한 운영 체제에서 사용하도록 설정되어 있지 않으므로, DNS를 사용하도록 설정하지 않은 경우에는 업데이트가 제공되지 않습니다.
...
<th style="border:1px solid black;" >DNS 서비스 거부 취약점(CVE-2012-0006)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
DNS 서버가 도메인의 리소스 레코드를 찾을 때 메모리의 개체를 적절하게 처리하지 못할 경우에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용한 공격자는 대상 시스템에서 DNS 서버가 응답을 중지하고 자동으로 재시작하게 할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0006(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006)을 참조하십시오.
  
#### DNS 서비스 거부 취약점(CVE-2012-0006)에 대한 완화 요소
  
이 취약점에 대해 확인된 완화 요소가 없습니다.
  
#### DNS 서비스 거부 취약점(CVE-2012-0006)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   DNS 캐시를 주기적으로 비웁니다.
  
    [Dnscmd Syntax](https://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx) 문서에 설명된 대로 다음 dnscmd 명령을 실행합니다.
  
    `dnscmd [ServerName] /clearcache`
  
    이 명령은 예약된 작업으로 실행하거나 필요에 따라 실행할 수 있습니다.
  
    대안의 영향. 지정된 DNS 서버에서 리소스 레코드의 DNS 캐시 메모리를 비웁니다.
  
    대안 실행 취소 방법.
  
    이 dnscmd 명령을 실행하는 예약된 작업을 삭제하거나 사용되지 않도록 설정합니다.
  
#### DNS 서비스 거부 취약점(CVE-2012-0006)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이 취약점은 서비스 거부 취약점입니다.
  
취약점의 원인은 무엇입니까?   
이 취약점은 DNS 서버가 리소스 레코드를 찾는 동안 메모리에서 개체를 적절하게 처리하지 못할 경우에 발생합니다.
  
DNS 리소스 레코드란 무엇입니까?   
DNS RR(리소스 레코드)은 도메인 안에서 특정 리소스를 식별합니다. 자세한 내용은 TechNet 문서 [How DNS Works(DNS 작동 방식) (영문)](https://technet.microsoft.com/ko-kr/library/dd197446(ws.10).aspx)을 참조하십시오.
  
공격자는 취약점을 악용하여 무엇을 할 수 있습니까?   
이 취약점 악용에 성공한 공격자는 대상 시스템에서 응답을 중지하거나 자동으로 다시 시작하도록 만들 수 있습니다.
  
공격자는 이러한 취약점을 어떻게 악용합니까?   
인증되지 않은 원격 공격자는 특수하게 조작된 DNS 쿼리를 대상 DNS 서버로 전송하여 이 취약점을 악용할 수 있습니다.
  
취약점으로 인해 위험에 노출되는 시스템은 주로 무엇입니까?   
DNS 역할을 실행하는 서버가 주로 위험합니다. 이 역할이 활성화되지 않은 서버는 위험하지 않습니다.
  
업데이트는 어떤 기능을 수행합니까?   
업데이트는 DNS 서버가 메모리에서 개체를 처리하는 방법을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2647170$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2647170">Microsoft 기술 자료 문서 2647170</a> 참조</td>
</tr>
<tr class="even">
...
-   V1.1(2012년 4월 19일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2647170 링크가 추가되었으며, Windows Server 2003 서비스 팩 2, Windows Server 2003 x64 Edition 서비스 팩 2 및 Windows Server 2003 SP2(Itanium 기반 시스템용) 공지 교체 정보가 수정되었습니다. 이 변경 사항은 공지에만 해당됩니다. 검색이나 보안 업데이트 파일에 대한 변경 사항은 없습니다.
