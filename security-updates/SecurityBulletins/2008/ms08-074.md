...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 959070](https://support.microsoft.com/kb/959070)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f&displaylang=ko)  
(KB958439)
</td>
<td style="border:1px solid black;">
해당 사항 없음 
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 959070](https://support.microsoft.com/kb/959070)에 나와 있습니다.
...
<th style="border:1px solid black;" >파일 형식 구문 분석 취약점(CVE-2008-4264)</th>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4265 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4264 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264)를 참조하십시오.
...
#### 파일 형식 구문 분석 취약점(CVE-2008-4264)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4266 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266)을 참조하십시오.
...
#### Excel 글로벌 배열 메모리 손상 취약점(CVE-2008-4266)에 대한 대안
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/959070">Microsoft 기술 자료 문서 959070</a> 참조</td>
</tr>
<tr class="even">
...
Office2003-kb958436-fullfile-kor /q:a<br />
<br />
Excel Viewer 2003:<br />
Office2003-kb958434-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Excel 2003:<br />
Office2003-kb958436-fullfile-kor /r:n<br />
<br />
Excel Viewer 2003:<br />
Office2003-kb958434-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   파일 형식 구문 분석 취약점(CVE-2008-4265)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Joshua J. Drake  
-   파일 형식 구문 분석 취약점(CVE-2008-4264)을 보고해 주신 [signedness.org (영문)](https://www.signedness.org/)의 Claes M Nyberg  
-   Excel 글로벌 배열 메모리 손상 취약점(CVE-2008-4266)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Dyon Balding
...
-   V2.0(2009년 1월 29일): 지원되는 Microsoft Office Excel 2007 버전에 대한 보안 업데이트 KB958437 및 KB958439와 관련하여 **영향을 받는 소프트웨어** 표에 각주를 추가하고 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 두 개의 항목을 추가하였습니다. 보안 업데이트 바이너리나 검색에 대한 변경 사항은 없습니다. 이미 KB958437 및 KB958439를 성공적으로 설치한 Microsoft Office Excel 2007 또는 Microsoft Office Excel 2007 서비스 팩 1을 사용하는 고객은 다시 설치할 필요가 없습니다.
