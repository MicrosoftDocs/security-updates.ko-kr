...
[**MS16-084: Internet Explorer용 누적 보안 업데이트(3169991)**](https://go.microsoft.com/fwlink/?linkid=808143)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[CVE-2016-3204(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3204)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-085: Microsoft Edge용 누적 보안 업데이트(3169999)**](https://go.microsoft.com/fwlink/?linkid=808148)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-086: JScript 및 VBScript용 누적 보안 업데이트(3169996)**](https://go.microsoft.com/fwlink/?linkid=808144)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-087: Microsoft 인쇄 스풀러용 보안 업데이트(3170005)**](https://go.microsoft.com/fwlink/?linkid=808150)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-088: Microsoft Office용 보안 업데이트(3170008)**](https://go.microsoft.com/fwlink/?linkid=808151)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[CVE-2016-3278(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3278)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-089: Windows 보안 커널 모드용 보안 업데이트(3170050)**](https://go.microsoft.com/fwlink/?linkid=808157)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-090: Windows 커널 모드 드라이버용 보안 업데이트(3171481)**](https://go.microsoft.com/fwlink/?linkid=808590)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[CVE-2016-3249(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3249)
...
<tr>
<td style="border:1px solid black;">
[CVE-2016-3250(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3250)
...
<tr>
<td style="border:1px solid black;">
[CVE-2016-3251(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3251)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-091: .NET Framework용 보안 업데이트(3170048)**](https://go.microsoft.com/fwlink/?linkid=808156)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[CVE-2016-3255(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3255)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-092: Windows 커널용 보안 업데이트(3171910)**](https://go.microsoft.com/fwlink/?linkid=808706)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[CVE-2016-3258(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3258)
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-093: Adobe Flash Player용 보안 업데이트(3174060)**](https://go.microsoft.com/fwlink/?linkid=809010)
...
<td style="border:1px solid black;">
취약성 심각도 및 업데이트 우선 순위 등급은 [Adobe 보안 공지 APSB16-25](https://helpx.adobe.com/security/products/flash-player/apsb16-25.html)를 참조하십시오.
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-094: 보안 부팅용 보안 업데이트(3177404)**](https://go.microsoft.com/fwlink/?linkid=817339)
...
[업데이트 관리를 위한 보안 가이드](https://go.microsoft.com/fwlink/?linkid=21168)는 보안 업데이트 적용에 대해 Microsoft가 권장하는 모범 사례와 관련한 추가 정보를 제공합니다.
...
나열된 영향받는 소프트웨어는 테스트를 거쳐 영향받는 버전이 확인되었습니다. 다른 버전은 지원 기간이 끝났습니다. 사용 중인 소프트웨어 버전에 대한 지원 기간을 확인하려면 [Microsoft 지원 기간](https://go.microsoft.com/fwlink/?linkid=21742)을 참조하십시오.
