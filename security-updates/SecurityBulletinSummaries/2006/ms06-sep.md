...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Publisher의 취약점으로 인한 원격 코드 실행 문제점(910729)**](http://technet.microsoft.com/security/bulletin/ms06-054)                                  |
| **요약**                   | 이 업데이트는 원격 코드 실행을 허용할 수 있는 Publisher의 취약점을 해결합니다.                                                                                      |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                       |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                      |
| **영향을 받는 소프트웨어** | **Office.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-054)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 공지 번호                  | Microsoft 보안 공지 MS06-055                                                                                                                                                            |
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**벡터 표시 언어의 취약점으로 인한 원격 코드 실행 문제점(925486)**](http://technet.microsoft.com/security/bulletin/ms06-055)                                                           |
| **요약**                   | 이 업데이트는 원격 코드 실행을 허용할 수 있는 벡터 표시 언어의 취약점을 해결합니다.                                                                                                     |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                                           |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                                          |
| **영향을 받는 소프트웨어** | **Windows, Internet Explorer.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-055)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**PGM(Pragmatic General Multicast)의 취약점으로 인한 원격 코드 실행 문제점(919007)**](http://technet.microsoft.com/security/bulletin/ms06-052)                      |
...
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                       |
| **영향을 받는 소프트웨어** | **Windows.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-052)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**인덱싱 서비스 취약점으로 인한 사이트 간 스크립팅 문제점(920685)**](http://technet.microsoft.com/security/bulletin/ms06-053)                                       |
| **요약**                   | 이 업데이트는 정보 유출을 허용할 수 있는 인덱싱 서비스의 취약점을 해결합니다.                                                                                        |
| **최대 심각도**            | [보통](http://technet.microsoft.com/security/bulletin/rating)                                                                                                        |
| **취약점으로 인한 영향**   | 정보 유출                                                                                                                                                            |
| **영향을 받는 소프트웨어** | **Windows.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-053)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
-   [MS06-052](http://technet.microsoft.com/security/bulletin/ms06-052)에서 설명한 문제점을 보고해 주신 NuPaper Inc.의 David Warden
-   [MS06-053](http://technet.microsoft.com/security/bulletin/ms06-053)에서 설명한 문제점을 보고해 주신 Eiji James Yoshida
-   [MS06-054](http://technet.microsoft.com/security/bulletin/ms06-054)에서 설명한 문제점을 보고해 주신 [Computer Terrorism (영문)](http://www.computerterrorism.com/)의 Stuart Pearson
-   [MS06-055](http://technet.microsoft.com/security/bulletin/ms06-055)에서 설명한 문제점과 관련하여 협력해 주신 [ISS X-Force (영문)](http://www.iss.net/)
-   [MS06-055](http://technet.microsoft.com/security/bulletin/ms06-055)에서 설명한 문제점을 보고해 주신 [iDEFENSE (영문)](http://www.idefense.com/)
-   [MS06-055](http://technet.microsoft.com/security/bulletin/ms06-055)에서 설명한 문제점을 보고해 주신 [Websense Security Labs (영문)](http://www.websense.com/securitylabs/)의 Dan Hubbard
...
-   기타 지역에 거주하는 고객은 해당 Microsoft 지사에서 지원을 받을 수 있습니다. 보안 업데이트와 관련된 기술 지원은 무료입니다. Microsoft 지원 부서에 연락하는 방법에 대한 자세한 내용은 [국가별 기술 지원 웹 사이트 (영문)](http://go.microsoft.com/fwlink/?linkid=21155)
