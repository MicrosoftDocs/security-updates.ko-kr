...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7&displaylang=ko)                                                                               | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                                     | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8&displaylang=ko)                                                                      | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d&displaylang=ko)                                                          | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                                      | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c&displaylang=ko)                                                                            | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc&displaylang=ko)                                                                | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705&displaylang=ko)\*                                                   | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6&displaylang=ko)\*                                                 | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                              | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56&displaylang=ko)                                 | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd&displaylang=ko)                             | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72&displaylang=ko)\* | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e)          | 원격 코드 실행 | 중요        | [MS11-054](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-054) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1985(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2002(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2003(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011)(영문)을 참조하십시오.
...
TrueType 글꼴 파일에는 TrueType 래스터라이저 및 운영 체제 소프트웨어에서 글꼴 디자이너의 의도대로 문자가 컴퓨터 화면에 표시되거나 정확히 출력되도록 하기 위해 사용되는 여러 다양한 정보가 포함되어 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](http://msdn.microsoft.com/ko-kr/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 운영 체제는 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2567053">Microsoft 기술 자료 문서 2567053</a> 참조</td>
</tr>
<tr class="even">
...
-   Win32k 널 포인터 역참조 취약점(CVE-2011-1985)을 보고해 주신 [BitDefender(영문)](http://www.bitdefender.com/)의 Andrei Lutas  
-   Win32k Null 포인터 역참조 취약점(CVE-2011-1985)을 보고해 주신 [Norman(영문)](http://www.norman.com/)의 Tarjei Mandt  
-   Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)을 보고해 주신 Maik Wellmann  
-   글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)을 보고해 주신 [CERT/CC(영문)](http://www.cert.org/)의 Will Dorman
