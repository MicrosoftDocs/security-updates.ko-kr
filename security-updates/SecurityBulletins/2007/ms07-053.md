...
|--------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Windows 2000 서비스 팩 4                                                       | [UNIX용 Windows 서비스 3.0](https://www.microsoft.com/download/details.aspx?familyid=557f89fc-c5d9-4405-9007-1654abf92277)                            | 권한 상승      | 중요        | 없음                      |
| Windows 2000 서비스 팩 4                                                       | [UNIX용 Windows 서비스 3.5](https://www.microsoft.com/download/details.aspx?familyid=70ae23c2-3ae8-4ea6-ba8d-8ac7e4f82663)                            | 권한 상승      | 중요        | 없음                      |
| Windows XP 서비스 팩 2                                                         | [UNIX용 Windows 서비스 3.0](https://www.microsoft.com/download/details.aspx?familyid=557f89fc-c5d9-4405-9007-1654abf92277)                            | 권한 상승      | 중요        | 없음                      |
| Windows XP 서비스 팩 2                                                         | [UNIX용 Windows 서비스 3.5](https://www.microsoft.com/download/details.aspx?familyid=70ae23c2-3ae8-4ea6-ba8d-8ac7e4f82663)                            | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2             | [UNIX용 Windows 서비스 3.0](https://www.microsoft.com/download/details.aspx?familyid=557f89fc-c5d9-4405-9007-1654abf92277)                            | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2             | [UNIX용 Windows 서비스 3.5](https://www.microsoft.com/download/details.aspx?familyid=70ae23c2-3ae8-4ea6-ba8d-8ac7e4f82663)                            | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2             | [UNIX 기반 응용 프로그램용 하위 시스템](https://www.microsoft.com/download/details.aspx?familyid=8ab5cc43-0b9c-45eb-aa51-47568ab6ce3f&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2 | [UNIX 기반 응용 프로그램용 하위 시스템](https://www.microsoft.com/download/details.aspx?familyid=1d21e3e8-b5f6-4044-9db6-054af836492b&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Window Vista                                                                   | [UNIX 기반 응용 프로그램용 하위 시스템](https://www.microsoft.com/download/details.aspx?familyid=4d52e4f4-2888-42df-8163-85c648e65b29&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows Vista x64 Edition                                                      | [UNIX 기반 응용 프로그램용 하위 시스템](https://www.microsoft.com/download/details.aspx?familyid=4be667cc-c239-480b-a9a0-939bcd27f0de&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 939778](https://support.microsoft.com/kb/939778)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.

**이 보안 공지에서 설명하는 소프트웨어의 이전 버전을 사용하고 있습니다. 어떻게 해야 합니까?**  
이 공지에 나열된 영향을 받는 소프트웨어는 테스트를 거쳐 해당 릴리스가 영향을 받는지 확인되었습니다. 다른 버전은 지원 기간이 끝났습니다. 사용 중인 소프트웨어 버전에 대한 지원 기간을 확인하려면 [Microsoft 지원 기간 정책 웹 사이트](https://go.microsoft.com/fwlink/?linkid=21742)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3036 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3036)을 참조하십시오.
...
이 취약점 악용에 성공한 공격자는 영향을 받는 시스템에서 권한이 상승될 수 있습니다. 게스트 운영 체제에 대해 사용자 권한이 적게 구성된 사용자는 게스트 운영 체제에 대해 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받지않습니다.
...
SUIT에 대한 자세한 내용은 다음 [Microsoft 웹 사이트](https://support.microsoft.com/kb/894154/)를 참조하십시오. SUIT의 제한 사항에 대한 자세한 내용은 [Microsoft 기술 자료 문서 306460](https://support.microsoft.com/kb/306460/)을 참조하십시오. SMS SUS Feature Pack에는 Microsoft Office 응용 프로그램용 업데이트 검색에 필요한 Microsoft Office Inventory Tool도 포함되어 있습니다.
  
SMS는 [Microsoft Update](https://update.microsoft.com/microsoftupdate)를 통해 제공되는 보안 업데이트를 검색하기 위해 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용할 수 있습니다. ITMU는 MBSA 2.0.1을 사용합니다. 따라서 이 공지의 앞 부분에서 설명한 MBSA 2.0.1에서 검색할 수 없는 프로그램과 관련된 동일한 제한 사항이 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 다음 [Microsoft 웹 사이트 (영문)](https://technet.microsoft.com/ko-kr/sms/bb676783.aspx)를 방문하십시오. SMS 2003은 Microsoft Office Inventory Tool을 사용하여 Microsoft Office 응용 프로그램에 필요한 업데이트를 검색할 수도 있습니다.
...
**EST 참고 사항:** Unix 3.0용 서비스 및 Unix 3.5용 서비스는 Windows 2000, Windows XP, Windows Vista 및 Windows Server 2003을 위한 완전한 기능의 추가 구성 요소입니다. MBSA 2.0.1은 이러한 응용 프로그램의 업데이트 검색을 지원하지 않습니다. [2007년 9월 Enterprise Scan Tool(EST) (영문)](https://www.microsoft.com/download/details.aspx?familyid=d7e0af00-47b7-46d0-9252-cc9d7db7385d)은 지원되는 모든 플랫폼에서 MS07-053 필수 업데이트를 검색하기 위해 제공됩니다. 업데이트 배포는 SMS에서 표준 소프트웨어 배포로 처리할 수 있습니다.
  
SMS 2.0 및 SMS 2003용 [Extended Security Update Inventory Tool (영문)](https://www.microsoft.com/download/details.aspx?familyid=2c93da1d-48a0-4e5c-991f-87e08954f61b)은 EST와 동일한 엔진을 사용하므로 MBSA에서 지원하는 않는 제품용 업데이트를 SMS에서 검색할 때 사용할 수 있습니다. 이 도구의 최신 버전은 MBSA에서 검색할 수 없는 MS04-028 이후 업데이트의 누적 업데이트를 제공합니다. Extended Security Update Inventory Tool 이전 버전이 SMS에 설치되어 있는 경우 최신 버전으로 업그레이드해야만 MS07-053을 검색할 수 있습니다.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 패치가 있는지 확인하는 레지스트리 키는 없습니다. 패치를 검색하려면 <a href="https://msdn2.microsoft.com/en-us/library/aa384642.aspx">WMI(Windows Management Instrumentation) (영문)</a>를 사용합니다.</td>
</tr>
</tbody>
</table>
...
-   UNIX용 Windows 서비스 권한 상승 문제점(CVE-2007-3036)을 보고해 주신 [WolfeReiter (영문)](https://www.wolfereiter.com/)의 Brian A. Reiter
