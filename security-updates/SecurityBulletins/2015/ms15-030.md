...
영향 받는 소프트웨어 버전 또는 에디션은 다음과 같습니다. 나열되지 않은 버전 또는 에디션은 지원 기간이 끝났거나 영향을 받지 않습니다. 사용 중인 소프트웨어 버전 또는 에디션에 대한 지원 기간을 확인하려면 [Microsoft 지원 기간](https://go.microsoft.com/fwlink/?linkid=21742)을 참조하십시오.
...
<td style="border:1px solid black;">
[**RDP(원격 데스크톱 프로토콜) 서비스 거부 취약점(CVE-2015-0079)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-0079)(영문)
