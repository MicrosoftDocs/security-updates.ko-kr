...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=60c8579b-1540-40d8-80a0-956edadd63ce&displaylang=ko)                                                             | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=023a777a-3d83-4a4e-8029-da8b095b074b&displaylang=ko)                                               | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8e3aac9d-7747-435f-9678-f621e314e070)                                                               | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=79a11dcd-5d88-4d83-beae-6580ef6fc2c0&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f42cc5d4-1bea-4a4a-8a08-b3eb92503588&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=50efb1cf-9d89-4522-929d-f87fd98d6fe8)                                                                | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7cb64633-d2a0-4e38-be35-ec32ea655a04&displaylang=ko)                                         | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bbfc4d80-67eb-4deb-9595-cb67942a0df2&displaylang=ko)                 | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=22d550fe-ba35-4750-a9d6-624858b67c94&displaylang=ko)\*     | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=09025626-4116-4a31-8700-215382898ee2&displaylang=ko)\* | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0035cfe2-d38d-41cd-b704-ec1feda307d8)          | 권한 상승      | 중요        | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0484 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0485 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)를 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-0485 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1255 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)를 참조하십시오.
...
TrueType 글꼴 파일에는 TrueType 래스터라이저 및 운영 체제 소프트웨어에서 글꼴 디자이너의 의도대로 문자가 컴퓨터 화면에 표시되거나 정확히 출력되도록 하기 위해 사용되는 여러 다양한 정보가 포함되어 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](http://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 운영 체제는 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-1255 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)가 지정되었습니다.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 979559](http://support.microsoft.com/kb/979559) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/979559">Microsoft 기술 자료 문서 979559</a> 참조</td>
</tr>
<tr class="even">
...
-   Win32k 부적절한 데이터 유효성 검사 취약점(CVE-2010-0484)을 보고해 주신[VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Sebastien Renaud  
-   Win32k TrueType 글꼴 구문 분석 취약점(CVE-2010-1255)을 해결하기 위해 협력해 주신 [Secunia Research (영문)](http://secunia.com/)
