...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1545 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1545)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1546 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1546)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 971557](https://support.microsoft.com/kb/971557) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971557">Microsoft 기술 자료 문서 971557</a> 참조</td>
</tr>
<tr class="even">
...
-   조작된 AVI 헤더 취약점(CVE-2009-1545)을 보고해 주신 [Adobe Systems, Inc. (영문)](https://www.adobe.com/)의 Vinay Anantharaman  
-   AVI 정수 오버플로 취약점(CVE-2009-1546)을 보고해 주신 [Adobe Systems, Inc. (영문)](https://www.adobe.com/)의 Vinay Anantharaman
