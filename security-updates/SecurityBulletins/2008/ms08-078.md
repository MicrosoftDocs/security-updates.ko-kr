---
TOCTitle: 'MS08-078'
Title: 'Microsoft 보안 공지 MS08-078 - 긴급'
ms:assetid: 'ms08-078'
ms:contentKeyID: 61230186
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-078(v=Security.10)'
---
...
게시된 날짜: 2008년 12월 18일 목요일 | 업데이트된 날짜: 2008년 12월 19일 금요일
...
이 보안 업데이트의 심각도는 Internet Explorer 5.01, Internet Explorer 6, Internet Explorer 6 서비스 팩 1 및 Internet Explorer 7에 대해 긴급입니다. Internet Explorer 8 Beta 2에 대한 추가 정보는 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항** 섹션을 참조하십시오. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 악용 가능 조건을 발생시키는 Internet Explorer의 데이터 바인딩 매개 변수 유효성 확인 및 오류 처리 방식을 수정하여 취약점을 제거합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 961051](https://technet.microsoft.com/security/advisory/961051)에서 처음 설명한 취약점도 해결합니다.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=d81e9cf9-ce0c-463a-a359-49a348cb89ae&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=015df302-d79f-43a1-b5c5-32ac04de0510&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=9ba71e23-8cef-4399-b215-983b0dcf5cb5&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=388847ec-817e-45cf-8fa7-32c7e1f57f80&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=2ae17caf-6204-470e-8480-380d3d505657&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=69979d92-8d45-47fe-ac4c-c2f1f23cf1fb&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=5552e564-dd1c-4e2a-9a42-6317522c884d&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
**참고** Internet Explorer 8 Beta 2에 대한 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항** 섹션을 참조하십시오.

이 보안 업데이트와 관련된 자주 제기되는 질문 사항
-------------------------------------------------

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 960714](https://support.microsoft.com/kb/960714)에 나와 있습니다.

**Windows Internet Explorer 8 Beta 2 릴리스는 이 취약점의 영향을 받습니까?**  
예. 이 취약점은 Windows Internet Explorer 8 Beta 2 발표 이후 보고되었습니다. Windows Internet Explorer 8 Beta 2를 사용 중인 고객은 업데이트를 다운로드하고 시스템에 적용하는 것이 좋습니다.
...
**이 Out-of-Band 업데이트는 Internet Explorer 누적 보안 업데이트입니까?**  
아니요. 이 Out-of-Band 보안 업데이트는 누적 업데이트가 아닙니다. 응답을 신속히 처리하기 위해 Microsoft는 취약점의 근본 원인을 해결하고 이 문제를 수정하기 위해 필요한 파일만 전달하기 위해 노력하고 있습니다. Microsoft는 강력한 안정성 및 보호를 위해 Windows 및 Internet Explorer 최신 보안 업데이트가 적용된 시스템에서 이 픽스의 개발 및 테스팅을 수행했습니다. 고객은 최신 Internet Explorer 누적 보안 업데이트(MS08-073)를 적용한 후 이 업데이트를 적용해야 합니다.

MS08-078 업데이트에는 Internet Explorer 최신 누적 보안 업데이트(MS08-073)에서 전달한 픽스가 포함되어 있지 않으며 MS08-073과 관련이 없으므로 고객은 현재 공격에 대응하기 위해 MS08-073이 설치되지 않은 시스템에 MS08-078을 적용할 수 있습니다.

MS08-078 업데이트는 향후 Internet Explorer용 누적 보안 업데이트에 포함될 예정입니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4844 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4844)를 참조하십시오.
...
-   기본적으로 Windows Vista 이상에서 Internet Explorer 7 및 Internet Explorer 8 Beta 2의 [보호 모드 (영문)](https://www.microsoft.com/windows/windows-vista/features/ie7-protected-mode.aspx)는 사용자의 동의 없는 다른 프로그램 시작 요청이나 파일 저장 요청을 제한함으로써 사용자와 시스템을 보호합니다. 여기에는 사용자 또는 시스템 파일 및 설정이 포함됩니다.
...
-   **XML Island 기능** **사용 안 함**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    Windows Vista 및 Windows Server 2008의 경우 다음과 같이 \[HKEY\_CLASSES\_ROOT\\CLSID\\{379E501F-B231-11D1-ADC1-00805FC752D8}\]의 소유권을 먼저 획득하십시오.

    1.  관리자로 로그인하여 **시작**, **실행**을 차례로 클릭하고 **열기** 상자에 **Regedit**를 입력한 다음 **확인**을 클릭합니다.
    2.  \[HKEY\_CLASSES\_ROOT\\CLSID\\{379E501F-B231-11D1-ADC1-00805FC752D8}\]로 이동합니다.
    3.  **권한**, **고급**, **소유자**를 차례로 클릭합니다.
    4.  **소유자**를 **관리자**로 변경합니다.
    5.  **관리자에게 전체 권한 부여**를 클릭합니다.
    6.  그런 다음 모든 하위 키에 대해 반복합니다.

    다음 내용을 .REG 확장명의 파일(예: Disable\_XML\_Island.reg)로 저장합니다.

    `Windows 레지스트리 편집기 버전 5.00[-HKEY_CLASSES_ROOT\CLSID\{379E501F-B231-11D1-ADC1-00805FC752D8}]`

    상승된 권한의 명령 프롬프트에서 다음 명령으로 Disable\_XML\_Island.reg를 실행합니다.
    ...
    **보안 권고 961051에서 소개한 대안의 실행을 취소하는 방법은 무엇입니까?**  

    [Microsoft 보안 권고 961051](https://technet.microsoft.com/security/advisory/961051)에서 이 대안과 동일한 내용이 레지스트리 수동 변경 방법으로 소개되었습니다. 이 방법을 사용했으며 이 대안을 실행 취소하려면 다음 레지스트리 파일을 사용하십시오.
...
-   **무결성 수준 ACL에서 Internet Explorer의 OLEDB32.dll 사용 제한**
    ...
    **32비트 시스템의 경우**
    ...
    텍스트 파일을 다음 이름으로 저장합니다. "BlockAccess\_x86.inf"
    ...
    **64비트 시스템의 경우**
    ...
    텍스트 파일을 다음 이름으로 저장합니다. "BlockAccess\_x64.inf"
    ...
    `작업을 성공적으로 완료했습니다.자세한 정보는 %windir%\security\logs\scesrv.log 로그를 참조하십시오.`
    ...
    **32비트 시스템의 경우**
    ...
    텍스트 파일을 다음 이름으로 저장합니다. "unBlockAccess\_x86.inf"
    ...
    **64비트 시스템의 경우**
    ...
    텍스트 파일을 다음 이름으로 저장합니다. "unBlockAccess\_x64.inf"
...
-   **OLEDB32.dll의 행 위치 기능 사용 안 함**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    Windows Vista 및 Windows Server 2008의 경우 다음과 같이 \[HKEY\_CLASSES\_ROOT\\CLSID\\{2048EEE6-7FA2-11D0-9E6A-00A0C9138C29}\]의 소유권을 먼저 획득하십시오.

    1.  관리자로 로그인하여 **시작**, **실행**을 차례로 클릭하고 **열기** 상자에 **Regedit**를 입력한 다음 **확인**을 클릭합니다.
    2.  \[HKEY\_CLASSES\_ROOT\\CLSID\\{2048EEE6-7FA2-11D0-9E6A-00A0C9138C29}\]로 이동합니다.
    3.  **권한**, **고급**, **소유자**를 차례로 클릭합니다.
    4.  **소유자**를 **관리자**로 변경합니다.
    5.  **관리자에게 전체 권한 부여**를 클릭합니다.
    6.  그런 다음 모든 하위 키에 대해 반복합니다.

    다음 내용을 .REG 확장명의 파일(예: Disable\_Row\_Position.reg)로 저장합니다.
    ...
    상승된 권한의 명령 프롬프트에서 다음 명령으로 Disable\_Row\_Position.reg를 실행합니다.
...
-   **WindowsVista** **및 Windows Server 2008에서 Internet Explorer 7에 대해 DEP 사용**
...
-   **Internet Explorer 8 Beta 2에서 데이터 바인딩 지원 사용 안 함**
    ...
    1.  인터넷 및 로컬 인트라넷 보안 영역 설정을 **높음**으로 설정합니다.
    2.  다음 내용을 .REG 확장명의 파일(예 Disable\_Data\_Binding.reg)로 저장하여 기능 컨트롤 키를 추가합니다.
        Windows 레지스트리 편집기 버전 5.00
        \[HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Internet Explorer\\MAIN\\FeatureControl\\FEATURE\_DATABINDING\_SUPPORT\]
        "iexplore.exe"=dword:00000000
    3.  상승된 권한의 명령 프롬프트에서 다음 명령으로 Disable\_Data\_Binding.reg를 실행합니다.
...
#### 포인터 참조 메모리 손상 취약점(CVE-2008-4844)에 대한 FAQ
...
Microsoft의 조사에 따르면 인터넷 영역 보안 설정을 **높음**으로 설정하면 알려진 공격으로부터 보호됩니다. 그러나 가장 효과적인 보호를 위해서는 **높음** 보안 설정과 함께 다음 대안 중 하나를 조합해서 사용해야 합니다.
...
스크립팅을 비활성화하고 Internet Explorer의 보안이 낮은 기능을 비활성화하며 데이터 실행 방지(DEP)를 우회하는 데 사용되는 알려진 기술을 차단하여 이 취약점에 대해 현재 알려진 모든 악용으로부터 보호받도록 인터넷 영역 보안 설정을 **높음**으로 설정합니다. 취약한 코드가 이러한 보호와 함께 있을 수 있지만 대안으로 인해 현재 공격은 통하지 않습니다.

**WindowsVista** **이상에서 Internet Explorer 7 및 Internet Explorer 8 Beta 2의 보호 모드가 이 취약점으로부터 어떻게 보호합니까?**  
Windows Vista에서 Internet Explorer 7 및 Internet Explorer 8 Beta 2는 기본적으로 인터넷 보안 영역에서 [보호 모드](https://www.microsoft.com/windows/windows-vista/features/ie7-protected-mode.aspx)로 실행됩니다. (보호 모드는 인터넷 영역에서 기본적으로 해제됩니다.) 보호 모드는 공격자가 사용자 컴퓨터의 데이터를 쓰고, 변경하고 파괴하거나 악성 코드를 설치할 가능성을 현저히 감소시킵니다. 이러한 기능은 높은 무결성 수준으로 프로세스, 파일 및 레지스트리 키에 대한 액세스를 제한하는 Windows Vista의 무결성 메커니즘을 사용하여 수행됩니다.

**데이터 실행 방지(DEP)란 무엇입니까?**  
데이터 실행 방지(DEP)는 Internet Explorer에 포함되어 있지만 Internet Explorer 7에서는 기본적으로 사용되지 않고, Internet Explorer 8 Beta 2에서는 기본적으로 사용되는 기능입니다. DEP는 코드가 실행할 수 없다고 표시된 메모리에서 실행되는 것을 방지하여 공격을 저지하도록 설계되었습니다. Internet Explorer의 DEP에 대한 자세한 내용은 다음 게시물을 참조하십시오. [https://blogs.msdn.com/ie/archive/2008/04/08/ie8-security-part-I\_3A00\_-dep-nx-memory-protection.aspx (영문)](https://blogs.msdn.com/ie/archive/2008/04/08/ie8-security-part-i_3a00_-dep-nx-memory-protection.aspx). 최근에 DEP를 우회하는 방법을 보여 주는 개념 증명 코드가 공개되었습니다. 그러나 보안 수준을 **높음**으로 설정하고 OLEDB32.dll 대안 중 하나를 적용하는 이 보안 권고에 포함된 대안은 현재 공격을 막는 데 효과적입니다.

**업데이트는 어떤 기능을 수행합니까?**  
보안 업데이트는 악용 가능 조건을 발생시키는 Internet Explorer의 데이터 바인딩 매개 변수 유효성 확인 및 오류 처리 방식을 수정하여 취약점을 제거합니다.

**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-4844 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4844)가 지정되었습니다.
...
IE5.01sp4-KB960714-Windows2000sp4-x86-kor /quiet<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB960714-Windows2000-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
IE5.01sp4-KB960714-Windows2000sp4-x86-kor /norestart<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB960714-Windows2000-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB960714-IE501SP4-20081211.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB960714-IE6SP1-20081211.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/960714">Microsoft 기술 자료 문서 960714</a> 참조</td>
</tr>
<tr class="even">
...
Windowsxp-KB960714-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsXP-KB960714-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003.WindowsXP-KB960714-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3용 Internet Explorer 6:<br />
Windowsxp-KB960714-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3용 Internet Explorer 7:<br />
IE7-WindowsXP-KB960714-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB960714-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstal\KB960714$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP용 Internet Explorer 7:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\ie7updates\KB960714-IE7\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/960714">Microsoft 기술 자료 문서 960714</a> 참조</td>
...
Windowsserver2003-KB960714-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB960714-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB960714-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 6:<br />
Windowsserver2003-KB960714-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB960714-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션용 Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003-KB960714-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 7:<br />
...
제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB960714$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   V1.0(2008년 12월 18일): 공지가 게시되었습니다.  
-   V1.1(2008년 12월 19일): Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(x64 기반 시스템용)에 영향을 받지 않는 Server Core 표시가 추가되었습니다. 또한 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 Internet Explorer Out-Band 업데이트 및 누적 보안 업데이트에 대한 항목이 설명되었습니다. 마지막으로 **XMLIsland기능** **사용 안 함** 대안의 실행 취소 방법이 추가되었습니다.
