...
|----------------------------|-----------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**Office의 취약점으로 인한 원격 코드 실행 문제점(873352)**](https://technet.microsoft.com/security/bulletin/ms05-005) |
...
| 게시판 ID                  | Microsoft Security Bulletin MS05-009                                                                                  |
|----------------------------|-----------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**PNG 처리 취약점으로 인한 원격 코드 실행 문제점(890261)**](https://technet.microsoft.com/security/bulletin/ms05-009) |
...
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**라이센스 로깅 서비스의 취약점으로 인한 원격 코드 실행 문제점(885834)**](https://technet.microsoft.com/security/bulletin/ms05-010) |
| **요약**                   | 원격 코드 실행을 가능하게 하는 취약점이 존재합니다.                                                                                 |
| **최대 위험 등급**         | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                           |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                      |
...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**서버 메시지 블록의 취약점으로 인한 원격 코드 실행 문제점(885250)**](https://technet.microsoft.com/security/bulletin/ms05-011) |
| **요약**                   | 원격 코드 실행을 가능하게 하는 취약점이 존재합니다.                                                                             |
| **최대 위험 등급**         | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                       |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                  |
| **영향을 받는 소프트웨어** | **Windows** 자세한 내용은 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오.                                            |
...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**OLE 및 COM의 취약점으로 인한 원격 코드 실행 문제점(873333)**](https://technet.microsoft.com/security/bulletin/ms05-012) |
| **요약**                   | 원격 코드 실행을 가능하게 하는 취약점이 존재합니다.                                                                       |
| **최대 위험 등급**         | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                 |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                            |
| **영향을 받는 소프트웨어** | **Windows** 자세한 내용은 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오.                                      |
...
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**DHTML Editing Component ActiveX 컨트롤의 취약점으로 인한 코드 실행 문제점(891781)**](https://technet.microsoft.com/security/bulletin/ms05-013) |
| **요약**                   | 원격 코드 실행을 가능하게 하는 공개된 취약점이 존재합니다.                                                                                       |
| **최대 위험 등급**         | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                        |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                   |
| **영향을 받는 소프트웨어** | **Windows** 자세한 내용은 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오.                                                             |

| 게시판 ID                  | Microsoft Security Bulletin MS05-014                                                                        |
|----------------------------|-------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**Internet Explorer 누적 보안 업데이트(867282)**](https://technet.microsoft.com/security/bulletin/ms05-014) |
...
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**하이퍼링크 개체 라이브러리의 취약점으로 인한 원격 코드 실행 문제점(888113)**](https://technet.microsoft.com/security/bulletin/ms05-015) |
| **요약**                   | 원격 코드 실행을 가능하게 하는 취약점이 존재합니다.                                                                                       |
| **최대 위험 등급**         | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                 |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                            |
| **영향을 받는 소프트웨어** | **Windows** 자세한 내용은 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오.                                                      |
...
|----------------------------|-------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**ASP.Net의 취약점으로 인한 인증 우회 문제점(887219)**](https://technet.microsoft.com/security/bulletin/ms05-004) |
...
|----------------------------|-------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**Windows의 취약점으로 인한 정보 공개 문제점(888302)**](https://technet.microsoft.com/security/bulletin/ms05-007) |
...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**Windows 셸의 취약점으로 인한 원격 코드 실행 문제점(890047)**](https://technet.microsoft.com/security/bulletin/ms05-008) |
...
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **게시판 제목**            | [**Windows SharePoint Services 및 SharePoint Team Services의 취약점으로 인한 사이트 간 스크립팅 및 스푸핑 침입 문제점(887981)**](https://technet.microsoft.com/security/bulletin/ms05-006) |
...
-   [MS05-005](https://technet.microsoft.com/security/bulletin/ms05-005)에서 설명된 문제점을 보고해 주신 [Finjan Software (US)](https://www.finjan.com/)의 Rafel Ivgi님
-   [MS05-007](https://technet.microsoft.com/security/bulletin/ms05-007)에서 설명된 문제점을 보고해 주신 [Herve Schauer Consultants (US)](https://www.hsc.fr/)의 Jean-Baptiste Marchand님
-   [MS05-009](https://technet.microsoft.com/security/bulletin/ms05-009)에서 설명된 문제점을 보고해 주신 [Core Security Technologies](https://www1.corest.com/home/home.php)의 Carlos Sarraute님
-   [MS05-010](https://technet.microsoft.com/security/bulletin/ms05-010)에서 설명된 문제점을 보고해 주신 CERT RENATER의 [Kostya Kortchinsky](https://technet.microsoft.com/ko-KR/mailto:kostya.kortchinsky@renater.fr)님
-   [MS05-011](https://technet.microsoft.com/security/bulletin/ms05-011)에서 설명된 문제점을 보고해 주신 [eEYE (US)](https://www.eeye.com/)
-   [MS05-012](https://technet.microsoft.com/security/bulletin/ms05-012)에서 설명된 문제점을 보고해 주신 [Application Security Inc (US)](https://www.appsecinc.com/)의 Cesar Cerrudo님
-   [MS05-014](https://technet.microsoft.com/security/bulletin/ms05-014)에서 설명된 문제점 해결을 위해 협력해 주신 [Michael Krax (US)](https://www.mikx.de/)님
-   [MS05-014](https://technet.microsoft.com/security/bulletin/ms05-014)에서 설명된 문제점을 보고해 주신 [Secunia (US)](https://secunia.com/)의 Andreas Sandblad님
-   [MS05-014](https://technet.microsoft.com/security/bulletin/ms05-014)에서 설명된 문제점을 보고해 주신 [Jouko Pynnonen (US)](https://jouko.iki.fi/index-en.html)님
-   [MS05-015](https://technet.microsoft.com/security/bulletin/ms05-015)에서 설명된 문제점을 보고해 주신 [0x1EE1 (US)](https://technet.microsoft.com/ko-KR/mailto:s53ur9ty_0x1ee1@yahoo.co.uk)
-   **기타 보안 관련 업데이트 입수:**
