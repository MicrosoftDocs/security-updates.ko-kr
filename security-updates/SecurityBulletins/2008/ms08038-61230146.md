...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Vista 및 Windows Vista 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=06739ca6-7368-4acb-bb67-7e8146071a29&displaylang=ko)                         | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=74ea0893-7c2f-4fad-ad27-588ad953b046&displaylang=ko) | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=189a4170-b495-4904-9cbd-209e7494d303&displaylang=ko)\*                            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=85d8701d-f8c7-4079-8a21-a3a9d5ba71ce&displaylang=ko)\*                          | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=b30ee4f0-850f-4ff3-86a4-663603a0a802)                                       | 원격 코드 실행 | 중요        | 없음                      |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 950582](http://support.microsoft.com/kb/950582)에 나와 있습니다.

**이 업데이트에 기능에 대한 보안 관련 변경 사항이 포함되어 있습니까?**  
예. 이 공지의 "취약점 세부 정보" 항목에 나열된 변경 사항 외에도 이 보안 업데이트는 Windows Vista 및 Windows Server 2008 시스템의 자동 실행 기능과 관련하여 공개적으로 알려진 문제점도 해결합니다. 이 업데이트는 NoDriveTypeAutorun 레지스트리 키에서 제어하는 마우스 오른쪽 단추 클릭 및 두 번 클릭 동작을 올바르게 비활성화합니다. [CVE-2008-0951(영문)](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0951)에서 확인된 문제점을 Windows Vista 및 Windows Server 2008에서 수정합니다. 이 레지스트리 키 사용에 대한 자세한 내용은 TechNet 문서, [Microsoft 기술 자료 문서 953252](http://support.microsoft.com/kb/953252)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1435(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1435)를 참조하십시오.
...
**Windows 검색이란 무엇입니까?**  
Windows 검색은 Windows Vista와 Windows Server 2008의 표준 구성 요소이며, 기본적으로 사용하도록 설정되어 있습니다. Windows 검색을 사용하여 전자 메일, 연락처, 일정 약속, 문서, 사진, 멀티미디어, 기타 타사 형식 등의 일반적인 파일 및 데이터 형식을 즉시 검색할 수 있습니다. 이 기능을 통해 소비자와 정보 작업자는 가정 및 기업 환경에서 많은 양의 데이터를 효율적으로 찾고 관리하고 구성할 수 있습니다.자세한 내용은 [Windows 검색(영문)](http://www.microsoft.com/windows/products/winfamily/desktopsearch/default.mspx) 홈 페이지를 참조하십시오.Windows 검색이 Windows XP의 추가 기능이기는 하지만 Windows XP 시스템은 이 문제점의 영향을 받지 않습니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2006-1435(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1435)이 지정되었습니다. 이 보안 공지에서는 공개적으로 보고된 취약점 및 내부 조사를 통해 발견된 추가적인 문제를 해결합니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/950582">Microsoft 기술 자료 문서 950582</a> 참조</td>
</tr>
<tr class="odd">
