---
TOCTitle: 'MS08-066'
Title: 'Microsoft 보안 공지 MS08-066 - 중요'
ms:assetid: 'ms08-066'
ms:contentKeyID: 61230174
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-066(v=Security.10)'
---

Microsoft 보안 공지 MS08-066 - 중요
===================================

Microsoft Ancillary Function Driver의 취약점으로 인한 권한 상승 문제점(956803)
------------------------------------------------------------------------------

게시된 날짜: 2008년 10월 15일 수요일 | 업데이트된 날짜: 2009년 1월 14일 수요일
...
이 보안 업데이트는 비공개로 보고된 Microsoft Ancillary Function Driver의 취약점을 해결합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
...
이 보안 업데이트는 AFD 구성 요소를 통해 사용자 모드에서 Windows 커널로 전달된 입력의 유효성을 정확하게 검사하여 취약점을 해결합니다. 이 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 956803](https://support.microsoft.com/kb/956803)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9&displaylang=ko)                                    | 권한 상승      | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3)             | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074&displaylang=ko)                  | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25&displaylang=ko)      | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 SP1 (Itanium 기반 시스템용) 및 Windows Server 2003 SP2 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517) | 권한 상승      | 중요        | 없음                      |
...
**이 보안 공지가 2009년 1월 13일에 개정된 이유는 무엇입니까?**  
Microsoft는 이 보안 업데이트의 검색 변경을 알리기 위해 이 보안 공지를 개정하였습니다. 수정된 검색은 이전에 이 보안 업데이트에서 제공하지 않았던 보안 업데이트를 영향을 받는 시스템에 제공합니다. 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 956803](https://support.microsoft.com/kb/956803)에 나와 있습니다.

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 문제점은 무엇입니까?**  
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 956803](https://support.microsoft.com/kb/956803)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<th style="border:1px solid black;" >AFD 커널 덮어쓰기 취약점(CVE-2008-3464)</th>
...
AFD 커널 덮어쓰기 취약점(CVE-2008-3464)  
---------------------------------------
  
Windows가 사용자 모드에서 커널로 전달된 입력의 유효성을 올바르게 검사하지 못하므로 Ancillary Function Driver(afd.sys)에 권한 상승 취약점이 존재합니다. 취약점을 통해 공격자가 권한을 상승시키는 코드를 실행할 수 있습니다. 이 취약점 악용에 성공한 로컬 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자는 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3464 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464)를 참조하십시오.
  
#### AFD 커널 덮어쓰기 취약점(CVE-2008-3464)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 이 취약점을 악용하려면 유효한 로그온 자격 증명을 가지고 있어야 하고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### AFD 커널 덮어쓰기 취약점(CVE-2008-3464)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### AFD 커널 덮어쓰기 취약점(CVE-2008-3464)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
AFD 구성 요소는 사용자 모드에서 커널로 데이터를 전달할 때 사용자가 입력하는 입력 내용의 유효성을 제대로 검증하지 않습니다.
  
**AFD 구성 요소란 무엇입니까?**    
AFD 구성 요소는 Windows 소켓 응용 프로그램을 지원하며 afd.sys 파일에 포함되어 있는 "ancillary function driver"를 제공합니다. afd.sys 드라이버는 커널 모드에서 실행되며 Winsock TCP/IP 통신 프로토콜을 관리합니다. 이 Winsock 커널 인터페이스를 통해 TDI 전송을 액세스할 수 있습니다. AFD 구성 요소에 대한 자세한 내용은 [Microsoft 웹 사이트 (영문)](https://msdn.microsoft.com/en-us/library/aa940505.aspx)를 참조하십시오.
  
**TDI 구성 요소란 무엇입니까?**  
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 [Microsoft 웹 사이트 (영문)](https://msdn.microsoft.com/en-us/library/ms801224.aspx)를 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 AFD 구성 요소를 통해 사용자 모드에서 Windows 커널로 전달된 입력의 유효성을 정확하게 검사하여 취약점을 해결합니다.
...
WindowsXP-KB956803-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb956803-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB956803$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/956803">Microsoft 기술 자료 문서 956803</a> 참조</td>
</tr>
<tr class="even">
...
Windowsserver2003-kb956803-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB956803-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb956803-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB956803-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\\$NTUninstallKB956803$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/956803">Microsoft 기술 자료 문서 956803</a> 참조</td>
...
-   AFD 커널 덮어쓰기 취약점(CVE-2008-3464)을 보고해 주신 [SkyRecon (영문)](https://www.skyrecon.com/)의 Fabien Le Mentec
...
-   V1.1(2009년 1월 13일): 이 보안 업데이트에 대한 검색 변경을 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목을 추가하였습니다. 수정된 검색은 이전에 이 업데이트에서 제공하지 않았던 보안 업데이트를 영향을 받는 시스템에 제공합니다. 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.
