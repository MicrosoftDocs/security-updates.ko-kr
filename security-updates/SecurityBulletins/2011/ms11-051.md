...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2518295](http://support.microsoft.com/kb/2518295)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
예. 웹 등록 ASP 페이지를 편집한 고객은 [Microsoft 기술 자료 문서 2518295](http://support.microsoft.com/kb/2518295)에서 시스템에 영향을 줄 수 있는 알려진 문제점에 대한 중요한 정보를 검토하는 것이 좋습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1264 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2518295">Microsoft 기술 자료 문서 2518295</a> 참조</td>
</tr>
<tr class="even">
...
-   Active Directory 자격 증명 서비스 취약점(CVE-2011-1264)을 보고해 주신 [Emaze Networks (영문)](http://www.emaze.net/)의 Ruggero Strabla와 [Saipem Security Team (영문)](http://www.saipem.com/)
