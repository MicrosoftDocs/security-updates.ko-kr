...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0097 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0105 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0978 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0979 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0980 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2466169">Microsoft 기술 자료 문서 2466169</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2502786">Microsoft 기술 자료 문서 2502786</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="https://support.microsoft.com/kb/2464583">Microsoft 기술 자료 문서 2464583</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="https://support.microsoft.com/kb/2466158">Microsoft 기술 자료 문서 2466158</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="https://support.microsoft.com/kb/2466156">Microsoft 기술 자료 문서 2466156</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2466146">Microsoft 기술 자료 문서 2466146</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Excel 정수 오버런 취약점(CVE-2011-0097)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Alin Rad Pop  
-   Excel 힙 오버플로 취약점(CVE-2011-0098)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Alin Rad Pop  
-   Excel 레코드 분석 WriteAV 취약점(CVE-2011-0101)을 보고해 주신 [Telus Security Labs (영문)](https://www.telussecuritylabs.com)의 Muhammad Junaid Bohio  
-   Excel 레코드 분석 WriteAV 취약점(CVE-2011-0101)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Aniway  
-   Excel 메모리 손상 취약점(CVE-2011-0103)을 [VeriSign iDefense Labs](https://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 버퍼 덮어쓰기 취약점(CVE-2011-0104)을 보고해 주신 VDT([Check Point Vulnerability Discovery Team (영문)](https://www.checkpoint.com/))의 Rodrigo Rubira Branco  
-   Excel 데이터 초기화 취약점(CVE-2011-0105)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Aniway  
-   Excel 배열 인덱싱 취약점(CVE-2011-0978)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Aniway  
-   Excel 연결된 목록 손상 취약점(CVE-2011-0979)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 현수 포인터 취약점(CVE-2011-0980)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
