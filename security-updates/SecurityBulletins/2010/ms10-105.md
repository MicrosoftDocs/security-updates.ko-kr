...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 968095](http://support.microsoft.com/kb/968095)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft Office XP 및 Microsoft Office 2003을 사용하는 고객은 이 공지(MS10-105)에서 설명하는 취약점으로부터 보호하기 위해 [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241), Microsoft Office의 취약점으로 인한 원격 코드 실행 문제점(2423930)에서 제공하는 Microsoft Office 업데이트도 설치해야 합니다. MS10-087 및 MS10-105 업데이트를 모두 설치해야 하지만 일정한 순서에 따라 설치할 필요는 없습니다.
...
예. 이 업데이트에는 Microsoft Office 2007 및 Microsoft Office 2010에서 기본적으로 차단되는 변환기 및 필터 목록을 무시하기 위한 지원을 제공하는 비보안 변경 사항이 포함되어 있습니다. Microsoft Office 그래픽 필터용 보안 설정에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2479871](http://support.microsoft.com/kb/2479871)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3945 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3945)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3946 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3946)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3947 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3947)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3949 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3949)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3950 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3950)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3951 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3951)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3952 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3952)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2289162">Microsoft 기술 자료 문서 2289162</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2289163">Microsoft 기술 자료 문서 2289163</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2288931">Microsoft 기술 자료 문서 2288931</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2289078">Microsoft 기술 자료 문서 2289078</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2456849">Microsoft 기술 자료 문서 2456849</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2431831">Microsoft 기술 자료 문서 2431831</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   CGM 이미지 변환기 버퍼 오버런 취약점(CVE-2010-3945)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Yamata Li  
-   PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Yamata Li  
-   PICT 이미지 변환기 정수 오버플로 취약점(CVE-2010-3946)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Alin Rad Pop  
-   TIFF 이미지 변환기 힙 오버플로 취약점(CVE-2010-3947)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Carsten Eiram  
-   TIFF 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3949)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Carsten Eiram  
-   TIFF 이미지 변환기 메모리 손상 취약점(CVE-2010-3950)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Carsten Eiram  
-   FlashPix 이미지 변환기 버퍼 오버플로 취약점(CVE-2010-3951)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Dyon Balding  
-   FlashPix 이미지 변환기 힙 손상 취약점(CVE-2010-3952)을 보고해 주신 [Secunia Research (영문)](http://secunia.com/)의 Dyon Balding
