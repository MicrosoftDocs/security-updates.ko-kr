...
<td style="border:1px solid black;">
[MS12-063](http://go.microsoft.com/fwlink/?linkid=255505)의 KB2744842는 KB2761451로 대체되었습니다.
</td>
</tr>
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [11월 공지 요약](http://technet.microsoft.com/security/bulletin/ms12-nov)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1538](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1539](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4775](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2761451">Microsoft 기술 자료 문서 2761451</a> 참조</td>
</tr>
<tr class="odd">
...
-   CFormElement 해제 후 사용 취약점(CVE-2012-1538)을 [VeriSign iDefense Labs](http://labs.idefense.com/)와 협력하여 보고해 주신 spa-s3c.blogspot.com의 Jose A. Vazquez Gonzalez  
-   CFormElement 해제 후 사용 취약점(CVE-2012-1538)을 보고해 주신 [Omair](http://krash.in/)  
-   CTreePos 해제 후 사용 취약점(CVE-2012-1539)을 [VeriSign iDefense Labs](http://labs.idefense.com/)와 협력하여 보고해 주신 spa-s3c.blogspot.com의 Jose A. Vazquez Gonzalez  
-   CTreeNode 해제 후 사용 취약점(CVE-2012-4775)을 보고해 주신 [Trend Micro](http://www.trendmicro.com/)의 Cheng-da Tsai(Orange), Sung-ting Tsai 및 Ming-chieh Pan(Nanika)
