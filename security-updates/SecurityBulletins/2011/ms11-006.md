---
TOCTitle: 'MS11-006'
Title: 'Microsoft 보안 공지 MS11-006 - 긴급'
ms:assetid: 'ms11-006'
ms:contentKeyID: 61230372
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-006(v=Security.10)'
---

Security Bulletin

Microsoft 보안 공지 MS11-006 - 긴급
===================================

Windows 셸 그래픽 처리의 취약점으로 인한 원격 코드 실행 문제점(2483185)
-----------------------------------------------------------------------

게시된 날짜: 2011년 2월 9일 수요일 | 업데이트된 날짜: 2011년 2월 15일 화요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Server 2003, Windows Vista 및 Windows Server 2008 에디션에 대해 긴급입니다. 지원 대상인 Windows 7 및 Windows Server 2008 R2 에디션은 이 취약점의 영향을 받지 않습니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Windows 셸 그래픽 프로세서가 축소판 그림을 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 2490606](http://technet.microsoft.com/security/advisory/2490606)에서 처음 설명한 취약점도 해결합니다.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57)                                                                 | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf&displaylang=ko)                                                                  | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398&displaylang=ko)                                                      | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)                                                             | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8&displaylang=ko)                                           | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d&displaylang=ko)                   | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb&displaylang=ko)\*\*     | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c&displaylang=ko)\*\* | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b)            | 원격 코드 실행 | 긴급        | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
...
**Microsoft 보안 권고 2490606에서 제공된 대안을 적용한 경우 이 업데이트를 적용하기 전에 해당 대안의 실행을 취소해야 합니까?**  
예. 이 보안 업데이트를 설치하기 전에 시스템에서 이전에 적용한 "Windows XP 및 Windows Server 2003 시스템에서 shimgvw.dll ACL(액세스 제어 목록) 수정" 대안의 실행을 취소해야 합니다. 이 대안을 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2483185](http://support.microsoft.com/kb/2483185)를 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
<th style="border:1px solid black;" >Windows 셸 그래픽 처리 오버런 취약점(CVE-2010-3970)</th>
...
Windows 셸 그래픽 프로세서가 특수하게 조작된 축소판 그림을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 로그온한 사용자의 보안 컨텍스트에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3970 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)을 참조하십시오.
  
#### Windows 셸 그래픽 처리 오버런 취약점(CVE-2010-3970)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다.  
-   취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
#### Windows 셸 그래픽 처리 오버런 취약점(CVE-2010-3970)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **Windows XP 및 Windows Server 2003 시스템에서 shimgvw.dll ACL(액세스 제어 목록) 수정**
  
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2483185](http://support.microsoft.com/kb/2483185)를 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
  
    shimgvw.dll의 ACL을 더 엄격하게 수정하려면 관리자 권한이 있는 명령 프롬프트에서 다음 명령을 실행합니다.
    ...
    **대안의 영향.** 일반적으로 Windows 셸 그래픽 프로세서에서 처리하는 미디어 파일이 제대로 표시되지 않습니다. MS11-006 보안 업데이트를 설치하기 전에 시스템에서 이전에 적용한 이 대안의 실행을 취소해야 합니다.
...
-   **Windows Vista 및 Windows Server 2008 시스템의 Windows 탐색기에서 미리 보기를 사용하지 않도록 설정**
  
    Windows Vista 및 Windows Server 2008의 Windows 탐색기에서 미리 보기를 사용하지 않도록 설정하려면 다음 단계를 수행하십시오.
  
    1.  **제어판**을 열고 **모양 및 개인 설정**을 선택합니다.  
    2.  메뉴에서 **폴더 옵션**을 선택합니다.  
    3.  **보기** 탭을 선택하고 **아이콘은 항상 표시하고 미리 보기는 표시하지 않음** 옵션이 선택되어 있는지 확인합니다. **확인**을 클릭하여 설정을 저장합니다.  
    4.  열려 있는 모든 Windows 탐색기 인스턴스를 닫아 변경 내용을 적용합니다.
  
    **대안의 영향:** Windows 탐색기가 미리 보기를 표시하지 않습니다.
  
    **대안 실행 취소 방법:**
  
    Windows Vista 및 Windows Server 2008에서 미리 보기를 사용하도록 설정하려면 다음 단계를 수행하십시오.
  
    1.  **제어판**을 열고 **모양 및 개인 설정**을 선택합니다.  
    2.  메뉴에서 **폴더 옵션**을 선택합니다.  
    3.  **보기** 탭을 선택하고 **아이콘은 항상 표시하고 미리 보기는 표시하지 않음** 옵션이 선택되어 있지 않은지 확인합니다. **확인**을 클릭하여 설정을 저장합니다.  
    4.  열려 있는 모든 Windows 탐색기 인스턴스를 닫아 변경 내용을 적용합니다.
  
#### Windows 셸 그래픽 처리 오버런 취약점(CVE-2010-3970)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
Windows 셸 그래픽 프로세서가 특수하게 조작된 축소판 그림을 제대로 구문 분석하지 못하여 스택 버퍼 오버런이 발생할 때 취약점이 야기됩니다.
...
이 취약점을 악용하려면 사용자가 특수하게 조작된 축소판 그림을 봐야 합니다.
  
네트워크 시나리오에서 공격자는 특수하게 조작된 축소판 그림이나 특수하게 조작된 축소판 그림을 포함하는 파일을 UNC 또는 WebDAV 위치와 같은 네트워크 공유에 두고 사용자가 Windows 탐색기에서 해당 위치를 검색하도록 유도해야 합니다. 사용자가 해당 공유로 이동하면 Windows 셸 그래픽 프로세서를 통해 영향을 받는 제어 경로가 트리거됩니다. 그런 다음 특수하게 조작된 축소판 그림에 의해 취약점이 악용되고 로그온한 사용자의 보안 컨텍스트에서 코드가 실행될 수 있습니다. 공격자는 강제로 사용자가 네트워크 공유, UNC 또는 WebDAV 위치를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 인스턴트 메신저 메시지의 링크를 클릭하여 공격자의 네트워크 공유, UNC 또는 WebDAV 위치를 방문하도록 유도하는 것이 일반적입니다.
  
**UNC(범용 명명 규칙)이란 무엇입니까?**  
UNC(범용 명명 규칙)은 네트워크의 공유 이름이나 파일과 같은 리소스를 식별하는 방법입니다. 일반적인 UNC 이름은 "\\\\server\\share\\subdirectory\\filename"과 같이 두 개의 백슬래시로 시작하며, 서버 이름이 뒤따릅니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Windows 셸 그래픽 프로세서가 축소판 그림을 구문 분석하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3970 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2490606](http://technet.microsoft.com/security/advisory/2490606)에서 설명되었습니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3970 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)이 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2483185$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2483185">Microsoft 기술 자료 문서 2483185</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 셸 그래픽 처리 오버런 취약점(CVE-2010-3970)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 Kobi Pariente 및 Yaniv Miron
...
-   V1.1(2011년 2월 15일): 이 보안 업데이트를 설치하기 전에 시스템에서 이전에 적용한 "Windows XP 및 Windows Server 2003 시스템에서 shimgvw.dll ACL(액세스 제어 목록) 수정" 대안의 실행을 취소해야 한다는 것을 고객에게 알리기 위해 업데이트 FAQ에 항목이 추가되었습니다.
