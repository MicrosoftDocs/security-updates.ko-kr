...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac&displaylang=ko)                                                             | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
...
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55)                                                               | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f)                                                                | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214&displaylang=ko)                                                                                  | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
...
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0568 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)을 참조하십시오.
...
IDL 파일은 클라이언트와 서버 간에 전송되는 항목에 대한 네트워크 계약을 지정합니다. 이 정보를 운영 환경에 대한 정보와 분리하면 IDL 파일을 다른 환경으로 이식할 수 있습니다. IDL 파일은 [인터페이스 헤더 (영문)](http://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx)와 [인터페이스 본문 (영문)](http://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx)의 두 부분으로 구성됩니다.
  
ACF는 네트워크 계약이 아닌 로컬 성능에만 영향을 미치는 특성을 지정합니다. Microsoft RPC는 ACF 및 IDL 특성을 단일 IDL 파일에 조합할 수 있도록 합니다. 여러 인터페이스 및 해당 ACF를 단일 IDL 파일에 조합할 수도 있습니다. 자세한 내용은 MSDN 문서, [IDL 및 ACF 파일 (영문)](http://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx)을 참조하십시오.
  
**IPC(프로세스 간 통신)란 무엇입니까?**    
Microsoft Windows 운영 체제는 응용 프로그램 간의 통신 및 데이터 공유를 용이하게 하기 위한 메커니즘을 제공합니다. 이러한 메커니즘을 통해 사용할 수 있는 작업을 통틀어 IPC(프로세스 간 통신)라고 합니다. 여러 구체적인 프로세스에 작업 부하를 편리하게 분산할 수 있도록 하는 IPC 형식도 있고, 네트워크의 여러 컴퓨터에 작업 부하를 편리하게 분산할 수 있도록 하는 IPC 형식도 있습니다. 자세한 내용은 MSDN 문서, [프로세스 간 통신(영문)](http://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-0568 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/970238">Microsoft 기술 자료 문서 970238</a> 참조</td>
</tr>
<tr class="even">
