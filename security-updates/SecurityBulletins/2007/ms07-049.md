...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 937986](https://support.microsoft.com/kb/937986)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
| [Microsoft Virtual PC for Mac 버전 6.1](https://www.microsoft.com/mac/downloads.aspx)                                                                 | 권한 상승      | 중요        | 없음                      |
| [Microsoft Virtual PC for Mac 버전 7](https://www.microsoft.com/mac/downloads.aspx)                                                                   | 권한 상승      | 중요        | 없음                      |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 937986](https://support.microsoft.com/kb/937986)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-0948 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0948)을 참조하십시오.
...
-   Microsoft Virtual Server 2005 R2 SP1은 이 문제점에 취약하지 않습니다. Microsoft Virtual Server 2005 R2 SP1의 정식 버전은 [Microsoft 다운로드 센터 (영문)](https://www.microsoft.com/technet/prodtechnol/eval/virtualserver/default.mspx)에서 다운로드할 수 있습니다.
...
보안 업데이트는 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747), [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 및 [Office 업데이트](https://go.microsoft.com/fwlink/?linkid=21135)에서 제공됩니다. 보안 업데이트는 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink/?linkid=21129)에서도 다운로드할 수 있으며 "security\_patch"라는 키워드를 사용하여 쉽게 찾을 수 있습니다. 마지막으로, 보안 업데이트는 Windows Update 카탈로그에서 다운로드할 수 있습니다. Windows Update 카탈로그에 대한 자세한 내용은 [Microsoft 기술 자료 문서 323166](https://support.microsoft.com/kb/323166)을 참조하십시오.
...
설치 관리자에 대한 자세한 내용은 [IExpress 기술 및 IExpress 마법사 웹 사이트 (영문)](https://www.microsoft.com/technet/prodtechnol/ie/ieak/techinfo/deploy/60/en/iexpress.mspx?mfr=true) (영문)를 참조하십시오.
...
-   [Microsoft Virtual PC for Mac 버전 6.1.1 업데이트](https://www.microsoft.com/mac/downloads.aspx)가 컴퓨터에 설치되어 있어야 합니다.
...
Microsoft Virtual PC for Mac 버전 6.1.2 업데이트의 해당 언어 버전을 [Microsoft Mactopia 웹 사이트](https://www.microsoft.com/mac/downloads.aspx)에서 다운로드하여 설치하십시오.
...
이 업데이트와 관련하여 기술적인 질문이 있거나 다운로드에 문제가 있는 경우 [Microsoft for Mac Suppor (영문)](https://www.microsoft.com/mac/support.aspx)를 방문하여 사용 가능한 지원 옵션에 대해 알아보십시오.
...
-   [Microsoft Virtual PC for Mac 버전 7.0.2 업데이트](https://www.microsoft.com/mac/downloads.aspx)가 컴퓨터에 설치되어 있어야 합니다.
...
Microsoft Virtual PC for Mac 버전 7.0.3 업데이트의 해당 언어 버전을 [Microsoft Mactopia 웹 사이트](https://www.microsoft.com/mac/downloads.aspx)에서 다운로드하여 설치하십시오.
...
-   Virtual PC 및 Virtual Server의 취약점으로 인한 권한 상승 취약점(CVE-2007-0948)을 해결하기 위해 Microsoft와 협력해 주신 [McAfee Avert Labs (영문)](https://www.avertlabs.com/)의 Rafal Wojtczuk
