...
이 보안 업데이트는 Adobe 보안 공지 [APSB17-04](https://helpx.adobe.com/kr/security/products/flash-player/apsb17-04.html)에 설명된 다음 취약성을 해결합니다.
...
<sup>[2]</sup>Windows 10 업데이트용 Adobe Flash Player 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 또는 [Microsoft Update](https://catalog.update.microsoft.com/v7/site/home.aspx) 카탈로그에서 제공됩니다.

\*대체된 업데이트 열에는 대체된 일련의 업데이트 중 최신 업데이트만 표시됩니다. 대체된 업데이트의 전체 목록을 확인하려면 [Microsoft 업데이트 카탈로그](https://catalog.update.microsoft.com/v7/site/home.aspx)로 이동하여 업데이트 KB 번호를 검색한 다음 업데이트 세부 정보를 보십시오. 대체된 업데이트 정보는 패키지 세부 정보 탭에 나와 있습니다.
