...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 917953](https://support.microsoft.com/kb/917953)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 917953](https://support.microsoft.com/kb/917953)을 참조하십시오.

**테스트된 소프트웨어 및 보안 업데이트 다운로드 위치:**

**영향을 받는 소프트웨어:**

-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=305e208c-d75c-471b-9e57-30d01e320ad1)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=b62abe8e-4735-4934-a66e-5b957986efbf)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=44213900-9082-45dc-b514-31d38717fe89)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ea319c61-b405-41ab-9eee-d5b3488b90e0)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=cd8b88b5-f90f-4c0c-a5ad-3641751381c9)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=cd8699bc-6760-4f0e-b8e0-2e7d89092ce8)
...
|-----------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| IP 원본 라우팅 취약점 - [CVE-2006-2379 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2379) | 원격 코드 실행       | 중요         | 중요                   | 보통                   | 중요                | 보통                            |
...
IP 원본 라우팅 비활성화에 대한 자세한 내용은 다음 MSDN 자료에서 추가 보호 정보를 읽어보십시오. [TCP/IP 스택 보안을 강화하는 방법(영문)](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnnetsec/html/hthardtcp.asp)
