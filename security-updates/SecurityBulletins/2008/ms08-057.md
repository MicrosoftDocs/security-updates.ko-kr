...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 956416](http://support.microsoft.com/kb/956416)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3477 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3477)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3471 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3471)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4019 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4019)를 참조하십시오.
...
-   지원되는 2007 Microsoft Office System 버전은 [Create a network installation point for the 2007 Office system(2007 Office System의 네트워크 설치 지점 만들기) (영문)](http://technet.microsoft.com/en-us/library/cc179063.aspx)을 참조하십시오.  
    **참고** 중앙에서 보안 업데이트를 관리하려는 경우 Windows Server Update Services를 사용합니다. Windows Server Update Services를 사용하여 2007 Microsoft Office System에 보안 업데이트를 신속하게 배포하는 방법에 대한 자세한 내용은 [Windows Server Update Services 웹 사이트](http://www.microsoft.com/korea/smserver/default.mspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/956416">Microsoft 기술 자료 문서 956416</a> 참조</td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/)및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 파일 형식 구문 분석 취약점(CVE-2008-3471)을 보고해 주신 Wushi  
-   [iDefense VCP](http://labs.idefense.com/)와 협력하여 일정 개체 유효성 검사 취약점(CVE-2008-3477)을 보고해 주신 [Labo Skopia (영문)](http://www.laboskopia.com/)의 Lionel d'Hauenens  
-   일정 개체 유효성 검사 취약점(CVE-2008-3477)을 보고해 주신 [iDefense (영문)](http://labs.idefense.com/)의 Joshua J. Drake
