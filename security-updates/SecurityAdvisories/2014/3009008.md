...
Microsoft는 고객 보호를 위해 함께 노력해주신 다음 분들께 [감사](https://technet.microsoft.com/ko-kr/security/gg309157.aspx)를 전합니다.
  
-   이 문제점을 해결하기 위해 협력해 주신 [Google Security Team](https://googleonlinesecurity.blogspot.com/)의 Bodo Möller
...
-   기술 지원은 1577-9700을 통해 Microsoft [고객 지원 센터](https://support.microsoft.com/ko-kr/gp/gp_security_main)에서 받을 수 있습니다. 자세한 내용은 [Microsoft 도움말 및 지원](https://support.microsoft.com/?ln=ko) 웹 사이트를 참조하십시오.  
