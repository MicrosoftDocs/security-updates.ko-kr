...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2405882](http://support.microsoft.com/kb/2405882)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=4a422192-d7fa-47e5-9661-2c65eaefaf62&displaylang=ko)<sup>[1]</sup>
(KB979688)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
Microsoft는 Windows Vista 서비스 팩 1에서 Windows Search 4.0을 설치한 후 [Microsoft 기술 자료 문서 2405882](http://support.microsoft.com/kb/2405882)에서 제공되는 보안 업데이트를 설치하고 Windows Vista 서비스 팩 2로 마이그레이션한 사용자를 위해 Windows Vista 서비스 팩 2용 추가 업데이트(KB979688)를 제공하기 위해 이 공지를 다시 릴리스했습니다. 이 시나리오에 해당되는 고객은 이 공지에서 설명하는 취약점으로부터 보호하기 위해 [Microsoft 기술 자료 문서 2405882](http://support.microsoft.com/kb/2405882)에서 제공하는 새 업데이트를 설치해야 합니다. 이 시나리오에 해당되는 자동 업데이트를 사용하는 고객은 이 업데이트가 시스템에 제공됩니다. 자세한 내용은 [Microsoft 기술 자료 문서 2405882](http://support.microsoft.com/kb/2405882)를 참조하십시오.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항의 위치에 대해서는 **보안 업데이트 배포** 섹션에서 참조 표를 참조하십시오.

**이 업데이트에 기능에 대한 다른 비보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 보안과 관련이 없는 기능 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 2252664](http://support.microsoft.com/kb/2252664)를 참조하십시오.
...
이 완화 조치는 [Microsoft 보안 권고(973882)](http://technet.microsoft.com/security/advisory/973882) 및 [MS09-035](http://technet.microsoft.com/security/bulletin/ms09-035)에 설명되어 있는 ATL 취약점을 해결합니다. 변경 사항은 영향을 받는 모든 플랫폼에 기본적으로 적용되며 Microsoft에서 작성하지 않은 컨트롤을 포함하여 Microsoft Windows에 로드되는 모든 컨트롤에서 ATL 취약점을 차단합니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/979687">Microsoft 기술 자료 문서 979687</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">WordPad의 경우 <a href="http://support.microsoft.com/kb/979687">Microsoft 기술 자료 문서 979687</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 셸의 경우 <a href="http://support.microsoft.com/kb/979688">Microsoft 기술 자료 문서 979688</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   COM 유효성 검사 취약점(CVE-2010-1263)을 보고해 주신 [Rapid7](http://www.rapid7.com/)의 HD Moore  
-   이 공지에서 해결된 심층 보안 변경 사항에 대해 협력해 주신 [IBM ISS X-Force (영문)](http://www.iss.net/)의 David Dewey 및 [Accuvant (영문)](http://www.accuvant.com/)(이전 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/))의 Ryan Smith
