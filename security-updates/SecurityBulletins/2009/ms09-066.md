...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1928 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/973037">Microsoft 기술 자료 문서 973037</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/973039">Microsoft 기술 자료 문서 973039</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory의 경우 <a href="http://support.microsoft.com/kb/973037">Microsoft 기술 자료 문서 973037</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003의 ADAM(Active Directory Application Mode)의 경우 <a href="http://support.microsoft.com/kb/973039">Microsoft 기술 자료 문서 973039</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory:<br />
