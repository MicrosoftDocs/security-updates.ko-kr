...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ccc3d8fb-2631-42d0-87ed-5d29d4b1f598&amp;displaylang=ko">Windows XP 서비스 팩 3</a> <br />
(KB2723135)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=246927">MS12-036</a>의 KB2685939는 KB2723135로 대체되었습니다.</td>
</tr>
</tbody>
</table>
...
Microsoft는 적절한 타임스탬프 특성 없이 Microsoft에서 생성한 특정 디지털 인증서와 관련된 문제를 해결하도록 하는 Windows XP에 대한 KB2723135 업데이트를 다시 릴리스하기 위해 이 공지를 개정했습니다. 자세한 내용은 [Microsoft 보안 권고 KB 2749655](https://go.microsoft.com/fwlink/?linkid=265301)를 참조하십시오.
  
파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.
  
보안 업데이트의 해시는 어디에 있습니까?  
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2723135](https://support.microsoft.com/kb/2723135)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](https://technet.microsoft.com/security/bulletin/ms12-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2526)(영문)을 참조하십시오.
...
-   더 이상 필요하지 않은 원격 데스크톱 기능을 사용하지 않도록 설정
    ...
    수동 및 그룹 정책을 사용하여 원격 지원을 사용하지 않도록 설정하는 방법에 대한 지침을 포함한 원격 지원에 대한 자세한 내용은 TechNet 문서 [Remote Assistance](https://technet.microsoft.com/library/bb457177.aspx)를 참조하십시오.
...
RDP(원격 데스크톱 프로토콜)을 사용하여 사용자는 자신의 데스크톱 컴퓨터에 가상 세션을 만들 수 있습니다. RDP를 통해 원격 사용자는 자신의 컴퓨터에 있는 모든 데이터와 응용 프로그램에 액세스할 수 있습니다. 자세한 내용은 MSDN 문서 [원격 데스크톱 프로토콜](https://msdn.microsoft.com/library/aa383015.aspx)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2723135">Microsoft 기술 자료 문서 2723135</a> 참조</td>
</tr>
<tr class="even">
