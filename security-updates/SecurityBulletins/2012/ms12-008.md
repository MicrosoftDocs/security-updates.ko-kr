---
TOCTitle: 'MS12-008'
Title: 'Microsoft 보안 공지 MS12-008 - 긴급'
ms:assetid: 'ms12-008'
ms:contentKeyID: 61230475
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-008(v=Security.10)'
---


Microsoft 보안 공지 MS12-008 - 긴급
===================================
...
이 보안 업데이트는 Windows 커널 모드 드라이버가 GDI에 대한 사용자 모드 호출을 처리하고 키보드 레이아웃 오류를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|-----------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=832afe5e-d61e-4554-b889-9174df042b32&displaylang=ko)                                                                                     | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ff2c141c-08b4-42c6-9f66-580f8678c01f)                                                                           | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f0e6e06d-89db-45ad-9660-7959c6f9b546&displaylang=ko)                                                                            | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b81decda-9d82-4ffb-baae-78b190e553ea&displaylang=ko)                                                                | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8dcd71c8-82ad-4f86-b386-7f1ea09e157f)                                                                            | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5852118c-fc39-45e2-8b44-ce1401d310e2&displaylang=ko)                                                                                  | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5161d16d-1037-49d5-8d4d-c353288cb41c&displaylang=ko)                                                                      | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=45c6c511-a4fa-4c3b-af26-6c113f6f5f5e&displaylang=ko)\*\*\*\*                                                   | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=046932cf-0671-49e6-8ddf-98abfc97c5f0&displaylang=ko)\*\*\*\*                                                 | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=304bd0c5-f4ee-4f8c-89b4-4cbaaf418679)                                                                    | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=3e5ca1bf-9415-412c-9dff-dd1abc57e74d&displaylang=ko)                                       | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=78cbbe02-a3d3-4cef-9b54-a3e78c1b885a&displaylang=ko)                                   | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=6b228ad6-d5a4-4b91-8aa8-0874deb22116&displaylang=ko)\*\*\*\* | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=922b2438-0cfc-49e3-b9a0-52c68b69126a)                | 긴급           | 원격 코드 실행 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
...
Windows Server 2008 및 Windows Server 2008 R2를 Server Core 설치 옵션을 사용하여 설치하면 CVE-2011-5046에 대한 공격 시나리오인 로컬 권한 상승 문제점에만 취약해지며 웹 기반 및 파일 공유 공격 시나리오는 적용되지 않습니다.
...
<th style="border:1px solid black;" >GDI 액세스 위반 취약점(CVE-2011-5046)</th>
<th style="border:1px solid black;" >키보드 레이아웃 해제 후 사용 취약점(CVE-2012-0154)</th>
...
GDI의 커널 구성 요소를 통해 사용자 모드에서 전달된 입력에 대한 잘못된 유효성 검사로 인해 원격 코드 실행 취약점이 Windows 커널에 존재합니다. 이 취약점은 공격자가 커널 모드에서 코드를 실행하고 프로그램을 설치하도록 하며 전체 관리자 권한으로 데이터를 보거나 변경하거나 삭제하고, 새 계정을 만들 수 있도록 합니다.
...
#### GDI 액세스 위반 취약점(CVE-2011-5046)에 대한 완화 요소
...
#### GDI 액세스 위반 취약점(CVE-2011-5046)에 대한 대안
...
#### GDI 액세스 위반 취약점(CVE-2011-5046)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이것은 원격 코드 실행 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
취약점의 원인은 무엇입니까?   
이 취약점은 Windows 커널 모드 드라이버가 GDI의 커널 구성 요소를 통해 사용자 모드에서 전달된 입력에 대한 적절한 검증을 수행하지 않을 때 발생합니다.
  
이 취약점의 영향을 받는 구성 요소는 무엇입니까?   
Win32k.sys가 취약점의 영향을 받는 Windows 구성 요소입니다.
  
GDI란 무엇입니까?   
Microsoft Windows GDI(그래픽 장치 인터페이스)를 통해 응용 프로그램이 비디오 디스플레이와 프린터 모두에서 그래픽과 형식 있는 텍스트를 사용할 수 있습니다. Windows 기반 응용 프로그램은 그래픽 하드웨어에 직접 액세스하지 않습니다. GDI가 응용 프로그램 대신 장치 드라이버와 상호 작용을 수행합니다. GDI에 대한 자세한 내용은 MSDN 문서, [Windows GDI](https://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)를 참조하십시오.
...
업데이트는 어떤 기능을 수행합니까?   
이 업데이트는 Windows 커널 모드 드라이버가 GDI에 대한 사용자 모드 호출을 처리하는 방식을 수정하여 이 취약점을 해결합니다.
  
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?   
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-5046(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-5046)이 지정되었습니다.
...
Windows 커널 모드 드라이버가 특정 키보드 레이아웃을 관리하는 방식 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0154(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0154)를 참조하십시오.
  
#### 키보드 레이아웃 해제 후 사용 취약점(CVE-2012-0154)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### 키보드 레이아웃 해제 후 사용 취약점(CVE-2012-0154)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### 키보드 레이아웃 해제 후 사용 취약점(CVE-2012-0154)에 대한 FAQ
...
취약점의 원인은 무엇입니까?   
이 취약점은 Windows 커널 모드 드라이버가 키보드 레이아웃 오류를 적절하게 처리하지 못할 때 발생합니다.
...
업데이트는 어떤 기능을 수행합니까?   
이 업데이트는 Windows 커널 모드 드라이버가 키보드 레이아웃 오류를 처리하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2660465$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2660465">Microsoft 기술 자료 문서 2660465</a> 참조</td>
</tr>
<tr class="even">
...
-   키보드 레이아웃 해제 후 사용 취약점(CVE-2012-0154)을 보고해 주신 [Azimuth Security(영문)](https://www.azimuthsecurity.com/)의 Tarjei Mandt
