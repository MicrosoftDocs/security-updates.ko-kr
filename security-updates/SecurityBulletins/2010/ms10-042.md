...
이 보안 업데이트는 [Microsoft 보안 권고 2219475](http://technet.microsoft.com/security/advisory/2219475)에서 처음 설명한 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1885 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885)를 참조하십시오.
...
**참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2229593](http://support.microsoft.com/kb/2229593)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-1885 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885)가 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2219475](http://technet.microsoft.com/security/advisory/2219475)에서 처음 설명되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2229593">Microsoft 기술 자료 문서 2229593</a> 참조</td>
</tr>
<tr class="even">
