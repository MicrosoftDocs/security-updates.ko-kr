---
TOCTitle: 'MS13-079'
Title: 'Microsoft 보안 공지 MS13-079 - 중요'
ms:assetid: 'ms13-079'
ms:contentKeyID: 61230629
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-079(v=Security.10)'
---

Microsoft 보안 공지 MS13-079 - 중요
===================================
...
이 보안 업데이트의 심각도는 Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2, Windows 8 및 Windows Server 2012에서 영향을 받는 AD LDS(Active Directory Lightweight Directory Service) 및 Active Directory Services에 대해 중요입니다.

이 보안 업데이트는 LDAP 디렉터리 서비스가 특수하게 조작된 LDAP 쿼리를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
| 기술 자료 문서 | [2853587](https://support.microsoft.com/kb/2853587) |
|----------------|-----------------------------------------------------|
| 파일 정보      | 예                                                  |
| SHA1/SHA2 해시 | 예                                                  |
| 알려진 문제점  | 없음                                                |
...
<td style="border:1px solid black;">
[AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=256f9ab0-48fe-40e1-af48-376d99d19f48&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=610e8d9a-2ae7-45d5-a885-b3b1ef9843a7&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[Active Directory 서비스 및 AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=32378465-931d-4edb-91b9-a4358f3476c7&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[Active Directory 서비스 및 AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=6d4985aa-6337-4b8c-8fd9-b97e026a7109&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=68c60e15-1a7a-4895-84d0-b5614ccd646a&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=33b8a458-bb54-45ce-9272-7ddad9ad0348&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[Active Directory 서비스 및 AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=0feca060-a2b7-4fa9-9325-87239b9a9960&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=fbe01ba9-4225-495d-82a3-32b21a4daca0&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=e21d4f90-bc42-4b52-8b63-781f73663d6f&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[Active Directory 서비스 및 AD LDS(Active Directory Lightweight Directory Service)](https://www.microsoft.com/download/details.aspx?familyid=bf75f088-9a30-4954-971c-8d56134a49c7&displaylang=ko)  
(2853587)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<span></span>
영향을 받는 소프트웨어 표에 나열된 운영체제 중 하나를 사용하고 있습니다. 보안 업데이트가 제공되지 않는 이유는 무엇입니까?  
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 에디션 서비스 팩 2의 AD LDS
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 서비스 팩 2의 AD LDS
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 서비스 팩 2의 AD LDS(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 AD LDS
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 AD LDS(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows 7(32비트 시스템용) 서비스 팩 1의 AD LDS
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용) 서비스 팩 1의 AD LDS
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 AD LDS
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 AD LDS(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Active Directory 서비스
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Active Directory 서비스(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Active Directory 서비스
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Active Directory 서비스(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Active Directory 서비스
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Active Directory 서비스(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr>
<td style="border:1px solid black;">
Windows Server 2012의 Active Directory 서비스
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2012의 Active Directory 서비스(Server Core 설치)
</td>
<td style="border:1px solid black;">
중요   
서비스 거부
...
<span></span>
서비스 거부 취약점이 Active Directory 서비스 및 AD LDS의 구현에 존재하여 LDAP 디렉터리 서비스 응답이 멈출 수 있습니다. 이러한 문제는 관리자가 서비스를 다시 시작해야 해결됩니다. 이 취약점은 LDAP 디렉터리 서비스가 특수하게 조작된 쿼리를 처리하지 못할 때 발생합니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-3868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3868)(영문)을 참조하십시오.
...
취약점의 원인은 무엇입니까?  
이 취약점은 LDAP 디렉터리 서비스가 특수하게 조작된 LDAP 쿼리를 적절하게 처리하지 못할 때 발생합니다.
...
AD LDS(Active Directory Lightweight Directory Service)는 응용 프로그램을 위한 전용 디렉터리 서비스를 제공하는 Active Directory의 독립 모드입니다. AD LDS는 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에서 사용할 수 있습니다. AD LDS는 Windows XP 및 Windows Server 2003에서 사용할 수 있는 ADAM(Active Directory Application Mode)을 대신합니다. AD LDS에 대한 자세한 내용은 [Active Directory LDS(Lightweight Directory Services) 개요](https://technet.microsoft.com/library/cc754361)를 참조하십시오.

공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
이 취약점을 성공적으로 악용한 공격자는 LDAP 디렉터리 서비스가 응답하지 않도록 만들 수 있습니다. 이러한 문제는 관리자가 서비스를 다시 시작해야 해결됩니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
공격자는 특수하게 조작된 쿼리를 LDAP 디렉터리 서비스로 보내 이 취약점을 악용할 수 있습니다.

취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?  
주로 서버가 이 취약점으로 인한 위험에 노출됩니다.

업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 LDAP 디렉터리 서비스가 특수하게 조작된 LDAP 쿼리를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2853587">Microsoft 기술 자료 문서 2853587</a> 참조</td>
</tr>
<tr class="odd">
...
|                         |                                                                                                                                                                                                                              |  
|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
| 보안 업데이트 파일 이름 | AD LDS가 있는 지원 대상인 모든 Windows 7 32비트 에디션:Windows6.1-KB2853587-x86.msu                                                                                                                                          |  
|                         | AD LDS가 있는 지원 대상인 모든 Windows 7 x64 기반 에디션:Windows6.1-KB2853587-x64.msu                                                                                                                                        |  
| 설치 스위치             | [Microsoft 기술 자료 문서 934307](https://support.microsoft.com/kb/934307) 참조                                                                                                                                               |  
...
| 파일 정보               | [Microsoft 기술 자료 문서 2853587](https://support.microsoft.com/kb/2853587) 참조                                                                                                                                             |  
...
<tr class="odd">
<td style="border:1px solid black;">보안 업데이트 파일 이름</td>
<td style="border:1px solid black;">Active Directory 서비스 및 AD LDS(Active Directory Lightweight Directory Service)를 제공하는 지원 대상인 모든 Windows Server 2012 에디션:<br />
Windows8-RT-KB2853587-x64.msu</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">설치 스위치</td>
