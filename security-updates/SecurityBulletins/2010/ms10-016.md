...
Microsoft Producer 2003을 사용하는 모든 사용자는 이 공지에서 설명한 취약점을 해결하기 위해 최신 버전의 [Microsoft Producer](https://www.microsoft.com/download/details.aspx?familyid=1b3c76d5-fc75-4f99-94bc-784919468e73)로 업그레이드하는 것이 좋습니다. 업그레이드할 수 없는 고객은 [Microsoft 기술 자료 문서 975561](http://support.microsoft.com/kb/975561)에 제공되는 자동화 솔루션으로 Microsoft Producer 파일 연결을 제거하고 이 공지에 포함된 대안을 적용하여 Microsoft Producer 2003 시스템에 미치는 영향을 완화할 수 있습니다. Microsoft Producer는 영어로만 제공됩니다.
