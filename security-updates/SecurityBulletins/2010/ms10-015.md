---
TOCTitle: 'MS10-015'
Title: 'Microsoft 보안 공지 MS10-015 - 중요'
ms:assetid: 'ms10-015'
ms:contentKeyID: 61230276
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-015(v=Security.10)'
---



Microsoft 보안 공지 MS10-015 - 중요
===================================

Windows 커널의 취약점으로 인한 권한 상승 문제점(977165)
-------------------------------------------------------

게시된 날짜: 2010년 2월 10일 수요일 | 업데이트된 날짜: 2010년 3월 18일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 및 Windows 7(32비트 시스템용) 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Windows 커널이 예외를 올바르게 처리하도록 하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 979682](https://technet.microsoft.com/security/advisory/979682)에서 처음 설명한 취약점도 해결합니다.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 977165](https://support.microsoft.com/kb/977165)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=ed8ac6a5-c8bb-4ed4-8994-810e9a1863c3&displaylang=ko)                                                                        | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=e2b348f5-ec8d-4782-bb03-5de550adea77&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e534d00c-6ddc-4eb3-9464-5db6e90afa3e)                                                                          | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=defd8603-ed9b-42f9-a539-2b6a690e9575&displaylang=ko)                                                                           | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9873c962-9d3d-46ef-b54b-2a50696fb6b2&displaylang=ko)                                                               | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c3c21225-8534-4c7f-96b6-20a743dcea74)                                                                           | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2761c7b4-d472-4f00-949b-af3ebafdc08d&displaylang=ko)                                     | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=38b40dab-6b4d-434b-9997-12ef70d6bbcc&displaylang=ko) | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=21e87558-9bd2-4aa9-aaa5-7fd26a5b60e6&displaylang=ko)\*                | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0b93047d-f2c6-403b-9200-c251898bc1e0&displaylang=ko)\*            | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cd6b234b-8e96-4128-a77a-645a0882996a)                     | 권한 상승      | 중요        | [MS09-058](https://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=66f14bb4-40fc-4ae3-9baf-429b7106cd91&displaylang=ko)                                                                                | 권한 상승      | 중요        | 없음                                                                |
...
**이 공지가 2010년 3월 3일에 개정된 이유는 무엇입니까?**  
Microsoft는 Windows Update에서 MS10-015 업데이트에 대한 수정된 패키지가 제공되는 것을 알리기 위해 이 보안 공지를 개정하였습니다. 이 개정에서는 시스템에 비정상적인 특정 조건이 존재하는 경우 보안 업데이트를 설치하지 못하게 하는 패키지 설치 로직이 변경되었습니다. 시스템의 이러한 비정상적인 조건은 일부 운영 체제 파일을 수정하여 감염된 컴퓨터가 MS10-015 업데이트와 호환되지 않게 하는 컴퓨터 바이러스에 감염된 결과일 수 있습니다. 경우에 따라 감염된 컴퓨터에 보안 업데이트 MS10-015를 설치하면 컴퓨터가 반복적으로 다시 시작될 수 있습니다. 이 문제점에 대한 자세한 내용은 다음 [웹 페이지](https://www.microsoft.com/security/updates/015)를 참조하십시오. 이 변경 사항은 Windows Update를 통해 배포되는 업데이트의 패키지 설치 로직에만 적용됩니다. 보안 업데이트 바이너리나 Windows Update 검색 로직에 대한 변경 사항은 없습니다. Microsoft 다운로드 센터에서 제공되는 업데이트는 변경되지 않았으며 이 새로운 패키지 설치 로직을 포함하지 않습니다. 자동 업데이트를 사용하는 고객을 포함하여 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다. 자동 업데이트를 사용하지만 이전에 이 업데이트를 설치하지 않은 고객은 가능한 빨리 업데이트를 적용하는 것이 좋습니다.
...
예, 영향을 받는 모든 Windows 플랫폼(KB977165)에 대한 업데이트 패키지에는 [Microsoft 기술 자료 문서 977165](https://support.microsoft.com/kb/977165)에서 설명한 Windows 커널에 대한 변경 사항이 포함되어 있습니다.
...
<th style="border:1px solid black;" >Windows 커널 예외 처리기 취약점(CVE-2010-0232)</th>
<th style="border:1px solid black;" >Windows 커널 Double Free 취약점(CVE-2010-0233)</th>
...
커널이 특정 예외를 처리하는 방식으로 인해 Windows 커널에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0232 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)를 참조하십시오.
  
#### Windows 커널 예외 처리기 취약점(CVE-2010-0232)에 대한 완화 요소
...
#### Windows 커널 예외 처리기 취약점(CVE-2010-0232)에 대한 대안
...
-   NTVDM 하위 시스템 사용 안 함
    ...
    **참고** 이 대안을 자동으로 구현하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 979682](https://support.microsoft.com/kb/979682)를 참조하십시오.
    ...
    1.  **시작**, **실행**을 차례로 클릭하고 **열기** 상자에 **gpedit.msc**를 입력한 다음 **확인**을 클릭합니다.  
        그룹 정책 콘솔이 열립니다.  
    2.  **관리 템플릿** 폴더를 확장한 후 **Windows 구성 요소**를 클릭합니다.  
    3.  **응용 프로그램 호환성** 폴더를 클릭합니다.  
    4.  세부 정보 창에서 **16비트 응용 프로그램으로의 액세스를 금지** 정책 설정을 두 번 클릭합니다. 기본적으로 이 정책은 **구성되지 않음**으로 설정되어 있습니다.  
    5.  정책 설정을 **사용**으로 변경한 후 **확인**을 클릭합니다.
  
    **대안의 영향.** 사용자가 16비트 응용 프로그램을 실행할 수 없게 됩니다.
  
#### Windows 커널 예외 처리기 취약점(CVE-2010-0232)에 대한 FAQ
...
NTVDM(Windows 가상 DOS 머신) 하위 시스템은 Windows NT 기반 운영 체제에서 MS-DOS 및 16비트 Windows를 에뮬레이트하는 보호 환경 하위 시스템입니다. VDM은 Windows NT 기반 운영 체제에서 사용자가 MS-DOS 응용 프로그램을 시작할 때마다 만들어집니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-0232 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)가 지정되었습니다. 이 문제점은 [Microsoft 보안 권고 979682](https://technet.microsoft.com/security/advisory/979682)에서 처음 설명되었습니다.
...
double free 조건으로 인해 Windows 커널에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0233 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0233)을 참조하십시오.
  
#### Windows 커널 Double Free 취약점(CVE-2010-0233)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 Double Free 취약점(CVE-2010-0233)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 Double Free 취약점(CVE-2010-0233)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널이 메모리를 해제할 때 포인터를 올바르게 다시 설정하지 않습니다. 이로 인해 Windows 커널에서 double free 조건이 발생합니다.
...
일반적으로 이 취약점은 서비스 거부 발생을 유발합니다. 그러나 특정 상황에서는 코드 실행이 발생할 수 있습니다. 영향 받는 각 시스템의 고유한 메모리 레이아웃 때문에 이 취약점을 대규모로 악용하는 것은 어렵습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows 커널이 메모리를 해제할 때 포인터를 올바르게 다시 설정하도록 하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">Windows2000-KB977165-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-KB977165-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB977165$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/977165">Microsoft 기술 자료 문서 977165</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">2010년 2월 9일 출시된 패키지:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows 2000\SP5\KB977165\Filelist<br />
2010년 3월 2일 출시된 수정된 패키지:<br />
...
WindowsXP-KB977165-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB977165-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">2010년 2월 9일 출시된 패키지를 사용하는 지원 대상인 모든 Windows XP 32비트 에디션:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB977165\Filelist<br />
2010년 3월 2일 출시된 수정된 패키지를 사용하는 지원 대상인 모든 Windows XP 32비트 에디션:<br />
...
WindowsServer2003-KB977165-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB977165-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB977165-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB977165-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">2010년 2월 9일 출시된 패키지를 사용하는 지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165\Filelist<br />
2010년 3월 2일 출시된 수정된 패키지를 사용하는 지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165-v2\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">2010년 2월 9일 출시된 패키지를 사용하는 지원 대상인 모든 Windows Server 2003 x64 기반 및 Itanium 기반 에디션:<br />
...
-   Windows 커널 Double Free 취약점(CVE-2010-0233)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy
...
-   V1.1(2010년 2월 11일): 지원 대상인 모든 Windows XP x64 기반 에디션에 대한 확인 레지스트리 키가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다.  
-   V1.2(2010년 3월 3일): Windows Update에서 수정된 패키지가 제공되는 것을 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목을 추가하였습니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.  
-   V1.3(2010년 3월 18일): Microsoft Windows 2000, Windows XP 및 Windows Server 2003에 대해 2010년 3월 2일 출시된 수정된 패키지의 확인 레지스트리 키가 추가되었습니다. 이 변경 사항은 정보에만 해당됩니다.
