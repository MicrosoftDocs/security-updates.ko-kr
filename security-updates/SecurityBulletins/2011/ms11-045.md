---
TOCTitle: 'MS11-045'
Title: 'Microsoft 보안 공지 MS11-045 - 중요'
ms:assetid: 'ms11-045'
ms:contentKeyID: 61230412
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-045(v=Security.10)'
---



Microsoft 보안 공지 MS11-045 - 중요
===================================

Microsoft Excel의 취약점으로 인한 원격 코드 실행 문제점(2537146)
----------------------------------------------------------------

게시된 날짜: 2011년 6월 15일 수요일 | 업데이트된 날짜: 2011년 8월 11일 목요일
...
이 보안 업데이트는 Microsoft Office에서 발견되어 비공개적으로 보고된 취약점 8건을 해결합니다. 사용자가 특수하게 조작된 Excel 파일을 열면 이러한 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 이러한 취약점 중 하나를 성공적으로 악용한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다. 의심되는 파일을 열지 못하도록 Office 파일 유효성 검사(OFV)를 설치하고 구성하면 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 공격 경로가 차단됩니다. Office 파일 유효성 검사 기능을 구성하여 공격 경로를 차단하는 방법에 대한 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**을 참조하십시오. Microsoft Excel 2010은 이 공지에 설명된 CVE-2011-1273에만 영향을 받습니다. [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)에서 사용할 수 있는 "Excel 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"에 대한 **Microsoft Fix it** 자동화 솔루션은 CVE-2011-1273을 악용하는 공격 경로를 차단합니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Excel 2002, Microsoft Excel 2003, Microsoft Excel 2007, Microsoft Excel 2010, Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac, Microsoft Office for Mac 2011 및 Open XML File Format Converter for Mac 에디션과 지원 대상인 모든 Microsoft Excel Viewer 및 Microsoft Office 호환 기능 팩 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 업데이트는 Microsoft Excel에서 특수하게 조작된 Excel 파일을 구문 분석할 때 레코드 정보의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2537146](https://support.microsoft.com/kb/2537146)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Excel 2002 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=853c0663-94f7-4634-98ad-47ca4b1f7b1e&displaylang=ko)  
(KB2541003)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=f38f183a-9c64-406b-9bf6-807cb2d55e56&displaylang=ko)  
(KB2541025)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5b271f87-a279-419f-9437-ded224fa19f1&displaylang=ko)<sup>[1]</sup>
(KB2541007)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2010(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=baba7ec1-4a5e-4e13-9d0e-9085a39a0554&displaylang=ko)  
(KB2523021)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2010(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=d6e9f422-43b0-4da5-8356-c38482e8eebb&displaylang=ko)  
(KB2523021)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Excel Viewer 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=77c1e7e2-207f-46fd-81f2-43a25eddc010&displaylang=ko)  
(KB2541015)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=3512a033-871d-49ec-a8d2-1b9c7dec4936&displaylang=ko)  
(KB2541012)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
Microsoft Excel 2003 및 Microsoft Excel 2007에서 Office 파일 유효성 검사 기능을 사용하면 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 데 사용될 수 있는 특수하게 조작된 파일이 자동으로 열리지 않고, 기본적으로 사용자에게 이러한 파일을 열 것인지 여부를 물어보게 됩니다. 사용자가 여러 번의 경고 대화 상자를 클릭한 후에 파일을 열어야만 취약점이 악용될 수 있습니다. Microsoft Excel 2003 또는 Microsoft Excel 2007의 Office 파일 유효성 검사 기능에 대한 자세한 내용은 [Microsoft 보안 권고 2501584](https://technet.microsoft.com/security/advisory/2501584)를 참조하십시오.

Office 파일 유효성 검사는 Microsoft Excel 2010에서 기본적으로 사용됩니다. CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 데 사용될 수 있는 특수하게 조작된 파일이 유효성 검사에 실패하면 [제한된 보기 (영문)](https://www.microsoft.com/security/pc-security/office2010.aspx)에서 열립니다. 그러면 사용자가 여러 번의 경고 메시지를 클릭한 후에 편집을 위해 파일을 열어야만 취약점이 악용될 수 있습니다.

**Excel 2003 및 Excel 2007에서 파일 유효성 검사에 실패하는 파일을 열지 못하도록 하면 어떠한 이점이 있습니까?**    
Office 파일 유효성 검사를 통해 Excel 2003 및 Excel 2007에서 의심되는 파일을 열지 못하도록 설정할 경우 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)에서 사용할 수 있는 **Microsoft Fix it** 솔루션, "Excel 2003 및 2007에 대한 문서 열기 사용 안 함"이 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 공격 경로를 차단합니다.

Fix it 자동화 솔루션, "Excel 2003 및 2007에 대한 문서 열기 사용 안 함"을 적용하는 방법은 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)를 참조하고, 솔루션을 수동으로 적용하는 방법은 이 공지의 취약점 정보 섹션에서 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279의 대안 섹션을 참조하십시오.

**Excel 2010에서 파일 유효성 검사에 실패하는 파일을 열지 못하도록 하면 어떠한 이점이 있습니까?**    
Microsoft Excel 2010은 이 공지에 설명된 CVE-2011-1273에만 영향을 받습니다. [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)에서 사용할 수 있는 **Microsoft Fix it** 자동화 솔루션, "Excel 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"이 CVE-2011-1273을 악용하는 공격 경로를 차단합니다. Excel 2010에 대한 보안 업데이트를 설치하지 않도록 선택한 고객은 나중에 Fix it 솔루션을 대안으로 적용하도록 선택할 수 있습니다.

Fix it 자동화 솔루션, "Excel 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"을 적용하는 방법은 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)를 참조하고 이 솔루션을 수동으로 적용하는 방법은 이 공지의 취약점 정보 섹션에서 CVE-2011-1273의 대안 섹션을 참조하십시오.
...
**이 보안 업데이트는 MS11-036과 어떤 관련이 있습니까?**    
이 공지에서 제공하는 Microsoft Office 2004 for Mac(KB2555786), Microsoft Office 2008 for Mac(KB2555785) 및 Open XML File Format Converter for Mac(KB2555784)용 보안 업데이트 패키지는 [MS11-036](https://technet.microsoft.com/security/bulletin/ms11-036) 보안 공지에서 설명하는 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1272 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1272)를 참조하십시오.

#### Excel 불충분한 레코드 유효성 검사 취약점(CVE-2011-1272)에 대한 완화 요소
...
#### Excel 불충분한 레코드 유효성 검사 취약점(CVE-2011-1272)에 대한 대안
...
#### Excel 불충분한 레코드 유효성 검사 취약점(CVE-2011-1272)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Microsoft Excel이 특수하게 조작된 Excel 파일을 구문 분석하는 동안 Excel 레코드 구조의 유효성을 불충분하게 검사할 때 이 취약점이 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Microsoft Excel에서 특수하게 조작된 Excel 파일을 구문 분석할 때 레코드 정보의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1273 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273)을 참조하십시오.

#### Excel 잘못된 레코드 구문 분석 취약점(CVE-2011-1273)에 대한 완화 요소
...
#### Excel 잘못된 레코드 구문 분석 취약점(CVE-2011-1273)에 대한 대안
...
#### Excel 잘못된 레코드 구문 분석 취약점(CVE-2011-1273)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

**취약점의 원인은 무엇입니까?**    
Microsoft Excel에서 특수하게 조작된 Excel 파일을 열 때 레코드 정보의 유효성을 검사하면 시스템 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1274 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1274)를 참조하십시오.

#### Excel 범위 초과 배열 액세스 취약점(CVE-2011-1274)에 대한 완화 요소
...
#### Excel 범위 초과 배열 액세스 취약점(CVE-2011-1274)에 대한 대안
...
#### Excel 범위 초과 배열 액세스 취약점(CVE-2011-1274)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1275 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275)를 참조하십시오.

#### Excel 메모리 힙 덮어쓰기 취약점(CVE-2011-1275)에 대한 완화 요소
...
#### Excel 메모리 힙 덮어쓰기 취약점(CVE-2011-1275)에 대한 대안
...
#### Excel 메모리 힙 덮어쓰기 취약점(CVE-2011-1275)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1276 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276)을 참조하십시오.

#### Excel 버퍼 오버런 취약점(CVE-2011-1276)에 대한 완화 요소
...
#### Excel 버퍼 오버런 취약점(CVE-2011-1276)에 대한 대안
...
#### Excel 버퍼 오버런 취약점(CVE-2011-1276)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1277](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277)을 참조하십시오.

#### Excel 메모리 손상 취약점(CVE-2011-1277)에 대한 완화 요소
...
#### Excel 메모리 손상 취약점(CVE-2011-1277)에 대한 대안
...
#### Excel 메모리 손상 취약점(CVE-2011-1277)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278)을 참조하십시오.

#### Excel WriteAV 취약점(CVE-2011-1278)에 대한 완화 요소
...
#### Excel WriteAV 취약점(CVE-2011-1278)에 대한 대안
...
#### Excel WriteAV 취약점(CVE-2011-1278)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279)를 참조하십시오.

#### Excel 범위 초과 WriteAV 취약점(CVE-2011-1279)에 대한 완화 요소
...
#### Excel 범위 초과 WriteAV 취약점(CVE-2011-1279)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **Excel 2003에서 유효성 검사에 실패하는 파일을 열지 못하도록 Office 파일 유효성 검사 설정**

    **참고** 이 대안을 적용하기 전에 해당 버전의 Microsoft Office에 대해 Office 파일 유효성 검사를 사용하도록 설정되어 있어야 합니다. Microsoft Office 2003에서 Office 파일 유효성 검사를 사용하도록 설정하는 방법에 대한 자세한 내용은 TechNet 문서 [Office 2003 및 Office 2007용 Office 파일 유효성 검사](https://technet.microsoft.com/en-us/library/gg985445(office.12).aspx)(영문)를 참조하십시오.
    ...
    **참고** 레지스트리를 잘못 수정하면 시스템 전체에 심각한 문제가 발생할 수 있으며 운영 체제를 다시 설치해야 할 수도 있습니다. Microsoft는 레지스트리를 잘못 수정하여 발생하는 문제에 대한 해결을 보증하지 않습니다. 레지스트리의 수정에 따른 모든 책임은 사용자에게 있습니다.
    ...
    해당 Office 소프트웨어용 레지스트리 스크립트를 사용하십시오.
...
이 대안에서 구성한 설정을 취소하려면 해당 소프트웨어용 레지스트리 스크립트를 사용하십시오.
...
#### Excel 범위 초과 WriteAV 취약점(CVE-2011-1279)에 대한 FAQ
...
| 소프트웨어                                                                         | MBSA   |
|------------------------------------------------------------------------------------|--------|
| Microsoft Office 2002 서비스 팩 3                                                  | 예     |
| Microsoft Excel 2003 서비스 팩 3                                                   | 예     |
| Microsoft Excel 2007 서비스 팩 2                                                   | 예     |
| Microsoft Excel 2010(32비트 에디션)                                                | 예     |
| Microsoft Excel 2010(64비트 에디션)                                                | 예     |
...
| Microsoft Excel 2003 서비스 팩 3                                                   | 예                  | 예                         |
| Microsoft Excel 2007 서비스 팩 2                                                   | 예                  | 예                         |
| Microsoft Excel 2010(32비트 에디션)                                                | 예                  | 예                         |
| Microsoft Excel 2010(64비트 에디션)                                                | 예                  | 예                         |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2541003">Microsoft 기술 자료 문서 2541003</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2541025">Microsoft 기술 자료 문서 2541025</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="https://support.microsoft.com/kb/2541007">Microsoft 기술 자료 문서 2541007</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="https://support.microsoft.com/kb/2541015">Microsoft 기술 자료 문서 2541015</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="https://support.microsoft.com/kb/2541012">Microsoft 기술 자료 문서 2541012</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2523021">Microsoft 기술 자료 문서 2523021</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.6.4 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=d12d0868-4f28-4c0a-ab61-338878064b70)에서 다운로드하여 설치하십시오.
...
-   바탕 화면에서 Microsoft Office 2004 for Mac 11.6.4 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2004 for Mac 11.6.4 업데이트 볼륨 창에서 Microsoft Office 2004 for Mac 11.6.4 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2004 for Mac 11.6.4 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **11.6.4**이면 업데이트가 설치된 것입니다.
...
Microsoft Office 2008 for Mac 12.3.0 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=9e2d348b-c753-4eab-838c-370cd5af5e14)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Microsoft Office 2008 for Mac 12.3.0 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2008 for Mac 12.3.0 업데이트 볼륨 창에서 Microsoft Office 2008 for Mac 12.3.0 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2008 for Mac 12.3.0 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **12.3.0**이면 업데이트가 설치된 것입니다.
...
Microsoft Office for Mac 2011 14.1.2 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=3c58555c-1eba-42fe-a10f-b30af9031e44)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램 및 모든 Microsoft Office 응용 프로그램을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Microsoft Office for Mac 2011 14.1.2 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 과정을 시작하려면 Microsoft Office for Mac 2011 14.1.2 업데이트 볼륨 창에서 Microsoft Office for Mac 2011 14.1.2 업데이트 응용 프로그램을 두 번 클릭하고 화면의 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office for Mac 2011 14.1.2 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
설치된 최신 업데이트 버전 번호가 **14.1.2**이면 업데이트가 성공적으로 설치된 것입니다.
...
Open XML File Format Converter for Mac 1.2.0 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=6118d5f5-b6fd-4584-be25-209534772379)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕화면에서 Open XML File Format Converter for Mac 1.2.0 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Open XML File Format Converter for Mac 1.2.0 업데이트 볼륨 창에서 Open XML File Format Converter for Mac 1.2.0 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Open XML File Format Converter for Mac 1.2.0 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **1.2.0**이면 업데이트가 설치된 것입니다.
...
-   Excel 불충분한 레코드 유효성 검사 취약점(CVE-2011-1272)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com/)의 Bing Liu  
-   Excel 잘못된 레코드 구문 분석 취약점(CVE-2011-1273)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 범위 초과 배열 액세스 취약점(CVE-2011-1274)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 Omair  
-   Excel 메모리 힙 덮어쓰기 취약점(CVE-2011-1275)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 버퍼 오버런 취약점(CVE-2011-1276)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 [Agarri (영문)](https://www.agarri.fr/)의 Nicolas Gregoire  
-   Excel 메모리 손상 취약점(CVE-2011-1277)을 보고해 주신 Omair  
-   Excel WriteAV 취약점(CVE-2011-1278)을 보고해 주신 [CERT/CC (영문)](https://www.cert.org/)의 Will Dormann  
-   Excel 범위 초과 WriteAV 취약점(CVE-2011-1279)을 보고해 주신 [CERT/CC (영문)](https://www.cert.org/)의 Will Dormann
...
-   V1.1(2011년 8월 11일): CVE-2011-1276에 대한 이 공지의 취약점 섹션의 두 가지 잘못된 대안이 제거되었습니다. 이 변경 사항은 정보에만 해당됩니다.
