...
이 보안 업데이트는 [Microsoft 보안 권고 977377](http://technet.microsoft.com/security/advisory/977377)에서 처음 설명한 취약점도 해결합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=ff00381c-e74b-48e5-9dd9-34dbedd906a2&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=eaffa70c-6f2b-4e66-b1bc-64bdbbbcd34f)                                                               | 원격 코드 실행 | 긴급        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f76d68df-97e5-489c-a5f6-0c378c1f62ae&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4543bcf0-3505-407b-a5a9-6250ece6fbac&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9ef992c3-96e9-4533-b844-07424a6054b3)                                                           | 원격 코드 실행 | 긴급        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
| [Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=aca69406-f795-4398-968f-959fe3a74e89)                                                                                     | 스푸핑         | 중요        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
...
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e2835ed1-5ca6-4347-8ff1-e694b1ac49ff&displaylang=ko)                 | 스푸핑         | 중요        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
...
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e0253d4-f0c0-4f28-ba08-6907c2fcb339&displaylang=ko)\*     | 스푸핑         | 중요        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
...
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a96891ff-8771-47b3-81bb-8640adb6c098&displaylang=ko)\* | 스푸핑         | 중요        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
...
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b16a422-0ee9-4eab-9cfe-e7688ffa0d76)          | 스푸핑         | 중요        | [MS09-007](http://technet.microsoft.com/security/bulletin/ms09-007) |
...
Microsoft Windows SChannel 인증 구성 요소에 구현된 TLS/SSL 프로토콜에 스푸핑 취약점이 존재합니다. 이 취약점을 악용한 공격자는 TLS/SSL 보호된 연결에 정보를 적용할 수 있으며, 이를 통해 트래픽을 효과적으로 보내 인증된 클라이언트에 스푸핑을 시도할 수 있습니다. 이 보안은 [Microsoft 보안 권고 977377](http://technet.microsoft.com/security/advisory/977377)에서 이미 설명한 취약점을 해결합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3555 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3555)를 참조하십시오.
...
자세한 내용은 MSDN 문서, [Secure Channel (영문)](http://msdn.microsoft.com/en-us/library/aa380123(vs.85).aspx)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3555 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3555)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2566 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2566)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/980436">Microsoft 기술 자료 문서 980436</a> 참조</td>
</tr>
<tr class="even">
...
-   TLS/SSL 재협상 취약점(CVE-2009-3555)을 보고해 주신 [PhoneFactor (영문)](http://www.phonefactor.com)의 Marsh Ray 및 Steve Dispensa
