...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2644615](http://support.microsoft.com/kb/2644615)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                            | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                            | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                             | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                  | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                      | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                         | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                       | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                     | 보안 기능 우회 | 중요        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                       | 보안 기능 우회 | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | 보안 기능 우회 | 중요        | 없음                      |
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [1월 공지 요약](http://technet.microsoft.com/ko-kr/security/bulletin/ms12-jan)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0001(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001)을 참조하십시오.
...
-   SEHOP(구조적 예외 처리 덮어쓰기 보호***)***사용
    ...
    Windows Vista, Windows 7, Windows Server 2008 및 Windows Server 2008 R2 시스템의 경우 기존 응용 프로그램에 대해 SEHOP를 사용하도록 설정하기 위한 지침을 제공하는 [Windows 운영 체제에서 SEHOP(구조적 예외 처리 덮어쓰기 보호)를 사용하도록 설정하는 방법](http://support.microsoft.com/kb/956607)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2644615">Microsoft 기술 자료 문서 2644615</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 커널 SafeSEH 우회 취약점(CVE-2012-0001)을 보고해 주신 [Accuvant LABS(영문)](http://www.accuvant.com/)의 Joshua J. Drake
