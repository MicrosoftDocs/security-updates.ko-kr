...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2780642](http://support.microsoft.com/kb/2780642)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[MS12-064](http://go.microsoft.com/fwlink/?linkid=260965)의 KB2687483은 KB2760497로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-064](http://go.microsoft.com/fwlink/?linkid=260965)의 KB2687315는 KB2760421로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-064](http://go.microsoft.com/fwlink/?linkid=260965)의 KB2553488은 KB2760410으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-064](http://go.microsoft.com/fwlink/?linkid=260965)의 KB2687485는 KB2760498로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-064](http://go.microsoft.com/fwlink/?linkid=260965)의 KB2687314는 KB2760416으로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=260965">MS12-064</a>의 KB2598237은 KB2760405로 대체되었습니다.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=260965">MS12-064</a>의 KB2687401은 KB2687412로 대체되었습니다.</td>
</tr>
</tbody>
</table>
...
Word Automation Services는 SharePoint Server 2010의 서비스 응용 프로그램으로, 문서를 Microsoft Word 클라이언트 응용 프로그램에서 지원하는 형식으로 서버 쪽에서 자동 변환해 줍니다. 자세한 내용은 [Word Automation Services 개요](http://msdn.microsoft.com/library/ee558830)(영문)를 참조하십시오.
...
예. Microsoft Office 2007 서비스 모델의 일부로 Microsoft Office 2007 서비스 팩 2 사용자가 이 업데이트를 설치하면 시스템이 Microsoft Office 2007 서비스 팩 3를 통해 최초로 출시된 보안 기능으로 업그레이드됩니다. 2011년 10월 25일 이후 출시된 모든 업데이트에는 [Microsoft Office 2007 서비스 팩 3](http://www.microsoft.com/ko-kr/download/details.aspx?id=27838)을 통해 소개된 이러한 보안 기능이 포함되어 있습니다. Microsoft에서 이 업데이트를 철저하게 테스트했지만, 모든 업데이트와 마찬가지로 사용자가 자신의 시스템 환경 및 구성에 따라 적절히 테스트하는 것이 좋습니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [12월 공지 요약](http://technet.microsoft.com/security/bulletin/ms12-dec)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2539](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2539)(영문)를 참조하십시오.
...
-   알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 RTF 문서를 열지 못하도록 Microsoft Office 파일 차단 정책 사용
    ...
    또는 그룹 정책을 사용하여 파일 차단을 적용할 수 있습니다. 자세한 내용은 TechNet 문서, [Office 2010의 파일 차단 설정 계획](http://technet.microsoft.com/ko-kr/library/cc179230.aspx)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2760497">Microsoft 기술 자료 문서 2760497</a> 및 <a href="http://support.microsoft.com/kb/2760498">Microsoft 기술 자료 문서 2760498</a> 참조</td>
</tr>
<tr class="even">
...
참고 관리되는 환경에서 작업하는 관리자는 Office Admin 업데이트 센터에서 조직에 Office 업데이트를 배포하는 데 필요한 리소스를 찾을 수 있습니다. 해당 사이트에서 아래로 스크롤하여 업데이트 리소스 섹션에서 업데이트 대상 소프트웨어 버전을 찾으십시오. [Windows Installer 설명서](http://go.microsoft.com/fwlink/?linkid=21685)(영문)에서도 Windows Installer에서 지원하는 매개 변수에 대한 자세한 내용을 설명합니다.
...
-   [Microsoft Windows 2000 및 Windows NT 4.0용 Windows Installer 2.0 재배포 가능 파일](http://go.microsoft.com/fwlink/?linkid=33338)(영문)
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2760421">Microsoft 기술 자료 문서 2760421</a> 및 <a href="http://support.microsoft.com/kb/2760416">Microsoft 기술 자료 문서 2760416</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2760410">Microsoft 기술 자료 문서 2760410</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2760405">Microsoft 기술 자료 문서 2760405</a> 및 <a href="http://support.microsoft.com/kb/2687412">Microsoft 기술 자료 문서 2687412</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word RTF 'listoverridecount' 원격 코드 실행 취약점(CVE-2012-2539)을 Beyond Security의 [SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html)(영문) 프로그램과 협력하여 보고해 주신 익명의 기고자
