...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2742 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742)를 참조하십시오.
...
Netlogon Remote Protocol은 도메인 기반 네트워크에서 사용자 및 시스템 인증에 사용되는 RPC(원격 프로시저 호출) 인터페이스입니다. Netlogon RPC에 대한 자세한 내용은 MSDN 문서 [Netlogon Remote Protocol 사양 (영문)](https://msdn.microsoft.com/en-us/library/cc237009(v=prot.10).aspx)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2207559">Microsoft 기술 자료 문서 2207559</a> 참조</td>
</tr>
<tr class="even">
