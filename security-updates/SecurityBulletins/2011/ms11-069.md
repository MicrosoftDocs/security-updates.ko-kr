...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2567951](http://support.microsoft.com/kb/2567951)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](http://technet.microsoft.com/security/bulletin/ms11-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1978(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 보안 강화 구성으로 알려진 제한된 모드로 실행됩니다. 이 모드는 Windows Server 2008 및 Windows Server 2008 R2의 웹 기반 공격 시나리오에서만 이 취약점을 완화합니다. [Internet Explorer 보안 강화(영문)](http://go.microsoft.com/fwlink/?linkid=92039) 구성에 대한 자세한 내용은 이 취약점의 FAQ 섹션을 참조하십시오.
...
-   [KB2562394](http://support.microsoft.com/kb/2562394)를 설치한 고객은 사용자 조작 없이 악용될 수 없습니다.
-   [MS11-044](http://technet.microsoft.com/security/bulletin/ms11-044)를 통해 사용할 수 있는 이 업데이트는 인터넷 영역의 ClickOnce 응용 프로그램이 사용자의 확인 없이 실행되지 못하게 합니다.
-   [KB2562394](http://support.microsoft.com/kb/2562394)를 설치하지 않은 고객에게는 이 응용 프로그램이 인터넷 전용 권한 수준만 사용하는 경우 확인 대화 상자가 표시되지 않습니다. 이 기능에 대한 자세한 내용은 [KB2562394](http://support.microsoft.com/kb/2562394)를 참조하십시오.
...
.NET Framework 내의 System.Net.Sockets 네임스페이스는 네트워크에 대한 액세스를 강력하게 제어해야 하는 개발자를 위한 관리되는 Winsock(Windows 소켓) 인터페이스 구현입니다. 자세한 내용은 MSDN 문서 [System.Net.Sockets 네임스페이스](http://msdn.microsoft.com/en-us/library/sb27wehh.aspx)를 참조하십시오.
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747)에서 제공하고 [Windows Server Update Services(영문)](http://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool(영문)](http://technet.microsoft.com/ko-kr/sms/bb676783.aspx)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools(영문)](http://technet.microsoft.com/en-us/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드(영문)](http://technet.microsoft.com/ko-kr/sms/bb676766.aspx)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2567951">Microsoft 기술 자료 문서 2567951</a> 참조</td>
</tr>
<tr class="odd">
