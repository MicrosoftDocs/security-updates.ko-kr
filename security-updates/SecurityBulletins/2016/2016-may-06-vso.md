...
ms.ContentId: 977dd108-efb3-47bc-b727-5a88d50c9a0e
...
![Improved formatting and usability of emails](_img/05_06_01.png)
...
![Checkbox control added to a work item](_img/05_06_02.png)
...
![Controlling annotations in Settings](_img/05_06_03.png)
...
![Selecting rules and colors for Query Tiles](_img/05_06_04.png)
...
![Selecting from the widget catalog](_img/05_06_05.png)
...
![Adding a test step attachment](_img/05_06_06.png)
...
![New columns in the Test results pane.](_img/05_06_07.png)
...
![Console logs and test duration in the Tests tab](_img/05_06_08.png)
...
![Linking a repository in Release Management](_img/05_06_09.png)
...
![Cloning a release definition](_img/05_06_10.png)
...
![Simplified release definition wizard](_img/05_06_11.png)
...
![Restyled, cleaner dialog box](_img/05_06_13.png)
