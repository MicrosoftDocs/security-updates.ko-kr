...
-   Microsoft Office 2000 서비스 팩 3 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e51b27c8-2f31-4e99-b868-ce626fed5b7d&displaylang=ko)
    -   PowerPoint 2000
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">PowerPoint 임시 인터넷 파일 정보 유출 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0004">CVE-2006-0004 (영문)</a></td>
...
예, 그러나 로컬 검사에만 해당됩니다. MBSA는 이 문제의 원격 검사를 지원하지 않는 Office Detection Tool(ODT)의 통합 버전에서 사용합니다. MBSA에 대한 자세한 내용은 [MBSA 웹 사이트](https://www.microsoft.com/korea/technet/security/tools/mbsahome.asp)를 참조하십시오. MBSA 지원에 대한 자세한 내용은 [Microsoft Baseline Security Analyzer 1.2 Q&A 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=33332)를 참조하십시오.

**MBSA(Microsoft Baseline Security Analyzer) 2.0을 사용하여 이 업데이트가 필요한지 확인할 수 있습니까?**  
아니요. MBSA 2.0은 현재 PowerPoint 2000 검색을 지원하지 않습니다. 이 업데이트가 필요한지 확인하려면 Office Detection Tool 또는 MBSA 1.2.1을 사용해야 합니다. MBSA 2.0은 Microsoft Update가 지원하는 제품용 보안 업데이트를 검색할 수 있습니다. 현재 Microsoft Update 및 MBSA 2.0으로 검색할 수 없는 프로그램에 대한 자세한 내용은 [Microsoft 기술 자료 문서 895660](https://support.microsoft.com/kb/895660)을 참조하십시오.
...
-   **Internet Explorer가 아닌 해당 Office 프로그램에서 Office 문서를 열도록 Internet Explorer를 구성합니다.**
    ...
    **참고** Windows 2000 또는 Windows Server 2003에서 터미널 서버를 실행하는 경우 이 절차의 4단계에서 **고급**을 클릭하여 **파일 형식 편집** 대화 상자를 열지 못할 수 있습니다. 이 문제는 NoFileAssociate 정책을 사용하면 발생합니다. 이 정책을 사용하면 사용자(관리자 포함)가 모든 사용자를 위한 파일 형식 연결을 변경할 수 없습니다. 이 동작에 대한 자세한 내용은 [Microsoft 기술 자료 문서 257592](https://support.microsoft.com/kb/257592/)의 문서를 참조하십시오.
...
-   Office 2000 서비스 팩 3(SP3)이 설치되어 있어야 합니다. 이 업데이트를 설치하기 전에 Office 2000 SP3을 설치하십시오. Office 2000 SP3 설치 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 326585](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;326585)를 참조하십시오.
...
[Office 업데이트 웹 사이트](https://office.microsoft.com/ko-kr/officeupdate/default.aspx)를 사용하여 Microsoft Office 2000 클라이언트 업데이트를 설치하는 것이 좋습니다. Office 업데이트 웹 사이트에서는 사용자 컴퓨터에 설치된 특정한 프로그램을 검색한 다음 프로그램을 최신으로 유지하기 위해 설치해야 할 것을 알려줍니다.
...
-   **Microsoft Baseline Security Analyzer**
    ...
    MBSA(Microsoft Baseline Security Analyzer) 도구를 사용하면 영향을 받는 시스템에 보안 업데이트가 설치되었는지 확인할 수 있습니다. 관리자는 MBSA를 사용하여 로컬 및 원격 시스템에서 누락된 보안 업데이트와 일반적인 보안 구성 오류를 검색할 수 있습니다. MBSA에 대한 자세한 내용은 [Microsoft Baseline Security Analyzer 웹 사이트](https://www.microsoft.com/korea/technet/security/tools/mbsahome.asp)를 참조하십시오.
...
1.  [이 보안 업데이트의 관리자용 버전을 다운로드합니다.](https://download.microsoft.com/download/6/b/b/6bb17459-afe7-4944-b8ab-eb1e3b87b1bf/office2000-kb889167-fullfile-kor.exe)
2.  **이 프로그램을 디스크에 저장**을 클릭한 다음 **확인**을 클릭합니다.
3.  **저장**을 클릭합니다.
...
**참고** 관리되는 환경에서 작업하는 관리자는 Office Admin 업데이트 센터에서 조직에 Office 업데이트를 배포하는 데 필요한 리소스를 찾을 수 있습니다. 해당 사이트에서 아래로 스크롤하여 **업데이트 리소스** 섹션에서 업데이트 대상 소프트웨어 버전을 찾으십시오. [Windows Installer 문서 (영문)](https://go.microsoft.com/fwlink/?linkid=21685)에서도 Windows Installer에서 지원하는 매개 변수에 대한 자세한 내용을 설명합니다.
...
-   PowerPoint 임시 인터넷 파일 정보 유출 취약점 - CVE-2006-0004를 보고해 주신 [ITsec Security Services (영문)](https://www.itsec-ss.nl/)의 Yorick Koster에게 감사드립니다.
