...
관리자 및 엔터프라이즈 설치의 경우 또는 이 보안 업데이트를 수동으로 설치하려는 최종 사용자(자동 업데이트를 사용하고 있지 않은 고객 포함)의 경우 고객이 업데이트 관리 소프트웨어를 사용하여 시스템에 영향을 주는 보안 업데이트를 적용하거나 [Microsoft 업데이트](https://go.microsoft.com/fwlink/?linkid=40747) 서비스를 통해 업데이트를 확인하고 즉시 업데이트를 적용하는 것이 좋습니다. 이 공지 뒷부분에 나오는 **영향을 받는 소프트웨어** 표에 있는 다운로드 링크를 통해서도 업데이트할 수 있습니다.
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=451d291b-23de-49e8-be86-5bfe3afc3b9c&displaylang=ko)  
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=a00f7767-cdef-49f3-a963-0460675475e2&displaylang=ko)  
(Starter 및 Home Basic 에디션을 제외한 모든 에디션)  
(2978742)
...
<td style="border:1px solid black;">
[Windows Media Center](https://www.microsoft.com/download/details.aspx?familyid=ed49b158-711a-490b-a132-2b50ea0c0135&displaylang=ko)  
(2978742)
...
<td style="border:1px solid black;">
[Windows Media Center](https://www.microsoft.com/download/details.aspx?familyid=aa2cd968-51db-464c-91be-67ca67b2af3d&displaylang=ko)  
(2978742)
...
<td style="border:1px solid black;">
[Windows Media Center](https://www.microsoft.com/download/details.aspx?familyid=63d6c0c2-027b-462d-9392-b40778574dde&displaylang=ko)<sup>[1]</sup>
(2978742)
...
<td style="border:1px solid black;">
[Windows Media Center](https://www.microsoft.com/download/details.aspx?familyid=015e7ddc-454d-49a9-a94d-2809b93ec506&displaylang=ko)<sup>[1]</sup>
(2978742)
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a32e78a8-7f20-4dd5-888b-c6de40b1b5ea&amp;displaylang=ko">Windows Media Center TV Pack for Windows Vista(32비트 에디션)</a>[2]<br />
(2978742)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1797e7d1-85d1-4e59-8df7-2941db987c84&amp;displaylang=ko">Windows Media Center TV Pack for Windows Vista(64비트 에디션)</a>[2]<br />
(2978742)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4060](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4060)(영문)을 참조하십시오.
...
-   CSyncBasePlayer 해제 후 사용 취약점(CVE-2014-4060)을 [HP](https://www.hpenterprisesecurity.com/products)(영문)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)(영문)와 협력해서 보고해 주신 Alisa Esage(@alisaesage)
