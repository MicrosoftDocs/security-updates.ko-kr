...
-   Microsoft Windows XP 서비스 팩 2에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=c9037cdb-3a57-4db7-aa0d-5ad28730303a&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=71f09617-d3cd-45fb-a09b-a9025c1d3f47)
-   Microsoft Windows Server 2003 서비스 팩 1에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=0c7e507f-2a42-49b5-82b2-84a6ec40b895&displaylang=ko)
-   Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용)에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=8f062b1c-7b93-4cb2-835a-b58ba29435f2)
-   Microsoft Windows Server 2003 x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=2aa6b4d1-a6eb-425b-ab7e-6cc27124a59e)
...
|------------------------------------------------------------------------------------------------------------------|----------------------|------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| MHTML 구문 분석 취약점 - [CVE-2006-2766 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2766) | 원격 코드 실행       | 긴급                                                                   | 긴급                                                                            |
...
예. Microsoft는 이 업데이트를 적용해야 하는지 확인할 수 있는 EST 버전을 개발했습니다. 이번 달에 릴리스되는 EST 버전에 대한 자세한 내용과 다운로드 링크는 다음 [Microsoft 웹 사이트](http://support.microsoft.com/kb/894193)를 참조하십시오. SMS 고객은 "SMS(Systems Management Server)를 사용하여
