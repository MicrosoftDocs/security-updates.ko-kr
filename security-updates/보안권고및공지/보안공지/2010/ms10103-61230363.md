...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>pubconv.dll의 크기 값 힙 손상 취약점(CVE-2010-2569)</th>
<th>pubconv.dll의 힙 오버런 취약점(CVE-2010-2570)</th>
<th>Pubconv.dll의 배열에 잘못된 인덱스로 인한 메모리 손상 취약점(CVE-2010-2571)</th>
<th>Microsoft Publisher 메모리 손상 취약점(CVE-2010-3954)</th>
<th>배열 인덱싱 메모리 손상 취약점(CVE-2010-3955)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
