...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=38cee83e-b17a-4c08-90ce-fb836b9615ad&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=6ef68858-4c91-47fb-ae34-0be556f10ede&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=50935f4e-e383-493e-97c6-599cbb2b87cc)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=759435a3-98f9-4115-b52e-d7fa9d024f16&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=462131c6-a728-4b3c-94de-85deccc42c3e)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=50eef5c5-861d-4802-85a2-6b0627aafc2a)
...
|----------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| 폴더 GUID 코드 실행 취약점 - [CVE-2006-3281 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3281) | 원격 코드 실행       | 중요         | 중요                   | 중요                   | 중요                | 중요                            |
...
-   **그룹 정책 설정을 사용하여 이 기능이 필요하지 않은 모든 영향을 받는 시스템에서 웹 클라이언트 서비스를 사용하지 않도록 설정합니다.**
    ...
    **참고** [Windows Server 2003 보안 가이드](https://www.microsoft.com/korea/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx)도 참조하십시오. 이 가이드에는 서비스 비활성화 방법에 대한 정보가 포함되어 있습니다.
    ...
    -   [Windows Server 2003 그룹 정책 (영문)](https://www.microsoft.com/windowsserver2003/techinfo/overview/gpintro.mspx)
