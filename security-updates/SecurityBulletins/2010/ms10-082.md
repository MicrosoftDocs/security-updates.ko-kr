---
TOCTitle: 'MS10-082'
Title: 'Microsoft 보안 공지 MS10-082 - 중요'
ms:assetid: 'ms10-082'
ms:contentKeyID: 61230343
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-082(v=Security.10)'
---
...
이 보안 업데이트의 심각도는 지원 대상인 Microsoft Windows 릴리스(Windows Server 2008 및 Windows Server 2008 R2 제외)에 설치된 Windows Media Player 9 시리즈, Windows Media Player 10, Windows Media Player 11 및 Windows Media Player 12에 대해 중요이며, 지원 대상인 Windows Server 2008 및 Windows Server 2008 R2에 설치된 Windows Media Player 11 및 Windows Media Player 12에 대해서는 보통입니다. 지원 대상인 모든 Itanium 기반 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2 에디션은 이 취약점의 영향을 받지 않습니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Windows Media Player에서 다시 로드하는 작업 중에 개체의 할당을 취소하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c&amp;displaylang=ko">Windows Media Player 9 시리즈</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows XP 서비스 팩 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c&amp;displaylang=ko">Windows Media Player 10</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c&amp;displaylang=ko">Windows Media Player 11</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=0663e0e8-c5d1-4cd2-b6d3-ff78fb56bba1">Windows Media Player 11</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5479fd20-50d1-447a-8555-a98ce0723f71&amp;displaylang=ko">Windows Media Player 10</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a9515e69-c147-4810-8c5a-6cb94c398a95&amp;displaylang=ko">Windows Media Player 10</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=95e24a63-d21a-4756-a16e-17a977595396&amp;displaylang=ko">Windows Media Player 11</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=277151a2-b74f-4da6-8203-e774af75e44c&amp;displaylang=ko">Windows Media Player 11</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=67eb3a70-9ca7-4184-b9fe-cc3e66b1bf36&amp;displaylang=ko">Windows Media Player 11</a>\*\*</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=33a06f0e-81ab-445a-bc89-14350ebfe688&amp;displaylang=ko">Windows Media Player 11</a>\*\*</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59a2ef36-9c32-488b-b5b1-30b5bcd83358&amp;displaylang=ko">Windows Media Player 12</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=00176d56-8a93-4780-96fc-a7ab715e7291&amp;displaylang=ko">Windows Media Player 12</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4cf0e3b1-4b72-4f99-b716-2489ea42ed72&amp;displaylang=ko">Windows Media Player 12</a>**</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
| 운영 체제                                                                                            | 구성 요소                |  
|------------------------------------------------------------------------------------------------------|--------------------------|  
| Windows XP 서비스 팩 3                                                                               | Windows Media Player 6.4 |  
| Windows XP Professional x64 Edition 서비스 팩 2                                                      | Windows Media Player 6.4 |  
| Windows Server 2003 서비스 팩 2                                                                      | Windows Media Player 6.4 |  
| Windows Server 2003 x64 Edition 서비스 팩 2                                                          | Windows Media Player 6.4 |  
...
Windows XP 서비스 팩 3에 설치된 Windows Media Player 9
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<td style="border:1px solid black;">
Windows XP 서비스 팩 3에 설치된 Windows Media Player 10
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Player 10
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2에 설치된 Windows Media Player 10
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Windows Media Player 10
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 3에 설치된 Windows Media Player 11
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Player 11
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2에 설치된 Windows Media Player 11
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2에 설치된 Windows Media Player 11
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2에 설치된 Windows Media Player 11\*\*
</td>
<td style="border:1px solid black;">
**보통**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2에 설치된 Windows Media Player 11\*\*
</td>
<td style="border:1px solid black;">
**보통**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7(32비트 시스템용)에 설치된 Windows Media Player 12
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용)에 설치된 Windows Media Player 12
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용)에 설치된 Windows Media Player 12\*\*
</td>
<td style="border:1px solid black;">
**보통**   
원격 코드 실행
...
Windows Media Player에서 웹 브라우저를 통해 다시 로드하는 작업 중에 개체의 할당을 취소하는 방식에 원격 코드 실행 취약점이 존재합니다. 사용자가 특수하게 조작된 웹 페이지를 방문할 경우 이 취약점으로 인해 코드 실행이 발생할 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2745 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745)를 참조하십시오.

#### Windows Media Player 메모리 손상 취약점(CVE-2010-2745)에 대한 완화 요소
...
-   데스크톱 경험 기능을 설치하지 않으면 지원 대상인 Windows Server 2008 및 Windows Server 2008 R2 에디션은 이 문제점의 영향을 받지 않습니다. 기본적으로 이러한 플랫폼에서는 영향을 받는 Windows Media Player 구성 요소를 로드하지 않습니다. 데스크톱 경험 기능에 대한 자세한 내용은 TechNet 문서, [데스크톱 경험 개요](http://technet.microsoft.com/library/cc772567.aspx)를 참조하십시오.

#### Windows Media Player 메모리 손상 취약점(CVE-2010-2745)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **wmp.dll 등록 취소**

    이 DLL의 등록을 취소하려면 상승된 권한의 명령 프롬프트에서 다음 명령을 실행합니다.
    ...
    **대안의 영향.** Windows Media Player에서 지원되는 파일 형식을 재생할 수 없습니다.
...
#### Windows Media Player 메모리 손상 취약점(CVE-2010-2745)에 FAQ
...
**취약점의 원인은 무엇입니까?**  
Windows Media Player에서 웹 브라우저를 통해 다시 로드하는 작업 중에 개체의 할당을 부적절하게 취소합니다.
...
**이 취약점을 악용하려면 사용자 조작이 필요합니까?**  
예. 공격에 성공하려면 사용자가 웹 페이지를 탐색할 때 하나 이상의 팝업 대화 상자를 클릭해야 합니다. 특수하게 조작된 웹 페이지를 방문하는 경우에는 이 취약점을 자동으로 악용할 수 없습니다.
...
공격자는 Windows Media Player를 통해 이 취약점을 악용하도록 설계된 특수하게 조작된 웹 사이트를 호스팅한 다음 해당 웹 사이트를 방문하도록 사용자를 유도할 수 있습니다. 악용에 성공하려면 사용자가 하나 이상의 팝업 대화 상자를 클릭해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 인스턴트 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
보안 업데이트는 Windows Media Player에서 다시 로드하는 작업 중에 개체의 할당을 취소하는 방식을 수정하여 문제점을 해결합니다.
...
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Player 10:<br />
windowsserver2003.windowsxp-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Player 11:<br />
windowsmedia11-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3에 설치된 Windows Media Player 9:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3에 설치된 Windows Media Player 10 및 Windows Media Player 11:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<br />
Windows XP 서비스 팩 3의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11:<br />
%Windir%\$NTUninstallKB2378111_WM9$\Spuninst 폴더<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Player 10:<br />
%Windir%\$NTUninstallKB2378111$\Spuninst 폴더<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Player 11:<br />
%Windir%\$NTUninstallKB2378111_WM11x64$\Spuninst 폴더</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2378111">Microsoft 기술 자료 문서 2378111</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">지원 대상인 Windows XP 32비트 에디션에 설치된 Windows Media Player 9, Media Player 10 및 Windows Media Player 11:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 x64 기반 Windows XP 에디션에 설치된 Windows Media Player 10:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP3\KB2378111\Filelist<br />
<br />
지원 대상인 모든 x64 기반 Windows XP 에디션에 설치된 Windows Media Player 11:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2378111$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2378111">Microsoft 기술 자료 문서 2378111</a> 참조</td>
...
-   Windows Media Player 메모리 손상 취약점(CVE-2010-2745)을 보고해 주신 [Google Inc.](http://www.google.com/)의 SkyLined
...
-   V1.1(2010년 10월 14일): Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Player 11에 대한 **영향을 받는 소프트웨어** 표의 다운로드 링크가 수정되었습니다.
