...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 950974 (영문)](http://support.microsoft.com/kb/950974)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 이 업데이트 설치에 대한 자세한 내용은 이 섹션에서 **이 보안 업데이트의 자주 제기되는 질문 사항(FAQ)**을 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=1b2ad648-7dc9-407a-99f6-f39922746027&displaylang=ko)                                                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=01a34aa4-a456-4efc-a93a-c3c682b0181c&displaylang=ko)                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=246b2686-e330-47a2-b4d4-68f218ad4021)           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=92a3d08f-c117-4b24-bc78-2b913d270df6&displaylang=ko)                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows 2003 Server x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6bfbb6d8-5106-4adf-83cb-35ffc6e8eaf8&displaylang=ko)    | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=45356565-697f-41b3-9879-3edd11dbcb7e) | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 및 Windows Vista 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=6418c78f-f008-4028-beb1-5a5ea8e797a1&displaylang=ko)                                        | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=e03ccfb0-3ea3-4c59-adcf-9882d7086013&displaylang=ko)                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=0640f95e-1eee-4dd1-b4dd-2b82b7e984b9&displaylang=ko)\*                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=51a93538-5e94-4f81-a6e0-d497a7b4899d&displaylang=ko)\*                                         | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=390da130-749d-4890-aad7-be91e15b32bb)                                                      | 원격 코드 실행 | 중요        | 없음                      |
...
그렇습니다. Windows Vista RTM 시스템에 이 공지의 업데이트를 설치하려면 먼저 Microsoft 보안 공지 [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277)에서 제공된 업데이트 또는 [Microsoft 기술 자료 문서 938371](http://support.microsoft.com/kb/938371)에서 제공된 업데이트를 설치해야 합니다. Windows Vista RTM 시스템에서 이 공지의 업데이트 설치 안정성을 향상시키려면 이러한 업데이트들이 전제 조건으로 필요합니다. 영향을 받는 소프트웨어에 명시된 Windows Vista 서비스 팩 1을 비롯한 다른 모든 시스템은 유사한 영향을 받지 않으며 이 FAQ 항목에 규정된 전제 조건이 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1457 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1457)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1456 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1456)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/950974">Microsoft 기술 자료 문서 950974 (영문)</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/950974">Microsoft 기술 자료 문서 950974 (영문)</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 에디션:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고</strong>: 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다. 업데이트가 있는지 확인하려면 WMI 데이터 판독기 태스크에 표시되는 것처럼 QFE 업데이트에 대한 WQL 쿼리를 사용하십시오. 자세한 내용은 <a href="http://msdn2.microsoft.com/en-us/library/aa384642.aspx">WMI(Windows Management Instrumentation)(영문)</a>를 참조하십시오.</td>
</tr>
</tbody>
</table>
...
-   Microsoft 이벤트 시스템 취약점(CVE-2008-1456)을 보고해 주신 [Palo Alto Networks(영문)](http://www.paloaltonetworks.com/index.html)의 Yamata Li
