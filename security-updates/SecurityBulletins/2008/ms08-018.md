...
**알려진 문제점.** [Microsoft 기술 자료 문서 950183](https://support.microsoft.com/kb/950183)은 고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 현재까지 알려진 문제점과 권장 해결 방법을 다룹니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fbe46241-b9da-40c6-803d-42eb6234be77&amp;displaylang=ko">Microsoft Project 2000 서비스 버전 1</a><br />
(KB949043)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=07a90718-6597-426d-9dca-a336d60c01b8&amp;displaylang=ko">Microsoft Project 2002 서비스 버전 1</a><br />
(KB949005)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aaba07d6-e972-4e85-bccd-406aa2c4a4f4&amp;displaylang=ko">Microsoft Project 2003 서비스 팩 2</a><br />
(KB948962)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 950183](https://support.microsoft.com/kb/950183)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1088 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088)을 참조하십시오.
...
-   지원되는 Microsoft Office 2000 버전은 [How to Create an Administrative Installation Point(관리 설치 지점을 만드는 방법)](https://office.microsoft.com/en-us/ork2000/ha011380221033.aspx)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office 2000 서비스 팩 3(SP3)으로 클라이언트 시스템에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 932889](https://support.microsoft.com/kb/932889)를 참조하십시오.  
...
-   지원되는 Microsoft Office 2003 버전은 [Creating an Administrative Installation Point(관리 설치 지점 만들기) (영문)](https://office.microsoft.com/en-us/ork2003/ha011401931033.aspx)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office 2003 원래 기준선 또는 서비스 팩 2(SP2)로 클라이언트 컴퓨터에 대한 원본을 변경하는 방법에 대한 자세한 내용은 Microsoft 기술 자료 문서 902349를 참조하십시오.  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950183">Microsoft 기술 자료 문서 950183</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
-   Project 메모리 유효성 검사 취약점(CVE-2008-1088)을 보고해 주신 [대한민국 국가사이버안전센터](https://www.ncsc.go.kr/)
