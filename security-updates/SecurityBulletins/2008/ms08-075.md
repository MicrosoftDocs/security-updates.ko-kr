...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0dcc5373-0435-42d5-864d-298e5bb122d9&amp;displaylang=ko">Windows Vista 및 Windows Vista 서비스 팩 1</a><br />
(KB958623)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5b1b65f0-6848-47c6-bdd5-be3c0621b323&amp;displaylang=ko">Windows Vista 및 Windows Vista 서비스 팩 1</a><br />
(KB958624)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2112c5c8-7c9f-4491-b127-b1093085e105&amp;displaylang=ko">Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1</a><br />
(KB958623)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-038">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=eb1d0ffe-1644-457b-9e82-768bd4c7f7ab&amp;displaylang=ko">Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1</a><br />
(KB958624)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=90ab7e6f-5ae7-4f55-8838-868fc98d8a16&amp;displaylang=ko">Windows Server 2008(32비트 시스템용)</a>&#42;<br />
(KB958623)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-038">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=470d506f-77ae-4a44-8598-df645f484295&amp;displaylang=ko">Windows Server 2008(32비트 시스템용)</a>&#42;<br />
(KB958624)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e1deab57-ada2-4b12-9157-5615e7b0071d&amp;displaylang=ko">Windows Server 2008(x64 기반 시스템용)</a>&#42;<br />
(KB958623)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-038">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e41f23e4-6a2f-4ebb-b425-d241a08da316&amp;displaylang=ko">Windows Server 2008(x64 기반 시스템용)</a>&#42;<br />
(KB958624)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=48bed90d-c243-4969-8e54-326d9a7af343">Windows Server 2008(Itanium 기반 시스템용)</a><br />
(KB958623)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-038">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=83de2263-de2a-4c13-96ba-ecfebdaf0bb9">Windows Server 2008(Itanium 기반 시스템용)</a><br />
(KB958624)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 959349](https://support.microsoft.com/kb/959349)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4268 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4268)을 참조하십시오.
...
**Windows 검색이란 무엇입니까?**    
Windows 검색은 Windows Vista와 Windows Server 2008의 표준 구성 요소이며, 기본적으로 사용하도록 설정되어 있습니다. Windows 검색을 사용하여 전자 메일, 연락처, 일정 약속, 문서, 사진, 멀티미디어, 기타 타사 형식 등의 일반적인 파일 및 데이터 형식을 즉시 검색할 수 있습니다. 이 기능을 통해 소비자와 정보 작업자는 가정 및 기업 환경에서 많은 양의 데이터를 효율적으로 찾고 관리하고 구성할 수 있습니다. 자세한 내용은 [Windows 검색 (영문)](https://www.microsoft.com/windows/products/winfamily/desktopsearch/default.mspx) 홈 페이지를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4269 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4269)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/959349">Microsoft 기술 자료 문서 959349</a> 참조</td>
</tr>
<tr class="odd">
...
-   Windows 검색 조건 저장 취약점(CVE-2008-4268)을 보고해 주신 [eEye Digital Security (영문)](https://www.eeye.com/)의 Andre Protas  
