...
**주의 사항:** [Microsoft 기술 자료 문서 912812](https://support.microsoft.com/kb/912812)에 나와 있습니다. 이 문서에는 이러한 문제점에 대한 권장 해결 방법도 나와 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 912812](https://support.microsoft.com/kb/912812)를 참조하십시오.

이 보안 업데이트는 2006년 2월 28일에 릴리스된 Windows XP 서비스 팩 2 및 Windows Server 2003 서비스 팩 1용 Internet Explorer 누적 업데이트도 대체합니다. 이 업데이트는 [Microsoft 보안 권고(912945): Internet Explorer 비보안 업데이트](https://technet.microsoft.com/security/advisory/912945)에서 다루었습니다. 이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 912945](https://support.microsoft.com/kb/912945)를 참조하십시오.

호환성 패치 – [Microsoft 기술 자료 문서 912945](https://support.microsoft.com/kb/912945)에서 다룬 ActiveX 업데이트에 대비하기 위해 시간이 더 필요한 기업 고객을 돕기 위해 Microsoft는 호환성 패치를 릴리스하고 있습니다. 이 호환성 패치를 배포하면 임시로 Internet Explorer의 ActiveX 컨트롤 처리 기능을 이전 상태로 되돌립니다. 이 호환성 패치는 6월 업데이트 주기의 일부로 Internet Explorer 업데이트가 릴리스될 때까지 작동하고, 이 때 Internet Explorer의 ActiveX 컨트롤 처리 방식은 영구히 고정됩니다. 자세한 내용은 [Microsoft 기술 자료 문서 917425](https://support.microsoft.com/kb/917425)를 참조하십시오.
...
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 5.01 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=594e7b87-af8f-4346-9164-596e3e5c22b1&displaylang=ko)
-   Microsoft Windows 2000 서비스 팩 4 또는 Microsoft Windows XP 서비스 팩 1에 설치된 Internet Explorer 6 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=033c41e1-2b36-4696-987a-099fc57e0129&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 2용 Internet Explorer 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f05ffb31-e6b4-4771-81f1-4accebf72133&displaylang=ko)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1용 Internet Explorer 6 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ee566871-d217-41d3-becc-b27fafa00054&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템)용 Internet Explorer 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e584957c-0abe-4129-abaf-aa2852ad62a3)
-   Microsoft Windows Server 2003 x64 Edition용 Internet Explorer 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=5a1c8be3-39ee-4937-9bd1-280fc35125c6)
-   Microsoft Windows XP Professional x64 Edition용 Internet Explorer 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c278fe3e-620a-4bbc-868b-ca2d9eff7ac3)
...
|----------------------------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------------------|-------------------------------------------------------------------------------------------|-------------------------------------------|-------------------------------------------------------|----------------------------------------------|
| DHTML 메서드 호출 메모리 손상 취약점 - [CVE-2006-1359 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1359)         | 원격 코드 실행       | 긴급                              | 긴급                                                                                      | 보통                                      | 보통                                                  | 긴급                                         |
| 다중 이벤트 처리기 메모리 손상 취약점 - [CVE-2006-1245 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1245)        | 원격 코드 실행       | 긴급                              | 긴급                                                                                      | 긴급                                      | 긴급                                                  | 긴급                                         |
| HTA 실행 취약점 - [CVE-2006-1388 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1388)                              | 원격 코드 실행       | 긴급                              | 긴급                                                                                      | 보통                                      | 보통                                                  | 긴급                                         |
| HTML 구문 분석 취약점 - [CVE-2006-1185 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1185)                        | 원격 코드 실행       | 긴급                              | 해당 사항 없음                                                                            | 해당 사항 없음                            | 긴급                                                  | 긴급                                         |
| COM 개체 인스턴스화 메모리 손상 취약점 - [CVE-2006-1186 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1186)       | 원격 코드 실행       | 긴급                              | 긴급                                                                                      | 보통                                      | 보통                                                  | 긴급                                         |
| HTML 태그 메모리 손상 취약점 - [CVE-2006-1188 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1188)                 | 원격 코드 실행       | 해당 사항 없음                    | 긴급                                                                                      | 긴급                                      | 긴급                                                  | 긴급                                         |
| 더블바이트 문자 구문 분석 메모리 손상 취약점 - [CVE-2006-1189 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1189) | 원격 코드 실행       | 해당 사항 없음                    | 긴급                                                                                      | 긴급                                      | 해당 사항 없음                                        | 긴급                                         |
| 스크립트 실행 취약점 - [CVE-2006-1190 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1190)                         | 원격 코드 실행       | 해당 사항 없음                    | 긴급                                                                                      | 보통                                      | 보통                                                  | 중요                                         |
| 도메인 간 정보 유출 취약점 - [CVE-2006-1191 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1191)                   | 정보 유출            | 해당 사항 없음                    | 해당 사항 없음                                                                            | 해당 사항 없음                            | 보통                                                  | 중요                                         |
| 주소 표시줄 스푸핑 취약점 - [CVE-2006-1192 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1192)                    | 스푸핑               | 보통                              | 보통                                                                                      | 보통                                      | 보통                                                  | 보통                                         |
...
**참고** 이 보안 업데이트는 2006년 2월 28일에 릴리스된 Windows XP 서비스 팩 2 및 Windows Server 2003 서비스 팩 1용 Internet Explorer 누적 업데이트도 대체합니다. 이 업데이트는 [Microsoft 보안 권고(912945): Internet Explorer 비보안 업데이트](https://technet.microsoft.com/security/advisory/912945)에서 다루었습니다. 이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 912945](https://support.microsoft.com/kb/912945)를 참조하십시오.

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 현재 알려진 문제점은 무엇입니까?**  
[Microsoft 기술 자료 문서 912812](https://support.microsoft.com/kb/912812)에 나와 있습니다. 이 문서에는 이러한 문제점에 대한 권장 해결 방법도 나와 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 912812](https://support.microsoft.com/kb/912812)를 참조하십시오.
...
-   또한 이 누적 보안 업데이트는 Danim.dll과 Dxtmsft.dll에 포함되어 있는 두 가지 ActiveX 컨트롤에 대해 [킬(kill) 비트](https://support.microsoft.com/kb/240797)를 설정합니다. 이 컨트롤에 포함된 보안 취약점이 발견되었습니다. 이러한 컨트롤을 설치한 고객을 보호하기 위해 이 업데이트는 이러한 컨트롤이 Internet Explorer에서 실행되는 것을 막습니다. 이를 위해 컨트롤에 킬(kill) 비트를 설정하는 방법을 사용합니다. 킬(kill) 비트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 240797](https://support.microsoft.com/kb/240797)을 참조하십시오. 이러한 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.
...
[웹 사이트](https://www.microsoft.com/korea/technet/security/policy/rating.asp)를 참조하십시오.
...
[Windows 운영 체제 제품 지원 기간 정책 FAQ](https://go.microsoft.com/fwlink/?linkid=33330)를 참조하십시오.
...
**createTextRange()** 메서드는 DHTML 개체 모델에 의해 노출되는 동적 HTML(DTHML) 메서드입니다. DHTML 메서드에 대한 자세한 내용은 [MSDN Library 웹 사이트 (영문)](https://msdn.microsoft.com/library/default.asp?url=/workshop/author/dhtml/reference/methods.asp)를 참조하십시오.
...
예. Windows 98, Windows 98 Second Edition 및 Windows Millennium Edition은 이 취약점으로 인해 심각한 영향을 받습니다. 보안 업데이트는 [Windows Update 웹 사이트](https://update.microsoft.com/microsoftupdate/)에서 제공됩니다. 심각도에 대한 자세한 내용은 다음 [웹 사이트](https://www.microsoft.com/korea/technet/security/policy/rating.asp)를 참조하십시오.
...
-   Microsoft 보안 공지 [MS05-052](https://technet.microsoft.com/security/bulletin/ms05-052) 또는 이후 Internet Explorer용 보안 공지에 포함된 보안 업데이트를 설치한 고객은 인터넷 영역에서 시도되는 공격의 위험에 노출되지 않습니다.
-   웹을 통한 공격의 경우 공격자는 이 취약점을 악용하는 웹 페이지를 포함한 웹 사이트를 호스팅해야 합니다. 공격자는 강제로 사용자가 악의적인 웹 사이트를 방문하도록 만들 수 없습니다. 대신, 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 눌러 공격자의 웹 사이트를 방문하도록 유인해야 합니다.
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
-   제한된 사이트 영역은 HTML 메일 메시지를 읽을 때 ActiveX 컨트롤을 사용하는 것을 방지하여 취약점이 악용되는 것을 막는 데 유용합니다. 그러나 사용자가 메일에 있는 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 문제점에 취약해질 수 있습니다.
    ...
    기본적으로 Outlook Express 6, Outlook 2002 및 Outlook 2003은 제한된 사이트 영역에서 HTML 메일 메시지를 엽니다. 또한, [Outlook 메일 보안 업데이트](https://www.microsoft.com/korea/office/outlook/evaluation/security.asp)를 설치한 경우 Outlook 2000은 제한된 사이트 영역에서 HTML 메일 메시지를 엽니다. Microsoft 보안 공지 [MS04-018](https://technet.microsoft.com/security/bulletin/ms04-018)을 설치한 경우 Outlook Express 5.5 서비스 팩 2는 제한된 사이트 영역에서 HTML 메일을 엽니다.
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 보안 업데이트에 대한 FAQ 섹션을 참조하십시오.
...
**참고** Microsoft 보안 공지 [MS05-052](https://technet.microsoft.com/security/bulletin/ms05-052) 또는 이후 Internet Explorer용 보안 공지에 포함된 보안 업데이트를 설치한 고객은 인터넷 영역에서 시도되는 공격의 위험에 노출되지 않습니다.
...
-   이 취약점은 더블바이트 문자 집합을 사용하는 시스템에만 영향을 줍니다. 더블바이트 문자 집합 언어를 사용하는 Windows 언어 버전 시스템이 영향을 받습니다. DBCS를 사용하는 언어로는 한국어, 중국어, 일본어 등이 있습니다. “[유니코드를 지원하지 않는 프로그램용 언어 (영문)](https://www.microsoft.com/globaldev/handson/user/xpintlsupp.mspx)”를 더블바이트 문자 집합 언어로 설정한 경우 Windows의 다른 언어 버전도 영향을 받을 수 있습니다.
...
**더블바이트 문자 집합이란 무엇입니까?**  
DBCS(더블바이트 문자 집합)은 최소 단위가 1바이트인 확장 8비트 문자 집합을 지칭합니다. DBCS의 일부 문자는 싱글바이트 코드 값을 갖고, 일부는 더블바이트 코드 값을 갖습니다. DBCS는 Microsoft Windows의 일부 아시아 버전에 대한 ANSI 문자 집합으로 간주됩니다. 자세한 내용은 [제품 설명서 (영문)](https://msdn.microsoft.com/library/en-us/intl/unicode_90c3.asp)를 참조하십시오.

**DBCS 로캘의 실행 여부를 어떻게 알 수 있습니까?**  
DBCS는 Microsoft Windows의 일부 아시아 버전에 대한 ANSI 문자 집합으로 간주됩니다. DBCS를 사용하는 언어로는 한국어, 중국어, 일본어 등이 있습니다. 시스템 로캘에 대한 자세한 내용 및 시스템 로캘을 확인하는 방법은 이 [Microsoft 웹 사이트 (영문)](https://www.microsoft.com/technet/security/drintl/faqs/locales.mspx)를 참조하십시오.
...
IOleClientSite 인터페이스는 포함 개체가 위치 및 해당 표시 사이트의 범위, 해당 모니커, 해당 사용자 인터페이스 및 해당 컨테이너에서 제공하는 기타 리소스 관련 정보를 획득하는 기본 수단입니다. 자세한 내용은 [제품 설명서 (영문)](https://msdn.microsoft.com/library/en-us/com/htm/compound_0po3.asp?frame=true)를 참조하십시오.

**Internet Explorer 보안 영역이란 무엇입니까?**  
Internet Explorer [보안 영역](https://support.microsoft.com/kb/174360/ko)은 온라인 콘텐츠의 신뢰도에 따라 콘텐츠를 범주나 영역으로 구분한 시스템 부분입니다. 특정 웹 도메인은 각 도메인의 콘텐츠가 얼마나 신뢰할 수 있는지에 따라 영역에 할당될 수 있습니다. 각 영역은 영역의 정책에 따라 웹 콘텐츠의 기능을 제한합니다. 기본적으로 대부분의 인터넷 도메인은 인터넷 영역의 일부로 취급됩니다. 기본적으로 인터넷 영역의 정책은 스크립트나 다른 활성 코드에서 로컬 시스템의 리소스를 액세스할 수 없게 합니다.
...
-   DHTML 메서드 호출 메모리 손상 취약점([CVE-2006-1359 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1359))을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Andreas Sandblad
-   HTA 실행 취약점([CVE-2006-1388 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1388))을 보고해 주신 Jeffrey van der Stad
-   HTML 구분 분석 취약점([CVE-2006-1185 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1185))을 보고해 주신 [Compass Security Network Computing AG (영문)](https://www.csnc.ch/)의 Jan P. Monsch
-   COM 개체 인스턴스화 메모리 손상 취약점([CVE-2006-1186 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1186))에 설명된 클래스 식별자를 보고해 주신 [Boston Software Forensics (영문)](https://www.bsf-llc.com)의 Richard M. Smith
-   HTML 태그 메모리 손상 취약점([CVE-2006-1188 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1188))의 변형된 버전을 보고해 주신 [Thomas Waldegger (영문)](https://morph3us.org/)
-   더블바이트 문자 구문 분석 메모리 손상 취약점([CVE-2006-1189 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1189))을 보고해 주신 [Nevis Labs (영문)](https://www.nevisnetworks.com/)의 Sowhat
-   스크립트 실행 취약점([CVE-2006-1190 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1190))을 보고해 주신 [SAP (영문)](https://www.sap.com/)의 Heiko Schultze
-   이 보안 업데이트에서 킬(Kill) 비트가 설정되는 Danim.dll 및 Dxtmsft.dll에 포함된 ActiveX 컨트롤 문제점을 보고해 주신 [CERT/CC (영문)](https://www.cert.org/)의 Will Dormann
