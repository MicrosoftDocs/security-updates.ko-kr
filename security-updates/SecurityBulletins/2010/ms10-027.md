---
TOCTitle: 'MS10-027'
Title: 'Microsoft 보안 공지 MS10-027 - 긴급'
ms:assetid: 'ms10-027'
ms:contentKeyID: 61230288
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-027(v=Security.10)'
---



Microsoft 보안 공지 MS10-027 - 긴급
===================================

Windows Media Player의 취약점으로 인한 원격 코드 실행 문제점 (979402)
---------------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000 및 Windows XP 버전에 설치된 Windows Media Player 9 시리즈에 대해 긴급입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows Media Player ActiveX 컨트롤이 악의적인 웹 사이트에서 호스팅하는 특수하게 조작된 미디어 콘텐츠를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 서비스 팩 4 | [Windows Media Player 9 시리즈](https://www.microsoft.com/download/details.aspx?familyid=c0b8b362-a321-4ac9-be98-15c71bb7a043&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS07-047](https://technet.microsoft.com/security/bulletin/ms07-047) |
| Windows XP 서비스 팩 2             | [Windows Media Player 9 시리즈](https://www.microsoft.com/download/details.aspx?familyid=5c748c6d-84d1-45a9-8a33-9372eb5504d5&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS07-047](https://technet.microsoft.com/security/bulletin/ms07-047) |
| Windows XP 서비스 팩 3             | [Windows Media Player 9 시리즈](https://www.microsoft.com/download/details.aspx?familyid=9e4277b4-2dc5-4163-a6aa-7e07dd32b721&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
...
<th style="border:1px solid black;" >Media Player 원격 코드 실행 취약점(CVE-2010-0268)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4에 설치된 Windows Media Player 9 시리즈</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP 서비스 팩 2에 설치된 Windows Media Player 9 시리즈</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP 서비스 팩 3에 설치된 Windows Media Player 9 시리즈</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
...
Media Player 원격 코드 실행 취약점(CVE-2010-0268)  
-------------------------------------------------
  

Windows Media Player ActiveX 컨트롤에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 모든 사용자 권한을 가지고 프로그램을 설치하거나, 데이터를 보거나 변경하거나 삭제할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0268 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268)을 참조하십시오.
  
#### Media Player 원격 코드 실행 취약점(CVE-2010-0268)에 대한 완화 요소
...
-   기본적으로 지원 대상인 모든 Microsoft Outlook 및 Microsoft Outlook Express 버전은 "제한된 사이트" 영역에서 HTML 메일 메시지를 엽니다. 제한된 사이트 영역은 HTML 메일 메시지를 읽을 때 Active 스크립팅과 ActiveX 컨트롤을 사용하는 것을 방지하여 이 취약점을 악용하기 위한 공격을 완화하는 데 도움이 됩니다. 그러나 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 취약점 악용에 취약해질 수 있습니다.
  
#### Media Player 원격 코드 실행 취약점(CVE-2010-0268)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **Internet Explorer에서 Windows Media Player ActiveX 컨트롤 실행 방지**
  
    레지스트리에서 컨트롤에 킬(kill) 비트를 설정하여 Internet Explorer에서 Windows Media Player ActiveX 컨트롤을 인스턴스화하지 않도록 설정할 수 있습니다.
    ...
    **참고** 레지스트리를 편집하기 전에 백업해 두는 것이 좋습니다.
    ...
    Internet Explorer에서 ActiveX 컨트롤을 사용하지 않도록 설정하려면 다음 단계를 따르십시오.
  
    1.  다음 내용을 .REG 확장명의 파일(예: Disable\_WMP.reg)로 저장합니다.  
        ...
        `"Compatibility Flags"=dword:00000400`  
    2.  다음 방법 중 하나로 위의 레지스트리 스크립트를 대상 컴퓨터에서 실행합니다.  
        대화형 방법의 경우 관리자 권한으로 **Disable\_WMP.reg** 파일을 두 번 클릭합니다.  
        관리되는 배포 방법의 경우 다음 명령을 실행합니다.  
        `Regedit.exe /s Disable_WMP.reg `  
        그룹 정책을 사용하여 레지스트리 변경 내용을 도메인 전체에 적용할 수도 있습니다. 그룹 정책에 대한 자세한 내용은 다음 Microsoft 웹 사이트를 참조하십시오.  
    ...
    **대안의 영향.** 사용자는 웹 페이지 내에서 Windows Media Player ActiveX 컨트롤을 시작할 수 없게 됩니다. 따라서 Windows Media Player 콘텐츠가 웹 페이지 내에서 렌더링되지 않습니다.
  
    **대안 실행 취소 방법.**
  
    1.  다음 내용을 .REG 확장명의 파일(예: Enable\_WMP.reg)로 저장합니다.  
        `Windows 레지스트리 편집기 버전 5.00 `  
        `[-HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\ActiveX Compatibility\{6BF52A52-394A-11d3-B153-00C04F79FAA6}] `  
        `[-HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\ActiveX Compatibility\{6BF52A52-394A-11d3-B153-00C04F79FAA6}] `  
    2.  다음 방법 중 하나로 위의 레지스트리 스크립트를 대상 컴퓨터에서 실행합니다.  
        대화형 방법의 경우 관리자 권한으로 **Enable\_WMP.reg** 파일을 두 번 클릭합니다.  
        관리되는 배포 방법의 경우 다음 명령을 실행합니다.  
...
#### Media Player 원격 코드 실행 취약점(CVE-2010-0268)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 모든 사용자 권한을 가지고 프로그램을 설치하거나, 데이터를 보거나 변경하거나 삭제할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 악의적인 웹 사이트에서 호스팅하는 특수하게 조작된 미디어 콘텐츠를 Windows Media Player ActiveX 컨트롤이 잘못 처리하기 때문에 발생합니다.
  
**Windows Media Player란 무엇입니까?**    
Windows Media Player는 개인 컴퓨터용 Windows 운영 체제에 포함된 기능입니다. 오디오 및 비디오를 재생하는 데 사용됩니다.
  
**내 시스템에 설치된 Windows Media Player의 버전을 어떻게 확인합니까?**    
시스템에 설치된 Windows Media Player의 버전을 확인하는 방법은 [Microsoft 기술 자료 문서](https://support.microsoft.com/kb/190990) 190990을 참조하십시오.
...
공격자는 Internet Explorer를 통해 이 취약점을 악용하도록 특수하게 조작된 미디어 콘텐츠를 호스팅하는 악의적인 웹 사이트를 호스팅한 다음 사용자가 웹 사이트를 방문하고 특수하게 조작된 미디어 콘텐츠를 열도록 유도할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
영향을 받는 소프트웨어를 실행하는 시스템이 주로 위험합니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows Media Player ActiveX 컨트롤이 악의적인 웹 사이트에서 호스팅하는 특수하게 조작된 미디어 콘텐츠를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">Windows2000-WindowsMedia-KB979402-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-WindowsMedia-KB979402-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB979402_WM9L$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/979402">Microsoft 기술 자료 문서 979402</a> 참조</td>
</tr>
<tr class="even">
...
WindowsXP-SP2-WindowsMedia-KB979402-x86-kor /quiet<br />
<br />
Windows XP 서비스 팩 3:<br />
WindowsXP-WindowsMedia-KB979402-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2:<br />
WindowsXP-SP2-WindowsMedia-KB979402-x86-kor /norestart<br />
<br />
Windows XP 서비스 팩 3:<br />
WindowsXP-WindowsMedia-KB979402-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">KB979402.log</td>
...
<br />
Windows XP 서비스 팩 2:<br />
%Windir%\$NTUninstallKB979402_WM9L$\Spuninst 폴더<br />
<br />
Windows XP 서비스 팩 3:<br />
%Windir%\$NTUninstallKB979402_WM9$\Spuninst 폴더</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/979402">Microsoft 기술 자료 문서 979402</a> 참조</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2의 경우 다음의 두 키가 모두 만들어집니다.<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Player\SP0\KB979402_WM9L\Filelist<br />
<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Player\KB979402_WM9L<br />
<br />
Windows XP 서비스 팩 3의 경우 다음의 두 키가 모두 만들어집니다.<br />
...
-   Media Player 원격 코드 실행 취약점(CVE-2010-0268)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
