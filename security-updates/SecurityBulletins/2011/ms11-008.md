...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0092 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0092)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0093 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0093)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2434711">Microsoft 기술 자료 문서 2434711</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2434733">Microsoft 기술 자료 문서 2434733</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2434737">Microsoft 기술 자료 문서 2434737</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Visio 개체 메모리 손상 취약점(CVE-2011-0092)을 [TippingPoint의 (영문)](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Procyun  
-   Visio 개체 메모리 손상 취약점(CVE-2011-0092)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Xin Ouyang  
-   Visio 데이터 형식 메모리 손상 취약점(CVE-2011-0093)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Xin Ouyang
