...
|----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Microsoft Office 2000 서비스 팩 3                                          | [Microsoft Word 2000 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=8b3072fb-5933-47f7-a498-13a93e268e57&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) |
| Microsoft Office XP 서비스 팩 3                                            | [Microsoft Word 2002 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=d6b787bb-03ff-4f67-8b69-6011fb18ba75&displaylang=ko) | 원격 코드 실행 | 중요        | [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) |
| [Mac용 Microsoft Office 2004](https://www.microsoft.com/mac/downloads.aspx) |                                                                                                                                                 | 원격 코드 실행 | 중요        | [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3899 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899)를 참조하십시오.
...
[Windows Installer 관리 설치 (영문)](https://msdn2.microsoft.com/en-us/library/aa367541.aspx)를 사용하는 서버 관리자는 서버 위치를 업데이트해야 합니다. 관리 설치 지점에 대한 자세한 내용은 **검색, 배포 도구 및 지침** 하위 섹션의 **Office 관리 설치 지점** 정보를 참조하십시오.
...
**참고** 관리되는 환경에서 작업하는 관리자는 Office Admin 업데이트 센터에서 조직에 Office 업데이트를 배포하는 데 필요한 리소스를 찾을 수 있습니다. 해당 사이트에서 아래로 스크롤하여 **업데이트 리소스** 섹션에서 업데이트 대상 소프트웨어 버전을 찾으십시오. [Windows Installer 설명서 (영문)](https://msdn2.microsoft.com/en-us/library/aa367541.aspx)에서도 Windows Installer에서 지원하는 설치 스위치에 대한 자세한 내용을 설명합니다.
...
**참고** 관리되는 환경에서 작업하는 관리자는 Office Admin 업데이트 센터에서 조직에 Office 업데이트를 배포하는 데 필요한 리소스를 찾을 수 있습니다. 해당 사이트에서 아래로 스크롤하여 **업데이트 리소스** 섹션에서 업데이트 대상 소프트웨어 버전을 찾으십시오. [Windows Installer 설명서 (영문)](https://msdn2.microsoft.com/en-us/library/aa367541.aspx)에서도 Windows Installer에서 지원하는 매개 변수에 대한 자세한 내용을 설명합니다.
...
Mac용 Microsoft Office 2004 11.3.8 업데이트의 적절한 언어 버전을 [Microsoft Mactopia 웹 사이트 (영문)](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1138.xml&secid=4&ssid=35&flgnosysreq=true)에서 다운로드하여 설치하십시오.
