---
TOCTitle: 'MS10-042'
Title: 'Microsoft 보안 공지 MS10-042 - 긴급'
ms:assetid: 'ms10-042'
ms:contentKeyID: 61230303
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-042(v=Security.10)'
---



Microsoft 보안 공지 MS10-042 - 긴급
===================================

도움말 및 지원 센터의 취약점으로 인한 원격 코드 실행 문제점 (2229593)
---------------------------------------------------------------------

게시된 날짜: 2010년 7월 14일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP 에디션에 대해 긴급이며 지원 대상인 모든 Windows Server 2003 에디션에 대해 낮음입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어** 하위 섹션을 참조하십시오.

이 보안 업데이트는 데이터가 Windows 도움말 및 지원 센터에 전달될 때 데이터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 2219475](https://technet.microsoft.com/security/advisory/2219475)에서 처음 설명한 취약점도 해결합니다.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=7c2122bb-0ecf-4467-a3ba-6fb862f603c5&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9232a336-9ded-4820-bac4-2d68877ee76c)                 | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cd4363b2-d7a7-4fff-8bcd-6fd02bd1ac07&displaylang=ko)                  | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a6bafd3b-c921-466d-bee0-59a3fe126712&displaylang=ko)      | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b61cc2d5-8432-4681-aa2c-a8807ec1fcf4)                  | 원격 코드 실행 | 낮음        | 없음                      |
...
<th style="border:1px solid black;" >도움말 센터 URL 유효성 검사 취약점(CVE-2010-1885)</th>
...
도움말 센터 URL 유효성 검사 취약점(CVE-2010-1885)  
-------------------------------------------------
  

Microsoft 도움말 및 지원 센터가 특수하게 조작된 URL의 유효성을 검사하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 웹 브라우저를 통해 특수하게 조작된 웹 페이지를 보거나 메일 메시지에 포함된 특수하게 조작된 링크를 클릭할 경우 원격 코드 실행이 허용될 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1885 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885)를 참조하십시오.
  
#### 도움말 센터 URL 유효성 검사 취약점(CVE-2010-1885)에 대한 완화 요소
...
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 메일 메시지를 통한 공격에 성공하려면 메일에 포함된 링크를 사용자가 클릭해야 합니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
#### 도움말 센터 URL 유효성 검사 취약점(CVE-2010-1885)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **HCP 프로토콜 등록 취소**
  
**참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2229593](https://support.microsoft.com/kb/2229593)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
HCP 프로토콜의 등록을 취소하면 영향을 받는 시스템에서 이 문제점이 악용되는 것을 방지할 수 있습니다.
...
4.  레지스트리 파일 내보내기 대화 상자에 **HCP\_Procotol\_Backup.reg**를 입력하고 **저장**을 클릭합니다.  
...
2.  다음 내용을 .REG 확장명의 파일(예: Disable\_HCP\_Protocol.reg)로 저장합니다.  
    Windows 레지스트리 편집기 버전 5.00  
    \[-HKEY\_CLASSES\_ROOT\\HCP\]  
3.  상승된 명령 프롬프트에서 위의 레지스트리 스크립트를 대상 컴퓨터에서 다음 명령으로 실행합니다.  
    Regedit.exe /s Disable\_HCP\_Protocol.reg
  
**대안의 영향:** HCP 프로토콜의 등록을 취소하면 hcp://를 사용하는 합법적인 로컬 도움말 링크가 모두 끊어집니다. 예를 들어, 제어판의 링크가 더 이상 작동하지 않을 수 있습니다.
...
3.  레지스트리 파일 가져오기 대화 상자에서 **HCP\_Procotol\_Backup.reg**를 선택하고 **열기**를 클릭합니다.
...
#### 도움말 센터 URL 유효성 검사 취약점(CVE-2010-1885)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 도움말 및 지원 센터가 HCP 프로토콜의 유효성을 적절히 검사하지 못하기 때문입니다.
  
**도움말 및 지원 센터란 무엇입니까?**    
도움말 및 지원 센터(HSC)는 다양한 항목에 대해 지원을 제공하는 Windows 기능입니다. 예를 들어 사용자는 HSC를 사용하여 Windows의 기능을 익히고, 소프트웨어 업데이트를 다운로드하여 설치하고, 특정 하드웨어 장치가 Windows와 호환되는지 확인하고, Microsoft로부터 지원을 받을 수 있습니다. 도움말 및 지원 센터로 연결되는 URL 링크를 실행하려면 URL 링크 맨 앞에 "hcp://" 접두사를 입력하면 됩니다.
  
**HCP 프로토콜이란 무엇입니까?**    
URL 링크를 실행하여 웹 브라우저를 여는 데 사용되는 HTTP 프로토콜과 비슷하게 HCP 프로토콜은 URL 링크를 사용하여 도움말 및 지원 센터 기능을 여는 데 사용할 수 있습니다.
  
**타사 응용 프로그램이 직접적으로 이 문제점의 영향을 받습니까?**    
아니요. 그러나 이 문제는 웹 브라우저의 유형에 관계 없이 웹 거래를 통해 악용될 수 있습니다. 웹을 통한 공격의 경우 공격자는 특수하게 조작된 URI를 포함한 웹 사이트를 호스팅해야 합니다. HCP 프로토콜을 처리할 수 있는 모든 응용 프로그램이 이 문제를 악용하기 위한 경로로 사용될 수 있습니다.
  
**Windows Server 2003에 대한 이 취약점의 심각도가 낮음인 이유는 무엇입니까?**    
Windows Server 2003에도 이 취약점이 존재하지만 Windows Server 2003을 실행하는 서버에서 이 취약점을 원격으로 악용할 수 있는 방법을 확인하지 못했습니다. 그럼에도 불구하고 이 업데이트는 원격 경로의 설명된 위협을 제거하여 Windows Server 2003의 취약점을 해결합니다.
...
공격자는 웹 브라우저를 통해 이 취약점을 악용하도록 설계된 특수하게 조작된 웹 사이트를 호스팅한 다음 사용자가 이 웹 사이트를 보도록 유도할 수 있습니다. 여기에는 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 웹 사이트와 공격에 노출된 웹 사이트도 포함될 수 있습니다. 이러한 웹 사이트에 이 취약점을 악용하는 특수하게 조작된 콘텐츠가 포함될 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 요청의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다. 배너 광고에서 특수하게 조작된 웹 콘텐츠를 표시하거나 웹 콘텐츠를 전달하는 다른 방법을 사용하여 영향을 받는 시스템에 대한 공격을 시도할 수도 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
Windows XP 시스템이 주로 이 취약점으로 인해 공격을 받을 위험이 있습니다. Windows Server 2003 시스템도 역시 위험하지만 Windows Server 2003에서 이 문제를 원격으로 악용할 수 있는 방법을 확인하지 못했습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 데이터가 Windows 도움말 및 지원 센터에 전달될 때 데이터의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-1885 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885)가 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2219475](https://technet.microsoft.com/security/advisory/2219475)에서 처음 설명되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
예. Microsoft는 이 취약점을 악용하려는 실제 공격에 대한 보고를 받았습니다. 분석 샘플에 따르면 Windows Server 2003 시스템은 현재 이러한 공격에 대해 위험하지 않습니다.
...
WindowsXP-KB2229593-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB2229593-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2229593$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2229593">Microsoft 기술 자료 문서 2229593</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2229593-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB2229593-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB2229593-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB2229593-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
