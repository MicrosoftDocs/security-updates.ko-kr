---
TOCTitle: 'MS10-036'
Title: 'Microsoft 보안 공지 MS10-036 - 중요'
ms:assetid: 'ms10-036'
ms:contentKeyID: 61230297
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-036(v=Security.10)'
---



Microsoft 보안 공지 MS10-036 - 중요
===================================

Microsoft Office의 COM 유효성 검사 취약점으로 인한 원격 코드 실행 문제점(983235)
--------------------------------------------------------------------------------

게시된 날짜: 2010년 6월 9일 수요일 | 업데이트된 날짜: 2010년 6월 17일 목요일
...
이 보안 업데이트의 심각도는 Microsoft Office 2003 및 2007 Microsoft Office 시스템에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 COM 개체를 인스턴스화하는 Microsoft Office의 유효성 검사 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 983235](https://support.microsoft.com/kb/983235)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<sup>[1]</sup>사용 가능한 업데이트가 없습니다. 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**을 참조하십시오.
...
| Office 변환 팩                                                                                                                                                           |
| Microsoft Office OneNote 2007 서비스 팩 1 및 Microsoft Office OneNote 2007 서비스 팩 2                                                                                   |
...
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩, Microsoft Office Word Viewer, Microsoft Office Excel Viewer, Microsoft Office PowerPoint Viewer 2007 및 Visual Studio 2008을 비롯하여 영향을 받지 않는 일부 소프트웨어에는 취약한 Office 구성 요소가 포함되어 있지만, 취약한 코드에 액세스하지 않으므로 이 취약점의 영향을 받지 않습니다. 그러나 취약한 코드가 있는 것이 사실이기 때문에 이 업데이트가 제공되는 것입니다.
...
**Microsoft Office XP가 영향을 받는 제품 목록에 있는 경우, Microsoft에서 그에 대한 업데이트를 배포하지 않는 이유는 무엇입니까?**  
Microsoft Office XP에는 올바른 유효성 검사를 위한 픽스를 적절히 지원하는 아키텍처가 없으므로, 이 취약점을 제거하는 Microsoft Office XP 제품을 위한 픽스를 작성할 수 없습니다. 그렇게 하려면 영향을 받는 구성 요소뿐 아니라, Microsoft Office XP 제품의 상당 부분에 대해 아키텍처를 다시 설계해야 합니다. 아키텍처를 다시 설계할 경우 다른 응용 프로그램과 제대로 호환되지 않을 가능성이 있기 때문에 이러한 Microsoft Office 제품이 업데이트된 시스템에서 설계된 대로 작동한다는 보장이 없습니다.

Microsoft는 Windows XP 시스템에 Office XP를 설치한 사용자를 위해 **Microsoft Fix it** 솔루션을 제공하고 있습니다. **Microsoft Fix it** 솔루션은 Office 제품 내의 코드를 수정하지는 않지만, 이 공지에서 설명한 취약점에 대해 비슷한 수준의 보호를 제공합니다. 응용 프로그램 호환성이 최소화될 수 있으므로 이 **Microsoft Fix it** 솔루션을 광범위하게 배포하기 전에 테스트하는 것이 좋습니다. 다운로드 위치와 추가 정보는 [Microsoft Knowledge Base Article 983235](https://support.microsoft.com/kb/983235)를 참조하십시오.

**구성 요소 업데이트 시 관련된 Microsoft Office 2003 또는 2007 Microsoft Office System 업데이트도 설치해야 합니까?**  
예. 이 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트를 적용하려면 Microsoft Office 2003 서비스 팩 3(KB982311) 또는 2007 Microsoft Office System 서비스 팩 1 및 2007 Microsoft Office System 서비스 팩 2(KB982312)와 함께 영향을 받는 소프트웨어 목록에 나열된 Excel, Word, Visio, Publisher 또는 PowerPoint의 관련 업데이트를 설치해야 합니다.

**MS10-038도 Microsoft Office Excel의 취약점을 설명합니다. MS10-038은 이 공지 MS10-036과 어떤 관련이 있습니까?**  
Microsoft Office Excel 2003(KB982133) 및 Microsoft Office Excel 2007(KB982308)에 대한 이 공지(MS10-036)의 보안 업데이트 패키지는 [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038)에서 설명한 취약점도 해결합니다. Microsoft Office Excel 2003 또는 Microsoft Office Excel 2007을 설치한 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다. 또한 사용자는 공지 MS10-036에서 설명한 취약점으로부터 보호하기 위해 이 공지에서 제공되는 Microsoft Office 업데이트(KB982311 또는 KB982312)도 설치해야 합니다.

**이 업데이트에 기능에 대한 다른 비보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 보안과 관련이 없는 기능 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 983632](https://support.microsoft.com/kb/983632)를 참조하십시오.

이 공지의 **취약점 정보** 항목에 나열된 변경 사항 이외에 한 가지 심층 보안 변경 사항이 포함되어 있습니다. 이 업데이트에는 취약한 버전의 ATL을 사용하여 개발된 구성 요소와 컨트롤의 취약점을 이 공지의 취약점 정보 항목에 나열된 Microsoft Office 제품에서 악용하지 못하게 방지하는 완화 조치가 포함되어 있습니다. 이 업데이트에서 제공하는 새로운 심층 방어 보호는 알려진 모든 공개 및 비공개 ATL 라이브러리의 취약점을 악용하려는 시도를 모니터링하고 방지합니다.

이 완화 조치는 [Microsoft 보안 권고(973882)](https://technet.microsoft.com/security/advisory/973882) 및 [MS09-035](https://technet.microsoft.com/security/bulletin/ms09-035)에 설명되어 있는 ATL 취약점을 해결합니다. 변경 사항은 영향을 받는 모든 플랫폼에 기본적으로 적용되며 Microsoft에서 작성하지 않은 컨트롤을 포함하여 Microsoft Office에 로드되는 모든 컨트롤에서 ATL 취약점을 차단합니다.

**심층 보안이란 무엇입니까?**  
정보 보안에서, 심층 보안이란 공격자가 네트워크 또는 시스템의 보안을 침해하지 못하게 하기 위해 여러 계층의 방어 기전을 배치하는 접근 방식을 의미합니다.

**이 문서에서 다뤄지는 Office 구성 요소는 내 시스템에 설치되어 있는 Office 제품군의 일부입니다. 하지만 특정 구성 요소를 모두 설치하도록 선택하지 않습니다. 업데이트가 모두 제공됩니까?**  
예. 사용자 시스템에 설치되어 있는 Office 제품군 버전이 이 공지에서 다뤄지는 구성 요소와 함께 공급된 경우, 개별 구성 요소의 설치 여부와 상관없이 시스템에 모든 업데이트가 제공됩니다. 영향을 받는 시스템을 검사하는 데 사용되는 검사 논리는 특정 Office 제품군과 함께 공급된 모든 구성 요소의 업데이트를 검사하도록 설계되어 있으므로 해당 시스템에 해당되는 업데이트를 제공합니다. 사용자는 설치되어 있지 않지만 해당 Office 제품군 버전에 포함되어 있는 구성 요소에 대해 업데이트를 적용하지 않도록 선택할 수 있으며, 해당 시스템의 보안 심각도는 증가되지 않습니다. 사용자가 업데이트를 설치하지 않도록 선택한 경우에도 시스템의 보안이나 성능에 부정적인 영향은 없습니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office Publisher 2003 서비스 팩 3
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Microsoft Office Visio 2003 서비스 팩 3
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Microsoft Office Publisher 2007 서비스 팩 1 및 Microsoft Office Publisher 2007 서비스 팩 2
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office Visio 2007 서비스 팩 1 및 Microsoft Office Visio 2007 서비스 팩 2
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
영향을 받는 Microsoft Office 소프트웨어가 COM 개체 인스턴스화의 유효성을 검사하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1263 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1263)을 참조하십시오.

#### COM 유효성 검사 취약점(CVE-2010-1263)에 대한 완화 요소
...
-   Microsoft Office 2002 이상 버전 사용자의 경우 문서를 열기 전에 열기, 저장 또는 취소 여부를 묻는 메시지가 표시됩니다. 이 취약점을 악용하려면 둘 이상의 사용자 작업이 필요하기 때문에 이것은 완화 요소로 작용합니다.

#### COM 유효성 검사 취약점(CVE-2010-1263)에 대한 대안
...
#### COM 유효성 검사 취약점(CVE-2010-1263)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
COM 개체가 Excel, PowerPoint, Publisher, Visio 및 Word의 개별 응용 프로그램에서 인스턴스화될 경우 Microsoft Office가 유효성 검사를 적절하게 수행하지 못합니다.

**COM이란 무엇입니까?**  
Microsoft Windows 운영 체제의 Microsoft COM(Component Object Model) 기술을 통해 소프트웨어 구성 요소가 서로 통신할 수 있습니다. 개발자는 다시 사용할 수 있는 소프트웨어 구성 요소를 만들 때, 구성 요소를 연결하여 응용 프로그램을 구축할 때, 그리고 Windows 서비스를 활용할 때 COM을 사용합니다. COM에 대한 자세한 내용은 Microsoft 문서 [COM이란 무엇입니까? (영문)](https://www.microsoft.com/com/default.mspx)를 참조하십시오.
...
이 취약점을 악용하려면 사용자가 특수하게 조작된 Excel, PowerPoint, Publisher, Visio 또는 Word 파일을 영향을 받는 Microsoft Office Project 버전에서 열어야 합니다.

전자 메일을 통한 공격의 경우 공격자는 특수하게 조작된 Microsoft Office 파일을 사용자에게 보내고 파일을 열도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.

웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 특수하게 조작된 Microsoft Office 파일이 포함된 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 눌러 공격자의 웹 사이트를 방문하도록 설득해야 합니다.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
워크스테이션 및 터미널 서버를 포함해 Excel, PowerPoint, Publisher, Visio 및 Word가 사용되는 시스템이 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 COM 개체를 인스턴스화하는 Microsoft Office의 유효성 검사 방식을 수정하여 취약점을 해결합니다.
...
office2003-kb982311-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 서비스 팩 3:<br />
office2003-kb982133-fullfile-kor /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 서비스 팩 3:<br />
office2003-kb982157-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 서비스 팩 3:<br />
office2003-kb982122-fullfile-kor /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 서비스 팩 3:<br />
office2003-kb982126-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 서비스 팩 3:<br />
office2003-kb982134-fullfile-kor /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Office 2003 서비스 팩 3:<br />
office2003-kb982311-fullfile-kor /r:n</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 서비스 팩 3:<br />
office2003-kb982133-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 서비스 팩 3:<br />
office2003-kb982157-fullfile-kor /r:n</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 서비스 팩 3:<br />
office2003-kb982122-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 서비스 팩 3:<br />
office2003-kb982126-fullfile-kor /r:n</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 서비스 팩 3:<br />
office2003-kb982134-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Office 2003 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/982311">Microsoft 기술 자료 문서 982311</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/982133">Microsoft 기술 자료 문서 982133</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/982157">Microsoft 기술 자료 문서 982157</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/982122">Microsoft 기술 자료 문서 982122</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/982126">Microsoft 기술 자료 문서 982126</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/982134">Microsoft 기술 자료 문서 982134</a> 참조</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">2007 Microsoft Office System 서비스 팩 1 및 2007 Microsoft Office System 서비스 팩 2:<br />
office2007-kb982312-fullfile-x86-glb /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2:<br />
excel2007-kb982308-fullfile-x86-glb /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 서비스 팩 1 및 Microsoft Office PowerPoint 2007 서비스 팩 2:<br />
powerpoint2007-kb982158-fullfile-x86-glb /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2007 서비스 팩 1 및 Microsoft Office Publisher 2007 서비스 팩 2:<br />
publisher2007-kb982124-fullfile-x86-glb /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2007 서비스 팩 1 및 Microsoft Office Visio 2007 서비스 팩 2:<br />
visio2007-kb982127-fullfile-x86-glb /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2007 서비스 팩 1 및 Microsoft Office Word 2007 서비스 팩 2:<br />
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">2007 Microsoft Office System 서비스 팩 1 및 2007 Microsoft Office System 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/982312">Microsoft 기술 자료 문서 982312</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 서비스 팩 1 및 Microsoft Office PowerPoint 2007 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/982158">Microsoft 기술 자료 문서 982158</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2007 서비스 팩 1 및 Microsoft Office Publisher 2007 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/982124">Microsoft 기술 자료 문서 982124</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2007 서비스 팩 1 및 Microsoft Office Visio 2007 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/982127">Microsoft 기술 자료 문서 982127</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2007 서비스 팩 1 및 Microsoft Office Word 2007 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/982135">Microsoft 기술 자료 문서 982135</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   이 공지에서 해결한 심층 보안 변경 사항에 대해 협력해 주신 [IBM ISS X-Force (영문)](https://www.iss.net/)의 David Dewey 및 [Accuvant (영문)](https://www.accuvant.com/)(이전 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)) Ryan Smith
...
-   V1.1(2010년 6월 17일): **보안 업데이트 배포** 섹션에서 Microsoft Office Word 2007에 대한 업데이트 파일 이름이 수정되었습니다. 또한 영향을 받는 소프트웨어가 시스템에 존재하지 않는 경우에도 업데이트가 제공되는 이유를 설명하는 항목이 추가되어 FAQ가 업데이트되었습니다.
