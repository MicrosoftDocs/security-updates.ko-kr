...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|---------------------------------------------------------------------------|
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042&displaylang=ko)                                                                            | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39&displaylang=ko)                                                                | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521&displaylang=ko)\*                                                   | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d&displaylang=ko)\*                                                 | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2(영문)](https://www.microsoft.com/download/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                                                        | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7&displaylang=ko)                                 | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5&displaylang=ko)                             | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f&displaylang=ko)\* | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1(영문)](https://www.microsoft.com/download/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad)    | 긴급           | 원격 코드 실행 | [MS11-064](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-064) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2013(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2588516">Microsoft 기술 자료 문서 2588516</a> 참조</td>
</tr>
<tr class="odd">
