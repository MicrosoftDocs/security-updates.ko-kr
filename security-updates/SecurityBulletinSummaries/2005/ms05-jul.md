---
TOCTitle: 'MS05-JUL'
Title: 2005 년 7 월 Microsoft 보안 공지 요약
ms:assetid: 'ms05-jul'
ms:contentKeyID: 61230667
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms05-jul(v=Security.10)'
---

2005 년 7 월 Microsoft 보안 공지 요약
=====================================

게시된 날짜: 2005년 7월 13일 수요일
...
-   최종 사용자의 경우 [PC 보호 웹 사이트](https://www.microsoft.com/korea/athome/security/protect/default.mspx)를 방문하십시오.
...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Word의 취약점으로 인한 원격 코드 실행 문제점(903672)**](https://technet.microsoft.com/security/bulletin/ms05-035)                                       |
| **요약**                   | Word에 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.                                                          |
| **최대 심각도**            | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                                           |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                      |
| **영향을 받는 소프트웨어** | **Office.** 자세한 내용은 [전문가용 게시판](https://technet.microsoft.com/security/bulletin/ms05-035)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 게시판 ID                  | Microsoft 보안 공지 MS05-036                                                                                                                                         |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft 색상 관리 모듈의 취약점으로 인한 원격 코드 실행 문제점(901214)**](https://technet.microsoft.com/security/bulletin/ms05-036)                              |
| **요약**                   | Microsoft 색상 관리 모듈에 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.                                       |
| **최대 심각도**            | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                                            |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                       |
| **영향을 받는 소프트웨어** | **Windows.** 자세한 내용은 [전문가용 게시판](https://technet.microsoft.com/security/bulletin/ms05-036)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 게시판 ID                  | Microsoft 보안 공지 MS05-037                                                                                                                                                                              |
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**JView 프로파일러의 취약점으로 인한 원격 코드 실행 문제점(903235)**](https://technet.microsoft.com/security/bulletin/ms05-037)                                                                           |
| **요약**                   | JView 프로파일러에 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.                                                                                    |
| **최대 심각도**            | [긴급](https://www.microsoft.com/korea/technet/security/policy/rating.asp)                                                                                                                                 |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                                                            |
| **영향을 받는 소프트웨어** | **Windows, JView 프로파일러, Internet Explorer.** 자세한 내용은 [전문가용 게시판](https://technet.microsoft.com/security/bulletin/ms05-037)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
-   [MS05-035](https://technet.microsoft.com/security/bulletin/ms05-035)에 설명되어 있는 문제를 보고해 주신 [iDEFENSE (영문)](https://www.idefense.com/)의 Lord Yup님께 감사드립니다.
-   [MS05-036](https://technet.microsoft.com/security/bulletin/ms05-036)에서 설명된 문제점을 보고해 주신 [ICST(Information & Communication Security Technology Center) (영문)](https://www.icst.org)의 Shih-hao Weng님께 감사드립니다.
