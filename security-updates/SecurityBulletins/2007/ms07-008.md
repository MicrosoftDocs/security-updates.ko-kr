...
|-----------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|------------------------|---------------------|---------------------------------|
| HTML 도움말 ActiveX 컨트롤 취약점 – [CVE-2007-0214 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0214) | 원격 코드 실행       | 긴급                     | 긴급                   | 보통                | 보통                            |
...
|-------------------------------------------------------------------------|--------------------------|------------------------|---------------------|---------------------------------|
| [**MS06-046**](http://technet.microsoft.com/security/bulletin/ms06-046) | 대체됨                   | 대체됨                 | 대체됨              | 대체됨                          |

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 문제점은 무엇입니까?**  
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 928843](http://support.microsoft.com/kb/928843)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
-   **Internet Explorer에서 HTML 도움말 ActiveX 컨트롤을 실행하지 않도록 임시로 설정**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    ActiveX 컨트롤이 Internet Explorer에서 실행되지 않도록 설정하는 자세한 절차는 [Microsoft 기술 자료 문서 240797](http://support.microsoft.com/kb/240797)을 참조하십시오. 이 절차에 따라 레지스트리에 Compatibility Flags 값을 만들어 HTML 도움말 ActiveX 컨트롤이 Internet Explorer에서 인스턴스화하지 않도록 방지하십시오.
...
Microsoft [HTML 도움말 (영문)](http://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconhh1start.asp)은 Windows 플랫폼의 표준 도움말 시스템입니다. HTML 도움말 ActiveX 컨트롤은 HTML 파일에 도움말 탐색 및 보조 창 기능을 삽입하는 데 사용되는 프로그램(Hhctrl.ocx)입니다. HTML 도움말 ActiveX 컨트롤은 Internet Explorer 및 Shdocvw.dll 구성 요소와 함께 작동하도록 설계되어 있습니다. Shdocvw.dll은 인터페이스를 호스트에 노출시키고 이를 통해 별도의 ActiveX 컨트롤로 호스트됩니다. Shdocvw.dll 구성 요소는 WebBrowser 컨트롤로 더 자주 불립니다. HTML 도움말 ActiveX 컨트롤에 대한 자세한 내용은 [제품 설명서 (영문)](http://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconocxov.asp) 및 HTML HELP API 지원을 참조하십시오.
...
-   HTML 도움말 취약점(CVE-2007-0214)과 관련하여 Microsoft와 협력해 주신 [BreakingPoint Systems (영문)](http://www.bpointsys.com/)의 HD Moore
