...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2618444](http://support.microsoft.com/kb/2618444)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
Microsoft는 업데이트 MS11-099가 Internet Explorer에 대해 [SSL/TLS의 취약점으로 인한 정보 유출 문제점](http://go.microsoft.com/fwlink/?linkid=232510) 업데이트인 MS12-006에서 제공된 보호를 허용했다는 점을 알리기 위해 이 공지를 개정했습니다. 자세한 내용은 [MS12-006](http://technet.microsoft.com/ko-kr/security/bulletin/ms12-006)을 참조하십시오.

이 보안 업데이트는 MS12-006및 CVE-2011-3389과 어떤 관련이 있습니까?  
[SSL/TLS의 취약점으로 인한 정보 유출 문제점](http://go.microsoft.com/fwlink/?linkid=232510) 업데이트인 MS12-006은 WinHTTP에 영향을 미치는 SSL 및 TLS 프로토콜 취약점([CVE-2011-3389(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389))을 해결하고 이러한 보호 효과가 시스템 전체에 적용될 수 있도록 합니다. 업데이트 MS11-099는 Internet Explorer에 대한 이러한 보호 효과를 허용합니다. 자세한 내용은[MS12-006](http://technet.microsoft.com/ko-kr/security/bulletin/ms12-006)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1992(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1992)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2019(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2019)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-3404(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3404)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2618444">Microsoft 기술 자료 문서 2618444</a> 참조</td>
</tr>
<tr class="even">
...
-   Internet Explorer의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2019)을 보고해 주신 [Citrix Security Team(영문)](http://www.citrix.com)의 Andy Cooper  
-   Content-Disposition 정보 유출 취약점(CVE-2011-3404)을 보고해 주신 [Google Inc.](http://www.google.com/)의 [Robert Swiecki(영문)](http://www.swiecki.net)  
-   Content-Disposition 정보 유출 취약점 취약점(CVE-2011-3404)을 해결하기 위해 협력해 주신 [Yosuke Hasegawa(영문)](http://utf-8.jp/)  
-   이 공지에 포함된 심층 보안 변경 사항에 대해 협력해 주신 [Jan Schejbal(영문)](http://janschejbal.wordpress.com/)
