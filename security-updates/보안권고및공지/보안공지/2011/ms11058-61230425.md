...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2d4aa38-9241-465d-8d65-aba73e936d0f&displaylang=ko)                                                                      | 서비스 거부    | 중요        | [MS09-008](http://technet.microsoft.com/ko-kr/security/bulletin/ms09-008) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2db4098a-f4f9-4211-b55d-5d0df1409c43&displaylang=ko)                                                          | 서비스 거부    | 중요        | [MS09-008](http://technet.microsoft.com/ko-kr/security/bulletin/ms09-008) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=1934acfa-5637-4ae9-9e9a-fc7e58930b7a&displaylang=ko)                                                       | 서비스 거부    | 중요        | [MS09-008](http://technet.microsoft.com/ko-kr/security/bulletin/ms09-008) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ac2d5122-6f9b-46f5-9840-77aa7ff84308&displaylang=ko)\*                                                   | 원격 코드 실행 | 긴급        | 없음                                                                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5f605f6f-3854-403d-878b-637626aef78f&displaylang=ko)\*                                                 | 원격 코드 실행 | 긴급        | 없음                                                                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=6a86e2cf-4e7d-4012-88c3-6957a3842dd3&displaylang=ko)\* | 원격 코드 실행 | 긴급        | 없음                                                                      |
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1966(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1966)을 참조하십시오.
...
NAPTR(Naming Authority Pointe) DNS RR(리소스 레코드)을 사용하면 도메인 이름 구문에 있지 않은 URI 등 다양한 리소스 이름에 대한 서비스를 찾는 데 DNS를 사용할 수 있습니다. NAPTR에 대한 자세한 내용은 [RFC-2915(영문)](http://www.ietf.org/rfc/rfc2915.txt)를 참조하십시오.
  
DNS 리소스 레코드란 무엇입니까?   
DNS RR(리소스 레코드)은 도메인 안에서 특정 리소스를 식별합니다. 자세한 내용은 TechNet 문서 [How DNS Works(DNS 작동 방식)](http://technet.microsoft.com/ko-kr/library/dd197446(ws.10).aspx)을 참조하십시오.
  
URI란 무엇입니까?   
URI(Uniform Resource Identifier)는 인터넷에 있거나 네트워크를 통해서 접근할 수 있는 리소스를 조작하거나 식별하는 데 사용되는 문자열입니다. 웹 사이트 등의 리소스를 참조하는 URL이 URI의 대표적인 예입니다. URI에 대한 자세한 내용은 [RFC 2396(영문)](http://www.ietf.org/rfc/rfc2915.txt)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1970(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1970)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2562485">Microsoft 기술 자료 문서 2562485</a> 참조</td>
</tr>
<tr class="even">
