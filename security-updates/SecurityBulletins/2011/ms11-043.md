---
TOCTitle: 'MS11-043'
Title: 'Microsoft 보안 공지 MS11-043 - 긴급'
ms:assetid: 'ms11-043'
ms:contentKeyID: 61230410
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-043(v=Security.10)'
---



Microsoft 보안 공지 MS11-043 - 긴급
===================================

SMB 클라이언트의 취약점으로 인한 원격 코드 실행 문제점 (2536276)
----------------------------------------------------------------

게시된 날짜: 2011년 6월 15일 수요일 | 업데이트된 날짜: 2013년 7월 10일 수요일
...
보안 업데이트는 SMB 클라이언트가 특수하게 조작된 SMB 응답을 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2536276](https://support.microsoft.com/kb/2536276)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|-----------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=492310d3-bbb4-4fff-b5fe-3470c17e7681&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | [MS11-019](https://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e10a4c3c-2ef8-4cfc-ac9b-4d97bfa79ac1)                                                               | 원격 코드 실행 | 긴급        | [MS11-019](https://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2719e0fb-3cfd-47b2-906d-3e07b0e3c978&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS11-019](https://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c962531e-f580-4195-989b-cf348cc96fa7&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | [MS11-019](https://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ea18a916-03cf-4eac-bacc-ceb006491f24)                                                                | 원격 코드 실행 | 긴급        | [MS11-019](https://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a62edfd8-9016-4bb5-bf48-885498fa0042&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cb561ba6-af4d-40cc-947c-923f9cca9a7e&displaylang=ko)                 | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8ab9679e-6a69-4ca3-9210-7ca4fb1980c2&displaylang=ko)\*     | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=22c63fc3-2c5a-4e50-9026-2e04a6e74210&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5bb889de-8ff6-4587-8ef9-ffb13e8d60fd)          | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=19a15098-1754-4536-a9ca-ff07d16464b7&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=19a15098-1754-4536-a9ca-ff07d16464b7&displaylang=ko)                                                         | 원격 코드 실행 | 긴급        | 없음                                                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b449f23e-b3df-46e5-bfe3-98268d20ad54&displaylang=ko)                                                                   | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=b449f23e-b3df-46e5-bfe3-98268d20ad54&displaylang=ko)                                                       | 원격 코드 실행 | 긴급        | 없음                                                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=06008192-3cac-477b-a913-83eed39d8718&displaylang=ko)\*                                                    | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=06008192-3cac-477b-a913-83eed39d8718&displaylang=ko)\*                                        | 원격 코드 실행 | 긴급        | 없음                                                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=93a32bd9-7e67-4ace-8c45-116f91b032f9)                                                                 | 원격 코드 실행 | 긴급        | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=93a32bd9-7e67-4ace-8c45-116f91b032f9)                                                     | 원격 코드 실행 | 긴급        | 없음                                                      |

\*Server Core 설치가 영향을 받습니다. 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008 또는 Windows Server 2008 R2에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 TechNet 문서, [Server Core 설치 관리](https://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx)(영문) 및 [Server Core 설치 서비스](https://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx)(영문)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008 및 Windows Server 2008 R2의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션에 따른 버전 비교](https://www.microsoft.com/ko-kr/server-cloud/windows-server/2012-editions.aspx)를 참조하십시오.
...
Microsoft는 모든 지원 대상 운영 체제에 대해 보안 업데이트 KB2536276을 다시 제공하기 위해 이 공지를 다시 릴리스했습니다. 이 업데이트의 새 버전은 업데이트 KB2536276의 원본 버전(V1)으로 인한 안정성 문제를 해결합니다. 모든 지원 대상 운영 체제에는 이 업데이트의 새 버전이 자동으로 제공됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치해야 합니다.
...
<th style="border:1px solid black;" >SMB 응답 구문 분석 취약점(CVE-2011-1268)</th>
...
Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답을 처리하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1268](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1268)(영문)을 참조하십시오.
  
#### SMB 응답 구문 분석 취약점(CVE-2011-1268)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 모두(인바운드 및 아웃바운드) 차단해야 합니다.
  
#### SMB 응답 구문 분석 취약점(CVE-2011-1268)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   방화벽에서 TCP 포트 139 및 445 차단
  
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 TCP 포트 139 및 445를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 이러한 특정 취약점의 경우, 노출을 줄이기 위해 인바운드 및 아웃바운드 SMB 트래픽을 차단해야 합니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
...
#### SMB 응답 구문 분석 취약점(CVE-2011-1268)에 대한 FAQ
...
취약점의 원인은 무엇입니까?    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답을 제대로 처리하지 못해 발생합니다.
  
Microsoft SMB(Server Message Block) 프로토콜이란 무엇입니까?    
Microsoft SMB(Server Message Block) 프로토콜은 Microsoft Windows에 사용되는 Microsoft 네트워크 파일 공유 프로토콜입니다. SMB에 대한 자세한 내용은 [MSDN 문서, Microsoft SMB 프로토콜 및 CIFS 프로토콜 개요](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)(영문)를 참조하십시오.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2536276$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2536276">Microsoft 기술 자료 문서 2536276</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">제거 정보</td>
<td style="border:1px solid black;">WUSA에서 설치한 업데이트를 설치 제거하려면 /Uninstall 설치 스위치를 사용하거나 제어판, 시스템 및 보안을 차례로 클릭한 후 Windows Update에서 설치된 업데이트 보기를 클릭하고 업데이트 목록에서 선택합니다.또는</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2536276">Microsoft 기술 자료 문서 2536276</a> 참조</td>
...
-   V1.1(2011년 6월 23일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2536276 링크가 추가되었습니다.  
-   V2.0(2011년 8월 10일): 모든 지원 대상 운영 체제에 업데이트를 다시 제공하여 안정성 문제를 해결하기 위해 이 공지가 다시 릴리스되었습니다. 이미 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치해야 합니다.  
-   V2.1(2011년 9월 22일): Windows XP 및 Windows Server 2003에 대한 보안 업데이트 배포 섹션에서 레지스트리 키 확인 항목이 수정되었습니다.  
-   V2.2(2013년 7월 10일): Windows Update의 다시 제공 문제를 수정하기 위해 2536276 업데이트에서 Windows Vista 패키지의 검색 변경 사항을 알리고자 공지가 개정되었습니다. 이 변경 사항은 검색에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.
