...
**참고**: Windows Server 2003 SP1에서 **프로그램 디버그** 사용자 권한을 제거하면 Windows Update 서비스를 사용하지 못할 수 있습니다. 그러나 다른 방법으로 패치를 수동으로 다운로드하여 설치하거나 적용할 수는 있습니다. 또한 이 사용자 권한을 제거하면 클러스터 서비스 작동에 영향을 줄 수 있습니다. 자세한 내용은 Microsoft 기술 자료 문서 "[Windows Server 2003 기본 클러스터 서버에서 좀 더 제한적인 보안 설정을 적용하는 방법](http://support.microsoft.com/?kbid=891597)"(http://support.microsoft.com/?kbid=891597)을 참조하십시오.
...
이 섹션에서는 이 가이드에 정의된 세 가지 환경에 대해 지정된 MSBP 이벤트 로그 설정을 자세히 설명합니다. 이 섹션에 나오는 규정된 설정은 이 가이드의 다운로드 가능 버전에 포함되어 있는 Microsoft Excel 통합 문서 "Windows Server 2003 보안 가이드 설정"에 요약되어 있습니다. 기본 구성 및 각 설정에 대한 자세한 설명은 관련 가이드인 위협 및 대책 - Windows Server 2003 및 Windows XP의 보안 설정을 참조하십시오. 이 가이드는 [http://www.microsoft.com/korea/technet/security/topics/serversecurity/tcg/tcgch01.mspx](http://www.microsoft.com/korea/technet/security/topics/serversecurity/tcg/tcgch00.mspx) 사이트에서 다운로드할 수 있습니다.
...
자세한 내용은 Microsoft 기술 자료 문서 "[Windows XP에서 자동 로그온을 설정하는 방법](http://support.microsoft.com/default.aspx?kbid=315231)"(http://support.microsoft.com/default.aspx?kbid=315231)을 참조하십시오.
...
이 가이드에 정의된 기준 서버를 강화하는 데 사용되는 대부분의 보안 대책은 그룹 정책을 통해 적용되지만 일부 추가 설정은 그룹 정책을 사용하여 적용하기 어렵거나 불가능합니다. 이 섹션에서 설명하는 각 보안 대책에 대한 자세한 내용은 관련 가이드인 [위협 및 대책 - Windows Server 2003 및 Windows XP용 보안 설정](http://www.microsoft.com/korea/technet/security/topics/serversecurity/tcg/tcgch00.mspx)을 참조하십시오. 이 가이드는 <http://www.microsoft.com/korea/technet/security/topics/serversecurity/tcg/tcgch00.mspx> 사이트에서 다운로드할 수 있습니다.
...
SCW 정책을 테스트하는 방법에 대한 자세한 내용은 [보안 구성 마법사에 대한 배포 가이드 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/scwdeploying/5254f8cd-143e-4559-a299-9c723b366946.mspx) 및 [보안 구성 마법사 설명서 (영문)](http://go.microsoft.com/fwlink/?linkid=43450)(http://go.microsoft.com/fwlink/?linkid=43450, 검토 및 테스트했습니다. 이 장에 나오는 각 설정에 대한 기본 )를 참조하십시오
...
-   Windows Server 2003 보안 설정에 대한 자세한 내용은 [보안 설정 설명 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/dd980ca3-f686-4ffc-a617-50c6240f5582.mspx) 페이지(http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/ServerHelp/dd980ca3-f686-4ffc-a617-50c6240f5582.mspx)를 참조하십시오.
  
-   Windows Server 2003의 보안에 대한 자세한 내용은 [Windows Server 2003 보안 센터](http://www.microsoft.com/korea/technet/security/prodtech/windowsserver2003.mspx)(http://www.microsoft.com/korea/technet/security/prodtech/windowsserver2003.mspx)를 참조하십시오.
  
-   Windows Server 2003의 감사 정책에 대한 자세한 내용은 [감사 정책 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/6847e72b-9c47-42ab-b3e3-691addac9f33.mspx) 페이지(http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/ServerHelp/6847e72b-9c47-42ab-b3e3-691addac9f33.mspx)를 참조하십시오.
  
-   MOM(Microsoft Operations Manger)에 대한 자세한 내용은 [Microsoft Operations Manager](http://www.microsoft.com/korea/mom/default.mspx) 페이지(http://www.microsoft.com/korea/mom/default.mspx)를 참조하십시오.
  
-   Windows Server 2003의 사용자 권한에 대한 자세한 내용은 [사용자 권한 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/589980fb-1a83-490e-a745-357750ced3d9.mspx) 페이지(http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/ServerHelp/589980fb-1a83-490e-a745-357750ced3d9.mspx)를 참조하십시오.
  
-   Windows Server 2003의 기본 보안 설정에 대한 자세한 내용은 [기본 보안 설정의 차이점 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/1494bf2c-b596-4785-93bb-bc86f8e548d5.mspx) 페이지(http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/ServerHelp/1494bf2c-b596-4785-93bb-bc86f8e548d5.mspx)를 참조하십시오.
  
-   Windows 2000 터미널 서비스의 보안 유지 방법에 대한 자세한 내용은 "[Windows 2000 터미널 서비스 보안 설정 (영문)](http://www.microsoft.com/technet/prodtechnol/win2kts/maintain/optimize/secw2kts.mspx)"(http://www.microsoft.com/technet/prodtechnol/win2kts/maintain/optimize/secw2kts.mspx)을 참조하십시오.
  
-   Windows Server 2003 TCP/IP 스택의 보안 유지 방법에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[HOWTO: Windows 2003에서 서비스 거부 공격에 대비한 TCP/IP 스택 강화](http://support.microsoft.com/?kbid=324270)"(http://support.microsoft.com/?kbid=324270)를 참조하십시오.
  
-   Windows Sockets 응용 프로그램의 설정을 강화하는 방법에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[악의적인 SYN 공격으로 인해 인터넷 서버를 사용할 수 없음](http://support.microsoft.com/?kbid=142641)"(http://support.microsoft.com/?kbid=142641)을 참조하십시오.
  
-   .adm 파일의 위치에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[Windows에서 ADM(관리 템플릿) 파일의 위치](http://support.microsoft.com/?kbid=228460)"(http://support.microsoft.com/?kbid=228460)를 참조하십시오.
  
-   보안 구성 편집기 사용자 인터페이스를 사용자 지정하는 방법에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[사용자 지정 레지스트리 설정을 보안 구성 편집기에 추가하는 방법](http://support.microsoft.com/?kbid=214752)"(http://support.microsoft.com/?kbid=214752)을 참조하십시오.
  
-   Windows에서 사용자 지정 관리 템플릿 파일을 만드는 방법에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[Windows 2000에서 사용자 지정 관리 템플릿을 만드는 방법](http://support.microsoft.com/?kbid=323639)"(http://support.microsoft.com/?kbid=323639)을 참조하십시오. 또한 백서 "[레지스트리 기반 그룹 정책 구현 (영문)](http://www.microsoft.com/windows2000/techinfo/howitworks/management/rbppaper.asp)"(http://www.microsoft.com/WINDOWS2000/techinfo/howitworks/management/rbppaper.asp)도 참조하십시오.
  
-   Windows 2000과 Windows NT 4.0 시스템이 혼합된 네트워크에서 보다 안전한 LAN Manager 인증 수준 설정을 사용하는 방법에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[NTLM 수준이 2인 Windows 2000이 NTLM 수준이 2보다 높은 Windows NT 4.0 도메인에서 인증을 받을 경우 발생하는 문제](http://support.microsoft.com/?kbid=305379)"(http://support.microsoft.com/?kbid=305379)를 참조하십시오.
  
-   NTLMv2 인증에 대한 자세한 내용은 Microsoft 기술 자료 문서 "[NTLM 2 인증을 사용 가능하게 설정하는 방법](http://support.microsoft.com/?kbid=239869)"(http://support.microsoft.com/?kbid=239869)을 참조하십시오.
  
-   Windows Server 2003 서비스의 기본 설정에 대한 자세한 내용은 [Default settings for services (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/2b1dc6cf-2e34-4681-9aa6-8d0ffba2d3e3.mspx) 페이지(http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/ServerHelp/2b1dc6cf-2e34-4681-9aa6-8d0ffba2d3e3.mspx)를 참조하십시오.
  
-   스마트 카드 배포에 대한 자세한 내용은 "[현명해지기! 스마트 카드로 네트워크의 지능 높이기 (영문)](http://www.microsoft.com/technet/technetmag/issues/2005/01/smartcards/)"(http://www.microsoft.com/technet/technetmag/issues/2005/01/SmartCards/default.aspx)를 참조하십시오.
  
-   "Restrict Anonymous" 레지스트리 값 및 Windows 2000에 대한 자세한 내용은 Microsoft 기술 자료 문서 "["RestrictAnonymous" 레지스트리 값을 사용할 경우 Windows 2000 도메인에 대한 신뢰가 깨질 수 있음](http://support.microsoft.com/?kbid=296405)"(http://support.microsoft.com/?kbid=296405)을 참조하십시오.
  
-   오류 보고에 대한 자세한 내용은 [회사 오류 보고 (영문)](http://www.microsoft.com/resources/satech/cer/) 페이지(www.microsoft.com/resources/satech/cer/)를 참조하십시오.
