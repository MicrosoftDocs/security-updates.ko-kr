---
TOCTitle: 'MS16-068'
Title: 'Microsoft 보안 공지 MS16-068 - 긴급'
ms:assetid: 'ms16-068'
ms:contentKeyID: 73142030
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-068(v=Security.10)'
---

MSRC ppDocument 서식 파일

Microsoft 보안 공지 MS16-068 - 긴급
===================================

Microsoft Edge용 누적 보안 업데이트(3163656)
--------------------------------------------
...
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3163656](https://support.microsoft.com/ko-kr/kb/3163656)을 참조하십시오.
...
이 공지(MS16-068)에서 릴리스된 CVE-2016-3201, CVE-2016-3203 및 CVE-2016-3215용 업데이트에서 해결하는 취약성은 Microsoft Edge가 실행되는 시스템에 대한 것입니다. 또한 이러한 CVE가 [MS16-080](https://go.microsoft.com/fwlink/?linkid=798620)의 운영 체제 구성 요소에 대해 해결되었습니다. MS16-068 및 [MS16-080](https://go.microsoft.com/fwlink/?linkid=798620)은 이번 달의 누적 Windows 10 업데이트에서 다룹니다.
...
Edge [CSP(콘텐츠 보안 정책)](https://technet.microsoft.com/ko-kr/library/security/dn848375.aspx)(영문)가 특수 제작된 문서의 유효성을 제대로 검사하지 못하는 경우 Microsoft Edge에 보안 기능 우회가 존재합니다. 이 우회를 악용한 공격자는 사용자가 악성 콘텐츠가 포함된 페이지를 로드하도록 유도할 수 있습니다.

이 우회를 악용하기 위해 공격자는 사용자가 악성 콘텐츠가 포함된 페이지를 로드하거나 악성 웹 사이트를 방문하도록 유도해야 합니다. 또한 공격자는 공격에 노출된 웹 사이트 또는 광고 네트워크에 악성 페이지를 넣을 수 있습니다. 이 업데이트는 Edge CSP가 문서의 유효성을 검사하는 방식을 수정하여 이러한 우회를 해결합니다.
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3198">CVE-2016-3198(영문)</a></td>
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3199">CVE-2016-3199(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">스크립팅 엔진 메모리 손상 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3214">CVE-2016-3214(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Edge 메모리 손상 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3222">CVE-2016-3222(영문)</a></td>
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3201">CVE-2016-3201(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows PDF 정보 유출 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3215">CVE-2016-3215(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
</tbody>
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3203">CVE-2016-3203(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
</tbody>
...
*2016-06-08 09:32-07:00에 페이지가 생성되었습니다.*
