...
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=86c2b78e-53bf-4ddd-88f6-5d12c6d18c90&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=2ac72356-7772-41b6-b4a6-7215c89f7347)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e2f5b9f9-4481-44f9-9aef-1af0afae8319&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=8c9a22a6-bd61-4fd4-9aa4-012d745046da)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ec4f4f72-8467-4964-ad28-ed9ea7562e0b)
...
|-------------------------------------------------------------------------------------------------------------------------------|----------------------|------------------------|------------------------|---------------------|---------------------------------|
| 개체 포장기 대화 상자 스푸핑 취약점 - [CVE-2006-4692 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4692) | 원격 코드 실행       | 보통                   | 보통                   | 낮음                | 낮음                            |
...
**개체 포장기란 무엇입니까?**  
개체 포장기는 파일에 삽입되는 패키지를 만드는 데 사용되는 도구입니다. 개체 포장기에 대한 자세한 내용은 [Microsoft 제품 설명서 (영문)](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true)를 참조하십시오.
...
Internet Explorer 보안 강화 구성에 대한 자세한 내용은 [웹 사이트](https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)에서 Internet Explorer 보안 강화 구성 관리 설명서를 참조하십시오.
...
-   개체 포장기 대화 상자 스푸핑 취약점(CVE-2006-4692)를 보고해 주신 [Secunia Research (영문)](https://www.secunia.com/)의 Andreas Sandblad
