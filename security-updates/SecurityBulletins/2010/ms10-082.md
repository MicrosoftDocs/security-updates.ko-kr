...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2745 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745)를 참조하십시오.
...
-   데스크톱 경험 기능을 설치하지 않으면 지원 대상인 Windows Server 2008 및 Windows Server 2008 R2 에디션은 이 문제점의 영향을 받지 않습니다. 기본적으로 이러한 플랫폼에서는 영향을 받는 Windows Media Player 구성 요소를 로드하지 않습니다. 데스크톱 경험 기능에 대한 자세한 내용은 TechNet 문서, [데스크톱 경험 개요](https://technet.microsoft.com/library/cc772567.aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2378111">Microsoft 기술 자료 문서 2378111</a> 참조</td>
</tr>
<tr class="odd">
...
-   Windows Media Player 메모리 손상 취약점(CVE-2010-2745)을 보고해 주신 [Google Inc.](https://www.google.com/)의 SkyLined
