---
TOCTitle: 'MS13-005'
Title: 'Microsoft 보안 공지 MS13-005 - 중요'
ms:assetid: 'ms13-005'
ms:contentKeyID: 61230555
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-005(v=Security.10)'
---

Microsoft 보안 공지 MS13-005 - 중요
===================================

Windows 커널 모드 드라이버의 취약점으로 인한 권한 상승 문제점 (2778930)
-----------------------------------------------------------------------

게시된 날짜: 2013년 1월 8일 화요일 | 업데이트된 날짜: 2013년 2월 12일 화요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2, Windows 8, Windows Server 2012, Windows RT 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널 모드 드라이버가 창 브로드캐스트 메시지를 처리하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2778930](https://support.microsoft.com/kb/2778930)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8b1aef73-cfb2-4998-bca6-35cccfbb2078)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<td style="border:1px solid black;">
[MS12-078](https://go.microsoft.com/fwlink/?linkid=271624)의 KB2779030은 KB2778930으로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4287381f-6f23-4a36-a7dc-f79c44bac124)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c635ad51-4e15-461c-8927-a86d79f90b45)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=eff3a82e-f3db-4733-95aa-a68621e27068)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=057726d1-cdb4-4488-8cd8-822dabfc62a6)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=057726d1-cdb4-4488-8cd8-822dabfc62a6)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=64249562-1fc3-436d-a9e1-4c9378b632d7)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=64249562-1fc3-436d-a9e1-4c9378b632d7)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=934a2e78-c88b-4d06-9b8f-1d0b612f3fd5)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=934a2e78-c88b-4d06-9b8f-1d0b612f3fd5)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1f5441f1-a66d-42c0-bf0e-2f6867d4d43a)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 8(64비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9d71dc77-9c01-4a1f-b403-8a18ca10979d)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c635ad51-4e15-461c-8927-a86d79f90b45)(Server Core 설치)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=eff3a82e-f3db-4733-95aa-a68621e27068)(Server Core 설치)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=934a2e78-c88b-4d06-9b8f-1d0b612f3fd5)(Server Core 설치)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=934a2e78-c88b-4d06-9b8f-1d0b612f3fd5)(Server Core 설치)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=2ad7872c-a387-41a1-8606-732a6ff0701d)(Server Core 설치)  
(KB2778930)
</td>
<td style="border:1px solid black;">
권한 상승
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2778930](https://support.microsoft.com/kb/2778930)을 참조하십시오.
...
Windows 커널이 창 브로드캐스트 메시지를 부적절하게 처리하는 경우 권한 상승 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0008)을 참조하십시오.

#### Win32k 부적절한 메시지 처리 취약점(CVE-2013-0008)에 대한 완화 요소

이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### Win32k 부적절한 메시지 처리 취약점(CVE-2013-0008)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### Win32k 부적절한 메시지 처리 취약점(CVE-2013-0008)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 권한 상승 취약점입니다.

**취약점의 원인은 무엇입니까?**  
이 취약점은 Windows 커널 모드 드라이버가 창 브로드캐스트 메시지를 부적절하게 처리할 때 발생합니다.
...
이 취약점 악용에 성공한 공격자는 높은 무결성 수준(IS) 프로세스의 컨텍스트에서 임의 코드를 실행할 수 있습니다. 사용자가 관리자 권한의 사용자 권한으로 로그온한 경우 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**Windows 무결성 메커니즘이란 무엇입니까?**  
Windows 무결성 메커니즘은 신뢰성이 낮은 동일한 사용자 계정으로 실행되는 응용 프로그램의 사용 권한에 대한 액세스를 제한하기 위해 무결성 수준(IL)을 사용하는 Windows 보안 아키텍처의 핵심 구성 요소입니다. 무결성 수준은 응용 프로그램에서 생성된 파일 등, 구동 중인 응용 프로그램 프로세스 및 개체에 대한 신뢰도를 나타냅니다. 무결성 메커니즘은 무결성 또는 신뢰도가 낮은 프로세스가 무결성이 높은 개체를 읽거나 수정하지 못하게 하는 사전 정의된 정책을 사용할 수 있는 기능을 파일 시스템과 같은 리소스 관리자에 제공합니다. Windows 보안 모델은 무결성 메커니즘을 통해 액세스 제어 목록(ACL)에서 사용자 또는 그룹 권한을 부여하여 정의할 수 없는 새로운 액세스 제어 제한을 적용할 수 있습니다.

**공격자는 이러한** **취약점을 어떻게 악용합니까?**  
공격자는 이 취약점을 악용하기 위해 사용자가 특수하게 조작된 응용 프로그램을 실행하도록 유도합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Windows 커널 모드 드라이버가 창 브로드캐스트 메시지를 처리하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2778930">Microsoft 기술 자료 문서 2778930</a> 참조</td>
</tr>
<tr class="odd">
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2778930](https://support.microsoft.com/kb/2778930) 참조                                                  |
...
-   V1.1(2013년 1월 9일): 검색 및 배포 요약 표가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.  
-   V1.2(2013년 2월 12일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2778930 링크가 추가되었습니다.
