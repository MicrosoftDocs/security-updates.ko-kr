---
TOCTitle: 'MS11-019'
Title: 'Microsoft 보안 공지 MS11-019 - 긴급'
ms:assetid: 'ms11-019'
ms:contentKeyID: 61230386
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-019(v=Security.10)'
---

Microsoft 보안 공지 MS11-019 - 긴급
===================================

SMB 클라이언트의 취약점으로 인한 원격 코드 실행 문제점(2511455)
---------------------------------------------------------------

게시된 날짜: 2011년 4월 13일 수요일 | 업데이트된 날짜: 2011년 4월 14일 목요일
...
보안 업데이트는 CIFS 브라우저가 특수하게 조작된 브라우저 메시지를 처리하는 방식을 수정하고, SMB 클라이언트가 특수하게 조작된 SMB 응답의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=f5378e7b-4619-4c42-9d9f-87b209c6d878&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c01441da-8933-4f60-923b-d9b00db8ba3d)                                                               | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=d46fe0bf-28c2-4696-87bc-dd3c8287fc28&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca0fb4d3-7651-4760-83fa-b71c86cbe459&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=87eb8b93-9829-45ec-9528-52787732044e)                                                           | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=da8dd55d-6630-484e-836c-9feeab5cc311&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=040f8b46-f458-4a72-a1b0-ad8a65a1194c&displaylang=ko)                 | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8c9390a-5ca1-492a-9e35-a516de48deb5&displaylang=ko)\*     | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b0cfd5e0-6de5-4863-b5e4-b223a0e36d72&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=8eaf51cd-2f6e-4bbc-bc4f-9deed03649ac)          | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715&displaylang=ko)                                                         | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25&displaylang=ko)                                                                   | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25&displaylang=ko)                                                       | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945&displaylang=ko)\*                                                    | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945&displaylang=ko)\*                                        | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                                                 | 원격 코드 실행 | 긴급        | [MS10-020](http://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                                     | 원격 코드 실행 | 긴급        | 없음                                                                |
...
<th style="border:1px solid black;" >브라우저 풀 손상 취약점(CVE-2011-0654)</th>
<th style="border:1px solid black;" >SMB 클라이언트 응답 구문 분석 취약점(CVE-2011-0660)</th>
...
브라우저 풀 손상 취약점(CVE-2011-0654)  
--------------------------------------
  

CIFS(Common Internet File System) 브라우저 프로토콜 구현이 잘못된 형식의 브라우저 메시지를 구문 분석하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0654 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)를 참조하십시오.
  
#### 브라우저 풀 손상 취약점(CVE-2011-0654)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 NetBIOS 데이터그램 서비스 포트(UDP 138)를 인터넷에서 차단해야 합니다.
  
#### 브라우저 풀 손상 취약점(CVE-2011-0654)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **방화벽에서 TCP 포트 138 차단**
  
    이 포트는 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 UDP 포트 138을 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템에 대한 공격을 막을 수 있습니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당 (영문)](http://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
  
    **대안의 영향.** 컴퓨터 브라우저 서비스에 의존하는 응용 프로그램이 작동하지 않게 됩니다. 여기에는 내 네트워크 환경 및 NET VIEW 명령과 같은 기능이 포함됩니다.
  
    **대안 실행 취소 방법.** 방화벽에서 TCP 포트 138의 차단을 해제합니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당 (영문)](http://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
  
#### 브라우저 풀 손상 취약점(CVE-2011-0654)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 CIFS 브라우저 프로토콜 구현이 특수하게 조작된 컴퓨터 브라우저 메시지의 구문을 제대로 분석하지 못해 발생합니다. 이로 인해 메모리 손상 문제가 발생하고 시스템 수준 권한으로 코드 실행이 허용될 수 있습니다.
...
**브라우저 서비스란 무엇입니까?**  
브라우저 서비스는 컴퓨터가 있는 도메인 이름 또는 작업 그룹 이름과 네트워크 세그먼트의 각 컴퓨터에 사용되고 브라우저 서비스를 실행하는 컴퓨터에서 제공하는 프로토콜 목록을 유지 관리합니다. 각 네트워크 세그먼트에서 마스터 브라우저는 브라우저 서비스를 실행하는 세그먼트에 있는 컴퓨터의 그룹에서 선택됩니다. 컴퓨터 브라우저 서비스에 대한 자세한 내용은 [Microsoft 기술 자료 문서 188001](http://support.microsoft.com/kb/188001)을 참고하십시오.
  
**CIFS(Common Internet File System) 브라우저 프로토콜이란 무엇입니까?**    
CIFS 브라우저 프로토콜은 네트워크에서 사용할 수 있는 서비스에 대한 클리어링하우스로 작동하는 서버, 인쇄 또는 파일 공유와 같은 서비스를 네트워크에서 사용할 수 있도록 해 주는 서버 및 특정 서비스의 상세 정보를 요청하는 클라이언트에서 송수신되는 메시지를 정의합니다. CIFS 브라우저 프로토콜의 의미에서 브라우징은 특정 서비스를 제공하는 서버를 검색하는 프로세스입니다. 자세한 내용은 MSDN 문서, [\[MS-BRWS\]: CIFS(Common Internet File System) 브라우저 프로토콜 사양 (영문)](http://msdn.microsoft.com/en-us/library/cc224428(prot.10).aspx)을 참조하십시오.
  
**마스터 브라우저란 무엇입니까?**    
마스터 브라우저는 마스터 브라우저의 네트워크 세그먼트에서 각 서버가 12분마다 데이터그램으로 전송하는 호스트 또는 서버 알림을 수집합니다. 마스터 브라우저는 각 네트워크 세그먼트에 대한 잠재 브라우저가 백업 브라우저가 되도록 지시합니다. 해당 네트워크 세그먼트의 백업 브라우저는 동일 세그먼트에 있는 클라이언트 컴퓨터에 브라우징 목록을 제공합니다. 컴퓨터 브라우저 서비스에 대한 자세한 내용은 [Microsoft 기술 자료 문서 188001](http://support.microsoft.com/kb/188001)을 참고하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이 취약점을 악용하려는 대부분의 시도는 영향을 받는 시스템의 응답 중지 및 재시작을 유발합니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 특수하게 조작한 브라우저 메시지를 만들어 영향을 받는 시스템에 보내는 방법으로 취약점 악용을 시도할 수 있습니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**    
영향을 받는 모든 운영 체제가 위험합니다. 해당 도메인에서 일반적으로 마스터 브라우저인 PDC(Primary Domain Controllers)가 가장 위험합니다. 네트워크의 모든 시스템이 마스터 브라우저가 될 수 있으며 이에 따라 취약해질 수 있습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 CIFS 브라우저가 특수하게 조작된 브라우저 메시지를 처리하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0654 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)가 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
아니요. Microsoft는 이 보안 공지를 처음에 게시했을 때 이 취약점이 고객을 공격하는 데 공개적으로 사용되었다는 정보를 확인하지 못했습니다.
  
SMB 클라이언트 응답 구문 분석 취약점(CVE-2011-0660)  
---------------------------------------------------
  

Microsoft SMB(Server Message Block) 클라이언트가 특수하게 조작된 SMB 응답의 유효성을 검사하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0660 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0660)을 참조하십시오.
  
#### SMB 클라이언트 응답 구문 분석 취약점(CVE-2011-0660)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 아웃바운드 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB 클라이언트 응답 구문 분석 취약점(CVE-2011-0660)에 대한 대안
...
#### SMB 클라이언트 응답 구문 분석 취약점(CVE-2011-0660)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답의 유효성을 제대로 검사하지 못해 발생합니다.
...
이 취약점에 의해 처리된 문제는 SMBv1과 SMBv2 둘 다에 영향을 미칩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 클라이언트가 특수하게 조작된 SMB 응답의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2511455$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2511455">Microsoft 기술 자료 문서 2511455</a> 참조</td>
</tr>
<tr class="even">
...
-   V1.1(2011년 4월 14일): **요약 표**에 취약점에 대한 설명이 추가되었습니다.
