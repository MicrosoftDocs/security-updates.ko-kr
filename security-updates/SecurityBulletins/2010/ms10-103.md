---
TOCTitle: 'MS10-103'
Title: 'Microsoft 보안 공지 MS10-103 - 중요'
ms:assetid: 'ms10-103'
ms:contentKeyID: 61230363
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-103(v=Security.10)'
---


Microsoft 보안 공지 MS10-103 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 Microsoft Publisher 2002, Microsoft Publisher 2003, Microsoft Publisher 2007 및 Microsoft Publisher 2010에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

업데이트는 Microsoft Publisher에서 특수하게 조작된 Publisher 파일을 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2292970](https://support.microsoft.com/kb/2292970)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f540692c-e404-4383-8937-4d6a36475da5&amp;displaylang=ko">Microsoft Publisher 2002 서비스 팩 3</a><br />
(KB2284692)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e600de65-3e9d-4e37-8906-8b7091ff523e&amp;displaylang=ko">Microsoft Publisher 2003 서비스 팩 3</a><br />
(KB2284695)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=79275011-bdc1-446a-8ea6-56fc31bd9c35&amp;displaylang=ko">Microsoft Publisher 2007 서비스 팩 2</a><br />
(KB2284697)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-036">MS10-036</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2010(32비트 에디션)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2&amp;displaylang=ko">Microsoft Publisher 2010(32비트 에디션)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010(64비트 에디션)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966&amp;displaylang=ko">Microsoft Publisher 2010(64비트 에디션)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<th style="border:1px solid black;" >pubconv.dll의 크기 값 힙 손상 취약점(CVE-2010-2569)</th>
<th style="border:1px solid black;" >pubconv.dll의 힙 오버런 취약점(CVE-2010-2570)</th>
<th style="border:1px solid black;" >Pubconv.dll의 배열에 잘못된 인덱스로 인한 메모리 손상 취약점(CVE-2010-2571)</th>
<th style="border:1px solid black;" >Microsoft Publisher 메모리 손상 취약점(CVE-2010-3954)</th>
<th style="border:1px solid black;" >배열 인덱싱 메모리 손상 취약점(CVE-2010-3955)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 2007 서비스 팩 2</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Publisher 2010(32비트 에디션)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 2010(64비트 에디션)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2569 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569)를 참조하십시오.
  
#### pubconv.dll의 크기 값 힙 손상 취약점(CVE-2010-2569)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 메일 메시지를 통한 공격에 성공하려면 메일로 보낸 첨부 파일을 사용자가 열어야 합니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.  
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 Publisher 파일을 열도록 유도해야 합니다.
  
#### pubconv.dll의 크기 값 힙 손상 취약점(CVE-2010-2569)에 대한 대안
...
-   **Publisher 변환기 DLL 사용 안 함**
    ...
    **참고** &lt;office version&gt;에 대해 Microsoft Publisher 2002의 경우 "Office10", Microsoft Publisher 2003의 경우 "Office11", Microsoft Publisher 2007의 경우 "Office12" 등과 같이 시스템의 해당 Microsoft Office 구성 요소의 버전을 입력합니다. 버전을 확인하려면 이 Microsoft Office 구성 요소를 열고 **도움말**을 클릭하십시오.
    ...
    **대안의 영향.** Publisher 변환기 DLL을 사용 안 함으로 설정한 사용자는 Microsoft Publisher 2007 이전 버전에서 만들어진 Publisher 파일을 열 수 없습니다.
...
#### pubconv.dll의 크기 값 힙 손상 취약점(CVE-2010-2569)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Microsoft Publisher에서 특수하게 조작된 Publisher 파일을 구문 분석하는 방식에 취약점이 존재합니다.
  
**pubconv.dll이란 무엇입니까?**    
Publisher 변환기 DLL은 Microsoft Publisher가 Microsoft Publisher 2007 이전 버전에서 만들어진 Publisher 파일을 여는 데 사용됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2570 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570)을 참조하십시오.
  
#### pubconv.dll의 힙 오버런 취약점(CVE-2010-2570)에 대한 완화 요소
...
#### pubconv.dll의 힙 오버런 취약점(CVE-2010-2570)에 대한 대안
...
-   **Publisher 변환기 DLL 사용 안 함**
    ...
    **참고** Microsoft Publisher 2002의 경우 "Office10", Microsoft Publisher 2003의 경우 "Office11", Microsoft Publisher 2007의 경우 "Office12", Microsoft Publisher 2010의 경우 "Office14" 등과 같이 시스템의 해당 Microsoft Office 소프트웨어 버전을 사용하십시오.
...
#### pubconv.dll의 힙 오버런 취약점(CVE-2010-2570)에 대한 FAQ
...
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하려면 사용자가 특수하게 조작된 Publisher 파일을 Microsoft Publisher에서 열어야 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2571 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571)을 참조하십시오.
  
#### Pubconv.dll의 배열에 잘못된 인덱스로 인한 메모리 손상 취약점(CVE-2010-2571)에 대한 완화 요소
...
#### Pubconv.dll의 배열에 잘못된 인덱스로 인한 메모리 손상 취약점(CVE-2010-2571)에 대한 대안
...
-   **Publisher 변환기 DLL 사용 안 함**
    ...
    **참고** Microsoft Publisher 2002의 경우 "Office10", Microsoft Publisher 2003의 경우 "Office11" 등과 같이 시스템의 해당 Microsoft Office 소프트웨어 버전을 사용하십시오.
...
#### Pubconv.dll의 배열에 잘못된 인덱스로 인한 메모리 손상 취약점(CVE-2010-2571)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Microsoft Publisher에서 Publisher 97 형식 파일을 구문 분석하는 방식에 취약점이 존재합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Microsoft Publisher가 Publisher 97 형식 파일을 변환하는 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3954 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954)를 참조하십시오.
  
#### Microsoft Publisher 메모리 손상 취약점(CVE-2010-3954)에 대한 완화 요소
...
#### Microsoft Publisher 메모리 손상 취약점(CVE-2010-3954)에 대한 대안
...
#### Microsoft Publisher 메모리 손상 취약점(CVE-2010-3954)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3955 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955)를 참조하십시오.
  
#### 배열 인덱싱 메모리 손상 취약점(CVE-2010-3955)에 대한 완화 요소
...
#### 배열 인덱싱 메모리 손상 취약점(CVE-2010-3955)에 대한 대안
...
-   **Publisher 변환기 DLL 사용 안 함**
    ...
    **대안 실행 취소 방법:**
    ...
    Windows Vista, Windows Server 2008 및 Windows 7 32비트 에디션의 경우 상승된 권한의 명령 프롬프트에서 다음 명령을 실행합니다.
...
#### 배열 인덱싱 메모리 손상 취약점(CVE-2010-3955)에 대한 FAQ
...
해당 조직에서 서버, 데스크톱, 모바일 시스템에 적용해야 하는 소프트웨어 및 보안 업데이트를 관리합니다. 자세한 내용은 [TechNet Update Management Center](https://go.microsoft.com/fwlink/?linkid=69903)를 참조하십시오. Microsoft TechNet Security 웹 사이트에서 Microsoft 제품의 보안에 관한 추가 정보를 제공합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2284692">Microsoft 기술 자료 문서 2284692</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2284695">Microsoft 기술 자료 문서 2284695</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2284697">Microsoft 기술 자료 문서 2284697</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2409055">Microsoft 기술 자료 문서 2409055</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   pubconv.dll의 크기 값 힙 손상 취약점(CVE-2010-2569)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   pubconv.dll의 힙 오버런 취약점(CVE-2010-2570)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   Pubconv.dll의 배열에 잘못된 인덱스로 인한 메모리 손상 취약점(CVE-2010-2571)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   Microsoft Publisher 메모리 손상 취약점(CVE-2010-3954)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   배열 인덱싱 메모리 손상 취약점(CVE-2010-3955)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar
