...
ms:contentKeyID: 18135182
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc720440(v=WS.10)'
---
...
| ![](images/Cc720440.Important(WS.10).gif)중요                                                                                                                                                                                                                           |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720440.note(WS.10).gif)참고                                                                                                                                       |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
