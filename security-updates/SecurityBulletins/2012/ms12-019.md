...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908)                                                                              | 서비스 거부    | 보통        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c)                                                                  | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3)\*\*                                                   | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b)\*\*                                                 | 서비스 거부    | 보통        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6)                                   | 서비스 거부    | 보통        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0)                               | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37)\*\* | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=dc5c336f-329c-4a56-8b24-555e3c8afd50)   | 서비스 거부    | 보통        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0156(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156)을 참조하십시오.
...
DirectWrite 란 무엇입니까?   
DirectWrite는 Unicode를 완벽히 지원하고 해상도에 독립적인 다중 포맷 텍스트 렌더링 API로 텍스트의 측정, 그리기 및 적중 테스트를 지원합니다. DirectWrite에 대한 자세한 내용은 MSDN 문서, [Introducing DirectWrite](http://msdn.microsoft.com/ko-kr/library/windows/desktop/dd371554(v=vs.85).aspx)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-0156(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2665364">Microsoft 기술 자료 문서 2665364</a> 참조</td>
</tr>
<tr class="odd">
