...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=24789423-72b7-48d1-bdc1-f0e5174d99bb)\* | 서비스 거부    | 중요        | [MS10-102](http://technet.microsoft.com/security/bulletin/ms10-102) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                    | 서비스 거부    | 중요        | [MS10-102](http://technet.microsoft.com/security/bulletin/ms10-102) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1872 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1872)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2525835">Microsoft 기술 자료 문서 2525835</a> 참조</td>
</tr>
<tr class="odd">
...
-   VMBus 지속적 DoS 취약점(CVE-2011-1872)을 보고해 주신 [Core Security Technologies (영문)](http://www.coresecurity.com/)의 Nicolas Economou
