...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 972652](https://support.microsoft.com/kb/972652)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693&displaylang=ko)\*  
(KB973593)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Mac용 Microsoft Office 2004](https://www.microsoft.com/download/details.aspx?familyid=8f115b1c-1e28-4ecf-937c-99c4b60c7c8e)  
(KB976830)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Mac용 Microsoft Office 2008](https://www.microsoft.com/download/details.aspx?familyid=b84fe57d-ddda-451e-9ead-69e10aee7928)  
(KB976828)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Mac용 Open XML File Format Converter](https://www.microsoft.com/download/details.aspx?familyid=4dd4bc05-1217-497e-8f65-4347f2544ed6)  
(KB976831)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
\*Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2를 사용하는 고객은 이 보안 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트 패키지 KB973593과 함께 [Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩 및 Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa)(KB973704)에 대한 보안 업데이트를 설치해야 합니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 972652](https://support.microsoft.com/kb/972652)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 공지에 나열된 영향을 받는 소프트웨어는 테스트를 거쳐 해당 버전이 영향을 받는지 확인되었습니다. 다른 버전은 지원 기간이 끝났습니다. 제품 지원 기간에 대한 자세한 내용은 [Microsoft 지원 기간 정책 웹 사이트](https://go.microsoft.com/fwlink/?linkid=21742)를 참조하십시오.

이전 버전의 소프트웨어를 사용 중인 고객은 이후의 취약점에 노출되지 않도록 지원되는 버전으로 마이그레이션을 우선적으로 고려하십시오. 사용 중인 소프트웨어 버전에 대한 지원 기간을 확인하려면 [지원 기간 제품 선택](https://go.microsoft.com/fwlink/?linkid=169555)을 참조하십시오. 이러한 소프트웨어 버전의 서비스 팩에 대한 정보는 [서비스 팩 지원 기간](https://go.microsoft.com/fwlink/?linkid=89213)을 참조하십시오.

이전 버전의 소프트웨어에 대한 사용자 지정 지원이 필요한 고객은 자신의 Microsoft 계정 관리 팀 담당자나 TAM(기술 계정 관리자) 또는 해당 Microsoft 파트너 담당자에게 사용자 지정 지원 옵션에 대해 문의하십시오. Alliance, Premier 또는 Authorized Contract가 없는 고객은 해당 지역의 Microsoft 판매처에 문의하십시오. 연락처 정보는 [Microsoft 정보 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=33329)를 방문하여 연락처 정보 목록에서 국가를 선택한 다음 **Go**를 클릭하면 나타나는 전화 번호 목록을 참조하십시오. 전화를 할 경우에는 해당 지역의 프리미어 지원 영업 담당자와 상담을 요청하십시오. 자세한 내용은 [Microsoft 지원 기간 정책 FAQ](https://go.microsoft.com/fwlink/?linkid=169557)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [11월 공지 요약](https://technet.microsoft.com/security/bulletin/ms09-nov)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3127 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3128 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3129 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3130 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3131 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3132 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132)를 참조하십시오.
...
#### Excel 인덱스 구문 분석 취약점(CVE-2009-3132)에 대한 대안
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3133 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3134 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134)를 참조하십시오.

#### Excel 필드 삭제 취약점(CVE-2009-3134)에 대한 완화 요소
...
#### Excel 필드 삭제 취약점(CVE-2009-3134)에 대한 대안
...
-   **알 수 없거나 신뢰할 수 없는 출처에서 받은 파일을 열 때 MOICE(Microsoft Office Isolated Conversion Environment)를 사용합니다.**
    ...
    [지금 FileFormatConverters.exe 패키지 다운로드 (영문)](https://www.microsoft.com/download/details.aspx?familyid=941b3470-3ae9-4aee-8f43-c6bb74cd1466&amp;displaylang=en)
...
#### Excel 필드 삭제 취약점(CVE-2009-3134)에 대한 FAQ
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|---------------------|---------------------|----------------------------|
| Microsoft Office Excel 2002 서비스 팩 3                                                                                                                                  | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft Office Excel 2003 서비스 팩 3                                                                                                                                  | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2                                                                                       | 아니요  | 아니요              | 예                  | 예                         |
| Office 2004 for Mac                                                                                                                                                      | 아니요  | 아니요              | 아니요              | 아니요                     |
| Office 2008 for Mac                                                                                                                                                      | 아니요  | 아니요              | 아니요              | 아니요                     |
| Open XML File Format Converter for Mac                                                                                                                                   | 아니요  | 아니요              | 아니요              | 아니요                     |
| Microsoft Office Excel Viewer 2003 서비스 팩 3                                                                                                                           | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;"><strong>OfficeXP-kb973471-fullfile-kor/q:a</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;"><strong>OfficeXP-kb973471-fullfile-kor /r:n</strong></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973471">Microsoft 기술 자료 문서 973471</a> 참조</td>
</tr>
<tr class="even">
...
<strong>Office2003-kb973475-fullfile-kor /q:a</strong><br />
<br />
Excel Viewer 2003:<br />
<strong>Office2003-kb973484-fullfile-kor /q:a</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Excel 2003:<br />
<strong>Office2003-kb973475-fullfile-kor /r:n</strong><br />
<br />
Excel Viewer 2003:<br />
<strong>Office2003-kb973484-fullfile-kor/r:n</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2003:<br />
<a href="https://support.microsoft.com/kb/973475">Microsoft 기술 자료 문서 973475</a> 참조<br />
<br />
Excel Viewer 2003:<br />
<a href="https://support.microsoft.com/kb/973484">Microsoft 기술 자료 문서 973484</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="https://support.microsoft.com/kb/973593">Microsoft 기술 자료 문서 973593</a> 참조<br />
<br />
Excel Viewer:<br />
<a href="https://support.microsoft.com/kb/973707">Microsoft 기술 자료 문서 973707</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="https://support.microsoft.com/kb/973704">Microsoft 기술 자료 문서 973704</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.5.6 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=8f115b1c-1e28-4ecf-937c-99c4b60c7c8e)에서 다운로드하여 설치하십시오.
...
-   바탕 화면에서 Microsoft Office 2004 for Mac 11.5.6 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2004 for Mac 11.5.6 업데이트 볼륨 창에서 Microsoft Office 2004 for Mac 11.5.6 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2004 for Mac 11.5.6 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **11.5.6**이면 업데이트가 설치된 것입니다.
...
Microsoft Office 2008 for Mac 12.2.3 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=b84fe57d-ddda-451e-9ead-69e10aee7928)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Microsoft Office 2008 for Mac 12.2.3 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 과정을 시작하려면 Microsoft Office 2008 for Mac 12.2.3 업데이트 볼륨 창에서 Microsoft Office 2008 for Mac 12.2.3 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2008 for Mac 12.2.3 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **12.2.3**이면 업데이트가 설치된 것입니다.
...
Open XML File Format Converter for Mac 1.1.3 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=4dd4bc05-1217-497e-8f65-4347f2544ed6)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕화면에서 Open XML File Format Converter for Mac 1.1.3 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Open XML File Format Converter for Mac 1.1.3 업데이트 볼륨 창에서 Open XML File Format Converter for Mac 1.1.3 업데이트 응용 프로그램을 두 번 클릭한 다음 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Open XML File Format Converter for Mac 1.1.3 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **1.1.3**이면 업데이트가 설치된 것입니다.
...
-   Excel 캐시 메모리 손상 취약점(CVE-2009-3127)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com)의 Bing Liu  
-   Excel 캐시 메모리 손상 취약점(CVE-2009-3127)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)  
-   Excel SxView 메모리 손상 취약점(CVE-2009-3128)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com)의 Bing Liu  
-   Excel Featheader 레코드 메모리 손상 취약점(CVE-2009-3129)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   Excel 문서 구문 분석 힙 오버플로 취약점(CVE-2009-3130)을 보고해 주신 [VUPEN Security (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 수식 구문 분석 메모리 손상 취약점(CVE-2009-3131)을 보고해 주신 [VUPEN Security (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 인덱스 구문 분석 취약점(CVE-2009-3132)을 보고해 주신 [VUPEN Security (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 문서 구문 분석 메모리 손상 취약점(CVE-2009-3133)을 보고해 주신 [VUPEN Security (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 필드 삭제 취약점(CVE-2009-3134)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com)의 Bing Liu
