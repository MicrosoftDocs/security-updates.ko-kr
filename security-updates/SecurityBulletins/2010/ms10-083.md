---
TOCTitle: 'MS10-083'
Title: 'Microsoft 보안 공지 MS10-083 - 중요'
ms:assetid: 'ms10-083'
ms:contentKeyID: 61230344
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-083(v=Security.10)'
---
...
게시된 날짜: 2010년 10월 13일 수요일 | 업데이트된 날짜: 2010년 12월 15일 수요일
...
보안 업데이트는 Windows 셸 및 WordPad에서 COM 개체의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2405882](https://support.microsoft.com/kb/2405882)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4a422192-d7fa-47e5-9661-2c65eaefaf62&displaylang=ko)<sup>[1]</sup>
(KB979688)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<sup>[1]</sup>동일한 운영 체제에 WordPad용 보안 업데이트 패키지(KB979687)와 Windows 셸용 보안 업데이트 패키지(KB979688)를 모두 사용할 수 있으면 둘 다 설치해야 이 공지에 설명된 취약점을 방지할 수 있습니다.

이 보안 업데이트와 관련된 자주 제기되는 질문 사항
-------------------------------------------------


**이 보안 공지가 2010년 12월 15일에 다시 릴리스된 이유는 무엇입니까?**  
Microsoft는 Windows Vista 서비스 팩 1에서 Windows Search 4.0을 설치한 후 [Microsoft 기술 자료 문서 2405882](https://support.microsoft.com/kb/2405882)에서 제공되는 보안 업데이트를 설치하고 Windows Vista 서비스 팩 2로 마이그레이션한 사용자를 위해 Windows Vista 서비스 팩 2용 추가 업데이트(KB979688)를 제공하기 위해 이 공지를 다시 릴리스했습니다. 이 시나리오에 해당되는 고객은 이 공지에서 설명하는 취약점으로부터 보호하기 위해 [Microsoft 기술 자료 문서 2405882](https://support.microsoft.com/kb/2405882)에서 제공하는 새 업데이트를 설치해야 합니다. 이 시나리오에 해당되는 자동 업데이트를 사용하는 고객은 이 업데이트가 시스템에 제공됩니다. 자세한 내용은 [Microsoft 기술 자료 문서 2405882](https://support.microsoft.com/kb/2405882)를 참조하십시오.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항의 위치에 대해서는 **보안 업데이트 배포** 섹션에서 참조 표를 참조하십시오.

**이 업데이트에 기능에 대한 다른 비보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 보안과 관련이 없는 기능 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 2252664](https://support.microsoft.com/kb/2252664)를 참조하십시오.

이 공지의 **취약점 정보** 항목에 나열된 변경 사항 이외에 한 가지 심층 보안 변경 사항이 포함되어 있습니다. 이 업데이트에는 취약한 버전의 ATL을 사용하여 개발된 구성 요소와 컨트롤의 취약점을 이 공지의 취약점 정보 항목에 나열된 Microsoft Windows 릴리스에서 악용하지 못하게 방지하는 완화 조치가 포함되어 있습니다. 이 업데이트에서 제공하는 새로운 심층 방어 보호는 알려진 모든 공개 및 비공개 ATL 라이브러리의 취약점을 악용하려는 시도를 모니터링하고 방지합니다.

이 완화 조치는 [Microsoft 보안 권고(973882)](https://technet.microsoft.com/security/advisory/973882) 및 [MS09-035](https://technet.microsoft.com/security/bulletin/ms09-035)에 설명되어 있는 ATL 취약점을 해결합니다. 변경 사항은 영향을 받는 모든 플랫폼에 기본적으로 적용되며 Microsoft에서 작성하지 않은 컨트롤을 포함하여 Microsoft Windows에 로드되는 모든 컨트롤에서 ATL 취약점을 차단합니다.
...
Windows 셸 및 WordPad에서 인스턴스화될 COM 개체의 유효성을 검사하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
...
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 메일 메시지를 통한 공격에 성공하려면 메일로 보낸 첨부 파일을 사용자가 열어야 합니다. 사용자가 이전에 "이 파일 형식을 열기 전에 항상 확인" 옵션을 선택 취소한 경우를 제외하고는 파일을 열 것인지 여부를 사용자가 결정할 수 있습니다.

#### COM 유효성 검사 취약점(CVE-2010-1263)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처의 문서를 WordPad를 사용하여 열지 마십시오.
-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 문서를 WordPad를 사용하여 열지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.
...
**취약점의 원인은 무엇입니까?**  
Windows 셸 및 WordPad에서 인스턴스화될 COM 개체의 유효성 검사를 적절하게 수행하지 못합니다.
...
**WordPad란 무엇입니까?**  
WordPad는 Microsoft Windows에 포함된 기본 워드 프로세서입니다. 워드 프로세서는 문서 작성, 편집, 확인 및 인쇄에 사용할 수 있는 컴퓨터 프로그램입니다. WordPad를 사용하면 편지, 독후감 및 기타 간단한 문서를 입력할 수 있습니다. 텍스트 모양을 변경하고 주위 문장과 단락으로 빠르게 이동하며 문서 내에서 그리고 문서 간에 텍스트를 복사하여 붙여넣을 수도 있습니다. WordPad에 대한 자세한 내용은 [WordPad 사용](https://windows.microsoft.com/ko-kr/windows-vista/using-wordpad)을 참조하십시오.
...
WordPad 공격 경로를 악용하려면 사용자가 특수하게 조작된 WordPad 파일을 영향을 받는 Microsoft Windows 버전에서 열어야 합니다.

전자 메일을 통한 공격의 경우 공격자는 특수하게 조작된 WordPad 파일을 사용자에게 보내고 파일을 열도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.

웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 특수하게 조작된 WordPad 파일을 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 눌러 공격자의 웹 사이트를 방문하도록 설득해야 합니다.

검색 기능을 이용하는 Windows 셸 공격 경로를 악용하려면 사용자가 네트워크 또는 WebDAV 공유에 있는 바로 가기 파일을 열거나 선택해야 합니다. 공격자는 강제로 사용자가 특수하게 조작된 WebDAV 또는 네트워크 공유를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자가 제어하는 웹 사이트로 연결되는 바로 가기 링크를 눌러 공유를 방문하도록 설득해야 합니다.

**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
영향을 받는 소프트웨어 표에 나열된 모든 운영 체제가 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Windows 셸 및 WordPad에서 인스턴스화될 COM 개체의 유효성을 검사하는 방식을 수정합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB979687$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/979687">Microsoft 기술 자료 문서 979687</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 32비트 에디션의 WordPad:<br />
Windows6.0-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 32비트 에디션의 Windows 셸:<br />
Windows6.0-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista x64 기반 에디션의 WordPad:<br />
Windows6.0-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista x64 기반 에디션의 Windows 셸:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">WordPad의 경우 <a href="https://support.microsoft.com/kb/979687">Microsoft 기술 자료 문서 979687</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 셸의 경우 <a href="https://support.microsoft.com/kb/979688">Microsoft 기술 자료 문서 979688</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 WordPad:<br />
Windows6.0-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 Windows 셸:<br />
Windows6.0-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 WordPad:<br />
Windows6.0-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 Windows 셸:<br />
Windows6.0-KB979688-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 Itanium 기반 에디션의 WordPad:<br />
Windows6.0-KB979687-ia64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 Itanium 기반 에디션의 Windows 셸:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 32비트 에디션의 WordPad:<br />
Windows6.1-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 32비트 에디션의 Windows 셸:<br />
Windows6.1-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 x64 기반 에디션의 WordPad:<br />
Windows6.1-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 x64 기반 에디션의 Windows 셸:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 x64 기반 에디션의 WordPad:<br />
Windows6.1-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 x64 기반 에디션의 Windows 셸:<br />
Windows6.1-KB979688-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 Itanium 기반 에디션의 WordPad:<br />
Windows6.1-KB979687-ia64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 Itanium 기반 에디션의 Windows 셸:<br />
...
-   COM 유효성 검사 취약점(CVE-2010-1263)을 보고해 주신 [Rapid7](https://www.rapid7.com/)의 HD Moore  
-   이 공지에서 해결된 심층 보안 변경 사항에 대해 협력해 주신 [IBM ISS X-Force (영문)](https://www.iss.net/)의 David Dewey 및 [Accuvant (영문)](https://www.accuvant.com/)(이전 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/))의 Ryan Smith
...
-   V2.0(2010년 12월 15일): Windows Vista 서비스 팩 1에서 Windows Search 4.0을 설치한 후 KB2405882에서 제공되는 보안 업데이트를 설치하고 Windows Vista 서비스 팩 2로 마이그레이션한 사용자를 위한 Windows Vista 서비스 팩 2용 추가 업데이트(KB979688)를 알리기 위해 업데이트 FAQ가 추가되었습니다. 이 시나리오에 해당되는 고객은 이 공지에서 설명하는 취약점으로부터 보호하기 위해 KB2405882에서 제공하는 새 업데이트를 설치해야 합니다.
