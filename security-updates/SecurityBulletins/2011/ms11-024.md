...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2527308](https://support.microsoft.com/kb/2527308)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft는 [CVE-2010-4701 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4701)을 이 업데이트에서 해결하는 취약점으로 추가하기 위해 이 공지를 개정하였습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다. 이 업데이트를 성공적으로 설치한 고객은 따로 조치를 취할 필요가 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3974 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3974)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3974 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3974)가 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**  ?  
아니요. Microsoft는 이 보안 공지를 처음에 게시했을 때 이 취약점이 고객을 공격하는 데 공개적으로 사용되었다는 정보를 확인하지 못했습니다.
  
**이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?**  ?  
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3974 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3974)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-4701 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4701)을 참조하십시오.
...
지원 대상인 Windows Vista Enterprise Edition 버전에서는 Windows 팩스 표지 편집기를 선택적 구성 요소로 사용할 수 있습니다. 지원 대상인 Windows Vista Business Edition 및 Windows Vista Ultimate Edition 버전과 지원 대상인 모든 Windows 7 에디션에서는 Windows 팩스 표지 편집기를 기본적으로 사용할 수 있습니다. 지원 대상인 Windows Server 2008(32비트 및 x64 기반만 해당) 및 Windows Server 2008 R2(x64 기반만 해당) 버전에서는 팩스 서버 역할을 사용하는 경우에만 팩스 표지 편집기를 사용할 수 있습니다. 일반적으로 이러한 운영 체제에서는 사용자가 팩스 표지를 만들거나 편집할 때 Windows 팩스 및 스캔 응용 프로그램 내에서 또는 팩스 서비스 관리자에서 Windows 표지 편집기가 시작됩니다. 팩스 표지 만들기 및 편집에 대한 자세한 내용은 [팩스 표지 만들기 또는 편집](https://windows.microsoft.com/en-us/windows-vista/create-or-edit-a-fax-cover-page) 및 TechNet 문서, [표지 관리](https://technet.microsoft.com/en-us/library/cc772493.aspx)를 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**      
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-4701 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4701)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**      
아니요. Microsoft는 이 보안 공지를 처음에 게시했을 때 이 취약점이 고객을 공격하는 데 공개적으로 사용되었다는 정보를 확인하지 못했습니다.
  
**이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?**      
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-4701 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4701)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2491683">Microsoft 기술 자료 문서 2491683</a> 및 <a href="https://support.microsoft.com/kb/2506212">Microsoft 기술 자료 문서 2506212</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 32비트 에디션의 Windows Server 2008과 지원 대상인 모든 x64 기반 에디션의 Server 2008에 대해서는 <a href="https://support.microsoft.com/kb/2491683">Microsoft 기술 자료 문서 2491683</a> 및 <a href="https://support.microsoft.com/kb/2506212">Microsoft 기술 자료 문서 2506212</a>를 참조하십시오.<br />
<br />
지원 대상인 모든 Itanium 기반 에디션의 Windows Server 2008에 대해서는 <a href="https://support.microsoft.com/kb/2506212">Microsoft 기술 자료 문서 2506212</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 x64 기반 에디션의 Windows Server 2008 R2에 대해서는 <a href="https://support.microsoft.com/kb/2491683">Microsoft 기술 자료 문서 2491683</a> 및 <a href="https://support.microsoft.com/kb/2506212">Microsoft 기술 자료 문서 2506212</a>를 참조하십시오.<br />
<br />
지원 대상인 모든 Itanium 기반 에디션의 Windows Server 2008 R2에 대해서는 <a href="https://support.microsoft.com/kb/2506212">Microsoft 기술 자료 문서 2506212</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
-   팩스 표지 해제 후 사용 취약점(CVE-2010-4701)을 보고해 주신 [Secunia](https://secunia.com/)의 Carsten Eiram
