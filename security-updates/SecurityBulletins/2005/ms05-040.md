---
TOCTitle: 'MS05-040'
Title: 'Microsoft 보안 공지 MS05-040 - 중요'
ms:assetid: 'ms05-040'
ms:contentKeyID: 61229946
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms05-040(v=Security.10)'
---



Microsoft 보안 공지 MS05-040 - 중요
===================================

전화 통신 서비스의 취약점으로 인한 원격 코드 실행 문제점 (893756)
-----------------------------------------------------------------

게시된 날짜: 2005년 8월 9일 화요일 | 업데이트된 날짜: 2005년 8월 17일 수요일
...
-   Microsoft Windows 2000 서비스 팩 4 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c7417ea1-7afc-4a55-95dc-e814975b8ae6&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=b049004b-af28-41d7-8ae6-7a3db15211f1&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=705545d0-b53b-4e17-8b62-a4c652697c61)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=0097fe14-1d6b-4423-a437-dea1ed665a07&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=bc16beae-0bad-490c-a80f-4bf81c360ca0)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=0cef9cc2-a7bd-42e0-81b1-edc303da8a40)
...
이 업데이트는 새로 발견되어 비공개적으로 보고된 취약점을 해결합니다. TAPI(Telephony Application Programming Interface) 서비스에 원격 코드 실행을 허용할 수 있는 취약점이 존재합니다. 취약점은 이 공지의 "취약점 세부 사항" 항목에 설명되어 있습니다.
...
|-------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------|--------------|------------|---------------------|
| 전화 통신 서비스 취약점 - [CAN-2005-0058 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0058) | 원격 코드 실행       | 긴급하지 않음         | 중요         | 중요       | 중요                |
...
예. SMS를 사용하면 이 보안 업데이트를 검색하고 배포하는 데 도움이 됩니다. SMS에 대한 자세한 내용은 [SMS 웹 사이트](https://www.microsoft.com/korea/smserver/default.asp)를 방문하십시오. SMS에서 Security Update Inventory Tool을 사용하여 [Windows Update](https://update.microsoft.com/microsoftupdate/)에서 제공하고, [Software Update Services](https://www.microsoft.com/korea/windowsserversystem/sus/default.asp)에서 지원하는 보안 업데이트와 MBSA 1.2.1에서 지원하는 다른 보안 업데이트를 검색할 수 있습니다. Security Update Inventory Tool에 대한 자세한 내용은 다음 [Microsoft 웹 사이트 (영문)](https://www.microsoft.com/smserver/downloads/2003/featurepacks/suspack)를 참조하십시오. Security Update Inventory Tool의 제한에 대한 자세한 내용은 [Microsoft 기술 자료 문서 306460](https://support.microsoft.com/kb/306460)을 참조하십시오. SMS에서 Microsoft Updates용 SMS 2003 Inventory Tool을 사용하여 [Microsoft Update](https://update.microsoft.com/microsoftupdate)에서 제공하고, [Windows Server Update Services (영문)](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. Microsoft Updates용 SMS 2003 Inventory Tool에 대한 자세한 내용은 다음 [Microsoft 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=50757)를 참조하십시오.

취약점 세부 정보
----------------

 
#### 전화 통신 서비스 취약점 - CAN-2005-0058

TAPI(Telephony Application Programming Interface)에 원격 코드 실행 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.

#### 전화 통신 서비스 취약점 - CAN-2005-0058에 대한 완화 요소:

-   원격 코드 실행은 전화 통신 서버 기능이 활성화된 Windows 2000 Server 및 Windows Server 2003 기반 시스템에서만 가능합니다. 이 기능에 대한 자세한 내용은 [여기 (영문)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/a3574189-fd2f-4e12-90d9-c3ecb65a8226.mspx)를 참조하십시오.
-   Windows Server 2003에서 전화 통신 서비스는 전화 통신 서버로 활성화되어 있을 때도 인증된 사용자 계정으로 제한됩니다. Windows Server 2003에서 익명 공격은 불가능합니다.
-   수동으로 전화 통신 서버 기능을 설정하지 않은 Windows 2000 Server 및 Windows Server 2003 기반 시스템에서 이것은 로컬 권한 상승 취약점입니다. 원격이나 익명 사용자로 이 취약점을 공격할 수 없습니다.
-   Windows 2000 Professional과 Windows XP에서 이것은 로컬 권한 상승 취약점입니다. 원격이나 익명 사용자로 이 취약점을 공격할 수 없습니다.
-   기본적으로 전화 통신 서비스는 Windows XP 및 Windows Server 2003에서 실행되지 않습니다. 그러나 필요한 경우 TAPI 클라이언트가 사용자 개입 없이 전화 통신 서비스를 시작합니다. 관리자가 전화 통신 서비스를 **사용 안함**으로 설정하지 않은 경우 권한이 없는 사용자 계정은 이 서비스를 시작할 수 있습니다. 전화 통신 서비스를 비활성화한 시스템은 이 문제에 취약하지 않게 됩니다.
-   최상의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템에는 최소한의 포트만 열어 두는 것이 좋습니다.

#### 전화 통신 서비스 취약점 - CAN-2005-0058에 대한 대안:

Microsoft는 다음 대안을 테스트했습니다. 이러한 대안은 취약점 자체를 해결하는 것은 아니지만 알려진 공격을 차단하는 데 도움이 됩니다. 대안으로 인해 기능이 저하되는 경우에는 아래 항목에 별도로 표시하였습니다.

-   **전화 통신 서비스 사용 안 함**

    전화 통신 서비스를 사용하지 않도록 설정하면 이 취약점을 악용하는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다. 전화 통신 서비스를 사용하지 않도록 설정하려면 다음 단계를 수행하십시오.
    ...
    명령 프롬프트에서 다음 명령을 사용하여 전화 통신 서비스를 중지하고 비활성화할 수도 있습니다.

    `sc stop tapisrv & sc config tapisrv start= disabled`

    **대안의 영향:** 전화 통신 서비스를 비활성화하면 종속 서비스나 운영 체제 기능에 장애가 발생하게 됩니다. 이러한 기능에는 새 연결 마법사, RAS, 모뎀 기반 전화 접속 네트워킹 및 팩스 서비스가 포함되며, 장애가 발생하게 됩니다. 따라서 보안 업데이트를 적용할 수 없는 시스템에만 이 대안을 사용하는 것이 좋습니다.
...
-   **방화벽에서 다음 항목을 차단합니다.**
    ...
    이들 포트는 RPC와 연결을 시작하는 데 사용됩니다. RPC는 Windows 2000 Server 및 Windows Server 2003에서 전화 통신 서비스와 원격으로 통신하는 데 사용할 수 있습니다. 방화벽에서 이 포트들을 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 또한 원격 시스템에서 특수하게 구성된 다른 모든 RPC 포트도 차단해야 합니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 들어오는 방향의 통신을 모두 차단하는 것이 좋습니다. RPC에서 사용하는 포트에 대한 자세한 내용은 [여기](https://technet.microsoft.com/security/bulletin/ms04-045)를 참조하십시오.

-   **네트워크를 통해 취약점을 악용하려는 시도로부터 보호하려면 Windows Server 2003에 포함되어 있는** [**인터넷 연결 방화벽**](https://www.microsoft.com/korea/security/protect/windowsxp/firewall.asp)**과 같은 개인 방화벽을 사용합니다.**
...
#### 전화 통신 서비스 취약점 - CAN-2005-0058에 대한 FAQ:

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  

운영 체제 버전과 구성에 따라 원격 코드 실행 취약점 또는 [로컬 권한 상승 (영문)](https://go.microsoft.com/fwlink/?linkid=21142) 취약점이 될 수 있습니다. 자세한 내용은 FAQ 항목의 "취약점으로 인해 주로 침입 받을 위험이 있는 시스템은 무엇입니까?" 질문 항목을 참조하십시오. 이 취약점을 악용한 공격자는 영향을 받는 시스템에 대해 완벽한 제어 권한을 얻을 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

**취약점의 원인은 무엇입니까?**  
전화 통신 서비스가 데이터와 권한의 유효성을 검사하는 데 사용하는 프로세스가 원인입니다.

**전화 통신 서비스란 무엇입니까?**  
전화 통신 서비스는 TAPI(Telephony Application Programming Interface)를 지원합니다. TAPI는 통신을 운영 체제에 통합합니다. TAPI는 음성, 데이터 및 비디오 통신을 제공하기 위해 일반 전화 통신과 IP 전화 통신을 모두 지원합니다. 지원되는 하드웨어는 사운드와 비디오 카드, 모뎀, ISDN 회선, ATM 네트워크 및 카메라 등이 있습니다. 이 하드웨어를 사용하여 로컬 컴퓨터 간 직접 연결, 전화선, LAN, WAN 및 인터넷을 통해 통신할 수 있습니다.
전화를 걸고 받는 것 이외에 프로그램은 TAPI를 사용하여 호출자 ID, 호출 라우팅, 음성 메일 및 비디오 회의 같은 향상된 전화 통신 기능을 제공할 수 있습니다. 통신 프로그램은 호출자를 식별하고 호출자 정보를 다시 호출하고 표시하며 고객 정보를 기반으로 통화 우선 순위를 정하거나 경로를 지정할 수 있습니다. TAPI에 대한 자세한 내용은 [여기 (영문)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/7d644322-d216-484c-ab74-028ae65f2116.mspx)를 참조하십시오.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.

**누가 취약점을 악용할 수 있습니까?**  
Windows 2000 Server에서 특수하게 조작한 메시지를 영향을 받는 시스템에 전달할 수 있는 모든 익명의 사용자가 이 취약점을 악용할 수 있습니다.
Windows Server 2003에서는 전화 통신 서비스가 인증된 사용자 계정으로 제한됩니다.
Windows 2000 Professional 및 Windows XP에서는 이것이 로컬 권한 상승 취약점입니다. 취약점을 악용려면 공격자가 로컬로 시스템에 로그온하고 Windows 2000 Professional 및 Windows XP에서 프로그램을 실행할 수 있어야 합니다.

**취약점으로 인해 주로 침입 받을 위험이 있는 시스템은 무엇입니까?**  
전화 통신 서버로 구성된 Windows 2000 Server는 익명의 공격자로부터 주로 공격을 받습니다. 그러나, 관리자는 Windows 2000 Server 컴퓨터를 전화 통신 서버로 구성하는 단계를 수행해야 합니다. 이러한 단계를 보려면 다음 [웹 사이트 (영문)](https://www.microsoft.com/windows2000/en/advanced/help/default.asp?url=/windows2000/en/advanced/help/tapi_server_enable_disable.htm)를 방문하십시오.
전화 통신 서버로 구성된 Windows Server 2003 시스템은 인증된 공격자로부터 공격을 받습니다. 그러나, 관리자는 Windows Server 2003 컴퓨터를 전화 통신 서버로 구성하는 단계를 수행해야 합니다. 이러한 단계를 보려면 다음 [웹 사이트 (영문)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/a3574189-fd2f-4e12-90d9-c3ecb65a8226.mspx)를 방문하십시오.
전화 통신 서버로 구성되지 않은 시스템, Windows 2000 Professional 및 Windows XP에서 이것은 로컬 권한 상승 취약점입니다.
전화 통신 서비스를 비활성화한 시스템은 이 문제점에 취약하지 않습니다.
...
예. 공격자는 인터넷을 통해 이 취약점을 악용할 수 있습니다. 방화벽 구성 모범 사례와 표준 기본 방화벽 구성을 이용하면 인터넷을 이용한 공격으로부터 네트워크를 보호할 수 있습니다. Microsoft는 PC 보호 방법에 대한 정보를 제공합니다. 최종 사용자는 [PC 보호 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=21169)를, IT 전문가는 [Security Guidance Center 웹 사이트](https://www.microsoft.com/korea/security/guidance/default.mspx)를 각각 참조하십시오.

**업데이트는 어떤 기능을 합니까?**  
이 업데이트는 전화 통신 서비스가 메시지를 할당된 버퍼로 전달하기 전에 메시지 길이에 대한 유효성을 검사하는 방식을 수정함으로써 취약점을 제거합니다.
...
**Windowsserver2003-kb893756-x86-kor /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 모든 실패 메시지에 대한 KB893756.log 파일을 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows Server 2003 명령 프롬프트에서 다음 명령을 사용하십시오.

**Windowsserver2003-kb893756-x86-kor /norestart**
...
또한 시스템 관리자는 Spuninst.exe 유틸리티를 사용하여 이 보안 업데이트를 제거할 수 있습니다. Spuninst.exe 유틸리티는 %Windir%\\$NTUninstallKB893756$\\Spuninst 폴더에 있습니다.
...
|--------------|---------------|------------|------------|---------|--------|
| Remotesp.tsp | 5.2.3790.366  | 2005-07-09 | 오전 4:23  | 74,752  | RTMGDR |
| Tapisrv.dll  | 5.2.3790.366  | 2005-07-09 | 오전 4:23  | 245,248 | RTMGDR |
| Remotesp.tsp | 5.2.3790.366  | 2005-07-09 | 오전 4:18  | 74,752  | RTMQFE |
| Tapisrv.dll  | 5.2.3790.366  | 2005-07-09 | 오전 4:18  | 245,248 | RTMQFE |
| Tapisrv.dll  | 5.2.3790.2483 | 2005-07-09 | 오전 4:21  | 255,488 | SP1GDR |
| Tapisrv.dll  | 5.2.3790.2483 | 2005-07-09 | 오전 4:25  | 255,488 | SP1QFE |
| Arpidfix.exe | 5.2.3790.2483 | 2005-07-08 | 오후 12:17 | 32,256  |        |
...
|---------------|---------------|----------------|-------|---------|-------|-------------|
| Remotesp.tsp  | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 195,584 |       | RTMGDR      |
| Tapisrv.dll   | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 664,064 | IA-64 | RTMGDR      |
| Wremotesp.tsp | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 74,752  |       | RTMGDR\\WOW |
| Wtapisrv.dll  | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 247,296 | x86   | RTMGDR\\WOW |
| Remotesp.tsp  | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 195,584 |       | RTMQFE      |
| Tapisrv.dll   | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 664,064 | IA-64 | RTMQFE      |
| Wremotesp.tsp | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 74,752  |       | RTMQFE\\WOW |
| Wtapisrv.dll  | 5.2.3790.366  | 2005년 7월 8일 | 23:37 | 247,296 | x86   | RTMQFE\\WOW |
| Tapisrv.dll   | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 697,856 | IA-64 | SP1GDR      |
| Wtapisrv.dll  | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 257,536 | x86   | SP1GDR\\WOW |
| Tapisrv.dll   | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 697,856 | IA-64 | SP1QFE      |
| Wtapisrv.dll  | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 257,536 | x86   | SP1QFE\\WOW |
| Arpidfix.exe  | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 74,752  | IA-64 |             |
...
| 파일 이름    | 버전          | 날짜           | 시간  | 크기    | CPU | 폴더        |
|--------------|---------------|----------------|-------|---------|-----|-------------|
| Tapisrv.dll  | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 407,552 | x64 | SP1GDR      |
| Wtapisrv.dll | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 257,536 | x86 | SP1GDR\\WOW |
| Tapisrv.dll  | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 407,552 | x64 | SP1QFE      |
| Wtapisrv.dll | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 257,536 | x86 | SP1QFE\\WOW |
| Arpidfix.exe | 5.2.3790.2483 | 2005년 7월 8일 | 23:37 | 43,008  | x64 |             |
...
-   **레지스트리 키 확인**
    ...
    **참고** 이 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자나 OEM이 893756 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
...
**Windowsxp-kb893756-x86-kor /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 모든 실패 메시지에 대한 KB893756.log 파일을 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows XP 명령 프롬프트에서 다음 명령을 사용하십시오.

**Windowsxp-kb893756-x86-kor /norestart**
...
| 파일 이름    | 버전          | 날짜       | 시간       | 크기    | 폴더   |
|--------------|---------------|------------|------------|---------|--------|
| Remotesp.tsp | 5.1.2600.1715 | 2005-07-09 | 오전 1:11  | 72,704  | SP1QFE |
| Tapisrv.dll  | 5.1.2600.1715 | 2005-07-09 | 오전 1:11  | 236,032 | SP1QFE |
| Remotesp.tsp | 5.1.2600.2716 | 2005-07-09 | 오전 1:28  | 76,800  | SP2GDR |
| Tapisrv.dll  | 5.1.2600.2716 | 2005-07-09 | 오전 1:28  | 246,784 | SP2GDR |
| Remotesp.tsp | 5.1.2600.2716 | 2005-07-09 | 오전 1:29  | 76,800  | SP2QFE |
| Tapisrv.dll  | 5.1.2600.2716 | 2005-07-09 | 오전 1:29  | 246,784 | SP2QFE |
| Arpidfix.exe | 5.1.2600.2716 | 2005-07-08 | 오전 11:27 | 30,720  |        |
...
-   **레지스트리 키 확인**
    ...
    **참고** 이러한 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자나 OEM이 893756 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이러한 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
...
| 파일 이름    | 버전          | 날짜       | 시간      | 크기    |
|--------------|---------------|------------|-----------|---------|
| Remotesp.tsp | 5.0.2195.7002 | 2005-07-02 | 오전 4:30 | 68,368  |
| Tapisrv.dll  | 5.0.2195.7057 | 2005-07-02 | 오전 4:30 | 175,888 |
...
-   **레지스트리 키 확인**
    ...
    **참고** 이 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자 또는 OEM이 893756 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
...
-   전화 통신 서비스 취약점(CAN-2005-0058)을 보고해 주신 CERT RENATER의 [Kostya Kortchinsky](https://technet.microsoft.com/ko-KR/mailto:kostya.kortchinsky@renater.fr)에게 감사드립니다.
