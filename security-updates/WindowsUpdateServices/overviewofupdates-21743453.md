...
ms:contentKeyID: 21743453
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Dd939871(v=WS.10)'
---
...
1.  Determine an overall update management plan based on your network topology and bandwidth, company needs, and organizational structure. Considerations might include the following:
    ...
    -   Which database to use for update metadata (for example, Windows® 내부 데이터베이스, SQL Server 2005).
