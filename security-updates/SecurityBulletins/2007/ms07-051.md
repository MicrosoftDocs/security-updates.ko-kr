...
|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=7cd248ed-d154-4dce-89ef-ceefd2700965&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS07-020](https://technet.microsoft.com/security/bulletin/ms07-020) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3040 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)을 참조하십시오.
...
Microsoft Windows 운영 체제의 Microsoft Agent는 대화형 애니메이션 캐릭터를 사용하여 사용자가 컴퓨터를 보다 쉽게 사용하고 익힐 수 있는 방법을 제공하는 구성 요소입니다. 자세한 내용은 [Microsoft Agent 웹 사이트 (영문)](https://www.microsoft.com/msagent/)를 참조하십시오.
...
-   Agent 원격 코드 실행 취약점([CVE-2007-3040 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040))을 보고해 주신 [Assurent Secure Technologies (영문)](https://www.assurent.com/)의 Vulnerability Research 팀
-   Agent 원격 코드 실행 취약점([CVE-2007-3040 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040))을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li
-   Agent 원격 코드 실행 취약점([CVE-2007-3040 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040))을 보고해 주신 VeriSign [iDefense VCP (영문)](https://labs.idefense.com/)와 협력해 주신 익명 연구원
