...
-   **옵션 1: NuGet을 사용하여 Visual Studio 프로젝트 패키지 업데이트, 응용 프로그램 다시 컴파일 및 배포**
    ...
    NuGet 대화 상자를 사용하여 NuGet 패키지를 관리하는 것에 대한 자세한 내용은 [대화 상자를 사용하여 NuGet 패키지 관리(영문)](https://docs.nuget.org/docs/start-here/managing-nuget-packages-using-the-dialog)를 참조하십시오.
...
-   **옵션 2: 패키지 관리자 콘솔 UI를 사용하여 Visual Studio 프로젝트 패키지 업데이트, 응용 프로그램 다시 컴파일 및 배포**
    ...
    패키지 관리자 콘솔 사용에 대한 자세한 내용은 [패키지 관리자 콘솔(영문)](https://docs.nuget.org/docs/start-here/using-the-package-manager-console)을 참조하십시오.
