...
<td style="border:1px solid black;">
[MS11-099](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-099)
</td>
</tr>
...
예. Windows 개발자 미리 보기 릴리즈에 KB2647516 업데이트가 사용될 수 있습니다. Windows 개발자 미리 보기를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. 이 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 구할 수 있습니다.
...
이전 버전의 소프트웨어에 대한 사용자 지정 지원이 필요한 고객은 자신의 Microsoft 계정 관리 팀 담당자나 TAM(기술 계정 관리자) 또는 해당 Microsoft 파트너 담당자에게 사용자 지정 지원 옵션에 대해 문의하십시오. Alliance, Premier 또는 Authorized Contract가 없는 고객은 해당 지역의 Microsoft 판매처에 문의하십시오. 연락처 정보는 [Microsoft 정보](https://technet.microsoft.com/security/advisory/) 웹 사이트를 방문하여 Contact Information 목록에서 국가를 선택한 다음 Go를 클릭하면 나타나는 전화 번호 목록을 참조하십시오. 전화를 할 경우에는 해당 지역의 프리미어 지원 영업 담당자와 상담을 요청하십시오. 자세한 내용은 [Microsoft 지원 기간 정책 FAQ](https://support.microsoft.com/kb/887012)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0010(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0010)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0011(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0011)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0012(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0012)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0155(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0155)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2647516">Microsoft 기술 자료 문서 2647516</a> 참조</td>
</tr>
<tr class="even">
...
-   복사 및 붙여넣기 정보 유출 취약점(CVE-2012-0010)을 보고해 주신 [Jan Schejbal(영문)](https://janschejbal.wordpress.com/)  
-   HTML 레이아웃 원격 코드 실행 취약점(CVE-2012-0011)을 [TippingPoint](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [Harmony Security(영문)](https://www.harmonysecurity.com/)의 Stephen Fewer  
-   Null Byte 정보 유출 취약점(CVE-2012-0012)을 보고해 주신 [HP Cloud Services(영문)](https://www.hpcloud.com/) ()의 Jason Hullinger  
-   VML 원격 코드 실행 취약점(CVE-2012-0155)을 [TippingPoint](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [Harmony Security(영문)](https://www.harmonysecurity.com/)의 Stephen Fewer
