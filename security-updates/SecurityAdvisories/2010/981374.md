---
TOCTitle: 981374
Title: Microsoft 보안 권고 981374
ms:assetid: 981374
ms:contentKeyID: 61229872
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/981374(v=Security.10)'
---
...
게시된 날짜: 2010년 3월 10일 수요일 | 업데이트된 날짜: 2010년 3월 31일 수요일
...
Microsoft는 공개적으로 보고된 이 취약점에 대해 조사를 완료했습니다. 이 문제점을 해결하기 위해 [MS10-018](https://go.microsoft.com/fwlink/?linkid=182969)이 게시되었습니다. 사용 가능한 보안 업데이트의 다운로드 링크를 포함하여, 이 문제점에 대한 자세한 내용은 [MS10-018](https://go.microsoft.com/fwlink/?linkid=182969)을 검토하십시오. 해결된 취약점은 초기화되지 않은 메모리 손상 취약점([CVE-2010-0806](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806))입니다.
