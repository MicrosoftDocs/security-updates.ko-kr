...
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=43779b6d-d8d5-40b0-a09e-d0009ec0cbcd&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=870a136b-81f9-4d4c-9174-28092cc7fc10&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=2fd74351-304a-4b27-b44a-c08ff58c9aa6&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a92130ec-0795-4f98-9219-c50571e33d35&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows 8(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3a86ba25-1f1f-498f-a95c-39819157f5db&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8.1(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a4809d9e-bd56-4b68-8af9-3f3a0a0ea4e0&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=99460009-b897-4e62-8e36-8d5453341e78&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=957e57ce-8184-450e-9539-d605b3e3ef98&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=809408c2-b329-4554-bf2b-c9a8901791ac&displaylang=ko)  
(2912390)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-0263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0263)(영문)을 참조하십시오.
...
Direct2D이란 무엇입니까?  
Direct2D는 하드웨어 가속의 즉시 모드 2D 그래픽 API로써 2D 기하학, 비트맵, 텍스트에 대한 고성능, 고품질 렌더링을 제공합니다. Direct2D API는 GDI, GDI+ 또는 Direct3D를 사용하는 기존 코드와 호환하도록 설계되었습니다 Direct2D에 대한 자세한 내용은 MSDN 문서, [Direct2D](https://msdn.microsoft.com/library/windows/desktop/dd370990)(영문)를 참조하십시오.
