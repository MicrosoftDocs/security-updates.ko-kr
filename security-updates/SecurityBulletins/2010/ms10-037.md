---
TOCTitle: 'MS10-037'
Title: 'Microsoft 보안 공지 MS10-037 - 중요'
ms:assetid: 'ms10-037'
ms:contentKeyID: 61230298
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-037(v=Security.10)'
---



Microsoft 보안 공지 MS10-037 - 중요
===================================

OpenType CFF(Compact Font Format) 드라이버의 취약점으로 인한 권한 상승 문제점 (980218)
--------------------------------------------------------------------------------------
...
보안 업데이트는 OpenType CFF(Compact Font Format) 드라이버가 데이터의 유효성을 올바르게 검사하도록 하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=5d645891-31e9-42c4-b12b-eb351473fd0c&displaylang=ko)                                                             | 권한 상승      | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=b42a17c5-997e-4504-ba5b-bfa62166b460&displaylang=ko)                                               | 권한 상승      | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=dc835b94-3368-4c1c-8f29-40517c73540e)                                                               | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ca49b5b5-db8e-4ebc-9a3c-b1ace09ac3c0&displaylang=ko)                                                                | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b0794e7e-c925-4672-b7a5-4bb3f847f045&displaylang=ko)                                                    | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=6e76ebea-bde1-4352-a283-dd71c2cc51a1)                                                                | 권한 상승      | 중요        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=363b503a-2e1e-4284-a029-9695d2acfcb6&displaylang=ko)                                         | 권한 상승      | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3f512b86-3a99-47f7-a90e-1ae9b291385c&displaylang=ko)                 | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e78ad607-d209-48c4-b0f3-ed4c70993174&displaylang=ko)\*     | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=85f6fc5d-efd1-4351-b4c0-b9b7080e6173&displaylang=ko)\* | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c6f1aae5-e8fd-4121-89b2-b97c571e8223)          | 권한 상승      | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=969af8d6-f6da-4dd1-a7d7-2de54a5a8978&displaylang=ko)                                                                     | 권한 상승      | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b069e5b2-aa2d-452e-b687-8734b5ba0051&displaylang=ko)                                                                   | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=45242c7c-3752-44bf-a766-024ad7d28f53&displaylang=ko)\*                                                    | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0a271fb5-da5b-4a17-9593-e56b9a843b8f)                                                                 | 권한 상승      | 중요        | 없음                      |
...
<th style="border:1px solid black;" >OpenType CFF 글꼴 드라이버 메모리 손상 취약점(CVE-2010-0819)</th>
...
사용자 모드에서 커널 모드로 전달된 특정 데이터의 부적절한 유효성 검사로 인해 Windows OpenType CFF(Compact Font Format) 드라이버에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0819 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819)를 참조하십시오.
  
#### OpenType CFF 글꼴 드라이버 메모리 손상 취약점(CVE-2010-0819)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### OpenType CFF 글꼴 드라이버 메모리 손상 취약점(CVE-2010-0819)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### OpenType CFF 글꼴 드라이버 메모리 손상 취약점(CVE-2010-0819)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
OpenType CFF(Compact Font Format) 드라이버가 사용자 모드에서 커널 모드로 전달된 데이터의 유효성 검사를 제대로 수행하지 않아 취약점이 발생합니다.
  
**OpenType CFF(Compact Font Format) 글꼴이란 무엇입니까?**    
OpenType CFF 글꼴은 PostScript Type 1 윤곽선이 포함된 OpenType 글꼴입니다. OpenType 글꼴에는 PostScript Type 1 또는 TrueType 윤곽선이 포함될 수 있습니다. 모든 Microsoft Windows 글꼴에는 트루타입 윤곽선이 포함됩니다. Adobe InDesign 및 QuarkXpress와 같은 전자 출판 응용 프로그램은 가장 많은 OpenType 기능을 지원합니다. Adobe Photoshop 및 Adobe Illustrator는 많은 기능을 지원합니다. 일반적인 OpenType 기능에 대한 지원은 Microsoft Publisher 및 Microsoft Word에도 추가되고 있습니다. 자세한 내용은 [Microsoft 입력 체계 OpenType FAQ (영문)](https://www.microsoft.com/typography/opentypefaq.mspx)를 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 OpenType CFF(Compact Font Format) 드라이버가 데이터의 유효성을 올바르게 검사하도록 하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">Windows2000-KB980218-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-KB980218-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB980218$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980218">Microsoft 기술 자료 문서 980218</a> 참조</td>
</tr>
<tr class="even">
...
WindowsXP-KB980218-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB980218-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
WindowsServer2003-KB980218-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB980218-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB980218-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB980218-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   OpenType CFF 글꼴 드라이버 메모리 손상 취약점(CVE-2010-0819)을 [Secunia (영문)](https://secunia.com/)와 협력하여 보고해 주신 Laserforce International의 Chris Carton
