---
TOCTitle: 'MS16-138'
Title: 'Microsoft 보안 공지 MS16-138 - 중요'
ms:assetid: 'ms16-138'
ms:contentKeyID: 74240654
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-138(v=Security.10)'
---



Microsoft 보안 공지 MS16-138 - 중요
===================================

Microsoft 가상 하드 디스크 드라이버용 보안 업데이트(3199647)
------------------------------------------------------------
...
이 보안 업데이트의 심각도는 Windows 8.1, Windows Server 2012, Windows Server 2012 R2, Windows RT 8.1, Windows 10 및 Windows Server 2016에 대해 중요입니다. 자세한 내용은 **영향받는 소프트웨어 및 취약성 심각도** 절을 참조하십시오.

이 보안 업데이트는 커널 API가 이러한 파일에 대한 액세스를 제한하는 방법을 수정하여 취약성을 해결합니다.

 
이 취약성에 대한 자세한 내용은 **취약성 정보** 절을 참조하십시오. 이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3199647](https://support.microsoft.com/ko-kr/kb/3199647)을 참조하십시오.
...
<td style="border:1px solid black;">
[**VHD 드라이버 권한 상승 취약성(CVE-2016-7223)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7223)

</td>
<td style="border:1px solid black;">
[**VHD 드라이버 권한 상승 취약성(CVE-2016-7224)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7224)

</td>
<td style="border:1px solid black;">
[**VHD 드라이버 권한 상승 취약성(CVE-2016-7225)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7225)

</td>
<td style="border:1px solid black;">
[**VHD 드라이버 권한 상승 취약성(CVE-2016-7226)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7226)
...
\*대체된 업데이트 열에는 대체된 업데이트 체인의 최신 업데이트만 표시됩니다. 대체된 업데이트의 전체 목록을 확인하려면 [Microsoft 업데이트 카탈로그](https://catalog.update.microsoft.com/v7/site/home.aspx)로 이동하여 업데이트 KB 번호를 검색한 다음 업데이트 세부 정보를 보십시오. 대체된 업데이트 정보는 **패키지세부 정보** 탭에 나와 있습니다.

취약성 정보
-----------

 
다양한 VHD 드라이버 권한 상승 취약성
------------------------------------

Windows 가상 하드 디스크 드라이버가 특정 파일에 대한 사용자 액세스를 적절하게 처리하지 못하는 경우 다양한 권한 상승 취약성이 존재합니다. 이 취약성을 성공적으로 악용한 공격자는 사용자에게 제공되어서는 안 되는 위치의 파일을 조작할 수 있습니다.
...
<tr class="even">
<td style="border:1px solid black;">VHD 드라이버 권한 상승 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7223">CVE-2016-7223(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">VHD 드라이버 권한 상승 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7224">CVE-2016-7224(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">VHD 드라이버 권한 상승 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7225">CVE-2016-7225(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">VHD 드라이버 권한 상승 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7226">CVE-2016-7226(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
</tbody>
...
*2016년 12월 12일 11:22-08:00에 페이지가 생성되었습니다.*
