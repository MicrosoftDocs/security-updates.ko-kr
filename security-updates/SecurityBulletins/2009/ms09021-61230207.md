...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969462](http://support.microsoft.com/kb/969462)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99&displaylang=ko)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99&displaylang=ko)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2&displaylang=ko)  
(KB969679)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2&displaylang=ko)  
(KB969679)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 1(32비트 에디션)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 2(32비트 에디션)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 1(64비트 에디션)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 2(64비트 에디션)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
\*Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2를 사용하는 고객은 이 보안 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트 패키지 KB969682와 함께 [Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩 및 Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)(KB969679)에 대한 보안 업데이트를 설치해야 합니다.
...
Microsoft Office 2004 for Mac(KB969661), Microsoft Office 2008 for Mac(KB971822) 및 Open XML File Format Converter for Mac (KB971824)에 대한 이 공지(MS09-021)의 보안 업데이트 패키지는 [MS09-017](http://technet.microsoft.com/security/bulletin/ms09-017) 및 [MS09-027](http://technet.microsoft.com/security/bulletin/ms09-027)에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 또는 Open XML File Format Converter for Mac이 설치된 사용자는 이 업데이트 패키지를 한 번만 설치하면 됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0549 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0557 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0558 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0559 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0560 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0561 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1134 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969683">Microsoft 기술 자료 문서 969683</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969680">Microsoft 기술 자료 문서 969680</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2003:<br />
<a href="http://support.microsoft.com/kb/969681">Microsoft 기술 자료 문서 969681</a> 참조<br />
<br />
Excel Viewer 2003:<br />
<a href="http://support.microsoft.com/kb/969685">Microsoft 기술 자료 문서 969685</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="http://support.microsoft.com/kb/969682">Microsoft 기술 자료 문서 969682</a> 참조<br />
<br />
Excel Viewer:<br />
<a href="http://support.microsoft.com/kb/969686">Microsoft 기술 자료 문서 969686</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="http://support.microsoft.com/kb/969679">Microsoft 기술 자료 문서 969679</a> 참조<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969737">Microsoft 기술 자료 문서 969737</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   레코드 포인터 손상 취약점(CVE-2009-0549)을 보고해 주신 Fortinet, [FortiGuard Global Security Research Team (영문)](http://www.fortiguardcenter.com/)의 Bing Liu  
-   개체 레코드 손상 취약점(CVE-2009-0557)을 보고해 주신 Fortinet, [FortiGuard Global Security Research Team (영문)](http://www.fortiguardcenter.com/)의 Bing Liu  
-   배열 인덱싱 메모리 손상 취약점(CVE-2009-0558)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten H. Eiram  
-   문자열 복사 Stack-Based 오버런 취약점(CVE-2009-0559)을 보고해 주신 [TELUS Security Labs Vulnerability Research Team (영문)](http://telussecuritylabs.com/)  
-   필드 삭제 메모리 손상 취약점(CVE-2009-0560)을 보고해 주신 Fortinet, [FortiGuard Global Security Research Team (영문)](http://www.fortiguardcenter.com/)의 Bing Liu  
-   레코드 정수 오버플로 취약점(CVE-2009-0561)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson과 Joshua Drake  
-   레코드 정수 오버플로 취약점(CVE-2009-0561)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten H. Eiram  
-   레코드 포인터 손상 취약점(CVE-2009-1134)을 보고해 주신 [TippingPoint (영문)](http://www.tippingpoint.com/)와 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)
