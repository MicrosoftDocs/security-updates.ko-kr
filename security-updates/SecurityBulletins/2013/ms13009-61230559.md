...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2792100](http://support.microsoft.com/kb/2792100)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS12-077](http://go.microsoft.com/fwlink/?linkid=268393)의 KB2761465 및 [MS13-008](http://go.microsoft.com/fwlink/?linkid=275222)의 KB2799329
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-077](http://go.microsoft.com/fwlink/?linkid=268393)의 KB2761465
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
예. 이 Internet Explorer 누적 보안 업데이트는 [MS13-008](http://go.microsoft.com/fwlink/?linkid=275222)에서 설명한 취약점을 해결합니다. 이 업데이트로 대체된 이전 업데이트에 대한 자세한 내용은 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어 섹션의 대체된 업데이트를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [2월 공지 요약](http://technet.microsoft.com/security/bulletin/ms13-feb)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0015)(영문)를 참조하십시오.
...
| 취약점 제목                                          | CVE 번호                                                                               |
|------------------------------------------------------|----------------------------------------------------------------------------------------|
| Internet Explorer SetCapture 해제 후 사용 취약점     | [CVE-2013-0018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0018)(영문) |
| Internet Explorer COmWindowProxy 해제 후 사용 취약점 | [CVE-2013-0019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0019)(영문) |
| Internet Explorer CMarkup 해제 후 사용 취약점        | [CVE-2013-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0020)(영문) |
| Internet Explorer vtable 해제 후 사용 취약점         | [CVE-2013-0021](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0021)(영문) |
| Internet Explorer LsGetTrailInfo 해제 후 사용 취약점 | [CVE-2013-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0022)(영문) |
| Internet Explorer CDispNode 해제 후 사용 취약점      | [CVE-2013-0023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0023)(영문) |
| Internet Explorer pasteHTML 해제 후 사용 취약점      | [CVE-2013-0024](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0024)(영문) |
| Internet Explorer SLayoutRun 해제 후 사용 취약점     | [CVE-2013-0025](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0025)(영문) |
| Internet Explorer InsertElement 해제 후 사용 취약점  | [CVE-2013-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0026)(영문) |
| Internet Explorer CPasteCommand 해제 후 사용 취약점  | [CVE-2013-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0027)(영문) |
| Internet Explorer CObjectElement 해제 후 사용 취약점 | [CVE-2013-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0028)(영문) |
| Internet Explorer CHTML 해제 후 사용 취약점          | [CVE-2013-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0029)(영문) |
...
-   기본적으로 지원 대상인 모든 Microsoft Outlook, Microsoft Outlook Express 및 Windows Mail 버전은 제한된 사이트 영역에서 HTML 메일 메시지를 엽니다. 스크립트 및 ActiveX 컨트롤을 비활성화하는 제한된 사이트 영역은 공격자가 이 취약점을 악용하여 악성 코드를 실행하는 위험을 줄이는 데 도움이 됩니다. 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 취약점 악용에 취약해질 수 있습니다.
-   기본적으로 Windows Server 2003, Windows Server 2008, Windows Server 2008 R2 및 Windows Server 2012의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/library/dd883248)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 이러한 취약점을 완화합니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 항목을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2792100">Microsoft 기술 자료 문서 2792100</a> 참조</td>
</tr>
<tr class="even">
...
| 파일 정보             | [Microsoft 기술 자료 문서 2792100](http://support.microsoft.com/kb/2792100) 참조                                                                                                                           |
...
-   Internet Explorer SetCapture 해제 후 사용 취약점(CVE-2013-0018)을 [HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 [Omair](http://krash.in/)(영문)  
-   Internet Explorer COmWindowProxy 해제 후 사용 취약점(CVE-2013-0019)을 [](http://www.hpenterprisesecurity.com/products)[HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365),</a> [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 SkyLined  
-   Internet Explorer CMarkup 해제 후 사용 취약점(CVE-2013-0020)을 Exodus Intelligence와 협력하여 보고해 주신 Arthur Gerkis  
-   Internet Explorer CMarkup 해제 후 사용 취약점(CVE-2013-0020)을 [HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 [Harmony Security](http://www.harmonysecurity.com)(영문)의 Stephen Fewer  
-   Internet Explorer vtable 해제 후 사용 취약점(CVE-2013-0021)을 보고해 주신 Tencent PC 관리자  
-   Internet Explorer LsGetTrailInfo 해제 후 사용 취약점(CVE-2013-0022)을 보고해 주신 [Omair](http://krash.in/)(영문)  
-   Internet Explorer CDispNode 해제 후 사용 취약점(CVE-2013-0023)을 [](http://www.hpenterprisesecurity.com/products)[HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365),</a> [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 Arthur Gerkis  
-   Internet Explorer pasteHTML 해제 후 사용 취약점(CVE-2013-0024)을 [](http://www.hpenterprisesecurity.com/products)[HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365),</a> [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 익명 연구자  
-   Internet Explorer SLayoutRun 해제 후 사용 취약점(CVE-2013-0025)을 보고해 주신 [Security-Assessment.com](http://www.security-assessment.com)(영문)의 Scott Bell  
...
-   Internet Explorer CObjectElement 해제 후 사용 취약점(CVE-2013-0028)을 보고해 주신 [Security-Assessment.com](http://www.security-assessment.com)(영문)의 Scott Bell  
-   Internet Explorer CObjectElement 해제 후 사용 취약점(CVE-2013-0028)을 [HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 Yenteasy Security Research의 Jose A Vazquez  
-   Internet Explorer CHTML 해제 후 사용 취약점(CVE-2013-0029)을 [HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 [Harmony Security](http://www.harmonysecurity.com)(영문)의 Stephen Fewer  
-   Internet Explorer CHTML 해제 후 사용 취약점(CVE-2013-0029)을 [HP](http://www8.hp.com/kr/ko/software-solutions/software.html?compuri=1214365)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com)  
-   이 공지에 포함된 심층 보안 변경 사항에 대해 협력해 주신 [NCC Group](http://www.nccgroup.com/)(영문)의 Ollie Whitehouse
