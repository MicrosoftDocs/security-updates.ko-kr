...
|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2                         | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=55141a02-3ad3-4691-98b9-80dd8ecb14c5&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | [MS10-050](http://technet.microsoft.com/security/bulletin/ms10-050) |
| Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2 | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=5b078136-a492-4a2e-939d-82799f774d82&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | [MS10-050](http://technet.microsoft.com/security/bulletin/ms10-050) |
...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>안전하지 않은 라이브러리 로드 취약점(CVE-2010-3967)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
