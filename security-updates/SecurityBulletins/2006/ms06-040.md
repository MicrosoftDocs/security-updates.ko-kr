---
TOCTitle: 'MS06-040'
Title: 'Microsoft 보안 공지 MS06-040 - 긴급'
ms:assetid: 'ms06-040'
ms:contentKeyID: 61230001
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms06-040(v=Security.10)'
---

Microsoft 보안 공지 MS06-040 - 긴급
===================================

서버 서비스의 취약점으로 인한 원격 코드 실행 문제점(921883)
-----------------------------------------------------------

게시된 날짜: 2006년 8월 9일 수요일 | 업데이트된 날짜: 2006년 9월 13일 수요일
...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 921883](https://support.microsoft.com/kb/921883)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 Article 921883](https://support.microsoft.com/kb/921883)을 참조하십시오.

**테스트된 소프트웨어 및 보안 업데이트 다운로드 위치:**

**영향을 받는 소프트웨어:**

-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=3b61153d-359f-4441-a448-24062cb2387c&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=2996b9b6-03ff-4636-861a-46b3eac7a305&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=314c7c2c-9a02-4e56-98cf-97703fecf0be)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=a0058f39-6dea-4dfc-9dd6-4cb45b305dec&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=af970833-2044-4284-937d-3beb2e2f286d)
-   Microsoft Windows Server 2003 x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=3b0c1954-fca5-4e95-abb2-6066a9d6bc76)
...
|----------------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| 서버 서비스의 버퍼 오버런 취약점 - [CVE-2006-3439 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) | 원격 코드 실행       | 긴급         | 긴급                   | 긴급                   | 긴급                | 긴급                            |
...
-   Windows Server 2003 및 Windows Server 2003 서비스 팩 1(Itanium 기반 시스템용)의 심각도는 Windows Server 2003의 심각도와 동일합니다.
...
**2006년 9월 13일 Microsoft가 이 공지를 다시 공개한 이유는 무엇입니까?**  
Microsoft는 Microsoft Windows Server 2003 서비스 팩 1 및 Microsoft Windows XP Professional x64 Edition에 영향을 주는 문제점([Microsoft 기술 자료 문서 921883](https://supprot.microsoft.com/kb/921883) 참조)을 해결하기 위해 이 공지 및 관련 보안 업데이트를 업데이트했습니다. 대용량 인접 메모리를 요구하는 응용 프로그램이 설치된 Microsoft Windows Server 2003 서비스 팩 1 및 Microsoft Windows XP Professional x64 Edition에 이 업데이트의 이전 버전을 설치하면 시스템 오류가 발생합니다.
...
#### 서버 서비스의 버퍼 오버런 취약점 - CVE-2006-3439:

서버 서비스에 원격 코드 실행 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.

#### 서버 서비스의 버퍼 오버런 취약점 - CVE-2006-3439에 대한 완화 요소:

-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.

#### 서버 서비스의 버퍼 오버런 취약점 - CVE-2006-3439에 대한 대안:
...
-   **방화벽에서 TCP 포트 139 및 445 차단:**
    ...
    이 포트는 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 TCP 포트 139 및 445를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 들어오는 방향의 원치 않는 인터넷 통신을 모두 차단하는 것이 좋습니다. 이 포트에 대한 자세한 내용은 다음 [웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)를 참조하십시오.
...
#### 서버 서비스의 버퍼 오버런 취약점 - CVE-2006-3439에 대한 FAQ:
...
모든 워크스테이션과 서버가 이 문제점과 관련하여 위험에 노출되어 있지만, 취약점의 고유 특성 및 영향을 받는 코드 경로 때문에 Windows 2000 시스템이 특히 취약합니다.
...
**업데이트는 어떤 기능을 합니까?**  
이 업데이트는 RPC 통신 메시지를 할당된 버퍼로 전달하기 전에 메시지 길이에 대한 유효성을 검사하는 방식을 수정함으로써 취약점을 제거합니다.
...
예. 이 보안 업데이트는 현재 악용되고 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 CVE-2006-3439가 지정되었습니다.

**이 취약점은 MS06-035로 해결된 취약점과 어떤 관계가 있습니까?**  
두 취약점이 모두 서버 서비스에 존재하기 때문에 이 업데이트는 MS06-035의 일부로 해결되지 않은 새로운 취약점을 해결합니다. MS06-035은 해당 공지에서 설명한 취약점으로부터 보호하지만 이 새로운 취약점은 해결하지 못합니다. 이 업데이트는 MS06-035를 대체하지 않습니다. 시스템을 두 취약점으로부터 보호하려면 이 업데이트와 MS06-035 보안 공지의 일부로 제공되는 업데이트를 설치해야 합니다.
...
**WindowsServer2003-KB921883-v2-x86-KOR /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB921883.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows Server 2003 명령 프롬프트에서 다음 명령을 사용하십시오.

**WindowsServer2003-KB921883-v2-x86-KOR /norestart**
...
시스템 관리자는 Spuninst.exe 유틸리티를 사용하여 이 보안 업데이트를 제거할 수도 있습니다. Spuninst.exe 유틸리티는 %Windir%\\$NTUninstallKB921883$\\Spuninst 폴더에 있습니다.
...
|--------------|---------------|-------------|-----------|---------|-----|--------|
| Netapi32.dll | 5.2.3790.559  | 2006-07-17  | 오후 6:45 | 324,608 | x86 | RTMGDR |
| Netapi32.dll | 5.2.3790.559  | 2006-07-17  | 오후 6:57 | 324,608 | x86 | RTMQFE |
...
**WindowsXP-KB921883-x86-KOR /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB921883.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows XP 명령 프롬프트에서 다음 명령을 사용하십시오.

**WindowsXP-KB921883-x86-KOR /norestart**
...
| 파일 이름    | 버전          | 날짜       | 시간       | 크기    | CPU | 폴더   |
|--------------|---------------|------------|------------|---------|-----|--------|
| Netapi32.dll | 5.1.2600.1874 | 2006-07-15 | 오전 12:57 | 307,200 | x86 | SP1QFE |
| Netapi32.dll | 5.1.2600.2952 | 2006-07-15 | 오전 12:40 | 332,288 | x86 | SP2GDR |
| Netapi32.dll | 5.1.2600.2952 | 2006-07-15 | 오전 12:41 | 336,896 | x86 | SP2QFE |
...
|--------------|---------------|------------|-----------|---------|-----|
| Netapi32.dll | 5.0.2195.7105 | 2006-07-14 | 오후 7:25 | 309,520 | x86 |
...
-   서버 서비스의 버퍼 오버런 취약점(CVE-2006-3439)을 해결하기 위해 협력해 주신 [US-CERT (영문)](https://www.us-cert.gov/)
-   서버 서비스의 버퍼 오버런 취약점(CVE-2006-3439)을 해결하기 위해 협력해 주신 [SANS (영문)](https://www.sans.org/)
...
-   V1.1 (2006년 8월 15일): KB921883의 공개를 반영하여 주의 사항이 업데이트되었습니다. “대안” 섹션의 영향 부분에서 확인된 포트 차단이 수정되었습니다.
-   V2.0 (2006년 9월 13일): [Microsoft 기술 자료 문서 921883](https://support.microsoft.com/kb/921883)에서 확인된 문제점을 해결하기 위해 Microsoft Windows 2003 및 Microsoft Windows XP Professional x64 Edition용 업데이트가 수정되어 다시 릴리스되었습니다.
