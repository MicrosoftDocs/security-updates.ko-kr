...
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-0075)을 보고해 주신 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)  
-   CSS 메모리 손상 취약점(CVE-2009-0076)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Sam Thomas([http://eshu.co.uk/ (영문)](http://eshu.co.uk/))
