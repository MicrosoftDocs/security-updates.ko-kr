...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=cedfd988-232c-4cba-ac65-beb54b8946e0&displaylang=ko)                                                     | 원격 코드 실행 | 보통        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26&displaylang=ko)                                                                 | 원격 코드 실행 | 보통        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
...
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=62874096-7d17-4116-9795-4756e2fb6dae&displaylang=ko) | 원격 코드 실행 | 보통        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=dadead99-09cb-4f2b-850d-e98a627cb9f8&displaylang=ko)                     | 원격 코드 실행 | 낮음        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=84f9b533-b0cb-46d1-b4a8-5c9469abbd22&displaylang=ko)         | 원격 코드 실행 | 낮음        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ac35ce19-d761-4529-9f55-1e1b5b2447ad)      | 원격 코드 실행 | 낮음        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=4af6575e-b061-45a6-b3d8-ecb32d76b2d3&displaylang=ko)                                             | 원격 코드 실행 | 보통        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=67576acb-9cb6-4c76-9a72-dc5e5556b658&displaylang=ko)                     | 원격 코드 실행 | 보통        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8a507fba-8c93-4952-91e4-98e9e7affbd2&displaylang=ko)&#42;                                                 | 원격 코드 실행 | 낮음        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1a11499d-a008-407f-9084-a5189fa27015&displaylang=ko)&#42;                                               | 원격 코드 실행 | 낮음        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=59b1689c-e723-4d87-973e-4beac107a6f7)                                                            | 원격 코드 실행 | 낮음        | [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023) |
...
참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교(영문)](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
...
운영 체제에 따라 취약점에 적용되는 완화 조치가 서로 다르므로, 이 업데이트의 심각도는 달라집니다. 그러한 완화 조치 중 하나로써, Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](http://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다.

**Windows Server 2008 Server Core 설치를 사용하는 사용자가 이 업데이트를 설치해야 합니까?**  
Windows Server 2008 Server Core 설치를 사용하는 사용자에게 이 업데이트가 제공되지만 설치할 필요는 없습니다. Server Core 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오.  
참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교(영문)](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-0675 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0675)를 참조하십시오.
...
-   BackWeb은 취약점을 해결하기 위한 [보안 공지 (영문)](http://backweb.com/news_events/press_releases/051608.php) 및 업데이트를 발표했습니다. 자세한 정보 및 다운로드 위치는 [BackWeb (영문)](http://backweb.com/news_events/press_releases/051608.php)의 보안 공지를 참조하십시오. 이 킬(Kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 컨트롤과 관련하여 지원이 필요한 고객은 [BackWeb (영문)](http://backweb.com/news_events/press_releases/051608.php)에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
