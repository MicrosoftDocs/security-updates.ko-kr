...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=de95d8b9-51a5-43cd-8ba3-8cbb1320d099">Microsoft Visio 2010 서비스 팩 1(32비트 에디션)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a>의 KB2553374는 KB2597171 또는 KB2687508로 대체되었습니다.[2]</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=af690cd8-cb2c-4743-96f0-ffaec77adf10">Microsoft Visio 2010 서비스 팩 1(64비트 에디션)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a>의 KB2553374는 KB2597171 또는 KB2687508로 대체되었습니다.[2]</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=62e87f7b-f48e-43a7-86d7-cbb8f0603ea3">Microsoft Visio Viewer 2010 서비스 팩 1(32비트 에디션)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a>의 KB2597981은 KB2598287로 대체되었습니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3889e1b3-69b2-4a8f-a0d9-de8c7dc6f5ec">Microsoft Visio Viewer 2010 서비스 팩 1(64비트 에디션)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a>의 KB2597981은 KB2598287로 대체되었습니다.</td>
...
Microsoft는 적절한 타임스탬프 특성 없이 Microsoft에서 생성한 특정 디지털 인증서와 관련된 문제를 해결하도록 영향을 받는 모든 Microsoft Visio 2010 에디션에 대한 KB2597171 업데이트를 KB2687508 업데이트로 대체하기 위해 이 공지를 다시 릴리스했습니다. 자세한 내용은 [Microsoft 보안 권고(2749655)](http://technet.microsoft.com/security/advisory/2749655)를 참조하십시오.
...
참고 기존 업데이트가 이미 설치되어 있으며 다시 릴리스된 업데이트를 같은 시스템에 설치하는 경우, 설치 관리자에서 이미 업데이트가 설치되어 있다는 메시지가 표시됩니다. 메시지가 생성된 후에는 설치된 업데이트 목록에서 다시 릴리스된 업데이트의 KB 번호가 기존 업데이트의 KB 번호를 대체합니다. 자세한 내용은 [Microsoft 기술 자료 문서 2720573](http://support.microsoft.com/kb/2720573)을 참조하십시오.
  
파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.
  
보안 업데이트의 해시는 어디에 있습니까?  
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2733918](http://support.microsoft.com/kb/2733918)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1888)(영문)을 참조하십시오.
...
<td style="border:1px solid black;">Microsoft Visio 2010의 경우 <a href="http://support.microsoft.com/kb/2597171">Microsoft 기술 자료 문서 2597171</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Visio Viewer 2010의 경우 <a href="http://support.microsoft.com/kb/2598287">Microsoft 기술 자료 문서 2598287</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
...
-   [TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)(영문)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 Visio DXF 파일 형식 버퍼 오버플로 취약점(CVE-2012-1888)을 보고해 주신 Alexander Gavrun
