---
TOCTitle: 'MS10-076'
Title: 'Microsoft 보안 공지 MS10-076 - 긴급'
ms:assetid: 'ms10-076'
ms:contentKeyID: 61230337
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-076(v=Security.10)'
---
...
보안 업데이트는 Embedded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 파일과 콘텐츠의 구문을 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=c3799399-ca72-4dec-a2a2-3571ad0b2f63&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=860ff738-205d-430e-b223-b333813fc590)                                                                 | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7b240b65-f3ca-465c-a606-b561999c1977&displaylang=ko)                                                                  | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=70c9e826-b80b-4a20-82d2-8e52e5cca839&displaylang=ko)                                                      | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=bd5878bb-f565-4303-afed-4e17b44a02f2)                                                             | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=29c4afb1-227d-4572-b136-a78ef7e1df77&displaylang=ko)                                           | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=880ad9a0-6ddd-41f4-a608-171d59a31b6a&displaylang=ko)                   | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=50386655-982e-4126-8261-2c972d695bbd&displaylang=ko)\*\*     | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a6b2ae1d-9225-4495-8560-97860f87d7b4&displaylang=ko)\*\* | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a4e38a77-3835-47b3-bd86-6c039169abf5)            | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=f6cae091-e9f1-48e9-a035-4346b9c6fec6&displaylang=ko)                                                                       | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=35882477-4e0a-4783-a4b4-0f1ea3398360&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b060c516-233a-4e1e-9237-698420e97b2f&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0ead2ed9-8b2f-496e-b7d1-3ad2b04be5cc)                                                                   | 원격 코드 실행 | 긴급        | 없음                      |
...
<th style="border:1px solid black;" >Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2010-1883)</th>
...
Microsoft Windows EOT(Embedded OpenType) 글꼴 기술이 특수하게 조작된 포함 글꼴에 있는 특정 테이블의 구문을 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1883 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1883)을 참조하십시오.
  
#### Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2010-1883)에 대한 완화 요소
...
#### Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2010-1883)에 대한 대안
...
-   **Internet Explorer에서 포함 글꼴 구문 분석 지원 사용 안 함**
    ...
    **대화형 방법 사용:**
    ...
    1.  Internet Explorer에서 **도구** 메뉴를 클릭한 다음 **인터넷 옵션**을 선택합니다.  
    2.  **인터넷 옵션**에서 **보안** 탭을 클릭하고 **인터넷 영역**을 선택한 다음 **사용자 지정 수준**을 클릭합니다.  
    3.  **보안 설정 - 인터넷 영역**에서 아래로 스크롤하여 **설정** 창의 **다운로드**로 이동하고 **글꼴 다운로드** 설정을 **확인** 또는 **사용 안 함**으로 선택합니다.  
    4.  **확인**을 클릭하여 선택 항목을 저장한 다음 **확인**을 다시 클릭하여 Internet Explorer로 돌아갑니다.
  
    **그룹 정책 사용:**
  
    **참고** 그룹 정책 MMC 스냅인을 사용하여 시스템, 조직 구성 단위 또는 전체 도메인에 대한 정책을 설정할 수 있습니다. 그룹 정책에 대한 자세한 내용은 다음 Microsoft 웹 사이트를 참조하십시오.
    ...
    그룹 정책을 사용하려면 다음 단계를 수행하십시오.
  
    1.  그룹 정책 관리 콘솔을 열고 해당 그룹 정책 개체(예: 로컬 컴퓨터, OU 또는 도메인 GPO)와 작동하도록 구성합니다.  
    2.  **사용자 구성**, **Windows 설정**, **Internet Explorer 유지 관리**, **보안**을 차례로 클릭합니다.  
    3.  **보안 영역 및 콘텐츠 등급**을 두 번 클릭하고 **현재 보안 영역 및 개인 정보 설정 가져오기**를 선택한 다음 **설정 수정**을 클릭합니다.
  
    **참고** 이렇게 하면 현재 로그온한 사용자의 설정을 기반으로 Internet Explorer에 대한 그룹 정책이 만들어지고 인터넷 속성이 열립니다.
  
    1.  인터넷 속성에서 **보안** 탭을 클릭하고 **인터넷 영역**을 선택한 다음 **사용자 지정 수준**을 클릭합니다.  
    2.  **보안 설정 - 인터넷 영역**에서 아래로 스크롤하여 **설정** 창의 **다운로드**로 이동하고 **글꼴 다운로드** 설정을 **확인** 또는 **사용 안 함**으로 선택합니다.  
    3.  **확인**을 클릭하여 **인터넷 속성**으로 돌아갑니다.  
    4.  **로컬 인트라넷** 영역에 대해서도 4-6단계를 반복합니다.  
    5.  **확인**을 세 번 클릭하여 그룹 정책 관리 콘솔로 돌아갑니다.  
    6.  모든 시스템에서 그룹 정책을 새로 고치거나 다음 예약된 그룹 정책 새로 고침 간격을 기다려서 새 설정을 적용합니다.
  
    **관리되는 스크립트 사용:**
  
    레지스트리 스크립트를 만들어 두 번 클릭하거나 로그온 또는 컴퓨터 시작 스크립트의 일부로 regedit.exe를 실행하여 해당 스크립트를 가져와서 이 보안 설정을 레지스트리에 수동으로 입력할 수 있습니다. 관리되는 배포의 경우 "-s" 스위치와 함께 regedit.exe를 사용하여 레지스트리 스크립트를 자동으로 가져올 수 있습니다. regedit 명령줄 스위치에 대한 자세한 내용은 [Microsoft 기술 자료 문서 82821](https://support.microsoft.com/kb/82821) , 등록 정보 편집기(REGEDIT) 명령줄 스위치를 참조하십시오.
  
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
  
    레지스트리를 편집하기 전에 백업해 두는 것이 좋습니다.
  
    인터넷 및 로컬 인트라넷 영역에 대해 이 설정을 "확인"으로 설정하려면 다음 텍스트를 .REG 파일에 붙여넣은 다음 관리되는 시스템에서 조직의 관리되는 배포 프로세스의 일부로 .REG 파일을 가져옵니다.
    ...
    인터넷 및 로컬 인트라넷 영역에 대해 이 설정을 "사용 안 함"으로 설정하려면 다음 텍스트를 .REG 파일에 붙여넣은 다음 관리되는 시스템에서 조직의 관리되는 배포 프로세스의 일부로 .REG 파일을 가져옵니다.
...
#### Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2010-1883)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점의 원인은 Microsoft Windows 구성 요소인 Embedded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 특수하게 조작된 파일과 콘텐츠에 있는 특정 테이블의 구문을 분석할 때 발생하는 정수 오버플로입니다.
...
이 취약점을 악용하려면 사용자가 특수하게 조작된 EOT 내장 글꼴이 있는 콘텐츠를 봐야 합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB982132$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/982132">Microsoft 기술 자료 문서 982132</a> 참조</td>
</tr>
<tr class="even">
...
-   Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2010-1883)을 [Tipping Point (영문)](https://www.tippingpoint.com) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Sebastian Apelt  
-   Embedded OpenType 글꼴 정수 오버플로 취약점(CVE-2010-1883)을 [iSIGHT Partners Global Vulnerability Partnership (영문)](https://gvp.isightpartners.com)을 통해 보고해 주신 Ivan Fratric
