...
Windows Server 2003의 인증서 서비스에 대한 자세한 내용은 [Windows Server 2003의 공개 키 구조](https://www.microsoft.com/windowsserver2003/technologies/pki/default.mspx) 웹 사이트(www.microsoft.com/windowsserver2003/technologies/pki/default.mspx)를 참조하십시오.

PKI에는 인증서 해지를 처리하는 메커니즘이 있어야 합니다. 인증서 해지는 인증서가 만료되거나 공격자에 노출된 경우 필요합니다. 각 인증서는 인증서 해지 목록(CRL)의 위치를 포함하고 있습니다. 인증서 해지를 관리하는 방법에 대한 자세한 내용은 www.microsoft.com/resources/documentation/WindowsServ/2003/standard/proddocs/en-us/sag\_CS\_procs\_revocation.asp에서 [인증서 해지 관리](https://www.microsoft.com/resources/documentation/windowsserv/2003/standard/proddocs/en-us/sag_cs_procs_revocation.asp) 항목을 참조하십시오.
...
인증서 템플릿에 대한 자세한 내용은 www.microsoft.com/resources/documentation/WindowsServ/2003/standard/proddocs/en-us/sag\_ct\_topnode.asp에서 [인증서 템플릿](https://www.microsoft.com/resources/documentation/windowsserv/2003/standard/proddocs/en-us/sag_ct_topnode.asp) 항목을 참조하십시오.
...
그룹을 만드는 방법에 대한 자세한 내용은 www.microsoft.com/resources/documentation/WindowsServ/2003/standard/proddocs/en-us/sag\_adgroups\_checklist\_create\_group.asp에서 [검사 목록: 그룹 만들기](https://www.microsoft.com/resources/documentation/windowsserv/2003/standard/proddocs/en-us/sag_adgroups_checklist_create_group.asp) 항목을 참조하십시오.
...
스마트 카드의 평가에 대한 자세한 내용은 https://technet2.microsoft.com/windowsserver/en/library/0eae38ec-d6e5-4ca7-96a3-42f2fd6c6e741033.mspx에서 [스마트 카드 및 판독기 평가](https://technet2.microsoft.com/windowsserver/en/library/0eae38ec-d6e5-4ca7-96a3-42f2fd6c6e741033.mspx) 항목을 참조하십시오.
