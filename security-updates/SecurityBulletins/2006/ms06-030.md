---
TOCTitle: 'MS06-030'
Title: 'Microsoft 보안 공지 MS06-030 - 긴급'
ms:assetid: 'ms06-030'
ms:contentKeyID: 61229991
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms06-030(v=Security.10)'
---



Microsoft 보안 공지 MS06-030 - 긴급
===================================

서버 메시지 블록의 취약점으로 인한 권한 상승 문제점 (914389)
------------------------------------------------------------
...
-   Microsoft Windows 2000 서비스 팩 4 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=6ec86784-6b12-410b-8068-028c58ed5df7)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c17ddc07-204b-4a7f-8c5a-36b7865a030c)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=89fbbdd0-7504-4807-9337-08324aa457e7)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=%2043d69a41-6acb-4c64-89dc-2b9aef6e98fd)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e1d13c18-72d1-40b8-95b3-08aef8db9213)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=b6018a61-b0ec-467e-9025-059d3c9f1c5f)
...
|-------------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| SMB 드라이버 권한 상승 취약점 - [CVE-2006-2373 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2373) | 권한 상승            | 중요         | 중요                   | 중요                   | 중요                | 중요                            |
| SMB 잘못된 핸들 취약점 - [CVE-2006-2374 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2374)        | 서비스 거부          | 보통         | 보통                   | 보통                   | 보통                | 보통                            |
...
-   Microsoft Windows XP Professional x64 Edition의 심각도는 (Comment: Validate which one) Windows Server 2003 서비스 팩 1 또는 Windows XP 서비스 팩 2 심각도와 동일합니다.
...
|--------------|--------------------------|------------------------|------------------------|---------------------|---------------------------------|
| **MS05-011** | 대체됨                   | 대체됨                 | 대체됨                 | 대체됨              | 해당 사항 없음                  |
...
MBSA에 대한 자세한 내용은 [MBSA 웹 사이트 (영문)](https://www.microsoft.com/technet/security/tools/mbsahome.mspx)를 방문하십시오. 현재 Microsoft Update와 MBSA 2.0으로 검색할 수 없는 소프트웨어에 대한 자세한 내용은 [Microsoft 기술 자료 문서 895660](https://support.microsoft.com/kb/895660)을 참조하십시오.
...
서버 메시지 블록(SMB)에 권한 상승 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.

#### SMB 드라이버 권한 상승 취약점 - CVE-2006-2373에 대한 완화 요소:

-   이 취약점을 악용하여 공격이 성공하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### SMB 드라이버 권한 상승 취약점 - CVE-2006-2373에 대한 대안:
...
**참고** 다음 단계를 수행하려면 관리자 권한이 필요합니다. 알려진 공격 경로를 차단하기 위해서는 권장되는 두 가지 대안을 모두 수행해야 합니다. 대안을 적용한 다음에는 컴퓨터를 다시 시작하는 것이 좋습니다.

-   **워크스테이션 서비스 해제**

    워크스테이션 서비스를 사용하지 않도록 설정하면 이 취약점을 악용하는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다. 워크스테이션 서비스를 사용하지 않도록 설정하려면 다음 단계를 수행하십시오.

    1.  **시작**을 클릭한 다음 **제어판** 을 클릭합니다.또는 **설정**을 가리킨 다음 **제어판**을 클릭합니다.
    2.  **관리 도구**를 두 번 클릭합니다.
    3.  **서비스**를 두 번 클릭합니다.
    4.  **워크스테이션**을 두 번 클릭합니다.
    5.  **시작 유형** 목록에서 **사용 안 함**을 클릭합니다.
    6.  **중지**, **확인**을 차례로 클릭합니다.

명령 프롬프트에서 다음 명령을 사용하여 워크스테이션 서비스를 중지하고 비활성화할 수도 있습니다.

`sc stop lanmanworkstation & sc config lanmanworkstation start= disabled`

**대안의 영향:** 워크스테이션 서비스를 사용하지 않도록 설정하면 클라이언트가 SMB 공유에 액세스할 수 없습니다.

-   **MRxSmb 드라이버 레지스트리 항목 삭제**

    MRxSmb 드라이버 레지스트리 항목을 삭제하면 이 취약점을 악용하는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다. MRxSmb 키를 삭제하려면 다음 단계를 수행하십시오.
    ...
    **참고** 레지스트리 편집기를 잘못 사용하면 시스템 전체에 심각한 문제가 발생할 수 있으며 운영 체제를 다시 설치해야 할 수도 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결을 보증하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다. 레지스트리를 편집하는 방법에 대한 자세한 내용은 레지스트리 편집기(Regedit.exe)의 "키와 값 변경" 도움말 항목 또는 Regedt32.exe의 "레지스트리의 정보 추가와 삭제" 및 "레지스트리 정보 편집" 도움말 항목을 참조하십시오.
    ...
    2.  HKLM\\System\\CurrentControlSet\\Services로 이동합니다.
    3.  MRxSmb 키를 마우스 오른쪽 단추로 클릭하고 키를 내보냅니다.
    4.  MRxSmb 키를 마우스 오른쪽 단추로 클릭하고 키를 삭제합니다.

    **대안의 영향:** MRxSmb 레지스트리 키를 삭제하면 클라이언트가 SMB 공유에 액세스할 수 없습니다.

#### SMB 드라이버 권한 상승 취약점 - CVE-2006-2373에 대한 FAQ:

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이는 권한 상승 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

**취약점의 원인은 무엇입니까?**  
영향을 받는 운영 체제가 일부 SMB 요청의 유효성을 검사할 때 사용하는 프로세스가 원인입니다.

**SMB란 무엇입니까?**  
SMB(서버 메시지 블록)과 그 후속인 CIFS(Common Internet File System)는 Windows가 컴퓨터 간 통신과 파일, 프린터, 직렬 포트의 공유에 사용하는 인터넷 표준 프로토콜입니다. SMB는 이를 위해 명명된 파이프와 메일 슬롯을 사용합니다. 네트워크로 연결된 환경에서 서버는 파일 시스템과 리소스를 클라이언트가 사용할 수 있도록 합니다. 클라이언트는 리소스에 대해 SMB 요청을 수행하고 서버는 SMB 응답을 수행합니다. 이를 클라이언트 서버, 요청 응답 프로토콜이라 합니다.
...
터미널 서버로 동작하는 시스템을 포함하여 사용자가 대화형으로 로그온할 수 있는 Microsoft Windows 2000, Windows XP 및 Windows Server 2003이 이 취약점으로 인한 주 공격 대상입니다.
...
**업데이트는 어떤 기능을 합니까?**  
업데이트는 영향을 받는 운영 체제가 SMB 관련 요청을 처리하는 방법을 수정함으로써 취약점을 해결합니다.
...
서버 메시지 블록(SMB)에 서비스 거부 취약점이 존재하며, 이 취약점 악용에 성공한 공격자는 영향을 받는 시스템이 응답하지 않도록 할 수 있습니다.

#### SMB 잘못된 핸들 취약점 - CVE-2006-2374에 대한 완화 요소:

-   이 취약점을 악용하여 공격이 성공하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### SMB 잘못된 핸들 취약점 - CVE-2006-2374에 대한 대안:

Microsoft는 다음과 같은 대안을 테스트했습니다. 이러한 대안이 취약점 자체를 해결하지는 않지만 알려진 공격 경로를 차단하는 데 도움이 됩니다. 대안으로 인해 기능이 저하되는 경우는 아래 섹션에 별도로 표시하였습니다.

**참고** 다음 단계를 수행하려면 관리자 권한이 필요합니다. 알려진 공격 경로를 차단하기 위해서는 권장되는 두 가지 대안을 모두 수행해야 합니다. 이 대안을 적용한 다음에는 컴퓨터를 다시 시작하는 것이 좋습니다.
...
#### SMB 잘못된 핸들 취약점 - CVE-2006-2374에 대한 FAQ:

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것이 바로 [서비스 거부](https://www.microsoft.com/korea/security/glossary.mspx) 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 응답을 중지하도록 만듭니다. 이 시간 동안 영향을 받는 시스템은 요청에 응답할 수 없습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 응답하지 않도록 만들 수 있습니다.
...
**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB914389.log 파일에서 모든 실패 메시지를 검토해야 합니다.
...
이 보안 업데이트를 적용한 다음 시스템을 다시 시작해야 합니다.
이 보안 업데이트는 Smb.sys 및 Rdbss.sys 파일 버전 5.2.3790.1830이 있는 시스템에서 핫패칭을 지원합니다. 핫패칭을 사용할 경우 Microsoft Windows Server 2003 서비스 팩 1을 실행하는 시스템에서 서버를 다시 시작하지 않고 보안 업데이트를 설치할 수 있습니다. 핫패칭에 대한 자세한 내용 및 핫패칭을 사용하여 보안 업데이트를 배포하는 방법은 [Microsoft 기술 자료 문서 897341](https://support.microsoft.com/kb/897341)을 참조하십시오.
핫 패칭을 사용하는 Windows Update, Microsoft Update 및 자동 업데이트를 통해 이 보안 업데이트를 적용할 경우 서버를 다시 시작할 필요 없습니다.

**제거 정보**

이 업데이트를 제거하려면 제어판의 프로그램 추가/제거 도구를 사용하십시오.

시스템 관리자는 Spuninst.exe 유틸리티를 사용하여 이 보안 업데이트를 제거할 수도 있습니다. Spuninst.exe 유틸리티는 %Windir%\\$NTUninstallKB914389$\\Spuninst 폴더에 있습니다.
...
|---------------|---------------|-------------|-------|---------|--------|
| Mrxsmb.sys    | 5.2.3790.529  | 06-May-2006 | 02:24 | 395,776 | RTMGDR |
| Rdbss.sys     | 5.2.3790.529  | 06-May-2006 | 02:24 | 157,184 | RTMGDR |
| Mrxsmb.sys    | 5.2.3790.529  | 08-May-2006 | 17:35 | 396,288 | RTMQFE |
| Rdbss.sys     | 5.2.3790.529  | 06-May-2006 | 02:18 | 158,720 | RTMQFE |
| Mrxsmb.hp.sys | 5.2.3790.2697 | 08-May-2006 | 17:18 | 14,848  | SP1GDR |
| Mrxsmb.sys    | 5.2.3790.2697 | 08-May-2006 | 17:18 | 469,504 | SP1GDR |
| Rdbss.hp.sys  | 5.2.3790.2697 | 08-May-2006 | 17:18 | 13,312  | SP1GDR |
| Rdbss.sys     | 5.2.3790.2697 | 08-May-2006 | 17:18 | 202,752 | SP1GDR |
| Mrxsmb.sys    | 5.2.3790.2697 | 06-May-2006 | 01:56 | 437,760 | SP1QFE |
| Rdbss.sys     | 5.2.3790.2697 | 06-May-2006 | 01:56 | 177,664 | SP1QFE |
...
| 파일 이름  | 버전          | 날짜        | 시간  | 크기      | 폴더   |
|------------|---------------|-------------|-------|-----------|--------|
| Mrxsmb.sys | 5.2.3790.529  | 08-May-2006 | 17:38 | 1,126,400 | RTMGDR |
| Rdbss.sys  | 5.2.3790.529  | 08-May-2006 | 17:38 | 462,848   | RTMGDR |
| Mrxsmb.sys | 5.2.3790.529  | 08-May-2006 | 17:38 | 1,128,960 | RTMQFE |
| Rdbss.sys  | 5.2.3790.529  | 08-May-2006 | 17:38 | 465,920   | RTMQFE |
| Mrxsmb.sys | 5.2.3790.2697 | 08-May-2006 | 17:40 | 1,171,968 | SP1GDR |
| Rdbss.sys  | 5.2.3790.2697 | 08-May-2006 | 17:40 | 488,448   | SP1GDR |
| Mrxsmb.sys | 5.2.3790.2697 | 08-May-2006 | 17:38 | 1,172,480 | SP1QFE |
| Rdbss.sys  | 5.2.3790.2697 | 08-May-2006 | 17:38 | 488,448   | SP1QFE |
...
| 파일 이름  | 버전          | 날짜        | 시간  | 크기    | 폴더   |
|------------|---------------|-------------|-------|---------|--------|
| Mrxsmb.sys | 5.2.3790.2697 | 08-May-2006 | 17:38 | 785,408 | SP1GDR |
| Rdbss.sys  | 5.2.3790.2697 | 08-May-2006 | 17:38 | 309,248 | SP1GDR |
| Mrxsmb.sys | 5.2.3790.2697 | 08-May-2006 | 17:35 | 785,920 | SP1QFE |
| Rdbss.sys  | 5.2.3790.2697 | 08-May-2006 | 17:35 | 309,248 | SP1QFE |

**참고** 이 보안 업데이트 설치 시 설치 프로그램은 하나 또는 그 이상의 파일들이, 이전에 마이크로소프트 핫픽스에 의해 업데이트된 귀하의 시스템에 업데이트되고 있는지를 점검합니다.

만일 예전에 이 파일들 중 하나를 업데이트하기 위해 핫픽스를 설치했다면 그 설치 프로그램은 RTMQFE, SP1QFE, 또는 SP2QFE 파일을 귀하의 시스템에 복사합니다. 그렇지 않으면 RTMGDR, SP1GDR, 또는 SP2GDR 파일을 복사합니다. 보안 업데이트는 이 파일들의 모든 변화 사항들을 포함하고 있지 않을 수도 있습니다. 이 행위에 대한 좀 더 자세한 정보는 [Microsoft 기술 자료 문서 824994](https://support.microsoft.com/kb/824994)를 보시기 바랍니다.
...
| Mrxsmb.sys | 5.1.2600.1836 | 05-May-2006 | 09:31 | 433,152 | SP1QFE |
| Rdbss.sys  | 5.1.2600.1836 | 05-May-2006 | 09:40 | 166,656 | SP1QFE |
| Mrxsmb.sys | 5.1.2600.2902 | 05-May-2006 | 09:41 | 453,120 | SP2GDR |
| Rdbss.sys  | 5.1.2600.2902 | 05-May-2006 | 09:47 | 174,592 | SP2GDR |
| Mrxsmb.sys | 5.1.2600.2902 | 05-May-2006 | 10:16 | 454,400 | SP2QFE |
| Rdbss.sys  | 5.1.2600.2902 | 05-May-2006 | 10:22 | 174,592 | SP2QFE |
...
| 파일 이름  | 버전          | 날짜        | 시간  | 크기      |
|------------|---------------|-------------|-------|-----------|
| Mrxsmb.sys | 5.0.2195.7097 | 31-May-2006 | 07:14 | 415,536   |
...
-   SMB 권한 상승 취약점 - CVE-2006-2373을 보고에 [iDEFENSE (영문)](https://www.idefense.com/)와 협조해주신 [Rubén Santamarta (영문)](https://www.reversemode.com/)
-   SMB 잘못된 핸들 취약점 - CVE-2006-2374를 보고에 [iDEFENSE (영문)](https://www.idefense.com/)와 협조해주신 [Rubén Santamarta (영문)](https://www.reversemode.com/)
...
-   V1.1 (2006년 6월 15일): 관련 취약점 보고를 위해 iDefense와 협조해 주신 Rubén Santamarta에 감사의 말
