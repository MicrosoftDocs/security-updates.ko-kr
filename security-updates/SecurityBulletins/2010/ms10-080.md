---
TOCTitle: 'MS10-080'
Title: 'Microsoft 보안 공지 MS10-080 - 중요'
ms:assetid: 'ms10-080'
ms:contentKeyID: 61230341
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-080(v=Security.10)'
---
...
이 보안 업데이트는 Microsoft Office에서 발견되어 비공개적으로 보고된 취약점 13건을 해결합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 Excel 파일이나 특수하게 조작된 Lotus 1-2-3 파일을 열 경우 원격 코드 실행이 허용될 수 있습니다. 이러한 취약점 중 하나를 성공적으로 악용한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Excel 2002, Microsoft Excel 2003, Microsoft Excel 2007, Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac 에디션과 지원 대상인 모든 Microsoft Office Excel Viewer 및 Microsoft Office 호환 기능 팩 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft Office Excel에서 특수하게 조작된 Excel 파일 및 특수하게 조작된 Lotus 1-2-3 파일을 구문 분석하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

권장 사항. 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2293211](https://support.microsoft.com/kb/2293211)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Excel 2002 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=ea859881-2cc5-407b-a394-5d00c5d9fd97&displaylang=ko)  
(KB2345017)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<sup>[1]</sup>Microsoft Office Excel 2007 서비스 팩 2를 사용하는 고객의 경우 이 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트 패키지 KB2345035 이외에도 Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩 서비스 팩 2용 보안 업데이트(KB2344875)를 설치해야 합니다.
...
MS10-079에서도 Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac의 취약점을 설명합니다. MS10-079는 이 공지(MS10-080)와 어떤 관련이 있습니까?  
Microsoft Office 2004 for Mac(KB2422343), Microsoft Office 2008 for Mac(KB2422352) 및 Open XML File Format Converter for Mac(KB2422398)에 대한 이 공지(MS10-080)의 보안 업데이트 패키지는 MS10-079에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 또는 Open XML File Format Converter for Mac이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3230 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230)을 참조하십시오.

#### Excel 레코드 구문 분석 정수 오버플로 취약점(CVE-2010-3230)에 대한 완화 요소
...
#### Excel 레코드 구문 분석 정수 오버플로 취약점(CVE-2010-3230)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처의 Microsoft Office 파일/문서는 열지 않음

    신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Office 파일은 열거나 저장하지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 레코드 구문 분석 정수 오버플로 취약점(CVE-2010-3230)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3231 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231)을 참조하십시오.

#### Excel 레코드 구문 분석 메모리 손상 취약점(CVE-2010-3231)에 대한 완화 요소
...
#### Excel 레코드 구문 분석 메모리 손상 취약점(CVE-2010-3231)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처의 Microsoft Office 파일은 열지 않음

    신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Office 파일은 열거나 저장하지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 레코드 구문 분석 메모리 손상 취약점(CVE-2010-3231)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3232 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232)를 참조하십시오.

#### Excel 파일 형식 구문 분석 취약점(CVE-2010-3232)에 대한 완화 요소
...
#### Excel 파일 형식 구문 분석 취약점(CVE-2010-3232)에 대한 대안
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는 Office 2007에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
-   알 수 없거나 신뢰할 수 없는 출처에서 받은 파일을 열 때 MOICE(Microsoft Office Isolated Conversion Environment)를 사용합니다.
    ...
    참고 이 대안을 사용하거나 사용하지 않도록 설정하려면 Microsoft 기술 자료 문서 935865을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
#### Excel 파일 형식 구문 분석 취약점(CVE-2010-3232)에 대한 FAQ
...
Microsoft Excel에서 특수하게 조작된 Lotus 1-2-3 통합 문서 파일(.wk3)을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3233 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233)을 참조하십시오.

#### Lotus 1-2-3 통합 문서 구문 분석 취약점(CVE-2010-3233)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 메일 메시지를 통한 공격에 성공하려면 메일로 보낸 첨부 파일을 사용자가 열어야 합니다.
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 Lotus 1-2-3 파일을 열도록 유도하는 것이 일반적입니다.

#### Lotus 1-2-3 통합 문서 구문 분석 취약점(CVE-2010-3233)에 대한 대안
...
#### Lotus 1-2-3 통합 문서 구문 분석 취약점(CVE-2010-3233)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

취약점의 원인은 무엇입니까?  
Microsoft Excel에서 특수하게 조작된 Lotus 1-2-3 파일을 구문 분석할 때 시스템 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.

Microsoft Excel 2003 서비스 팩 3에 대한 이 취약점의 심각도가 보통인 이유는 무엇입니까?  
기본적으로 Microsoft Excel 2003 서비스 팩 3에서는 Lotus 1-2-3 파일 열기가 차단됩니다. 이 완화 요소는 Microsoft Excel 2003 서비스 팩 3에 대한 CVE-2010-3233의 심각도를 낮춥니다. Microsoft Office 2003 서비스 팩 3 설치 후 차단되는 파일 형식에 대한 자세한 내용은 [Microsoft 기술 자료 문서 938810](https://support.microsoft.com/kb/938810/)을 참조하십시오.

공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
이 취약점을 악용에 성공한 공격자는 로그온한 사용자 자격으로 임의 코드를 실행할 수 있습니다. 사용자가 관리자 권한의 사용자 권한으로 로그온한 경우 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
이 취약점을 악용하려면 사용자가 특수하게 조작된 Lotus 1-2-3 파일을 영향을 받는 Microsoft Excel 버전에서 열어야 합니다.

전자 메일을 통한 공격의 경우 공격자는 특수하게 조작된 Lotus 1-2-3 파일을 사용자에게 보내고 파일을 열도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.

웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 Lotus 1-2-3 파일을 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 Lotus 1-2-3 파일을 열도록 유도해야 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3234 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234)를 참조하십시오.

#### 수식 하위 스트림 메모리 손상 취약점(CVE-2010-3234)에 대한 완화 요소
...
#### 수식 하위 스트림 메모리 손상 취약점(CVE-2010-3234)에 대한 대안
...
#### 수식 하위 스트림 메모리 손상 취약점(CVE-2010-3234)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

취약점의 원인은 무엇입니까?  
Microsoft Excel에서 특수하게 조작된 Excel 파일을 열 때 수식 정보의 유효성을 검사하면 시스템 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
...
업데이트는 어떤 기능을 수행합니까?  
업데이트는 Microsoft Excel에서 수식 정보에 대한 유효성 검사 방식을 수정하여 취약점을 제거합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3235 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235)를 참조하십시오.

#### 수식 BIFF 레코드 취약점(CVE-2010-3235)에 대한 완화 요소
...
#### 수식 BIFF 레코드 취약점(CVE-2010-3235)에 대한 대안
...
#### 수식 BIFF 레코드 취약점(CVE-2010-3235)에 대한 FAQ
...
업데이트는 어떤 기능을 수행합니까?  
업데이트는 Microsoft Excel에서 수식 정보에 대한 유효성 검사 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3236 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236)을 참조하십시오.

#### 범위 초과 배열 취약점(CVE-2010-3236)에 대한 완화 요소
...
#### 범위 초과 배열 취약점(CVE-2010-3236)에 대한 대안
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
#### 범위 초과 배열 취약점(CVE-2010-3236)에 대한 FAQ
...
업데이트는 어떤 기능을 수행합니까?  
업데이트는 Microsoft Excel에서 레코드 정보에 대한 유효성 검사 방식을 수정하여 취약점을 제거합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3237 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237)을 참조하십시오.

#### 셀 병합 레코드 포인터 취약점(CVE-2010-3237)에 대한 완화 요소
...
#### 셀 병합 레코드 포인터 취약점(CVE-2010-3237)에 대한 대안
...
#### 셀 병합 레코드 포인터 취약점(CVE-2010-3237)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3238 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238)을 참조하십시오.

#### 음수 미래 함수 취약점(CVE-2010-3238)에 대한 완화 요소
...
#### 음수 미래 함수 취약점(CVE-2010-3238)에 대한 대안
...
#### 음수 미래 함수 취약점(CVE-2010-3238)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

취약점의 원인은 무엇입니까?  
Microsoft Excel에서 특수하게 조작된 Excel 파일을 열 때 바이너리 파일 형식 정보의 유효성을 검사하면 시스템 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
...
업데이트는 어떤 기능을 수행합니까?  
업데이트는 Microsoft Excel에서 바이너리 파일 형식 정보에 대한 유효성 검사 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3239 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239)를 참조하십시오.

#### 추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)에 대한 완화 요소
...
#### 추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)에 대한 대안
...
#### 추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3240 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240)을 참조하십시오.

#### 실시간 데이터 배열 레코드 취약점(CVE-2010-3240)에 대한 완화 요소
...
#### 실시간 데이터 배열 레코드 취약점(CVE-2010-3240)에 대한 대안
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2007에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
#### 실시간 데이터 배열 레코드 취약점(CVE-2010-3240)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3241 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241)을 참조하십시오.

#### 구문 분석 시 범위 초과 메모리 쓰기 취약점(CVE-2010-3241)에 대한 완화 요소
...
#### 구문 분석 시 범위 초과 메모리 쓰기 취약점(CVE-2010-3241)에 대한 대안
...
#### 구문 분석 시 범위 초과 메모리 쓰기 취약점(CVE-2010-3241)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3242 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242)를 참조하십시오.

#### 삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)에 대한 완화 요소
...
#### 삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)에 대한 대안
...
#### 삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)에 대한 FAQ
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2345017">Microsoft 기술 자료 문서 2345017</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2344893">Microsoft 기술 자료 문서 2344893</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Excel 2007(모든 에디션) 및 Excel Viewer(모든 에디션)
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="https://support.microsoft.com/kb/2345035">Microsoft 기술 자료 문서 2345035</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="https://support.microsoft.com/kb/2345088">Microsoft 기술 자료 문서 2345088</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="https://support.microsoft.com/kb/2344875">Microsoft 기술 자료 문서 2344875</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Excel 레코드 구문 분석 정수 오버플로 취약점(CVE-2010-3230)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Alin Rad Pop  
-   Excel 레코드 구문 분석 메모리 손상 취약점(CVE-2010-3231)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   Excel 파일 형식 구문 분석 취약점(CVE-2010-3232)을 보고해 주신 Omair  
-   Lotus 1-2-3 통합 문서 구문 분석 취약점(CVE-2010-3233)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten H. Eiram  
-   수식 하위 스트림 메모리 손상 취약점(CVE-2010-3234)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   수식 BIFF 레코드 취약점(CVE-2010-3235)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   범위 초과 배열 취약점(CVE-2010-3236)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   셀 병합 레코드 포인터 취약점(CVE-2010-3237)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   음수 미래 함수 취약점(CVE-2010-3238)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Alin Rad Pop  
-   실시간 데이터 배열 레코드 취약점(CVE-2010-3240)을 보고해 주신 [VUPEN Vulnerability Research Team](https://www.vupen.com/)의 Chaouki Bekrar  
-   구문 분석 시 범위 초과 메모리 쓰기 취약점(CVE-2010-3241)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Chaouki Bekrar  
-   삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten H. Eiram
