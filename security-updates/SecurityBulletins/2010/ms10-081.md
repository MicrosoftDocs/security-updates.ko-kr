---
TOCTitle: 'MS10-081'
Title: 'Microsoft 보안 공지 MS10-081 - 중요'
ms:assetid: 'ms10-081'
ms:contentKeyID: 61230342
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-081(v=Security.10)'
---
...
이 보안 업데이트는 Windows 공용 컨트롤이 타사 SVG(scalable vector graphics) 뷰어에서 전달된 메시지를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1&displaylang=ko)                                                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                                 | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45&displaylang=ko)                                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb&displaylang=ko)                                                      | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                             | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd&displaylang=ko)                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb&displaylang=ko)                   | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c&displaylang=ko)\*\*     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da&displaylang=ko)\*\* | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6)            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c&displaylang=ko)                                                                       | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28&displaylang=ko)                                                                     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                                   | 원격 코드 실행 | 중요        | 없음                      |
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-oct)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >Comctl32 힙 오버플로 취약점(CVE-2010-2746)</th>
...
Windows 공용 컨트롤 라이브러리가 타사 SVG(scalable vector graphics) 뷰어를 사용할 때 특수하게 조작된 웹 사이트를 렌더링하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점으로 인해 사용자가 특수하게 조작된 웹 페이지를 방문할 경우 코드 실행이 허용될 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2746 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746)을 참조하십시오.
  
#### Comctl32 힙 오버플로 취약점(CVE-2010-2746)에 대한 완화 요소
...
-   기본 Windows 구성에서는 이 취약점을 악용할 수 없습니다. 취약점이 발생하기 위해서는 SVG(scalable vector graphics)를 렌더링하는 타사 응용 프로그램이 시스템에 설치되어야 합니다.
  
#### Comctl32 힙 오버플로 취약점(CVE-2010-2746)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Comctl32 힙 오버플로 취약점(CVE-2010-2746)에 대한 FAQ
...
취약점의 원인은 무엇입니까?    
타사 SVG(scalable vector graphics) 뷰어에서 전달된 SVG를 렌더링할 때 Windows 공용 컨트롤 라이브러리가 특정 메시지를 적절히 처리하지 않아 취약점이 발생합니다.
  
Windows 공용 컨트롤 라이브러리란 무엇입니까?    
공용 컨트롤은 Windows 운영 체제에 포함되어 있는 DLL인 공용 컨트롤 라이브러리 Comctl32.dll로 구현되는 창 집합입니다. 다른 컨트롤 창과 마찬가지로 공용 컨트롤은 사용자와 상호 작용을 위해 응용 프로그램에서 다른 창과 함께 사용하는 하위 창입니다. 이러한 라이브러리에 대한 자세한 내용은 MSDN 문서, [공용 컨트롤 정보 (영문)](https://msdn.microsoft.com/ko-kr/library/bb775493(vs.85).aspx)를 참조하십시오.
  
기본 Windows 구성에서 이 문제점을 악용할 수 있습니까?    
아니요. 취약점이 발생하기 위해서는 SVG(scalable vector graphics)를 렌더링하는 타사 응용 프로그램이 시스템에 설치되어야 합니다. Microsoft는 시스템에 타사 뷰어가 설치되지 않은 상태에서 공격 경로를 확인하지 못했습니다. SVG 구현 목록은 W3C(World Wide Web Consortium)의 [SVG 구현 (영문)](https://www.w3.org/graphics/svg/wg/wiki/implementations) 목록을 참조하십시오.
  
SVG(Scalable Vector Graphics)란 무엇입니까?    
SVG(Scalable Vector Graphics)는 XML 문서를 사용하여 2차원 벡터 그래픽을 제작하고 배포하기 위한 표준입니다. W3C(World Wide Web Consortium) 권장 사양을 마련하는 데 많은 업계 조직이 동참하고 승인했습니다. SVG는 핵심적으로 SVG 승인 프로세스의 일부로 정의된 스키마를 따르는 XML 문서입니다. 사양에서는 사각형, 원, 타원형, 선, 다중선, 다각형 및 상형 문자(예: 텍스트)와 같은 다양한 기본적인 기하학 도형이 정의되었습니다. 좀더 복잡한 도형은 경로 요소를 사용하여 선, 호 및 복잡한 3차원 곡선의 시퀀스로 도형을 정의할 수 있습니다. 약간의 독창성과 더불어 이러한 기본적인 도형을 사용하면 매우 복잡한 기하학 구조물도 만들 수 있습니다.
...
업데이트는 어떤 기능을 수행합니까?    
업데이트는 Windows 공용 컨트롤 라이브러리가 타사 SVG(scalable vector graphics) 뷰어에서 전달된 특정 메시지를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2296011$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2296011">Microsoft 기술 자료 문서 2296011</a> 참조</td>
</tr>
<tr class="even">
...
-   Comctl32 힙 오버플로 취약점(CVE-2010-2746)을 [Secunia (영문)](https://secunia.com/)와 협력하여 보고해 주신 Krystian Kloskowski(h07)
...
-   V1.0(2010년 10월 14일): 공지가 게시되었습니다.
