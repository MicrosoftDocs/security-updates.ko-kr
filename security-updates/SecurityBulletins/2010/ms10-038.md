...
문제점.[Microsoft 기술 자료 문서 2027452](http://support.microsoft.com/kb/2027452) 는 고객이 보안 업데이트를 할 때 겪을 수 있는 현재까지 알려진 문제점들을 기술하고 있다. 또한 이 문제들을 해결하기 위한 추천 해결책을 기술하고 있다.
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=1b2599f0-1e5d-463c-b100-6c6a1b17b2ec&displaylang=ko)<sup>[1]</sup>
(KB982308)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
Microsoft Office Excel 2003(KB982133) 및 Microsoft Office Excel 2007(KB982308)에 대한 [MS10-036](http://technet.microsoft.com/security/bulletin/ms10-036)의 보안 업데이트 패키지도 이 공지(MS10-038)에서 설명한 취약점을 해결합니다. Microsoft Office Excel 2003 또는 Microsoft Office Excel 2007이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다. 또한 [MS10-036](http://technet.microsoft.com/security/bulletin/ms10-036)은 [MS10-036](http://technet.microsoft.com/security/bulletin/ms10-036)에서 설명한 취약점 해결을 위해 설치해야 하는 Microsoft Office 관련 업데이트(KB982311 또는 KB982312)를 제공합니다.
...
예. Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2(KB982308)에 대한 업데이트 패키지에는 [Microsoft 기술 자료 문서 981046](http://support.microsoft.com/kb/981046)에 설명되어 있는 Excel 2007에 대한 변경 사항이 포함되어 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0821 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0821)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0822 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0823 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0824 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1245 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1246 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1247 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1248 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1249 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1250 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1251 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1252 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1253 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1254 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/982299">Microsoft 기술 자료 문서 982299</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/982133">Microsoft 기술 자료 문서 982133</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="http://support.microsoft.com/kb/982308">Microsoft 기술 자료 문서 982308</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Excel Viewer:<br />
<a href="http://support.microsoft.com/kb/982333">Microsoft 기술 자료 문서 982333</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="http://support.microsoft.com/kb/982331">Microsoft 기술 자료 문서 982331</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.5.9 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=16c71ab8-9284-407a-856a-93c67995f125)에서 다운로드하여 설치하십시오.
...
Microsoft Office 2008 for Mac 12.2.5 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=d46255bd-6470-4106-9fe2-ea67acd3f1bd)에서 다운로드하여 설치하십시오.
...
Open XML File Format Converter for Mac 1.1.5 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=b6ca7b05-cf97-43a2-95eb-7b5caf7c1528)에서 다운로드하여 설치하십시오.
...
-   Excel 레코드 분석 메모리 손상 취약점(CVE-2010-0821)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 개체 스택 오버플로 취약점(CVE-2010-0822)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 메모리 손상 취약점(CVE-2010-0823)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](http://www.fortiguard.com/)의 Bing Liu  
-   Excel 레코드 메모리 손상 취약점(CVE-2010-0824)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 레코드 메모리 손상 취약점(CVE-2010-1245)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel RTD 메모리 손상 취약점(CVE-2010-1246)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 메모리 손상 취약점(CVE-2010-1247)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel HFPicture 메모리 손상 취약점(CVE-2010-1248)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 메모리 손상 취약점(CVE-2010-1249)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel EDG 메모리 손상 취약점(CVE-2010-1250)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 레코드 스택 손상 취약점(CVE-2010-1251)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten Eiram  
-   Excel 문자열 변수 취약점(CVE-2010-1252)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten Eiram  
-   Excel ADO 개체 취약점(CVE-2010-1253)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
