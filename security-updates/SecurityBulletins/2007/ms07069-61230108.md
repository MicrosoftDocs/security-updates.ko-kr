...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 942615](http://support.microsoft.com/kb/942615)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=b3bd16ea-5d69-4ae3-84b3-ab773052ceeb&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=bc8edf05-262a-4d1d-b196-4fc1a844970c&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=6e4ebafc-34c3-4dc7-b712-152c611d3f0a&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=f5a5af23-30fb-4e47-94bd-3b05b55c92f2&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=bf466060-a585-4c2e-a48d-70e080c3bbe7&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=074697f2-18c8-4521-bbf7-1d0e7395d27d&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=b15a6506-02dd-43c2-aef4-e10c1c76ee97&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=c092a6bb-8e62-4d90-bdb1-5f3a15968f75&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=34759c10-16a5-42a2-974d-9d532fb5a0a7&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=7dccce5a-7562-448b-a345-cf1cc758e35c&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=26d303da-bb2e-4555-96f1-becb0e277341&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=c5e88e0b-a4c2-4690-91d9-326800030a16&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
일부 고객은 파일 정보 항목의 크기로 인해 공지를 볼 때 긴 지연 시간을 경험할 수 있습니다. 이러한 지연 시간을 방지하기 위해 파일 정보 세부 사항은 [Microsoft 기술 자료 문서 942615](http://support.microsoft.com/kb/942615)로 이동되었습니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 942615](http://support.microsoft.com/kb/942615)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.

이 공지의 원래 버전이 출시된 이후 알려진 문제점

-   [KB946627](http://support.microsoft.com/kb/946627): Windows XP 서비스 팩 2를 실행하는 컴퓨터에 보안 업데이트 942615를 설치한 다음 Internet Explorer 6에서 충돌이 발생합니다.

**KB946627은 이 릴리스와 어떤 관련이 있습니까?**  
[KB946627](http://support.microsoft.com/kb/946627)은 이 보안 업데이트의 알려진 문제점을 해결합니다. 패키지는 다음 레지스트리 하위 키에 값이 1인 \*이라는 이름의 DWORD 값을 추가합니다.
...
-   이 업데이트는 지원되지 않는 ActiveX 컨트롤, DXTLIPI.DLL에 대해 [킬(kill) 비트](http://support.microsoft.com/kb/240797)를 설정합니다.
    -   {201ea564-a6f6-11d1-811d-00c04fb6db36}
-   이 업데이트는 더 이상 지원되지 않는 ActiveX 컨트롤, HRTBEAT.OCX의 이전 버전에 대해 [킬(kill) 비트](http://support.microsoft.com/kb/240797)를 설정합니다.
...
-   이 보안 업데이트는 Intuit에서 제공하는 ActiveX 컨트롤에 [킬(kill) 비트](http://support.microsoft.com/kb/240797)를 설정합니다. Intuit은 영향을 받는 구성 요소의 취약점을 해결하는 보안 공지와 업데이트를 출시했습니다. 자세한 정보 및 다운로드 위치는 [Intuit (영문)](https://sc.accounting.quickbooks.com/update/index.cfm?id=32)의 보안 공지를 참조하십시오. 이 킬(kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.
...
-   이 보안 업데이트는 Vantage에서 제공하는 ActiveX 컨트롤에 [킬(kill) 비트](http://support.microsoft.com/kb/240797)를 설정합니다. Vantage는 영향을 받는 구성 요소의 취약점을 해결하는 보안 공지와 업데이트를 출시했습니다. 자세한 정보 및 다운로드 위치는 [Vantage (영문)](http://www.vantagelinguistics.com/answerworks/release/)의 보안 공지를 참조하십시오. 이 킬(kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.
...
예, 이 보안 업데이트는 [KB921090](http://support.microsoft.com/kb/921090) 업데이트를 포함합니다.

**KB945007 ‘IE 자동 구성 요소 활성화 미리 보기’가 이 보안 업데이트에 포함되어 있습니까?**    
아니요, [KB945007](http://support.microsoft.com/kb/945007) 업데이트는 이 보안 업데이트에 포함되어 있지 않습니다.  그러나 이후 Internet Explorer 누적 업데이트에는 [KB945007](http://support.microsoft.com/kb/945007)이 포함될 예정입니다. 현재 Internet Explorer에서는 “활성화하려면 클릭하십시오”라는 툴팁이 표시되는 일부 웹 페이지에서 컨트롤을 사용자가 수동으로 활성화해야 합니다. 이 “활성화하려면 클릭하십시오” 동작은 2008년 4월 이후 영구적으로 제거될 예정입니다.

**이 변경 사항에 대해 어떻게 준비해야 합니까?**    
IE 자동 구성 요소 활성화(IE ACA) 미리 보기를 사용하여 웹 사이트와 응용 프로그램을 테스트하도록 권장합니다. IE ACA 미리 보기([KB945007](http://support.microsoft.com/kb/945007))를 적용하려면 이 보안 업데이트를 먼저 적용해야 합니다. 이 변경 사항에 대한 추가 정보 및 상세한 가이드에 관심 있는 고객은 IE 자동 구성 요소 활성화 문서를 계속 모니터링하여 이 릴리스에 대해 업데이트되는 추가 정보를 확인하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3902 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3902)를 참조하십시오.
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](http://msdn2.microsoft.com/ko-kr/library/ms537180.aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역이 보안 수준을 높음으로 설정합니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
...
예. 기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](http://msdn2.microsoft.com/ko-kr/library/ms537180.aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](http://www.microsoft.com/downloads/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)도 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3903 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3903)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-5344 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5344)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-5347 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5347)을 참조하십시오.
...
이 공지의 영어 버전 파일은 [KB942615](http://support.microsoft.com/kb/942615)에 나열되어 있습니다. 이러한 파일의 날짜와 시간은 UTC(Coordinated Universal Time) 기준입니다. 파일 정보를 볼 때 로컬 시간으로 변환됩니다. UTC와 로컬 시간의 차이를 확인하려면 제어판의 날짜 및 시간 도구에서 **표준 시간대** 탭을 사용하십시오.

지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4, [KB942615](http://support.microsoft.com/kb/942615) 참조

지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1, [KB942615](http://support.microsoft.com/kb/942615) 참조
...
지원되는 모든 Windows XP 에디션용 Internet Explorer 6 및 Internet Explorer 7, [KB942615](http://support.microsoft.com/kb/942615) 참조
...
지원되는 모든 Windows Server 2003 에디션용 Internet Explorer 6 및 Internet Explorer 7, [KB942615](http://support.microsoft.com/kb/942615) 참조
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고</strong>: 이 패치가 있는지 확인하는 레지스트리 키는 없습니다. 패치를 검색하려면 <a href="http://msdn2.microsoft.com/ko-kr/library/aa384642.aspx">WMI(Windows Management Instrumentation) (영문)</a>를 사용합니다.</td>
</tr>
</tbody>
</table>
...
지원되는 모든 Windows Vista 에디션용 Internet Explorer 7, [KB942615](http://support.microsoft.com/kb/942615)참조
...
-   초기화되지 않은 메모리 손상 취약점(CVE-2007-3902)을 보고해 주신 [iDefense VCP (영문)](http://idefense.com/)와 이를 해결하기 위해 협력해 주신 Peter Vreugdenhil  
-   초기화되지 않은 메모리 손상 취약점(CVE-2007-3902)을 해결하기 이해 협력해 주신 [TippingPoint (영문)](http://www.tippingpoint.com/)의 익명 연구자 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)  
-   초기화되지 않은 메모리 손상 취약점(CVE-2007-3903)을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 이를 해결하기 위해 협력해 주신 Sam Thomas  
-   초기화되지 않은 메모리 손상 취약점(CVE-2007-5344)을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 이를 해결하기 위해 협력해 주신 Peter Vreugdenhil
