...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 917537](https://support.microsoft.com/kb/917537)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 917953](https://support.microsoft.com/kb/917537)을 참조하십시오.

**테스트된 소프트웨어 및 보안 업데이트 다운로드 위치:**

**영향을 받는 소프트웨어:**

-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c917d6da-da2d-402c-a870-1de3cbd21ebf)
-   Microsoft Windows XP Professional 서비스 팩 1 및 Microsoft Windows XP Professional 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=55d3ca3a-97fc-4e22-8ecc-9416ebc993c4)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=4e19b792-7505-4453-b460-5a16915443db)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c5e274a8-f962-4944-8878-6b88b1592bbf)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 서비스 팩 1(Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e2dc245e-d0f3-41b9-b090-68a2118001cb)
-   Microsoft Windows Server 2003 x64 Edition 제품군 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f29c886d-b896-4fcf-a22b-2c1a53b1a9eb)
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| 조작된 ASP(Active Server Pages)를 사용하는 인터넷 정보 서비스 취약점 - [CVE-2006-0026 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0026) | 원격 코드 실행       | 보통                                                                   | 중요                                                                                                                                                                     | 중요                                                                    |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 917537](https://support.microsoft.com/kb/917537)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 917537](https://support.microsoft.com/kb/917537)을 참조하십시오.
...
이 보안 업데이트는 Asp.dll 파일 버전 6.0.3790.1830이 있는 시스템에서 핫패칭을 지원합니다. 핫패칭을 사용할 경우 Microsoft Windows Server 2003 서비스 팩 1을 실행하는 시스템에서 서버를 다시 시작하지 않고 보안 업데이트를 설치할 수 있습니다. 핫패칭에 대한 자세한 내용 및 핫패칭을 사용하여 보안 업데이트를 배포하는 방법은 [Microsoft 기술 자료 문서 897341](https://support.microsoft.com/kb/897341)을 참조하십시오.
...
-   조작된 ASP(Active Server Pages)를 사용하는 인터넷 정보 서비스 취약점 - [CVE-2006-0026 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0026)을 보고해 주신 [Security-Assessment.com (영문)](https://security-assessment.com/)의 Brett Moore
