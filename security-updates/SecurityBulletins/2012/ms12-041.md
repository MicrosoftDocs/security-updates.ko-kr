...
<td style="border:1px solid black;">
[MS12-018](http://go.microsoft.com/fwlink/?linkid=235364)의 KB2641653은 KB2709162로 대체되었습니다.
</td>
</tr>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1864(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1865(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1866(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1867(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1868(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2709162">Microsoft 기술 자료 문서 2709162</a> 참조</td>
</tr>
<tr class="even">
...
-   문자열 Atom 클래스 이름 처리 취약점(CVE-2012-1864)을 보고해 주신 [Azimuth Security(영문)](http://www.azimuthsecurity.com/)의 Tarjei Mandt  
-   Win32k.sys 경쟁 조건 취약점(CVE-2012-1865)을 보고해 주신 [Azimuth Security](http://www.azimuthsecurity.com/)(영문)의 Tarjei Mandt  
-   클립보드 형식 Atom 이름 처리 취약점(CVE-2012-1866)을 보고해 주신 [Azimuth Security](http://www.azimuthsecurity.com/)(영문)의 Tarjei Mandt  
-   글꼴 리소스 Refcount 정수 오버플로 취약점(CVE-2012-1867)을 보고해 주신 [Google Inc(영문).](http://www.google.com)의 [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org)(영문)
