...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=fa8d18ec-ebf4-4c49-afa0-f6a215b3624f&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c5bcf2db-adce-42bd-abee-1380f258158b&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c54bb4ba-fb9b-4615-9bbe-ef6d3885467d)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=44275ecb-2e79-4ce8-8269-e81219ce8f6c&displaylang=ko)
-   Itanium 기반 시스템용 Microsoft Windows Server 2003 및 Itanium 기반 시스템용 Microsoft Windows Server 2003 SP1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=97a903bc-90e1-4fde-9487-1816c4a647bb)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=52167b42-8790-4965-9f26-dc5edc2e84f8)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">색상 관리 모듈 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1219">CAN-2005-1219 (영문)</a></td>
...
아니요. Windows 98, Windows 98 Second Edition 또는 Windows Millennium Edition은 해당 구성 요소를 포함하고 있지만 취약점이 긴급하지는 않습니다. 치명적인 공격 경로를 통해서는 공격 가능하지 않기 때문입니다. 심각도에 대한 자세한 내용은 [여기](https://www.microsoft.com/korea/technet/security/policy/rating.asp)를 참조하십시오.
...
Microsoft 색상 관리 모듈은 운영 체제에서 다른 장치 및 응용 프로그램 간에 일정한 색상 매핑을 지원하도록 해 줍니다. 또한 이 모듈은 하나의 색상 공간에서 다른 색상 공간(예: RGB - CMYK)으로 색상을 변환할 때 사용됩니다. 색상 관리에 대한 자세한 내용은 다음 [웹 사이트 (영문)](https://www.microsoft.com/whdc/device/display/color/icmwp.mspx)를 방문하십시오.
  
**ICC(International Color Consortium)란무엇입니까?**  
ICC(International Color Consortium)는 공급업체간 호환성을 보장하기 위해 색상 관리를 구현하는 공급업체 간 표준을 제공하는 조직입니다. ICC(International Color Consortium)에 대한 자세한 내용은 다음 [웹 사이트 (영문)](https://www.color.org/)를 방문하십시오.
...
-   색상 관리 모듈 취약점(CAN-2005-1219)을 보고해 주신 [ICST(nformation & Communication Security Technology Center) (중문)](https://www.icst.org.tw)의 Shih-hao Weng님께 감사드립니다.
