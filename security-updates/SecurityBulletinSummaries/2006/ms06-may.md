...
-   [PC 보호 웹 사이트](http://www.microsoft.com/korea/athome/security/protect/windowsxpsp2/default.mspx)를 방문하십시오.
...
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Exchange의 취약점으로 인한 원격 코드 실행 문제점 (916803)**](http://technet.microsoft.com/security/bulletin/ms06-019)                                    |
| **요약**                   | Microsoft Exchange에 원격 코드 실행을 허용할 수 있는 취약점이 존재합니다.                                                                                             |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                         |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                        |
| **영향을 받는 소프트웨어** | **Exchange.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-019)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 공지 번호                  | Microsoft 보안 공지 MS06-020                                                                                                                                         |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Adobe사의 Macromedia Flash Player의 취약점으로 인한 원격 코드 실행 문제점 (913433)**](http://technet.microsoft.com/security/bulletin/ms06-020)                    |
| **요약**                   | Adobe의 Macromedia Flash Player에 원격 코드 실행을 허용할 수 있는 취약점이 존재합니다.                                                                               |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                        |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                       |
| **영향을 받는 소프트웨어** | **Windows.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-020)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Distributed Transaction Coordinator의 취약점으로 인한 서비스 거부 문제점 (913580)**](http://technet.microsoft.com/security/bulletin/ms06-018)                                                     |
...
| **취약점으로 인한 영향**   | 서비스 거부                                                                                                                                                                                                    |
| **영향을 받는 소프트웨어** | **Windows.** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms06-018)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오.                                           |
...
-   [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018)에서 설명한 문제점을 보고해 주신 [eEye Digital Security (영문)](http://www.eeye.com/html/).
-   [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018)에서 설명한 문제점을 보고해 주신 [McAfee](http://www.mcafee.com)의 Xiao Chen.
-   [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018)에서 설명한 문제점을 보고해 주신 [VenusTech (영문)](http://www.venustech.com.cn)의 Kai Zhang.

**기타 보안 관련 업데이트 받기:**

기타 보안 문제 관련 업데이트는 다음 사이트에서 구할 수 있습니다.

-   [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/results.aspx?displaylang=ko%20&freetext=security_patch)에서 다운로드할 수 있으며 "security\_patch"라는 키워드를 사용하여 쉽게 찾을 수 있습니다.
