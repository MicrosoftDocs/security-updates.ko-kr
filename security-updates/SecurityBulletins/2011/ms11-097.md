---
TOCTitle: 'MS11-097'
Title: 'Microsoft 보안 공지 MS11-097 - 중요'
ms:assetid: 'ms11-097'
ms:contentKeyID: 61230464
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-097(v=Security.10)'
---


Microsoft 보안 공지 MS11-097 - 중요
===================================
...
이 보안 업데이트는 CSRSS(Client/Server Run-time Subsystem)가 프로세스 간 장치 이벤트 메시지 권한을 평가하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|-----------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=edb594a4-14d2-4ffe-8d1c-2c283689fe8c&displaylang=ko)                                                                               | 권한 상승      | 중요        | [MS11-010](https://go.microsoft.com/fwlink/?linkid=207840) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9e1273e2-7775-40b4-b939-ab530677cd4a)                                                                     | 권한 상승      | 중요        | [MS11-010](https://go.microsoft.com/fwlink/?linkid=207840) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a14057e5-e2c2-4dde-8d26-542a9f162e98&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS11-010](https://go.microsoft.com/fwlink/?linkid=207840) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7f595fd6-bdfd-4075-97e5-70efb7d49dff&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-010](https://go.microsoft.com/fwlink/?linkid=207840) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=147ec6d3-3401-4aa3-a409-55346bcc7bd7)                                                                      | 권한 상승      | 중요        | [MS11-010](https://go.microsoft.com/fwlink/?linkid=207840) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fa6e6d91-4aca-49a6-a6e8-c33ec413097e&displaylang=ko)                                                                            | 권한 상승      | 중요        | 없음                                                      |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c9794756-803d-48ba-86db-350fb577f01b&displaylang=ko)                                                                | 권한 상승      | 중요        | 없음                                                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6f934885-b134-400c-a452-50fd4eeedd5e&displaylang=ko)\*                                                   | 권한 상승      | 중요        | 없음                                                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7ade3832-bc20-4fce-8eac-8a3d072d2f1c&displaylang=ko)\*                                                 | 권한 상승      | 중요        | 없음                                                      |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4bd7a02b-c6d8-4eb5-a46d-e494a1233dc8)                                                              | 권한 상승      | 중요        | 없음                                                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0666bdf5-9eed-44c9-84ee-b45f9b3e14b3&displaylang=ko)                                 | 권한 상승      | 중요        | 없음                                                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=620f94f9-1f61-45a0-a22e-e7510b56b9b8&displaylang=ko)                             | 권한 상승      | 중요        | 없음                                                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=04878e9a-539a-4549-a5af-11d45add91da&displaylang=ko)\* | 권한 상승      | 중요        | 없음                                                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=5b2ebec4-cebb-47b6-864a-12d59a9a3e18)          | 권한 상승      | 중요        | 없음                                                      |
...
<th style="border:1px solid black;" >CSRSS 로컬 권한 상승 취약점(CVE-2011-3408)</th>
...
CSRSS 로컬 권한 상승 취약점(CVE-2011-3408)  
------------------------------------------
  
CSRSS(Client/Server Run-time Subsystem)에 권한 상승 취약점이 존재하며 이 취약점으로 인해 임의 코드가 다른 프로세스의 컨텍스트에서 실행됩니다. 이 프로세스가 관리자 권한으로 실행되는 경우 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경 또는 삭제하거나 모든 사용자 권한이 있는 새 계정을 만들 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-3408(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3408)을 참조하십시오.
  
#### CSRSS 로컬 권한 상승 취약점(CVE-2011-3408)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### CSRSS 로컬 권한 상승 취약점(CVE-2011-3408)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### CSRSS 로컬 권한 상승 취약점(CVE-2011-3408)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이 취약점은 권한 상승 취약점입니다.
  
취약점의 원인은 무엇입니까?   
이 취약점은 무결성이 낮은 프로세스가 무결성이 높은 프로세스로 장치 이벤트 메시지를 전달할 경우에 CSRSS가 권한의 유효성을 잘못 검사하기 때문에 발생합니다.
  
이 취약점의 영향을 받는 구성 요소는 무엇입니까?   
Csrsrv.dll이 취약점의 영향을 받는 구성 요소입니다.
  
CSRSS(Client Server Run-Time Subsystem)란 무엇입니까?   
CSRSS(Client/Server Run-time Subsystem)는 Win32 하위 시스템의 사용자 모드 부분입니다. CSRSS는 항상 실행되어야 하는 핵심적인 하위 시스템의 하나입니다. CSRSS는 콘솔 창과 스레드의 생성 및/또는 삭제를 담당합니다.
...
이 취약점을 악용하려면 공격자가 먼저 시스템에 로그온해야 합니다. 이렇게 되면 공격자가 무결성이 높은 프로세스에 장치 이벤트 메시지를 보내도록 특수하게 조작된 응용 프로그램을 실행할 수 있습니다.
  
취약점으로 인해 위험에 노출되는 시스템은 주로 무엇입니까?   
워크스테이션과 서버가 이 취약점에 대한 위험에 노출되어 있습니다.
  
업데이트는 어떤 기능을 수행합니까?   
업데이트는 CSRSS가 프로세스 간 장치 이벤트 메시지 권한을 평가하는 방법을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2620712$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2620712">Microsoft 기술 자료 문서 2620712</a> 참조</td>
</tr>
<tr class="even">
...
-   CSRSS 로컬 권한 상승 취약점(CVE-2011-3408)을 보고해 주신 Winsider Seminars & Solutions Inc.의 Alex Ionescu
...
[Microsoft MAPP(Active Protections Program) 파트너](https://go.microsoft.com/fwlink/?linkid=215201)(영문)
