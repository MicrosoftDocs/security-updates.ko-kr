...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2508062](http://support.microsoft.com/kb/2508062)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0029 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)가 지정되었습니다.
...
<td style="border:1px solid black;">원격 데스크톱 연결 5.2:<br />
<a href="http://support.microsoft.com/kb/2483618">Microsoft 기술 자료 문서 2483618</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 및 원격 데스크톱 연결 6.1:<br />
<a href="http://support.microsoft.com/kb/2481109">Microsoft 기술 자료 문서 2481109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 7.0:<br />
<a href="http://support.microsoft.com/kb/2483614">Microsoft 기술 자료 문서 2483614</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 클라이언트 Multilingual User Interface(MUI):<br />
<a href="http://support.microsoft.com/kb/2483619">Microsoft 기술 자료 문서 2483619</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2481109">Microsoft 기술 자료 문서 2481109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2483614">Microsoft 기술 자료 문서 2483614</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
-   원격 데스크톱의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0029)을 보고해 주신 [Versafe Anti Fraud (영문)](http://www.versafe-login.com/)의 Eyal Gruner
