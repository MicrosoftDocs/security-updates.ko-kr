...
**문제점.** [Microsoft 기술 자료 문서 949032](https://support.microsoft.com/kb/949032)는 고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 현재까지 알려진 문제점과 권장 해결 방법을 다룹니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 949032](https://support.microsoft.com/kb/949032)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1089 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1090 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/949032">Microsoft 기술 자료 문서 949032</a>를 참조하십시오.</td>
</tr>
<tr class="even">
