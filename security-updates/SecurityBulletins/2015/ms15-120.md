...
<td style="border:1px solid black;">
[**Windows IPSec 서비스 거부 취약성(CVE-2015-6111)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-6111)
...
이 취약성은 공개적으로 보고되었습니다. 이 취약성에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2015-6111](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-6111)(영문)이 할당되었습니다. 이 보안 공지를 처음에 게시했을 때 Microsoft는 이 취약성을 악용하려는 공격에 대해 보고받은 바 없습니다.
