...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=e0678d14-c1b5-457a-8222-8e7682760ed4&displaylang=ko)                                                | 원격 코드 실행 | 긴급        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=eeafcdc5-df39-4b29-b6f1-7d32b64761e1&displaylang=ko)                                  | 원격 코드 실행 | 긴급        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=26898401-f669-4542-ad93-199ed1fe9a2a)           | 원격 코드 실행 | 긴급        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=588ca8e8-38a9-47ed-9c41-09aaf1022e49&displaylang=ko)                | 원격 코드 실행 | 긴급        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee59441c-1e8f-4425-ae8d-dec14e7f13fb&displaylang=ko)    | 원격 코드 실행 | 긴급        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=caec9321-fa5b-42f0-9f26-61f673fe6eef) | 원격 코드 실행 | 긴급        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=9179c463-c10a-452a-990f-b7e37cdd889b&displaylang=ko)                                        | 원격 코드 실행 | 보통        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=6b26952e-b59d-4b0f-a52d-025e45ecd233&displaylang=ko)                | 원격 코드 실행 | 보통        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2008 (32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=7245b411-7c9e-41e5-9841-4c586336086c&displaylang=ko)\*                                           | 원격 코드 실행 | 보통        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2008 (x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=a241eaad-95a0-442b-978f-f21a6f0c7db4&displaylang=ko)\*                                         | 원격 코드 실행 | 보통        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2008 (Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=ab7c7015-20bb-4a0c-977a-969f4e2a5189)                                                      | 원격 코드 실행 | 보통        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 958687](http://support.microsoft.com/kb/958687)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4834 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4834)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4835 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4835)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4114 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4114)를 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-4114 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4114)가 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/958687">Microsoft 기술 자료 문서 958687</a> 참조</td>
</tr>
<tr class="even">
...
-   SMB 버퍼 오버플로 원격 코드 실행 취약점(CVE-2008-4834)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   SMB 유효성 검사 오버플로 원격 코드 실행 취약점(CVE-2008-4835)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
