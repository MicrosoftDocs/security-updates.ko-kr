...
The [Windows Server Update Services 3.0 Operations Guide](https://go.microsoft.com/fwlink/?linkid=81072) (https://go.microsoft.com/fwlink/?LinkId=81072) includes other types of migration documentation, such as migrating from Windows 내부 데이터베이스 to Microsoft SQL Server.
