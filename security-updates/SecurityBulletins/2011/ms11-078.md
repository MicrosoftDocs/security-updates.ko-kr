...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2604930](http://support.microsoft.com/kb/2604930)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS09-061](http://technet.microsoft.com/ko-kr/security/bulletin/ms09-061)의 KB953295는 KB2572066으로 대체되었습니다.  
[MS10-070](http://technet.microsoft.com/ko-kr/security/bulletin/ms10-070)의 KB2416447는 KB2572067로 대체되었습니다.  
[MS10-060](http://technet.microsoft.com/ko-kr/security/bulletin/ms10-060)의 KB983583는 KB2572073로 대체되었습니다.  
...
<td style="border:1px solid black;">
[MS09-061](http://technet.microsoft.com/ko-kr/security/bulletin/ms09-061)의 KB953298는 KB2572069로 대체되었습니다.  
[MS10-060](http://technet.microsoft.com/ko-kr/security/bulletin/ms10-060)의 KB983583는 KB2572073로 대체되었습니다.  
KB2572078로 대체된 공지는 없습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-070](http://technet.microsoft.com/ko-kr/security/bulletin/ms10-070)의 KB2416447는 KB2572067로 대체되었습니다.  
[MS10-060](http://technet.microsoft.com/ko-kr/security/bulletin/ms10-060)의 KB983589는 KB2572075로 대체되었습니다.  
KB2572078로 대체된 공지는 없습니다.
</td>
</tr>
<tr>
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](http://technet.microsoft.com/security/bulletin/ms11-oct.mspx)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1253)(영문)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 보안 강화 구성으로 알려진 제한된 모드로 실행됩니다. 이 모드는 Windows Server 2008 및 Windows Server 2008 R2의 웹 탐색 공격 시나리오에서만 이 취약점을 완화합니다. Internet [Explorer 보안 강화](http://go.microsoft.com/fwlink/?linkid=92039) 구성에 대한 자세한 내용은 이 취약점의 FAQ 섹션을 참조하십시오.
...
예. 기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. CVE-2011-1253의 경우 보안 강화 구성은 Windows Server 2008 및 Windows Server 2008 R2의 웹 탐색 공격 시나리오에서만 이 취약점을 완화합니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2604930">Microsoft 기술 자료 문서 2604930</a> 참조</td>
</tr>
<tr class="odd">
...
-   .NET Framework 클래스 상속 취약점(CVE-2011-1253)을 [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) 프로그램과 협력하여 보고해 주신 익명 기여자
