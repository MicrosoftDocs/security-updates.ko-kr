...
<td style="border:1px solid black;">
[MS12-055](https://go.microsoft.com/fwlink/?linkid=257907)의 KB2731847은 KB2761226으로 대체되었습니다.
</td>
</tr>
...
예. Windows 8 Release Preview 및 Windows Server 2012 출시 후보 버전에서 KB2761226 업데이트를 사용할 수 있습니다. Windows 8 Release Preview와 Windows Server 2012 출시 후보 버전을 보유한 고객은 시스템에 이 업데이트를 적용하는 것이 좋습니다. 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 제공됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530)(영문)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553)(영문)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2761226">Microsoft 기술 자료 문서 2761226</a> 참조</td>
</tr>
<tr class="even">
...
| 파일 정보             | [Microsoft 기술 자료 문서 2761226](https://support.microsoft.com/kb/2761226) 참조                                           |
...
-   Windows 커널 win32k.sys 해제 후 사용 취약점(CVE-2012-2553)을 보고해 주신 [Google Inc](https://www.google.com)의 Matthew Jurczyk  
-   TrueType 글꼴 구문 분석 취약점(CVE-2012-2897)을 Chromium Security Rewards Program과 협력하여 보고해 주신 [Documill](https://www.documill.com)의 Eetu Luodemaa와 Joni Vähämäki
