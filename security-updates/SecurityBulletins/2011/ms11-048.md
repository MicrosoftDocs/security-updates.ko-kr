...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5f0007c3-8d11-4940-8766-1112e3777aae)                                                     | 서비스 거부    | 중요        | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fadf6f12-1f09-4d49-93b1-8fce01400b4f)                             | 서비스 거부    | 중요        | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8960dd62-7cf7-41cb-97b2-b082bd1750aa)\*                 | 서비스 거부    | 중요        | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0abc6908-ac6a-4da3-843a-af6841ccc1db)\*             | 서비스 거부    | 중요        | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=057f1356-9c70-4457-a1df-69334fdab467)       | 서비스 거부    | 중요        | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cf9e5ecd-68f7-4982-b4ed-be80859b757c)                                       | 서비스 거부    | 중요        | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=2707650a-604c-4044-acc4-07a30b5640d8)                                   | 서비스 거부    | 중요        | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=f9824310-772d-4e1e-980e-11e2db3ac53e)\*       | 서비스 거부    | 중요        | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0533d293-e186-4d39-a925-ab3d9ed46290) | 서비스 거부    | 중요        | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1267 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1267)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2536275">Microsoft 기술 자료 문서 2536275</a> 참조</td>
</tr>
<tr class="odd">
