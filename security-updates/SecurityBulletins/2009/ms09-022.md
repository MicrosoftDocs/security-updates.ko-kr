---
TOCTitle: 'MS09-022'
Title: 'Microsoft 보안 공지 MS09-022 - 긴급'
ms:assetid: 'ms09-022'
ms:contentKeyID: 61230208
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-022(v=Security.10)'
---


Microsoft 보안 공지 MS09-022 - 긴급
===================================

Windows 인쇄 스풀러 취약점으로 인한 원격 코드 실행 문제점(961501)
-----------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원되는 모든 Microsoft Windows 2000 에디션에 대해서는 긴급이고 지원되는 모든 Windows XP 및 Windows Server 2003 에디션에 대해서는 보통이며 지원되는 모든 Windows Vista 및 Windows Server 2008 에디션에 대해서는 중요입니다. 자세한 내용은 이 섹션의 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 업데이트는 인쇄 스풀러가 특정 인쇄 데이터 구조를 구문 분석하는 방식을 변경하고, Windows 인쇄 서비스가 구분 페이지 또는 포함된 파일을 읽을 수 있는 위치를 제한하고, 인쇄 스풀러가 DLL을 로드할 수 있는 경로를 제한하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.**  이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 961501](https://support.microsoft.com/kb/961501)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=86378753-db24-44c2-a27d-cc0239f40ab8&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS07-021](https://technet.microsoft.com/security/bulletin/ms07-021) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=f2119aca-a98e-4810-be52-f38241443baf&displaylang=ko)                                                          | 권한 상승      | 보통        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=22699d09-1e68-456a-8733-bfad6667ebf5)                                                                          | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=865414f8-3f77-4fee-acc6-6684a3dc0aa4&displaylang=ko)                                                                           | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=197a6cc7-4ba3-4d2e-b621-0ef3da645ef2&displaylang=ko)                                                               | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=719efd62-fb33-447d-b6dd-2aaafbbad881)                                                                           | 권한 상승      | 보통        | 없음                                                                |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3ad8f037-2434-4dea-bfc3-9d3b4008b828&displaylang=ko)                                     | 권한 상승      | 중요        | 없음                                                                |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=85c317cd-2a14-4747-9f50-3af3ddd3ae1b&displaylang=ko) | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0f18356d-9f09-4d24-8361-970c0d1ccac4&displaylang=ko)\*                | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7d0a6e8d-a31d-4f3d-a7d7-e61215bfebed&displaylang=ko)\*            | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bbac3deb-6c93-45aa-832c-02b915ac7f44)                     | 권한 상승      | 중요        | 없음                                                                |
...
예. 이 공지의 취약점 정보 섹션에 나열된 변경 사항 외에, 이 보안 업데이트는 구분 파일 및 @F*pathname* 포함 파일이 위치하는 경로를 제한합니다. 이 업데이트를 설치하기 전에는 위치에 상관없이 포함된 파일이 있는 구분 페이지를 적용할 수 있습니다.이 업데이트를 설치한 후에는 제한된 위치에 포함된 파일이 있는 구분 페이지만 인쇄됩니다. 이러한 파일의 적절한 위치에 대한 자세한 내용은 [Microsoft 기술 자료 문서 102712](https://support.microsoft.com/kb/102712)를 참조하십시오.
...
<th style="border:1px solid black;" >인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)</th>
<th style="border:1px solid black;" >인쇄 스풀러 파일 읽기 취약점(CVE-2009-0229)</th>
<th style="border:1px solid black;" >인쇄 스풀러 라이브러리 로드 취약점(CVE-2009-0230)</th>
...
인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)  
-----------------------------------------------
  
Windows 인쇄 스풀러에 인증되지 않은 원격 공격자가 영향을 받는 시스템에서 임의 코드를 실행할 수 있는 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0228 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0228)을 참조하십시오.
  
#### 인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)에 대한 완화 요소
...
#### 인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)에 대한 대안
...
-   **Microsoft Windows 2000 Server 서비스 팩 4의 경우 NullSessionPipes 레지스트리 키에서 인쇄 스풀러 서비스를 제거합니다.**
  
    Microsoft Windows 2000 Server 서비스 팩 4는 영향을 받는 서비스에 대한 익명 연결을 허용합니다. 익명의 공격자가 이 취약점을 악용하지 못하도록 하려면 NullSessionPipes 하위 키에서 인쇄 스풀러 서비스를 제거하십시오. 이 대안은 인증된 사용자의 공격은 차단하지 못합니다. 프린터 스풀러 서비스를 비활성화할 수 없는 경우에만 이 대안을 사용합니다.
...
-   **인쇄 스풀러 서비스 사용 안 함**
    ...
    **대안 실행 취소 방법.**
    ...
    인쇄 스풀러 서비스를 사용하도록 설정하려면 다음 단계를 수행하십시오.
  
    1.  **시작**, **제어판**을 차례로 클릭합니다. 또는 **설정**을 가리킨 다음 **제어판**을 클릭합니다.  
    2.  **관리 도구**를 두 번 클릭합니다.  
    3.  **서비스**를 두 번 클릭합니다.  
    4.  **인쇄 스풀러**를 두 번 클릭합니다.  
    5.  **시작 유형 목록**에서 **자동**을 클릭합니다.  
    6.  **시작**을 클릭한 다음 **확인**을 클릭합니다.
  
#### 인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 인쇄 스풀러가 특정 인쇄 데이터 구조를 잘못 구문 분석하여 버퍼 오버플로가 발생합니다.
  
**인쇄 스풀러 서비스란 무엇입니까?**    
인쇄 스풀러 서비스는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 자세한 내용은 TechNet 문서 [How Network Printing Works(네트워크 인쇄 작동 방식) (영문)](https://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true)를 참조하십시오.
...
원격 코드 실행을 위해 공격자는 먼저 영향을 받는 시스템에서 액세스할 수 있는 악성 인쇄 서버를 설치해야 합니다. 그러면 공격자는 특수하게 조작된 RPC 요청을 영향을 받는 시스템으로 보낼 수 있습니다. 이 요청으로 인해 영향을 받는 시스템이 열거 중에 공격자의 인쇄 서버에서 ShareName의 구문을 제대로 분석하지 못합니다. 이로 인해 공격자는 시스템 수준 권한으로 영향을 받는 시스템에서 원격 코드를 실행할 수 있게 됩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 인쇄 스풀러가 특정 인쇄 데이터 구조를 구문 분석하는 방식을 변경하여 취약점을 해결합니다.
...
인쇄 스풀러 파일 읽기 취약점(CVE-2009-0229)  
-------------------------------------------
  
Windows 인쇄 서비스에 사용자가 시스템에서 파일을 읽거나 인쇄할 수 있도록 하는 인증된 로컬 정보 유출 취약점이 존재합니다. 사용자에게 관리 액세스 권한이 없더라도 이 작업을 수행할 수 있습니다. 그러나 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0229 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0229)를 참조하십시오.
  
#### 인쇄 스풀러 파일 읽기 취약점(CVE-2009-0229)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### 인쇄 스풀러 파일 읽기 취약점(CVE-2009-0229)에 대한 대안
...
#### 인쇄 스풀러 파일 읽기 취약점(CVE-2009-0229)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이는 \\lang1042\\f5 정보 유출 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 해당 시스템에서 파일을 읽거나 인쇄할 수 있습니다. 사용자에게 관리 액세스 권한이 없더라도 이 작업을 수행할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 인쇄 서비스에서 구분 페이지에 포함될 수 있는 파일을 제대로 확인하지 않습니다.
  
**인쇄 스풀러 서비스란 무엇입니까?**    
인쇄 스풀러 서비스는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 자세한 내용은 TechNet 문서 [How Network Printing Works(네트워크 인쇄 작동 방식) (영문)](https://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true)를 참조하십시오.
  
**구분 페이지란 무엇입니까?**    
구분 또는 배너 페이지는 일반적으로 프린터로 문서를 보낸 사람과 인쇄 날짜 및 시간을 알려줍니다. 표준 구분 페이지 중 하나를 사용하거나 사용자 지정 페이지를 만들 수 있습니다. Windows의 %systemroot%\\System32 폴더에서 세 개의 구분 페이지 파일이 제공됩니다. 자세한 내용은 TechNet 문서 [Using separator pages(구분 페이지 사용) (영문)](https://technet.microsoft.com/en-us/library/cc737357.aspx)를 참조하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점을 성공적으로 악용한 공격자는 영향을 받는 시스템에서 파일을 읽거나 인쇄할 수 있습니다.그러나 파일 내용을 변경할 수는 없습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하려면 공격자가 먼저 시스템에 로그온해야 합니다.그런 다음 공격자는 인쇄 요청에 포함하려는 시스템의 파일이 포함된 특수하게 조작된 구분 페이지를 만들 수 있습니다.
  
모든 버전의 Microsoft Windows에서 공격자는 이 문제를 악용하기 위해 "프린터 관리" 권한이 필요합니다. Windows Vista 및 Windows Server 2008에서는 로컬 프린터를 설치할 때 로컬 사용자에게 이 권한이 자동으로 부여됩니다. 프린터 드라이버가 기본적으로 포함되어 있는 경우에는 관리 권한 없이도 이러한 작업이 진행될 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
워크스테이션과 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows 인쇄 서비스에서 구분 페이지 및 포함된 파일을 읽는 위치를 제한하여 취약점을 해결합니다.
...
인쇄 스풀러 라이브러리 로드 취약점(CVE-2009-0230)  
-------------------------------------------------
  
Windows 인쇄 스풀러에에 임의의 DLL(동적 연결 라이브러리)을 인쇄 스풀러가 로드할 수 있도록 하는 인증된 원격 권한 상승 취약점이 존재합니다.이 취약점 악용에 성공한 공격자는 상승된 권한을 사용하여 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0230 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0230)을 참조하십시오.
  
#### 인쇄 스풀러 라이브러리 로드 취약점(CVE-2009-0230)에 대한 완화 요소
...
-   모든 버전의 Microsoft Windows에서 공격자는 이 취약점을 악용하기 위해 "프린터 관리" 권한이 필요합니다.Microsoft Windows Vista 및 Windows Server 2008에서는 로컬 프린터를 설치할 때 로컬 사용자에게 이 권한이 자동으로 부여됩니다.프린터 드라이버가 기본적으로 포함되어 있는 경우에는 관리 권한 없이도 이러한 작업이 진행될 수 있습니다.
  
#### 인쇄 스풀러 라이브러리 로드 취약점(CVE-2009-0230)에 대한 대안
...
#### 인쇄 스풀러 라이브러리 로드 취약점(CVE-2009-0230)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 인쇄 스풀러가 DLL이 로드될 수 있는 경로의 유효성을 제대로 검사하지 않습니다.
  
**인쇄 스풀러 서비스란 무엇입니까?**    
인쇄 스풀러 서비스는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 자세한 내용은 TechNet 문서 [How Network Printing Works(네트워크 인쇄 작동 방식) (영문)](https://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true)를 참조하십시오.
  
**DLL이란 무엇입니까?**    
DLL(동적 연결 라이브러리)은 다른 모듈(응용 프로그램 또는 DLL)에 의해 사용될 수 있는 함수 및 데이터가 포함된 모듈입니다. DLL은 다음 두 가지 종류의 함수를 정의할 수 있습니다. 내보낸 함수와 내부 함수 내보낸 함수는 이 함수가 정의된 DLL 내에서 뿐만 아니라 다른 모듈에서 호출되도록 설계되었습니다. 내부 함수는 일반적으로 이 함수가 정의된 DLL 내에서만 호출되도록 설계되었습니다. DLL이 데이터를 내보낼 수 있지만, 이 데이터는 일반적으로 함수에서만 사용됩니다. 단, 다른 모듈이 해당 주소를 읽거나 쓰지 못하도록 차단할 수 있는 방법이 전혀 없습니다. DLL은 응용 프로그램을 모듈화할 수 있는 방법을 제공하여 더욱 쉽게 기능을 업데이트하고 다시 사용할 수 있습니다. 또한, 각 응용 프로그램이 각기 고유한 DLL 데이터 사본을 받지만, 응용 프로그램에서 이 DLL 코드를 공유하므로 여러 응용 프로그램에서 동시에 동일한 기능을 사용할 때 메모리 오버헤드를 줄일 수 있습니다. 자세한 내용은 MSDN 문서 [Dynamic-Link Libraries(동적 연결 라이브러리) (영문)](https://msdn.microsoft.com/en-us/library/ms682589.aspx)를 참조하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점 악용에 성공한 공격자는 Windows 인쇄 스풀러와 동일한 권한으로 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하기 위해 공격자는 인쇄 스풀러에서 액세스할 수 있는 위치에 악성 DLL을 저장해야 합니다. 공격자는 특수하게 조작된 RPC 메시지를 만들어 영향을 받는 시스템으로 전송합니다. 이 메시지로 인해 인쇄 스풀러는 상승된 권한으로 악성 DLL을 로드하고 코드를 실행할 수 있습니다.
  
모든 버전의 Microsoft Windows에서 공격자는 이 문제를 악용하기 위해 "프린터 관리" 권한이 필요합니다. Windows Vista 및 Windows Server 2008에서는 로컬 프린터를 설치할 때 로컬 사용자에게 이 권한이 자동으로 부여됩니다. 프린터 드라이버가 기본적으로 포함되어 있는 경우에는 관리 권한 없이도 이러한 작업이 진행될 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
인쇄 서버로 구성된 시스템이 주로 이 문제에 취약합니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 인쇄 스풀러가 DLL을 로드할 수 있는 경로를 제한하여 이러한 취약점을 해결합니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-KB961501-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-KB961501-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | kb961501.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB961501$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 961501](https://support.microsoft.com/kb/961501) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB961501\\Filelist                                        |
...
WindowsXP-KB961501-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB961501-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB961501$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/961501">Microsoft 기술 자료 문서 961501</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB961501-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB961501-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB961501-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB961501-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Jun Mao
...
-   V1.1(2009년 6월 18일): "인쇄 스풀러 서비스 사용 안 함"이 CVE-2009-0230의 대안으로 추가되었습니다.
