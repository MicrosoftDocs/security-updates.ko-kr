---
TOCTitle: 'MS12-025'
Title: 'Microsoft 보안 공지 MS12-025 - 긴급'
ms:assetid: 'ms12-025'
ms:contentKeyID: 61230492
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-025(v=Security.10)'
---

Microsoft 보안 공지 MS12-025 - 긴급
===================================

.NET Framework의 취약점으로 인한 원격 코드 실행 문제점 (2671605)
----------------------------------------------------------------

게시된 날짜: 2012년 4월 10일 화요일 | 업데이트된 날짜: 2012년 6월 13일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션의 Microsoft .NET Framework 1.0 서비스 팩 3, Microsoft .NET Framework 1.1 서비스 팩 1, Microsoft .NET Framework 2.0 서비스 팩 2, Microsoft .NET Framework 3.5.1 및 Microsoft .NET Framework 4에 대해 긴급입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 Microsoft .NET Framework가 함수에 데이터를 전달할 때 매개 변수를 확인하는 방법을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 1.0 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=1cfeae57-d4e9-4fff-8956-523e7b71453c&displaylang=ko)  
(KB2656378)  
(Media Center Edition 2005 및 Tablet PC Edition 2005만 해당)  
[Microsoft .NET Framework 1.1 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c376fbdc-2289-47b6-950b-4e668cd3a390&displaylang=ko)  
(KB2656370)  
[Microsoft .NET Framework 2.0 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c1338821-d8b2-4513-aa35-087323188509&displaylang=ko)  
(KB2656369)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=40b1ae34-28ad-41a0-88df-b905517e4acf&displaylang=ko)<sup>[1]</sup>
(KB2656368)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 1.1 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=ffd26218-e149-44ea-a0b9-f2a1315fce9e&displaylang=ko)  
(KB2656376)  
[Microsoft .NET Framework 2.0 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c1338821-d8b2-4513-aa35-087323188509&displaylang=ko)  
(KB2656369)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=40b1ae34-28ad-41a0-88df-b905517e4acf&displaylang=ko)<sup>[1]</sup>
...
[Microsoft .NET Framework 1.1 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c376fbdc-2289-47b6-950b-4e668cd3a390&displaylang=ko)  
(KB2656370)  
[Microsoft .NET Framework 2.0 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8e1c10a1-9cb2-4815-8aa6-e401ced5df80&displaylang=ko)  
(KB2656374)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=40b1ae34-28ad-41a0-88df-b905517e4acf&displaylang=ko)<sup>[1]</sup>
(KB2656368)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/download/details.aspx?familyid=c3f521a9-4dc8-46b7-a7f2-696b8759b398&displaylang=ko)  
(KB2656372)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=40b1ae34-28ad-41a0-88df-b905517e4acf&displaylang=ko)<sup>[1]</sup>
(KB2656368)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/download/details.aspx?familyid=efccca8d-1371-4cda-96ab-ceef735742e2&displaylang=ko)  
(KB2656373)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=40b1ae34-28ad-41a0-88df-b905517e4acf&displaylang=ko)<sup>[1]</sup>
(KB2656368)
</td>
...
이 보안 공지가 2012년 6월 12일에 다시 ***릴리스****된****이유는****무엇입니까**?   ***
Microsoft는 모든 영향을 받는 소프트웨어에 대해 보안 업데이트를 다시 제공하기 위해 이 공지를 다시 릴리스하였습니다. 다시 제공된 이 업데이트는 Windows Forms 응용 프로그램의 알려진 인쇄 관련 문제를 해결합니다. 2012년 4월 10일에 제공된 기존 업데이트를 설치하면 특정 Windows Forms 응용 프로그램으로 인쇄 작업 시 인쇄가 되지 않거나 지정된 인쇄 설정을 사용하지 않는 문제가 발생될 수 있습니다. Windows .NET Framework 응용 프로그램의 인쇄 기능을 사용하지 않는 시스템에는 영향을 미치지 않습니다. 기존의 업데이트를 이미 성공적으로 설치한 고객의 경우 다시 제공된 업데이트를 설치하는 것이 좋습니다.

Microsoft .NET Framework 4.5 개발자 미리보기 와 Windows 개발자 미리 보기 의 Microsoft .NET Framework 3.5 및 Microsoft .NET Framework 4.5 가 이 취약점의 영향을 받습니까?
...
|----------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Windows 개발자 미리 보기의 Microsoft .NET Framework 3.5                                                  | [Microsoft 기술 자료 문서 2656380](https://support.microsoft.com/kb/2656380) |
| Windows 개발자 미리 보기의 Microsoft .NET Framework 4.5                                                  | [Microsoft 기술 자료 문서 2656371](https://support.microsoft.com/kb/2656371) |
| Windows Server 2008, Windows 7 및 Windows Server 2008 R2의 Microsoft .NET Framework 4.5 개발자 미리 보기 | [Microsoft 기술 자료 문서 2656381](https://support.microsoft.com/kb/2656381) |
...
이 공지는 .NET Framework 2.0 기능 계층의 취약점을 설명합니다. .NET Framework 3.0 서비스 팩 2 설치 프로그램은 .NET Framework 2.0 서비스 팩 2 설치에서 연계되므로 .NET Framework 3.0 서비스 팩 2을 설치하면 .NET Framework 2.0 서비스 팩 2도 설치됩니다. 따라서 .NET Framework 3.0 서비스 팩 2를 설치한 고객은 .NET Framework 2.0 서비스 팩 2용 보안 업데이트를 설치해야 합니다. 자세한 내용은 [Microsoft 기술 자료 문서 2695500](https://go.microsoft.com/fwlink/?linkid=247462)을 참조하십시오.

.NET Framework 3.5 서비스 팩 1을 설치했습니다. 다른 업데이트를 설치해야 합니까?  
이 공지는 .NET Framework 2.0 기능 계층의 취약점을 설명합니다. .NET Framework 3.5 서비스 팩 1 설치 프로그램은 .NET Framework 2.0 서비스 팩 2 설치와 .NET Framework 3.0 서비스 팩 2 설치 모두에서 연계됩니다. 따라서 .NET Framework 3.5 서비스 팩 1을 설치한 고객은 .NET Framework 2.0 서비스 팩 2용 보안 업데이트를 설치해야 합니다. 자세한 내용은 [Microsoft 기술 자료 문서 2695500](https://go.microsoft.com/fwlink/?linkid=247462)을 참조하십시오.
...
Microsoft .NET Framework가 함수에 데이터를 전달할 때 매개 변수의 유효성을 검사하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0163(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0163)을 참조하십시오.

#### .NET Framework 매개 변수 유효성 검사 취약점(CVE-2012-0163)에 대한 완화 요소
...
#### .NET Framework 매개 변수 유효성 검사 취약점(CVE-2012-0163)에 대한 대안
...
#### .NET Framework 매개 변수 유효성 검사 취약점(CVE-2012-0163)에 대한 FAQ
...
취약점의 원인은 무엇입니까?  
이 취약점은 .NET Framework가 함수에 데이터를 전달할 때 매개 변수를 적절하게 확인하지 못하기 때문에 발생합니다.
...
-   웹 호스팅 공격 시나리오
-   호스팅 환경에서 사용자의 사용자 지정 ASP.NET 응용 프로그램 업로드를 허용하는 경우, 공격자는 악의적인 ASP.NET 응용 프로그램을 업로드하여 이 취약점을 통해 ASP.NET 코드가 서버 시스템에서 유해한 작업을 수행하지 못하도록 하는 데 사용되는 샌드박스를 우회할 수 있습니다.
...
업데이트는 어떤 기능을 수행합니까?  
업데이트는 .NET Framework에서 매개 변수의 유효성을 확인하는 방식을 수정하여 이 취약점을 해결합니다.
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)에서 제공하고 [Windows Server Update Services(영문)](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은[Microsoft Updates용 SMS 2003 Inventory Tool(영문)](https://technet.microsoft.com/ko-kr/sms/bb676783.aspx)을참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools(영문)](https://technet.microsoft.com/ko-kr/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드(영문)](https://technet.microsoft.com/ko-kr/sms/bb676766.aspx)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2671605">Microsoft 기술 자료 문서 2671605</a> 참조</td>
</tr>
<tr class="odd">
...
-   .NET Framework 매개 변수 유효성 검사 취약점(CVE-2012-0163)을 [VeriSign iDefense Labs(영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 Vitaliy Toropov
...
-   V1.1(2012년 4월 13일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2671605 링크가 추가되었습니다.
-   V2.0(2012년 6월 13일): 영향을 받는 모든 소프트웨어에 대한 업데이트를 다시 제공하기 위해 공지가 다시 릴리스되었습니다. 2012년 4월 10일에 제공된 기존 업데이트를 이미 성공적으로 설치한 고객의 경우 다시 제공되는 업데이트를 설치하는 것이 좋습니다. 자세한 내용은 업데이트 FAQ를 참조하십시오.
