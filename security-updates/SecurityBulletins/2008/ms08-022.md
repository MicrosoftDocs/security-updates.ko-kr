...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 944338](https://support.microsoft.com/kb/944338)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|--------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 서비스 팩 4                                                               | [VBScript 5.1 및 JScript 5.1](https://www.microsoft.com/download/details.aspx?familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
| Microsoft Windows 2000 서비스 팩 4                                                               | [VBScript 5.6 및 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
| Windows XP 서비스 팩 2                                                                           | [VBScript 5.6 및 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=c0124698-3b94-4474-9473-22a2f39a4a56&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
| Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2           | [VBScript 5.6 및 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=87b80ae3-e299-4d15-a135-3b1bcf943652)                | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
| Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2                               | [VBScript 5.6 및 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=88518aa6-e334-4529-aa63-0bf2ef417ce3&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
| Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2                   | [VBScript 5.6 및 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=12cefefc-8553-4dca-9850-c653371de61e&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
| Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용) | [VBScript 5.6 및 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=fe22a828-cca4-4b51-bbd5-995c65fead21)                | 원격 코드 실행 | 긴급        | [MS06-023](https://technet.microsoft.com/security/bulletin/ms06-023) |
...
Microsoft는 [Microsoft 기술 자료 문서 944338](https://support.microsoft.com/kb/944338)에 중요한 알려진 문제점이 추가되었음을 알리기 위해 이 보안 공지를 개정하였습니다. 알려진 문제점과 해결 방법은 다음과 같습니다.
...
-   Microsoft Windows 2000 서비스 팩 4에 VBScript 5.1 및 JScript 5.1 업데이트를 적용할 때 라이브러리 등록 문제점이 발생할 수 있습니다. 해결 방법은 [Microsoft 기술 자료 문서 944338](https://support.microsoft.com/kb/944338)에 설명된 대안입니다. 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 944533](https://support.microsoft.com/kb/944338)에 나와 있습니다.

**JScript 5.1 및/또는 VBScript 5.1을 사용하고 있는 경우 이 취약점의 영향을 받습니까?**  
예, 사용 중인 소프트웨어는 영향을 받습니다. 이 업데이트는 사용 중인 소프트웨어에 적용되며 버전 수준을 JScript 5.6 및/또는 VBScript 5.6으로 변경합니다. [Microsoft 기술 자료 문서 944338](https://support.microsoft.com/kb/944338)에 있는 파일 정보가 사용자에게 적용됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0083 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0083)을 참조하십시오.
...
예. 기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180.aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 [인터넷 영역 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537183.aspx) 보안 수준을 높음으로 설정합니다. 인터넷 영역의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다.
  
**Internet Explorer 보안 강화 구성이란 무엇입니까?**    
Internet Explorer [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180.aspx)은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer 보안 강화 구성은 이러한 위험을 줄이기 위해 다양한 보안 관련 설정을 수정합니다. 여기에는 **인터넷 옵션** 대화 상자의 **보안** 탭과 **고급** 탭의 설정이 포함됩니다. 중요한 몇 가지 수정 사항은 다음과 같습니다.
...
Internet Explorer 보안 강화 구성에 대한 자세한 내용은 [Internet Explorer 보안 강화 구성 관리(Managing Internet Explorer Enhanced Security Configuration)](https://www.microsoft.com/oldcprops%20https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en) 가이드를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/944338">Microsoft 기술 자료 문서 925120</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">핫패칭</td>
<td style="border:1px solid black;">이 보안 업데이트는 핫패칭을 지원하지 않습니다. 핫패칭에 대한 자세한 내용은 <a href="https://support.microsoft.com/kb/897341/ko-kr">Microsoft 기술 자료 문서 897341</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
...
-   VBScript/Jscript 원격 코드 실행 취약점(CVE-2008-0083)을 보고해 주신 [Symantec (영문)](https://www.symantec.com/)의 Peter Ferrie
