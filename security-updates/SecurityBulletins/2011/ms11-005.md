...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0040 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040)을 참조하십시오.
...
**SPN이란 무엇입니까?**  
SPN(Service Principle Name)은 클라이언트가 서비스의 인스턴스를 식별하는 이름입니다. 서비스 사용자 이름의 사용과 관련된 자세한 내용은 MSDN 문서, [서비스 사용자 이름 (영문)](https://msdn.microsoft.com/en-us/library/ms677949(vs.85).aspx)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0040 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2478953">Microsoft 기술 자료 문서 2478953</a> 참조</td>
</tr>
<tr class="even">
