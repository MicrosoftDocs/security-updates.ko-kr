...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2545814](http://support.microsoft.com/kb/2545814)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
이 보안 공지가 처음 게시되었을 때 사용할 수 없었던 Office for Mac용 보안 업데이트가 이제 [MS11-045](http://go.microsoft.com/fwlink/?linkid=217502) 공지에서 제공됨을 알리기 위해 이 공지를 개정하였습니다.

**Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac용 보안 업데이트는 어디에 있습니까?**    
MS11-045 공지에 설명된 취약점을 해결하는 것 이외에도 Microsoft Office 2004 for Mac(KB2555786), Microsoft Office 2008 for Mac(KB2555785) 및 Open XML File Format Converter for Mac(KB2555787)에 대한 보안 업데이트는 이 공지에서 설명하는 취약점도 해결합니다. 자세한 내용과 다운로드 링크는 [MS11-045](http://go.microsoft.com/fwlink/?linkid=217502)를 참조하십시오.

**파일 정보 세부 사항은 어디에 있습니까?**    
파일 정보 세부 사항의 위치에 대해서는 **보안 업데이트 배포** 섹션에서 참조 표를 참조하십시오.

**Office 파일 유효성 검사 기능이 취약점을 완화하는 데 어떤 도움이 됩니까?**    
Microsoft PowerPoint 2003 및 Microsoft PowerPoint 2007에서 Office 파일 유효성 검사 기능을 사용하면 취약점을 악용하는 데 사용될 수 있는 특수하게 조작된 파일이 자동으로 열리지 않고, 기본적으로 사용자에게 이러한 파일을 열 것인지 여부를 물어보게 됩니다. 사용자가 여러 번의 경고 대화 상자를 클릭한 후에 파일을 열어야만 취약점이 악용될 수 있습니다. Microsoft PowerPoint 2003 또는 Microsoft PowerPoint 2007의 Office 파일 유효성 검사 기능에 대한 자세한 내용은 [Microsoft 보안 권고 2501584](http://technet.microsoft.com/security/advisory/2501584)를 참조하십시오.

**PowerPoint 2003 및 PowerPoint 2007에서 파일 유효성 검사에 실패하는 파일을 열지 못하도록 하면 어떠한 이점이 있습니까?**    
Office 파일 유효성 검사를 통해 PowerPoint 2003 및 PowerPoint 2007에서 의심되는 파일을 열지 못하도록 설정할 경우 [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)에서 사용할 수 있는 **Microsoft Fix it** 솔루션, "PowerPoint 2003 및 2007에 대한 문서 열기 사용 안 함"이 CVE-2011-1269 및 CVE-2011-1270에 설명된 취약점을 악용하는 공격 경로를 차단합니다. 고객은 나중에 PowerPoint 2003 또는 PowerPoint 2007에 대한 보안 업데이트를 설치할 때까지 대안으로 Fix it 솔루션을 적용할 수 있습니다.
Fix it 자동화 솔루션, "PowerPoint 2003 및 2007에 대한 문서 열기 사용 안 함"을 적용하는 방법은 [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)를 참조하고, 솔루션을 수동으로 적용하는 방법은 이 공지의 취약점 정보 섹션에서 CVE-2011-1269 및 CVE-2011-1270의 대안 섹션을 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [5월 공지 요약](http://technet.microsoft.com/security/bulletin/ms11-may)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1269 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269)를 참조하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.**
    ...
    **Microsoft Office 2003 및 Microsoft Office 2007**
    ...
    다음 레지스트리 스크립트는 레지스트리 항목(.reg) 파일로 저장하여 파일 차단 정책을 설정하는 데 사용할 수 있습니다. 레지스트리 스크립트 사용 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 310516](http://support.microsoft.com/kb/310516)을 참조하십시오. 해당 Office 소프트웨어에 알맞은 레지스트리 스크립트를 사용하십시오.
...
또는 Microsoft Office 2007의 경우 그룹 정책을 사용하여 파일 차단을 적용할 수 있습니다. 자세한 내용은 TechNet 문서 [Office 2007에서 파일 형식 차단 설정 구성 (영문)](http://technet.microsoft.com/en-us/library/cc179186(office.12).aspx)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1270 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270)을 참조하십시오.
...
-   **PowerPoint 2003에서 유효성 검사에 실패하는 파일을 열지 못하도록 Office 파일 유효성 검사 설정**
    ...
    **참고** 이 대안을 적용하기 전에 해당 버전의 Microsoft Office에 대해 Office 파일 유효성 검사를 사용하도록 설정되어 있어야 합니다. Microsoft Office 2003에서 Office 파일 유효성 검사를 사용하도록 설정하는 방법에 대한 자세한 내용은 TechNet 문서 [Office 2003 및 Office 2007용 Office 파일 유효성 검사 (영문)](http://technet.microsoft.com/en-us/library/gg985445(office.12).aspx)를 참조하십시오.
...
**참고** 최신 MBSA, Microsoft Update 및 Windows Server Update Services에서 지원하지 않는 레거시 소프트웨어를 사용하는 고객은 [Microsoft Baseline Security Analyzer (영문)](http://www.microsoft.com/technet/security/tools/mbsahome.mspx)를 방문하고 레거시 제품 지원 섹션을 참조하여 레거시 도구로 종합 보안 업데이트 검색을 만드는 방법을 찾으십시오.
...
-   지원 대상인 Microsoft Office 버전에 네트워크 설치 지점을 만드는 방법에 대한 자세한 내용은 [Microsoft Office의 네트워크 설치 지점 만들기](http://technet.microsoft.com/library/cc179063.aspx)를 참조하십시오.
    **참고** 중앙에서 보안 업데이트를 관리하려는 경우 Windows Server Update Services를 사용합니다. Microsoft Office용 보안 업데이트를 배포하는 방법에 대한 자세한 내용은 [Windows Server Update Services 웹 사이트](http://technet.microsoft.com/wsus/default.aspx)를 방문하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2535802">Microsoft 기술 자료 문서 2535802</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2535812">Microsoft 기술 자료 문서 2535812</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">PowerPoint 2007의 경우 <a href="http://support.microsoft.com/kb/2535818">Microsoft 기술 자료 문서 2535818</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩 서비스 팩 2의 경우 <a href="http://support.microsoft.com/kb/2540162">Microsoft 기술 자료 문서 2540162</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   프레젠테이션 메모리 손상 RCE 취약점(CVE-2011-1269)을 해결하기 위해 협력해 주신 [CERT/CC (영문)](http://www.cert.org/)의 Will Dormann  
-   프레젠테이션 버퍼 오버런 RCE 취약점(CVE-2011-1270)을 해결하기 위해 협력해 주신 [CERT/CC (영문)](http://www.cert.org/)의 Will Dormann
