...
**권장 사항**. 업데이트 관리 소프트웨어를 사용하여 보안 업데이트를 적용하거나 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 서비스를 통해 업데이트를 확인하여 보안 업데이트를 적용하는 방법을 고려해 보는 것이 좋습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3223 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3223)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2294255">Microsoft 기술 자료 문서 2294255</a> 참조</td>
</tr>
<tr class="odd">
