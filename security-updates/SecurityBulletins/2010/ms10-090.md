...
이 보안 업데이트는 [Microsoft 보안 권고 2458511](https://technet.microsoft.com/security/advisory/2458511)에서 처음 설명한 취약점도 해결합니다.
...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2416400](https://support.microsoft.com/kb/2416400)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3340 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3340)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3342 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342)를 참조하십시오.
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3342 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3343 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3343)을 참조하십시오.
...
-   LMClassFactory 사용 안 함
    ...
    대안의 영향. Liquid Motion을 사용하는 기능을 사용할 수 없습니다. Liquid Motion에 대한 자세한 내용은 [Microsoft 기술 자료 문서 257557](https://support.microsoft.com/kb/257557)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3345 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3345)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3346 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3346)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3348 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348)을 참조하십시오.
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3348 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3962 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)를 참조하십시오.
...
-   사용자 정의 스타일 시트를 사용하여 웹 사이트 CSS 무시
    ...
    대안의 영향. 사용자 정의 CSS를 적용하면 웹 사이트 스타일 시트가 제대로 작동하지 않을 수 있습니다. 이전에 이 대안을 적용한 경우 이 보안 업데이트를 적용하기 전에 대안을 되돌려야 합니다. 이 대안을 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2458511](https://support.microsoft.com/kb/2458511)에서 Microsoft Fix it 자동화 솔루션을 사용하십시오.
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2458511](https://support.microsoft.com/kb/2458511)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3962 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)가 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2458511](https://technet.microsoft.com/security/advisory/2458511)에서 처음 설명되었습니다.

이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?  
예. Microsoft는 이 취약점을 악용하려는 실제 공격에 대한 보고를 받았습니다.

이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?  
예. 이 보안 업데이트는 현재 악용되고 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3962 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)가 지정되었습니다.

[Microsoft Security Advisory 2458511](https://technet.microsoft.com/security/advisory/2458511)에서 제공된 대안을 적용한 경우 이 업데이트를 적용하기 전에 원래대로 되돌려야 합니까?  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2416400">Microsoft 기술 자료 문서 2416400</a> 참조</td>
</tr>
<tr class="even">
...
-   HTML 개체 메모리 손상 취약점(CVE-2010-3340)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Aniway  
-   HTML 개체 메모리 손상 취약점(CVE-2010-3343)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   HTML 요소 메모리 손상 취약점(CVE-2010-3345)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Stephen Fewer  
-   HTML 요소 메모리 손상 취약점(CVE-2010-3346)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [Peter Vreugdenhil (영문)](https://vreugdenhilresearch.nl/)  
-   도메인 간 정보 유출 취약점(CVE-2010-3348)을 보고해 주신 [AZIA CO., LTD. (일문)](https://www.azia.jp)의 Masatoshi Sato  
-   도메인 간 정보 유출 취약점 취약점(CVE-2010-3348)을 해결하기 위해 협력해 주신 [Yosuke Hasegawa (일문)](https://utf-8.jp)  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-3962)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Jose Antonio Vazquez Gonzalez
