...
Microsoft는 고객에게 폭넓은 보호를 제공할 수 있도록 정보를 제공하기 위해 [MAPP(Microsoft Active Protections Program)](https://go.microsoft.com/fwlink/?linkid=215201) 파트너와 협력하고 있습니다. 또한 Microsoft는 위협 현황을 모니터링하고 이 취약점을 악용하려는 악성 사이트에 대한 조치를 취하기 위해 파트너와 협력하고 있습니다.

Microsoft는 [Microsoft 안전 및 보안 센터](https://www.microsoft.com/security/pc-security/protect-pc.aspx)의 지침을 따라 방화벽을 설정하고, 모든 소프트웨어 업데이트를 적용하고, 안티바이러스 및 안티스파이웨어 소프트웨어를 설치하도록 고객들에게 권장합니다.

완화 요소:

-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](https://technet.microsoft.com/library/dd883248.aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다.
...
| 참고 자료 | 번호                                                                                   |
|-----------|----------------------------------------------------------------------------------------|
| CVE 참고  | [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)(영문) |
...
Microsoft는 이 문제의 악용을 방지하기 위한 Microsoft Fix it 솔루션, "Prevent Memory Corruption via ExecCommand in Internet Explorer"(Internet Explorer의 ExecCommand를 통한 메모리 손상 방지)의 출시를 알리기 위해 알리기 위해 이 권고를 개정했습니다. [Microsoft 기술 자료 문서 2757760](https://support.microsoft.com/kb/2757760)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
-   Microsoft Fix it 솔루션, "Prevent Memory Corruption via ExecCommand in Internet Explorer "(Internet Explorer의 ExecCommand를 통한 메모리 손상 방지)를 적용하여 이 문제의 취약점 방지
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2757760](https://support.microsoft.com/kb/2757760)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
-   타사 소프트웨어 업데이트 상태 유지
    ...
    [어디에서 Java 6의 최신 버전을 얻을 수 있습니까?](https://java.com/ko/download/faq/java_6.xml)

    [Java Update란 무엇입니까?](https://java.com/ko/download/help/java_update.xml)

    [사용 중인 시스템에서 Java의 이전 버전을 제거해야 하는 이유는 무엇입니까?](https://www.java.com/ko/download/faq/remove_olderversions.xml)
