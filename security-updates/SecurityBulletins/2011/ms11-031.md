...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0663 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0663)을 참조하십시오.
...
**VBScript란 무엇입니까?**    
VBScript(Visual Basic 스크립트)는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. VBScript 스크립트는 ASP(Active Server Page), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 자세한 내용은 MSDN 문서, [VBScript 기본 사항 (영문)](https://msdn.microsoft.com/en-us/library/0ad0dkea(vs.85).aspx)을 참조하십시오.
...
예. 기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 보안 강화 구성으로 알려진 제한된 모드로 실행됩니다. [보안 강화 구성](https://technet.microsoft.com/library/dd883248(ws.10).aspx)은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다.
...
<td style="border:1px solid black;">JScript 5.6 및 VBScript 5.6의 경우 <a href="https://support.microsoft.com/kb/2510587">Microsoft 기술 자료 문서 2510587</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 및 VBScript 5.7의 경우 <a href="https://support.microsoft.com/kb/2510581">Microsoft 기술 자료 문서 2510581</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 및 VBScript 5.8의 경우 <a href="https://support.microsoft.com/kb/2510531">Microsoft 기술 자료 문서 2510531</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
-   스크립팅 메모리 재할당 취약점(CVE-2011-0663)을 해결하기 위해 협력해 주신 [Mozilla](https://www.mozilla.org/)의 [Jesse Ruderman (영문)](https://www.squarefree.com/)
