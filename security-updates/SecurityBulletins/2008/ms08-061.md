---
TOCTitle: 'MS08-061'
Title: 'Microsoft 보안 공지 MS08-061 - 중요'
ms:assetid: 'ms08-061'
ms:contentKeyID: 61230169
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-061(v=Security.10)'
---

Microsoft 보안 공지 MS08-061 - 중요
===================================

Windows 커널의 취약점으로 인한 권한 상승 문제점 (954211)
--------------------------------------------------------

게시된 날짜: 2008년 10월 15일 수요일
...
이 보안 업데이트는 새 창 생성 프로세스 중 전달된 창 속성 유효성 검사, 다중 스레드로부터의 시스템 호출 처리 방식 및 사용자 모드에서 Windows 커널로 전달된 매개 변수의 유효성 검사를 수정하여 이러한 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 954211](https://support.microsoft.com/kb/954211)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=3a6165a6-d7e7-4526-9291-290caf0639b4&displaylang=ko)                                                  | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607&displaylang=ko)                                                              | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607&displaylang=ko)                                                              | 권한 상승      | 중요        | 없음                                                                |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b06d3a02-b6e4-4d40-913a-3759a31f20f3)             | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e696762-d652-4a8f-ab8f-622f9746c320&displaylang=ko)                  | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=57ca28ea-e5e1-4191-a3d6-84aa90a3d668&displaylang=ko)      | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 SP1 (Itanium 기반 시스템용) 및 Windows Server 2003 SP2 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1e6c3f81-85bb-48e6-a5af-635a7e540c93) | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=3483b400-cedc-441f-ba8e-594e3df89190&displaylang=ko)                                          | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=905ab030-14a5-4a3d-aa11-e8f957f6a1ea&displaylang=ko)                  | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 (32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8b97114a-71aa-47a2-b9e7-f4e158c18c80&displaylang=ko)\*                                             | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 (x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=6e641db2-90c8-458f-9795-3e46b70a5203&displaylang=ko)\*                                           | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b6546e1c-bf7b-4354-8574-6c16fa707de0)                                                        | 권한 상승      | 중요        | [MS08-025](https://technet.microsoft.com/security/bulletin/ms08-025) |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 954211](https://support.microsoft.com/kb/954211)에 나와 있습니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 954211](https://support.microsoft.com/kb/954211)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<th style="border:1px solid black;" >Windows 커널 창 생성 취약점(CVE-2008-2250)</th>
<th style="border:1px solid black;" >Windows 커널 처리되지 않은 예외 취약점(CVE-2008-2251)</th>
<th style="border:1px solid black;" >Windows 커널 메모리 손상 취약점(CVE-2008-2252)</th>
...
Windows 커널 창 생성 취약점(CVE-2008-2250)  
------------------------------------------
  
Windows 커널이 새 창 생성 프로세스 중 전달된 창의 속성에 대한 유효성 검사를 올바르게 수행하지 못하므로 권한 상승 취약점이 있습니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-2250 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2250)을 참조하십시오.
  
#### Windows 커널 창 생성 취약점(CVE-2008-2250)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 이 취약점을 악용하려면 유효한 로그온 자격 증명을 가지고 있어야 하고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 창 생성 취약점(CVE-2008-2250)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 창 생성 취약점(CVE-2008-2250)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널은 새 창이 생성될 때 상위 창이 하위 창에 전달한 입력을 잘못 처리합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 새 창 생성 프로세스 중 전달된 창 속성에 대한 유효성 검사를 올바르게 수행하여 해당 취약점을 해결합니다.
...
Windows 커널 처리되지 않은 예외 취약점(CVE-2008-2251)  
-----------------------------------------------------
  
Windows 커널에 가능한 "Double Free" 조건으로 인해 권한 상승의 취약점이 있습니다. 취약점을 통해 공격자가 권한을 상승시키는 코드를 실행할 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-2251 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251)을 참조하십시오.
  
#### Windows 커널 처리되지 않은 예외 취약점(CVE-2008-2251)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 이 취약점을 악용하려면 유효한 로그온 자격 증명을 가지고 있어야 하고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 처리되지 않은 예외 취약점(CVE-2008-2251)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 처리되지 않은 예외 취약점(CVE-2008-2251)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Windows 커널이 여러 스레드의 특정 시스템 호출을 올바르게 처리하지 못하기 때문에 발생합니다.
...
공격자는 특수하게 조작한 프로그램을 처리하면서 영향 받은 시스템이 여러 번 사용을 위해 확보된 메모리를 해제 또는 "확보"하도록 만들 수 있습니다. 이미 확보된 메모리를 해제하면 메모리 손상으로 이어질 수 있습니다. 그러면 공격자는 메모리 손상이 발생할 때 실행되는 메모리에 임의의 코드를 추가할 수 있습니다. 그리고 이 코드는 시스템 권한 수준에서 실행됩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 여러 스레드의 시스템 호출을 처리하는 방식을 수정하여 해당 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 보안 공지가 처음 게시되었을 때 이 취약점은 공개되어 있었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-2251 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
아니요. Microsoft는 이 취약점이 공개적으로 고객을 공격하는 데 사용되었다는 정보를 받지 못했으며, 이 보안 공지를 처음에 게시했을 때 개념 증명 코드의 예제를 보지 못했습니다.
  
Windows 커널 메모리 손상 취약점(CVE-2008-2252)  
----------------------------------------------
  
Windows 커널이 사용자 모드에서 커널로 전달된 입력의 유효성을 올바르게 검사하지 못하는 권한 상승 취약점이 존재합니다. 취약점을 통해 공격자가 권한을 상승시키는 코드를 실행할 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-2252 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2252)를 참조하십시오.
  
#### Windows 커널 메모리 손상 예외 취약점(CVE-2008-2252)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 이 취약점을 악용하려면 유효한 로그온 자격 증명을 가지고 있어야 하고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 메모리 손상 예외 취약점(CVE-2008-2252)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 메모리 손상 예외 취약점(CVE-2008-2252)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Windows 커널이 사용자 모드에서 커널로 전달된 입력에 대한 유효성 검사를 잘못 수행하여 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 사용자 모드에서 Windows 커널로 전달되는 매개 변수의 유효성 검사 방식을 수정하여 취약점을 해결합니다.
...
Windows2000-kb954211-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-kb954211-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB954211$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/954211">Microsoft 기술 자료 문서 954211</a> 참조</td>
</tr>
<tr class="even">
...
Windowsxp-kb954211-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb954211-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB954211$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/954211">Microsoft 기술 자료 문서 954211</a> 참조</td>
...
Windowsserver2003-kb954211-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB954211-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb954211-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB954211-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\\$NTUninstallKB954211$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/954211">Microsoft 기술 자료 문서 954211</a> 참조</td>
...
-   커널 창 생성 취약점(CVE-2008-2250)을 보고해 주신 [iShadow (영문)](https://www.ishadow.com/)의 Paul Caton  
-   Windows 커널 메모리 손상 취약점(CVE-2008-2252)을 보고해 주신 [SkyRecon (영문)](https://www.skyrecon.com/)의 Thomas Garnier
