...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=bf7065bc-c183-4a78-8d46-72fe7385c07c&displaylang=ko)                                                | 스푸핑         | 중요        | [MS07-031](https://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3&displaylang=ko)                                                            | 스푸핑         | 중요        | [MS07-031](https://technet.microsoft.com/security/bulletin/ms07-031) |
...
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6d02306e-9e2e-4ae8-bd21-8a2c1a229472)           | 스푸핑         | 중요        | [MS07-031](https://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0b3f6fdd-276e-4267-99d8-8f00d91ad6a2&displaylang=ko)                | 스푸핑         | 중요        | [MS07-031](https://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ce98ff55-f565-469d-bbd2-32b681faf908&displaylang=ko)    | 스푸핑         | 중요        | [MS07-031](https://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5ca3c72c-cadb-4b0a-b3a3-fb81d0bfd7b3) | 스푸핑         | 중요        | [MS07-031](https://technet.microsoft.com/security/bulletin/ms07-031) |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 960225](https://support.microsoft.com/kb/960225)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0085 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0085)를 참조하십시오.
...
-   고객은 이 취약점의 영향을 받지 않는 Active Directory 인증서 매핑을 구현할 수 있습니다. 사용자는 Active Directory 인증서 매핑을 통해 사용자 이름과 암호를 입력하지 않고도 신뢰할 수 있는 공개 키를 사용해 도메인 리소스에 액세스할 수 있습니다. 클라이언트 인증서는 Active Directory 사용자 계정에 바로 매핑할 수 있습니다.  
    인증서 매핑을 구성하는 여러 가지 방법에 대해서는 [사용자 계정에 인증서 매핑 (영문)](https://technet.microsoft.com/en-us/library/cc736706.aspx)을 참조하십시오.
...
Secure Channel(Schannel) 보안 패키지는 SSL(Secure Sockets Layer) 및 TLS(Transport Layer Security) 인터넷 표준 인증 프로토콜을 구현하는 SSP(보안 지원 공급자)입니다. 이러한 구성 요소는 웹 탐색과 같은 여러 일반 인터넷과 네트워크 응용 프로그램을 지원하는 보안 통신을 구현하는 데 사용됩니다. SChannel은 클라이언트와 서버 간에 보안 통신을 지원하기 위한 인증 서비스를 제공하는 보안 패키지의 일부입니다. SChannel에 대한 자세한 내용은 MSDN의 [SChannel (영문)](https://msdn.microsoft.com/en-us/library/ms678421.aspx) 웹 사이트를 참조하십시오.
...
이러한 프로토콜은 서버와 클라이언트 시스템 사이에 암호화된 연결을 제공합니다. SSL은 인터넷과 같은 공용 네트워크를 통해 사용자들이 보내는 정보를 보호합니다. SSL 지원을 위해서는 SSL 인증서가 서버에 설치되어 있어야 합니다. SSL에 대한 자세한 내용은 [XADM: SSL(Secure Sockets Layer) 작동 방법](https://support.microsoft.com/default.aspx?scid=kb;ko-kr;q245152)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/960225">Microsoft 기술 자료 문서 960225</a> 참조</td>
</tr>
<tr class="even">
...
-   SChannel 스푸핑 취약점(CVE-2009-0085)을 보고해 주신 [Secretaria da Fazenda do Estado do Rio Grande do Sul (영문)](https://www.sefaz.rs.gov.br/)  
-   SChannel 스푸핑 취약점(CVE-2009-0085)을 보고해 주신 [Cia de Processamento de Dados do Estado do Rio Grande do Sul (영문)](https://www.procergs.rs.gov.br/)
