---
TOCTitle: 'MS10-MAY'
Title: 2010 년 5 월 Microsoft 보안 공지 요약
ms:assetid: 'ms10-may'
ms:contentKeyID: 61230728
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-may(v=Security.10)'
---


2010 년 5 월 Microsoft 보안 공지 요약
=====================================
...
이 공지 요약 목록에는 2010년 5월 발표된 보안 공지가 포함되어 있습니다.

2010년 5월 공지 발표와 함께 이 공지 요약이 2010년 5월 6일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](http://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](http://go.microsoft.com/fwlink/?linkid=21163)을 참조하십시오.

Microsoft는 2010년 5월 13일 오전 3:00(한국 표준시)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [5월 보안 공지 웹캐스트에 지금 등록하십시오](http://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032427724&culture=en-us). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약 (영문)](http://technet.microsoft.com/security/bulletin/summary) 및 웹캐스트를 참조하십시오.
...
<td style="border:1px solid black;"><strong>Outlook Express 및 Windows Mail의 취약점으로 인한 원격 코드 실행 문제점 (978542)</strong><br />
<br />
이 보안 업데이트는 Outlook Express, Windows Mail 및 Windows Live Mail에서 비공개적으로 보고된 취약점 1건을 해결합니다. 이 취약점으로 인해 사용자가 악의적인 메일 서버에 방문할 경우 원격 코드 실행이 발생할 수 있습니다. 취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.</td>
...
<td style="border:1px solid black;"><strong>Microsoft Visual Basic for Applications의 취약점으로 인한 원격 코드 실행 문제점 (978213)</strong><br />
<br />
...
|---------------------------------------------------------------------|------------------------------------------------------|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|  
| [MS10-031](http://technet.microsoft.com/security/bulletin/ms10-031) | VBE6.DLL 스택 메모리 손상 취약점                     | [CVE-2010-0815 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0815) | [**2 (영문)**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - 비일관적인 악용 코드 가능 | (없음)                                                                                              |  
| [MS10-030](http://technet.microsoft.com/security/bulletin/ms10-030) | Outlook Express 및 Windows Mail 정수 오버플로 취약점 | [CVE-2010-0816 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0816) | [**2 (영문)**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - 비일관적인 악용 코드 가능 | Windows Vista 및 그 이상의 운영 체제에서는 힙 취약점이 완화되었기 때문에 악용 가능성이 더 낮습니다. |
...
<sup>[1]</sup>Microsoft Office에 대한 이러한 업데이트는 취약한 공유 Office 구성 요소를 포함하고 있는 지원 대상인 모든 Microsoft Office 제품군 및 기타 Microsoft Office 소프트웨어에 적용됩니다. 여기에는 지원 대상인 Microsoft Office Visio 및 Microsoft Office Project 버전이 포함됩니다.
...
<sup>[3]</sup>독립 소프트웨어 공급업체(ISV)는 이 공지에서 설명하는 취약점을 해결한 업데이트된 버전의 Visual Basic for Applications SDK를 [Summit Software Company (영문)](http://www.summsoft.com/)에서 사용할 수 있습니다.
...
-   MS10-030에서 설명한 문제점을 보고해 주신 Protek Research Lab의 Francis Provencher
-   MS10-031에서 설명한 문제점을 보고해 주신 [NSFocus Security Team (영문)](http://www.nsfocus.com/)
...
-   V1.0(2010년 5월 12일): 공지 요약이 게시되었습니다.
-   V1.1(2010년 5월 13일): MS10-030의 다시 시작 요구 사항이 수정되었습니다.
-   V1.2(2010년 5월 20일): MS10-030의 Windows 7 및 Windows Server 2008 R2에 설치된 Windows Mail에 대한 잘못된 참조가 제거되었습니다. 또한 Microsoft Office에 대한 업데이트가 취약한 버전의 VBE6.dll을 포함하고 있는 지원 대상인 모든 Microsoft Office 제품군 및 기타 Microsoft Office 소프트웨어에 적용된다는 사실을 설명하기 위해 MS10-031의 영향을 받는 소프트웨어에 설명을 추가했습니다.
