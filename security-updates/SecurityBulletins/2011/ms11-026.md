---
TOCTitle: 'MS11-026'
Title: 'Microsoft 보안 공지 MS11-026 - 중요'
ms:assetid: 'ms11-026'
ms:contentKeyID: 61230393
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-026(v=Security.10)'
---

Microsoft 보안 공지 MS11-026 - 중요
===================================
...
보안 업데이트는 MHTML 파서가 요청을 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 2501696](http://technet.microsoft.com/security/advisory/2501696)에서 처음 설명한 취약점도 해결합니다.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae&displaylang=ko)                                                                                 | 정보 유출      | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b01fe9a5-66a4-4683-963b-e78aea214579)                                                                       | 정보 유출      | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f&displaylang=ko)                                                                        | 정보 유출      | 낮음        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3&displaylang=ko)                                                            | 정보 유출      | 낮음        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=3fb450a0-d087-4f36-9301-05ffbf94cc1a)                                                                   | 정보 유출      | 낮음        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256&displaylang=ko)                                                 | 정보 유출      | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7da10b64-d0a9-4e42-aa3a-87c657122a8c&displaylang=ko)                         | 정보 유출      | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596&displaylang=ko)\*\*           | 정보 유출      | 낮음        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8&displaylang=ko)\*\*       | 정보 유출      | 낮음        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f35ecdd1-6b5c-40e7-a00b-ca083bdf5cba)                  | 정보 유출      | 낮음        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b&displaylang=ko)                                   | 정보 유출      | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb&displaylang=ko)                               | 정보 유출      | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498&displaylang=ko)\*\* | 정보 유출      | 낮음        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=140ea384-2877-401f-ac3b-f84f6966e970)            | 정보 유출      | 낮음        | 없음                      |
...
<th style="border:1px solid black;" >MHTML MIME 형식의 요청 취약점(CVE-2011-0096)</th>
...
MHTML MIME 형식의 요청 취약점(CVE-2011-0096)  
--------------------------------------------
  

MHTML이 문서 내의 콘텐츠 블록에 대한 MIME 형식의 요청을 해석하는 방식에 정보 유출 취약점이 존재합니다. 특정 조건에서 이 취약점으로 인해 공격자는 잘못된 보안 컨텍스트에서 클라이언트 쪽 스크립트를 실행할 수 있습니다. 서버 쪽 사이트 간 스크립팅(XSS) 취약점과 유사하게 이 취약점은 사용자의 Internet Explorer 인스턴스의 컨텍스트에서 실행되는 웹 요청의 응답에 공격자가 클라이언트 쪽 스크립트를 주입할 수 있는 특정 조건에서 발생할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0096 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)을 참조하십시오.
  
#### MHTML MIME 형식의 요청 취약점(CVE-2011-0096)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   웹을 통한 공격의 경우 웹 사이트에 이 취약점을 악용하기 위해 사용되는 특수하게 조작된 "MHTML:"로 시작하는 링크가 포함되어 있을 수 있습니다. 공격자는 사용자가 웹 사이트를 방문하여 특수하게 조작된 URL을 열도록 유도해야 하는데, 일반적으로 사용자를 공격자의 웹 사이트로 유인하는 전자 메일 메시지 또는 인스턴트 메신저 메시지에 포함된 링크를 클릭하도록 하는 방법을 사용합니다. 그 후 공격자는 사용자가 특수하게 조작된 링크를 클릭하도록 유도합니다.  
...
-   기본적으로 Windows Server 2003 및 2008의 Internet Explorer는 [보안 강화 구성 (영문)](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 다음 섹션, "Windows Server 2003, Windows Server 2008 또는 Windows Server 2008 R2에서 Internet Explorer를 실행하고 있습니다. 이 취약점이 완화됩니까?"의 FAQ 항목을 참조하십시오.
  
#### MHTML MIME 형식의 요청 취약점(CVE-2011-0096)에 대한 대안
...
-   **MHTML 프로토콜 처리기 사용 안 함**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    MHTML 프로토콜 처리기를 사용하지 않도록 설정하려면 다음 레지스트리 키 백업 및 삭제 절차를 따르십시오.
  
    1.  레지스트리 편집기를 엽니다.  
    2.  다음 레지스트리 키로 이동합니다.  
        HKEY\_CLASSES\_ROOT\\CLSID\\{05300401-BCBC-11d0-85E3-00C04FD85AB4}  
    3.  레지스트리 키를 마우스 오른쪽 단추로 클릭하고 **내보내기**를 선택한 다음 레지스트리 파일(예: "mhtml.reg")로 저장하여 레지스트리 키를 백업합니다.  
    4.  레지스트리 키를 마우스 오른쪽 단추로 클릭하고 **삭제**를 선택하여 레지스트리에서 키를 삭제합니다.
  
    **참고** 내보낸 .reg 파일을 대상 시스템에 복사하고 두 번 클릭하여 개별 시스템에 적용할 수 있습니다. 그룹 정책을 사용하여 도메인 전체에 적용할 수도 있습니다. 그룹 정책에 대한 자세한 내용은TechNet 문서, [그룹 정책 컬렉션](http://go.microsoft.com/fwlink/?linkid=215719)을 참조하십시오.
  
    **대안의 영향.** MHTML 프로토콜이 작동하지 않게 됩니다. MHTML을 사용하는 모든 응용 프로그램이 이 대안의 영향을 받습니다.
  
    **대안 실행 취소 방법.** 이 대안을 실행 취소하려면 위의 3단계에서 내보낸 레지스트리 파일을 두 번 클릭하십시오.
  
-   **MHTML 프로토콜 잠금 사용**
  
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
  
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2503658](http://support.microsoft.com/kb/2503658)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
  
    MHTML을 잠그려면 다음 텍스트를 메모장 같은 텍스트 편집기에 복사하여 붙여 넣으십시오. 그런 다음 .reg 파일 이름 확장명을 사용하여 파일을 저장하십시오.
  
    **Microsoft Windows 32비트 에디션:**
    ...
    **대안의 영향.** MHTML 문서 내의 모든 영역에서 스크립트의 실행을 방지하기 위해 MHTML 프로토콜이 제한됩니다. MHTML을 사용하는 모든 응용 프로그램이 이 대안의 영향을 받습니다. in 표준 HTML 파일의 스크립트는 이 대안의 영향을 받지 않습니다.
...
#### MHTML MIME 형식의 요청 취약점(CVE-2011-0096)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 지원 대상인 모든 Microsoft Windows 릴리스에 영향을 미치는 정보 유출 취약점입니다.
  
**취약점의 원인은 무엇입니까?**    
MHTML이 문서 내의 콘텐츠 블록에 대한 MIME 형식의 요청을 해석할 때 취약점이 발생합니다. 이로 악용하면 공격자가 잘못된 보안 컨텍스트에서 스크립트를 실행할 수 있습니다(예: 일부 스크립트가 잘못된 Internet Explorer 보안 영역에서 실행될 수 있음).
  
**MHTML이란 무엇입니까?**    
MHTML(MIME Encapsulation of Aggregate HTML)은 HTML 콘텐츠를 래핑하는 데 사용되는 MIME 구조를 정의하는 인터넷 표준입니다. Windows의 MHTML 프로토콜 처리기는 MHTML로 인코딩된 문서가 응용 프로그램에서 렌더링될 수 있도록 하는 [플러그 가능한 프로토콜 (영문)](http://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx)을 제공합니다.
...
영향을 받는 구성 요소는 Outlook Express, Windows Mail, Internet Explorer 및 Microsoft Office 프로그램(예: Microsoft Word) 등 여러 제품에서 사용되는 MHTML입니다.
...
MHTML이 문서 내의 콘텐츠 블록에 대한 MIME 형식의 요청을 해석하는 방식으로 인해 공격자는 잘못된 보안 컨텍스트에서 스크립트를 실행함으로써 이 취약점을 악용할 수 있습니다.
...
**MHTML 프로토콜 잠금 사용을 위해 Microsoft Fix it 솔루션을 설치했습니다. 이 보안 업데이트를 설치하면 어떤 영향을 받게 됩니까?**    
[Microsoft 기술 자료 문서 2503658](http://support.microsoft.com/kb/2503658)의 Microsoft Fix it 솔루션을 사용하여 MHTML 프로토콜을 잠글 수 있습니다. 보안 업데이트는 MHTML의 취약점을 해결하지만, Microsoft Fix it 솔루션으로 적용된 MHTML 프로토콜 잠금을 취소하지 않습니다. 보안 업데이트가 설치된 후에도 대안의 영향은 여전히 유효합니다. MHTML 프로토콜을 잠금 상태로 유지하지 않으려는 사용자는 Microsoft Fix it 솔루션을 사용하여 잠금을 사용하지 않도록 설정해야 합니다. Microsoft Fix it 솔루션에 대한 자세한 내용은 이전 섹션의 대안 항목, "MHTML 프로토콜 잠금 사용"을 참조하십시오.
  
**MHTML 프로토콜 잠금 사용을 위해 Microsoft Fix it 솔루션을 설치했습니다. 이 보안 업데이트를 설치하기 전에 이 업데이트를 제거해야 합니까?**    
아니요. 보안 업데이트 설치를 위해 Microsoft Fix it 솔루션을 제거할 필요는 없습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 MHTML 파서가 요청을 처리하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0096 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
예. 보안 공지가 릴리스되었을 때 이 취약점이 악용되고 있다는 보고를 받았습니다.
  
**이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?**    
예. 이 보안 업데이트는 현재 악용되고 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0096 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)이 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2503658$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2503658">Microsoft 기술 자료 문서 2503658</a> 참조</td>
</tr>
<tr class="even">
...
-   MHTML MIME 형식의 웹 요청 취약점(CVE-2011-0096)을 해결하기 위해 협력해 주신 [Google Security Team](http://www.google.co.kr/)
