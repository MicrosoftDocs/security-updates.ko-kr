...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2412048](https://support.microsoft.com/kb/2412048)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 2(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=aee3f2de-ccf3-4d32-b468-eede4e8afcd4&displaylang=ko)<sup>[1]</sup>
(KB2345212)
</td>
<td style="border:1px solid black;">
정보 유출
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 2(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=e5e60751-242a-4fdb-9852-6d94050d3d0e&displaylang=ko)<sup>[1]</sup>
(KB2345212)
</td>
<td style="border:1px solid black;">
정보 유출
...
HTML 삭제 취약점(CVE-2010-3243)과 HTML 삭제 취약점(CVE-2010-3324)은 이 업데이트(MS10-072)와 [Internet Explorer 누적 보안 업데이트](https://technet.microsoft.com/security/bulletin/ms10-071)(MS10-071) 업데이트로 해결됩니다.
...
**Microsoft Office SharePoint Server 2007 참고 사항** 위에 설명된 검색 테이블은 단일 서버를 이용한 Microsoft Office SharePoint Server 2007의 배포에 기초하고 있습니다. 검색 도구는 다중 시스템 SharePoint 서버 팜의 일부로 구성된 시스템에 대한 업데이트 적용 여부를 검색하지 않습니다. 독립 실행형 및 다중 서버 구성에서의 업데이트 배포에 대한 자세한 내용은 TechNet 문서, [Office SharePoint Server 2007에 대한 소프트웨어 업데이트 배포](https://technet2.microsoft.com/office/en-us/library/f484f5f2-35bb-4d70-bf56-dd1c4c287c721033.mspx)를 참조하십시오.
...
<td style="border:1px solid black;">Microsoft Windows SharePoint Services 3.0에 대한 자세한 내용은 <a href="https://support.microsoft.com/kb/2345304">Microsoft 기술 자료 문서 2345304</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft SharePoint Foundation 2010에 대한 자세한 내용은 <a href="https://support.microsoft.com/kb/2345322">Microsoft 기술 자료 문서 2345322</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2345212">Microsoft 기술 자료 문서 2345212</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2346298">Microsoft 기술 자료 문서 2346298</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2346411">Microsoft 기술 자료 문서 2346411</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   HTML 삭제 취약점(CVE-2010-3243)을 보고해 주신 [Google Inc.](https://www.google.com/)의 [Sirdarckcat (영문)](https://www.sirdarckcat.net/)  
