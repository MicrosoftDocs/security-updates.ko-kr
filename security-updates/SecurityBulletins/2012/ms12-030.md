---
TOCTitle: 'MS12-030'
Title: 'Microsoft 보안 공지 MS12-030 - 중요'
ms:assetid: 'ms12-030'
ms:contentKeyID: 61230497
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-030(v=Security.10)'
---

Microsoft 보안 공지 MS12-030 - 중요
===================================

Microsoft Office의 취약점으로 인한 원격 코드 실행 문제점 (2663830)
------------------------------------------------------------------

게시된 날짜: 2012년 5월 8일 화요일 | 업데이트된 날짜: 2012년 5월 10일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Excel 2003, Microsoft Excel 2007, Microsoft Office 2007, Microsoft Excel 2010, Microsoft Office 2010, Microsoft Office 2008 for Mac 및 Microsoft Office for Mac 2011 에디션과 지원 대상인 모든 Microsoft Excel Viewer 및 Microsoft Office 호환 기능 팩 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft Excel이 특수하게 조작된 Excel 파일을 열 때 데이터의 유효성을 확인하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;">
[MS11-096](https://go.microsoft.com/fwlink/?linkid=232696)의 KB2596954는 KB2597086으로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047)의 KB2553073은 KB2597161로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047)의 KB2553070은 KB2597166으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-094](https://go.microsoft.com/fwlink/?linkid=232493)의 KB2644354는 KB2665346으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-089](https://go.microsoft.com/fwlink/?linkid=225739)의 KB2644347은 KB2665351로 대체되었습니다.
</td>
</tr>
<tr>
<th style="border:1px solid black;" colspan="5">
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047)의 KB2553075는 KB2596842로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047)의 KB2553074는 KB2597162로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
이 업데이트는 MS12-029와 어떤 관련이 있습니까?
이 공지에서 제공하는 Microsoft Office 2008 for Mac(KB2665346) 및 Microsoft Office for Mac 2011(KB2665351)용 보안 업데이트 패키지는 [MS12-029](https://go.microsoft.com/fwlink/?linkid=248419) 보안 공지에서 설명하는 취약점도 해결합니다.
...
취약점에 대한 공격 경로는 Microsoft Excel을 통하는 것입니다. 이 공지가 Microsoft Office 업데이트인 이유는 무엇입니까?
이 공지에서 설명한 취약점에 대한 공격 경로는 영향을 받는 버전의 Microsoft Excel을 통한 것이지만 취약한 코드는 Microsoft Office의 공유 구성 요소에 포함되어 있습니다. 지원 대상인 일부 Microsoft Access, Microsoft Word 및 Microsoft PowerPoint를 비롯한 기타 Microsoft Office 소프트웨어에 Microsoft Office의 취약한 공유 구성 요소가 포함되어 있지만 이 취약한 코드에 액세스할 수 없으므로 이 취약점의 영향을 받지 않습니다. 그러나 취약한 코드가 있는 것이 사실이기 때문에 이 업데이트가 제공되는 것입니다.
...
Microsoft Office 2007 서비스 팩 2, Microsoft Office 2007 서비스 팩 3, Microsoft Office 2010 및 Microsoft Office 2010 서비스 팩 1에 대해 여러 패키지 업데이트를 사용할 수 있는 이유는 무엇입니까?   
이 공지에 설명된 취약점을 해결하는 데 필요한 업데이트는 Microsoft Office 2007 및 Microsoft Office 2010에 대한 요소화된 서비스 모델 때문에 영향을 받는 소프트웨어 표에 설명된 것처럼 여러 다른 서버-패키지 업데이트에 제공됩니다. 취약점으로부터 보호하려면 두 업데이트가 모두 필요하지만 특정 순서로 설치할 필요는 없습니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [5월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-may)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
<th style="border:1px solid black;" >
Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0141(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0141)을 참조하십시오.

#### Excel 파일 형식 메모리 손상 취약점(CVE-2012-0141)에 대한 완화 요소
...
#### Excel 파일 형식 메모리 손상 취약점(CVE-2012-0141)에 대한 대안
...
#### Excel 파일 형식 메모리 손상 취약점(CVE-2012-0141)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0142(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0142)를 참조하십시오.

#### OBJECTLINK 레코드의 Excel 파일 형식 메모리 손상 취약점(CVE-2012-0142)에 대한 완화 요소
...
#### OBJECTLINK 레코드의 Excel 파일 형식 메모리 손상 취약점(CVE-2012-0142)에 대한 대안
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    <tr class="odd">
    <td style="border:1px solid black;">Microsoft Excel 2007</td>
    <td style="border:1px solid black;">Windows Registry Editor Version5.00<br />
    <br />
    [HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Excel\Security\FileOpenBlock]<br />
    <br />
    &quot;BinaryFiles&quot;=dword:00000000</td>
...
#### OBJECTLINK 레코드의 Excel 파일 형식 메모리 손상 취약점(CVE-2012-0142)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0143(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)을 참조하십시오.

#### 여러 수정된 바이트를 사용한 Excel 메모리 손상 취약점(CVE-2012-0143)에 대한 완화 요소
...
#### 여러 수정된 바이트를 사용한 Excel 메모리 손상 취약점(CVE-2012-0143)에 대한 대안
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. Microsoft Office 2003의 경우, 파일 차단 정책은 구현했으나 특수 면제 디렉터리(exempt directory)를 구성하지 않았거나 파일을 신뢰할 수 있는 위치로 이동하지 않은 사용자는 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
#### 여러 수정된 바이트를 사용한 Excel 메모리 손상 취약점(CVE-2012-0143)에 대한 FAQ
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-0143(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0184(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0184)를 참조하십시오.

#### Excel SXLI 레코드 메모리 손상 취약점(CVE-2012-0184)에 대한 완화 요소
...
#### Excel SXLI 레코드 메모리 손상 취약점(CVE-2012-0184)에 대한 대안
...
#### Excel SXLI 레코드 메모리 손상 취약점(CVE-2012-0184)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0185(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0185)를 참조하십시오.

#### Excel MergeCells 레코드 힙 오버플로 취약점(CVE-2012-0185)에 대한 완화 요소
...
#### Excel MergeCells 레코드 힙 오버플로 취약점(CVE-2012-0185)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   Excel 2007에서 유효성 검사에 실패하는 파일을 열지 못하도록 Office 파일 유효성 검사 설정

    참고 이 대안을 적용하기 전에 해당 버전의 Microsoft Office에 대해 Office 파일 유효성 검사를 사용하도록 설정되어 있어야 합니다. Microsoft Office 2007에서 Office 파일 유효성 검사를 사용하도록 설정하는 방법에 대한 자세한 내용은 TechNet 문서 [Office 2003 및 Office 2007용 Office 파일 유효성 검사(영문)](https://technet.microsoft.com/ko-kr/library/gg985445(office.12).aspx)를 참조하십시오.
...
#### Excel MergeCells 레코드 힙 오버플로 취약점(CVE-2012-0185)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1847(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1847)을 참조하십시오.

#### Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)에 대한 완화 요소
...
#### Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)에 대한 대안
...
#### Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)에 대한 FAQ
...
| Microsoft Office 2007 서비스 팩 2 및 Microsoft Excel 2007 서비스 팩 3                  | 예     |
| Microsoft Office 2010 및 Microsoft Excel 2010 서비스 팩 1(32비트 에디션)               | 예     |
| Microsoft Office 2010 및 Microsoft Excel 2010 서비스 팩 1(64비트 에디션)               | 예     |
...
| Microsoft Office 2007 서비스 팩 2 및 Microsoft Excel 2007 서비스 팩 3                  | 예                  | 예                         |
| Microsoft Office 2010 및 Microsoft Excel 2010 서비스 팩 1(32비트 에디션)               | 예                  | 예                         |
| Microsoft Office 2010 및 Microsoft Excel 2010 서비스 팩 1(64비트 에디션)               | 예                  | 예                         |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2597086">Microsoft 기술 자료 문서 2597086</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="https://support.microsoft.com/kb/2597161">Microsoft 기술 자료 문서 2597161</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 2007의 경우 <a href="https://support.microsoft.com/kb/2597969">Microsoft 기술 자료 문서 2597969</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="https://support.microsoft.com/kb/2596842">Microsoft 기술 자료 문서 2596842</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 호환 기능 팩의 경우 <a href="https://support.microsoft.com/kb/2597162">Microsoft Knowledge Base Article 2597162</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2597166">Microsoft 기술 자료 문서 2597166</a> 및 <a href="https://support.microsoft.com/kb/2553371">Microsoft 기술 자료 문서 2553371</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2008 for Mac 12.3.3 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=8f85fc23-480e-4835-9ce5-0aa56702ef59)에서 다운로드하여 설치하십시오.
...
Microsoft Office for Mac 2011 14.2.2 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=5d88d3d4-89bd-44c3-9e5a-657998223e2f)에서 다운로드하여 설치하십시오.
...
-   Excel 파일 형식 메모리 손상 취약점(CVE-2012-0141)을 보고해 주신 [Omair(영문)](https://krash.in/)  
-   OBJECTLINK 레코드의 Excel 파일 형식 메모리 손상 취약점(CVE-2012-0142)을 보고해 주신 [Omair(영문)](https://krash.in/)  
-   Excel SXLI 레코드 메모리 손상 취약점(CVE-2012-0184)을 [VeriSign iDefense Labs(영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 Omair  
-   Excel MergeCells 레코드 힙 오버플로 취약점(CVE-2012-0185)을 [VeriSign iDefense Labs(영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 Sean Larsson 및 Jun Mao  
-   Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)을 [VeriSign iDefense Labs(영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 Sean Larsson 및 Jun Mao  
-   Excel 계열 레코드 구문 분석 유형 불일치 취약점(CVE-2012-1847)을 [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
...
-   V1.1(2012년 5월 10일): 요약에서 알려진 문제에 대한 잘못된 참조가 제거되었으며 CVE-2012-1847의 제목을 변경하였습니다.
