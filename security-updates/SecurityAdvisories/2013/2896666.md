...
Microsoft는 비공개적으로 보고된 이 취약점에 대해 조사를 완료했습니다. Microsoft 그래픽 구성 요소 메모리 손상 취약점([CVE-2013-3906](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3906)(영문))을 해결하기 위해 [MS13-096](http://go.microsoft.com/fwlink/?linkid=344108)이 게시되었습니다. 이 문제점에 대한 자세한 정보와 사용 가능한 보안 업데이트의 다운로드 링크를 보려면 [MS13-096](http://go.microsoft.com/fwlink/?linkid=344108)을 검토하십시오.
