...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2305420](http://support.microsoft.com/?kbid=2305420)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3338 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338)을 참조하십시오.
...
작업 스케줄러는 선택한 컴퓨터에서 일상적인 작업의 자동화를 가능하게 하는 Windows 서비스입니다. 작업 스케줄러는 사용자가 작업 시작을 위해 선택한 기준(트리거라고 함)을 모니터링하고 기준이 충족되면 작업을 실행하여 이 기능을 수행합니다. 자세한 내용은 MSDN 라이브러리 항목 [작업 스케줄러 (영문)](http://msdn.microsoft.com/en-us/library/aa383614(vs.85).aspx)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3338 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338)이 지정되었습니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3338 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2305420">Microsoft 기술 자료 문서 2305420</a> 참조</td>
</tr>
<tr class="odd">
...
-   작업 스케줄러 취약점(CVE-2010-3338)을 보고해 주신 [Kaspersky Lab](http://usa.kaspersky.com/)의 Sergey Golovanov, Alexander Gostev, Maxim Golovkin 및 Alexey Monastyrsky와 [Design and Test Lab (영문)](http://www.dnt-lab.com/)의 Vitaly Kiktenko 및 Alexander Saprykin  
-   작업 스케줄러 취약점(CVE-2010-3338)을 보고해 주신 [Symantec (영문)](http://www.symantec.com/index.jsp)의 Liam O Murchu  
-   작업 스케줄러 취약점(CVE-2010-3338)을 보고해 주신 [ESET (영문)](http://www.eset.com/)의 Alexandr Matrosov, Eugene Rodionov, Juraj Malcho 및 David Harley
