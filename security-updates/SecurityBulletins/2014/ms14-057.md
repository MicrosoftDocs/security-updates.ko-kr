...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4073](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4073)(영문)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4121(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4121)을 참조하십시오.

### 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   .NET 4.0 응용 프로그램에서 iriParsing은 기본적으로 비활성화 상태입니다. 취약점이 악용될 수 있기 때문에 응용 프로그램은 app.config 파일에서 &lt;iriParsing enabled="true"/&gt;을 설정함으로써 명시적으로 이 기능을 사용합니다. 자세한 내용은 [&lt;iriParsing&gt; 요소(URI 설정)](http://msdn.microsoft.com/ko-kr/library/bb882600(v=vs.110).aspx)를 참조하십시오. .NET 4.5 응용 프로그램에서 iriParsing은 기본적으로 활성화되어 있으며 비활성화할 수 없습니다. 자세한 내용은 [.NET Framework 4.5의 응용 프로그램 호환성](http://msdn.microsoft.com/ko-kr/library/hh367887(v=vs.110).aspx)을 참조하십시오.
...
-   **.NET 4.0 응용 프로그램에 대한 app.config 파일에서 iriParsing을 "false"로 설정**
    ...
    자세한 내용은 [&lt;iriParsing&gt; 요소(URI 설정)](http://msdn.microsoft.com/ko-kr/library/bb882600(v=vs.110).aspx)를 참조하십시오.

    .NET 4.5의 경우 이 옵션은 사용할 수 없습니다. 자세한 내용은 [.NET Framework 4.5의 응용 프로그램 호환성](http://msdn.microsoft.com/ko-kr/library/hh367887(v=vs.110).aspx)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4122](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4122)(영문)를 참조하십시오.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>설치 스위치</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2844699/ko">Microsoft 기술 자료 문서 2844699</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>로그 파일 업데이트</strong></td>
<td style="border:1px solid black;">Microsoft .NET Framework 2.0 서비스 팩 2:<br />
...
2978042 업데이트는 <a href="http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ko-kr">Windows Update</a>에서 제공됩니다.<br />
2979577 업데이트는 <a href="http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ko-kr">Windows Update</a>에서 제공됩니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;">Windows RT 8.1의 Microsoft .NET Framework 4.5.1/4.5.2:<br />
2978041 업데이트는 <a href="http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ko-kr">Windows Update</a>에서 제공됩니다.<br />
2979576 업데이트는 <a href="http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ko-kr">Windows Update</a>에서 제공됩니다.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>다시 시작 요구 사항</strong></td>
...
-   .NET ClickOnce 권한 상승 취약점(CVE-2014-4073)을 보고해 주신 [Context Information Security(영문)](http://www.contextis.com/)의 James Forshaw
...
고객에 대한 보안을 강화하기 위해 Microsoft는 월별 보안 업데이트를 배포하기 전에 주요 보안 소프트웨어 제공업체에 취약점 정보를 제공합니다. 보안 소프트웨어 제공업체는 이 취약점 정보를 사용하여 안티바이러스, 네트워크 기반 침입 탐지 시스템 또는 호스트 기반 침임 방지 시스템 등 자사의 보안 소프트웨어나 장치를 통해 업데이트된 보호 기능을 고객에게 제공할 수 있습니다. 보안 소프트웨어 제공업체가 활성 보호 기능을 제공하는지 확인하려면 [Microsoft MAPP(Active Protections Program) 파트너(문문)](http://technet.microsoft.com/ko-kr/security/dn467918)에 나열된 프로그램 파트너가 제공하는 활성 보호 기능 웹 사이트를 참조하십시오.
  
### 지원
  
**이 보안 업데이트에 대한 도움말 및 지원을 얻는 방법**
  
-   업데이트 설치 도움말: [Microsoft 업데이트에 대한 지원](http://support.microsoft.com/ph/6527/ko)  
