...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59266a9d-a319-4309-a046-7f15c6da0136&amp;displaylang=ko">Windows XP 서비스 팩 3</a><br />
(KB2412687)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3797009a-b9a4-4e83-8614-e1589c8b5090">Windows XP Professional x64 Edition 서비스 팩 2</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd284233-e177-4064-9b02-f83dcb727dbe&amp;displaylang=ko">Windows Server 2003 서비스 팩 2</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d5adaf4e-4cd7-42ea-8202-31b5c856f5e3&amp;displaylang=ko">Windows Server 2003 x64 Edition 서비스 팩 2</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=72a513bb-f901-4992-8562-d1afe1afec8a">Windows Server 2003 SP2(Itanium 기반 시스템용)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ff2e440-79c2-4045-b225-913d1740fdb9&amp;displaylang=ko">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4d826026-e62a-4cec-8682-49fbe7f65cd6&amp;displaylang=ko">Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fbada866-7d36-4b85-acde-fd856a998737&amp;displaylang=ko">Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2</a>\*\*\*<br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f4ddfcb-374d-4cad-8c61-2b988b46f628&amp;displaylang=ko">Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2</a>\*\*\*<br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2fd71543-0e18-4907-89b9-355d24d7db69">Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
이 공지에서 제공하는 Microsoft Office XP(KB2509461)에 대한 보안 업데이트 패키지도 [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-029) 보안 공지에 설명된 취약점을 해결합니다. Microsoft Office XP가 설치된 사용자는 보안 업데이트 패키지를 한 번만 설치하면 됩니다.

**GDI+에 대한 최신 Microsoft 보안 공지인 MS09-062에는 이 공지에 없는 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어가 나열되어 있습니다. 그 이유는 무엇입니까?**  
이 공지에 나열된 소프트웨어는 지원되는 버전 또는 에디션 중 영향을 받는 것과 영향을 받지 않는 것을 확인하기 위한 테스트 과정을 거쳤습니다. [MS09-062](https://technet.microsoft.com/security/bulletin/ms09-062)에 나열된 기타 버전 또는 에디션은 지원 기간이 끝났거나 더 이상 지원되지 않는 Windows 2000 서비스 팩 4에 설치된 GDI+에만 해당됩니다. 사용 중인 소프트웨어 버전에 대한 지원 기간을 확인하려면 [Microsoft 지원 기간 정책 웹 사이트](https://go.microsoft.com/fwlink/?linkid=21742)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0041 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0041)을 참조하십시오.
...
-   **메타파일 처리 사용 안 함**
    ...
    [MS07-017](https://technet.microsoft.com/security/bulletin/ms07-017)을 적용했거나 Windows Vista 또는 Windows Server 2008을 사용하는 고객은 레지스트리를 수정하여 메타파일 처리를 사용하지 않도록 설정할 수 있습니다. 이 취약점을 악용하려는 시도로부터 영향을 받는 시스템을 보호하는 데 이 설정이 유용합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2412687">Microsoft 기술 자료 문서 2412687</a> 참조</td>
</tr>
<tr class="even">
...
-   GDI+ 정수 오버플로 취약점(CVE-2011-0041)을 보고해 주신 [VUPEN Threat Protection Program (영문)](https://www.vupen.com/english/services/tpp-index.php)의 Nicolas Joly 및 Chaouki Bekrar
