---
TOCTitle: 'MS08-027'
Title: 'Microsoft 보안 공지 MS08-027 - 긴급'
ms:assetid: 'ms08-027'
ms:contentKeyID: 61230135
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-027(v=Security.10)'
---
...
게시된 날짜: 2008년 5월 14일 수요일 | 업데이트된 날짜: 2008년 6월 5일 목요일
...
이 보안 업데이트의 심각도는 Microsoft Office Publisher 2000 서비스 팩 3에 대해 긴급이며, 지원되는 Microsoft Office Publisher 2002, Microsoft Office Publisher 2003 및 Microsoft Office Publisher 2007 버전에 대해 중요입니다. 자세한 내용은 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

취약점에 대한 자세한 내용은 **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 고객에게 업데이트를 즉시 적용하도록 권장합니다.

**알려진 문제점.** [Microsoft 기술 자료 문서 951208](https://support.microsoft.com/kb/951208)은 고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 현재까지 알려진 문제점과 권장 해결 방법을 다룹니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8675b9b6-fbf0-4ad2-9210-285e2cc10556">Microsoft Office Publisher 2000 서비스 팩 3</a><br />
(KB950682)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=df623784-6e26-42c0-9e21-e7960b849e1e">Microsoft Office Publisher 2002 서비스 팩 3</a><br />
(KB950129)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c18b060b-9828-4952-8e80-5328c0832d83">Microsoft Office Publisher 2003 서비스 팩 2</a><br />
(KB950213)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-012">MS08-012</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c18b060b-9828-4952-8e80-5328c0832d83">Microsoft Office Publisher 2003 서비스 팩 3</a><br />
(KB950213)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e4b647c2-79a3-49e0-9b1d-741667fdbcca">Microsoft Office Publisher 2007</a><br />
(KB950114)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e4b647c2-79a3-49e0-9b1d-741667fdbcca">Microsoft Office Publisher 2007 서비스 팩 1</a><br />
(KB950114)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 951208](https://support.microsoft.com/kb/951208)에 나와 있습니다.
  
**이 문서에서 다뤄지는 Microsoft Office 구성 요소는 내 시스템에 설치되어 있는 Office 제품군의 일부입니다. 하지만 이 특정 구성 요소를 설치하도록 선택하지 않습니다. 이 업데이트가 제공됩니까?**  
예. 사용자 시스템에 설치되어 있는 Microsoft Office 제품군 버전이 이 공지에서 다뤄지는 구성 요소와 함께 공급된 경우, 해당 구성 요소의 설치 여부와 상관없이 시스템에 업데이트가 제공됩니다. 영향을 받는 시스템을 검사하는 데 사용되는 검사 논리는 특정 Microsoft Office 제품군과 함께 공급된 모든 구성 요소의 업데이트를 검사하도록 설계되어 있으므로 해당 시스템에 해당되는 업데이트를 제공합니다. 사용자는 설치되어 있지 않지만 해당 Microsoft Office 제품군 버전에 포함되어 있는 구성 요소에 대해 업데이트를 적용하지 않도록 선택할 수 있으며, 해당 시스템의 보안 심각도는 증가되지 않습니다. 사용자가 업데이트를 설치하지 않도록 선택한 경우에도 시스템의 보안이나 성능에 부정적인 영향은 없습니다. 이 문제점에 대한 자세한 내용은 [Microsoft 기술 자료 문서 830335](https://support.microsoft.com/kb/830335)를 참조하십시오.
...
**이 업데이트의 심각도가 Microsoft Office Publisher 2000에 대해서만 긴급이고, 영향을 받는 다른 모든 버전의 Publisher에 대해서는 중요인 이유가 무엇입니까?**  
Microsoft Office Publisher 2002 이상에는 문서를 열기 전에 사용자에게 열기, 저장 또는 취소 권한을 부여할 수 있는 기능이 내장되어 있습니다. 이 취약점을 악용하려면 둘 이상의 사용자 작업이 필요하기 때문에 이 완화 요소로 인해 취약점이 긴급에서 중요로 낮아집니다.
...
<th style="border:1px solid black;" >Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Publisher 2000 서비스 팩 3</td>
<td style="border:1px solid black;"><strong>긴급</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Publisher 2002 서비스 팩 3</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Publisher 2003 서비스 팩 2</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Publisher 2003 서비스 팩 3</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
...
Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)  
-------------------------------------------------------
  

Microsoft Office Publisher에서 개체 헤더 데이터에 대한 유효성 검사를 수행하는 방식에 원격 코드 실행 취약점이 존재합니다. 공격자는 전자 메일 첨부 파일로 포함되거나 특수하게 조작되거나 공격에 노출된 웹 사이트에서 호스팅될 수 있는 특수하게 조작된 Publisher 파일을 보내 취약점을 악용할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0119 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0119)를 참조하십시오.
  
#### Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)에 대한 완화 요소
...
-   Office 2000용 Office 문서 열기 확인 도구를 설치하여 사용하고 있는 사용자의 경우 문서를 열기 전에 열기, 저장 또는 취소 여부를 묻는 메시지가 표시됩니다. [Office 문서 열기 확인 도구](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f&displaylang=ko)의 기능은 Office XP 이후 에디션에 포함되어 있습니다.
  
#### Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)에 대한 대안
...
#### Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)에 대한 FAQ
...
**개체 처리기란 무엇이고, 어떤 기능을 수행합니까?**  
개체 처리기는 OLE 서버 응용 프로그램에 대한 동적 연결 라이브러리(DLL)입니다. 이 DLL은 클라이언트와 서버 응용 프로그램 간의 매개 역할을 수행하며, 예를 들어 클라이언트 응용 프로그램의 창에서 개체를 다시 그려야 하는 경우 필요에 따라 성능을 향상시킵니다.
...
Microsoft Office Publisher를 사용하는 시스템이 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Publisher 파일을 열 때 개체 처리기 데이터에 대해 적절한 유효성 검사를 수행하여 취약점을 제거합니다.
...
| 소프트웨어                                  | MBSA 2.1 |  
|---------------------------------------------|----------|  
| Microsoft Office Publisher 2000 서비스 팩 3 | 아니요   |  
| Microsoft Office Publisher 2002 서비스 팩 3 | 예       |  
| Microsoft Office Publisher 2003 서비스 팩 2 | 예       |  
| Microsoft Office Publisher 2003 서비스 팩 3 | 예       |  
| Microsoft Office Publisher 2007             | 예       |  
...
|---------------------------------------------|---------|----------------------|---------------------|-----------|  
| Microsoft Office Publisher 2000 서비스 팩 3 | 예      | 예                   | 아니요              | 아니요    |  
| Microsoft Office Publisher 2002 서비스 팩 3 | 예      | 예                   | 예                  | 예        |  
| Microsoft Office Publisher 2003 서비스 팩 2 | 예      | 예                   | 예                  | 예        |  
| Microsoft Office Publisher 2003 서비스 팩 3 | 예      | 예                   | 예                  | 예        |  
| Microsoft Office Publisher 2007             | 아니요  | 아니요               | 예                  | 예        |  
...
<td style="border:1px solid black;">office2000-kb950682-fullfile-kor/q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2000-kb950682-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/951208">Microsoft 기술 자료 문서 951208</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">officeXP-kb950129-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">officeXP-kb950129-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">office2003-kb950213-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2003-kb950213-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
| **배포**                  |                                                                                                                                                                                   |  
| 사용자 개입 없이 설치     | publisher2007-kb950114-fullfile-x86-glb /passive                                                                                                                                  |  
| 다시 시작하지 않고 설치   | publisher2007-kb950114-fullfile-x86-glb /norestart                                                                                                                                |  
...
| **파일 정보**             | [Microsoft 기술 자료 문서 951208](https://support.microsoft.com/kb/951208)을 참조하십시오.                                                                                         |  
| **레지스트리 키 확인**    | 해당 사항 없음                                                                                                                                                                    |
...
-   Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)을 보고해 주신 [Fortinet Security Research (영문)](https://www.fortinet.com/)의 Cocoruder
...
-   V1.1 2008년 6월 5일: 요약의 알려진 문제점에 Microsoft 기술 자료 문서 951208 링크가 추가되었습니다.
