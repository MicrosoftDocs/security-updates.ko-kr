---
TOCTitle: 'MS11-053'
Title: 'Microsoft 보안 공지 MS11-053 - 긴급'
ms:assetid: 'ms11-053'
ms:contentKeyID: 61230420
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-053(v=Security.10)'
---



Microsoft 보안 공지 MS11-053 - 긴급
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows Vista 및 Windows 7 에디션에 대해 긴급입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows Bluetooth 스택이 메모리에서 개체를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2566220](http://support.microsoft.com/kb/2566220)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6bff74ac-45f3-4585-92da-316921b458fa&amp;displaylang=ko">Windows Vista 서비스 팩 1</a>[1]<br />
(KB2561109)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a1e5aa7d-5f38-4ce2-9575-4b4cb7520160&amp;displaylang=ko">Windows Vista 서비스 팩 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=849d2694-c8b3-4670-8203-912661bccabf&amp;displaylang=ko">Windows Vista x64 Edition 서비스 팩 1</a>[1]<br />
(KB2561109)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4287eeb4-ab29-4727-83f2-260d838b44d4&amp;displaylang=ko">Windows Vista x64 Edition 서비스 팩 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01&amp;displaylang=ko">Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa&amp;displaylang=ko">Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<sup>[1]</sup>Windows Vista 서비스 팩 1은 선택적인 Windows Vista Feature Pack for Wireless가 설치되어 있을 때만 영향을 받습니다. 자세한 내용은 업데이트 FAQ를 참조하십시오.
...
**Windows Vista 서비스 팩 1을 실행하고 있습니다.** **내 시스템이 이 취약점의 영향을 받습니까?**      
Windows Vista 서비스 팩 1은 Bluetooth 2.1 기술을 지원하는 시스템에서만 영향을 받습니다. [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567)를 설치한 Windows Vista 서비스 팩 1 고객은 Bluetooth 2.1 기술 지원이 제공되므로 이 취약점의 영향을 받습니다. 이러한 고객은 보안 업데이트 KB2561109를 설치해야 합니다. Windows Vista Feature Pack for Wireless를 설치하지 않은 고객은 Bluetooth 2.1 지원을 받지 못하므로 이 취약점의 영향을 받지 않습니다. 자세한 내용은 [Microsoft 기술 자료 문서 2566220](http://support.microsoft.com/kb/2566220)을 참조하십시오.
  
**Windows Vista 서비스 팩 1용 Windows Vista Feature Pack for Wireless를 설치했지만 Windows Vista 서비스 팩 2로 업그레이드했습니다. 어떤 업데이트를 설치해야 합니까?**      
Windows Vista 서비스 팩 1용 [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567)를 사용하도록 설정했으며 Windows Vista 서비스 팩 2로 성공적으로 업그레이드한 고객은 보안 업데이트 KB2532531을 설치해야 합니다. 자세한 내용은 [Microsoft 기술 자료 문서 2566220](http://support.microsoft.com/kb/2566220)을 참조하십시오.
...
<th style="border:1px solid black;" >Bluetooth 스택 취약점(CVE-2011-1265)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
Bluetooth 스택 취약점(CVE-2011-1265)  
------------------------------------
  

메모리의 개체가 잘못 초기화되었거나 삭제되었을 때 해당 개체가 액세스되는 방식 때문에 Windows Bluetooth 2.1 스택에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 일련의 Bluetooth 패킷을 생성하고 대상 시스템으로 전송하여 이러한 취약점을 악용할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1265 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265)를 참조하십시오.
  
#### Bluetooth 스택 취약점(CVE-2011-1265)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점은 Bluetooth 기능이 설치된 시스템에만 영향을 줍니다.
  
#### Bluetooth 스택 취약점(CVE-2011-1265)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **Bluetooth 드라이버 중지 및 사용 안 함**
  
    명령 프롬프트에서 다음 명령을 사용하여 해당 드라이버를 중지하고 사용하지 않도록 설정할 수 있습니다.
  
    `sc config bthport start= disabled`
  
    **대안 실행 취소 방법.**
  
    명령 프롬프트에서 다음 명령을 사용하여 Bluetooth 드라이버를 다시 사용하도록 설정할 수 있습니다.
  
    `sc config bthport start= demand`
  
#### Bluetooth 스택 취약점(CVE-2011-1265)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**      
이 취약점은 원격 코드 실행 취약점입니다.
  
**취약점의 원인은 무엇입니까?**      
이 취약점은 Windows Bluetooth 스택이 잘못 초기화되었거나 삭제된 메모리에 액세스하는 방식 때문에 발생합니다.
  
**Bluetooth란 무엇입니까?**      
Bluetooth는 컴퓨터, 핸드헬드 장치, 휴대폰 및 기타 장치에서 무선 연결을 구성할 수 있는 업계 표준 프로토콜입니다. 자세한 내용은 MSDN 문서 [Bluetooth (영문)](http://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx)를 참조하십시오.
...
공격자는 이 취약점을 악용하여 Bluetooth 라디오 스펙트럼 내에서 라디오 전송을 송수신하기 위해 대상 시스템과 같은 거리에 있어야 합니다. 그런 후 공격자는 특수하게 조작된 일련의 Bluetooth 패킷을 생성하고 대상 시스템으로 전송하여 이러한 취약점을 악용할 수 있습니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**      
주로 워크스테이션이 이 취약점으로 인한 위험에 노출됩니다.
  
**내 Windows Vista 또는 Windows 7 워크스테이션에 Bluetooth 기술이 없습니다. 이 취약점의 영향을 받게 됩니까?**      
예. Windows Vista 및 Windows 7은 다양한 Bluetooth 라디오 장치를 지원하며 시스템에 이동식 Bluetooth 장치가 추가될 때 Bluetooth 드라이버를 설치합니다. 따라서 지원되는 모든 Windows Vista 및 Windows 7 버전이 영향을 받습니다. 자세한 내용은 MSDN 문서 [Bluetooth 무선 기술 FAQ - 2010 (영문)](http://msdn.microsoft.com/windows/hardware/gg487349.aspx)을 참조하십시오.
  
**업데이트는 어떤 기능을 수행합니까?**      
이 업데이트는 Windows Bluetooth 2.1 스택이 메모리에서 개체를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">Windows Vista Feature Pack for Wireless가 설정된 Windows Vista 서비스 팩 1 32비트 에디션:<br />
Windows6.0-KB2561109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 서비스 팩 2 32비트 에디션:<br />
Windows6.0-KB2532531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista Feature Pack for Wireless가 설정된 Windows Vista 서비스 팩 1 x64 기반 에디션:<br />
Windows6.0-KB2561109-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 서비스 팩 2 x64 기반 에디션:<br />
...
<td style="border:1px solid black;">Windows Vista Feature Pack for Wireless가 설정된 Windows Vista 서비스 팩 1:<br />
<a href="http://support.microsoft.com/kb/2561109">Microsoft 기술 자료 문서 2561109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista 서비스 팩 2:<br />
<a href="http://support.microsoft.com/kb/2532531">Microsoft 기술 자료 문서 2532531</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2532531">Microsoft 기술 자료 문서 2532531</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
