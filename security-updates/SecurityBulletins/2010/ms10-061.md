---
TOCTitle: 'MS10-061'
Title: 'Microsoft 보안 공지 MS10-061 - 긴급'
ms:assetid: 'ms10-061'
ms:contentKeyID: 61230322
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-061(v=Security.10)'
---


Microsoft 보안 공지 MS10-061 - 긴급
===================================
...
이 보안 업데이트는 프린터 스풀러 서비스가 사용자 권한이 유효한지 확인하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=93faba6b-0a85-4acc-b527-a012bbf56b13&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9f7f3737-056d-44bd-b644-51093b5b501b)                                                               | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3d79680b-c071-462f-9cea-551fbd42edf0&displaylang=ko)                                                                | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=073b3305-4a81-4ef8-b6aa-e53b31a936b4&displaylang=ko)                                                    | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ca35a520-c4da-41bb-abcc-d5bc534ff19a)                                                           | 권한 상승      | 중요        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=028977fd-0f39-42d4-9fee-0d90a2931cfd&displaylang=ko)                                         | 권한 상승      | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c68b9337-883d-4e98-ba0a-90b5cad46184&displaylang=ko)                 | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e2e788de-8400-4bf6-b96b-a915154aa20a&displaylang=ko)\*     | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e08d4f49-5a13-4e1d-b0a7-27b314c2edb5&displaylang=ko)\* | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=098537d5-bf6e-4e04-ad33-1cde697e062f)          | 권한 상승      | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=34619e9e-1f00-40e4-be6f-5bbf5e3c801b&displaylang=ko)                                                                     | 권한 상승      | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=dbb747a5-658d-44cf-bd49-425d1700157f&displaylang=ko)                                                                   | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=11e20088-1be2-4166-9c97-234b7e9f1c4f&displaylang=ko)\*                                                    | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=d8c635f8-8978-44bf-b457-e07368f08ef4)                                                                 | 권한 상승      | 중요        | 없음                      |
...
**Windows XP 시스템에 대한 이 취약점의 심각도가 더 높은 이유는 무엇입니까?**  
Windows XP에서는 기본적으로 게스트 계정이 사용되도록 설정되어 있으므로 익명 사용자가 프린터 공유에 액세스할 수 있습니다. Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에서 공격자는 암호 기반 공유가 사용되지 않도록 설정된 경우가 아니면 이 취약점을 이용하기 위해 인증을 받아야 합니다. 암호 기반 공유가 사용되지 않도록 설정되어 있으면 공격자는 인증 없이 이러한 시스템을 이용할 수 있습니다.
...
<th style="border:1px solid black;" >인쇄 스풀러 서비스 가장 취약점(CVE-2010-2729)</th>
...
Windows 인쇄 스풀러 서비스에 인증되지 않은 원격 공격자가 영향을 받는 Windows XP 시스템에서 임의 코드를 실행할 수 있는 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 새 계정을 만들 수도 있습니다. 이 취약점은 지원 대상인 다른 모든 Microsoft Windows 시스템에서 권한 상승 취약점입니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2729 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729)를 참조하십시오.
  
#### 인쇄 스풀러 서비스 가장 취약점(CVE-2010-2729)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   기본적으로 프린터는 현재 지원되는 어떤 Windows 운영 체제에서도 공유되지 않습니다.  
-   시스템은 프린터를 공유하고 원격 공격자가 프린터 공유에 액세스할 수 있을 때만 원격 공격에 취약합니다.  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.
  
#### 인쇄 스풀러 서비스 가장 취약점(CVE-2010-2729)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **방화벽에서 RPC와 관련된 포트 차단**
  
    -   UDP 포트 135번, 137번, 138번, 445번 및 TCP 포트 135번, 139번, 445번, 593번  
    -   1024 이후의 포트에서 원치 않는 모든 인바운드 트래픽  
    -   기타 특별 구성된 RPC 포트
  
    이들 포트는 RPC와 연결을 시작하는 데 사용됩니다. 방화벽에서 이러한 포트를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 또한 원격 시스템에서 특수하게 구성된 다른 모든 RPC 포트도 차단해야 합니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
    ...
    **대안 실행 취소 방법.** 방화벽에서 UDP 포트 135, 137, 138, 445 및 TCP 포트 135, 139, 445, 593을 차단 해제합니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
  
-   **프린터 공유 사용 안 함**
  
    프린터 공유를 사용하지 않으려면 다음을 수행하십시오.
  
    Windows XP 및 Windows 2003 시스템:
  
    1.  **시작**을 클릭한 후 **프린터 및 팩스**를 클릭합니다.  
    2.  프린터 아이콘을 마우스 오른쪽 단추로 클릭한 후 **공유**를 선택합니다.  
    3.  **이 프린터 공유 안 함**을 선택한 후 **확인**을 클릭합니다.  
    4.  시스템에서 공유되는 모든 프린터에 대해 이 프로세스를 반복합니다.
  
    이후 버전의 모든 Windows 운영 체제:
  
    1.  **시작**을 클릭한 후 **장치 및 프린터**를 클릭합니다.  
    2.  프린터 아이콘을 마우스 오른쪽 단추로 클릭한 후 **프린터 속성**을 선택합니다.  
    3.  **공유** 탭을 선택합니다.  
    4.  **이 프린터 공유** 옵션이 선택되지 않았는지 확인한 후 **확인**을 클릭합니다.  
    5.  시스템에서 공유되는 모든 프린터에 대해 이 프로세스를 반복합니다.
  
    **대안의 영향.** 이 기능을 사용하지 않도록 설정하면 원격 사용자가 영향 받는 프린터로 인쇄할 수 없게 됩니다.
    ...
    **대안 실행 취소 방법:**
    ...
    2.  프린터 아이콘을 마우스 오른쪽 단추로 클릭한 후 **프린터 속성**을 선택합니다.  
    3.  **공유** 탭을 선택합니다.  
    4.  **이 프린터 공유** 옵션을 선택한 후 **확인**을 클릭합니다.  
    5.  시스템에서 공유되는 모든 프린터에 대해 이 프로세스를 반복합니다.
  
#### 인쇄 스풀러 서비스 가장 취약점(CVE-2010-2729)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 Windows 인쇄 스풀러가 인쇄 스풀러에 액세스하기 위한 사용자 권한을 충분히 제한하지 못할 때 발생합니다.
...
공격자는 RPC를 통해 인쇄 스풀러 인터페이스가 노출된 취약한 시스템으로 악의적인 인쇄 요청을 작성하여 전송함으로써 이러한 취약점을 악용할 수 있습니다. 대상 시스템은 원격 사용자가 충분한 권한이 있는지 여부를 제대로 확인하지 못하며 원격 공격자가 Windows 시스템 디렉터리에서 파일을 만들 수 있도록 허용합니다. 이러한 파일을 특정 위치에 놓으면 시스템에 의해 자동으로 실행될 수 있습니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**    
프린터를 공유하는 워크스테이션 및 터미널 서버와 인쇄 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 프린터 스풀러 서비스가 인쇄 스풀러 액세스에 대한 사용자 권한이 유효한지 확인하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2729 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729)가 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2347290$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2347290">Microsoft 기술 자료 문서 2347290</a> 참조</td>
</tr>
<tr class="even">
...
-   인쇄 스풀러 서비스 가장 취약점(CVE-2010-2729)을 보고해 주신 [Kaspersky Lab (영문)](https://www.kaspersky.com)의 Sergey Golovanov, Alexander Gostev, Maxim Golovkin 및 Alexey Monastyrsky와 [Design and Test Lab (영문)](https://www.dnt-lab.com)의 Vitaly Kiktenko 및 Alexander Saprykin  
-   인쇄 스풀러 서비스 가장 취약점(CVE-2010-2729)을 보고해 주신 [Symantec (영문)](https://www.symantec.com/index.jsp)의 Liam O Morchu
