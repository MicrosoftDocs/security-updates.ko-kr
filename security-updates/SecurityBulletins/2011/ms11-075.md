---
TOCTitle: 'MS11-075'
Title: 'Microsoft 보안 공지 MS11-075 - 중요'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61230442
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-075(v=Security.10)'
---


Microsoft 보안 공지 MS11-075 - 중요
===================================

Microsoft Active Accessibility의 취약점으로 인한 원격 코드 실행 문제점 (2623699)
--------------------------------------------------------------------------------

게시된 날짜: 2011년 10월 11일 화요일 | 업데이트된 날짜: 2011년 10월 26일 수요일
...
보안 업데이트는 Microsoft Active Accessibility 구성 요소에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=96af60b9-4b8d-4a9b-b125-10775bb48252&amp;displaylang=ko">Windows XP 서비스 팩 3</a><br />
(KB2564958)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c8fcf427-17d0-4caa-b406-50703f980862&amp;displaylang=ko">Windows XP Professional x64 Edition 서비스 팩 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=09e178f8-2bd2-46e1-b975-4938ee1f304d&amp;displaylang=ko">Windows Server 2003 서비스 팩 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9b8030db-1f47-4666-8cb5-1c56577f2340&amp;displaylang=ko">Windows Server 2003 x64 Edition 서비스 팩 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed&amp;displaylang=ko">Windows Server 2003 SP2(Itanium 기반 시스템용)</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=96b089c0-a2e7-44cb-9fc4-9569b3993afa&amp;displaylang=ko">Windows Vista 서비스 팩 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b79a389c-8340-4dd2-9ab1-a0943c5a220f&amp;displaylang=ko">Windows Vista x64 Edition 서비스 팩 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5&amp;displaylang=ko">Windows Server 2008(32비트 시스템용) 서비스 팩 2</a>\*<br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca&amp;displaylang=ko">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2</a>\*<br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b&amp;displaylang=ko">Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42&amp;displaylang=ko">Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07&amp;displaylang=ko">Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8&amp;displaylang=ko">Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1</a>\*<br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87&amp;displaylang=ko">Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms11-038">MS11-038</a></td>
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-oct)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >Active Accessibility의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1247)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
Active Accessibility의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1247)  
--------------------------------------------------------------------------
  
Microsoft Active Accessibility 구성 요소에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1247(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247)을 참조하십시오.
  
#### Active Accessibility의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1247)에 대한 완화 요소
...
#### Active Accessibility의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1247)에 대한 대안
...
-   사용 안 함
    ...
    1.  시작, 실행  
    2.  을 클릭하고 Services.msc를 입력한 다음 확인을 클릭합니다.  
    3.  WebClient 서비스를 마우스 오른쪽 단추로 클릭한 다음 속성을 선택합니다.  
    4.  시작 유형을 자동으로 변경합니다. 서비스가 실행 중인 경우 시작을 클릭합니다.  
    5.  확인을 클릭하고 관리 응용 프로그램을 종료합니다.
...
#### Active Accessibility의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1247)에 대한 FAQ
...
취약점의 원인은 무엇입니까?   
이 취약점은 Microsoft Active Accessibility 구성 요소가 외부 라이브러리 로드에 사용되는 경로를 부적절하게 제안하기 때문에 발생합니다.
  
Microsoft Active Accessibility 구성 요소란 무엇입니까?   
Microsoft Active Accessibility 구성 요소는 내게 필요한 도구가 Microsoft Windows에서 실행되는 응용 프로그램과 작동하는 방식을 개선하는 COM(Component Object Model) 기술입니다. 이 구성 요소는 UI 요소에 대한 정보를 안정적으로 노출하는 방법을 제공하는 COM 인터페이스 및 API 요소뿐만 아니라 운영 체제에 통합되는 동적 연결 라이브러리를 제공합니다. 자세한 내용은 MSDN 문서, [Microsoft Active Accessibility(영문)](https://msdn.microsoft.com/ko-kr/library/ms971350.aspx)를 참조하십시오.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 파일을 열도록 유도할 수 있습니다. 결과적으로 합법적인 파일을 열 때 Microsoft Active Accessibility 구성 요소가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 첨부 파일을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 합법적인 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 결과적으로 합법적인 파일을 열 때 Microsoft Active Accessibility 구성 요소가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
...
업데이트는 어떤 기능을 수행합니까?   
업데이트는 Microsoft Active Accessibility 구성 요소에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2564958$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2564958">Microsoft 기술 자료 문서 2564958</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">제거 정보</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003의 32비트 및 x64 기반 에디션:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2564958$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2605295$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003의 32비트 및 x64 기반 에디션:<br />
<a href="https://support.microsoft.com/kb/2564958">Microsoft 기술 자료 문서 2564958</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
<a href="https://support.microsoft.com/kb/2605295">Microsoft 기술 자료 문서 2605295</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003의 32비트 및 x64 기반 에디션:<br />
...
-   Active Accessibility의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1247)을 [Adobe Systems, Inc.](https://www.adobe.com/korea)의 Anshul Kothari 및 Nishant Kaushik와 협력하여 보고해 주신 [Mila Parkour(영문)](https://contagiodump.com)
...
[Microsoft MAPP(Active Protections Program) 파트너](https://www.microsoft.com/ko-kr/security/default.aspx)
...
-   V1.1(2011년 10월 12일): 지원 대상인 모든 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대한 공지 교체 정보가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 검색 로직이나 업데이트 파일에 대한 변경 사항은 없습니다.  
-   V1.2(2011년 10월 26일): Microsoft 기술 자료 문서 KB816915에 문서화된 스키마에 따라 Windows XP 및 Windows Server 2003의 32비트 및 x64 기반 에디션의 업데이트 파일 이름이 개정되었습니다. 이는 파일 이름에 대한 변경사항입니다. 검색 로직이나 업데이트 콘텐츠에 대한 변경 사항은 없습니다. 이 업데이트를 이미 성공적으로 설치한 고객은 조치를 취할 필요가 없습니다.
