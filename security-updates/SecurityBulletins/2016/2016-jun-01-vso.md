...
ms.ContentId: 1bef29f2-c8ba-4c74-b821-f572668f0be8
...
![Setting filters on the Kanban board](_img/06_01_01.png)
...
![Managing SSH connections to Git repos](_img/06_01_02.png)
...
![Branches page showing the Mine pivot](_img/06_01_03.png)
...
![Creating a link to code](_img/06_01_04.png)
...
![Capturing a screen in the Web runner](_img/06_01_05.png)
...
![Ordering tests](_img/06_01_06.png)

![Ordering tasks on the Kanban board](_img/06_01_07.png)
...
![Running a Docker image](_img/06_01_08.png)
...
![SonarQube analysis comments](_img/06_01_09.png)
...
![Test results trend widget](_img/06_01_10.png)
...
![LInking a TeamCity artifact source](_img/06_01_11.png)
...
A number of features in this release are directly based on feedback that you submitted. If have ideas on things you’d like to see us prioritize, head over to [UserVoice](https://visualstudio.uservoice.com/forums/330519-team-services) to add your idea or vote for an existing one.
