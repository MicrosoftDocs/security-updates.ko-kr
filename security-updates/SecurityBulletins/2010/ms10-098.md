---
TOCTitle: 'MS10-098'
Title: 'Microsoft 보안 공지 MS10-098 - 중요'
ms:assetid: 'ms10-098'
ms:contentKeyID: 61230358
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-098(v=Security.10)'
---


Microsoft 보안 공지 MS10-098 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Windows 커널 모드 드라이버의 메모리 할당, 더 이상 사용되지 않는 개체 릴리스, 커널 모드 드라이버 개체 관리 및 사용자 모드에서 전달된 입력의 유효성 검사 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=bb9d1657-5beb-4372-b74c-a612a6fff5a8)                                                                               | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1f277ae4-4f85-4c8a-bfc5-dcdc8afed133)                                                      | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4aa39f59-2177-459f-9b8a-9543330d48ec)                                                                      | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bca61d61-d5cf-49a4-ab99-b61e50e8f619)                                                          | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4fce129d-2b4e-4a66-af27-bbbde1e65ba1)                                                       | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b824d3b9-2ce1-4abc-ae06-68aef1250be9)                                               | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f4c42cfe-b7f2-4436-919e-4bd305a3439a)                       | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e2f572a-4169-47f2-a872-5466997122ed)\*           | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=09a4b646-989d-43ef-a3e8-64af8b380a14)\*       | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=46522323-837e-4a74-9cf0-45f69343e776) | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=aa7de2e4-ba48-4d58-b034-05349f0eb920)                                                                           | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b21db627-91c2-4ebf-b7c0-38ac58ae5b6c)                                                                         | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=d417ebce-7841-4bbb-8abc-b15ef5f4b733)\*                                                          | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=7eeac1bb-9f86-4ea5-b30f-980d52be5044)                                                        | 권한 상승      | 중요        | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
...
<th style="border:1px solid black;" >Win32k 버퍼 오버플로 취약점(CVE-2010-3939)</th>
<th style="border:1px solid black;" >Win32k PFE 포인터 Double Free 취약점(CVE-2010-3940)</th>
<th style="border:1px solid black;" >Win32k Double Free 취약점(CVE-2010-3941)</th>
<th style="border:1px solid black;" >Win32k WriteAV 취약점(CVE-2010-3942)</th>
<th style="border:1px solid black;" >Win32k 커서 연결 취약점(CVE-2010-3943)</th>
<th style="border:1px solid black;" >Win32k 메모리 손상 취약점(CVE-2010-3944)</th>
...
Windows 커널 모드 드라이버가 사용자 모드에서 데이터를 복사할 때 메모리를 부적절하게 할당하는 방식에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3939 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939)를 참조하십시오.
  
#### Win32k 버퍼 오버플로 취약점(CVE-2010-3939)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 버퍼 오버플로 취약점(CVE-2010-3939)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 버퍼 오버플로 취약점(CVE-2010-3939)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 사용자 모드에서 데이터를 복사할 때 메모리를 제대로 할당하지 못하면 취약점이 발생합니다.
  
**이 취약점의 영향을 받는 Windows 구성 요소는 무엇입니까?**    
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버에서 메모리를 할당하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3939 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939)가 지정되었습니다.
...
Windows 커널 모드 드라이버가 더 이상 사용되지 않는 개체를 릴리스하는 방식 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3940 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3940)을 참조하십시오.
  
#### Win32k PFE 포인터 Double Free 취약점(CVE-2010-3940)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k PFE 포인터 Double Free 취약점(CVE-2010-3940)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k PFE 포인터 Double Free 취약점(CVE-2010-3940)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
커널 모드 드라이버 개체에 대한 포인트 관련 "double free" 조건으로 인해 취약점이 발생합니다.
  
**"double free" 조건이란 무엇입니까?**    
double free 조건은 프로그램이 할당된 메모리를 두 번 이상 해제하도록 하는 조건입니다. 이미 확보된 메모리를 해제하면 메모리 손상으로 이어질 수 있습니다. 그러면 공격자는 메모리 손상이 발생할 때 실행되는 메모리에 임의의 코드를 추가할 수 있습니다. 그리고 이 코드는 시스템 권한 수준에서 실행됩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 커널 모드 드라이버에서 더 이상 사용되지 않는 개체를 릴리스하는 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3941 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3941)을 참조하십시오.
  
#### Win32k Double Free 취약점(CVE-2010-3941)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.  
-   공격자가 이 취약점을 악용하려면 영향을 받는 시스템에서 16비트 프로그램을 실행할 수 있어야 합니다. 64비트 서버에서는 16비트 프로그램을 실행할 수 없으므로 취약점을 악용할 수 없습니다.
  
#### Win32k Double Free 취약점(CVE-2010-3941)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **그룹 정책을 편집하여 NTVDM 하위 시스템 사용 안 함**
  
    NT 가상 DOS 모드(NTVDM)가 필요하지 않은 사용자는 NTVDM 하위 시스템을 사용 안 함으로 설정하여 이 취약점의 악용을 줄일 수 있습니다.
  
    Windows XP 시스템에서 NTVDM 하위 시스템을 사용하지 않도록 설정하려면:
  
    1.  관리자 권한으로 로그온한 후 **시작**, **실행**을 차례로 클릭하고 **gpedit.msc**를 입력한 다음 **확인**을 클릭합니다.  
    2.  그룹 정책 편집기의 탐색 창에서 **관리 템플릿**, **Windows 구성 요소**를 차례로 두 번 클릭한 다음 **응용 프로그램 호환성**을 클릭합니다.  
    3.  응용 프로그램 호환성 창에서 **16비트 응용 프로그램으로의 액세스를 금지**를 두 번 클릭하여 설정 탭에서 선택을 **사용**으로 변경하고 **확인**을 클릭한 다음 그룹 정책 편집기를 종료합니다.
  
    Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2 시스템의 경우 Windows XP 시스템에 사용되는 동일한 템플릿을 사용하여 그룹 정책으로 이 설정을 배포할 수 있습니다.
  
    Windows NT 4.0 시스템의 경우 Microsoft 기술 자료 문서 [MSDOS 및 WOWEXEC 하위 터미널 서버에서 사용 안 함](http://support.microsoft.com/kb/220159)을 참조하십시오.
  
    **대안의 영향.**  16비트 응용 프로그램에 대한 액세스가 불가능해집니다.
  
    **대안 실행 취소 방법.**
  
    Windows XP 시스템에서 NTVDM 하위 시스템을 사용하도록 다시 설정하려면:
  
    1.  관리자 권한으로 로그온한 후 **시작**, **실행**을 차례로 클릭하고 **gpedit.msc**를 입력한 다음 **확인**을 클릭합니다.  
    2.  그룹 정책 편집기의 탐색 창에서 **관리 템플릿**, **Windows 구성 요소**를 차례로 두 번 클릭한 다음 **응용 프로그램 호환성**을 클릭합니다.  
    3.  응용 프로그램 호환성 창에서 **16비트 응용 프로그램으로의 액세스를 금지**를 두 번 클릭하여 설정 탭에서 선택을 **구성되지 않음**으로 변경하고 **확인**을 클릭한 다음 그룹 정책 편집기를 종료합니다.
  
    Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2 시스템의 경우 Windows XP 시스템에 사용되는 동일한 템플릿을 사용하여 그룹 정책으로 이 설정을 배포할 수 있습니다.
  
    Windows NT 4.0 시스템의 경우 Microsoft 기술 자료 문서 [MSDOS 및 WOWEXEC 하위 터미널 서버에서 사용 안 함](http://support.microsoft.com/kb/220159)을 참조하십시오.
  
-   **시스템 레지스트리를 편집하여 NTVDM 하위 시스템 사용 안 함**
    ...
    **참고** 레지스트리를 편집하기 전에 백업해 두는 것이 좋습니다.
    ...
    시스템 레지스트리를 편집하여 NTVDM 하위 시스템을 사용하지 않도록 설정하려면 다음 단계를 수행하십시오.
  
    1.  **시작**, **실행**을 차례로 클릭하고 **regedit**을 입력한 다음 **확인**을 클릭합니다.  
    2.  시스템 레지스트리에서 다음 키를 찾습니다.  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  **DisallowedPolicyDefault** 이름의 DWORD 항목을 추가하고 값을 **1**로 설정합니다(이 경우 NTVDM을 사용 안 함).  
    4.  레지스트리 편집기를 닫습니다.
    ...
    **대안 실행 취소 방법.**
    ...
    시스템 레지스트리를 편집하여 NTVDM 하위 시스템을 사용하도록 다시 설정하려면 다음 단계를 수행하십시오.
  
    1.  **시작**, **실행**을 차례로 클릭하고 **regedit**을 입력한 다음 **확인**을 클릭합니다.  
    2.  시스템 레지스트리에서 다음 키를 찾습니다.  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  **DisallowedPolicyDefault** 값을 **0**으로 변경합니다(이 경우 NTVDM을 다시 사용).  
    4.  레지스트리 편집기를 닫습니다.
  
#### Win32k Double Free 취약점(CVE-2010-3941)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3942 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3942)를 참조하십시오.
  
#### Win32k WriteAV 취약점(CVE-2010-3942)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k WriteAV 취약점(CVE-2010-3942)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k WriteAV 취약점(CVE-2010-3942)에 대한 FAQ
...
Windows 커널 모드 드라이버가 커널 모드 드라이버 개체를 관리하는 방식 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3943 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3943)을 참조하십시오.
  
#### Win32k 커서 연결 취약점(CVE-2010-3943)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 커서 연결 취약점(CVE-2010-3943)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 커서 연결 취약점(CVE-2010-3943)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
커널 모드 드라이버 개체를 연결할 때 연결된 목록이 손상되어 논리적 오류로 인한 취약점이 발생합니다.
...
Windows 커널 모드 드라이버가 사용자 모드에서 전달된 입력의 유효성을 부적절하게 검사하는 방식에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3944 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3944)를 참조하십시오.
  
#### Win32k 메모리 손상 취약점(CVE-2010-3944)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 메모리 손상 취약점(CVE-2010-3944)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 메모리 손상 취약점(CVE-2010-3944)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 사용자 모드에서 전달된 입력의 유효성을 유효성 검사하지 못하면 취약점이 발생합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2436673$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2436673">Microsoft 기술 자료 문서 2436673</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb2436673">Microsoft 기술 자료 문서 2436673</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   Windows 커널 Double Free 취약점(CVE-2010-3941)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Windows 커널 WriteAV 취약점(CVE-2010-3942)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Windows 커널 커서 연결 취약점(CVE-2010-3943)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Windows 커널 메모리 손상 취약점(CVE-2010-3944)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Windows 커널 메모리 손상 취약점(CVE-2010-3944)을 보고해 주신 [Sysdream (영문)](http://www.sysdream.com)의 Stéfan Le Berre
