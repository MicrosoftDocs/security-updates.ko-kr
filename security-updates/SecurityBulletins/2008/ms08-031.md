---
TOCTitle: 'MS08-031'
Title: 'Microsoft 보안 공지 MS08-031 - 긴급'
ms:assetid: 'ms08-031'
ms:contentKeyID: 61230139
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-031(v=Security.10)'
---
...
이 보안 업데이트는 비공개적으로 보고된 취약점 1건과 공개적으로 보고된 취약점 1건을 해결합니다. 비공개적으로 보고된 취약점은 사용자가 Internet Explorer를 사용하여 특수하게 조작된 웹 페이지를 볼 경우 원격 코드 실행을 허용할 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다. 공개적으로 보고된 취약점은 사용자가 Internet Explorer를 사용하여 특수하게 조작된 웹 페이지를 볼 경우 정보 유출을 허용할 수 있습니다.

이 보안 업데이트의 심각도는 Microsoft Windows 2000 서비스 팩 4의 Internet Explorer 6 서비스 팩 1, 지원되는 Windows XP 버전의 Internet Explorer 6, 및 지원되는 Windows XP, Windows Vista 버전의 Internet Explorer 7에 대해 긴급입니다. 또한 이 보안 업데이트의 심각도는 Microsoft Windows 2000 서비스 팩 4의 Internet Explorer 5.01에 대해 중요이며 다른 모든 Internet Explorer 버전에 대해 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Internet Explorer의 HTML 객체 호출 처리 및 데이터 유효성 검증 방식을 수정하여 이러한 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=88990b23-d37f-4d02-a5a3-2ee389ade53c&displaylang=ko)
</td>
<td style="border:1px solid black;">
정보 유출
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=cc325017-3a48-4475-90e4-0c79a002fce3&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=c8783cfe-9da5-4842-ab3a-1e2be4fafc47&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=fbc31bde-0bf5-490c-96a8-071310d9464a&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=19c0ccdc-95c9-4151-96b6-4f49b594ebe0&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=6d68b39d-157f-4c3d-ac76-bc5a9386db59&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=4cf92235-861e-4b74-bee3-8e977c8688d9&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=a8922e7e-9264-4e09-b8ad-c5420fed8690&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=05b0e838-24d7-4387-b069-2604bbcc43b9&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
\*Server Core 설치 옵션을 사용하여 Windows Server 2008이 설치된 경우 이 업데이트에서 해결하는 취약점은 Windows Server 2008에 대해 영향을 주지 않습니다. 이 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](https://msdn.microsoft.com/ko-kr/library/ms723891(en-us,vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교 (영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.

이 보안 업데이트와 관련된 자주 제기되는 질문 사항
-------------------------------------------------


**이 공지가 2008년 6월 11일에 개정된 이유는 무엇입니까?**  
관련된 [Microsoft 기술 자료 문서 950759](https://support.microsoft.com/kb/950759)의 파일 정보 업데이트를 알리기 위해 이 공지가 개정되었습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 950759](https://support.microsoft.com/kb/950759)에 나와 있습니다.
...
<th style="border:1px solid black;" >HTML 개체 메모리 손상 취약점(CVE-2008-1442)</th>
<th style="border:1px solid black;" >도메인 간 요청 헤더 정보 유출 취약점(CVE-2008-1544)</th>
...
HTML 개체 메모리 손상 취약점(CVE-2008-1442)  
-------------------------------------------
  

Internet Explorer에서 HTML 개체에 대한 예상치 못한 특정 메서드 호출을 포함한 웹 페이지를 표시하는 방식에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1442 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1442)를 참조하십시오.
  
#### HTML 개체 메모리 손상 취약점(CVE-2008-1442)에 대한 완화 요소
...
-   기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역 보안 수준을 높음으로 설정합니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
  
#### HTML 개체 메모리 손상 취약점(CVE-2008-1442)에 대한 대안
...
#### HTML 개체 메모리 손상 취약점(CVE-2008-1442)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
HTML 개체에 대한 예상치 못한 특정 메서드 호출을 포함한 웹 페이지를 Internet Explorer에서 표시할 때 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
...
예. 기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)도 참조하십시오.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Internet Explorer에서 HTML 개체 호출을 처리하는 방식을 수정하여 이 취약점을 제거합니다.
...
도메인 간 요청 헤더 정보 유출 취약점(CVE-2008-1544)  
---------------------------------------------------
  

Internet Explorer의 특정 요청 헤더 처리 방식에 정보 유출 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 보면 취약점을 통해 공격자가 다른 Internet Explorer 도메인에서 데이터를 읽을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1544 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1544)를 참조하십시오.
  
#### 도메인 간 요청 헤더 정보 유출 취약점(CVE-2008-1544)에 대한 완화 요소
  
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.  
-   기본적으로 지원되는 모든 Microsoft Outlook 및 Microsoft Outlook Express 버전은 제한된 사이트 영역에서 HTML 메일 메시지를 엽니다. 제한된 사이트 영역은 HTML 메일 메시지를 읽을 때 Active 스크립팅과 ActiveX 컨트롤을 사용하는 것을 방지하여 이 취약점을 악용하기 위한 공격을 완화하는 데 도움이 됩니다. 그러나 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 취약점 악용에 취약해질 수 있습니다.  
-   기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역 보안 수준을 높음으로 설정합니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
  
#### 도메인 간 요청 헤더 정보 유출 취약점(CVE-2008-1544)에 대한 대안
...
#### 도메인 간 요청 헤더 정보 유출 취약점(CVE-2008-1544)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이는 정보 유출 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 다른 Internet Explorer 도메인에서 데이터를 읽을 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Internet Explorer에서 특수하게 조작된 요청 헤더에 대한 구문 분석을 부정확하게 처리하여 동일 원본 정책을 위반하기 때문입니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 웹 서버에서 보낸 요청 헤더에 동일 원본 정책을 강제로 적용합니다.
  
**동일 원본 정책이란 무엇입니까?**  
동일 원본 정책(SOP)은 최신 브라우저에서 액세스 제어를 관리합니다. 하나의 원본에서 로드된 문서 또는 스크립트가 다른 원본의 문서 속성을 받거나 설정하지 못하도록 차단하는 총체적인 격리를 제공합니다. [JScript 블로그: ECMAScript, 매시업 및 보안 (영문)](https://blogs.msdn.com/jscript/archive/2007/11/29/ecmascript-mashups-and-security.aspx)을 참조하십시오.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 CVE-2008-1544가 지정되었습니다.
...
IE5.01sp4-KB950759-Windows2000sp4-x86-kor /quiet<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB950759-Windows2000-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
IE5.01sp4-KB950759-Windows2000sp4-x86-kor /norestart<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB950759-Windows2000-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB950759-IE501SP4-20080418.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB950759-IE6SP1-20080418.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950759">Microsoft 기술 자료 문서 950759</a>를 참조하십시오.</td>
</tr>
<tr class="even">
...
Windowsxp-kb950759-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003.WindowsXP-KB950759-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3용 Internet Explorer 6:<br />
Windowsxp-KB950759-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB950759-x64-kor / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3용 Internet Explorer 7:<br />
IE7-WindowsXP-KB950759-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB950759-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstal\KB950759$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP용 Internet Explorer 7:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\ie7updates\KB950759-IE7\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950759">Microsoft 기술 자료 문서 950759 참조</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
설치 프로그램에 대한 자세한 내용은 [Microsoft TechNet 웹 사이트 (영문)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/deployment/winupdte.msp)를 방문하십시오.
...
Windowsserver2003-KB950759-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB950759-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 6:<br />
Windowsserver2003-KB950759-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003-KB950759-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 7:<br />
...
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB950759$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   HTML 개체 메모리 손상 취약점(CVE-2008-1442)을 보고해 주신 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](https://www.tippingpoint.com/)와 협력해 주신 Sebastian Apelt, Peter Vreugdenhil 및 익명의 연구자
...
-   V1.1 (2008년 6월 12일): 관련된 Microsoft 기술 자료 문서 950759의 파일 정보 업데이트를 알리기 위해 업데이트 FAQ에 항목이 추가되었습니다.
