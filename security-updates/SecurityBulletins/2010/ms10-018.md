...
이 보안 업데이트는 [Microsoft 보안 권고 981374](http://technet.microsoft.com/security/advisory/981374)에서 처음 설명한 취약점도 해결합니다. Windows 7, Windows Server 2008 R2 또는 Internet Explorer 8은 해당 취약점([CVE-2010-0806 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806))의 영향을 받지 않습니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 980182](http://support.microsoft.com/kb/980182)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0267 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0267)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0488 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0488)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0489 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0489)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0490 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0490)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0491 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0491)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0492 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0492)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0494 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0494)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0805 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0805)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0806 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806)을 참조하십시오.
...
-   **자동화된 Microsoft Fix It을 사용하여 Internet Explorer 7의 DEP 사용**
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 980182](http://support.microsoft.com/kb/980182)를 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-0806 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806)이 지정되었으며 [Microsoft 보안 권고(981374)](http://technet.microsoft.com/security/advisory/981374)에도 설명되어 있습니다.

**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**  
예. Microsoft는 이 취약점을 악용하려는 공격에 대한 보고를 받았습니다.

**권고 981374에서 제공된 대안을 적용한 경우 이 업데이트를 적용하기 전에 원래대로 되돌려야 합니까?**  
[Microsoft 보안 권고 981374](http://technet.microsoft.com/security/advisory/981374)에서 제공된 대안을 적용한 경우 원래대로 되돌려야 합니다. 지침에 따라 초기화되지 않은 메모리 손상 취약점(CVE-2010-0806)에 대한 대안 항목에서 제공되는 대안을 실행 취소하십시오. [Microsoft 보안 권고(981374)](http://technet.microsoft.com/security/advisory/981374)에서 제공된 "이 픽스 사용" 기능을 사용하여 iepeers.dll 또는 DEP 대안을 적용한 경우, [Microsoft 기술 자료 문서 980182](http://support.microsoft.com/kb/980182)의 대안에 대해 "이 픽스 사용 안 함" 옵션을 선택하여 대안을 되돌릴 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0807 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0807)을 참조하십시오.
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](http://update.microsoft.com/microsoftupdate)에서 제공하고 [Windows Server Update Services](http://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool](http://technet.microsoft.com/sms/bb676783.aspx)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools](http://technet.microsoft.com/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드](http://technet.microsoft.com/sms/bb676766.aspx)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/980182">Microsoft 기술 자료 문서 980182</a> 참조</td>
</tr>
<tr class="even">
...
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-0267)을 해결하기 위해 협력해 주신 [Secunia (영문)](http://secunia.com)  
-   인코딩 후 정보 유출 취약점(CVE-2010-0488)을 보고해 주신 [Cyber Defense Institute Inc. (영문)](http://www.cyberdefense.jp/)의 Daiki Fukumori  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-0490)을 보고해 주신 [Red Database Security (영문)](http://www.red-database-security.com/)의 Alexander Kornbrust  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-0490)을 보고해 주신 [iSIGHT Partners (영문)](http://www.isightpartners.com/) Global Vulnerability Partnership의 Ivan Fratric  
-   HTML 개체 메모리 손상 취약점(CVE-2010-0491)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 [team509 (영문)](http://www.team509.com/)의 Wushi  
-   HTML 개체 메모리 손상 취약점(CVE-2010-0492)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Simon Zuckerbraun  
-   HTML 요소 도메인 간 취약점(CVE-2010-0494)을 보고해 주신 [Context Information Security (영문)](http://www.contextis.co.uk/)의 Paul Stone  
-   메모리 손상 취약점(CVE-2010-0805)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-0806)을 보고해 주신 [VenusTech (영문)](http://www.venustech.com.cn/)의 ADLab  
-   HTML 렌더링 메모리 손상 취약점(CVE-2010-0807)을 보고해 주신 [VenusTech (영문)](http://www.venustech.com.cn/)의 ADLab
