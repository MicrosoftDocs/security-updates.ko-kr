...
|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=899e2728-2433-4ccb-a195-05b5d65e5469&displaylang=ko) | 원격 코드 실행 | 중요        | [MS07-065](https://technet.microsoft.com/security/bulletin/ms07-065) |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 951071](https://support.microsoft.com/kb/951071)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3479 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3479)를 참조하십시오.
...
-   **Message Queuing 서비스를 사용하지 않도록 설정:**
    ...
    -   그룹 정책:  
        ...
        **참고:** Windows Server 2003 보안 가이드도 참조하십시오. 이 가이드에는 서비스 비활성화 방법에 대한 정보가 포함되어 있습니다.  
        ...
        [그룹 정책 기능 모음 이해를 위한 단계별 가이드 (영문)](https://technet.microsoft.com/en-us/library/bb742376.aspx)
...
**RPC란 무엇입니까?**    
Microsoft RPC는 분산형 컴퓨팅 환경에서의 프로그래밍을 위한 모델입니다. RPC의 목표는 투명한 커뮤니케이션을 제공하여 클라이언트가 서버와 직접 커뮤니케이션하는 것처럼 보이게 하는 것입니다. Microsoft의 RPC 구현은 OSF(Open Software Foundation) DCE(Distributed Computing Environment) RPC와 호환됩니다. RPC에 대한 자세한 내용은 [RPC MSDN 사이트 (영문)](https://msdn.microsoft.com/en-us/library/ms691207(vs.85).aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/951071">Microsoft 기술 자료 문서 951071</a> 참조</td>
</tr>
<tr class="even">
...
-   MSMQ 원격 코드 실행 취약점(CVE-2008-3479)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)
