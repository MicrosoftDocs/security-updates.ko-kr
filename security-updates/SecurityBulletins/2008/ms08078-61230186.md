...
이 보안 업데이트는 [Microsoft 보안 권고 961051](http://technet.microsoft.com/security/advisory/961051)에서 처음 설명한 취약점도 해결합니다.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=d81e9cf9-ce0c-463a-a359-49a348cb89ae&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=015df302-d79f-43a1-b5c5-32ac04de0510&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=9ba71e23-8cef-4399-b215-983b0dcf5cb5&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=388847ec-817e-45cf-8fa7-32c7e1f57f80&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=2ae17caf-6204-470e-8480-380d3d505657&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=69979d92-8d45-47fe-ac4c-c2f1f23cf1fb&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=5552e564-dd1c-4e2a-9a42-6317522c884d&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 960714](http://support.microsoft.com/kb/960714)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4844 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4844)를 참조하십시오.
...
-   기본적으로 Windows Vista 이상에서 Internet Explorer 7 및 Internet Explorer 8 Beta 2의 [보호 모드 (영문)](http://www.microsoft.com/windows/windows-vista/features/ie7-protected-mode.aspx)는 사용자의 동의 없는 다른 프로그램 시작 요청이나 파일 저장 요청을 제한함으로써 사용자와 시스템을 보호합니다. 여기에는 사용자 또는 시스템 파일 및 설정이 포함됩니다.
...
-   **XML Island 기능** **사용 안 함**
    ...
    **보안 권고 961051에서 소개한 대안의 실행을 취소하는 방법은 무엇입니까?**  
    ...
    [Microsoft 보안 권고 961051](http://technet.microsoft.com/security/advisory/961051)에서 이 대안과 동일한 내용이 레지스트리 수동 변경 방법으로 소개되었습니다. 이 방법을 사용했으며 이 대안을 실행 취소하려면 다음 레지스트리 파일을 사용하십시오.
...
-   **OLEDB32.dll의 행 위치 기능 사용 안 함**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    `Windows 레지스트리 편집기 버전 5.00[-HKEY_CLASSES_ROOT\CLSID\{2048EEE6-7FA2-11D0-9E6A-00A0C9138C29}]`
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-4844 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4844)가 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/960714">Microsoft 기술 자료 문서 960714</a> 참조</td>
</tr>
<tr class="even">
