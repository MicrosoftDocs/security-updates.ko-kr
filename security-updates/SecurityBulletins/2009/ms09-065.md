---
TOCTitle: 'MS09-065'
Title: 'Microsoft 보안 공지 MS09-065 - 긴급'
ms:assetid: 'ms09-065'
ms:contentKeyID: 61230251
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-065(v=Security.10)'
---

Microsoft 보안 공지 MS09-065 - 긴급
===================================

Windows 커널 모드 드라이버의 취약점으로 인한 원격 코드 실행 문제점 (969947)
---------------------------------------------------------------------------

게시된 날짜: 2009년 11월 11일 수요일 | 업데이트된 날짜: 2009년 11월 13일 금요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000, Windows XP 및 Windows Server 2003 에디션에 대해서는 긴급이며 지원 대상인 모든 Windows Vista 및 Windows Server 2008 에디션에 대해서는 중요입니다. 자세한 내용은 이 섹션의 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 시스템 호출에 전달된 인수의 유효성을 검사하고 GDI의 커널 구성 요소를 통해 사용자 모드에서 전달된 입력의 유효성을 검사하며 Windows 커널 모드 드라이버에서 글꼴 코드를 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.**[Microsoft 기술 자료 문서 969947](https://support.microsoft.com/kb/969947)는 보안 업데이트 시 발생되는 알려진 이슈에 대해 설명하고 있습니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=45db8bb1-c81b-4d3f-a658-74f5fa445f81&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=916abdad-44b7-4f9d-986a-0c3558fb8e06&displaylang=ko)                                                          | 원격 코드 실행 | 긴급        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1d0464c6-5ed8-4064-887e-618a2db09236)                                                                          | 원격 코드 실행 | 긴급        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5cd62750-e269-44ae-8c7c-c335e8545b9a&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=04a7f817-f330-4003-8b25-d3e744905b12&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b95daac0-4c99-47a4-b0ca-9429997ea3d9)                                                                           | 원격 코드 실행 | 긴급        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=54562103-1d99-42d7-8f7f-c0cbcdce90db&displaylang=ko)                                     | 권한 상승      | 중요        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fcb87cc8-6fd7-4f16-93d6-552999462fb1&displaylang=ko) | 권한 상승      | 중요        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b97d48de-0f6d-4bca-b990-acf543fdb8b7&displaylang=ko)\*                | 권한 상승      | 중요        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0e2b8607-10fa-406a-96a5-18290f479c48&displaylang=ko)\*            | 권한 상승      | 중요        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=28eba3f3-99a5-424c-bc8d-a718c716699e)                     | 권한 상승      | 중요        | [MS09-025](https://technet.microsoft.com/security/bulletin/ms09-025) |
...
<th style="border:1px solid black;" >Win32k NULL 포인터 역참조 취약점(CVE-2009-1127)</th>
<th style="border:1px solid black;" >Win32k 불충분한 데이터 유효성 검사 취약점(CVE-2009-2513)</th>
<th style="border:1px solid black;" >Win32k EOT 구문 분석 취약점(CVE-2009-2514)</th>
...
Windows 커널에서 Windows 커널 시스템 호출에 전달된 인수의 유효성을 올바르게 검사하지 않아 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1127 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1127)을 참조하십시오.
  
#### Win32k NULL 포인터 역참조 취약점(CVE-2009-1127)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k NULL 포인터 역참조 취약점(CVE-2009-1127)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k NULL 포인터 역참조 취약점(CVE-2009-1127)에 대한 FAQ
...
GDI의 커널 구성 요소를 통해 사용자 모드에서 전달된 입력의 부적절한 유효성 검사로 인해 Windows 커널 모드 드라이버에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2513 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2513)을 참조하십시오.
  
#### Win32k 불충분한 데이터 유효성 검사 취약점(CVE-2009-2513)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 불충분한 데이터 유효성 검사 취약점(CVE-2009-2513)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 불충분한 데이터 유효성 검사 취약점(CVE-2009-2513)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
GDI의 커널 구성 요소를 통해 사용자 모드에서 전달된 입력의 유효성을 Windows 커널 모드 드라이버에서 올바르게 검사하지 않습니다.
...
**GDI란 무엇입니까?**    
Microsoft Windows GDI(그래픽 장치 인터페이스)를 통해 응용 프로그램이 비디오 디스플레이와 프린터 모두에서 그래픽과 형식 있는 텍스트를 사용할 수 있습니다. Windows 기반 응용 프로그램은 그래픽 하드웨어에 직접 액세스하지 않습니다. GDI가 응용 프로그램 대신 장치 드라이버와 상호 작용을 수행합니다. GDI에 대한 자세한 내용은 MSDN 문서, [Windows GDI (영문)](https://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)를 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 GDI의 커널 구성 요소를 통해 사용자 모드에서 전달된 입력의 유효성을 올바르게 검사하여 취약점을 해결합니다.
...
디렉터리 항목 테이블을 만들 때 글꼴 코드의 부적절한 구문 분석으로 인해 Windows 커널 모드 드라이버에 원격 코드 실행 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2514 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2514)를 참조하십시오.
  
#### Win32k EOT 구문 분석 취약점(CVE-2009-2514)에 대한 완화 요소
...
#### Win32k EOT 구문 분석 취약점(CVE-2009-2514)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **Internet Explorer에서 포함 글꼴 구문 분석 지원 사용 안 함**
  
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 969947](https://support.microsoft.com/kb/969947)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
#### Win32k EOT 구문 분석 취약점(CVE-2009-2514)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버에서 디렉터리 항목 테이블을 만들 때 글꼴 코드를 올바르게 구문 분석하지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버에서 글꼴 코드를 구분 문석하는 방식을 수정하여 취약점을 해결합니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-kb969947-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-kb969947-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | kb969947.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB969947$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 969947](https://support.microsoft.com/kb/969947) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969947\\Filelist                                        |
...
Windowsxp-kb969947-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb969947-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB969947$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969947">Microsoft 기술 자료 문서 969947</a> 참조</td>
</tr>
<tr class="even">
...
Windowsserver2003-kb969947-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB969947-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb969947-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB969947-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   Win32k NULL 포인터 역참조 취약점(CVE-2009-1127)을 보고해 주신 Agin Sun  
-   Win32k EOT 구문 분석 취약점(CVE-2009-2514)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy
...
-   V1.1(2009년 11월 13일): 알려진 문제점에 Microsoft 기술 자료 문서 969947가 추가 되었습니다.
