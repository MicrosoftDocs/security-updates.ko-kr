...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2707960](https://support.microsoft.com/kb/2707960)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=178811">MS10-031</a>의 KB976382는 KB2598361 또는 KB2687626으로 대체되었습니다.[2]</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=178811">MS10-031</a>의 KB976321은 KB2596744로 대체되었습니다.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=178811">MS10-031</a>의 KB974945는 KB2688865로 대체되었습니다.</td>
</tr>
<tr class="even">
...
Microsoft에서는 적절한 타임스탬프 특성 없이 Microsoft에서 생성한 특정 디지털 인증서와 관련된 문제를 해결하도록 Microsoft Office 2003 서비스 팩 3의 KB2598361 업데이트를 KB2687626 업데이트로 대체함을 알리기 위해 이 공지를 다시 릴리스하였습니다. 자세한 내용은 [Microsoft 보안 권고 2749655](https://technet.microsoft.com/security/advisory/2749655)를 참조하십시오.
...
참고: KB2598361 업데이트가 이미 설치되어 있으며 KB2687626 업데이트를 같은 시스템에 설치하는 경우, 이미 업데이트가 설치되어 있다는 메시지가 설치 프로그램에 생성됩니다. 메시지가 생성된 후 설치된 업데이트 목록에서 KB2687626 업데이트가 KB2598361 업데이트를 대체합니다. 설치 동작에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2707960](https://support.microsoft.com/kb/2707960)을 참조하십시오.
  
이 업데이트는 Microsoft 보안 권고 2269637과 관련이 있습니까?  
예, 이 업데이트에서 해결하는 Visual Basic for Applications의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-1854)은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2707960](https://support.microsoft.com/kb/2707960)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1854](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1854)(영문)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-1854](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1854)(영문)가 지정되었습니다.
...
Windows Server Update Services(WSUS)를 사용하면 정보 기술 관리자가 최신 Microsoft 제품 업데이트를 Windows 운영 체제를 실행하는 컴퓨터에 배포할 수 있습니다. Windows Server Update Services를 사용하여 보안 업데이트를 신속하게 배포하는 방법에 대한 자세한 내용은 TechNet 문서의 [Windows Server Update Services](https://technet.microsoft.com/en-us/wsus/default.aspx)(영문)를 참조하십시오.
...
-   지원 대상인 Microsoft Office 버전에 네트워크 설치 지점을 만드는 방법에 대한 자세한 내용은 [Microsoft Office의 네트워크 설치 지점 만들기](https://technet.microsoft.com/ko-kr/library/cc179063.aspx)(영문)를 참조하십시오.  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2687626">Microsoft 기술 자료 문서 KB2687626</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2596744">Microsoft 기술 자료 문서 KB2596744</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2598243">Microsoft 기술 자료 문서 2598243</a> 및 <a href="https://support.microsoft.com/kb/2553447">Microsoft 기술 자료 문서 2553447</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2688865">Microsoft 기술 자료 문서 2688865</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
...
-   Visual Basic for Applications의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-1854)을 보고해 주신 [Huawei Security Labs](https://www.huawei.com)의 Bai Haowen
