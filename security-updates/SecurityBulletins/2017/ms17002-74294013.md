...
<td style="border:1px solid black;">
[**Microsoft Office 메모리 손상 취약성(CVE-2017-0003)(영문)**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0003)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Word 2016(32비트 버전)](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=b7836db7-bb8b-4353-bb1f-e426ddc99fe2&displaylang=ko)  
(3128057)
...
<td style="border:1px solid black;">
[MS16-121](http://go.microsoft.com/fwlink/?linkid=828158)(3118331)

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Microsoft Word 2016(64비트 버전)](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=fd2cd6ce-5bc6-4fcd-9ebc-977d1c0a0a59&displaylang=ko)  
(3128057)
...
Server 2016 64비트 버전](http://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=4312bfdb-31ab-429a-b3ac-66a53dc62e41&displaylang=ko)  
(3141486)
...
\*대체된 업데이트 열은 대체된 업데이트 체인의 최신 업데이트만 표시합니다. 대체된 업데이트의 전체 목록을 확인하려면 [Microsoft 업데이트 카탈로그](http://catalog.update.microsoft.com/v7/site/home.aspx)로 이동하고 업데이트 번호를 검색한 다음 업데이트 세부 정보를 보십시오. 대체된 업데이트 정보는 패키지 세부 정보 탭에 있습니다.
...
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0003">CVE-2017-0003(영문)</a></td>
