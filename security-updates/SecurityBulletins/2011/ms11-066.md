---
TOCTitle: 'MS11-066'
Title: 'Microsoft 보안 공지 MS11-066 - 중요'
ms:assetid: 'ms11-066'
ms:contentKeyID: 61230433
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-066(v=Security.10)'
---



Microsoft 보안 공지 MS11-066 - 중요
===================================

Microsoft 차트 컨트롤의 취약점으로 인한 정보 유출 문제점(2567943)
-----------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 릴리스의 Microsoft .NET Framework 4 및 Microsoft .NET Framework 3.5 서비스 팩 1용 차트 컨트롤에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 차트 컨트롤이 특수하게 조작된 URI 내의 함수를 확인하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2567943](https://support.microsoft.com/kb/2567943)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6ca837f7-eda1-4ebe-b48a-8c77f949ebfd&amp;displaylang=ko">Microsoft .NET Framework 4</a>[1]<br />
(KB2487367)</td>
...
<sup>[1]</sup>.NET Framework 4 Client Profile은 영향을 받지 않습니다. .NET Framework 버전 4 재배포 가능 패키지는 .NET Framework 4 및 .NET Framework 4 Client Profile의 두 가지 프로필로 제공됩니다. .NET Framework 4 Client Profile은 .NET Framework 4의 하위 집합입니다. 이 업데이트로 해결된 취약점은 .NET Framework 4에만 영향을 주며 .NET Framework 4 Client Profile에는 영향을 주지 않습니다. 자세한 내용은 MSDN 문서, [.NET Framework 설치](https://msdn.microsoft.com/ko-kr/library/5a4x27ek.aspx)를 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8a80cc03-0db9-4446-9ce6-159ad02cab52&amp;displaylang=ko">Microsoft .NET Framework 3.5 서비스 팩 1용 차트 컨트롤</a><br />
(KB2500170)</td>
<td style="border:1px solid black;">정보 유출</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
.NET Framework 3.5 서비스 팩 1이 이 문제의 영향을 받습니까?    
아니요. .NET Framework 3.5 서비스 팩 1 자체는 이 문제의 영향을 받지 않습니다. 이 취약점은 .NET Framework 3.5 서비스 팩 1 플랫폼용 추가 기능인 Microsoft 차트 컨트롤에 존재합니다. 추가 컨트롤을 설치하지 않은 .NET Framework 3.5 서비스 팩 1 사용자는 어떤 조치도 취할 필요가 없습니다.
...
Windows XP 서비스 팩 3의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 SP2(Itanium 기반 시스템용)의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Microsoft .NET Framework 4\*\*
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Microsoft .NET Framework 4\*\*
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr>
<td style="border:1px solid black;">
Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용)의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Microsoft .NET Framework 4\*
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1의 Microsoft .NET Framework 4
</td>
<td style="border:1px solid black;">
중요   
정보 유출
...
Microsoft 차트 컨트롤이 특수하게 조작된 URI 내에서 특수 문자를 잘못 처리하는 방식에 정보 유출 취약점이 존재합니다. 이 취약점을 성공적으로 악용한 공격자는 web.config와 같이 웹 사이트 디렉터리나 하위 디렉터리 내의 모든 파일 콘텐츠를 읽을 수 있습니다. web.config 파일에는 중요한 정보가 저장되는 경우가 많습니다. 이러한 정보 노출의 결과는 정보 자체의 특성에 따라 좌우됩니다. 이 취약점으로 인해 공격자가 직접 코드를 실행하거나 해당 사용자 권한을 상승시킬 수는 없지만 영향을 받는 시스템의 손상을 악화시키는 데 사용할 수 있는 정보를 생성할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1977(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1977)을 참조하십시오.

#### 차트 컨트롤 정보 유출 취약점(CVE-2011-1977)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   Microsoft 차트 컨트롤을 사용하는 웹 응용 프로그램만 이 문제의 영향을 받습니다. .NET Framework 기본 설치는 영향을 받지 않습니다.

#### 차트 컨트롤 정보 유출 취약점(CVE-2011-1977)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### 차트 컨트롤 정보 유출 취약점(CVE-2011-1977)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이는 정보 유출 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 web.config를 비롯한 ASP.NET 응용 프로그램 내의 모든 파일 콘텐츠를 검색할 수 있습니다. 이 취약점으로 인해 공격자가 직접 코드를 실행하거나 해당 사용자 권한을 상승시킬 수는 없지만 영향을 받는 시스템의 손상을 악화시키는 데 사용할 수 있는 정보를 빼낼 수 있습니다.

취약점의 원인은 무엇입니까?  
차트 컨트롤이 특수하게 조작된 URI 내의 함수를 제대로 확인하지 못하므로 이 취약점이 존재합니다.

Microsoft 차트 컨트롤이란 무엇입니까?
Microsoft 차트 컨트롤을 사용하여 복잡한 통계 또는 재무 분석을 위한 간단하고 직관적이며 시각적으로 이해하기 쉬운 차트로 ASP.NET 페이지 또는 Windows Forms 응용 프로그램을 만들 수 있습니다. 차트 컨트롤에 대한 자세한 내용은 MSDN 문서 [차트 컨트롤](https://msdn.microsoft.com/en-us/library/dd456632.aspx)을 참조하십시오.
...
이 취약점을 성공적으로 악용한 공격자는 web.config와 같이 웹 사이트 디렉터리나 하위 디렉터리 내의 모든 파일 콘텐츠를 읽을 수 있습니다. web.config 파일에는 중요한 정보가 저장되는 경우가 많습니다. 이러한 정보 노출의 결과는 정보 자체의 특성에 따라 좌우됩니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
이 취약점을 악용하기 위해 공격자는 차트 컨트롤을 호스팅하는 영향 받은 서버로 특수하게 조작된 GET 요청을 전송합니다.

취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?  
차트 컨트롤이 설치된 웹 서버는 이 문제에 취약합니다.

업데이트는 어떤 기능을 수행합니까?  
업데이트는 차트 컨트롤이 특수하게 조작된 URL 내의 함수를 확인하는 방식을 수정하여 이 취약점을 해결합니다.
...
| Microsoft .NET Framework 3.5 서비스 팩 1용 차트 컨트롤                                                     | 예   |
...
| Microsoft .NET Framework 3.5 서비스 팩 1용 차트 컨트롤                                                     | 예                  | 예                         |
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)에서 제공하고 [Windows Server Update Services(영문)](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool(영문)](https://technet.microsoft.com/en-us/sms/bb676783.aspx)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools(영문)](https://technet.microsoft.com/ko-kr/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드(영문)](https://technet.microsoft.com/ko-kr/sms/bb676766.aspx)도 참조하십시오.
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft .NET Framework 4:<br />
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2487367">Microsoft 기술 자료 문서 2487367</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Microsoft .NET Framework 4:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 x64 기반 에디션 Windows Server 2003 및 지원 대상인 모든 Itanium 기반 에디션 Windows Server 2003의 Microsoft .NET Framework 4:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Extended\KB2487367<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista x64 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 Itanium 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-IA64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 x64 기반 에디션 Windows Server 2008 및 지원 대상인 모든 Itanium 기반 에디션 Windows Server 2008의 Microsoft .NET Framework 4:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Extended\KB2487367<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
-   파일 버전 확인
    ...
    2.  프로그램에 해당 파일이 나타나면 파일 이름을 마우스 오른쪽 단추로 클릭하고 속성을 클릭합니다.
    3.  일반 탭에 표시된 파일 크기를 공지 KB 문서에 제공된 파일 정보 표와 비교합니다.
    4.  세부정보 탭 및 비교 정보를 클릭하여 파일 버전과 수정된 날짜를 공지 KB 문서에 제공된 파일 정보 표와 비교할 수도 있습니다.
    5.  마지막으로, 이전 버전 탭을 클릭하여 표시된 이전 파일 버전의 파일 정보를 새 파일 또는 업데이트된 파일 버전의 파일 정보와 비교할 수도 있습니다.
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 32비트 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 x64 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 x64 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 Itanium 기반 에디션의 Microsoft .NET Framework 4:<br />
NDP40-KB2487367-IA64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
|                         |                                                                                                                                                                                                                                                                                                    |
|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 향후 서비스 팩에 포함   | 해당 사항 없음                                                                                                                                                                                                                                                                                     |
| 배포                    |                                                                                                                                                                                                                                                                                                    |
| 사용자 개입 없이 설치   | MSChart\_KB2500170.exe /q                                                                                                                                                                                                                                                                          |
| 다시 시작하지 않고 설치 | MSChart\_KB2500170.exe /q /norestart                                                                                                                                                                                                                                                               |
...
| 파일 정보               | [Microsoft 기술 자료 문서 2500170](https://support.microsoft.com/kb/2500170) 참조                                                                                                                                                                                                                   |
| 레지스트리 키 확인      | HKEY\_LOCAL\_MACHINE\\Software\\Microsoft\\NET Framework Chart Setup\\NDP\\v3.5\\Version                                                                                                                                                                                                           |
...
-   차트 컨트롤 정보 유출 취약점(CVE-2011-1977)을 보고해 주신 Context Information Security의 Nico Leidecker 및 James Forshaw
...
-   V1.1(2011년 10월 27일): Windows Server 2008 R2(x64 기반 시스템용)의 .NET Framework 4에 대한 Server Core 설치 적용 가능성이 수정되었습니다.
