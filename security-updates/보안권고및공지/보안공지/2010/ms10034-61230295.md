...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=d3955983-0079-476e-a488-99713097259c&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=8c3f2e81-c0ea-494a-a47c-4f8982effb49&displaylang=ko)                                                 | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f3e462fb-df95-4b79-a8bc-5359c2967503)                                                                 | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3c0bd349-aa77-47de-ba1d-1fcc72dcad28&displaylang=ko)                                                                  | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa0ec4f-5502-4f2a-9732-975518c34444&displaylang=ko)                                                      | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=55d9d7f0-f9d9-4833-b5cc-eb87a62da6a8)                                                                  | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2ddaa4b3-1a98-4183-94af-ebdae4e7b76a&displaylang=ko)                                           | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ddf55e74-dbaa-45f7-ac5b-ae3da24e0e33&displaylang=ko)                   | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=a06b9f42-47ac-4ff2-ac32-e4958cdb611e&displaylang=ko)\*\*     | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6d0a3f7c-2617-4bc6-a4c7-cda26c6471e1&displaylang=ko)\*\* | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=38347fa6-5946-4bb5-9fea-a5b2f4e7c1f2)            | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=5bce87fe-dcbb-4638-b248-3f0755537b00&displaylang=ko)                                                                       | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=ee68ecd0-5b8a-4c1e-bdee-bd8616558d43&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=901f7c89-02af-4f87-8592-dad318997d77&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=4958b221-2776-43d7-9e1c-1e1cb318a694)                                                                   | 원격 코드 실행 | 보통        | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
...
이 업데이트는 이전 Microsoft 보안 공지 [MS09-060](http://technet.microsoft.com/security/bulletin/ms09-060)에서 다룬 Outlook 보기 컨트롤 ActiveX 컨트롤에 킬(kill) 비트를 설정합니다.

이 ActiveX 컨트롤 및 컨트롤 업데이트 방법과 관련된 자세한 내용은 Microsoft 보안 공지, [Microsoft Office용 Microsoft ATL(액티브 템플릿 라이브러리) ActiveX 컨트롤의 취약점으로 인한 원격 코드 실행 문제점(973965)](http://technet.microsoft.com/security/bulletin/ms09-060)을 검토하십시오.
...
이전 버전의 소프트웨어에 대한 사용자 지정 지원이 필요한 고객은 자신의 Microsoft 계정 관리 팀 담당자나 TAM(기술 계정 관리자) 또는 해당 Microsoft 파트너 담당자에게 사용자 지정 지원 옵션에 대해 문의하십시오. Alliance, Premier 또는 Authorized Contract가 없는 고객은 해당 지역의 Microsoft 판매처에 문의하십시오. 연락처 정보는 [Microsoft 정보 웹 사이트](http://office.microsoft.com/ko-kr/outlook/default.aspx)를 방문하여 국가를 선택한 다음 **Go**를 클릭하면 나타나는 전화 번호 목록을 참조하십시오. 전화를 할 경우에는 해당 지역의 프리미어 지원 영업 담당자와 상담을 요청하십시오. 자세한 내용은 [Windows 운영 체제 제품 지원 기간 정책 FAQ](http://go.microsoft.com/fwlink/?linkid=33330)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0252 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0252)를 참조하십시오.
...
Microsoft Data Analyzer ActiveX 컨트롤은 Microsoft Visual Basic 등의 COM 기반 개발 응용 프로그램에서 Data Analyzer의 프로그램 방식 컨트롤을 허용합니다. 자세한 내용은 MSDN 문서, [Exploring Microsoft Data Analyzer 프로그래밍 탐색(영문)](http://msdn.microsoft.com/en-us/library/aa155447(office.10).aspx)을 참조하십시오.
...
Microsoft Internet Explorer 8 개발자 도구는 웹 사이트 개발자들이 Microsoft Jscript를 빠르게 디버깅하거나 Internet Explorer와 관련된 동작을 조사하거나 새 디자인 또는 솔루션을 즉석에서 고안할 수 있도록 합니다. IE8 도구에 대한 자세한 내용은 MSDN 문서, [Internet Explorer 개발자 도구 발견](http://msdn.microsoft.com/en-us/library/dd565628(vs.85).aspx)(영문)을 참조하십시오.
...
-   [Danske Bank (영문)](http://www.danskebank.dk/)는 ActiveX 컨트롤, Danske eSec에 대한 킬(Kill) 비트를 요청했습니다. Danske eSec ActiveX 컨트롤과 관련된 질문이나 의견이 있는 경우 [Danske Bank (영문)](http://www.danskebank.dk/)에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {F6A56D95-A3A3-11D2-AC26-400000058481}  
-   [CA (영문)](http://www.ca.com/us/)는 Pest Scan 제품의 ActiveX 컨트롤, PSFormX에 대한 권고와 관련된 보안 권고를 발표했습니다. 자세한 내용은 CA의 보안 공지를 참조하십시오. 이 킬(Kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {56393399-041A-4650-94C7-13DFCB1F4665}  
-   [Eastman Kodak Company (영문)](http://www.kodakgallery.com/)는 "Ofoto Upload Manager / Kodak Gallery Easy Upload Manager ActiveX Control"에 대해 ActiveX 컨트롤에 대한 킬(Kill) 비트를 요청했습니다. Eastman Kodak Gallery는 다양한 업로드 옵션이 있는 다음 페이지를 제공하고 있습니다. [http://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp (영문)](http://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp). 이 업데이트에 킬(Kill) 비트가 설정되는 컨트롤에 대한 대체 컨트롤은 다음 사이트에서 찾을 수 있습니다. [http://classic.kodakgallery.com/UploadChoicesAll.jsp (영문)](http://classic.kodakgallery.com/uploadchoicesall.jsp). 이 킬(Kill) 비트에 대해 질문이나 의견이 있는 경우 Kodak Gallery([http://www.kodakgallery.com/gallery/footerLinksContent.jsp?pageID=600002 (영문)](http://www.kodakgallery.com/gallery/footerlinkscontent.jsp?pageid=600002))에 문의하십시오. 이 ActiveX 컨트롤에 대한 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {6f750200-1362-4815-a476-88533de61d0c}  
    -   {6f750201-1362-4815-a476-88533de61d0c}  
-   [Avaya (영문)](http://www.avaya.com/)는 CallPilot Unified Messaging에 대한 킬(Kill) 비트를 요청했습니다. CallPilot Unified Messaging의 킬(Kill) 비트와 관련해서 질문이나 의견이 있는 경우 Avaya 보안 담당자(securityalerts@avaya.com)에게 문의하십시오. 이 ActiveX 컨트롤에 대한 클래스 식별자(CLSID)는 다음과 같습니다.  
...
-   Microsoft Data Analyzer ActiveX 컨트롤 취약점(CVE-2010-0252)을 보고해 주신 [NGS Software (영문)](http://www.ngssoftware.com/)의 Shaun Colley  
