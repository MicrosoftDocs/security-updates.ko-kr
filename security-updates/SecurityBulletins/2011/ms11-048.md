---
TOCTitle: 'MS11-048'
Title: 'Microsoft 보안 공지 MS11-048 - 중요'
ms:assetid: 'ms11-048'
ms:contentKeyID: 61230415
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-048(v=Security.10)'
---



Microsoft 보안 공지 MS11-048 - 중요
===================================
...
이 보안 업데이트는 SMB 프로토콜 소프트웨어가 특수하게 조작된 SMB 요청을 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5f0007c3-8d11-4940-8766-1112e3777aae)                                                     | 서비스 거부    | 중요        | [MS09-050](https://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fadf6f12-1f09-4d49-93b1-8fce01400b4f)                             | 서비스 거부    | 중요        | [MS09-050](https://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8960dd62-7cf7-41cb-97b2-b082bd1750aa)\*                 | 서비스 거부    | 중요        | [MS09-050](https://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0abc6908-ac6a-4da3-843a-af6841ccc1db)\*             | 서비스 거부    | 중요        | [MS09-050](https://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=057f1356-9c70-4457-a1df-69334fdab467)       | 서비스 거부    | 중요        | [MS09-050](https://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cf9e5ecd-68f7-4982-b4ed-be80859b757c)                                       | 서비스 거부    | 중요        | [MS11-020](https://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=2707650a-604c-4044-acc4-07a30b5640d8)                                   | 서비스 거부    | 중요        | [MS11-020](https://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=f9824310-772d-4e1e-980e-11e2db3ac53e)\*       | 서비스 거부    | 중요        | [MS11-020](https://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0533d293-e186-4d39-a925-ab3d9ed46290) | 서비스 거부    | 중요        | [MS11-020](https://technet.microsoft.com/security/bulletin/ms11-020) |
...
<th style="border:1px solid black;" >SMB 요청 구문 분석 취약점(CVE-2011-1267)</th>
...
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 요청을 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 네트워크 메시지를 서버 서비스를 실행하는 컴퓨터로 전송하여 취약점을 악용할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1267 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1267)을 참조하십시오.
  
#### SMB 요청 구문 분석 취약점(CVE-2011-1267)에 대한 완화 요소
...
#### SMB 요청 구문 분석 취약점(CVE-2011-1267)에 대한 대안
...
#### SMB 요청 구문 분석 취약점(CVE-2011-1267)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**      
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 요청을 제대로 처리하지 못할 때 취약점이 발생합니다.
...
**이 문제가 SMBv1 또는 SMBv2에 영향을 줍니까?**      
이 문제는 SMBv1 및 SMBv2 프로토콜에 모두 영향을 미칩니다.
...
**업데이트는 어떤 기능을 수행합니까?**      
이 보안 업데이트는 SMB 프로토콜 소프트웨어가 특수하게 조작된 SMB 요청을 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2536275">Microsoft 기술 자료 문서 2536275</a> 참조</td>
</tr>
<tr class="odd">
