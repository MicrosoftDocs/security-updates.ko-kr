...
**문제점.**[Microsoft 기술 자료 문서 982666](http://support.microsoft.com/kb/982666) 는 고객이 보안 업데이트를 할 때 겪을 수 있는 현재까지 알려진 문제점들을 기술하고 있다. 또한 이 문제들을 해결하기 위한 추천 해결책을 기술하고 있다.
...
|------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Windows Server 2003 서비스 팩 2                                                                      | [IIS(인터넷 정보 서비스) 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=0761c207-5465-4f42-b61f-bd02efcef27d&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2003 x64 Edition 서비스 팩 2                                                          | [IIS(인터넷 정보 서비스) 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=023572ff-ce5d-4428-a96b-1245db6ff312&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2003 SP2(Itanium 기반 시스템용)                                                       | [IIS(인터넷 정보 서비스) 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=f1f3e524-8ac6-4210-a3a8-4ffc58a606ea)<sup>[1]</sup>                | 원격 코드 실행 | 중요        | 없음                      |
| Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2                                               | [IIS(인터넷 정보 서비스) 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=01382926-2313-4769-a0a5-262c4f9f18a1&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2                       | [IIS(인터넷 정보 서비스) 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=7fb6f2b8-c7a6-4239-99f3-cf3aacf89b0f&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2             | [IIS(인터넷 정보 서비스) 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=84a54246-5d9e-49e2-8170-af48b43f984d&displaylang=ko)\*<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2         | [IIS(인터넷 정보 서비스) 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=38286e43-89a6-4895-8ff9-69452df38706&displaylang=ko)\*<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2 | [IIS(인터넷 정보 서비스) 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=8ad19eba-9821-48b4-a942-4ee4f002f913)<sup>[1]</sup>                | 원격 코드 실행 | 중요        | 없음                      |
| Windows 7(32비트 시스템용)                                                                           | [IIS(인터넷 정보 서비스) 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=588167cb-f62a-4fb8-8a18-ac15dc322495&displaylang=ko)        | 원격 코드 실행 | 중요        | 없음                      |
| Windows 7(x64 기반 시스템용)                                                                         | [IIS(인터넷 정보 서비스) 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=1c45d0c8-1629-470b-8167-c6bf66054595&displaylang=ko)        | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008 R2(x64 기반 시스템용)                                                            | [IIS(인터넷 정보 서비스) 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=5d9b7705-6280-4d2e-94fa-3160b3ce5cfa&displaylang=ko)\*      | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008 R2(Itanium 기반 시스템용)                                                        | [IIS(인터넷 정보 서비스) 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=869e900a-0063-4d8b-9b7c-7d12f6be12cd)                       | 원격 코드 실행 | 중요        | 없음                      |
...
<sup>[1]</sup>이 운영 체제는 인증에 대한 확장된 보호가 설치된 경우에만 영향을 받습니다. [Microsoft 기술 자료 문서 973917](http://support.microsoft.com/kb/973917)을 참조하십시오. 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**의 항목을 참조하십시오.
...
이 취약점은 Windows 7 및 Windows Server 2008 R2 시스템에 영향을 줍니다. 또한 인증에 대한 확장된 보호를 구현하는 비보안 업데이트 [KB973917](http://support.microsoft.com/kb/973917)을 설치한 Windows Server 2003, Windows Vista 및 Windows Server 2008 시스템에도 영향을 줍니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1256 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256)을 참조하십시오.
...
-   **토큰 검사 요구**
    ...
    [Microsoft 기술 자료 문서 973917](http://support.microsoft.com/kb/973917)에 설명되어 있는 것처럼, 확장된 보호를 사용하여 토큰 검사를 '요구'하도록 IIS(인터넷 정보 서비스)가 구성되어 있는 시스템은 이 취약점에 노출되지 않습니다.
...
확장된 보호는 Windows Server 2003, Windows Vista 및 Windows Server 2008에서 비보안 업데이트로 사용할 수 있습니다([Microsoft 기술 자료 문서 973917](http://support.microsoft.com/kb/973917) 참조). Windows 7 및 Windows Server 2008 R2에서는 이 기능이 운영 체제의 선택적 구성 요소이며, IIS(인터넷 정보 서비스) 웹 서버에 대한 Windows 인증 역할 서비스를 설치할 경우 사용하도록 설정됩니다.
  
**인증에 대한 확장된 보호를 사용하고 있는지 어떻게 확인할 수 있습니까?**    
인증에 대한 확장된 보호는 다양한 방법으로 구성할 수 있습니다. 이러한 구성 방법을 통해 이 기능이 존재하는지 확인할 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 973917](http://support.microsoft.com/kb/973917)을 참조하십시오.
...
인증이 필요한 콘텐츠를 호스팅하고 인증에 대한 확장된 보호를 지원하는 대부분의 웹 서버가 이 취약점의 영향을 받습니다. 시스템은 [Microsoft 기술 자료 문서 973917](http://support.microsoft.com/kb/973917)에 설명되어 있는 대로 확장된 보호 업데이트를 설치한 경우에만 영향을 받습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/982666">Microsoft 기술 자료 문서 982666</a> 참조</td>
</tr>
<tr class="even">
