...
이 정보의 최종 사용자 버전은 다음 [웹 사이트](http://www.microsoft.com/korea/security/)에서 제공됩니다.
...
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Excel의 취약점으로 인한 원격 코드 실행 문제점(927198)**](http://technet.microsoft.com/security/bulletin/ms07-002)                                     |
| **요약**                   | 이 업데이트는 원격 코드 실행을 허용할 수 있는 Excel의 취약점을 해결합니다.                                                                                         |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                      |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                     |
| **영향을 받는 소프트웨어** | **Office** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms07-002)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 공지 번호                  | Microsoft 보안 공지 MS07-003                                                                                                                                       |
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Outlook의 취약점으로 인한 원격 코드 실행 문제점(925938)**](http://technet.microsoft.com/security/bulletin/ms07-003)                                   |
| **요약**                   | 이 업데이트는 원격 코드 실행을 허용할 수 있는 Outlook의 취약점을 해결합니다.                                                                                       |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                      |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                     |
| **영향을 받는 소프트웨어** | **Office** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms07-003)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |

| 공지 번호                  | Microsoft 보안 공지 MS07-004                                                                                                                                                           |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**벡터 표시 언어의 취약점으로 인한 원격 코드 실행 문제점(929969)**](http://technet.microsoft.com/security/bulletin/ms07-004)                                                          |
| **요약**                   | 이 업데이트는 원격 코드 실행을 허용할 수 있는 Internet Explorer 취약점을 해결합니다.                                                                                                   |
| **최대 심각도**            | [긴급](http://technet.microsoft.com/security/bulletin/rating)                                                                                                                          |
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                                         |
| **영향을 받는 소프트웨어** | **Windows, Internet Explorer** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms07-004)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Microsoft Office 2003 포르투갈어(브라질) 문법 검사의 취약점으로 인한 원격 코드 실행 문제점(921585)**](http://technet.microsoft.com/security/bulletin/ms07-001)  |
...
| **취약점으로 인한 영향**   | 원격 코드 실행                                                                                                                                                     |
| **영향을 받는 소프트웨어** | **Office** 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms07-001)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
-   [MS07-002](http://technet.microsoft.com/security/bulletin/ms07-002)에서 설명한 문제점을 보고해 주신 [CERT (영문)](https://www.securecoding.cert.org/confluence/display/seccode/cert+secure+coding+standards)의 Jeff Gennari, [Fortinet Security Research Team (영문)](http://www.fortinet.com/)의 Jie Ma, [NSFocus Security Team (중문)](http://www.nsfocus.com/), [IDefense Labs (영문)](http://labs.idefense.com/)의 Greg MacManus
-   [MS07-003](http://technet.microsoft.com/security/bulletin/ms07-003)에서 설명한 문제점을 보고해 주신 [Sourcefire (영문)](http://www.sourcefire.com/)의 Lurene Grenier, [Computer Terrorism (영문)](http://www.computerterrorism.com/)의 Stuart Pearson
