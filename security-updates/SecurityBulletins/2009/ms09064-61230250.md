...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 Server 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=365a8dff-2383-42f6-b567-e545461fd135&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2523 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 974783](http://support.microsoft.com/kb/974783) 참조                                                   |  
...
-   라이센스 로깅 서버 힙 오버플로 취약점(CVE-2009-2523)을 보고해 주신 [TippingPoint DVLabs (영문)](http://dvlabs.tippingpoint.com/)의 Cody Pierce
