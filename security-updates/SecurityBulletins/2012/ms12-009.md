---
TOCTitle: 'MS12-009'
Title: 'Microsoft 보안 공지 MS12-009 - 중요'
ms:assetid: 'ms12-009'
ms:contentKeyID: 61230476
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-009(v=Security.10)'
---


Microsoft 보안 공지 MS12-009 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP(x86 기반 제외), Windows Server 2003, Windows Vista(x86 기반 제외), Windows Server 2008(x86 기반 제외), Windows 7(x86 기반 제외) 및 Windows Server 2008 R2 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 사용자 모드에서 Windows 커널로 입력을 전달하기 전에 AFD에서 입력의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

권장 사항. 대다수의 고객은 자동 업데이트를 사용하고 있기 때문에 따로 조치를 취할 필요가 없습니다. 이 보안 업데이트가 자동으로 다운로드되고 설치됩니다. 자동 업데이트를 사용하고 있지 않은 고객은 수동으로 업데이트를 확인하고 이 업데이트를 설치해야 합니다. 자동 업데이트의 특정 구성 옵션에 대한 자세한 내용은 [Microsoft 기술 자료 문서 294871](https://support.microsoft.com/kb/294871)을 참조하십시오. 고객이 업데이트 관리 소프트웨어를 사용하거나 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 서비스를 통해 업데이트를 확인하여 업데이트를 최대한 빨리 적용하는 것이 좋습니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                     | 권한 상승      | 중요        | [MS11-080](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS11-080](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-080](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                                      | 권한 상승      | 중요        | [MS11-080](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-080) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS11-046](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb&displaylang=ko)\*                                                 | 권한 상승      | 중요        | [MS11-046](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                              | 권한 상승      | 중요        | [MS11-046](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127&displaylang=ko)                             | 권한 상승      | 중요        | [MS11-046](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744&displaylang=ko)\* | 권한 상승      | 중요        | [MS11-046](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc)          | 권한 상승      | 중요        | [MS11-046](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-046) |
...
Windows Server 2003 서비스 팩 2가 이 공지의 영향을 받는 유일한 Windows 32비트 에디션인 이유는 무엇입니까?  
이 보안 업데이트는 취약점 2건(CVE-2012-0148 및 CVE-2012-0149)을 해결합니다. CVE-2012-0148은 어떠한 Windows 32비트 에디션에도 영향을 미치지 않으며, CVE-2012-0149는 지원 대상인 Windows Server 2003 에디션(32비트 에디션 포함)에만 영향을 미칩니다. 따라서 Windows Server 2003 서비스 팩 2가 이 공지의 영향을 받는 소프트웨어에 포함된 유일한 Windows 32비트 에디션입니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [2월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-feb)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >AfdPoll 권한 상승 취약점(CVE-2012-0148)</th>
<th style="border:1px solid black;" >Ancillary Function Driver 권한 상승 취약점(CVE-2012-0149)</th>
...
사용자 모드에서 Windows 커널로 전달된 입력의 유효성을 올바르게 검사하지 못하는 경우 Ancillary Function Driver(afd.sys)에 권한 상승 취약점이 존재합니다. 취약점을 통해 공격자가 권한을 상승시키는 코드를 실행할 수 있습니다. 이 취약점 악용에 성공한 로컬 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0148(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148)을 참조하십시오.
  
#### AfdPoll 권한 상승 취약점(CVE-2012-0148)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.  
-   Microsoft Windows 32비트 에디션에서는 이 취약점을 악용할 수 없습니다.
  
#### AfdPoll 권한 상승 취약점(CVE-2012-0148)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### AfdPoll 권한 상승 취약점(CVE-2012-0148)에 대한 FAQ
...
취약점의 원인은 무엇입니까?   
이 취약점은 afd.sys 드라이버가 사용자 모드에서 데이터를 수신할 때 입력에 대한 유효성 검사를 제대로 수행하지 못할 경우에 발생합니다.
  
Ancillary Function Driver(AFD)란 무엇입니까?   
AFD 구성 요소는 Windows 소켓 응용 프로그램을 지원하며 afd.sys 파일에 포함되어 있는 "ancillary function driver"를 제공합니다. afd.sys 드라이버는 커널 모드에서 실행되며 Winsock TCP/IP 통신 프로토콜을 관리합니다. 이 Winsock 커널 인터페이스를 통해 TDI 전송을 액세스할 수 있습니다.
  
TDI(Transport Driver Interface)란 무엇입니까?   
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 MSDN 문서, [Transport Driver Interface(영문)](https://msdn.microsoft.com/ko-kr/library/ff565685.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0149(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149)를 참조하십시오.
  
#### Ancillary Function Driver 권한 상승 취약점(CVE-2012-0149)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### Ancillary Function Driver 권한 상승 취약점(CVE-2012-0149)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Ancillary Function Driver 권한 상승 취약점(CVE-2012-0149)에 대한 FAQ
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2645640$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2645640">Microsoft 기술 자료 문서 2645640</a> 참조</td>
</tr>
<tr class="even">
...
-   AfdPoll 권한 상승 취약점(CVE-2012-0148)을 보고해 주신 [Azimuth Security(영문)](https://www.azimuthsecurity.com/)의 Tarjei Mandt  
-   AfdPoll 권한 상승 취약점(CVE-2012-0149)을 보고해 주신 [Azimuth Security(영문)](https://www.azimuthsecurity.com/)의 Tarjei Mandt
