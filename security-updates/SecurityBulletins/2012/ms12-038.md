---
TOCTitle: 'MS12-038'
Title: 'Microsoft 보안 공지 MS12-038 - 긴급'
ms:assetid: 'ms12-038'
ms:contentKeyID: 61230505
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-038(v=Security.10)'
---

Microsoft 보안 공지 MS12-038 - 긴급
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션의 Microsoft .NET Framework 2.0 서비스 팩 2, Microsoft .NET Framework 3.5.1 및 Microsoft .NET Framework 4에 대해 긴급입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 .NET Framework가 함수 포인터에 전달된 데이터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
Microsoft .NET Framework 4.5 Consumer Preview와 Windows Consumer Preview의 Microsoft .NET Framework 3.5 및 Microsoft .NET Framework 4.5가 이 취약점의 영향을 받습니까?
예. 이 취약점은 Windows Consumer Preview 및 Microsoft .NET Framework 4.5 Consumer Preview의 출시 이후 보고되었습니다. Consumer Preview 소프트웨어를 실행하는 고객은 이 업데이트를 다운로드하여 시스템에 적용하는 것이 좋습니다. Microsoft 다운로드 센터 링크를 비롯한 자세한 내용은 다음 Microsoft 기술 자료 문서를 참조하십시오.

| 영향을 받는 소프트웨어                                                                                   | Microsoft 기술 자료 문서                                                    |
|----------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Windows Consumer Preview의 Microsoft .NET Framework 3.5                                                  | [Microsoft 기술 자료 문서 2686868](https://support.microsoft.com/kb/2686868) |
| Windows Consumer Preview의 Microsoft .NET Framework 4.5                                                  | [Microsoft 기술 자료 문서 2686837](https://support.microsoft.com/kb/2686837) |
| Windows Server 2008, Windows 7 및 Windows Server 2008 R2의 Microsoft .NET Framework 4.5 Consumer Preview | [Microsoft 기술 자료 문서 2686838](https://support.microsoft.com/kb/2686838) |
...
Windows Release Preview와 Windows RT, Microsoft .NET Framework 4.5 출시 후보 버전의 Microsoft .NET Framework 3.5 및 Microsoft .NET Framework 4.5가 이 취약점의 영향을 받습니까?  
아니요. 이 취약점은 Windows Release Preview, Windows RT, Microsoft .NET Framework 4.5 출시 후보 버전의 출시 전에 보고되었기 때문에 이 보안 공지에서 설명한 취약점에 대한 수정 프로그램은 해당 릴리스에 포함되어 있습니다.
...
이 공지는 .NET Framework 2.0 및 .NET Framework 4 기능 계층의 취약점을 설명합니다. .NET Framework 3.0 서비스 팩 2 설치 프로그램은 .NET Framework 2.0 서비스 팩 2 설치에서 연계되므로 .NET Framework 3.0 서비스 팩 2을 설치하면 .NET Framework 2.0 서비스 팩 2도 설치됩니다. 따라서 .NET Framework 3.0 서비스 팩 2를 설치한 고객은 .NET Framework 2.0 서비스 팩 2용 보안 업데이트를 설치해야 합니다.

.NET Framework 3.5 서비스 팩 1을 설치했습니다. 다른 업데이트를 설치해야 합니까?  
이 공지에서는 .NET Framework 2.0 기능 계층 및 .NET Framework 4의 취약점을 설명합니다. .NET Framework 3.5 서비스 팩 1 설치 프로그램은 .NET Framework 2.0 서비스 팩 2 설치 및 .NET Framework 3.0 서비스 팩 2 설치 모두에서 연계됩니다. 따라서 .NET Framework 3.5 서비스 팩 1을 설치한 고객은 .NET Framework 2.0 서비스 팩 2용 보안 업데이트를 설치해야 합니다.
...
잘못된 함수 포인터의 실행으로 인해 Microsoft .NET Framework에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1855(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1855)를 참조하십시오.

#### .NET Framework 메모리 액세스 취약점(CVE-2012-1855)에 대한 완화 요소
...
#### .NET Framework 메모리 액세스 취약점(CVE-2012-1855)에 대한 대안
...
#### .NET Framework 메모리 액세스 취약점(CVE-2012-1855)에 대한 FAQ
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 .NET Framework가 함수 포인터에 전달된 데이터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
자세한 내용은 [System Center Configuration Manager](https://go.microsoft.com/fwlink/?linkid=21158)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2706726">Microsoft 기술 자료 문서 2706726</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션에 설치된 Microsoft .NET Framework 2.0 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP Professional x64 기반 에디션에 설치된 Microsoft .NET Framework 2.0 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP Professional x64 기반 에디션에 설치된 Microsoft .NET Framework 4:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 32비트 에디션의 Microsoft .NET Framework 4:<br />
...
-   .NET Framework 메모리 액세스 취약점(CVE-2012-1855)을 [Tipping Point(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/) 와 협력하여 보고해 주신 Vitaliy Toropov
