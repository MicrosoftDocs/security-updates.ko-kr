...
2010년 5월 공지 발표와 함께 이 공지 요약이 2010년 5월 6일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](https://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](https://go.microsoft.com/fwlink/?linkid=21163)을 참조하십시오.

Microsoft는 2010년 5월 13일 오전 3:00(한국 표준시)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [5월 보안 공지 웹캐스트에 지금 등록하십시오](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032427724&culture=en-us). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약 (영문)](https://technet.microsoft.com/security/bulletin/summary) 및 웹캐스트를 참조하십시오.
...
|---------------------------------------------------------------------|------------------------------------------------------|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|  
| [MS10-031](https://technet.microsoft.com/security/bulletin/ms10-031) | VBE6.DLL 스택 메모리 손상 취약점                     | [CVE-2010-0815 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0815) | [**2 (영문)**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 비일관적인 악용 코드 가능 | (없음)                                                                                              |  
| [MS10-030](https://technet.microsoft.com/security/bulletin/ms10-030) | Outlook Express 및 Windows Mail 정수 오버플로 취약점 | [CVE-2010-0816 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0816) | [**2 (영문)**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 비일관적인 악용 코드 가능 | Windows Vista 및 그 이상의 운영 체제에서는 힙 취약점이 완화되었기 때문에 악용 가능성이 더 낮습니다. |
...
<sup>[3]</sup>독립 소프트웨어 공급업체(ISV)는 이 공지에서 설명하는 취약점을 해결한 업데이트된 버전의 Visual Basic for Applications SDK를 [Summit Software Company (영문)](https://www.summsoft.com/)에서 사용할 수 있습니다.
...
-   MS10-031에서 설명한 문제점을 보고해 주신 [NSFocus Security Team (영문)](https://www.nsfocus.com/)
