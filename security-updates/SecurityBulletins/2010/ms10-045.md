...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 978212](http://support.microsoft.com/kb/978212)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
예. 이 공지의 취약점 정보 항목에 나열된 변경 사항 이외에 이 업데이트에는 PR\_ATTACH\_METHOD 속성의 ATTACH\_BY\_REFERENCE 값을 사용하여 전자 메일의 첨부 파일을 차단하는 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 2271150](http://support.microsoft.com/kb/2271150)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0266 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0266)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/980371">Microsoft 기술 자료 문서 980371</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/980373">Microsoft 기술 자료 문서 980373</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/980376">Microsoft 기술 자료 문서 980376</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Microsoft Outlook SMB 첨부 파일 취약점(CVE-2010-0266)을 [SSD/SecuriTeam Secure Disclosure Program (영문)](http://www.beyondsecurity.com/ssd.html)과 협력하여 보고해 주신 Yorick Koster
