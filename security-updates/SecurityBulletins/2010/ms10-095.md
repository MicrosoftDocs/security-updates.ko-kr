...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3966 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3966)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2385678">Microsoft 기술 자료 문서 2385678</a> 참조</td>
</tr>
<tr class="odd">
...
-   BranchCache 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3966)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com/)의 Haifei Li
