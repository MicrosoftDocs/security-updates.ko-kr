...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">SNMP 메모리 손상 취약점 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5583">CVE-2006-5583 (영문)</a></td>
...
[SNMP (영문)](http://search.msdn.microsoft.com/search/redirect.aspx?title=snmp+functions+%5bsnmp%5d&url=http://msdn.microsoft.com/library/en-us/snmp/snmp/snmp_functions.asp)(단순 네트워크 관리 프로토콜)를 사용하여 관리자는 서버, 워크스테이션, 라우터, 브리지, 방화벽 등의 네트워크 장치를 원격으로 관리할 수 있습니다. SNMP는 다양한 공급업체에서 만든 장치를 하나의 프로토콜을 통해 관리할 수 있는 업계 표준 프로토콜입니다.
...
이 보안 업데이트는 핫패칭을 지원합니다. 핫패칭에 대한 자세한 내용은 [Microsoft 기술 자료 문서 897341](http://support.microsoft.com/kb/897341)을 참조하십시오.
...
-   SNMP 메모리 손상 취약점(CVE-2006-5583)을 보고해 주신 [The European Aeronautic Defense and Space Company (영문)](http://www.eads.com/)의 Kostya Kortchinsky
