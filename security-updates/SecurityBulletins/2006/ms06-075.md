...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 목록 손상 취약점</strong> - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5585">CVE-2006-5585 (영문)</a></td>
...
Microsoft Windows가 특수하게 조작된 파일 목록을 사용하여 응용 프로그램을 시작하는 방식으로 인한 [권한 상승](http://www.microsoft.com/korea/security/glossary.mspx) 취약점이 존재합니다. 이 취약점을 통해 로그온한 사용자가 시스템에 대한 전체 제어 권한을 얻을 수 있습니다.
...
[Microsoft 기술 자료 문서 921337](http://support.microsoft.com/kb/921337/ko-kr)은 시스템 재부팅을 일으킬 수 있는 파일 목록 관련 문제점을 다룹니다. 이 문제점을 검토하면서 Microsoft는 이 보안 업데이트 릴리스로 해결되는 잠재적인 보안 취약점을 확인했습니다.
