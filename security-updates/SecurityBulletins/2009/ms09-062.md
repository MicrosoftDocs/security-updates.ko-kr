...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2500 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2500)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2501 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2501)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2502 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2502)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2503 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2503)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2504 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2504)를 참조하십시오.
...
**CAS란 무엇입니까?**   
CAS(코드 액세스 보안)는 보호된 리소스 및 작업에 대한 해당 코드의 액세스를 제한하는 메커니즘입니다. CAS에 대한 자세한 내용은 MSDN 문서, [코드 액세스 보안 소개 (영문)](https://msdn.microsoft.com/en-us/library/c5tk9z76.aspx)를 참조하십시오.

**XBAP란 무엇입니까?**   
XBAP(XAML 브라우저 응용 프로그램)에는 웹 응용 프로그램과 다양한 기능을 갖춘 클라이언트 응용 프로그램의 기능이 통합되어 있습니다. 따라서 웹 응용 프로그램처럼 웹 서버에 게시하고 Internet Explorer에서 시작할 수 있으며, 클라이언트 응용 프로그램처럼 WPF 기능을 활용할 수 있습니다. XBAP에 대한 자세한 내용은 [Windows Presentation Foundation XAML 브라우저 응용 프로그램 개요(영문)](https://msdn.microsoft.com/en-us/library/aa970060.aspx)를 참조하십시오.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**   
취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다. 사용자가 관리자 권한의 사용자 권한으로 로그온한 경우 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

웹 호스팅 시나리오의 경우, 이 취약점을 성공적으로 악용한 공격자는 Microsoft .NET 응용 프로그램이 실행 중인 응용 프로그램 풀의 응용 프로그램 풀 ID와 연관된 서비스 계정과 동일한 권한을 얻을 수 있습니다. 응용 프로그램 풀 격리 구성 및 서비스 계정에 부여된 권한에 따라 공격자는 웹 서버의 다른 응용 프로그램 풀을 제어하거나 영향을 받는 시스템을 완전히 제어할 수 있습니다. 응용 프로그램 풀 ID 및 구성에 대한 자세한 내용은 TechNet 문서, [응용 프로그램 풀 ID 구성(영문)](https://technet.microsoft.com/en-us/library/cc781986(ws.10).aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3126 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3126)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2528 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2528)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2518 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2518)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 958869](https://support.microsoft.com/kb/958869) 참조                                                                          |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/958869">Microsoft 기술 자료 문서 958869</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft .NET Framework 1.1 서비스 팩 1:<br />
<a href="https://support.microsoft.com/kb/971108">Microsoft 기술 자료 문서 971108</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft .NET Framework 1.1 서비스 팩 1:<br />
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft .NET Framework 2.0 서비스 팩 1:<br />
<a href="https://support.microsoft.com/kb/971110">Microsoft 기술 자료 문서 971110</a> 참조<br />
<br />
Microsoft .NET Framework 2.0 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/971111">Microsoft 기술 자료 문서 971111</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft .NET Framework 2.0 서비스 팩 1:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/974811">Microsoft 기술 자료 문서 974811</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   [Windows 2000 및 Windows NT 4.0용 Windows Installer 2.0 재배포 가능 파일](https://go.microsoft.com/fwlink/?linkid=33338)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/972580">Microsoft 기술 자료 문서 972580</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/972581">Microsoft 기술 자료 문서 972581</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975365">Microsoft 기술 자료 문서 975365</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973636">Microsoft 기술 자료 문서 973636</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/970899">Microsoft 기술 자료 문서 970899</a> 참조</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/957488">Microsoft 기술 자료 문서 957488</a> 참조</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971022">Microsoft 기술 자료 문서 971022</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971023">Microsoft 기술 자료 문서 971023</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Visual Studio 2008<br />
<a href="https://support.microsoft.com/kb/972221">Microsoft 기술 자료 문서 972221</a> 참조<br />
<br />
Microsoft Visual Studio 2008 서비스 팩 1<br />
<a href="https://support.microsoft.com/kb/972222">Microsoft 기술 자료 문서 972222</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft Visual Studio 2008<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971117">Microsoft 기술 자료 문서 971117</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<a href="https://support.microsoft.com/kb/971118">Microsoft 기술 자료 문서 971118</a> 참조<br />
<br />
Microsoft Report Viewer 2008 재배포 가능 패키지 서비스 팩 1<br />
<a href="https://support.microsoft.com/kb/971119">Microsoft 기술 자료 문서 971119</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft Report Viewer 2008 재배포 가능 패키지<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971104">Microsoft 기술 자료 문서 971104</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971105">Microsoft 기술 자료 문서 971105</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4에 설치된 Microsoft Visual FoxPro 9.0 서비스 팩 2:<br />
...
| **파일 정보**           | [Microsoft 기술 자료 문서 975337](https://support.microsoft.com/kb/975337) 참조            |
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975962">Microsoft 기술 자료 문서 975962</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   GDI+ WMF 정수 오버플로 취약점(CVE-2009-2500)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li  
-   GDI+ PNG 힙 오버플로 취약점(CVE-2009-2501)을 보고해 주신 [SkyRecon (영문)](https://www.skyrecon.com/)의 Thomas Garnier  
-   GDI+ TIFF 버퍼 오버플로 취약점(CVE-2009-2502)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Wushi  
-   GDI+ TIFF 메모리 손상 취약점(CVE-2009-2503)을 보고해 주신 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)의 Ivan Fratric, [Google Inc.](https://www.google.com/)의 Tavis Ormandy 및 Carlo Di Dato(aka shinnai)  
-   GDI+ PNG 정수 오버플로 취약점(CVE-2009-3126)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy  
-   메모리 손상 취약점(CVE-2009-2528)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Marsu Pilami  
-   Office BMP 정수 오버플로 취약점(CVE-2009-2518)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten H. Eiram
