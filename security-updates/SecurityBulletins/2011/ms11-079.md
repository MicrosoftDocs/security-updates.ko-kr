...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2544641](https://support.microsoft.com/kb/2544641)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b0de8d20-9c25-41c0-9c02-d263b9ed22fa">Microsoft Forefront Unified Access Gateway 2010 업데이트 1</a>[1]<br />
(KB2522483)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=166bdfcb-5088-4471-9d51-a3071ac13b73">Microsoft Forefront Unified Access Gateway 2010 업데이트2</a>[1]<br />
(KB2522484)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8b6ad2ae-e168-45d9-bd3f-5590e0cbd2b5">Microsoft Forefront Unified Access Gateway 2010 서비스 팩 1</a>[1]<br />
(KB2522485)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1895(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1895)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1896(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1896)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1897(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1897)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1969(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1969)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2012(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2012)를 참조하십시오.
...
<td style="border:1px solid black;">Forefront Unified Access Gateway 2010(KB2522482):<br />
<a href="https://support.microsoft.com/kb/2522482">Microsoft 기술 자료 문서 2522482</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Forefront Unified Access Gateway 2010 업데이트 1(KB2522483):<br />
<a href="https://support.microsoft.com/kb/2522483">Microsoft 기술 자료 문서 2522483</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Forefront Unified Access Gateway 2010 업데이트 2(KB2522484):<br />
<a href="https://support.microsoft.com/kb/2522484">Microsoft 기술 자료 문서 2522484</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Forefront Unified Access Gateway 2010 서비스 팩 1(KB2522485):<br />
<a href="https://support.microsoft.com/kb/2522485">Microsoft 기술 자료 문서 2522485</a> 참조</td>
</tr>
<tr class="even">
...
-   ExcelTable 응답 분할 XSS 취약점(CVE-2011-1895)을 보고해 주신 [Tenable Network Security(영문)](https://www.tenable.com/)
-   ExcelTable 응답 분할 XSS 취약점(CVE-2011-1895)을 보고해 주신 [Tenable Network Security(영문)](https://www.tenable.com/)
-   ExcelTable의 변형된 XSS 취약점(CVE-2011-1896)을 보고해 주신 [Tenable Network Security(영문)](https://www.tenable.com/)
-   손상된 코드 실행 취약점(CVE-2011-1969)을 보고해 주신 [SEC Consult Unternehmensberatung GmbH(영문)](https://www.sec-consult.com/)의 Elisabeth Demeter
