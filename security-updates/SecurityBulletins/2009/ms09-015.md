...
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=3de0684d-605c-489b-bdc7-08bce9b2d4f6&displaylang=ko)                                  | 권한 상승      | 보통        | [MS07-035](http://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b743a7fe-7bf4-420d-a72e-39471e5659fa)           | 권한 상승      | 보통        | [MS07-035](http://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=992bb0cd-fbc7-4a7c-9088-f7f9d9a3ead0&displaylang=ko)                | 권한 상승      | 보통        | [MS07-035](http://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f0a58e8c-7d63-4d7d-ba95-b3787cf408f0&displaylang=ko)    | 권한 상승      | 보통        | [MS07-035](http://technet.microsoft.com/security/bulletin/ms07-035) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=00c6479d-f81f-445d-b8e4-7b71d77d540a) | 권한 상승      | 보통        | [MS07-035](http://technet.microsoft.com/security/bulletin/ms07-035) |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 959426](http://support.microsoft.com/kb/959426)에 나와 있습니다.

**이 업데이트는 MS09-014와 어떤 관련이 있습니까?**  
이 보안 공지에서 설명한 혼합 보안 위협 권한 상승 취약점([CVE-2008-2540 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540))도 Internet Explorer에 영향을 미칩니다. 따라서 사용자는 [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014), Internet Explorer 누적 보안 업데이트(963027)로 제공되는 보안 업데이트도 설치하는 것이 좋습니다.
...
아니요. Internet Explorer 누적 보안 업데이트([MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014))에서 제공하는 심층 방어 보호도 따로 사용해야 합니다. 하지만 혼합 보안 위협에 대해 이 심층 방어 보호를 사용하는 것이 자신의 사용 환경에서 적합한지 확인해야 합니다.

Internet Explorer에서 심층 방어 보호를 사용하려면 [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014)에서 이 보안 업데이트와 관련된 자주 제기되는 질문 사항에 설명된 SearchPath 기능 컨트롤 키를 사용하십시오. 혼합 보안 위협 문제점에 대한 자세한 내용은 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-2540 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)을 참조하십시오.
...
이러한 아키텍처 변경으로 인해 Microsoft Windows 2000에서는 레지스트리 키, HKLM\\System\\CCS\\control\\Session Manager\\SafeDLLSearchMode를 사용하여 Microsoft Windows 2000 고유의 심층 방어 변경 사항을 사용해야 합니다. 지침은 [Microsoft 기술 자료 문서 959426](http://support.microsoft.com/kb/959426)을 참조하십시오. 자세한 내용은 MSDN 문서, [동적 연결 라이브러리 검색 순서 (영문)](http://msdn.microsoft.com/en-us/library/ms682586.aspx)를 참조하십시오.

**SearchPath 기능이란 무엇입니까?**  
SearchPath 기능은 지정된 경로에서 특정 파일을 검색하는 데 사용됩니다. 자세한 내용은 MSDN 문서, [SearchPath 기능(영문)](http://msdn.microsoft.com/en-us/library/aa365527.aspx)을 참조하십시오.

**LoadLibrary 기능이란 무엇입니까?**  
LoadLibrary 기능은 지정된 모듈을 호출 프로세스의 주소 공간으로 로드합니다. 지정된 모듈로 인해 다른 모듈이 로드될 수 있습니다. 자세한 내용은 MSDN 문서, [LoadLibrary 기능(영문)](http://msdn.microsoft.com/en-us/library/ms684175(vs.85).aspx)을 참조하십시오.
...
[CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)은 Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3용 Internet Explorer 7, Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 Internet Explorer 7, 그리고 Windows의 SearchPath 기능에 모두 영향을 미칩니다. 따라서 사용자는 [MS09-014](http://go.microsoft.com/fwlink/?linkid=146659), Internet Explorer 누적 보안 업데이트(963027)로 제공되는 보안 업데이트도 설치하는 것이 좋습니다. 이 업데이트의 취약점에 대한 심층 방어 변경 사항(SetSearchPathMode라고 부르는 새로운 API) 또한 [MS09-014](http://go.microsoft.com/fwlink/?linkid=146659)의 픽스에 해당합니다. **이 보안 업데이트와 관련된 자주 제기되는 질문 사항** 섹션에서 FAQ, "이 업데이트에 기능에 대한 보안 관련 변경 사항이 포함되어 있습니까?"를 참조하십시오
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2008-2540 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 953818](http://technet.microsoft.com/security/advisory/953818)에서 처음 설명되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/959426">Microsoft 기술 자료 문서 959426</a> 참조</td>
</tr>
<tr class="even">
...
-   혼합 보안 위협 권한 상승 취약점(CVE-2008-2540)을 보고해 주신 [Aviv Raff (영문)](http://aviv.raffon.net)
