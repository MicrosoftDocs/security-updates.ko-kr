...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3127 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3134 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/973471">Microsoft 기술 자료 문서 973471</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2003:<br />
<a href="http://support.microsoft.com/kb/973475">Microsoft 기술 자료 문서 973475</a> 참조<br />
<br />
Excel Viewer 2003:<br />
<a href="http://support.microsoft.com/kb/973484">Microsoft 기술 자료 문서 973484</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="http://support.microsoft.com/kb/973593">Microsoft 기술 자료 문서 973593</a> 참조<br />
<br />
Excel Viewer:<br />
<a href="http://support.microsoft.com/kb/973707">Microsoft 기술 자료 문서 973707</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="http://support.microsoft.com/kb/973704">Microsoft 기술 자료 문서 973704</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Excel 캐시 메모리 손상 취약점(CVE-2009-3127)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](http://www.fortiguard.com)의 Bing Liu  
-   Excel 캐시 메모리 손상 취약점(CVE-2009-3127)을 보고해 주신 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)  
-   Excel SxView 메모리 손상 취약점(CVE-2009-3128)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](http://www.fortiguard.com)의 Bing Liu  
-   Excel Featheader 레코드 메모리 손상 취약점(CVE-2009-3129)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   Excel 문서 구문 분석 힙 오버플로 취약점(CVE-2009-3130)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 수식 구문 분석 메모리 손상 취약점(CVE-2009-3131)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 인덱스 구문 분석 취약점(CVE-2009-3132)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 문서 구문 분석 메모리 손상 취약점(CVE-2009-3133)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Excel 필드 삭제 취약점(CVE-2009-3134)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](http://www.fortiguard.com)의 Bing Liu
