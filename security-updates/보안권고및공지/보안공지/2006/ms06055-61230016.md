...
-   Microsoft Windows XP 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=383c13dc-51a9-4b12-89e3-871a1a3de98f&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=b5f19858-4e86-4fd4-a264-e4823ff6d0a9&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=afd3279c-6171-4f20-a36e-b9b56ee4c7f1)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=af8f3a58-ba7a-41bf-bb1b-3a9ddfdc3e27&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용) - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=271e9c78-1c6a-443e-924d-43fd6d51e643)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=e2cb474f-fc1b-4b7d-a607-02a1528c6743)

**테스트된 Microsoft Windows 구성 요소:**

**영향을 받는 구성 요소:**

-   Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 5.01 서비스 팩 4 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=4c48ff93-6559-4616-9c2d-406e808b7e97&displaylang=ko)
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 6 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=ea7de30f-d765-4e5b-bfd4-64f3fed578ff&displaylang=ko)
...
|------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|------------------------|------------------------|---------------------|---------------------------------|
| VML 버퍼 오버런 취약점 - [CVE-2006-4868 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4868) | 원격 코드 실행       | 긴급                     | 긴급                   | 긴급                   | 긴급                | 보통                            |
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)으로 알려진 제한된 모드로 실행됩니다. 인터넷 영역에서 바이너리 및 스크립트 동작을 기본적으로 사용하지 않으므로, 이 모드는 Windows Server 2003 서비스 팩 1의 취약점을 완화합니다.
...
-   VML 버퍼 오버런 취약점(CVE-2006-4868)과 관련하여 Microsoft와 협력해 주신 [ISS X-Force (영문)](http://www.iss.net/)
-   VML 버퍼 오버런 취약점(CVE-2006-4868)과 관련하여 Microsoft와 협력해 주신 [iDEFENSE (영문)](http://www.idefense.com/)
-   VML 버퍼 오버런 취약점(CVE-2006-4868)과 관련하여 Microsoft와 협력해 주신 [Websense Security Labs (영문)](http://www.websense.com/securitylabs/)의 Dan Hubbard
