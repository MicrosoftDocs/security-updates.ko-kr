---
TOCTitle: 'MS09-007'
Title: 'Microsoft 보안 공지 MS09-007 - 중요'
ms:assetid: 'ms09-007'
ms:contentKeyID: 61230193
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-007(v=Security.10)'
---


Microsoft 보안 공지 MS09-007 - 중요
===================================
...
이 보안 업데이트는 클라이언트가 TLS 핸드셰이크 중에 서버가 키 교환 데이터의 구문을 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=bf7065bc-c183-4a78-8d46-72fe7385c07c&displaylang=ko)                                                | 스푸핑         | 중요        | [MS07-031](http://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3&displaylang=ko)                                                            | 스푸핑         | 중요        | [MS07-031](http://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3&displaylang=ko)                                                            | 스푸핑         | 중요        | 없음                                                                |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6d02306e-9e2e-4ae8-bd21-8a2c1a229472)           | 스푸핑         | 중요        | [MS07-031](http://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0b3f6fdd-276e-4267-99d8-8f00d91ad6a2&displaylang=ko)                | 스푸핑         | 중요        | [MS07-031](http://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ce98ff55-f565-469d-bbd2-32b681faf908&displaylang=ko)    | 스푸핑         | 중요        | [MS07-031](http://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5ca3c72c-cadb-4b0a-b3a3-fb81d0bfd7b3) | 스푸핑         | 중요        | [MS07-031](http://technet.microsoft.com/security/bulletin/ms07-031) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=21086a04-402a-4940-8358-7fa63508102b&displaylang=ko)                                        | 스푸핑         | 중요        | 없음                                                                |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c75a2ea9-b42f-457b-be09-5c8fa0339388&displaylang=ko)                | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008 (32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=47b361ce-624b-466c-b5c5-8703f6532615&displaylang=ko)\*                                           | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008 (x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5c81ac45-60e6-4121-ab6b-d3b3179aacc4&displaylang=ko)\*                                         | 스푸핑         | 중요        | 없음                                                                |
| [Windows Server 2008 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=bf8f5a86-1757-4f9b-b632-d4aa7005a9f8)                                                      | 스푸핑         | 중요        | 없음                                                                |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 960225](http://support.microsoft.com/kb/960225)에 나와 있습니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [3월 공지 요약](http://technet.microsoft.com/security/bulletin/ms09-mar)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >SChannel 스푸핑 취약점(CVE-2009-0085)</th>
...
SChannel 스푸핑 취약점(CVE-2009-0085)  
-------------------------------------
  
인증서 기반 인증을 사용하는 경우 Microsoft Windows SChannel 인증 구성 요소에 스푸핑 취약점이 존재합니다. 이 취약점을 악용한 공격자는 연관된 개인 키 없이 승인된 사용자의 디지털 인증서만 사용하여 서버에서 인증을 받을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0085 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0085)를 참조하십시오.
  
#### SChannel 스푸핑 취약점(CVE-2009-0085)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   고객은 인증에 사용된 인증서가 다른 방법을 통해 공격자에게 이미 공개된 경우에만 영향을 받습니다. IIS 웹 서버의 경우, 인증서는 인증 프로세스 동안 일반 텍스트로 전송되지 않습니다.  
-   사용자 계정이 로컬 시스템에서 구성된 경우에만 이 문제에 취약합니다. Active Directory 도메인에 대한 응용 프로그램에 인증된 사용자의 인증서를 매핑한 고객은 이 취약점의 영향을 받지 않습니다.
  
#### SChannel 스푸핑 취약점(CVE-2009-0085)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   고객은 이 취약점의 영향을 받지 않는 Active Directory 인증서 매핑을 구현할 수 있습니다. 사용자는 Active Directory 인증서 매핑을 통해 사용자 이름과 암호를 입력하지 않고도 신뢰할 수 있는 공개 키를 사용해 도메인 리소스에 액세스할 수 있습니다. 클라이언트 인증서는 Active Directory 사용자 계정에 바로 매핑할 수 있습니다.  
    인증서 매핑을 구성하는 여러 가지 방법에 대해서는 [사용자 계정에 인증서 매핑 (영문)](http://technet.microsoft.com/en-us/library/cc736706.aspx)을 참조하십시오.
  
#### SChannel 스푸핑 취약점(CVE-2009-0085)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
인증서 기반 인증을 사용하는 경우 Microsoft Windows SChannel 인증 구성 요소에 스푸핑 취약점이 존재합니다. 이 취약점을 악용한 공격자는 사용자의 인증 자격 증명의 공개 구성 요소을 사용해 다른 사용자를 가장하여 보호된 서버에서 인증을 받을 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
SChannel 인증 구성 요소가 클라이언트가 실제로 인증에 사용된 인증서에 연결된 개인 키에 액세스했는지를 확인하는 특정 TLS(Transport Layer Security) 핸드셰이크 메시지에 대해 유효성 검사를 충분히 수행하지 않습니다.
  
**Secure Channel(SChannel) 보안 패키지란 무엇입니까?**    
Secure Channel(Schannel) 보안 패키지는 SSL(Secure Sockets Layer) 및 TLS(Transport Layer Security) 인터넷 표준 인증 프로토콜을 구현하는 SSP(보안 지원 공급자)입니다. 이러한 구성 요소는 웹 탐색과 같은 여러 일반 인터넷과 네트워크 응용 프로그램을 지원하는 보안 통신을 구현하는 데 사용됩니다. SChannel은 클라이언트와 서버 간에 보안 통신을 지원하기 위한 인증 서비스를 제공하는 보안 패키지의 일부입니다. SChannel에 대한 자세한 내용은 MSDN의 [SChannel (영문)](http://msdn.microsoft.com/en-us/library/ms678421.aspx) 웹 사이트를 참조하십시오.
  
**x.509 디지털 인증서란 무엇입니까?**    
공개 및 개인 키를 사용하는 암호화 기술에는 공개 키의 배포 및 인증을 지원하는 PKI(공개 키 구조)가 필요합니다. PKI(공개 키 구조)에는 디지털 인증서 패키지 공개 키, 사용된 알고리즘에 관한 정보, 소유자 또는 주체 데이터, 주체 데이터를 확인한 인증서 권한의 디지털 서명, 인증서가 유효한 것으로 간주되는 날짜 범위 등이 있습니다.
  
사용자가 연결 중인 서버가 실제 호스트 이름에 대한 합법적인 서버인지 확인하기 위해 Internet Explorer와 같은 클라이언트가 디지털 인증서를 확인합니다. 또한 인증서는 사용자 권한 및 인증에 대한 보안 자격 증명으로 사용될 수도 있습니다.
  
**Microsoft Secure Sockets 라이브러리란 무엇입니까?**    
Microsoft SSL(Secure Sockets Layer) 라이브러리에는 많은 보안 통신 프로토콜에 대한 지원 기능이 포함되어 있습니다. 여기에는 TLS 1.0(Transport Layer Security 1.0), SSL 3.0(Secure Sockets Layer 3.0) 및 오래되고 별로 사용되지 않는 SSL 2.0(Secure Sockets Layer 2.0) 및 PCT 1.0(Private Communication Technology 1.0) 프로토콜이 포함됩니다.
  
이러한 프로토콜은 서버와 클라이언트 시스템 사이에 암호화된 연결을 제공합니다. SSL은 인터넷과 같은 공용 네트워크를 통해 사용자들이 보내는 정보를 보호합니다. SSL 지원을 위해서는 SSL 인증서가 서버에 설치되어 있어야 합니다. SSL에 대한 자세한 내용은 [XADM: SSL(Secure Sockets Layer) 작동 방법](http://support.microsoft.com/default.aspx?scid=kb;ko-kr;q245152)을 참조하십시오.
...
**SSP(보안 지원 공급자)란 무엇입니까?**    
보안 지원 공급자는 Microsoft RPC(원격 프로시저 호출) 및 보안 제공업체(예: Windows 배포 보안)와 같은 전송 수준 응용 프로그램 간의 공통 인터페이스를 구현하며, 하나 이상의 보안 패키지를 통해 응용 프로그램에 제공됩니다. 각 보안 패키지는 응용 프로그램의 보안 지원 공급자 인터페이스 기능 호출 및 실제 보안 프로토콜 기능 간의 매핑을 지원합니다. 보안 패키지는 Kerberos 인증 및 Microsoft LAN Manager와 같은 보안 프로토콜을 지원합니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
일반적으로 클라이언트 인증을 요구하도록 구성된 서버에서 성공적으로 인증을 받기 위해서는 사용자의 개인 키가 필요합니다. 공격자는 취약점을 이용해 승인된 사용자의 개인 키에 액세스하지 않고도 보호된 서버의 인증을 받아서 승인된 사용자를 가장할 수 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 최종 사용자가 인증에 사용한 실제 인증서의 공개 구성 요소에 액세스해야 합니다. 그런 다음 인증 과정에서 개인 키가 실제로 제시되는지 확인하기 위해 적용되는 SChannel 구성 요소의 유효성 확인을 우회하기 위해 TLS(Transport Layer Security) 패킷을 만듭니다.
  
가장 일반적인 배포에서 클라이언트 인증에 사용되는 인증서는 Windows 클라이언트로 구성된 단일한 목적만을 가집니다. 이러한 인증서는 웹 인증과 같은 단일한 특정 목적을 위해서만 전송됩니다. IIS(인터넷 정보 서비스) 웹 서버로 SSL 연결을 사용하는 경우, 공개 키는 일반 텍스트로 전송되지 않습니다. 하지만 전자 메일에 서명하거나 여러 웹 사이트를 인증하는 경우처럼 단일 인증서를 클라이언트 인증과 다른 목적으로 동시에 사용한 경우, 공개 키가 더욱 광범위하게 배포됩니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
이 취약점은 인증서 기반 인증을 사용하는 웹 서버 등의 서비스에 영향을 미치므로 사용자는 인증 프로세스 동안 인증서의 해당 개인 키를 보유하고 있음을 입증해야 합니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 TLS 핸드셰이크 중에 서버가 키 교환 데이터의 구문을 분석하는 방식을 수정하여 취약점을 제거합니다.
...
Windows2000-kb960225-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-kb960225-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB960225$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/960225">Microsoft 기술 자료 문서 960225</a> 참조</td>
</tr>
<tr class="even">
...
Windowsxp-kb960225-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb960225-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB960225$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/960225">Microsoft 기술 자료 문서 960225</a> 참조</td>
...
Windowsserver2003-kb960225-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB960225-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb960225-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB960225-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB960225$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/960225">Microsoft 기술 자료 문서 960225</a> 참조</td>
...
-   SChannel 스푸핑 취약점(CVE-2009-0085)을 보고해 주신 [Secretaria da Fazenda do Estado do Rio Grande do Sul (영문)](http://www.sefaz.rs.gov.br/)  
-   SChannel 스푸핑 취약점(CVE-2009-0085)을 보고해 주신 [Cia de Processamento de Dados do Estado do Rio Grande do Sul (영문)](http://www.procergs.rs.gov.br/)
