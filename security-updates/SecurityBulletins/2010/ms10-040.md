---
TOCTitle: 'MS10-040'
Title: 'Microsoft 보안 공지 MS10-040 - 중요'
ms:assetid: 'ms10-040'
ms:contentKeyID: 61230301
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-040(v=Security.10)'
---



Microsoft 보안 공지 MS10-040 - 중요
===================================
...
이 보안 업데이트의 심각도는 IIS 6.0, IIS 7.0 및 IIS 7.5에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 인증 유효성 검사를 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**문제점.**[Microsoft 기술 자료 문서 982666](https://support.microsoft.com/kb/982666) 는 고객이 보안 업데이트를 할 때 겪을 수 있는 현재까지 알려진 문제점들을 기술하고 있다. 또한 이 문제들을 해결하기 위한 추천 해결책을 기술하고 있다.
...
|------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Windows Server 2003 서비스 팩 2                                                                      | [IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=0761c207-5465-4f42-b61f-bd02efcef27d&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2003 x64 Edition 서비스 팩 2                                                          | [IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=023572ff-ce5d-4428-a96b-1245db6ff312&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2003 SP2(Itanium 기반 시스템용)                                                       | [IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=f1f3e524-8ac6-4210-a3a8-4ffc58a606ea)<sup>[1]</sup>                | 원격 코드 실행 | 중요        | 없음                      |
| Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2                                               | [IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=01382926-2313-4769-a0a5-262c4f9f18a1&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2                       | [IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=7fb6f2b8-c7a6-4239-99f3-cf3aacf89b0f&displaylang=ko)<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2             | [IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=84a54246-5d9e-49e2-8170-af48b43f984d&displaylang=ko)\*<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2         | [IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=38286e43-89a6-4895-8ff9-69452df38706&displaylang=ko)\*<sup>[1]</sup> | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2 | [IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=8ad19eba-9821-48b4-a942-4ee4f002f913)<sup>[1]</sup>                | 원격 코드 실행 | 중요        | 없음                      |
| Windows 7(32비트 시스템용)                                                                           | [IIS(인터넷 정보 서비스) 7.5](https://www.microsoft.com/download/details.aspx?familyid=588167cb-f62a-4fb8-8a18-ac15dc322495&displaylang=ko)        | 원격 코드 실행 | 중요        | 없음                      |
| Windows 7(x64 기반 시스템용)                                                                         | [IIS(인터넷 정보 서비스) 7.5](https://www.microsoft.com/download/details.aspx?familyid=1c45d0c8-1629-470b-8167-c6bf66054595&displaylang=ko)        | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008 R2(x64 기반 시스템용)                                                            | [IIS(인터넷 정보 서비스) 7.5](https://www.microsoft.com/download/details.aspx?familyid=5d9b7705-6280-4d2e-94fa-3160b3ce5cfa&displaylang=ko)\*      | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008 R2(Itanium 기반 시스템용)                                                        | [IIS(인터넷 정보 서비스) 7.5](https://www.microsoft.com/download/details.aspx?familyid=869e900a-0063-4d8b-9b7c-7d12f6be12cd)                       | 원격 코드 실행 | 중요        | 없음                      |
...
<sup>[1]</sup>이 운영 체제는 인증에 대한 확장된 보호가 설치된 경우에만 영향을 받습니다. [Microsoft 기술 자료 문서 973917](https://support.microsoft.com/kb/973917)을 참조하십시오. 자세한 내용은 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**의 항목을 참조하십시오.

**영향을 받지 않는 소프트웨어**

| 운영 체제                                        | 구성 요소                   |
|--------------------------------------------------|-----------------------------|
| Microsoft Windows 2000 서비스 팩 4               | IIS(인터넷 정보 서비스) 5.0 |
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3 | IIS(인터넷 정보 서비스) 5.1 |
| Windows XP Professional x64 Edition 서비스 팩 2  | IIS(인터넷 정보 서비스) 6.0 |
...
이 취약점은 Windows 7 및 Windows Server 2008 R2 시스템에 영향을 줍니다. 또한 인증에 대한 확장된 보호를 구현하는 비보안 업데이트 [KB973917](https://support.microsoft.com/kb/973917)을 설치한 Windows Server 2003, Windows Vista 및 Windows Server 2008 시스템에도 영향을 줍니다.

**KB973917을 설치하지 않은 컴퓨터는 이 문제점에 취약합니까?**  
KB973917을 설치하지 않은 지원 대상인 Windows Server 2003, Windows Vista 및 Windows Server 2008 에디션을 실행하는 시스템은 이 문제점에 취약하지 않습니다. 지원 대상인 Windows 7 및 Windows Server 2008 R2 에디션을 실행하는 시스템은 이 문제점에 취약합니다.

**KB973917을 설치하지 않아도 이 보안 업데이트가 제공됩니까?**  
KB973917 업데이트를 설치하지 않은 시스템은 이 보안 취약점의 영향을 받지 않으므로 이 업데이트가 제공되지 않습니다.
...
<th style="border:1px solid black;" >IIS 인증 메모리 손상 취약점 - CVE-2010-1256</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 IIS(인터넷 정보 서비스) 6.0</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 IIS(인터넷 정보 서비스) 6.0</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 SP2(Itanium 기반 시스템용)의 IIS(인터넷 정보 서비스) 6.0</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 IIS(인터넷 정보 서비스) 7.0</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 IIS(인터넷 정보 서비스) 7.0</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2의 IIS(인터넷 정보 서비스) 7.0*</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 IIS(인터넷 정보 서비스) 7.0*</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2의 IIS(인터넷 정보 서비스) 7.0</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows 7(32비트 시스템용)의 IIS(인터넷 정보 서비스) 7.5</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 7(x64 기반 시스템용)의 IIS(인터넷 정보 서비스) 7.5</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2(x64 기반 시스템용)의 IIS(인터넷 정보 서비스) 7.5*</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2(Itanium 기반 시스템용)의 IIS(인터넷 정보 서비스) 7.5</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
...
IIS(인터넷 정보 서비스)에 원격 코드 실행 취약점이 존재합니다. 이 취약점은 인증 정보를 올바르게 구문 분석하지 못해 발생합니다. 이 취약점 악용에 성공한 공격자는 WPI(Worker Process Identity)의 컨텍스트에서 코드를 실행할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1256 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256)을 참조하십시오.
  
#### IIS 인증 메모리 손상 취약점(CVE-2010-1256)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   KB973917을 설치하지 않은 Windows Server 2003, Windows Vista 및 Windows Server 2008 시스템은 인증에 대한 확장된 보호 기능이 없으며 취약하지 않습니다.  
-   영향을 받는 모든 플랫폼에서 인증에 대한 확장된 보호는 기본적으로 사용되지 않습니다. 이것은 KB973917을 설치한 경우에도 마찬가지입니다. 시스템은 이 기능을 사용하는 경우에만 영향을 받습니다.
  
#### IIS 인증 메모리 손상 취약점(CVE-2010-1256)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **토큰 검사 요구**
  
    [Microsoft 기술 자료 문서 973917](https://support.microsoft.com/kb/973917)에 설명되어 있는 것처럼, 확장된 보호를 사용하여 토큰 검사를 '요구'하도록 IIS(인터넷 정보 서비스)가 구성되어 있는 시스템은 이 취약점에 노출되지 않습니다.
  
    **대안의 영향.** 이 구성을 변경하면 확장된 보호를 구현하지 않는 클라이언트의 인증을 허용하지 않습니다.
  
#### IIS 인증 메모리 손상 취약점(CVE-2010-1256)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점 악용에 성공한 원격 인증된 공격자는 IIS 서버에서 WPI(Worker Process Identity)와 동일한 권한으로 작업을 수행할 수 있습니다. Windows Server 2003, Windows Vista 및 Windows Server 2008에서는 이 ID가 기본적으로 네트워크 서비스 계정이 되도록 구성되고, Windows 7 및 Windows Server 2008 R2에서는 이 ID가 가상 응용 프로그램 풀 ID가 되도록 구성됩니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 IIS(인터넷 정보 서비스) 웹 서버가 클라이언트로부터 받은 특정 인증 정보를 구문 분석할 때 메모리를 올바르게 할당하지 못해 발생합니다.
  
**이 취약점의 영향을 받는 구성 요소는 무엇입니까?**    
이 취약점은 인증에 대한 확장된 보호만 사용하여 인증 요청을 지원하도록 구성되어 있는 IIS(인터넷 정보 서비스) 웹 서버에 영향을 미칩니다. 이 구성 요소가 취약해지려면 확장된 보호 기능을 기본 상태와 다르게 토큰 검사를 허용하도록 구성해야 합니다.
  
**인증에 대한 확장된 보호란 무엇입니까?**    
인증에 대한 확장된 보호를 사용하면 공격자가 클라이언트의 자격 증명을 가로채 서버에 전달하는 방식인 MITM(Man-in-the-Middle) 공격을 방지할 수 있습니다. 인증에 대한 확장된 보호는 비보안 업데이트로 배포되고 있으므로 이 추가 보호 기능을 제공하려면 관리자와 사용자가 직접 설치해야 합니다.
  
확장된 보호는 Windows Server 2003, Windows Vista 및 Windows Server 2008에서 비보안 업데이트로 사용할 수 있습니다([Microsoft 기술 자료 문서 973917](https://support.microsoft.com/kb/973917) 참조). Windows 7 및 Windows Server 2008 R2에서는 이 기능이 운영 체제의 선택적 구성 요소이며, IIS(인터넷 정보 서비스) 웹 서버에 대한 Windows 인증 역할 서비스를 설치할 경우 사용하도록 설정됩니다.
  
**인증에 대한 확장된 보호를 사용하고 있는지 어떻게 확인할 수 있습니까?**    
인증에 대한 확장된 보호는 다양한 방법으로 구성할 수 있습니다. 이러한 구성 방법을 통해 이 기능이 존재하는지 확인할 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 973917](https://support.microsoft.com/kb/973917)을 참조하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점 악용에 성공한 원격 인증된 공격자는 IIS 서버에서 WPI(Worker Process Identity)와 동일한 권한으로 작업을 수행할 수 있습니다. WPI는 기본적으로 네트워크 서비스 계정 권한으로 구성됩니다. 사용자 권한을 가진 계정을 사용하는 WPI로 응용 프로그램 풀이 구성되어 있는 ASP 페이지가 포함된 IIS 서버는 기본 WPI 설정으로 응용 프로그램 풀이 구성되어 있는 IIS 서버보다 더 심각한 영향을 받습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
클라이언트는 인증에 대한 확장된 보호를 사용하지 않지만 서버는 사용하는 경우 IIS 서버가 인증 시도를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 HTTP 요청을 만들어 이 취약점을 악용할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
인증이 필요한 콘텐츠를 호스팅하고 인증에 대한 확장된 보호를 지원하는 대부분의 웹 서버가 이 취약점의 영향을 받습니다. 시스템은 [Microsoft 기술 자료 문서 973917](https://support.microsoft.com/kb/973917)에 설명되어 있는 대로 확장된 보호 업데이트를 설치한 경우에만 영향을 받습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 IIS가 클라이언트에 의해 전달된 특정 인증 정보의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
WindowsServer2003-KB982666-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB982666-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB982666-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB982666-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB982666$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/982666">Microsoft 기술 자료 문서 982666</a> 참조</td>
</tr>
<tr class="even">
...
-   V1.1(2010년 7월 1일): 요약의 알려진 문제에 보안 업데이트 후 재부팅 시 IIS의 특정한 부분에서 설치 실패하게 되는 것에 대하여 Microsoft 기술 자료 문서 982666으로의 링크가 추가 되었습니다.
