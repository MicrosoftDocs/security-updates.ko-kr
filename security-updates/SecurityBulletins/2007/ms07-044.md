...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/mac/downloads.aspx">Mac용 Microsoft Office 2004</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-036">MS07-036</a></td>
</tr>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3890 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3890)을 참조하십시오.
...
-   [Mac용 Microsoft Office 2004 11.3.5 업데이트 (영문)](http://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1135.xml&secid=4&ssid=33&flgnosysreq=true)가 컴퓨터에 설치되어 있어야 합니다.  
...
Mac용 Microsoft Office 2004 11.3.6 업데이트의 적절한 언어 버전을 [Microsoft Mactopia 웹 사이트 (영문)](http://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1136.xml&secid=4&ssid=35&flgnosysreq=true)에서 다운로드하여 설치하십시오.
...
-   작업공간 메모리 손상 취약점(CVE-2007-3890)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten Eiram
