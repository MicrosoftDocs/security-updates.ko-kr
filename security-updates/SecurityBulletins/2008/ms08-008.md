...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=93b3d0a3-2091-405e-8dd4-10f20dc2be7f&amp;displaylang=ko">Windows 2000 서비스 팩 4</a><br />
(KB943055)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5c331a3a-93e0-42e4-9cd1-4e32ebdda38d&amp;displaylang=ko">Windows XP 서비스 팩 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e0a15967-7184-4194-8edb-81760e440604">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cfa0d5c6-a9b0-4c5c-a651-898e9f900799&amp;displaylang=ko">Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a08e87dc-993b-493b-8af3-be6e98643aeb&amp;displaylang=ko">Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5a88522b-ee30-4deb-878b-598e852fd60e">Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c67ec357-0f86-4f7d-9af0-d63d8b765f44&amp;displaylang=ko">Windows Vista</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9137108f-e80b-46f1-b547-82da8fb058bf&amp;displaylang=ko">Windows Vista x64 Edition</a><br />
(KB943055)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c96420a9-7436-4625-9649-75f1514b0fe3&amp;displaylang=ko">Microsoft Visual Basic 6.0 서비스 팩 6</a><br />
(KB946235)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
이 보안 업데이트의 영향을 받는 유일한 개발 플랫폼은 Visual Basic 6.0입니다. 이 공지는 Visual Basic 6.0 서비스 팩 6을 위한 업데이트 다운로드 링크를 제공합니다. VB6 패키지 및 배포 마법사를 사용하여 oleaut32.dll 파일을 재배포하는 개발자는 이 공지에서 제공하는 Visual Basic 6.0 업데이트를 다운로드하여 해당 응용 프로그램과 함께 설치되는 oleaut32.dll 버전을 업데이트해야 합니다. 공유 구성 요소 사용에 대한 모범 사례를 따르도록 개발자에게 권장합니다. 공유 구성 요소 사용의 최선책에 대한 자세한 내용은 [Microsoft 기술 자료 문서 835322](https://support.microsoft.com/kb/835322)에서 격리된 응용 프로그램을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-0065 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0065)를 참조하십시오.
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역 보안 수준을 높음으로 설정합니다. 인터넷 영역의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
...
-   **Internet Explorer에서 Microsoft Forms 2.0 Image ActiveX 컨트롤 인스턴스화 시도를 사용 안 함**
    ...
    **참고** 레지스트리를 편집하기 전에 백업해 두는 것이 좋습니다.
    ...
    -   [Windows 2000 그룹 정책 (영문)](https://technet.microsoft.com/ko-kr/library/bb742376.aspx)  
...
예. 기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 악의적인 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](https://go.microsoft.com/fwlink/?linkid=92055)도 참조하십시오.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고</strong>: 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다. 업데이트를 검색하려면 <a href="https://msdn2.microsoft.com/ko-kr/library/aa384642.aspx">WMI(Windows Management Instrumentation) (영문)</a>를 사용합니다.</td>
</tr>
</tbody>
</table>
...
Microsoft Office 2004 for Mac 11.4.0 업데이트의 해당 언어 버전을 [Microsoft Mactopia 웹 사이트 (영문)](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1138.xml&secid=4&ssid=35&flgnosysreq=true)에서 다운로드하여 설치하십시오.
...
-   OLE 힙 오버런 취약점(CVE-2007-0065)을 보고해 주신 [IBM ISS X-Force (영문)](https://www.iss.net/)의 Ryan Smith 및 Alex Wheeler
