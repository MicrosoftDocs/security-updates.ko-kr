---
TOCTitle: 'MS09-027'
Title: 'Microsoft 보안 공지 MS09-027 - 긴급'
ms:assetid: 'ms09-027'
ms:contentKeyID: 61230213
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-027(v=Security.10)'
---


Microsoft 보안 공지 MS09-027 - 긴급
===================================

Microsoft Office Word의 취약점으로 인한 원격 코드 실행 문제점 (969514)
----------------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원되는 모든 Microsoft Office Word 2000 에디션에 대해 긴급입니다. 또한 지원되는 모든 Microsoft Office Word 2002, Microsoft Office Word 2003, Microsoft Office Word 2007, Microsoft Office 2004 for Mac, 및 Microsoft Office 2008 for Mac 에디션, 지원되는 모든 Open XML File Format Converter for Mac 버전, Microsoft Office 호환 기능 팩 및 Microsoft Office Word Viewer에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

업데이트는 Word에서 파일을 열고 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 고객은 업데이트를 즉시 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969514](https://support.microsoft.com/kb/969514)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473&displaylang=ko)  
(KB969604)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473&displaylang=ko)  
(KB969604)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a&displaylang=ko)  
(KB969613)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a&displaylang=ko)  
(KB969613)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969514](https://support.microsoft.com/kb/969514)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.

**MS09-017과 MS09-021에서도 Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac의 취약점을 설명합니다. MS09-017과 MS09-021은 이 공지(MS09-027)와 어떤 관련이 있습니까?**  
Microsoft Office 2004 for Mac(KB969661), Microsoft Office 2008 for Mac(KB971822) 및 Open XML File Format Converter for Mac (KB971824)에 대한 이 공지(MS09-027)의 보안 업데이트 패키지는 [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) 및 [MS09-021](https://technet.microsoft.com/security/bulletin/ms09-021)에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 또는 Open XML File Format Converter for Mac이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다.
...
<th style="border:1px solid black;" >
Word 버퍼 오버플로 취약점(CVE-2009-0563)
</th>
<th style="border:1px solid black;" >
Word 버퍼 오버플로 취약점(CVE-2009-0565)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office Word 2007 서비스 팩 1 및 Microsoft Office Word 2007 서비스 팩 2
</td>
<td style="border:1px solid black;">
**중요**  
원격 코드 실행
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0563 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563)을 참조하십시오.

#### Word 버퍼 오버플로 취약점(CVE-2009-0563)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 Office 파일을 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 Office 파일을 열도록 유도해야 합니다.
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 메일 메시지를 통한 공격에 성공하려면 메일로 보낸 첨부 파일을 사용자가 열어야 합니다.
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

#### Word 버퍼 오버플로 취약점(CVE-2009-0563)에 대한 대안
...
#### Word 버퍼 오버플로 취약점(CVE-2009-0563)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0565 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565)를 참조하십시오.

#### Word 버퍼 오버플로 취약점(CVE-2009-0565)에 대한 완화 요소
...
#### Word 버퍼 오버플로 취약점(CVE-2009-0565)에 대한 대안
...
#### Word 버퍼 오버플로 취약점(CVE-2009-0565)에 대한 FAQ
...
| Microsoft Office Word 2007 서비스 팩 1 및 Microsoft Office Word 2007 서비스 팩 2                                                                                         | 예       |
| Microsoft Office 2004 for Mac                                                                                                                                            | 아니요   |
| Microsoft Office 2008 for Mac                                                                                                                                            | 아니요   |
| Open XML File Format Converter for Mac                                                                                                                                   | 아니요   |
| Microsoft Office Word Viewer 2003 서비스 팩 3                                                                                                                            | 예       |
...
| Microsoft Office Word 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2                                                                                        | 아니요  | 아니요               | 예                  | 예                         |
...
| Microsoft Office Word Viewer 2003 서비스 팩 3                                                                                                                            | 예      | 예                   | 예                  | 예                         |
| Microsoft Office Word Viewer                                                                                                                                             | 예      | 예                   | 예                  | 예                         |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969600">Microsoft 기술 자료 문서 969600</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969602">Microsoft 기술 자료 문서 969602</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Word 2003(모든 에디션), Word Viewer 2003 및 Word Viewer
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
<a href="https://support.microsoft.com/kb/969603">Microsoft 기술 자료 문서 969603</a> 참조<br />
<br />
Word Viewer 2003 및 Word Viewer:<br />
<a href="https://support.microsoft.com/kb/969614">Microsoft 기술 자료 문서 969614</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Word 2007(모든 에디션) 및 Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2007:<br />
<a href="https://support.microsoft.com/kb/969604">Microsoft 기술 자료 문서 969604</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="https://support.microsoft.com/kb/969613">Microsoft 기술 자료 문서 969613</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word 버퍼 오버플로 취약점(CVE-2009-0563)을 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [team509 (영문)](https://www.team509.com/)의 Wushi  
-   Word 버퍼 오버플로 취약점(CVE-2009-0565)을 보고해 주신 [VUPEN Security (영문)](https://www.vupen.com/)의 Nicolas Joly
