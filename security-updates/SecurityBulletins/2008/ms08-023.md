---
TOCTitle: 'MS08-023'
Title: 'Microsoft 보안 공지 MS08-023 - 긴급'
ms:assetid: 'ms08-023'
ms:contentKeyID: 61230131
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-023(v=Security.10)'
---

Microsoft 보안 공지 MS08-023 - 긴급
===================================

ActiveX 킬(Kill) 비트 보안 업데이트(948881)
-------------------------------------------
...
이 보안 업데이트는 Microsoft 제품에 대해 비공개적으로 보고된 취약점 1건을 해결합니다. 이 업데이트에는 Yahoo! Music Jukebox 제품에 대한 킬(kill) 비트도 포함되어 있습니다. 이 취약점은 사용자가 Internet Explorer를 사용하여 특수하게 조작된 웹 페이지를 볼 경우 원격 코드 실행을 허용할 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 보안 업데이트는 Microsoft Windows 2000 서비스 팩 4의 Internet Explorer 5.01 서비스 팩 4, Microsoft Windows 2000 서비스 팩 4에 설치된 Internet Explorer 6 서비스 팩 1, Windows XP 서비스 팩 2, Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2에 대해 긴급입니다.

이 보안 업데이트는 Windows Vista 및 Windows Vista 서비스 팩 1, Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1에 대해 중요입니다.

이 보안 업데이트는 지원되는 모든 Windows Server 2003 에디션에 대해 보통입니다.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Microsoft Windows 2000 서비스 팩 4                                                                                                                                                                     | [Microsoft Internet Explorer 5.01 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=0395451f-b719-4f71-a7b4-403d0c7e8fcc&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Microsoft Windows 2000 서비스 팩 4                                                                                                                                                                     | [Microsoft Internet Explorer 6 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=ba6d3aeb-e35a-47cc-bace-7bd9d58a9d3f&displaylang=ko)    | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9dbf002f-fe53-4cc7-a430-35f45c520d10&displaylang=ko)                                                                 |                                                                                                                                                              | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=01400970-df68-4daf-aa39-2fc4f969974c&displaylang=ko) |                                                                                                                                                              | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ad384fea-53be-4be3-8acb-1cd23a7f5405&displaylang=ko)                     |                                                                                                                                                              | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ffc5c893-cb24-4875-b0a7-6d5c7aa4d642&displaylang=ko)         |                                                                                                                                                              | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=94cf78d3-b6c3-41bc-993e-3af3be0d70f1)      |                                                                                                                                                              | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d7f14001-7f42-4ca0-9193-cdf061179b59&displaylang=ko)                                             |                                                                                                                                                              | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d33462b6-7391-482d-babe-fb4cd0beaa21&displaylang=ko)                     |                                                                                                                                                              | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=95691924-2813-4a86-9e11-99d853f8e606&displaylang=ko)                                                   |                                                                                                                                                              | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=920ae29b-19d0-4089-ac79-f2da824a2256&displaylang=ko)                                                 |                                                                                                                                                              | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=66df79ac-8364-4922-9688-ebc7ec76d89f)                                                            |                                                                                                                                                              | 원격 코드 실행 | 낮음        | 없음                      |
...
**영향을 받는 구성 요소가 설치되어 있지 않아도 이 업데이트를 설치해야 합니까?**    
...
<th style="border:1px solid black;" >ActiveX 개체 메모리 손상 취약점 - CVE-2008-1086</th>
...
ActiveX 개체 메모리 손상 취약점 - CVE-2008-1086  
-----------------------------------------------
  

ActiveX 컨트롤 hxvz.dll에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 취약점 악용을 시도할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1086 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1086)을 참조하십시오.
  
#### ActiveX 개체 메모리 손상 취약점(CVE-2008-1086)에 대한 완화 요소
...
#### ActiveX 개체 메모리 손상 취약점 - CVE-2008-1086에 대한 대안
...
-   **Internet Explorer에서 COM 개체가 실행되지 않도록 설정합니다.**
    ...
    **참고** ActiveX 개체가 포함된 클래스 식별자 및 해당 파일은 "ActiveX 개체 메모리 손상 취약점(CVE-2008-1086)에 대한 FAQ" 섹션의 "업데이트는 어떤 기능을 수행합니까?"에 나와 있습니다. 아래 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}를 해당 섹션에 나와 있는 클래스 식별자로 바꾸십시오.
...
#### ActiveX 개체 메모리 손상 취약점(CVE-2008-1086)에 대한 FAQ
...
-   Yahoo!는 Yahoo! Music Jukebo의 취약점을 해결하는 [보안 공지 (영문)](https://help.yahoo.com/l/us/yahoo/music/jukebox/troubleshoot/securityupdate.html) 및 업데이트를 출시했습니다. 자세한 정보 및 다운로드 위치는 [Yahoo! (영문)](https://help.yahoo.com/l/us/yahoo/music/jukebox/troubleshoot/securityupdate.html)의 보안 공지를 참조하십시오. 이 킬(Kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
...
IE5.01sp4-KB948881-Windows2000sp4-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB948881-Windows2000-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
IE5.01sp4-KB948881-Windows2000sp4-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB948881-Windows2000-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB948881-IE501SP4-20080313.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB948881-IE6SP1-20080313.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
...
Windowsxp-kb948881-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB948881-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2:<br />
Windowsxp-kb948881-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB948881-x64-kor / norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2, Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
KB948881.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">추가 정보</td>
...
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2, Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB948881$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2;<br />
...
Windowsserver2003-kb948881-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Windowsserver2003-kb948881-ia64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows Server 2003:<br />
Windowsserver2003-kb948881-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용):<br />
Windowsserver2003-kb948881-ia64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션 및 Itanium 기반 에디션:<br />
...
-   ActiveX 개체 메모리 손상 취약점(CVE-2008-1086)을 보고해 주신 [iDefense VCP (영문)](https://labs.idefense.com/)의 익명 연구자
...
-   V1.1 (2008년 4월 17일): Windows XP(모든 에디션)용 제거 유틸리티 경로가 수정되었습니다.  
-   V1.2 (2008년 4월 24일): 지원되는 모든 Windows Server 2003 x64 기반 에디션의 확인용 레지스트리 키가 수정되었습니다.
