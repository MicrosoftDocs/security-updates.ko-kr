---
TOCTitle: 'MS09-041'
Title: 'Microsoft 보안 공지 MS09-041 - 중요'
ms:assetid: 'ms09-041'
ms:contentKeyID: 61230227
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-041(v=Security.10)'
---


Microsoft 보안 공지 MS09-041 - 중요
===================================

Workstation 서비스의 취약점으로 인한 권한 상승 문제점 (971657)
--------------------------------------------------------------

게시된 날짜: 2009년 8월 12일 수요일
...
이 보안 업데이트는 Workstation 서비스가 메모리를 할당하고 사용 가능하게 해제하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=9c0e5bff-c248-4e87-a83b-82ba52f5299d&displaylang=ko)                                                          | 권한 상승      | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7b64a454-d383-47e3-b469-b87e2b3c1a9f)                                                                          | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9cb0477f-0656-47f5-bd35-5716e0572fbd&displaylang=ko)                                                                           | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=96fbf65f-1db2-432d-92a0-6669d8abaeb0&displaylang=ko)                                                               | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=11321f48-8997-4b99-982a-3ba4ad3f5992)                                                                           | 권한 상승      | 중요        | 없음                      |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=979ac9da-940f-49e7-91a2-b12db3708076&displaylang=ko)                                     | 서비스 거부    | 보통        | 없음                      |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b9aa04cc-a5c5-47ae-bf0f-250cff275d26&displaylang=ko) | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=24c77c27-0b7d-4a35-a871-b453f90e5913&displaylang=ko)\*                | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=48d0432e-704a-4bbb-b0a1-cd14069a8e93&displaylang=ko)\*            | 서비스 거부    | 보통        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c119223c-f4e0-449b-8e7b-a6bf11c98f94)                     | 서비스 거부    | 보통        | 없음                      |
...
<th style="border:1px solid black;" >Workstation 서비스 메모리 손상 취약점(CVE-2009-1544)</th>
...
Windows Workstation 서비스에는 서비스에서 발생하는 "Double Free" 조건 때문에 권한 상승 취약점이 발생합니다. 이 취약점 악용에 성공한 공격자는 상승된 권한을 사용하여 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1544 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1544)를 참조하십시오.
  
#### Workstation 서비스 메모리 손상 취약점(CVE-2009-1544)에 대한 완화 요소
...
-   공격자가 이 취약점을 악용하려면 취약한 시스템에 대한 유효한 로그온 자격 증명이 필요합니다. 익명 사용자는 이 취약점을 악용할 수 없습니다.
  
#### Workstation 서비스 메모리 손상 취약점(CVE-2009-1544)에 대한 대안
...
#### Workstation 서비스 메모리 손상 취약점(CVE-2009-1544)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows Workstation 서비스가 특수하게 조작된 RPC 메시지를 수신할 때 메모리를 제대로 할당하고 사용 가능하게 해제하지 못합니다.
  
**Workstation 서비스란 무엇입니까?**    
Workstation 서비스는 원격 파일 및 네트워크 인쇄 리소스 요청의 라우팅을 지원하는 Windows 구성 요소입니다. 로컬 파일 시스템 요청과 원격 파일 또는 인쇄 네트워크 요청은 모두 워크스테이션을 통해 라우팅됩니다. 이 서비스는 리소스의 위치를 파악한 다음 요청을 로컬 파일 시스템이나 네트워킹 구성 요소로 라우팅합니다. 워크스테이션 서비스가 중지되면 모든 요청은 로컬 요청으로 간주됩니다.
...
Microsoft RPC(원격 프로시저 호출)는 다른 프로세스에 있는 데이터의 교환 및 기능의 호출을 가능하게 하는 IPC(프로세스 간 통신) 메커니즘입니다. 이 프로세스는 동일한 컴퓨터에, LAN(Local Area Network)에 또는 인터넷상에 있을 수 있습니다. Microsoft RPC 메커니즘은 명명된 파이프, NetBIOS 또는 Winsock 등의 다른 IPC 메커니즘을 사용하여 클라이언트와 서버 간에 통신을 설정합니다. RPC를 사용할 경우 필수적인 프로그램 로직 및 관련 프로시저 코드가 여러 컴퓨터에 분산되어 있을 수 있으며, 이러한 기능은 분산 응용 프로그램에서 아주 중요합니다. 자세한 내용은 TechNet 문서 RPC란 무엇입니까?(영문)를 참조하십시오.
  
**이 공격이 성공하지 못하도록 Workstation 서비스를 비활성화할 수 있습니까?**    
이 취약점의 해결 방안으로 Workstation 서비스를 비활성화하는 것은 권장되지 않습니다. 워크스테이션 서비스를 해제하면 시스템에서는 네트워크의 모든 공유 파일 리소스나 공유 인쇄 리소스에 연결할 수 없습니다. 따라서 이 대안은 대부분의 홈 시스템 같이 네트워크에 연결하지 않는 독립 실행형 시스템에만 사용해야 합니다. 워크스테이션 서비스가 해제되면 명시적으로 워크스테이션 서비스를 사용하는 모든 서비스가 시작되지 않으며 시스템 이벤트 로그에 오류 메시지가 기록됩니다. 워크스테이션 서비스를 사용하는 서비스는 다음과 같습니다.
...
**참고:** Workstation 서비스가 비활성화될 경우 Microsoft Baseline Security Analyzer는 작동하지 않습니다.
...
공격자는 특수하게 조작한 RPC 메시지를 조작한 다음, 영향을 받는 시스템에 해당 메시지를 보내는 방법으로 취약점을 악용할 수 있습니다. 그러면 이 메시지는 인증된 클라이언트가 임의 데이터를 Workstation 서비스 주소 공간의 메모리에 쓸 수 있도록 합니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
Workstation 서비스가 활성화된 모든 시스템은 취약한 상태가 됩니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Workstation 서비스가 메모리를 할당하고 사용 가능하게 해제하는 방식을 수정하여 이 취약점을 해결합니다.
...
Windowsxp-kb971657-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb971657-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB971657$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971657">Microsoft 기술 자료 문서 971657</a> 참조</td>
</tr>
<tr class="even">
...
Windowsserver2003-kb971657-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB971657-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb971657-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB971657-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   Workstation 서비스 메모리 손상 취약점(CVE-2009-1544)을 보고해 주신 [TippingPoint DVLabs (영문)](https://dvlabs.tippingpoint.com/)의 Cody Pierce
