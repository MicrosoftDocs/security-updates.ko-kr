...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 961371](http://support.microsoft.com/kb/961371)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=1efbbd95-cd72-43df-b1ce-7e2b0c0cb9e2&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS06-002](http://technet.microsoft.com/security/bulletin/ms06-002) |
| [Windows XP 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b&displaylang=ko)                                                                                    | 원격 코드 실행 | 긴급        | [MS06-002](http://technet.microsoft.com/security/bulletin/ms06-002) |
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b&displaylang=ko)                                                                                    | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b8b019e-e6d8-4ce2-8f1f-3a6399b252d1)                                                                          | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=018ef53d-f78e-4084-940d-7c86bf59d83c&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f5fc902-f5d8-4a87-a73f-68632f9a0935&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=7df0fce2-543c-4e82-85e6-012bfc8bf130)                                                                           | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c67d85c4-25c5-4821-8db9-91764888f893&displaylang=ko)                                     | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f8ae651-59f7-48e1-9e8c-8e07c6806964&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=91f6ee68-0e39-4ec3-b4cd-45f05404e2fb&displaylang=ko)\*                | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cdc3014-97b3-47b5-a6b7-cd0e12ec60e4&displaylang=ko)\*            | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=03330a14-9cfa-4146-a3d3-4b7a76975d2d)                     | 원격 코드 실행 | 긴급        | 없음                                                                |
...
이 알려진 문제점에 대한 자세한 내용은 [Microsoft 기술 자료 문서 961371](http://support.microsoft.com/kb/961371)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0231 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231)을 참조하십시오.
...
EOT(Embedded OpenType) 글꼴은 웹 페이지에 사용하도록 설계된 압축 형태의 글꼴로, 문서에 포함될 수 있습니다. EOT 글꼴을 사용할 경우 사용자는 작성자가 의도한 대로 정확히 문서를 보게 됩니다. 웹 작성자는 WEFT(Web Embedding Fonts Tool)를 사용하여 브라우저를 통해 본 페이지가 글꼴 개체에 포함된 스타일로 표시되도록 웹 페이지에 연결된 글꼴 개체를 만들 수 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](http://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 플랫폼은 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0232 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0232)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/961371">Microsoft 기술 자료 문서 961371</a> 참조</td>
</tr>
<tr class="even">
...
-   Embedded OpenType 글꼴 힙 오버플로 취약점(CVE-2009-0231)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)  
