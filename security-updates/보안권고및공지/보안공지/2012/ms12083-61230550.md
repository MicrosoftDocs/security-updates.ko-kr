...
[Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f&displaylang=ko)  
(KB2765809)
</td>
<td style="border:1px solid black;">
보안 기능 우회
...
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f&displaylang=ko)  
(KB2765809)
</td>
<td style="border:1px solid black;">
보안 기능 우회
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=d6654bf1-1ab9-4691-8729-793eb6d0e563&displaylang=ko)  
(KB2765809)
</td>
<td style="border:1px solid black;">
보안 기능 우회
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f&displaylang=ko)(Server Core 설치)  
(KB2765809)
</td>
<td style="border:1px solid black;">
보안 기능 우회
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f&displaylang=ko)(Server Core 설치)  
(KB2765809)
</td>
<td style="border:1px solid black;">
보안 기능 우회
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=d6654bf1-1ab9-4691-8729-793eb6d0e563&displaylang=ko)(Server Core 설치)  
(KB2765809)
</td>
<td style="border:1px solid black;">
보안 기능 우회
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549)(영문)를 참조하십시오.
...
-   해지된 클라이언트 인증서와 연결된 도메인 컴퓨터 계정을 사용하지 않습니다.
    ...
    Windows Server 2008 R2 및 Windows Server 2012에서 컴퓨터 계정을 사용하지 않는 방법은 [컴퓨터 계정 사용 안 함 또는 사용](http://technet.microsoft.com/ko-kr/library/cc732965.aspx)을 참조하십시오.

    스크립트를 사용하여 여러 컴퓨터 계정을 사용하지 않는 방법은 [컴퓨터 계정 사용 안 함](http://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c)을 참조하십시오.
...
IP-HTTPS란 무엇입니까?  
IP-HTTPS(IP over HTTPS)는 보안 HTTP 연결을 사용하여 보안 IP 터널을 설정할 수 있는 프로토콜입니다. 일반적으로 Microsoft DirectAccess 배포에서 사용됩니다. 자세한 내용은 [IP-HTTPS(IP over HTTPS) 터널링 프로토콜](http://msdn.microsoft.com/en-us/library/dd358571(v=prot.20).aspx)을 참조하십시오.

DirectAccess란 무엇입니까?  
Windows 7 및 Windows Server 2008 R2 운영 체제에서 도입된 DirectAccess는 원격 사용자가 IP-HTTPS와 같은 보안 프로토콜을 사용하여 엔터프라이즈 공유, 웹 사이트 및 응용 프로그램에 안전하게 액세스할 수 있도록 합니다. 자세한 내용은 [DirectAccess](http://technet.microsoft.com/en-us/network/dd420463.aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2765809">Microsoft 기술 자료 문서 2765809</a> 참조</td>
</tr>
<tr class="odd">
