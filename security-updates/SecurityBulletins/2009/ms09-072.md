---
TOCTitle: 'MS09-072'
Title: 'Microsoft 보안 공지 MS09-072 - 긴급'
ms:assetid: 'ms09-072'
ms:contentKeyID: 61230258
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-072(v=Security.10)'
---

Microsoft 보안 공지 MS09-072 - 긴급
===================================
...
이 보안 업데이트는 Internet Explorer에 대해 비공개적으로 보고된 취약점 4건과 공개된 취약점 1건을 해결합니다. 이 취약점들은 모두 사용자가 Internet Explorer를 사용하여 특수하게 조작된 웹 페이지를 볼 경우 원격 코드 실행을 허용할 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다. Microsoft ATL(액티브 템플릿 라이브러리) 헤더로 작성된 ActiveX 컨트롤이 원격 코드 실행을 허용할 수 있습니다. 이 문제점에 대한 자세한 내용은 이 섹션에서 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**을 참조하십시오.

이 보안 업데이트의 심각도는 지원 대상인 모든 Internet Explorer(Internet Explorer 5.01, Internet Explorer 6, Internet Explorer 6 서비스 팩 1, Internet Explorer 7(지원되는 Windows Server 2003 및 Windows Server 2008 에디션에서 실행되는 경우 제외) 및 Internet Explorer 8(지원되는 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2 에디션에서 실행되는 경우 제외)) 버전에 대해 긴급입니다. 나열된 Windows 서버에서 실행되는 Internet Explorer 7 및 Internet Explorer 8에 대한 이 업데이트의 심각도는 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 컨트롤을 수정하고 Internet Explorer에서 메모리의 개체를 처리하는 방식을 수정하여 이러한 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 977981](http://technet.microsoft.com/security/advisory/977981)에서 처음 설명한 취약점도 해결합니다.
...
**이 보안 업데이트에는 Microsoft 기술 자료 문서 976749에서 해결된 MS09-054에 대해 알려진 문제점을 해결하는 수정 사항이 포함되어 있습니까?**  
예. 이 보안 업데이트(976325)에는 Microsoft 보안 공지 [MS09-054](http://technet.microsoft.com/security/bulletin/ms09-054)의 보안 업데이트 974455에 대해 알려진 문제점을 해결하는 [Microsoft 보안 권고 976749](http://technet.microsoft.com/security/advisory/976749)에 설명되어 있는 수정 사항이 포함되어 있습니다.

**이 보안 공지는 MS09-035에 설명되어 있는 ATL 문제점과 어떤 관련이 있습니까?**  
Microsoft 보안 공지 [MS09-035](http://technet.microsoft.com/security/bulletin/ms09-035)에서는 ATL(액티브 템플릿 라이브러리)의 취약한 공개 버전을 사용하여 개발된 구성 요소와 컨트롤의 취약점에 대해 설명합니다. 이 보안 업데이트(976325)는 [Microsoft 보안 권고 973882](http://technet.microsoft.com/security/advisory/973882) 및 MS09-035에 설명되어 있는 ATL 버전으로 개발된 구성 요소와 컨트롤을 이용하는 Internet Explorer의 알려진 공격 방법을 완화합니다. 다음 섹션 **취약점 정보**에서 ATL COM 초기화 취약점([CVE-2009-2493 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493))을 참조하십시오.

**이 보안 공지는 Microsoft 보안 권고 973882에 설명되어 있는 ATL 문제점과 어떤 관련이 있습니까?**  
[Microsoft 보안 권고 973882](http://technet.microsoft.com/security/advisory/973882)에서는 ATL(액티브 템플릿 라이브러리)의 공개 버전과 비공개 버전의 취약점에 대해 설명합니다. 이 보안 업데이트(976325)는 [Microsoft 보안 권고 973882](http://technet.microsoft.com/security/bulletin/ms09-035) 및 MS09-035에 설명되어 있는 ATL 버전으로 개발된 컨트롤을 업데이트합니다. 다음 섹션 **취약점 정보**에서 ATL COM 초기화 취약점([CVE-2009-2493 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493))을 참조하십시오.
...
예. [MS09-035](http://technet.microsoft.com/security/bulletin/ms09-035)는 Microsoft Visual Studio에서 ATL(액티브 템플릿 라이브러리)을 사용하는 개발자를 위해 특별히 개발된 것입니다. ATL로 작성된 구성 요소와 컨트롤을 재배포하는 개발자는 MS09-035로 제공된 업데이트를 설치하여 이러한 구성 요소와 컨트롤이 해당 보안 공지에 설명되어 있는 취약점을 포함하지 않도록 해야 합니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 976325](http://support.microsoft.com/kb/976325)에 나와 있습니다.
...
<th style="border:1px solid black;" >
초기화되지 않은 메모리 손상 취약점(CVE-2009-3671)
</th>
<th style="border:1px solid black;" >
HTML 개체 메모리 손상 취약점(CVE-2009-3672)
</th>
<th style="border:1px solid black;" >
초기화되지 않은 메모리 손상 취약점(CVE-2009-3673)
</th>
<th style="border:1px solid black;" >
초기화되지 않은 메모리 손상 취약점(CVE-2009-3674)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 취약한 Microsoft ATL(액티브 템플릿 라이브러리) 헤더로 작성된 ActiveX 컨트롤 때문에 발생합니다. 이 컨트롤의 안전하지 않은 사용으로 인해 관련 보안 정책을 우회할 수 있는 임의 개체의 인스턴스화가 허용됩니다.
...
이 취약점의 영향을 받는 구성 요소는 tdc.ocx입니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 표 형식 데이터를 처리하는 컨트롤을 수정하여 취약점을 해결합니다. 이 컨트롤은 이전에 취약한 Microsoft ATL(액티브 템플릿 라이브러리)을 사용하여 작성되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3671 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3671)을 참조하십시오.

#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3671)에 대한 완화 요소
...
#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3671)에 대한 대안
...
#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3671)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3672 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672)를 참조하십시오.

#### HTML 개체 메모리 손상 취약점(CVE-2009-3672)에 대한 완화 요소
...
#### HTML 개체 메모리 손상 취약점(CVE-2009-3672)에 대한 대안
...
-   **자동화된 Microsoft Fix It을 통해 Internet Explorer 6 또는 Internet Explorer 7의 DEP 사용**
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 976325](http://support.microsoft.com/kb/976325)를 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
#### HTML 개체 메모리 손상 취약점(CVE-2009-3672)에 대한 FAQ
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3672 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3673 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3673)을 참조하십시오.

#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3673)에 대한 완화 요소
...
#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3673)에 대한 대안
...
#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3673)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3674 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3674)를 참조하십시오.

#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3674)에 대한 완화 요소
...
#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3674)에 대한 대안
...
#### 초기화되지 않은 메모리 손상 취약점(CVE-2009-3674)에 대한 FAQ
...
IE5.01sp4-KB976325-Windows2000sp4-x86-kor /quiet<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB976325-Windows2000-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
IE5.01sp4-KB976325-Windows2000sp4-x86-kor /norestart<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB976325-Windows2000-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB976325-IE501SP4-20091027.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB976325-IE6SP1-20091027.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/976325">Microsoft 기술 자료 문서 976325</a> 참조</td>
</tr>
<tr class="even">
...
WindowsXP-KB976325-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE7-WindowsXP-KB976325-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE8-WindowsXP-KB976325-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션용 Internet Explorer 6:<br />
WindowsXP-KB976325-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션용 Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션용 Internet Explorer 7:<br />
IE7-WindowsXP-KB976325-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션용 Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션용 Internet Explorer 8:<br />
IE8-WindowsXP-KB976325-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션용 Internet Explorer 8:<br />
...
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 6:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB976325$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 7:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\ie7updates\KB976325-IE7\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 8:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\ie8updates\KB976325-IE8\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/976325">Microsoft 기술 자료 문서 976325</a> 참조</td>
...
WindowsServer2003-KB976325-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB976325-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
IE7-WindowsServer2003-KB976325-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB976325-x64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
IE8-WindowsServer2003-KB976325-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB976325-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 6:<br />
WindowsServer2003-KB976325-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 6:<br />
WindowsServer2003.WindowsXP-KB976325-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션용 Internet Explorer 6:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003-KB976325-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB976325-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션용 Internet Explorer 7:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 8:<br />
IE8-WindowsServer2003-KB976325-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 8:<br />
IE8-WindowsServer2003.WindowsXP-KB976325-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
-   ATL COM 초기화 취약점(CVE-2009-2493)을 보고해 주신 [Verisign IDefense Lab (영문)s](http://labs.idefense.com/)의 Ryan Smith  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-3671)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Sam Thomas(eshu.co.uk)  
-   HTML 개체 메모리 손상 취약점(CVE-2009-3672)을 [Verisign IDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 [team509 (영문)](http://www.team509.com/)  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-3673)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-3674)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
...
-   V1.1(2009년 12월 10일): **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에서 Microsoft 기술 자료 문서 976749에 대한 참조가 수정되었습니다. 또한 **보안 업데이트 배포** 섹션에서 지원 대상인 모든 Windows XP x64 기반 에디션용 Internet Explorer 7의 업데이트 확인을 위한 레지스트리 키가 수정되었습니다.
