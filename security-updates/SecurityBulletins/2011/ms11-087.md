---
TOCTitle: 'MS11-087'
Title: 'Microsoft 보안 공지 MS11-087 - 긴급'
ms:assetid: 'ms11-087'
ms:contentKeyID: 61230454
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-087(v=Security.10)'
---


Microsoft 보안 공지 MS11-087 - 긴급
===================================
...
이 보안 업데이트는 Windows 커널 모드 드라이버가 TrueType 글꼴 파일을 처리하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 2639658](https://technet.microsoft.com/ko-kr/security/advisory/2639658)에서 처음 설명한 취약점도 해결합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa&displaylang=ko)                                                                                     | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6)                                                                           | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69&displaylang=ko)                                                                            | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)                                                                            | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af&displaylang=ko)                                                                                  | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e&displaylang=ko)                                                                      | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25&displaylang=ko)\*\*\*\*                                                   | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416&displaylang=ko)\*\*\*\*                                                 | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)                                                                    | 원격 코드 실행 | 긴급        | [MS11-077](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6&displaylang=ko)                                       | 원격 코드 실행 | 긴급        | [MS11-084](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629&displaylang=ko)                                   | 원격 코드 실행 | 긴급        | [MS11-084](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea&displaylang=ko)\*\*\*\* | 원격 코드 실행 | 긴급        | [MS11-084](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813)                | 원격 코드 실행 | 긴급        | [MS11-084](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
...
Microsoft 보안 권고 2639658에서 제공된 대안을 적용한 경우 이 업데이트를 적용하기 전에 해당 대안의 실행을 취소해야 합니까?  
아니요. 이 보안 업데이트를 설치하기 전에 이전에 적용한 "T2EMBED.DLL 액세스 거부" 대안을 실행 취소할 필요는 없습니다.

그러나 이 대안으로 인해 비활성화된 기능을 복원하기 위해 이 보안 업데이트를 적용한 후에 이전에 대안을 적용했던 시스템에서 "T2EMBED.DLL 액세스 거부" 대안을 실행 취소해야 합니다. 이 대안을 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2639417](https://support.microsoft.com/kb/2639417)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.

파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.

Windows 개발자 미리 보기가 이 문제점의 영향을 받습니까?  
예, Windows 개발자 미리 보기 릴리스에 KB2639417 업데이트가 사용될 수 있습니다. Windows 개발자 미리 보기를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. 이 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서 구할 수 있습니다.

이 업데이트가 Server Core 설치 옵션을 사용하여 설치할 때 더 낮은 심각도로 지원 대상인 Windows Server 2008 및 Windows Server 2008 R2 에디션에 적용되는 이유는 무엇입니까?  
Windows Server 2008 및 Windows Server 2008 R2를 Server Core 설치 옵션을 사용하여 설치하면 CVE-2011-3402에 대한 공격 시나리오인 로컬 권한 상승 문제점에만 취약해지며 웹 기반 및 파일 공유 공격 시나리오는 적용되지 않습니다.
...
<th style="border:1px solid black;" >TrueType 글꼴 구문 분석 취약점(CVE-2011-3402)</th>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008(32비트 시스템용) 서비스 팩 2를 Server Core 설치 옵션을 사용하여 설치할 경우</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2를 Server Core 설치 옵션을 사용하여 설치할 경우</td>
<td style="border:1px solid black;">중요 <br />
권한 상승</td>
<td style="border:1px solid black;">중요</td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1을 Server Core 설치 옵션을 사용하여 설치할 경우</td>
<td style="border:1px solid black;">중요 <br />
권한 상승</td>
<td style="border:1px solid black;">중요</td>
</tr>
...
Windows 커널에 특수하게 조작된 TrueType 글꼴 파일의 부적절한 처리로 인한 원격 코드 실행 취약점이 존재합니다. 이 취약점은 공격자가 커널 모드에서 코드를 실행하고 프로그램을 설치하도록 하며 전체 관리자 권한으로 데이터를 보거나 변경하거나 삭제하고, 새 계정을 만들 수 있도록 합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-3402(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3402)를 참조하십시오.
...
-   T2EMBED.DLL 액세스 거부
    ...
    참고 이 대안은 웹 기반 및 파일 공유 공격 시나리오만 완화합니다. 로컬 공격 시나리오는 이 대안으로 완화되지 않습니다.
...
업데이트는 어떤 기능을 수행합니까?   
이 업데이트는 Windows 커널 모드 드라이버가 TrueType 글꼴 파일을 처리하는 방식을 수정하여 이 취약점을 해결합니다.
  
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?   
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-3402(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3402)가 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2639417$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2639417">Microsoft 기술 자료 문서 2639417</a> 참조</td>
</tr>
<tr class="even">
...
-   TrueType 글꼴 구문 분석 취약점(CVE-2011-3402)을 해결하기 위해 협력해 주신 Symantec 및 Laboratory of Cryptography and System Security(CrySyS)
