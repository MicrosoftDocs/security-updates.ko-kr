...
|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=9787619f-1297-411e-8b9c-3ad3e6a99797&displaylang=ko)             | 권한 상승      | 중요        | 없음                      |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=5f382050-8df6-43aa-82e9-8fad5ff8ecec&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-5350 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5350)을 참조하십시오.
...
<br />
<strong>참고:</strong> 이 패치가 있는지 확인하는 레지스트리 키는 없습니다. 패치를 검색하려면 <a href="http://msdn2.microsoft.com/ko-kr/library/aa384642.aspx">WMI(Windows Management Instrumentation) (영문)</a>를 사용합니다.</td>
</tr>
</tbody>
</table>
...
-   Windows 커널 취약점(CVE-2007-5350)을 보고해 주신 [SkyRecon (영문)](http://www.skyrecon.com/)의 Thomas Garnier
