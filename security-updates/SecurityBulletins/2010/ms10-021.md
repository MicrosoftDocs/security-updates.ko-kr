...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 979683](https://support.microsoft.com/kb/979683)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=c5f4577e-7546-40e9-8bcd-be11c1b260a6&displaylang=ko)                                                             | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=142710fd-9cd4-4dd0-aaba-2aace03c008f&displaylang=ko)                                               | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3c0cb02e-3484-4cdf-8c64-c697ad3e2889)                                                               | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0a7ea2d0-61ce-4b68-ad82-d917b1a56f9d&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1fc66f54-260a-4219-a0b4-056ba9dd0abe&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8dcb8be8-fb78-4518-aa7e-f8b17f7dfb86)                                                                | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=86d7b054-af4f-4d8a-9873-cb5246466374&displaylang=ko)                                                                                  | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=86d7b054-af4f-4d8a-9873-cb5246466374&displaylang=ko)                                         | 서비스 거부    | 보통        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=7c84aa24-6331-427a-969c-27f7d39db3d7&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7c84aa24-6331-427a-969c-27f7d39db3d7&displaylang=ko)                 | 서비스 거부    | 보통        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=25e3ce7f-53a0-4049-a65c-011d2143c4c2&displaylang=ko)\*     | 서비스 거부    | 보통        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8b99e54d-955b-4a06-9a04-b2f4596efd72&displaylang=ko)\* | 서비스 거부    | 보통        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b1f9746d-61a2-406f-b707-60646bd5b5bb)          | 서비스 거부    | 보통        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ff58d80c-33ce-4d9e-aaa5-0b1841458931&displaylang=ko)                                                                     | 서비스 거부    | 보통        | [MS10-015](https://technet.microsoft.com/security/bulletin/ms10-015) |
...
**\*Server Core 설치가 영향을 받습니다.** 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008 및 Windows Server 2008 R2에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 MSDN 문서, [Server Core(영문)](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) 및 [Windows Server 2008 R2용 Server Core(영문)](https://msdn.microsoft.com/en-us/library/ee391631(vs.85).aspx)를 참조하십시오. Server Core 설치 옵션은 Windows Server 2008 및 Windows Server 2008 R2의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교](https://www.microsoft.com/windowsserver2008/ko/kr/compare-core-installation.aspx)를 참조하십시오
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0234 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0234)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0235 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0235)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0236 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0236)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0237 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0237)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0238 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0238)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0481 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0481)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0482 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0482)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0810 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0810)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 979683](https://support.microsoft.com/kb/979683) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/979683">Microsoft 기술 자료 문서 979683</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 커널 Null 포인터 취약점(CVE-2010-0234)을 보고해 주신 [Hispasec (영문)](https://www.hispasec.com/), [Virustotal (영문)](https://www.virustotal.com/)의 Matthew 'j00ru' Jurczyk 및 Gynvael Coldwind  
-   Windows 커널 심볼 링크 값 취약점(CVE-2010-0235)을 보고해 주신 [Hispasec (영문)](https://www.hispasec.com/), [Virustotal (영문)](https://www.virustotal.com/)의 Matthew 'j00ru' Jurczyk 및 Gynvael Coldwind  
-   Windows 커널 메모리 할당 취약점(CVE-2010-0236)을 보고해 주신 [Hispasec (영문)](https://www.hispasec.com/), [Virustotal (영문)](https://www.virustotal.com/)의 Matthew 'j00ru' Jurczyk 및 Gynvael Coldwind  
-   Windows 커널 심볼 링크 작성 취약점(CVE-2010-0237)을 보고해 주신 [Hispasec (영문)](https://www.hispasec.com/), [Virustotal (영문)](https://www.virustotal.com/)의 Gynvael Coldwind 및 Matthew 'j00ru' Jurczyk  
-   Windows 커널 레지스트리 키 취약점(CVE-2010-0238)을 보고해 주신 [Hispasec (영문)](https://www.hispasec.com/), [Virustotal (영문)](https://www.virustotal.com/)의 Matthew 'j00ru' Jurczyk 및 Gynvael Coldwind  
-   Windows 가상 경로 구분 분석 취약점(CVE-2010-0481)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy  
-   Windows 커널 조작된 이미지 취약점(CVE-2010-0482)을 보고해 주신 [Obsidium Software (영문)](https://www.obsidium.de/)의 Martin Tofall  
-   Windows 커널 예외 처리기 취약점(CVE-2010-0810)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy
