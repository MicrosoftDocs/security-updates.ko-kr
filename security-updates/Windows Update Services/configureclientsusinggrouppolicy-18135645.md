...
ms:contentKeyID: 18135645
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc708574(v=WS.10)'
---
...
| ![](images/Cc708574.note(WS.10).gif)참고                                                            |
|----------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc708574.Important(WS.10).gif)중요                                                                                                                                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
