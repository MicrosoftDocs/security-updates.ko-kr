...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=a1db7736-f3e4-45df-af1d-52746978a0a8&displaylang=ko)                                                                               | 권한 상승      | 중요        | [MS08-066](http://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=71497891-41a2-476d-b524-4eb5cecb9639)                                                                     | 권한 상승      | 중요        | [MS08-066](http://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c614cb8b-223e-4f84-b94c-f15747760aa5&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS08-066](http://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9a951087-25c5-4f5c-8407-a1585491ae0b&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS08-066](http://technet.microsoft.com/security/bulletin/ms08-066) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=dd48b93b-24fa-45a3-91fb-9f9f9418c49f)                                                                 | 권한 상승      | 중요        | [MS08-066](http://technet.microsoft.com/security/bulletin/ms08-066) |
...
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e)                                                                                          | 권한 상승      | 중요        | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
...
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9&displaylang=ko)                             | 권한 상승      | 중요        | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
...
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
...
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441)          | 권한 상승      | 중요        | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1249 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)를 참조하십시오.
...
TDI(Transport Driver Interface)는 모든 전송 프로토콜 스택의 위쪽에 노출되는 커널 모드 네트워크 인터페이스를 의미합니다. 이런 모든 스택에서 맨 위에 있는 프로토콜은 고속 커널 모드 네트워크 클라이언트를 위해 TDI 인터페이스를 지원합니다. TDI 구성 요소에 대한 자세한 내용은 MSDN 문서, [Transport Driver Interface (영문)](http://msdn.microsoft.com/en-us/library/ff565685.aspx)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-1249 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)가 지정되었습니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-1249 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)가 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2503665">Microsoft 기술 자료 문서 2503665</a> 참조</td>
</tr>
<tr class="even">
...
-   Ancillary Function Driver 권한 상승 취약점(CVE-2011-1249)을 보고해 주신 [Shadowserver Foundation (영문)](http://www.shadowserver.org)의 Steven Adair와 Chris S.
