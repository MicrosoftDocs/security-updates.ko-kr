---
TOCTitle: 'MS08-009'
Title: 'Microsoft 보안 공지 MS08-009 - 긴급'
ms:assetid: 'ms08-009'
ms:contentKeyID: 61230117
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-009(v=Security.10)'
---

Microsoft 보안 공지 MS08-009 - 긴급
===================================

Microsoft Word의 취약점으로 인한 원격 코드 실행 문제점(947077)
--------------------------------------------------------------
...
이 긴급 보안 업데이트는 비공개적으로 보고된 취약점 1건을 해결합니다. 사용자가 특수하게 조작된 Word 파일을 열면 이 Microsoft Word 취약점을 통해 원격 코드 실행이 허용될 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 보안 업데이트는 지원되는 Microsoft Office 2000 에디션에 대해 긴급 업데이트이며, Microsoft Office XP, Microsoft Office 2003 및 Microsoft Office Word Viewer 2003에 대해 중요 업데이트입니다. 자세한 내용은 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어** 섹션을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a513069b-8244-48e9-b136-01ddd3862802&amp;displaylang=ko">Microsoft Word 2000 서비스 팩 3</a><br />
(KB943990)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=78c338aa-e410-4422-9e36-562f70d742e9&amp;displaylang=ko">Microsoft Word 2002 서비스 팩 3</a><br />
(KB943957)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=85cb1aa5-211f-4652-827b-2e79b8ffc2fc&amp;displaylang=ko">Microsoft Word 2003 서비스 팩 2</a><br />
(KB943983)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd4ddecd-abd6-4783-b300-32b9d4bad22a&amp;displaylang=ko">Microsoft Office Word Viewer 2003</a><br />
(KB943992)</td>
...
Office XP(Word 2002) 이상에는 문서를 열기 전에 사용자에게 열기, 저장 또는 취소 권한을 부여할 수 있는 기능이 내장되어 있습니다. 이 취약점을 악용하려면 둘 이상의 사용자 작업이 필요하기 때문에 이 완화 요소로 인해 취약점이 긴급에서 중요로 낮아집니다.
  
**Microsoft Office 2003 서비스 팩 3을 사용하고 있는데, 이 업데이트가 제공되는 이유가 무엇입니까?**    
Microsoft Office 2003 서비스 팩 3은 이 공지에 설명된 보안 취약점의 영향을 받지 않습니다. 하지만 Microsoft Office 2003 서비스 팩 3에 대해 업데이트된 파일이 Microsoft Office 2003 서비스 팩 3으로 제공된 파일보다 최신(상위 버전 번호)이기 때문에 사용자에게 이 업데이트가 계속 제공됩니다. Microsoft에서 이 업데이트를 철저하게 테스트했지만, 모든 업데이트와 마찬가지로 사용자가 자신의 시스템 환경 및 구성에 따라 적절히 테스트하는 것이 좋습니다.
  
**Microsoft Update 메커니즘에 결함이 있기 때문에 Microsoft Office 2003 서비스 팩 3 업데이트가 제공되는 것입니까?**    
아니요, Microsoft Update 메커니즘은 업데이트 패키지에 최신 버전이 포함되어 있어 업데이트를 제공하므로 올바르게 작동하고 있습니다.
...
<th style="border:1px solid black;" >Word 메모리 손상 취약점 – CVE-2008-0109</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
Word 메모리 손상 취약점 – CVE-2008-0109  
---------------------------------------
  

Word에서 특수하게 조작된 Word 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 조작된 값을 포함하여 특수하게 조작된 Word 파일을 사용자가 열면 이 취약점으로 인해 원격 코드 실행이 허용됩니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0109 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109)를 참조하십시오.
  
#### Word 메모리 손상 취약점(CVE-2008-0109)에 대한 완화 요소
...
#### Word 메모리 손상 취약점(CVE-2008-0109)에 대한 대안
...
-   **알 수 없거나 신뢰할 수 없는 출처에서 받은 파일을 열 때 MOICE(Microsoft Office Isolated Conversion Environment)를 사용합니다.**
    ...
    MOICE를 사용하도록 설정하려면 .doc 파일 형식에 대한 레지스트리 핸들을 변경하십시오. 다음 표는 MOICE에서 .doc 파일 형식을 사용하거나 사용하지 않도록 설정하는 명령을 설명합니다.
...
#### Word 메모리 손상 취약점(CVE-2008-0109)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**     
특수하게 조작된 Word 파일의 구문을 분석할 때 메모리 계산 오류 때문에 취약점이 발생합니다. 오류로 인해 시스템 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
...
**업데이트는 어떤 기능을 수행합니까?**     
업데이트는 Word 파일을 열 때 Word에서 필요한 메모리 할당을 계산하는 방식을 수정하여 취약점을 제거합니다.
...
| Microsoft Office Word Viewer 2003 | 예         |  
...
|-----------------------------------|---------|----------------------|---------------------|-----------|  
| Microsoft Word 2000 서비스 팩 3   | 예      | 예                   | 아니요              | 예        |  
| Microsoft Word 2002 서비스 팩 3   | 예      | 예                   | 예                  | 예        |  
| Microsoft Word 2003 서비스 팩 2   | 예      | 예                   | 예                  | 예        |  
| Microsoft Office Word Viewer 2003 | 예      | 예                   | 예                  | 예        |
...
<td style="border:1px solid black;">office2000-KB943990-FullFile-KOR /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2000-KB943990-FullFile-KOR /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><strong>검색, 배포 도구 및 지침</strong> 섹션을 참조하십시오.
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">officexp-KB943957-FullFile-KOR /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">officexp-KB943957-FullFile-KOR /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Word 2003: office2003-KB943983-FullFile-KOR /q:a
Word Viewer 2003: office2003-KB943992-FullFile-KOR /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Word 2003: office2003-KB943983-FullFile-KOR /r:n
Word Viewer 2003: office2003-KB943992-FullFile-KOR /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;">추가 정보</td>
<td style="border:1px solid black;">검색, 배포 도구 및 지침 섹션을 참조하십시오.
선택적으로 설치할 수 있는 기능에 대한 자세한 내용은 이 섹션에서 <strong>관리 설치의 Office 기능</strong> 하위 섹션을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>다시 시작 요구 사항</strong></td>
...
지원 대상인 모든 Word 2003 에디션:
  
| 파일 이름   | 버전        | 날짜        | 시간  | 크기       |  
|-------------|-------------|-------------|-------|------------|  
| Winword.exe | 11.0.8202.0 | 20-Nov-2007 | 03:35 | 12,311,048 |
  
지원 대상인 모든 Word Viewer 2003 에디션:
...
-   Word 메모리 손상 취약점(CVE-2008-0109)을 보고해 주신 [Reversemode.com (영문)](https://reversemode.com/)의 Rubén Santamarta
...
-   V1.2 (2008년 9월 11일): 공지가 업데이트되었습니다. Microsoft Office의 비보안 버전에 이 업데이트가 제공되는 이유를 설명하기 위해 업데이트 FAQ에 항목을 추가하였습니다.
