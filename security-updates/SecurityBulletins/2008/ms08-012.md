...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0102 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102)를 참조하십시오.
...
-   Publisher 잘못된 메모리 참조 취약점(CVE-2008-0102)을 보고해 주신 [Fortinet Security Research](http://www.fortinet.com/)의 Bing Liu  
-   Publisher 메모리 손상 취약점(CVE-2008-0104)을 보고해 주신 [Fortinet Security Research (영문)](http://www.fortinet.com/)의 Bing Liu
