---
TOCTitle: 'MS17-005'
Title: 'Microsoft 보안 공지 MS17-005 - 긴급'
ms:assetid: 'ms17-005'
ms:contentKeyID: 74419867
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms17-005(v=Security.10)'
---

Microsoft 보안 공지 MS17-005 - 긴급
===================================

Adobe Flash Player용 보안 업데이트(4010250)
-------------------------------------------
...
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 4010250](https://support.microsoft.com/ko-kr/kb/4010250)을 참조하십시오.

취약성 정보
-----------

<span id="sectionToggle1"></span>
이 보안 업데이트는 Adobe 보안 공지 [APSB17-04](http://helpx.adobe.com/kr/security/products/flash-player/apsb17-04.html)에 설명된 다음 취약성을 해결합니다.
...
<td style="border:1px solid black;">
[MS17-003](https://go.microsoft.com/fwlink/?linkid=838351)(3214628)
...
\*대체된 업데이트 열에는 대체된 일련의 업데이트 중 최신 업데이트만 표시됩니다. 대체된 업데이트의 전체 목록을 확인하려면 [Microsoft 업데이트 카탈로그](http://catalog.update.microsoft.com/v7/site/home.aspx)로 이동하여 업데이트 KB 번호를 검색한 다음 업데이트 세부 정보를 보십시오. 대체된 업데이트 정보는 패키지 세부 정보 탭에 나와 있습니다.
...
-   V1.0(2017년 2월 21일): 공지가 게시되었습니다.

*2017년 2월 8일 10:22-08:00에 페이지가 생성되었습니다.*