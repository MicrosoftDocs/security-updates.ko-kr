...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|------------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=b031a496-aa74-4367-b2ae-24843c061745&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=eddd2964-9765-461d-9df8-2c05402948e8)                                                                 | 원격 코드 실행 | 긴급             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=53756404-39e4-43af-81e9-81471536aa66&displaylang=ko)                                                                  | 원격 코드 실행 | 보통             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c8d59f49-45ec-4527-b3a8-4925f710bbfd&displaylang=ko)                                                      | 원격 코드 실행 | 보통             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=9c784734-f44f-4a3c-8223-6289f7dc2ad8)                                                             | 없음           | 심각도 없음<sup>[1]</sup> | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=80bf050a-9aff-4cd4-8e2f-196b0a92b1c0&displaylang=ko)                                           | 원격 코드 실행 | 긴급             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=a81412d0-2516-4bf4-87f7-3e41ebf6b82b&displaylang=ko)                   | 원격 코드 실행 | 긴급             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c3247886-76d0-4292-be9d-3e9b0221c46a&displaylang=ko)\*\*     | 원격 코드 실행 | 보통             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=51521b6b-94a7-4bcf-ad5f-fc304728b10f&displaylang=ko)\*\* | 원격 코드 실행 | 보통             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e7c38b0d-7240-420a-88d3-2749a40e386f)            | 없음           | 심각도 없음<sup>[1]</sup> | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d&displaylang=ko)                                                                       | 원격 코드 실행 | 긴급             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d&displaylang=ko)                                                           | 원격 코드 실행 | 긴급             | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082&displaylang=ko)                                                         | 원격 코드 실행 | 긴급             | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 보통             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de&displaylang=ko)\*\*                                        | 원격 코드 실행 | 보통             | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                                   | 원격 코드 실행 | 보통             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                       | 원격 코드 실행 | 보통             | 없음                                                                |
...
이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에는 새로운 킬(Kill) 비트 그리고 이전에 릴리스된 ActiveX 킬(Kill) 비트 보안 업데이트([MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS09-032](http://technet.microsoft.com/security/bulletin/ms09-032)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034)) 및 제목이 ActiveX 킬(Kill) 비트용 업데이트 롤업인 권고([Microsoft 보안 권고 953839](http://technet.microsoft.com/security/advisory/953839), [Microsoft 보안 권고 956391](http://technet.microsoft.com/security/advisory/956391), [Microsoft 보안 권고 960715](http://technet.microsoft.com/security/advisory/960715) 및 [Microsoft 보안 권고 969898](http://technet.microsoft.com/security/advisory/969898))의 모든 킬 비트가 포함되어 있습니다.
...
운영 체제에 따라 취약점에 적용되는 완화 조치가 서로 다르므로, 이 업데이트의 심각도는 달라집니다. 그러한 완화 조치 중 하나로써, Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0811 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811)을 참조하십시오.
...
Microsoft Internet Explorer 8 개발자 도구는 웹 사이트 개발자들이 Microsoft JScript를 빠르게 디버깅하거나 Internet Explorer와 관련된 동작을 조사하거나 새 디자인 또는 솔루션을 즉석에서 고안할 수 있도록 합니다. IE8 도구에 대한 자세한 내용은 MSDN 문서, [Internet Explorer 개발자 도구 발견 (영문)](http://msdn.microsoft.com/en-us/library/dd565628(vs.85).aspx)을 참조하십시오.
...
**참고** 이 킬(kill) 비트를 설정하면 [Microsoft 보안 공지 MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034)에서 처음으로 설명한 [CVE-2010-0811 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811) 취약점의 변종을 해결할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3973 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)을 참조하십시오.
...
-   WMITools ActiveX 컨트롤은 서명되지 않았습니다. 기본적으로 Internet Explorer는 서명되지 않은 컨트롤을 차단합니다. 자세한 내용은 MSDN 문서, [ActiveX 차단 (영문)](http://msdn.microsoft.com/library/dd565667.aspx)을 참조하십시오.  
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.  
-   기본적으로 지원 대상인 모든 Microsoft Outlook, Microsoft Outlook Express 및 Windows Mail 버전은 스크립트와 ActiveX 컨트롤을 비활성화하는 제한된 사이트 영역에서 HTML 메일 메시지를 열어 공격자가 이 취약성을 사용하여 악의적인 코드를 실행할 수 없도록 위험을 제거합니다. 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 취약점 악용에 취약해질 수 있습니다.
...
아니요, 이 ActiveX 컨트롤은 디지털 서명되지 않았습니다. ActiveX 컨트롤 서명에 대한 자세한 내용은 MSDN 블로그 게시물, [Authenticode 코드 서명에 대해 알아야 하는 모든 것(영문)](http://blogs.msdn.com/b/ieinternals/archive/2011/03/22/authenticode-code-signing-for-developers-for-file-downloads-building-smartscreen-application-reputation.aspx)을 참조하십시오.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3973 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
아니요. Microsoft는 이 보안 공지를 처음에 게시했을 때 이 취약점이 고객을 공격하는 데 공개적으로 사용되었다는 정보를 확인하지 못했습니다.
  
**이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?**    
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3973 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1243 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1243)을 참조하십시오.
...
-   [Oracle](http://www.oracle.com)은 ActiveX 컨트롤, Java Deployment Toolkit에 대한 킬(Kill) 비트를 요청했습니다. Java Deployment Toolkit ActiveX 컨트롤의 보안 문제와 관련된 자세한 내용은 [Oracle Security Alert CVE-2010-0886 (영문)](http://www.oracle.com/technetwork/topics/security/alert-cve-2010-0886-094541.html)을 참조하십시오. 이 ActiveX 컨트롤에 대한 클래스 식별자는 다음과 같습니다.  
    -   {CAFEEFAC-DEC7-0000-0000-ABCDEFFEDCBA}  
-   [CA (영문)](http://www.ca.com/us/)는 ActiveX 컨트롤, WebScan에 대한 권고와 관련된 보안 권고를 발표했습니다. WebScan ActiveX 컨트롤과 관련된 문의 사항이나 문제가 있을 경우 CA([http://www.ca.com (영문)](http://www.ca.com))로 문의하십시오. 자세한 내용은 CA의 보안 공지를 참조하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {7B297BFD-85E4-4092-B2AF-16A91B2EA103}  
-   [IBM](http://www.ibm.com)은 "Rational Suite License ActiveX Control"에 대해 ActiveX 컨트롤에 대한 킬(Kill) 비트를 요청했습니다. Rational Suite License ActiveX 컨트롤과 관련된 문의 사항이나 문제가 있을 경우 IBM(<http://www.ibm.com>)으로 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
...
-   Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)을 해결하기 위해 협력해 주신 [TippingPoint's](http://www.tippingpoint.com/) [DVLabs](http://dvlabs.tippingpoint.com/)의 Brian Gorenc  
-   [iSIGHT Partners (영문)](http://www.isightpartners.com/) Global Vulnerability Partnership과 협력하여 Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)을 보고해 주신 RadLSneak
