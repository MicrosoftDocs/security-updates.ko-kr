---
TOCTitle: 'MS12-071'
Title: 'Microsoft 보안 공지 MS12-071 - 긴급'
ms:assetid: 'ms12-071'
ms:contentKeyID: 61230538
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-071(v=Security.10)'
---

Microsoft 보안 공지 MS12-071 - 긴급
===================================

Internet Explorer 누적 보안 업데이트 (2761451)
----------------------------------------------

게시된 날짜: 2012년 11월 13일 화요일
...
이 보안 업데이트의 심각도는 Windows 클라이언트의 Internet Explorer 9에 대해 긴급이고, Windows 서버의 Internet Explorer 9에 대해 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
<td style="border:1px solid black;">
[MS12-063](https://go.microsoft.com/fwlink/?linkid=255505)의 KB2744842는 KB2761451로 대체되었습니다.
</td>
</tr>
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2761451](https://support.microsoft.com/kb/2761451)을 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [11월 공지 요약](https://technet.microsoft.com/security/bulletin/ms12-nov)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1538](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538)을 참조하십시오.

#### CFormElement 해제 후 사용 취약점(CVE-2012-1538)에 대한 완화 요소
...
#### CFormElement 해제 후 사용 취약점(CVE-2012-1538)에 대한 대안
...
#### CFormElement 해제 후 사용 취약점(CVE-2012-1538)에 대한 FAQ
...
이 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 워크스테이션 또는 터미널 서버와 같이 Internet Explorer 9를 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1539](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539)를 참조하십시오.

#### CTreePos 해제 후 사용 취약점(CVE-2012-1539)에 대한 완화 요소
...
#### CTreePos 해제 후 사용 취약점(CVE-2012-1539)에 대한 대안
...
#### CTreePos 해제 후 사용 취약점(CVE-2012-1539)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4775](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775)를 참조하십시오.

#### CTreeNode 해제 후 사용 취약점(CVE-2012-4775)에 대한 완화 요소
...
#### CTreeNode 해제 후 사용 취약점(CVE-2012-4775)에 대한 대안
...
#### CTreeNode 해제 후 사용 취약점(CVE-2012-4775)에 대한 FAQ
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2761451">Microsoft 기술 자료 문서 2761451</a> 참조</td>
</tr>
<tr class="odd">
...
-   CFormElement 해제 후 사용 취약점(CVE-2012-1538)을 [VeriSign iDefense Labs](https://labs.idefense.com/)와 협력하여 보고해 주신 spa-s3c.blogspot.com의 Jose A. Vazquez Gonzalez  
-   CFormElement 해제 후 사용 취약점(CVE-2012-1538)을 보고해 주신 [Omair](https://krash.in/)  
-   CTreePos 해제 후 사용 취약점(CVE-2012-1539)을 [VeriSign iDefense Labs](https://labs.idefense.com/)와 협력하여 보고해 주신 spa-s3c.blogspot.com의 Jose A. Vazquez Gonzalez  
-   CTreeNode 해제 후 사용 취약점(CVE-2012-4775)을 보고해 주신 [Trend Micro](https://www.trendmicro.com/)의 Cheng-da Tsai(Orange), Sung-ting Tsai 및 Ming-chieh Pan(Nanika)
