...
이 보안 업데이트는 [Microsoft 보안 권고 2887505](https://technet.microsoft.com/security/advisory/2887505)에서 처음 설명한 취약점도 해결합니다.
...
<td style="border:1px solid black;">
[MS13-069](https://go.microsoft.com/fwlink/?linkid=320631)의 2870699
</td>
</tr>
...
Microsoft는 2884101이 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서 제공됨을 알리기 위해 이 공지를 개정하였습니다.

Windows RT 8.1, Windows 8.1 또는 Windows Server 2012 R2에 Internet Explorer 11이 설치되어 있습니다. 어떤 업데이트가 시스템에 적용됩니까?  
2884101 업데이트는 Windows RT 8.1, Windows 8.1 및 Windows Server 2012 R2를 실행하는 고객에게 적용됩니다. 2884101 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2884101](https://support.microsoft.com/kb/2884101)을 참조하십시오.

Internet Explorer 11 Preview 는 이 보안 공지에서 해결된 취약점의 영향을 받습니 까?  
예. 2879017 업데이트는 Windows 7, Windows 8.1 Preview 및 Windows RT 8.1 Preview용 Internet Explorer 11 Preview에 대해 사용할 수 있습니다. Internet Explorer 11 Preview를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)를 통해 제공됩니다.
...
아니요. 이전에 [Microsoft 보안 권고 2887505](https://technet.microsoft.com/security/advisory/2887505)에 기술된 Microsoft Fix it 솔루션 "CVE-2013-3893 MSHTML Shim 대안"을 구현한 고객은 이 업데이트 적용을 전후하여 Microsoft Fix it 솔루션을 취소할 필요가 없습니다.
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [10월 공지 요약](https://technet.microsoft.com/security/bulletin/ms13-oct)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
| 취약점 제목                          | CVE 번호                                                                               |
|--------------------------------------|----------------------------------------------------------------------------------------|
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3872](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3872)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3873](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3873)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3874](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3874)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3875](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3875)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3882)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3885)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3886)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3893)(영문) |
| Internet Explorer 메모리 손상 취약점 | [CVE-2013-3897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3897)(영문) |
...
-   CVE-2013-3893의 경우, 이 문제점의 악용을 방지할 수 있는 Microsoft Fix it 솔루션 " CVE-2013-3893 MSHTML Shim 대안" 적용
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2879017](https://support.microsoft.com/kb/2879017)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오. 참고 이 대안은 공개된 취약점(CVE-2013-3893)만 해결합니다.
...
| CVE 번호                                                                               | 공개됨                                                                                                                         |
|----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| [CVE-2013-3872](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3872)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3873](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3873)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3874](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3874)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3875](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3875)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3882)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3885)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3886)(영문) | 아니요                                                                                                                         |
| [CVE-2013-3893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3893)(영문) | 예. 이 취약점은 [Microsoft 보안 공지 2887505](https://technet.microsoft.com/security/advisory/2887505)에서 처음 설명되었습니다. |
| [CVE-2013-3897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3897)(영문) | 아니요                                                                                                                         |
...
| [CVE-2013-3885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3885)(영문) | 아니요                                                                                                                      |
| [CVE-2013-3886](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3886)(영문) | 아니요                                                                                                                      |
| [CVE-2013-3893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3893)(영문) | 예. Microsoft는 Internet Explorer 8 및 Internet Explorer 9에서 이 취약점을 악용하려는 일정한 공격에 대한 보고를 받았습니다. |
| [CVE-2013-3897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3897)(영문) | 예. Microsoft는 Internet Explorer 8에서 이 취약점을 악용하려는 일정한 공격에 대한 보고를 받았습니다.                        |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2879017">Microsoft 기술 자료 문서 2879017</a> 참조</td>
</tr>
<tr class="even">
...
<a href="https://support.microsoft.com/kb/2879017">Microsoft 기술 자료 문서 2879017</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 8.1 에디션의 Internet Explorer 11:<br />
<a href="https://support.microsoft.com/kb/2884101">Microsoft 기술 자료 문서 2884101</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">참고: 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
