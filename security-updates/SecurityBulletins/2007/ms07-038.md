...
**알려진 문제점:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 935807](https://support.microsoft.com/kb/935807)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=e9b64746-6afa-4a30-833d-e058e000c821&displaylang=ko)             | 정보 유출      | 보통        | 없음                      |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=0df5d190-3ad7-42d5-8629-43c47ec450cb&displaylang=ko) | 정보 유출      | 보통        | 없음                      |

이 보안 업데이트와 관련된 자주 제기되는 질문 사항
-------------------------------------------------

**Microsoft가 2007년 8월 14일에 이 공지를 다시 공개한 이유는 무엇입니까?**  
Microsoft는 [Microsoft 기술 자료 문서 935807](https://support.microsoft.com/kb/935807)에서 확인된 문제점을 해결하기 위해 이 공지 및 관련 보안 업데이트를 업데이트했습니다. 이 문제점으로 인해 Windows Vista에서 LogFiles\\Firewall 폴더가 없거나 이 폴더가 손상된 경우 업데이트 설치가 실패할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3038 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3038)을 참조하십시오.
...
Windows Vista 방화벽 차단 규칙 정보 유출 취약점(CVE-2007-3038)을 보고해 주신 [Symantec](https://www.symantec.com/ko/kr/index.jsp)의 Jim Hoagland 및 Ollie Whitehouse
...
-   V2.0 (2007년 8월 14일): [Microsoft 기술 자료 문서 935807](https://support.microsoft.com/kb/935807)에서 확인된 문제점을 해결하기 위해 수정된 업데이트가 다시 릴리스되었습니다.
