---
TOCTitle: 'MS11-042'
Title: 'Microsoft 보안 공지 MS11-042 - 긴급'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61230409
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-042(v=Security.10)'
---



Microsoft 보안 공지 MS11-042 - 긴급
===================================

분산 파일 시스템의 취약점으로 인한 원격 코드 실행 문제점(2535512)
-----------------------------------------------------------------

게시된 날짜: 2011년 6월 15일 수요일 | 업데이트된 날짜: 2011년 6월 15일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션에 대해 긴급, 지원 대상인 모든 Windows Vista 및 Windows Server 2008 에디션과 Windows 7(32비트 시스템용), Windows 7(x64 기반 시스템용), Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용)에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 DFS 클라이언트가 특수하게 조작된 DFS 참조 응답에서 필드의 유효성을 검사하는 방식을 수정하고, DFS 서비스가 특수하게 조작된 DFS 참조 응답을 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                               | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                           | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2&displaylang=ko)                                         | 서비스 거부    | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270&displaylang=ko)                 | 서비스 거부    | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90&displaylang=ko)\*     | 서비스 거부    | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e&displaylang=ko)\* | 서비스 거부    | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4)          | 서비스 거부    | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                    | 서비스 거부    | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2&displaylang=ko)                                                                   | 서비스 거부    | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca&displaylang=ko)\*                                                    | 서비스 거부    | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                 | 서비스 거부    | 중요        | 없음                      |

**\*Server Core 설치가 영향을 받습니다.** 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008 또는 Windows Server 2008 R2에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 TechNet 문서, [Server Core 설치 관리 (영문)](https://technet.microsoft.com/library/ee441255(ws.10).aspx)및 [Server Core 설치 서비스 (영문)](https://technet.microsoft.com/library/ff698994(ws.10).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008 및 Windows Server 2008 R2의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션에 따른 버전 비교](https://www.microsoft.com/windowsserver2008/ko/kr/compare-core-installation.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >DFS 메모리 손상 취약점(CVE-2011-1868)</th>
<th style="border:1px solid black;" >DFS 참조 응답 취약점(CVE-2011-1869)</th>
...
분산 파일 시스템(DFS) 클라이언트가 특수하게 조작된 DFS 응답을 구문 분석하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 DFS 응답을 클라이언트가 시작한 DFS 요청으로 보내 취약점을 악용할 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1868 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868)을 참조하십시오.
  
#### DFS 메모리 손상 취약점(CVE-2011-1868)에 대한 완화 요소
...
#### DFS 메모리 손상 취약점(CVE-2011-1868)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### DFS 메모리 손상 취약점(CVE-2011-1868)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**      
Microsoft 분산 파일 시스템(DFS) 구현에서 특수하게 조작된 DFS 응답 내 모든 필드의 유효성을 제대로 검사하지 못할 때 취약점이 발생합니다.
  
**분산 파일 시스템(DFS)이란 무엇입니까?**      
분산 파일 시스템(DFS)을 통해 관리자는 서로 다른 서버에 있는 공유 폴더를 하나 이상의 DFS 네임스페이스로 투명하게 연결하여 그룹화할 수 있습니다. DFS 네임스페이스는 조직의 공유 폴더에 대한 가상 보기입니다. DFS 도구를 사용하여 관리자는 네임스페이스에 표시할 공유 폴더를 선택하고, 이러한 폴더가 나타나는 계층을 설계하며, 공유 폴더가 네임스페이스에 나타나는 이름을 결정할 수 있습니다. 사용자가 네임스페이스를 볼 때 폴더는 단일 대용량 하드 디스크에 있는 것으로 나타납니다. 사용자는 데이터를 호스팅하는 서버 이름이나 공유 폴더를 알 필요 없이 네임스페이스에서 폴더를 탐색할 수 있습니다. 자세한 내용은 [DFS 기술 참조 (영문)](https://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx)를 참조하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**      
이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이 취약점을 악용하려는 대부분의 시도는 영향을 받는 시스템의 응답 중지 및 재시작을 유발합니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**      
공격자는 이 취약점을 악용하도록 설계된 특수하게 조작된 서버를 호스팅하고 사용자가 DFS 연결을 시작하도록 유도할 수 잇습니다. 또한 로컬 네트워크의 공격자는 MITM(man-in-the-middle) 공격을 수행하여 정당한 DFS 요청에 대해 악의적인 DFS 응답으로 응답할 수 있습니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**      
지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션이 이 문제에 취약합니다.
  
**업데이트는 어떤 기능을 수행합니까?**      
이 보안 업데이트는 DFS 클라이언트가 특수하게 조작된 DFS 응답 내 필드의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
Microsoft 분산 파일 시스템(DFS)이 특수하게 조작된 DFS 참조 응답을 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 네트워크 메시지를 서버 서비스를 실행하는 컴퓨터로 전송하여 취약점을 악용할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1869 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869)를 참조하십시오.
  
#### DFS 참조 응답 취약점(CVE-2011-1869)에 대한 완화 요소
...
#### DFS 참조 응답 취약점(CVE-2011-1869)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### DFS 참조 응답 취약점(CVE-2011-1869)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**      
분산 파일 시스템(DFS) 구현에서 특수하게 조작된 DFS 참조 응답을 제대로 처리하지 못할 때 취약점이 발생합니다.
...
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**      
지원 대상인 모든 Windows 버전이 이 문제에 취약합니다.
  
**업데이트는 어떤 기능을 수행합니까?**      
이 보안 업데이트는 DFS 클라이언트가 특수하게 조작된 DFS 참조 응답을 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2535512$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2535512">Microsoft 기술 자료 문서 2535512</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">모든 Windows 7(x64 기반 시스템용):<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows 2008 R2(x64 기반 시스템용):<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 2008 R2(Itanium 기반 시스템용):<br />
...
-   DFS 참조 응답 취약점(CVE-2011-1869)을 보고해 주신 [NGS Software (영문)](https://www.ngssoftware.com/)의 Laurent Gaffié
...
-   V1.1(2011년 6월 15일): Windows 7(32비트 시스템용) 서비스 팩 1, Windows 7(x64 기반 시스템용) 서비스 팩 1, Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1이 영향을 받는 소프트웨어 표에서 영향을 받지 않는 소프트웨어 표로 이동되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.
