...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969856](https://support.microsoft.com/kb/969856)에 나와 있습니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969856](https://support.microsoft.com/kb/969856)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1542 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1542)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969856">Microsoft 기술 자료 문서 969856</a> 참조</td>
</tr>
<tr class="even">
...
설치 관리자에 대한 자세한 내용은 [IExpress 기술 및 IExpress 마법사 웹 사이트](https://www.microsoft.com/technet/prodtechnol/ie/ieak/techinfo/deploy/60/en/iexpress.mspx?mfr=true)(영문)를 참조하십시오.

*핫픽스*와 같이 이 공지에서 사용하는 용어에 대한 자세한 내용은 [Microsoft 기술 자료 문서 824684](https://support.microsoft.com/kb/824684)를 참조하십시오.

이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 설치 문제점은 [Microsoft 기술 자료 문서 937987](https://support.microsoft.com/kb/937987)에 나와 있습니다.
...
-   Virtual PC 및 Virtual Server 권한 있는 명령 디코딩 취약점(CVE- 2009-1542)을 보고해 주신 [Google Inc. (영문)](https://www.google.com/)의 Julien Tinnes 및 Tavis Ormandy
