...
Microsoft는 공개적으로 보고된 취약점에 대해 조사를 완료했습니다. 이 문제점을 해결하기 위해 [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026)이 게시되었습니다. 이 문제점에 대한 자세한 정보와 사용 가능한 보안 업데이트의 다운로드 링크를 보려면 [MS11-026](https://technet.microsoft.com/security/bulletin/ms11-026)을 검토하십시오. 해결되는 취약점은 MHTML MIME 형식의 요청 취약점([CVE-2011-0096 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096))입니다.
