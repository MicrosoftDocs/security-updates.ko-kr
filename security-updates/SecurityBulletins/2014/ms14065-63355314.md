...
다음 표에 지정된 위험, 중요, 보통 값은 심각도를 나타냅니다. 자세한 내용은 [보안 게시판 심각도 등급 시스템](http://technet.microsoft.com/ko-kr/security/gg309177)(영문)을 참조 하십시오. 약어는 다음 키에 표시된대로 나타내는 최대 영향을 지정 합니다.
