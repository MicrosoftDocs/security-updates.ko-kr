...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>Exchange Server용 Outlook Web Access 데이터 유효성 검사 사이트 간 스크립팅 취약점(CVE-2008-2247)</th>
<th>Exchange Server용 Outlook Web Access 구문 분석 사이트 간 스크립팅 취약점(CVE-2008-2248)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
