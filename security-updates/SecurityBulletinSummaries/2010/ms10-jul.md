...
2010년 7월 공지 발표와 함께 이 공지 요약이 2010년 7월 8일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](https://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](https://go.microsoft.com/fwlink/?linkid=21163)을 참조하십시오.

Microsoft는 2010년 7월 15일 목요일 오전 3시(한국 표준시)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [7월 보안 공지 웹캐스트에 지금 등록하십시오 (영문)](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032454299&culture=en-us). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약 (영문)](https://technet.microsoft.com/security/bulletin/summary) 및 웹캐스트를 참조하십시오.
...
|---------------------------------------------------------------------|-----------------------------------------------|-----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|-----------------------------------------------------------|  
| [MS10-045](https://technet.microsoft.com/security/bulletin/ms10-045) | Microsoft Outlook SMB 첨부 파일 취약점        | [CVE-2010-0266 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0266) | [**1 (영문)**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 일관적인 악용 코드 가능 | (없음)                                                    |  
| [MS10-044](https://technet.microsoft.com/security/bulletin/ms10-044) | Access ActiveX 컨트롤 취약점                  | [CVE-2010-0814 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0814) | [**2 (영문)**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 일관적인 악용 코드 가능 | (없음)                                                    |  
| [MS10-044](https://technet.microsoft.com/security/bulletin/ms10-044) | ACCWIZ.dll 초기화되지 않은 변수 취약점        | [CVE-2010-1881 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1881) | [**1 (영문)**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 일관적인 악용 코드 가능 | (없음)                                                    |  
| [MS10-042](https://technet.microsoft.com/security/bulletin/ms10-042) | 도움말 센터 URL 유효성 검사 취약점            | [CVE-2010-1885 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) | [**1 (영문)**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 일관적인 악용 코드 가능 | **이 취약점은 현재 인터넷 생태계에서 악용되고 있습니다.** |  
| [MS10-043](https://technet.microsoft.com/security/bulletin/ms10-043) | Canonical Display Driver 정수 오버플로 취약점 | [CVE-2009-3678 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3678) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 비일관적인 악용 코드 가능      | (없음)                                                    |
...
-   MS10-043에서 설명한 문제점을 보고해 주신 [Reactive Systems, Inc. (영문)](https://www.reactive-systems.com/)의 David Hansel
-   MS10-044에서 설명한 문제점을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
-   MS10-044에서 설명한 문제점을 보고해 주신 [IBM ISS X-Force (영문)](https://www.iss.net/)의 Robert Freeman
-   MS10-045에서 설명한 문제점을 [SSD/SecuriTeam Secure Disclosure Program (영문)](https://www.beyondsecurity.com/ssd.html)과 협력하여 보고해 주신 Yorick Koster
