...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2293211](http://support.microsoft.com/kb/2293211)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3230 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3231 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3232 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232)를 참조하십시오.
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는 Office 2007에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3233 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233)을 참조하십시오.
...
기본적으로 Microsoft Excel 2003 서비스 팩 3에서는 Lotus 1-2-3 파일 열기가 차단됩니다. 이 완화 요소는 Microsoft Excel 2003 서비스 팩 3에 대한 CVE-2010-3233의 심각도를 낮춥니다. Microsoft Office 2003 서비스 팩 3 설치 후 차단되는 파일 형식에 대한 자세한 내용은 [Microsoft 기술 자료 문서 938810](http://support.microsoft.com/kb/938810/)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3234 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3235 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3236 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236)을 참조하십시오.
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3237 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3238 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3239 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3240 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240)을 참조하십시오.
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2007에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3241 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3242 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2345017">Microsoft 기술 자료 문서 2345017</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2344893">Microsoft 기술 자료 문서 2344893</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="http://support.microsoft.com/kb/2345035">Microsoft 기술 자료 문서 2345035</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="http://support.microsoft.com/kb/2345088">Microsoft 기술 자료 문서 2345088</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="http://support.microsoft.com/kb/2344875">Microsoft 기술 자료 문서 2344875</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Excel 레코드 구문 분석 정수 오버플로 취약점(CVE-2010-3230)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Alin Rad Pop  
-   Excel 레코드 구문 분석 메모리 손상 취약점(CVE-2010-3231)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Excel 파일 형식 구문 분석 취약점(CVE-2010-3232)을 보고해 주신 Omair  
-   Lotus 1-2-3 통합 문서 구문 분석 취약점(CVE-2010-3233)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten H. Eiram  
-   수식 하위 스트림 메모리 손상 취약점(CVE-2010-3234)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   수식 BIFF 레코드 취약점(CVE-2010-3235)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   범위 초과 배열 취약점(CVE-2010-3236)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   셀 병합 레코드 포인터 취약점(CVE-2010-3237)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   음수 미래 함수 취약점(CVE-2010-3238)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   추가 범위 초과 레코드 구문 분석 취약점(CVE-2010-3239)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Alin Rad Pop  
-   실시간 데이터 배열 레코드 취약점(CVE-2010-3240)을 보고해 주신 [VUPEN Vulnerability Research Team](http://www.vupen.com/)의 Chaouki Bekrar  
-   구문 분석 시 범위 초과 메모리 쓰기 취약점(CVE-2010-3241)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   삭제할 레코드 유형 구문 분석 취약점(CVE-2010-3242)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten H. Eiram
