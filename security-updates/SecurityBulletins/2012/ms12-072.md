...
예. Windows 8 Release Preview 및 Windows Server 2012 출시 후보 버전에서 KB2727528 업데이트를 사용할 수 있습니다. Windows 8 Release Preview와 Windows Server 2012 출시 후보 버전을 보유한 고객은 시스템에 이 업데이트를 적용하는 것이 좋습니다. 이 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 구할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527)(영문)을 참조하십시오.
...
서류 가방이란 무엇입니까?   
서류 가방은 두 폴더의 콘텐츠를 동기화하는 Windows의 기능입니다. 서류 가방을 통해 사용자는 USB 썸 드라이브와 같은 장치와 컴퓨터 간에 폴더를 동기화할 수 있습니다. 자세한 내용은 [서류 가방을 사용한 동기화](https://windows.microsoft.com/en-us/windows7/sync-using-briefcase)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2727528">Microsoft 기술 자료 문서 2727528</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 서류 가방 정수 언더플로 취약점(CVE-2012-1527)을 [VeriSign iDefense Labs](https://labs.idefense.com/)와 협력하여 보고해 주신 Tal Zeltzer  
-   Windows 서류 가방 정수 오버플로 취약점(CVE-2012-1528)을 [VeriSign iDefense Labs](https://labs.idefense.com/)와 협력하여 보고해 주신 Tal Zeltzer
