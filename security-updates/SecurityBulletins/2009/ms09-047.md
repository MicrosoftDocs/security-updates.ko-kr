---
TOCTitle: 'MS09-047'
Title: 'Microsoft 보안 공지 MS09-047 - 긴급'
ms:assetid: 'ms09-047'
ms:contentKeyID: 61230233
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-047(v=Security.10)'
---


Microsoft 보안 공지 MS09-047 - 긴급
===================================

Windows Media Format의 취약점으로 인한 원격 코드 실행 문제점 (973812)
---------------------------------------------------------------------

게시된 날짜: 2009년 9월 9일 수요일 | 업데이트된 날짜: 2009년 9월 17일 목요일
...
이 보안 업데이트의 심각도는 Windows Media Format Runtime 9.0, Windows Media Format Runtime 9.5, Windows Media Format Runtime 11, Microsoft Media Foundation, Windows Media Services 9.1 및 Windows Media Services 2008에 대해 긴급입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows Media Format Runtime의 ASF(Advanced Systems Format) 파일 및 MP3(MPEG-1 Audio Layer 3) 파일 구문 분석 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 973812](https://support.microsoft.com/kb/973812)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Windows Media Format Runtime 9.0, Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11](https://www.microsoft.com/download/details.aspx?familyid=31585f5a-9aaa-40da-b15a-11284b4b800c&displaylang=ko)  
(KB968816)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows Media Format Runtime 9.5](https://www.microsoft.com/download/details.aspx?familyid=4ab34e3d-34cb-4e35-a2da-b348ace8a8f7&displaylang=ko)  
(KB968816)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows Media Format Runtime 11 및 Microsoft Media Foundation](https://www.microsoft.com/download/details.aspx?familyid=d2bdefcc-f6b9-47c3-a55d-a4f33f967828&displaylang=ko)  
(KB968816)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows Media Format Runtime 11 및 Microsoft Media Foundation](https://www.microsoft.com/download/details.aspx?familyid=97f00b25-fb8f-4300-80c0-c63179f32182&displaylang=ko)  
(KB968816)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows Media Services 9.1](https://www.microsoft.com/download/details.aspx?familyid=61cd0581-c36e-4da6-ae95-41609adbe922&displaylang=ko)  
(KB972554)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
**Microsoft Media Foundation이란 무엇입니까?**  
Microsoft Media Foundation은 Windows Vista 이상 버전에 포함된 기본 구성 요소로 응용 프로그램에서 디지털 미디어를 재생하거나 캡처할 수 있도록 합니다.
...
<tr>
<td style="border:1px solid black;">
Microsoft Windows 2000 서비스 팩 4에 설치된 Windows Media Format Runtime 9.0
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 Windows Media Format Runtime 9.0
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition 및 Windows Media Format Runtime 11
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 Windows Media Format Runtime 9.5
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 Windows Media Format Runtime 11
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 JMicrosoft Media Foundation
</td>
<td style="border:1px solid black;">
해당 사항 없음
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 Windows Media Format Runtime 11
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 Microsoft Media Foundation
</td>
<td style="border:1px solid black;">
해당 사항 없음
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2\*\*의 Windows Media Format Runtime 11
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2\*\*의 Microsoft Media Foundation
</td>
<td style="border:1px solid black;">
해당 사항 없음
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2\*\*의 Windows Media Format Runtime 11
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2\*\*의 Microsoft Media Foundation
</td>
<td style="border:1px solid black;">
해당 사항 없음
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 Windows Media Services 9.1
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Services 9.1
</td>
<td style="border:1px solid black;">
**긴급**  
원격 코드 실행
...
Microsoft Windows에서 특수하게 조작된 ASF 형식 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이러한 취약점으로 인해 사용자가 특수하게 조작된 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2498 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2498)을 참조하십시오.

#### Windows Media 헤더 구문 분석의 잘못된 메모리 해제 취약점(CVE-2009-2498)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn.microsoft.com/en-us/library/ms537180(vs.85).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 섹션을 참조하십시오.
...
-   Windows Media Services는 모든 Windows 플랫폼의 선택적 구성 요소이며 기본적으로 설치되지 않습니다.

#### Windows Media 헤더 구문 분석의 잘못된 메모리 해제 취약점(CVE-2009-2498)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

**wmvcore.dll에 대한 액세스 제한**
...
**대안의 영향.** Windows Explorer 또는 Windows Media Player에서 미디어 파일을 재생할 수 없게 됩니다.
...
**지원 대상인 모든 32비트 에디션의 WindowsVista** **및 Windows Server 2008:**

상승된 권한의 관리자 명령 프롬프트에서 다음 명령을 실행합니다.
...
**대안의 영향.** Windows Explorer 또는 Windows Media Player에서 미디어 파일을 재생할 수 없게 됩니다. 오류가 발생하며 Windows Media Player가 종료됩니다.
...
**지원 대상인 모든 x64 기반 에디션의 WindowsVista** **및 Windows Server 2008:**
...
#### Windows Media 헤더 구문 분석의 잘못된 메모리 해제 취약점(CVE-2009-2498)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
ASF 파일 처리를 담당하는 Windows 구성 요소는 조작된 헤더가 있는 특수하게 조작된 ASF 파일을 제대로 처리하지 못합니다.
...
이 취약점을 통해 악의적인 동작이 발생하려면 로그온한 사용자가 Windows Media Format Runtime 기반 응용 프로그램에서 특수하게 조작된 ASF 파일을 열어야 합니다. 따라서 워크스테이션 또는 터미널 서버와 같이 Windows Media Format Runtime 또는 Windows Media Server가 자주 사용되는 시스템은 이 취약점으로 인해 가장 위험할 수 있습니다.
...
Microsoft Windows가 MP3 미디어 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이러한 취약점으로 인해 사용자가 특수하게 조작된 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2499 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2499)를 참조하십시오.

#### Windows Media 재생 메모리 손상 취약점(CVE-2009-2499)에 대한 완화 요소
...
#### Windows Media 재생 메모리 손상 취약점(CVE-2009-2499)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

**wmvcore.dll 및 mf.dll에 대한 액세스 제한**
...
#### Windows Media 재생 메모리 손상 취약점(CVE-2009-2499)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

**취약점의 원인은 무엇입니까?**  
MP3 파일 처리를 담당하는 Windows 구성 요소가 특수하게 조작된 메타데이터를 제대로 처리하지 못합니다.

**Windows Media Format Runtime이란 무엇입니까?**  
Microsoft Windows Media Format Runtime은 Windows Media 콘텐츠를 사용하는 응용 프로그램을 위한 정보와 도구를 제공합니다.

**MP3(MPEG-1 Audio Layer 3)이란 무엇입니까?**  
MPEG-1 Audio Layer 3은 손실 허용 압축을 이용해 오디오 정보를 압축하는 파일 형식입니다. 손실 허용 압축은 압축을 해제한 데이터가 처음에 압축한 데이터와 다를 수 있지만 구문 분석을 하고 표시하기에는 충분히 유사한 기술입니다. 이는 스트리밍 미디어와 같은 오디오 응용 프로그램에서는 일반적인 기술입니다.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

**공격자는 이러한 취약점을 어떻게 악용합니까?**  
이 취약점을 이용하려면 사용자가 특수하게 조작된 MP3 파일을 열거나, 웹 사이트 또는 웹 콘텐츠를 제공하는 응용 프로그램으로부터 특수하게 조작된 스트리밍 콘텐츠를 받아야 합니다.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
이 취약점을 통해 악의적인 동작이 발생하려면 로그온한 사용자가 Windows Media Format Runtime 기반 응용 프로그램에서 특수하게 조작된 MP3 파일을 열어야 합니다. 따라서 워크스테이션 또는 터미널 서버와 같이 Windows Media Format Runtime을 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.

**Windows Server 2003 또는 Windows Server 2008에서 Internet Explorer를 실행하고 있습니다. 이 경우 취약점이 완화됩니까?**  
예. 기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성 (영문)](https://go.microsoft.com/fwlink/?linkid=92039)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](https://go.microsoft.com/fwlink/?linkid=92055)도 참조하십시오.

**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Windows Media Format Runtime의 MP3(MPEG-1 Audio Layer 3) 파일 구문 분석 방식을 수정하여 취약점을 제거합니다.
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4에 설치된 Windows Media Format Runtime 9.0:<br />
Windows2000-WindowsMedia-KB968816-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4에 설치된 Windows Media Format Runtime 9.0:<br />
Windows2000-WindowsMedia-KB968816-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB968816_WM9$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/968816">Microsoft 기술 자료 문서 968816</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">
무인 설치 모드입니다. 사용자 조작이 필요 없으나, 설치 제거 상태는 표시됩니다. 설치 완료 후 다시 시작이 필요한 경우 컴퓨터가 30초 후에 다시 시작한다는 타이머 경고가 있는 대화 상자가 사용자에게 표시됩니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
설치 제거 후 컴퓨터를 다시 시작하고, 종료 시 기타 응용 프로그램을 닫고 열린 파일은 저장하지 않습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2의 Windows Media Format Runtime 9.0과 Windows XP 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11:<br />
WindowsXP-SP2-WindowsMedia-KB968816-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 Windows Media Format Runtime 9.0과 Windows XP 서비스 팩 3에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11:<br />
WindowsXP-WindowsMedia-KB968816-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
WindowsServer2003.WindowsXP-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition:<br />
WindowsMedia10-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 11:<br />
WindowsMedia11-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2의 Windows Media Format Runtime 9.0과 Windows XP 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11:<br />
WindowsXP-SP2-WindowsMedia-KB968816-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 Windows Media Format Runtime 9.0과 Windows XP 서비스 팩 3에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11:<br />
WindowsXP-WindowsMedia-KB968816-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
WindowsServer2003.WindowsXP-KB968816-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition:<br />
...
<br />
Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 Windows Media Format Runtime 9.0과 Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11:<br />
%Windir%\$NTUninstallKB968816_WM9$\Spuninst<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
%Windir%\$NTUninstallKB968816$\Spuninst<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition:<br />
%Windir%\$NTUninstallKB968816_WM10Lx64$\Spuninst<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 11:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 Windows Media Format Runtime 9.0과 Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3에 설치된 Windows Media Format Runtime 9.5 및 Windows Media Format Runtime 11:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
WindowsServer2003-KB968816-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
WindowsServer2003.WindowsXP-KB968816-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition:<br />
WindowsMedia10-KB968816-x64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 Windows Media Services 9.1:<br />
WindowsServer2003-KB972554-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Services 9.1:<br />
WindowsServer2003.WindowsXP-KB972554-x64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
WindowsServer2003-KB968816-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition:<br />
WindowsMedia10-KB968816-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 Windows Media Services 9.1:<br />
WindowsServer2003-KB972554-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Services 9.1:<br />
WindowsServer2003.WindowsXP-KB972554-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 다음 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows Server 2003 서비스 팩 2 및 Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
%Windir%\$NTUninstallKB968816$\Spuninst<br />
<br />
Windows Server 2003 x64 Edition 서비스 팩 2에 설치된 Windows Media Format Runtime 9.5 x64 Edition:<br />
%Windir%\$NTUninstallKB968816_WM10Lx64$\Spuninst<br />
<br />
Windows Server 2003 서비스 팩 2 및 Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Services 9.1:<br />
%Windir%\$NTUninstallKB972554$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Windows Media Format Runtime:<br />
<a href="https://support.microsoft.com/kb/968816">Microsoft 기술 자료 문서 968816</a> 참조<br />
<br />
Windows Media Services:<br />
<a href="https://support.microsoft.com/kb/972554">Microsoft 기술 자료 문서 972554</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2 및 Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Format Runtime 9.5:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2 및 Windows Server 2003 x64 Edition 서비스 팩 2의 Windows Media Services 9.1:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2의 Windows Media Format Runtime 11 및 Microsoft Media Foundation:<br />
Windows6.0-KB968816-x86 /quiet<br />
<br />
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 Windows Media Format Runtime 11 및 Microsoft Media Foundation:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Windows Media Format Runtime 및 Microsoft Media Foundation:<br />
<a href="https://support.microsoft.com/kb/968816">Microsoft 기술 자료 문서 968816</a> 참조<br />
<br />
Windows Media Services:<br />
<a href="https://support.microsoft.com/kb/972554">Microsoft 기술 자료 문서 972554</a> 참조</td>
...
-   Windows Media 헤더 구문 분석의 잘못된 메모리 해제 취약점(CVE-2009-2498)을 보고해 주신 [NGS Software (영문)](https://www.ngssoftware.com/)의 Peter Winter-Smith  
-   Windows Media 재생 메모리 손상 취약점(CVE-2009-2499)을 보고해 주신 Alice Carroll 팬 클럽의 Hiroshi Noguchi
...
-   V1.1(2009년 9월 17일): Microsoft Windows 2000, Windows XP 및 Windows Server 2003 내용 중 Windows Media Format Runtime의 내용이 업데이트 되어 보안공지 목록이 수정되었습니다.
