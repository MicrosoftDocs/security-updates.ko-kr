...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0043 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0043 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0091 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2478971">Microsoft 기술 자료 문서 2478971</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2425227">Microsoft 기술 자료 문서 2425227</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   공개키 체크섬 취약점(CVE-2011-0043)을 보고해 주신 [MIT Kerberos Team (영문)](https://web.mit.edu/kerberos)  
-   Kerberos 스푸핑 취약점(CVE-2011-0091)을 보고해 주신 [iSEC Partners (영문)](https://www.isecpartners.com/)의 Scott Stender
