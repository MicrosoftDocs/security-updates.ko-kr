...
<td style="border:1px solid black;">
[Microsoft Windows 하이퍼링크 개체 라이브러리](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3208481)<sup>[1]</sup>
(3208481)
...
<sup>[4]</sup>이 업데이트는 [Windows 업데이트](https://go.microsoft.com/fwlink/?linkid=21130)를 통해 제공됩니다.
...
[Windows 업데이트](https://go.microsoft.com/fwlink/?linkid=21130)를 통해 Windows Server 2016 Technical Preview 5용 업데이트가 제공되기는 하지만, 고객은 최대한 빨리 Window Server 2016으로 업그레이드하는 것이 좋습니다. 
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7278">CVE-2016-7278(영문)</a></td>
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7284">CVE-2016-7284(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
</tbody>
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7283">CVE-2016-7283(영문)</a></td>
<td style="border:1px solid black;">아니요</td>
<td style="border:1px solid black;">아니요</td>
</tr>
</tbody>
