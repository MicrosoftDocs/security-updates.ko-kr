---
TOCTitle: 'MS08-057'
Title: 'Microsoft 보안 공지 MS08-057 - 긴급'
ms:assetid: 'ms08-057'
ms:contentKeyID: 61230165
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-057(v=Security.10)'
---

Microsoft 보안 공지 MS08-057 - 긴급
===================================

Microsoft Excel의 취약점으로 인한 원격 코드 실행 문제점 (956416)
----------------------------------------------------------------
...
이 보안 업데이트의 심각도는 모든 지원되는 Microsoft Office Excel 2000에 대해 긴급, 모든 지원되는 Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel Viewer 2003, Microsoft Office Excel 2007, Microsoft Office 호환 기능 팩, Microsoft Office Excel Viewer 및 Microsoft Office SharePoint Server 2007 에디션에 대해 중요입니다. 자세한 내용은 이 섹션의 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어** 절을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1b2740e0-ecdd-48ca-84e0-eb187c31eb16&amp;displaylang=ko">Excel 2000 서비스 팩 3</a><br />
(KB955461)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-043">MS08-043</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office XP 서비스 팩 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=27cedef1-c47c-472c-a343-cd9b4ebc2bba&amp;displaylang=ko">Excel 2002 서비스 팩 3</a><br />
(KB955464)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4df27e8a-d803-483b-a700-0177d71bf368&amp;displaylang=ko">Excel 2003 서비스 팩 2</a><br />
(KB955466)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-043">MS08-043</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4df27e8a-d803-483b-a700-0177d71bf368&amp;displaylang=ko">Excel 2003 서비스 팩 3</a><br />
(KB955466)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-043">MS08-043</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2765bbc0-ea2e-4b6e-822c-222ee8e5021f&amp;displaylang=ko">Excel 2007</a><br />
(KB955470)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-043">MS08-043</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2765bbc0-ea2e-4b6e-822c-222ee8e5021f&amp;displaylang=ko">Excel 2007 서비스 팩 1</a><br />
(KB955470)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-043">MS08-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9769ce08-5207-4c63-b7b9-536266ad6b2b&amp;displaylang=ko">Microsoft Office Excel Viewer 2003</a><br />
(KB955468)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9769ce08-5207-4c63-b7b9-536266ad6b2b&amp;displaylang=ko">Microsoft Office Excel Viewer 2003 서비스 팩 3</a><br />
(KB955468)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=83c88444-75b8-44d1-b280-3671394ade45&amp;displaylang=ko">Microsoft Office Excel Viewer</a><br />
(KB955935)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9a7be004-5903-4101-90c5-c0d5f8722af9&amp;displaylang=ko">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩</a><br />
(KB955936)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9a7be004-5903-4101-90c5-c0d5f8722af9&amp;displaylang=ko">Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩</a><br />
(KB955936)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5c29e646-504c-4455-9d35-9a1bed6d7535&amp;displaylang=ko">Microsoft Office SharePoint Server 2007</a>&#42;<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5c29e646-504c-4455-9d35-9a1bed6d7535&amp;displaylang=ko">Microsoft Office SharePoint Server 2007 서비스 팩 1</a>&#42;<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c21c405-2c9e-45d0-be4d-8ccd093af31f&amp;displaylang=ko">Microsoft Office SharePoint Server 2007 x64 Edition</a>&#42;<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c21c405-2c9e-45d0-be4d-8ccd093af31f&amp;displaylang=ko">Microsoft Office SharePoint Server 2007 x64 Edition 서비스 팩 1</a>&#42;<br />
(KB955937)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 956416](https://support.microsoft.com/kb/956416)에 나와 있습니다.
...
<th style="border:1px solid black;" >일정 개체 유효성 검사 취약점(CVE-2008-3477)</th>
<th style="border:1px solid black;" >파일 형식 구문 분석 취약점(CVE-2008-3471)</th>
<th style="border:1px solid black;" >수식 구문 분석 취약점(CVE-2008-4019)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Excel 2002 서비스 팩 3</td>
...
<tr class="odd">
<td style="border:1px solid black;">Excel 2003 서비스 팩 2</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
...
<tr class="even">
<td style="border:1px solid black;">Excel 2003 서비스 팩 3</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
...
<tr class="even">
<td style="border:1px solid black;">Excel 2007 서비스 팩 1</td>
<td style="border:1px solid black;">없음</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office SharePoint Server 2007 서비스 팩 1</td>
<td style="border:1px solid black;">없음</td>
<td style="border:1px solid black;">없음</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office SharePoint Server 2007 x64 Edition 서비스 팩 1</td>
<td style="border:1px solid black;">없음</td>
<td style="border:1px solid black;">없음</td>
<td style="border:1px solid black;"><strong>중요</strong><br />
원격 코드 실행</td>
...
일정 개체 유효성 검사 취약점(CVE-2008-3477)  
-------------------------------------------
  
Excel이 VBA 성능 캐시를 처리하는 방식에 원격 코드 실행 취약점이 있습니다. 이 취약점으로 인해 사용자가 VBA 성능 캐시에서 특수하게 조작된 Excel 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3477 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3477)을 참조하십시오.
  
#### Excel 일정 개체 유효성 검사 취약점(CVE-2008-3477)에 대한 완화 요소
...
#### Excel 일정 개체 유효성 검사 취약점(CVE-2008-3477)에 대한 대안
...
-   VBE6.DLL의 액세스 제어 목록(ACL)을 수정하여 Everyone 그룹에 대한 액세스 거부
  
    **Windows 2000 및 Windows XP**
  
    VBE6.DLL의 액세스 제어 목록(ACL)을 더 엄격하게 수정하려면 다음 절차를 따르십시오.
    ...
    **대안의 영향:** 포함된 ActiveX 컨트롤이 Office 문서에서 실행되지 않습니다. 사용자가 문서에 개체를 삽입하지 못하게 됩니다.
...
**취약점의 원인은 무엇입니까?**    
Excel은 VBA 성능 캐시에서 충분한 데이터 유효성 검사를 수행하지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Excel이 ActiveX 컨트롤이 있는 VBA 성능 캐시 로드를 처리하는 방식을 수정합니다.
...
파일 형식 구문 분석 취약점(CVE-2008-3471)  
-----------------------------------------
  
Microsoft Excel에는 Excel 개체를 로드할 때 메모리 할당이 부적절하기 때문에 원격 코드 실행 취약점이 있습니다. 조작된 개체를 포함하여 특수하게 조작된 Excel 파일을 사용자가 열면 이 취약점으로 인해 원격 코드 실행이 허용됩니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-3471 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3471)을 참조하십시오.
  
#### 파일 형식 구문 분석 취약점(CVE-2008-1444)에 대한 완화 요소
...
#### 파일 형식 구문 분석 취약점(CVE-2008-1444)에 대한 대안
...
#### 파일 형식 구문 분석 취약점(CVE-2008-1444)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Microsoft Excel에는 특수하게 조작된 공격자 제공 Excel 스프레드시트를 열 때 공격자가 원격 코드를 실행할 수 있게 하는 취약점이 있습니다. 이러한 특정한 결함은 Microsoft Excel이 Excel 스프레드시트 형식을 구문 분석하는 방식에 있습니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점을 악용에 성공한 공격자는 로그온한 사용자 자격으로 임의 코드를 실행할 수 있습니다. 사용자가 관리자 권한의 사용자 권한으로 로그온한 경우 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하려면 사용자가 특수하게 조작된 Excel 스프레드시트를 영향을 받는 Microsoft Excel 버전에서 열어야 합니다.  
전자 메일을 통한 공격의 경우 공격자는 조작된 Excel 파일을 사용자에게 보내고 파일을 열도록 설득하는 방식으로 이 취약점을 악용할 수 있습니다.  
웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 Office 파일을 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 눌러 공격자의 웹 사이트를 방문하도록 설득해야 합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Microsoft Excel의 조작된 BIFF 파일을 처리하는 방식을 수정하여 취약점을 제거합니다.
...
수식 구문 분석 취약점(CVE-2008-4019)  
------------------------------------
  
이 특정 결함은 셀 안에 특수 조작된 수식이 포함된 Microsoft Excel 문서를 구문 분석할 때 발생합니다. 이로 인해 현재 로그인한 사용자의 컨텍스트에서 원격 시스템 손상을 초래할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4019 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4019)를 참조하십시오.
  
#### 수식 구문 분석 취약점(CVE-2008-4019)에 대한 완화 요소
...
#### 수식 구문 분석 취약점(CVE-2008-4019)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### 수식 구문 분석 취약점(CVE-2008-4019)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Excel REPT 함수가 최대 셀 길이의 정수 오버플로를 허용하므로 악용이 가능한 조건이 유발됩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Excel 파일을 메모리로 로드할 때 정수 오버플로를 제거합니다.
...
| Microsoft Office SharePoint Server 2007 x64 Edition                                | 예       |  
| Microsoft Office SharePoint Server 2007 x64 Edition 서비스 팩 1                    | 예       |
  
MBSA 2.1에 대한 자세한 내용은 [MBSA 2.1 자주 제기되는 질문 사항(FAQ) (영문)](https://www.microsoft.com/technet/security/tools/mbsa2/qa.mspx)을 참조하십시오.
  
MBSA 2.0.1, Microsoft Update 및 Windows Server Update Services에서 지원하지 않는 레거시 소프트웨어를 사용하는 고객을 위한 **참고**: [Microsoft Baseline Security Analyzer](https://www.microsoft.com/technet/security/tools/mbsahome.mspx)를 방문하고 레거시 제품 지원 섹션을 참조하여 레거시 도구로 종합 보안 업데이트 검색을 만드는 방법을 찾으십시오.
...
| Microsoft Office SharePoint Server 2007 x64 Edition                                | 아니요  | 아니요               | 예. 아래의 **Microsoft Office SharePoint Server 2007에 대한 주석**을 참조하십시오. | 예. 아래의 **Microsoft Office SharePoint Server 2007에 대한 주석**을 참조하십시오. |  
| Microsoft Office SharePoint Server 2007 x64 Edition 서비스 팩 1                    | 아니요  | 아니요               | 예. 아래의 **Microsoft Office SharePoint Server 2007에 대한 주석**을 참조하십시오. | 예. 아래의 **Microsoft Office SharePoint Server 2007에 대한 주석**을 참조하십시오. |
...
-   지원되는 2007 Microsoft Office System 버전은 [Create a network installation point for the 2007 Office system(2007 Office System의 네트워크 설치 지점 만들기) (영문)](https://technet.microsoft.com/en-us/library/cc179063.aspx)을 참조하십시오.  
    **참고** 중앙에서 보안 업데이트를 관리하려는 경우 Windows Server Update Services를 사용합니다. Windows Server Update Services를 사용하여 2007 Microsoft Office System에 보안 업데이트를 신속하게 배포하는 방법에 대한 자세한 내용은 [Windows Server Update Services 웹 사이트](https://www.microsoft.com/korea/smserver/default.mspx)를 참조하십시오.
...
<td style="border:1px solid black;">excel2000-kb955461-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">excel2000-kb955461-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/956416">Microsoft 기술 자료 문서 956416</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">officexp-KB955464-FullFile-KOR /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">officexp-KB955464-FullFile-KOR /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Excel 2003 및 Excel Viewer 2003(모든 에디션)
...
Excel2003-kb955466-fullfile-kor /q:a<br />
<br />
Excel Viewer 2003:<br />
ExcelViewer2003-kb955468-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Excel 2003:<br />
Excel2003-kb955466-fullfile-kor /r:n<br />
<br />
Excel Viewer 2003:<br />
ExcelViewer2003-kb955468-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Word, Excel, PowerPoint 2007 파일 형식용 Excel 2007, Excel Viewer 및 Microsoft Office 호환 기능 팩(모든 에디션)
...
이 보안 업데이트를 적용하려면 시스템에 Windows Installer 3.1 이상이 설치되어 있어야 합니다. 지원되는 Windows 버전에는 Windows Installer 3.1 이상 버전이 모두 포함됩니다.
...
#### Office SharePoint Server 2007(모든 에디션)
...
Microsoft Office 2004 for Mac 11.5.2 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=ba4fa21a-7e01-4ef8-9b9f-9d51d00ef094)에서 다운로드하여 설치하십시오.
...
-   바탕 화면에서 Microsoft Office 2004 for Mac 11.5.2 Update 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2004 for Mac 11.4.2 볼륨 창에서 Microsoft Office 2004 for Mac 11.5.2 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2004 for Mac 11.5.2 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 **11.5.2**이면 업데이트가 설치된 것입니다.
...
Microsoft Office 2004 for Mac 12.1.3 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=e70c5ae0-2858-46de-81f8-dcd1786656b7)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Microsoft Office 2008 for Mac 12.1.3 Update 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 과정을 시작하려면 Microsoft Office 2008 for Mac 12.1.3 Update 볼륨 창에서 Microsoft Office 2008 for Mac 12.1.3 Update 응용 프로그램을 두 번 클릭하고 화면의 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2008 for Mac 12.1.3 Update 볼륨을 휴지통으로 끌어온 다음 다운로드한 파일을 휴지통으로 끌어옵니다.
...
버전 번호가 **12.1.3**이면 업데이트가 설치된 것입니다.
...
[Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=2a8d9a3b-b8a4-43b6-82a6-a2e7d16ae11d)에서 Open XML File Format Converter for Mac 1.0.1 업데이트를 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕화면에서 Open XML File Format Converter for Mac 1.0.1 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Open XML File Format Converter for Mac 1.0.1 업데이트 볼륨 창에서 Open XML File Format Converter for Mac 1.0.1 업데이트 응용 프로그램을 두 번 클릭한 다음 화면의 지침에 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Open XML File Format Converter for Mac 1.0.1 업데이트 볼륨을 휴지통으로 끌어간 다음 다운로드한 파일을 휴지통으로 끌어갑니다.
...
버전 번호가 **1.0.1**이면 업데이트가 설치된 것입니다.
...
-   [TippingPoint](https://www.tippingpoint.com/)및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 파일 형식 구문 분석 취약점(CVE-2008-3471)을 보고해 주신 Wushi  
-   [iDefense VCP](https://labs.idefense.com/)와 협력하여 일정 개체 유효성 검사 취약점(CVE-2008-3477)을 보고해 주신 [Labo Skopia (영문)](https://www.laboskopia.com/)의 Lionel d'Hauenens  
-   일정 개체 유효성 검사 취약점(CVE-2008-3477)을 보고해 주신 [iDefense (영문)](https://labs.idefense.com/)의 Joshua J. Drake
...
-   V1.1(2008년 10월 16일): **검색, 배포 도구 및 지침** 섹션에서 지원되는 모든 버전의 Microsoft Office Excel Viewer 2003에 대해 Systems Management Server 검색 및 배포 요약을 "예"로 변경하였습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 공지 바이너리나 검색 로직은 변경되지 않았습니다.  
-   V1.2(2008년 10월 30일): Microsoft Office 2003 서비스 팩 2에 대한 업데이트에 포함된 모든 추가 보안 기능을 설명하기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목을 추가하였습니다. **검색, 배포 도구 및 지침**에 Excel 2003 서비스 팩 3에 대해 누락된 항목을 추가하였습니다. 마지막으로 **보안 업데이트 배포**의 Windows Installer 재배포 가능 파일에 대한 참조를 수정하였습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 바이너리에 대한 변경 사항은 없습니다.
