...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>UAG 리디렉션 스푸핑 취약점(CVE-2010-2732)</th>
<th>UAG XSS EOP 허용 취약점(CVE-2010-2733)</th>
<th>Forefront Unified Access Gateway의 UAG 모바일 포털 웹 사이트에서 나타나는 XSS 문제 취약점(CVE-2010-2734)</th>
<th>Signurl.asp의 XSS 취약점(CVE-2010-3936)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
