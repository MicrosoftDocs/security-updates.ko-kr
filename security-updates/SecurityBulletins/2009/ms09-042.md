...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 960859](http://support.microsoft.com/kb/960859)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=240977d6-3581-4058-b9f1-7847e4edcf8a&displaylang=ko)(KB960859)                                                                        | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=b3331388-1e52-4924-b512-23275a8fde84&displaylang=ko)(KB960859)                                                          | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6ee7af3-3e39-4866-a893-92bf1c786cd4)(KB960859)                                                                          | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3fe9c745-d87c-43b0-9b2a-356fb34282b4&displaylang=ko)(KB960859)                                                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e2a788e7-a9d1-4574-b106-f8ab44c6c4a2&displaylang=ko)(KB960859)                                                               | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=4f625d39-29d4-44f9-b4bd-cd99f1ea422d)(KB960859)                                                                               | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=d77f406d-11cb-4d19-94ec-938b356c3427&displaylang=ko)(KB960859)                                     | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7a41b8c1-f955-474e-a08e-5e73964327d1&displaylang=ko)(KB960859) | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=62f2e0a6-5e68-41c7-a851-d99bcff6ff3e&displaylang=ko)\*(KB960859)                | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e5d1db9-efef-4112-8138-62f14670cf0d&displaylang=ko)\*(KB960859)            | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b813c74-b2ae-4962-9ebb-1311193d9e2d)(KB960859)                     | 원격 코드 실행 | 보통        | 없음                      |
...
예, 이 공지에는 텔넷 클라이언트 및 서버가 인증에 대한 확장된 보호로 옵트인하도록 지원하는 업데이트도 포함되어 있습니다. 자세한 내용은 [Microsoft 보안 권고 973811](http://technet.microsoft.com/security/advisory/973811)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1930 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1930)을 참조하십시오.
...
**텔넷이란 무엇입니까?**    
텔넷은 TCP프로토콜을 통한 명령줄 원격 액세스를 허용하는 양방향 통신 프로토콜입니다. 자세한 내용은 MSDN 문서, [텔넷 서버(영문)](http://msdn.microsoft.com/en-us/library/aa919240.aspx)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-1930](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1930)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/960859">Microsoft 기술 자료 문서 960859</a> 참조</td>
</tr>
<tr class="even">
