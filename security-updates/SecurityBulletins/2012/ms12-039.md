...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2707956](https://support.microsoft.com/kb/2707956)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=75eea324-689a-4892-bdd9-03ef399c4cba&amp;displaylang=ko">Microsoft Communicator 2007 R2</a><br />
(KB2708980)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=425406ea-28b9-46f7-8c49-0c7ea46f16e3&amp;displaylang=ko">Microsoft Lync 2010(32비트)</a><br />
(KB2693282)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=06e5285f-1947-4409-b608-e0a145fadba4&amp;displaylang=ko">Microsoft Lync 2010(64비트)</a><br />
(KB2693282)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c40f0d38-af90-4966-a0f0-346fa48683d0&amp;displaylang=ko">Microsoft Lync 2010 Attendee</a><br />
(관리자 수준 설치)<br />
(KB2696031)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=ad864c0e-5850-44a3-b74f-5980a998a384&amp;displaylang=ko">Microsoft Lync 2010 Attendee</a>[1]<br />
(사용자 수준 설치)<br />
(KB2693283)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fe7ad0f9-ee84-4cda-b252-a8d31ead5053&amp;displaylang=ko">Microsoft Lync 2010 Attendant(32비트)</a><br />
(KB2702444)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fe7ad0f9-ee84-4cda-b252-a8d31ead5053&amp;displaylang=ko">Microsoft Lync 2010 Attendant(64비트)</a><br />
(KB2702444)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
TrueType 글꼴 구문 분석 취약점(CVE-2011-3402)은 Microsoft Lync와 이 공지에 설명된 관련 소프트웨어, [MS12-034](https://go.microsoft.com/fwlink/?linkid=251038)에 설명된 기타 Microsoft 소프트웨어에도 영향을 미칩니다. 그러나 시스템에 설치한 소프트웨어에 해당하는 업데이트만 설치할 수 있습니다. Microsoft Lync 또는 관련된 해당 소프트웨어를 설치한 경우 이 공지에 따라 필수 업데이트를 적용하십시오. Microsoft Windows, Microsoft Office, Microsoft Silverlight의 경우 [MS12-034](https://go.microsoft.com/fwlink/?linkid=251038)에 따라 필수 업데이트를 적용하십시오.
  
이 보안 업데이트는 MS12-037과 어떤 관련이 있습니까?  
이 공지에 설명된 HTML 삭제 취약점(CVE-2012-1858)은 Internet Explorer에도 영향을 미칩니다. 그러나 시스템에 설치한 소프트웨어에 해당하는 업데이트만 설치할 수 있습니다. Microsoft Lync를 설치한 경우 이 공지에 따라 필수 업데이트를 적용하십시오. Internet Explorer를 설치한 경우 [MS12-037](https://go.microsoft.com/fwlink/?linkid=249045)에 따라 필수 업데이트를 적용하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [6월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-jun)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
<th style="border:1px solid black;" >TrueType 글꼴 구문 분석 취약점(CVE-2012-0159)</th>
<th style="border:1px solid black;" >Lync의 안전하지 않은 라이브러리 로드 취약점(CVE-2012-1849)</th>
<th style="border:1px solid black;" >HTML 삭제 취약점(CVE-2012-1858)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0159(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0159)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1849(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1849)를 참조하십시오.
...
예, 이 취약점은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다.
...
<a href="https://support.microsoft.com/kb/2708980">Microsoft 기술 자료 문서 2708980</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Lync 2010:<br />
<a href="https://support.microsoft.com/kb/2693282">Microsoft 기술 자료 문서 2693282</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Lync 2010 Attendee(관리자 수준 설치):<br />
<a href="https://support.microsoft.com/kb/2696031">Microsoft 기술 자료 문서 2696031</a> 참조<br />
<br />
Microsoft Lync 2010 Attendee(사용자 수준 설치):<br />
<a href="https://support.microsoft.com/kb/2693283">Microsoft 기술 자료 문서 2693283</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Lync 2010 Attendant(32비트 및 64비트):<br />
<a href="https://support.microsoft.com/kb/2702444">Microsoft 기술 자료 문서 2702444</a> 참조</td>
</tr>
<tr class="odd">
...
-   HTML 삭제 취약점(CVE-2012-1858)을 보고해 주신 [IBM Security Systems - Application Security](https://blog.watchfire.com/)의 Adi Cohen  
-   TrueType 글꼴 구문 분석 취약점(CVE-2012-0159)을 [Tipping Point](https://www.tippingpoint.com/)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Alin Rad Pop
