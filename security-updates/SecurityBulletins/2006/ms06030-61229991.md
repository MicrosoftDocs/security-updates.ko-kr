...
-   Microsoft Windows 2000 서비스 팩 4 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=6ec86784-6b12-410b-8068-028c58ed5df7)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=c17ddc07-204b-4a7f-8c5a-36b7865a030c)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=89fbbdd0-7504-4807-9337-08324aa457e7)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=%2043d69a41-6acb-4c64-89dc-2b9aef6e98fd)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=e1d13c18-72d1-40b8-95b3-08aef8db9213)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=b6018a61-b0ec-467e-9025-059d3c9f1c5f)
...
|-------------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| SMB 드라이버 권한 상승 취약점 - [CVE-2006-2373 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2373) | 권한 상승            | 중요         | 중요                   | 중요                   | 중요                | 중요                            |
| SMB 잘못된 핸들 취약점 - [CVE-2006-2374 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2374)        | 서비스 거부          | 보통         | 보통                   | 보통                   | 보통                | 보통                            |
...
MBSA에 대한 자세한 내용은 [MBSA 웹 사이트 (영문)](http://www.microsoft.com/technet/security/tools/mbsahome.mspx)를 방문하십시오. 현재 Microsoft Update와 MBSA 2.0으로 검색할 수 없는 소프트웨어에 대한 자세한 내용은 [Microsoft 기술 자료 문서 895660](http://support.microsoft.com/kb/895660)을 참조하십시오.
...
**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것이 바로 [서비스 거부](http://www.microsoft.com/korea/security/glossary.mspx) 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 응답을 중지하도록 만듭니다. 이 시간 동안 영향을 받는 시스템은 요청에 응답할 수 없습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 응답하지 않도록 만들 수 있습니다.
...
이 보안 업데이트는 Smb.sys 및 Rdbss.sys 파일 버전 5.2.3790.1830이 있는 시스템에서 핫패칭을 지원합니다. 핫패칭을 사용할 경우 Microsoft Windows Server 2003 서비스 팩 1을 실행하는 시스템에서 서버를 다시 시작하지 않고 보안 업데이트를 설치할 수 있습니다. 핫패칭에 대한 자세한 내용 및 핫패칭을 사용하여 보안 업데이트를 배포하는 방법은 [Microsoft 기술 자료 문서 897341](http://support.microsoft.com/kb/897341)을 참조하십시오.
...
만일 예전에 이 파일들 중 하나를 업데이트하기 위해 핫픽스를 설치했다면 그 설치 프로그램은 RTMQFE, SP1QFE, 또는 SP2QFE 파일을 귀하의 시스템에 복사합니다. 그렇지 않으면 RTMGDR, SP1GDR, 또는 SP2GDR 파일을 복사합니다. 보안 업데이트는 이 파일들의 모든 변화 사항들을 포함하고 있지 않을 수도 있습니다. 이 행위에 대한 좀 더 자세한 정보는 [Microsoft 기술 자료 문서 824994](http://support.microsoft.com/kb/824994)를 보시기 바랍니다.
...
-   SMB 권한 상승 취약점 - CVE-2006-2373을 보고에 [iDEFENSE (영문)](http://www.idefense.com/)와 협조해주신 [Rubén Santamarta (영문)](http://www.reversemode.com/)
-   SMB 잘못된 핸들 취약점 - CVE-2006-2374를 보고에 [iDEFENSE (영문)](http://www.idefense.com/)와 협조해주신 [Rubén Santamarta (영문)](http://www.reversemode.com/)
