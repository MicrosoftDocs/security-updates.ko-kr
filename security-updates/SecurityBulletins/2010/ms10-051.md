...
|--------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Windows XP 서비스 팩 3                                 | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=dbdbbe5e-2ef9-4704-80c4-27ef28fd95ef&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows XP Professional x64 Edition 서비스 팩 2        | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=4d4e8eeb-a0b2-41c6-9ee4-3f4beb44195e)                | 원격 코드 실행 | 긴급        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Server 2003 서비스 팩 2                        | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=31ce233e-4d2d-404b-84a8-683319ba8ef7&displaylang=ko) | 원격 코드 실행 | 보통        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Server 2003 x64 Edition 서비스 팩 2            | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=4d784b57-8564-4e7e-8f61-f897398e7ea5&displaylang=ko) | 원격 코드 실행 | 보통        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Server 2003 SP2(Itanium 기반 시스템용)         | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=d87ac8b3-41fb-4cdd-b305-181a0024d85c)                | 원격 코드 실행 | 보통        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Vista 서비스 팩 1                              | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=bbfaadf8-ab38-456c-956a-ea18c64236c9&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Vista 서비스 팩 2                              | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=bbfaadf8-ab38-456c-956a-ea18c64236c9&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| Windows Vista x64 Edition 서비스 팩 1                  | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=577131cd-1229-4746-89d7-84d75f29e1f0&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Vista x64 Edition 서비스 팩 2                  | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=577131cd-1229-4746-89d7-84d75f29e1f0&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| Windows Server 2008(32비트 시스템용)\*                 | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=73b5f45c-c9d6-491f-8483-98838b2a7c04&displaylang=ko) | 원격 코드 실행 | 보통        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Server 2008(32비트 시스템용) 서비스 팩 2\*     | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=73b5f45c-c9d6-491f-8483-98838b2a7c04&displaylang=ko) | 원격 코드 실행 | 보통        | 없음                                                                |
| Windows Server 2008(x64 기반 시스템용)\*               | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=43ece408-4aa7-4819-b3f6-7f0719ed3213&displaylang=ko) | 원격 코드 실행 | 보통        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Server 2008(x64 기반 시스템용) 서비스 팩 2\*   | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=43ece408-4aa7-4819-b3f6-7f0719ed3213&displaylang=ko) | 원격 코드 실행 | 보통        | 없음                                                                |
| Windows Server 2008(Itanium 기반 시스템용)             | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=b6faee94-e821-432d-bfa2-9008664566af)                | 원격 코드 실행 | 보통        | [MS08-069](http://technet.microsoft.com/security/bulletin/ms08-069) |
| Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2 | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=b6faee94-e821-432d-bfa2-9008664566af)                | 원격 코드 실행 | 보통        | 없음                                                                |
| Windows 7(32비트 시스템용)                             | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=31d0f5ac-2cff-42a1-8f18-128bbfc4e57d&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| Windows 7(x64 기반 시스템용)                           | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=a4f6d7c2-b475-4900-82f0-75f5be0b7b63&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| Windows Server 2008 R2(x64 기반 시스템용)\*            | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=a48cdac5-4d78-49b5-a6d8-ecf6c58cace2&displaylang=ko) | 원격 코드 실행 | 보통        | 없음                                                                |
| Windows Server 2008 R2(Itanium 기반 시스템용)          | [Microsoft XML Core Services 3.0](http://www.microsoft.com/downloads/details.aspx?familyid=b4d3210e-f3ad-4dbb-9390-6e98eeb99eaa)                | 원격 코드 실행 | 보통        | 없음                                                                |
