...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=92234237-a8eb-4ce4-bc5e-cd86feb7dbd3&displaylang=ko)               | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=b8e7bf17-a037-4200-9ae2-2280b19766a4&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b8d83f30-9cd7-4d6b-b2b9-65d0a483cb9c)                 | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cb2e203-18fb-4887-a1c9-289d86b8ba11&displaylang=ko)                  | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=90360537-9311-45e2-8047-9a971f90c3c3&displaylang=ko)      | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=d695ca9f-a1db-4c0f-94b6-7112861c28da)                  | 원격 코드 실행 | 긴급        | 없음                      |
...
URL 유효성 검사 취약점(CVE-2010-0027)은 사용자 시스템에 설치된 Microsoft Windows 버전 및 Internet Explorer 버전에 따라 이 업데이트(MS10-007)를 적용하거나 [Internet Explorer 누적 보안 업데이트(MS10-002)](http://technet.microsoft.com/security/bulletin/ms10-002)를 적용하여 해결합니다.
...
**ShellExecute란 무엇입니까?**    
ShellExecute는 Windows Shell API(응용 프로그래밍 인터페이스) 기능의 일부로 특정 파일에서 작업을 수행합니다. 예를 들어, 이를 통해 특정 파일 유형에 대한 정확한 처리기가 실행될 수 있습니다. ShellExecute 기능에 대한 자세한 내용은 MSDN 문서 [ShellExecute 기능 (영문)](http://msdn.microsoft.com/en-us/library/bb762153(vs.85).aspx)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 975713](http://support.microsoft.com/kb/975713) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/975713">Microsoft 기술 자료 문서 975713</a> 참조</td>
</tr>
<tr class="even">
...
-   [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 URL 유효성 검사 취약점(CVE-2010-0027)을 보고해 주신 Brett Moore
-   URL 유효성 검사 취약점(CVE-2010-0027)을 보고해 주신 [Lostmon Lords (영문)](http://lostmon.blogspot.com/)
