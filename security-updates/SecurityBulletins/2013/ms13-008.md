...
이 보안 업데이트는 [Microsoft 보안 권고 2794220](http://technet.microsoft.com/security/advisory/2794220)에서 처음 설명한 취약점도 해결합니다.
...
호환성 문제를 방지하기 위해 최신 Internet Explorer 누적 보안 업데이트 [MS12-077](http://go.microsoft.com/fwlink/?linkid=268393)이 설치되어 있는지 확인하십시오.

Microsoft 보안 권고 2794220의 Internet Explorer에 대한 Microsoft Fix it 자동화 솔루션 을 적용한 경우 이 업데이트를 적용하기 전에 해당 대안을 실행 취소해야 합니까?  
[Microsoft 보안 권고 2794220](http://technet.microsoft.com/security/advisory/2794220)의 Microsoft Fix it 솔루션 "MSHTML Shim 대안"을 구현한 고객은 이 업데이트를 적용하기 전에 Microsoft Fix it 솔루션을 취소할 필요가 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4792](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792)(영문)를 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 R2 및 Windows Server 2012의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/library/dd883248)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 항목을 참조하십시오.
...
-   이 문제점의 악용을 방지할 수 있는 Microsoft Fix it 솔루션 "MSHTML Shim 대안" 적용
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2799329](http://support.microsoft.com/kb/2799329)를 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) [CVE-2012-4792](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792)(영문)가 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2794220](http://technet.microsoft.com/security/advisory/2794220)에서 처음 설명되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2799329">Microsoft 기술 자료 문서 2799329</a> 참조</td>
</tr>
<tr class="even">
