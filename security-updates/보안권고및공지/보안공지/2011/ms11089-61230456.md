...
CVE-2011-1983의 공격은 영향을 받는 Microsoft Word 버전을 통해서만 진행되지만 취약한 코드가 Microsoft Office의 공유 구성 요소에 포함되어 있습니다. 지원 대상인 일부 Microsoft Visio([KB2553374(x86)](http://www.microsoft.com/downloads/details.aspx?familyid=20a9e33e-079d-4522-8cff-6a284d842979), [KB2553374 (x64)](http://www.microsoft.com/downloads/details.aspx?familyid=866f0a93-01a9-4e0a-8bf8-aa4dffce6c15) 참조), Microsoft Visio Viewer([KB2553353(x86)](http://www.microsoft.com/downloads/details.aspx?familyid=d8db143f-bc08-466e-81bb-2efef1d8a68d), [KB2553353 (x64)](http://www.microsoft.com/downloads/details.aspx?familyid=dee2c20c-0afd-4ebe-aabb-66593c76adf3) 참조), Microsoft Office WAC(Web Application Companions)([KB2553153](http://www.microsoft.com/downloads/details.aspx?familyid=f7e2fb4c-a883-4517-8c6d-740a69845fe8) 참조), Microsoft SharePoint Server 2010([KB2553132](http://www.microsoft.com/downloads/details.aspx?familyid=e03b4a55-810e-4503-8236-2e1a33ec3e7d) 참조)을 비롯한 기타 Microsoft Office 소프트웨어에 Microsoft Office의 취약한 공유 구성 요소가 포함되어 있지만 이 취약한 코드에 액세스하지 않으므로 이 취약점의 영향을 받지 않습니다. 그러나 취약한 코드가 있는 것이 사실이기 때문에 이 업데이트가 제공되는 것입니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1983(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1983)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2596785">Microsoft 기술 자료 문서 2596785</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2589320">Microsoft 기술 자료 문서 2589320</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office for Mac 2011 14.1.4 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=3c8017d6-232c-42a6-a133-96efe3ad3385)에서 다운로드하여 설치하십시오.
...
-   [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/)와 협력하여 Word 해제 후 사용 취약점(CVE-2011-1983)을 보고해 주신 Nikita Tarakanov(CISS Research Team) 및 Alexey Sintsov(Digital Security Research Group)
