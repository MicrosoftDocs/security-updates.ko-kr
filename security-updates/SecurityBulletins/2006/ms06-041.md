...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=144408a7-3011-458a-bc79-49b1658aa25d&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c332b95a-2956-406b-9e06-07c5e96b02e3&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=1be5310b-1995-4ef9-a462-04da9833f50b)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=6d027e72-1f94-44de-95f9-f52000a991cc&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=18477016-0b70-4c86-90c7-3535d365b7c1)
-   Microsoft Windows Server 2003 x64 Edition — [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=583b741c-47e2-429d-9d50-44670bb2f452)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Winsock 호스트 이름 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3440">CVE-2006-3440 (영문)</a></td>
...
<tr class="even">
<td style="border:1px solid black;">DNS 클라이언트 버퍼 오버런 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3441">CVE-2006-3441 (영문)</a></td>
...
**Winsock이란 무엇입니까?**  
Windows Sockets 2(Winsock)는 프로그래머가 고급 인터넷, 인트라넷 및 기타 네트워크 지원 응용 프로그램을 작성하여 사용 중인 네트워크 프로토콜과 독립적으로 네트워크를 통해 응용 프로그램 데이터를 전송할 수 있도록 지원합니다. Winsock을 통해 프로그래머는 멀티캐스트 및 QOS(Quality of Service)와 같은 고급 Microsoft® Windows® 네트워킹 기능에 대한 액세스 권한을 제공 받습니다. Winsock에 대한 자세한 내용은 [MSDN 문서 (영문)](https://windowssdk.msdn.microsoft.com/en-us/library/ms740673.aspx)를 참조하십시오.
...
**DNS란 무엇입니까?**  
DNS(도메인 이름 시스템) 클라이언트 서비스는 DNS 이름을 확인하여 캐시합니다. DNS 클라이언트 서비스는 DNS 이름 확인을 수행하는 모든 컴퓨터에서 실행되어야 합니다. DNS 이름을 확인하는 기능은 Active Directory 도메인에서 도메인 컨트롤러의 위치를 찾는 데 매우 중요합니다. 또한, DNS 클라이언트 서비스도 DNS 이름 확인을 사용해 확인된 장치를 찾는 데 중요한 역할을 합니다. DNS 클라이언트 서비스에 대한 자세한 내용은 [Microsoft TechNet 문서 (영문)](https://technet2.microsoft.com/windowsserver/en/library/6715556b-dfe4-41c4-87a9-333d22e473b21033.mspx?mfr=true)를 참조하십시오.
...
-   Winsock 호스트 이름 취약점(CVE-2006-3440)을 보고해 주신 [NGS Software (영문)](https://www.ngssoftware.com/index.htm)의 Peter Winter Smith
-   DNS 클라이언트 버퍼 오버런 취약점(CVE-2006-3441)을 보고해 주신 [ISS X-Force (영문)](https://www.iss.net/)의 연구자 Mark Dowd
