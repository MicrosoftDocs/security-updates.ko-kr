...
**보안 업데이트 대체:** 이 게시판은 [**MS03-025**](https://www.microsoft.com/korea/technet/security/bulletin/ms03-025.asp)를 대체합니다. 자세한 내용은 아래의 FAQ를 참조하십시오.
...
-   Microsoft Windows 2000 서비스 팩 2, Microsoft Windows 2000 서비스 팩 3 및 Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=94cd9925-d99b-4cb6-b51e-248d4fd8af07&displaylang=ko)
...
이 업데이트는 새로 발견되어 개인적으로 보고된 취약점을 해결합니다. 유틸리티 관리자가 응용 프로그램을 실행하는 방식에 [권한 상승 (US)](https://go.microsoft.com/fwlink/?linkid=21142) 취약점이 존재합니다. 로그온한 사용자는 유틸리티 관리자에서 강제로 시스템 권한이 있는 응용 프로그램을 시작하여 시스템에 대한 전체 제어 권한을 얻을 수 있습니다. 취약점은 이 게시판의 취약점 세부 사항에 설명되어 있습니다.
...
|----------------------------------------------------------------------------------------------------------------|----------------------|--------------|
| 유틸리티 관리자 취약점 - [CAN-2004-0213 (US)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0213) | 권한 상승            | 중요         |
...
|---------------------------------------------------------------------------------------|----------------|--------------|----------------|---------------------|
| [**MS03-025**](https://www.microsoft.com/korea/technet/security/bulletin/ms03-025.asp) | 해당 사항 없음 | 대체됨       | 해당 사항 없음 | 해당 사항 없음      |
...
**참고** 2004년 4월 20일 후 MBSA 1.1.1과 이전 버전에서 사용되는 Mssecure.xml 파일은 새로운 보안 게시판 데이터로 더 이상 업데이트되지 않고 있습니다. 따라서 이 날짜 이후에 MBSA 1.1.1이나 이전 버전으로 수행되는 검색은 완전하지 않습니다. 모든 사용자는 더욱 정확한 보안 업데이트 검색 기능을 제공하고 추가 제품을 지원하는 MBSA 1.2로 업그레이드해야 합니다. MBSA 1.2는 [MBSA 웹 사이트](https://www.microsoft.com/korea/technet/security/tools/tools/mbsahome.asp)에서 다운로드할 수 있습니다. MBSA 지원에 대한 자세한 내용은 [Microsoft Baseline Security Analyzer 1.2 Q&A 웹 사이트 (US)](https://www.microsoft.com/technet/security/tools/mbsaqa.mspx)를 참조하십시오.
...
유틸리티 관리자가 응용 프로그램을 실행하는 방식에 [권한 상승 (US)](https://go.microsoft.com/fwlink/?linkid=21142) 취약점이 존재합니다. 로그온한 사용자는 유틸리티 관리자에서 강제로 시스템 권한이 있는 응용 프로그램을 시작하여 시스템에 대한 전체 제어 권한을 얻을 수 있습니다.
...
-   [Windows 2000 Hardening Guide (US)](https://www.microsoft.com/download/details.aspx?familyid=15e83186-a2c8-4c8f-a9d0-a0201f639a56&displaylang=en)에서는 유틸리티 관리자 서비스를 비활성화할 것을 권장하고 있습니다. 이 지침을 따르면 이 취약점으로 인한 공격의 가능성을 줄일 수 있습니다.
...
유틸리티 관리자는 공격 도구로 사용될 수 있으므로 그룹 정책 설정을 사용하여 비활성화합니다. 유틸리티 관리자 프로세스 이름은 Utilman.exe입니다. 다음 지침은 [그룹 정책](https://www.microsoft.com/korea/windows2000/techinfo/howitworks/management/grouppolwp.asp) 설정을 사용하여 사용자들이 승인된 응용 프로그램만 실행할 수 있게 하는 방법에 대한 정보를 제공합니다.

**참고** [Windows 2000 Hardening Guide (US)](https://www.microsoft.com/download/details.aspx?familyid=15e83186-a2c8-4c8f-a9d0-a0201f639a56&displaylang=en)도 참조하십시오. 이 안내서에는 유틸리티 관리자를 비활성화하는 방법에 대한 정보가 포함되어 있습니다.

**대안의 영향:** 유틸리티 관리자를 통해 운영 체제의 내게 필요한 옵션 기능 중 많은 것들을 쉽게 사용할 수 있습니다. 제한 사항을 제거할 때까지는 이러한 액세스 기능을 사용할 수 없습니다. 내게 필요한 옵션 기능을 수동으로 시작하는 방법에 대한 자세한 내용은 [여기 (US)](https://www.microsoft.com/enable/training/windows2000/default.aspx)를 참조하십시오.

#### 유틸리티 관리자 취약점 - CAN-2004-0213에 대한 FAQ:

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것은 [권한 상승 (US)](https://go.microsoft.com/fwlink/?linkid=21142) 취약점입니다. 이 취약점을 성공적으로 악용하는 경우 침입자는 프로그램 설치, 데이터 보기, 변경 또는 삭제, 모든 권한을 가진 새 계정 만들기 등의 작업을 포함하여 해당 시스템을 완전히 제어할 수 있습니다.

**취약점의 원인은 무엇입니까?**  
유틸리티 관리자가 응용 프로그램을 시작하기 위해 사용하는 프로세스가 원인입니다. 유틸리티 관리자는 시스템 권한이 있는 응용 프로그램을 시작할 수 있습니다.

**유틸리티 관리자란 무엇입니까?**  
유틸리티 관리자는 내게 필요한 옵션 프로그램(예: Microsoft 돋보기, 내레이터, 화상 키보드 등)의 상태를 확인하고 프로그램을 시작하거나 중지할 수 있는 [내게 필요한 옵션 유틸리티 (US)](https://www.microsoft.com/enable/at/default.aspx)입니다.
...
-   유틸리티 관리자의 취약점(CAN-2004-0213)을 보고해 주신 [Application Security Inc. (US)](https://www.appsecinc.com)의 Cesar Cerrudo님
...
-   각 사용자 플랫폼에 해당하는 업데이트는 [Windows Update](https://windowsupdate.microsoft.com/) 웹 사이트 에서 구할 수 있습니다.
