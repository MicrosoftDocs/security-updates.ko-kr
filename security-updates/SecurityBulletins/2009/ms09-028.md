...
이 보안 업데이트는 [Microsoft 보안 권고 971778](https://technet.microsoft.com/security/advisory/971778)에서 처음 설명한 취약점도 해결합니다.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 971633](https://support.microsoft.com/kb/971633)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1537 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1537)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1538 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1538)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1539 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1539)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971633">Microsoft 기술 자료 문서 971633</a> 참조</td>
</tr>
<tr class="even">
...
-   DirectX 널 바이트 덮어쓰기 취약점(CVE-2009-1537)을 보고해 주신 [SkyRecon (영문)](https://www.skyrecon.com/)의 Thomas Garnier 및 [Qihoo 360 Security Center (영문)](https://www.360.cn/)의 Zheng Wenbin, Liu Qi 및 Song Shenlei
-   DirectX 포인터 유효성 검사 취약점(CVE-2009-1538)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li
-   DirectX 크기 유효성 검사 취약점(CVE-2009-1539)을 TippingPoint의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/), [SkyRecon (영문)](https://www.skyrecon.com/)의 Thomas Garnier 및 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li와 협력하여 보고해 주신 [TippingPoint DVLabs (영문)](https://dvlabs.tippingpoint.com/)의 Aaron Portnoy 및 익명 연구자
