...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2698365](http://support.microsoft.com/kb/2698365)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<sup>[1]</sup>또한 KB2698365 업데이트는 Windows Data Access Components 6.1에도 적용됩니다. [KB2640696](http://www.microsoft.com/download/details.aspx?id=28422) 업데이트를 설치한 고객은 Windows Data Access Components 6.1을 자신의 시스템에 설치한 뒤 KB2698365 업데이트를 설치하여 취약점을 해결해야 합니다.
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트에 대한 해시 정보는 [Microsoft 기술 자료 문서 2698365](http://support.microsoft.com/kb/2698365)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2698365">Microsoft 기술 자료 문서 2698365</a> 참조</td>
</tr>
<tr class="even">
...
-   ADO Cachesize 힙 오버플로 RCE 취약점(CVE-2012-1891)을 [TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
