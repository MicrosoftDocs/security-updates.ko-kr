---
TOCTitle: 'MS11-085'
Title: 'Microsoft 보안 공지 MS11-085 - 중요'
ms:assetid: 'ms11-085'
ms:contentKeyID: 61230452
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-085(v=Security.10)'
---


Microsoft 보안 공지 MS11-085 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows Vista 에디션에 대해 중요이며, 지원 대상인 모든 Windows Server 2008 에디션에 대해 보통이며, 지원 대상인 모든 Windows 7 및 Windows Server 2008 R2 에디션에 대해 낮음입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 Windows Mail 및 Windows Meeting Space에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524&displaylang=ko)                                                                              | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38&displaylang=ko)                                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc&displaylang=ko)\*\*                                                   | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9&displaylang=ko)\*\*                                                 | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                                | 원격 코드 실행 | 보통        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9&displaylang=ko)                                   | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960&displaylang=ko)                               | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5&displaylang=ko)\*\* | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1)            | 원격 코드 실행 | 낮음        | 없음                      |
...
Windows Server 2008의 Desktop Experience란 무엇입니까?  
Windows Server 2008에 기본적으로 설치되지 않는 Windows Mail 등의 다양한 데스크톱 기능이 있습니다. 대신 Windows Server 2008에 Desktop Experience를 설치하여 이런 기능을 모두 함께 설치할 수 있습니다. 자세한 내용은 TechNet 문서, [Windows Mail, Windows Media Player 및 기타 Windows Server 2008의 Desktop Experience에 포함된 기능](https://technet.microsoft.com/ko-kr/library/cc771519(ws.10).aspx)을 참조하십시오.

Desktop Experience의 설치 여부에 상관없이 이 업데이트를 Windows Server 2008 시스템에 제공하는 이유는 무엇입니까?  
Desktop Experience의 설치 여부에 상관없이 Windows Server 2008 설치 파일에 취약한 코드가 존재합니다. 취약한 코드가 있는 것이 사실이기 때문에 업데이트가 제공되는 것입니다.

다른 한편으로, 이 취약점을 악용하기 위한 공격 경로가 Windows Mail과 Windows Meeting Space를 통합니다. 기본적으로 Windows Server 2008에는 Windows Meeting Space와 Windows Mail이 설치되지 않습니다. Windows Meeting Space와 Windows Mail이 설치되지 않는 시스템에서는 취약한 코드에 액세스하지 않습니다.

Windows Server 2008에 Desktop Experience를 설치하면 Windows Mail을 설치할 수 있습니다. Windows Server 2008 사용자는 이 업데이트를 적용하여 공격 경로로 사용될 수 있는 가능성을 차단하는 것이 좋습니다.

Windows 7 및 Windows Server 2008 R2 시스템에 대한 심각도가 더 낮은 이유는 무엇입니까?  
Windows 7 및 Windows Server 2008 R2에 취약한 코드가 존재하지만, Microsoft는 이런 운영 체제에서 이 취약점이 악용될 수 있는 공격 경로에 대해 보고 받은 바 없습니다. 그래도 이런 운영 체제의 사용자는 심층 보안 대응책으로 이 업데이트를 적용하는 것이 좋습니다.

심층 보안이란 무엇입니까?  
정보 보안에서, 심층 보안이란 공격자가 네트워크 또는 시스템의 보안을 침해하지 못하게 하기 위해 여러 계층의 방어 기전을 배치하는 접근 방식을 의미합니다.

Windows Live Mail 또는 Outlook Express와 같은 다른 메일 클라이언트가 이 문제의 영향을 받습니까?  
아니요. 이 취약점은 영향을 받는 소프트웨어 표에 나열된 운영 체제에 있는 Windows Mail 클라이언트에만 영향을 줍니다. 다른 메일 클라이언트는 전혀 영향을 받지 않습니다.
...
<th style="border:1px solid black;" >Windows Mail의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2016)</th>
...
Windows Mail의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2016)  
------------------------------------------------------------------
  
Windows Mail 및 Windows Meeting Space에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2016(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016)을 참조하십시오.
  
#### Windows Mail의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2016)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격에 성공하려면, 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문하거나 이러한 위치에서 취약한 응용 프로그램이 로드되는 합법적인 파일(예: .eml 또는 .wcinv 파일)을 열어야 합니다.  
...
-   Windows Server 2008에서는 Windows Mail과 Windows Meeting Space가 기본적으로 설치되지 않습니다. Windows Mail은 Desktop Experience도 설치되어 있을 때만 설치됩니다.  
-   Windows 7 및 Windows Server 2008 R2에 취약한 코드가 존재하지만, Microsoft는 이런 운영 체제에서 이 취약점이 악용될 수 있는 공격 경로에 대해 보고 받은 바 없습니다.
  
#### Windows Mail의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2016)에 대한 대안
...
#### Windows Mail의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2016)에 대한 FAQ
...
취약점의 원인은 무엇입니까?   
이 취약점은 Windows Mail 및 Windows Meeting Space가 외부 라이브러리를 로드할 때 경로를 부적절하게 제안하기 때문에 발생합니다.
  
Windows Mail이란 무엇입니까?   
Windows Mail(이전의 Outlook Express)은 Windows에서 사용할 수 있는 온라인 통신 도구입니다.
  
Windows Meeting Space란 무엇입니까?   
Windows Meeting Space를 사용하면 Windows Vista 운영 체제가 설치된 컴퓨터를 보유한 다른 사용자와 문서, 프로그램 또는 데스크톱을 공유할 수 있습니다. Windows Meeting Space에서는 P2P(Peer-to-Peer) 기술을 사용하고 기존 네트워크를 찾을 수 없는 경우 ad-hoc 네트워크를 자동으로 설정합니다. 자세한 내용은 [Windows Meeting Space FAQ](https://windows.microsoft.com/ko-kr/windows-vista/windows-meeting-space-frequently-asked-questions)를 참조하십시오.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 파일(예: .eml 또는 .wcinv 파일)을 열도록 유도할 수 있습니다. 이렇게 하면 합법적인 파일을 열 때 Windows Mail 또는 Windows Meeting Space가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 파일(예: .eml 또는 .wcinv 파일)을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 합법적인 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 이렇게 하면 합법적인 파일을 열 때 Windows Mail 또는 Windows Meeting Space가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
네트워크 공격 시나리오에서 공격자는 합법적인 파일(예: .eml 또는 .wcinv 파일) 및 특수하게 조작된 DLL 파일을 네트워크 공유, UNC 또는 WebDAV 위치에 두고 사용자가 파일을 열도록 유도할 수 있습니다.
  
취약점으로 인해 위험에 노출되는 시스템은 주로 무엇입니까?   
워크스테이션 및 터미널 서버를 포함해 Windows Mail 또는 Windows Meeting Space가 사용되는 시스템이 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
업데이트는 어떤 기능을 수행합니까?   
업데이트는 Windows Mail 및 Windows Meeting Space에서 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2620704">Microsoft 기술 자료 문서 2620704</a> 참조</td>
</tr>
<tr class="odd">
...
-   Windows Mail의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-2016)을 보고해 주신 EvilCode의 Ivan Sanchez
