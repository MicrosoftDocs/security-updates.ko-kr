...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 서비스 팩 4 | [Windows Media Player 9 시리즈](http://www.microsoft.com/downloads/details.aspx?familyid=c0b8b362-a321-4ac9-be98-15c71bb7a043&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS07-047](http://technet.microsoft.com/security/bulletin/ms07-047) |
| Windows XP 서비스 팩 2             | [Windows Media Player 9 시리즈](http://www.microsoft.com/downloads/details.aspx?familyid=5c748c6d-84d1-45a9-8a33-9372eb5504d5&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS07-047](http://technet.microsoft.com/security/bulletin/ms07-047) |
| Windows XP 서비스 팩 3             | [Windows Media Player 9 시리즈](http://www.microsoft.com/downloads/details.aspx?familyid=9e4277b4-2dc5-4163-a6aa-7e07dd32b721&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0268 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268)을 참조하십시오.
...
시스템에 설치된 Windows Media Player의 버전을 확인하는 방법은 [Microsoft 기술 자료 문서](http://support.microsoft.com/kb/190990) 190990을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/979402">Microsoft 기술 자료 문서 979402</a> 참조</td>
</tr>
<tr class="even">
...
-   Media Player 원격 코드 실행 취약점(CVE-2010-0268)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
