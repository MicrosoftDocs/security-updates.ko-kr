---
TOCTitle: 'MS09-026'
Title: 'Microsoft 보안 공지 MS09-026 - 중요'
ms:assetid: 'ms09-026'
ms:contentKeyID: 61230212
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-026(v=Security.10)'
---


Microsoft 보안 공지 MS09-026 - 중요
===================================
...
이 업데이트는 RPC 마샬링 엔진이 내부 상태를 업데이트하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac&displaylang=ko)                                                             | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40&displaylang=ko)                                                                         | 권한 상승      | 중요        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55)                                                               | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f)                                                                | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214&displaylang=ko)                                                                                  | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214&displaylang=ko)                                         | 권한 상승      | 중요        | 없음                                                                |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS07-058](https://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd&displaylang=ko)                 | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca&displaylang=ko)\*     | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e&displaylang=ko)\* | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f33012b9-5d5b-4f72-8d49-a8e1c8bc1337)          | 권한 상승      | 중요        | 없음                                                                |
...
<th style="border:1px solid black;" >RPC 마샬링 엔진 취약점(CVE-2009-0568)</th>
...
RPC 마샬링 엔진 취약점(CVE-2009-0568)  
-------------------------------------
  
Windows RPC(원격 프로시저 호출) 기능에 RPM 마샬링 엔진이 내부 상태를 적절히 업데이트하지 못하는 권한 상승 취약점이 존재합니다. 내부 상태를 업데이트하지 못하면 잘못된 위치에서 포인터가 읽힐 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0568 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)을 참조하십시오.
  
#### RPC 마샬링 엔진 취약점(CVE-2009-0568)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   지원되는 Microsoft Windows 에디션에는 이 취약점이 악용될 때 영향을 받는 RPC 서버 또는 클라이언트가 포함되어 있지 않습니다. 기본 구성에서는 이 취약점의 악용되어도 사용자는 공격을 받지 않지만 Microsoft Windows RPC 런타임에 취약점이 있어 타사 RPC 응용 프로그램에 영향을 미칠 수 있습니다.
  
#### RPC 마샬링 엔진 취약점(CVE-2009-0568)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### RPC 마샬링 엔진 취약점(CVE-2009-0568)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 RPC(원격 프로시저 호출) 마샬링 엔진이 내부 상태를 적절히 업데이트하지 않을 때 발생합니다. 이와 같이 업데이트하지 못하면 잘못된 위치에서 포인터가 읽힐 수 있습니다. 규정을 준수하지 않는 다양한 배열을 포함하는 IDL(Interface Definition Language)은 이 문제로 인해 영향을 받을 수 있습니다.
  
**어떤 RPC 응용 프로그램이 이 취약점의 영향을 받을 수 있습니까?**    
응용 프로그램이 이 문제의 영향을 받는지 여부를 확인하기 위해서는 클라이언트 또는 서버 응용 프로그램을 컴파일하는 데 사용되는 IDL 파일에 액세스할 수 있어야 합니다. 결과로 생성된 스텁에 FC\_SMVARRAY 또는 FC\_LGVARRAY와 FC\_VARIABLE REPEAT 및 FC\_VARIABLE\_OFFSET이 포함되어 있는 경우 RPC 응용 프로그램은 이 취약점의 악용에 취약할 수 있습니다.
  
**RPC(원격 프로시저 호출)란 무엇입니까?**    
Microsoft RPC(원격 프로시저 호출)는 다른 프로세스에 있는 데이터의 교환 및 기능의 호출을 가능하게 하는 IPC(프로세스 간 통신) 메커니즘입니다. 이 프로세스는 동일한 컴퓨터에, LAN(Local Area Network)에 또는 인터넷상에 있을 수 있습니다. Microsoft RPC 메커니즘은 명명된 파이프, NetBIOS 또는 Winsock 등의 다른 IPC 메커니즘을 사용하여 클라이언트와 서버 간에 통신을 설정합니다. RPC를 사용할 경우 필수적인 프로그램 로직 및 관련 프로시저 코드가 여러 컴퓨터에 분산되어 있을 수 있으며, 이러한 기능은 분산 응용 프로그램에서 아주 중요합니다. 자세한 내용은 TechNet 문서 [RPC란 무엇입니까? (영문)](https://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx)를 참조하십시오.
  
**RPC 마샬링 엔진이란 무엇입니까?**    
NDR이라고도 하는 RPC 마샬링 엔진은 RPC 클라이언트와 서버 간에 공통 RPC 인터페이스를 제공합니다. NDR20은 32비트 아키텍처에 사용되고, NDR64는 64비트 아키텍처용으로 최적화되어 있습니다. 프로그램 아키텍처에 관계없이 클라이언트 쪽과 서버 쪽 모두에 동일한 마샬링 엔진이 사용됩니다. 클라이언트와 서버는 통신에 사용되는 마샬링 엔진을 협상합니다.
  
**IDL(Interface Definition Language) 파일 및 ACF(응용 프로그램 구성 파일)는 무엇입니까?**    
IDL(Interface Definition Language) 파일은 클라이언트 및 서버 프로그램 간의 인터페이스 설명을 포함합니다. RPC 응용 프로그램은 ACF(응용 프로그램 구성 파일)를 사용하여 특정 운영 환경을 구성하는 하드웨어 및 운영 체제에 관련된 인터페이스의 특성을 설명합니다. 이 정보를 두 개의 파일로 나누는 목적은 소프트웨어 인터페이스를 운영 환경에만 영향을 미치는 특성과 구분하기 위한 것입니다.
  
IDL 파일은 클라이언트와 서버 간에 전송되는 항목에 대한 네트워크 계약을 지정합니다. 이 정보를 운영 환경에 대한 정보와 분리하면 IDL 파일을 다른 환경으로 이식할 수 있습니다. IDL 파일은 [인터페이스 헤더 (영문)](https://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx)와 [인터페이스 본문 (영문)](https://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx)의 두 부분으로 구성됩니다.
  
ACF는 네트워크 계약이 아닌 로컬 성능에만 영향을 미치는 특성을 지정합니다. Microsoft RPC는 ACF 및 IDL 특성을 단일 IDL 파일에 조합할 수 있도록 합니다. 여러 인터페이스 및 해당 ACF를 단일 IDL 파일에 조합할 수도 있습니다. 자세한 내용은 MSDN 문서, [IDL 및 ACF 파일 (영문)](https://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx)을 참조하십시오.
  
**IPC(프로세스 간 통신)란 무엇입니까?**    
Microsoft Windows 운영 체제는 응용 프로그램 간의 통신 및 데이터 공유를 용이하게 하기 위한 메커니즘을 제공합니다. 이러한 메커니즘을 통해 사용할 수 있는 작업을 통틀어 IPC(프로세스 간 통신)라고 합니다. 여러 구체적인 프로세스에 작업 부하를 편리하게 분산할 수 있도록 하는 IPC 형식도 있고, 네트워크의 여러 컴퓨터에 작업 부하를 편리하게 분산할 수 있도록 하는 IPC 형식도 있습니다. 자세한 내용은 MSDN 문서, [프로세스 간 통신(영문)](https://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx)을 참조하십시오.
...
이 취약점을 악용하려는 공격자는 특수하게 조작된 RPC 메시지를 만들어 영향을 받는 TCP 또는 UDP 포트를 통해 영향을 받는 시스템에 메시지를 전송해야 합니다. 그러면 이 메시지는 클라이언트가 임의 데이터를 RPC 서버 주소 공간의 메모리에 쓸 수 있도록 합니다. 규정을 준수하지 않는 다양한 배열을 포함하는 IDL 인터페이스만 이 문제의 영향을 받습니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-0568 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)이 지정되었습니다.
...
Windows2000-KB970238-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-KB970238-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB970238$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/970238">Microsoft 기술 자료 문서 970238</a> 참조</td>
</tr>
<tr class="even">
...
WindowsXP-KB970238-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB970238-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB970238$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/970238">Microsoft 기술 자료 문서 970238</a> 참조</td>
...
WindowsServer2003-KB970238-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB970238-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB970238-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB970238-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
