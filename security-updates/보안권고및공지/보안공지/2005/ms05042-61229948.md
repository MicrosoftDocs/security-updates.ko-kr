...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=4e34cd17-8710-4e22-8620-3b84139c18bb&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=dd24f6fa-f6bb-4358-8c2f-7f6ab405981a&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=fb703dbd-3563-41fd-b608-361cc23796a5)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=34e7cf41-c584-4071-a36f-de19d0d04b97&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용) - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=037cd6d6-11f7-4c44-9cfb-4b6d0b9b93cb)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=b86e688c-b668-4841-b961-7c5412c525ec)
...
|-----------------------------------------------------------------------------------------------------------|----------------------|---------------------------|---------------------|------------|---------------------|
| Kerberos 취약점 - [CAN-2005-1981 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1981) | 서비스 거부          | 없음                      | 보통                | 없음       | 보통                |
| PKINIT 취약점 - [CAN-2005-1982 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1982)   | 정보 유출 및 스푸핑  | 낮음                      | 낮음                | 낮음       | 낮음                |
...
공격자가 특수하게 조작한 메시지를 Windows 도메인 컨트롤러에 보내 Active Directory 도메인에서 사용자 인증을 담당하는 서비스의 응답을 멈추게 할 수 있는 [서비스 거부](http://www.microsoft.com/korea/security/glossary/glossary_a_z.asp) 취약점이 존재합니다.
...
Windows 2000 이상의 운영 체제 버전은 Kerberos를 기본 인증 프로토콜로 사용합니다. Kerberos는 보안 사용자 인증을 제공합니다. 또한 업계 표준이므로 Kerberos는 상호 운용을 허용합니다. Active Directory 도메인 컨트롤러는 Kerberos 서비스 지원을 위해 사용자 계정과 로그온 정보를 유지합니다. 예를 들어, Kerberos는 [Active Directory (영문)](http://go.microsoft.com/fwlink/?linkid=21200)의 데이터에 액세스하는 데 사용되는 프로토콜입니다. Kerberos에 대한 자세한 내용은 다음 [Kerberos 인증 설명 웹 사이트 (영문)](http://www.microsoft.com/technet/prodtechnol/windows2000serv/maintain/security/kerberos.mspx) 또는 [TechNet 웹 사이트 (영문)](http://www.microsoft.com/technet/archive/security/news/kerb2000.mspx)를 참조하십시오.
...
-   공격자가 사용하는 계정과 이 공격 대상이 사용하는 계정에는 스마트 카드 인증에 사용할 수 있는 계정이 있어야 합니다. 기업 내에서 스마트 카드를 사용하는 데 필요한 단계에 대한 자세한 내용은 다음 [웹 사이트 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/b989f4fd-febd-42e1-a130-9e0f33800734.mspx)를 참조하십시오.
...
**PKINIT란 무엇입니까?**
PKINIT는 "Kerberos의 초기 인증을 위한 공개 키 암호화"를 위한 IETF(Internet Engineering Task Force) 인터넷 초안입니다. Windows 2000 이상은 IETF "Kerberos의 초기 인증을 위한 공개 키 암호화" 인터넷 초안의 초안 9를 사용합니다. Windows는 대화형 로그온을 위해 스마트 카드를 사용할 때 이 프로토콜을 사용합니다. IETF 인터넷 초안은 다음 [IETF 웹 사이트 (영문)](http://www.ietf.org)에서 볼 수 있습니다.
...
Arpidfix.exe는 보안 업데이트 설치 관리자가 [Microsoft 기술 자료 문서 904630 (영문)](http://support.microsoft.com/kb/904630)에서 설명하는 문제를 해결하는 데 사용합니다. 이 파일은 영향을 받는 시스템에 설치되지 않습니다.
...
-   Kerberos 취약점(CAN-2005-1981)을 보고해 주신 [Shell, Inc.](http://www.shell.com)의 [Tony Chin](mailto:tony.chin@shell.com)에게 감사드립니다.
