...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 944533](http://support.microsoft.com/kb/944533)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=1032a039-468b-4c5f-8c1c-5e54c2832e41&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=87e66dce-5060-4814-8754-829b4e190359&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=bb2aa3cb-021f-4890-ab20-2a51f8e17554&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=8989f576-8b30-4866-90ec-929d24f3b409&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=429b7ed1-fe78-459a-b834-d0f3c69cb703&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?familyid=e989e23c-38bb-4fe7-a830-d7bdf7659392&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=d4aa293a-6332-4c6c-b128-876f516bd030&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=b72af1b6-6e23-4005-aef6-82195b380153&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=b2aa6562-881e-4fd6-be1b-53426a0ff4a9&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=4bb99afc-be14-4f2e-9570-b7fe09e39131&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=0de25b98-f443-4874-a06f-4daae14c16b0&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?familyid=c08ebbe7-639b-4ea2-8304-fab531930abf&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 944533](http://support.microsoft.com/kb/944533)에 나와 있습니다.
...
아니요, [KB947518](http://support.microsoft.com/kb/947518) 업데이트는 이 보안 업데이트에 포함되어 있지 않습니다.  그러나 이후 Internet Explorer 누적 업데이트에는 [KB947518](http://support.microsoft.com/kb/947518)이 포함될 예정입니다. 현재 Internet Explorer에서는 "활성화하려면 클릭하십시오"라는 툴팁이 표시되는 일부 웹 페이지에서 컨트롤을 사용자가 수동으로 활성화해야 합니다. 이 "활성화하려면 클릭하십시오" 동작은 2008년 4월 이후 영구적으로 제거될 예정입니다.

**이 변경 사항에 대해 어떻게 준비해야 합니까?**    
IE 자동 구성 요소 활성화(IE ACA) 미리 보기를 사용하여 웹 사이트와 응용 프로그램을 테스트하도록 권장합니다. IE ACA 미리 보기([KB947518](http://support.microsoft.com/kb/947518))를 적용하려면 이 보안 업데이트를 먼저 적용해야 합니다. 이 변경 사항에 대한 추가 정보 및 상세한 가이드에 관심 있는 고객은 IE 자동 구성 요소 활성화 문서를 계속 모니터링하여 이 릴리스에 대해 업데이트되는 추가 정보를 확인하십시오.

**KB945007 'IE 자동 구성 요소 활성화 미리 보기'를 설치한 경우에도 KB947518 'IE 자동 구성 요소 활성화 미리 보기'를 설치해야 합니까?**    
예, 이 보안 업데이트를 설치한 다음 [KB947518](http://support.microsoft.com/kb/947518)을 설치해야 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0076 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0076)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0077 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0077)을 참조하십시오.
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](http://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역 보안 수준을 높음으로 설정합니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
...
예. 기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성](http://msdn2.microsoft.com/ko-kr/library/ms537180(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](http://go.microsoft.com/fwlink/?linkid=92055)도 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0078 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0078)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-4790 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-4790)을 참조하십시오.
...
이 공지의 영어 버전 파일은 [KB944533](http://support.microsoft.com/kb/944533)에 나열되어 있습니다. 이러한 파일의 날짜와 시간은 UTC(Coordinated Universal Time) 기준입니다. 파일 정보를 볼 때 로컬 시간으로 변환됩니다. UTC와 로컬 시간의 차이를 확인하려면 제어판의 날짜 및 시간 도구에서 **표준 시간대** 탭을 사용하십시오.

지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4, [KB944533](http://support.microsoft.com/kb/944533) 참조

지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1, [KB944533](http://support.microsoft.com/kb/944533) 참조
...
-   HTML 렌더링 메모리 손상 취약점(CVE-2008-0076)을 보고해 주신 [Security Objectives (영문)](http://www.microsoft.com/technet/security/bulletin/www.security-objectives.com)의 Shane Macaulay 및 Riley Hassell  
-   속성 메모리 손상 취약점(CVE-2008-0077)을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 협력해 주신 익명의 연구자  
-   속성 메모리 손상 취약점(CVE-2008-0077)에 대해 Microsoft와 협력해 주신 [VeriSign iDefense VCP (영문)](http://idefense.com/)의 hyy  
-   인수 처리 메모리 손상 취약점(CVE-2008-0078)을 보고해 주신 [Venustech (영문)](http://www.venustech.com.cn/)의 ADLABS
