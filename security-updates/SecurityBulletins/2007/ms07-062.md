...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=c80fcd9b-d0f8-44db-96fc-bf2ead054ff4&displaylang=ko)                                         | 스푸핑         | 중요        | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ed8e2cb4-bcd9-40fc-9ad6-46b364d0656d&displaylang=ko)                | 스푸핑         | 중요        | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d1323e14-ffa7-4d03-a2a7-9240c192a75e&displaylang=ko)    | 스푸핑         | 중요        | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=f3ad67de-85ad-452d-a1e0-0af3faf969d6) | 스푸핑         | 중요        | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3898 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3898)을 참조하십시오.
...
이 취약점은 재귀 조회를 수행하는 Windows DNS 서버에 해당됩니다. 재귀 쿼리에 대한 자세한 내용은 [DNS 쿼리 작동 방법 (영문)](https://technet2.microsoft.com/windowsserver/en/library/0bcd97e6-b75d-48ce-83ca-bf470573ebdc1033.mspx?mfr=true) Technet 문서를 참조하십시오.
...
-   DNS 스푸핑 공격 취약점(CVE-2007-3898)을 보고해 주신 [Scanit (영문)](https://www.scanit.be/)의 Alla Berzroutchko
-   DNS 스푸핑 공격 취약점(CVE-2007-3898)을 보고해 주신 [Trusteer (영문)](https://www.trusteer.com/)의 Amit Klein
