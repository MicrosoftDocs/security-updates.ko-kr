...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=543dc6a7-fa76-4ba9-81e4-25fdf2013548&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=7bcf3945-0552-478e-b7f3-bbca97dd1b5d&displaylang=ko)                                                          | 원격 코드 실행 | 긴급        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=25ef97e8-e76e-44c2-953c-f94cbac552cf)                                                                          | 원격 코드 실행 | 긴급        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=29ff72f7-1663-4f35-a794-2dfe3c17b39c&displaylang=ko)                                                                           | 원격 코드 실행 | 보통        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=d4a97bb7-4f74-4884-9a6e-7a4df9c540fb&displaylang=ko)                                                               | 원격 코드 실행 | 보통        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=b84f0be4-6d11-4b07-bb3c-2c76ae9ceea8)                                                                           | 원격 코드 실행 | 보통        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c897ddd-f441-41d4-b5b4-d794cfc96e6b&displaylang=ko)                                     | 원격 코드 실행 | 중요        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f349f7aa-d020-4e0d-a35f-518a63ec92df&displaylang=ko) | 원격 코드 실행 | 중요        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a85b1bf-7427-47d0-9e1b-21dbe824a62c&displaylang=ko)\*\*              | 원격 코드 실행 | 낮음        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=fde218c3-90ab-4664-852d-25ca55835054&displaylang=ko)\*\*          | 원격 코드 실행 | 낮음        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5b6e9451-df38-4626-bb1d-4fc160d7a40e)                     | 원격 코드 실행 | 낮음        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=ec6d996f-dffa-45ad-9467-e96a4ac63e5f&displaylang=ko)                                                                                | 원격 코드 실행 | 중요        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=b3265576-04c1-48b1-8ce9-128843c58cf5&displaylang=ko)                                                                              | 원격 코드 실행 | 중요        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=cda31c54-8b81-4185-a623-64480ad4b73c&displaylang=ko)\*\*                                                             | 원격 코드 실행 | 낮음        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=43fa4e26-160f-4aa3-a03d-b98a79666a18)                                                                            | 원격 코드 실행 | 낮음        | [MS09-055](http://technet.microsoft.com/security/bulletin/ms09-055) |
...
이 업데이트는 이전 Microsoft 보안 공지 [MS09-062](http://technet.microsoft.com/security/bulletin/ms09-062)에서 다룬 RSClientPrint ActiveX 컨트롤에 킬(kill) 비트를 설정합니다.

이 ActiveX 컨트롤에 관한 내용 및 컨트롤이 업데이트되는 방식에 대한 자세한 내용은 Microsoft 공지에서 [GDI+의 취약점으로 인한 원격 코드 실행 문제점(957488)](http://technet.microsoft.com/security/bulletin/ms09-062)을 검토하십시오.
...
-   [Symantec](http://www.symantec.com/)은 Symantec WinFax Pro 10.3을 위한 ActiveX 컨트롤용 킬(kill) 비트를 요청했습니다. Symantec이 권장하는, 컨트롤에 킬(kill) 비트를 설정하는 방법에 대한 자세한 내용은 게시물([http://go.microsoft.com/fwlink/?LinkID=169405 (영문)](http://go.microsoft.com/fwlink/?linkid=169405))을 참조하십시오. Symantec WinFax Pro 10.3 컨트롤용 킬(kill) 비트에 관한 질문 또는 문제가 있는 경우 Symantec Security(<secure@symantec.com>)로 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다:  
    -   {C05A1FBC-1413-11D1-B05F-00805F4945F6}.  
-   [Google](http://www.google.com/)은 Google Desktop Gadget v5.8을 위한 ActiveX 컨트롤용 킬(kill) 비트를 요청했습니다. Google Desktop Gadget Control v5.8에 관한 질문 또는 문제가 있는 경우 Google Security(<security@google.com>)로 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {5D80A6D1-B500-47DA-82B8-EB9875F85B4D}.  
-   [Facebook](http://www.facebook.com/)은 Facebook Photo Updater 5.5.8을 위한 ActiveX 컨트롤용 킬(kill) 비트를 요청했습니다. 새로운 컨트롤은 [http://go.microsoft.com/fwlink/?LinkID=179108&clcid=0x409](http://go.microsoft.com/fwlink/?linkid=179108&clcid=0x409)에서 찾을 수 있습니다. Facebook Image Uploader ActiveX 컨트롤용 킬(kill) 비트에 관한 질문 또는 문제가 있는 경우 [Facebook Security](http://www.facebook.com/help/contact.php?show_form=whitehat)로 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {0CCA191D-13A6-4E29-B746-314DEE697D83}.  
-   [Panda Security (영문)](http://www.pandasecurity.com/)는 PandaActiveScan Installer 2.0을 위한 ActiveX 컨트롤용 킬(kill) 비트를 요청했습니다. 새로운 컨트롤은 [http://go.microsoft.com/fwlink/?LinkID=179109 (영문)](http://go.microsoft.com/fwlink/?linkid=179109)에서 찾을 수 있습니다. Panda Security ActiveX 컨트롤용 킬(kill) 비트에 관한 질문 또는 문제가 있는 경우 [Panda Security](mailto:secure@pandasecurity.com)로 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
