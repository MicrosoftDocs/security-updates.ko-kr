...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 923694](http://support.microsoft.com/kb/923694)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 923694](http://support.microsoft.com/kb/923694)를 참조하십시오.
...
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Outlook Express 5.5 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=cb0563fb-a05d-4d9d-b269-b5602b09c16a&displaylang=ko)
-   Microsoft Windows 2000 서비스 팩 4에 설치된 Outlook Express 6 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=1f0432d4-3f45-472e-8c2d-b7b6a879acb8&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 2에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=560e8778-9733-4719-a565-614fd490c320&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=6be4f4ce-abd6-4a38-84a5-8952e3531217)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1에 설치된 Outlook Express 6 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=fe358108-15df-4ed9-b257-01aeb82647df&displaylang=ko)
-   Microsoft Windows Server 2003 x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=6be4f4ce-abd6-4a38-84a5-8952e3531217)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용)에 설치된 Outlook Express 6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=7d3fea7a-ddc0-4a22-a8b3-d5f46707d017)
...
|-------------------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------------------------------------------------------------|---------------------------------------------------------------------------|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| Windows 주소록 연락처 레코드 취약점 - [CVE-2006-2386 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2386) | 원격 코드 실행       | 중요                                                                        | 중요                                                                      | 중요                                                                             | 중요                                                                                                                  |
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 923694](http://support.microsoft.com/kb/923694)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 923694](http://support.microsoft.com/kb/923694)를 참조하십시오.

-   [Microsoft 기술 자료 문서 923694](http://support.microsoft.com/kb/923694): 누적 보안 업데이트 설치 후 Windows 주소록 또는 Outlook Express를 열 때 오류 메시지가 표시됨
...
이전에 핫픽스를 설치하여 이러한 파일 중 하나를 업데이트한 경우에는 설치 프로그램이 RTMQFE 파일을 시스템에 복사하고, 그렇지 않은 경우에는 RTMGDR 파일을 시스템에 복사합니다. 보안 업데이트는 이러한 파일의 일부 버전을 포함하지 않을 수 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 824994](http://support.microsoft.com/kb/824994)를 참조하십시오.
