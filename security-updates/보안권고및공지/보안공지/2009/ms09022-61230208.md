...
**문제점.**  이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 961501](http://support.microsoft.com/kb/961501)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=86378753-db24-44c2-a27d-cc0239f40ab8&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS07-021](http://technet.microsoft.com/security/bulletin/ms07-021) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=f2119aca-a98e-4810-be52-f38241443baf&displaylang=ko)                                                          | 권한 상승      | 보통        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=22699d09-1e68-456a-8733-bfad6667ebf5)                                                                          | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=865414f8-3f77-4fee-acc6-6684a3dc0aa4&displaylang=ko)                                                                           | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=197a6cc7-4ba3-4d2e-b621-0ef3da645ef2&displaylang=ko)                                                               | 권한 상승      | 보통        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=719efd62-fb33-447d-b6dd-2aaafbbad881)                                                                           | 권한 상승      | 보통        | 없음                                                                |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3ad8f037-2434-4dea-bfc3-9d3b4008b828&displaylang=ko)                                     | 권한 상승      | 중요        | 없음                                                                |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=85c317cd-2a14-4747-9f50-3af3ddd3ae1b&displaylang=ko) | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=0f18356d-9f09-4d24-8361-970c0d1ccac4&displaylang=ko)\*                | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d0a6e8d-a31d-4f3d-a7d7-e61215bfebed&displaylang=ko)\*            | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=bbac3deb-6c93-45aa-832c-02b915ac7f44)                     | 권한 상승      | 중요        | 없음                                                                |
...
예. 이 공지의 취약점 정보 섹션에 나열된 변경 사항 외에, 이 보안 업데이트는 구분 파일 및 @F*pathname* 포함 파일이 위치하는 경로를 제한합니다. 이 업데이트를 설치하기 전에는 위치에 상관없이 포함된 파일이 있는 구분 페이지를 적용할 수 있습니다.이 업데이트를 설치한 후에는 제한된 위치에 포함된 파일이 있는 구분 페이지만 인쇄됩니다. 이러한 파일의 적절한 위치에 대한 자세한 내용은 [Microsoft 기술 자료 문서 102712](http://support.microsoft.com/kb/102712)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0228 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0228)을 참조하십시오.
...
**인쇄 스풀러 서비스란 무엇입니까?**    
인쇄 스풀러 서비스는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 자세한 내용은 TechNet 문서 [How Network Printing Works(네트워크 인쇄 작동 방식) (영문)](http://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0229 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0229)를 참조하십시오.
...
**구분 페이지란 무엇입니까?**    
구분 또는 배너 페이지는 일반적으로 프린터로 문서를 보낸 사람과 인쇄 날짜 및 시간을 알려줍니다. 표준 구분 페이지 중 하나를 사용하거나 사용자 지정 페이지를 만들 수 있습니다. Windows의 %systemroot%\\System32 폴더에서 세 개의 구분 페이지 파일이 제공됩니다. 자세한 내용은 TechNet 문서 [Using separator pages(구분 페이지 사용) (영문)](http://technet.microsoft.com/en-us/library/cc737357.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0230 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0230)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 961501](http://support.microsoft.com/kb/961501) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/961501">Microsoft 기술 자료 문서 961501</a> 참조</td>
</tr>
<tr class="even">
...
-   인쇄 스풀러 버퍼 오버플로 취약점(CVE-2009-0228)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Jun Mao
