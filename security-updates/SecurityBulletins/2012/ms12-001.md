---
TOCTitle: 'MS12-001'
Title: 'Microsoft 보안 공지 MS12-001 - 중요'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61230468
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-001(v=Security.10)'
---


Microsoft 보안 공지 MS12-001 - 중요
===================================

Windows 커널 취약점으로 인한 Kernel 보안 기능 우회 (2644615)
------------------------------------------------------------

게시된 날짜: 2012년 1월 10일 화요일 | 업데이트된 날짜: 2012년 2월 23일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 x64 기반 Windows XP 에디션과 모든 Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해 "중요"입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Windows 커널이 구조적 예외 처리 테이블을 로드하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2644615](https://support.microsoft.com/kb/2644615)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                            | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                            | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                             | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                  | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                      | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                         | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                       | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                     | 보안 기능 우회 | 중요        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                       | 보안 기능 우회 | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | 보안 기능 우회 | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | 보안 기능 우회 | 중요        | 없음                      |
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [1월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-jan)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >Windows 커널 SafeSEH 우회 취약점(CVE-2012-0001)</th>
...
Windows에서는 커널이 구조적 예외 처리 테이블을 로드하는 방식 때문에 보안 기능 우회 취약점이 존재합니다. 이 취약점을 성공적으로 악용한 공격자는 SafeSEH 심층 방어 메커니즘을 우회하여 다른 취약점이 악용되도록 할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0001(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001)을 참조하십시오.
  
#### Windows 커널 SafeSEH 우회 취약점(CVE-2012-0001)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   Microsoft Visual C++ .NET 2003을 사용하여 컴파일한 소프트웨어 응용 프로그램만 이 취약점을 악용하는 데 이용될 수 있습니다. 참고
  
#### Windows 커널 SafeSEH 우회 취약점(CVE-2012-0001)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   새로운 버전의 Microsoft Visual C++을 사용하여 소프트웨어 다시 컴파일
  
    Microsoft Visual C++ .NET 2003을 사용하여 컴파일한 소프트웨어 응용 프로그램만 이 취약점을 악용하는 데 이용될 수 있습니다. 문제점을 해결하려면 Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 또는 Microsoft Visual C++ 2010 버전을 사용하여 소프트웨어를 다시 컴파일하십시오.
  
-   SEHOP(구조적 예외 처리 덮어쓰기 보호***)***사용
  
    Windows Vista, Windows 7, Windows Server 2008 및 Windows Server 2008 R2 시스템의 경우 기존 응용 프로그램에 대해 SEHOP를 사용하도록 설정하기 위한 지침을 제공하는 [Windows 운영 체제에서 SEHOP(구조적 예외 처리 덮어쓰기 보호)를 사용하도록 설정하는 방법](https://support.microsoft.com/kb/956607)을 참조하십시오.
  
#### Windows 커널 SafeSEH 우회 취약점(CVE-2012-0001)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이 취약점은 보안 기능 우회 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 SafeSEH 보호 기능을 우회하여 다른 취약점이 악용되도록 할 수 있습니다.
...
Ntdll.dll이 취약점의 영향을 받는 구성 요소입니다.
  
공격자는 취약점을 악용하여 무엇을 할 수 있습니까?   
이 취약점을 성공적으로 악용한 공격자는 소프트웨어 응용 프로그램에서 SafeSEH 보안 기능을 우회할 수 있습니다. 그런 후 공격자는 다른 취약점을 이용하여 구조적 예외 처리기가 임의 코드를 실행하도록 할 수 있습니다.
  
공격자는 이러한 취약점을 어떻게 악용합니까?   
이 취약점을 악용하여 임의 코드를 실행하기 위해 공격자는 먼저 SafeSEH 보안 기능을 우회한 다음 이 보안 우회 조건을 이용하여 다른 취약점을 통해 임의 코드를 실행해야 합니다.
  
구 조적 예 외 처리기란 무엇입니까?   
SEH(구조적 예외 처리기)는 하드웨어 및 소프트웨어 예외를 처리하기 위한 소프트웨어 응용 프로그램의 메커니즘입니다. SEH는 프로그래머가 예외 처리를 완전히 제어할 수 있도록 하고, 디버거를 지원하며, 모든 프로그래밍 언어 및 시스템에서 사용될 수 있습니다.
  
SafeSEH 란 무엇입니까?   
SafeSEH는 버퍼 오버플로 시 구조적 예외 처리기를 손상시키거나 가로채지 못하게 하는 보안 기능입니다.
  
취약점으로 인해 위험에 노출되는 시스템은 주로 무엇입니까?   
워크스테이션과 서버가 이 취약점에 대한 위험에 노출되어 있습니다.
  
업데이트는 어떤 기능을 수행합니까?   
이 업데이트는 Windows 커널이 구조적 예외 처리 테이블을 로드하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2644615$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2644615">Microsoft 기술 자료 문서 2644615</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 커널 SafeSEH 우회 취약점(CVE-2012-0001)을 보고해 주신 [Accuvant LABS(영문)](https://www.accuvant.com/)의 Joshua J. Drake
...
-   V1.1(2012년 2월 23일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2644615 링크가 추가되었습니다.
