...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2797052](https://support.microsoft.com/kb/2797052)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS11-052](https://go.microsoft.com/fwlink/?linkid=218115)의 KB2544521
</td>
</tr>
...
예. KB2797052 업데이트는 Windows 7(32비트 시스템용) 서비스 팩 1, Windows 7(x64 기반 시스템용) 서비스 팩 1 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Internet Explorer 10 Release Preview에서 사용할 수 있습니다. Windows 7(32비트 시스템용) 서비스 팩 1, Windows 7(x64 기반 시스템용) 서비스 팩 1 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Internet Explorer 10 Release Preview를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. Windows 7(32비트 시스템용) 서비스 팩 1 및 Windows 7(x64 기반 시스템용) 서비스 팩 1의 Internet Explorer 10 Release Preview에 대한 KB2797052 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 및 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink/?linkid=21129)에서 제공됩니다. Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 Internet Explorer 10 Release Preview에 대한 KB2797052 업데이트는 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink/?linkid=21129)에서 제공됩니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [2월 공지 요약](https://technet.microsoft.com/security/bulletin/ms13-feb)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0030)을 참조하십시오.
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)에서 제공하고 [Windows Server Update Services](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool](https://technet.microsoft.com/sms/bb676783)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools](https://technet.microsoft.com/sms/bb676786)를 참조하십시오. [Systems Management Server 2003용 다운로드](https://technet.microsoft.com/sms/bb676766)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2797052">Microsoft 기술 자료 문서 2797052</a> 참조</td>
</tr>
<tr class="even">
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2797052](https://support.microsoft.com/kb/2797052) 참조                                                                                                                                                                                                                   |
