...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2769327](https://support.microsoft.com/kb/2769327)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2769327](https://support.microsoft.com/kb/2769327)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0005)(영문)를 참조하십시오.
...
-   클라이언트용 인증이 IIS에 연결하도록 요청
    ...
    IIS 7인 경우 [IIS 7에서 인증 구성](https://technet.microsoft.com/ko-kr/library/cc733010(v=ws.10).aspx)

    IIS 6.0인 경우 [IIS 6.0의 Windows 통합 인증](https://technet.microsoft.com/ko-kr/library/cc738016(v=ws.10).aspx)
...
OData란 무엇입니까?  
OData(Open Data) 프로토콜은 데이터의 쿼리 및 업데이트용 프로토콜로, 오늘날 응용 프로그램에 존재하는 사일로로부터 데이터를 잠금 해제하며 데이터가 영향을 받지 않도록 하는 방식을 제공합니다. OData는 [HTTP](https://www.w3.org/protocols/), [Atom Publishing Protocol](https://www.ietf.org/rfc/rfc4287.txt)(AtomPub), [JSON](https://json.org/) 등 웹 기술을 통해 적용 및 구현함으로써 이러한 방식을 제공하므로 다양한 응용 프로그램, 서비스, 저장소의 정보에 액세스할 수 있습니다. 이 프로토콜은 지난 몇 년간 다양한 제품에서 AtomPub 클라이언트 및 서버를 구현한 경험을 토대로 개발되었습니다. OData는 관계형 데이터베이스, 파일 시스템, 콘텐츠 관리 시스템, 일반 웹 사이트 등 다양한 출처의 정보를 노출 및 활용하는데 사용됩니다. OData 사양에 대한 자세한 내용은 [Open Data 프로토콜 웹 사이트](https://www.odata.org/)를 참조하십시오.

관 리 OData IIS 확장 웹 서비스란 무엇입니까?   
관리 OData IIS 확장은 IIS에서 실행되는 OData 기반 웹 서비스를 통해 Windows PowerShell cmdlet을 간편하게 노출하기 위한 프레임워크입니다. 자세한 내용은 [관리 OData IIS 확장 웹 서비스 생성](https://msdn.microsoft.com/ko-kr/library/windows/desktop/hh880865(v=vs.85).aspx)(영문)을 참조하십시오.

WCF란 무엇입니까?   
WCF(Windows Communication Foundation)는 서비스 지향 응용 프로그램 구축을 위한 Microsoft의 통합 프로그래밍 모델로, 개발자는 플랫폼 간 통합되고 기존 인프라와도 상호 운용되는 안전하고 신뢰할 만한 트랜잭션형 솔루션을 구축할 수 있습니다. WCF에 대한 자세한 내용은 [Windows Communication Foundation](https://msdn.microsoft.com/ko-kr/library/dd456779.aspx)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736416">Microsoft 기술 자료 문서 2736416</a> 참조<br />
<a href="https://support.microsoft.com/kb/2736428">Microsoft 기술 자료 문서 2736428</a> 참조</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736418">Microsoft 기술 자료 문서 2736418</a> 참조<br />
<a href="https://support.microsoft.com/kb/2736422">Microsoft 기술 자료 문서 2736422</a> 참조<br />
<a href="https://support.microsoft.com/kb/2736428">Microsoft 기술 자료 문서 2736428</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736693">Microsoft 기술 자료 문서 2736693</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2736693">Microsoft 기술 자료 문서 2736693</a> 참조<br />
<a href="https://support.microsoft.com/kb/2753596">Microsoft 기술 자료 문서 2753596</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">Microsoft .NET Framework 3.5:<br />
