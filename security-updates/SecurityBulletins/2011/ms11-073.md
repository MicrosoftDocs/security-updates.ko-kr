...
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/ko-kr/security/bulletin/ms10-087">MS10-087</a></td>
</tr>
<tr class="odd">
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1980 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1980)을 참조하십시오.
...
Office 파일 유효성 검사는 Office 2003 및 2007용 보안 추가 기능입니다. Office 파일 유효성 검사는 바이너리 파일 형식 파일이 Microsoft Office 파일 형식에 맞는지 확인하는 데 사용됩니다. 파일이 해당 형식에 맞지 않으면 보안이 위험할 수 있다는 알림이 제공됩니다. 이 추가 기능에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)에서 찾을 수 있습니다.
...
예, 이 취약점은 응용 프로그램이 [Microsoft 보안 권고 2269637](http://technet.microsoft.com/ko-kr/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1982 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1982)를 참조하십시오.
...
또는 그룹 정책을 사용하여 파일 차단을 적용할 수 있습니다. 자세한 내용은 TechNet 문서, [Office 2010의 파일 차단 설정 계획 (영문)](http://technet.microsoft.com/en-us/library/cc179230.aspx)을 참조하십시오.
...
해당 조직에서 서버, 데스크톱, 모바일 시스템에 적용해야 하는 소프트웨어 및 보안 업데이트를 관리합니다. 자세한 내용은 [TechNet Update Management Center](http://technet.microsoft.com/ko-kr/updatemanagement/bb245732)를 참조하십시오. [Microsoft TechNet Security 웹 사이트](http://technet.microsoft.com/ko-kr/security/default.aspx)에서는 Microsoft 제품의 보안에 관한 추가 정보를 제공합니다.
...
<br />
다시 시작이 필요한 상황을 줄이려면 보안 업데이트를 설치하기 전에 영향 받는 모든 서비스를 중지하고 영향을 받는 파일이 사용될 수 있는 모든 응용 프로그램을 닫으십시오. 컴퓨터를 다시 시작하라는 메시지가 나타나는 이유에 대한 자세한 내용은 <a href="http://support.microsoft.com/kb/887012">Microsoft 기술 자료 문서 887012</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2584052">Microsoft 기술 자료 문서 2584052</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2584063">Microsoft 기술 자료 문서 2584063</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2584066">Microsoft 기술 자료 문서 2584066</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Office 구성 요소 비보안 라이브러리 로드 취약점(CVE-2011-1980)을 [Secunia Research (영문)](http://secunia.com/)와 협력하여 보고해 주신 Parvez Anwar  
-   Office 초기화되지 않은 개체 포인터 취약점(CVE-2011-1982)을 보고해 주신 [CERT/CC (영문)](http://www.cert.org/)의 David Warren
