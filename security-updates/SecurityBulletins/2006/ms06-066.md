...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=3cf0b0d1-ff07-40ac-a6ac-44dc4a54f91e&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=2f54258f-1071-467b-80a2-e4dbfc050667&displaylang=ko)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=f23574f7-4033-45ac-8ad8-6cced2ee9285&displaylang=ko)
...
|---------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|-------------------------------------|--------------------------------------------------------|
| Microsoft Client Service for NetWare 메모리 손상 취약점 - [CVE-2006-4688 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) | 원격 코드 실행       | 중요                     | 중요                                | 보통                                                   |
| NetWare 드라이버 서비스 거부 취약점 - [CVE-2006-4689 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4689)                     | 서비스 거부          | 보통                     | 보통                                | 낮음                                                   |
...
-   **방화벽에서 TCP 포트 139 및 445 차단:**
    ...
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 TCP 포트 139 및 445를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 들어오는 방향의 원치 않는 인터넷 통신을 모두 차단하는 것이 좋습니다. 이 포트에 대한 자세한 내용은 다음 [웹 사이트](http://go.microsoft.com/fwlink/?linkid=21312)를 참조하십시오.
...
-   **네트워크를 통해 취약점을 악용하려는 시도로부터 보호하려면 Windows XP에 포함되어 있는** [**Windows 방화벽**](http://www.microsoft.com/korea/athome/security/default.mspx)**과 같은 개인 방화벽을 사용합니다.**
...
-   **네트워크를 통해 취약점을 악용하려는 시도로부터 보호하려면 Windows XP에 포함되어 있는** [**Windows 방화벽**](http://www.microsoft.com/korea/athome/security/default.mspx)**과 같은 개인 방화벽을 사용합니다.**
    ...
    기본적으로 Windows XP 및 Windows Server 2003의 [Windows 방화벽 기능](http://www.microsoft.com/korea/athome/security/default.mspx)은 들어오는 방향의 원치 않는 트래픽을 차단하여 인터넷 연결을 보호합니다. 들어오는 방향의 원치 않는 인터넷 통신을 모두 차단하는 것이 좋습니다.
...
-   Client Service for NetWare 메모리 손상 취약점(CVE-2006-4688)을 보고해 주신 [NGS Software (영문)](http://www.ngssoftware.com/)의 Peter Winter-Smith
-   Client Service for NetWare 메모리 손상 취약점(CVE-2006-4688) 및 Client Service for NetWare 드라이버 서비스 거부 취약점(CVE-2006-4689)을 보고해 주신 [McAfee (영문)](http://www.mcafee.com/us)의 Sam Arun Raj
