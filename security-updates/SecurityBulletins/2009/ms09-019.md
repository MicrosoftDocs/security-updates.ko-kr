...
<td style="border:1px solid black;">
[없음](https://technet.microsoft.com/security/bulletin/ms09-014)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Internet Explorer8](https://www.microsoft.com/download/details.aspx?familyid=d9e27ce1-4e7c-437f-9477-e7805a33da08&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 8](https://www.microsoft.com/download/details.aspx?familyid=5edb14f7-11ec-4180-9f0f-b2673f1c8d83&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 969897](https://support.microsoft.com/kb/969897)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3091 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2007-3091 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1140 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1140)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1141 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1141)을 참조하십시오.
...
**DHTML란 무엇입니까?**
DHTML(Dynamic HTML)은 Microsoft가 Internet Explorer 4.0에서 처음 도입한 기능 집합으로서 사용자가 웹 페이지와 상호 작용하고 있을 때 웹 페이지 제작자가 웹 페이지의 렌더링 및 콘텐츠를 동적으로 변경할 수 있도록 해줍니다. 자세한 내용은 MSDN 문서, [DHTML 개체(영문)](https://msdn.microsoft.com/en-us/library/ms533054(vs.85).aspx)를 참조하십시오.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
이 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.

**Windows Server 2003에서 Internet Explorer를 실행하고 있습니다. 이 경우 취약점을 완화됩니까?**  
예. 기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://go.microsoft.com/fwlink/?linkid=92039)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리 (영문)](https://go.microsoft.com/fwlink/?linkid=92055)도 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1528 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1528)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1529 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1529)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1530 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1530)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1531 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1531)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1532 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1532)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969897">Microsoft 기술 자료 문서 969897</a> 참조</td>
</tr>
<tr class="even">
...
-   경쟁 조건 도메인 간 정보 유출 취약점(CVE-2007-3091)을 해결하기 위해 협력해 주신 [Google Inc.](https://www.google.com/)의 David Bloom  
-   도메인 간 정보 유출 취약점(CVE-2009-1140)을 보고해 주신 [Core Security Technologies (영문)](https://www.coresecurity.com/)의 Jorge Luis Alvarez Medina  
-   DHTML 개체 메모리 손상(CVE-2009-1141)을 보고해 주신 [Fortinet (영문)](https://www.fortinet.com)의 Haifei Li  
-   HTML 개체 메모리 손상(CVE-2009-1528)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-1529)을 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](https://www.tippingpoint.com/)와 협력하여 보고해 주신 Peter Vreugdenhil  
-   HTML 개체 메모리 손상 취약점(CVE-2009-1530)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Wushi  
-   HTML 개체 메모리 손상 취약점(CVE-2009-1531)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Wushi  
-   HTML 개체 메모리 손상 취약점(CVE-2009-1532)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Nils
