...
이 업데이트 설치에 대한 자세한 내용은 [Microsoft 기술 자료 문서 960715](https://support.microsoft.com/kb/960715)를 참조하십시오.
...
| 참고 자료                    | 번호                                             |
|------------------------------|--------------------------------------------------|
| **Microsoft 기술 자료 문서** | [960715](https://support.microsoft.com/kb/960715) |
...
아니요, 자동 업데이트를 위해 이 업데이트는 Microsoft 보안 공지 [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368)에 설명된 ActiveX 킬(Kill) 비트 누적 보안 업데이트(950760)를 대체하지 않습니다. 자동 업데이트는 이 업데이트(960715) 설치 여부에 관계 없이 MS08-032 업데이트를 고객에게 계속 제공합니다. 그러나 이 업데이트(960715)를 설치한 고객은 MS08-032에 제공된 킬(kill) 비트로 보호받기 위해 MS08-032 업데이트를 설치할 필요가 없습니다.
...
그렇습니다. 이 업데이트에는 이전의 [Microsoft 보안 권고(956391)](https://technet.microsoft.com/security/advisory/956391)에서 발표된 킬 비트도 포함되어 있습니다.
...
다음 클래스 식별자는 [Akamai (영문)](https://www.akamai.com/)가 취약한 클래스 식별자에 대해 킬 비트를 설정하도록 요청한 것입니다. 자세한 내용은 Akamai가 발표한 [보안 릴리스 (영문)](https://go.microsoft.com/fwlink/?linkid=139453)를 참조하십시오.
...
다음 클래스 식별자는 [RIM(Research In Motion) (영문)](https://www.rim.com/)이 취약한 클래스 식별자에 대해 킬 비트를 설정하도록 요청한 것입니다. 자세한 내용은 RIM이 발표한 [보안 릴리스 (영문)](https://go.microsoft.com/fwlink/?linkid=139451)를 참조하십시오.
...
다음 클래스 식별자는 Microsoft 보안 공지 [MS08-070](https://technet.microsoft.com/security/bulletin/ms08-070), Visual Basic 6.0 Runtime Extended Files(ActiveX 컨트롤)의 취약점으로 인한 원격 코드 실행 문제점(932349)에서 해결한 CAPICOM 컨트롤과 관련이 있습니다.
...
Microsoft는 이 업데이트를 설치하도록 고객에게 권장합니다. 이 업데이트에 대해 더 자세히 알고 싶은 고객은 [Microsoft 기술 자료 문서 960715](https://support.microsoft.com/kb/960715)를 검토하십시오.
...
-   기타 지역에 거주하는 고객은 해당 Microsoft 지사에서 지원을 받을 수 있습니다. Microsoft 지원 부서에 연락하는 방법에 대한 자세한 내용은 [국가별 지원 (영문)](https://go.microsoft.com/fwlink/?linkid=21155)에 나와 있습니다.
