---
TOCTitle: 'MS09-021'
Title: 'Microsoft 보안 공지 MS09-021 - 긴급'
ms:assetid: 'ms09-021'
ms:contentKeyID: 61230207
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-021(v=Security.10)'
---


Microsoft 보안 공지 MS09-021 - 긴급
===================================

Microsoft Office Excel의 취약점으로 인한 원격 코드 실행 문제점(969462)
----------------------------------------------------------------------
...
이 보안 업데이트는 비공개적으로 보고된 여러 건의 취약점을 해결합니다. 조작된 레코드 개체를 포함하고 있는 특수하게 조작된 Excel 파일을 사용자가 열면 이 취약점을 통해 원격 코드 실행이 허용될 수 있습니다. 이러한 취약점 중 어느 것이든 성공적으로 악용한 경우 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

\\이 보안 업데이트의 심각도는 지원되는 모든 Microsoft Office Excel 2000 에디션에 대해 긴급입니다. 또한 지원되는 모든 Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel 2007, Microsoft Office 2004 for Mac 및 Microsoft Office 2008 for Mac 에디션, Open XML File Format Converter for Mac 및 지원되는 모든 Microsoft Office Excel Viewer 에디션 및 Microsoft Office 호환 기능 팩에 대해 중요입니다.

업데이트는 Excel에서 Excel 파일을 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 고객은 업데이트를 즉시 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969462](https://support.microsoft.com/kb/969462)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99&displaylang=ko)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99&displaylang=ko)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2&displaylang=ko)  
(KB969679)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2&displaylang=ko)  
(KB969679)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 1(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 2(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 1(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 서비스 팩 2(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd&displaylang=ko)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
\*Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2를 사용하는 고객은 이 보안 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트 패키지 KB969682와 함께 [Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩 및 Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)(KB969679)에 대한 보안 업데이트를 설치해야 합니다.
...
**MS09-017과 MS09-027에서도 Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac의 취약점을 설명합니다. MS09-017과 MS09-027은 이 공지(MS09-021)와 어떤 관련이 있습니까?**  
Microsoft Office 2004 for Mac(KB969661), Microsoft Office 2008 for Mac(KB971822) 및 Open XML File Format Converter for Mac (KB971824)에 대한 이 공지(MS09-021)의 보안 업데이트 패키지는 [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) 및 [MS09-027](https://technet.microsoft.com/security/bulletin/ms09-027)에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 또는 Open XML File Format Converter for Mac이 설치된 사용자는 이 업데이트 패키지를 한 번만 설치하면 됩니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [6월 공지 요약](https://technet.microsoft.com/security/bulletin/ms09-jun)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >
레코드 포인터 손상 취약점(CVE-2009-0549)
</th>
<th style="border:1px solid black;" >
개체 레코드 손상 취약점(CVE-2009-0557)
</th>
<th style="border:1px solid black;" >
배열 인덱싱 메모리 손상 취약점(CVE-2009-0558)
</th>
<th style="border:1px solid black;" >
문자열 복사 Stack-Based 오버런 취약점(CVE-2009-0559)
</th>
<th style="border:1px solid black;" >
필드 삭제 메모리 손상 취약점(CVE-2009-0560)
</th>
<th style="border:1px solid black;" >
레코드 정수 오버플로 취약점(CVE-2009-0561)
</th>
<th style="border:1px solid black;" >
레코드 포인터 손상 취약점(CVE-2009-1134)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Office Excel 2000 서비스 팩 3
</td>
<td style="border:1px solid black;">
**긴급**   
원격 코드 실행
...
사용자가 조작된 레코드 개체가 포함된 특수하게 조작된 Excel 파일을 열 때 Microsoft Office Excel의 취약점으로 인해 원격 코드 실행을 허용할 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0549 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549)를 참조하십시오.

#### 레코드 포인터 손상 취약점(CVE-2009-0549)에 대한 완화 요소
...
#### 레코드 포인터 손상 취약점(CVE-2009-0549)에 대한 대안
...
-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열거나 **저장**하지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### 레코드 포인터 손상 취약점(CVE-2009-0549)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
특수하게 조작된 Excel 스프레드시트를 열 때 Microsoft Office Excel이 Excel 스프레드시트 형식을 구문 분석하는 방식으로 인해 원격 코드 실행을 허용할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0557 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557)을 참조하십시오.

#### 개체 레코드 손상 취약점(CVE-2009-0557)에 대한 완화 요소
...
#### 개체 레코드 손상 취약점(CVE-2009-0557)에 대한 대안
...
-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열거나 저장하지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### 개체 레코드 손상 취약점(CVE-2009-0557)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0558 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558)을 참조하십시오.

#### 배열 인덱싱 메모리 손상 취약점(CVE-2009-0558)에 대한 완화 요소
...
#### 배열 인덱싱 메모리 손상 취약점(CVE-2009-0558)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열거나 저장하지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### 배열 인덱싱 메모리 손상 취약점(CVE-2009-0558)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0559 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559)를 참조하십시오.

#### 문자열 복사 Stack-Based 오버런 취약점(CVE-2009-0559)에 대한 완화 요소
...
#### 문자열 복사 Stack-Based 오버런 취약점(CVE-2009-0559)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열거나 저장하지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### 문자열 복사 Stack-Based 오버런 취약점(CVE-2009-0559)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0560 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560)을 참조하십시오.

#### 필드 삭제 메모리 손상 취약점(CVE-2009-0560)에 대한 완화 요소
...
#### 필드 삭제 메모리 손상 취약점(CVE-2009-0560)에 대한 대안
...
#### 필드 삭제 메모리 손상 취약점(CVE-2009-0560)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0561 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561)을 참조하십시오.

#### 레코드 정수 오버플러 취약점(CVE-2009-0561)에 대한 완화 요소
...
#### 레코드 정수 오버플러 취약점(CVE-2009-0561)에 대한 대안
...
#### 레코드 정수 오버플러 취약점(CVE-2009-0561)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1134 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134)를 참조하십시오.

#### 레코드 포인터 손상 취약점(CVE-2009-1134)에 대한 완화 요소
...
#### 레코드 포인터 손상 취약점(CVE-2009-1134)에 대한 대안
...
#### 레코드 포인터 손상 취약점(CVE-2009-1134)에 대한 FAQ
...
| Microsoft Office Excel 2002 서비스 팩 3                                                                                                                                  | 예       |
| Microsoft Office Excel 2003 서비스 팩 3                                                                                                                                  | 예       |
| Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2                                                                                       | 예       |
...
| Microsoft Office Excel 2002 서비스 팩 3                                                                                                                                  | 예      | 예                   | 예                                                                                 | 예                                                                                 |
| Microsoft Office Excel 2003 서비스 팩 3                                                                                                                                  | 예      | 예                   | 예                                                                                 | 예                                                                                 |
| Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2                                                                                       | 아니요  | 아니요               | 예                                                                                 | 예                                                                                 |
...
<td style="border:1px solid black;">office2000-kb969683-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2000-kb969683-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969683">Microsoft 기술 자료 문서 969683</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">officeXP-kb969680-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">officeXP-kb969680-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969680">Microsoft 기술 자료 문서 969680</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Excel 2003(모든 에디션) 및 Excel Viewer 2003
...
office2003-kb969681-fullfile-kor /q:a<br />
<br />
Excel Viewer 2003:<br />
office2003-kb969685-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Excel 2003:<br />
office2003-kb969681-fullfile-kor /r:n<br />
<br />
Excel Viewer 2003:<br />
office2003-kb969685-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2003:<br />
<a href="https://support.microsoft.com/kb/969681">Microsoft 기술 자료 문서 969681</a> 참조<br />
<br />
Excel Viewer 2003:<br />
<a href="https://support.microsoft.com/kb/969685">Microsoft 기술 자료 문서 969685</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="https://support.microsoft.com/kb/969682">Microsoft 기술 자료 문서 969682</a> 참조<br />
<br />
Excel Viewer:<br />
<a href="https://support.microsoft.com/kb/969686">Microsoft 기술 자료 문서 969686</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="https://support.microsoft.com/kb/969679">Microsoft 기술 자료 문서 969679</a> 참조<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969737">Microsoft 기술 자료 문서 969737</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   레코드 포인터 손상 취약점(CVE-2009-0549)을 보고해 주신 Fortinet, [FortiGuard Global Security Research Team (영문)](https://www.fortiguardcenter.com/)의 Bing Liu  
-   개체 레코드 손상 취약점(CVE-2009-0557)을 보고해 주신 Fortinet, [FortiGuard Global Security Research Team (영문)](https://www.fortiguardcenter.com/)의 Bing Liu  
-   배열 인덱싱 메모리 손상 취약점(CVE-2009-0558)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten H. Eiram  
-   문자열 복사 Stack-Based 오버런 취약점(CVE-2009-0559)을 보고해 주신 [TELUS Security Labs Vulnerability Research Team (영문)](https://telussecuritylabs.com/)  
-   필드 삭제 메모리 손상 취약점(CVE-2009-0560)을 보고해 주신 Fortinet, [FortiGuard Global Security Research Team (영문)](https://www.fortiguardcenter.com/)의 Bing Liu  
-   레코드 정수 오버플로 취약점(CVE-2009-0561)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson과 Joshua Drake  
-   레코드 정수 오버플로 취약점(CVE-2009-0561)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten H. Eiram  
-   레코드 포인터 손상 취약점(CVE-2009-1134)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/)와 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)
...
-   V1.1(2009년 6월 18일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 969462 링크가 추가되었습니다.
