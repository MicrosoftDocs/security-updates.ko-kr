---
TOCTitle: Microsoft TechNet ID 및 액세스 관리 관련 자료
Title: Microsoft TechNet ID 및 액세스 관리 관련 자료
ms:assetid: '80ae09a0-0ffe-445d-863c-7bf7854643a0'
ms:contentKeyID: 20212548
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc895263(v=MSDN.10)'
---

ID 및 액세스 관리 교육 관련 자료
================================

합법적인 사용자가 관련 자료에 액세스하도록 허용하고, 외부 해커 또는 내부의 악의적인 직원 등과 같이 승인되지 않은 사용자의 액세스를 더욱 어렵게 하는 Microsoft 기술에 대해 알아 보십시오. 어떤 도구가 사용자의 ID를 확인하고, 사용자가 액세스할 수 있는 관련 자료를 제어하며 리소스 지원 주기 동안 데이터에 대한 액세스를 보호하는지 확인하십시오.
...
<td style="border:1px solid black;">  <img src="images/Cc895263.ms_compare3(ko-kr,MSDN.10).gif" /></td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/technet/traincert/virtuallab/exchange.mspx">TechNet 가상 랩 및 체험식 랩: Exchange (영문)</a></td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;">  <img src="images/Cc895263.ms_compare3(ko-kr,MSDN.10).gif" /></td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/technet/traincert/virtuallab/isa.mspx">TechNet 가상 랩 및 체험식 랩: ISA (영문)</a></td>
<td style="border:1px solid black;">  <img src="images/Cc895263.ms_compare3(ko-kr,MSDN.10).gif" /></td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/technet/traincert/virtuallab/security.mspx">TechNet 가상 랩 및 체험식 랩: 보안 (영문)</a></td>
<td style="border:1px solid black;">  <img src="images/Cc895263.ms_compare3(ko-kr,MSDN.10).gif" /></td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/technet/traincert/virtuallab/sms.mspx">TechNet 가상 랩 및 체험식 랩: Microsoft Systems Management Server(SMS) 2003 (영문)</a></td>
<td style="border:1px solid black;">  <img src="images/Cc895263.ms_compare3(ko-kr,MSDN.10).gif" /></td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
<td style="border:1px solid black;"> </td>
