...
이 보안 업데이트는 [Microsoft 보안 권고 977981](https://technet.microsoft.com/security/advisory/977981)에서 처음 설명한 취약점도 해결합니다.
...
예. 이 보안 업데이트(976325)에는 Microsoft 보안 공지 [MS09-054](https://technet.microsoft.com/security/bulletin/ms09-054)의 보안 업데이트 974455에 대해 알려진 문제점을 해결하는 [Microsoft 보안 권고 976749](https://technet.microsoft.com/security/advisory/976749)에 설명되어 있는 수정 사항이 포함되어 있습니다.

**이 보안 공지는 MS09-035에 설명되어 있는 ATL 문제점과 어떤 관련이 있습니까?**  
Microsoft 보안 공지 [MS09-035](https://technet.microsoft.com/security/bulletin/ms09-035)에서는 ATL(액티브 템플릿 라이브러리)의 취약한 공개 버전을 사용하여 개발된 구성 요소와 컨트롤의 취약점에 대해 설명합니다. 이 보안 업데이트(976325)는 [Microsoft 보안 권고 973882](https://technet.microsoft.com/security/advisory/973882) 및 MS09-035에 설명되어 있는 ATL 버전으로 개발된 구성 요소와 컨트롤을 이용하는 Internet Explorer의 알려진 공격 방법을 완화합니다. 다음 섹션 **취약점 정보**에서 ATL COM 초기화 취약점([CVE-2009-2493 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493))을 참조하십시오.

**이 보안 공지는 Microsoft 보안 권고 973882에 설명되어 있는 ATL 문제점과 어떤 관련이 있습니까?**  
[Microsoft 보안 권고 973882](https://technet.microsoft.com/security/advisory/973882)에서는 ATL(액티브 템플릿 라이브러리)의 공개 버전과 비공개 버전의 취약점에 대해 설명합니다. 이 보안 업데이트(976325)는 [Microsoft 보안 권고 973882](https://technet.microsoft.com/security/bulletin/ms09-035) 및 MS09-035에 설명되어 있는 ATL 버전으로 개발된 컨트롤을 업데이트합니다. 다음 섹션 **취약점 정보**에서 ATL COM 초기화 취약점([CVE-2009-2493 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493))을 참조하십시오.
...
예. [MS09-035](https://technet.microsoft.com/security/bulletin/ms09-035)는 Microsoft Visual Studio에서 ATL(액티브 템플릿 라이브러리)을 사용하는 개발자를 위해 특별히 개발된 것입니다. ATL로 작성된 구성 요소와 컨트롤을 재배포하는 개발자는 MS09-035로 제공된 업데이트를 설치하여 이러한 구성 요소와 컨트롤이 해당 보안 공지에 설명되어 있는 취약점을 포함하지 않도록 해야 합니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 976325](https://support.microsoft.com/kb/976325)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3671 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3671)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3672 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672)를 참조하십시오.
...
-   **자동화된 Microsoft Fix It을 통해 Internet Explorer 6 또는 Internet Explorer 7의 DEP 사용**
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 976325](https://support.microsoft.com/kb/976325)를 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3672 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3673 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3673)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3674 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3674)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/976325">Microsoft 기술 자료 문서 976325</a> 참조</td>
</tr>
<tr class="even">
...
-   ATL COM 초기화 취약점(CVE-2009-2493)을 보고해 주신 [Verisign IDefense Lab (영문)s](https://labs.idefense.com/)의 Ryan Smith  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-3671)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Sam Thomas(eshu.co.uk)  
-   HTML 개체 메모리 손상 취약점(CVE-2009-3672)을 [Verisign IDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 [team509 (영문)](https://www.team509.com/)  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-3673)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-3674)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
