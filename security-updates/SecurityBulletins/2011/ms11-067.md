...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=59231988-5413-4238-a3aa-32a127871430">Microsoft Visual Studio 2005 서비스 팩 1</a><br />
(KB2548826)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=28bf2ae0-9e21-4201-b7f1-a207abc2866f">Microsoft Report Viewer 2005 서비스 팩 1 재배포 가능 패키지</a><br />
(KB2579115)</td>
<td style="border:1px solid black;">정보 유출</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms09-062">MS09-062</a></td>
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1976(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1976)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](https://technet.microsoft.com/ko-kr/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 섹션을 참조하십시오.  
...
| 파일 정보               | [Microsoft 기술 자료 문서 2548826](https://support.microsoft.com/kb/2548826) 참조                                                                                                                                                                                                                   |  
...
| 핫패칭                  | 해당 사항 없음                                                                   |  
| 제거 정보               | 제어판의 프로그램 추가/제거 도구를 사용하십시오.                                 |  
| 파일 정보               | [Microsoft 기술 자료 문서 2579115](https://support.microsoft.com/kb/2579115) 참조 |  
| 레지스트리 키 확인      | 참고: 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.                    |
...
-   Report Viewer 컨트롤 XSS 취약점(CVE-2011-1976)을 보고해 주신 [Gotham Digital Science(영문)](https://www.gdssecurity.com/)의 Adam Bixby
