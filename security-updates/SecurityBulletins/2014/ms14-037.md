...
<td style="border:1px solid black;">
[MS14-035](https://go.microsoft.com/fwlink/?linkid=400972)의 2957689
...
다음 표에 대한 설명: 긴급, 중요, 보통으로 표시된 경우, 이는 심각도를 나타냅니다. 자세한 정보는 [보안 공지 심각도 시스템](https://technet.microsoft.com/security/gg309177)(영문)을 참조하십시오. RCE(원격 코드 실행), EoP(권한 상승), 보안 기능 우회가 표시된 경우, 이는 최대 영향을 나타냅니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2014-2783](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-2783)이 지정되었습니다.
...
-   Internet Explorer 메모리 손상 취약점(CVE-2014-1763)을 [HP](https://www.hpenterprisesecurity.com/products)(영문)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 [VUPEN](https://www.vupen.com/)(영문)  
...
-   Internet Explorer 메모리 손상 취약점(CVE-2014-2802)을 보고해 주신 [NSFOCUS Security Team](https://www.nsfocus.com/)(영문)의 [Chen Zhang(demi6od)](https://github.com/demi6od)(중문)  
