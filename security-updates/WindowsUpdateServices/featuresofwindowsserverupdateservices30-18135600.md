...
ms:contentKeyID: 18135600
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc708464(v=WS.10)'
---
...
-   The Windows® 내부 데이터베이스 database that WSUS can install during setup on Windows Server 2003.
