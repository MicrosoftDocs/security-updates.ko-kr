...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0109 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109)를 참조하십시오.
...
-   Word 메모리 손상 취약점(CVE-2008-0109)을 보고해 주신 [Reversemode.com (영문)](http://reversemode.com/)의 Rubén Santamarta
