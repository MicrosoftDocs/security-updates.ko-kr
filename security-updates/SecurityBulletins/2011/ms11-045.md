...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2537146](http://support.microsoft.com/kb/2537146)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft Excel 2003 및 Microsoft Excel 2007에서 Office 파일 유효성 검사 기능을 사용하면 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 데 사용될 수 있는 특수하게 조작된 파일이 자동으로 열리지 않고, 기본적으로 사용자에게 이러한 파일을 열 것인지 여부를 물어보게 됩니다. 사용자가 여러 번의 경고 대화 상자를 클릭한 후에 파일을 열어야만 취약점이 악용될 수 있습니다. Microsoft Excel 2003 또는 Microsoft Excel 2007의 Office 파일 유효성 검사 기능에 대한 자세한 내용은 [Microsoft 보안 권고 2501584](http://technet.microsoft.com/security/advisory/2501584)를 참조하십시오.

Office 파일 유효성 검사는 Microsoft Excel 2010에서 기본적으로 사용됩니다. CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 데 사용될 수 있는 특수하게 조작된 파일이 유효성 검사에 실패하면 [제한된 보기 (영문)](http://www.microsoft.com/security/pc-security/office2010.aspx)에서 열립니다. 그러면 사용자가 여러 번의 경고 메시지를 클릭한 후에 편집을 위해 파일을 열어야만 취약점이 악용될 수 있습니다.

**Excel 2003 및 Excel 2007에서 파일 유효성 검사에 실패하는 파일을 열지 못하도록 하면 어떠한 이점이 있습니까?**    
Office 파일 유효성 검사를 통해 Excel 2003 및 Excel 2007에서 의심되는 파일을 열지 못하도록 설정할 경우 [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)에서 사용할 수 있는 **Microsoft Fix it** 솔루션, "Excel 2003 및 2007에 대한 문서 열기 사용 안 함"이 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279에 설명된 취약점을 악용하는 공격 경로를 차단합니다.

Fix it 자동화 솔루션, "Excel 2003 및 2007에 대한 문서 열기 사용 안 함"을 적용하는 방법은 [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)를 참조하고, 솔루션을 수동으로 적용하는 방법은 이 공지의 취약점 정보 섹션에서 CVE-2011-1272, CVE-2011-1273 및 CVE-2011-1279의 대안 섹션을 참조하십시오.

**Excel 2010에서 파일 유효성 검사에 실패하는 파일을 열지 못하도록 하면 어떠한 이점이 있습니까?**    
Microsoft Excel 2010은 이 공지에 설명된 CVE-2011-1273에만 영향을 받습니다. [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)에서 사용할 수 있는 **Microsoft Fix it** 자동화 솔루션, "Excel 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"이 CVE-2011-1273을 악용하는 공격 경로를 차단합니다. Excel 2010에 대한 보안 업데이트를 설치하지 않도록 선택한 고객은 나중에 Fix it 솔루션을 대안으로 적용하도록 선택할 수 있습니다.

Fix it 자동화 솔루션, "Excel 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"을 적용하는 방법은 [Microsoft 기술 자료 문서 2501584](http://support.microsoft.com/kb/2501584)를 참조하고 이 솔루션을 수동으로 적용하는 방법은 이 공지의 취약점 정보 섹션에서 CVE-2011-1273의 대안 섹션을 참조하십시오.
...
이 공지에서 제공하는 Microsoft Office 2004 for Mac(KB2555786), Microsoft Office 2008 for Mac(KB2555785) 및 Open XML File Format Converter for Mac(KB2555784)용 보안 업데이트 패키지는 [MS11-036](http://technet.microsoft.com/security/bulletin/ms11-036) 보안 공지에서 설명하는 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1272 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1272)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1273 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1274 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1274)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1275 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1276 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1277](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1278](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1279](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279)를 참조하십시오.
...
-   **Excel 2003에서 유효성 검사에 실패하는 파일을 열지 못하도록 Office 파일 유효성 검사 설정**
    ...
    **참고** 이 대안을 적용하기 전에 해당 버전의 Microsoft Office에 대해 Office 파일 유효성 검사를 사용하도록 설정되어 있어야 합니다. Microsoft Office 2003에서 Office 파일 유효성 검사를 사용하도록 설정하는 방법에 대한 자세한 내용은 TechNet 문서 [Office 2003 및 Office 2007용 Office 파일 유효성 검사](http://technet.microsoft.com/en-us/library/gg985445(office.12).aspx)(영문)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2541003">Microsoft 기술 자료 문서 2541003</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2541025">Microsoft 기술 자료 문서 2541025</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Excel 2007의 경우 <a href="http://support.microsoft.com/kb/2541007">Microsoft 기술 자료 문서 2541007</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer의 경우 <a href="http://support.microsoft.com/kb/2541015">Microsoft 기술 자료 문서 2541015</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="http://support.microsoft.com/kb/2541012">Microsoft 기술 자료 문서 2541012</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2523021">Microsoft 기술 자료 문서 2523021</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Excel 불충분한 레코드 유효성 검사 취약점(CVE-2011-1272)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](http://www.fortiguard.com/)의 Bing Liu  
-   Excel 잘못된 레코드 구문 분석 취약점(CVE-2011-1273)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 범위 초과 배열 액세스 취약점(CVE-2011-1274)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 Omair  
-   Excel 메모리 힙 덮어쓰기 취약점(CVE-2011-1275)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 버퍼 오버런 취약점(CVE-2011-1276)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 [Agarri (영문)](http://www.agarri.fr/)의 Nicolas Gregoire  
-   Excel 메모리 손상 취약점(CVE-2011-1277)을 보고해 주신 Omair  
-   Excel WriteAV 취약점(CVE-2011-1278)을 보고해 주신 [CERT/CC (영문)](http://www.cert.org/)의 Will Dormann  
-   Excel 범위 초과 WriteAV 취약점(CVE-2011-1279)을 보고해 주신 [CERT/CC (영문)](http://www.cert.org/)의 Will Dormann
