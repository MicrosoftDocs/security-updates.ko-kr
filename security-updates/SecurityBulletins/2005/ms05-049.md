...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">셸 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2122">CAN-2005-2122 (영문)</a></td>
...
<tr class="even">
<td style="border:1px solid black;">셸 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2118">CAN-2005-2118 (영문)</a></td>
<td style="border:1px solid black;">원격 코드 실행<br />
</td>
<td style="border:1px solid black;">중요<br />
</td>
...
<tr class="odd">
<td style="border:1px solid black;">웹 보기 스크립트 삽입 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2117">CAN-2005-2117 (영문)</a></td>
<td style="border:1px solid black;">원격 코드 실행<br />
</td>
...
|-------------------------------------------------------------------------|--------------|-----------------------|---------------------|---------------------------------|
| [**MS05-016**](https://technet.microsoft.com/security/bulletin/ms05-016) | 대체됨       | 대체됨                | 대체됨              | 해당 사항 없음                  |
| [**MS05-024**](https://technet.microsoft.com/security/bulletin/ms05-024) | 대체됨       | 해당 사항 없음        | 해당 사항 없음      | 해당 사항 없음                  |
...
-   **그룹 정책 설정을 사용하여 이 기능이 필요하지 않은 모든 영향을 받는 시스템에서 웹 보기를 비활성화합니다.**
    ...
    -   [Windows 2000 그룹 정책 (영문)](https://www.microsoft.com/windows2000/techinfo/howitworks/management/grouppolwp.asp)

    **대안의 영향:** 이러한 변경 내용으로 일반적인 폴더와 작업에 대한 링크가 포함된 작업창이 제거되어 Windows 탐색기의 기능이 축소됩니다.

-   **경계 방화벽에서 TCP 포트 139 및 445 차단:**

    이러한 포트는 SMB(서버 메시지 블록) 프로토콜을 사용하여 연결을 시작하는 데 사용됩니다. 경계 방화벽에서 나가는 방향의 SMB 트래픽을 차단하면 시스템이 방화벽 외부의 악의적인 파일 서버에 연결하는 시도를 막을 수 있습니다. 이 포트에 대한 자세한 내용은 다음 [웹 사이트(영어)](https://go.microsoft.com/fwlink/?linkid=21312)를 참조하십시오.
...
-   셸 취약점(CAN-2005-2122) 및 셸 취약점(CAN-2005-2118)을 보고해 주신 [Argeniss (영문)](https://www.argeniss.com)의 Cesar Cerudo에 감사드립니다.
-   웹 보기 스크립트 삽입 취약점(CAN-2005-2117)을 보고해 주신 [security-assessment.com (영문)](https://www.security-assessment.com/)의 Brett Moore에 감사드립니다.
