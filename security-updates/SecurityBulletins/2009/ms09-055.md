...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=edfea805-9544-4dc0-a52c-d7594205657b&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=171d43d3-669c-4923-b266-e47591833c05&displaylang=ko)                                                          | 원격 코드 실행 | 긴급        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c08623bf-94bc-4c50-8c10-f50fb8448a0b)                                                                          | 원격 코드 실행 | 긴급        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f3249c99-82e4-45dc-a254-28e647e822c8&displaylang=ko)                                                                           | 원격 코드 실행 | 보통        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1ad3f7b3-58d5-4507-ae20-a265e47cee9c&displaylang=ko)                                                               | 원격 코드 실행 | 보통        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=575e75d9-e348-4fbb-9eaa-43240e4d715e)                                                                           | 원격 코드 실행 | 보통        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7313c03b-8844-4086-a0cc-43dfdb3ca48c&displaylang=ko)                                     | 원격 코드 실행 | 중요        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7216bcb1-ff16-402b-ad1b-1500d46d0157&displaylang=ko) | 원격 코드 실행 | 중요        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=51eb56fa-8204-45f3-86d7-6d03a2c8d78d&displaylang=ko)\*                | 원격 코드 실행 | 낮음        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=131b047a-ae93-4a99-83e5-71d5a79e96ea&displaylang=ko)\*            | 원격 코드 실행 | 낮음        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3d16c5bf-ee5c-4220-9755-5cb92eac2aae)                     | 원격 코드 실행 | 낮음        | [MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b64bcc14-38a7-45b9-8f85-acc573777506&displaylang=ko)                                                                                | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=809e29f3-ec68-4a2b-b04e-11759dd16001&displaylang=ko)                                                                              | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=bcd2b944-6852-48f2-820b-cce7d195e391&displaylang=ko)\*                                                               | 원격 코드 실행 | 낮음        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=85e76e55-3766-4ffe-9a18-8655de935b7c)                                                                            | 원격 코드 실행 | 낮음        | 없음                                                                |
...
Microsoft Office Online 사이트, [Viewers for Visio 2007](https://office.microsoft.com/en-us/downloads/cd102071301033.aspx)에서 Microsoft Office Visio Viewer 2007 서비스 팩 2를 다운로드할 수 있습니다. 그런 다음 [MS09-060](https://go.microsoft.com/fwlink/?linkid=160633)에서 설명한 취약점으로부터 보호하기 위해 해당 공지에서 Microsoft Office Visio Viewer 2007 서비스 팩 2용 업데이트(KB973709)를 적용해야 합니다. 또는 자동 업데이트를 사용하도록 설정한 경우 자동 업데이트를 통해 최신 업데이트를 적용할 수도 있습니다.
...
**MS09-034 업데이트를 설치한 경우에도** [Microsoft 보안 권고 973882](https://technet.microsoft.com/security/advisory/973882) **및 Microsoft 보안 공지**[**MS09-035**](https://technet.microsoft.com/security/bulletin/ms09-035)**에 설명되어 있는 취약점을 해결하기 위해 Microsoft나 타사에서 배포한 구성 요소와 컨트롤을 계속 설치해야 합니까?** 
[MS09-034](https://technet.microsoft.com/security/bulletin/ms09-034)에 설명된 Internet Explorer 완화 조치는 ATL(액티브 템플릿 라이브러리)로 개발된 특정 구성 요소와 컨트롤의 근본적인 취약점을 해결하지 못합니다. 따라서, 개발자는 이 공지에서 설명하는 취약점의 영향을 받는 모든 구성 요소와 컨트롤을 이 공지에 제공된 지침에 따라 수정하고 다시 빌드하는 것이 좋습니다.

**이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에는 어떤 킬 비트가 포함되어 있습니까?**  
이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에는 이전에 릴리스된 ActiveX 킬(Kill) 비트 보안 업데이트([MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS08-032](https://technet.microsoft.com/security/bulletin/ms08-032)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS09-032](https://technet.microsoft.com/security/bulletin/ms09-032)) 및 제목이 ActiveX 킬(Kill) 비트용 업데이트 롤업인 권고([Microsoft 보안 권고 953839](https://technet.microsoft.com/security/advisory/953839), [Microsoft 보안 권고 956391](https://technet.microsoft.com/security/advisory/956391), [Microsoft 보안 권고 960715](https://technet.microsoft.com/security/advisory/960715) 및 [Microsoft 보안 권고 969898](https://technet.microsoft.com/security/advisory/969898))의 모든 킬 비트가 포함되어 있습니다.
...
킬(Kill) 비트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 240797](https://support.microsoft.com/kb/240797): Internet Explorer에서 ActiveX 컨트롤 실행을 중지하는 방법을 참조하십시오.
...
Microsoft 보안 공지 [MS09-035](https://technet.microsoft.com/security/bulletin/ms09-035)에 설명된 취약한 Microsoft ATL(액티브 템플릿 라이브러리)을 사용하여 컴파일된 Microsoft ActiveX 컨트롤(이 취약점에 대한 FAQ 섹션 참조)에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 컨트롤의 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
...
예. 기본적으로 Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성](https://go.microsoft.com/fwlink/?linkid=92039)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. [Internet Explorer 보안 강화 구성 관리](https://go.microsoft.com/fwlink/?linkid=92055)도 참조하십시오.
