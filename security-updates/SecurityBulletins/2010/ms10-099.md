...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3963 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963)을 참조하십시오.
...
**NDProxy란 무엇입니까?**    
NDPROXY는 WAN 미니포트 드라이버, 호출 관리자 및 미니포트 호출 관리자를 TAPI(Telephony Application Programming Interfaces) 서비스에 연결하는 시스템 제공 드라이버입니다. 자세한 내용은 MSDN 문서 [NDPROXY 개요 (영문)](https://msdn.microsoft.com/library/ff568322(vs.85).aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2440591">Microsoft 기술 자료 문서 2440591</a> 참조</td>
</tr>
<tr class="even">
...
-   커널 NDProxy 버퍼 오버플로 취약점(CVE-2010-3963)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com/)의 Honggang Ren
