---
TOCTitle: 'MS09-069'
Title: 'Microsoft 보안 공지 MS09-069 - 중요'
ms:assetid: 'ms09-069'
ms:contentKeyID: 61230255
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-069(v=Security.10)'
---

Microsoft 보안 공지 MS09-069 - 중요
===================================
...
이 보안 업데이트는 비공개적으로 보고된 Microsoft Windows의 취약점을 해결합니다. 이 취약점으로 인해 IPSEC(인터넷 프로토콜 보안)을 통해 영향을 받는 시스템의 로컬 보안 기관 하위 시스템 서비스(LSASS)와 통신할 때 원격에서 인증된 공격자가 특수하게 조작된 ISAKMP 메시지를 보낼 경우 서비스 거부가 허용될 수 있습니다.

이 보안 업데이트의 심각도는 지원되는 모든 Microsoft Windows 2000, Windows XP 및 Windows Server 2003 에디션에 대해 중요입니다. 자세한 내용은 본 섹션의 하위 섹션, **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 LSASS가 특수하게 조작된 요청을 처리하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=560e01db-5f59-4ef1-9406-f5d7e0fd4128&displaylang=ko)               | 서비스 거부    | 중요        | [MS06-025](https://technet.microsoft.com/security/bulletin/ms06-025) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=5448b168-6bf7-4bae-9627-b88d76c4d5c5&displaylang=ko) | 서비스 거부    | 중요        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c2bbf515-f81a-436b-947b-cbf2db85fdd9)                 | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a779aae1-7724-4458-94fb-a2343356ecae&displaylang=ko)                  | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a8a9bf12-4ad6-49fd-b2b7-f379dc3309d2&displaylang=ko)      | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=f5b003ad-af25-488a-91fb-98835a0bfeac)                  | 서비스 거부    | 중요        | 없음                                                                |
...
<th style="border:1px solid black;" >
로컬 보안 기관 하위 시스템 서비스 리소스 부족 취약점(CVE-2009-3675)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
IPSec을 통해 통신할 때 로컬 보안 기간 하위 시스템 서비스(LSASS)가 특수하게 조작된 ISAKMP 메시지를 부적절하게 처리하는 방식으로 인해 Microsoft Windows에 서비스 거부 취약점이 존재합니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3675 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3675)를 참조하십시오.

#### 로컬 보안 기관 하위 시스템 서비스 리소스 부족 취약점(CVE-2009-3675)에 대한 완화 요소

이 취약점에 대해 확인된 완화 요소가 없습니다.

#### 로컬 보안 기관 하위 시스템 서비스 리소스 부족 취약점(CVE-2009-3675)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   IPSec 서비스 사용 안 함

    IPSec 서비스를 사용하지 않는 경우 사용하지 않도록 설정할 수 있습니다.
    ...
    **참고** 레지스트리 편집기를 잘못 사용하면 시스템 전체에 심각한 문제가 발생할 수 있으며 운영 체제를 다시 설치해야 할 수도 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결을 보증하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다. 레지스트리를 편집하는 방법에 대한 자세한 내용은 레지스트리 편집기(Regedit.exe)의 "키와 값 변경" 도움말 항목 또는 Regedt32.exe의 "레지스트리의 정보 추가와 삭제" 및 "레지스트리 정보 편집" 도움말 항목을 참조하십시오.
    ...
    -   **대화형 방법 사용**
        ...
        4.  **PolicyAgent** 키를 클릭합니다.
        5.  다음 작업을 수행하여 레지스트리 키의 백업 사본을 만듭니다.
            파일 메뉴에서 **내보내기**를 클릭합니다.
            레지스트리 파일 내보내기 대화 상자에 **PolicyAgent\_configuration\_backup.reg**를 입력한 다음 **저장**을 클릭합니다.
        6.  **PolicyAgent** 키에서 **Start** 값을 두 번 클릭합니다.
        7.  **값 데이터** 필드를 **4**로 변경합니다.
        8.  **확인**을 클릭합니다.
        9.  관리자로 실행하여 명령 프롬프트에서 다음 명령을 실행합니다.
    ...
    -   **관리되는 배포 스크립트 사용**
        ...
        2.  다음 내용을 .REG 확장명의 파일로 저장합니다(예: Disable\_PolicyAgent.reg).
        ...
        5.  다음 작업을 수행하여 레지스트리 키의 백업 사본을 만듭니다.
            파일 메뉴에서 **내보내기**를 클릭합니다.
            레지스트리 파일 내보내기 대화 상자에 **PolicyAgent\_configuration\_backup.reg**를 입력한 다음 **저장**을 클릭합니다.
        6.  2단계에서 만든 위의 레지스트리 스크립트를 대상 시스템에서 다음 명령으로 실행합니다.
            Regedit /s Disable\_PolicyAgent.reg
        7.  **값 데이터** 필드를 **4**로 변경합니다.
        8.  **확인**을 클릭합니다.
        9.  대상 시스템에서 관리자로 실행하여 명령 프롬프트에서 다음 명령을 실행합니다.
            net stop PolicyAgent

    **대안의 영향.**특정 컴퓨터에서 IPSec을 사용할 수 없게 됩니다.
...
-   **대화형 방법 사용**
    ...
    3.  레지스트리 파일 가져오기 대화 상자에서 **PolicyAgent\_configuration\_backup.reg**를 선택한 다음 **열기**를 클릭합니다.
...
#### 로컬 보안 기관 하위 시스템 서비스 리소스 부족 취약점(CVE-2009-3675)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이것은 서비스 거부 취약점입니다. IPSec을 통해 서버와 통신할 때 원격에서 인증된 공격자가 특수하게 조작된 ISAKMP 메시지를 보내 LSASS.exe가 시스템 리소스를 소모하게 함으로써 서버가 다시 부팅될 때까지 서비스 거부가 지속되도록 할 수 있습니다.

**취약점의 원인은 무엇입니까?**  
이 취약점은 LSASS에서 잘못된 형식의 패킷으로 특수하게 조작된 ISAKMP 메시지를 제대로 처리하지 못하기 때문에 발생합니다.

**IPsec이란 무엇입니까?**
IPSec(Internet Protocol security)은 암호화 보안 서비스를 사용하여 IP(Internet Protocol) 네트워크를 통한 통신을 보호하는 공개 표준 프레임워크입니다. IPSec은 네트워크 수준 피어 인증, 데이터 출처 인증, 데이터 무결성, 데이터 기밀성(암호화) 및 재생 보호를 지원합니다. Microsoft의 IPSec 구현은 IETF(Internet Engineering Task Force) IPSec 작업 그룹에서 개발한 표준을 기반으로 합니다.
...
**IKE란 무엇입니까?**  
IKE는 IPSec SA(Security Associations)를 설정하기 위한 메커니즘을 설명하는 RFC 2409에서 정의된 인터넷 표준입니다. SA는 상호 합의된 정책과 IPSec 피어 간 통신을 보호하는 보안 서비스 및 메커니즘을 정의하는 키의 조합입니다. 구체적으로 IKE는 RFC 2408의 ISAKMP(Internet Security Association and Key Management 프로토콜)와 RFC 2412의 Oakley Key Determination 프로토콜을 결합합니다.
IKE는 Oakley 프로토콜을 사용하여 보호된 통신에 대한 비밀 키 자료를 생성합니다. IKE는 ISAKMP를 사용하여 SA를 협상합니다.

**ISAKMP 메시지란 무엇입니까?**  
ISAKMP는 특정 키 교환 프로토콜, 암호화/무결성 알고리즘 및 인증 방법과 독립적으로 보호된 통신을 협상하기 위한 프레임워크입니다. ISAKMP에는 피어를 식별 및 인증하고, SA를 관리하며, 키 자료를 교환하기 위한 기능이 포함되어 있습니다.

**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
이 취약점 악용에 성공한 공격자는 영향을 받는 시스템이 CPU 리소스를 소모하여 다시 시작할 때까지 응답하지 않도록 할 수 있습니다.

**공격자는 이러한 취약점을 어떻게 악용합니까?**  
공격자는 IPSEC을 통해 LSASS 서버에 연결되고 인증을 받을 때 특수하게 조작된 ISAKMP 메시지를 보내 이 취약점을 악용할 수 있습니다.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
클라이언트와 IPSec 통신을 요청하거나 필요로 하는 서버가 이 취약점으로 인해 공격 받을 가능성이 높습니다.

**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 LSASS에서 특수하게 조작된 ISAKMP 요청을 처리하는 방식을 변경합니다.
...
| **배포**                  |                                                                                                              |
| 사용자 개입 없이 설치     | Windows2000-KB974392-x86-kor /quiet                                                                          |
| 다시 시작하지 않고 설치   | Windows2000-KB974392-x86-kor /norestart                                                                      |
| 로그 파일 업데이트        | KB974392.log                                                                                                 |
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                  |
| **다시 시작 요구 사항**   |                                                                                                              |
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                          |
| 핫패칭                    | 해당 사항 없음                                                                                               |
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB974392$\\Spuninst 유틸리티를 사용하십시오. |
| **파일 정보**             | [Microsoft 기술 자료 문서 974392](https://support.microsoft.com/kb/974392) 참조                               |
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974392\\Filelist                    |
...
WindowsXP-KB974392-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB974392-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB974392$\Spuninst 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/974392">Microsoft 기술 자료 문서 974392</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB974392-x86-KOR /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB974392-x64-KOR /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB974392-x86-KOR /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB974392-x64-KOR /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
