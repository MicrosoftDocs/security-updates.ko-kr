...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>Windows 커널 데스크톱 취약점(CVE-2009-1123)</th>
<th>Windows 커널 포인터 유효성 검사 취약점(CVE-2009-1124)</th>
<th>Windows 드라이버 클래스 등록 취약점(CVE-2009-1125)</th>
<th>Windows 데스크톱 매개 변수 편집 취약점(CVE-2009-1126)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
