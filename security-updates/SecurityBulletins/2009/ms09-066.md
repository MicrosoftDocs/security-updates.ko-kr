---
TOCTitle: 'MS09-066'
Title: 'Microsoft 보안 공지 MS09-066 - 중요'
ms:assetid: 'ms09-066'
ms:contentKeyID: 61230252
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-066(v=Security.10)'
---

Microsoft 보안 공지 MS09-066 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000 Server, Windows XP, Windows Server 2003 및 Windows Server 2008 에디션의 Active Directory, ADAM 및 AD LDS에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Active Directory, ADAM 및 AD LDS에서 조작된 LDAP 또는 LDAPS 요청을 처리하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=297158cf-374c-45d9-b213-978e1f54d244&amp;displaylang=ko">Active Directory</a><br />
(KB973037)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cbe09780-f288-457a-b254-58c9c8744055&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b65ddf36-a02d-4aa2-9b4f-7416dbf59e2a">ADAM(Active Directory Application Mode)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=28f1c494-4e16-43b6-93d2-49e15f142ac9&amp;displaylang=ko">Active Directory</a><br />
(KB973037)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=44cb9029-4b19-4bad-8fc9-3efe285adb0e&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=509aeec0-112b-44ab-8686-43f381b61940&amp;displaylang=ko">Active Directory</a><br />
(KB973037)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=87f2109e-5129-467c-930f-70af31ebf5de&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=701abf15-7f93-41de-8d09-13404fd79a7e&amp;displaylang=ko">Active Directory 및 AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB973037)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=17f5f9e0-5869-41da-9b3b-6e67540af1f0&amp;displaylang=ko">Active Directory 및 AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB973037)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
Microsoft Windows 2000 Server, Windows Server 2003 및 Windows Server 2008의 Active Directory 구현에 서비스 거부 취약점이 존재합니다. 이 취약점은 Windows XP 및 Windows Server 2003에 설치된 ADAM(Active Directory Application Mode) 및 Windows Server 2008에 설치된 AD LDS(Active Directory Lightweight Directory Services)에도 존재합니다. 이 취약점은 특정 유형의 LDAP 또는 LDAPS 요청을 실행하는 동안 다 써버린 스택 공간으로 인해 발생합니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템이 응답을 중지하도록 만듭니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1928 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928)을 참조하십시오.

#### LSASS 재귀 스택 오버플로 취약점(CVE-2009-1928)에 대한 완화 요소
...
#### LSASS 재귀 스택 오버플로 취약점(CVE-2009-1928)에 대한 대안
...
-   **방화벽에서 TCP 포트 389, 636, 3268 및 3269를 차단**
    ...
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 기업 방화벽의 들어오는 방향과 나가는 방향 모두에서 이들 포트를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 침입을 예방할 수 있습니다. 포트 389 및 636은 각각 LDAP와 보안 LDAP 서비스를 제공하는 반면, 포트 3268 및 3269는 LDAP 요청도 처리하는 Global Catalog 서버에서 사용됩니다. ADAM(Active Directory Application Mode)과 AD LDS(Active Directory Lightweight Directory Service)를 통해 관리자는 기본이 아닌 LDAP 포트를 구성할 수 있습니다. 이 대안을 적용하면 악용 방지를 위해 방화벽에서도 해당 포트가 차단됩니다.
...
#### LSASS 재귀 스택 오버플로 취약점(CVE-2009-1928)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
LDAP 서비스에서 특정 LDAP 또는 LDAPS 요청을 부적절하게 처리하여 스택 공간을 다 써버립니다.

**Active Directory란 무엇입니까?**  
Active Directory의 주요 목적은 Windows 기반 컴퓨터에 대해 중앙 인증 및 권한 부여 서비스를 제공하는 것입니다.

**Active Directory Lightweight Directory Service란 무엇입니까?**  
AD LDS(Active Directory Lightweight Directory Services)는 응용 프로그램을 위한 전용 디렉터리 서비스를 제공하는 독립 모드의 Active Directory입니다. AD LDS는 Windows Server 2008 이상에서 제공되며, Windows XP 및 Windows Server 2003에서 제공된 ADAM(Active Directory Application Mode)을 대체합니다.

**LDAP란 무엇입니까?**  
LDAP(Lightweight Directory Access Protocol)는 분산형 디렉터리에 액세스를 제공하기 위해 설계된 개방형 네트워크 프로토콜 표준입니다.

**LDAPS(LDAP over SSL)란 무엇입니까?**  
기본적으로 LDAP 트래픽은 보안되지 않은 상태로 전송됩니다. 그러나 SSL(Secure Sockets Layer)과 TLS(Transport Layer Security)를 활용하여 LDAP 트래픽의 기밀을 유지하고 수정을 방지할 수 있습니다. 관리자는 [Microsoft 기술 자료 문서 321051](https://support.microsoft.com/kb/321051)에 따라 Microsoft 인증 기관(CA)이나 Microsoft 이외 CA가 발행한 올바른 형식의 디지털 인증서를 설치하여 LDAPS(LDAP over SSL)를 활성화할 수 있습니다.
...
**Active Directory를 사용 중인 경우 서버에서 LDAP 서비스를 실행하고 있는지 어떻게 확인할 수 있습니까**?  
서버의 LDAP나 LDAPS 쿼리 수신 대기 여부를 확인하려면 관리자 명령 프롬프트에서 다음 명령을 실행하여 시스템이 LDAP 포트(389) 또는 LDAPS 포트(636)에서 수신 대기 중인지 아니면 Global Catalog 서비스 포트(3268 또는 3269) 중 하나에서 대기 중인지 확인하십시오.
netstat –a
...
이 취약점 악용에 성공한 공격자는 사용자의 시스템에서 응답을 중지하거나 다시 시작하도록 만들 수 있습니다.

**공격자는 이러한 취약점을 어떻게 악용합니까?**  
공격자는 특수하게 조작한 LDAP 또는 LDAPS 패킷을 ADAM, AD LDS 또는 Active Directory 서버에 보내는 방법으로 취약점 악용을 시도할 수 있습니다. Microsoft Windows 2000 Server의 경우 대상 네트워크에 액세스할 수 있는 익명 사용자가 특수하게 조작한 네트워크 패킷을 영향을 받는 시스템에 전달하여 이 취약점을 악용할 수 있습니다. 기타 모든 영향을 받는 플랫폼에서 공격자가 이 취약점을 악용하려면 유효한 인증 자격 증명이 있어야 합니다.

**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
LDAP(Lightweight Directory Access Protocol)는 Active Directory, ADAM 및 AD LDS에 반드시 필요합니다. 따라서 ADAM, AD LDS 또는 Active Directory 서버로 실행 중인 시스템이 이 취약점의 영향을 받습니다.

**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 조작된 LDAP 또는 LDAPS 요청을 올바르게 처리하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server의 Active Directory:<br />
Windows2000-KB973037-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 Server의 Active Directory:<br />
Windows2000-KB973037-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server에 설치된 Active Directory의 경우 제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973037$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973037">Microsoft 기술 자료 문서 973037</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 ADAM(Active Directory Application Mode):<br />
WindowsXP-KB973039-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 ADAM(Active Directory Application Mode):<br />
WindowsXP-KB973039-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 ADAM(Active Directory Application Mode):<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973039$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/973039">Microsoft 기술 자료 문서 973039</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 Active Directory:<br />
WindowsServer2003-KB973037-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 ADAM(Active Directory Application Mode:<br />
WindowsServer2003-KB973039-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 Active Directory:<br />
WindowsServer2003.WindowsXP-KB973037-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 ADAM(Active Directory Application Mode):<br />
WindowsServer2003.WindowsXP-KB973039-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 SP2(Itanium 기반 시스템용)의 Active Directory:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">Active Directory의 경우 제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973037$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM(Active Directory Application Mode)의 경우 제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973039$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory의 경우 <a href="https://support.microsoft.com/kb/973037">Microsoft 기술 자료 문서 973037</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003의 ADAM(Active Directory Application Mode)의 경우 <a href="https://support.microsoft.com/kb/973039">Microsoft 기술 자료 문서 973039</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory:<br />
