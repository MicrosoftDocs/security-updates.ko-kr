...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2293194](http://support.microsoft.com/kb/2293194)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft Word Web App은 Microsoft Office Web Apps의 일부로 Microsoft SharePoint Server 2010에 Office Web Apps를 구성한 조직에서 사용할 수 있습니다. Word Web App는 Microsoft Word 경험을 웹 브라우저로 확장하여 문서가 저장되는 웹 사이트에서 바로 문서 작업을 할 수 있습니다. Word Web App에 대한 자세한 내용은 [Word Web App 소개(영문)](http://office.microsoft.com/en-us/web-apps-help/introduction-to-word-web-app-ha010378341.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2747 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2747)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2748 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2748)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2750 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2750)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3214 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3214)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3215 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3215)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3216 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3216)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3217 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3217)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3218 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3218)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3219 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3219)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3220 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3220)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3221 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3221)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2328360">Microsoft 기술 자료 문서 2328360</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2344911">Microsoft 기술 자료 문서 2344911</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Word 2007의 경우 <a href="http://support.microsoft.com/kb/2344993">Microsoft 기술 자료 문서 2344993</a>을 참조하십시오.<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="http://support.microsoft.com/kb/2345043">Microsoft 기술 자료 문서 2345043</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Office 2010의 경우 <a href="http://support.microsoft.com/kb/2345000">Microsoft 기술 자료 문서 2345000</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Word Web App의 경우 <a href="http://support.microsoft.com/kb/2345015">Microsoft 기술 자료 문서 2345015</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Web Apps의 경우 <a href="http://support.microsoft.com/kb/2346411">Microsoft 기술 자료 문서 2346411</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word 초기화되지 않은 포인터 취약점(CVE-2010-2747)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 경계 검사 취약점(CVE-2010-2748)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 인덱스 취약점(CVE-2010-2750)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 스택 오버플로 취약점(CVE-2010-3214)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   Word 반환 값 취약점(CVE-2010-3215)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 책갈피 취약점(CVE-2010-3216)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 포인터 취약점(CVE-2010-3217)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 힙 오버플로 취약점(CVE-2010-3218)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 인덱스 구문 분석 취약점(CVE-2010-3219)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 구문 분석 취약점(CVE-2010-3220)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar  
-   Word 구문 분석 취약점(CVE-2010-3221)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Chaouki Bekrar
