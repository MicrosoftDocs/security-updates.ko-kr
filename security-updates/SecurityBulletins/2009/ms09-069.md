...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=560e01db-5f59-4ef1-9406-f5d7e0fd4128&displaylang=ko)               | 서비스 거부    | 중요        | [MS06-025](http://technet.microsoft.com/security/bulletin/ms06-025) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3675 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3675)를 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 974392](http://support.microsoft.com/kb/974392) 참조                               |
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/974392">Microsoft 기술 자료 문서 974392</a> 참조</td>
</tr>
<tr class="even">
