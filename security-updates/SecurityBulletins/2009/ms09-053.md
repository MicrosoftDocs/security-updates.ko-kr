...
이 보안 업데이트는 [Microsoft 보안 권고 975191](https://technet.microsoft.com/security/advisory/975191)에서 처음 설명한 취약점도 해결합니다.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975254](https://support.microsoft.com/kb/975254)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
-   [IIS 7.0(x86)용 Microsoft FTP 서비스 7.5](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=b7f5b652-8c5c-447a-88b8-8cfc5c13f571)
-   [IIS 7.0(x64)용 Microsoft FTP 서비스 7.5](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=ffb7c167-279e-48d3-8169-dea85784c4d1)
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2521 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-2521 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521)이 지정되었습니다.
...
예. 이 보안 업데이트는 현재 악용되고 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-2521 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3023 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023)을 참조하십시오.
...
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
FTP 서비스에 액세스 권한이 있는 공격자는 이 취약점을 사용하여 IIS 5.0을 실행하고 있는 시스템에서 스택 기반 오버런을 발생시켜 LocalSystem 계정의 컨텍스트에서 임의 코드를 실행하거나 IIS 5.1 또는 IIS 6.0을 실행하는 영향을 받는 시스템에서 서비스 거부를 유발할 수 있습니다. LocalSystem 계정에 대한 자세한 내용은 MSDN 문서, [LocalSystem 계정(영문)](https://msdn.microsoft.com/en-us/library/ms684190(vs.85).aspx)을 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023)이 지정되었습니다.

**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
예. Microsoft는 이 취약점을 악용하려는 제한적이며 대상이 일정한 공격에 대한 보고를 받았습니다.

**이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?**    
예. 이 보안 업데이트는 현재 악용되고 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023)이 지정되었습니다.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 975254](https://support.microsoft.com/kb/975254) 참조                                                   |
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975254">Microsoft 기술 자료 문서 975254</a> 참조</td>
</tr>
<tr class="even">
