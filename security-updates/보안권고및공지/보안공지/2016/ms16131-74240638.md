...
<td style="border:1px solid black;">
[**Microsoft 비디오 컨트롤 원격 코드 실행 취약성(CVE-2016-7248)(영문)**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198218)  
(3198218)
...
<td style="border:1px solid black;">
[MS16-122](http://go.microsoft.com/fwlink/?linkid=829051)([3190847](https://support.microsoft.com/ko-kr/kb/3190847))

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 버전 서비스 팩 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3198218)  
(3198218)
...
**영향받는 소프트웨어 및 취약성 심각도** 표에서 심각도가 긴급으로 표시된 경우 Outlook 미리 보기 창이 [CVE-2016-0142(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248)에 대한 공격 벡터입니다.
...
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248">CVE-2016-7248(영문)</a></td>
