---
TOCTitle: 'MS16-003'
Title: 'Microsoft 보안 공지 MS16-003 - 긴급'
ms:assetid: 'ms16-003'
ms:contentKeyID: 72150192
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-003(v=Security.10)'
---


Microsoft 보안 공지 MS16-003 - 긴급
===================================

원격 코드 실행을 해결하기 위한 JScript 및 VBScript에 대한 누적 보안 업데이트(3125540)
-------------------------------------------------------------------------------------

게시된 날짜: 2016년 1월 13일 | 업데이트된 날짜: 2016년 5월 26일
...
이 업데이트는 VBScript 스크립팅 엔진이 메모리에서 개체를 처리하는 방식을 수정하여 이러한 취약성을 해결합니다. 이 취약성에 대한 자세한 내용은 **취약성정보** 절을 참조하십시오.

<span id="KBArticle"></span>
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3125540](https://support.microsoft.com/ko-kr/kb/3125540)을 참조하십시오.

영향받는 소프트웨어
-------------------

<span id="sectionToggle1"></span>
다음 버전의 VBScript가 이 공지에 설명된 취약성의 영향을 받습니다. 나열되지 않은 이전 버전 또는 에디션은 [지원 주기](https://support.microsoft.com/ko-kr/lifecycle)가 끝났거나 영향을 받지 않습니다. 다음과 같은 영향받는 소프트웨어는 Internet Explorer 7 이하가 설치된 시스템 및 Internet Explorer가 설치되지 않은 시스템에 적용됩니다. 시스템에서 Internet Explorer 8 이상을 실행하는 고객은 Internet Explorer 누적 업데이트 3124275([MS16-001](https://technet.microsoft.com/ko-kr/library/security/ms16-001))를 적용해야 합니다. 이 업데이트는 본 공지에 설명된 취약성을 해결합니다.
...
<td style="border:1px solid black;">
[VBScript 5.7](https://www.microsoft.com/ko-kr/download/details.aspx?id=50603&displaylang=ko)  
(3124624)
...
<td style="border:1px solid black;">
[MS15-126](https://technet.microsoft.com/ko-kr/library/security/ms15-126)의 3105579
...
<td style="border:1px solid black;">
[VBScript 5.7](https://www.microsoft.com/ko-kr/download/details.aspx?id=50540&displaylang=ko)  
(3124624)
...
<td style="border:1px solid black;">
[VBScript 5.7](https://www.microsoft.com/ko-kr/download/details.aspx?id=50528&displaylang=ko)  
(3124624)
...
<td style="border:1px solid black;">
[VBScript 5.7](https://www.microsoft.com/ko-kr/download/details.aspx?id=50643&displaylang=ko)  
(3124624)
...
<td style="border:1px solid black;">
[VBScript 5.8](https://www.microsoft.com/ko-kr/download/details.aspx?id=50544&displaylang=ko)  
(3124625)
...
<td style="border:1px solid black;">
[MS15-126](https://technet.microsoft.com/ko-kr/library/security/ms15-126)의 3105578
...
이 공지의 영향받는 소프트웨어는 Internet Explorer가 설치되지 않은 시스템 및 Internet Explorer 7 이하 버전이 설치된 시스템에 적용됩니다. 시스템에서 Internet Explorer 8 이상을 실행하는 고객은 Internet Explorer 누적 업데이트([MS16-001](https://technet.microsoft.com/ko-kr/library/security/ms16-001))를 적용해야 합니다. 이 업데이트는 본 공지에 설명된 취약성을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/library/security/ms16-001"><strong>MS16-001</strong></a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">
[**스크립팅 엔진 메모리 손상 취약성(CVE-2016-0002)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0002)
...
*2016-05-25 12:44-07:00에 페이지가 생성되었습니다.*
