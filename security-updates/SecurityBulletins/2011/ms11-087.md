...
이 보안 업데이트는 [Microsoft 보안 권고 2639658](http://technet.microsoft.com/ko-kr/security/advisory/2639658)에서 처음 설명한 취약점도 해결합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa&displaylang=ko)                                                                                     | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6)                                                                           | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69&displaylang=ko)                                                                            | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)                                                                            | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af&displaylang=ko)                                                                                  | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e&displaylang=ko)                                                                      | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25&displaylang=ko)\*\*\*\*                                                   | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416&displaylang=ko)\*\*\*\*                                                 | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)                                                                    | 원격 코드 실행 | 긴급        | [MS11-077](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-077) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6&displaylang=ko)                                       | 원격 코드 실행 | 긴급        | [MS11-084](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629&displaylang=ko)                                   | 원격 코드 실행 | 긴급        | [MS11-084](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea&displaylang=ko)\*\*\*\* | 원격 코드 실행 | 긴급        | [MS11-084](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813)                | 원격 코드 실행 | 긴급        | [MS11-084](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-084) |
...
그러나 이 대안으로 인해 비활성화된 기능을 복원하기 위해 이 보안 업데이트를 적용한 후에 이전에 대안을 적용했던 시스템에서 "T2EMBED.DLL 액세스 거부" 대안을 실행 취소해야 합니다. 이 대안을 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2639417](http://support.microsoft.com/kb/2639417)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.

파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.

Windows 개발자 미리 보기가 이 문제점의 영향을 받습니까?  
예, Windows 개발자 미리 보기 릴리스에 KB2639417 업데이트가 사용될 수 있습니다. Windows 개발자 미리 보기를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. 이 업데이트는 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130)에서 구할 수 있습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2639417">Microsoft 기술 자료 문서 2639417</a> 참조</td>
</tr>
<tr class="even">
