...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524&displaylang=ko)                                                                              | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38&displaylang=ko)                                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc&displaylang=ko)\*\*                                                   | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9&displaylang=ko)\*\*                                                 | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                                | 원격 코드 실행 | 보통        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9&displaylang=ko)                                   | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960&displaylang=ko)                               | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5&displaylang=ko)\*\* | 원격 코드 실행 | 낮음        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1)            | 원격 코드 실행 | 낮음        | 없음                      |
...
Windows Server 2008에 기본적으로 설치되지 않는 Windows Mail 등의 다양한 데스크톱 기능이 있습니다. 대신 Windows Server 2008에 Desktop Experience를 설치하여 이런 기능을 모두 함께 설치할 수 있습니다. 자세한 내용은 TechNet 문서, [Windows Mail, Windows Media Player 및 기타 Windows Server 2008의 Desktop Experience에 포함된 기능](http://technet.microsoft.com/ko-kr/library/cc771519(ws.10).aspx)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2016(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016)을 참조하십시오.
...
Windows Meeting Space를 사용하면 Windows Vista 운영 체제가 설치된 컴퓨터를 보유한 다른 사용자와 문서, 프로그램 또는 데스크톱을 공유할 수 있습니다. Windows Meeting Space에서는 P2P(Peer-to-Peer) 기술을 사용하고 기존 네트워크를 찾을 수 없는 경우 ad-hoc 네트워크를 자동으로 설정합니다. 자세한 내용은 [Windows Meeting Space FAQ](http://windows.microsoft.com/ko-kr/windows-vista/windows-meeting-space-frequently-asked-questions)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2620704">Microsoft 기술 자료 문서 2620704</a> 참조</td>
</tr>
<tr class="odd">
