---
TOCTitle: 'MS11-011'
Title: 'Microsoft 보안 공지 MS11-011 - 중요'
ms:assetid: 'ms11-011'
ms:contentKeyID: 61230378
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-011(v=Security.10)'
---
...
보안 업데이트는 Windows 커널이 메모리를 할당하기 전에 사용자 제공 데이터의 유효성을 올바르게 검사하도록 하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2393802](http://support.microsoft.com/kb/2393802)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=a511d33a-9ae0-46ee-a225-9d97390de7d1&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e7273a85-ce96-464b-8c4f-2710701213e3)                                                               | 권한 상승      | 중요        | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6bf2eeec-8225-477f-a606-263d3ee434d6&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec544894-ee98-4a2b-ac4d-33b0c3754213&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=fcd48499-1bb4-4304-b9cc-27d9d92e11cd)                                                           | 권한 상승      | 중요        | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=66978514-bb7f-42cc-9360-2fd1c686f4e6&displaylang=ko)                                         | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fdb8c37-1b22-457b-bdc0-21f6a5061dd3&displaylang=ko)                 | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b37418a-e044-415e-b566-4507f157934a&displaylang=ko)\*     | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=163d3aca-3703-452e-b1cb-73932e2bcf8c&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=55b07bc0-dff5-4cd7-87c9-c08e5a49197d)          | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=e1224c90-b0bc-4e4b-999a-efae327213b4&displaylang=ko)                                                                     | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=ddcf352e-742c-485e-9ed5-19cdba673562&displaylang=ko)                                                                   | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=70f5056a-72ad-46ff-a43f-ee151639b9a7&displaylang=ko)\*                                                    | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=1646b3a5-714f-4ea5-b109-566fa9b933b6)                                                                 | 권한 상승      | 중요        | [MS10-047](http://technet.microsoft.com/security/bulletin/ms10-047) |
...
<th style="border:1px solid black;" >Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)</th>
<th style="border:1px solid black;" >Windows 커널 정수 잘림 취약점(CVE-2011-0045)</th>
...
Windows 커널과 드라이버으 부적절한 상호 작용으로 인해 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-4398 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398)을 참조하십시오.
  
#### Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 드라이버와 Windows 커널의 부적절한 상호 작용으로 인해 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 영향을 받는 드라이버와 Windows 커널의 상호 작용을 안전하게 하여 취약점을 해결합니다.
  
**이 업데이트에 기능에 대한 보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 보안과 관련된 기능 변경 사항이 포함되어 있습니다. 자세한 내용은 MSDN 문서, [RtlQueryRegistryValues 루틴 (영문)](http://msdn.microsoft.com/en-us/library/ff562046(v=vs.85).aspx)을 참조하십시오.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-4398 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398)이 지정되었습니다.
...
Windows 커널이 사용자 제공 데이터를 읽을 때 메모리를 할당하는 방식에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0045 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0045)를 참조하십시오.
  
#### Windows 커널 정수 잘림 취약점(CVE-2011-0045)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
  
#### Windows 커널 정수 잘림 취약점(CVE-2011-0045)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 정수 잘림 취약점(CVE-2011-0045)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**  
Windows 커널이 메모리를 할당하기 전에 사용자 제공 데이터의 유효성을 올바르게 검사하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Windows 커널이 메모리를 할당하기 전에 사용자 제공 데이터의 유효성을 올바르게 검사하도록 하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2393802$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2393802">Microsoft 기술 자료 문서 2393802</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)을 보고해 주신 [360safe (영문)](http://www.360.cn)의 Zhengwenbin  
-   Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)을 보고해 주신 Guo Bojun  
-   Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)을 보고해 주신 Wei Zhang  
-   Windows 커널과 드라이버의 부적절한 상호 작용 취약점(CVE-2010-4398)을 해결하기 위해 협력해 주신 [Prevx](http://www.prevx.com/)의 Marco Giuliani  
-   Windows 커널 정수 잘림 취약점(CVE-2011-0045)을 [TippingPoint (영문)](http://www.tippingpoint.com/) [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 std\_logic
...
-   V1.1(2011년 3월 3일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2393802 링크가 추가되었습니다.  
-   V1.2(2011년 3월 19일): **영향을 받지 않는 소프트웨어**에 Windows 7(32비트 시스템용) 서비스 팩 1, Windows 7(x64 기반 시스템용) 서비스 팩 1, Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1이 추가되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.
