...
[Microsoft Exchange Server 2007 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=605fc9bc-a05c-4466-ace6-9c2af087d797&displaylang=ko)   
(KB2746157)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-058](http://go.microsoft.com/fwlink/?linkid=259630)의 KB2756497은 KB2746157로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Exchange Server 2010 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=e43b1164-d768-4152-b9a3-d1491e2f3cba&displaylang=ko)   
(KB2787763)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-058](http://go.microsoft.com/fwlink/?linkid=259630)의 KB2756496은 KB2787763으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Microsoft Exchange Server 2010 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2a49ed58-9dab-4d48-ae8a-c7139e3b34ba&displaylang=ko)   
(KB2785908)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-058](http://go.microsoft.com/fwlink/?linkid=259630)의 KB2756485는 KB2785908로 대체되었습니다.
</td>
</tr>
</table>
...
[Oracle Critical Patch Update Advisory - October 2012](http://www.oracle.com/technetwork/topics/security/cpuoct2012-1515893.html)에 설명된 CVE-2012-3214 및 CVE-2012-3217은 Microsoft Exchange Server에 영향을 미치며, 이 업데이트에 의해 해결됩니다.
...
-   Exchange Server 2007 서비스 팩 3용 업데이트 롤업 9(KB2746157)의 경우 [Microsoft 기술 자료 문서 2746157](http://support.microsoft.com/kb/2746157)을 참조하십시오.
-   Exchange 2010 서비스 팩 1용 업데이트 롤업 8(KB2787763)의 경우 [Microsoft 기술 자료 문서 2787763](http://support.microsoft.com/kb/2787763)을 참조하십시오.
-   Exchange 2010 서비스 팩 2용 업데이트 롤업 5(KB2785908)의 경우 [Microsoft 기술 자료 문서 2785908](http://support.microsoft.com/kb/2785908)을 참조하십시오.

이전에 Exchange Server 2010 사서함 서버 핫픽스에 상위 버전 버킷을 설치했습니다. 이 경우 업데이트를 설치해야 합니까?  
예. 이미 [Microsoft 기술 자료 문서 2786772](http://support.microsoft.com/kb/2786772)에서 설명한 핫픽스가 적용된 시스템은 [CVE-2012-4791](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791)에 설명된 취약점으로부터 보호되지만 시스템은 이 업데이트로 해결된 Oracle Outside In 취약점에 여전히 취약합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4791](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791)(영문)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2784126">Microsoft 기술 자료 문서 2784126</a> 참조</td>
</tr>
<tr class="even">
