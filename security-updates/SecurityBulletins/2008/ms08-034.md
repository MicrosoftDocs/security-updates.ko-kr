...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=aa8aa79f-c2cc-440c-9e5c-089143e6f814&displaylang=ko)                                         | 권한 상승      | 중요        | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
...
| [Windows Server 2003 x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc&displaylang=ko)                                                   | 권한 상승      | 중요        | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 948745](http://support.microsoft.com/kb/948745)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1541 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1451)을 참조하십시오.
...
WINS에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 상승된 권한을 사용하여 코드를 실행할 수 있습니다. 그런 다음 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 자세한 내용은 [WINS (영문)](http://technet2.microsoft.com/windowsserver/en/library/ea41036e-5cbf-427b-a34f-9e4d1d1519581033.mspx?mfr=true) Technet 문서를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/948745">Microsoft 기술 자료 문서 948745</a>를 참조하십시오.</td>
</tr>
<tr class="even">
