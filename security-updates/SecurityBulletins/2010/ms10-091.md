---
TOCTitle: 'MS10-091'
Title: 'Microsoft 보안 공지 MS10-091 - 긴급'
ms:assetid: 'ms10-091'
ms:contentKeyID: 61230351
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-091(v=Security.10)'
---


Microsoft 보안 공지 MS10-091 - 긴급
===================================

OPF(OpenType 글꼴) 드라이버의 취약점으로 인한 원격 코드 실행 문제점(2296199)
----------------------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해 긴급입니다. 또한 지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 OpenType 글꼴을 구문 분석할 때 OTF(OpenType 글꼴) 드라이버가 배열을 인덱싱하고, 메모리를 확보할 때 포인터를 다시 설정하고, OpenType 글꼴을 렌더링할 때 OMAP 테이블을 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3)                                                               | 권한 상승      | 중요        | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de)                                                           | 권한 상승      | 중요        | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30&displaylang=ko)                 | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e&displaylang=ko)\*     | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b)          | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92&displaylang=ko)                                                                   | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01&displaylang=ko)\*                                                    | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5)                                                                 | 원격 코드 실행 | 긴급        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
...
<th style="border:1px solid black;" >OpenType 글꼴 인덱스 취약점(CVE-2010-3956)</th>
<th style="border:1px solid black;" >OpenType 글꼴 Double Free 취약점(CVE-2010-3957)</th>
<th style="border:1px solid black;" >OpenType CMAP 테이블 취약점(CVE-2010-3959)</th>
...
OTP(OpenType 글꼴) 드라이버가 특수하게 조작된 OpenType 글꼴을 부적절하게 구문 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3956 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956)을 참조하십시오.
  
#### OpenType 글꼴 인덱스 취약점(CVE-2010-3956)에 대한 완화 요소
...
#### OpenType 글꼴 인덱스 취약점(CVE-2010-3956)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **Windows 탐색기에서 미리 보기 창 및 세부 정보 창 사용 안 함**
  
    Windows 탐색기에서 미리 보기 및 세부 정보 창을 사용하지 않도록 설정하면 Windows 탐색기에 OTF 글꼴이 보이지 않습니다. 이로 인해 Windows 탐색기에서 악의적인 파일이 보이지 않게 되지만 허가된 로컬 사용자가 특수하게 조작된 프로그램을 실행해서 이 취약점을 악용하는 것을 막지는 못합니다. Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에서 이러한 창을 사용하지 않도록 설정하려면 다음을 수행하십시오.
...
#### OpenType 글꼴 인덱스 취약점(CVE-2010-3956)에 대한 FAQ
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 OTF(OpenType 글꼴) 드라이버가 OpenType 글꼴을 구문 분석할 때 배열을 인덱싱하는 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3957 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957)을 참조하십시오.
  
#### OpenType 글꼴 Double Free 취약점(CVE-2010-3957)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
  
#### OpenType 글꼴 Double Free 취약점(CVE-2010-3957)에 대한 대안
...
#### OpenType 글꼴 Double Free 취약점(CVE-2010-3957)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
OTF(OpenType 글꼴) 드라이버가 메모리를 해제할 때 포인터를 올바르게 다시 설정하지 못하면 이 취약점이 발생합니다. 결과적으로 "double free" 조건이 됩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 OTF(OpenType 글꼴) 드라이버가 메모리를 해제할 때 포인터를 다시 설정하는 방식을 수정하여 이 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3959 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959)를 참조하십시오.
  
#### OpenType CMAP 테이블 취약점(CVE-2010-3959)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
  
#### OpenType CMAP 테이블 취약점(CVE-2010-3959)에 대한 대안
...
#### OpenType CMAP 테이블 취약점(CVE-2010-3959)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
OTF(OpenType 글꼴) 드라이버가 특수하게 조작된 OpenType 글꼴을 렌더링할 때 CMAP 테이블을 제대로 구문 분석하지 못하면 이 취약점이 발생합니다.
  
**EOT(Embedded OpenType) 글꼴이란 무엇입니까?**    
EOT(Embedded OpenType) 글꼴은 웹 페이지에 사용하도록 설계된 압축 형태의 글꼴로, 문서에 포함될 수 있습니다. 따라서 사용자는 작성자가 의도한 대로 정확히 문서를 보게 됩니다. 웹 작성자는 WEFT(Web Embedding Fonts Tool)를 사용하여 브라우저를 통해 본 페이지가 글꼴 개체에 포함된 스타일로 표시되도록 웹 페이지에 연결된 글꼴 개체를 만들 수 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보 (영문)](http://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 운영 체제는 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
**타사 웹 브라우저가 이 취약점의 영향을 받습니까?**    
예. 기본적으로 OpenType 글꼴을 렌더링하는 경우에는 타사 웹 브라우저도 이 취약점의 영향을 받습니다. 이러한 응용 프로그램의 경우 사용자가 특수하게 조작된 포함 OpenType 글꼴이 있는 웹 사이트로 이동할 경우 이 취약점으로 인해 원격 서비스 거부 공격이 발생할 수 있습니다. 기본적으로 Internet Explorer는 이 문제점의 영향을 받지 않습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 OTF(OpenType 글꼴) 드라이버가 OpenType 글꼴을 렌더링할 때 CMAP 테이블을 구문 분석하는 방식을 수정하여 취약점을 해결합니다.
  
**CMAP 테이블이란 무엇입니까?**    
이 테이블은 문자 코드-글꼴에 사용된 문자 모양 인덱스 값 매핑을 정의합니다. 여기에는 둘 이상의 문자 모양 인코딩 체계를 지원하기 위한 둘 이상의 하위 테이블이 포함될 수 있습니다. 테이블 머리글에는 하위 테이블이 있는 문자 인코딩이 나와 있습니다. 각 하위 테이블은 7가지 서식 중 하나로 존재하며, 사용된 서식을 나타내는 서식 코드로 시작됩니다. 자세한 내용은 [문자-문자 모양 인덱스 매핑 테이블 (영문)](http://www.microsoft.com/typography/otspec/cmap.htm)을 참조하십시오.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2296199$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2296199">Microsoft 기술 자료 문서 2296199</a> 참조</td>
</tr>
<tr class="even">
...
-   OpenType 글꼴 인덱스 취약점(CVE-2010-3956)을 [Opera Security Team (영문)](http://www.opera.com/security/)과 협력하여 보고해 주신 [Red Hat Security Response Team (영문)](https://www.redhat.com/security/team/)의 Marc Schoenefeld  
-   OpenType 글꼴 Double Free 취약점(CVE-2010-3957)을 보고해 주신 [Red Hat Security Response Team (영문)](https://www.redhat.com/security/team/)의 Marc Schoenefeld  
-   OpenType CMAP 테이블 취약점(CVE-2010-3959)을 보고해 주신 Paul-Kenji Cahier Furuya
