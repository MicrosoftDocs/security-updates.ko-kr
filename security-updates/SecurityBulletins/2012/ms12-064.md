...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2742319](https://support.microsoft.com/kb/2742319)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[MS12-029](https://go.microsoft.com/fwlink/?linkid=248419)의 KB2598332는 KB2687483으로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-029](https://go.microsoft.com/fwlink/?linkid=248419)의 KB2596917은 KB2687315로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696)의 KB2345009는 KB2687485로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-029](https://go.microsoft.com/fwlink/?linkid=248419)의 KB2596880은 KB2687314로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2742319](https://support.microsoft.com/kb/2742319)를 참조하십시오.
...
이 공지에서 제공하는 Microsoft Office Web Apps 2010 서비스 팩 1(KB2687401)에 대한 보안 업데이트 패키지는 [MS12-066](https://go.microsoft.com/fwlink/?linkid=260957) 보안 공지에서 설명하는 취약점도 해결합니다.
  
Word Automation Services란 무엇입니까?  
Word Automation Services는 SharePoint Server 2010의 서비스 응용 프로그램으로, 문서를 Microsoft Word 클라이언트 응용 프로그램에서 지원하는 형식으로 서버 쪽에서 자동 변환해 줍니다. 자세한 내용은 [Word Automation Services 개요](https://msdn.microsoft.com/library/ee558830)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [9월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-sep)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0182](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0182)(영문)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2528)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2687483">Microsoft 기술 자료 문서 2687483</a> 및 <a href="https://support.microsoft.com/kb/2687485">Microsoft 기술 자료 문서 2687485</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2687315">Microsoft 기술 자료 문서 2687315</a> 및 <a href="https://support.microsoft.com/kb/2687314">Microsoft 기술 자료 문서 2687314</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2553488">Microsoft 기술 자료 문서 2553488</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2598237">Microsoft 기술 자료 문서 2598237</a> 및 <a href="https://support.microsoft.com/kb/2687401">Microsoft 기술 자료 문서 2687401</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word PAPX 섹션 손상 취약점(CVE-2012-0182)을 [TippingPoint의](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 익명 연구자  
-   RTF 파일 listid Use-After-Free 취약점(CVE-2012-2528)을 Beyond Security의 [SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html)(영문) 프로그램과 협력하여 보고해 주신 익명 연구자
