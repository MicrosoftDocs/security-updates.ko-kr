...
이 보안 업데이트는 [Microsoft 보안 권고 2286198](http://technet.microsoft.com/security/advisory/2286198)에서 처음 설명한 취약점을 해결합니다.
...
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3b44bd67-48e2-497f-9165-42a702e2cc0d)                                                               | 원격 코드 실행 | 긴급        | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=32fe91ef-5a8d-4095-90ee-2ca216696b09&displaylang=ko)                                                                | 원격 코드 실행 | 긴급        | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=923de214-c4fa-41e6-8307-2c5a37f13e8e&displaylang=ko)                                                    | 원격 코드 실행 | 긴급        | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=63aa5f8a-fe47-4892-b905-b54e4f3b6580)                                                           | 원격 코드 실행 | 긴급        | [MS07-061](http://technet.microsoft.com/security/bulletin/ms07-061) |
...
영향을 받는 Microsoft Windows 버전에 원격 코드 실행 취약점이 있습니다. 이 취약점은 바로 가기에 대한 Windows의 잘못된 구문 분석으로 인해 발생하며 운영 체제에 악성 바로 가기 파일의 아이콘이 표시될 때 악성 코드가 실행될 수 있습니다. 이 취약점을 악용에 성공한 공격자는 로그온한 사용자 자격으로 임의 코드를 실행할 수 있습니다. 이 업데이트는 [Microsoft 보안 권고 2286198](http://technet.microsoft.com/security/advisory/2286198)에서 이미 다룬 취약점을 해결합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2568 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)을 참조하십시오.
...
-   **바로 가기 아이콘 표시 사용 안 함**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2286198](http://support.microsoft.com/kb/2286198)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오. 이 Fix it 솔루션을 적용하기 위해서는 완료되는 대로 다시 시작해야 합니다. 이 Fix it 솔루션에서 배포하는 대안은 모든 사용자에게 영향을 미칩니다. 따라서 관리자는 이 Fix it 솔루션을 배포하기 전에 해당 KB 문서를 면밀히 검토하는 것이 좋습니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2568 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2286198">Microsoft 기술 자료 문서 2286198</a> 참조</td>
</tr>
<tr class="even">
...
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 보고해 주신 [VirusBlokAda (영문)](http://www.anti-virus.by/)의 Sergey I. Ulasen 및 Uleg Kopreev  
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 보고해 주신 [AV-Test (영문)](http://www.av-test.org/)의 Andreas Marx 및 Maik Morgenstern  
-   바로 가기 아이콘 로드 취약점(CVE-2010-2568)을 해결하기 위해 협력해 주신 [CERT/CC (영문)](http://www.cert.org)의 Will Dormann  
