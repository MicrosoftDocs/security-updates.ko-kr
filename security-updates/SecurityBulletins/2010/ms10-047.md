---
TOCTitle: 'MS10-047'
Title: 'Microsoft 보안 공지 MS10-047 - 중요'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61230308
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-047(v=Security.10)'
---



Microsoft 보안 공지 MS10-047 - 중요
===================================
...
이 보안 업데이트의 심각도는 Windows XP, Windows Vista 및 Windows Server 2008에 대해 중요이며, Windows 7 및 Windows Server 2008 R2에 대해서는 보통입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널 개체 초기화 및 액세스 제어 목록의 유효성 검사를 수정하고 스레드 생성 메커니즘에 추가 런타임 유효성 검사를 도입하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1&displaylang=ko)                                         | 권한 상승      | 중요        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc&displaylang=ko)                 | 권한 상승      | 중요        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27&displaylang=ko)\*     | 권한 상승      | 중요        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79)          | 권한 상승      | 중요        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14&displaylang=ko)                                                                     | 서비스 거부    | 보통        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8&displaylang=ko)                                                                   | 서비스 거부    | 보통        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4&displaylang=ko)\*                                                    | 서비스 거부    | 보통        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5)                                                                 | 서비스 거부    | 보통        | [MS10-021](https://technet.microsoft.com/security/bulletin/ms10-021) |
...
<th style="border:1px solid black;" >Windows 커널 데이터 초기화 취약점(CVE-2010-1888)</th>
<th style="border:1px solid black;" >Windows 커널 Double Free 취약점(CVE-2010-1889)</th>
<th style="border:1px solid black;" >Windows 커널 잘못된 유효성 검사 취약점(CVE-2010-1890)</th>
...
Windows 커널에는 커널이 특정 스레드 생성 시도를 처리하는 방식으로 인해 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1888 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888)을 참조하십시오.
  
#### Windows 커널 데이터 초기화 취약점(CVE-2010-1888)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 데이터 초기화 취약점(CVE-2010-1888)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 데이터 초기화 취약점(CVE-2010-1888)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 특정 유형의 스레드를 만들 때 나타나는 경쟁 조건 때문에 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 스레드 생성 메커니즘에 추가 런타임 유효성 검사를 도입하여 이러한 취약점을 해결합니다.
...
Windows 커널에는 커널이 특정 오류를 처리하는 동안 개체를 초기화하는 방식으로 인해 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1889 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889)를 참조하십시오.
  
#### Windows 커널 Double Free 취약점(CVE-2010-1889)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 Double Free 취약점(CVE-2010-1889)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 Double Free 취약점(CVE-2010-1889)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널은 특정 오류를 처리하는 동안 개체를 제대로 초기화하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널이 특정 오류를 처리하는 동안 개체를 제대로 초기화하도록 하여 취약점을 해결합니다.
...
Windows 커널이 커널 개체의 액세스 제어 목록에 대해 유효성 검사를 수행하는 방식에 서비스 공격 취약점이 존재합니다. 공격자는 특수하게 조작된 응용 프로그램을 실행하여 취약점을 악용함으로써 시스템이 응답하지 않거나 다시 시작되도록 할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1890 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890)을 참조하십시오.
  
#### Windows 커널 잘못된 유효성 검사 취약점(CVE-2010-1890)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Windows 커널 잘못된 유효성 검사 취약점(CVE-2010-1890)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Windows 커널 잘못된 유효성 검사 취약점(CVE-2010-1890)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널이 커널 개체에 있는 액세스 제어 목록의 유효성을 제대로 검사하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널이 커널 개체에 적용된 액세스 제어 목록의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB981852$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/981852">Microsoft 기술 자료 문서 981852</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 커널 데이터 초기화 취약점(CVE-2010-1888)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy  
-   Windows 커널 Double Free 취약점(CVE-2010-1889)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy  
-   Windows 커널 잘못된 유효성 검사 취약점(CVE-2010-1890)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy
