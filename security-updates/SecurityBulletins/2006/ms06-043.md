---
TOCTitle: 'MS06-043'
Title: 'Microsoft 보안 공지 MS06-043 - 긴급'
ms:assetid: 'ms06-043'
ms:contentKeyID: 61230004
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms06-043(v=Security.10)'
---

Microsoft 보안 공지 MS06-043 - 긴급
===================================

Microsoft Windows의 취약점으로 인한 원격 코드 실행 문제점 (920214)
------------------------------------------------------------------
...
-   Microsoft Windows XP 서비스 팩 2에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=c9037cdb-3a57-4db7-aa0d-5ad28730303a&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=71f09617-d3cd-45fb-a09b-a9025c1d3f47)
-   Microsoft Windows Server 2003 서비스 팩 1에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=0c7e507f-2a42-49b5-82b2-84a6ec40b895&displaylang=ko)
-   Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용)에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=8f062b1c-7b93-4cb2-835a-b58ba29435f2)
-   Microsoft Windows Server 2003 x64 Edition에 설치된 Outlook Express 6 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=2aa6b4d1-a6eb-425b-ab7e-6cc27124a59e)
...
**참고** Microsoft Windows Server 2003 서비스 팩 1 및 Windows Server 2003 x64 Edition용 보안 업데이트는 Windows Server 2003 R2에도 적용됩니다.
...
| 취약점                                                                                                           | 취약점으로 인한 영향 | Windows XP 서비스 팩 2(64-bit Edition 포함)에 설치된 Outlook Express 6 | Windows Server 2003 서비스 팩 1(64-bit Edition 포함)에 설치된 Outlook Express 6 |
|------------------------------------------------------------------------------------------------------------------|----------------------|------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| MHTML 구문 분석 취약점 - [CVE-2006-2766 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2766) | 원격 코드 실행       | 긴급                                                                   | 긴급                                                                            |
...
| Microsoft Windows Server 2003 서비스 팩 1에 설치된 Outlook Express 6                | 아니요     | 예                               | 예       |
| Microsoft Windows Server 2003 x64 Edition에 설치된 Outlook Express 6                | 아니요     | 아니요                           | 예       |
| Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용)에 설치된 Outlook Express 6 | 아니요     | 아니요                           | 예       |
...
예. Microsoft는 이 업데이트를 적용해야 하는지 확인할 수 있는 EST 버전을 개발했습니다. 이번 달에 릴리스되는 EST 버전에 대한 자세한 내용과 다운로드 링크는 다음 [Microsoft 웹 사이트](https://support.microsoft.com/kb/894193)를 참조하십시오. SMS 고객은 "SMS(Systems Management Server)를 사용하여

이 업데이트가 필요한지 확인할 수 있습니까?"를 반드시 검토하십시오. SMS 및 EST에 대한 자세한 정보와 FAQ.
...
| Microsoft Windows XP Professional x64 Edition에 설치된 Outlook Express 6  | 아니요       | 예       |
| Microsoft Windows Server 2003 서비스 팩 1에 설치된 Outlook Express 6      | 예(EST 사용) | 예       |
| Microsoft Windows Server 2003 x64 Edition에 설치된 Outlook Express 6      | 아니요       | 예       |
| Windows Server 2003 SP1(Itanium 기반 시스템용)에 설치된 Outlook Express 6 | 아니요       | 예       |
...
#### MHTML 구문 분석 취약점 - CVE-2006-2766:

MHTML 프로토콜의 부정확한 구문 분석으로 인한 원격 코드 실행 취약점이 Windows에 존재합니다. 공격자는 사용자가 특수하게 조작된 웹 사이트를 방문하거나 특수하게 조작된 메일 메시지의 링크를 클릭할 경우 원격 코드 실행을 유도하도록 특수하게 조작된 웹 페이지 또는 HTML 전자 메일을 만들어 취약점을 악용할 수 있습니다.

사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

#### MHTML 구문 분석 취약점 - CVE-2006-2766에 대한 완화 요소:
...
-   기본적으로 Outlook Express 6은 HTML 전자 메일 메시지를 제한된 사이트 영역에서 엽니다.
    제한된 사이트 영역은 HTML 메일 메시지를 읽을 때 ActiveX 컨트롤을 사용하는 것을 방지하여 취약점이 악용되는 것을 제한하는 데 유용합니다. 그러나 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 문제점에 취약해질 수 있습니다.
...
#### MHTML 구문 분석 취약점 - CVE-2006-2766에 대한 대안:
...
-   **MHTML 프로토콜 레지스트리 키를 사용하지 않도록 ACL(액세스 제어 목록) 수정**
    “**MHTML 프로토콜**” 레지스트리 키에서 ACL(액세스 제어 목록)을 수정하면 이 취약점을 악용하려는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다. MHTML 프로토콜 레지스트리 키를 수정하려면 다음 절차를 수행하십시오.
    ...
    **참고** 나중에 원래 값으로 복원할 수 있도록 대화 상자에 나열된 사용 권한을 적어 놓으십시오.
    ...
    2.  **HKEY\_CLASSES\_ROOT**, **CLSID**를 차례로 확장한 다음 **{05300401-BCBC-11d0-85E3-00C04FD85AB4}**를 클릭합니다.
    ...
    6.  이 레지스트리 키에 아무도 액세스할 수 없게 된다는 메시지가 표시됩니다. **예**, **확인**을 차례로 클릭하여 **{05300401-BCBC-11d0-85E3-00C04FD85AB4} 사용 권한** 대화 상자를 닫습니다.

**대안의 영향:** 이 대안은 MHTML 웹 페이지에 대한 페이지 렌더링을 사용하지 않도록 설정합니다.

#### MHTML 구문 분석 취약점 - CVE-2006-2766에 대한 FAQ:
...
**취약점의 원인은 무엇입니까?**  
Windows의 MHTML 프로토콜에 대한 잘못된 구문 분석으로 인해 발생합니다.

**MHTML이란 무엇입니까?**  
MHTML은 HTML을 확장하여 HTML 문서에 이미지와 같은 인코딩된 개체를 포함합니다. 실제로는 MHTML을 렌더링하는 HTML 렌더링 확장이지만, 이 기능을 MHTML 렌더링 확장이라고 하기도 합니다.
...
**업데이트는 어떤 기능을 합니까?**  
업데이트는 올바르게 MHTML 프로토콜을 구문 분석할 수 있도록 Windows를 변경함으로써 이 취약점을 제거합니다.

**이 보안 공지를 게시했을 때 이 취약점이 공개되었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호CVE-2006-2766이 지정되었습니다.
...
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 CVE-2006-2766이 지정되었습니다.
...
**전제 조건**
이 보안 업데이트를 설치하려면 Windows Server 2003 서비스 팩 1이 있어야 합니다.

**참고** Microsoft Windows Server 2003 서비스 팩 1 및 Windows Server 2003 x64 Edition용 보안 업데이트는 Microsoft Windows Server 2003 R2에도 적용됩니다.
...
**WindowsServer2003-KB920214-x86-KOR /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB920214.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows Server 2003 명령 프롬프트에서 다음 명령을 사용하십시오.

**WindowsServer2003-KB920214-x86-KOR /norestart**
...
시스템 관리자는 Spuninst.exe 유틸리티를 사용하여 이 보안 업데이트를 제거할 수도 있습니다. Spuninst.exe 유틸리티는 %Windir%\\$NTUninstallKB920214$\\Spuninst 폴더에 있습니다.
...
|--------------|---------------|------------|-----------|---------|--------|
| Inetcomm.dll | 6.0.3790.2757 | 2006-07-27 | 오전 2:11 | 681,472 | SP1GDR |
| Inetcomm.dll | 6.0.3790.2757 | 2006-07-27 | 오전 2:43 | 681,472 | SP1QFE |

Windows Server 2003 Enterprise Edition SP1 (Itanium 기반 시스템용), Windows Server 2003 Datacenter Edition SP1 (Itanium 기반 시스템용) (영어 버전):
...
-   **레지스트리 키 확인**
    ...
    **참고** 이 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자나 OEM이 920214 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이러한 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
...
**WindowsXP-KB920214-x86-KOR /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB920214.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows XP 명령 프롬프트에서 다음 명령을 사용하십시오.

**WindowsXP-KB920214-x86-KOR /norestart**
...
Windows XP Professional 서비스 팩 2, Windows XP Tablet PC Edition 2005, Windows XP Home Edition 서비스 팩 2 및 Windows XP Media Center Edition 2005 (한국어 버전):

| 파일 이름    | 버전          | 날짜       | 시간       | 크기    | 폴더   |
|--------------|---------------|------------|------------|---------|--------|
| Inetcomm.dll | 6.0.2900.2962 | 2006-07-27 | 오후 10:24 | 679,424 | SP2GDR |
| Inetcomm.dll | 6.0.2900.2962 | 2006-07-27 | 오후 10:40 | 679,424 | SP2QFE |
...
-   **레지스트리 키 확인**
    ...
    **참고** 이러한 레지스트리 키에는 설치된 파일의 전체 목록이 포함되어 있지 않을 수도 있습니다. 또한 관리자나 OEM이 920214 보안 업데이트를 Windows 설치 원본 파일에 통합하거나 포함시키는 경우 이러한 레지스트리 키가 제대로 만들어지지 않을 수 있습니다.
