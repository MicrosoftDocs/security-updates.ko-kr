...
-   Microsoft Windows 2000 서비스 팩 4 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=c7417ea1-7afc-4a55-95dc-e814975b8ae6&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=b049004b-af28-41d7-8ae6-7a3db15211f1&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=705545d0-b53b-4e17-8b62-a4c652697c61)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=0097fe14-1d6b-4423-a437-dea1ed665a07&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용) - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=bc16beae-0bad-490c-a80f-4bf81c360ca0)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=0cef9cc2-a7bd-42e0-81b1-edc303da8a40)
...
|-------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------|--------------|------------|---------------------|
| 전화 통신 서비스 취약점 - [CAN-2005-0058 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0058) | 원격 코드 실행       | 긴급하지 않음         | 중요         | 중요       | 중요                |
...
-   원격 코드 실행은 전화 통신 서버 기능이 활성화된 Windows 2000 Server 및 Windows Server 2003 기반 시스템에서만 가능합니다. 이 기능에 대한 자세한 내용은 [여기 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/a3574189-fd2f-4e12-90d9-c3ecb65a8226.mspx)를 참조하십시오.
...
운영 체제 버전과 구성에 따라 원격 코드 실행 취약점 또는 [로컬 권한 상승 (영문)](http://go.microsoft.com/fwlink/?linkid=21142) 취약점이 될 수 있습니다. 자세한 내용은 FAQ 항목의 "취약점으로 인해 주로 침입 받을 위험이 있는 시스템은 무엇입니까?" 질문 항목을 참조하십시오. 이 취약점을 악용한 공격자는 영향을 받는 시스템에 대해 완벽한 제어 권한을 얻을 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
...
전화를 걸고 받는 것 이외에 프로그램은 TAPI를 사용하여 호출자 ID, 호출 라우팅, 음성 메일 및 비디오 회의 같은 향상된 전화 통신 기능을 제공할 수 있습니다. 통신 프로그램은 호출자를 식별하고 호출자 정보를 다시 호출하고 표시하며 고객 정보를 기반으로 통화 우선 순위를 정하거나 경로를 지정할 수 있습니다. TAPI에 대한 자세한 내용은 [여기 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/7d644322-d216-484c-ab74-028ae65f2116.mspx)를 참조하십시오.
...
전화 통신 서버로 구성된 Windows 2000 Server는 익명의 공격자로부터 주로 공격을 받습니다. 그러나, 관리자는 Windows 2000 Server 컴퓨터를 전화 통신 서버로 구성하는 단계를 수행해야 합니다. 이러한 단계를 보려면 다음 [웹 사이트 (영문)](http://www.microsoft.com/windows2000/en/advanced/help/default.asp?url=/windows2000/en/advanced/help/tapi_server_enable_disable.htm)를 방문하십시오.
전화 통신 서버로 구성된 Windows Server 2003 시스템은 인증된 공격자로부터 공격을 받습니다. 그러나, 관리자는 Windows Server 2003 컴퓨터를 전화 통신 서버로 구성하는 단계를 수행해야 합니다. 이러한 단계를 보려면 다음 [웹 사이트 (영문)](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/a3574189-fd2f-4e12-90d9-c3ecb65a8226.mspx)를 방문하십시오.
