...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=777f3bbe-094c-411d-879d-34a5a20ae7f3&displaylang=ko)\*\* | 권한 상승      | 중요        | 없음                      |
...
<th style="border:1px solid black;" >원격 데스크톱 웹 액세스 취약점(CVE-2011-1263)</th>
