...
<td style="border:1px solid black;">
[MS12-023](https://go.microsoft.com/fwlink/?linkid=242739)의 KB2675157은 KB2699988로 대체되었습니다.
</td>
</tr>
...
이 공지에 설명된 HTML 삭제 취약점(CVE-2012-1858)은 Microsoft Lync에도 영향을 미칩니다. 그러나 시스템에 설치한 소프트웨어에 해당하는 업데이트만 설치할 수 있습니다. Internet Explorer를 설치한 경우 이 공지에 따라 필수 업데이트를 적용하십시오. Microsoft Lync를 설치한 경우 [MS12-039](https://go.microsoft.com/fwlink/?linkid=252488)에 따라 필수 업데이트를 적용하십시오.
...
예. Windows 8 Consumer Preview 릴리스에서 KB2699988 업데이트를 사용할 수 있습니다. Windows 8 Consumer Preview를 사용하는 고객은 이 업데이트를 시스템에 적용하는 것이 좋습니다. 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 제공됩니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [6월 공지 요약](https://technet.microsoft.com/ko-kr/security/bulletin/ms12-jun)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1523(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1523)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1858(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1858)을 참조하십시오.
...
toStaticHTML 메서드는 사용자 입력의 이벤트 특성 및 스크립트를 HTML로 표시하기 전에 제거하는 데 사용할 수 있습니다. 자세한 내용은 [toStaticHTML 메서드](https://msdn.microsoft.com/en-us/library/cc848922.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1872(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1872)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1873(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1873)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1874(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1874)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1875(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1875)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1876(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1876)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1877(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1877)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1878(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1878)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1879(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1879)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1880(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1880)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1881(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1881)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1882(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882)를 참조하십시오.
...
이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-1882(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882)가 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2699988">Microsoft 기술 자료 문서 2699988</a> 참조</td>
</tr>
<tr class="even">
...
-   HTML 삭제 취약점(CVE-2012-1858)을 보고해 주신 [IBM Security Systems - Application Security(영문)](https://blog.watchfire.com/)의 Adi Cohen  
...
-   개발자 도구 모음 원격 코드 실행 취약점(CVE-2012-1874)을 보고해 주신 [VulnHunt(영문)](https://www.vulnhunt.com)의 Code Audit Labs  
-   동일한 ID 속성 원격 코드 실행 취약점(CVE-2012-1875)을 보고해 주신 [VulnHunt(영문)](https://www.vulnhunt.com)의 Dark Son  
-   동일한 ID 속성 원격 코드 실행 취약점(CVE-2012-1875)에 대해 Microsoft와 협력해 주신 [Qihoo 360 Security Center(영문)](https://www.360.cn/)  
-   동일한 ID 속성 원격 코드 실행 취약점(CVE-2012-1875)에 대해 Microsoft와 협력해 주신 McAfee Labs의 Yichong Lin  
-   동일한 ID 속성 원격 코드 실행 취약점(CVE-2012-1875)에 대해 Microsoft와 협력해 주신 [Google Inc(영문).](https://www.google.com/)  
-   [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 Col 요소 원격 코드 실행 취약점(CVE-2012-1876)을 보고해 주신 [VUPEN Security(영문)](https://www.vupen.com)  
-   [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/) 와 협력하여 Title 요소 변경 원격 코드 실행 취약점(CVE-2012-1877)을 보고해 주신 익명 연구자  
-   [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 OnBeforeDeactivate 이벤트 원격 코드 실행 취약점(CVE-2012-1878)을 보고해 주신 익명 연구자  
-   [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 insertAdjacentText 원격 코드 실행 취약점(CVE-2012-1879)을 보고해 주신 익명 연구자  
-   [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 insertRow 원격 코드 실행 취약점(CVE-2012-1880)을 보고해 주신 익명 연구자  
-   [TippingPoint(영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 OnRowsInserted 이벤트 원격 코드 실행 취약점(CVE-2012-1881)을 보고해 주신 익명 연구자
