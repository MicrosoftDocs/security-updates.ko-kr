...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969514](http://support.microsoft.com/kb/969514)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473&displaylang=ko)  
(KB969604)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473&displaylang=ko)  
(KB969604)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a&displaylang=ko)  
(KB969613)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a&displaylang=ko)  
(KB969613)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 969514](http://support.microsoft.com/kb/969514)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
Microsoft Office 2004 for Mac(KB969661), Microsoft Office 2008 for Mac(KB971822) 및 Open XML File Format Converter for Mac (KB971824)에 대한 이 공지(MS09-027)의 보안 업데이트 패키지는 [MS09-017](http://technet.microsoft.com/security/bulletin/ms09-017) 및 [MS09-021](http://technet.microsoft.com/security/bulletin/ms09-021)에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 또는 Open XML File Format Converter for Mac이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0563 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0565 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969600">Microsoft 기술 자료 문서 969600</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969602">Microsoft 기술 자료 문서 969602</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
<a href="http://support.microsoft.com/kb/969603">Microsoft 기술 자료 문서 969603</a> 참조<br />
<br />
Word Viewer 2003 및 Word Viewer:<br />
<a href="http://support.microsoft.com/kb/969614">Microsoft 기술 자료 문서 969614</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2007:<br />
<a href="http://support.microsoft.com/kb/969604">Microsoft 기술 자료 문서 969604</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="http://support.microsoft.com/kb/969613">Microsoft 기술 자료 문서 969613</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word 버퍼 오버플로 취약점(CVE-2009-0563)을 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [team509 (영문)](http://www.team509.com/)의 Wushi  
-   Word 버퍼 오버플로 취약점(CVE-2009-0565)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly
