...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 951698](https://support.microsoft.com/kb/951698)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[DirectX 7.0](https://www.microsoft.com/download/details.aspx?familyid=65640123-a9e4-455c-a51a-9df28bd2d412&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 8.1](https://www.microsoft.com/download/details.aspx?familyid=c6a28d45-13cf-48c4-8f89-3417d552e90b&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b 또는 DirectX 9.0c](https://www.microsoft.com/download/details.aspx?familyid=4dc47e04-5e95-4636-a814-3f912d961461&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b 또는 DirectX 9.0c](https://www.microsoft.com/download/details.aspx?familyid=7aaa6427-1e22-4566-960c-836a3b9e5f36&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b 또는 DirectX 9.0c](https://www.microsoft.com/download/details.aspx?familyid=5e8e7e9d-828d-442c-acac-8d91e80dfb36)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b 또는 DirectX 9.0c](https://www.microsoft.com/download/details.aspx?familyid=2274ecb2-2802-47e2-84fd-6621fcb17758&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a , DirectX 9.0b 또는 DirectX 9.0c](https://www.microsoft.com/download/details.aspx?familyid=5ba63bb7-ed6d-4c59-88b3-456eda07e190&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b 또는 DirectX 9.0c (영문)](https://www.microsoft.com/download/details.aspx?familyid=be71c002-2f64-49e9-9f4b-ba99c4f3caf6)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 10.0](https://www.microsoft.com/download/details.aspx?familyid=4d4b305b-57f8-448d-92fa-3dcdd1f42ed7&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 10.0](https://www.microsoft.com/download/details.aspx?familyid=b040cfad-2290-44f4-8f5a-5d1ed98a7265&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 10.0](https://www.microsoft.com/download/details.aspx?familyid=c0c495f8-2a35-4638-a635-1e55dd15e062&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[DirectX 10.0](https://www.microsoft.com/download/details.aspx?familyid=0b70fc2e-4e80-4ae8-8682-41ea04c24e4e&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
\*지원 대상인 Windows Server 2008 에디션에서 Server Core 설치 옵션을 사용하여 설치한 경우에는 영향을 받지 않습니다. 이 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](https://msdn.microsoft.com/ko-kr/library/ms723891(en-us,vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교 (영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
...
Microsoft Baseline Security Analyzer(MBSA) 2.1 및 이 업데이트의 검색과 관련하여 알려진 문제점에 대한 픽스를 설명하기 위해 [Microsoft 기술 자료 문서 951698](https://support.microsoft.com/kb/951698)이 업데이트되었음을 알리고자 이 공지가 개정되었습니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 951698](https://support.microsoft.com/kb/951698)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0011 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0011)을 참조하십시오.
...
-   **quartz.dll 액세스 제어 목록 수정**
    ...
    Icacls.exe %WINDIR%\SYSTEM32\QUARTZ.DLL /save %TEMP%\QUARTZ_ACL.TXTI  
    cacls.exe %WINDIR%\SYSTEM32\QUARTZ.DLL /deny everyone:(F)
    ```
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1444 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1444)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/951698">Microsoft 기술 자료 문서 951698</a> 참조</td>
</tr>
<tr class="even">
...
-   MJPEG 디코더 취약점(CVE-2008-0011)을 보고해 주신 [IBM Internet Security Systems X-Force (영문)](https://xforce.iss.net/)의 연구원 Mark Dowd  
-   형식 구문 구문 취약점(CVE-2008-1444)을 보고하기 위해[Tipping Point (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력해 주신 익명 연구원
