---
TOCTitle: 'MS10-068'
Title: 'Microsoft 보안 공지 MS10-068 - 중요'
ms:assetid: 'ms10-068'
ms:contentKeyID: 61230329
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-068(v=Security.10)'
---


Microsoft 보안 공지 MS10-068 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 설치된 Active Directory, ADAM 및 AD LDS에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 LSASS(로컬 보안 기관 하위 시스템 서비스)에서 특정 LDAP 메시지를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6554f98f-4dc5-4784-b92c-b0aae1fa22ca&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB982000)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5bc00f9a-3028-4c9d-be06-f2b78fa444c4">ADAM(Active Directory Application Mode)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3fe6e78c-c60a-4903-9273-27b37e129f0a&amp;displaylang=ko">Active Directory</a><br />
(KB981550)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=c42731f1-6393-42ed-b59f-5310c832fdc4&amp;displaylang=ko">ADAM(Active Directory Application Mode)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=22412eed-33cd-4dfc-8ef7-b74dcd7c5faf&amp;displaylang=ko">Active Directory</a><br />
(KB981550)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=79fb639d-2cc1-4bea-9df6-c67ed95890e3">ADAM(Active Directory Application Mode)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=853a71f3-fb0d-43af-a2b8-45bf8ca1a588&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=566f468b-22b6-400a-a656-ae64cfcb52df&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1452befe-b7b8-4131-b36f-dded2bd16d5e&amp;displaylang=ko">Active Directory 및 AD LDS(Active Directory Lightweight Directory Service)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=38eb875f-1869-401b-b7d3-9f18f4ba4f24&amp;displaylang=ko">Active Directory 및 AD LDS(Active Directory Lightweight Directory Service)</a>\*<br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=454fc025-bfa2-4552-9522-3585f523ecb2&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b15ad533-3cf1-4dcf-847c-05ebffb84e26&amp;displaylang=ko">AD LDS(Active Directory Lightweight Directory Service)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=54f36389-8be4-4a0c-9640-dc32addac9d7&amp;displaylang=ko">Active Directory 및 AD LDS(Active Directory Lightweight Directory Service)</a>\*<br />
(KB981550)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
| 운영 체제                                                                                                 |  
|-----------------------------------------------------------------------------------------------------------|  
| Windows Vista 서비스 팩 1<sup>[1]</sup>                                                                          |  
| Windows Vista x64 Edition 서비스 팩 1<sup>[1]</sup>                                                              |  
| Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2<sup>[1]</sup> |  
...
LSASS(로컬 보안 기관 하위 시스템 서비스)에서 특정 LDAP(Lightweight Directory Access Protocol) 메시지를 처리한 방식으로 인해 Microsoft Windows에 인증된 권한 상승 취약점이 존재합니다. ADAM(Active Directory, Active Directory Application Mode) 및 AD LDS(Active Directory Lightweight Directory Service)의 구현에 취약점이 존재합니다. 공격자는 이 문제를 악용하기 전에 LSASS를 통해 미리 인증을 받아야 합니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0820 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820)을 참조하십시오.

#### LSASS 힙 오버플로 취약점(CVE-2010-0820)에 대한 완화 요소
...
-   공격자가 이 취약점을 성공적으로 악용하려면 대상 Windows 도메인 내의 구성원 계정이어야 합니다. 그러나 Windows 도메인에 참가한 워크스테이션이 있어야 할 필요는 없습니다.

#### LSASS 힙 오버플로 취약점(CVE-2010-0820)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **방화벽에서 TCP 포트 389 차단**

    방화벽에서 TCP 포트 389를 차단합니다. 이 포트는 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다.
...
#### LSASS 힙 오버플로 취약점(CVE-2010-0820)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 Windows LSASS 구현을 통해 LDAP 메시지에서 잘못된 형식의 특정 패킷을 제대로 처리하지 못할 때 발생합니다.

**LSASS란 무엇입니까?**  
LSASS(로컬 보안 기관 하위 시스템 서비스)는 로컬 보안, 도메인 인증 및 Active Directory 프로세스를 관리하기 위한 인터페이스를 제공합니다. LSASS는 클라이언트와 서버 모두에 대한 인증을 처리하며, Active Directory 유틸리티에 대한 지원 기능도 포함되어 있습니다.
...
공격자는 특수하게 조작된 LDAP 메시지를 수신하는 LSASS 서버로 보내 이 취약점을 악용할 수 있습니다. 공격자는 이 문제를 악용하기 전에 LSASS를 통해 미리 인증을 받아야 합니다.

**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
Active Directory 서비스가 설치되어 있고 영향을 받는 운영 체제를 실행하는 모든 시스템은 이 취약점의 영향을 받습니다. 이 취약점은 클라이언트 전용 시스템에 직접적인 영향을 주지 않습니다.

**업데이트는 어떤 기능을 수행합니까?**  
보안 업데이트는 LSASS가 특정 LDAP 메시지를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
| Windows Vista 서비스 팩 2                                                                    | 아니요  | 아니요              | 예                  | 예                         |
| Windows Vista x64 Edition 서비스 팩 2                                                        | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB982000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/982000">Microsoft 기술 자료 문서 982000</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">Active Directory의 경우 제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB981550$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">ADAM(Active Directory Application Mode)의 경우 제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB982000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Windows Server 2003의 Active Directory의 경우 <a href="https://support.microsoft.com/kb/981550">Microsoft 기술 자료 문서 981550</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003의 ADAM(Active Directory Application Mode)의 경우 <a href="https://support.microsoft.com/kb/982000">Microsoft 기술 자료 문서 982000</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/981550">Microsoft 기술 자료 문서 981550</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
