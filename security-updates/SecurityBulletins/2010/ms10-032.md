---
TOCTitle: 'MS10-032'
Title: 'Microsoft 보안 공지 MS10-032 - 중요'
ms:assetid: 'ms10-032'
ms:contentKeyID: 61230293
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-032(v=Security.10)'
---



Microsoft 보안 공지 MS10-032 - 중요
===================================
...
이 보안 업데이트는 개체 변경 및 콜백 매개 변수 유효성 검사를 수정하고, Windows가 사용자 모드 응용 프로그램에 대한 TrueType 글꼴 윤곽을 제공하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=60c8579b-1540-40d8-80a0-956edadd63ce&displaylang=ko)                                                             | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=023a777a-3d83-4a4e-8029-da8b095b074b&displaylang=ko)                                               | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8e3aac9d-7747-435f-9678-f621e314e070)                                                               | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=79a11dcd-5d88-4d83-beae-6580ef6fc2c0&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f42cc5d4-1bea-4a4a-8a08-b3eb92503588&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=50efb1cf-9d89-4522-929d-f87fd98d6fe8)                                                                | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7cb64633-d2a0-4e38-be35-ec32ea655a04&displaylang=ko)                                         | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bbfc4d80-67eb-4deb-9595-cb67942a0df2&displaylang=ko)                 | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=22d550fe-ba35-4750-a9d6-624858b67c94&displaylang=ko)\*     | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=09025626-4116-4a31-8700-215382898ee2&displaylang=ko)\* | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0035cfe2-d38d-41cd-b704-ec1feda307d8)          | 권한 상승      | 중요        | [MS09-065](https://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3e0ff389-4612-4c92-bbff-bb45b5bdfc6a&displaylang=ko)                                                                     | 권한 상승      | 중요        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2b1e4aff-605a-4e94-88f9-135ce35f0646&displaylang=ko)                                                                   | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4272277f-b2dd-4406-8bbd-bc461c9923b8&displaylang=ko)\*                                                    | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=7d636f82-e828-468c-ac36-808ff9d37c7f)                                                                 | 권한 상승      | 중요        | 없음                                                                |
...
<th style="border:1px solid black;" >Win32k 부적절한 데이터 유효성 검사 취약점(CVE-2010-0484)</th>
<th style="border:1px solid black;" >Win32k 창 생성 취약점(CVE-2010-0485)</th>
<th style="border:1px solid black;" >Win32k TrueType 글꼴 구문 분석 취약점(CVE-2010-1255)</th>
...
Windows 커널 모드 드라이버가 특정 커널 개체 변경 내용의 유효성을 적절히 검사하지 않기 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0484 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484)를 참조하십시오.
  
#### Win32k 부적절한 데이터 유효성 검사 취약점(CVE-2010-0484)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 부적절한 데이터 유효성 검사 취약점(CVE-2010-0484)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 부적절한 데이터 유효성 검사 취약점(CVE-2010-0484)에 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 특정 커널 개체 변경 내용의 유효성을 적절히 검사하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 특정 커널 개체 변경 내용의 유효성을 검사하는 데 사용되는 방법을 수정하여 이 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0485 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)를 참조하십시오.
  
#### Win32k 창 생성 취약점(CVE-2010-0485)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 창 생성 취약점(CVE-2010-0485)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 창 생성 취약점(CVE-2010-0485)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 새 창을 생성할 때 일부 콜백 매개 변수의 유효성을 제대로 검사하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 새 창을 생성할 때 콜백 매개 변수의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-0485 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)가 지정되었습니다.
...
운영 체제에서 응용 프로그램에 글꼴 관련 정보를 제공하는 방식에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1255 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)를 참조하십시오.
  
#### Win32k TrueType 글꼴 구문 분석 취약점(CVE-2010-1255)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k TrueType 글꼴 구문 분석 취약점(CVE-2010-1255)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k TrueType 글꼴 구문 분석 취약점(CVE-2010-1255)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Windows가 응용 프로그램에 문자 윤곽 정보를 제공하는 방식 때문에 발생합니다.
...
TrueType 글꼴 파일에는 TrueType 래스터라이저 및 운영 체제 소프트웨어에서 글꼴 디자이너의 의도대로 문자가 컴퓨터 화면에 표시되거나 정확히 출력되도록 하기 위해 사용되는 여러 다양한 정보가 포함되어 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](https://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 운영 체제는 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
원격 경로를 통해 이 취약점을 노출시키는 Microsoft 응용 프로그램은 없습니다. 그러나 타사 프로그램의 경우, 신뢰할 수 없는 출처의 특정 폰트를 구문 분석하여 이 취약점을 원격으로 노출시킬 수 있습니다. 이런 경우 이 취약점을 악용하면 임의 사용자가 모든 관리 권한으로 코드를 실행할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
워크스테이션과 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows가 사용자 모드 응용 프로그램에 Truetype 글꼴의 윤곽을 제공하는 방식을 수정하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-1255 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)가 지정되었습니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-KB979559-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-KB979559-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | KB979559.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB979559$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 979559](https://support.microsoft.com/kb/979559) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB979559\\Filelist                                        |
...
WindowsXP-KB979559-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB979559-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB979559$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/979559">Microsoft 기술 자료 문서 979559</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB979559-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB979559-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB979559-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB979559-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   Win32k 부적절한 데이터 유효성 검사 취약점(CVE-2010-0484)을 보고해 주신[VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Sebastien Renaud  
-   Win32k TrueType 글꼴 구문 분석 취약점(CVE-2010-1255)을 해결하기 위해 협력해 주신 [Secunia Research (영문)](https://secunia.com/)
