...
이 검색 변경 사항으로 인해 Windows Server Update Services(WSUS)를 사용하는 고객에게는 이 보안 업데이트가 새 업데이트로 표시될 수 있습니다. 자동 승인 규칙이 없는 경우 업데이트를 수동으로 재승인해야 할 수 있습니다. 업데이트를 재승인하지 않으면 업데이트가 적용되지 않는 경우에도 시스템에 업데이트가 계속 제공될 수 있습니다. 이러한 검색 변경 사항에 대한 자세한 내용은 [Microsoft 기술 자료 문서 894199](http://support.microsoft.com/kb/894199)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0480 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0480)을 참조하십시오.
...
취약한 MPEG Layer-3 오디오 코덱은 Microsoft DirectShow용 MPEG Layer-3 오디오 코덱(l3codecx.ax) 그리고 Fraunhofer IIS MPEG Layer-3 ACM 코덱(L3codeca.acm 및 L3codecp.acm)입니다. 이러한 MPEG Layer-3 오디오 코덱은 Windows Media에 포함되어 제공됩니다. 자세한 내용은 [Window Media](http://www.microsoft.com/korea/windows/windowsmedia/) 홈 페이지를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/977816">Microsoft 기술 자료 문서 977816</a> 참조</td>
</tr>
<tr class="even">
...
-   MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Yamata Li
