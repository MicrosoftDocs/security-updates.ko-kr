---
TOCTitle: 'MS10-012'
Title: 'Microsoft 보안 공지 MS10-012 - 중요'
ms:assetid: 'ms10-012'
ms:contentKeyID: 61230272
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-012(v=Security.10)'
---

Microsoft 보안 공지 MS10-012 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 SMB가 SMB 요청의 유효성을 검사하는 방법을 수정하여 이러한 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=267ce982-54a0-418f-ad52-e4963610f714&displaylang=ko)                                                                        | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=8f7adee3-e68e-41b3-b835-d84691774f31&displaylang=ko)                                                          | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=91ee57f2-81e5-49bd-bdfc-d3e385efc8a5)                                                                          | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3d18cbc4-ac48-458c-8aa3-90708fd854ff&displaylang=ko)                                                                           | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7d63c95e-311a-446f-8852-dffd217a89f6&displaylang=ko)                                                               | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ee7f8cc4-f7fd-4dc7-808c-436204ee80cb)                                                                           | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=16494dac-553a-4de9-b751-0d6b51cb43f0&displaylang=ko)                                     | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cec582b3-e37f-448e-a5c3-6abdcee9e57c&displaylang=ko) | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=597b2310-2cd8-4d0f-8248-781eb8b7450a&displaylang=ko)\*                | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=67119fb6-e517-46f4-ab0b-2351cdc3d670&displaylang=ko)\*            | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f90fc0c8-babe-4224-be07-614ea7ddf102)                     | 원격 코드 실행 | 중요        | [MS09-001](https://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=122fc003-0651-4ad2-a5c8-a21536defad8&displaylang=ko)                                                                                | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3e096468-db6c-45c6-bee5-eaeaa63500b5&displaylang=ko)                                                                              | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=dc757b6d-f0f8-4e71-ab6f-1417233eedf9&displaylang=ko)\*                                                               | 원격 코드 실행 | 중요        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=d5b0b1eb-24f3-47ec-aba1-c1b95400189e)                                                                            | 원격 코드 실행 | 중요        | 없음                                                                |
...
**이 보안 업데이트는 2010년 2월 9일에 릴리스된 MS10-006와 관련이 있습니까?**  
아니요. Microsoft 보안 공지 [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006), "SMB 클라이언트의 취약점으로 인한 원격 코드 실행 문제점"은 다른 SMB 구성 요소를 해결합니다. 이 보안 업데이트는 다른 업데이트와 별도로 적용할 수 있습니다.

**MS10-006 업데이트를 설치한 경우에도 여전히 이 업데이트를 설치해야 합니까? **
예. 이 보안 공지 업데이트는 Windows SMB 서버 구성 요소의 취약점을 해결하고, [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006)는 Windows SMB 클라이언트 구성 요소의 취약점을 해결합니다.
...
<th style="border:1px solid black;" >SMB 경로 이름 오버플로 취약점(CVE-2010-0020)</th>
<th style="border:1px solid black;" >SMB 메모리 손상 취약점(CVE-2010-0021)</th>
<th style="border:1px solid black;" >SMB Null 포인터 취약점(CVE-2010-0022)</th>
<th style="border:1px solid black;" >SMB NTLM 엔트로피 인증 부족 취약점(CVE-2010-0231)</th>
...
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 패킷을 처리하는 방식에 인증된 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작한 네트워크 메시지를 인증된 사용자로서 서버 서비스를 실행하는 시스템으로 전송하여 이러한 취약점을 악용할 수 있습니다. 이 취약점 악용에 성공한 공격자는 영향을 받은 시스템을 완전히 제어할 수 있으므로 이 취약점을 악용하려는 시도는 대부분 서비스 거부 상태를 유발할 가능성이 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0020 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0020)를 참조하십시오.
  
#### SMB 경로 이름 오버플로 취약점(CVE-2010-0020)에 대한 완화 요소
...
#### SMB 경로 이름 오버플로 취약점(CVE-2010-0020)에 대한 대안
...
#### SMB 경로 이름 오버플로 취약점(CVE-2010-0020)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 조작된 SMB 요청에서 필드의 유효성 검사를 제대로 수행하지 못하는 Microsoft SMB(Server Message Block) 구현으로 인해 발생합니다.
...
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 패킷을 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 네트워크 메시지를 서버 서비스를 실행하는 컴퓨터로 전송하여 취약점을 악용할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0021 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0021)를 참조하십시오.
  
#### SMB 메모리 손상 취약점(CVE-2010-0021)에 대한 완화 요소
...
#### SMB 메모리 손상 취약점(CVE-2010-0021)에 대한 대안
...
#### SMB 메모리 손상 취약점(CVE-2010-0021)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이것은 서비스 거부 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 협상 단계에서 SMB 패킷을 구문 분석할 때 발생할 수 있는 경쟁 조건을 제대로 처리하지 못하는 Microsoft SMB(Server Message Block) 프로토콜 소프트웨어로 인해 발생합니다. 이 취약점은 SMB 버전 1 및 SMB 버전 2에 영향을 줍니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB가 특수하게 조작된 SMB 패킷을 구문 분석하는 방식을 수정하여 취약점을 해결합니다.
...
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 특수하게 조작된 SMB 패킷을 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 네트워크 메시지를 서버 서비스를 실행하는 컴퓨터로 전송하여 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 컴퓨터가 다시 시작될 때까지 컴퓨터에서 응답을 중지하도록 만들 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0022 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022)를 참조하십시오.
  
#### SMB Null 포인터 취약점(CVE-2010-0022)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   Windows Vista 및 Windows 7에서 네트워크 프로필이 "Public(공개)”으로 설정되어 있는 경우 기본적으로 원치 않는 인바운드 네트워크 패킷이 차단되므로, 시스템은 이 취약점으로 인한 영향을 받지 않습니다.  
-   취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다.  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB Null 포인터 취약점(CVE-2010-0022)에 대한 대안
...
-   **SMBv2를 사용하지 않도록 설정**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 975517](https://support.microsoft.com/kb/975517)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
#### SMB Null 포인터 취약점(CVE-2010-0022)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이것은 서비스 거부 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 조작된 SMB 패킷에서 공유 및 서버 이름 필드를 제대로 확인하지 못하는 Microsoft SMB(Server Message Block) 프로토콜 소프트웨어로 인해 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 보안 업데이트는 SMB 패킷 내부 필드의 유효성을 올바르게 검사하여 취약점을 해결합니다.
...
Microsoft SMB(Server Message Block) 프로토콜 소프트웨어가 인증 시도를 처리하는 방식에 인증되지 않은 권한 상승 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 대량의 인증 요청을 SMB 서버로 전송하여 취약점을 악용할 수 있습니다. 이 취약점 악용에 성공한 공격자는 권한이 있는 사용자의 자격 증명으로 대상 사용자의 SMB 서비스에 액세스할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0231 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0231)을 참조하십시오.
  
#### SMB NTLM 엔트로피 인증 부족 취약점(CVE-2010-0231)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB NTLM 엔트로피 인증 부족 취약점(CVE-2010-0231)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### SMB NTLM 엔트로피 인증 부족 취약점(CVE-2010-0231)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 정확한 인증 자격 증명을 요청하지 않고 대상 시스템에 대해 성공적으로 인증할 수 있습니다. 그런 다음 공격자는 파일을 업로드 및 다운로드하고, 해당 사용자가 사용 가능한 SMB 네트워크 리소스에 액세스할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 SMB 서버가 챌린지(challenge)를 생성하고 이를 연결 클라이언트에 제공할 때 암호화 엔트로피가 부족하여 발생합니다. 이로 인해 공격자는 계속해서 SMB 서버에 대해 인증을 시도할 수 있으며 결과적으로 서버에서 중복 값을 생성하게 됩니다.
  
**Microsoft SMB(Server Message Block) 프로토콜이란 무엇입니까?**    
Microsoft SMB(Server Message Block) 프로토콜은 Microsoft Windows에 사용되는 Microsoft 네트워크 파일 공유 프로토콜입니다. SMB에 대한 자세한 내용은 [Microsoft SMB 프로토콜 및 CIFS 프로토콜 개요 (영문)](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)를 참조하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
이 취약점 악용에 성공한 공격자는 파일을 업로드 및 다운로드하고, 공격자가 계정에 액세스할 수 있는 계정의 사용자가 사용 가능한 SMB 네트워크 리소스에 액세스할 수 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 계속해서 서버에 대해 인증을 시도하고, 유효한 인증 토큰을 스푸핑하는 데 실패한 연결의 정보를 다시 사용하여 이러한 취약점 악용을 시도할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
SMB 서버 서비스를 사용하는 모든 시스템이 이 취약점의 영향을 받습니다. 도메인 컨트롤러는 모든 도메인 사용자에게 네트워크 공유를 개방하기 때문에 이 취약점의 악용에 대해 매우 위험합니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 SMB 서버가 충분한 엔트로피 보증이 있는 암호화 공급자를 사용하도록 하여 취약점을 해결합니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-KB971468-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-KB971468-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | KB971468.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB971468$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 971468](https://support.microsoft.com/kb/971468) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971468\\Filelist                                        |
...
WindowsXP-KB971468-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB971468-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB971468$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971468">Microsoft 기술 자료 문서 971468</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB971468-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB971468-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB971468-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB971468-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   SMB 경로 이름 오버플로 취약점(CVE-2010-0020)을 보고해 주신 [Codenomicon (영문)](https://www.codenomicon.com/)의 Joshua Morin  
-   SMB 메모리 손상 취약점(CVE-2010-0021)을 보고해 주신 [BSI (영문)](https://www.bsi.bund.de/)의 Florian Rienhardt  
-   SMB NTLM 인증 엔트로피 부족 취약점(CVE-2010-0231)을 보고해 주신 Hernan Ochoa(독립된 정보 보안 컨설턴트/연구자)
...
-   V1.1(2010년 2월 11일): 취약점에 대한 신뢰할 수 있는 공개된 정보를 반영하기 위해 **SMB Null 포인터 취약점(CVE-2010-0022)에 대한 FAQ**가 수정되었습니다. Windows 7 및 Windows Server 2008 R2에 대한 SMS 2003(ITMU 포함)의 **Systems Management Server** 표 항목이 변경되었습니다. 지원 대상인 모든 Windows XP x64 기반 에디션에 대한 확인 레지스트리 키가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.
