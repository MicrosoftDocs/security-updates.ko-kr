...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=5d645891-31e9-42c4-b12b-eb351473fd0c&displaylang=ko)                                                             | 권한 상승      | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=b42a17c5-997e-4504-ba5b-bfa62166b460&displaylang=ko)                                               | 권한 상승      | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=dc835b94-3368-4c1c-8f29-40517c73540e)                                                               | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca49b5b5-db8e-4ebc-9a3c-b1ace09ac3c0&displaylang=ko)                                                                | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b0794e7e-c925-4672-b7a5-4bb3f847f045&displaylang=ko)                                                    | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=6e76ebea-bde1-4352-a283-dd71c2cc51a1)                                                                | 권한 상승      | 중요        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=363b503a-2e1e-4284-a029-9695d2acfcb6&displaylang=ko)                                         | 권한 상승      | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f512b86-3a99-47f7-a90e-1ae9b291385c&displaylang=ko)                 | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e78ad607-d209-48c4-b0f3-ed4c70993174&displaylang=ko)\*     | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=85f6fc5d-efd1-4351-b4c0-b9b7080e6173&displaylang=ko)\* | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=c6f1aae5-e8fd-4121-89b2-b97c571e8223)          | 권한 상승      | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=969af8d6-f6da-4dd1-a7d7-2de54a5a8978&displaylang=ko)                                                                     | 권한 상승      | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=b069e5b2-aa2d-452e-b687-8734b5ba0051&displaylang=ko)                                                                   | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=45242c7c-3752-44bf-a766-024ad7d28f53&displaylang=ko)\*                                                    | 권한 상승      | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=0a271fb5-da5b-4a17-9593-e56b9a843b8f)                                                                 | 권한 상승      | 중요        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0819 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819)를 참조하십시오.
...
OpenType CFF 글꼴은 PostScript Type 1 윤곽선이 포함된 OpenType 글꼴입니다. OpenType 글꼴에는 PostScript Type 1 또는 TrueType 윤곽선이 포함될 수 있습니다. 모든 Microsoft Windows 글꼴에는 트루타입 윤곽선이 포함됩니다. Adobe InDesign 및 QuarkXpress와 같은 전자 출판 응용 프로그램은 가장 많은 OpenType 기능을 지원합니다. Adobe Photoshop 및 Adobe Illustrator는 많은 기능을 지원합니다. 일반적인 OpenType 기능에 대한 지원은 Microsoft Publisher 및 Microsoft Word에도 추가되고 있습니다. 자세한 내용은 [Microsoft 입력 체계 OpenType FAQ (영문)](http://www.microsoft.com/typography/opentypefaq.mspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/980218">Microsoft 기술 자료 문서 980218</a> 참조</td>
</tr>
<tr class="even">
...
-   OpenType CFF 글꼴 드라이버 메모리 손상 취약점(CVE-2010-0819)을 [Secunia (영문)](http://secunia.com/)와 협력하여 보고해 주신 Laserforce International의 Chris Carton
