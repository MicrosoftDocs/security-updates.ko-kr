...
| 주소 표시줄 스푸핑 취약점 - [CVE-2006-1626 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1626)              | 스푸핑               | 보통                              | 보통                                                                                      | 낮음                                      | 낮음                                                  | 보통                                         |
...
-   예외 처리 메모리 손상 취약점(CVE-2006-2218)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Andreas Sandblad.
-   HTML 디코딩 메모리 손상 취약점(CVE-2006-2382)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative. (영문)](https://www.zerodayinitiative.com/)
-   ActiveX 컨트롤 메모리 손상 취약점(CVE-2006-2383)을 보고해 주신 [CERT/CC (영문)](https://www.cert.org/)의 Will Dormann.
-   COM 개체 인스턴스화 메모리 손상 취약점(CVE-2006-1303)에 설명된 클래스 식별자를 보고해 주신 Metasploit Project의 H D Moore.
-   COM 개체 인스턴스화 메모리 손상 취약점(CVE-2006-1303)에 설명된 클래스 식별자를 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/).
-   주소 표시줄 스푸핑 취약점(CVE-2006-2384)을 보고해 주신 [ITsec Security Services (영문)](https://www.itsec-ss.nl/)의 Yorick Koster.
...
**참고** SMS는 Microsoft Baseline Security Analyzer, Microsoft Office Detection Tool 및 Enterprise Update Scanning Tool을 사용하여 보안 공지 업데이트 검색 및 배포를 위한 광범위한 지원을 제공합니다. 일부 소프트웨어 업데이트는 이러한 도구로 검색하지 못할 수도 있습니다. 이러한 경우 관리자는 SMS의 인벤토리 기능을 사용하여 특정 시스템을 대상으로 업데이트를 수행할 수 있습니다. 이 절차에 대한 자세한 내용은 다음 [여기 (영문)](https://go.microsoft.com/fwlink/?linkid=33341)를 참조하십시오. 일부 보안 업데이트 작업에는 시스템을 다시 시작한 후에 관리자 권한이 필요합니다. 관리자는 Elevated Rights Deployment Tool을 사용하여 이러한 업데이트를 설치할 수 있으며, 이 도구는 [SMS 2003 Administration 기능 팩 (영문)](https://go.microsoft.com/fwlink/?linkid=33387) 및 [SMS 2.0 Administration 기능 팩 (영문)](https://go.microsoft.com/fwlink/?linkid=21161)에서 제공되는 Elevated Rights Deployment Tool을 사용하여 이러한 업데이트를 설치할 수 있습니다.
