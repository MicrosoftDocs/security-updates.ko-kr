---
TOCTitle: 'MS10-023'
Title: 'Microsoft 보안 공지 MS10-023 - 중요'
ms:assetid: 'ms10-023'
ms:contentKeyID: 61230284
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-023(v=Security.10)'
---



Microsoft 보안 공지 MS10-023 - 중요
===================================

Microsoft Office Publisher의 취약점으로 인한 원격 코드 실행 문제점 (981160)
---------------------------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원되는 Microsoft Office Publisher 2002, Microsoft Office Publisher 2003 및 Microsoft Office Publisher 2007 버전에서 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

Microsoft Office Publisher에서 업데이트는 특수하게 조작된 Publisher 파일을 여는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.** 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 981160](https://support.microsoft.com/kb/981160)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=943b3830-70d5-46c5-bffc-1b494434b5f7&amp;displaylang=ko">Microsoft Office Publisher 2002 서비스 팩 3</a><br />
(KB980466)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7c2f4610-77bb-4d72-847b-1a06c523b137&amp;displaylang=ko">Microsoft Office Publisher 2003 서비스 팩 3</a><br />
(KB980469)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-027">MS08-027</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=10ca2f71-0ab2-4344-b7fd-bbbd6a783a96&amp;displaylang=ko">Microsoft Office Publisher 2007 서비스 팩 1</a><br />
(KB980470)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;">2007 Microsoft Office System 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=10ca2f71-0ab2-4344-b7fd-bbbd6a783a96&amp;displaylang=ko">Microsoft Office Publisher 2007 서비스 팩 2</a><br />
(KB980470)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
...
<th style="border:1px solid black;" >Microsoft Office Publisher 파일 변환 텍스트 상자 처리 버퍼 오버플로 취약점(CVE-2010-0479)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Publisher 2007 서비스 팩 2</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
...
Microsoft Office Publisher 파일 변환 텍스트 상자 처리 버퍼 오버플로 취약점(CVE-2010-0479)  
-----------------------------------------------------------------------------------------
  

Microsoft Office Publisher에서 Publisher 파일을 여는 방식에 원격 코드 실행 취약점이 존재합니다. 공격자는 전자 메일 첨부 파일로 포함할 수 있거나, 특수하게 조작되었거나 공격에 노출된 웹 사이트에 호스팅할 수 있는 특수하게 조작된 Publisher 파일을 작성한 후 사용자가 특수하게 조작된 Publisher 파일을 열도록 유도하여 취약점을 악용할 수 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0479 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0479)를 참조하십시오.
  
#### Microsoft Office Publisher 파일 변환 텍스트 상자 처리 버퍼 오버플로 취약점(CVE-2010-0479)에 대한 완화 요소
...
#### Microsoft Office Publisher 파일 변환 텍스트 상자 처리 버퍼 오버플로 취약점(CVE-2010-0479)에 대한 대안
...
#### Microsoft Office Publisher 파일 변환 텍스트 상자 처리 버퍼 오버플로 취약점(CVE-2010-0479)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Microsoft Office Publisher가 특수하게 조작된 Publisher 파일을 열려고 할 때 파일 구문 분석 코드에 취약점이 존재합니다.
...
| Microsoft Office Publisher 2007 서비스 팩 2 | 예         |
...
|---------------------------------------------|---------|---------------------|---------------------|----------------------------|  
| Microsoft Office Publisher 2002 서비스 팩 3 | 아니요  | 아니요              | 예                  | 예                         |  
| Microsoft Office Publisher 2003 서비스 팩 3 | 아니요  | 아니요              | 예                  | 예                         |  
| Microsoft Office Publisher 2007 서비스 팩 1 | 아니요  | 아니요              | 예                  | 예                         |  
| Microsoft Office Publisher 2007 서비스 팩 2 | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;">Officexp-KB980466-FullFile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Officexp-KB980466-FullFile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980466">Microsoft 기술 자료 문서 980466</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">office2003-KB980469-FullFile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2003-KB980469-FullFile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980469">Microsoft 기술 자료 문서 980469</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980470">Microsoft 기술 자료 문서 980470</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Microsoft Office Publisher 파일 변환 텍스트 상자 처리 버퍼 오버플로 취약점(CVE-2010-0479)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Lionel d'Hauenens
