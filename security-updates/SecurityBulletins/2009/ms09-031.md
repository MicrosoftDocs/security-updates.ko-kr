...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 970953](https://support.microsoft.com/kb/970953)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c4e9b1dd-526d-407b-bc23-ebc2738b1b19&amp;displaylang=ko">Microsoft Internet Security and Acceleration Server 2006</a><br />
(KB970811)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e8ccd770-a925-411c-b994-78e4cf5c3476&amp;displaylang=ko">Microsoft Internet Security and Acceleration Server 2006 지원 업데이트</a><br />
(KB970811)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e536cfed-c1af-4868-b2ac-79178d6355a5&amp;displaylang=ko">Microsoft Internet Security and Acceleration Server 2006 서비스 팩 1</a><br />
(KB971143)</td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1135 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1135)를 참조하십시오.
...
-   Radius OTP와 함께 ISA 양식 기반 인증에 대해 기본 인증으로 폴백 사용 안 함
    ...
    1.  Microsoft Internet Security and Acceleration Server 2006의 원래 버전을 실행하는 고객의 경우 [Microsoft 기술 자료 문서 938966](https://support.microsoft.com/kb/938966/)에서 제공되는 핫픽스를 설치해야 합니다. Microsoft Internet Security and Acceleration Server 2006 지원 업데이트와 Microsoft Internet Security and Acceleration Server 2006 서비스 팩 1을 실행하는 고객의 경우에는 이 핫픽스를 적용하지 않아도 됩니다.  
    2.  문서의 지침에 따라 [Microsoft 기술 자료 문서 938966](https://support.microsoft.com/kb/938966/)의 **사후 핫픽스 설치 정보** 섹션에서 제공되는 Microsoft Visual Basic 스크립트를 실행합니다.
  
    **대안의 영향.** ISA 서버가 해당 웹 수신기를 통해 처리되는 클라이언트의 기본 인증을 허용하지 않습니다.
  
    **대안 실행 취소 방법.**
  
    1.  [Microsoft 기술 자료 문서 938966](https://support.microsoft.com/kb/938966/)의 **사후 핫픽스 설치 정보** 섹션에서 제공되는 Microsoft Visual Basic 스크립트를 편집하여 "Const SE\_VPS\_VALUE = true"를 "Const SE\_VPS\_VALUE = false"로 변경합니다.  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/970811">Microsoft 기술 자료 문서 970811</a> 참조</td>
</tr>
<tr class="even">
