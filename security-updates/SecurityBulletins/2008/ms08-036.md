...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 950762](https://support.microsoft.com/kb/950762)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=36b14a81-5979-4e38-9ba3-ed83dfc17adf&displaylang=ko)                                                            | 서비스 거부    | 중요        | [MS06-052](https://technet.microsoft.com/security/bulletin/ms08-052) |
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=36b14a81-5979-4e38-9ba3-ed83dfc17adf&displaylang=ko)                                                            | 서비스 거부    | 중요        | 없음                                                                |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9e9d24ee-8183-428c-8067-168a8d85eaa1)           | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1e8e2faf-009f-403b-a5fe-a47cf014db3a&displaylang=ko)                | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=78bf92d8-63c4-4596-8425-8fcfea7f5582&displaylang=ko)    | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5b7e94fa-22ed-4f7c-b452-647b2e620113) | 서비스 거부    | 중요        | 없음                                                                |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=ef2d2a4b-4831-41be-b5d0-8df5b01fd205&displaylang=ko)                                        | 서비스 거부    | 보통        | 없음                                                                |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0839fcf4-85ca-445e-896b-f634b10b6700&displaylang=ko)                | 서비스 거부    | 보통        | 없음                                                                |
| [Windows Server 2008 (32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0466a6e7-fdca-4647-af62-449e5f20d1e4&displaylang=ko)\*                                           | 서비스 거부    | 보통        | 없음                                                                |
| [Windows Server 2008 (x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=304898e6-21a7-476f-b9ed-7ac0d88a91e2&displaylang=ko)\*                                         | 서비스 거부    | 보통        | 없음                                                                |
| [Windows Server 2008 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8907783b-e3fe-40b2-9fc8-4937e7d58b7e)                                                      | 서비스 거부    | 보통        | 없음                                                                |

\*지원 대상인 Windows Server 2008 에디션에서 Server Core 설치 옵션을 사용하여 설치한 경우에는 영향을 받지 않습니다. 이 설치 옵션에 대한 자세한 내용은 [Server Core (영문)](https://msdn.microsoft.com/ko-kr/library/ms723891(vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교 (영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 950762](https://support.microsoft.com/kb/950762)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1440 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1440)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1441 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1441)을 참조하십시오.
...
**PGM(Pragmatic General Multicast)이란 무엇입니까?**  
PGM은 안정적이고 확장 가능한 멀티캐스트 프로토콜로서 수신기가 손실을 탐지하여 손실된 데이터의 재전송을 요청하거나 응용 프로그램에 복구 불가능한 손실을 통보하도록 지원합니다. PGM은 안정적인 수신을 위한 프로토콜입니다. 즉, 수신기가 모든 데이터를 수신하도록 보장함으로써 통신 안정성에 대해 보낸 사람의 수신 책임을 면해줍니다. PGM은 여러 출처에서 여러 수신기로 중복이 없는 멀티캐스트 데이터를 전달해야 하는 응용 프로그램에 적합합니다. PGM는 배달 확인을 지원하지 않으며, 여러 보낸 사람으로부터의 패킷 주문을 보장하지도 않습니다. PGM에 대한 자세한 내용은 [MSDN 문서 (영문)](https://msdn.microsoft.com/ko-kr/library/ms740125(en-us,vs.85).aspx)를 참조하십시오.
...
관리자는 MBSA(Microsoft Baseline Security Analyzer)를 사용하여 로컬 및 원격 시스템에서 누락된 보안 업데이트 및 일반적인 보안 설정 오류를 검색할 수 있습니다. MBSA에 대한 자세한 내용을 보려면 [Microsoft Baseline Security Analyzer (영문)](https://technet.microsoft.com/ko-kr/security/cc184924(en-us).aspx)를 방문하십시오.
...
SMS 2.0 및 SMS 2003, SMS SUS Feature Pack(SUSFP)에는 Security Update Inventory Tool(SUIT)이 포함되어 있으며 SMS는 이를 이용하여 보안 업데이트를 검색합니다. [Systems Management Server 2.0용 다운로드](https://technet.microsoft.com/ko-kr/sms/bb676799.aspx%20(영문))도 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950762">Microsoft 기술 자료 문서 950762</a> 참조</td>
</tr>
<tr class="even">
