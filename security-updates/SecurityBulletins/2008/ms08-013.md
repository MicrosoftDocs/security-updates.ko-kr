...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0103 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0103)을 참조하십시오.
...
[Windows Installer 관리 설치](http://msdn2.microsoft.com/ko-kr/library/aa367541(en-us).aspx)를 사용하는 서버 관리자는 서버 위치를 업데이트해야 합니다. 관리 설치 지점에 대한 자세한 내용은 **검색, 배포 도구 및 지침** 하위 섹션의 **Office 관리 설치 지점** 정보를 참조하십시오.
...
Microsoft Office 2004 for Mac 11.4.0 업데이트의 해당 언어 버전을 [Microsoft Mactopia 웹 사이트 (영문)](http://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)에서 다운로드하여 설치하십시오.
...
-   Microsoft Office 실행 점프 취약점(CVE-2008-0103)을 보고해 주신 [NGSSoftware (영문)](http://www.ngssoftware.com/)의 Shaun Colley
