...
업데이트는 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink/?linkid=21129) 및 [Microsoft Update 카탈로그](https://go.microsoft.com/fwlink/?linkid=96155)에서만 제공됩니다.
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=bde50a1f-322f-4a98-889a-c80f9b293db8&displaylang=ko)  
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=e7c4167e-8d0f-460f-acc5-ef1dd660fd98&displaylang=ko)  
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0a2fa03d-0065-44bb-8fd8-58fda2950f33&displaylang=ko)<sup>[2]</sup>
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=35b790ef-ab67-44cb-867d-4bccfef18406&displaylang=ko)<sup>[2]</sup>
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=61095b86-9fe7-43db-b010-1d352ce00d22)<sup>[2]</sup>
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=40312da7-75f2-4b4f-8d52-54735dfb5fc6&displaylang=ko)  
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=e8487c2a-9683-47e9-bf74-55ce9b02c225&displaylang=ko)  
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e42d043d-9a2d-4c07-96ce-bfe400cf48a5&displaylang=ko)<sup>[2]</sup>
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=318a7743-57cb-4bba-85ea-05a464305b08)<sup>[2]</sup>
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=2bf17c73-3465-476f-ae1a-b09b1745f5e8&displaylang=ko)  
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=b45f0f7b-749a-4efa-bf7c-0d4c468c48bf&displaylang=ko)  
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=a3a15402-eb63-426d-994c-83b4a15df982&displaylang=ko)<sup>[3]</sup>
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=d84a7b89-cf11-41f0-aa13-fd521c294f44&displaylang=ko)\[4\]  
(2961899)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=81d6d466-1ad3-4626-b332-c90f8f672d02&displaylang=ko)<sup>[3]</sup>
(2928120)
...
<td style="border:1px solid black;">
[원격 서버 관리 도구](https://www.microsoft.com/download/details.aspx?familyid=c00b522f-b5d6-4415-b506-f50ec77cb0d0&displaylang=ko)\[4\]  
(2961899)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=fbdfd743-132b-416e-8d5a-19e086daadfe&displaylang=ko)<sup>[2]</sup>
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=615c8a8e-c325-4be4-9285-1cacdfc1f0f1&displaylang=ko)<sup>[2]</sup><sup>[3]</sup>
(2928120)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=bf6f3cb8-74d3-458a-b9f7-cc14bd6dbe3d&displaylang=ko)<sup>[2]</sup>\[4\]  
(2961899)
...
Microsoft는 고객이 가능한 신속하게 시스템 업데이트를 시작할 수 있도록 이 업데이트를 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink/?linkid=21129) 및 [Microsoft Update 카탈로그](https://go.microsoft.com/fwlink/?linkid=96155)에 게시하고 있습니다.
...
예. Windows 8.1 또는 Windows Server 2012 R2 시스템을 실행하는 고객은 2928120 업데이트를 설치하기 전에 먼저 2014년 4월에 발표된 2919355 업데이트를 설치해야 합니다. 필수 구성 요소 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 2919355](https://support.microsoft.com/kb/2919355)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-1812](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1812)(영문)를 참조하십시오.
...
**그룹 정책 기본 설정이란 무엇입니까?**  
그룹 정책 기본 설정에는 20개 이상의 새로운 그룹 정책 확장이 포함되어 있으며, 이 확장은 그룹 정책 개체(GPO) 내에서 구성 가능한 설정 범위를 확장합니다. 이러한 새로운 확장은 GPMC(그룹 정책 관리 콘솔)의 새 기본 설정 항목에 있는 그룹 정책 관리 편집기 창에 포함되어 있습니다. 새 그룹 정책 기본 설정 확장에는 폴더 옵션, 매핑 드라이브, 프린터, 예약된 작업, 서비스 및 시작 메뉴 설정 등이 있습니다. 그룹 정책 기본 설정에 대한 자세한 내용은 [그룹 정책 기본 설정 시작 가이드](https://technet.microsoft.com/library/cc731892)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2014-1812](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1812)(영문)가 지정되었습니다.
...
마지막으로, 보안 업데이트는 [Microsoft Update 카탈로그](https://go.microsoft.com/fwlink/?linkid=96155)에서 다운로드할 수 있습니다. Microsoft Update 카탈로그는 보안 업데이트, 드라이버, 서비스 팩을 포함하여 Windows Update 및 Microsoft Update에서 제공하는 콘텐츠의 검색 가능한 목록입니다. 보안 공지 번호(예: "MS14-001")를 사용하여 검색하면 적용 가능한 모든 업데이트(다른 언어의 업데이트 포함)를 장바구니에 추가하고, 선택한 업데이트를 로컬 폴더에 다운로드할 수 있습니다. Microsoft Update 카탈로그에 대한 자세한 내용은 [Microsoft Update 카탈로그 FAQ](https://go.microsoft.com/fwlink/?linkid=97900)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2928120">Microsoft 기술 자료 문서 2928120</a> 참조</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2928120">Microsoft 기술 자료 문서 2928120</a> 참조<br />
<a href="https://support.microsoft.com/kb/2961899">Microsoft 기술 자료 문서 2961899</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
