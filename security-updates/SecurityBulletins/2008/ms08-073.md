...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 958215](http://support.microsoft.com/kb/958215)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4258 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4258)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4259 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4259)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4260 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4260)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-4261 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4261)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/958215">Microsoft 기술 자료 문서 958215</a> 참조</td>
</tr>
<tr class="even">
...
-   HTML 개체 메모리 손상 취약점(CVE-2008-4259)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Brett Moore  
-   초기화되지 않은 메모리 손상 취약점(CVE-2008-4260)을 보고해 주신 [Casaba Security (영문)](http://www.casabasecurity.com/)의 Chris Weber  
-   HTML 렌더링 메모리 손상 취약점(CVE-2008-4261)을 보고해 주신 [Verisign iDefense Labs (영문)](http://labs.idefense.com/)의 Jun Mao
