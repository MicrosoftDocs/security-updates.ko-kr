...
For information about how to manually remove Network Service or ASP.NET accounts from a computer running SQL Server 2005 or Windows 내부 데이터베이스, see SQL Server product documentation. You can download product documentation for SQL Server at [SQL Server Books Online](https://go.microsoft.com/fwlink/?linkid=81092) (https://go.microsoft.com/fwlink/?LinkId=81092).
