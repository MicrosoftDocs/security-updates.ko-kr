---
TOCTitle: 'MS11-015'
Title: 'Microsoft 보안 공지 MS11-015 - 긴급'
ms:assetid: 'ms11-015'
ms:contentKeyID: 61230382
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-015(v=Security.10)'
---

Microsoft 보안 공지 MS11-015 - 긴급
===================================
...
이 보안 업데이트의 심각도는 영향을 받는 모든 Windows XP(Windows XP Media Center Edition 2005 포함) 에디션, 지원 대상인 모든 Windows Vista, Windows 7 및 Windows Media Center TV Pack for Windows Vista 에디션에 대해 긴급입니다. 이 보안 업데이트의 심각도는 지원 대상인 Windows Server 2008 R2(x64 기반 시스템용)에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 라이브러리 파일 및 Windows 미디어 파일이 열리는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b1be30de-7e88-467d-aee2-68f88e6a7355&amp;displaylang=ko">Windows XP Media Center Edition 2005 서비스 팩 3</a><br />
(KB2502898)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d8284bfa-ed6c-4647-9fb0-588e53173775">Windows XP 서비스 팩 3</a><br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5270b5d3-3720-42a2-a8cf-67089c0cc658">Windows XP Professional x64 Edition 서비스 팩 2</a><br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f9f1dde2-2219-4bf1-a497-edd011577b96">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2</a>[1]<br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e11d00df-d1cf-4a33-a1be-6721cdff5995&amp;displaylang=ko">Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2</a>[2]<br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1be77daa-29b1-4dae-a87f-2cb8f7e6a305&amp;displaylang=ko">Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1</a><br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56fb24ce-65c7-4573-b613-e424ccc1a3a6&amp;displaylang=ko">Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1</a><br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6f45658a-1db8-4ef5-b840-4d0180d4d90e&amp;displaylang=ko">Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1</a>\*\*<br />
(KB2479943)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1bc240b3-1938-4350-b26f-67b81a79f8a0&amp;displaylang=ko">Windows Media Center TV Pack for Windows Vista(32비트 에디션</a>)[3]<br />
(KB2494132)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cd4c5a80-db24-4696-a248-1286c3b9f550&amp;displaylang=ko">Windows Media Center TV Pack for Windows Vista(64비트 에디션</a>)[3]<br />
(KB2494132)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
예, 이 업데이트에서 해결하는 취약점 1건은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
  
**Windows Media Center TV Pack for Windows Vista란 무엇입니까?**      
Windows Media Center TV Pack for Windows Vista는 Windows Vista Home Premium 및 Ultimate 에디션의 OEM 설치에서 선택적 구성 요소로만 제공됩니다. 이 선택적 구성 요소를 시스템에 설치한 고객은 두 업데이트를 모두 설치해야 합니다. 가장 좋은 효과를 얻기 위해 Microsoft는 Windows Media Center TV Pack 업데이트(KB2494132)를 설치하기 전에 운영 체제 업데이트(KB2479943)를 설치할 것을 권장합니다.
...
<th style="border:1px solid black;" >DirectShow의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0032)</th>
<th style="border:1px solid black;" >DVR-MS 취약점(CVE-2011-0042)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Media Center TV Pack for Windows Vista(32비트 에디션)</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Media Center TV Pack for Windows Vista(64비트 에디션)</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
...
Microsoft DirectShow에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0032 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032)를 참조하십시오.
  
#### DirectShow의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0032)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격이 성공하려면 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문한 후 미디어 파일(.wtv, .drv-ms, .mpg 파일 등)을 열어야 합니다.  
-   파일 공유 프로토콜인 SMB(Server Message Block)는 경계 방화벽에서 자주 비활성화됩니다. 이것이 이 취약점의 가능한 공격 경로를 제한합니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
#### DirectShow의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0032)에 대한 대안
...
#### DirectShow의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0032)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**      
이 취약점은 Microsoft DirectShow가 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.
  
**DirectShow란 무엇입니까?**      
DirectShow는 Windows 프로그램에서 멀티미디어 지원을 위해 사용하는 DirectX 하위 수준 응용 프로그래밍 인터페이스(API)입니다. DirectX 내에서 DirectShow 기술은 클라이언트쪽 오디오와 비디오 소싱, 조작 및 렌더링을 수행합니다.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 Windows Media Player 파일(.wtv, .drv-ms, .mpg 파일 등)을 열도록 유도할 수 있습니다. 이렇게 하면 미디어 파일을 열 때 Microsoft DirectShow가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 미디어 첨부 파일(.wtv, .drv-ms, .mpg 파일 등)을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 미디어 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 이렇게 하면 미디어 파일을 열 때 Microsoft DirectShow가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
네트워크 공격 시나리오에서 공격자는 합법적인 미디어 파일 및 특수하게 조작된 DLL을 네트워크 공유, UNC 또는 WebDAV 위치에 두고 사용자가 미디어 파일을 열도록 유도할 수 있습니다.
  
**Windows Recorded TV Show(.wtv) 파일이란 무엇입니까?**      
Windows Recorded TV Show(WTV) 파일 형식은 이전에 사용된 DVR-MS 파일 형식을 대체합니다. 비디오는 MPEG-2 표준을 사용하여 인코딩되고, 오디오는 MPEG-1 Layer II 또는 Dolby Digital AC-3(ATSC A/52) 표준을 사용하여 인코딩됩니다. 이 파일 형식은 콘텐츠 및 DRM(digital rights management)에 대한 메타데이터를 포함시켜 이러한 표준을 확장합니다. WTV 파일 콘텐츠는 Stream Buffer Engine DirectShow 소스 필터를 사용하여 액세스됩니다. 이전 버전의 Media Center에서 만들어지고 ASF 파일 형식을 기반으로 하는 .dvr-ms 파일과 달리, WTV 파일은 새로운 파일 형식을 기반으로 합니다.
  
**Microsoft Digital Video Recording(.dvr-ms) 파일이란 무엇입니까?**      
Microsoft Digital Video Recording 파일은 SBE(Stream Buffer Engine)로 만들어지고 .dvr-ms 파일 확장명으로 저장되는 파일입니다. SBE가 Video Control에서 제어될 때 오디오 및 비디오 기본 스트림에서 복사 보호/통제 정보가 검사됩니다. 이 정보에서 콘텐츠의 암호화를 지정하지 않을 경우 나중에 SBE를 사용하는 모든 DirectShow 기반 응용 프로그램에서 액세스할 수 있도록 암호화되지 않은 파일로 만들어집니다. 이 정보에서 콘텐츠의 암호화를 지정할 경우 만들어지는 파일은 녹화를 위해 사용된 동일 시스템에서만 재생이 가능합니다. Video Control을 기반으로 하지 않는 DirectShow 응용 프로그램은 SBE를 직접 사용하여 암호화되지 않은 dvr-ms 파일을 만들고 재생할 수 있습니다.
  
**DirectShow 필터란 무엇입니까?**      
DirectShow는 Microsoft Windows와 함께 자동으로 설치되는 기본 필터 모음을 제공합니다. 이러한 필터는 높은 수준의 하드웨어 독립성을 제공하면서 다양한 데이터 형식을 지원합니다. 응용 프로그램은 사용자 지정 필터를 대상 시스템에 등록하고 설치할 수도 있습니다. 전체 필터 목록 및 추가 정보는 MSDN 문서, [DirectShow 필터(영문)](https://msdn.microsoft.com/library/dd375464(v=vs.85).aspx)를 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**      
이 업데이트는 Microsoft DirectShow가 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0032 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0042 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0042)를 참조하십시오.
  
#### DVR-MS 취약점(CVE-2011-0042)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.  
-   메일을 통해 취약점을 자동으로 악용할 수 없습니다. 공격에 성공하려면 메일 메시지에 첨부 파일로 특수하게 조작된 .dvr-ms 파일을 사용자가 열어야 합니다. 공격자가 특수하게 조작된 .dvr-ms 파일을 사용자가 열도록 강제하는 방법은 없습니다. 공격에 성공하려면 공격자는 사용자가 파일을 열도록 유도해야 합니다.  
...
#### DVR-MS 취약점(CVE-2011-0042)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **Stream Buffer Engine(SBE.dll)에 대한 액세스 제한**
  
    관리자로 로그인하여 명령 프롬프트에서 다음 명령을 실행합니다.
  
    `takeown /f "%windir%\system32\sbe.dll"cacls "%windir%\system32\sbe.dll" /E /P everyone:N`
  
    **대안의 영향.** Stream Buffer Engine으로 만들어진 .dvr-ms 파일을 재생하지 못합니다.
...
#### DVR-MS 취약점(CVE-2011-0042)에 대한 FAQ
...
**어떤 구성 요소가 취약점의 영향을 받습니까?**      
Windows Media Center 및 Windows Media Player가 취약점의 영향을 받는 구성 요소입니다.
...
전자 메일 공격의 경우 공격자가 특수하게 조작된 .dvr-ms 파일이 내장된 미디어 파일을 사용자에게 보내고 파일을 열도록 유도하여 이러한 취약점을 악용할 수 있습니다.
  
웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 특수하게 조작된 콘텐츠를 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다.
...
|----------------------------------------------------------------------------------------------------|---------|---------------------|---------------------|----------------------------|  
| Windows XP Media Center Edition 2005 서비스 팩 3                                                   | 아니요  | 아니요              | 아니요              | 아니요                     |  
...
| Windows Media Center TV Pack for Windows Vista(32비트 에디션)                                      | 아니요  | 아니요              | 예                  | 예                         |  
| Windows Media Center TV Pack for Windows Vista(64비트 에디션)                                      | 아니요  | 아니요              | 예                  | 예                         |
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](https://update.microsoft.com/microsoftupdate)에서 제공하고 [Windows Server Update Services](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool (영문)](https://technet.microsoft.com/en-us/sms/bb676783.aspx)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools (영문)](https://technet.microsoft.com/en-us/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드 (영문)](https://technet.microsoft.com/sms/bb676766.aspx)도 참조하십시오.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2479943$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2479943">Microsoft 기술 자료 문서 2479943</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Vista Home Premium 및 Windows Vista Ultimate 32비트 에디션의 Windows Media Center TV Pack:<br />
MCETVPack-Windows6.0-KB2494132-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista Home Premium 및 Windows Vista Ultimate 64비트 에디션의 Windows Media Center TV Pack:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2494132">Microsoft 기술 자료 문서 2494132</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
-   DVR-MS 취약점(CVE-2011-0042)을 보고해 주신 [Sourcefire VRT (영문)](https://www.sourcefire.com/services/sf_vrt.html)의 Matthew Watchinski
...
-   V1.1(2011년 3월 10일): Windows XP 서비스 팩 3에 대한 SMS 2.0 및 SMS 2003(SUIT 포함)의 Systems Management Server 표 항목이 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.  
-   V1.2(2011년 3월 17일): **영향을 받지 않는 소프트웨어**의 Windows XP Home Edition 서비스 팩 3 및 Windows XP Tablet PC Edition 서비스 팩 3에 대해 잘못된 참조가 제거되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다. Windows XP Home Edition 또는 Windows XP Table PC Edition을 실행하는 고객과 이 업데이트를 이미 적용하지 않은 고객은 업데이트를 즉시 적용하는 것이 좋습니다. 이 업데이트를 이미 적용한 고객은 추가 조치가 필요하지 않습니다.
