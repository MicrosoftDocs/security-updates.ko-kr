---
TOCTitle: 'MS12-054'
Title: 'Microsoft 보안 공지 MS12-054 - 긴급'
ms:assetid: 'ms12-054'
ms:contentKeyID: 61230521
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-054(v=Security.10)'
---

Microsoft 보안 공지 MS12-054 - 긴급
===================================

Windows 네트워킹 구성 요소의 취약점으로 인한 원격 코드 실행 문제점 (2733594)
----------------------------------------------------------------------------

게시된 날짜: 2012년 8월 15일 수요일 | 업데이트된 날짜: 2013년 7월 10일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션에 대해 긴급, 지원 대상인 모든 Windows Vista 에디션에 대해 중요, 지원 대상인 모든 Windows Server 2008, Windows 7 및 Windows 2008 R2에 대해 보통입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Windows 인쇄 스풀러가 특수하게 조작된 응답을 처리하는 방식과 Windows 네트워킹 구성 요소가 RAP(Remote Administration Protocol) 응답을 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;">
[MS08-067](https://go.microsoft.com/fwlink/?linkid=130719)의 KB958644는 KB2705219로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-022](https://go.microsoft.com/fwlink/?linkid=141786)의 KB961501은 KB2712808로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2857701f-3447-452c-a986-9f2fe42fe64d)  
(KB2712808)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=354e502b-3016-4c5e-8611-bc1b35e1a7eb&displaylang=ko)(Server Core 설치)  
(KB2705219)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=35fb03b1-162a-4552-8bb9-6b564acbd57b&displaylang=ko)(Server Core 설치)  
(KB2712808)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2b8a730c-46ac-49b7-b9ae-73062d5a79f2&displaylang=ko)(Server Core 설치)  
(KB2705219)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e89024ca-a9e8-4ebf-91eb-cbf8e05398e7&displaylang=ko)(Server Core 설치)  
(KB2712808)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175&displaylang=ko)(Server Core 설치)  
(KB2705219)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a&displaylang=ko)(Server Core 설치)  
(KB2712808)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175&displaylang=ko)(Server Core 설치)  
(KB2705219)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a&displaylang=ko)(Server Core 설치)  
(KB2712808)
</td>
<td style="border:1px solid black;">
서비스 거부
...
기존 KB2705219 업데이트를 이미 성공적으로 설치했습니다. 2012년 10월 9일에 다시 릴리스된 KB2705219 업데이트 패키지를 설치해야 합니까?  
Windows XP 및 Windows Server 2003에서는 기존 업데이트가 설치되지 않은 시스템에만 다시 릴리스된 업데이트가 적용됩니다. 기존 업데이트 KB2705219를 이미 성공적으로 설치한 Windows XP 및 Windows Server 2003 에디션의 고객은 추가 조치가 필요하지 않습니다. 이미 시스템에 설치된 경우 이 업데이트는 다시 제공되지 않습니다.

Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션의 고객은 다시 릴리스된 KB2705219 업데이트 패키지를 적용해야 합니다.

참고 KB2705219 업데이트만 2012년 10월 9일에 다시 릴리스되었습니다. KB2712808 업데이트는 이 재배포판에 해당되지 않습니다.

이 공지가 2012년 10월 9일에 개정된 이유는 무엇입니까?  
Microsoft는 적절한 타임스탬프 특성 없이 Microsoft에서 생성한 특정 디지털 인증서와 관련된 문제를 해결하도록 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에 대한 KB2705219 업데이트를 다시 릴리스하기 위해 이 공지를 개정했습니다. 자세한 내용은 [Microsoft 보안 권고 2749655](https://technet.microsoft.com/security/advisory/2749655)를 참조하십시오.

파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.

보안 업데이트의 해시는 어디에 있습니까?  
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2733594](https://support.microsoft.com/kb/2733594)를 참조하십시오.
...
영향을 받는 소프트웨어 표에 나열된 Windows Server 2008 R2(Server Core 설치) 를 실행하고 있습니다. ***KB2712808*** ***업데이트가***제공되지 않는 이유는 무엇입니까?  
KB2712808 업데이트는 Printing-ServerCore-Role 설정이 활성화된 경우에 Windows Server 2008 R2의 Server Core 설치 옵션을 실행하는 시스템에만 제공됩니다.
...
Windows 네트워킹 구성 요소에 서비스 거부 취약점이 존재합니다. 이 취약점은 서비스에서 특수하게 조작된 RAP 요청을 올바르게 처리하지 못해 발생합니다. 취약점 악용에 성공한 공격자는 일부 Windows 네트워킹 구성 요소가 응답을 중지하도록 만들 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1850](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1850)(영문)을 참조하십시오.

#### 원격 관리 프로토콜 서비스 거부 취약점(CVE-2012-1850)에 대한 완화 요소
...
#### 원격 관리 프로토콜 서비스 거부 취약점(CVE-2012-1850)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   LanmanWorkstation 서비스 사용 안 함
    ...
    3.  LanmanWorkstation을 선택한 다음 파일 메뉴를 클릭하고 내보내기를 선택합니다.
    4.  레지스트리 파일 내보내기 대화 상자에 lanmanworkstation\_configuration\_backup.reg를 입력한 다음 저장을 클릭합니다.
    5.  Start 레지스트리 항목을 두 번 클릭하고 값 데이터 필드를 4로 변경한 다음 확인을 클릭합니다.
    ...
    2.  다음 스크립트를 .REG 확장명의 파일(예: Disable\_lanmanworkstation.reg)로 저장합니다.

        ```
        Windows Registry Editor Version 5.00  [HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\lanmanworkstation]  
    ...
    3.  레지스트리 파일 가져오기 대화 상자에서 lanmanworkstation\_configuration\_backup.reg를 선택한 다음 열기를 클릭합니다.
...
#### 원격 관리 프로토콜 서비스 거부 취약점(CVE-2012-1850)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 서비스 거부 취약점입니다.

취약점의 원인은 무엇입니까?  
이 취약점은 Windows 네트워킹 구성 요소가 RAP(Remote Administration Protocol) 응답을 올바르게 처리하지 못할 때 발생합니다.

RAP란 무엇입니까?  
RAP(Remote Administration Protocol)는 LAN Manager 서버의 공유 유지 관리 및 프린터 유지 관리 같은 작업을 포함하는 관리 기능을 처리합니다. 자세한 내용은 [\[MS-RAP\]: Remote Administration Protocol 사양(영문)](https://msdn.microsoft.com/en-us/library/cc240191(v=prot.13))을 참조하십시오.

이 취약점의 영향을 받는 구성 요소는 무엇입니까?  
Netapi32.dll이 취약점의 영향을 받는 구성 요소입니다.

공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
취약점 악용에 성공한 공격자는 서비스가 응답을 중지하도록 만들 수 있습니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
인증되지 않은 원격 공격자는 특수하게 조작된 RAP 패킷 시퀀스를 대상 시스템으로 전송하여 이 취약점을 악용할 수 있습니다.

취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?  
워크스테이션과 서버 모두 이 취약점으로 인한 위험에 노출되어 있습니다.

업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Windows 네트워킹 구성 요소가 RAP 응답을 처리하는 방식을 수정하여 취약점을 해결합니다.
...
Windows 인쇄 스풀러 서비스에 인증되지 않은 원격 공격자가 영향을 받는 시스템에서 임의 코드를 실행할 수 있는 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1851](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1851)(영문)을 참조하십시오.

#### 인쇄 스풀러 서비스 형식 문자열 취약점(CVE-2012-1851)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 직접 연결되는 시스템의 경우 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.

#### 인쇄 스풀러 서비스 형식 문자열 취약점(CVE-2012-1851)에 대한 대안
...
-   인쇄 스풀러 서비스 사용 안 함
    ...
    1.  시작, 실행을 차례로 클릭하고 regedit을 입력한 다음 확인을 클릭합니다.
    2.  레지스트리 편집기에서 다음 레지스트리 위치를 확장합니다. HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\services\\
...
#### 인쇄 스풀러 서비스 형식 문자열 취약점(CVE-2012-1851)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다.

취약점의 원인은 무엇입니까?  
이 취약점은 Windows 인쇄 스풀러가 특수하게 조작된 응답을 처리하지 못할 때 발생합니다.

이 취약점의 영향을 받는 구성 요소는 무엇입니까?  
Windows 인쇄 스풀러 서비스는 이 취약점의 영향을 받는 구성 요소입니다.

인쇄 스풀러 서비스란 무엇입니까?  
인쇄 스풀러 서비스는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 자세한 내용은 [How Network Printing Works(네트워크 인쇄 작동 방식)](https://technet.microsoft.com/en-us/library/cc783789(v=ws.10).aspx)(영문)를 참조하십시오.
...
공격자는 이러한 취약점을 어떻게 악용합니까?  
인증되지 않은 원격 공격자는 특수하게 조작된 응답으로 인쇄 스풀러의 요청에 응답하는 방식으로 이 취약점을 악용할 수 있습니다.

취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?  
워크스테이션과 서버 모두 이 취약점으로 인한 위험에 노출되어 있습니다.

업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Windows 인쇄 스풀러가 특수하게 조작된 응답을 처리하는 방식을 수정하여 취약점을 해결합니다.
...
Windows 네트워킹 구성 요소가 특수하게 조작된 RAP 응답을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 성공적으로 악용한 공격자는 대상 시스템에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1852](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1852)(영문)를 참조하십시오.

#### 원격 관리 프로토콜 힙 오버플로 취약점(CVE-2012-1852)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 직접 연결되는 시스템의 경우 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.

#### 원격 관리 프로토콜 힙 오버플로 취약점(CVE-2012-1852)에 대한 대안
...
#### 원격 관리 프로토콜 힙 오버플로 취약점(CVE-2012-1852)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1853](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1853)(영문)을 참조하십시오.

#### 원격 관리 프로토콜 스택 오버플로 취약점(CVE-2012-1853)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 직접 연결되는 시스템의 경우 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.

#### 원격 관리 프로토콜 스택 오버플로 취약점(CVE-2012-1853)에 대한 대안
...
#### 원격 관리 프로토콜 스택 오버플로 취약점(CVE-2012-1853)에 대한 FAQ
...
이 취약점의 영향을 받는 구성 요소는 무엇입니까?  
Browser.dll이 취약점의 영향을 받는 구성 요소입니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 다음 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
%Windir%\$NTUninstallKB2705219-v2$\Spuninst<br />
%Windir%\$NTUninstallKB2712808$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2705219">Microsoft 기술 자료 문서 2705219</a> 참조<br />
<a href="https://support.microsoft.com/kb/2712808">Microsoft 기술 자료 문서 2712808</a> 참조</td>
</tr>
<tr class="even">
...
-   원격 관리 프로토콜 서비스 거부 취약점(CVE-2012-1850)을 보고해 주신 [Palo Alto Networks](https://www.paloaltonetworks.com/)(영문)의 Yamata Li  
-   인쇄 스풀러 서비스 형식 문자열 취약점(CVE-2012-1851)을 보고해 주신 [Palo Alto Networks](https://www.paloaltonetworks.com/)(영문)의 Yamata Li  
-   원격 관리 프로토콜 힙 오버플로 취약점(CVE-2012-1852)을 보고해 주신 [Palo Alto Networks](https://www.paloaltonetworks.com/)(영문)의 Yamata Li  
-   원격 관리 프로토콜 스택 오버플로 취약점(CVE-2012-1853)을 보고해 주신 [Palo Alto Networks](https://www.paloaltonetworks.com/)(영문)의 Yamata Li
...
-   V1.1(2012년 8월 16일): KB2712808 업데이트는 Printing-ServerCore-Role 설정이 활성화된 경우에 Windows Server 2008 R2의 Server Core 설치 옵션을 실행하는 시스템에만 제공된다는 설명이 추가되었습니다.  
-   V2.0(2012년 10월 10일): Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2에 대한 KB2705219 업데이트를 다시 릴리스하기 위해 공지를 개정했습니다. Windows XP 및 Windows Server 2003을 사용 중인 고객은 Microsoft 보안 권고 2749655에 설명된 디지털 인증서 관련 문제를 방지하기 위해 이 다시 릴리스된 업데이트를 적용하지 않아도 됩니다. Windows Vista, Windows 7, Windows Server 2008을 사용 중인 고객은 Microsoft 보안 권고 2749655에 설명된 디지털 인증서 관련 문제를 방지하기 위해 다시 릴리스된 업데이트 패키지를 적용해야 합니다.  
-   V2.1(2012년 10월 11일): 다시 릴리스된 KB2705219 업데이트에서는 배포 지침을 제공하기 위해 업데이트 FAQ에 항목이 추가되었습니다. 자세한 내용은 업데이트 FAQ를 참조하십시오.  
-   V2.2(2013년 7월 10일): Windows Update의 다시 제공 문제를 수정하기 위해 2705219 업데이트에서 Windows Vista 패키지의 검색 변경 사항을 알리고자 공지가 개정되었습니다. 이 변경 사항은 검색에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.
