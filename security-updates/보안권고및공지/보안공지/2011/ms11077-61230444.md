...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>Win32k Null 포인터 역참조 취약점(CVE-2011-1985)</th>
<th>Win32k TrueType 글꼴 유형 변환 취약점(CVE-2011-2002)</th>
<th>글꼴 라이브러리 파일 버퍼 오버런 취약점(CVE-2011-2003)</th>
<th>Win32k 해제 후 사용 취약점(CVE-2011-2011)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
