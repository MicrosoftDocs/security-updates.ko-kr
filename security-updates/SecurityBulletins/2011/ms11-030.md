---
TOCTitle: 'MS11-030'
Title: 'Microsoft 보안 공지 MS11-030 - 긴급'
ms:assetid: 'ms11-030'
ms:contentKeyID: 61230397
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-030(v=Security.10)'
---



Microsoft 보안 공지 MS11-030 - 긴급
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해 긴급이며, 지원 대상인 모든 Windows XP 및 Windows Server 2003 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

보안 업데이트는 DNS 클라이언트가 특수하게 조작된 DNS 쿼리를 처리하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2509553](https://support.microsoft.com/kb/2509553)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2d433adb-bcaf-4c59-9405-a4892f8ccba3">Windows XP 서비스 팩 3</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms08-020">MS08-020</a>,<br />
<a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms08-037">MS08-037</a>,<br />
<a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=29ff546e-a232-4f23-a223-c029c71ff1c6">Windows XP Professional x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms08-020">MS08-020</a>,<br />
<a href="https://technet.microsoft.com/ko-kr/security/bulletin/ms08-037">MS08-037</a>,<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=753ed6e3-df2e-4b2d-9e9f-7275cd94d214">Windows Server 2003 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=a0192dbc-4d0d-4555-9ef7-3e10209a6389">Windows Server 2003 x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="https://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f5ad6963-2d6a-4d59-9e25-4fc088647fcd">Windows Server 2003 SP2(Itanium 기반 시스템용)</a></td>
<td style="border:1px solid black;">권한 상승</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="https://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2a17e44f-54aa-423d-b3c7-a4f404f7c28b">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=e708d24f-e348-4c4d-99ed-e78dd1689d01">Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=9894be38-a582-4c15-ad0e-cc3afab2aebc">Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2</a>*</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2d7d2021-020f-4cc9-a027-258d7e5faec9">Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2</a>*</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c0275df0-10ac-4500-ab86-b7e9a34f8e1d">Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=8fdae09b-d1bb-4ef5-aa45-2a05f2a5e12d">Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=40879dfb-efa4-41ba-8d5c-22e926a55eef">Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/ko-kr/details.aspx?familyid=2084c726-187e-41f9-9bea-da18f490d29e">Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1</a>*</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=34d2793e-a2cd-49f6-b524-6598ea86175f">Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [4월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-apr)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >DNS 쿼리 취약점(CVE-2011-0657)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
DNS 쿼리 취약점(CVE-2011-0657)  
------------------------------
  

DNS 클라이언트 서비스가 특수하게 조작된 LLMNR 쿼리를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 NetworkService 계정의 컨텍스트에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0657(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0657)을 참조하십시오.
  
#### DNS 쿼리 취약점(CVE-2011-0657)에 대한 완화 요소
...
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 LLMNR 포트를 인터넷에서 차단해야 합니다. 방화벽에서 TCP 포트 5355 및 UDP 포트 5355 차단 방법은 아래의 FAQ를 참조하십시오.
  
#### DNS 쿼리 취약점(CVE-2011-0657)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   방화벽에서 TCP 포트 5355 및 UDP 포트 5355 차단
  
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 기업 방화벽의 들어오는 방향과 나가는 방향 모두에서 이들 포트를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 침입을 예방할 수 있습니다. 다른 포트를 사용하는 공격을 방지하려면 인바운드 원치 않는 인터넷 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오. Windows 방화벽에 대한 자세한 내용은 [단일 컴퓨터에서 Windows 방화벽을 구성하는 방법](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx)을 참조하십시오.
  
    대안의 영향. 이들 포트에 대한 연결을 차단하면 방화벽 뒤의 시스템이 이 취약점을 악용하는 것을 예방할 수 있습니다.
  
    대안 실행 취소 방법. 방화벽에서 TCP 포트 5355 및 UDP 포트 5355 차단을 해제합니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
  
-   그룹 정책을 사용하여 링크-로컬 멀티캐스트 이름 확인 사용 안 함
  
    그룹 정책을 사용하여 링크-로컬 멀티캐스트 이름 확인을 사용하지 않도록 설정하려면 다음 절차를 수행하십시오.
  
    1.  그룹 정책 편집기를 엽니다.  
    2.  컴퓨터 구성, 관리 템플릿, 네트워크, DNS 클라이언트를 차례로 확장합니다.  
    3.  멀티캐스트 이름 확인 사용 안 함을 두 번 클릭하고 사용을 클릭한 다음 확인을 클릭합니다.
  
    대안의 영향. 컴퓨터가 네트워크의 다른 컴퓨터에 보이지 않을 수 있습니다.
  
    대안 실행 취소 방법.
  
    그룹 정책을 사용하여 링크-로컬 멀티캐스트 이름 확인을 다시 사용하도록 설정하려면 다음 절차를 수행하십시오.
  
    1.  그룹 정책 편집기를 엽니다.  
    2.  컴퓨터 구성, 관리 템플릿, 네트워크, DNS 클라이언트를 차례로 확장합니다.  
    3.  멀티캐스트 이름 확인 사용 안 함을 두 번 클릭하고 사용 안 함을 클릭한 다음 확인을 클릭합니다.
  
-   네트워크 검색 끄기
  
    네트워크 검색을 끄려면 다음 절차를 수행하십시오.
  
    1.  제어판을 엽니다.  
    2.  네트워크 및 인터넷, 네트워크 및 공유 센터, 고급 공유 설정 변경을 차례로 클릭합니다.  
    3.  네트워크 검색에서 네트워크 검색 끄기를 클릭한 다음 변경 내용 저장을 클릭합니다.
  
    대안의 영향. 컴퓨터가 네트워크의 다른 컴퓨터에 보이지 않을 수 있습니다.
  
    대안 실행 취소 방법.
  
    네트워크 검색을 다시 사용으로 설정하려면 다음 절차를 수행하십시오.
  
    1.  제어판을 엽니다.  
    2.  네트워크 및 인터넷, 네트워크 및 공유 센터, 고급 공유 설정 변경을 차례로 클릭합니다.  
    3.  네트워크 검색에서 네트워크 검색 켜기를 클릭한 다음 변경 내용 저장을 클릭합니다.
  
#### DNS 쿼리 취약점(CVE-2011-0657)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?    
Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 시스템에서는 원격 코드 실행 취약점입니다. 이 취약점 악용에 성공한 공격자는 NetworkService 계정의 컨텍스트에서 코드를 실행할 수 있습니다.
  
Windows XP 및 Windows Server 2003 시스템에서는 권한 상승 취약점입니다. 사용자 자격 증명을 가진 공격자가 취약점을 악용하면 공격자가 NetworkService 계정의 컨텍스트에서 코드를 실행할 수 있는 권한 상승이 발생합니다.
  
취약점의 원인은 무엇입니까?    
이 취약점은 DNS 클라이언트가 특수하게 조작된 LLMNR 쿼리를 처리하는 방식으로 인해 발생합니다.
  
이 취약점의 영향을 받는 구성 요소는 무엇입니까?    
DNSAPI.dll이 영향을 받는 구성 요소입니다.
  
공격자는 취약점을 악용하여 무엇을 할 수 있습니까?    
이 취약점 악용에 성공한 공격자는 NetworkService 계정의 컨텍스트에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
공격자는 이러한 취약점을 어떻게 악용합니까?    
Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 시스템에서 이 취약점 악용에 성공한 공격자는 네트워크에 액세스해야 합니다. 그런 다음 공격자는 특수하게 조작된 LLMNR 브로드캐스트 쿼리를 대상 시스템에 보내는 사용자 지정 프로그램을 만들 수 있습니다.
  
Windows XP 및 Windows Server 2003 시스템에서 공격자는 이 취약점을 악용하기 위해 먼저 시스템에 로그온해야 합니다. 그런 다음 공격자는 취약점을 악용할 수 있는 특수하게 조작된 응용 프로그램을 실행하여 공격자의 권한을 NetworkService 계정으로 상승시킵니다.
  
Windows XP 또는 Windows Server 2003에서 이 취약점을 원격으로 악용할 수 있습니까?    
아니요. LLMNR은 Windows XP 또는 Windows Server 2003에서 지원되지 않습니다. 이러한 시스템의 경우에도 DNS 클라이언트의 취약점이 존재하며 특수하게 조작된 응용 프로그램을 실행하여 로컬에서만 악용할 수 있습니다.
  
LLMNR이란 무엇입니까?    
LLMNR(링크-로컬 멀티캐스트 이름 확인)은 네트워크 환경의 컴퓨터 이름을 확인하기 위한 추가적인 방법을 제공하는 새로운 프로토콜입니다. LLMNR은 DNS(도메인 이름 시스템) 서버가 없는 네트워크에 특히 유용합니다. LLMNR에서는 요청 및 응답 메시지의 단순 교환을 사용하여 컴퓨터 이름을 IPv6(인터넷 프로토콜 버전 6) 또는 IPv4(IP 버전 4) 주소로 확인합니다. LLMNR에 대한 자세한 내용은 Microsoft TechNet 문서, [LLMNR(링크-로컬 멀티캐스트 이름 확인) (영문)](https://technet.microsoft.com/ko-kr/library/bb878128.aspx)을 참조하십시오.
...
업데이트는 어떤 기능을 수행합니까?    
이 업데이트는 DNS 클라이언트가 특수하게 조작된 DNS 쿼리를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2509553$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2509553">Microsoft 기술 자료 문서 2509553</a> 참조</td>
</tr>
<tr class="even">
...
-   DNS 쿼리 취약점(CVE-2011-0657)을 보고해 주신 [Google Inc.](https://www.google.com/ko)의 Neel Mehta
...
-   V1.1(2012년 3월 14일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2509553 링크가 추가되었습니다.
