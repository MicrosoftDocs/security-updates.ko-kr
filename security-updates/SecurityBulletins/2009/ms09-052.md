...
|--------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 서비스 팩 4               | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=13035ef7-7e47-487c-8b7c-7795d33ce7de&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                                                                |
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3 | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=b2efe1ac-d8d7-41bb-b87d-fc5e22afef0f&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows XP Professional x64 Edition 서비스 팩 2  | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=a9e7dfd8-7ba1-4f14-8e60-92ef00d91467)                | 원격 코드 실행 | 긴급        | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows Server 2003 서비스 팩 2                  | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=5f82d01c-573e-425e-b9f2-86a54f377b19&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows Server 2003 x64 Edition 서비스 팩 2      | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=65e9036e-2e1b-40ff-a84b-c507107bcce8&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
...
이 공지는 [MS09-051](http://technet.microsoft.com/security/bulletin/ms09-051), Windows Media Runtime의 취약점으로 인한 원격 코드 실행 문제점과 관련이 없습니다. 시스템을 완벽하게 보호하려면 두 업데이트를 모두 설치해야 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2527 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2527)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/974112">Microsoft 기술 자료 문서 974112</a> 참조</td>
</tr>
<tr class="even">
...
-   WMP 힙 오버플로 취약점(CVE-2009-2527)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Yamata Li
