...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=41326ade-96b6-47ce-9291-d4e3039471c4&displaylang=ko)                                                | 스푸핑         | 중요        | 없음                      |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=893f4cef-0395-4c44-ba28-7a10b6e7dd48&displaylang=ko)                                                            | 스푸핑         | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8fdd1207-6e93-4c43-bacc-fe3623a6ebe7)           | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=214bd8f5-6eb2-414c-b013-c516a306d692&displaylang=ko)                | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fd123394-a5d6-4b55-be74-2938f52ce922&displaylang=ko)    | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=e0e63f03-904d-47ee-94fc-51a8dea668eb) | 스푸핑         | 중요        | 없음                      |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=8203d303-c855-4579-9bbf-b06ddf5c1b87&displaylang=ko)                                                                     | 스푸핑         | 중요        | 없음                      |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=73f3a234-3973-4467-be7e-69efa7ee978c&displaylang=ko)                                                         | 스푸핑         | 중요        | 없음                      |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 945553](https://support.microsoft.com/kb/945553)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0087 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0087)을 참조하십시오.
...
도메인 이름 시스템(DNS)은 TCP/IP를 구성하는 업계 표준 프로토콜 모음입니다. DNS는 두 소프트웨어 구성 요소를 사용하여 구성됩니다. DNS 서버와 DNS 클라이언트(또는 확인자). 두 구성 요소는 백그라운드 서비스 응용 프로그램으로 실행됩니다. 네트워크 리소스는 숫자 형식의 IP 주소로 식별되지만 이러한 IP 주소는 네트워크 사용자가 기억하기 어렵습니다. DNS 데이터베이스에는 사용자에게 친숙한 네트워크 리소스의 영숫자 이름을 이러한 리소스에서 통신을 위해 사용되는 IP 주소로 매핑하는 레코드가 포함되어 있습니다. 이와 같이 DNS는 니모닉 장치의 역할을 수행하여 네트워크 사용자가 네트워크 리소스를 더욱 쉽게 기억할 수 있도록 합니다. DNS가 다른 Windows 기술과 함께 사용되는 방식을 나타낸 논리적 다이어그램과 자세한 내용을 [DNS 작동 방식](https://technet2.microsoft.com/windowsserver/en/library/ff937311-03ce-4d04-b72c-b39c4d51cb361033.mspx) 문서를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/945553">Microsoft 기술 자료 문서 945553</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
-   DNS 스푸핑 공격 취약점(CVE-2008-0087)을 보고해 주신 [Trusteer (영문)](https://www.trusteer.com/)의 Amit Klein  
-   DNS 스푸핑 공격 취약점(CVE-2008-0087)을 보고해 주신 [Scanit (영문)](https://www.scanit.be/)의 Alla Berzroutchko  
-   DNS 스푸핑 공격 취약점(CVE-2008-0087)을 보고해 주신 [Nominet UK (영문)](https://www.nominet.org.uk/)의 Roy Arends
