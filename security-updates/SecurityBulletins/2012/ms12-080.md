---
TOCTitle: 'MS12-080'
Title: 'Microsoft 보안 공지 MS12-080 - 긴급'
ms:assetid: 'ms12-080'
ms:contentKeyID: 61230547
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-080(v=Security.10)'
---

Microsoft 보안 공지 MS12-080 - 긴급
===================================
...
[Microsoft Exchange Server 2007 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=605fc9bc-a05c-4466-ace6-9c2af087d797&displaylang=ko)   
(KB2746157)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-058](https://go.microsoft.com/fwlink/?linkid=259630)의 KB2756497은 KB2746157로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Exchange Server 2010 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e43b1164-d768-4152-b9a3-d1491e2f3cba&displaylang=ko)   
(KB2787763)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-058](https://go.microsoft.com/fwlink/?linkid=259630)의 KB2756496은 KB2787763으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Microsoft Exchange Server 2010 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2a49ed58-9dab-4d48-ae8a-c7139e3b34ba&displaylang=ko)   
(KB2785908)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-058](https://go.microsoft.com/fwlink/?linkid=259630)의 KB2756485는 KB2785908로 대체되었습니다.
</td>
</tr>
</table>
...
[Oracle Critical Patch Update Advisory - October 2012](https://www.oracle.com/technetwork/topics/security/cpuoct2012-1515893.html)에 설명된 CVE-2012-3214 및 CVE-2012-3217은 Microsoft Exchange Server에 영향을 미치며, 이 업데이트에 의해 해결됩니다.
...
-   Exchange Server 2007 서비스 팩 3용 업데이트 롤업 9(KB2746157)의 경우 [Microsoft 기술 자료 문서 2746157](https://support.microsoft.com/kb/2746157)을 참조하십시오.
-   Exchange 2010 서비스 팩 1용 업데이트 롤업 8(KB2787763)의 경우 [Microsoft 기술 자료 문서 2787763](https://support.microsoft.com/kb/2787763)을 참조하십시오.
-   Exchange 2010 서비스 팩 2용 업데이트 롤업 5(KB2785908)의 경우 [Microsoft 기술 자료 문서 2785908](https://support.microsoft.com/kb/2785908)을 참조하십시오.

이전에 Exchange Server 2010 사서함 서버 핫픽스에 상위 버전 버킷을 설치했습니다. 이 경우 업데이트를 설치해야 합니까?  
예. 이미 [Microsoft 기술 자료 문서 2786772](https://support.microsoft.com/kb/2786772)에서 설명한 핫픽스가 적용된 시스템은 [CVE-2012-4791](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791)에 설명된 취약점으로부터 보호되지만 시스템은 이 업데이트로 해결된 Oracle Outside In 취약점에 여전히 취약합니다.
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2784126](https://support.microsoft.com/kb/2784126)을 참조하십시오.
...
CVE-2012-3214<br />
CVE-2012-3217</th>
<th style="border:1px solid black;" >RSS 피드로 인한 Exchange DoS 취약점(CVE-2012-4791)</th>
...
원격 코드 실행 취약점은 WebReady 문서 보기 기능을 통해 Microsoft Exchange Server에 존재합니다. 사용자가 브라우저에서 Outlook Web Access를 통해 특수하게 조작된 파일을 보는 경우 이 취약점은 원격 코드 실행을 LocalService 계정처럼 허용할 수 있습니다. 이 취약점을 성공적으로 악용하는 공격자는 영향을 받은 서버에서 코드를 LocalService 계정으로만 실행할 수 있습니다. LocalService 계정에는 로컬 컴퓨터의 최소 권한이 있으며 네트워크에서 익명 자격 증명을 제시합니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-3214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-3214) (영문)및 [CVE-2012-3217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-3217)(영문)을 참조하십시오.
...
-   WebReady 문서 보기 비활성화
    ...
    1.  Exchange 관리 셸에 Exchange 조직 관리자로 로그인합니다.  
    2.  다음 PowerShell 명령을 실행합니다.  
    3.  Get-OwaVirtualDirectory | where {$_.OwaVersion -eq 'Exchange2007' -or $_.OwaVersion -eq 'Exchange2010'} | Set-OwaVirtualDirectory -WebReadyDocumentViewingOnPublicComputersEnabled:$True -WebReadyDocumentViewingOnPrivateComputersEnabled:$True  
    4.  참고 위 단계는 Exchange Administrator가 이전에 WebReady 문서를 OWA에 대한 공개 및 비공개 로그온 모두에서 볼 수 있도록 허용했었다고 가정합니다. 적절한 $True 또는 $False 값은 사용자 로그온에 기반하여 요구되는 행동을 설정할 때 사용되어야 합니다.
...
-   [CVE-2012-3214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-3214)(영문)  
-   [CVE-2012-3217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-3217)(영문)
  
이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 <strong>*보고를*</strong> 받았습니까?  
...
Exchange에서 RSS 피드를 부적절하게 처리할 때 Microsoft Exchange Server에 서비스 거부 취약점이 존재합니다. 취약점으로 인해 프로세스가 강제로 종료될 때까지 영향을 받는 시스템의 Information Store 서비스가 응답하지 않을 수 있습니다. 이 무응답 조건으로 인해 Exchange 데이터베이스가 마운트 해제되고 데이터베이스 손상으로 이어져 사용자 사서함이 영향을 받을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4791](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791)(영문)를 참조하십시오.
  
#### RSS 피드로 인한 Exchange DoS 취약점(CVE-2012-4791)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 이 취약점을 악용하기 위해서는 영향을 받는 Exchange Server에서 유효한 전자 메일 계정을 가지고 RSS 피드를 만들 수 있어야 합니다.
  
#### RSS 피드로 인한 Exchange DoS 취약점(CVE-2012-4791)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### RSS 피드로 인한 Exchange DoS 취약점(CVE-2012-4791)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 서비스 거부 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 응답하지 않도록 만들 수 있습니다. 공격자가 이 취약점을 악용하더라도 코드를 실행하거나 사용자 권한을 승격시킬 수는 없습니다.
  
취약점의 원인은 무엇입니까?  
취약점은 Exchange Server가 RSS 피드를 부적절하게 처리할 때 발생하며 이로 인해 서비스 거부 조건이 발생할 수 있습니다.
  
RSS 란 무엇입니까?  
RSS(Really Simple Syndication)는 콘텐츠 제작자가 표준화된 형식으로 정보를 배포하기 위한 편리한 방법을 제공합니다. 표준화된 XML 파일 형식은 정보를 한 번만 게시하면 Outlook과 같은 여러 프로그램에서 볼 수 있습니다. 사용자가 RSS 피드를 구독하면 업데이트된 콘텐츠를 알려줍니다.
  
공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
이 취약점 악용에 성공한 공격자는 프로세스가 강제로 종료될 때까지 영향을 받는 시스템의 Information Store 서비스가 응답하지 않도록 할 수 있습니다. 이 무응답 조건으로 인해 Exchange 데이터베이스가 마운트 해제되고 데이터베이스 손상으로 이어져 사용자 사서함이 영향을 받을 수 있습니다.
  
공격자는 이러한 취약점을 어떻게 악용합니까?  
Exchange Server에서 유효한 전자 메일 계정을 가지고 있는 공격자는 이 취약점을 악용하도록 고안된 특수하게 조작된 RSS 피드를 만든 다음 RSS 피드를 구독할 수 있습니다. 이 취약점은 영향을 받는 Exchange Server에서 RSS 피드를 처리할 때 악용될 수 있습니다.
  
취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?  
Exchange 서버 시스템이 이 취약점으로 인한 위험에 주로 노출됩니다.
  
업데이트는 어떤 기능을 수행합니까?  
업데이트는 Exchange Server에서 RSS 피드를 처리하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2784126">Microsoft 기술 자료 문서 2784126</a> 참조</td>
</tr>
<tr class="even">
