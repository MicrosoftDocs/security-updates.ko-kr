---
TOCTitle: 'MS11-041'
Title: 'Microsoft 보안 공지 MS11-041 - 긴급'
ms:assetid: 'ms11-041'
ms:contentKeyID: 61230408
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-041(v=Security.10)'
---



Microsoft 보안 공지 MS11-041 - 긴급
===================================
...
이 보안 업데이트의 심각도는 32비트 에디션을 제외한 지원 대상인 모든 Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해 긴급이며, 32비트 에디션을 제외한 지원 대상인 모든 Windows XP 및 Windows Server 2003에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널 모드 드라이버가 OpenType 글꼴을 구문 분석하는 동안 포인터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=035d5115-54b6-41d3-b9f0-890041ead178)                                                                     | 권한 상승      | 중요        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4aa8c003-0353-4a5b-8aea-c01a103af393&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2e07b5fa-c9fa-495b-9352-c07ce46a7e8b)                                                                 | 권한 상승      | 중요        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a519a5d7-bfe3-4e53-99e9-d85f7e34237f&displaylang=ko)                       | 원격 코드 실행 | 긴급        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cd8f3713-b408-4db6-aecd-7eed2176a715&displaylang=ko)\*       | 원격 코드 실행 | 긴급        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5a61f888-c81e-4b8a-8932-2fe67df4b2ad)                | 원격 코드 실행 | 긴급        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e7f52b13-5b3d-438c-ae14-86da50c8b67a&displaylang=ko)                             | 원격 코드 실행 | 긴급        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=b77e5be6-d3eb-4e3a-9be2-831578f0447c&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c00a33bc-c874-4693-b0f7-5034c5df9424)          | 원격 코드 실행 | 긴급        | [MS11-034](https://technet.microsoft.com/security/bulletin/ms11-034) |
...
<th style="border:1px solid black;" >Win32k OTF 유효성 검사 취약점(CVE-2011-1873)</th>
...
Windows 커널 모드 드라이버가 64비트 컴퓨터에서 특수하게 조작된 OpenType 글꼴을 잘못 구문 분석하는 방식으로 인해 원격 코드 실행 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1873 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1873)을 참조하십시오.
  
#### Win32k OTF 유효성 검사 취약점(CVE-2011-1873)에 대한 완화 요소
...
#### Win32k OTF 유효성 검사 취약점(CVE-2011-1873)에 대한 대안
...
#### Win32k OTF 유효성 검사 취약점(CVE-2011-1873)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**      
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**      
Windows 커널 모드 드라이버가 OpenType 글꼴을 구문 분석하는 동안 포인터의 유효성을 잘못 검사할 때 취약점이 발생합니다.
...
웹을 통한 공격의 경우 공격자는 네트워크 공유 위치의 특수하게 조작된 OpenType 글꼴을 가리키는 웹 사이트를 호스팅해야 합니다. 그런 후 사용자가 웹 사이트로 이동하면 Windows 탐색기의 세부 정보 및 미리 보기 창을 통해 영향 받은 제어 경로가 트리거됩니다. 결과적으로 특수하게 조작된 OpenType 글꼴은 이러한 취약점을 악용하고 영향 받은 시스템을 완전히 제어할 수 있게 됩니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 할 수 없습니다. 대신 공격자는 사용자가 공격자의 사이트로 연결되는 링크를 클릭하여 공격자의 웹 사이트를 방문하고 특수하게 조작된 파일을 열도록 유도해야 합니다.
  
네트워크 공유 위치를 통한 공격의 경우 공격자는 네트워크 공유 위치에 특수하게 조작된 OpenType 글꼴을 호스팅할 수 있습니다. 그런 후 사용자가 Windows 탐색기에서 공유로 이동하면 세부 정보 및 미리 보기 창을 통해 영향 받은 제어 경로가 트리거됩니다. 결과적으로 특수하게 조작된 OpenType 글꼴은 이러한 취약점을 악용하고 영향 받은 시스템을 완전히 제어할 수 있게 됩니다.
...
**어떤 유형의 시스템이 이 취약점의 영향을 받습니까?**    
64 기반 및 Itanium 기반 버전의 Windows 운영 체제만 이 취약점의 영향을 받으며, 32비트 버전의 Windows 운영 체제는 영향을 받지 않습니다.
  
**업데이트는 어떤 기능을 수행합니까?**      
이 업데이트는 Windows 커널 모드 드라이버가 OpenType 글꼴을 구문 분석하는 동안 포인터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2525694$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2525694">Microsoft 기술 자료 문서 2525694</a> 참조</td>
</tr>
<tr class="odd">
...
-   Win32k OTF 유효성 검사 취약점(CVE-2011-1873)을 보고해 주신 [www.korosoft.net (영문)](https://www.korosoft.net/)의 Koro
