---
TOCTitle: 'MS11-012'
Title: 'Microsoft 보안 공지 MS11-012 - 중요'
ms:assetid: 'ms11-012'
ms:contentKeyID: 61230379
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-012(v=Security.10)'
---

Microsoft 보안 공지 MS11-012 - 중요
===================================
...
보안 업데이트는 Windows 커널 모드 드라이버가 사용자 모드에서 전달된 입력의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=56f4f43e-c313-49dc-a278-e3e8a83a907e&displaylang=ko)                                                                               | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80db313-b470-4d71-bc34-70bfbfb6579f)                                                                     | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fe2669-8a63-4d96-8b82-5b10f45b293e&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4632e1ce-6ae8-431c-9104-9a8840e5ac63&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643)                                                                 | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9&displaylang=ko)                                               | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882&displaylang=ko)                       | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1&displaylang=ko)\*           | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569&displaylang=ko)\*       | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93)                | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2&displaylang=ko)                                 | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16&displaylang=ko)                             | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d)          | 권한 상승      | 중요        | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
...
**이 공지가 2011년 3월 19일에 개정된 이유는 무엇입니까?**  
...
<th style="border:1px solid black;" >Win32k 부적절한 사용자 입력 유효성 검사 취약점(CVE-2011-0086)</th>
<th style="border:1px solid black;" >Win32k 불충분한 사용자 입력 유효성 검사 취약점(CVE-2011-0087)</th>
<th style="border:1px solid black;" >Win32k 창 클래스 포인터 혼란 취약점(CVE-2011-0088)</th>
<th style="border:1px solid black;" >Win32k 창 클래스 부적절한 포인터 유효성 검사 취약점(CVE-2011-0089)</th>
<th style="border:1px solid black;" >Win32k 메모리 손상 취약점(CVE-2011-0090)</th>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0086 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086)을 참조하십시오.
  
#### Win32k 부적절한 사용자 입력 유효성 검사 취약점(CVE-2011-0086)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 부적절한 사용자 입력 유효성 검사 취약점(CVE-2011-0086)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 부적절한 사용자 입력 유효성 검사 취약점(CVE-2011-0086)에 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0087 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087)을 참조하십시오.
  
#### Win32k 불충분한 사용자 입력 유효성 검사 취약점(CVE-2011-0087)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 불충분한 사용자 입력 유효성 검사 취약점(CVE-2011-0087)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 불충분한 사용자 입력 유효성 검사 취약점(CVE-2011-0087)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0088 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088)을 참조하십시오.
  
#### Win32k 창 클래스 포인터 혼란 취약점(CVE-2011-0088)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 창 클래스 포인터 혼란 취약점(CVE-2011-0088)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 창 클래스 포인터 혼란 취약점(CVE-2011-0088)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0089 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089)를 참조하십시오.
  
#### Win32k 창 클래스 부적절한 포인터 유효성 검사 취약점(CVE-2011-0089)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 창 클래스 부적절한 포인터 유효성 검사 취약점(CVE-2011-0089)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 창 클래스 부적절한 포인터 유효성 검사 취약점(CVE-2011-0089)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0090 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090)을 참조하십시오.
  
#### Win32k 메모리 손상 취약점(CVE-2011-0090)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 메모리 손상 취약점(CVE-2011-0090)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 메모리 손상 취약점(CVE-2011-0090)에 대한 FAQ
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2479628$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2479628">Microsoft 기술 자료 문서 2479628</a> 참조</td>
</tr>
<tr class="even">
...
-   Win32k 부적절한 사용자 입력 유효성 검사 취약점(CVE-2011-0086)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Win32k 불충분한 사용자 입력 유효성 검사 취약점(CVE-2011-0087)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Win32k 창 클래스 포인터 혼란 취약점(CVE-2011-0088)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Win32k 창 클래스 부적절한 포인터 유효성 검사 취약점(CVE-2011-0089)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt  
-   Win32k 메모리 손상 취약점(CVE-2011-0090)을 보고해 주신 [Norman (영문)](http://www.norman.com)의 Tarjei Mandt
...
-   V2.0(2011년 3월 19일): 영향을 받는 소프트웨어에 Windows 7(32비트 시스템용) 서비스 팩 1, Windows 7(x64 기반 시스템용) 서비스 팩 1, Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1이 포함된다는 설명이 추가되었습니다. **이 보안 업데이트와 관련된 자주 제기되는 질문 사항** 섹션에서 이 개정 사항에 대해 설명하는 항목을 참조하십시오.
