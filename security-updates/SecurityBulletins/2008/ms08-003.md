...
**알려진 문제점.**  이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 946538](https://support.microsoft.com/kb/946538)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9df0875d-0466-4974-b4c0-1ecc777173b1&amp;displaylang=ko">Active Directory</a><br />
(KB943484)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bff7dcb9-5d00-442e-b03c-ce923d213faa&amp;displaylang=ko">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">서비스 거부</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=63d3d784-f057-4686-b85e-ab5fbab5a722&amp;displaylang=ko">Active Directory</a><br />
(KB943484)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-039">MS07-039</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=60781cf3-7c6d-4795-a9d0-bc18ee356e94&amp;displaylang=ko">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=835d647a-dce6-476e-b7c4-928a67b0acfb&amp;displaylang=ko">Active Directory</a><br />
(KB943484)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-039">MS07-039</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5e97698d-8150-44f9-9d34-87a0db6ba5a7&amp;displaylang=ko">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">서비스 거부</td>
<td style="border:1px solid black;">보통</td>
<td style="border:1px solid black;">없음</td>
...
Microsoft는 Microsoft Exchange Server의 Exchange Management 콘솔에서 매우 큰 사서함 목록을 표시하려고 할 때 실패하는 LDAP 쿼리를 확인했습니다. 이 문제점에 대한 자세한 내용은 [Microsoft 기술 자료 문서 946538](https://support.microsoft.com/kb/946538)의 알려진 문제점 섹션을 참조하십시오.
...
<th style="border:1px solid black;" >Active Directory 취약점 - CVE-2008-0088</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0088 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0088)을 참조하십시오.
...
[ADAM (영문)](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true)은 시스템 서비스가 아닌 사용자 서비스로 실행되는 LDAP(Lightweight Directory Access Protocol) 디렉터리 서비스입니다.
...
-   Active Directory 취약점(CVE-2008-0088)을 보고해 주신 [SkyRecon (영문)](https://www.skyrecon.com/)의 Thomas Garnier
...
-   V1.1 (2008년 2월 14일): ADAM이 설치된, 지원 대상인 모든 x64 기반 에디션의 Windows XP Professional에 대한 레지스트리 키 확인 섹션에서 수정된 KB 번호를 반영하여 공지가 업데이트되었습니다.
-   V1.2 (2008년 3월 27일): 알려진 문제점 섹션에 KB 링크가 추가되어 공지가 업데이트되었습니다.
-   
