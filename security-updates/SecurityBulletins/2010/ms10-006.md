...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=80b49bab-6c2f-48a8-a901-ca3f76e4fe6b&displaylang=ko)                                 | 원격 코드 실행 | 긴급        | [MS06-030](https://technet.microsoft.com/security/bulletin/ms06-030) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=f6c4472e-385c-4412-bda9-c2e615e50713&displaylang=ko)                   | 원격 코드 실행 | 긴급        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=63e15ff0-73b3-46c9-96f8-c18977d35a10)                                   | 원격 코드 실행 | 긴급        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=feb8c145-7c30-45fa-a6f0-8b6453ddd521&displaylang=ko)                                    | 원격 코드 실행 | 긴급        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=36d88c1b-814c-4371-9ed2-d4576f419fc3&displaylang=ko)                        | 원격 코드 실행 | 긴급        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=622442b0-cffe-4fc2-94a8-edff9d71ecd3)                                    | 원격 코드 실행 | 긴급        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e&displaylang=ko)                         | 권한 상승      | 중요        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e&displaylang=ko)                                          | 권한 상승      | 중요        | 없음                                                                |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da&displaylang=ko) | 권한 상승      | 중요        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da&displaylang=ko)                              | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7&displaylang=ko)\*                             | 권한 상승      | 중요        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7&displaylang=ko)\*                 | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6&displaylang=ko)\*                           | 권한 상승      | 중요        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6&displaylang=ko)\*               | 권한 상승      | 중요        | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)                                        | 권한 상승      | 중요        | [MS08-068](https://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)                            | 권한 상승      | 중요        | 없음                                                                |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a589431a-93dc-42cd-a74e-d9c1e3452fef&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3c1edcf8-d304-45c4-9818-1cd86383b3fe&displaylang=ko)                                       | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ecb06350-47a7-48eb-825f-3e8f89c5ca8e&displaylang=ko)\*                        | 원격 코드 실행 | 긴급        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=badd6cab-7738-4401-a68c-c15414388601)                                     | 원격 코드 실행 | 긴급        | 없음                                                                |
...
아니요. Microsoft 보안 공지 [MS10-012](https://technet.microsoft.com/security/bulletin/ms10-012), "SMB 서버의 취약점으로 인한 원격 코드 실행 문제점"은 다른 SMB 구성 요소를 해결합니다. 이 보안 업데이트는 다른 업데이트와 별도로 적용할 수 있습니다.

**MS10-012 업데이트를 설치한 경우에도 여전히 이 업데이트를 설치해야 합니까? **
예. 이 보안 공지 업데이트는 Windows SMB 클라이언트 구성 요소의 취약점을 해결하고, [MS10-012](https://technet.microsoft.com/security/bulletin/ms10-012)는 Windows SMB 서버 구성 요소의 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0016 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0016)을 참조하십시오.
...
Microsoft SMB(Server Message Block) 프로토콜은 Microsoft Windows에 사용되는 Microsoft 네트워크 파일 공유 프로토콜입니다. SMB에 대한 자세한 내용은 [Microsoft SMB 프로토콜 및 CIFS 프로토콜 개요 (영문)](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0017 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0017)을 참조하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 978251](https://support.microsoft.com/kb/978251) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/978251">Microsoft 기술 자료 문서 978251</a> 참조</td>
</tr>
<tr class="even">
...
-   SMB 클라이언트 풀 손상 취약점(CVE-2010-0016) 및 SMB 클라이언트 경쟁 조건 취약점(CVE-2010-0017)을 보고해 주신 [stratsec (영문)](https://www.stratsec.net/)의 Laurent Gaffié
