---
TOCTitle: 'MS12-059'
Title: 'Microsoft 보안 공지 MS12-059 - 중요'
ms:assetid: 'ms12-059'
ms:contentKeyID: 61230526
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-059(v=Security.10)'
---

Microsoft 보안 공지 MS12-059 - 중요
===================================
...
이 보안 업데이트의 심각도는 Microsoft Visio 2010 및 Microsoft Visio Viewer 2010의 지원되는 모든 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft Office Visio가 특수하게 조작된 Visio 파일을 구문 분석할 때 데이터를 확인하는 방법을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=de95d8b9-51a5-43cd-8ba3-8cbb1320d099">Microsoft Visio 2010 서비스 팩 1(32비트 에디션)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a>의 KB2553374는 KB2597171 또는 KB2687508로 대체되었습니다.[2]</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=af690cd8-cb2c-4743-96f0-ffaec77adf10">Microsoft Visio 2010 서비스 팩 1(64비트 에디션)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a>의 KB2553374는 KB2597171 또는 KB2687508로 대체되었습니다.[2]</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=62e87f7b-f48e-43a7-86d7-cbb8f0603ea3">Microsoft Visio Viewer 2010 서비스 팩 1(32비트 에디션)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a>의 KB2597981은 KB2598287로 대체되었습니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3889e1b3-69b2-4a8f-a0d9-de8c7dc6f5ec">Microsoft Visio Viewer 2010 서비스 팩 1(64비트 에디션)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a>의 KB2597981은 KB2598287로 대체되었습니다.</td>
...
<sup>[1]</sup>다시 릴리스된 업데이트(KB2687508)가 영향을 받는 모든 Microsoft Visio 2010 에디션의 기존 업데이트(KB2597171)를 대체하지만 KB2597171 업데이트를 성공적으로 설치한 고객은 KB2687508 업데이트를 설치할 필요가 없습니다. 자세한 내용은 Update FAQ를 참조하십시오.
  
<sup>[2]</sup>MS11-089 공지에 Microsoft Visio 2010이 영향을 받지 않는 소프트웨어로 나열되어 있지만 Microsoft Office 업데이트(MS11-089)는 이 소프트웨어를 실행하는 시스템에 적용되었습니다.
...
Microsoft는 적절한 타임스탬프 특성 없이 Microsoft에서 생성한 특정 디지털 인증서와 관련된 문제를 해결하도록 영향을 받는 모든 Microsoft Visio 2010 에디션에 대한 KB2597171 업데이트를 KB2687508 업데이트로 대체하기 위해 이 공지를 다시 릴리스했습니다. 자세한 내용은 [Microsoft 보안 권고(2749655)](https://technet.microsoft.com/security/advisory/2749655)를 참조하십시오.
  
다시 릴리스된 업데이트(KB2687508)가 기존 업데이트(KB2687323)를 대체하지만 기존 업데이트를 성공적으로 설치한 고객은 다시 릴리스된 업데이트를 설치할 필요가 없습니다.
  
기존 KB2597171업데이트를 이미 성공적으로 설치했습니다. 2012년 12월 11일에 다시 릴리스된 업데이트 패키지(KB2687508)를 설치해야 합니까?  
아니요. 다시 릴리스된 업데이트(KB2687508)는 해당되는 기존 업데이트(KB2597171)가 이미 설치되지 않은 경우에 영향을 받는 소프트웨어를 실행하는 시스템에만 적용됩니다. 기존 업데이트를 이미 성공적으로 설치한 고객은 조치를 취할 필요가 없으며 이러한 고객에게는 다시 릴리스된 업데이트가 제공되지 않습니다.
  
참고 기존 업데이트가 이미 설치되어 있으며 다시 릴리스된 업데이트를 같은 시스템에 설치하는 경우, 설치 관리자에서 이미 업데이트가 설치되어 있다는 메시지가 표시됩니다. 메시지가 생성된 후에는 설치된 업데이트 목록에서 다시 릴리스된 업데이트의 KB 번호가 기존 업데이트의 KB 번호를 대체합니다. 자세한 내용은 [Microsoft 기술 자료 문서 2720573](https://support.microsoft.com/kb/2720573)을 참조하십시오.
  
파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.
  
보안 업데이트의 해시는 어디에 있습니까?  
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2733918](https://support.microsoft.com/kb/2733918)을 참조하십시오.
...
<th style="border:1px solid black;" >Visio DXF 파일 형식 버퍼 오버플로 취약점(CVE-2012-1888)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점 악용에 성공한 공격자는 현재 사용자 권한으로 임의 코드를 실행할 수 있습니다. 현재 사용자가 관리자 권한의 사용자 권한으로 로그온한 경우 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1888](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1888)(영문)을 참조하십시오.
  
#### Visio DXF 파일 형식 버퍼 오버플로 취약점(CVE-2012-1888)에 대한 완화 요소
...
#### Visio DXF 파일 형식 버퍼 오버플로 취약점(CVE-2012-1888)에 대한 대안
...
#### Visio DXF 파일 형식 버퍼 오버플로 취약점(CVE-2012-1888)에 대한 FAQ
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Microsoft Office Visio에서 특수하게 조작된 Visio 파일을 구문 분석할 때 데이터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
| Microsoft Visio Viewer 2010 서비스 팩 1(32비트 에디션) | 예   |  
| Microsoft Visio Viewer 2010 서비스 팩 1(64비트 에디션) | 예   |
...
| Microsoft Visio Viewer 2010 서비스 팩 1(32비트 에디션) | 예                  | 예                                  |  
| Microsoft Visio Viewer 2010 서비스 팩 1(64비트 에디션) | 예                  | 예                                  |
...
#### Microsoft Visio 2010 및 Microsoft Visio Viewer 2010(모든 에디션)
...
<td style="border:1px solid black;">Microsoft Visio 2010의 경우 <a href="https://support.microsoft.com/kb/2597171">Microsoft 기술 자료 문서 2597171</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Visio Viewer 2010의 경우 <a href="https://support.microsoft.com/kb/2598287">Microsoft 기술 자료 문서 2598287</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
...
-   [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)(영문)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)(영문)와 협력하여 Visio DXF 파일 형식 버퍼 오버플로 취약점(CVE-2012-1888)을 보고해 주신 Alexander Gavrun
...
-   V2.0(2012년 12월 12일): 영향을 받는 모든 Microsoft Visio 2010 에디션용 KB2597171 업데이트를 KB2687508 업데이트로 대체하기 위해 공지를 다시 릴리스했습니다.
