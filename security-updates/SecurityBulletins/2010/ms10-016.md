...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6301e462-02be-4b9a-bae9-7c4821b42d2d&amp;displaylang=ko">Movie Maker 2.1</a>[1]</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ae2e9b75-1616-4fe3-91bb-e2e28252ff1c&amp;displaylang=ko">Movie Maker 6.0</a>[1]<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=ca2d1118-ca64-419d-86af-9396e61b90b0&amp;displaylang=ko">Movie Maker 2.6</a>[2]</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e27f353e-deb6-4d61-8808-c751d20a42a1&amp;displaylang=ko">Movie Maker 6.0</a>[1]<br />
<br />
...
|-------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|  
| [Microsoft Producer 2003](https://www.microsoft.com/download/details.aspx?familyid=1b3c76d5-fc75-4f99-94bc-784919468e73)<sup>[3]</sup> | 원격 코드 실행 | 중요        | 없음                      |
...
Microsoft는 Microsoft 다운로드 센터에서 [Microsoft Producer](https://www.microsoft.com/download/details.aspx?familyid=1b3c76d5-fc75-4f99-94bc-784919468e73)를 사용할 수 있음을 알리기 위해 이 보안 공지를 개정했습니다. Microsoft Producer 2003 사용자는 이 공지에서 설명한 취약점을 해결하기 위해 Microsoft Producer로 업그레이드하는 것이 좋습니다.
  
**Microsoft Producer 2003용 업데이트는 어디에 있습니까?**    
Microsoft Producer 2003을 사용하는 모든 사용자는 이 공지에서 설명한 취약점을 해결하기 위해 최신 버전의 [Microsoft Producer](https://www.microsoft.com/download/details.aspx?familyid=1b3c76d5-fc75-4f99-94bc-784919468e73)로 업그레이드하는 것이 좋습니다. 업그레이드할 수 없는 고객은 [Microsoft 기술 자료 문서 975561](https://support.microsoft.com/kb/975561)에 제공되는 자동화 솔루션으로 Microsoft Producer 파일 연결을 제거하고 이 공지에 포함된 대안을 적용하여 Microsoft Producer 2003 시스템에 미치는 영향을 완화할 수 있습니다. Microsoft Producer는 영어로만 제공됩니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0265 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0265)를 참조하십시오.
...
-   **Microsoft Producer 2003 .MSProducer, .MSProducerZ 및 .MSProducerBF 파일 연결 제거**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 975561](https://support.microsoft.com/kb/975561)을 참조하여 **Microsoft Fix it** 자동화 솔루션을 사용하십시오.
...
SMS 2.0 및 SMS 2003의 경우 SUIT(Security Update Inventory Tool)를 SMS와 함께 사용하여 보안 업데이트를 검색할 수 있습니다. [Systems Management Server 2.0용 다운로드](https://technet.microsoft.com/en-us/sms/bb676799.aspx)도 참조하십시오.
  
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](https://update.microsoft.com/microsoftupdate)에서 제공하고 [Windows Server Update Services](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool](https://technet.microsoft.com/en-us/sms/bb676783.aspx)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools](https://technet.microsoft.com/en-us/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드](https://technet.microsoft.com/en-us/sms/bb676766.aspx)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975561">Microsoft 기술 자료 문서 975561</a> 참조</td>
</tr>
<tr class="even">
...
-   Movie Maker 및 Producer 버퍼 오버플로 취약점(CVE-2010-0265)을 보고해 주신 [Core Security Technologies (영문)](https://www.coresecurity.com/)의 Damián Frizza
