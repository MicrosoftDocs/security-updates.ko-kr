...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|-----------------------------------------------------------|
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=156c1bd9-55bc-482c-874b-61998d1ef153&displaylang=ko)                                     | 서비스 거부    | 보통        | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=5c7db930-5495-43f0-928c-d586ac9e80d0&displaylang=ko)                                 | 서비스 거부    | 보통        | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=5d810dae-5c52-4155-b5c2-163d27be6e78&displaylang=ko)\*\*\* | 서비스 거부    | 보통        | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=395819e2-1028-44b7-ace4-ca754b1a7543)              | 서비스 거부    | 보통        | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2004(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2004)를 참조하십시오.
...
-   방화벽에서 TCP 포트 139 및 445 차단
    ...
    대안 실행 취소 방법. 방화벽에서 TCP 포트 139 및 445를 차단 해제합니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당(영문)](http://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2617657">Microsoft 기술 자료 문서 2617657</a> 참조</td>
</tr>
<tr class="odd">
...
-   TrueType 글꼴 구문 분석 취약점(CVE-2011-2004)을 보고해 주신 [CERT/CC(영문)](http://www.cert.org/)의 Will Dorman
