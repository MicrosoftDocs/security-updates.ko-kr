...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7951fd7b-6b0a-4168-8519-312a62ff3289&amp;displaylang=ko">Microsoft Data Access Components 2.8 서비스 팩 1</a><br />
(KB2419632)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ce06bfdc-7b0d-4e65-9a13-e009e3a6a9f0">Microsoft Data Access Components 2.8 서비스 팩 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d451ced7-c9c7-4c41-9d44-8f8929fca390&amp;displaylang=ko">Microsoft Data Access Components 2.8 서비스 팩 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3f2c8cfa-819e-4fd9-93ba-b687eb2d46fe&amp;displaylang=ko">Microsoft Data Access Components 2.8 서비스 팩 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8dbcbb91-464b-4eb3-b7e5-afe82febf8d7">Microsoft Data Access Components 2.8 서비스 팩 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=13445e4a-099a-4edd-864e-c44f42940500&amp;displaylang=ko">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd6b806e-50d4-4f4d-96e1-7c71fca4c543&amp;displaylang=ko">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3d0885ac-97b3-46b5-970d-cc810270fba3&amp;displaylang=ko">Windows Data Access Components 6.0</a>\*<br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f33c57e-343c-4cdb-b667-af18a8779ad2&amp;displaylang=ko">Windows Data Access Components 6.0</a>\*<br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3dfd4f1c-e7a5-4686-8d2c-b7a5a53c5333&amp;displaylang=ko">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cf30e5c0-811b-4ecd-a6b2-874000d25074&amp;displaylang=ko">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;">없음</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cc9bac5a-3eaa-46fb-9ef4-c511b5f57996&amp;displaylang=ko">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;">없음</td>
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [1월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-jan)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0026 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026)을 참조하십시오.
  
#### DSN 오버플로 취약점(CVE-2011-0026)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   기본 Windows 구성에서는 이 취약점을 악용할 수 없습니다. 취약점이 발생하기 위해서는 특정 ODBC([Open Database Connectivity](https://support.microsoft.com/kb/110093)) API를 취약한 방식으로 사용하는 타사 응용 프로그램이 시스템에 설치되어 있어야 합니다.
...
이 취약점을 노출시키는 Microsoft 응용 프로그램은 없습니다. 그러나 타사 프로그램의 경우 신뢰할 수 없는 출처의 ODBC([Open Database Connectivity](https://support.microsoft.com/kb/110093)) API로의 액세스를 허용하여 이 취약점을 원격으로 노출시킬 수 있습니다. 이런 경우 이 취약점을 악용하면 익명 사용자가 모든 관리 권한으로 코드를 실행할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**  
타사 응용 프로그램에서 사용될 수 있는 ODBC([Open Database Connectivity](https://support.microsoft.com/kb/110093)) API의 DSN(Data Source Name) 인수에 버퍼 오버플로가 존재합니다.
  
**Microsoft Data Access Components란 무엇입니까?**  
MDAC([Microsoft Data Access Components (영문)](https://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx))는 프로그램이 데이터베이스에 액세스한 후 데이터베이스에 있는 데이터를 조작할 수 있도록 지원하는 구성 요소의 모음입니다. 오늘날의 데이터베이스는 다양한 형태(예: SQL Server 데이터베이스, Microsoft Access 데이터베이스, XML 파일 등)로 다양한 위치(예: 로컬 시스템이나 원격 데이터베이스 서버)에 존재할 수 있습니다. MDAC는 다양한 데이터 원본을 대상으로 일관된 방식으로 작업할 수 있도록 통합된 함수 집합을 제공합니다. Windows Vista부터는 MDAC를 WDAC(Windows Data Access Components)라고 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0027 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성 (영문)](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 섹션을 참조하십시오.
...
예. 기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성 (영문)](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다.
...
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 Microsoft Data Access Components 2.8 서비스 팩 1:<br />
<a href="https://support.microsoft.com/kb/2419632">Microsoft 기술 자료 문서 2419632</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft Data Access Components 2.8 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/2419635">Microsoft 기술 자료 문서 2419635</a> 참조</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2419635">Microsoft 기술 자료 문서 2419635</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2419640">Microsoft 기술 자료 문서 2419640</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
-   DSN 오버플로 취약점(CVE-2011-0026)을 [TippingPoint (영문)](https://www.tippingpoint.com/)*의* [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Abdul Aziz Hariri  
-   ADO 레코드 메모리 취약점(CVE-2011-0027)을 [TippingPoint (영문)](https://www.tippingpoint.com/)*의* [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Peter Vreugdenhil
