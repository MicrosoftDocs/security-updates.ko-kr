---
TOCTitle: 'MS12-078'
Title: 'Microsoft 보안 공지 MS12-078 - 긴급'
ms:assetid: 'ms12-078'
ms:contentKeyID: 61230545
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-078(v=Security.10)'
---

Microsoft 보안 공지 MS12-078 - 긴급
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 릴리스에 대해 긴급입니다(단 Server Core 설치의 심각도는 중요입니다). 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널 모드 드라이버가 메모리에서 개체를 처리하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**알려진 문제점**. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2783534](https://support.microsoft.com/kb/2783534)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS11-032](https://go.microsoft.com/fwlink/?linkid=212224)의 KB2507618은 KB2753842로 대체되었습니다.  
[MS12-075](https://go.microsoft.com/fwlink/?linkid=270856)의 KB2761226은 KB2779030으로 대체되었습니다.
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=fedee43c-0065-42bf-9714-171b5b74f099)(Server Core 설치)  
(KB2753842)  
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=3dfa40ef-86a2-44a0-b523-f4a85c7ac82c)(Server Core 설치)  
(KB2779030)
</td>
<td style="border:1px solid black;">
권한 상승
...
**이 보안 공지가 2012년 12월 20일에 다시 릴리스된 이유는 무엇입니까?**  
Microsoft는 기존 업데이트 적용 후에 OTF(OpenType 글꼴)가 응용 프로그램에서 적절히 렌더링되지 않는 문제와 관련한 KB2753842 업데이트의 알려진 문제를 해결하기 위해 이 공지를 다시 릴리스했습니다. 기존 KB2753842 업데이트를 성공적으로 설치한 고객은 CVE-2012-2556에서 설명된 취약점의 보호를 받습니다. 하지만 고객은 다시 릴리스된 KB2753842 업데이트를 설치하여 올바르지 않은 OpenType 글꼴 렌더링 문제를 해결하고 영향을 받는 바이너리를 최신 상태로 유지하는 것이 좋습니다.

**참고** Windows 8 Release Preview 및 Windows Server 2012 출시 후보 버전에 대한 패키지는 다시 릴리스되지 않습니다. Windows 8 Release Preview 및 Windows Server 2012 출시 후보 버전에 대한 지원은 종료되었습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항의 위치에 대해서는 **보안 업데이트 배포** 섹션에서 참조 표를 참조하십시오.

**보안 업데이트의 해시는** **어디에 있습니까?**    
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2783534](https://support.microsoft.com/kb/2783534)를 참조하십시오.

**Windows 8 Release Preview 또는 Windows Server 2012 출시 후보 버전은 이 권고에서 해결된 취약점의 영향을 받습니까?**  
예. KB2753842 및 KB2779030 업데이트는 Windows 8 Release Preview 및 Windows Server 2012 Release Candidate에 사용할 수 있습니다. Windows 8 Release Preview와 Windows Server 2012 출시 후보 버전을 보유한 고객은 시스템에 이 업데이트를 적용하는 것이 좋습니다. 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 제공됩니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [12월 공지 요약](https://technet.microsoft.com/security/bulletin/ms12-dec)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
영향을 받는 구성 요소가 특수하게 조작된 OpenType 글꼴 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이러한 취약점으로 인해 사용자가 특수하게 조작된 OpenType 글꼴 파일을 열 경우 원격 코드 실행이 허용될 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)을 참조하십시오.

#### OpenType 글꼴 구문 분석 취약점(CVE-2012-2556)에 대한 완화 요소
...
#### OpenType 글꼴 구문 분석 취약점(CVE-2012-2556)에 대한 대안
...
-   **WebClient** **서비스** **사용 안 함**
    ...
    2.  **WebClient서비스**를 마우스 오른쪽 단추로 클릭한 다음 **속성**을 선택합니다.
    3.  **시작유형**을 **사용 안 함**으로 변경합니다. 서비스가 실행 중인 경우 **중지**를 클릭합니다.
    ...
    **대안 실행 취소 방법**.
    ...
    1.  **시작**, **실행**을 클릭하고 **Services.msc**를 입력한 다음 **확인**을 클릭합니다.
    2.  **WebClient서비스**를 마우스 오른쪽 단추로 클릭한 다음 **속성**을 선택합니다.
    3.  **시작유형**을 **자동**으로 변경합니다. 서비스가 실행 중인 경우 **시작**을 클릭합니다.
    4.  **확인**을 클릭하고 관리 응용 프로그램을 종료합니다.
...
-   **Windows 탐색기에서 미리 보기 창 및 세부 정보 창 사용 안 함**
    ...
    3.  Windows 탐색기를 열고 **구성**을 클릭한 후 **폴더및검색옵션**을 클릭합니다.
    4.  **보기** 탭을 클릭합니다.
    5.  **고급설정**에서 아이콘은 **항상표시**하고 **미리 보기**는 **표시하지 않음** 확인란을 선택합니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4786](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4786)을 참조하십시오.

#### TrueType 글꼴 구문 분석 취약점(CVE-2012-4786)에 대한 완화 요소
...
#### TrueType 글꼴 구문 분석 취약점(CVE-2012-4786)에 대한 대안
...
#### TrueType 글꼴 구문 분석 취약점(CVE-2012-4786)에 대한 FAQ
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 항목 또는 다음 폴더의 Spuninst.exe 유틸리티를 사용하십시오. %Windir%\$NTUninstallKB2753842-v2$\Spuninst<br />
%Windir%\$NTUninstallKB2779030$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2753842">Microsoft 기술 자료 문서 2753842</a> 및 <a href="https://support.microsoft.com/kb/2779030">Microsoft 기술 자료 문서 2779030</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
제어판의 **프로그램 추가/제거** 항목 또는 다음 폴더의 Spuninst.exe 유틸리티를 사용하십시오. %Windir%\\$NTUninstallKB2753842-v2$\\Spuninst  
...
<td style="border:1px solid black;" colspan="2">
[Microsoft 기술 자료 문서 2753842](https://support.microsoft.com/kb/2753842) 및 [Microsoft 기술 자료 문서 2779030](https://support.microsoft.com/kb/2779030) 참조
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">WUSA에서 설치한 업데이트를 설치 제거하려면 /Uninstall 설치 스위치를 사용하거나 <strong>제어판</strong>, <strong>시스템 및 보안</strong>, <strong>Windows Update</strong>를 차례로 클릭한 후 <strong><strong>설치된 업데이트</strong></strong>를 클릭하고 업데이트 목록에서 선택합니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2753842">Microsoft 기술 자료 문서 2753842</a> 및 <a href="https://support.microsoft.com/kb/2779030">Microsoft 기술 자료 문서 2779030</a> 참조</td>
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2753842](https://support.microsoft.com/kb/2753842) 및 [Microsoft 기술 자료 문서 2779030](https://support.microsoft.com/kb/2779030) 참조 |
...
-   Windows 글꼴 구문 분석 취약점(CVE-2012-2556)을 Chromium Security Rewards Program과 협력하여 보고해 주신 [Documill](https://www.documill.com)의 Eetu Luodemaa와 Joni Vähämäki
...
-   V1.0(2012년 12월 11일): 공지가 게시되었습니다.  
-   V1.1(2012년 12월 14일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2783534 링크가 추가되었습니다.  
-   V2.0(2012년 12월 20일): 기존의 업데이트가 설치된 이후 OpenType 글꼴이 올바르게 렌더링되지 않는 문제를 해결하기 위해 KB2753842 업데이트가 다시 릴리스되었습니다. 기존의 KB2753842 업데이트를 성공적으로 설치한 고객은 다시 릴리스된 업데이트를 설치할 필요가 없습니다.
