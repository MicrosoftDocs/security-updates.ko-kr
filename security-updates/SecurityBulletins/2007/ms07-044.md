---
TOCTitle: 'MS07-044'
Title: 'Microsoft 보안 공지 MS07-044 - 긴급'
ms:assetid: 'ms07-044'
ms:contentKeyID: 61230083
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms07-044(v=Security.10)'
---


Microsoft 보안 공지 MS07-044 - 긴급
===================================

Microsoft Excel의 취약점으로 인한 원격 코드 실행 문제점 (940965)
----------------------------------------------------------------
...
지원되는 Microsoft Office 2000 에디션에 대한 긴급 보안 업데이트입니다. 지원되는 Microsoft Office XP, Microsoft Office 2003, Microsoft Office 2004 for Mac 에디션의 경우 이 업데이트의 심각도는 중요입니다. 이 업데이트의 Excel Viewer 2003에 대한 심각도도 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=082b98f7-9556-4f1f-823a-c41ddf5a7c9a&amp;displaylang=ko">Microsoft Office 2000 서비스 팩 3</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=91308769-2577-4f9f-8209-06f2c8c8a86f&amp;displaylang=ko">Microsoft Office XP 서비스 팩 3</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b0130e9e-8845-4d79-aaa1-a21cc9388abe&amp;displaylang=ko">Microsoft Office 2003 서비스 팩 2</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=c4a87572-3128-44f7-8069-95535a78500a&amp;displaylang=ko">Microsoft Excel Viewer 2003</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-036">MS07-036</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/mac/downloads.aspx">Mac용 Microsoft Office 2004</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-036">MS07-036</a></td>
</tr>
...
<th style="border:1px solid black;" >작업공간 메모리 손상 취약점 - CVE-2007-3890</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3890 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3890)을 참조하십시오.
  
#### 작업공간 메모리 손상 취약점 - CVE-2007-3890에 대한 완화 요소
...
#### 작업공간 메모리 손상 취약점 - CVE-2007-3890에 대한 대안
...
#### 작업공간 메모리 손상 취약점 - CVE-2007-3890에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
작업공간의 색인 값을 표시할 때 Excel에서 유효성 검사를 충분히 수행하지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 작업공간에 연결되어 있는 색인 값 특성에 대한 Microsoft Excel의 유효성 검사 방식을 수정하여 취약점을 해결합니다.
...
-   지원되는 Microsoft Office 2000 버전은 How to Create an Administrative Installation Point(관리 설치 지점을 만드는 방법)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office 2000 원래 기준선 또는 서비스 팩 3(SP3)으로 클라이언트 시스템에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 932889](https://support.microsoft.com/kb/932889)를 참조하십시오.
...
<td style="border:1px solid black;">office2000-kb940596-fullfile-kor.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2000-kb940596-fullfile-kor.exe /r:n</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">officexp-kb940601-fullfile-kor.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">officexp-kb940601-fullfile-kor.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">office2003-KB940602-FullFile-kor.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">office2003-KB940602-FullFile-kor.exe /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   [Mac용 Microsoft Office 2004 11.3.5 업데이트 (영문)](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1135.xml&secid=4&ssid=33&flgnosysreq=true)가 컴퓨터에 설치되어 있어야 합니다.  
...
Mac용 Microsoft Office 2004 11.3.6 업데이트의 적절한 언어 버전을 [Microsoft Mactopia 웹 사이트 (영문)](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1136.xml&secid=4&ssid=35&flgnosysreq=true)에서 다운로드하여 설치하십시오.
...
-   작업공간 메모리 손상 취약점(CVE-2007-3890)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten Eiram
