...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=2998105d-6796-4e60-8c9c-e8241385f2a9&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=08ab17b9-149c-44d4-96cf-87a8c6b9dc22&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=433fd0f9-938f-432d-99d4-f41b92235dcf)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=abad4cc1-4ea6-4051-bc5a-79deb4dbe72b&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=849eedef-332b-4792-b84e-3750d407a86f)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=31e448f7-298d-417c-a857-1646689e0817)
...
|--------------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| 서버 서비스 서비스 거부 취약점 - [CVE-2006-3942 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3942) | 서비스 거부          | 중요         | 중요                   | 중요                   | 중요                | 중요                            |
| SMB 이름 바꾸기 취약점 - [CVE-2006-4696 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4696)         | 원격 코드 실행       | 중요         | 중요                   | 중요                   | 중요                | 중요                            |
...
현재 Microsoft Update와 MBSA 2.0으로 검색할 수 없는 프로그램에 대한 자세한 내용은 [Microsoft 기술 자료 문서 895660](http://support.microsoft.com/kb/895660)을 참조하십시오.
...
서버 서비스에서 특정 네트워크 메시지를 처리하는 방식 때문에 서버 서비스에 [서비스 거부](http://www.microsoft.com/korea/security/glossary.mspx) 취약점이 존재합니다. 공격자는 특수하게 조작한 네트워크 메시지를 서버 서비스를 실행하는 컴퓨터로 전송하여 이러한 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 영향을 받는 컴퓨터가 응답을 중지하도록 만듭니다.
...
이것은 [서비스 거부](http://www.microsoft.com/korea/security/glossary.mspx) 취약점입니다. 공격자는 이 취약점을 악용하여 영향을 받는 시스템이 응답을 중지하게 하고, 서버가 자동으로 다시 시작되도록 만듭니다. 이 시간 동안에는 서버가 요청에 응답할 수 없게 됩니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 요청 수신을 중단하도록 만들 수 있습니다.
...
이 보안 업데이트는 핫패칭을 지원합니다. 핫패칭에 대한 자세한 내용과 핫패치로 이 보안 업데이트를 배포하는 방법은 [Microsoft 기술 자료 문서 897341](http://support.microsoft.com/kb/897341)을 참조하십시오.
...
-   서버 서비스 서비스 거부 취약점(CVE-2006-3942)을 보고해 주신 [Core Security Technologies (영문)](http://www.coresecurity.com)의 Gerardo Richarte
-   서버 서비스 서비스 거부 취약점(CVE-2006-3942)을 보고해 주신 [NS Focus (영문)](http://www.nsfocus.com)
-   SMB 이름 바꾸기 취약점(CVE-2006-4696)을 보고해 주신 [Fortinet (영문)](http://www.fortinet.com)
-   SMB 이름 바꾸기 취약점(CVE-2006-4696)을 보고해 주신 [VMWare (영문)](http://www.vmware.com)의 Matthew Amdur
