...
\[4\]2017년 4월 11일부로 Windows Server 2012용 CVE-2017-0042에 적용되는 보안 업데이트가 공개됨을 알리기 위해 수정된 공지입니다. Windows Server 2012를 실행하는 고객은 업데이트 4015548(보안 전용) 또는 4015551(월별 롤업)을 설치해야 이 취약성으로부터 완전히 보호받을 수 있습니다.
