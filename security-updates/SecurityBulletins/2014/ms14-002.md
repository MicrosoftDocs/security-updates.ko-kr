...
[Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=6cae1016-419a-47ab-9765-b4c1d7c0865c&displaylang=ko)  
(2914368)
</td>
<td style="border:1px solid black;">
권한 상승
...
<td style="border:1px solid black;">
[MS10-099](https://go.microsoft.com/fwlink/?linkid=206365)의 2440591
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c1094864-2576-4770-9d2d-3dae33ddecb6)  
(2914368)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6d50f851-4be3-413f-b02d-b5b6a3f49fb4&displaylang=ko)  
(2914368)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=69966ceb-a9c9-4aa7-b685-78562c96640f&displaylang=ko)  
(2914368)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0b1c1309-8b6f-4342-92aa-6cb5cb2abe6a)  
(2914368)
</td>
<td style="border:1px solid black;">
권한 상승
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-5065](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5065)(영문)을 참조하십시오.
...
NDPROXY란 무엇입니까?  
NDPROXY는 WAN 미니포트 드라이버, 호출 관리자 및 미니포트 호출 관리자를 TAPI(Telephony Application Programming Interfaces) 서비스에 연결하는 시스템 제공 드라이버입니다. 추가 정보는 [NDPROXY 개요](https://msdn.microsoft.com/library/ff568322(vs.85).aspx)(영문)를 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2013-5065](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5065)(영문)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2914486](https://technet.microsoft.com/security/advisory/2914486)에서 처음 설명되었습니다.
