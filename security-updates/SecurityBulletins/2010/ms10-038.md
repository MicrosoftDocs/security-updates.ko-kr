---
TOCTitle: 'MS10-038'
Title: 'Microsoft 보안 공지 MS10-038 - 중요'
ms:assetid: 'ms10-038'
ms:contentKeyID: 61230299
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-038(v=Security.10)'
---



Microsoft 보안 공지 MS10-038 - 중요
===================================

Microsoft Office Excel의 취약점으로 인한 원격 코드 실행 문제점(2027452)
-----------------------------------------------------------------------

게시된 날짜: 2010년 6월 9일 수요일 | 업데이트된 날짜: 2010년 7월 1일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel 2007, Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 및 Open XML File Format Converter for Mac 에디션과 지원 대상인 모든 Microsoft Office Excel Viewer 및 Microsoft Office 호환 기능 팩 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 업데이트는 Microsoft Office Excel에서 특수하게 조작된 Excel 파일을 구문 분석하는 방식을 변경하고 Open XML File Format Converter for Mac의 설치 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

권장 사항. 이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

문제점.[Microsoft 기술 자료 문서 2027452](https://support.microsoft.com/kb/2027452) 는 고객이 보안 업데이트를 할 때 겪을 수 있는 현재까지 알려진 문제점들을 기술하고 있다. 또한 이 문제들을 해결하기 위한 추천 해결책을 기술하고 있다.
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1b2599f0-1e5d-463c-b100-6c6a1b17b2ec&displaylang=ko)<sup>[1]</sup>
(KB982308)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<sup>[1]</sup>Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2를 사용하는 고객은 이 보안 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트 패키지 KB982308과 함께 Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩 및 Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩(KB982331)에 대한 보안 업데이트를 설치해야 합니다.

영향을 받지 않는 소프트웨어

| Office 및 기타 소프트웨어                                                                                                 |
|---------------------------------------------------------------------------------------------------------------------------|
| Microsoft Office Excel 2010(32비트 에디션)                                                                                |
| Microsoft Office Excel 2010(64비트 에디션)                                                                                |
...
MS10-036도 Microsoft Office Excel의 취약점을 설명합니다. MS10-036은 이 공지(MS10-038)와 어떤 관련이 있습니까?  
Microsoft Office Excel 2003(KB982133) 및 Microsoft Office Excel 2007(KB982308)에 대한 [MS10-036](https://technet.microsoft.com/security/bulletin/ms10-036)의 보안 업데이트 패키지도 이 공지(MS10-038)에서 설명한 취약점을 해결합니다. Microsoft Office Excel 2003 또는 Microsoft Office Excel 2007이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다. 또한 [MS10-036](https://technet.microsoft.com/security/bulletin/ms10-036)은 [MS10-036](https://technet.microsoft.com/security/bulletin/ms10-036)에서 설명한 취약점 해결을 위해 설치해야 하는 Microsoft Office 관련 업데이트(KB982311 또는 KB982312)를 제공합니다.
...
예. Microsoft Office Excel 2007 서비스 팩 1 및 Microsoft Office Excel 2007 서비스 팩 2(KB982308)에 대한 업데이트 패키지에는 [Microsoft 기술 자료 문서 981046](https://support.microsoft.com/kb/981046)에 설명되어 있는 Excel 2007에 대한 변경 사항이 포함되어 있습니다.
...
예. 2007 Microsoft Office System 서비스 모델의 일부로 Microsoft Office 2007 서비스 팩 1 사용자가 이 업데이트를 설치하면 시스템이 Microsoft Office 2007 서비스 팩 2를 통해 최초로 출시된 보안 기능으로 업그레이드됩니다. 2009년 4월 24일 이후 출시된 모든 업데이트에는 [2007 Microsoft Office System 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b444bf18-79ea-46c6-8a81-9db49b4ab6e5&displaylang=en)를 통해 소개된 이러한 보안 기능이 포함되어 있습니다. Microsoft에서 이 업데이트를 철저하게 테스트했지만, 모든 업데이트와 마찬가지로 사용자가 자신의 시스템 환경 및 구성에 따라 적절히 테스트하는 것이 좋습니다.
...
<tr>
<td style="border:1px solid black;">
Microsoft Office Excel 2007 서비스 팩 1
</td>
<td style="border:1px solid black;">
중요   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office Excel 2007 서비스 팩 2
</td>
<td style="border:1px solid black;">
중요   
원격 코드 실행
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0821 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0821)을 참조하십시오.

#### Excel 레코드 분석 메모리 손상 취약점(CVE-2010-0821)에 대한 완화 요소
...
#### Excel 레코드 분석 메모리 손상 취약점(CVE-2010-0821)에 대한 대안
...
-   Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 Microsoft [기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는Office 2007 이전 버전의 파일을 열 수 없습니다.
...
#### Excel 레코드 분석 메모리 손상 취약점(CVE-2010-0821)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0822 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822)를 참조하십시오.

#### Excel 개체 스택 오버플로 취약점(CVE-2010-0822)에 대한 완화 요소
...
#### Excel 개체 스택 오버플로 취약점(CVE-2010-0822)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 개체 스택 오버플로 취약점(CVE-2010-0822)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0823 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823)을 참조하십시오.

#### Excel 메모리 손상 취약점(CVE-2010-0823)에 대한 완화 요소
...
#### Excel 메모리 손상 취약점(CVE-2010-0823)에 대한 대안
...
#### Excel 메모리 손상 취약점(CVE-2010-0823)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

취약점의 원인은 무엇입니까?  
특수하게 조작된 Excel 파일을 열 때 Microsoft Office Excel에서 Excel 파일 형식의 조작된 차트 시트 하위 스트림을 구문 분석하는 방식에 취약점이 존재합니다.
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 특수하게 조작된 Excel 파일의 조작된 차트 시트 하위 스트림을 구문 분석할 때 Microsoft Office Excel이 처리하는 방식을 수정하여 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0824 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824)를 참조하십시오.

#### Excel 레코드 메모리 손상 취약점(CVE-2010-0824)에 대한 완화 요소
...
#### Excel 레코드 메모리 손상 취약점(CVE-2010-0824)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 레코드 메모리 손상 취약점(CVE-2010-0824)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1245 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245)를 참조하십시오.

#### Excel 레코드 메모리 손상 취약점(CVE-2010-1245)에 대한 완화 요소
...
#### Excel 레코드 메모리 손상 취약점(CVE-2010-1245)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 레코드 메모리 손상 취약점(CVE-2010-1245)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1246 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246)을 참조하십시오.

#### Excel RTD 메모리 손상 취약점(CVE-2010-1246)에 대한 완화 요소
...
#### Excel RTD 메모리 손상 취약점(CVE-2010-1246)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel RTD 메모리 손상 취약점(CVE-2010-1246)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1247 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247)을 참조하십시오.

#### Excel 메모리 손상 취약점(CVE-2010-1247)에 대한 완화 요소
...
#### Excel 메모리 손상 취약점(CVE-2010-1247)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 메모리 손상 취약점(CVE-2010-1247)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1248 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248)을 참조하십시오.

#### Excel HFPicture 메모리 손상 취약점(CVE-2010-1248)에 대한 완화 요소
...
#### Excel HFPicture 메모리 손상 취약점(CVE-2010-1248)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel HFPicture 메모리 손상 취약점(CVE-2010-1248)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1249 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249)를 참조하십시오.

#### Excel 메모리 손상 취약점(CVE-2010-1249)에 대한 완화 요소
...
#### Excel 메모리 손상 취약점(CVE-2010-1249)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 메모리 손상 취약점(CVE-2010-1249)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1250 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250)을 참조하십시오.

#### Excel EDG 메모리 손상 취약점(CVE-2010-1250)에 대한 완화 요소
...
#### Excel EDG 메모리 손상 취약점(CVE-2010-1250)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel EDG 메모리 손상 취약점(CVE-2010-1250)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1251 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251)을 참조하십시오.

#### Excel 레코드 스택 손상 취약점(CVE-2010-1251)에 대한 완화 요소
...
#### Excel 레코드 스택 손상 취약점(CVE-2010-1251)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 레코드 스택 손상 취약점(CVE-2010-1251)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1252 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252)를 참조하십시오.

#### Excel 문자열 변수 취약점(CVE-2010-1252)에 대한 완화 요소
...
#### Excel 문자열 변수 취약점(CVE-2010-1252)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   신뢰할 수 없는 출처에서 받았거나, 출처는 신뢰할 수 있지만 예상치 못한 Excel 파일은 열어보지 마십시오. 사용자가 특수하게 조작된 파일을 열 경우 이 취약점이 악용될 수 있습니다.

#### Excel 문자열 변수 취약점(CVE-2010-1252)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1253 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253)을 참조하십시오.

#### Excel ADO 개체 취약점(CVE-2010-1253)에 대한 완화 요소
...
#### Excel ADO 개체 취약점(CVE-2010-1253)에 대한 대안
...
#### Excel ADO 개체 취약점(CVE-2010-1253)에 대한 FAQ
...
Open XML File Format Converter for Mac의 자체 설치 방식에 권한 상승 취약점이 존재합니다. 설치 도중 Open XML File Format Converter for Mac은 /Applications 폴더의 보안 설정을 낮추고 폴더 내 파일에 대한 모든 액세스를 허용하는 방식으로 /Applications 폴더의 파일 시스템 ACL을 변경합니다. 이 취약점을 악용하려면 공격자가 먼저 시스템에 로그온해야 합니다. 공격자는 Open XML File Format Converter for Mac을 악의적인 실행 파일로 대체할 수 있습니다. 나중에 관리자가 로그온하여 Open XML File Format Converter for Mac을 실행할 경우 공격자가 보낸 코드가 실행되어 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1254 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254)를 참조하십시오.

#### Mac Office Open XML 사용 권한 취약점(CVE-2010-1254)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.
-   Open XML File Format Converter for Mac은 어느 버전의 Office for Mac과도 함께 설치되지 않습니다. 별도의 다운로드를 통한 설치만 가능합니다.
-   공격자가 설치를 수정한 후 관리자가 Open XML File Format Converter for Mac을 설치한 경우 공격자는 영향을 받는 시스템에서 권한을 상승시킬 수만 있습니다. 이는 직접적인 권한 상승이 아니라 유인 공격입니다.

#### Mac Office Open XML 사용 권한 취약점(CVE-2010-1254)에 대한 대안

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   /Applications 폴더 및 Open XML File Format Converter for Mac의 소유자와 그룹을 권한 있는 사용자로 변경

    터미널 응용 프로그램에서 다음 명령을 실행하여 사용 권한을 설정합니다.

    `sudo chown root:admin /Applicationssudo chown -R root:admin /Applications/Open\ XML\ Converter.app`

    대안 실행 취소 방법.

    사용 권한을 Open XML File Format Converter for Mac 설치로 설정된 취약한 상태로 재설정하려면 다음을 실행합니다.

    `sudo chown 99:99/Applicationssudo chown -R 99:99/Applications/Open\ XML\ Converter.app`

#### Mac Office Open XML 사용 권한 취약점(CVE-2010-1254)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 권한 상승 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 원격으로 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

취약점의 원인은 무엇입니까?  
설치 도중 Office XML Converter for Mac 응용 프로그램은 /Applications 폴더의 보안 설정을 낮추는 방식으로 /Applications 폴더의 파일 시스템 ACL을 변경합니다.

공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
공격자는 Office XML Converter for Mac 응용 프로그램을 악의적인 실행 파일로 대체할 수 있습니다. 나중에 관리자가 로그온하여 Office XML Converter for Mac 응용 프로그램을 실행할 경우 공격자가 보낸 코드가 실행되어 공격자가 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
이 취약점을 악용하려면 먼저 공격자가 시스템에 로그온하여 Open XML File Format Converter for Mac을 악의적인 실행 파일로 대체해야 합니다. 나중에 관리자가 로그온하여 Office XML Converter for Mac 응용 프로그램을 실행할 경우 공격자가 보낸 코드가 실행될 수 있습니다.

취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?  
워크스테이션과 터미널 서버가 주로 위험합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.

업데이트는 어떤 기능을 수행합니까?  
업데이트는 /Applications 폴더의 기본 보안 설정을 변경하지 않도록 Open XML File Format Converter for Mac의 설치 방식을 수정하여 취약점을 해결합니다.
...
MBSA 2.1.1, Microsoft Update 및 Windows Server Update Services에서 지원하지 않는 레거시 소프트웨어를 사용하는 고객을 위한 참고: [Microsoft Baseline Security Analyzer](https://technet.microsoft.com/ko-kr/security/cc184924.aspx)를 방문하고 레거시 제품 지원 섹션을 참조하여 레거시 도구로 종합 보안 업데이트 검색을 만드는 방법을 찾으십시오.
...
-   지원되는 2007 Microsoft Office System 버전은 [Create a network installation point for the 2007 Office system(2007 Office System의 네트워크 설치 지점 만들기) (영문)](https://technet.microsoft.com/en-us/library/cc179063.aspx)을 참조하십시오.
    참고 중앙에서 보안 업데이트를 관리하려는 경우 Windows Server Update Services를 사용합니다. Windows Server Update Services를 사용하여 2007 Microsoft Office System에 보안 업데이트를 신속하게 배포하는 방법에 대한 자세한 내용은 [Windows Server Update Services 웹 사이트](https://go.microsoft.com/fwlink/?linkid=50120)를 참조하십시오.
...
<td style="border:1px solid black;">OfficeXP-kb982299-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">OfficeXP-kb982299-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/982299">Microsoft 기술 자료 문서 982299</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Office2003-kb982133-fullfile-kor /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Office2003-kb982133-fullfile-kor /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/982133">Microsoft 기술 자료 문서 982133</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### Word, Excel, PowerPoint 2007 파일 형식용 Excel 2007(모든 에디션), Excel Viewer 및 Microsoft Office 호환 기능 팩(모든 버전)
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Excel Viewer:<br />
...
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="https://support.microsoft.com/kb/982308">Microsoft 기술 자료 문서 982308</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Excel Viewer:<br />
<a href="https://support.microsoft.com/kb/982333">Microsoft 기술 자료 문서 982333</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="https://support.microsoft.com/kb/982331">Microsoft 기술 자료 문서 982331</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.5.9 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=16c71ab8-9284-407a-856a-93c67995f125)에서 다운로드하여 설치하십시오.
...
-   바탕 화면에서 Microsoft Office 2004 for Mac 11.5.9 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2004 for Mac 11.5.9 업데이트 볼륨 창에서 Microsoft Office 2004 for Mac 11.5.9 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2004 for Mac 11.5.9 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 11.5.9이면 업데이트가 설치된 것입니다.
...
Microsoft Office 2008 for Mac 12.2.5 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=d46255bd-6470-4106-9fe2-ea67acd3f1bd)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Microsoft Office 2008 for Mac 12.2.5 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Microsoft Office 2008 for Mac 12.2.5 업데이트 볼륨 창에서 Microsoft Office 2008 for Mac 12.2.5 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office 2008 for Mac 12.2.5 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
버전 번호가 12.2.5이면 업데이트가 설치된 것입니다.
...
Open XML File Format Converter for Mac 1.1.5 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=b6ca7b05-cf97-43a2-95eb-7b5caf7c1528)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램, 모든 Microsoft Office 응용 프로그램, Microsoft Messenger for Mac, Office 알림을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Open XML File Format Converter for Mac 1.1.5 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 프로세스를 시작하려면 Open XML File Format Converter for Mac 1.1.5 업데이트 볼륨 창에서 Open XML File Format Converter for Mac 1.1.5 업데이트 응용 프로그램을 두 번 클릭하고 화면에 나타난 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Open XML File Format Converter 1.1.5 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
-   Excel 레코드 분석 메모리 손상 취약점(CVE-2010-0821)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   Excel 개체 스택 오버플로 취약점(CVE-2010-0822)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 메모리 손상 취약점(CVE-2010-0823)을 보고해 주신 [Fortinet's FortiGuard Labs (영문)](https://www.fortiguard.com/)의 Bing Liu  
-   Excel 레코드 메모리 손상 취약점(CVE-2010-0824)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 레코드 메모리 손상 취약점(CVE-2010-1245)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel RTD 메모리 손상 취약점(CVE-2010-1246)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 메모리 손상 취약점(CVE-2010-1247)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel HFPicture 메모리 손상 취약점(CVE-2010-1248)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 메모리 손상 취약점(CVE-2010-1249)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel EDG 메모리 손상 취약점(CVE-2010-1250)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Excel 레코드 스택 손상 취약점(CVE-2010-1251)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten Eiram  
-   Excel 문자열 변수 취약점(CVE-2010-1252)을 보고해 주신 [Secunia (영문)](https://secunia.com/)의 Carsten Eiram  
-   Excel ADO 개체 취약점(CVE-2010-1253)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   Mac Office Open XML 사용 권한 취약점(CVE-2010-1254)을 보고해 주신 애리조나 주 길버트 소재 Gilbert Public Schools의 Rick Glaspie
...
-   V1.1(2010년 6월 10일): 요약에서 알려진 문제점 표시가 삭제되었습니다. 현재 이 보안 업데이트에 대한 알려진 문제점은 없습니다.  
-   V1.2(2010년 6월 23일): 요약에 Knowledge 기술 자료 문서 2027452로의 링크가 추가 되었습니다.
