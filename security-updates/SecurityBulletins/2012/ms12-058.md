---
TOCTitle: 'MS12-058'
Title: 'Microsoft 보안 공지 MS12-058 - 긴급'
ms:assetid: 'ms12-058'
ms:contentKeyID: 61230525
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-058(v=Security.10)'
---

Microsoft 보안 공지 MS12-058 - 긴급
===================================

Microsoft Exchange Server WebReady 문서 보기가 원격 코드 실행을 허용할 수 있는 취약점 (2740358)
-----------------------------------------------------------------------------------------------

게시된 날짜: 2012년 8월 14일 화요일 | 업데이트된 날짜: 2012년 11월 21일 수요일
...
이 보안 업데이트는 또한 Microsoft Exchange Server의 영향을 받는 에디션에 대한 [Microsoft 보안 권고 2737111](https://technet.microsoft.com/security/advisory/2737111)에서 처음 설명된 취약점을 해결합니다.
...
[Microsoft Exchange Server 2007 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=21a26e23-9d83-41b6-95be-4b48f6e76023)   
(KB2756497)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Exchange Server 2010 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=8646aaca-9829-4d3f-a77b-d24673818da7)   
(KB2756496)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Microsoft Exchange Server 2010 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4b24182a-cee9-4ca0-9cc5-c4453475999d)   
(KB2756485)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
기존 KB2734323, KB2743248 또는 KB2706690 업데이트를 이미 성공적으로 설치했습니다. 2012년 10월 9일에 다시 릴리스된 업데이트 패키지(KB2756497, KB2756496 또는 KB2756485)를 설치해야 합니까?  
예. 모든 경우, 고객은 다시 릴리스된 업데이트 패키지를 적용해야 합니다.

참고 이 다시 릴리스된 업데이트 패키지의 적용 가능성은 Microsoft Windows가 설치된 Microsoft Exchange의 버전과 관련이 없습니다.

이 공지가 2012년 10월 9일에 개정된 이유는 무엇입니까?  
Microsoft는 적절한 타임스탬프 특성 없이 Microsoft에서 생성한 특정 디지털 인증서와 관련된 문제를 해결하도록 Microsoft Exchange Server 2007 서비스 팩 3(KB2756497), Microsoft Exchange Server 2010 서비스 팩 1 (KB2756496) 및 Microsoft Exchange Server 2010 서비스 팩 2(KB2756485)에 대한 다시 릴리스된 업데이트를 제공하기 위해 이 공지를 개정했습니다. 자세한 내용은 [Microsoft 보안 권고 2749655](https://technet.microsoft.com/security/advisory/2749655)를 참조하십시오.

다시 릴리스된 업데이트 KB2756497, KB2756496 및 KB2756485는 각각 원본 업데이트 KB2734323, KB2743248 및 KB2706690을 대체합니다.

Microsoft 보안 권고 2737111의 Microsoft Exchange Server에 대한 대안을 적용한 경우 이 업데이트를 적용하기 전에 이 대안을 실행 취소해야 합니까?  
WebReady 문서 보기를 비활성화하기 위해 [Microsoft 보안 권고 2737111](https://technet.microsoft.com/security/advisory/2737111)의 대안을 구현한 고객은 이 업데이트를 적용하기 전에 대안을 실행 취소하지 않아도 됩니다. 하지만 WebReady 문서 보기 기능을 다시 활성화하기 위해 이 업데이트를 적용하고 대안을 실행 취소해야 할 수 있습니다.

Microsoft는 WebReady 문서 보기 기능을 다시 활성화하기 전에 모든 서버에 이 업데이트를 적용할 것을 권장합니다.

Microsoft 보안 권고 2737111 에 설명된 취약점이 다양합니다. 이 업데이트로 취약점의 문제가 어떻게 해결됩니까***?***  
[Microsoft 보안 권고 2737111](https://technet.microsoft.com/security/advisory/2737111)에서 설명한 CVE-2012-1766, CVE-2012-1767, CVE-2012-1768, CVE-2012-1769, CVE-2012-1770, CVE-2012-1771, CVE-2012-1772, CVE-2012-1773, CVE-2012-3106, CVE-2012-3107, CVE-2012-3108, CVE-2012-3109 및 CVE-2012-3110은 Microsoft Exchange Server에 영향을 미치며 이 업데이트에 의해 해결됩니다.
...
-   Exchange Server 2007 서비스 팩 1용 업데이트 롤업 8(KB2756497)의 경우 [Microsoft 기술 자료 문서 2756497](https://support.microsoft.com/kb/2756497)을 참조하십시오.
-   Exchange 2010 서비스 팩 1용 업데이트 롤업 7(KB2756496)의 경우 [Microsoft 기술 자료 문서 2756496](https://support.microsoft.com/kb/2756496)을 참조하십시오.
-   Exchange 2010 서비스 팩 2용 업데이트 롤업 4(KB2756485)의 경우 [Microsoft 기술 자료 문서 2756485](https://support.microsoft.com/kb/2756485)를 참조하십시오.

파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.

보안 업데이트의 해시는 어디에 있습니까?  
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2740358](https://support.microsoft.com/kb/2740358)을 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](https://technet.microsoft.com/security/bulletin/ms12-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Exchange Server 2010 서비스 팩 1 </td>
<td style="border:1px solid black;">긴급 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
</tr>
...
원격 코드 실행 취약점은 WebReady 문서 보기 기능을 통해 Microsoft Exchange Server에 존재합니다. 사용자가 브라우저에서 Outlook Web Access를 통해 특수하게 조작된 파일을 보는 경우 이 취약점은 원격 코드 실행을 로컬 시스템처럼 허용할 수 있습니다. 이 취약점을 성공적으로 악용하는 공격자는 영향을 받은 서버에서 코드를 LocalService로만 실행할 수 있습니다. LocalService 계정에는 로컬 컴퓨터의 최소 권한이 있으며 네트워크에서 익명 자격 증명을 제시합니다.
...
-   WebReady 문서 보기 비활성화
    ...
    3.  `Get-OwaVirtualDirectory | where {$_.OwaVersion -eq 'Exchange2007' -or $_.OwaVersion -eq 'Exchange2010'} | Set-OwaVirtualDirectory -WebReadyDocumentViewingOnPublicComputersEnabled:$False -WebReadyDocumentViewingOnPrivateComputersEnabled:$False`
    ...
    1.  Exchange 관리 셸에 Exchange 조직 관리자로 로그인합니다.  
    2.  다음 PowerShell 명령을 실행합니다.  
    3.  `Get-OwaVirtualDirectory | where {$_.OwaVersion -eq 'Exchange2007' -or $_.OwaVersion -eq 'Exchange2010'} | Set-OwaVirtualDirectory -WebReadyDocumentViewingOnPublicComputersEnabled:$True -WebReadyDocumentViewingOnPrivateComputersEnabled:$True참고`
...
취약점 악용에 성공한 공격자는 영향을 받은 Exchange 서버에서 임의의 코드를 LocalService로 실행할 수 있습니다. LocalService 계정에는 로컬 컴퓨터의 최소 권한이 있으며 네트워크에서 익명 자격 증명을 제시합니다.
  
공격자는 어떤 방식으로 이러한 취약점을 악용할 수 있습니까?  
공격자는 영향을 받는 Exchange 버전 사용자에게 특수하게 조작된 파일이 포함된 전자 메일 메시지를 보낼 수 있습니다. 사용자가 브라우저를 통해 특수하게 조작된 파일을 미리 보면 Exchange 서버에서 임의 코드가 실행됩니다. 서버 프로세스를 장악한 공격자는 다양한 프로그램을 설치하여 데이터를 보고, 변경하거나 삭제할 수 있으며, 서버에서 수행할 수 있는 모든 작업을 수행할 수 있습니다.
...
| Microsoft Exchange Server 2010 서비스 팩 1  | 예   |  
...
| Microsoft Exchange Server 2010 서비스 팩 1  | 예                  | 예                                  |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2740358">Microsoft 기술 자료 문서 2740358</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Microsoft Exchange Server 2010 서비스 팩 1:<br />
...
-   V2.0(2012년 10월 9일): Microsoft Exchange Server 2007 서비스 팩 3(KB2756497), Microsoft Exchange Server 2010 서비스 팩 1(KB2756496) 및 Microsoft Exchange Server 2010 서비스 팩 2(KB2756485)에 대한 다시 릴리스된 업데이트를 제공하기 위해 공지가 개정되었습니다. 고객은 Microsoft 보안 권고 2749655에 설명된 디지털 인증서 관련 문제를 방지하기 위해 다시 릴리스된 업데이트를 적용해야 합니다.
-   V2.1(2012년 10월 10일): 다시 릴리스된 KB2756497, KB2756496, KB2756485 업데이트에서는 배포 지침을 제공하기 위해 업데이트 FAQ에 항목이 추가되었습니다. 자세한 내용은 업데이트 FAQ를 참조하십시오.
-   V2.2(2012년 11월 21일): 이 공지의 KB2756497 및 KB2756496 업데이트에 대해 정확하지 않은 업데이트 패키지 이름, 레지스트리 확인 키, 로그 파일 이름을 수정했습니다. 이 변경 사항은 정보에만 해당됩니다. 다운로드 페이지 및 관련된 기술 자료 문서에는 이미 올바른 정보가 포함되어 있습니다.
