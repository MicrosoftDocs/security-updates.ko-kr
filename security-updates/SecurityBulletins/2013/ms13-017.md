---
TOCTitle: 'MS13-017'
Title: 'Microsoft 보안 공지 MS13-017 - 중요'
ms:assetid: 'ms13-017'
ms:contentKeyID: 61230567
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-017(v=Security.10)'
---

Microsoft 보안 공지 MS13-017 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2, Windows 8, Windows Server 2012 및 Windows RT 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널이 메모리에서 개체를 처리하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2799494](https://support.microsoft.com/kb/2799494)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
[Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=9100bf70-8723-4635-9b78-f7c3048a950f)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<td style="border:1px solid black;">
[MS12-068](https://go.microsoft.com/fwlink/?linkid=257912)의 KB2724197
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c005c0a0-4025-4a07-a76d-c57ed5afbd68)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=dc004424-61f9-49ed-9cb3-b89ed9e98aef)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4de1249f-012e-47cb-ad08-4fd5bddb0879)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=448ac43a-0a6f-4049-be2b-c853b5dbfab3)  
(KB 2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6d7a74c8-de4b-4bcb-8b3f-581858d0776b)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c9fbb7cc-c33b-4af9-8416-9d16015e79c1)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=912ac2e1-e737-43fb-acc8-a01a918a8475)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=912ac2e1-e737-43fb-acc8-a01a918a8475)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0d1601cc-fb76-4276-bf0b-a46b7f8055ae)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0d1601cc-fb76-4276-bf0b-a46b7f8055ae)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5b74e5b3-7b8d-4669-b403-c776e70bf072)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8(64비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a41a2b38-5e5c-48bc-8727-e19402519f12)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6d7a74c8-de4b-4bcb-8b3f-581858d0776b)(Server Core 설치)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c9fbb7cc-c33b-4af9-8416-9d16015e79c1)(Server Core 설치)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb)(Server Core 설치)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb)(Server Core 설치)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=4e427f56-436e-43d0-b4f8-eee8427b3741)(Server Core 설치)  
(KB2799494)
</td>
<td style="border:1px solid black;">
권한 상승
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2768387](https://support.microsoft.com/kb/2768387)을 참조하십시오.
...
<th style="border:1px solid black;" >
커널 경쟁 조건 취약점(2013-1278)
</th>
<th style="border:1px solid black;" >
커널 경쟁 조건 취약점(CVE-2013-1279)
</th>
<th style="border:1px solid black;" >
Windows 커널 참조 수 취약점(CVE-2013-1280)
</th>
<th style="border:1px solid black;" >
전체 심각도
</th>
...
Windows 커널이 메모리에서 개체를 부적절하게 처리하는 경우 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1278)을 참조하십시오.

#### 커널 경쟁 조건 취약점(CVE-2013-1278)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### 커널 경쟁 조건 취약점(CVE-2013-1278)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### 커널 경쟁 조건 취약점(CVE-2013-1278)에 대한 FAQ

**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 권한 상승 취약점입니다.

**취약점의 원인은 무엇입니까?**  
이 취약점은 Windows 커널이 메모리에서 개체를 부적절하게 처리할 때 발생합니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
이 업데이트는 Windows 커널이 메모리에서 개체를 처리하는 방식을 수정하여 이 취약점을 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1279)를 참조하십시오.

#### 커널 경쟁 조건 취약점(CVE-2013-1279)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### 커널 경쟁 조건 취약점(CVE-2013-1279)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### 커널 경쟁 조건 취약점(CVE-2013-1279)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-1280](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1280)을 참조하십시오.

#### Windows 커널 참조 수 취약점(CVE-2013-1280)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다.

#### Windows 커널 참조 수 취약점(CVE-2013-1280)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### Windows 커널 참조 수 취약점(CVE-2013-1280)에 대한 FAQ
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거 항목</strong> 또는 %Windir%\$NTUninstallKB2799494$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2799494">Microsoft 기술 자료 문서 2799494</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
제어판의 **프로그램 추가/제거 항목** 또는 %Windir%\\$NTUninstallKB2799494$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
[Microsoft 기술 자료 문서 2799494](https://support.microsoft.com/kb/2799494) 참조
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **파일 정보**             | [Microsoft 기술 자료 문서 2799494](https://support.microsoft.com/kb/2799494) 참조                                                  |
...
-   커널 경쟁 조건 취약점(CVE-2013-1278)을 보고해 주신 [Google Inc](https://www.google.com)의 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 및 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/)  
-   커널 경쟁 조건 취약점(CVE-2013-1279)을 보고해 주신 [Google Inc](https://www.google.com)의 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 및 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/)
...
-   V1.1(2013년 2월 12일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2799494 링크가 추가되었습니다.
