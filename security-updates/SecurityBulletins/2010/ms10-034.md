---
TOCTitle: 'MS10-034'
Title: 'Microsoft 보안 공지 MS10-034 - 긴급'
ms:assetid: 'ms10-034'
ms:contentKeyID: 61230295
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-034(v=Security.10)'
---



Microsoft 보안 공지 MS10-034 - 긴급
===================================
...
이 보안 업데이트는 Microsoft 소프트웨어에서 발견되어 비공개적으로 보고된 취약점 2건을 해결합니다. 이 보안 업데이트의 등급은 지원되는 모든 버전의 Microsoft Windows 2000, Windows XP, Windows Vista 및 Windows 7에 대해 긴급, 지원되는 모든 버전의 Windows Server 2003, Windows Server2008 및 Windows Server 2008 R2에 대해 보통입니다. 자세한 내용은 이 절의 하위 절인 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=d3955983-0079-476e-a488-99713097259c&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=8c3f2e81-c0ea-494a-a47c-4f8982effb49&displaylang=ko)                                                 | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f3e462fb-df95-4b79-a8bc-5359c2967503)                                                                 | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3c0bd349-aa77-47de-ba1d-1fcc72dcad28&displaylang=ko)                                                                  | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4aa0ec4f-5502-4f2a-9732-975518c34444&displaylang=ko)                                                      | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=55d9d7f0-f9d9-4833-b5cc-eb87a62da6a8)                                                                  | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2ddaa4b3-1a98-4183-94af-ebdae4e7b76a&displaylang=ko)                                           | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ddf55e74-dbaa-45f7-ac5b-ae3da24e0e33&displaylang=ko)                   | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a06b9f42-47ac-4ff2-ac32-e4958cdb611e&displaylang=ko)\*\*     | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6d0a3f7c-2617-4bc6-a4c7-cda26c6471e1&displaylang=ko)\*\* | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=38347fa6-5946-4bb5-9fea-a5b2f4e7c1f2)            | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5bce87fe-dcbb-4638-b248-3f0755537b00&displaylang=ko)                                                                       | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ee68ecd0-5b8a-4c1e-bdee-bd8616558d43&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=901f7c89-02af-4f87-8592-dad318997d77&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4958b221-2776-43d7-9e1c-1e1cb318a694)                                                                   | 원격 코드 실행 | 보통        | [MS10-008](https://technet.microsoft.com/security/bulletin/ms10-008) |
...
이 업데이트는 이전 Microsoft 보안 공지 [MS09-060](https://technet.microsoft.com/security/bulletin/ms09-060)에서 다룬 Outlook 보기 컨트롤 ActiveX 컨트롤에 킬(kill) 비트를 설정합니다.

이 ActiveX 컨트롤 및 컨트롤 업데이트 방법과 관련된 자세한 내용은 Microsoft 보안 공지, [Microsoft Office용 Microsoft ATL(액티브 템플릿 라이브러리) ActiveX 컨트롤의 취약점으로 인한 원격 코드 실행 문제점(973965)](https://technet.microsoft.com/security/bulletin/ms09-060)을 검토하십시오.
...
-   Microsoft Data Analyzer가 설치되어 있지 않으면 악의적인 웹 사이트가 시스템에서 이 취약점을 악용할 수 없습니다. 기본적으로 Microsoft Data Analyzer는 Microsoft Office 시스템에 설치되지 않습니다.
...
| 클래스 식별자                          | 파일            | 설명                                      |  
|----------------------------------------|-----------------|-------------------------------------------|  
| {14FD1463-1F3F-4357-9C03-2080B442F503} | max3activex.dll | 데이터 분석용 Office Excel ActiveX 컨트롤 |  
| {E9CB13DB-20AB-43C5-B283-977C58FB5754} | max3activex.dll | 데이터 분석용 Office Excel ActiveX 컨트롤 |
...
Microsoft Internet Explorer 8 개발자 도구에 원격 코드 실행 취약점이 있습니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
...
-   **Internet Explorer에서 COM 개체가 실행되지 않도록 설정**
    ...
    **참고** ActiveX 개체가 포함된 클래스 식별자 및 해당 파일은 **Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)에 대한 FAQ** 섹션의 "업데이트는 어떤 기능을 수행합니까?"에 나와 있습니다. 아래 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}를 해당 섹션에 나와 있는 클래스 식별자로 바꾸십시오.
...
**공격자는 이러한 취약점을 어떻게 악용합니까?**  
공격자는 Internet Explorer를 통해 이 취약점을 악용하도록 설계하여 특수하게 조작된 웹 사이트를 호스팅한 다음 사용자가 이 웹 사이트를 보도록 유도할 수 있습니다. 또한 공격자는 응용 프로그램이나 IE 렌더링 엔진을 호스팅하는 Microsoft Office 문서에 "초기화에 안전"이라고 표시된 ActiveX 컨트롤을 포함시킬 수 있습니다. 여기에는 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 웹 사이트와 공격에 노출된 웹 사이트도 포함될 수 있습니다. 이러한 웹 사이트에 이 취약점을 악용하는 특수하게 조작된 콘텐츠가 포함될 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 요청의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다. 배너 광고에서 특수하게 조작된 웹 콘텐츠를 표시하거나 웹 콘텐츠를 전달하는 다른 방법을 사용하여 영향을 받는 시스템에 대한 공격을 시도할 수도 있습니다.
...
Microsoft Internet Explorer 8 개발자 도구는 웹 사이트 개발자들이 Microsoft Jscript를 빠르게 디버깅하거나 Internet Explorer와 관련된 동작을 조사하거나 새 디자인 또는 솔루션을 즉석에서 고안할 수 있도록 합니다. IE8 도구에 대한 자세한 내용은 MSDN 문서, [Internet Explorer 개발자 도구 발견](https://msdn.microsoft.com/en-us/library/dd565628(vs.85).aspx)(영문)을 참조하십시오.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**  
이 Microsoft Internet Explorer 8 개발자 도구 컨트롤의 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 Microsoft Internet Explorer 8 개발자 도구 컨트롤이 설치되어 있고 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템이 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
...
| 클래스 식별자                          | 파일         | 설명                                      |  
|----------------------------------------|--------------|-------------------------------------------|  
| {8fe85d00-4647-40b9-87e4-5eb8a52f4759} | iedvtool.dll | Microsoft Internet Explorer 8 개발자 도구 |
...
-   [Danske Bank (영문)](https://www.danskebank.dk/)는 ActiveX 컨트롤, Danske eSec에 대한 킬(Kill) 비트를 요청했습니다. Danske eSec ActiveX 컨트롤과 관련된 질문이나 의견이 있는 경우 [Danske Bank (영문)](https://www.danskebank.dk/)에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {F6A56D95-A3A3-11D2-AC26-400000058481}  
-   [CA (영문)](https://www.ca.com/us/)는 Pest Scan 제품의 ActiveX 컨트롤, PSFormX에 대한 권고와 관련된 보안 권고를 발표했습니다. 자세한 내용은 CA의 보안 공지를 참조하십시오. 이 킬(Kill) 비트는 해당 ActiveX 컨트롤 소유자의 요청에 의해 설정됩니다. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {56393399-041A-4650-94C7-13DFCB1F4665}  
-   [Eastman Kodak Company (영문)](https://www.kodakgallery.com/)는 "Ofoto Upload Manager / Kodak Gallery Easy Upload Manager ActiveX Control"에 대해 ActiveX 컨트롤에 대한 킬(Kill) 비트를 요청했습니다. Eastman Kodak Gallery는 다양한 업로드 옵션이 있는 다음 페이지를 제공하고 있습니다. [https://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp (영문)](https://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp). 이 업데이트에 킬(Kill) 비트가 설정되는 컨트롤에 대한 대체 컨트롤은 다음 사이트에서 찾을 수 있습니다. [https://classic.kodakgallery.com/UploadChoicesAll.jsp (영문)](https://classic.kodakgallery.com/uploadchoicesall.jsp). 이 킬(Kill) 비트에 대해 질문이나 의견이 있는 경우 Kodak Gallery([https://www.kodakgallery.com/gallery/footerLinksContent.jsp?pageID=600002 (영문)](https://www.kodakgallery.com/gallery/footerlinkscontent.jsp?pageid=600002))에 문의하십시오. 이 ActiveX 컨트롤에 대한 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {6f750200-1362-4815-a476-88533de61d0c}  
    -   {6f750201-1362-4815-a476-88533de61d0c}  
-   [Avaya (영문)](https://www.avaya.com/)는 CallPilot Unified Messaging에 대한 킬(Kill) 비트를 요청했습니다. CallPilot Unified Messaging의 킬(Kill) 비트와 관련해서 질문이나 의견이 있는 경우 Avaya 보안 담당자(securityalerts@avaya.com)에게 문의하십시오. 이 ActiveX 컨트롤에 대한 클래스 식별자(CLSID)는 다음과 같습니다.  
...
Windows2000-KB980195-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-KB980195-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB980195$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
...
Windowsxp-KB980195-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션:<br />
Windowsxp-KB980195-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB980195$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션:<br />
...
Windowsserver2003-KB980195-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB980195-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-KB980195-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB980195-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)을 보고해 주신 Carnegie Mellon University Computing Services의 Chris Ries
