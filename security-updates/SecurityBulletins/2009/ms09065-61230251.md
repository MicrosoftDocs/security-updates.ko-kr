...
**문제점.**[Microsoft 기술 자료 문서 969947](http://support.microsoft.com/kb/969947)는 보안 업데이트 시 발생되는 알려진 이슈에 대해 설명하고 있습니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=45db8bb1-c81b-4d3f-a658-74f5fa445f81&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=916abdad-44b7-4f9d-986a-0c3558fb8e06&displaylang=ko)                                                          | 원격 코드 실행 | 긴급        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d0464c6-5ed8-4064-887e-618a2db09236)                                                                          | 원격 코드 실행 | 긴급        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cd62750-e269-44ae-8c7c-c335e8545b9a&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=04a7f817-f330-4003-8b25-d3e744905b12&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=b95daac0-4c99-47a4-b0ca-9429997ea3d9)                                                                           | 원격 코드 실행 | 긴급        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=54562103-1d99-42d7-8f7f-c0cbcdce90db&displaylang=ko)                                     | 권한 상승      | 중요        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=fcb87cc8-6fd7-4f16-93d6-552999462fb1&displaylang=ko) | 권한 상승      | 중요        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b97d48de-0f6d-4bca-b990-acf543fdb8b7&displaylang=ko)\*                | 권한 상승      | 중요        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e2b8607-10fa-406a-96a5-18290f479c48&displaylang=ko)\*            | 권한 상승      | 중요        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=28eba3f3-99a5-424c-bc8d-a718c716699e)                     | 권한 상승      | 중요        | [MS09-025](http://technet.microsoft.com/security/bulletin/ms09-025) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1127 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1127)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2513 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2513)을 참조하십시오.
...
**GDI란 무엇입니까?**    
Microsoft Windows GDI(그래픽 장치 인터페이스)를 통해 응용 프로그램이 비디오 디스플레이와 프린터 모두에서 그래픽과 형식 있는 텍스트를 사용할 수 있습니다. Windows 기반 응용 프로그램은 그래픽 하드웨어에 직접 액세스하지 않습니다. GDI가 응용 프로그램 대신 장치 드라이버와 상호 작용을 수행합니다. GDI에 대한 자세한 내용은 MSDN 문서, [Windows GDI (영문)](http://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2514 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2514)를 참조하십시오.
...
-   **Internet Explorer에서 포함 글꼴 구문 분석 지원 사용 안 함**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 969947](http://support.microsoft.com/kb/969947)을 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
| **파일 정보**             | [Microsoft 기술 자료 문서 969947](http://support.microsoft.com/kb/969947) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/969947">Microsoft 기술 자료 문서 969947</a> 참조</td>
</tr>
<tr class="even">
...
-   Win32k EOT 구문 분석 취약점(CVE-2009-2514)을 보고해 주신 [Google Inc.](http://www.google.com/)의 Tavis Ormandy
