...
<td style="border:1px solid black;">
[MS12-041](http://go.microsoft.com/fwlink/?linkid=251707)의 KB2709162는 KB2718523으로 대체되었습니다.
</td>
</tr>
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2718523](http://support.microsoft.com/kb/2718523)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)(영문)을 참조하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)(영문)이 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2718523">Microsoft 기술 자료 문서 2718523</a> 참조</td>
</tr>
<tr class="even">
...
-   키보드 레이아웃 취약점(CVE-2012-1890)을 보고해 주신 [Core Security Technologies](http://www.coresecurity.com/)의 Nicolas Economou  
-   키보드 레이아웃 취약점(CVE-2012-1890)을 보고해 주신 [Qihoo 360 Security Center](http://www.360.cn/)  
-   Win32k 부정확한 유형 처리 취약점(CVE-2012-1893)을 [Secunia Research](http://secunia.com/)와 협력하여 보고해 주신 Neusoft Corporation의 Lufeng Li
