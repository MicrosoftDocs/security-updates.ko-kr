---
TOCTitle: 'MS16-036'
Title: 'Microsoft 보안 공지 MS16-036 - 긴급'
ms:assetid: 'ms16-036'
ms:contentKeyID: 72464134
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-036(v=Security.10)'
---

MSRC ppDocument 서식 파일

Microsoft 보안 공지 MS16-036 - 긴급
===================================

Adobe Flash Player용 보안 업데이트(3144756)
-------------------------------------------
...
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3144756](https://support.microsoft.com/ko-kr/kb/3144756)을 참조하십시오.

취약성 정보
-----------

<span id="sectionToggle1"></span>
이 보안 업데이트는 Adobe 보안 공지 [APSB16-08](https://helpx.adobe.com/kr/security/products/flash-player/apsb16-08.html)에 설명된 다음 취약성을 해결합니다.
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/ko-kr/download/details.aspx?id=51482&displaylang=ko)  
(3144756)
...
<td style="border:1px solid black;">
[MS16-022](https://technet.microsoft.com/ko-kr/library/security/ms16-022)의 3135782
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/ko-kr/download/details.aspx?id=51481&displaylang=ko)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/ko-kr/download/details.aspx?id=51483&displaylang=ko)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/ko-kr/download/details.aspx?id=51480&displaylang=ko)  
(3144756)
...
**참고** Windows Server Technical Preview 4가 영향을 받습니다. 전체 심각도는 긴급이며 영향은 보통, 원격 코드 실행입니다. 이 운영 체제를 실행하는 고객은 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ko-kr)에서 제공되는 해당 업데이트를 적용하는 것이 좋습니다.
...
-   **영향받는 시스템에 설치된 Office 2010에서 Adobe Flash Player 실행 방지**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 심각한 문제가 발생할 수 있으며 문제를 해결하기 위해 운영 체제를 다시 설치해야 할 수도 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용함으로써 발생하는 문제에 대해 해결을 보증하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    Internet Explorer에서 컨트롤이 실행되지 않도록 설정하는 자세한 단계는 [Microsoft 기술 자료 문서 240797](https://technet.microsoft.com/ko-kr/library/cc179076.aspx)(영문)을 참조하십시오. 이 단계에 따라 레지스트리에 Compatibility Flags 값을 만들어 COM 개체가 Internet Explorer에서 인스턴스화되는 것을 방지하십시오.
...
-   **신뢰하는 사이트를 Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가**
    ...
    **참고** 사용자 시스템에 악의적인 행위를 하지 않을 것으로 신뢰하는 사이트를 모두 추가하십시오. 특히 **\*.windowsupdate.microsoft.com** 및 **\*.update.microsoft.com** 두 사이트는 추가하는 것이 좋습니다. 이러한 사이트는 업데이트를 호스트하는 사이트이며, 업데이트를 설치하기 위해 ActiveX 컨트롤이 필요합니다.
...
-   V1.0(2016년 3월 11일): 공지가 게시되었습니다.

*2016-03-10 13:50-08:00에 페이지가 생성되었습니다.*
