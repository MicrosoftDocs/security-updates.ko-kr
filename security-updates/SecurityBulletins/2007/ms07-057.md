...
**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=95827f3f-a984-4e34-a949-d16a0614121a&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=df3ba596-7c5b-4151-9884-6957aa884aab&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=513a8320-6d36-4fc9-a38a-867192b55b53&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=ae8a26d8-1910-4b8c-8a73-6e2fa6b5b29f&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=4aefaa38-8757-4e6e-8924-57cabd1c2fc3&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=88aba9dd-653b-4cdf-a513-cca32a7d7e41&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=4ca0ac93-bf51-40fe-a1ba-cb3e0a36d8b5&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=dbd284d0-2664-42a4-ad16-a0535244c81c&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=0a31c451-32f4-4551-ae45-d600f8b3b11b&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=c1915633-d181-4ca1-a4f0-7ca0f865aa72&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=86392e8d-098c-427f-a233-699cdb9375ae&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=62490e6d-0a21-4a15-90bd-63ca8f8886b6&displaylang=ko)
</td>
<td style="border:1px solid black;">
**원격 코드 실행**
</td>
...
일부 고객은 파일 정보 항목의 크기로 인해 공지를 볼 때 긴 지연 시간을 경험할 수 있습니다. 이러한 지연 시간을 방지하기 위해 파일 정보 세부 사항은 [Microsoft 기술 자료 문서 939353](https://support.microsoft.com/kb/939653)으로 이동되었습니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.

이 공지의 원래 버전이 출시된 이후 알려진 문제점

-   [KB904710](https://support.microsoft.com/kb/904710): Windows XP 서비스 팩 2에서 사용자 지정 관리 템플릿을 작성하기 위해 설정한 정책이 WinINet에서 무시됩니다.
...
-   이 업데이트는 이전 Microsoft 보안 공지에서 다룬 ActiveX 컨트롤에 [킬(kill) 비트](https://support.microsoft.com/kb/240797)를 설정합니다.
    -   Microsoft 보안 공지 [MS06-061](https://technet.microsoft.com/security/bulletin/ms06-061): Microsoft XML Core Services의 취약점으로 인한 원격 코드 실행 문제점(924191)에서 해결된 MSXML2 컨트롤
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3892 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3892)를 참조하십시오.
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537183(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-3893 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3893)을 참조하십시오.
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성](https://msdn2.microsoft.com/ko-kr/library/ms537183(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역이 보안 수준을 높음으로 설정합니다. 인터넷 영역의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 하위 섹션을 참조하십시오.
...
Internet Explorer 보안 강화 구성에 대한 자세한 내용은 [웹 사이트 (영문)](https://www.microsoft.com/oldcprops%20https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)에서 Internet Explorer 보안 강화 구성 관리 설명서를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-1091 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1091) 및 [CVE-2007-3826 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3826)을 참조하십시오.
...
-   제한된 사이트 영역은 HTML 전자 메일 메시지를 읽을 때 Active 스크립팅을 사용할 수 없도록 방지하여 이 취약점이 악용될 위험을 줄입니다. 그러나 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 문제점에 취약해질 수 있습니다.
-   기본적으로 지원되는 모든 Microsoft Outlook 및 Microsoft Outlook Express 버전은 제한된 사이트 영역에서 HTML 메일 메시지를 엽니다. 제한된 사이트 영역은 HTML 전자 메일을 읽을 때 Active 스크립팅과 ActiveX 컨트롤을 사용하는 것을 방지하여 이 취약점을 악용하는 공격을 줄이는 데 도움이 됩니다. 그러나 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 문제점에 취약해질 수 있습니다.
-   기본적으로 Windows Server 2003의 Internet Explorer는 [보안 강화 구성 (영문)](https://msdn2.microsoft.com/ko-kr/library/ms537183(en-us).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드는 이 취약점을 완화합니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 섹션을 참조하십시오.
...
보안 업데이트는 [Microsoft Update](https://update.microsoft.com/microsoftupdate/), [Windows Update](https://update.microsoft.com/) 및 [Office 업데이트](https://office.microsoft.com/ko-kr/downloads/)에서 제공됩니다. 보안 업데이트는 [Microsoft 다운로드 센터](https://www.microsoft.com/downloads/results.aspx?displaylang=ko&freetext=security_patch)에서도 다운로드할 수 있으며 "security\_patch"라는 키워드를 사용하여 쉽게 찾을 수 있습니다. 마지막으로, 보안 업데이트는 Windows Update 카탈로그에서 다운로드할 수 있습니다.
...
이 공지의 영어 버전 파일은 Microsoft 기술 자료 문서 [939653](https://support.microsoft.com/kb/939653)에 나열되어 있습니다. 이러한 파일의 날짜와 시간은 UTC(Coordinated Universal Time) 기준입니다. 파일 정보를 볼 때 로컬 시간으로 변환됩니다. UTC와 로컬 시간의 차이를 확인하려면 제어판의 날짜 및 시간 도구에서 표준 시간대 탭을 사용하십시오.

지원 대상인 모든 Windows 2000 에디션의 Internet Explorer 5.01 서비스 팩 4는 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)을 참조하십시오.

지원 대상인 모든 Windows 2000 에디션에 설치된 Internet Explorer 6 서비스 팩 1은 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)을 참조하십시오.
...
지원되는 모든 Windows XP 에디션용 Internet Explorer 6 및 Internet Explorer 7은 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)을 참조하십시오.
...
지원되는 모든 Windows Server 2003 버전 및 에디션용 Internet Explorer 6 및 Internet Explorer 7은 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)을 참조하십시오.
...
지원되는 모든 Windows Vista 에디션의 Internet Explorer 7은 [Microsoft 기술 자료 문서 939653](https://support.microsoft.com/kb/939653)을 참조하십시오.
...
-   오류 처리 메모리 손상 취약점(CVE-2007-3893)을 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Carsten H. Eiram  
-   주소 표시줄 스푸핑 취약점(CVE-2007-1091)을 최초로 보고해 주신 [Secunia Research (영문)](https://secunia.com/)의 Jakob Balle
