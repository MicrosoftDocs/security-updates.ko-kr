---
TOCTitle: 'MS11-071'
Title: 'Microsoft 보안 공지 MS11-071 - 중요'
ms:assetid: 'ms11-071'
ms:contentKeyID: 61230438
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-071(v=Security.10)'
---


Microsoft 보안 공지 MS11-071 - 중요
===================================

Windows 구성 요소의 취약점으로 인한 원격 코드 실행 문제점 (2570947)
-------------------------------------------------------------------

게시된 날짜: 2011년 9월 13일 화요일 | 업데이트된 날짜: 2011년 11월 8일 화요일
...
보안 업데이트는 Windows 구성 요소에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=70f944b0-9bf0-4168-b150-67d2ff68df2d)                                                                                     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4b9debed-edbb-43e1-b755-0faf01980289)                                                            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d44274d2-0401-4fd8-bc4f-c59f6d81c34f)                                                                            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=935720ee-cee0-42c2-965e-ce1b07e95e1a)                                                                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=78c2ac72-da89-42a4-bff9-79551b5d3c4e)                                                             | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=15840336-4886-4a1b-8c1e-2c535c3938f7)                                                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e80739b4-89bb-4317-8381-991244a71cb8)                                                                      | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=05c39ab3-7b57-4147-8913-df5df6005799)\*                                                         | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1499d988-fd55-4317-b859-ec170907d547)\*                                                       | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e2d2ea9-0af6-4d23-875d-3211722cd62f)                                                     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=76b99ab2-7e99-4aad-a419-7996bae05c48)                                       | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0f6d32de-d3ff-4af9-9b26-a4f12581f5fe)                                   | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=a8a451bd-3e5c-4845-9941-daabd9418776)\*       | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=0fdfb1f9-20b3-4d61-8019-33d1003290c8) | 원격 코드 실행 | 중요        | 없음                      |
...
**이 공지가 2011년 11월 8일에 다시 릴리스된 이유는 무엇입니까?**  
Microsoft는 Windows 7 Embedded를 위한 업데이트를 알리기 위해 이 공지를 릴리스하였습니다. 이 플랫폼을 실행하는 고객은 이 업데이트를 다운로드하여 시스템에 적용하는 것이 좋습니다. 보안 업데이트는 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 및 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)를 통해 제공됩니다. 다른 업데이트 패키지는 이 발표의 영향을 받지 않습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.

**이 업데이트는 Microsoft 보안 권고 2269637과 관련이 있습니까?**  
예, 이 업데이트에서 해결하는 Windows 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1991)은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [9월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-sep)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >Windows 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1991)</th>
...
Windows 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1991)  
-----------------------------------------------------------------------
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1991](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991)을 참조하십시오.
  
#### Windows 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1991)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 성공하려면 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문하여 서식 있는 텍스트 형식(.rtf), 텍스트 파일(.txt) 또는 Word 문서(.doc) 파일을 열어야 합니다.  
-   파일 공유 프로토콜인 SMB(Server Message Block)는 경계 방화벽에서 자주 비활성화됩니다. 이것이 이 취약점의 가능한 공격 경로를 제한합니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
#### Windows 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1991)에 대한 대안
...
#### Windows 구성 요소의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-1991)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 특정 Windows 구성 요소가 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.
  
**이 업데이트로 어떤 구성 요소의 문제가 해결됩니까?**  
디스플레이 패닝 CPL 확장(deskpan.dll), Microsoft EAPHost Authenticator Service, MMC(Microsoft Management Console), 폴더 리디렉션, 일본어 IME(입력기), HyperTerminal은 이 업데이트로 문제점이 해결되는 구성 요소입니다.
  
**디스플레이 패닝 CPL(제어판 응용 프로그램) 확장이란?**  
디스플레이 패닝 CPL 확장(deskpan.dll)은 사용자의 화면에 나타나는 그림의 디스플레이 설정과 관련된 모듈입니다. 이 확장은 연결된 DLL과 함께 작용하여 사용자가 고급 디스플레이 어댑터 속성 및 디스플레이 모니터 속성을 조정할 수 있도록 합니다.
  
**Microsoft** **EAPHost** **Authenticator Service란?**  
EAPHost는 802.1X 및 PPP(지점 간)와 같은 "써플리컨트" 프로토콜 구현의 인증을 위해 EAP(Extensible Authentication Protocol)를 제공하는 Microsoft Windows 네트워킹 구성 요소입니다. 또한 Microsoft NPS(네트워크 정책 서버)와 같은 "인증자" 기술을 통한 인증을 허용합니다. 자세한 내용은 MSDN 문서, [Extensible Authentication Protocol 호스트](https://msdn.microsoft.com/en-us/library/aa364249(v=vs.85).aspx)(영문)를 참조하십시오.
  
**MMC(Microsoft Management Console)란 무엇입니까?**  
MMC(Microsoft Management Console)는 관리 응용 프로그램에 대한 확장 가능 공통 프레젠테이션 서비스입니다. MMC는 Microsoft 및 기타 소프트웨어 공급업체에서 제공하는 스냅인을 위한 공통 호스트 환경을 제공합니다. 스냅인이 실제 관리 동작을 제공하고 MMC 자체는 관리 기능을 제공하지 않습니다. MMC 환경은 스냅인 간에 원활하게 통합될 수 있도록 합니다. 자세한 내용은 TechNet 문서 [Microsoft Management Console - 개요](https://technet.microsoft.com/en-us/library/bb742441.aspx)(영문)를 참조하십시오.
  
**폴더 리디렉션 구성 요소란 무엇입니까?**  
폴더 리디렉션은 사용자 및 관리자가 폴더의 경로를 새 위치로 리디렉션할 수 있도록 하는 IntelliMirror의 기능입니다. 새 위치는 로컬 컴퓨터의 폴더이거나 네트워크 공유의 디렉터리일 수 있습니다. 사용자는 마치 문서가 로컬 드라이브에 있는 것처럼 서버의 문서로 작업할 수 있게 됩니다. 예를 들어 주로 컴퓨터의 로컬 하드 디스크에 저장되어 있는 내 문서 폴더를 네트워크 위치로 리디렉션할 수 있습니다. 이 폴더의 문서는 네트워크에 연결된 어떤 컴퓨터에서도 사용할 수 있게 됩니다. 자세한 내용은 TechNet 문서 [Folder Redirection Overview(폴더 리디렉션 개요)](https://technet.microsoft.com/en-us/library/cc778976(ws.10).aspx)를 참조하십시오.
  
**IME(일본어) 구성 요소란 무엇입니까?**  
일본어 IME(입력기)를 사용하여 문서, 워크시트, 프레젠테이션, 메일 메시지, 발행물 및 웹 페이지에 일본어 텍스트를 입력할 수 있습니다. 이 IME 및 사용 가능한 다른 IME에 대한 자세한 내용은 MSDN 문서 [Installing and Using Input Method Editors(입력기 설치 및 사용)](https://msdn.microsoft.com/en-us/library/ee418266%28v=vs.85%29.aspx)를 참조하십시오.
  
**HyperTerminal이란 무엇입니까?**  
HyperTerminal은 모뎀, 널 모뎀 케이블 또는 이더넷 연결을 사용하여 다른 컴퓨터, 텔넷 사이트, BBS(Bulletin Board System), 온라인 서비스 및 호스트 컴퓨터에 연결하는 데 사용할 수 있는 프로그램입니다.
  
**이 취약점과 관련해서 여러 구성 요소가 언급된 이유는 무엇입니까?**  
이 단일 취약점과 관련해서 여러 구성 요소가 언급되었지만 문제의 주요 원인은 모든 구성 요소에 공통적으로 적용됩니다.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 서식 있는 텍스트 형식 파일(.rtf), 텍스트 파일(.txt) 또는 Word 문서(.doc)를 열도록 유도할 수 있습니다. 결과적으로 합법적인 파일을 열 때 영향을 받는 구성 요소가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
전자 메일 공격 시나리오에서는 공격자가 사용자에게 합법적인 서식 있는 텍스트 형식 파일(.rtf), 텍스트 파일(.txt) 또는 Word 문서(.doc) 첨부 파일을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 첨부 파일을 디렉터리에 저장한 후 열도록 유도하여 이 취약점을 악용할 수 있습니다. 결과적으로 합법적인 파일을 열 때 영향을 받는 구성 요소가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
네트워크 공격 시나리오에서는 공격자가 합법적인 서식 있는 텍스트 형식 파일(.rtf), 텍스트 파일(.txt) 또는 Word 문서(.doc)와 특수하게 조작된 DLL 파일을 네트워크 공유, UNC 또는 WebDAV 위치에 넣은 후 사용자가 열도록 유도할 수 있습니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Windows 구성 요소가 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다. 또한 외부 라이브러리의 로드를 제한하도록 레지스트리 키 항목을 수정합니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-1991](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991)이 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2570947$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2570947">Microsoft 기술 자료 문서 2570947</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">
컴퓨터가 x초 후 다시 시작한다는 타이머 경고가 있는 대화 상자를 사용자에게 표시합니다. (기본 설정은 30초) **/quiet** 스위치 또는 **/passive** 스위치와 함께 사용하도록 되어 있습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
이 보안 업데이트를 설치할 때 설치 관리자는 해당 컴퓨터에서 하나 이상의 업데이트할 파일이 Microsoft *핫픽스*에 의해 이미 업데이트되었는지 확인합니다.
...
-   V2.0(2011년 11월 8일): 이 공지는 Windows 7 Embedded를 위한 업데이트를 알리기 위해 릴리스되었습니다. 다른 업데이트 패키지는 이 발표의 영향을 받지 않습니다.
