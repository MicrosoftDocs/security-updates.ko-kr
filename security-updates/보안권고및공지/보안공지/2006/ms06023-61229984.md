...
**주의 사항:** Microsoft는 이 업데이트를 [Microsoft 보안 공지 MS06-021: Internet Explorer 누적 보안 업데이트 (916281)](http://technet.microsoft.com/security/bulletin/ms06-021)에 포함된 업데이트에 대한 보조 업데이트로 제공합니다. 상기 보안 공지의 보안 업데이트는 이 취약점을 노출하거나 응용 프로그램 호환성 문제를 일으킬 수 있으므로 위의 업데이트와 동시에 이 업데이트를 설치할 것을 권장합니다.
...
-   Microsoft Windows 2000 서비스 팩 4의 Microsoft JScript 5.1 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=23e79abd-b1fe-4734-b3d3-fb53d286c06f)
-   Windows 2000 서비스 팩 4의 Microsoft JScript 5.6 및 5.5 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=16dd21a1-c4ee-4eca-8b80-7bd1dfefb4f8)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2의 Microsoft JScript 5.6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=d28c02be-cac3-4579-9b93-939fd5d3cde6)
-   Microsoft Windows XP Professional x64 Edition의 Microsoft JScript 5.6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=2ee3dd28-7167-4a2c-941d-a236f8cc5c4b)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1의 Microsoft JScript 5.6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=8963ae25-2230-47fe-aece-49d7457d96d4)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용)의 Microsoft JScript 5.6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=7764c7dc-a7e4-4b91-95c2-ef7d4dce0a00)
-   Microsoft Windows Server 2003 x64 Edition의 Microsoft JScript 5.6 - [업데이트 다운로드](http://www.microsoft.com/downloads/details.aspx?familyid=bcf7ab2e-ee1c-45f9-8b1c-4b1cef683082)
...
|--------------------------------------------------------------------------------------------------------------------------------|----------------------|-----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| Microsoft JScript 메모리 손상 취약점 - [CVE-2006-1313 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1313) | 원격 코드 실행       | 긴급                  | 긴급         | 긴급                   | 긴급                   | 보통                | 보통                            |
...
JScript는 Microsoft에서 ECMA 262 언어 사양(ECMAScript Edition 3)을 구현한 것입니다. 또한 JScript는 인터프리터 방식의 개체 기반 스크립트 언어입니다. 자세한 내용은 [제품 설명서 (영문)](http://msdn.microsoft.com/library/en-us/dnanchor/html/scriptinga.asp)를 참조하십시오.
...
아니요. Microsoft는 이 업데이트를 [Microsoft 보안 공지 MS06-021: Internet Explorer 누적 보안 업데이트 (916281)](http://technet.microsoft.com/security/bulletin/ms06-021)에 포함된 업데이트에 대한 보조 업데이트로 제공합니다. 상기 보안 공지의 보안 업데이트는 이 취약점을 노출하거나 응용 프로그램 호환성 문제를 일으킬 수 있으므로 위의 업데이트와 동시에 이 업데이트를 설치할 것을 권장합니다.
