...
이 보안 업데이트는 [Microsoft 보안 권고 969136](http://technet.microsoft.com/security/advisory/969136)에서 처음 설명한 취약점도 해결합니다.

**권장 사항.** 고객은 업데이트를 즉시 적용하는 것이 좋습니다.

**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 967340](http://support.microsoft.com/kb/967340)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=11f8380f-ffb6-4c22-a89c-3dc55d0f9834&displaylang=ko)\*  
(KB957789)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=11f8380f-ffb6-4c22-a89c-3dc55d0f9834&displaylang=ko)  
(KB957789)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 1용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a&displaylang=ko)  
(KB969618)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](http://www.microsoft.com/downloads/details.aspx?familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a&displaylang=ko)  
(KB969618)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
Microsoft Office 2004 for Mac(KB969661), Microsoft Office 2008 for Mac(KB971822) 및 Open XML File Format Converter for Mac (KB971824)에 대한 이 공지(MS09-017)의 보안 업데이트 패키지는 [MS09-021](http://go.microsoft.com/fwlink/?linkid=147294) 및 [MS09-027](http://go.microsoft.com/fwlink/?linkid=147416)에 설명되어 있는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac 또는 Open XML File Format Converter for Mac이 설치된 사용자는 이 업데이트 패키지를 한 번만 설치하면 됩니다.

**MS09-024도 Microsoft Works 8.5 및 Microsoft Works 9의 취약점에 대해 설명하고 있습니다. MS09-024는 이 공지(MS09-017)와 어떤 관련이 있습니까?**  
Microsoft Works 8.5 (KB967043) 및 Microsoft Works 9 (KB967044)에 대한 이 공지(MS09-017)의 보안 업데이트 패키지는 [MS09-024](http://go.microsoft.com/fwlink/?linkid=128104)에 설명되어 있는 취약점도 해결합니다. Microsoft Works 8.5 또는 Microsoft Works 9가 설치된 사용자는 이 업데이트 패키지를 한 번만 설치하면 됩니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 967340](http://support.microsoft.com/kb/967340)에 나와 있습니다.
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [5월 공지 요약](http://technet.microsoft.com/security/bulletin/ms09-may)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](http://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0221 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0221)을 참조하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.**
    ...
    **대안의 영향:** 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 970980](http://support.microsoft.com/kb/970980)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는 2007 Microsoft Office System에서 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0222 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0222)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0223 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0223)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0224 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0224)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0225 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0225)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0226 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0226)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0227 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0227)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0556 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556)을 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-0556 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 969136](http://technet.microsoft.com/security/advisory/969136)에서 처음 설명되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1128 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1128)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1129 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1129)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1130 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1130)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1131 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1131)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1137 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1137)을 참조하십시오.
...
MBSA 2.1, Microsoft Update 및 Windows Server Update Services에서 지원하지 않는 구형 소프트웨어를 사용하는 고객을 위한 **참고**: [Microsoft Baseline Security Analyzer](http://technet.microsoft.com/ko-kr/security/cc184924.aspx)를 방문하고 구형 제품 지원 섹션을 참조하여 구형 도구로 종합 보안 업데이트 검색을 만드는 방법을 찾으십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/967340">Microsoft 기술 자료 문서 967340</a> 참조</td>
</tr>
<tr class="even">
...
Microsoft Office 2004 for Mac 11.5.5 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=5557bfb7-ebb4-4c42-8042-41e830c4e550)에서 다운로드하여 설치하십시오.
...
이 업데이트의 다운로드 또는 사용과 관련하여 기술적인 문의 사항이나 문제가 있는 경우 [Microsoft for Mac Support](http://www.microsoft.com/mac/support.aspx)를 방문하여 사용 가능한 지원 옵션을 살펴보십시오.
...
Microsoft Office 2004 for Mac 12.1.9 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=58326da2-eb75-4b42-b1bc-e70319defb58)에서 다운로드하여 설치하십시오.
...
[Microsoft 다운로드 센터](http://www.microsoft.com/downloads/details.aspx?familyid=9d6d9eaa-8442-4184-8886-faab2803bde6)에서 Open XML File Converter for Mac 1.0.3 업데이트를 다운로드하여 설치하십시오.
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Works 8.5:<br />
<a href="http://support.microsoft.com/kb/967043">Microsoft 기술 자료 문서 967043</a> 참조<br />
<br />
Microsoft Works 9:<br />
<a href="http://support.microsoft.com/kb/967044">Microsoft 기술 자료 문서 967044</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   구형 파일 형식 취약점(CVE-2009-0220)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자  
-   정수 오버플로 취약점(CVE-2009-0221)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   구형 파일 형식 취약점(CVE-2009-0222)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   구형 파일 형식 취약점(CVE-2009-0223)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Marsu Pilami  
-   메모리 손상 취약점(CVE-2009-0224)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   PP7 메모리 손상 취약점(CVE-2009-0225)을 보고해 주신 [VUPEN Security (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   구형 파일 형식 취약점(CVE-2009-0226)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Marsu Pilami  
-   구형 파일 형식 취약점(CVE-2009-0227)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Marsu Pilami  
-   메모리 손상 취약점(CVE-2009-0556)을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)의 Marsu Pilami  
-   PP7 메모리 손상 취약점(CVE-2009-1128)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Marsu Pilami  
-   PP7 메모리 손상 취약점(CVE-2009-1129)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Marsu Pilami  
-   힙 손상 취약점(CVE-2009-1130)을 [TippingPoint (영문)](http://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [team509 (영문)](http://www.team509.com/)의 Ling 및 Wushi와 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   데이터 범위 초과 취약점(CVE-2009-1131)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten H. Eiram  
-   구형 파일 형식 취약점(CVE-2009-1137)을 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)와 협력하여 보고해 주신 익명 연구자
