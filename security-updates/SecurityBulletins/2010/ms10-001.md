---
TOCTitle: 'MS10-001'
Title: 'Microsoft 보안 공지 MS10-001 - 긴급'
ms:assetid: 'ms10-001'
ms:contentKeyID: 61230261
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-001(v=Security.10)'
---

Microsoft 보안 공지 MS10-001 - 긴급
===================================

Embedded OpenType 글꼴 엔진의 취약점으로 인한 원격 코드 실행 문제점(972270)
---------------------------------------------------------------------------

게시된 날짜: 2010년 1월 13일 수요일 | 업데이트된 날짜: 2011년 1월 20일 목요일
...
이 보안 업데이트의 심각도는 Microsoft Windows 2000에 대해 긴급이며 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에 대해 낮음입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Embedded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 특수하게 조작된 파일과 콘텐츠의 압축을 해제하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 972270](https://support.microsoft.com/kb/972270)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=47f85cbd-282e-4c92-9809-68bba49e0a12&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=793a6b3f-7660-40be-b7d5-7b0eec55e1cd&displaylang=ko)                                                          | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=31609ce9-656a-4f7d-a501-709a31ca34c3)                                                                          | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e1d6e338-dea9-458e-b35d-796e069d74d7&displaylang=ko)                                                                           | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ddbcf231-9fde-4dc2-ad04-a01b69d1a980&displaylang=ko)                                                               | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c71a13cf-7e2f-4b02-8684-1a4e4b46ddda)                                                                      | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6387228c-eedc-4511-b3c6-8922606f4c84&displaylang=ko)                                     | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7b4f5089-13b1-421b-a00b-22632bba4229&displaylang=ko) | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e175c436-37e0-497f-8b7f-6cacaa25ad7c&displaylang=ko)\*                | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1b10a177-fd45-406f-8edc-b8d4b84881b7&displaylang=ko)\*            | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e8bc9a24-a794-4827-a6bb-785c6b2189f4)                     | 원격 코드 실행 | 낮음        | [MS09-029](https://technet.microsoft.com/security/bulletin/ms09-029) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=75491ad0-40a6-4efb-9574-d82210f6d0da&displaylang=ko)                                                                                | 원격 코드 실행 | 낮음        | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=8a53f0e9-0616-440e-90f2-a12524e1bee4&displaylang=ko)                                                                              | 원격 코드 실행 | 낮음        | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=308166e4-571b-4d6c-bd9f-3ed4afa4eafe&displaylang=ko)\*                                                               | 원격 코드 실행 | 낮음        | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1d0da42b-9755-4fd2-afd1-0d023d187133)                                                                            | 원격 코드 실행 | 낮음        | 없음                                                                |
...
**이 취약점의 심각도가 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2에 대해 낮음인 이유는 무엇입니까?**  
이러한 Windows 운영 체제에는 취약한 코드가 포함되어 있지만 취약점을 노출할 수 있는 방식으로 이 코드를 사용하지 않습니다. Microsoft는 취약한 코드를 사용하는 타사 구성 요소를 보고 받은 바 없지만 이론적으로는 이러한 구성 요소가 있을 수 있습니다.

**이 업데이트에 기능에 대한 다른 비보안 관련 변경 사항이 포함되어 있습니까?**  
이 업데이트에는 보안과 관련이 없는 기능 변경 사항이 포함되어 있습니다. 자세한 내용은 [Microsoft 기술 자료 문서 978909](https://support.microsoft.com/kb/978909)를 참조하십시오.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [1월 공지 요약](https://technet.microsoft.com/security/bulletin/ms10-jan)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스 (영문)](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<th style="border:1px solid black;" >LZCOMP Decompressor의 Microtype Express 압축 폰트 정수 결함 취약점(CVE-2010-0018)</th>
...
LZCOMP Decompressor의 Microtype Express 압축 폰트 정수 결함 취약점(CVE-2010-0018)  
---------------------------------------------------------------------------------
  

Microsoft Windows EOT(Embedded OpenType) 글꼴 엔진이 특수하게 조작된 EOT 글꼴의 압축을 해제하는 방식에 원격 코드 실행 취약점이 존재합니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0018 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0018)을 참조하십시오.
  
#### LZCOMP Decompressor의 Microtype Express 압축 폰트 정수 결함 취약점(CVE-2010-0018)에 대한 완화 요소
...
#### LZCOMP Decompressor의 Microtype Express 압축 폰트 정수 결함 취약점(CVE-2010-0018)에 대한 대안
...
#### LZCOMP Decompressor의 Microtype Express 압축 폰트 정수 결함 취약점(CVE-2010-0018)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점의 원인은 Microsoft Windows 구성 요소인 Embeded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 특수하게 조작된 파일과 콘텐츠의 압축을 해제할 때 발생하는 정수 오버플로입니다.
  
**EOT(Embedded OpenType) 글꼴이란 무엇입니까?**    
EOT(Embedded OpenType) 글꼴은 문서나 웹 페이지에 포함하는 데 사용되는 압축 형태의 글꼴입니다. 이러한 글꼴은 Word .doc 파일과 같은 특정 문서 형식으로 포함되거나 웹 서버에 있는 .eot 파일에 대한 링크를 사용하여 웹 페이지에 포함될 수 있습니다. EOT 글꼴을 사용할 경우 사용자는 작성자가 의도한 대로 정확히 문서를 보게 됩니다. 웹 작성자는 WEFT(Web Embedding Fonts Tool)를 사용하여 브라우저를 통해 본 페이지가 글꼴 개체에 포함된 스타일로 표시되도록 웹 페이지에 연결된 글꼴 개체를 만들 수 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보(영문)](https://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 플랫폼은 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Embedded OpenType 글꼴 엔진이 포함 글꼴을 포함하는 특수하게 조작된 파일과 콘텐츠의 압축을 해제하는 방식을 수정하여 문제점을 해결합니다.
...
<td style="border:1px solid black;">Windows2000-KB972270-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-KB972270-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB972270$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/972270">Microsoft 기술 자료 문서 972270</a> 참조</td>
</tr>
<tr class="even">
...
WindowsXP-KB972270-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB972270-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
WindowsServer2003-KB972270-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB972270-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB972270-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB972270-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   LZCOMP Decompressor의 Microtype Express 압축 폰트 정수 결함 취약점(CVE-2010-0018)을 보고해 주신 [Google Inc.](https://www.google.com/)의 Tavis Ormandy
...
-   V1.0(2010년 1월 13일): 공지가 게시되었습니다.  
-   V1.1(2011년 1월 20일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 972270 링크가 추가되었습니다.
