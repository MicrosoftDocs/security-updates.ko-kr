---
TOCTitle: 'MS08-062'
Title: 'Microsoft 보안 공지 MS08-062 - 중요'
ms:assetid: 'ms08-062'
ms:contentKeyID: 61230170
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-062(v=Security.10)'
---

Microsoft 보안 공지 MS08-062 - 중요
===================================
...
이 업데이트의 심각도는 지원되는 모든 Microsoft Windows 2000, Windows XP, Windows Server 2003 및 Windows Server 2008 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 IPP(인터넷 인쇄 프로토콜) 서비스 내에 메모리가 할당되는 방식을 변경하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=8163d1f6-feb5-4f39-8134-3ed42326b822&displaylang=ko)                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=e7ef571f-c9e8-4e14-95a3-3eeaec55b784&displaylang=ko)                                    | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3ae4b913-bff0-4974-b198-828ca10d2a87)             | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=437a9b68-6a0c-48c8-9348-0d6fda48aa21&displaylang=ko)                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d3df6508-a568-449d-ac97-fbf3f97b98ef&displaylang=ko)      | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 SP1 (Itanium 기반 시스템용) 및 Windows Server 2003 SP2 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=748f54f1-40b9-407c-9819-909061b53743) | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=9b5995df-a3b8-4e81-b118-9bb057e19884&displaylang=ko)                                          | 없음           | 없음        | 없음                      |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=4a0fcf4b-eb8e-456a-b934-400ae18248ee)                                 | 없음           | 없음        | 없음                      |
| [Windows Server 2008(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?displaylang=ko&familyid=3d6290d8-1745-4bc0-9ca9-eeb1ad0be4a5)\*                                              | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?displaylang=ko&familyid=a33c833c-d5c5-4e37-8f89-7b9079f92e59)\*                                            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=31783e88-76e2-4bc6-b4ae-308443c6d223&displaylang=ko)                                          | 없음           | 없음        | 없음                      |

**\*Windows Server 2008 Server Core 설치는 영향을 받지 않습니다.** 지원 대상인 Windows Server 2008 에디션에 대해 이 업데이트의 심각도는 Windows Server 2008에 Server Core 설치 옵션의 사용 여부와 상관없이 동일하게 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 [Server Core](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교(영문)](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)를 참조하십시오.

이 보안 업데이트와 관련된 자주 제기되는 질문 사항
-------------------------------------------------

**이 보안 공지가 2008년 10월 30일에 개정된 이유는 무엇입니까?**  
이제 Windows Update, Microsoft Update, WSUS(Windows Software Update Services), Systems Management Server 및 System Center Configuration Manager를 통해 Windows Server 2008(Itanium 기반 시스템용) 및 지원되는 모든 Windows Vista 에디션에 대한 업데이트 패키지를 이용할 수 있음을 고객에게 알리기 위해 이 공지가 개정되었습니다. 처음 이 공지가 발표되었을 때는 이러한 플랫폼에 대한 업데이트를 Microsoft 다운로드 센터에서만 이용할 수 있었습니다.

**이 보안 공지가 2008년 10월 16일에 개정된 이유는 무엇입니까?**  
Windows 인터넷 인쇄 서비스가 시스템 권한으로 실행되는 스풀러 서비스의 컨텍스트에서 실행됨을 알리기 위해 이 공지가 개정되었습니다. 이 보안 공지에 설명된 취약점을 성공적으로 악용하는 공격자는 시스템 권한으로 임의 코드를 실행할 수 있게 되고 영향을 받는 시스템을 완전하게 제어할 수 있게 됩니다.

**이 보안 공지가 2008년 10월 15일에 개정된 이유는 무엇입니까?**  
Windows Server 2008(Itanium 기반 시스템용)에 대한 심각도 등급을 제거하기 위해 이 공지가 개정되었습니다. 또한 Microsoft는 Microsoft 다운로드 센터에서 Windows Server 2008(Itanium 기반 시스템용)에 대한 업데이트가 사용 가능하며 가능한 빨리 기타 배포 채널을 통해 발표할 것을 알리기 위해 이 공지를 업데이트했습니다.

**Windows Server 2008(Itanium 기반 시스템용) 및 Windows** **Vista** **가 심각도가 없음에도 불구하고 영향을 받는 소프트웨어 목록에 나열되어 있는 이유는 무엇입니까?**  
Windows Server 2008(Itanium 기반 시스템용) 및 지원되는 모든 Windows Vista 에디션에는 이 보안 업데이트에서 업데이트된 공유 인쇄 스풀러 구성 요소가 포함되어 있습니다. 그러나 인터넷 인쇄는 Windows Server 2008(Itanium 기반 시스템용) 또는 Windows Vista에서 지원되지 않으므로 이 보안 공지에서 논의된 악용 가능한 경로는 노출되지 않습니다. 나중에 발생 가능한 새로운 경로를 방지하기 위한 심층적인 보안 대응책으로써 Windows Server 2008(Itanium 기반 시스템용) 및 Windows Vista 고객은 보안 업데이트를 적용하는 것이 좋습니다.

**파일 정보 세부 사항은 어디에 있습니까?**  
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 953155](https://support.microsoft.com/kb/953155)에 나와 있습니다.
...
<th style="border:1px solid black;" >IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)</th>
...
IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)  
------------------------------------------------
  
Windows 인터넷 인쇄 서비스를 설정한 상태에서 Microsoft IIS(인터넷 정보 서비스)를 실행하는 Windows 시스템에 원격 코드 실행 취약점이 존재합니다.인증된 공격자는 이 문제를 악용하여 영향을 받는 시스템에 임의의 코드를 원격으로 실행할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1446 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1446)을 참조하십시오.
  
#### IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   인터넷 인쇄 프로토콜(IPP)은 Windows 2000 및 Windows XP용 IIS에서 기본적으로 사용됩니다.그러나 모든 플랫폼에 대해 기본적인 파일 권한이 설정되어 IPP에는 "인증된" 그룹의 사용자만 액세스할 수 있습니다.이런 제한으로 인해 인증 받지 못한 사용자는 기본적으로 이 취약점을 원격으로 악용하는데 필요한 폴더 권한을 갖지 못하게 됩니다.  
-   Windows Server 2003의 IIS 설치에는 이런 기본 구성에 취약점이 없습니다.인터넷 인쇄 프로토콜 ISAPI 필터를 IIS 내에 사용한 Windows Server 2003 설치에만 취약점이 있습니다.인터넷 인쇄 및 ASP(Active Server Page) 구성 요소는 웹 기반 프린터 관리 및 인터넷 인쇄를 사용하기 위해 필요합니다.ASP(Active Server Page) 구성 요소가 "허용"으로 설정되어 있고 인터넷 인쇄 구성 요소가 "금지"로 설정된 경우 웹 기반 프린터 관리만 사용할 수 있습니다. 사용자는 인터넷 인쇄를 통해 공유 프린터에 연결할 수 없습니다.  
-   Windows Server 2008의 IIS 설치에는 기본적으로 취약점이 없습니다.Windows Server 2008을 실행하는 컴퓨터는 인터넷 인쇄를 사용하는 클라이언트 컴퓨터로 사용할 수 있습니다. 인쇄 요청을 하는 컴퓨터 사용자는 인쇄 서버에 연결된 프린터를 사용하기 전에 이 서버의 인증을 받아야 합니다. Windows Server 2008을 실행하는 컴퓨터를 인터넷 인쇄를 지원하는 서버로 사용하려면 웹 서버(IIS) 역할과 인쇄 서버 역할을 설치하고 인쇄 서비스 역할에 인터넷 인쇄 역할 서비스를 설치해야 합니다.  
-   이 취약점을 악용하려면 IIS 서버가 악성 컴퓨터의 포트 445로 아웃바운드 통신을 해야 합니다. IIS 서버와 인터넷 간의 아웃바운드 SMB 연결을 차단하는 관리자는 신뢰할 수 없는 시스템에서 이런 취약점을 악용하지 못하도록 만들 수 있습니다.
  
#### IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **IPP 서비스 사용 안 함**
  
    IIS 5.0 및 IIS 5.1에서 IPP 서비스를 사용하지 않으려면 다음 단계를 따르십시오.
  
    1.  **인터넷 서비스 관리자**를 엽니다.  
    2.  **기본 웹사이트**를 마우스 오른쪽 단추로 클릭한 후 **속성**을 선택합니다.  
    3.  **홈 디렉터리** 탭으로 이동한 후 **구성**을 선택합니다.  
    4.  아래로 스크롤하여 **.printer** 확장명과 **msw3prt.dll** 경로를 찾습니다.  
    5.  **제거**를 클릭합니다.  
    6.  **확인**을 클릭합니다.  
    7.  IIS 서비스를 다시 시작합니다.
  
    **참고** 그룹 정책 및 인터넷 서비스 관리자를 통해 인터넷 인쇄를 구성할 수 있습니다. 그룹 정책 설정과 인터넷 서비스 관리자 간에 충돌이 있는 경우 그룹 정책 설정이 우선합니다. 인터넷 서비스 관리자를 통해 인터넷 인쇄를 제거할 경우 로컬 또는 도메인 그룹 정책에서 다시 사용하도록 설정하지 않았는지 확인하십시오. (기본 그룹 정책에는 인터넷 인쇄에 대한 설정이 없습니다.) MMC 그룹 정책 스냅인에서 컴퓨터 구성 | 관리 템플릿 | 인쇄 |웹 기반 인쇄를 확인하십시오.
  
    IIS 6.0에서 IPP 서비스를 사용하지 않으려면
  
    1.  **IIS 관리자**나 **IIS 스냅인**을 시작합니다.  
    2.  **\* server\_name**을 확장합니다. 여기서 server\_name은 서버의 이름입니다.  
    3.  **웹 서비스 확장**을 클릭합니다.  
    4.  오른쪽 창에서 **인터넷 인쇄**를 클릭한 후 **금지**를 클릭합니다.  
    5.  IIS 관리자를 종료합니다.
  
    Windows Server 2008의 IIS 7.0에서 IPP 서비스를 사용하지 않으려면 다음 단계를 따르십시오.
  
    1.  **서버 관리자**가 실행 중이 아니면 **시작**, **관리 도구**, **서버 관리자**를 차례로 클릭합니다. (**사용자 계정 컨트롤** 대화 상자가 나타나면 표시되는 조치가 원하는 조치인지 확인한 후 **계속**을 클릭합니다.)  
    2.  역할 노드를 확장한 다음 **인쇄 서비스**를 마우스 오른쪽 단추로 클릭하고 **역할 서비스 제거**를 선택합니다.  
    3.  역할 서비스 제거 마법사가 나타납니다. **인터넷 인쇄** 옵션이 선택되어 있는 경우 확인란의 선택을 취소한 후 **다음**을 클릭하고 **제거**를 클릭하여 마법사를 완료합니다.
  
    **대안의 영향.** 사용자는 인터넷 인쇄를 통해 모든 공유 프린터에 연결할 수 없습니다.
  
    **대안 실행 취소 방법.**
  
    IIS 5.0 및 IIS 5.1에서 IPP 서비스를 사용하려면 다음 단계를 따르십시오.
    ...
    4.  아래로 스크롤하여 **.printer** 확장명과 **msw3prt.dll** 경로를 찾습니다.  
    5.  **추가**를 클릭합니다.  
    6.  **실행 파일**이 표시된 필드에 다음을 입력합니다.  
        %systemroot%\\system32\\msw3prt.dll  
    7.  **확장명**이 표시된 필드에는 다음을 입력합니다.  
        .printer  
    8.  **다음으로 제한**이 표시된 필드에는 다음을 입력합니다.  
        GET,POST  
    9.  입력이 끝났으면 IIS 서비스를 다시 시작합니다.
  
    IIS 6.0에서 IPP 서비스를 사용하려면 다음 단계를 따르십시오.
  
    1.  **IIS 관리자**나 **IIS 스냅인**을 시작합니다.  
    2.  **\* server\_name**을 확장합니다. 여기서 server\_name은 서버의 이름입니다.  
    3.  **웹 서비스 확장**을 클릭합니다.  
    4.  오른쪽 창에서 **인터넷 인쇄**를 클릭한 후 **허용**을 클릭합니다.  
    5.  IIS 관리자를 종료합니다.
  
    IIS 7.0에서 IPP 서비스를 사용하려면 다음 단계를 따르십시오.
  
    1.  **서버 관리자**가 실행 중이 아니면 **시작**, **관리 도구**, **서버 관리자**를 차례로 클릭합니다. (**사용자 계정 컨트롤** 대화 상자가 나타나면 표시되는 조치가 원하는 조치인지 확인한 후 **계속**을 클릭합니다.)  
    2.  역할 노드를 확장한 다음 **인쇄 서비스**를 마우스 오른쪽 단추로 클릭하고 **역할 서비스 추가**를 선택합니다.  
    3.  역할 서비스 추가 마법사가 나타납니다. **인터넷 인쇄** 옵션을 선택한 후 **다음**을 클릭하고 **설치**를 클릭하여 마법사를 완료합니다.
  
-   **IIS 잠금 도구 2.1 실행**
  
    IIS 5.0를 실행하는 Windows 2000, IIS 5.1을 실행하는 Windows XP에서 IIS 잠금 마법사 버전 2.1을 사용하여 인터넷 인쇄를 비롯하여 필요 없는 기능을 사용하지 않도록 설정할 수 있습니다. 이 마법사를 실행하려면 다음 조치를 완료하십시오.
  
    1.  [여기](https://www.microsoft.com/download/details.aspx?familyid=dde9efc0-bb30-47eb-9a61-fd755d23cdec&displaylang=en)에서 IIS 잠금 도구 2.1을 다운로드합니다.  
    2.  다음 중 하나를 수행합니다.  
    ...
    **대안의 영향.**
    ...
    사용자는 인터넷 인쇄를 통해 모든 공유 프린터에 연결할 수 없습니다.IIS 잠금 도구 사용자도 인터넷 인쇄를 통해 공유된 프린터에 연결할 수 없습니다.IIS 잠금 도구에 의한 모든 변경 사항을 보려면 다음의 [MSDN 문서 (영문)](https://msdn.microsoft.com/en-us/library/aa302365.aspx)를 참조하십시오.
  
    **대안 실행 취소 방법.**
  
    IIS 잠금에 의한 변경 사항을 실행 취소하려면 **IISlockd.exe**를 한 번 더 실행한 후 변경 사항을 취소합니다. 실행 취소 작업은 IISLockdown을 실행하기 바로 전의 시스템 상태로 복원합니다. 이에 대한 자세한 내용은 로그 파일 \\WINNT\\System32\\inetsrv\\0blt-log에 기록됩니다. 따라서 IISLockdown을 실행한 후 즉시 시스템을 테스트해야 합니다. 실행을 취소하려면 즉시 취소합니다.
  
    **참고** IIS 잠금의 일부로 설치된 URLScan ISAPI 필터는 실행 취소 과정에서 제거되지 않습니다. 인터넷 서비스 관리자의 서버 수준에서 ISAPI 필터 탭을 사용하여 URLScan을 수동으로 제거할 수 있습니다.
  
#### IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이것은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
IPP(인터넷 인쇄 프로토콜) 기능은 IIS용 ISAPI 확장으로 구현됩니다. IIS를 실행 중인 Windows 서버에 Microsoft IPP를 구현하면 원격으로 인증 받는 취약점이 발생합니다. IPP 구현에는 인증된 공격자가 영향을 받는 IIS 서버에 원격 코드 실행을 수행할 수 있는 정수 오버플로가 존재합니다.
  
**ISAPI이란 무엇입니까?**  
ISAPI(Internet Services Application Programming Interface)는 웹 개발자가 웹 서버에 새 서비스를 제공하는 사용자 지정 코드를 작성하여 자신의 웹 서버의 기능을 확장할 수 있는 기술입니다. 사용자 지정 코드는 새 기능이 낮은 수준의 서비스를 제공하는 경우 ISAPI 필터, 높은 수준의 서비스를 제공하는 경우 ISAPI 확장에 구현할 수 있습니다. 이 경우 영향 받는 코드는 ISAPI 확장입니다.
  
**여기서 문제가 되는 ISAPI 확장은 무엇입니까?**  
영향 받는 ISAPI 확장은 RFC 2910 및 2911에 정의된 산업 표준인 인터넷 인쇄 프로토콜(IPP)을 구현하는 확장입니다. IPP는 HTTP를 사용한 인터넷을 통해 인쇄 서비스를 요청하고 인쇄 작업의 상태를 확인하는 방법을 제공합니다. 예를 들어, IPP를 사용하는 이동 중인 사용자는 인터넷을 통해 회사 네트워크에 있는 프린터로 인쇄하는 인쇄 작업을 전송할 수 있습니다. 또한 인쇄 작업이 오류 없이 무사히 완료되었는지도 확인할 수 있습니다.
  
Microsoft Windows 2000에는 인터넷 인쇄를 위한 고유 지원이 사용되었습니다. Microsoft Windows 2000 구현에서 사용자는 직접 URL로 인쇄하고 브라우저를 통해 인쇄 작업의 정보를 확인할 수 있습니다. 인터넷 인쇄를 위한 지원은 Microsoft Windows 2000 Server 버전에서 기본적으로 사용 가능합니다. 또한 Microsoft Windows 2000 Professional, Windows XP, Windows Server 2003 및 Windows Server 2008에 별도의 구성 요소로도 설치 가능합니다.
...
공격자는 취약한 웹 서버에 특수하게 조작된 HTTP POST 요청을 전송하여 서버가 공격자가 제어하는 컴퓨터에 연결되어 IPP를 통해 프린터로 동작하도록 만들 수 있습니다. 그런 다음 공격자는 특수하게 조작된 응답을 사용하여 대상 서버에서 원격 코드 실행을 수행할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
인터넷 인쇄 프로토콜(IPP) 서비스가 사용되는 IIS를 실행하는 워크스테이션과 서버는 주로 이런 취약점을 갖고 있습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
이 보안 업데이트는 인터넷 인쇄 프로토콜(IPP) 서비스 내의 원격 컴퓨터로부터 수신되는 데이터의 유효성을 검증하여 이 취약점을 해결합니다.
...
예, Microsoft는 이 취약점을 악용하려는 공격에 대한 보고를 받았습니다.Microsoft는 이 보안 공지를 처음에 게시했을 때 개념 증명 코드의 예제를 보지 못했습니다.
...
Windows2000-kb953155-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
Windows2000-kb953155-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB953155$Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953155">Microsoft 기술 자료 문서 953155</a> 참조</td>
</tr>
<tr class="even">
...
Windowsxp-kb953155-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb953155-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB953155$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953155">Microsoft 기술 자료 문서 953155</a> 참조</td>
...
Windowsserver2003-kb953155-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB953155-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb953155-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB953155-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;">다시 시작 필요 여부</td>
<td style="border:1px solid black;">예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.
<strong>참고</strong> Windows Server 2003에서 IIS 서비스를 중지하고 업데이트를 설치한 다음 IIS 서비스를 다시 시작하면 시스템 다시 시작을 방지할 수 있습니다. 업데이트를 설치하기 전에 IIS 서비스를 중지하지 않으면 시스템을 다시 시작해야 합니다.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">핫패칭</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\\$NTUninstallKB953155$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953155">Microsoft 기술 자료 문서 953155</a> 참조</td>
...
-   IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)을 보고한 [CERT/CC (영문)](https://www.cert.org/)
...
-   V2.0(2008년 10월 16일): Windows Server 2008(Itanium 기반 시스템용)에 대한 심각도 등급이 제거되었습니다. 심각도 등급이 변경된 이유를 설명하고 Microsoft 다운로드 센터에서 Windows Server 2008(Itanium 기반 시스템용)에 대한 업데이트를 사용할 수 있다는 것을 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목을 추가했습니다. 또한 **검색, 배포 도구 및 지침** 섹션에서 Windows Server 2008(Itanium 기반 시스템)에 대한 Microsoft Baseline Security Analyzer 및 Systems Management Server 배포 요약이 "아니요"로 변경되었습니다. 보안 업데이트 바이너리에 대한 변경 사항은 없습니다.  
-   V2.1(2008년 10월 17일): Windows 인터넷 인쇄 서비스가 시스템 권한으로 실행되는 스풀러 서비스의 컨텍스트에서 실행됨을 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**에 항목을 추가하였습니다. 또한 **요약** 및 **IPP 서비스의 정수 오버플로 취약점(CVE-2008-1446)에 대한 FAQ** 섹션에서 사용자 권한에 대한 참조가 제거되었습니다.  
-   V2.2(2008년 10월 30일): 이제 Windows Update, Microsoft Update, WSUS(Windows Software Update Services), Systems Management Server 및 System Center Configuration Manager를 통해 Windows Server 2008(Itanium 기반 시스템용) 및 지원되는 모든 Windows Vista 에디션에 대한 업데이트 패키지를 이용할 수 있음을 고객에게 알리기 위해 **이 보안 업데이트와 관련된 자주 제기되는 질문 사항**의 항목 및 **검색, 배포 도구 및 지침** 섹션의 MBSA(Microsoft Baseline Security Analyzer), SMS(Systems Management Server) 검색 및 배포 표의 항목이 개정되었습니다.
