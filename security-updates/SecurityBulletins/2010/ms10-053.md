...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1258 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1258)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2556 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2556)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2557 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2557)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2558 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2558)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2559 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2559)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2560 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2560)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2183461">Microsoft 기술 자료 문서 2183461</a> 참조</td>
</tr>
<tr class="even">
...
-   이벤트 처리기 도메인 간 취약점(CVE-2010-1258)을 보고해 주신 [Google Inc.](http://www.google.com/)의 David Bloom  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-2556)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com)의 Nicolas Joly  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-2557)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   경쟁 조건 메모리 손상 취약점(CVE-2010-2558)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly  
-   초기화되지 않은 메모리 손상 취약점(CVE-2010-2559)을 보고해 주신 Gambino ZaDarkSide  
-   HTML 레이아웃 메모리 손상 취약점(CVE-2010-2560)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](http://www.vupen.com/)의 Nicolas Joly
