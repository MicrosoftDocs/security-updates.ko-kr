...
<td style="border:1px solid black;">
[MS13-021](http://go.microsoft.com/fwlink/?linkid=279923)의 2809289 및  
[MS13-010](http://go.microsoft.com/fwlink/?linkid=275837)의 2797052
</td>
</tr>
...
<td style="border:1px solid black;">
[MS13-021](http://go.microsoft.com/fwlink/?linkid=279923)의 2809289
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Windows 7용 Internet Explorer 10 Release Preview는 이 권고에서 해결된 취약점의 영향을 받습니까?  
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [4월 공지 요약](http://technet.microsoft.com/security/bulletin/ms13-apr)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
| 취약점 제목                           | CVE 번호                                                                               |
|---------------------------------------|----------------------------------------------------------------------------------------|
| Internet Explorer 해제 후 사용 취약점 | [CVE-2013-1303](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1303)(영문) |
| Internet Explorer 해제 후 사용 취약점 | [CVE-2013-1304](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1304)(영문) |
| Internet Explorer 해제 후 사용 취약점 | [CVE-2013-1338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1338)(영문) |
...
| CVE 번호                                                                               | 공개됨 |
|----------------------------------------------------------------------------------------|--------|
| [CVE-2013-1303](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1303)(영문) | 아니요 |
| [CVE-2013-1304](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1304)(영문) | 아니요 |
| [CVE-2013-1338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1338)(영문) | 아니요 |
...
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 6:<br />
제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2817183$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 7:<br />
제어판의 프로그램 추가/제거 항목 또는 %Windir%\ie7updates\KB2817183-IE7\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 에디션용 Internet Explorer 8:<br />
제어판의 프로그램 추가/제거 항목 또는 %Windir%\ie8updates\KB2817183-IE8\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2817183">Microsoft 기술 자료 문서 2817183</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2817183-x86-ENU.exe</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
| 파일 정보           | [Microsoft 기술 자료 문서 2817183](http://support.microsoft.com/kb/2817183) 참조                                                    |
...
-   Internet Explorer 해제 후 사용 취약점(CVE-2013-1338)을 [HP](http://www.hpenterprisesecurity.com/products)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)(영문)와 협력하여 보고해 주신 익명 연구자  
...
-   V1.1(2013년 4월 25일): CVE-2013-1338이 이 업데이트에서 해결하는 취약점으로 추가되었습니다. 또한 업데이트 대체가 수정되었고 이 업데이트가 MS13-010을 대체하는 이유에 대한 설명이 추가되었습니다. 이 변경 사항은 정보에만 해당됩니다.
