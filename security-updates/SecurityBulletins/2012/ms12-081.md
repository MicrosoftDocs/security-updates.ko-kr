---
TOCTitle: 'MS12-081'
Title: 'Microsoft 보안 공지 MS12-081 - 긴급'
ms:assetid: 'ms12-081'
ms:contentKeyID: 61230548
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-081(v=Security.10)'
---

Microsoft 보안 공지 MS12-081 - 긴급
===================================

Windows 파일 처리 구성 요소의 취약점으로 인한 원격 코드 실행 문제점 (2758857)
-----------------------------------------------------------------------------

게시된 날짜: 2012년 12월 12일 수요일 | 업데이트된 날짜: 2013년 5월 23일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해 긴급입니다. Windows 8, Windows Server 2012 및 Window RT는 이 취약점의 영향을 받지 않습니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 특수하게 조작된 이름을 가진 파일이 Windows에서 처리되는 방식을 수정함으로써 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2758857](https://support.microsoft.com/kb/2758857)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
[Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=f189ee1c-1457-4d50-87cd-5be268b04f16&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS07-035](https://go.microsoft.com/fwlink/?linkid=91397)의 KB935839는 KB2758857로 대체되었습니다.
</td>
</tr>
<tr>
<th colspan="4">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2242a927-cafb-41eb-8bf2-01302b5a5d94&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4d97b0a5-1ba7-44f0-88b6-1e0a8039b9b1&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ebd25f89-e6d9-4c48-a673-f665d189905c&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)의 KB2533623은 KB2758857로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e7629d85-5c18-4979-a8e2-054a6175cf21&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ced1ffc6-7d30-480a-a3e0-8071981d1863&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b9a687e6-9ab7-4dae-9771-5f7bb3123e06&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=cdaae723-6287-4607-9dc2-c23e1fb31f80&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS11-063](https://go.microsoft.com/fwlink/?linkid=221864)의 KB2567680은 KB2758857로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=cdaae723-6287-4607-9dc2-c23e1fb31f80&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4a389411-bf52-4cb2-9051-ba7344b58474&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=4a389411-bf52-4cb2-9051-ba7344b58474&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9e06181f-de06-423b-bbeb-df1f451fb817&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=9e06181f-de06-423b-bbeb-df1f451fb817&displaylang=ko)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ced1ffc6-7d30-480a-a3e0-8071981d1863&displaylang=ko)(Server Core 설치)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b9a687e6-9ab7-4dae-9771-5f7bb3123e06&displaylang=ko)(Server Core 설치)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9e06181f-de06-423b-bbeb-df1f451fb817&displaylang=ko)(Server Core 설치)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=9e06181f-de06-423b-bbeb-df1f451fb817&displaylang=ko)(Server Core 설치)  
(KB2758857)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2758857](https://support.microsoft.com/kb/2758857)을 참조하십시오.

Windows 8 Release Preview 및 Windows Server 2012 출시 후보 버전은 이 보안 공지에서 해결된 취약점의 영향을 받습니까?  
예. Windows 8 Release Preview 및 Windows Server 2012 출시 후보 버전에서 KB2758857 업데이트를 사용할 수 있습니다. Windows 8 Release Preview와 Windows Server 2012 출시 후보 버전을 보유한 고객은 시스템에 이 업데이트를 적용하는 것이 좋습니다. 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)에서만 제공됩니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [12월 공지 요약](https://technet.microsoft.com/security/bulletin/ms12-dec)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
Microsoft Windows가 파일 이름을 구문 분석하는 방식에 원격 코드 실행 취약점이 존재합니다. 취약점으로 인해 메모리가 손상되고 공격자가 현재 사용자의 컨텍스트에서 임의 코드를 실행할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-4774](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774)(영문)를 참조하십시오.

#### Windows 파일 이름 구문 분석 취약점(CVE-2012-4774)에 대한 완화 요소
...
#### Windows 파일 이름 구문 분석 취약점(CVE-2012-4774)에 대한 대안

이 취약점에 대한 대안을 확인하지 못했습니다.

#### Windows 파일 이름 구문 분석 취약점(CVE-2012-4774)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다.

취약점의 원인은 무엇입니까?  
이 취약점은 Windows가 특수하게 조작된 파일 또는 하위 폴더 이름을 제대로 처리하지 못해 적절하게 할당되지 않은 메모리에 데이터 복사를 허용할 때 발생합니다.
...
공격자는 사용자가 특수하게 조작된 이름의 파일 또는 하위 폴더가 있는 파일 시스템을 찾아보도록 유인하여 이 취약점을 악용할 수 있습니다.

네트워크 공격 시나리오에서 공격자는 특수하게 조작된 파일 이름을 가진 파일을 네트워크 공유, UNC 공유 또는 WebDAV 위치에서 호스팅한 다음 사용자가 파일을 열도록 유도할 수 있습니다.

전자 메일 공격 시나리오에서 공격자는 특수하게 조작된 파일 또는 하위 폴더를 첨부 파일로 보내 사용자가 이 첨부 파일이 포함된 파일 시스템을 찾아보도록 유인하여 취약점을 악용할 수 있습니다.

웹을 통한 공격의 경우 공격자는 특수하게 조작된 이름을 가진 파일을 포함하는 웹 사이트를 호스팅해야 합니다. 공격자가 강제로 사용자로 하여금 문제의 파일을 호스팅하는 웹 사이트를 방문하도록 할 방법은 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.
...
업데이트는 어떤 기능을 수행합니까?  
이 보안 업데이트는 특수하게 조작된 이름을 가진 파일이 Windows에서 처리되는 방식을 수정함으로써 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2758857$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2758857">Microsoft 기술 자료 문서 2758857</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows 파일 이름 구문 분석 취약점(CVE-2012-4774)을 보고해 주신 [IOActive](https://ioactive.co.uk/)(영문)의 Lucas Apa
...
-   V1.1(2013년 5월 23일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2758857 링크가 추가되었습니다.
