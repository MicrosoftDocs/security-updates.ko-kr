...
예. 이 공지의 취약점 정보 섹션에 나열된 변경 사항 외에도, 이 업데이트에는 OWA(Outlook Web Access)를 사용할 때 중국어 문자 집합 문제를 해결하는 Microsoft Exchange 2000 Server 서비스 팩 3에 대한 심층 보안 변경 사항이 포함되어 있습니다. 이 문제는 Exchange 2000 시스템에만 영향을 미칩니다. Microsoft Exchange 2000 Server 서비스 팩 3용 업데이트를 수행하기 전에 Exchange 2000 Server 서비스 팩 3(SP3) 이후 업데이트 롤업 패치가 필요합니다. 이 보안 공지에서 제공하는 심층 보안 업데이트를 설치하기 전에 Exchange 2000(KB870540)용 업데이트 롤업을 설치해야 합니다. 이 업데이트는 업데이트 롤업이 설치되어 있는지 확인합니다. 업데이트 롤업이 설치되어 있지 않은 경우 다운로드 웹 사이트로 안내를 받게 됩니다. 자세한 내용은 [Microsoft 기술 자료 문서 870540](http://support.microsoft.com/kb/870540)을 참조하십시오. 필수 업데이트를 다운로드하려면 [Exchange 2000용 업데이트 롤업(KB870540)](https://www.microsoft.com/download/details.aspx?familyid=363a57a4-8bed-4bbb-bbe4-abc11ab04611)을 참조하십시오.
