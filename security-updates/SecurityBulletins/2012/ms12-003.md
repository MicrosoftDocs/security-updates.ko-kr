---
TOCTitle: 'MS12-003'
Title: 'Microsoft 보안 공지 MS12-003 - 중요'
ms:assetid: 'ms12-003'
ms:contentKeyID: 61230470
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-003(v=Security.10)'
---


Microsoft 보안 공지 MS12-003 - 중요
===================================
...
보안 업데이트는 CSRSS(Client/Server Run-time Subsystem)가 유니코드 문자를 처리하는 방식을 변경하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=cfc38dc2-c4c7-4a44-8e5a-b98bb9bc0396&displaylang=ko)                               | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3956db98-88d9-49fc-be51-247b40bfc272)                     | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=39f5f8fb-ee4d-4b7a-9cd7-3d1e9c8abd8c&displaylang=ko)                      | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e27d85f8-a285-4e95-85a0-0868286cc2b9&displaylang=ko)          | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b69bd01d-9925-4ff1-bfeb-b4473631578c)                      | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=73682d4b-3179-4488-8ba9-94ed68c4896b&displaylang=ko)                            | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b5c33025-13d9-43d2-a415-a8a4d683a821&displaylang=ko)                | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fbf119cf-a8ed-4266-a673-442149992f7c&displaylang=ko)\*   | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e8e68f89-27f4-4142-94ca-58f086a98157&displaylang=ko)\* | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=fc6491e8-6c3e-43a1-bc56-16c9a2fd2749)              | 권한 상승      | 중요        | [MS11-063](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-063) |
...
1.  시작, 제어판을 차례로 클릭합니다.
2.  국가 및 언어 옵션에서 고급 탭을 클릭합니다.
3.  유니코드를 지원하지 않는 프로그램용 언어
4.  섹션에서 원하는 시스템 로캘을 선택합니다.
...
<th style="border:1px solid black;" >CSRSS 권한 상승 취약점(CVE-2012-0005)</th>
...
CSRSS가 특수하게 조작된 유니코드 문자 시퀀스를 처리하는 방식 때문에 Windows CSRSS에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 로컬 서비스의 보안 컨텍스트에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0005(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0005)를 참조하십시오.
  
#### CSRSS 권한 상승 취약점(CVE-2012-0005)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 또는 원격으로 로그온할 수 있어야 합니다.  
-   이 취약점은 중국어, 일본어 또는 한국어 시스템 로캘로 구성된 시스템에서만 악용될 수 있습니다.
  
#### CSRSS 권한 상승 취약점(CVE-2012-0005)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### CSRSS 권한 상승 취약점(CVE-2012-0005)에 대한 FAQ
  
이 취약점을 악용하면 어느 작업까지 가능합니까?   
이 취약점은 로컬 시스템의 컨텍스트에서 나타나는 권한 상승 취약점입니다.
...
멀티바이트 언어 시스템 로캘(중국어, 일본어 또는 한국어)로 실행되는 워크스테이션 및 터미널 서버가 주로 취약합니다. 관리자가 사용자가 서버에 로그온하여 프로그램을 실행할 수 있도록 허용할 경우, 서버가 더 위험할 수 있습니다. 가장 좋은 방법은 이러한 기능을 허용하지 않는 것입니다.
  
업데이트는 어떤 기능을 수행합니까?   
업데이트는 CSRSS가 유니코드 문자를 처리하는 방식을 해결합니다.
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 항목 또는 %Windir%\$NTUninstallKB2646524$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2646524">Microsoft 기술 자료 문서 2646524</a> 참조</td>
</tr>
<tr class="even">
...
-   CSRSS 권한 상승 취약점(CVE-2012-0005)을 보고해 주신 [Shenzhen Jowto Research Dep(영문)](https://www.jowto.com)의 Kang Wu
