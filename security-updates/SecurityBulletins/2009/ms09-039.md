...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b5b9228a-66c0-49e6-afde-cc2825a6851f&amp;displaylang=ko">Microsoft Windows 2000 Server 서비스 팩 4</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=139821">MS09-008</a><br />
(KB961064만 해당)</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3a8d8ef9-ad41-4237-9cbb-daecfd8f216c&amp;displaylang=ko">Windows Server 2003 서비스 팩 2</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=139821">MS09-008</a><br />
(KB961064만 해당)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e132d051-4444-4ef1-9b6f-2d7da9d2e88e&amp;displaylang=ko">Windows Server 2003 x64 Edition 서비스 팩 2</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=139821">MS09-008</a><br />
(KB961064만 해당)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=96c3f496-7b2f-4dbc-b484-216c9943c2b1">Windows Server 2003 SP2(Itanium 기반 시스템용)</a></td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">긴급</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=139821">MS09-008</a><br />
(KB961064만 해당)</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1923 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1923)을 참조하십시오.
...
**WINS란 무엇입니까?**    
WINS는 NetBT(NetBIOS over TCP/IP)를 지원하도록 특수하게 고안된 프로토콜입니다. 사용자가 리소스에 액세스하는 데 NetBIOS 이름이 필요한 모든 환경에서는 WINS가 필수적입니다. 그러한 네트워크에서 WINS를 사용하지 않으면, 원격 네트워크 리소스에 연결하거나 파일 및 인쇄 공유 연결을 구성하기 위해 LMHOSTS 파일을 사용해야 합니다. 자세한 내용은 [WINS (영문)](https://technet.microsoft.com/en-us/library/cc784180.aspx) TechNet 문서를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1924 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1924)를 참조하십시오.
  
#### WINS 정수 오버플로 취약점(CVE-2009-1924)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   기본 구성에서 이 공격은 신뢰할 수 있는 WINS 복제 파트너로부터 성공적으로 수행될 수 있습니다. 그러나 레지스트리 키 "HKLM\\System\\CCS\\Services\\WINS\\Parameteres\\RplOnlyWCnfPnrs"를 0으로 설정하면 네트워크의 누구라도 이 취약점을 이용할 수 있습니다. 이 레지스트리 키 및 사용 방법에 대한 자세한 설명은 [KB251067](https://support.microsoft.com/kb/251067)을 참조하십시오.  
-   기본적으로 WINS는 영향을 받는 운영 체제 버전에 설치되지 않으며, 이 구성 요소를 수동으로 설치한 고객만 이 문제의 영향을 받습니다.  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다.  
...
| **파일 정보**             | [Microsoft 기술 자료 문서 969883](https://support.microsoft.com/kb/969883) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/969883">Microsoft 기술 자료 문서 969883</a> 참조</td>
</tr>
<tr class="even">
...
-   WINS 힙 오버플로 취약점(CVE-2009-1923)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)
-   WINS 정수 오버플로 취약점(CVE-2009-1924)을 보고해 주신 [National University of Defense Technology (영문)](https://english.nudt.edu.cn/)의 LiGen
