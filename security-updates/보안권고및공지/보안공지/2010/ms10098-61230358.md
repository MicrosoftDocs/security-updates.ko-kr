...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>Win32k 버퍼 오버플로 취약점(CVE-2010-3939)</th>
<th>Win32k PFE 포인터 Double Free 취약점(CVE-2010-3940)</th>
<th>Win32k Double Free 취약점(CVE-2010-3941)</th>
<th>Win32k WriteAV 취약점(CVE-2010-3942)</th>
<th>Win32k 커서 연결 취약점(CVE-2010-3943)</th>
<th>Win32k 메모리 손상 취약점(CVE-2010-3944)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
