...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6&displaylang=ko)                      | 원격 코드 실행 | 중요        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d)            | 원격 코드 실행 | 중요        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c&displaylang=ko)             | 원격 코드 실행 | 중요        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39&displaylang=ko) | 원격 코드 실행 | 중요        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73)             | 원격 코드 실행 | 중요        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2567 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567)을 참조하십시오.
...
-   **방화벽에서 RPC와 관련된 포트 차단**
    ...
    이들 포트는 RPC와 연결을 시작하는 데 사용됩니다. 방화벽에서 이러한 포트를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 또한 원격 시스템에서 특수하게 구성된 다른 모든 RPC 포트도 차단해야 합니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터 원치 않는 들어오는 방향의 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당 (영문)](http://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/982802">Microsoft 기술 자료 문서 982802</a> 참조</td>
</tr>
<tr class="even">
...
-   RPC 메모리 손상 취약점(CVE-2010-2567)을 보고해 주신 [Palo Alto Networks (영문)](http://www.paloaltonetworks.com/)의 Yamata Li
