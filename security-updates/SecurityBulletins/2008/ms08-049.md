---
TOCTitle: 'MS08-049'
Title: 'Microsoft 보안 공지 MS08-049 - 중요'
ms:assetid: 'ms08-049'
ms:contentKeyID: 61230157
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-049(v=Security.10)'
---
...
게시된 날짜: 2008년 8월 13일 수요일 | 업데이트된 날짜: 2008년 9월 10일 수요일
...
이 보안 업데이트의 심각도는 지원되는 모든 Windows 2000, Windows XP, Windows Server 2003, Windows Vista 및 Windows Server 2008 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 이벤트 시스템이 사용자별 가입을 처리하는 방식을 변경하여 취약점을 해결합니다. 이러한 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항.**  이 업데이트를 가능한 빨리 적용하는 것이 좋습니다.

**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 950974 (영문)](https://support.microsoft.com/kb/950974)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 이 업데이트 설치에 대한 자세한 내용은 이 섹션에서 **이 보안 업데이트의 자주 제기되는 질문 사항(FAQ)**을 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=1b2ad648-7dc9-407a-99f6-f39922746027&displaylang=ko)                                                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=01a34aa4-a456-4efc-a93a-c3c682b0181c&displaylang=ko)                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=246b2686-e330-47a2-b4d4-68f218ad4021)           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=92a3d08f-c117-4b24-bc78-2b913d270df6&displaylang=ko)                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows 2003 Server x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6bfbb6d8-5106-4adf-83cb-35ffc6e8eaf8&displaylang=ko)    | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=45356565-697f-41b3-9879-3edd11dbcb7e) | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=6418c78f-f008-4028-beb1-5a5ea8e797a1&displaylang=ko)                                        | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e03ccfb0-3ea3-4c59-adcf-9882d7086013&displaylang=ko)                | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0640f95e-1eee-4dd1-b4dd-2b82b7e984b9&displaylang=ko)\*                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=51a93538-5e94-4f81-a6e0-d497a7b4899d&displaylang=ko)\*                                         | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 (Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=390da130-749d-4890-aad7-be91e15b32bb)                                                      | 원격 코드 실행 | 중요        | 없음                      |
...
**이 공지에서 제공된 업데이트를 Windows** **Vista** **RTM 시스템에 설치하는 데 전제 조건이 있습니까?**  
그렇습니다. Windows Vista RTM 시스템에 이 공지의 업데이트를 설치하려면 먼저 Microsoft 보안 공지 [MS08-008](https://go.microsoft.com/fwlink/?linkid=108277)에서 제공된 업데이트 또는 [Microsoft 기술 자료 문서 938371](https://support.microsoft.com/kb/938371)에서 제공된 업데이트를 설치해야 합니다. Windows Vista RTM 시스템에서 이 공지의 업데이트 설치 안정성을 향상시키려면 이러한 업데이트들이 전제 조건으로 필요합니다. 영향을 받는 소프트웨어에 명시된 Windows Vista 서비스 팩 1을 비롯한 다른 모든 시스템은 유사한 영향을 받지 않으며 이 FAQ 항목에 규정된 전제 조건이 없습니다.
...
<th style="border:1px solid black;" >이벤트 시스템 취약점(CVE-2008-1457)(영문)</th>
<th style="border:1px solid black;" >이벤트 시스템 취약점(CVE-2008-1456)</th>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 SP1(Itanium 기반 시스템용)(영문) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
...
이벤트 시스템 취약점(CVE-2008-1457)  
-----------------------------------
  
Microsoft Windows 이벤트 시스템이 사용자 가입 요청을 만들 때 유효성을 올바르게 확인하지 못하기 때문에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하면 원격 코드 실행이 가능합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1457 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1457)을 참조하십시오.
  
#### 이벤트 시스템 취약점(CVE-2008-1457)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 취약점을 악용하려면 인증을 받아야 합니다.
  
#### 이벤트 시스템 취약점(CVE-2008-1457)에 대한 대안
...
-   **Unregister es.dll**
    ...
    **대안의 영향:** 이벤트 시스템이 실행되지 않게 됩니다.
  
    **대안 실행 취소 방법.** es.dll을 재등록합니다. 명령 프롬프트에 다음 명령을 입력합니다.
  
    regsvr 32 %WINDIR%\\SYSTEM32\\es.dll
  
-   **시스템 이벤트 알림 및 COM+ 이벤트 시스템 서비스를 중지하고 사용하지 않도록 설정**
  
    이러한 서비스를 사용하지 않도록 설정하면 이 취약점을 악용하려는 시도로부터 영향을 받는 시스템을 보호할 수 있습니다.
    ...
    -   대화형
        ...
        3.  **서비스**를 두 번 클릭합니다.  
        4.  **시스템 이벤트 알림**을 두 번 클릭합니다.  
        5.  **시작 유형** 목록에서 **사용 안 함**을 클릭합니다.  
        6.  **중지**, **확인**을 차례로 클릭합니다.
  
        명령 행에서 다음 명령을 사용하여 **시스템 이벤트 알림** 서비스를 중지하고 사용하지 않도록 설정할 수 있습니다(Windows XP 및 Microsoft Windows 2000 Resource Kit에서 사용 가능).
  
        sc stop sens & sc config sens start= disabled
  
        그런 다음 **COM+ 이벤트 시스템**에 대해 위 단계를 반복합니다.
  
        명령 행에서 다음 명령을 사용하여 **COM+ 이벤트 시스템** 서비스를 중지하고 사용하지 않도록 설정할 수 있습니다(Windows XP 및 Microsoft Windows 2000 Resource Kit에서 사용 가능).
  
        sc stop eventsystem & sc config eventsystem start= disabled
  
    -   그룹 정책:
  
        그룹 정책 설정을 사용하여 이러한 서비스를 비활성화합니다. Microsoft Windows 2000 도메인 환경 또는 Windows Server 2003 도메인 환경에서는 그룹 정책 개체 기능을 사용하여 로컬, 사이트, 도메인 또는 조직 구성 단위 수준에서 이 서비스가 시작되지 않도록 비활성화할 수 있습니다.
    ...
    **대안의 영향.** 이러한 서비스가 필요한 프로그램이 실행되지 않게 됩니다.
  
    **대안 실행 취소 방법:** 위 단계를 사용하여 **시작 유형**을 **자동**으로 설정하고 서비스를 시작합니다.
  
-   **es.dll 액세스 제어 목록 수정**
  
    es.dll의 액세스 제어 목록(ACL)을 더 엄격하게 수정하려면 다음 절차를 따르십시오.
    ...
    **대안의 영향:** 이벤트 시스템이 필요한 프로그램이 실행되지 않게 됩니다.
  
    **대안 실행 취소 방법:** 명령 프롬프트에 다음 명령을 입력합니다.
  
    echo y| cacls %WINDIR%\\SYSTEM32\\es.DLL /E /R everyone  
    es.dll의 액세스 제어 목록(ACL)을 덜 엄격하게 수정하려면 다음 절차를 따르십시오.
  
    1.  관리자 권한이 있는 사용자로 로그온합니다.  
    2.  **시작**, **실행**을 차례로 클릭하고 **cmd**를 입력한 다음 **확인**을 클릭합니다.  
    3.  이 수정 사항을 실행 취소할 경우 나중에 참조할 수 있도록 파일의 현재 ACL(상속 설정 포함)을 적어 놓습니다. ACL을 보려면 다음과 같이 입력합니다.  
        cacls %WINDIR%\\SYSTEM32\\es.DLL  
    4.  파일에 대한 "everyone" 그룹의 액세스를 허용하려면 명령 프롬프트에 다음 명령을 입력합니다.  
...
#### 이벤트 시스템 취약점(CVE-2008-1457)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
Microsoft Windows 이벤트 시스템에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Microsoft Windows 이벤트 시스템이 사용자별 가입을 올바르게 처리하지 못해 로컬 시스템의 컨텍스트에서 임의의 코드가 실행될 수 있습니다.
  
**Microsoft Windows 이벤트 시스템이란 무엇입니까?**    
Microsoft Windows 이벤트 시스템은 시스템에서 Windows와 응용 프로그램 간의 메서드 호출과 이벤트 가입을 관리하는 서비스입니다.
...
이 취약점을 악용하려면 공격자는 인증을 받아야 합니다. 그런 다음 공격자가 특수하게 조작된 이벤트 가입 요청을 Microsoft Windows 이벤트 시스템으로 보내면 공격자가 시스템 권한으로 코드를 실행할 수 있게 되고 영향 받는 시스템을 완전하게 제어할 수 있게 됩니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
영향을 받는 버전의 Microsoft Windows 이벤트 시스템을 실행하는 모든 시스템이 이 취약점으로 인한 위험에 노출됩니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Microsoft Windows 이벤트 시스템이 사용자별 가입을 처리하는 방식을 변경하여 가입을 통해 이벤트 게시자의 보안 컨텍스트에서 코드를 실행하지 못하게 함으로써 취약점을 제거합니다.
...
이벤트 시스템 취약점(CVE-2008-1456)  
-----------------------------------
  
함수 포인터 배열을 호출할 때 Microsoft Windows 이벤트 시스템이 인덱스 범위의 유효성을 올바르게 검사하지 못하기 때문에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하면 원격 코드 실행이 가능합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1456 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1456)을 참조하십시오.
  
#### 이벤트 시스템 취약점(CVE-2008-1456)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   공격자가 취약점을 악용하려면 인증을 받아야 합니다.
  
#### 이벤트 시스템 취약점(CVE-2008-1456)에 대한 대안
...
#### 이벤트 시스템 취약점(CVE-2008-1456)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
Microsoft Windows 이벤트 시스템에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 전체 관리자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Microsoft Windows 이벤트 시스템은 메서드 매개 변수를 함수 포인터의 정적 배열에 대한 인덱스로 사용합니다. 이 인덱스 범위의 유효성 검사가 올바르게 처리되지 못하기 때문에 로컬 시스템의 컨텍스트에서 임의의 코드가 실행될 수 있습니다.
...
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하려면 공격자는 인증을 받아야 합니다. 그런 다음 공격자가 Microsoft Windows 이벤트 시스템을 호출하고 배열 범위를 넘는 특수하게 조작된 요청을 제공합니다. 공격자는 배열에 상대적인 예측 가능한 위치에서 포인터를 찾아 상승된 권한으로 코드를 실행하여 영향을 받는 시스템을 완전하게 제어할 수 있게 됩니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
영향을 받는 버전의 Microsoft Windows 이벤트 시스템을 실행하는 모든 시스템이 이 취약점으로 인한 위험에 노출됩니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Microsoft Windows 이벤트 시스템이 인덱스 범위의 유효성을 검사하는 방식을 변경하여 가입을 통해 이벤트 게시자의 보안 컨텍스트에서 코드를 실행하지 못하게 함으로써 취약점을 제거합니다.
...
Windows2000-kb950974-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows 2000 서비스 팩 4:<br />
Windows2000-kb950974-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB950974$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950974">Microsoft 기술 자료 문서 950974 (영문)</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:
Windowsxp-kb950974-x86-kor /quiet
Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:
Windowsserver-2003.Windows XP-KB950974-x64-kor.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:
WindowsXP-KB950974-x86-kor.exe /norestart
Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:
Windowsserver-2003.Windows XP-KB950974-x64-kor.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\\$NTUninstallKB950974$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950974">Microsoft 기술 자료 문서 950974 (영문)</a> 참조</td>
...
Windowsserver2003-kb950974-x86-kor /quiet
Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2:
Windowsserver2003.WindowsXP-kb950974-x64-kor /quiet
<br />
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2:
Windowsserver2003-kb950974-x86-kor /norestart
Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2:
Windowsserver2003.WindowsXP-kb950974-x64-kor / norestart
<br />
Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용):
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/950974">Microsoft 기술 자료 문서 950974 (영문)</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 에디션:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Vista 및 Windows Vista 서비스 팩 1:
...
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고</strong>: 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다. 업데이트가 있는지 확인하려면 WMI 데이터 판독기 태스크에 표시되는 것처럼 QFE 업데이트에 대한 WQL 쿼리를 사용하십시오. 자세한 내용은 <a href="https://msdn2.microsoft.com/en-us/library/aa384642.aspx">WMI(Windows Management Instrumentation)(영문)</a>를 참조하십시오.</td>
</tr>
</tbody>
</table>
...
-   Microsoft 이벤트 시스템 취약점(CVE-2008-1456)을 보고해 주신 [Palo Alto Networks(영문)](https://www.paloaltonetworks.com/index.html)의 Yamata Li
...
-   V1.1 (2008년 9월 11일): Windows XP의 레지스트리 키 확인 항목을 수정하였습니다.
