...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Collaboration Data Objects 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1987">CAN-2005-1987 (영문)</a></td>
...
예. MBSA 2.0을 사용하면 이 업데이트가 필요한지 여부를 확인할 수 있습니다. MBSA 2.0은 Microsoft Update가 지원하는 제품용 보안 업데이트를 검색할 수 있습니다. MBSA에 대한 지원은 [MBSA 웹 사이트](https://www.microsoft.com/korea/technet/security/tools/mbsahome.asp)를 방문하십시오.  
...
-   Collaboration Data Objects Vulnerability - CAN-2005-1987을 보고해 주신 [Sec-1 (영문)](https://www.sec-1.com/)의 Gary O’leary-Steele에 감사드립니다.
...
-   [Microsoft TechNet Security](https://go.microsoft.com/fwlink/?linkid=21132) 웹 사이트에서 Microsoft 제품의 보안에 관한 추가 정보를 제공합니다.
...
Software Update Services에서 보안 업데이트를 배포하는 방법에 대한 자세한 내용은 [Software Update Services 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=21133)를 참조하십시오.
