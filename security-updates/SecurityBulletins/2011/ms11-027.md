---
TOCTitle: 'MS11-027'
Title: 'Microsoft 보안 공지 MS11-027 - 긴급'
ms:assetid: 'ms11-027'
ms:contentKeyID: 61230394
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-027(v=Security.10)'
---

Microsoft 보안 공지 MS11-027 - 긴급
===================================

ActiveX 킬(Kill) 비트 누적 보안 업데이트(2508272)
-------------------------------------------------

게시된 날짜: 2011년 4월 13일 수요일 | 업데이트된 날짜: 2011년 7월 28일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Windows XP, Windows Vista 및 Windows 7 에디션에 대해 긴급이며, 지원 대상인 모든 Windows Server 2003(Itanium 기반 에디션 제외), Windows Server2008(Itanium 기반 에디션 제외) 및 Windows Server 2008 R2에 대해 보통입니다. Itanium 기반 Windows Server 2003 및 Windows Server 2008 에디션의 경우 이 보안 업데이트의 심각도는 없습니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|------------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=b031a496-aa74-4367-b2ae-24843c061745&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=eddd2964-9765-461d-9df8-2c05402948e8)                                                                 | 원격 코드 실행 | 긴급             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=53756404-39e4-43af-81e9-81471536aa66&displaylang=ko)                                                                  | 원격 코드 실행 | 보통             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c8d59f49-45ec-4527-b3a8-4925f710bbfd&displaylang=ko)                                                      | 원격 코드 실행 | 보통             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9c784734-f44f-4a3c-8223-6289f7dc2ad8)                                                             | 없음           | 심각도 없음<sup>[1]</sup> | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=80bf050a-9aff-4cd4-8e2f-196b0a92b1c0&displaylang=ko)                                           | 원격 코드 실행 | 긴급             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a81412d0-2516-4bf4-87f7-3e41ebf6b82b&displaylang=ko)                   | 원격 코드 실행 | 긴급             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c3247886-76d0-4292-be9d-3e9b0221c46a&displaylang=ko)\*\*     | 원격 코드 실행 | 보통             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=51521b6b-94a7-4bcf-ad5f-fc304728b10f&displaylang=ko)\*\* | 원격 코드 실행 | 보통             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e7c38b0d-7240-420a-88d3-2749a40e386f)            | 없음           | 심각도 없음<sup>[1]</sup> | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d&displaylang=ko)                                                                       | 원격 코드 실행 | 긴급             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d&displaylang=ko)                                                           | 원격 코드 실행 | 긴급             | 없음                                                                |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082&displaylang=ko)                                                         | 원격 코드 실행 | 긴급             | 없음                                                                |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 보통             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de&displaylang=ko)\*\*                                        | 원격 코드 실행 | 보통             | 없음                                                                |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                                   | 원격 코드 실행 | 보통             | [MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                       | 원격 코드 실행 | 보통             | 없음                                                                |

<sup>[1]</sup>이 특정 운영 체제는 취약점의 영향을 받지 않습니다. 하지만 타사 컨트롤에 대한 킬(kill) 비트를 설정하는 사용 가능한 업데이트가 이 운영 체제를 포함한 여러 운영 체제에 적용됩니다. 자세한 내용은 **취약점 정보** 섹션에서 “타사 킬(Kill) 비트”를 참조하십시오.
...
**Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)에 대한 킬(Kill) 비트가 이미 MS10-034에서 설정되었습니다. 이 업데이트로 다른 킬(Kill) 비트를 설정하는 이유는 무엇입니까?**  
Microsoft는 이 ActiveX 컨트롤에 대한 킬(Kill) 비트 목록에 CLSID를 더 추가합니다.
...
운영 체제에 따라 취약점에 적용되는 완화 조치가 서로 다르므로, 이 업데이트의 심각도는 달라집니다. 그러한 완화 조치 중 하나로써, Windows Server 2003 및 Windows Server 2008의 Internet Explorer는 [보안 강화 구성](https://technet.microsoft.com/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다.
...
<th style="border:1px solid black;" >Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)</th>
<th style="border:1px solid black;" >Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)</th>
<th style="border:1px solid black;" >Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)</th>
...
<sup>[2]</sup>Internet Explorer 8은 이 운영 체제에 기본적으로 설치되어 있지 않습니다. 심각도는 Internet Explorer 8이 설치된 경우에만 적용됩니다.
...
ActiveX 컨트롤인 Microsoft Internet Explorer 8 개발자 도구에 원격 코드 실행 취약점이 있습니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0811 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811)을 참조하십시오.
  
#### Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)에 대한 완화 요소
...
#### Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)에 대한 대안
...
-   **Internet Explorer에서 COM 개체가 실행되지 않도록 설정합니다.**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    값이 {1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1}인 CLSID에 킬(kill) 비트를 설정하려면 다음 텍스트를 메모장과 같은 텍스트 편집기에 붙여 넣으십시오. 그런 다음 .reg 파일 이름 확장명을 사용하여 파일을 저장하십시오.
    ...
    두 번 클릭하여 이 .reg 파일을 개별 시스템에 적용할 수 있습니다. 그룹 정책을 사용하면 도메인 전체에 적용할 수도 있습니다. 그룹 정책에 대한 자세한 내용은TechNet 문서, [그룹 정책 컬렉션](https://go.microsoft.com/fwlink/?linkid=215719)을 참조하십시오.
...
#### Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**  
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**  
Internet Explorer에서 ActiveX 컨트롤을 사용할 때 이 컨트롤로 인해 시스템 상태가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**  
취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
...
이 취약점은 Microsoft Internet Explorer 8 개발자 도구 컨트롤에 영향을 미칩니다.
  
**이 문제의 영향을 받는 Internet Explorer 6 및 Internet Explorer 7용 다운로드 가능 개발자 도구가 있습니까?**  
아니요, Internet Explorer 6 및 Internet Explorer 7용 다운로드 가능 개발자 도구는 이 문제의 영향을 받지 않습니다.
  
**Microsoft Internet Explorer 8 개발자 도구란 무엇입니까?**  
Microsoft Internet Explorer 8 개발자 도구는 웹 사이트 개발자들이 Microsoft JScript를 빠르게 디버깅하거나 Internet Explorer와 관련된 동작을 조사하거나 새 디자인 또는 솔루션을 즉석에서 고안할 수 있도록 합니다. IE8 도구에 대한 자세한 내용은 MSDN 문서, [Internet Explorer 개발자 도구 발견 (영문)](https://msdn.microsoft.com/en-us/library/dd565628(vs.85).aspx)을 참조하십시오.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
이 Microsoft Internet Explorer 8 개발자 도구 컨트롤의 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 Microsoft Internet Explorer 8 개발자 도구가 설치되어 있고 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템이 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
...
| 클래스 식별자                          | 파일         | 설명                                      |  
|----------------------------------------|--------------|-------------------------------------------|  
| {1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1} | iedvtool.dll | Microsoft Internet Explorer 8 개발자 도구 |
  
**참고** 이 킬(kill) 비트를 설정하면 [Microsoft 보안 공지 MS10-034](https://technet.microsoft.com/security/bulletin/ms10-034)에서 처음으로 설명한 [CVE-2010-0811 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811) 취약점의 변종을 해결할 수 있습니다.
...
Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)  
-------------------------------------------------------
  

Microsoft WMITools ActiveX 컨트롤 중 하나에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3973 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)을 참조하십시오.
  
#### Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   WMI 관리 도구 패키지는 기본적으로 설치되지 않습니다.  
-   WMITools ActiveX 컨트롤은 서명되지 않았습니다. 기본적으로 Internet Explorer는 서명되지 않은 컨트롤을 차단합니다. 자세한 내용은 MSDN 문서, [ActiveX 차단 (영문)](https://msdn.microsoft.com/library/dd565667.aspx)을 참조하십시오.  
-   웹을 통한 공격의 경우 공격자는 호스팅하는 웹 사이트에 이 취약점을 악용하는 웹 페이지를 포함할 수 있습니다. 또한 사용자가 제공한 콘텐츠나 광고를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 그러나 어떠한 경우에도 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 전자 메일 메시지 또는 메신저 메시지의 링크를 클릭하여 공격자의 웹 사이트를 방문하도록 유도하는 것이 일반적입니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.  
-   기본적으로 지원 대상인 모든 Microsoft Outlook, Microsoft Outlook Express 및 Windows Mail 버전은 스크립트와 ActiveX 컨트롤을 비활성화하는 제한된 사이트 영역에서 HTML 메일 메시지를 열어 공격자가 이 취약성을 사용하여 악의적인 코드를 실행할 수 없도록 위험을 제거합니다. 사용자가 메일에 포함된 링크를 클릭하면 웹 기반 공격 시나리오를 통해 이 취약점 악용에 취약해질 수 있습니다.
  
#### Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)에 대한 대안
...
-   **Internet Explorer에서 COM 개체가 실행되지 않도록 설정합니다.**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    {2745E5F5-D234-11D0-847A-00C04FD7BB08}, {FF371BF4-213D-11D0-95F3-00C04FD9B15B} 및 {AC146530-87A5-11D1-ADBD-00AA00B8E05A} 값을 지닌 CLSID에 킬(kill) 비트를 설정하려면 다음 텍스트를 메모장 같은 텍스트 편집기에 복사하여 붙여 넣으십시오. 그런 다음 .reg 파일 이름 확장명을 사용하여 파일을 저장하십시오.
...
#### Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)에 대한 FAQ
...
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
이 Microsoft WMITools ActiveX 컨트롤 중 하나의 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 Microsoft WMITools ActiveX 컨트롤이 설치된 시스템이나, 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
...
| 클래스 식별자                          | 파일               | 설명                              |  
|----------------------------------------|--------------------|-----------------------------------|  
| {2745E5F5-D234-11D0-847A-00C04FD7BB08} | WBEMSingleView.OCX | Microsoft WMITools ActiveX 컨트롤 |  
| {FF371BF4-213D-11D0-95F3-00C04FD9B15B} | WBEMMultiView.OCX  | Microsoft WMITools ActiveX 컨트롤 |  
| {AC146530-87A5-11D1-ADBD-00AA00B8E05A} | WBEMEventList.OCX  | Microsoft WMITools ActiveX 컨트롤 |
  
**이 ActiveX 컨트롤은 디지털 서명되었습니다?**  
아니요, 이 ActiveX 컨트롤은 디지털 서명되지 않았습니다. ActiveX 컨트롤 서명에 대한 자세한 내용은 MSDN 블로그 게시물, [Authenticode 코드 서명에 대해 알아야 하는 모든 것(영문)](https://blogs.msdn.com/b/ieinternals/archive/2011/03/22/authenticode-code-signing-for-developers-for-file-downloads-building-smartscreen-application-reputation.aspx)을 참조하십시오.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3973 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**  
아니요. Microsoft는 이 보안 공지를 처음에 게시했을 때 이 취약점이 고객을 공격하는 데 공개적으로 사용되었다는 정보를 확인하지 못했습니다.
  
**이 보안 업데이트를 적용하면 취약점을 악용하려는 일반에 공개된 코드로부터 고객을 보호할 수 있습니까?**  
예. 이 보안 업데이트는 공개된 개념 증명 코드를 사용하여 악용될 수 있는 취약점을 해결합니다. 해결된 취약점에 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3973 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)이 지정되었습니다.
  
Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)  
----------------------------------------------------------------
  

Microsoft Windows Messenger ActiveX 컨트롤에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1243 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1243)을 참조하십시오.
  
#### Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)에 대한 완화 요소
...
#### Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)에 대한 대안
...
-   **Internet Explorer에서 COM 개체가 실행되지 않도록 설정합니다.**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    값이 {FB7199AB-79BF-11d2-8D94-0000F875C541}인 CLSID에 킬(kill) 비트를 설정하려면 다음 텍스트를 메모장과 같은 텍스트 편집기에 붙여 넣으십시오. 그런 다음 .reg 파일 이름 확장명을 사용하여 파일을 저장하십시오.
...
#### Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)에 대한 FAQ
...
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
이 Microsoft Windows Messenger ActiveX 컨트롤의 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 Microsoft Windows Messenger ActiveX 컨트롤이 설치된 시스템이나, 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
...
| 클래스 식별자                          | 파일      | 설명                                       |  
|----------------------------------------|-----------|--------------------------------------------|  
| {FB7199AB-79BF-11d2-8D94-0000F875C541} | msgsc.dll | Microsoft Windows Messenger ActiveX 컨트롤 |
...
-   [Oracle](https://www.oracle.com)은 ActiveX 컨트롤, Java Deployment Toolkit에 대한 킬(Kill) 비트를 요청했습니다. Java Deployment Toolkit ActiveX 컨트롤의 보안 문제와 관련된 자세한 내용은 [Oracle Security Alert CVE-2010-0886 (영문)](https://www.oracle.com/technetwork/topics/security/alert-cve-2010-0886-094541.html)을 참조하십시오. 이 ActiveX 컨트롤에 대한 클래스 식별자는 다음과 같습니다.  
    -   {CAFEEFAC-DEC7-0000-0000-ABCDEFFEDCBA}  
-   [CA (영문)](https://www.ca.com/us/)는 ActiveX 컨트롤, WebScan에 대한 권고와 관련된 보안 권고를 발표했습니다. WebScan ActiveX 컨트롤과 관련된 문의 사항이나 문제가 있을 경우 CA([https://www.ca.com (영문)](https://www.ca.com))로 문의하십시오. 자세한 내용은 CA의 보안 공지를 참조하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {7B297BFD-85E4-4092-B2AF-16A91B2EA103}  
-   [IBM](https://www.ibm.com)은 "Rational Suite License ActiveX Control"에 대해 ActiveX 컨트롤에 대한 킬(Kill) 비트를 요청했습니다. Rational Suite License ActiveX 컨트롤과 관련된 문의 사항이나 문제가 있을 경우 IBM(<https://www.ibm.com>)으로 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2508272$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
...
-   Microsoft Internet Explorer 8 개발자 도구 취약점(CVE-2010-0811)을 보고해 주신 Carnegie Mellon University Information Security Office의 Chris Ries  
-   Microsoft WMITools ActiveX 컨트롤 취약점(CVE-2010-3973)을 해결하기 위해 협력해 주신 [TippingPoint's](https://www.tippingpoint.com/) [DVLabs](https://dvlabs.tippingpoint.com/)의 Brian Gorenc  
-   [iSIGHT Partners (영문)](https://www.isightpartners.com/) Global Vulnerability Partnership과 협력하여 Microsoft Windows Messenger ActiveX 컨트롤 취약점(CVE-2011-1243)을 보고해 주신 RadLSneak
...
-   V1.1(2011년 7월 28일): 이 공지의 취약점 섹션, CVE-2010-3973에 설명된 Microsoft WMITools ActiveX 컨트롤에 대한 클래스 식별자가 추가되었습니다. 이 변경 사항은 정보에만 해당됩니다. 이 취약점에 대한 "Internet Explorer에서 COM 개체가 실행되지 않도록 설정" 대안을 이미 적용한 고객은 추가 클래스 식별자로 해당 대안을 다시 적용해야 합니다.
