...
**문제점.**[Microsoft 기술 자료 문서 2269638](https://support.microsoft.com/kb/2269638) 는 보안 업데이트 설치시 겪을지 모르는 문제점에 대해서 기술합니다. 본 문서에서도 문제를 해결 하기 위하여 설명 하고 있습니다.
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0d7210a3-662e-41e7-affc-ae94f9d89388&displaylang=ko)<sup>[1]</sup>
(KB2251419)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
Microsoft Office Word Viewer는 Word Viewer 2003 및 모든 이전 버전의 Word Viewer를 대체합니다. Word가 설치되어 있지 않은 경우에도 사용자는 Word Viewer를 통해 Word 문서를 보고, 인쇄하고 복사할 수 있습니다. 현재 지원되는 Office 뷰어에 대한 자세한 내용은 [지원되는 Office 뷰어 버전](https://support.microsoft.com/kb/979860/en-us)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1900 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1901 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1902 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1903 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2251389">Microsoft 기술 자료 문서 2251389</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2003의 경우 <a href="https://support.microsoft.com/kb/2251399">Microsoft 기술 자료 문서 2251399</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word Viewer의 경우 <a href="https://support.microsoft.com/kb/2251437">Microsoft 기술 자료 문서 2251437</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2007의 경우 <a href="https://support.microsoft.com/kb/2251419">Microsoft 기술 자료 문서 2251419</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩의 경우 <a href="https://support.microsoft.com/kb/2277947">Microsoft 기술 자료 문서 2277947</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.6.0 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=d2f44d4a-7cd8-4514-b3ff-1770bc47d595)에서 다운로드하여 설치하십시오.
...
Microsoft Office 2008 for Mac 12.2.6 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=6ece112f-0ca7-4b1f-ad20-603950edee66)에서 다운로드하여 설치하십시오.
...
Open XML File Format Converter for Mac 1.1.6 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=a7b834a3-5a44-42d4-afe9-6ef207333834)에서 다운로드하여 설치하십시오.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2092914">Microsoft 기술 자료 문서 2092914</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word 레코드 구문 분석 취약점(CVE-2010-1900)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 [team509 (영문)](https://www.team509.com/)의 L.W.Z  
-   Word RTF 구문 분석 엔진 메모리 손상 취약점(CVE-2010-1901)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 [team509 (영문)](https://www.team509.com/)의 Wushi  
-   Word RTF 구문 분석 버퍼 오버플로 취약점(CVE-2010-1902)을 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)와 협력하여 보고해 주신 [team509 (영문)](https://www.team509.com/)  
-   Word HTML 연결된 개체 메모리 손상(CVE-2010-1903)을 보고해 주신 [Check Point (영문)](https://www.checkpoint.com/) IPS Research Team의 Rodrigo Rubira Branco  
-   Word HTML 연결된 개체 메모리 손상 취약점(CVE-2010-1903)을 [TippingPoint](https://www.tippingpoint.com/)의 [Zero Day Initiative](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
