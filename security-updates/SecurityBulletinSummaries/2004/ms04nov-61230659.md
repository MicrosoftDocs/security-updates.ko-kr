...
이 정보의 최종 사용자 버전은 [여기](http://www.microsoft.com/korea/security/security_bulletins/200411_isa.asp)를 참조하십시오.
...
| **취약점으로 인한 영향**   | 스푸핑                                                                                                                                                  |
| **영향을 받는 소프트웨어** | 자세한 내용은 [전문가용 게시판](http://technet.microsoft.com/security/bulletin/ms04-039)에서 영향을 받는 소프트웨어 및 다운로드 위치 절을 참조하십시오. |
...
-   보안 업데이트는 [Microsoft 다운로드 센터 (US)](http://go.microsoft.com/fwlink/?linkid=21129)에서 다운로드할 수 있으며 "security\_patch"라는 키워드를 사용하여 쉽게 찾을 수 있습니다.
...
-   [Microsoft Software Update Services](http://www.microsoft.com/technet/security/bulletin/korea/windowsserversystem/sus/default.asp)
