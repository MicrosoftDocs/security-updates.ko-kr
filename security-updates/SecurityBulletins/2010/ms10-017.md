...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 980150](https://support.microsoft.com/kb/980150)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 980150](https://support.microsoft.com/kb/980150)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0257 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0257)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0258 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0258)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0260 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0260)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0261 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0262 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0262)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0263 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0263)을 참조하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2007 문서를 열지 못하게 합니다.**
    ...
    **대안의 영향.** 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는 2007 Microsoft Office System에서 Office 2007 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0264 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0264)를 참조하십시오.
...
최신 버전의 MBSA인 [Microsoft Baseline Security Analyzer 2.1.1](https://www.microsoft.com/download/details.aspx?familyid=b1e76bbe-71df-41e8-8b52-c871d012ba78&displaylang=en)이 릴리스되었습니다. 자세한 내용은 [Microsoft Baseline Security Analyzer 2.1](https://technet.microsoft.com/security/cc184923.aspx)을 참조하십시오.

MBSA 2.1.1, Microsoft Update 및 Windows Server Update Services에서 지원하지 않는 레거시 소프트웨어를 사용하는 고객을 위한 **참고**: [Microsoft Baseline Security Analyzer](https://www.microsoft.com/technet/security/tools/mbsahome.mspx)를 방문하고 레거시 제품 지원 섹션을 참조하여 레거시 도구로 종합 보안 업데이트 검색을 만드는 방법을 찾으십시오.
...
**Microsoft Office SharePoint Server 2007 참고 사항** 위에 설명된 검색 테이블은 단일 서버를 이용한 Microsoft Office SharePoint Server 2007의 배포에 기초하고 있습니다. 검색 도구는 다중 시스템 SharePoint 서버 팜의 일부로 구성된 시스템에 대한 업데이트 적용 여부를 검색하지 않습니다. 독립 실행형 및 다중 서버 구성에 관한 자세한 정보는 [Office SharePoint Server 2007에 대한 소프트웨어 업데이트 배포](https://technet2.microsoft.com/office/en-us/library/f484f5f2-35bb-4d70-bf56-dd1c4c287c721033.mspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/978471">Microsoft 기술 자료 문서 978471</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/978474">Microsoft 기술 자료 문서 978474</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Excel 2007:<br />
<a href="https://support.microsoft.com/kb/978382">Microsoft 기술 자료 문서 978382</a> 참조<br />
<br />
Excel Viewer:<br />
<a href="https://support.microsoft.com/kb/978383">Microsoft 기술 자료 문서 978383</a> 참조<br />
<br />
Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩:<br />
<a href="https://support.microsoft.com/kb/978380">Microsoft 기술 자료 문서 978380</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/979439">Microsoft 기술 자료 문서 979439</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Microsoft Office Excel 레코드 메모리 손상 취약점(CVE-2010-0257)을 보고해 주신 [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com/)의 Nicolas Joly  
-   Microsoft Office Excel 시트 개체 유형 혼란 취약점(CVE-2010-0258)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   Microsoft Office Excel MDXTUPLE 레코드 힙 오버플로 취약점(CVE-2010-0260)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   Microsoft Office Excel MDXSET 레코드 힙 오버플로 취약점(CVE-2010-0261)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   Microsoft Office Excel FNGROUPNAME 레코드 초기화되지 않은 메모리 취약점(CVE-2010-0262)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Sean Larsson  
-   Microsoft Office Excel XLSX 파일 구문 분석 코드 실행 취약점(CVE-2010-0263)을 [TippingPoint (영문)](https://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   Microsoft Office Excel DbOrParamQry 레코드 구문 분석 취약점(CVE-2010-0264)을 보고해 주신 [Core Security Technologies (영문)](https://www.coresecurity.com/)의 Damián Frizza
