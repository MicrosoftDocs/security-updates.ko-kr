...
<tr>
<td style="border:1px solid black;">
[Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=950f873e-da4f-4b80-947a-034afc8f030a&displaylang=ko)    
(2916036)
...
<td style="border:1px solid black;">
[MS10-051](http://go.microsoft.com/fwlink/?linkid=196268)의 2079403

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2703b0d3-b0d2-41f0-8fc5-01cd85b5fb7c)    
(2916036)
...
<td style="border:1px solid black;">
[MS13-002](http://go.microsoft.com/fwlink/?linkid=264923)의 2757638
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1ac6e0b-a61f-4ee6-ada9-ac8112f183b6&displaylang=ko)    
(2916036)
...
<td style="border:1px solid black;">
[MS12-043](http://go.microsoft.com/fwlink/?linkid=254824)의 2719985

</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=47c9b297-5022-4a21-a77a-c879d6cc2dbc&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=79c368bd-f3e2-447b-a1b0-95957ce1db48)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=662f0e61-09e9-49b6-b6fd-fb380e10fbcd&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e4f2cf28-4759-48c6-86aa-f3ea580641a0&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e765ce1e-671e-41dc-9e94-f932e0ed52d4&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=caafd1dc-3f61-477a-baf4-82d732608c45&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e2972d61-6a8e-477a-911e-dfb6f221cdcb)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=56863b59-8344-4fa7-8318-7832dbe64eb6&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=3d37a672-326a-46bf-9f15-0f551e385b1f&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=336461b4-589e-49c5-8871-f9e4656fb603&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=18a002c7-2c8d-43d1-a006-94c813da7989)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=29631609-bc36-44a2-8e31-68d13c8d4098&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows 8(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=6c008a71-bfdd-4b60-b847-53d5d331c184&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1(32비트 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=682b773e-21d8-4d66-90af-a8394d8c8de1&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1(x64 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=8158f9f8-f494-4953-bad6-f0e05e068957&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=1ffbe808-add5-43bc-9bfa-2817ad8a6e9d&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](http://www.microsoft.com/downloads/details.aspx?familyid=12837041-b5a8-4b0b-9664-624b64935a2d&displaylang=ko)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=e765ce1e-671e-41dc-9e94-f932e0ed52d4&displaylang=ko)(Server Core 설치)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=caafd1dc-3f61-477a-baf4-82d732608c45&displaylang=ko)(Server Core 설치)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](http://www.microsoft.com/downloads/details.aspx?familyid=336461b4-589e-49c5-8871-f9e4656fb603&displaylang=ko)(Server Core 설치)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=1ffbe808-add5-43bc-9bfa-2817ad8a6e9d&displaylang=ko)(Server Core 설치)    
(2916036)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](http://www.microsoft.com/downloads/details.aspx?familyid=12837041-b5a8-4b0b-9664-624b64935a2d&displaylang=ko)(Server Core 설치)    
(2916036)
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-0266(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0266)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008, Windows Server 2008 R2, Windows Server 2012 및 Windows Server 2012 R2의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/library/dd883248)(영문)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 항목을 참조하십시오.
...
-   **Internet Explorer에서 MSXML 3.0 바이너리 동작이 사용되지 않도록 방지**
    ...
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
    ...
    두 번 클릭하여 이 .reg 파일을 개별 시스템에 적용할 수 있습니다. 그룹 정책을 사용하면 도메인 전체에 적용할 수도 있습니다. 그룹 정책에 대한 자세한 내용은 TechNet 문서, [그룹 정책 컬렉션](http://go.microsoft.com/fwlink/?linkid=215719)(영문)을 참조하십시오.

    | <img src="../../images/Dn613825.note(ko-KR,Security.10).gif" class="note" />참고: |
    |----------------------------------------------------------------------------------------------------------|
...
XMLHTTP 요청을 전송하기 전에 호스팅 페이지의 URL을 [open](http://msdn.microsoft.com/library/ms536648)(영문) 메소드의 URL과 비교하여 해당 URL이 동일한 도메인에 있는지 확인합니다. 동일한 도메인에 있지 않을 경우, 이 요청은 요청이 시작된 [보안 영역](http://msdn.microsoft.com/library/ms537183)(영문)의 정책에 따라 처리됩니다. 자세한 내용은 [네이티브 XMLHTTP 정보](http://msdn.microsoft.com/library/ms537505)(영문)를 참조하십시오.
...
예. 기본적으로 Windows Server 2003, Windows Server 2008, Windows Server 2008 R2, Windows Server 2012 및 Windows Server 2012 R2의 Internet Explorer는 [보안 강화 구성(영문)](http://technet.microsoft.com/library/dd883248)으로 알려진 제한된 모드로 실행됩니다. 보안 강화 구성은 미리 구성된 Internet Explorer 설정 그룹으로, 사용자나 관리자가 서버에서 특수하게 조작된 웹 콘텐츠를 다운로드하고 실행할 가능성을 줄여 줍니다. Internet Explorer의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2014-0266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0266)(영문)이 지정되었습니다.
