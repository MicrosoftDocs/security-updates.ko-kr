...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=87fe4c18-21dc-4d83-a1d8-503b92fdba2b&displaylang=ko)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">MMC 리디렉션 사이트 간 스크립팅 취약점 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3643">CVE-2006-3643 (영문)</a></td>
...
Microsoft 관리 콘솔은 Windows 기반 환경을 위한 통합 관리 사용자 인터페이스 및 관리 모델입니다. [Microsoft 관리 콘솔 웹 사이트 (영문)](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/mmc/mmc/microsoft_management_console_start_page.asp)를 참조하십시오.
...
-   MMC 리디렉션 사이트 간 스크립팅 취약점(CVE-2006-3643)을 보고해 주신 [ITsec Security Services (영문)](https://www.itsec-ss.nl/)의 Yorick Koster
-   MMC 리디렉션 사이트 간 스크립팅 취약점(CVE-2006-3643)을 보고해 주신 ITsec Security Services의 [H D Moore (영문)](https://www.metasploit.com)
-   MMC 리디렉션 사이트 간 스크립팅 취약점(CVE-2006-3643)을 보고해 주신 ITsec Security Services의 [Tom Gilder (영문)](https://tom.me.uk/)
