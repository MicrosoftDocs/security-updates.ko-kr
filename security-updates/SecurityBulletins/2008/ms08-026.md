...
**참고** 이 업데이트에는 [Microsoft 보안 권고 950627](http://technet.microsoft.com/security/advisory/950627)에서 처음 설명한 This Microsoft Jet 데이터베이스 엔진의 취약점을 악용하기 위해 Microsoft Word를 사용하는 공격에 대한 추가적인 보안 완화 조치가 포함되어 있습니다. 이러한 유형의 공격에 대해 최신의 보안 조치가 적용되도록 [Microsoft 보안 공지 MS08-028: Microsoft Jet 데이터베이스 엔진(Jet)의 취약점으로 인한 원격 코드 실행 문제점(950749)](http://technet.microsoft.com/security/bulletin/ms08-028)에서 제공되는 업데이트도 설치하도록 고객에게 권장합니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 951207](http://support.microsoft.com/kb/951207)에 나와 있습니다.
...
Outlook 2007 또는 Outlook 2007 서비스 팩 1만 설치한 사용자도 이 Word 업데이트를 적용해야 합니다. Outlook 2007 또는 Outlook 2007 서비스 팩 1과 Word 2007 또는 Word 2007 서비스 팩 을 함께 설치한 사용자도 이 업데이트를 적용해야 하지만, 한 번만 설치하면 됩니다. 이 문제점에 대한 자세한 내용은 [Microsoft 기술 자료 문서 949370](http://support.microsoft.com/kb/949370)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1091)을 참조하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.**
    ...
    **대안의 영향**: 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는 2007 Microsoft Office System에서 .rtf 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1434)를 참조하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.**
    ...
    **대안의 영향**: 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Word 또는 Outlook에서 HTML 문서를 열 수 없습니다.
    ...
    **대안의 영향**: 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](http://support.microsoft.com/kb/922848)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Word 2003 또는 2007 Microsoft Office System에서 HTML 문서를 열 수 없습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/951207">Microsoft 기술 자료 문서 951207</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
-   Word CSS(Cascading Style Sheet) 취약점(CVE-2008-1434)을 보고해 주신 [iDefense Labs (영문)](http://labs.idefense.com/)와 협력해 주신 Jun Mao  
-   개체 구문 분석 취약점(CVE-2008-1091)을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력해 주신[team509 (영문)](http://www.team509.com/)의 wushi
