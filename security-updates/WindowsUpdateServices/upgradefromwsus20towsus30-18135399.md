...
ms:contentKeyID: 18135399
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc720542(v=WS.10)'
---
...
| ![](images/Cc720542.note(WS.10).gif)참고         |
|-------------------------------------------------------------------------------|
...
The [Windows Server Update Services 3.0 Operations Guide](http://go.microsoft.com/fwlink/?linkid=81072) (http://go.microsoft.com/fwlink/?LinkId=81072) includes other types of migration documentation, such as migrating from Windows 내부 데이터베이스 to Microsoft SQL Server.
