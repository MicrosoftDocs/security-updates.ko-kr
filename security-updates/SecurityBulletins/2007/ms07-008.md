---
TOCTitle: 'MS07-008'
Title: 'Microsoft 보안 공지 MS07-008 - 긴급'
ms:assetid: 'ms07-008'
ms:contentKeyID: 61230047
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms07-008(v=Security.10)'
---


Microsoft 보안 공지 MS07-008 - 긴급
===================================
...
**보안 업데이트 대체:** 이 공지는 이전의 보안 업데이트를 대체합니다. 자세한 내용은 자주 제기되는 질문 사항(FAQ)의 대체 표를 참조하십시오.
...
-   Microsoft Windows 2000 서비스 팩 4 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=211a9c07-88ff-4ae4-a82a-ce2045c6c4fe&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 2 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=a3700273-d7da-4a60-ba80-c95c8036d670&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=69ef4daa-cf0f-4898-8675-911428e7fd74)
-   Microsoft Windows Server 2003 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=5a1f1607-b6ec-41e2-aac0-34387f1211a7&displaylang=ko)
-   Microsoft Windows Server 2003 서비스 팩 1 - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=5a1f1607-b6ec-41e2-aac0-34387f1211a7&displaylang=ko)
-   Microsoft Windows Server 2003(Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=d638c8e8-5fbe-4a32-945c-440a4b684b0f)
-   Microsoft Windows Server 2003 SP1(Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=d638c8e8-5fbe-4a32-945c-440a4b684b0f)
-   Microsoft Windows Server 2003 x64 Edition - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=65bf2245-6c89-43db-8d28-12988791c395)
...
이 업데이트는 새로 발견되어 비공개적으로 보고된 취약점과 내부 조사를 통해 발견된 추가 문제점을 해결합니다. 취약점은 이 공지의 "취약점 세부 사항" 섹션에 설명되어 있습니다.
...
|-----------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------------|------------------------|---------------------|---------------------------------|
| HTML 도움말 ActiveX 컨트롤 취약점 – [CVE-2007-0214 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0214) | 원격 코드 실행       | 긴급                     | 긴급                   | 보통                | 보통                            |
...
|-------------------------------------------------------------------------|--------------------------|------------------------|---------------------|---------------------------------|
| [**MS06-046**](https://technet.microsoft.com/security/bulletin/ms06-046) | 대체됨                   | 대체됨                 | 대체됨              | 대체됨                          |

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 문제점은 무엇입니까?**  
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 928843](https://support.microsoft.com/kb/928843)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
#### HTML 도움말 ActiveX 컨트롤 취약점 - CVE-2007-0214

HTML 도움말 ActiveX 컨트롤에 원격 코드 실행 취약점이 존재합니다. 공격자는 사용자가 해당 웹 페이지를 방문할 때 원격 코드가 실행되도록 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.

#### HTML 도움말 ActiveX 컨트롤 취약점 - CVE-2007-0214에 대한 완화 요소:
...
-   기본적으로 Windows Server 2003의 Internet Explorer는 보안 강화 구성으로 알려진 제한된 모드로 실행됩니다. 이 모드는 인터넷 영역이 보안 수준을 높음으로 설정합니다. 인터넷 영역의 신뢰할 수 있는 사이트 영역에 추가되지 않는 웹 사이트에 대한 완화 요소입니다.

#### HTML 도움말 ActiveX 컨트롤 취약점 - CVE-2007-0214에 대한 대안:
...
-   **Internet Explorer에서 HTML 도움말 ActiveX 컨트롤을 실행하지 않도록 임시로 설정**

    이 취약점으로부터 보호하려면 ActiveX 컨트롤에 킬(kill) 비트를 설정하여
    Internet Explorer에서 HTML 도움말 ActiveX를 임시로 비활성화하여 실행하지 않도록 설정합니다.
    **경고** 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.

    ActiveX 컨트롤의 CLSID는 해당 컨트롤의 GUID입니다. Internet Explorer가 컨트롤을 호출하지 못하도록 킬 (kill) 비트를 설정함으로써 Internet Explorer에서 ActiveX 컨트롤이 실행되지 않도록 할 수 있습니다. 킬(kill) 비트는 레지스트리에서 해당 ActiveX 컨트롤의 Compatibility Flags DWORD 값에 지정하는 특정 값입니다.
    HTML 도움말 ActiveX 컨트롤의 CLSID는 {52a2aaae-085d-4187-97ea-8c30db990436}입니다.
    ActiveX 컨트롤이 Internet Explorer에서 실행되지 않도록 설정하는 자세한 절차는 [Microsoft 기술 자료 문서 240797](https://support.microsoft.com/kb/240797)을 참조하십시오. 이 절차에 따라 레지스트리에 Compatibility Flags 값을 만들어 HTML 도움말 ActiveX 컨트롤이 Internet Explorer에서 인스턴스화하지 않도록 방지하십시오.
    **참고** 이 대안을 사용하는 경우 동일한 Compatibility Flags 레지스트리 값을 제거하여 이 레지스트리를 초기화해야 합니다. HTML 도움말 ActiveX 컨트롤이 제공하는 기능을 다시 사용하려면 이 보안 업데이트를 적용한 후에 이 과정을 수행해야 합니다.
...
#### HTML 도움말 ActiveX 컨트롤 취약점 - CVE-2007-0214에 대한 FAQ:
...
**취약점의 원인은 무엇입니까?**  
HTML 도움말 ActiveX 컨트롤 메서드에서 매개 변수 유효성 검사를 충분히 수행하지 않습니다.

**HTML 도움말 및 HTML 도움말 ActiveX 컨트롤이란 무엇입니까?**  
Microsoft [HTML 도움말 (영문)](https://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconhh1start.asp)은 Windows 플랫폼의 표준 도움말 시스템입니다. HTML 도움말 ActiveX 컨트롤은 HTML 파일에 도움말 탐색 및 보조 창 기능을 삽입하는 데 사용되는 프로그램(Hhctrl.ocx)입니다. HTML 도움말 ActiveX 컨트롤은 Internet Explorer 및 Shdocvw.dll 구성 요소와 함께 작동하도록 설계되어 있습니다. Shdocvw.dll은 인터페이스를 호스트에 노출시키고 이를 통해 별도의 ActiveX 컨트롤로 호스트됩니다. Shdocvw.dll 구성 요소는 WebBrowser 컨트롤로 더 자주 불립니다. HTML 도움말 ActiveX 컨트롤에 대한 자세한 내용은 [제품 설명서 (영문)](https://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconocxov.asp) 및 HTML HELP API 지원을 참조하십시오.
...
이 취약점의 경우 사용자가 웹 사이트를 방문해야 악의적인 동작이 발생합니다. 따라서 사용자의 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템은 이 취약점으로 인한 공격을 받을 위험이 가장 큽니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 HTML 도움말 ActiveX 컨트롤 메서드의 매개 변수를 초기화하여 취약점을 제거합니다.
...
**Windows2000-kb928843-x86-kor /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB928843.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows 2000 서비스 팩 4 명령 프롬프트에서 다음 명령을 사용하십시오.

**Windows2000-kb928843-x86-kor /norestart**
...
시스템 관리자는 Spuninst.exe 유틸리티를 사용하여 이 보안 업데이트를 제거할 수도 있습니다. Spuninst.exe 유틸리티는 %Windir%\\$NTUninstallKB928843$\\Spuninst 폴더에 있습니다.
...
**Windowsxp-kb928843-x86-kor /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB928843.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows XP 명령 프롬프트에서 다음 명령을 사용하십시오.

**Windowsxp-kb928843-x86-kor /norestart**
...
**Windowsserver2003-kb928843-x86-kor /quiet**

**참고** **/quiet** 스위치를 사용하면 모든 메시지가 표시되지 않습니다. 마찬가지로 실패 메시지도 표시되지 않습니다. 관리자는 지원되는 방법 중 하나를 사용하여 **/quiet** 스위치를 사용할 때 설치가 제대로 되었는지 확인해야 합니다. 또한 관리자는 이 스위치를 사용할 때 KB928843.log 파일에서 모든 실패 메시지를 검토해야 합니다.

컴퓨터를 다시 시작하지 않고 보안 업데이트를 설치하려면 Windows Server 2003 명령 프롬프트에서 다음 명령을 사용하십시오.

**Windowsserver2003-kb928843-x86-kor /norestart**
...
-   HTML 도움말 취약점(CVE-2007-0214)과 관련하여 Microsoft와 협력해 주신 [BreakingPoint Systems (영문)](https://www.bpointsys.com/)의 HD Moore
