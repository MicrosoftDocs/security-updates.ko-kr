---
TOCTitle: 'MS16-050'
Title: 'Microsoft 보안 공지 MS16-050 - 긴급'
ms:assetid: 'ms16-050'
ms:contentKeyID: 72785205
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms16-050(v=Security.10)'
---

MSRC ppDocument 서식 파일

Microsoft 보안 공지 MS16-050 - 긴급
===================================

Adobe Flash Player용 보안 업데이트(3154132)
-------------------------------------------
...
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 3154132](https://support.microsoft.com/ko-kr/kb/3154132)를 참조하십시오.

취약성 정보
-----------

<span id="sectionToggle1"></span>
이 보안 업데이트는 Adobe 보안 공지 [APSB16-10](https://helpx.adobe.com/kr/security/products/flash-player/apsb16-10.html)에 설명된 다음 취약성을 해결합니다.

CVE-2016-1006, CVE-2016-1011, CVE-2016-1012, CVE-2016-1013, CVE-2016-1014, CVE-2016-1015, CVE-2016-1016, CVE-2016-1017, CVE-2016-1018 및 CVE-2016-1019.
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/downloads/details.aspx?familyid=????)  
(3154132)
...
<td style="border:1px solid black;">
[MS16-036](https://technet.microsoft.com/ko-kr/library/security/ms16-036)의 3144756
...
**참고**  Windows Server 2016 Technical Preview 4 및 Windows Server 2016 Technical Preview 5가 영향을 받습니다. 전체 심각도는 긴급이며 영향은 보통, 원격 코드 실행입니다. 해당 운영 체제를 실행하는 고객은 [Windows Update](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=ko-kr)에서 제공되는 이 업데이트를 적용하는 것이 좋습니다.
...
*2016-04-04 13:13-07:00에 페이지가 생성되었습니다.*
