...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://https://www.microsoft.com/download/details.aspx?familyid=c2191703-8cbd-4959-9f84-e13f21173926&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-0499 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1499)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-2222 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2222)를 참조하십시오.
...
-   COM 개체 인스턴스화 메모리 손상 취약점 - CVE-2007-0218을 보고해 주신 [iDefense VCP (영문)](http://idefense.com/)의 익명의 연구자  
-   COM 개체 인스턴스화 메모리 손상 취약점 - CVE-2007-0218과 관련하여 Microsoft와 협력해 주신 [ISS (영문)](http://www.iss.net/)의 Tom Cross  
-   언어 팩 설치 취약점 - CVE-2007-3027을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 협력해 주신 익명의 연구자  
-   초기화되지 않은 메모리 손상 취약점 - CVE-2007-1751을 보고해 주신 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/) 및 [TippingPoint (영문)](http://www.tippingpoint.com/)와 협력해 주신 Sam Thomas  
-   음성 제어 메모리 손상 취약점 - CVE-2007-2222를 보고해 주신 [CERT/CC (영문)](http://www.cert.org/certcc.html)의 Will Dorman  
-   음성 제어 메모리 손상 취약점 - CVE-2007-2222와 관련하여 Microsoft와 협력해 주신 [Fortinet Security Research (영문)](http://www.fortinet.com/)의 cocoruder
