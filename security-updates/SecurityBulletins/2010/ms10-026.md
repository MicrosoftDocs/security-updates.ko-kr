---
TOCTitle: 'MS10-026'
Title: 'Microsoft 보안 공지 MS10-026 - 긴급'
ms:assetid: 'ms10-026'
ms:contentKeyID: 61230287
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-026(v=Security.10)'
---



Microsoft 보안 공지 MS10-026 - 긴급
===================================

Microsoft MPEG Layer-3 코덱의 취약점으로 인한 원격 코드 실행 문제점(977816)
---------------------------------------------------------------------------

게시된 날짜: 2010년 4월 14일 수요일 | 업데이트된 날짜: 2010년 6월 23일 수요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000, Windows XP, Windows Server 2003(Itanium 기반 에디션 제외) 및 Windows Server 2008(Itanium 기반 에디션 제외) 에디션에 대해 긴급입니다. 지원 대상인 모든 Windows Vista에 대해서는 중요입니다. Windows Server 2003 및 Windows Server 2008의 Itanium 기반 에디션 그리고 지원 대상인 모든 Windows 7 및 Windows Server 2008 R2 에디션은 이 취약점의 영향을 받지 않습니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Microsoft MPEG Layer-3 오디오 코덱이 특수하게 조작된 AVI 파일에서 MPEG Layer-3 오디오 스트림을 디코딩하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|-----------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Microsoft Windows 2000 서비스 팩 4                                                                        | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=f6394fc2-b9d0-46cf-9265-a0d4aeb1448f&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3                                                          | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=b1582a74-4a7b-4540-beb1-7c89c86eae87&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows XP Professional x64 Edition 서비스 팩 2                                                           | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=8afca317-a647-44aa-a771-5d85cd5d62ea)                | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Server 2003 서비스 팩 2                                                                           | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=9f89746c-181e-4177-a851-ec1826e78b6d&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Server 2003 x64 Edition 서비스 팩 2                                                               | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=b97e7ea1-a163-4ce4-8cbc-5f933773c4b2&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2                                     | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=0e7140bb-42d3-48b3-9f4b-d55b17770de8&displaylang=ko) | 원격 코드 실행 | 중요        | 없음                      |
| Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2 | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=b885aef4-3a5d-4c3e-bef6-5efef2965752&displaylang=ko) | 원격 코드 실행 | 중요        | 없음                      |
| Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2\*\*              | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=8e9c04c9-898f-4ed2-949d-f4343cc0d9f6&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2\*\*          | [MPEG Layer-3 코덱](https://www.microsoft.com/download/details.aspx?familyid=d6f2e1ae-48d3-4d2c-b329-32cff00afee5&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
...
**이 공지가 2010년 6월 22일에 개정된 이유는 무엇입니까?**  
Microsoft는 2010년 4월 13일의 Microsoft Windows 2000 서비스 팩 4의 MPEG Layer-3 코덱용 보안 업데이트(KB977816)가 Microsoft Windows 2000에서 Microsoft Office를 실행하는 일부 시스템에 잘못 제공되었던 문제를 해결하는 검색 로직 변경 사항을 알리기 위해 이 공지를 개정하였습니다. 이 변경 사항은 최초 업데이트에 포함된 파일에 영향을 주지 않는 검색 변경 사항에 해당합니다. 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.

이 검색 변경 사항으로 인해 Windows Server Update Services(WSUS)를 사용하는 고객에게는 이 보안 업데이트가 새 업데이트로 표시될 수 있습니다. 자동 승인 규칙이 없는 경우 업데이트를 수동으로 재승인해야 할 수 있습니다. 업데이트를 재승인하지 않으면 업데이트가 적용되지 않는 경우에도 시스템에 업데이트가 계속 제공될 수 있습니다. 이러한 검색 변경 사항에 대한 자세한 내용은 [Microsoft 기술 자료 문서 894199](https://support.microsoft.com/kb/894199)를 참조하십시오.
...
<th style="border:1px solid black;" >MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 서비스 팩 4의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 MPEG Layer-3 코덱</td>
<td style="border:1px solid black;"><strong>중요</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>중요</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2의 MPEG Layer-3 코덱**</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 MPEG Layer-3 코덱**</td>
<td style="border:1px solid black;"><strong>긴급</strong> <br />
원격 코드 실행</td>
<td style="border:1px solid black;"><strong>긴급</strong></td>
</tr>
...
MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)  
--------------------------------------------------------------
  

Microsoft MPEG Layer-3 코덱이 AVI 미디어 파일을 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이러한 취약점으로 인해 사용자가 Microsoft MPEG Layer-3 오디오 스트림을 포함하고 있는 특수하게 조작된 AVI 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0480 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0480)을 참조하십시오.
  
#### MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)에 대한 완화 요소
...
-   Windows Vista 시스템에 취약한 코드가 있기는 하지만 Windows Vista의 Windows Media Player는 기본적으로 MPEG Layer-3 오디오 스트림이 들어 있는 AVI 파일을 디코딩할 때 이 취약한 코드를 사용하지 않습니다. 대신 취약하지 않은 다른 코덱을 사용합니다.
  
#### MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **MPEG Layer-3 오디오 코덱에 대한 액세스 제한**
  
    관리자는 코덱에 액세스 제어 목록을 적용하여 더 이상 코덱을 로드하지 않도록 할 수 있습니다. 이 방법은 이 공격 경로를 사용하는 취약점 악용을 효과적으로 방지할 수 있습니다.
  
    코덱에 대한 액세스를 제한하려면
  
    -   지원 대상인 모든 Microsoft Windows 2000 에디션과 지원 대상인 모든 Windows XP 및 Windows Server 2003 32비트 에디션에서는 명령 프롬프트에서 다음 명령을 실행합니다.  
        `cacls "%windir%\system32\l3codeca.acm" /E /P everyone:N `  
        `cacls "%windir%\system32\l3codecx.ax" /E /P everyone:N`  
    -   지원 대상인 모든 Windows XP 및 Windows Server 2003 64비트 에디션에서는 명령 프롬프트에서 다음 명령을 실행합니다.  
        `cacls "%windir%\system32\l3codeca.acm" /E /P everyone:N `  
        `cacls "%windir%\system32\l3codecx.ax" /E /P everyone:N`  
        `cacls "%windir%\SysWow64\l3codeca.acm" /E /P everyone:N `  
        `cacls "%windir%\SysWow64\l3codecx.ax" /E /P everyone:N`  
    -   지원 대상인 모든 Windows Vista 및 Windows Server 2008 32비트 에디션에서는 상승된 권한의 명령 프롬프트에서 다음 명령을 실행합니다.  
    ...
    -   지원 대상인 모든 Windows Vista 및 Windows Server 2008 64비트 에디션에서는 상승된 권한의 명령 프롬프트에서 다음 명령을 실행합니다.  
        `takeown /f "%windir%\system32\l3codeca.acm"`  
        `cacls "%windir%\system32\l3codeca.acm" /E /P everyone:N `  
        `takeown /f "%windir%\system32\l3codecp.acm"`  
        `cacls "%windir%\system32\l3codecp.acm" /E /P everyone:N`  
    ...
    **대안의 영향.** MPEG Layer-3 오디오 인코딩된 파일이 재생되지 않습니다.
...
#### MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Microsoft MPEG Layer-3 오디오 코덱이 MPEG Layer-3 오디오 스트림을 포함하는 특수하게 조작된 AVI 파일을 올바르게 처리하지 못하기 때문입니다.
  
**어떤 Microsoft MPEG Layer-3 오디오 코덱이 취약합니까?**    
취약한 MPEG Layer-3 오디오 코덱은 Microsoft DirectShow용 MPEG Layer-3 오디오 코덱(l3codecx.ax) 그리고 Fraunhofer IIS MPEG Layer-3 ACM 코덱(L3codeca.acm 및 L3codecp.acm)입니다. 이러한 MPEG Layer-3 오디오 코덱은 Windows Media에 포함되어 제공됩니다. 자세한 내용은 [Window Media](https://www.microsoft.com/korea/windows/windowsmedia/) 홈 페이지를 참조하십시오.
...
코덱은 인코더와 디코더의 두 가지 요소로 구성될 수 있습니다. 인코더는 압축(인코딩) 기능을 수행하고, 디코더는 압축 해제(디코딩) 기능을 수행합니다. 일부 코덱에는 이 두 구성 요소가 모두 포함되어 있고, 일부 코덱에는 하나만 포함되어 있습니다.
  
예를 들어 오디오 CD에서 컴퓨터로 곡을 전송할 때 Windows Media Player는 기본적으로 Windows Media Audio 코덱을 사용하여 곡을 작은 WMA 파일로 압축합니다. 이 WMA 파일(또는 웹 사이트에서 스트리밍될 수 있는 모든 WMA 파일)을 재생할 때 Windows Media Player는 스피커를 통해 곡이 재생될 수 있도록 Windows Media Audio 코덱을 사용하여 파일을 압축 해제합니다.
  
**AVI 미디어 파일이란 무엇입니까?**    
AVI(Audio Video Interleave)는 RIFF(Resource Interchange File Format)를 사용하는 멀티미디어 컨테이너 형식입니다. AVI는 Microsoft에 의해 정의됩니다. .avi 파일 형식은 컴퓨터의 오디오 및 비디오 데이터에 일반적인 형식입니다.
...
전자 메일 공격의 경우 공격자가 특수하게 조작된 AVI 파일이 내장된 미디어 파일을 사용자에게 보내고 미디어 파일을 열도록 유도하여 이러한 취약점을 악용할 수 있습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Microsoft MPEG Layer-3 오디오 코덱이 특수하게 조작된 AVI 파일에서 MPEG Layer-3 오디오 스트림을 처리하는 방식을 수정하여 문제점을 해결합니다.
...
<td style="border:1px solid black;">Windows2000-WindowsMedia-KB977816-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-WindowsMedia-KB977816-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB977816_wm9$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/977816">Microsoft 기술 자료 문서 977816</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">다음의 두 키가 모두 만들어집니다.<br />
...
WindowsXP-KB977816-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB977816-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>제거 정보</strong></td>
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB977816$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/977816">Microsoft 기술 자료 문서 977816</a> 참조</td>
...
WindowsServer2003-KB977816-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB977816-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB977816-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB977816-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">KB977816.log</td>
...
-   MPEG Layer-3 오디오 디코더 스택 오버플로 취약점(CVE-2010-0480)을 보고해 주신 [Palo Alto Networks (영문)](https://www.paloaltonetworks.com/)의 Yamata Li
...
-   V1.1(2010년 6월 23일): Microsoft Windows 2000 서비스 팩 4의 MPEG Layer-3 코덱의 다시 제공 문제를 해결하는 검색 로직 변경 사항을 알리기 위해 이 공지를 개정하였습니다. 이 변경 사항은 최초 업데이트에 포함된 파일에 영향을 주지 않는 검색 변경 사항에 해당합니다. 시스템을 성공적으로 업데이트한 고객은 이 업데이트를 다시 설치할 필요가 없습니다.
