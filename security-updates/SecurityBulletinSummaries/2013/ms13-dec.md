...
2013년 12월 보안 공지 발표와 함께 이 공지 요약이 2013년 12월 5일에 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](http://go.microsoft.com/fwlink/?linkid=217213)을 참조하십시오.
...
-   Internet Explorer 메모리 손상 취약점(CVE-2013-5047)을 보고해 주신 [HP](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/)의 Abdul-Aziz Hariri
-   Internet Explorer 메모리 손상 취약점(CVE-2013-5048)을 [HP](http://www.hpenterprisesecurity.com/products)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
-   Internet Explorer 메모리 손상 취약점(CVE-2013-5049)을 [HP](http://www.hpenterprisesecurity.com/products)의 [Zero Day Initiative](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Jose Antonio Vazquez Gonzalez
-   Internet Explorer 메모리 손상 취약점(CVE-2013-5051)을 보고해 주신 [OUSPG](https://www.ee.oulu.fi/research/ouspg/)의 Atte Kettunen
-   Internet Explorer 메모리 손상 취약점(CVE-2013-5052)을 보고해 주신 [Palo Alto Networks](http://www.paloaltonetworks.com/)의 Bo Qu
-   이 공지에 포함된 Internet Explorer XSS 필터 심층 보안 변경 사항에 대해 협력해 주신 Alex Inführ

**MS13-098**

-   WinVerifyTrust 서명 유효성 검사 취약점(CVE-2013-3900)을 보고해 주신 [Kingsoft Internet Security Software Co. Ltd](http://www.ijinshan.com/)의 Kingsoft Internet Security Center
...
-   LRPC 클라이언트 버퍼 오버런 취약점(CVE-2013-3878)을 보고해 주신 [Qihoo](http://www.360.cn/)의 Renguang Yuan

**MS13-104**

-   토큰 가로채기 취약점(CVE-2013-5054)을 보고해 주신 [Adallom](http://www.adallom.com/)의 Noam Liran

**MS13-105**

-   OWA XSS 취약점(CVE-2013-5072)을 [Criteo](http://www.criteo.com/) 대신 보고해 주신 [Minded Security](https://www.mindedsecurity.com/)
