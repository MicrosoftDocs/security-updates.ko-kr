...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9&displaylang=ko)                                                                            | 서비스 거부    | 보통        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653&displaylang=ko)                                                                | 서비스 거부    | 보통        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e&displaylang=ko)\*                                                   | 서비스 거부    | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0&displaylang=ko)\*                                                 | 서비스 거부    | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9babf81a-8b21-42ae-a65c-f414793516ab)                                                              | 서비스 거부    | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00&displaylang=ko)                                 | 서비스 거부    | 보통        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53&displaylang=ko)                             | 서비스 거부    | 보통        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3&displaylang=ko)\* | 서비스 거부    | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=93752c8f-5461-4e6f-9cab-6401b985ef17)          | 서비스 거부    | 중요        | [MS10-058](https://technet.microsoft.com/security/bulletin/ms10-058) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1871 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1871)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1965 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1965)를 참조하십시오.
...
-   정책 기반 QoS를 사용하지 않도록 설정합니다. 자세한 내용은 Microsoft TechNet 문서 [정책 기반 QoS(서비스 품질) (영문)](https://technet.microsoft.com/library/dd919203(ws.10).aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2563894">Microsoft 기술 자료 문서 2563894</a> 참조</td>
</tr>
<tr class="odd">
