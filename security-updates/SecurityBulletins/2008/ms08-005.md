...
|--------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Microsoft Windows 2000 서비스 팩 4                                                               | [Microsoft IIS(인터넷 정보 서비스) 5.0](https://www.microsoft.com/download/details.aspx?familyid=b24f34fb-40b9-4aa5-b5ac-e3f0a6062753&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows XP Professional 서비스 팩 2                                                              | [Microsoft IIS(인터넷 정보 서비스) 5.1](https://www.microsoft.com/download/details.aspx?familyid=73d24fcf-bea9-4b13-9f1c-4e068c53a4ae&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2           | [Microsoft IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=103a6bc0-034a-443d-b1d4-81117820dcb2)                | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2                               | [Microsoft IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=516ef8e8-3cb6-4660-b771-3c7f66917a11&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2                   | [Microsoft IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=e24fb33c-67b9-4ed4-9317-b5fd535d005a&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용) | [Microsoft IIS(인터넷 정보 서비스) 6.0](https://www.microsoft.com/download/details.aspx?familyid=5a4a6083-8c67-4403-8e20-7f2b82178124)                | 권한 상승      | 중요        | 없음                      |
| Windows Vista                                                                                    | [Microsoft IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=8c7018ec-ae80-4a30-93fc-0f7386732514&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
| Windows Vista x64 Edition                                                                        | [Microsoft IIS(인터넷 정보 서비스) 7.0](https://www.microsoft.com/download/details.aspx?familyid=4de2fffc-5793-4acf-98ee-1b801e59ae39&displaylang=ko) | 권한 상승      | 중요        | 없음                      |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0074 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0074)를 참조하십시오.
...
-   V1.1 (2008년 2월 14일) 공지가 업데이트되었습니다. Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2용 다운로드 링크 참조가 Internet Information Services 6.0을 참조하도록 수정되었습니다. 다운로드 링크는 IIS 6.0 업데이트로 정확하게 연결되지만, 참조 링크가 IIS 5.1로 부정확하게 기재되어 있었습니다.
