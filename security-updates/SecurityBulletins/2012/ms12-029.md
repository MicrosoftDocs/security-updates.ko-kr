...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) (영문)의 KB2344911은 KB2598332로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) (영문)의 KB2344993은 KB2596917로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-094](https://go.microsoft.com/fwlink/?linkid=232493) (영문)의 KB2644354는 KB2665346으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-089](https://go.microsoft.com/fwlink/?linkid=225739) (영문)의 KB2644347은 KB2665351로 대체되었습니다.
</td>
</tr>
<tr>
<th style="border:1px solid black;" colspan="5">
...
<td style="border:1px solid black;">
[MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) (영문)의 KB2345043은 KB2596880으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Office 파일 유효성 검사에 대한 자세한 내용은 [Microsoft 보안 권고 2501584](https://technet.microsoft.com/security/advisory/2501584) 및 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)를 참조하십시오.

Microsoft Word 2003 서비스 팩 3 또는 Microsoft Word 2007 서비스 팩 2를 실행하고 있습니다. 파일을 열 때 Office 파일 유효성 검사 메시지가 표시되는 이유는 무엇입니까?  
MS12-029 업데이트를 적용하면 고객은 Office 파일 유효성 검사 기능이 Microsoft Word에 대해 활성화되어 있는 것을 확인할 수 있습니다. 이는 고객이 이전에 [Microsoft Office 파일 유효성 검사 추가 기능](https://www.microsoft.com/download/details.aspx?familyid=6a4e39a4-4c3f-4cc7-98ec-1cb2d5cb5881)(KB2501584)을 설치하였지만 Office 파일 유효성 검사에 대한 Microsoft Word에 아키텍처 업데이트를 적용하지 않은 경우에 발생합니다. 이러한 경우, MS12-029에 Microsoft Word에 대한 Office 파일 유효성 검사가 포함되어 있고, Office 파일 유효성 검사 추가 기능이 이전에 설치되어 있었으므로 Office 파일 유효성 검사가 Microsoft Word에 대해 활성화됩니다.

Office 파일 유효성 검사 기능이 파일을 유효성 검사하지 않도록 레지스트리 키를 설정하여 Office 파일 유효성 검사를 비활성화할 수 있습니다. Office 파일 유효성 검사를 비활성화하는 방법에 대해서는 [Office 2003 및 Office 2007용 Office 파일 유효성 검사](https://technet.microsoft.com/ko-kr/library/53782285-736e-4d00-b458-6170054287af.aspx)(영문)를 참조하십시오. Office 파일 유효성 검사 기능 비활성화에 대한 대안으로 Microsoft Word 2007 고객은 [신뢰할 수 있는 위치 기능](https://technet.microsoft.com/en-us/library/cc178948(office.12).aspx)을 사용하여 Office 파일 유효성 검사 확인에서 제외되는 콘텐츠를 담고 있는 디렉토리를 지정할 수 있습니다.
...
이 공지에서 제공하는 Microsoft Office 2008 for Mac(KB2665346) 및 Microsoft Office for Mac 2011(KB2665351)용 보안 업데이트 패키지는 [MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) 보안 공지에서 설명하는 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-0183](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0183) (영문)을 참조하십시오.
...
-   알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 RTF 문서를 열지 못하도록 Microsoft Office 파일 차단 정책 사용
    ...
    대안의 영향. 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 면제 디렉터리(exempt directory)를 구성하지 않았거나 파일을 신뢰할 수 있는 위치로 이동하지 않은 사용자는 Office 2003 또는 2007 Microsoft Office System에서 RTF 파일을 열 수 없습니다.
...
-   지원되는 Microsoft Office XP 버전은 [Creating an Administrative Installation Point(관리 설치 지점 만들기)](https://office.microsoft.com/en-us/orkxp/ha011363091033.aspx) (영문)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office XP 원래 기준선으로 클라이언트 시스템에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 922665](https://support.microsoft.com/kb/922665)를 참조하십시오.  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2598332">Microsoft 기술 자료 문서 2598332</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Word 2007의 경우 <a href="https://support.microsoft.com/kb/2596917">Microsoft 기술 자료 문서 2596917</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Office 호환 기능 팩의 경우 <a href="https://support.microsoft.com/kb/2596880">Microsoft Knowledge Base Article 2596880</a>을 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   [Windows Server 2008, Windows Vista, Windows Server 2003 및 Windows XP용 Windows Installer 4.5 재배포 가능 파일](https://www.microsoft.com/download/details.aspx?familyid=5a58b56f-60b6-4412-95b9-54d056d6f9f4&displaylang=ko)  
-   [Windows Server 2003, Windows XP 및 Microsoft Windows 2000용 Windows Installer 3.1 재배포 가능 파일](https://www.microsoft.com/download/details.aspx?familyid=889482fc-5f56-4a38-b838-de776fd4138c&displaylang=ko%5b)
...
-   RTF 불일치 취약점(CVE-2012-0183)을 [TippingPoint](https://www.tippingpoint.com/) (영문)의 [Zero Day Initiative](https://www.zerodayinitiative.com/) (영문)와 협력하여 보고해 주신 익명 연구자
