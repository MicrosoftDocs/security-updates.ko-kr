...
ms:contentKeyID: 18135308
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc720475(v=WS.10)'
---
...
| ![](images/Cc720475.note(WS.10).gif)참고                           |
|-------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720475.Important(WS.10).gif)중요     |
|--------------------------------------------------------------------------------|
