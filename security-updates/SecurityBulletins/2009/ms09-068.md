...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3135 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3135)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/973444">Microsoft 기술 자료 문서 973444</a> 참조</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
<a href="http://support.microsoft.com/kb/973443">Microsoft 기술 자료 문서 973443</a> 참조<br />
<br />
Word Viewer 2003 및 Word Viewer:<br />
<a href="http://support.microsoft.com/kb/973866">Microsoft 기술 자료 문서 973866</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Microsoft Office Word 파일 정보 메모리 손상 취약점(CVE-2009-3135)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Jun Mao
