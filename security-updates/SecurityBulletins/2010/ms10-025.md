...
|--------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 Server 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=73b3d681-26bb-49c1-849e-1f72484cb978) | 원격 코드 실행 | 긴급        | 없음                      |
...
**내 시스템에서는 Windows Media Services를 실행하고 있지 않습니다. 이 업데이트가 제공됩니까?**  
...
<th style="border:1px solid black;" >Media Services 스택 기반 버퍼 오버플로 취약점(CVE-2010-0478)</th>
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0478 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0478)을 참조하십시오.
...
-   Windows Media Player 같은 플레이어를 사용하여 콘텐츠를 재생하는 컴퓨터나 장치  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980858">Microsoft 기술 자료 문서 980858</a> 참조</td>
</tr>
<tr class="even">
...
-   Media Services 스택 기반 버퍼 오버플로 취약점(CVE-2010-0478)을 보고해 주신 [CERT-LEXSI (영문)](https://cert.lexsi.com/)의 Fabien Perigaud

Microsoft는 원본 보안 업데이트의 품질 문제에 대한 상세 정보를 제공하고 협력해 주신 다음 개인 및 회사에 대해 [감사 드립니다](https://go.microsoft.com/fwlink/?linkid=21127).

-   [CERT-LEXSI (영문)](https://cert.lexsi.com/)의 Fabien Perigaud
-   [VUPEN Vulnerability Research Team (영문)](https://www.vupen.com)
-   [TELUS Security Labs (영문)](https://telussecuritylabs.com)의 Vulnerability Research Team
