...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>ExcelTable 응답 분할 XSS 취약점(CVE-2011-1895)</th>
<th>ExcelTable의 변형된 XSS 취약점(CVE-2011-1896)</th>
<th>기본 변형 XSS 취약점(CVE-2011-1897)</th>
<th>손상된 코드 실행 취약점(CVE-2011-1969)</th>
<th>Null 세션 쿠키 충돌(CVE-2011-2012)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
