---
TOCTitle: 'MS11-017'
Title: 'Microsoft 보안 공지 MS11-017 - 중요'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61230384
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-017(v=Security.10)'
---

Microsoft 보안 공지 MS11-017 - 중요
===================================

원격 데스크톱 클라이언트의 취약점으로 인한 원격 코드 실행 문제점(2508062)
-------------------------------------------------------------------------

게시된 날짜: 2011년 3월 9일 수요일 | 업데이트된 날짜: 2011년 4월 14일 목요일
...
이 보안 업데이트의 심각도는 원격 데스크톱 연결 5.2 클라이언트, 원격 데스크톱 연결 6.0 클라이언트, 원격 데스크톱 연결 6.1 클라이언트 및 원격 데스크톱 연결 7.0 클라이언트에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Windows 원격 데스크톱 클라이언트에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2508062](https://support.microsoft.com/kb/2508062)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<tr>
<th colspan="5">
원격 데스크톱 연결 6.0 클라이언트 및 원격 데스크톱 연결 6.1 클라이언트
</th>
</tr>
...
| 운영 체제                                                 | 구성 요소                         |
|-----------------------------------------------------------|-----------------------------------|
| Windows XP Professional x64 Edition 서비스 팩 2           | 원격 데스크톱 연결 5.2 클라이언트 |
| Windows Server 2003 서비스 팩 2                           | 원격 데스크톱 연결 5.2 클라이언트 |
| Windows Server 2003 x64 Edition 서비스 팩 2               | 원격 데스크톱 연결 5.2 클라이언트 |
| Windows Server 2003 SP2(Itanium 기반 시스템용)            | 원격 데스크톱 연결 5.2 클라이언트 |
| Windows 7(32비트 시스템용) 서비스 팩 1                    | 원격 데스크톱 연결 7.1 클라이언트 |
| Windows 7(x64 기반 시스템용) 서비스 팩 1                  | 원격 데스크톱 연결 7.1 클라이언트 |
| Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1     | 원격 데스크톱 연결 7.1 클라이언트 |
| Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1 | 원격 데스크톱 연결 7.1 클라이언트 |
...
<tr>
<td style="border:1px solid black;">
Windows XP 서비스 팩 3의 원격 데스크톱 연결 5.2
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 3의 원격 데스크톱 연결 6.1
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 서비스 팩 2의 원격 데스크톱 연결 6.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 원격 데스크톱 연결 6.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 서비스 팩 2의 원격 데스크톱 연결 6.0 Multilingual User Interface(MUI)
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 서비스 팩 2의 원격 데스크톱 연결 6.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 원격 데스크톱 연결 6.1
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 원격 데스크톱 연결 6.1
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2의 원격 데스크톱 연결 6.1\*\*
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 원격 데스크톱 연결 6.1\*\*
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008(Itanium 기반 시스템용) and Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2의 원격 데스크톱 연결 6.1
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP 서비스 팩 3의 원격 데스크톱 연결 7.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 원격 데스크톱 연결 7.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 원격 데스크톱 연결 7.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows 7(32비트 시스템용)의 원격 데스크톱 연결 7.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용)의 원격 데스크톱 연결 7.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2(x64 기반 시스템용)의 원격 데스크톱 연결 7.0\*\*
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2(Itanium 기반 시스템용)의 원격 데스크톱 연결 7.0
</td>
<td style="border:1px solid black;">
**중요**   
원격 코드 실행
...
Windows 원격 데스크톱 클라이언트에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0029 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)를 참조하십시오.

#### 원격 데스크톱의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0029)에 대한 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   공격이 성공하려면 사용자가 신뢰할 수 없는 원격 파일 시스템 위치 또는 WebDAV 공유를 방문한 후 .rdp 파일을 열어야 합니다.
-   파일 공유 프로토콜인 SMB(Server Message Block)는 경계 방화벽에서 자주 비활성화됩니다. 이것이 이 취약점의 가능한 공격 경로를 제한합니다.

#### 원격 데스크톱의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0029)에 대한 대안
...
#### 원격 데스크톱의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0029)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 Windows 원격 데스크톱 클라이언트가 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.

**원격 데스크톱 클라이언트란 무엇입니까?**  
Windows의 원격 데스크톱 기능을 사용하면 두 번째 Windows 기반 컴퓨터에서 사용자의 컴퓨터에 있는 모든 프로그램, 리소스 및 주변 장치에 액세스할 수 있습니다. 연결되면 원격 데스크톱에서 첫 번째 컴퓨터의 마우스 및 키보드 제어권을 넘겨 주면서 화면에 나타나는 모든 것을 보여 줍니다.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 원격 데스크톱 구성 파일(.rdp)을 열도록 유도할 수 있습니다. 이렇게 하면 .rdp 파일을 열 때 Windows 원격 데스크톱 클라이언트가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.

전자 메일 공격 시나리오에서 공격자는 사용자에게 합법적인 .rdp 첨부 파일을 전송하고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 해당 첨부 파일을 추가하고 .rdp 파일을 열도록 유도하여 이 취약점을 악용할 수 있습니다. 이렇게 하면 .rdp 파일을 열 때 Windows 원격 데스크톱 클라이언트가 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.

네트워크 시나리오에서 공격자는 합법적인 .rdp 파일 및 특수하게 조작된 DLL을 UNC 또는 WebDAV 위치에 두고 사용자가 .rdp 파일을 열도록 유도할 수 있습니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 Windows 원격 데스크톱 클라이언트에서 외부 라이브러리를 로드하는 방식을 수정하여 이 취약점을 해결합니다.

**이 취약점은 Microsoft 보안 권고 2269637과 관련이 있습니까?**  
예, 이 업데이트에서 해결하는 취약점은 응용 프로그램이 [Microsoft 보안 권고 2269637](https://technet.microsoft.com/security/advisory/2269637)에 설명된 외부 라이브러리를 로드하는 방식에 영향을 미치는 취약점 클래스와 관련이 있습니다. 이 보안 업데이트는 이러한 취약점 유형의 특정 인스턴스를 해결합니다.

**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**  
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)가 지정되었습니다.
...
| Windows 7(32비트 시스템용) 서비스 팩 1                                                               | 아니요  | 아니요              | 예                  | 예                         |
...
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 원격 데스크톱 연결 5.2:<br />
WindowsXP-KB2483618-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 원격 데스크톱 연결 6.1:<br />
WindowsXP-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 3의 원격 데스크톱 연결 7.0:<br />
WindowsXP-KB2483614-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 원격 데스크톱 연결 6.0:<br />
...
<td style="border:1px solid black;">원격 데스크톱 연결 5.2:<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 및 원격 데스크톱 연결 6.1:<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 7.0:<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">원격 데스크톱 연결 5.2:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2483618$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 및 원격 데스크톱 연결 6.1:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2481109$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 7.0:<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2483614$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">원격 데스크톱 연결 5.2:<br />
<a href="https://support.microsoft.com/kb/2483618">Microsoft 기술 자료 문서 2483618</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 및 원격 데스크톱 연결 6.1:<br />
<a href="https://support.microsoft.com/kb/2481109">Microsoft 기술 자료 문서 2481109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 7.0:<br />
<a href="https://support.microsoft.com/kb/2483614">Microsoft 기술 자료 문서 2483614</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 원격 데스크톱 연결 6.0:<br />
WindowsServer2003-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 서비스 팩 2의 원격 데스크톱 연결 6.0 Multilingual User Interface(MUI):<br />
WindowsServer2003-KB2483619-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 원격 데스크톱 연결 6.0:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0:<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 클라이언트 Multilingual User Interface(MUI):<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">추가 정보</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 클라이언트 Multilingual User Interface(MUI):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2483619$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0 클라이언트 Multilingual User Interface(MUI):<br />
<a href="https://support.microsoft.com/kb/2483619">Microsoft 기술 자료 문서 2483619</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 원격 데스크톱 연결 6.1:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2의 원격 데스크톱 연결 7.0:<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2의 원격 데스크톱 연결 6.1:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">원격 데스크톱 연결 6.1:<br />
<a href="https://support.microsoft.com/kb/2481109">Microsoft 기술 자료 문서 2481109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 원격 데스크톱 연결 6.1:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 원격 데스크톱 연결 6.1:<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 Itanium 기반 에디션의 원격 데스크톱 연결 6.1:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2481109">Microsoft 기술 자료 문서 2481109</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 원래 버전의 32비트 에디션의 원격 데스크톱 연결 7.0:<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows 7 원래 버전의 x64 기반 에디션의 원격 데스크톱 연결 7.0:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2483614">Microsoft 기술 자료 문서 2483614</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 원래 버전의 x64 기반 에디션의 원격 데스크톱 연결 7.0:<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 R2 원래 버전의 Itanium 기반 에디션의 원격 데스크톱 연결 7.0:<br />
...
-   원격 데스크톱의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-0029)을 보고해 주신 [Versafe Anti Fraud (영문)](https://www.versafe-login.com/)의 Eyal Gruner
...
-   V1.1(2011년 3월 9일): Windows XP 서비스 팩 3 및 Windows Server 2003 서비스 팩 2에 대한 SMS 2.0 및 SMS 2003(SUIT 포함)의 Systems Management Server 표 항목이 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.  
-   V1.2(2011년 3월 10일): Windows 7 서비스 팩 1 및 Windows Server 2008 R2 서비스 팩 1 버전의 **영향을 받지 않는 소프트웨어** 구성 요소 항목이 원격 데스크톱 연결 7.0 클라이언트에서 원격 데스크톱 연결 7.1 클라이언트로 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 보안 업데이트 파일이나 검색 로직에 대한 변경 사항은 없습니다.  
-   V1.3(2011년 4월 14일): 지원 대상인 Windows Server 2003 에디션의 원격 데스크톱 연결 6.0 클라이언트 및 지원 대상인 Windows Vista에디션의 원격 데스크톱 연결 6.1 클라이언트에 대한 공지 교체 정보가 수정되었습니다. 이 변경 사항은 공지에만 해당됩니다. 검색이나 보안 업데이트 파일에 대한 변경 사항은 없습니다.
