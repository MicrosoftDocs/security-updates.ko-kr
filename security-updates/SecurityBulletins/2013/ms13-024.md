...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0080](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0080)(영문)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0083)(영문)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0084](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0084)(영문)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0085](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0085)(영문)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2553407">Microsoft 기술 자료 문서 2553407</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2687418">Microsoft 기술 자료 문서 2687418</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   콜백 기능 취약점(CVE-2013-0080)을 보고해 주신 [BugSec](https://www.bugsec.com/)의 Emanuel Bronshtein  
-   SharePoint XSS 취약점(CVE-2013-0083)을 보고해 주신 INR Labs([Network Intelligence India](https://niiconsulting.com/)(영문))의 Sunil Yadav  
