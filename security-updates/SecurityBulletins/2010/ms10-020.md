---
TOCTitle: 'MS10-020'
Title: 'Microsoft 보안 공지 MS10-020 - 긴급'
ms:assetid: 'ms10-020'
ms:contentKeyID: 61230281
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-020(v=Security.10)'
---



Microsoft 보안 공지 MS10-020 - 긴급
===================================
...
보안 업데이트는 SMB 클라이언트가 SMB 응답을 처리하고, 메모리를 할당하고, SMB 응답 내의 필드 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.

이 보안 업데이트는 [Microsoft 보안 권고 977544](https://technet.microsoft.com/security/advisory/977544)에서 처음 설명한 취약점도 해결합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=67ccac04-e5c8-4381-9d1a-9b676dd516a6&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=dec38c02-3d4a-41c5-8954-e57f56b8fa5b&displaylang=ko)                                                          | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c5a21239-a9a3-4ec5-9de8-7d2fc16fc6b8)                                                                          | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1189304f-d626-426d-960c-a86dc2d2b528&displaylang=ko)                                                                           | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=52e4f66b-b76c-46a1-aeff-74efa21fc743&displaylang=ko)                                                               | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b2b6d8b1-63cc-459c-b5fa-1355386273c8)                                                                           | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=25eeaeb3-c0a3-4a02-9912-acd0342648ba&displaylang=ko)                                     | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=394c1caa-97e4-47a3-9aac-a4a88508bd31&displaylang=ko) | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=51c9c420-4507-4911-a8f5-82331a696882&displaylang=ko)\*                | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=61c26a1f-c885-4474-9843-204c41628889&displaylang=ko)\*            | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bcf8b919-08a9-487f-8dfd-3ca24328c4f3)                     | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=389184c5-9001-497d-bdf4-81f97ecb617f&displaylang=ko)                                                                                | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=f3495dae-71f3-421d-a191-d26965f26ad1&displaylang=ko)                                                                              | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=cd1a046e-915d-4904-b753-5a24be10c504&displaylang=ko)\*                                                               | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=541e9e2f-ec1d-42b2-aae5-481c0d435169)                                                                            | 원격 코드 실행 | 긴급        | [MS10-006](https://technet.microsoft.com/security/bulletin/ms10-006) |
...
<th style="border:1px solid black;" >SMB 클라이언트 불완전 응답 취약점(CVE-2009-3676)</th>
<th style="border:1px solid black;" >SMB 클라이언트 메모리 할당 취약점(CVE-2010-0269)</th>
<th style="border:1px solid black;" >SMB 클라이언트 트랜잭션 취약점(CVE-2010-0270)</th>
<th style="border:1px solid black;" >SMB 클라이언트 응답 구문 분석 취약점(CVE-2010-0476)</th>
<th style="border:1px solid black;" >SMB 클라이언트 메시지 크기 취약점(CVE-2010-0477)</th>
...
SMB 클라이언트 불완전 응답 취약점(CVE-2009-3676)  
------------------------------------------------
  

Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답을 처리하는 방식에 서비스 거부 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 컴퓨터가 다시 시작될 때까지 컴퓨터에서 응답을 중지하도록 만들 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3676 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3676)을 참조하십시오.
  
#### SMB 클라이언트 불완전 응답 취약점(CVE-2009-3676)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다.  
...
#### SMB 클라이언트 불완전 응답 취약점(CVE-2009-3676)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   **방화벽에서 TCP 포트 139 및 445 차단**
  
    이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 TCP 포트 139 및 445를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 이러한 특정 취약점의 경우, 노출을 줄이기 위해 인바운드 및 아웃바운드 SMB 트래픽을 차단해야 합니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
...
#### SMB 클라이언트 불완전 응답 취약점(CVE-2009-3676)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이것은 서비스 거부 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다. 서비스 거부 취약점으로 인해 공격자가 코드를 실행하거나 사용자 권한이 상승되는 것은 아니지만 영향을 받는 시스템이 수동으로 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트 구현이 불완전한 SMB 응답을 잘못 처리하기 때문에 발생합니다.
  
**Microsoft SMB(Server Message Block) 프로토콜이란 무엇입니까?**    
Microsoft SMB(Server Message Block) 프로토콜은 Microsoft Windows에 사용되는 Microsoft 네트워크 파일 공유 프로토콜입니다. SMB에 대한 자세한 내용은 MSDN 문서, Microsoft SMB 프로토콜 및 CIFS 프로토콜 개요를 참조하십시오.
...
-   클라이언트 연결이 일시적으로 끊긴 경우 연결을 다시 설정해야 하는 파일을 열 수 있도록 허용.  
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 클라이언트가 불완전한 SMB 응답을 처리하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3676 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3676)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
아니요. Microsoft는 이 보안 공지를 처음에 게시했을 때 이 취약점이 고객을 공격하는 데 공개적으로 사용되었다는 정보를 확인하지 못했습니다.
  
SMB 클라이언트 메모리 할당 취약점(CVE-2010-0269)  
------------------------------------------------
  

특수하게 조작된 SMB 응답을 구문 분석할 때 Microsoft SMB(Server Message Block) 클라이언트 구현이 메모리를 할당하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0269 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0269)를 참조하십시오.
  
#### SMB 클라이언트 메모리 할당 취약점(CVE-2010-0269)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB 클라이언트 메모리 할당 취약점(CVE-2010-0269)에 대한 대안
...
#### SMB 클라이언트 메모리 할당 취약점(CVE-2010-0269)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답을 구문 분석할 때 메모리를 부적절하게 할당하기 때문에 발생합니다.
  
**Microsoft SMB(Server Message Block) 프로토콜이란 무엇입니까?**    
Microsoft SMB(Server Message Block) 프로토콜은 Microsoft Windows에 사용되는 Microsoft 네트워크 파일 공유 프로토콜입니다. SMB에 대한 자세한 내용은 [MSDN 문서, Microsoft SMB 프로토콜 및 CIFS 프로토콜 개요 (영문)](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)를 참조하십시오.
...
**어떤 SMB 버전이 이 취약점의 영향을 받습니까?**    
이 CVE에 의해 처리된 문제는 SMBv1과 SMBv2 둘 다에 영향을 미칩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 클라이언트가 특수하게 조작된 SMB 응답을 구문 분석할 때 SMB 클라이언트가 메모리를 할당하는 방식을 수정하여 취약점을 해결합니다.
...
SMB 클라이언트 트랜잭션 취약점(CVE-2010-0270)  
---------------------------------------------
  

Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 트랜잭션 응답을 처리하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0270 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0270)을 참조하십시오.
  
#### SMB 클라이언트 트랜잭션 취약점(CVE-2010-0270)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB 클라이언트 트랜잭션 취약점(CVE-2010-0270)에 대한 대안
...
#### SMB 클라이언트 트랜잭션 취약점(CVE-2010-0270)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트가 SMB 응답에 있는 필드에 대한 유효성 검사를 제대로 수행하지 못하기 때문에 발생합니다. 이로 인해 메모리 손상 문제가 발생하고 시스템 수준 권한으로 코드 실행이 허용됩니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 응답 내의 필드 유효성이 검사되는 방식을 수정하여 취약점을 해결합니다.
...
SMB 클라이언트 응답 구문 분석 취약점(CVE-2010-0476)  
---------------------------------------------------
  

Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 트랜잭션 응답을 구문 분석하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0476 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0476)을 참조하십시오.
  
#### SMB 클라이언트 응답 구문 분석 취약점(CVE-2010-0476)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB 클라이언트 응답 구문 분석 취약점(CVE-2010-0476)에 대한 대안
...
#### SMB 클라이언트 응답 구문 분석 취약점(CVE-2010-0476)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 트랜잭션 응답의 구문을 제대로 분석하지 못해 발생합니다. 이로 인해 메모리 손상 문제가 발생하고 시스템 수준 권한으로 코드 실행이 허용됩니다.
...
**Windows 7 및 Windows Server 2008 R2가 낮음 심각도로 표시되는 이유는 무엇입니까?**    
이 취약점이 이러한 플랫폼에 직접적으로 영향을 미치지 않더라도 이 문제에 취약한 타사의 TDI 필터가 있을 수 있습니다. 업데이트는 이 문제를 해결합니다. 이러한 플랫폼에는 이 문제에 취약한 TDI 필터가 제공되지 않습니다. Microsoft는 이 문제의 영향을 받는 타사 TDI 필터를 알고 있지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 클라이언트가 특수하게 조작된 SMB 트랜잭션 응답을 구문 분석하는 방식을 수정하여 취약점을 해결합니다.
...
SMB 클라이언트 메시지 크기 취약점(CVE-2010-0477)  
------------------------------------------------
  

Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답을 처리하는 방식에 인증되지 않은 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용하려는 시도에는 인증이 필요하지 않으며 공격자는 특수하게 조작된 SMB 응답을 클라이언트가 시작한 SMB 요청으로 보내 취약점을 악용할 수 있습니다. 취약점 악용에 성공한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0477 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0477)을 참조하십시오.
  
#### SMB 클라이언트 메모리 크기 취약점(CVE-2010-0477)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이런 경우 SMB 포트를 인터넷에서 차단해야 합니다.
  
#### SMB 클라이언트 메모리 크기 취약점(CVE-2010-0477)에 대한 대안
...
#### SMB 클라이언트 메모리 크기 취약점(CVE-2010-0477)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 원격 코드 실행 취약점입니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
이 취약점은 Microsoft SMB(Server Message Block) 클라이언트 구현이 특수하게 조작된 SMB 응답을 부적절하게 처리하여 SMB 클라이언트가 전체 응답을 소비하고 Winsock 커널에 대해 유효하지 않은 값을 지정하도록 하기 때문에 발생합니다.
...
**Winsock 커널이란 무엇입니까?**    
WSK(Winsock 커널)는 커널 모드 NPI(네트워크 프로그래밍 인터페이스)입니다. WSK를 통해 커널 모드 소프트웨어 모듈은 사용자 모드 Winsock2에서 지원하는 동일한 소켓 프로그래밍 개념을 사용하여 네트워크 I/O 작업을 수행할 수 있습니다. WSK NPI는 스켓 작성, 바인딩, 연결 설정 및 데이터 전송(보내고 받기) 같은 익숙한 소켓 작업을 지원합니다. 그러나 WSK NPI는 사용자 모드 Winsock2와 동일한 소켓 프로그램 개념을 대부분 지원하지만 IRP 및 이벤트 콜백을 사용하여 성능을 향상시키는 비동기 I/O와 같은 고유한 특성을 갖는 완전히 새롭고 다른 인터페이스입니다. 자세한 내용은 MSDN 문서 [Winsock 커널 (영문)](https://msdn.microsoft.com/en-us/library/ff571084.aspx)을 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 SMB 클라이언트가 특수하게 조작된 SMB 응답을 처리하는 방식을 수정하여 취약점을 해결합니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-KB980232-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-KB980232-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | KB980232.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB980232$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 980232](https://support.microsoft.com/kb/980232) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB980232\\Filelist                                        |
...
WindowsXP-KB980232-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB980232-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB980232$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/980232">Microsoft 기술 자료 문서 980232</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB980232-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB980232-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB980232-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
WindowsServer2003.WindowsXP-KB980232-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   SMB 클라이언트 메모리 할당 취약점(CVE-2010-0269)을 보고해 주신 [Visuality Systems Ltd. (영문)](https://www.visualitynq.com/)의 Mark Rabinovich  
-   SMB 클라이언트 트랜잭션 취약점(CVE-2010-0270)을 보고해 주신 [stratsec (영문)](https://www.stratsec.net/)의 Laurent Gaffié  
-   SMB 클라이언트 응답 구문 분석 취약점(CVE-2010-0476)을 보고해 주신 [stratsec (영문)](https://www.stratsec.net/)의 Laurent Gaffié  
-   SMB 클라이언트 메시지 크기 취약점(CVE-2010-0477)을 보고해 주신 [stratsec (영문)](https://www.stratsec.net/)의 Laurent Gaffié
