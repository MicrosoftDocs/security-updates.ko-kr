---
TOCTitle: 'MS12-056'
Title: 'Microsoft 보안 공지 MS12-056 - 중요'
ms:assetid: 'ms12-056'
ms:contentKeyID: 61230523
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-056(v=Security.10)'
---

Microsoft 보안 공지 MS12-056 - 중요
===================================

JScript 및 VBScript 엔진의 취약점으로 인한 원격 코드 실행 문제점 (2706045)
--------------------------------------------------------------------------

게시된 날짜: 2012년 8월 14일 화요일 | 업데이트된 날짜: 2013년 7월 10일 수요일
...
이 보안 업데이트의 심각도는 64비트 Windows 클라이언트의 JScript 5.8 및 VBScript 5.8에 대해 중요입니다. 이 보안 업데이트의 심각도는 64비트 Windows 서버의 JScript 5.8 및 VBScript 5.8에 대해 낮음입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 JScript 및 VBScript가 메모리에서 개체를 처리하는 방법을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e1b9a081-0329-4db6-b026-04a332cb0b4d">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=81f5d8a5-12e5-4227-ae6f-5aea6ffff2a5&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=294a7eb4-c47f-449f-8931-262bec7d6ecc&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=47b2e47f-30f1-48e8-a857-70df319011ef">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ece661be-4ddf-42cc-a62b-15ce53b9d74b&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbb876e6-a6b9-4193-be5e-d84390d30f1e&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=97004a96-0c83-421d-91a9-d55be32610c9">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2706045](https://support.microsoft.com/kb/2706045)를 참조하십시오.
...
이 보안 업데이트는 MS12-052와 어떤 관련이 있습니까?  
이 공지에서 설명하는 JavaScript 정수 오버플로 원격 코드 실행 취약점(CVE-2012-2523)은 [MS12-052](https://go.microsoft.com/fwlink/?linkid=255327)를 통해서도 해결됩니다.

시스템에 Internet Explorer 8을 설치한 고객은 CVE-2012-2523에 설명된 취약점으로부터 보호하기 위해 이 공지에서 설명하는 KB2706045 업데이트를 설치해야 합니다.

시스템에 Internet Explorer 9를 설치한 고객은 CVE-2012-2523에 설명된 취약점으로부터 보호하기 위해 [MS12-052](https://go.microsoft.com/fwlink/?linkid=255327)에서 설명하는 KB2722913 업데이트를 설치해야 합니다.

내 시스템에 설치되어 있는 JScript 및 VBScript 스크립팅 엔진의 버전은 어떻게 확인합니까?  
Internet Explorer 8, Internet Explorer 9 및 Internet Explorer 10에는 JScript 5.8 및 VBScript 5.8 스크립팅 엔진이 포함되어 있습니다. KB2706045 업데이트 패키지는 Internet Explorer 8 버전의 JScript 및 VBScript를 업데이트합니다. MS12-052에 설명된 KB2722913 업데이트 패키지는 Internet Explorer 9 버전을 업데이트합니다. Internet Explorer 10 버전은 이미 최신 버전이므로 이 업데이트가 필요 없습니다.
...
<th style="border:1px solid black;" >JavaScript 정수 오버플로 원격 코드 실행 취약점(CVE-2012-2523)</th>
<th style="border:1px solid black;" >전체 심각도</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">중요 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2의 VBScript 5.8 및 JScript 5.8</td>
<td style="border:1px solid black;">낮음 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition 서비스 팩 2의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">중요 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008(x64 기반 시스템용) 서비스 팩 2의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">낮음 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows 7(x64 기반 시스템용)의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">중요 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 7(x64 기반 시스템용) 서비스 팩 1의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">중요 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2(x64 기반 시스템용)의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">낮음 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">낮음 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2(Itanium 기반 시스템용)의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">낮음 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1의 JScript 5.8 및 VBScript 5.8</td>
<td style="border:1px solid black;">낮음 <br />
원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
</tr>
...
JScript 및 VBScript 엔진이 복사 작업 도중 메모리에서 개체의 크기를 계산하는 방식에 원격 코드 실행 취약점이 존재합니다. 취약점으로 인해 메모리가 손상되고 공격자가 현재 사용자의 컨텍스트에서 임의 코드를 실행할 수 있습니다. 현재 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
...
-   32비트 버전Internet Explorer 사용
    ...
    2.  Internet Explorer를 기본 브라우저로 설정할 것인지 묻는 메시지가 표시되면 예를 클릭합니다. 이렇게만 하면 모든 설정이 완료됩니다.  
        메시지가 나타나지 않으면 다음 단계로 이동합니다.  
...
취약점의 원인은 무엇입니까?  
이 취약점은 JScript 엔진이 복사 작업 도중 메모리에서 개체의 크기를 부적절하게 계산할 때 발생합니다.
  
JScript란 무엇입니까?  
JScript는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. JScript 스크립트는 ASP(Active Server Pages), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 좀 더 구체적으로 말하자면, JScript는 Microsoft에서 ECMA 262 언어 사양(ECMAScript Edition 3)을 구현한 것입니다. 자세한 내용은 MSDN 문서, [JScript 기본 정보](https://msdn.microsoft.com/en-us/library/6974wx4d(vs.85).aspx)(영문)를 참조하거나 웹 사이트, [ECMA International](https://www.ecma-international.org/)(영문)을 참조하십시오.
  
VBScript란 무엇입니까 ?  
VBScript(Visual Basic 스크립트)는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. VBScript 스크립트는 ASP(Active Server Page), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 자세한 내용은 MSDN 문서, [VBScript 기본 사항](https://msdn.microsoft.com/en-us/library/0ad0dkea(vs.85).aspx)(영문)을 참조하십시오.
...
워크스테이션 또는 터미널 서버와 같이 Internet Explorer 8 및 Internet Explorer 9를 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 JScript 및 VBScript가 메모리에서 개체를 처리하는 방법을 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션의 JScript 5.8 및 VBScript 5.8:<br />
...
<td style="border:1px solid black;">JScript 5.8 및 VBScript 5.8: KB2706045-IE8.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">지원 대상인 모든 Windows XP x64 기반 에디션의 JScript 5.8 및 VBScript 5.8:<br />
제어판의 프로그램 추가/제거 항목 또는 %Windir%\ie8updates\KB2706045-IE8\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2706045">Microsoft 기술 자료 문서 2706045</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 JScript 5.8 및 VBScript 5.8:<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
#### Windows Server 2008 R2(64비트 에디션)
...
-   V1.1(2013년 7월 10일): Windows Update의 다시 제공 문제를 수정하기 위해 2706045 업데이트에서 Windows Vista 패키지의 검색 변경 사항을 알리고자 공지가 개정되었습니다. 이 변경 사항은 검색에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.
