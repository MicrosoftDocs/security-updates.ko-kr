...
이 보안 업데이트는 Microsoft PowerPoint에서 발견되어 비공개적으로 보고된 3건의 취약점을 해결합니다. 이러한 취약점으로 인해 사용자가 특수하게 조작된 PowerPoint 파일을 열 경우 원격 코드 실행이 발생할 수 있습니다. 이러한 취약점 중 하나를 성공적으로 악용한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다. [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)에서 사용할 수 있는 PowerPoint 2010, "PowerPoint 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"에 대한 **Microsoft Fix it** 자동화 솔루션은 CVE-2011-0655 및 CVE-2011-0656에 설명된 취약점을 악용하는 공격 경로를 차단합니다.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2489283](https://support.microsoft.com/kb/2489283)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2002 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=0d215ab6-c9be-4f43-9501-658bb7ef008e&displaylang=ko)  
(KB2464617)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=2ce8349f-79b1-41ef-a1c0-cbe40ccf9f20&displaylang=ko)  
(KB2464588)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6b2526fe-a061-4a17-992e-ac867bef130e&displaylang=ko)  
(KB2464594)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2010(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=549ca7f0-44bf-4965-a9d2-aa5e8dac2238&displaylang=ko)<sup>[1]</sup>
(KB2519975)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2010(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=ef62deae-2b07-41c9-a4bf-b746566e59ee&displaylang=ko)<sup>[1]</sup>
(KB2519975)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Word, Excel, PowerPoint 2007 파일 형식 서비스 팩 2용 Microsoft Office 호환 기능 팩](https://www.microsoft.com/download/details.aspx?familyid=913efc28-7deb-47b8-8c22-8eb5fc2631e4&displaylang=ko)  
(KB2464635)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr>
<td style="border:1px solid black;">
[Microsoft PowerPoint Viewer 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e23d3c3-2944-42ea-80b3-0663af60d0f1&displaylang=ko)  
(KB2464623)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft PowerPoint Viewer](https://www.microsoft.com/download/details.aspx?familyid=44a703f5-b581-4900-bdbb-0f0e8d9bf0e6&displaylang=ko)  
(KB2519984)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<sup>[1]</sup>[Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)에서 사용할 수 있는 PowerPoint 2010, "PowerPoint 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"에 대한 **Microsoft Fix it** 자동화 솔루션은 CVE-2011-0655 및 CVE-2011-0656에 설명된 취약점을 악용하는 공격 경로를 차단합니다. 자세한 내용은 다음 섹션의 FAQ 항목, "Microsoft Fix it 솔루션을 적용하여 제한된 보기에서 편집을 사용하지 않도록 설정한 경우 얻을 수 있는 이점은 무엇입니까?"를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9847dc05-7d4a-4a64-9e6a-622d3fa171f9&amp;displaylang=ko">Microsoft PowerPoint Web App</a><br />
(KB2520047)</td>
...
예. Microsoft PowerPoint 2003 서비스 팩 3(KB2464588) 및 Microsoft PowerPoint 2007 서비스 팩 2(KB2464594)의 업데이트는 [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023)에서 제공되는 업데이트와 함께 Office 파일 유효성 검사 기능을 지원합니다. Office 파일 유효성 검사 기능에 대한 자세한 내용은 [Microsoft 보안 권고 2501584](https://technet.microsoft.com/security/advisory/2501584)를 참조하십시오.
  
**이 보안 업데이트는 MS10-087 및 MS10-088과 어떤 관련이 있습니까?**  
이 공지에서 제공하는 Microsoft Office 2004 for Mac(KB2505924)용 업데이트는 [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) 및 [MS10-088](https://technet.microsoft.com/security/bulletin/ms10-088) 보안 공지에서 설명하는 취약점도 해결합니다.
...
Fix it 자동화 솔루션, "PowerPoint 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"을 적용하는 방법은 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)를 참조하고 이 솔루션을 수동으로 적용하는 방법은 이 공지의 취약점 정보 섹션에서 CVE-2011-0655 및 CVE-2011-0656의 대안 섹션을 참조하십시오.
...
이 공지에서 제공하는 Microsoft Office 2004 for Mac(KB2505924), Microsoft Office 2008 for Mac(KB2505927) 및 Open XML File Format Converter for Mac(KB2505935)용 보안 업데이트 패키지는 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021) 및 [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-023) 보안 공지에서 설명하는 취약점도 해결합니다. 이 공지에서 제공하는 Microsoft Office for Mac 2011(KB2525412)용 보안 업데이트 패키지는 [MS11-021](https://technet.microsoft.com/security/bulletin/ms11-021)에서 설명하는 취약점도 해결합니다. Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac, Open XML File Format Converter for Mac 또는 Microsoft Office for Mac 2011이 설치된 사용자는 이 보안 업데이트 패키지를 한 번만 설치하면 됩니다.
...
영향을 받는 소프트웨어에 이 보안 업데이트를 적용하면 지원 대상인 Microsoft PowerPoint 2003 및 Microsoft PowerPoint 2007 에디션을 실행하는 고객은 PowerPoint의 [CD용 프레젠테이션 패키지 만들기](https://support.microsoft.com/kb/828504) 기능을 사용하여 만든 업데이트된 프레젠테이션 버전을 실행하기 때문에 프레젠테이션에 포함된 PowerPoint Viewer는 이 공지에 설명된 취약점으로부터 보호를 받습니다.
...
**Microsoft Office 독립 실행형 프로그램은 어떻게 이러한 취약점의 영향을 받습니까?**  
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [3월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-mar)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0655 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0655)를 참조하십시오.
...
-   Microsoft PowerPoint 2010에서는 Microsoft Office 2010이 기본적으로 사용하는 Office 파일 유효성 검사를 통한 보호 덕분에 공격자가 이 취약점을 악용하는 데 성공할 가능성이 낮습니다. 이 취약점을 악용하는 데 사용되는 특수하게 조작된 파일이 제한된 보기에서 열리며 사용자는 파일이 안전하지 않다는 것과 파일이 유효성 검사를 통과하지 못해서 유해할 가능성이 있다는 경고를 받습니다. 사용자가 여러 번의 경고 대화 상자를 클릭한 후에 파일을 열어서 편집하거나 저장해야만 취약점이 악용될 수 있습니다. 제한된 보기 및 Office 파일 유효성 검사에 대한 자세한 내용은 TechNet 문서, [Office 2010의 보안 개요](https://technet.microsoft.com/library/cc179050.aspx)를 참조하십시오.  
...
-   **PowerPoint 2010의 제한된 보기에서 편집을 사용하지 않도록 Office 파일 유효성 검사 설정**
    ...
    **참고** 이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2501584](https://support.microsoft.com/kb/2501584)를 참조하여 **Microsoft Fix it** 자동화 솔루션, "PowerPoint 2010의 제한된 보기에서 편집을 사용하지 않도록 설정"을 사용하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 Microsoft PowerPoint에서 열지 못하게 합니다.**
    ...
    **대안의 영향.** Microsoft Office 2007의 경우, 파일 차단 정책은 구현했으나 [Microsoft 기술 자료 문서 922848](https://support.microsoft.com/kb/922848)에서 설명한 특수 면제 디렉터리(exempt directory)를 구성하지 않았거나 파일을 신뢰할 수 있는 위치로 이동하지 않은 사용자는 Office 2003 이전 버전의 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0656 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0656)을 참조하십시오.
...
#### 일정한 디렉터리 RCE 취약점(CVE-2011-0656)에 대한 FAQ
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0976 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0976)을 참조하십시오.
...
#### OfficeArt Atom RCE 취약점(CVE-2011-0976)에 대한 대안
...
| Microsoft PowerPoint Viewer 2007 서비스 팩 2                                       | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft PowerPoint Viewer                                                        | 아니요  | 아니요              | 예                  | 예                         |
| Microsoft PowerPoint Web App                                                       | 아니요  | 아니요              | 예                  | 예                         |
...
-   지원 대상인 Microsoft Office 버전에 네트워크 설치 지점을 만드는 방법에 대한 자세한 내용은 [Microsoft Office의 네트워크 설치 지점 만들기](https://technet.microsoft.com/library/cc179063.aspx)를 참조하십시오.  
    **참고** 중앙에서 보안 업데이트를 관리하려는 경우 Windows Server Update Services를 사용합니다. Microsoft Office용 보안 업데이트를 배포하는 방법에 대한 자세한 내용은 [Windows Server Update Services 웹 사이트 (영문)](https://technet.microsoft.com/wsus/default.aspx)를 방문하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2464617">Microsoft 기술 자료 문서 2464617</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">PowerPoint 2003 서비스 팩 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2464588">Microsoft 기술 자료 문서 2464588</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### PowerPoint 2007(모든 에디션), Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩(모든 버전) 및 PowerPoint Viewer 2007(모든 버전)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">PowerPoint 2007의 경우 <a href="https://support.microsoft.com/kb/2464594">Microsoft 기술 자료 문서 2464594</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩 서비스 팩 2의 경우 <a href="https://support.microsoft.com/kb/2464635">Microsoft 기술 자료 문서 2464635</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint Viewer 2007 서비스 팩 2의 경우 <a href="https://support.microsoft.com/kb/2464623">Microsoft 기술 자료 문서 2464623</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
#### PowerPoint 2010(모든 에디션), PowerPoint Viewer(모든 버전) 및 PowerPoint Web App
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">PowerPoint 2010(32비트 에디션):<br />
PowerPoint2010-kb2519975-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint 2010(64비트 에디션):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">PowerPoint 2010의 경우 <a href="https://support.microsoft.com/kb/2519975">Microsoft 기술 자료 문서 2519975</a>를 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint Viewer의 경우 <a href="https://support.microsoft.com/kb/2519984">Microsoft 기술 자료 문서 2519984</a>를 참조하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint Web App의 경우 <a href="https://support.microsoft.com/kb/2520047">Microsoft 기술 자료 문서 2520047</a>을 참조하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2004 for Mac 11.6.3 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5)에서 다운로드하여 설치하십시오.
...
버전 번호가 **11.6.3**이면 업데이트가 설치된 것입니다.
...
Microsoft Office 2008 for Mac 12.2.9 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918)에서 다운로드하여 설치하십시오.
...
버전 번호가 **12.2.9**이면 업데이트가 설치된 것입니다.
...
Microsoft Office for Mac 2011 14.1 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=ef1e612f-d8e3-4628-9fe4-ad136f0debd3)에서 다운로드하여 설치하십시오.
...
설치된 최신 업데이트 버전 번호가 **14.1**이면 업데이트가 성공적으로 설치된 것입니다.
...
Open XML File Format Converter for Mac 1.1.9 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14)에서 다운로드하여 설치하십시오.
...
버전 번호가 **1.1.9**이면 업데이트가 설치된 것입니다.
...
-   부동점 테크노컬러 타임 밴디트 RCE 취약점(CVE-2011-0655)을 [TippingPoint's (영문)](https://www.tippingpoint.com/)**[Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   일정한 디렉터리 RCE 취약점(CVE-2011-0656)을 [TippingPoint's (영문)](https://www.tippingpoint.com/)**[Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자  
-   OfficeArt Atom RCE 취약점(CVE-2011-0976)을 [TippingPoint's (영문)](https://www.tippingpoint.com/)**[Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
...
-   V1.0(2011년 4월 12일): 공지가 게시되었습니다.
    ...
    V1.1(2011년 4월 21일): Microsoft PowerPoint Web App 업데이트(KB2520047)에 대한 공지 교체 정보가 수정되었습니다. 이 변경 사항은 정보에만 해당됩니다. 검색 로직이나 업데이트 파일에 대한 변경 사항은 없습니다.
