...
**참고:** 개체** **액세스를 제외하고 모든 감사 범주가 설정된 도메인 컨트롤러는 시간당 약 3,000개의 보안 이벤트를 생성할 수 있습니다. 이 정보를 Event Comb MT에서 .CSV 파일로 저장하면 1MB 크기의 파일이 만들어집니다. 개체 액세스 감사 및 프로세스 추적을 사용하면 이러한 파일 크기가 크게 증가할 수 있습니다.
