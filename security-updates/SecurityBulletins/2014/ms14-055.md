...
<tr>
<td style="border:1px solid black;">
[Microsoft Lync Server 2010](https://www.microsoft.com/download/details.aspx?familyid=242b60fd-e25b-4ea3-9666-b9a4ea2e7dfd&displaylang=ko)  
(서버)  
(2982385)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Lync Server 2013](https://www.microsoft.com/download/details.aspx?familyid=ec851cbf-83eb-44d0-8325-56fc2d5e13fd&displaylang=ko)  
(서버)  
(2986072)
...
<td style="border:1px solid black;">
[MS14-032](https://go.microsoft.com/fwlink/?linkid=400969)의 2963288
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4068](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4068)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4070](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4070)을 참조하십시오.
...
-   **일반 텍스트로 전자 메일 메시지 읽기**
    ...
    -   [전자 메일 메시지를 일반 텍스트로 읽기](https://office.microsoft.com/ko-kr/outlook-help/read-email-messages-in-plain-text-ha102748923.aspx)(Outlook 2013)
    -   [Microsoft 기술 자료 문서 831607](https://support.microsoft.com/kb/831607)(Outlook 2010)
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4071](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4071)을 참조하십시오.
...
-   Lync 서비스 거부 취약점(CVE-2014-4068)을 보고해 주신 [Telecommunication Software GmbH](https://www.telecomsoftware.com/)의 Peter Schraffl
-   Lync XSS 정보 유출 취약점(CVE-2014-4070)을 Beyond Security의 [SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 팀과 협력하여 보고해 주신 Noam Rathaus
