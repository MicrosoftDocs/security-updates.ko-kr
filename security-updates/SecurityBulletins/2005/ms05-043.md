...
**주의 사항:** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 908506](https://support.microsoft.com/kb/908506)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 자세한 내용은 [Microsoft 기술 자료 문서 908506](https://support.microsoft.com/kb/908506)을 참조하십시오.

**테스트된 소프트웨어 및 보안 업데이트 다운로드 위치:**

**영향을 받는 소프트웨어:**

-   Microsoft Windows 2000 서비스 팩 4 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=3dd3b530-7f43-4c18-8298-6e8797431a5d&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ef402946-1c3b-47e9-9d51-77d890df8725&displaylang=ko)
-   Microsoft Windows Server 2003 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=25469675-df28-4889-8d13-25efcd498388&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f0aec064-34a3-4ee4-9f15-be1e3dd02bc7)
...
|--------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|
| 인쇄 스풀러 취약점 - [CAN-2005-1984 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1984) | 원격 코드 실행       | 긴급         | 긴급                   | 보통                   | 보통                |
...
[Microsoft 기술 자료 문서 908506](https://support.microsoft.com/kb/908506): Windows 2000 서비스 팩 4를 실행하는 컴퓨터에서 보안 업데이트 896423을 설치한 다음 네트워크 프린터를 통한 인쇄를 못하게 될 수 있습니다.
...
**인쇄 스풀러 서비스란 무엇입니까?**  
인쇄 스풀러 서비스인 Spoolsv.exe는 서비스로 설치된 실행 파일입니다. 스풀러는 운영 체제를 시작할 때 로드되며 운영 체제를 종료할 때까지 계속 실행됩니다. 인쇄 스풀러 서비스는 올바른 프린터 드라이버의 위치 검색, 해당 드라이버 로드, 높은 수준의 함수 호출을 인쇄 작업에 스풀링, 인쇄 작업 예약 등의 작업을 포함하는 인쇄 프로세스를 관리합니다. 특정 인쇄 작업이 완료되면 인쇄 스풀러 서비스는 인쇄 라우터로 작업을 전달합니다. 인쇄 스풀러 서비스에 대한 자세한 내용은 다음 [웹 사이트](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/techref/d58ce7b9-49cf-4f5e-95e9-1ade005c13e0.mspx)를 방문하십시오.
...
이 업데이트를 적용하기 위해 다시 시작할 필요는 없습니다. 다시 부팅할 필요성을 줄이려면 스풀러 서비스를 중지하고 보안 업데이트를 설치하기 전에 영향을 받는 파일을 사용하는 모든 응용 프로그램을 닫으십시오. 컴퓨터를 다시 시작하라는 메시지가 나타나는 이유에 대한 자세한 내용은 [Microsoft 기술 자료 문서 887012](https://support.microsoft.com/kb/887012)를 참조하십시오.
