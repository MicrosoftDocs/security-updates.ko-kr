---
TOCTitle: 'MS08-JAN'
Title: 2008 년 1 월 Microsoft 보안 공지 요약
ms:assetid: 'ms08-jan'
ms:contentKeyID: 61230700
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms08-jan(v=Security.10)'
---

2008 년 1 월 Microsoft 보안 공지 요약
=====================================
...
이 공지 요약 목록에는 2008년 1월 발표된 보안 공지가 포함되어 있습니다.

2008년 1월 공지 발표와 함께 이 공지 요약이 2008년 1월 4일 게시된 공지 사전 알림을 대체합니다. 보안 사전 알림 서비스에 대한 자세한 내용은 [Microsoft 보안 공지 사전 알림](https://technet.microsoft.com/security/bulletin/advance)을 참조하십시오.

Microsoft 보안 공지가 게시될 때 자동 알림을 받는 방법은 [Microsoft 기술 보안 알림](https://technet.microsoft.com/security/bulletin/notify)을 참조하십시오.

Microsoft는 2008년 1월 10일 목요일(한국 기준)에 이 공지에 대한 고객 문의 사항에 답변을 제공하는 웹캐스트를 진행할 예정입니다. [1월 보안 공지 웹캐스트에 지금 등록하십시오](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?culture=ko-kr&eventid=1032357214&countrycode=kr). 이 날짜 이후 이 웹캐스트는 주문형으로 제공됩니다. 자세한 내용은 [Microsoft 보안 공지 요약](https://www.microsoft.com/korea/technet/security/current.aspx) 및 웹캐스트를 참조하십시오.
...
| 공지 번호                  | Microsoft 보안 공지 MS08-001                                                                                                                                                                                                                                                                                                            |
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**Windows TCP/IP의 취약점으로 인한 원격 코드 실행 문제점(941644)**](https://technet.microsoft.com/security/bulletin/ms08-001)                                                                                                                                                                                                           |
...
| 공지 번호                  | Microsoft 보안 공지 MS08-002                                                                                                                                                                                                                                                                                                                                                                          |
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **공지 제목**              | [**LSASS의 취약점으로 인한 로컬 권한 상승 문제점(943485)**](https://technet.microsoft.com/security/bulletin/ms08-002)                                                                                                                                                                                                                                                                                  |
| **요약**                   | 이 중요 업데이트는 비공개적으로 보고된 Microsoft Windows LSASS(로컬 보안 기관 하위 시스템 서비스)의 취약점을 해결합니다. 취약점을 통해 공격자가 권한을 상승시키는 임의 코드를 실행할 수 있습니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 공격자가 프로그램을 설치하거나 데이터를 보고, 변경하거나 삭제하고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. |
...
-   [MS08-001](https://technet.microsoft.com/security/bulletin/ms08-001)에서 설명한 문제점을 보고해 주신 Alex Wheeler 및 Ryan Smith의 [IBM Internet Security Systems X-Force (영문)](https://www.iss.net/)
-   [MS08-001](https://technet.microsoft.com/security/bulletin/ms08-001)에서 설명한 문제점을 보고해 주신 Alex Wheeler 및 Ryan Smith의 [IBM Internet Security Systems X-Force (영문)](https://www.iss.net/)
-   [MS08-002](https://technet.microsoft.com/security/bulletin/ms08-002)에서 설명한 문제점을 보고해 주신 [SkyRecon (영문)](https://www.skyrecon.com/)의 Thomas Garnier
...
-   V1.0 (2008년 1월 9일): 공지 요약이 게시되었습니다.
-   V1.1 (2008년 1월 24일): Windows Small Business Server 2003 서비스 팩 2가 MS08-001 공지에 영향을 받는 소프트웨어로 추가되어 공지 요약이 업데이트되었습니다.
-   V1.2 (2008년 1월 26일): Windows Small Business Server 2003 서비스 팩 1, Windows Small Business Server 2003 R2, Windows Small Business Server 2003 R2 서비스 팩 2 및 Windows Home Server가 MS08-001 공지에 영향을 받는 소프트웨어로 추가되어 공지 요약이 업데이트되었습니다.
