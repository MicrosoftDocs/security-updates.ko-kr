---
TOCTitle: 'MS14-063'
Title: 'Microsoft 보안 공지 MS14-063 - 중요'
ms:assetid: 'ms14-063'
ms:contentKeyID: 63172122
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms14-063(v=Security.10)'
---

Microsoft 보안 공지 MS14-063 - 중요
===================================

FAT32 디스크 파티션 드라이버의 취약점으로 인한 권한 상승 문제점(2998579)
------------------------------------------------------------------------
...
이 보안 업데이트는 지원 대상인 모든 Windows Server 2003, Windows Vista, Windows Server 2008 에디션에 대해 중요입니다. 자세한 내용은 **영향을 받는 소프트웨어** 섹션을 참조하십시오.

이 보안 업데이트는 특정 기능이 호출될 때 메모리가 할당되는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 이 공지 뒷부분에 있는 특정 취약점에 대한 **자주 제기되는 질문 사항(FAQ)**을 참조하십시오.
...
-   **기술 자료 문서**: [**2998579**](https://support.microsoft.com/kb/2998579)
-   **파일 정보**: 예
-   **SHA1/SHA2 해시**: 예
-   **알려진 문제점**: 없음
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8a59fc6d-cbad-4905-842b-e5aa1fc6fedf&displaylang=ko)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a63521fe-94cf-4ed3-87c6-782e96532971&displaylang=ko)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2a2ea181-b074-4daf-a3d5-e069e459836d)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d13ccfee-7674-46ac-a994-ec28bb1b3bbc&displaylang=ko)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=024a2556-9e2f-4717-957e-cd1757d597a7&displaylang=ko)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=aa97d6b1-b71c-4ad5-abc9-b354064bb256&displaylang=ko)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cf9ce9ec-e9ec-4c8f-a827-6990f5fb1d80&displaylang=ko)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=357f0938-6ae0-43f4-a63c-de50d29cf53f)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=aa97d6b1-b71c-4ad5-abc9-b354064bb256&displaylang=ko)(Server Core 설치)  
(2998579)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cf9ce9ec-e9ec-4c8f-a827-6990f5fb1d80&displaylang=ko)(Server Core 설치)  
(2998579)
...
권한 상승 취약점은 Windows FASTFAT 시스템 드라이버가 FAT32 디스크 파티션과 상호 작용하는 방식에 존재합니다. 이 취약점 악용에 성공한 공격자는 상승된 권한을 사용하여 임의 코드를 실행할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2014-4115](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4115)(영문)를 참조하십시오.

### 완화 요소

완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.

-   공격자가 이 취약점을 악용하려면 시스템에 물리적으로 액세스해야 합니다.
...
**취약점의 원인은 무엇입니까?**  
이 취약점은 FASTFAT 드라이버가 버퍼 할당 문제를 유발하는 기능을 실행할 때 발생합니다. 이 버퍼 할당은 공격자가 정상적으로 예약된 운영 체제의 일부에 데이터를 기록할 수 있게 할 수 있습니다.

**FASTFAT란 무엇입니까?**  
Microsoft Windows FASTFAT 드라이버는 FAT32의 디스크 파티션을 관리하는 데 사용됩니다.

**FAT32란 무엇입니까?**  
파일 시스템은 데이터가 디스크에서 기록되고 읽히는 방식을 관리하는 데 사용됩니다. FAT32는 Microsoft Windows에서 지원하는 파일 시스템 유형입니다.
...
인증되지 않은 공격자가 시스템에 특수하게 조작된 USB 드라이브를 삽입하여 로컬 시스템을 공격할 수 있습니다.

**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**  
워크스테이션과 서버 모두 이 취약점으로 인한 위험에 노출되어 있습니다.

**업데이트는 어떤 기능을 수행합니까?**  
이 보안 업데이트는 특정 기능이 호출될 때 메모리가 할당되는 방식을 변경하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><strong>제어판</strong>의 프로그램 <strong>추가/제거</strong> 항목 또는 %Windir%\$NTUninstallKB2998579$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2998579">Microsoft 기술 자료 문서 2998579</a> 참조</td>
</tr>
<tr class="odd">
...
*2014년 10월 10일 14:54Z-07:00에 페이지가 생성되었습니다.*
