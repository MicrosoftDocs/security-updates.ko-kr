---
TOCTitle: 'MS09-056'
Title: 'Microsoft 보안 공지 MS09-056 - 중요'
ms:assetid: 'ms09-056'
ms:contentKeyID: 61230242
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-056(v=Security.10)'
---

Microsoft 보안 공지 MS09-056 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 및 Windows 7 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 null 종결자가 포함된 인증서 이름을 거부하고 ASN.1 개체 식별자의 유효성을 올바르게 검사하도록 CryptoAPI를 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.

**권장 사항.** 대다수의 고객은 자동 업데이트를 사용하고 있기 때문에 따로 조치를 취할 필요가 없습니다. 이 보안 업데이트가 자동으로 다운로드되고 설치됩니다. 자동 업데이트를 사용하고 있지 않은 고객은 수동으로 업데이트를 확인하고 이 업데이트를 설치해야 합니다.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 974571](https://support.microsoft.com/kb/974571)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=52b9198d-b65f-467a-a5ab-141e23d64a86&displaylang=ko)                                                                        | 스푸핑         | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=9c5ab624-e37b-418a-a919-d8f652b15679&displaylang=ko)                                                          | 스푸핑         | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=ad29696d-4611-4a12-9dfa-74fa6866b759)                                                                          | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=49e9cc53-cf17-4bc7-aaaa-92213167e1a9&displaylang=ko)                                                                           | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d170cef9-f5d2-4fcd-997b-e778ad5a6797&displaylang=ko)                                                               | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2ede1eb9-7f5f-411d-bbc3-5db46d80e0bb)                                                                           | 스푸핑         | 중요        | 없음                      |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8b5a9a95-9439-40c8-acef-000b919daa04&displaylang=ko)                                     | 스푸핑         | 중요        | 없음                      |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4a60f789-1a4a-49a8-8d13-fda989ed40be&displaylang=ko) | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f9b487af-fe73-42a8-b240-d59c4321f95b&displaylang=ko)\*                | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0d8a2a3e-d7d4-47fb-8364-16fce28e4d38&displaylang=ko)\*            | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8962f0b6-f346-4e88-9d83-4d15b699dd9d)                     | 스푸핑         | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ad6f06d5-27db-445d-a8b2-c42adc90afc0&displaylang=ko)                                                                                | 스푸핑         | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=70cd0270-77e9-492a-82d9-798364640c10&displaylang=ko)                                                                              | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ce78c019-ec08-4ec6-abec-334f5ec5cb76&displaylang=ko)\*                                                               | 스푸핑         | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=6442a77a-3c0d-4beb-b2d2-2885376c2135)                                                                            | 스푸핑         | 중요        | 없음                      |
...
<th style="border:1px solid black;" >X.509 일반 이름 Null 잘림 취약점(CVE-2009-2510)</th>
<th style="border:1px solid black;" >X.509 개체 식별자 정수 오버플로 취약점(CVE-2009-2511)</th>
...
X.509 인증서에서 ASN.1 정보의 구문을 분석할 때 Microsoft Windows CryptoAPI 구성 요소에 스푸핑 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 다른 사용자 또는 시스템을 가장할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2510 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510)을 참조하십시오.
  
#### X.509 일반 이름 Null 잘림 취약점(CVE-2009-2510)에 대한 완화 요소
  
이 취약점에 대해 확인된 완화 요소가 없습니다.
  
#### X.509 일반 이름 Null 잘림 취약점(CVE-2009-2510)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### X.509 일반 이름 Null 잘림 취약점(CVE-2009-2510)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**      
이 취약점은 스푸핑 취약점입니다. DNS 스푸핑과 같은 다른 특정 공격과 이 취약점이 결합될 경우 공격자가 Windows CryptoAPI를 사용하는 응용 프로그램에 대한 웹 사이트의 디지털 인증서를 스푸핑할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**      
Windows CryptoAPI가 OID(개체 식별자)로 식별되는 값의 끝에 있는 null 종결자의 구문을 잘못 분석하기 때문입니다. 이로 인해 CryptoAPI가 실제 값의 일부만 구문 분석할 수 있습니다. 이 부분 값이 최종 사용자에게 의미가 있는 경우에는 공격자가 다른 사용자 또는 시스템을 가장할 수 있는 상황이 발생할 수 있습니다.
  
**Windows CryptoAPI란 무엇입니까?**      
CryptoAPI는 응용 프로그램 개발자가 데이터의 암호화/해독, 디지털 인증서를 사용하는 인증 및 ASN.1(Abstract Syntax Notation 1)과의 암호화/해독을 해당 Windows 기반 응용 프로그램에 추가할 수 있도록 하는 서비스를 제공합니다. 응용 프로그램 개발자는 기본 구현의 상세 정보를 알지 못해도 CryptoAPI의 기능을 사용할 수 있습니다. 이는 특정 그래픽 하드웨어 구성을 모르는 상태에서 그래픽 라이브러리를 사용할 수 있는 것과 같습니다. CryptoAPI는 실제 암호화 기능을 수행하는 여러 암호화 서비스 공급자에서 작동합니다.
...
ASN.1에 대한 자세한 내용은 [Microsoft 기술 자료 문서 252648](https://support.microsoft.com/kb/252648)을 참조하십시오.
...
**개체 식별자 또는 OID란 무엇입니까?**      
OID(개체 식별자)는 배포된 응용 프로그램의 데이터 요소, 구문 및 기타 요소를 고유하게 식별하기 위해 여러 발급 기관에서 발급하는 숫자 값입니다. OID는 OSI 응용 프로그램, X.500 디렉터리, SNMP 및 기타 고유성이 중요한 응용 프로그램에서 사용됩니다. OID는 ISO와 같은 상위 발급 기관이 하위 기관에 트리 분기를 할당하고, 이 하위 기관은 하위 분기를 할당하는 식으로 구성된 트리 구조를 기반으로 합니다.
  
**NULL 종결자란 무엇입니까?**      
Null 종결자는 0 값을 가지는 문자입니다. C와 같은 특정 프로그래밍 언어에서는 문자열의 끝을 서명하기 위해 예약된 문자로 사용됩니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**      
공격자는 다른 사용자 또는 시스템을 가장할 수 있습니다. CryptoAPI를 사용하여 이 데이터의 구문을 분석하는 응용 프로그램은 사용자가 잘못된 신뢰 결정을 내리도록 유도할 수 있는 정보를 반환할 수 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**      
공격자는 클라이언트에서 신뢰하는 인증 기관이 CN(일반 이름) 필드에 null 종결자가 포함된 인증서에 서명하도록 유인하여 이 취약점을 악용할 수 있습니다. 그런 다음 공격자는 Windows 컴퓨터에 이 인증서를 제공하는 사기성 웹 사이트를 설정할 수 있습니다. 이 경우 컴퓨터는 일반 이름 필드의 구문을 잘못 분석하여 사용자에게 잘못된 신뢰 정보를 제공합니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**      
HTTPS 웹 사이트를 검색하는 클라이언트 또는 전자 메일 대화 등을 보호하기 위해 인증서에 X.509를 사용하는 클라이언트는 이 취약점에 대해 매우 위험합니다.
  
**업데이트는 어떤 기능을 수행합니까?**      
이 보안 업데이트는 null 종결자가 포함된 인증서 이름을 거부하도록 CryptoAPI를 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**      
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-2510 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**      
Microsoft는 공격자가 제한적인 시나리오에서 이 취약점을 악용할 수 있는 일반에 공개된 개념 증명 코드를 확인했습니다. 그러나 Microsoft는 이 취약점이 공개적으로 고객을 공격하는 데 사용되었다는 정보를 입수하지 못했습니다.
  
X.509 개체 식별자 정수 오버플로 취약점(CVE-2009-2511)  
-----------------------------------------------------
  

X.509 인증서에서 ASN.1 개체 식별자의 구문을 분석할 때 Microsoft Windows CryptoAPI 구성 요소에 스푸핑 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 다른 사용자 또는 시스템을 가장할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2511 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511)을 참조하십시오.
  
#### X.509 개체 식별자 정수 오버플로 취약점(CVE-2009-2511)에 대한 완화 요소
  
이 취약점에 대해 확인된 완화 요소가 없습니다.
  
#### X.509 개체 식별자 정수 오버플로 취약점(CVE-2009-2511)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### X.509 개체 식별자 정수 오버플로 취약점(CVE-2009-2511)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**      
이 취약점은 스푸핑 취약점입니다. DNS 스푸핑과 같은 다른 특정 공격과 이 취약점이 결합될 경우 공격자가 Windows CryptoAPI를 사용하는 응용 프로그램에 대한 웹 사이트의 디지털 인증서를 스푸핑할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**      
X.509 인증서에서 CN(일반 이름)과 같은 ASN.1 개체 식별자의 구문을 분석할 때 Windows CryptoAPI에 정수 오버플로가 발생합니다. 공격자는 Windows CryptoAPI가 잘못 구문 분석하는 악의적인 인증서를 생성하여 다른 사용자 또는 시스템으로 가장할 수 있습니다.
...
**개체 식별자 또는 OID란 무엇입니까?**      
OID(개체 식별자)는 배포된 응용 프로그램의 데이터 요소, 구문 및 기타 요소를 고유하게 식별하기 위해 여러 발급 기관에서 발급하는 고유의 숫자 값입니다. OID는 OSI 응용 프로그램, X.500 디렉터리, SNMP 및 기타 고유성이 중요한 응용 프로그램에서 사용됩니다. OID는 ISO와 같은 상위 발급 기관이 하위 기관에 트리 분기를 할당하고, 이 하위 기관은 하위 분기를 할당하는 식으로 구성된 트리 구조를 기반으로 합니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**      
공격자는 다른 사용자 또는 시스템을 가장할 수 있습니다. CryptoAPI를 사용하여 이 데이터의 구문을 분석하는 응용 프로그램은 사용자가 잘못된 신뢰 결정을 내리도록 유도할 수 있는 정보를 반환할 수 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**      
공격자는 클라이언트에서 신뢰하는 인증 기관이 조작된 개체 식별자가 포함된 인증서에 서명하도록 유인하여 이 취약점을 악용할 수 있습니다. 그런 다음 공격자는 Windows 클라이언트에 이 인증서를 제공하는 사기성 웹 사이트를 설정할 수 있습니다. 이 경우 이 클라이언트 응용 프로그램은 일반 이름 필드의 구문을 잘못 분석하여 사용자에게 잘못된 신뢰 정보를 제공합니다.
  
**취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?**      
HTTPS 웹 사이트를 검색하는 클라이언트 응용 프로그램 또는 전자 메일 대화 등을 보호하기 위해 인증서에 X.509를 사용하는 클라이언트 응용 프로그램은 이 취약점에 대해 매우 위험합니다.
  
**업데이트는 어떤 기능을 수행합니까?**      
이 보안 업데이트는 CryptoAPI가 ASN.1 개체 식별자의 유효성을 올바르게 검사하도록 하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**      
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-2511 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511)이 지정되었습니다.
...
| **배포**                  |                                                                                                                                  |  
| 사용자 개입 없이 설치     | Windows2000-kb974571-x86-kor /quiet                                                                                              |  
| 다시 시작하지 않고 설치   | Windows2000-kb974571-x86-kor /norestart                                                                                          |  
| 로그 파일 업데이트        | kb974571.log                                                                                                                     |  
| 추가 정보                 | **검색, 배포 도구 및 지침**을 참조하십시오.                                                                                      |  
| **다시 시작 요구 사항**   |                                                                                                                                  |  
| 다시 시작 필요 여부       | 예, 이 보안 업데이트를 적용한 후에는 컴퓨터를 다시 시작해야 합니다.                                                              |  
| 핫패칭                    | 해당 사항 없음                                                                                                                   |  
| **제거 정보**             | 제어판의 **프로그램 추가/제거** 도구 또는 %Windir%\\$NTUninstallKB974571$\\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오. |  
| **파일 정보**             | [Microsoft 기술 자료 문서 974571](https://support.microsoft.com/kb/974571) 참조                                                   |  
| **레지스트리 키 확인**    | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974571\\Filelist                                        |
...
Windowsxp-kb974571-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb974571-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB974571$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/974571">Microsoft 기술 자료 문서 974571</a> 참조</td>
</tr>
<tr class="even">
...
Windowsserver2003-kb974571-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB974571-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb974571-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB974571-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   X.509 일반 이름 Null 잘림 취약점(CVE-2009-2510)을 해결하기 위해 협력해 주신 [Citrix (영문)](https://www.citrix.com/)의 Ian Wright 및 Jean-Luc Giraud  
-   X.509 일반 이름 Null 잘림 취약점(CVE-2009-2510) 및 X.509 개체 식별자 정수 오버플로 취약점(CVE-2009-2511)을 보고해 주신 [IOActive (영문)](https://www.ioactive.com/)의 Dan Kaminsky
  
#### MAPP(Microsoft Active Protections Program)
  
고객에 대한 보안을 강화하기 위해 Microsoft는 월별 보안 업데이트를 배포하기 전에 주요 보안 소프트웨어 제공업체에 취약점 정보를 제공합니다. 보안 소프트웨어 제공업체는 이 취약점 정보를 사용하여 안티바이러스, 네트워크 기반 침입 탐지 시스템 또는 호스트 기반 침임 방지 시스템 등 자사의 보안 소프트웨어나 장치를 통해 업데이트된 보호 기능을 고객에게 제공할 수 있습니다.
...
-   V1.1(2009년 10월 15일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 974571 링크가 추가되었습니다.
