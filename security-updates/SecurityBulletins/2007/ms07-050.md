---
TOCTitle: 'MS07-050'
Title: 'Microsoft 보안 공지 MS07-050 - 긴급'
ms:assetid: 'ms07-050'
ms:contentKeyID: 61230089
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms07-050(v=Security.10)'
---


Microsoft 보안 공지 MS07-050 - 긴급
===================================

벡터 표시 언어의 취약점으로 인한 원격 코드 실행 문제점(938127)
--------------------------------------------------------------

게시된 날짜: 2007년 8월 14일 화요일 | 업데이트된 날짜: 2008년 8월 28일 목요일
...
이 보안 업데이트의 등급은 지원되는 Internet Explorer 5.01, Internet Explorer 6 및 Internet Explorer 7 릴리스에 대해 긴급입니다. 자세한 내용은 이 섹션의 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**을 참조하십시오.

보안 업데이트는 VML 렌더링 요청에 대한 Internet Explorer의 유효성 검사를 강화함으로써 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.

**권장 사항:** 고객은 업데이트를 즉시 적용하는 것이 좋습니다.

**알려진 문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 938127](https://support.microsoft.com/default.aspx?ln=ko)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=31e63d6f-b6b7-41d7-8ae6-dd7fcf89d477&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=7099d33a-0ef6-423f-824e-757482517612&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=4447d74f-09ea-4be0-9dae-c243ce657fb7&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=98ccd207-f4d0-4625-aeab-0ebf1643a5fd&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=463535aa-e04e-4a30-b3ab-8cd6d8cdd13c&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=9d4375d4-fb9b-4771-bd6f-e5d23eedbc6b&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?familyid=c7be313b-3405-42e1-9e4b-0cb6bf3d2cb1)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=9f5da816-194c-478e-8a96-9421a0c52c9f&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?displaylang=ko&familyid=9f5da816-194c-478e-8a96-9421a0c52c9f)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=1c3168a9-d959-4137-868a-ec70da737c21&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=59884e97-4912-4a9a-8a31-8182ea2d24db&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=%2042060e27-de14-4d0c-92a0-138cb57fe2b5&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=2dd908a4-6152-4976-aaaa-01f5f37c9143&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=592435bc-1d43-4544-bd8a-4a2d829dc1a1&displaylang=ko)
</td>
<td style="border:1px solid black;">
원격 코드 실행
</td>
...
**이 보안 공지가 2008년 8월 26일에 개정된 이유는 무엇입니까?**  
Windows XP 서비스 팩 3의 Internet Explorer 7이 영향을 받는 제품에 추가되었으며, 이제 업데이트가 제공될 예정이므로 이 공지가 개정되었습니다.

**고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 알려진 문제점은 무엇입니까?**  
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 938127](https://support.microsoft.com/default.aspx?ln=ko)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
**Internet Explorer 7로 업그레이드하기 전에 이 보안 업데이트를 설치하는 경우 Internet Explorer 7로 업그레이드한 다음에도 이 업데이트를 적용해야 합니까?**  
예. Internet Explorer 6이 설치된 시스템에 현재 VML 보안 업데이트를 설치한 고객이 나중에 Internet Explorer 7을 설치하면 이 업데이트의 Internet Explorer 7용 버전이 제공됩니다. Windows Internet Explorer 7과 함께 설치되는 vgx.dll 버전은 Windows 2000, Windows XP 또는 Windows Server 2003에 포함된 vgx.dll보다 주요한 버전입니다. Internet Explorer 7이 설치되면 이 보안 업데이트에서 제공하여 Internet Explorer 6에서 업데이트된 vgx.dll이 교체됩니다.
...
Microsoft Windows에 구현된 VML(벡터 표시 언어)에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지나 HTML 전자 메일을 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지나 메시지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-1749 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1749)를 참조하십시오.

#### VML 버퍼 오버런 취약점(CVE-2007-1749)에 대한 완화 요소:
...
#### VML 버퍼 오버런 취약점(CVE-2007-1749)에 대한 대안:

대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.

-   **VGX.DLL 등록 취소**

    1.  시작, 실행을 차례로 클릭하고 "%SystemRoot%\\System32\\regsvr32.exe" -u "%CommonProgramFiles%\\Microsoft Shared\\VGX\\vgx.dll"을 입력한 다음 확인을 클릭합니다.
    ...
    **대안의 영향:** vgx.dll을 등록 취소하면 VML 렌더링 응용 프로그램에서 더 이상 렌더링이 불가능합니다.
    ...
    1.  시작, 실행을 차례로 클릭하고 "%SystemRoot%\\System32\\regsvr32.exe" "%CommonProgramFiles%\\Microsoft Shared\\VGX\\vgx.dll"을 입력한 다음 확인을 클릭합니다.
...
#### VML 버퍼 오버런 취약점(CVE-2007-1749)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**  
Microsoft Windows에 구현된 VML에서 벡터 그래픽 링크 라이브러리 루틴, vgx.dll이 Internet Explorer에서 VML 렌더링 요청의 유효성 검사를 충분히 수행하지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**  
업데이트는 벡터 그래픽 링크 라이브러리 루틴, vgx.dll이 Internet Explorer에서 VML 렌더링 요청의 유효성 검사 방식을 변경합니다.
...
| 소프트웨어                                                                                                 | MBSA 1.2.1 | Enterprise Scanning Tool(EST) | MBSA 2.0.1                                             |
|------------------------------------------------------------------------------------------------------------|------------|-------------------------------|--------------------------------------------------------|
| Windows 2000 서비스 팩 4                                                                                   | 아니오     | 예                            | 예                                                     |
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3                                                           | 아니오     | 예                            | 예                                                     |
| Windows XP Professional x64 Edition 및 Microsoft Windows XP Professional x64 Edition 서비스 팩 2           | 아니오     | 예                            | 예                                                     |
| Windows Server 2003 서비스 팩 1 및 Microsoft Windows Server 2003 서비스 팩 2                               | 아니오     | 예                            | 예                                                     |
| Windows Server 2003 x64 Edition 및 Microsoft Windows Server 2003 x64 Edition 서비스 팩 2                   | 아니오     | 예                            | 예                                                     |
| Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP2(Itanium 기반 시스템용) | 아니오     | 예                            | 예                                                     |
| Windows Vista                                                                                              | 아니오     | 아니오                        | 아래의 **Windows** **Vista 참고 사항**을 참조하십시오. |
| Windows Vista x64 Edition                                                                                  | 아니오     | 아니오                        | 아래의 **Windows** **Vista 참고 사항**을 참조하십시오. |

**Windows** **Vista 참고 사항** Microsoft는 Windows Vista를 실행하는 컴퓨터에 MBSA 2.0.1을 설치하도록 권장하지 않습니다. 그러나 지원되는 운영 체제에 MBSA 2.0.1을 설치하고 Windows Vista 기반 컴퓨터를 원격으로 검사하는 것은 가능합니다. MBSA의 Windows Vista 지원에 대한 자세한 내용은 [MBSA 웹 사이트 (영문)](https://go.microsoft.com/fwlink/?linkid=21134)를 참조하십시오. [Microsoft 기술 자료 문서 931943](https://support.microsoft.com/default.aspx?ln=ko)도 참조하십시오. MBSA(Microsoft Baseline Security Analyzer)는 Windows Vista를 지원합니다.
...
**EST(EnterpriseUpdate** **Scan Tool)이란?**  
...
**EnterpriseUpdate** **Update Scan Tool)를 사용하여 이 업데이트가 필요한지 확인할 수 있습니까?**  

예. Microsoft는 이 업데이트를 적용해야 하는지 확인할 수 있는 EST 버전을 개발했습니다. 이번 달에 릴리스되는 EST 버전에 대한 자세한 내용과 다운로드 링크는 다음 [Microsoft 웹 사이트](https://support.microsoft.com/kb/894193)를 참조하십시오.
...
| Windows Server 2003 x64 Edition 및 Microsoft Windows Server 2003 x64 Edition 서비스 팩 2         | 아니오  | 예                                                     |
...
IE5.01sp4-KB938127-Windows2000sp4-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB938127-Windows2000-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Internet Explorer 5.01 서비스 팩 4:<br />
IE5.01sp4-KB938127-Windows2000sp4-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 6 서비스 팩 1:<br />
IE6.0sp1-KB938127-Windows2000-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Internet Explorer 5.01 서비스 팩 4:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB938127-IE501SP4- 20070626.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 6 서비스 팩 1:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB938127-IE6SP1- 20070626.120000$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
...
Windowsxp-kb938127-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2용 Internet Explorer 7 및 Windows XP 서비스 팩 3용 Internet Explorer 7:<br />
IE7-KB938127-WindowsXP-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2용 Internet Explorer 6:<br />
Windowsxp-kb938127-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2용 Internet Explorer 7 및 Windows XP 서비스 팩 3용 Internet Explorer 7:<br />
IE7-KB938127-WindowsXP-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2용 Internet Explorer 6:<br />
...
제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB938127$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP용 Internet Explorer 7:<br />
제어판의 프로그램 추가/제거 도구 또는 %Windir%\ie7updates\KB938127-IE7\spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">전체 파일 목록은 아래에 있는 <strong>파일 정보</strong> 참조</td>
...
Windowsserver2003-kb938127-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션, 64비트 에디션 및 Itanium 기반 에디션용 Internet Explorer 7:<br />
IE7-KB938127-WindowsServer2003-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션, 64비트 에디션 및 Itanium 기반 에디션용 Internet Explorer 6:<br />
Windowsserver2003-kb938127-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션, 64비트 에디션 및 Itanium 기반 에디션용 Internet Explorer 7:<br />
IE7-KB938127-WindowsServer2003-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
...
설치 프로그램에 대한 자세한 내용은 [Microsoft 기술 자료 문서 934307](https://support.microsoft.com/default.aspx?ln=ko)을 참조하십시오.
...
**참고** 설치 프로그램에 대한 자세한 내용은 [Microsoft 기술 자료 문서 934307](https://support.microsoft.com/default.aspx?ln=ko)을 참조하십시오.
...
-   VML 버퍼 오버런 취약점(CVE-2007-1749)을 보고해 주신 [eEye Digital Security (영문)](https://www.eeye.com/)
...
-   V1.1 (2007년 8월 15일): Windows 2003용 Microsoft Internet Explorer 7 파일 정보를 수정하여 공지가 개정되었습니다.  
-   V1.2 (2007년 8월 22일): 지원 대상인 모든 Windows Server 2003 32비트 에디션, 64비트 에디션 및 Itanium 기반 에디션용 Internet Explorer 7의 레지스트리 키 확인을 수정하기 위해 공지가 개정되었습니다.  
-   V2.0 (2008년 8월 28일): Windows XP 서비스 팩 3용 Internet Explorer 7을 추가하여 이 공지가 개정되었습니다.
