---
TOCTitle: 'MS13-065'
Title: 'Microsoft 보안 공지 MS13-065 - 중요'
ms:assetid: 'ms13-065'
ms:contentKeyID: 61230615
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-065(v=Security.10)'
---

Microsoft 보안 공지 MS13-065 - 중요
===================================
...
이 보안 업데이트는 비공개적으로 보고된 Microsoft Windows의 취약점을 해결합니다. 이 취약점은 공격자가 특수하게 조작된 ICMP 패킷을 대상 시스템에 전송할 경우 서비스 거부를 허용할 수 있습니다.
...
이 보안 업데이트는 Windows TCP/IP 스택이 특수하게 조작된 ICMPv6 패킷을 처리하는 동안 메모리를 할당하는 방법을 올바르게 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
| 기술 자료 문서 | [2868623](https://support.microsoft.com/kb/2868623) |
|----------------|-----------------------------------------------------|
| 파일 정보      | 예                                                  |
| SHA1/SHA2 해시 | 예                                                  |
| 알려진 문제점  | 예                                                  |
...
[Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=de74160f-7d45-4a71-aa0e-c89ee592d7e4&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<td style="border:1px solid black;">
[MS13-049](https://go.microsoft.com/fwlink/?linkid=301749)의 2845690
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2ed1112f-4480-49a7-9104-91538f4c83cb&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=41fc623b-2486-4442-8ce9-61aa994c2ede&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7cc4526b-f2ab-4a7c-b0e4-0679a9ed3c27&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=bbf0050b-30f3-45ee-aa96-163e40ce2a36)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c76a1832-c6ad-48ae-b8fa-034b53386646&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=ce357356-0965-4a4a-8812-91df8bc74c08&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=37b68571-bbba-433f-a869-a0362b0ebe75&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=71b75d3d-54f0-464e-88bb-334756def478)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=16279325-b227-4e11-86c8-2da1ba57338c&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows 8(64비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=d8124b46-e435-4804-b70a-88a0e77d4d25&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=e482739b-6777-4f2d-874d-13ddbcdd7159&displaylang=ko)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=41fc623b-2486-4442-8ce9-61aa994c2ede&displaylang=ko)(Server Core 설치)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7cc4526b-f2ab-4a7c-b0e4-0679a9ed3c27&displaylang=ko)(Server Core 설치)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=37b68571-bbba-433f-a869-a0362b0ebe75&displaylang=ko)(Server Core 설치)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=e482739b-6777-4f2d-874d-13ddbcdd7159&displaylang=ko)(Server Core 설치)  
(2868623)
</td>
<td style="border:1px solid black;">
서비스 거부
...
<span></span>
Windows TCP/IP 스택에는 대상 시스템이 다시 시작할 때까지 응답을 중지하도록 만드는 서비스 거부 취약점이 존재합니다. 이러한 취약점은 TCP/IP 스택이 수신되는 ICMPv6 패킷에 대해 올바르게 메모리를 할당하지 않을 경우 발생합니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-3183](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3183)(영문)을 참조하십시오.
...
취약점의 원인은 무엇입니까?  
이 취약점은 Windows TCP/IP 스택이 특수하게 조작된 ICMPv6 패킷을 처리하는 도중 올바르게 메모리를 할당하지 않을 경우 발생합니다.

ICMP(Internet Control Message Protocol) 란 무엇입니까?  
ICMP(Internet Control Message Protocol)란 오류 보고 및 진단 유틸리티로, 모든 IP 구현에 필수적인 사항입니다. 자세한 내용은 [Microsoft 기술 자료 문서 170292](https://support.microsoft.com/kb/170292)을 참조하십시오.

공격자는 취약점을 악용하여 무엇을 할 수 있습니까?  
이 취약점 악용에 성공한 인증되지 않은 공격자는 대상 시스템이 다시 시작될 때까지 응답을 중지하도록 만들 수 있습니다.

공격자는 이러한 취약점을 어떻게 악용합니까?  
인증되지 않은 공격자가 특수하게 조작한 ICMPv6 패킷을 대상 시스템에 전송합니다.

취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?  
영향을 받은 Microsoft Windows 버전을 실행 중인 모든 컴퓨터가 취약점으로 인한 위험에 노출됩니다.

업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Windows TCP/IP 스택이 특수하게 조작된 ICMPv6 패킷을 처리하는 동안 메모리를 할당하는 방법을 올바르게 수정하여 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2868623">Microsoft 기술 자료 문서 2868623</a> 참조</td>
</tr>
<tr class="odd">
...
| 파일 정보           | [Microsoft 기술 자료 문서 2868623](https://support.microsoft.com/kb/2868623) 참조                                                    |
