...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>HTML 개체 메모리 손상 취약점(CVE-2008-2254)</th>
<th>HTML 개체 메모리 손상 취약점(CVE-2008-2255)</th>
<th>초기화되지 않은 메모리 손상 취약점(CVE-2008-2256)</th>
<th>HTML 개체 메모리 손상 취약점(CVE-2008-2257)</th>
<th>HTML 개체 메모리 손상 취약점(CVE-2008-2258)</th>
<th>HTML 구성 요소 처리 취약점(CVE-2008-2259)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
