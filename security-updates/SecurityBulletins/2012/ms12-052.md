...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2722913](http://support.microsoft.com/kb/2722913)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[MS12-037](http://go.microsoft.com/fwlink/?linkid=249045)의 KB2699988은 KB2722913으로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-044](http://go.microsoft.com/fwlink/?linkid=254377)의 KB2719177은 KB2722913으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2722913](http://support.microsoft.com/kb/2722913)을 참조하십시오.
...
이 공지에서 설명하는 JavaScript 정수 오버플로 원격 코드 실행 취약점(CVE-2012-2523)은 [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487)을 통해서도 해결됩니다.

시스템에 Internet Explorer 8을 설치한 고객은 CVE-2012-2523에 설명된 취약점으로부터 보호하기 위해 [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487)에서 설명하는 KB2706045 업데이트를 설치해야 합니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](http://technet.microsoft.com/security/bulletin/ms12-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-1526](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526)(영문)을 참조하십시오.
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/library/dd883248.aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 항목을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2521](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521)(영문)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2522](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522)(영문)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523)(영문)을 참조하십시오.
...
참고 이 업데이트는 Internet Explorer 8에 대해서는 이 취약점을 해결하지 않습니다. Internet Explorer 8의 경우 [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487)에 설명된 KB2706045 업데이트를 통해 이 업데이트를 사용할 수 있습니다.

내 시스템에 Internet Explorer 8이 설치되어 있습니다. CVE-2012-2523을 해결하는 업데이트는 어디에서 구할 수 있습니까?  
시스템에 Internet Explorer 8을 설치한 고객은 [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487)에 설명된 KB2706045 업데이트를 설치하여 CVE-2012-2523에 설명된 취약점을 해결할 수 있습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2722913">Microsoft 기술 자료 문서 2722913</a> 참조</td>
</tr>
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/)(영문)와 협력하여 레이아웃 메모리 손상 취약점(CVE-2012-1526)을 보고해 주신 GWSlabs  
-   [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) (영문)프로그램과 협력하여 비동기 NULL 개체 액세스 원격 코드 실행 취약점(CVE-2012-2521)을 보고해 주신 Derek Soeder  
-   가상 함수 테이블 손상 원격 코드 실행 취약점(CVE-2012-2522)을 보고해 주신 [Trend Micro](http://www.trendmicro.com/)의 Sung-ting Tsai 및 Ming-Chieh Pan  
-   JavaScript 정수 오버플로 원격 코드 실행 취약점(CVE-2012-2523)을 보고해 주신 [Google Chrome Security Team](http://chrome.google.com/)의 Cris Neckar
