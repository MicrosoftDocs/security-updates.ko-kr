...
-   Microsoft Windows 2000 서비스 팩 4 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f361fccb-b273-47e7-bb15-bc9c27073446&displaylang=ko)
-   Microsoft Windows XP 서비스 팩 1 및 Microsoft Windows XP 서비스 팩 2 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=e38372b2-3bf6-4393-b9a4-f34248c8073e&displaylang=ko)
-   Microsoft Windows XP Professional x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=086c6878-916c-4a4f-8ca8-a4c0e304fda4)
-   Microsoft Windows Server 2003 및 Microsoft Windows Server 2003 서비스 팩 1 – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=cee3dd3b-3c20-47a9-8bbd-1ea2fbb4af96&displaylang=ko)
-   Microsoft Windows Server 2003 (Itanium 기반 시스템용) 및 Microsoft Windows Server 2003 SP1 (Itanium 기반 시스템용) - [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=ccff22bb-adc4-4974-813c-7721bdb842c0)
-   Microsoft Windows Server 2003 x64 Edition – [업데이트 다운로드](https://www.microsoft.com/download/details.aspx?familyid=f1adb6e4-0a08-496c-b94c-a1b37178914a)
...
|---------------------------------------------------------------------------------------------------------------------|----------------------|--------------|------------------------|------------------------|---------------------|---------------------------------|
| 그래픽 렌더링 엔진 취약점 - [CAN-2005-2123 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2123) | 원격 코드 실행       | 긴급         | 긴급                   | 긴급                   | 긴급                | 긴급                            |
| Windows 메타파일 취약점 - [CAN-2005-2124 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2124)   | 원격 코드 실행       | 긴급         | 긴급                   | 없음                   | 긴급                | 없음                            |
| 확장 메타파일 취약점 - [CAN-2005-0803 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0803)      | 서비스 거부          | 보통         | 보통                   | 없음                   | 보통                | 없음                            |
...
이미지 종류와 형식에 대한 자세한 내용은 [Microsoft 기술 자료 문서 320314](https://support.microsoft.com/kb/320314/ko) 를 참조하십시오. 또한 [MSDN Library 웹 사이트 (영문)](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/gdicpp/gdiplus/aboutgdiplus/imagesbitmapsandmetafiles/metafiles.asp) 에서도 이러한 파일 형식에 대한 추가 정보를 얻을 수 있습니다.
...
-   메타파일 취약점(CAN-2005-2123)을 보고해 주신 [eEye Digital Security (영문)](https://www.eeye.com/html/) 에 감사드립니다.
-   Windows 메타파일 취약점(CAN-2005-2124)을 보고해 주신 [Venustech AdDLab (영문)](https://www.venustech.com.cn) , [eEye Digital Security (영문)](https://www.eeye.com/html/) 및 [Symantec Security Response (영문)](https://securityresponse.symantec.com) 의 and Peter Ferrie에 감사드립니다.
...
-   MBSA([Microsoft Baseline Security Analyzer (영문)](https://go.microsoft.com/fwlink/?linkid=21134))
