...
|----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3                                       | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=d5891180-5dd1-49ec-bcc6-3030a544202c&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2 | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=caf8a45e-a9f8-4e91-98fd-87eddbeae64c)                | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Vista 및 Windows Vista 서비스 팩 1                                             | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=2f4118fd-1ffb-46da-b922-cd4ca4f9d84e&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1                     | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=334352e7-d41f-494f-866d-f1f1745ffd17&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Server 2008(32비트 시스템용)\*                                                 | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=72fc6028-6af4-44ec-8d2a-28c53807d6bc&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
| Windows Server 2008(x64 기반 시스템용)\*                                               | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=3906512b-26db-473e-b522-3883ff34a21c&displaylang=ko) | 원격 코드 실행 | 긴급        | 없음                      |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 954154](https://support.microsoft.com/kb/954154)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-2253 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2253)을 참조하십시오.
...
SSPL이란 클라이언트에서 재생될 콘텐츠, 재생 시간 및 재생 순서가 담긴 목록입니다. Windows Media 서버용 SSPL은 XML 문서입니다. SSPL에 대한 자세한 내용은 [Server-Side Playlists (영문)](https://msdn.microsoft.com/en-us/library/ms753585(vs.85).aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/954154">Microsoft 기술 자료 문서 954154</a> 참조</td>
</tr>
<tr class="even">
