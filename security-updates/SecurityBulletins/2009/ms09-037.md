...
**문제점.**[Microsoft 기술 자료 문서 973908](https://support.microsoft.com/kb/973908) 은 고객이 이 보안 업데이트를 설치할 때 발생하는 알려진 이슈에 대한 자료 입니다. 또한 이 문서는 관련 이슈에 관한 권장 솔루션을 제공합니다. 현재 알려진 이슈 및 권장 솔루션이 특정 소프트웨어의 릴리스 만이 관계가 있을 경우, 이 문서는 추가 문서 링크를 제공합니다.
...
<td style="border:1px solid black;">
[DHTML Editing Component ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=223e25d2-83d7-4cb7-85c4-46a42b8110e0&displaylang=ko)  
(KB973869)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows Media Player 9](https://www.microsoft.com/download/details.aspx?familyid=ec84c98b-6bc7-442f-9280-d6e204280b2f&displaylang=ko)  
(KB973540)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Windows Media Player 10 및 Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=ec84c98b-6bc7-442f-9280-d6e204280b2f&displaylang=ko)  
(KB973540)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[DHTML Editing Component ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=bdfcd0c3-7c18-4e63-91dd-d8f82cd89592&displaylang=ko)  
(KB973869)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft MSWebDVD ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=8b71bcc9-5146-4afc-8847-0af21d7fad36)  
(KB973815)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[HtmlInput Object ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=46aa443c-4e7b-4bd5-8b4e-0068c3dc0e79)  
(KB973768)  
...
<td style="border:1px solid black;">
[DHTML Editing Component ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=d04a6959-41a4-4a87-b3ad-7455d8fe8b99)  
(KB973869)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[DHTML Editing Component ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=bfc474c2-e3c5-40df-85d4-4ac666ff0561&displaylang=ko)  
(KB973869)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[DHTML Editing Component ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=9f502d79-99a8-45dc-9876-2df27e14ffaa&displaylang=ko)  
(KB973869)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[DHTML Editing Component ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=82c0bb02-70ad-4605-a1f4-4698adf9f4ac)  
(KB973869)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[HtmlInput Object ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=59fefa17-0ad4-4a62-82be-e6a2b7a0aec3)  
(KB973768)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[HtmlInput Object ActiveX 컨트롤](https://www.microsoft.com/download/details.aspx?familyid=92de8a2e-2d50-4278-937e-ccb862c5ab8f)  
(KB973768)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
**이 공지가 2009년 9월 8일에 다시 릴리스된 이유는 무엇입니까?**  
...
HtmlInput Object ActiveX 컨트롤은 Windows Media Center에 호스팅된 HTML 응용 프로그램을 사용하여 HTML 페이지에 트리플 탭/소프트 키보드 ActiveX 컨트롤의 인스턴스를 포함시킵니다. 이 컨트롤은 사용자의 텍스트 입력을 검색하기 위한 표준 인터페이스를 제공하며, 이 인터페이스에서 리모컨을 사용하여 텍스트를 입력할 수 있습니다. 자세한 내용은 MSDN 문서, [HtmlInput Object](https://msdn.microsoft.com/en-us/library/ms814716.aspx)를 참조하십시오.
...
이 공지는 [Microsoft 보안 권고(973882)](https://technet.microsoft.com/security/advisory/973882)에서 설명한 Microsoft ATL(액티브 템플릿 라이브러리) 취약점의 영향을 받는 Windows 구성 요소의 문제점을 해결합니다.
...
예, 타사의 업데이트된 컨트롤이 릴리스되면 설치해야 합니다. [MS09-034](https://technet.microsoft.com/security/bulletin/ms09-034) Internet Explorer 완화 조치는 ATL(액티브 템플릿 라이브러리)로 개발된 특정 구성 요소와 컨트롤의 근본적인 취약점을 해결하지 못합니다. 따라서, 개발자는 이 공지에서 설명하는 취약점의 영향을 받는 모든 구성 요소와 컨트롤을 이 공지에 제공된 지침에 따라 수정하고 다시 빌드하는 것이 좋습니다.

**ATL이란 무엇입니까?**  
ATL(액티브 템플릿 라이브러리)은 개발자가 작고 빠른 COM(Component Object Model) 개체를 만들 수 있는 템플릿 기반 C++ 클래스 모음입니다. 이 클래스 모음은 스톡 구현, 듀얼 인터페이스, 표준 COM 열거자 인터페이스, 연결 지점, 분리(tear-off) 인터페이스, ActiveX 컨트롤을 비롯한 핵심 COM 기능을 지원합니다. 자세한 내용은 다음 [MSDN 문서 (영문)](https://msdn.microsoft.com/en-us/library/3ax346b7(vs.71).aspx)를 참조하십시오.

**DHTML Editing Component ActiveX 컨트롤이란 무엇입니까?**  
DHTML Editing Component ActiveX 컨트롤은 개발자가 소프트웨어에서 동적 웹 사이트 HTML 편집을 지원하는 데 사용할 수 있는 HTML 편집기를 제공합니다. HTML Editing Component ActiveX 컨트롤에 대한 자세한 내용은 다음 [MSDN 문서 (영문)](https://msdn.microsoft.com/en-us/library/aa753630(vs.85).aspx)를 참조하십시오.

**ESTMicrosoft MSWebDVD ActiveX 컨트롤?**  
Microsoft MSWebDVD ActiveX 컨트롤은 MSWebDVD 개체를 응용 프로그램에 노출함으로써 스크립트 기반 DVD 응용 프로그램을 만드는 데 사용됩니다. 자세한 내용은 다음 [MSDN 문서](https://msdn.microsoft.com/en-us/library/dd390904(vs.85).aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0020 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0020)을 참조하십시오.
...
**타사 ActiveX 컨트롤이 이 문제점의 영향을 받습니까?**  
특정 조건에서 구성 요소와 컨트롤을 빌드한 경우 타사 구성 요소와 컨트롤이 이 문제점의 영향을 받을 수 있습니다. 따라서, 개발자는 이 공지에서 설명하는 취약점의 영향을 받는 모든 구성 요소와 컨트롤을 [MS09-035](https://technet.microsoft.com/security/bulletin/ms09-035) Visual Studio 공지에 제공된 지침에 따라 수정하고 다시 빌드하는 것이 좋습니다.
  
**타사 응용 프로그램 개발자로서 구성 요소와 컨트롤에 ATL을 사용합니다. 이러한 구성 요소 또는 컨트롤이 취약합니까? 그렇다면 어떻게 업데이트해야 합니까?**    
구성 요소와 컨트롤이 취약한지 확인하는 절차와 업데이트하는 방법에 대해서는 다음 [MSDN 문서 (영문)](https://msdnworking.redmond.corp.microsoft.com/en-us/ee309358.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2493](https://technet.microsoft.com/security/bulletin/ms09-jul)을 참조하십시오.
...
스트림에서 variant 읽기를 허용하고 variant 유형 읽기를 잘못된 variant와 함께 두는 ATL 헤더의 버그로 인해 Microsoft ATL(액티브 템플릿 라이브러리)에 원격 코드 실행 취약점이 존재합니다. variant를 삭제할 때 공격자가 제어할 수 있는 메모리의 의도되지 않은 영역을 해제할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2494 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2494)를 참조하십시오.
  
#### ATL 개체 유형 불일치 취약점(CVE-2009-2494)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   잠재적으로 취약한 구성 요소와 컨트롤에 대한 완화 요소와 대안은 [Microsoft 보안 권고(973882)](https://technet.microsoft.com/security/advisory/973882)에서 찾을 수 있습니다.
  
#### ATL 개체 유형 불일치 취약점(CVE-2009-2494)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   잠재적으로 취약한 구성 요소와 컨트롤에 대한 완화 요소와 대안은 [Microsoft 보안 권고(973882)](https://technet.microsoft.com/security/advisory/973882)에서 찾을 수 있습니다.
  
#### ATL 개체 유형 불일치 취약점(CVE-2009-2494)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 스트림에서 variant 읽기를 허용하고 variant 유형 읽기를 잘못된 variant와 함께 두는 ATL 헤더의 버그로 인해 발생합니다. variant를 삭제할 때 공격자가 제어할 수 있는 메모리의 의도되지 않은 영역을 해제하여 비일관적인 메모리 내용과 악성 코드 실행을 유발할 수 있습니다.
  
**타사 ActiveX 컨트롤이 이 문제점의 영향을 받습니까?**  
이 취약점은 Microsoft ATL에 있지만 Visual Studio와 함께 제공되는 ATL 버전은 영향을 받지 않습니다. Windows XP 및 Windows Server 2003에서 제공되는 개인 헤더 파일에 영향을 받는 ATL 헤더가 있습니다. 대부분의 타사 개발자는 Visual Studio와 함께 제공되는 헤더 파일을 사용합니다. 이러한 응용 프로그램은 이 문제점에 노출되지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 스트림에서 variant 읽기의 유효성을 확인하고, 수정된 ATL 헤더를 사용하여 작성된 Windows 구성 요소 및 컨트롤의 업데이트된 버전을 제공하여 문제점을 해결합니다.
...
<td style="border:1px solid black;">Microsoft Outlook Express 5.5 서비스 팩 2(KB973354):<br />
OE5.5sp2-KB973354-Windows2000-x86-kor /quiet<br />
<br />
Microsoft Outlook Express 6 서비스 팩 1(KB973354):<br />
OE6.0sp1-KB973354-Windows2000-x86-kor /quiet<br />
<br />
Windows Media Player 9(KB973540):<br />
Windows2000-WindowsMedia9-KB973540-x86-kor /quiet<br />
<br />
Windows ATL 구성 요소(KB973507):<br />
Windows2000-KB973507-x86-kor /quiet<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
Windows2000-KB973869-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Microsoft Outlook Express 5.5 서비스 팩 2(KB973354):<br />
OE5.5sp2-KB973354-Windows2000-x86-kor /norestart<br />
<br />
Microsoft Outlook Express 6 서비스 팩 1(KB973354):<br />
OE6.0sp1-KB973354-Windows2000-x86-kor /norestart<br />
<br />
Windows Media Player 9(KB973540):<br />
Windows2000-WindowsMedia9-KB973540-x86-kor /norestart<br />
<br />
Windows ATL 구성 요소(KB973507):<br />
Windows2000-KB973507-x86-kor /norestart<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
Windows2000-KB973869-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">kb973354.log, kb973540.log, kb973507.log 또는 kb973869.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Microsoft Outlook Express 5.5 서비스 팩 2 또는 Outlook Express 6 서비스 팩 1(KB973354):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973354$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows Media Player 9(KB973540):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973540$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows ATL 구성 요소(KB973507):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973507$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973869$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Outlook Express 5.5 서비스 팩 2 또는 Outlook Express 6 서비스 팩 1(KB973354):<br />
<a href="https://support.microsoft.com/kb/973354">Microsoft 기술 자료 문서 973354</a> 참조<br />
<br />
Windows Media Player 9(KB973540):<br />
<a href="https://support.microsoft.com/kb/973540">Microsoft 기술 자료 문서 973540</a> 참조<br />
<br />
Windows ATL 구성 요소(KB973507):<br />
<a href="https://support.microsoft.com/kb/973507">Microsoft 기술 자료 문서 973507</a> 참조<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
<a href="https://support.microsoft.com/kb/973869">Microsoft 기술 자료 문서 973869</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsxp-kb973354-x86-kor /quiet<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft Outlook Express 6(KB973354):<br />
WindowsServer2003.WindowsXP-KB973354-x64-enu /quiet<br />
<br />
Windows XP 서비스 팩 2의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
WindowsXP-SP2-WindowsMedia-KB973540-x86-kor /quiet<br />
<br />
Windows XP 서비스 팩 3의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
WindowsXP-WindowsMedia-KB973540-x86-kor /quiet<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Player 10(KB973540):<br />
WindowsServer2003.WindowsXP-KB973540-x64-enu /quiet<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Player 11(KB973540):<br />
WindowsMedia11-KB973540-x64-enu /quiet<br />
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsXP-KB973507-x86-kor /quiet<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003.WindowsXP-KB973507-x64-enu /quiet<br />
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsXP-KB973869-x86-kor /quiet<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003.WindowsXP-KB973869-x64-enu /quiet<br />
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 Media Center 컨트롤(KB973815):<br />
WindowsXP-KB973815-x86-kor /quiet<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Media Center 컨트롤(KB973815):<br />
WindowsServer2003.WindowsXP-KB973815-x64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows XP 32비트 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsxp-kb973354-x86-kor /norestart<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft Outlook Express 6(KB973354):<br />
WindowsServer2003.WindowsXP-KB973354-x64-enu /norestart<br />
<br />
Windows XP 서비스 팩 2의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
WindowsXP-SP2-WindowsMedia-KB973540-x86-kor /norestart<br />
<br />
Windows XP 서비스 팩 3의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
WindowsXP-WindowsMedia-KB973540-x86-kor /norestart<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Player 10(KB973540):<br />
...
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsXP-KB973507-x86-kor /norestart<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003.WindowsXP-KB973507-x64-enu /norestart<br />
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsXP-KB973869-x86-kor /norestart<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003.WindowsXP-KB973869-x64-enu /norestart<br />
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 Media Center 컨트롤(KB973815):<br />
WindowsXP-KB973815-x86-kor /norestart<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Media Center 컨트롤(KB973815):<br />
...
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">kb973354.log, kb973540.log, kb973507.log, kb973869.log, kb973815.log 또는 KB973768.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">추가 정보</td>
<td style="border:1px solid black;"><strong>검색, 배포 도구 및 지침</strong>을 참조하십시오.</td>
...
<br />
Windows XP 서비스 팩 2의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %WinDir%\$NTUninstallKB973540_WM9L$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows XP 서비스 팩 3의 Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %WinDir%\$NTUninstallKB973540_WM9$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Player 10(KB973540):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %windir%\$NTUninstallKB973540$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows Media Player 11(KB973540):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %WinDir%\$NTUninstallKB973540_WM11x64\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Windows ATL Component(KB973507):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973507$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973869$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973815$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.<br />
<br />
HtmlInput Object ActiveX 컨트롤(KB973768):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973768$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Outlook Express 6(KB973354):<br />
<a href="https://support.microsoft.com/kb/973354">Microsoft 기술 자료 문서 973354</a> 참조<br />
<br />
Windows Media Player 9, Windows Media Player 10 및 Windows Media Player 11(KB973540):<br />
<a href="https://support.microsoft.com/kb/973540">Microsoft 기술 자료 문서 973540</a> 참조<br />
<br />
Windows ATL 구성 요소(KB973507):<br />
<a href="https://support.microsoft.com/kb/973507">Microsoft 기술 자료 문서 973507</a> 참조<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
<a href="https://support.microsoft.com/kb/973869">Microsoft 기술 자료 문서 973869</a> 참조<br />
<br />
Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
<a href="https://support.microsoft.com/kb/973815">Microsoft 기술 자료 문서 973815</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3의 Microsoft Outlook Express 6(KB973354):<br />
...
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 Windows ATL Component(KB973507):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB973507<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Windows ATL Component(KB973507):<br />
...
<br />
지원 대상인 모든 Windows XP 32비트 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Hotfix\KB973815<br />
&quot;Installed&quot;,0x10001,1<br />
<br />
Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Hotfix\KB973815<br />
&quot;Installed&quot;,0x10001,1<br />
<br />
Windows XP Media Center Edition 2005의 HtmlInput Object ActiveX 컨트롤(KB973768):<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsserver2003-kb973354-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsserver2003.WindowsXP-KB973354-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsserver2003-KB973354-ia64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Windows Media Player 10(KB973540):<br />
WindowsServer2003-KB973540-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Windows Media Player 10(KB973540):<br />
WindowsServer2003.WindowsXP-KB973540-x64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003-KB973507-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003.WindowsXP-KB973507-x64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003-KB973507-ia64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003-KB973869-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003.WindowsXP-KB973869-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003-KB973869-ia64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
WindowsServer2003-KB973815-x86-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
WindowsServer2003.WindowsXP-KB973815-x64-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
WindowsServer2003-KB973815-ia64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsserver2003-kb973354-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Microsoft Outlook Express 6(KB973354):<br />
Windowsserver2003.WindowsXP-KB973354-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Microsoft Outlook Express 6(KB973354):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Windows Media Player 10(KB973540):<br />
WindowsServer2003-KB973540-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Windows Media Player 10(KB973540):<br />
WindowsServer2003.WindowsXP-KB973540-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003-KB973507-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
WindowsServer2003.WindowsXP-KB973507-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003-KB973869-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
WindowsServer2003.WindowsXP-KB973869-x64-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 DHTML Editing Component ActiveX 컨트롤(KB973869):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
WindowsServer2003-KB973815-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
WindowsServer2003.WindowsXP-KB973815-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션의 Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
...
<tr class="odd">
<td style="border:1px solid black;">로그 파일 업데이트</td>
<td style="border:1px solid black;">kb973354.log, kb973540.log, kb973507.log, kb973869.log 또는 kb973815.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">추가 정보</td>
<td style="border:1px solid black;"><strong>검색, 배포 도구 및 지침</strong>을 참조하십시오.</td>
...
<br />
Microsoft MSWebDVD ActiveX 컨트롤(KB973815):<br />
제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB973815$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;">Microsoft Outlook Express 6(KB973354):<br />
...
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB973869<br />
<br />
DHTML Editing Component ActiveX 컨트롤(KB973815):<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Hotfix\KB973815<br />
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 32비트 에디션의 Windows Media Player 11(KB973540):<br />
Windows6.0-KB973540-x86 /quiet<br />
<br />
지원 대상인 모든 Windows Vista x64 기반 에디션의 Windows Media Player 11(KB973540):<br />
Windows6.0-KB973540-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 32비트 에디션의 Windows ATL 구성 요소(KB973507):<br />
Windows6.0-KB973507-x86 /quiet<br />
<br />
지원 대상인 모든 Windows Vista x64 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
Windows6.0-KB973507-x64 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Vista 32비트 에디션의 HtmlInput Object ActiveX 컨트롤(KB973768):<br />
Windows6.0-KB973768-x86 /quiet<br />
<br />
지원 대상인 모든 Windows Vista x64 기반 에디션의 HtmlInput Object ActiveX 컨트롤(KB973768):<br />
Windows6.0-KB973768-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 WindowsVista 32비트 에디션의 Windows Media Player 11(KB973540):<br />
...
<br />
HtmlInput Object ActiveX 컨트롤(KB973768):<br />
<a href="https://support.microsoft.com/kb/973768">Microsoft 기술 자료 문서 973768</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">사용자 개입 없이 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 Windows Media Player 11(KB973540):<br />
Windows6.0-KB973540-x86 /quiet<br />
<br />
지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 Windows Media Player 11(KB973540):<br />
Windows6.0-KB973540-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2008 32비트 에디션의 Windows ATL 구성 요소(KB973507):<br />
Windows6.0-KB973507-x86 /quiet<br />
<br />
지원 대상인 모든 Windows Server 2008 x64 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
Windows6.0-KB973507-x64 /quiet<br />
<br />
지원 대상인 모든 Windows Server 2008 Itanium 기반 에디션의 Windows ATL 구성 요소(KB973507):<br />
...
<br />
Windows ATL 구성 요소(KB973507):<br />
<a href="https://support.microsoft.com/kb/973507">Microsoft 기술 자료 문서 973507</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;"><strong>참고:</strong> 이 업데이트가 있는지 확인하는 레지스트리 키는 없습니다.</td>
...
-   ATL 헤더 Memcopy 취약점(CVE-2008-0020)을 보고해 주신 [IBM ISS X-Force (영문)](https://www.iss.net/)의 Robert Freeman  
...
-   ATL 개체 유형 불일치 취약점(CVE-2009-2494)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Ryan Smith
...
-   V1.1(2009년 8월 13일): **이 보안 업데이트와 관련된 자주 제기되는 질문 사항(FAQ)** 섹션에서 알려진 문제에 대한 잘못된 참조가 제거되었고 **Microsoft 비디오 ActiveX 컨트롤 취약점(CVE-2008-0015)에 대한 FAQ** 섹션에 이 공지와 Microsoft 보안 공지 MS09-032 사이의 관계를 설명하는 새 항목이 추가되었으며, 다시 시작 요구 사항이 공지에서 수정되고 기타 내용이 편집되었습니다.  
-   V1.1(2009년 8월 20일): DHTML Editing Component Active X 컨트롤 업데이트를 명확히 하기 위해 영향을 받는 소프트웨어 테이블이 수정되어 Windows XP 서비스 팩 3용을 제외한 Windows XP 서비스 팩 2용의 MS05-13 으로 대체되었습니다. 또한 Windows Media Player 11(KB973869) 업데이트는 Windows Vista x64 버전 서비스 팩 1 혹은 Windows Vista x64 버전 서비스 팩 2를 제외한 Windows Vista x64 버전의 MS07-047 로 대체되었습니다.  
-   V2.0(2009년 9월 9일): Windows XP Media Center Edition 2005 및 지원 대상인 모든 Windows Vista 에디션의 HtmlInput Object ActiveX 컨트롤에 대한 새로운 업데이트를 제공하기 위해 공지가 릴리스되었습니다. 또한 Microsoft Windows 2000, Windows XP 및 Windows Server 2003의 Windows Media Player에 대한 **보안 업데이트 배포** 섹션에서 여러 테이블 항목이 수정되었습니다.  
-   V2.1(2009년 12월 17일): 요약의 알려진 이슈에 Microsoft 보안 권고(973908)링크가 추가 되었습니다.
