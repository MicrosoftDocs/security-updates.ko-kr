---
TOCTitle: 'MS10-096'
Title: 'Microsoft 보안 공지 MS10-096 - 중요'
ms:assetid: 'ms10-096'
ms:contentKeyID: 61230356
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-096(v=Security.10)'
---


Microsoft 보안 공지 MS10-096 - 중요
===================================
...
보안 업데이트는 Windows 주소록에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=46baa431-126c-4fa5-9a7b-525008e2817d&displaylang=ko)                                                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b9ce9d62-2eaa-48d8-bb6d-ea137e63d077)                                                                 | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e0b2837c-019b-419b-954d-5bdc71a3a332&displaylang=ko)                                                                  | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4c5cb600-9a39-40a0-be42-1593b1e0b97d&displaylang=ko)                                                      | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9abc8270-f3ac-474d-9ebc-410aaa6262cc)                                                             | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a1c7f1b5-e054-4cd6-857d-2ab0a2fe9f62&displaylang=ko)                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=73624b68-a69d-4517-b971-f0b7d2ccc9d6&displaylang=ko)                   | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=118f528f-bd05-49c2-a4a4-78314cd00992&displaylang=ko)\*\*     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=77e288fb-b51f-4f57-baac-1443d8fbd37b&displaylang=ko)\*\* | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=82f71194-6f1f-4f43-8752-4bf5e5f94a93)            | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4e8ad5cd-af27-4f00-9378-ad778b8ee7b3&displaylang=ko)                                                                       | 원격 코드 실행 | 중요        | 없음                      |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=35a3e821-b463-411c-858b-d01eb5aed42b&displaylang=ko)                                                                     | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9e2c95f6-9381-4484-b11b-814ab9138118&displaylang=ko)\*\*                                                    | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=cb4211f3-1082-4245-8f03-7cbac90e9a31)                                                                   | 원격 코드 실행 | 중요        | 없음                      |
...
<th style="border:1px solid black;" >안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)</th>
...
Windows 주소록에서 DLL 파일 로드를 처리하는 방식에 원격 코드 실행 취약점이 존재합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3147 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147)을 참조하십시오.
  
#### 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)에 대한 완화 요소
...
#### 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)에 대한 대안
...
#### 안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
이 취약점은 Windows 주소록이 외부 라이브러리 로드에 사용되는 경로를 잘못 제한하기 때문에 발생합니다.
  
**Windows 주소록이란 무엇입니까?**    
Windows에서 연락처 정보를 저장하는 주소록입니다. Windows 주소록(WAB)은 사용자가 사람을 추적할 수 있는 응용 프로그램 및 서비스입니다. WAB는 사람에 대한 정보를 찾고 편집하는 로컬 데이터베이스와 사용자 인터페이스로 구성되어 있으며 LDAP(Lightweight Directory Access Protocol)를 사용하여 네트워크 디렉터리 서버를 쿼리할 수 있습니다. 다른 응용 프로그램에서도 WAB를 사용할 수 있습니다. 예를 들어, Microsoft Outlook에서는 WAB를 전자 메일 주소록으로 사용합니다.
...
공격자는 사용자가 특수하게 조작된 DLL(동적 연결 라이브러리) 파일과 동일한 네트워크 디렉터리에 있는 합법적인 Windows 주소록(WAB) 파일을 열도록 유도할 수 있습니다. 이렇게 하면 WAB 파일을 열 때 Windows 주소록이 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
전자 메일 공격 시나리오에서 공격자는 합법적인 WAB 첨부 파일을 사용자에게 보내고 사용자가 특수하게 조작된 DLL 파일이 들어 있는 디렉터리에 WAB 파일을 두고 WAB 파일을 열도록 유도하여 취약점을 악용할 수 있습니다. 이렇게 하면 WAB 파일을 열 때 Windows 주소록이 DLL 파일 로드 및 포함된 코드 실행을 시도할 수 있습니다.
  
네트워크 시나리오에서 공격자는 합법적인 WAB 파일 및 특수하게 조작된 DLL을 UNC 또는 WebDAV 위치에 두고 사용자가 WAB 파일을 열도록 유도할 수 있습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 주소록에서 외부 라이브러리를 로드하는 방식을 수정하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-3147 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147)이 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2423089$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2423089">Microsoft 기술 자료 문서 2423089</a> 참조</td>
</tr>
<tr class="even">
...
#### Windows Server 2003(모든 32비트 에디션)
...
-   안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)을 보고해 주신 [ACROS Security (영문)](http://www.acrossecurity.com/)의 Simon Raner  
-   안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)을 보고해 주신 [Rapid7 (영문)](http://www.rapid7.com/)의 HD Moore  
-   안전하지 않은 라이브러리 로드 취약점(CVE-2010-3147)을 보고해 주신 [NGS Software (영문)](http://www.ngssoftware.com/)의 Muhaimin Dzulfakar
