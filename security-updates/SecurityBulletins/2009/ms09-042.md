---
TOCTitle: 'MS09-042'
Title: 'Microsoft 보안 공지 MS09-042 - 중요'
ms:assetid: 'ms09-042'
ms:contentKeyID: 61230228
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms09-042(v=Security.10)'
---


Microsoft 보안 공지 MS09-042 - 중요
===================================
...
이 보안 업데이트는 자격 증명 전달을 방지하기 위해 텔넷 서비스가 인증 응답의 유효성을 검사하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 960859](https://support.microsoft.com/kb/960859)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=240977d6-3581-4058-b9f1-7847e4edcf8a&displaylang=ko)(KB960859)                                                                        | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=b3331388-1e52-4924-b512-23275a8fde84&displaylang=ko)(KB960859)                                                          | 원격 코드 실행 | 중요        | 없음                      |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a6ee7af3-3e39-4866-a893-92bf1c786cd4)(KB960859)                                                                          | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3fe9c745-d87c-43b0-9b2a-356fb34282b4&displaylang=ko)(KB960859)                                                                           | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e2a788e7-a9d1-4574-b106-f8ab44c6c4a2&displaylang=ko)(KB960859)                                                               | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Server 2003(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4f625d39-29d4-44f9-b4bd-cd99f1ea422d)(KB960859)                                                                               | 원격 코드 실행 | 중요        | 없음                      |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d77f406d-11cb-4d19-94ec-938b356c3427&displaylang=ko)(KB960859)                                     | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7a41b8c1-f955-474e-a08e-5e73964327d1&displaylang=ko)(KB960859) | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=62f2e0a6-5e68-41c7-a851-d99bcff6ff3e&displaylang=ko)\*(KB960859)                | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=6e5d1db9-efef-4112-8138-62f14670cf0d&displaylang=ko)\*(KB960859)            | 원격 코드 실행 | 보통        | 없음                      |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4b813c74-b2ae-4962-9ebb-1311193d9e2d)(KB960859)                     | 원격 코드 실행 | 보통        | 없음                      |
...
예, 이 공지에는 텔넷 클라이언트 및 서버가 인증에 대한 확장된 보호로 옵트인하도록 지원하는 업데이트도 포함되어 있습니다. 자세한 내용은 [Microsoft 보안 권고 973811](https://technet.microsoft.com/security/advisory/973811)을 참조하십시오.
...
<th style="border:1px solid black;" >텔넷 자격 증명 리플렉션 취약점(CVE-2009-1930)</th>
...
Microsoft 텔넷 서비스에 원격 코드 실행 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 프로그램을 설치하거나 데이터를 보고 변경하거나 삭제하고 모든 사용자 권한이 있는 새 계정을 만들 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1930 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1930)을 참조하십시오.
  
#### 텔넷 자격 증명 리플렉션 취약점(CVE-2009-1930)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   최선의 방화벽 구성 방법과 표준 기본 방화벽 구성을 이용하면 기업 경계 외부에서 들어오는 공격으로부터 네트워크를 보호할 수 있습니다. 인터넷과 연결되는 시스템의 경우, 필요한 포트만 최소한으로 열어 두는 것이 안전합니다. 이 경우 자격 증명이 리플렉션될 가능성이 가장 높은 대상 SMB 포트를 인터넷에서 차단해야 합니다.  
-   취약점 악용에 성공한 공격자는 로컬 사용자와 동일한 권한을 얻을 수 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.  
-   기본적으로 텔넷은 Windows Vista 및 Windows Server 2008 시스템에 설치되지 않습니다.
  
#### 텔넷 자격 증명 리플렉션 취약점(CVE-2009-1930)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### 텔넷 자격 증명 리플렉션 취약점(CVE-2009-1930)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
텔넷 프로토콜이 NTLM 자격 증명 리플렉션 보호에 대해 올바르게 지정되지 않아 사용자의 자격 증명이 되돌아오지 않고 사용자에 대해 사용되었습니다.
  
**텔넷이란 무엇입니까?**    
텔넷은 TCP프로토콜을 통한 명령줄 원격 액세스를 허용하는 양방향 통신 프로토콜입니다. 자세한 내용은 MSDN 문서, [텔넷 서버(영문)](https://msdn.microsoft.com/en-us/library/aa919240.aspx)를 참조하십시오.
  
**NTLM이란 무엇입니까?**    
NTLM은 제공된 자격 증명의 신뢰성을 확인하는 데 사용되는 Challenge/Response 메커니즘을 기반으로 한 인증 프로토콜입니다.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
공격자는 이 취약점을 이용하여 로그온한 사용자의 권한을 획득하고 로그온한 사용자의 권한으로 할 수 있는 모든 것을 할 수 있습니다. 사용자가 관리자 권한으로 로그온한 경우, 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
이 취약점을 악용하려면 영향을 받는 텔넷 버전이 있는 사용자가 특수하게 조작된 텔넷 서버에 액세스해야 합니다. 공격자는 이 취약점을 이용하기 위해 특수하게 조작된 텔넷 서버를 호스팅해야 합니다. 공격자는 강제로 사용자가 특수하게 조작된 텔넷 서버에 연결하도록 할 수 없습니다. 대신, 공격자는 사용자가 특수하게 조작된 텔넷 서버로 이동되는 전자 메일 메시지 또는 인스턴트 메신저 메시지의 링크를 클릭하도록 하여 텔넷 서버를 방문하도록 만들어야 합니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
현재 지원 대상인 모든 Windows 시스템이 위험합니다.
  
**이 취약점의 심각도가 WindowsVista** **및 Windows Server 2008에 대해 중요이고 기타 모든 플랫폼에 대해 긴급인 이유는 무엇입니까?**    
텔넷 클라이언트는 지원되는 Windows Vista 에디션 및 Windows Server 2008에 기본으로 설치되어 있지 않습니다. 컴퓨터는 텔넷을 수동으로 설치한 경우에만 이 공지에서 해결한 문제에 취약할 수 있습니다. 기타 모든 지원되는 Windows 에디션에는 텔넷이 기본으로 설치되어 있습니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
보안 업데이트는 Microsoft 텔넷 서비스가 Windows에서 사용할 수 있는 자격 증명 보호 메커니즘으로 적절하게 옵트인하도록 보장하여 취약점을 완화합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-1930](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1930)이 지정되었습니다.
...
<td style="border:1px solid black;">Windows2000-kb960859-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows2000-kb960859-x86-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB960859$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/960859">Microsoft 기술 자료 문서 960859</a> 참조</td>
</tr>
<tr class="even">
...
Windowsxp-kb960859-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
Windowsxp-kb960859-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2:<br />
...
Windowsserver2003-kb960859-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB960859-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
Windowsserver2003-kb960859-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
Windowsserver2003.WindowsXP-KB960859-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션:<br />
...
-   V1.1(2009년 8월 13일): 알려진 문제점 기술 자료 문서에 대한 링크가 추가되었습니다. Windows Vista 및 Windows Server 2008에 대한 완화 요소가 추가되었습니다. Windows 플랫폼의 서로 다른 심각도에 대한 FAQ가 추가되었습니다. 보안 권고 973811에 대한 링크가 제거되었습니다. 다시 시작 요구 사항이 변경되었습니다.
