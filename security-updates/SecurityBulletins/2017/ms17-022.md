---
TOCTitle: 'MS17-022'
Title: 'Microsoft 보안 공지 MS17-022 - 중요'
ms:assetid: 'ms17-022'
ms:contentKeyID: 74430774
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms17-022(v=Security.10)'
---

Microsoft 보안 공지 MS17-022 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원되는 모든 Microsoft Windows 릴리스의 Microsoft XML Core Services 3.0에 대해 중요입니다. 자세한 내용은 **영향받는 소프트웨어** 절을 참조하십시오.

이 업데이트는 MSXML이 메모리의 개체를 처리하는 방식을 변경하여 취약성을 해결합니다. 취약성에 대한 자세한 내용은 **취약성 정보** 절을 참조하십시오.

<span id="KBArticle"></span>
이 업데이트에 대한 자세한 내용은 [Microsoft 기술 자료 문서 4010321](https://support.microsoft.com/ko-kr/kb/4010321)을 참조하십시오.
...
<td style="border:1px solid black;">
[**Microsoft XML Core Services 정보 유출 취약성(CVE-2017-0022)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0022)
...
<td style="border:1px solid black;">
[MS16-040](https://go.microsoft.com/fwlink/?linkid=746897)(3146963)
...
<tr>
<td style="border:1px solid black;">
[Windows 10 버전 1607(32비트 시스템용)](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3216916)<sup>[3]</sup>
(3216916)
...
<tr>
<td style="border:1px solid black;">
[Windows 10 버전 1607(x64 기반 시스템용)](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3216916)<sup>[3]</sup>
(3216916)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2016(x64 기반 시스템용)](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3216916)<sup>[3]</sup>
(3216916)
...
<tr>
<td style="border:1px solid black;">
Windows Server 2012 R2(Server Core 설치)월별 롤업<sup>[1]</sup>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2016(x64 기반 시스템용)](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3216916)<sup>[3]</sup>(Server Core 설치)  
(3216916)
...
<tr class="even">
<td style="border:1px solid black;">Windows 10(모든 릴리스)</td>
<td style="border:1px solid black;">운영 체제와 함께 제공됨</td>
</tr>
<tr class="odd">
...
Microsoft XML Core Services 정보 유출 취약성(CVE-2017-0022)(영문)  
-----------------------------------------------------------------
  
[Microsoft XML Core Services(MSXML)](https://technet.microsoft.com/ko-kr/library/security/dn848375.aspx)(영문)가 메모리의 개체를 부적절하게 처리하는 경우 정보 취약성이 존재합니다. 이 취약성 악용에 성공한 공격자는 디스크의 파일 유무를 테스트할 수 있습니다.
  
이 취약성을 악용하기 위해 공격자는 Internet Explorer를 통해 MSXML을 호출하도록 디자인된 특수 제작된 웹 사이트를 호스트할 수 있습니다. 하지만 공격자는 강제로 사용자가 이러한 웹 사이트를 방문하도록 만들 수 없습니다. 대신 일반적으로 공격자는 사용자가 전자 메일 메시지의 링크 또는 인스턴트 메신저 요청의 링크를 클릭하여 해당 웹 사이트를 방문하도록 유도해야 합니다.
  
이 업데이트는 MSXML이 메모리에서 개체를 처리하는 방식을 변경하여 취약성을 해결합니다.
...
<tr class="even">
<td style="border:1px solid black;">Microsoft XML Core Services 정보 유출 취약성</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0022">CVE-2017-0022(영문)</a></td>
...
*2017년 3월 8일 12:49-08:00에 페이지가 생성되었습니다.*