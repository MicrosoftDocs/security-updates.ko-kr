...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 961260](https://support.microsoft.com/kb/961260)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 961260](https://support.microsoft.com/kb/961260)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0075 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-0076 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076)을 참조하십시오.

#### CSS 메모리 손상 취약점(CVE-2009-0076)에 대한 완화 요소
...
**CSS란?**  
CSS(Cascading Style Sheet)는 HTML을 사용하는 웹 페이지의 서식 지정 방법입니다. CSS에 대한 자세한 내용은 [Microsoft TechNet 웹 사이트 (영문)](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/961260">Microsoft 기술 자료 문서 961260</a> 참조</td>
</tr>
<tr class="even">
...
IE7-WindowsServer2003.WindowsXP-KB961260-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치 </td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003-KB961260-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션용 Internet Explorer 7:<br />
IE7-WindowsServer2003.WindowsXP-KB961260-x64-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 Itanium 기반 에디션용 Internet Explorer 7:<br />
...
-   초기화되지 않은 메모리 손상 취약점(CVE-2009-0075)을 보고해 주신 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)  
-   CSS 메모리 손상 취약점(CVE-2009-0076)을 [TippingPoint (영문)](https://www.tippingpoint.com/) 및 [Zero Day Initiative (영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 Sam Thomas([https://eshu.co.uk/ (영문)](https://eshu.co.uk/))
...
-   V1.1(2009년 2월 17일): **요약**의 알려진 문제점에 Microsoft 기술 자료 문서 961260 링크가 추가되었습니다.
