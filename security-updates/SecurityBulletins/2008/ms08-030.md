...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=980bb421-950f-4825-8039-44cc961a47b8&displaylang=ko)                        | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=81ab56ca-933f-4974-a393-290a54c30a78) | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Vista 및 Windows Vista 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=6524debe-be50-44d1-8543-af0bfaf086ad&displaylang=ko)                              | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Vista x64 Edition 및 Windows Vista x64 Edition 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=6adee8b9-3455-4f3b-8bdd-2585c8ff83b8&displaylang=ko)      | 원격 코드 실행 | 긴급        | 없음                      |
...
Microsoft는 Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3 업데이트에 영향을 주는 문제점 때문에 [Microsoft 보안 공지 MS08-030](https://technet.microsoft.com/security/bulletin/ms08-030) - [Bluetooth 스택의 취약점으로 인한 원격 코드 실행 문제점(951376)](https://technet.microsoft.com/security/bulletin/ms08-030)에서 다룬 업데이트를 다시 제공합니다. [Microsoft 보안 공지 MS08-030](https://technet.microsoft.com/security/bulletin/ms08-030)에서 제공된 Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3 업데이트가 해당 보안 공지에서 설명한 취약점을 완전하게 해결하지 못했습니다. 기타 보안 업데이트 버전은 모두 해당 보안 공지에서 다룬 문제점에 대해 적절한 보안 조치를 제공합니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 951376](https://support.microsoft.com/kb/951376)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-1453 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1453)을 참조하십시오.
...
**Bluetooth란 무엇입니까?**    
Bluetooth는 컴퓨터, 핸드헬드 장치, 휴대폰 및 기타 장치에서 무선 연결을 구성할 수 있는 업계 표준 프로토콜입니다. 자세한 정보는 [MSDN Bluetooth 문서 (영문)](https://msdn.microsoft.com/ko-kr/library/aa362932(vs.85).aspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/951376">Microsoft 기술 자료 문서 951376</a> 참조</td>
</tr>
<tr class="even">
...
-   Bluetooth 취약점(CVE-2008-1453)에 대한 업데이트 재발표에 도움을 주신 [NSFocus (영문)](https://www.nsfocus.com/)의 Tombkeeper 및 [Nevis Labs (영문)](https://www.nevisnetworks.com/)의 Sowhat
