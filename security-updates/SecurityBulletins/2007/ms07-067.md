...
이 보안 업데이트는 [Microsoft 보안 권고 944653](https://technet.microsoft.com/security/advisory/944653)에서 처음 설명한 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2007-5587 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587)을 참조하십시오.
...
예. 이 보안 공지가 처음 게시되었을 때 이 취약점은 공개되어 있었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2006-5587 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587)이 지정되었습니다. 이 취약점은 Microsoft 보안 권고 944653에서 처음 설명되었습니다.
