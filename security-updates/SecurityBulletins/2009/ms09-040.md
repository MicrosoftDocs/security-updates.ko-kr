...
**문제점.**[Microsoft 기술 자료 문서 971032](https://support.microsoft.com/kb/971032)는 고객이 보안 업데이트를 할 때 겪을 수 있는 현재까지 알려진 문제점들을 기술하고 있다. 또한 이 문제들을 해결하기 위한 추천 해결책을 기술하고 있다.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=8ed8bad7-2885-452c-9c34-3982cd498be8&displaylang=ko)          | 중요           | 권한 상승   | [MS08-065](https://technet.microsoft.com/security/bulletin/ms08-065) |
| [Windows XP 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=93490aa7-9985-4658-b0d7-88fb3f27ada0&displaylang=ko)                      | 중요           | 권한 상승   | [MS07-065](https://technet.microsoft.com/security/bulletin/ms07-065) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=12e6be68-dc87-450e-927b-3c9b6873eb13)            | 중요           | 권한 상승   | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=52f59c56-2aba-4626-a90e-311e0e73c813&displaylang=ko)             | 중요           | 권한 상승   | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2f77ef7b-54f8-4260-b6a6-d62a0f85ef45&displaylang=ko) | 중요           | 권한 상승   | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ad55c653-ee6b-4c92-b7f4-3923bb916546)             | 중요           | 권한 상승   | 없음                                                                |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=00afd94c-b483-4155-884f-b617acca6e7d&displaylang=ko)                               | 중요           | 권한 상승   | 없음                                                                |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=a0c698aa-a913-4981-8798-6bbb8cacfb86&displaylang=ko)                   | 중요           | 권한 상승   | 없음                                                                |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-1922 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1922)를 참조하십시오.
...
-   **Message Queuing 서비스를 사용하지 않도록 설정::**
    ...
    -   그룹 정책:  
        ...
        **참고:** Windows Server 2003 보안 가이드도 참조하십시오. 이 가이드에는 서비스 비활성화 방법에 대한 정보가 포함되어 있습니다.  
        ...
        [Step-by-Step Guide to Understanding the Group Policy Feature Set (영문)](https://technet.microsoft.com/en-us/library/bb742376.aspx)  
        [Windows 2000 그룹 정책 (영문)](https://technet.microsoft.com/en-us/library/bb742376.aspx)  
...
| **파일 정보**             | [Microsoft 기술 자료 문서 971032](https://support.microsoft.com/kb/971032) 참조                                                   |  
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/971032">Microsoft 기술 자료 문서 971032</a> 참조</td>
</tr>
<tr class="even">
...
-   MSMQ Null 포인터 취약점(CVE-2009-1922)을 보고해 주신 [Positive Technologies Research Team (영문)](https://en.securitylab.ru/lab/)의 Nikita Tarakanov
