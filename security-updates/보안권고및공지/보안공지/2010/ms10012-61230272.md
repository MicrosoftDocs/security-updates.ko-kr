...
<tr class="header">
<th>영향을 받는 소프트웨어</th>
<th>SMB 경로 이름 오버플로 취약점(CVE-2010-0020)</th>
<th>SMB 메모리 손상 취약점(CVE-2010-0021)</th>
<th>SMB Null 포인터 취약점(CVE-2010-0022)</th>
<th>SMB NTLM 엔트로피 인증 부족 취약점(CVE-2010-0231)</th>
<th>전체 심각도</th>
</tr>
</thead>
<tbody>
