---
TOCTitle: 'MS13-015'
Title: 'Microsoft 보안 공지 MS13-015 - 중요'
ms:assetid: 'ms13-015'
ms:contentKeyID: 61230565
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-015(v=Security.10)'
---

Security Bulletin

Microsoft 보안 공지 MS13-015 - 중요
===================================
...
보안 업데이트는 사용자가 제공하는 콜백을 실행할 때 .NET Framework가 권한을 상승하는 방법을 수정하여 발생하는 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
<td style="border:1px solid black;">
[](http://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)</a>의 KB2686828이 KB2789643으로 대체됨  
[](http://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)</a>의 KB2686827이 KB2789642로 대체됨
</td>
</tr>
...
<td style="border:1px solid black;">
[](http://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)</a>의 KB2686833이 KB2789646으로 대체됨  
[](http://go.microsoft.com/fwlink/?linkid=251095)[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)</a>의 KB2686827이 KB2789642로 대체됨  
KB2789648로 대체된 업데이트 없음
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)의 KB2686830이 KB2789644로 대체됨  
[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)의 KB2686827이 KB2789642로 대체됨
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)의 KB2686831이 KB2789645로 대체됨  
[MS12-038](http://go.microsoft.com/fwlink/?linkid=251095)의 KB2686827이 KB2789642로 대체됨  
KB2789648로 대체된 업데이트 없음
</td>
</tr>
...
(KB2789645)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/details.aspx?familyid=182f4d35-f18b-4485-be22-43becbd3cc05&displaylang=ko)<sup>[1]</sup>(Server Core 설치)  
(KB2789642)  
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2800277](https://support.microsoft.com/kb/2800277)을 참조하십시오.
...
<th>
WinForms 콜백 권한 상승 취약점(CVE-2013-0073)
</th>
<th>
전체 심각도
</th>
...
<span></span>
.NET Framework가 특정 Windows Forms 개체를 만들 때 콜백 기능의 권한을 상승하는 경우 권한 상승 취약점이 발생합니다. 이 취약점을 악용한 공격자는 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다. 시스템에 대한 사용자 권한이 적게 구성된 계정의 사용자는 관리자 권한으로 작업하는 사용자에 비해 영향을 적게 받습니다.

.NET Framework가 특정 WinForms 개체를 만들 때 콜백 기능의 권한을 부적절하게 상승하면 취약점이 발생할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-0073](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0073)(영문)을 참조하십시오.

#### WinForms 콜백 권한 상승 취약점(CVE-2013-0073)에 대한 완화 요소
...
#### WinForms 콜백 권한 상승 취약점(CVE-2013-0073)에 대한 대안
...
#### WinForms 콜백 권한 상승 취약점(CVE-2013-0073)에 대한 FAQ
...
업데이트는 어떤 기능을 수행합니까? 
업데이트는 사용자가 제공하는 콜백을 실행할 때 .NET Framework가 권한을 상승하는 방법을 수정하여 발생하는 취약점을 해결합니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2800277">Microsoft 기술 자료 문서 2800277</a> 참조</td>
</tr>
<tr class="odd">
...
| /q         | 자동 모드, 사용자가 입력하지 않아도 되며 출력 결과가 표시되지 않습니다.                 |
| /norestart | 패치를 재시작해야 하는 경우 재시작을 묻는 메시지가 표시되지 않으며 재시작되지 않습니다. |
| /uninstall | 보안 업데이트를 제거합니다.                                                             |

참고 Windows 설치 프로그램 기반 소프트웨어 업데이트의 명령줄 스위치에 대한 자세한 내용은 [Command-Line Options(명령줄 옵션)](http://msdn.microsoft.com/en-us/library/aa367988)을 참조하십시오.
...
Microsoft .NET Framework 2.0 서비스 팩 2의 보안 업데이트는 다음 설치 스위치를 지원합니다.
...
참고 wusa.exe 설치 프로그램의 명령줄 스위치에 대한 자세한 내용은 [Windows 소프트웨어 업데이트 패키지의 명령줄 스위치](http://support.microsoft.com/kb/262841)를 참조하십시오.
...
-   WinForms 콜백 권한 상승 취약점(CVE-2013-0073)을 보고해 주신 [Context Information Security](http://www.contextis.com)의 James Forshaw
