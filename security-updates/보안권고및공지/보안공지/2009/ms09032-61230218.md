...
이 보안 업데이트는 [Microsoft 보안 권고 972890](http://technet.microsoft.com/security/advisory/972890)에서 처음 설명한 취약점도 해결합니다.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 서비스 팩 4](http://www.microsoft.com/downloads/details.aspx?familyid=89d941f0-3f71-46e3-8096-716561396b72&displaylang=ko)                                                                        | 없음           | 없음\*\*    | 없음                                                                |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](http://www.microsoft.com/downloads/details.aspx?familyid=24701af8-b87e-4e85-9463-f50755a1b6ad&displaylang=ko)                                                          | 원격 코드 실행 | 긴급        | [MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032) |
| [Windows XP Professional x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=2cbf3699-7f79-4006-99e9-0a4c0d394c48)                                                                          | 원격 코드 실행 | 긴급        | [MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032) |
| [Windows Server 2003 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=b0a458d6-c34c-41c7-964a-c130cfcb0d01&displaylang=ko)                                                                           | 원격 코드 실행 | 보통        | [MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=8b7a7bb0-80ef-4f25-bc70-3d0ac06007c5&displaylang=ko)                                                               | 원격 코드 실행 | 보통        | [MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](http://www.microsoft.com/downloads/details.aspx?familyid=7be36edf-02af-402f-983a-f9ca8128b6b5)                                                                           | 원격 코드 실행 | 보통        | [MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032) |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c90240e-c201-4dad-9835-ea71e3527b45&displaylang=ko)                                     | 없음           | 없음\*\*    | 없음                                                                |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=d2084e8d-212b-4c39-9163-a71ec6d1b1c7&displaylang=ko) | 없음           | 없음\*\*    | 없음                                                                |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2\*](http://www.microsoft.com/downloads/details.aspx?familyid=0194f994-5821-4fb9-b9e1-ed6af248c995&displaylang=ko)                | 없음           | 없음\*\*    | 없음                                                                |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2\*](http://www.microsoft.com/downloads/details.aspx?familyid=4127b125-fdaa-489a-a80c-14b5647ac7e0&displaylang=ko)            | 없음           | 없음\*\*    | 없음                                                                |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](http://www.microsoft.com/downloads/details.aspx?familyid=4082c776-318c-4e0c-83fc-2f3f472c039a)                     | 없음           | 없음\*\*    | 없음                                                                |
...
[Microsoft 보안 권고 972890](http://technet.microsoft.com/security/advisory/972890)에 제시된 대안은 Internet Explorer에서 Microsoft 비디오 ActiveX 컨트롤이 실행되지 않도록 합니다. 고객은 이 대안을 수동으로 적용하거나 [Microsoft 기술 자료 문서 972890](http://support.microsoft.com/kb/972890)의 자동 Microsoft Fix it 솔루션을 사용하여 대안을 사용할 수 있습니다. 위의 방법을 사용하여 이 대안을 적용한 고객은 이 보안 업데이트를 설치할 필요가 없습니다.
...
이 대안을 수동으로 적용했거나 [Microsoft 기술 자료 문서 972890](http://support.microsoft.com/kb/972890)의 Microsoft Fix it 솔루션을 사용하여 자동으로 적용한 고객은 이 업데이트를 설치하기 전에 [Microsoft 보안 권고 972890](http://technet.microsoft.com/security/advisory/972890)에서 제시된 대안 실행을 취소할 필요가 없습니다.

**이 업데이트를 설치한 다음 Microsoft 보안 권고 972890의 대안 실행을 취소하면 어떻게 됩니까?**  
이 시나리오에서 Windows Vista 및 Windows Server 2008 고객이 추가 보안을 위해 이 보안 업데이트를 설치한 다음 수동으로 [Microsoft 보안 권고 972890](http://technet.microsoft.com/security/advisory/972890)의 대안 실행을 취소하거나 [Microsoft 기술 자료 문서 972890](http://support.microsoft.com/kb/972890)의 자동 Microsoft Fix it 솔루션을 사용하여 대안을 해제한 경우입니다. 이러한 고객은 더 이상 Internet Explorer에서 Microsoft 비디오 ActiveX 컨트롤이 실행되는 것을 예방하지 않아 시스템이 취약해집니다. 또한 추후 검색 결과에서 대안 실행이 취소된 성공적인 설치를 반환하므로 해당 시스템에는 이 업데이트가 다시 제공되지 않습니다.

**이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에 Microsoft 보안 권고 973472에서 설명한 킬 비트가 포함되어 있습니까? **
아니요, 이 업데이트에는 Office Web Components(OWC) 라이브러리가 Internet Explorer에서 실행되지 않도록 하는 [Microsoft 보안 권고 973472](http://technet.microsoft.com/security/advisory/973472)에서 설명한 킬(kill) 비트가 포함되어 있지 않습니다. 해당 킬 비트를 설정하려면 해당 권고의 대안 섹션에 있는 지침을 따르십시오.

**이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에는 어떤 킬 비트가 포함되어 있습니까?**  
이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에는 이전에 릴리스된 ActiveX 킬(Kill) 비트 보안 업데이트([MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032)) 및 제목이 ActiveX 킬(Kill) 비트용 업데이트 롤업인 권고([Microsoft 보안 권고 953839](http://technet.microsoft.com/security/advisory/953839), [Microsoft 보안 권고 956391](http://technet.microsoft.com/security/advisory/956391), [Microsoft 보안 권고 960715](http://technet.microsoft.com/security/advisory/960715) 및 [Microsoft 보안 권고 969898](http://technet.microsoft.com/security/advisory/969898))의 모든 킬 비트가 포함되어 있습니다.
