...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=f5378e7b-4619-4c42-9d9f-87b209c6d878&displaylang=ko)                                                                         | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c01441da-8933-4f60-923b-d9b00db8ba3d)                                                               | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
...
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=da8dd55d-6630-484e-836c-9feeab5cc311&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=040f8b46-f458-4a72-a1b0-ad8a65a1194c&displaylang=ko)                 | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f8c9390a-5ca1-492a-9e35-a516de48deb5&displaylang=ko)\*     | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b0cfd5e0-6de5-4863-b5e4-b223a0e36d72&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8eaf51cd-2f6e-4bbc-bc4f-9deed03649ac)          | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
...
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25&displaylang=ko)                                                                   | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
...
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945&displaylang=ko)\*                                                    | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
...
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                                                 | 원격 코드 실행 | 긴급        | [MS10-020](https://technet.microsoft.com/security/bulletin/ms10-020) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0654 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)를 참조하십시오.
...
-   **방화벽에서 TCP 포트 138 차단**
    ...
    이 포트는 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 UDP 포트 138을 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템에 대한 공격을 막을 수 있습니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
  
    **대안의 영향.** 컴퓨터 브라우저 서비스에 의존하는 응용 프로그램이 작동하지 않게 됩니다. 여기에는 내 네트워크 환경 및 NET VIEW 명령과 같은 기능이 포함됩니다.
  
    **대안 실행 취소 방법.** 방화벽에서 TCP 포트 138의 차단을 해제합니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당 (영문)](https://go.microsoft.com/fwlink/?linkid=21312)을 참조하십시오.
...
**브라우저 서비스란 무엇입니까?**  
브라우저 서비스는 컴퓨터가 있는 도메인 이름 또는 작업 그룹 이름과 네트워크 세그먼트의 각 컴퓨터에 사용되고 브라우저 서비스를 실행하는 컴퓨터에서 제공하는 프로토콜 목록을 유지 관리합니다. 각 네트워크 세그먼트에서 마스터 브라우저는 브라우저 서비스를 실행하는 세그먼트에 있는 컴퓨터의 그룹에서 선택됩니다. 컴퓨터 브라우저 서비스에 대한 자세한 내용은 [Microsoft 기술 자료 문서 188001](https://support.microsoft.com/kb/188001)을 참고하십시오.
  
**CIFS(Common Internet File System) 브라우저 프로토콜이란 무엇입니까?**  
CIFS 브라우저 프로토콜은 네트워크에서 사용할 수 있는 서비스에 대한 클리어링하우스로 작동하는 서버, 인쇄 또는 파일 공유와 같은 서비스를 네트워크에서 사용할 수 있도록 해 주는 서버 및 특정 서비스의 상세 정보를 요청하는 클라이언트에서 송수신되는 메시지를 정의합니다. CIFS 브라우저 프로토콜의 의미에서 브라우징은 특정 서비스를 제공하는 서버를 검색하는 프로세스입니다. 자세한 내용은 MSDN 문서, [\[MS-BRWS\]: CIFS(Common Internet File System) 브라우저 프로토콜 사양 (영문)](https://msdn.microsoft.com/en-us/library/cc224428(prot.10).aspx)을 참조하십시오.
  
**마스터 브라우저란 무엇입니까?**  
마스터 브라우저는 마스터 브라우저의 네트워크 세그먼트에서 각 서버가 12분마다 데이터그램으로 전송하는 호스트 또는 서버 알림을 수집합니다. 마스터 브라우저는 각 네트워크 세그먼트에 대한 잠재 브라우저가 백업 브라우저가 되도록 지시합니다. 해당 네트워크 세그먼트의 백업 브라우저는 동일 세그먼트에 있는 클라이언트 컴퓨터에 브라우징 목록을 제공합니다. 컴퓨터 브라우저 서비스에 대한 자세한 내용은 [Microsoft 기술 자료 문서 188001](https://support.microsoft.com/kb/188001)을 참고하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2011-0654 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)가 지정되었습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0660 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0660)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2511455">Microsoft 기술 자료 문서 2511455</a> 참조</td>
</tr>
<tr class="even">
