...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS10-078](https://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3)                                                               | 권한 상승      | 중요        | [MS10-078](https://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS10-078](https://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS10-078](https://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de)                                                           | 권한 상승      | 중요        | [MS10-078](https://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f&displaylang=ko)                                         | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30&displaylang=ko)                 | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e&displaylang=ko)\*     | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b)          | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5&displaylang=ko)                                                                     | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92&displaylang=ko)                                                                   | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01&displaylang=ko)\*                                                    | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5)                                                                 | 원격 코드 실행 | 긴급        | [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3956 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3957 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-3959 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959)를 참조하십시오.
...
EOT(Embedded OpenType) 글꼴은 웹 페이지에 사용하도록 설계된 압축 형태의 글꼴로, 문서에 포함될 수 있습니다. 따라서 사용자는 작성자가 의도한 대로 정확히 문서를 보게 됩니다. 웹 작성자는 WEFT(Web Embedding Fonts Tool)를 사용하여 브라우저를 통해 본 페이지가 글꼴 개체에 포함된 스타일로 표시되도록 웹 페이지에 연결된 글꼴 개체를 만들 수 있습니다. 자세한 내용은 MSDN 문서, [글꼴 포함 정보 (영문)](https://msdn.microsoft.com/en-us/library/ms533034.aspx)를 참조하십시오. 영향을 받는 소프트웨어 표에 나열된 운영 체제는 모두 EOT 글꼴 렌더링을 기본적으로 지원합니다.
...
**CMAP 테이블이란 무엇입니까?**    
이 테이블은 문자 코드-글꼴에 사용된 문자 모양 인덱스 값 매핑을 정의합니다. 여기에는 둘 이상의 문자 모양 인코딩 체계를 지원하기 위한 둘 이상의 하위 테이블이 포함될 수 있습니다. 테이블 머리글에는 하위 테이블이 있는 문자 인코딩이 나와 있습니다. 각 하위 테이블은 7가지 서식 중 하나로 존재하며, 사용된 서식을 나타내는 서식 코드로 시작됩니다. 자세한 내용은 [문자-문자 모양 인덱스 매핑 테이블 (영문)](https://www.microsoft.com/typography/otspec/cmap.htm)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2296199">Microsoft 기술 자료 문서 2296199</a> 참조</td>
</tr>
<tr class="even">
...
-   OpenType 글꼴 인덱스 취약점(CVE-2010-3956)을 [Opera Security Team (영문)](https://www.opera.com/security/)과 협력하여 보고해 주신 [Red Hat Security Response Team (영문)](https://www.redhat.com/security/team/)의 Marc Schoenefeld  
