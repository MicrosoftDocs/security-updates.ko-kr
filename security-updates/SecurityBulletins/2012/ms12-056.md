...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1b9a081-0329-4db6-b026-04a332cb0b4d">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 서비스 팩 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=81f5d8a5-12e5-4227-ae6f-5aea6ffff2a5&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=294a7eb4-c47f-449f-8931-262bec7d6ecc&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=47b2e47f-30f1-48e8-a857-70df319011ef">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ece661be-4ddf-42cc-a62b-15ce53b9d74b&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bbb876e6-a6b9-4193-be5e-d84390d30f1e&amp;displaylang=ko">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=97004a96-0c83-421d-91a9-d55be32610c9">JScript 5.8 및 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">낮음</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a>의 KB2510531은 KB2706045로 대체되었습니다.</td>
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2706045](http://support.microsoft.com/kb/2706045)를 참조하십시오.

Server Core 설치가 어떻게 이 공지에서 설명한 취약점의 영향을 받습니까?  
Server Core 설치 옵션을 사용하여 설치한 경우 이 업데이트에서 해결하는 취약점은 지원되는 Windows Server 2008 또는 Windows Server 2008 R2 에디션에 영향을 주지 않습니다. 이 설치 옵션에 대한 자세한 내용은 TechNet 문서, [Server Core 설치 관리](http://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx)(영문) 및 [Server Core 설치 서비스](http://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx)(영문)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008 및 Windows Server 2008 R2의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션에 따른 버전 비교](http://www.microsoft.com/ko-kr/server-cloud/windows-server/2012-editions.aspx)를 참조하십시오.

이 보안 업데이트는 MS12-052와 어떤 관련이 있습니까?  
이 공지에서 설명하는 JavaScript 정수 오버플로 원격 코드 실행 취약점(CVE-2012-2523)은 [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327)를 통해서도 해결됩니다.

시스템에 Internet Explorer 8을 설치한 고객은 CVE-2012-2523에 설명된 취약점으로부터 보호하기 위해 이 공지에서 설명하는 KB2706045 업데이트를 설치해야 합니다.

시스템에 Internet Explorer 9를 설치한 고객은 CVE-2012-2523에 설명된 취약점으로부터 보호하기 위해 [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327)에서 설명하는 KB2722913 업데이트를 설치해야 합니다.
...
JScript란 무엇입니까?  
JScript는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. JScript 스크립트는 ASP(Active Server Pages), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 좀 더 구체적으로 말하자면, JScript는 Microsoft에서 ECMA 262 언어 사양(ECMAScript Edition 3)을 구현한 것입니다. 자세한 내용은 MSDN 문서, [JScript 기본 정보](http://msdn.microsoft.com/en-us/library/6974wx4d(vs.85).aspx)(영문)를 참조하거나 웹 사이트, [ECMA International](http://www.ecma-international.org/)(영문)을 참조하십시오.
  
VBScript란 무엇입니까 ?  
VBScript(Visual Basic 스크립트)는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. VBScript 스크립트는 ASP(Active Server Page), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 자세한 내용은 MSDN 문서, [VBScript 기본 사항](http://msdn.microsoft.com/en-us/library/0ad0dkea(vs.85).aspx)(영문)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2706045">Microsoft 기술 자료 문서 2706045</a> 참조</td>
</tr>
<tr class="even">
