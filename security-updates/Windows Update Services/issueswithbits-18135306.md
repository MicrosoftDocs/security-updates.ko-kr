...
ms:contentKeyID: 18135306
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc720473(v=WS.10)'
---
...
| ![](images/Cc720473.note(WS.10).gif)참고        |
|------------------------------------------------------------------------------|
...
| ![](images/Cc720473.Important(WS.10).gif)중요                                                                                             |  
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
