---
TOCTitle: 'MS13-073'
Title: 'Microsoft 보안 공지 MS13-073 - 중요'
ms:assetid: 'ms13-073'
ms:contentKeyID: 61230623
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms13-073(v=Security.10)'
---

Microsoft 보안 공지 MS13-073 - 중요
===================================
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Excel 2003, Microsoft Excel 2007, Microsoft Excel 2010, Microsoft Excel 2013, Microsoft Excel 2013 RT 및 Microsoft Office for Mac 2011 에디션과 지원 대상인 모든 Microsoft Excel Viewer 및 Microsoft Office 호환 기능 팩 버전에 대해 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft Excel 및 영향을 받는 기타 Microsoft 소프트웨어에서 특수하게 조작된 Office 파일을 구문 분석할 때 데이터의 유효성을 검사하는 방식을 수정하고, Excel에서 사용되는 XML 구문 분석기가 특수하게 조작된 파일 내의 외부 엔터티를 확인하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
| 기술 자료 문서 | [2858300](https://support.microsoft.com/kb/2858300) |
|----------------|-----------------------------------------------------|
| 파일 정보      | 예                                                  |
| SHA1/SHA2 해시 | 예                                                  |
| 알려진 문제점  | 없음                                                |
...
<td style="border:1px solid black;">
[Microsoft Excel 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=56101dde-8221-4b72-9a75-d8cafad566c7&displaylang=ko)  
(2810048)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-076](https://go.microsoft.com/fwlink/?linkid=260964)의 2687481
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Excel 2007 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=15f16e7b-8a94-49bb-8ecc-08dc073cd895&displaylang=ko)<sup>[1]</sup>
(2760583)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-076](https://go.microsoft.com/fwlink/?linkid=260964)의 2687307
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 서비스 팩 1(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=465d3b7b-b76c-4d8a-a262-bc39e0e0f12d&displaylang=ko)  
(2760597)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-076](https://go.microsoft.com/fwlink/?linkid=260964)의 2597126
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 서비스 팩 2(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=465d3b7b-b76c-4d8a-a262-bc39e0e0f12d&displaylang=ko)  
(2760597)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 서비스 팩 1(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=e3129e7c-e075-4e05-ab54-af885a7421d5&displaylang=ko)  
(2760597)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 서비스 팩 2(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=e3129e7c-e075-4e05-ab54-af885a7421d5&displaylang=ko)  
(2760597)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2013(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=7ed643f2-110c-482f-865f-d52b462b9c60&displaylang=ko)  
(2768017)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Excel 2013(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=286789e8-a717-427b-9a9c-b6f6cda6cfdc&displaylang=ko)  
(2768017)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS13-051](https://go.microsoft.com/fwlink/?linkid=296303)의 2848689
</td>
</tr>
<tr>
<th colspan="5">
...
<tr>
<td style="border:1px solid black;">
[Microsoft Excel Viewer](https://www.microsoft.com/download/details.aspx?familyid=9eb46e28-b854-4cf7-824c-b1ffe533ecc1&displaylang=ko)<sup>[3]</sup>
(2760590)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<td style="border:1px solid black;">
[MS12-076](https://go.microsoft.com/fwlink/?linkid=260964)의 2687313
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 호환 기능 팩 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=3a9ebaa6-2594-43ee-bb9c-64375b026ab6&displaylang=ko)  
(2760588)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<td style="border:1px solid black;">
[MS12-076](https://go.microsoft.com/fwlink/?linkid=260964)의 2687311
</td>
</tr>
</table>
 
<sup>[1]</sup>Microsoft Office Excel 2007을 사용하는 고객의 경우 이 공지에서 설명한 취약점으로부터 보호하기 위해 보안 업데이트 패키지 2760583 이외에도 Microsoft Office 호환 기능 팩용 보안 업데이트(2760588)를 설치해야 합니다.

<sup>[2]</sup>이 업데이트는 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)를 통해 제공됩니다.

<sup>[3]</sup>이 업데이트를 설치하기 전에 Microsoft Excel Viewer를 지원되는 서비스 팩 수준(Excel Viewer 2007 서비스 팩 3)으로 업데이트해야 합니다. 지원되는 Office 뷰어에 대한 자세한 내용은 [Microsoft 기술 자료 문서 979860](https://support.microsoft.com/kb/979860)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-1315](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1315)(영문)를 참조하십시오.
...
취약점의 원인은 무엇입니까?  
이 취약점은 영향을 받는 Microsoft Excel 및 영향을 받는 기타 Microsoft Office 소프트웨어에서 특수하게 조작된 Office 파일을 구문 분석할 때 메모리의 개체를 올바르게 처리하지 못하는 경우 발생합니다.
...
이 취약점을 악용하려면 사용자가 특수하게 조작된 Office 파일을 영향을 받는 Microsoft Excel 버전 또는 영향을 받는 기타 Microsoft Office 소프트웨어로 열어야 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-3158](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3158)(영문)을 참조하십시오.
...
<span></span>
Microsoft Excel에서 외부 엔터티를 포함하는 특수하게 조작된 XML 파일을 구문 분석하는 방식에 정보 유출 취약점이 존재합니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-3159](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3159)(영문)를 참조하십시오.
...
취약점의 원인은 무엇입니까?  
Microsoft Excel이 다른 XML 외부 엔터티 선언 내에서 확인되는 XML 외부 엔터티를 잘못 처리하기 때문에 취약점이 발생합니다.
...
전자 메일을 통한 공격의 경우 공격자는 특수하게 조작된 파일을 사용자에게 보내고 영향을 받는 Microsoft Excel 버전에서 파일을 열도록 유도하는 방식으로 이 취약점을 악용할 수 있습니다.

웹을 통한 공격의 경우 공격자는 이 취약점 악용 시도에 사용되는 파일을 포함한 웹 사이트를 호스팅해야 합니다. 또한 사용자가 제공한 콘텐츠를 허용하거나 호스팅하는 공격 당한 웹 사이트에는 이 취약점을 악용할 수 있는 특수하게 조작된 콘텐츠가 포함되어 있을 수 있습니다. 공격자는 강제로 사용자가 특수하게 조작된 웹 사이트를 방문하도록 만들 수 없습니다. 대신 공격자는 사용자가 웹 사이트를 방문하도록 유도해야 하는데, 일반적으로 사용자를 공격자의 웹 사이트로 유인하는 전자 메일 메시지 또는 인스턴트 메신저 메시지에 포함된 링크를 클릭하도록 하는 방법을 사용합니다. 그 후 공격자는 사용자가 영향을 받는 Microsoft Excel 버전에서 특수하게 조작된 파일을 열도록 유도합니다.

취약점으로 인해 주로 공격 받을 위험이 있는 시스템은 무엇입니까?  
이 취약점을 이용하여 악의적인 동작이 발생하려면 사용자가 영향을 받는 응용 프로그램으로 특수하게 조작된 파일을 열어야 합니다. 그러므로 워크스테이션이나 터미널 서버와 같이 Excel 파일을 자주 보는 시스템이 이 취약점으로 인해 가장 위험할 수 있습니다.

업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 Excel에서 사용되는 XML 구문 분석기가 특수하게 조작된 파일 내의 외부 엔터티를 확인하는 방식을 수정하여 취약점을 해결합니다.
...
Microsoft Office for Mac의 경우 Microsoft AutoUpdate for Mac을 통해 Microsoft 소프트웨어를 최신으로 유지할 수 있습니다. 자세한 정보를 보려면 [자동으로 Office for Mac 업데이트 확인](https://go.microsoft.com/fwlink/?linkid=307130)을 참조하십시오.
...
office2003-kb2810048-fullfile-enu.exe</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2810048">Microsoft 기술 자료 문서 2810048</a> 참조</td>
</tr>
<tr class="even">
...
#### Microsoft Excel 2007(모든 에디션), Excel Viewer, Office 호환 기능 팩
...
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;">Microsoft Office 2007 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/2760583">Microsoft 기술 자료 문서 2760583</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer:<br />
<a href="https://support.microsoft.com/kb/2760590">Microsoft 기술 자료 문서 2760590</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 호환 기능 팩 서비스 팩 3:<br />
<a href="https://support.microsoft.com/kb/2760588">Microsoft 기술 자료 문서 2760588</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">보안 업데이트 파일 이름</td>
<td style="border:1px solid black;">지원 대상인 모든 Microsoft Excel 2010(32비트 에디션) 에디션:<br />
excel2010-kb2760597-fullfile-x86-glb.exe</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Microsoft Excel 2010(64비트 에디션) 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2760597">Microsoft 기술 자료 문서 2760597</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">보안 업데이트 파일 이름</td>
<td style="border:1px solid black;">지원 대상인 모든 Microsoft Excel 2013(32비트 에디션) 에디션:<br />
excelloc2013-kb2768017-fullfile-x86-glb.exe</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Microsoft Excel 2013(64비트 에디션) 에디션:<br />
...
<tr class="even">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2768017">Microsoft 기술 자료 문서 2768017</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office for Mac 2011 14.3.7 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=3445fbdc-e092-4530-bf31-d60cecd53ab8)에서 다운로드하여 설치하십시오.
  
-   설치를 방해할 수 있으므로 바이러스 예방 응용 프로그램 및 모든 Microsoft Office 응용 프로그램을 포함하여 실행 중인 응용 프로그램을 모두 종료합니다.  
-   바탕 화면에서 Microsoft Office for Mac 2011 14.3.7 업데이트 볼륨을 엽니다. 이 단계가 자동으로 수행되었을 수도 있습니다.  
-   업데이트 과정을 시작하려면 Microsoft Office for Mac 2011 14.3.7 업데이트 볼륨 창에서 Microsoft Office for Mac 2011 14.3.7 업데이트 응용 프로그램을 두 번 클릭하고 화면의 지침을 따릅니다.  
-   설치가 성공적으로 완료되면 하드 디스크에서 업데이트 설치 프로그램을 제거할 수 있습니다. 설치가 성공적으로 완료되었는지 확인하려면 다음 "업데이트 설치 확인"을 참조하십시오. 업데이트 설치 프로그램을 제거하려면 먼저 Microsoft Office for Mac 2011 14.3.7 업데이트 볼륨을 휴지통에 끌어 놓은 다음 다운로드한 파일을 휴지통에 끌어 놓습니다.
...
설치된 최신 업데이트 버전 번호가 14.3.7이면 업데이트가 성공적으로 설치된 것입니다.
...
-   Microsoft Office 메모리 손상 취약점(CVE-2013-1315)을 보고해 주신 [CERT/CC](https://www.cert.org/)(영문)의 Will Dormann  
-   Microsoft Office 메모리 손상 취약점(CVE-2013-3158)을 보고해 주신 [CERT/CC](https://www.cert.org/)(영문)의 Will Dormann  
-   XML 외부 엔터티 확인 취약점(CVE-2013-3159)을 보고해 주신 [Positive Technologies](https://www.ptsecurity.com/)(영문)의 Timur Yunusov, Alexey Osipov 및 Ilya Karpov
...
-   V1.1(2013년 9월 14일): Microsoft Excel 2003 업데이트(2810048), Microsoft Excel 2007 업데이트(2760583), Microsoft Excel Viewer 업데이트(2760590) 및 Microsoft Office 호환 기능 팩 업데이트(2760588)에 대한 검색 변경 사항을 알리기 위해 공지가 개정되었습니다. 이 변경 사항은 검색 변경 사항에만 해당됩니다. 업데이트 파일에 대한 변경 사항은 없습니다. 이 업데이트를 성공적으로 설치한 고객은 조치를 취할 필요가 없습니다. 기술 자료 문서 섹션의 알려진 문제점 항목이 "예"에서 "없음"으로 업데이트되었습니다.
