---
TOCTitle: 'MS10-073'
Title: 'Microsoft 보안 공지 MS10-073 - 중요'
ms:assetid: 'ms10-073'
ms:contentKeyID: 61230334
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-073(v=Security.10)'
---
...
이 보안 업데이트는 Windows 커널 모드 드라이버의 공개된 여러 취약점을 해결합니다. 가장 위험한 취약점으로 인해 공격자가 영향을 받는 시스템에 로그온하여 특수하게 조작한 응용 프로그램을 실행할 경우 권한 상승이 허용될 수 있습니다. 이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

보안 업데이트는 Windows 커널 모드 드라이버가 개체에 대한 참조 수를 유지하는 방식, 디스크에서 키보드 레이아웃을 로드할 때 함수 포인터의 테이블을 인덱스화하는 방식 및 창 클래스 데이터의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2)                                                               | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf)                                                           | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f&displaylang=ko)                                         | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db&displaylang=ko)                 | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763&displaylang=ko)\*     | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd)          | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602&displaylang=ko)                                                                     | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad&displaylang=ko)                                                                   | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5&displaylang=ko)\*                                                    | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3)                                                                 | 권한 상승      | 중요        | [MS10-048](https://technet.microsoft.com/security/bulletin/ms10-048) |
...
<th style="border:1px solid black;" >Win32k 참조 수 취약점(CVE-2010-2549)</th>
<th style="border:1px solid black;" >Win32k 키보드 레이아웃 취약점(CVE-2010-2743)</th>
<th style="border:1px solid black;" >Win32k 창 클래스 취약점(CVE-2010-2744)</th>
...
Windows 커널 모드 드라이버가 개체에 대한 참조 수를 유지하는 방식 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2549 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549)를 참조하십시오.
  
#### Win32k 참조 수 취약점(CVE-2010-2549)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 참조 수 취약점(CVE-2010-2549)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 참조 수 취약점(CVE-2010-2549)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 개체에 대한 참조 수를 적절히 유지하지 않아 취약점이 발생합니다.
...
**참조 수란 무엇입니까?**    
참조 수는 개체 관리자가 운영 체제 프로세스에 넘겨준 개체 포인터 수에 대한 레코드입니다. 개체 관리자는 포인터를 개체에 넘겨줄 때마다 개체에 대한 참조 수를 늘립니다. 커널 모드 구성 요소가 포인터 사용을 마치면 개체 관리자를 호출하여 개체의 참조 수를 줄이도록 합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 개체에 대한 참조 수를 유지하는 방식을 수정하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2549 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549)가 지정되었습니다.
...
Windows 커널 모드 드라이버가 특정 키보드 레이아웃을 로드하는 방식 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2743 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743)을 참조하십시오.
  
#### Win32k 키보드 레이아웃 취약점(CVE-2010-2743)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 키보드 레이아웃 취약점(CVE-2010-2743)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 키보드 레이아웃 취약점(CVE-2010-2743)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 디스크에서 키보드 레이아웃을 로드할 때 함수 포인터의 테이블을 적절히 인덱스화하지 않아 취약점이 발생합니다.
  
**이 취약점의 심각도가 지원 대상인 모든 Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 및 Windows Server 2008 R2 에디션에 대해 낮음인 이유는 무엇입니까?**    
이러한 Windows 릴리스의 경우, 이 취약점과 관련된 코드가 존재하지만 공격자가 이 코드에 접근할 수 있는 알려진 방법이 없습니다. 하지만 이 업데이트는 향후 이 코드를 악용하여 권한을 상승시킬 수 있는 방법을 찾을 경우를 대비한 심층 보안 대응책으로 이 코드의 취약점을 해결합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 디스크에서 키보드 레이아웃을 로드할 때 함수 포인터의 테이블을 인덱스화하는 방식을 수정하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2743 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743)이 지정되었습니다.
  
**이 보안 공지를 게시했을 때 Microsoft는 이 취약점이 악용되었다는 보고를 받았습니까?**    
예. 이 공지가 출시되었을 때 이 취약점은 맬웨어에 의해 제한적으로 악용되고 있었습니다.
  
Win32k 창 클래스 취약점(CVE-2010-2744)  
--------------------------------------
  

Windows 커널 모드 드라이버가 창 클래스 데이터의 유효성을 적절히 검사하지 않기 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-2744 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744)를 참조하십시오.
  
#### Win32k 창 클래스 취약점(CVE-2010-2744)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 창 클래스 취약점(CVE-2010-2744)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 창 클래스 취약점(CVE-2010-2744)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 창 클래스를 적절히 관리하지 않아 이 취약점이 발생합니다.
...
**창 클래스란 무엇입니까?**    
창 클래스는 시스템에서 창을 만들기 위한 템플릿으로 사용하는 특성 모음입니다. 모든 창은 창 클래스의 구성원입니다. 모든 창 클래스는 프로세스를 따릅니다. 창 클래스의 유형에는 세 가지가 있습니다. 시스템 클래스는 시스템에서 등록하는 창 클래스입니다. 모든 프로세스에서 많은 시스템 클래스를 사용할 수 있지만, 일부는 시스템에서 내부적으로만 사용됩니다. 시스템에서 이러한 클래스를 등록하기 때문에 프로세스는 삭제할 수 없습니다. 응용 프로그램 전역 클래스는 프로세스의 다른 모든 모듈에서 사용할 수 있는 실행 파일이나 DLL에서 등록하는 창 클래스입니다. 응용 프로그램 로컬 클래스는 실행 파일이나 .dll에서 독점적인 사용을 위해 등록하는 창 클래스입니다. 로컬 클래스를 원하는 만큼 등록할 수 있지만 대개 하나만 등록합니다. 이 창 클래스는 응용 프로그램 기본 창의 창 프로시저를 지원합니다. 창 클래스에 대한 자세한 내용은 MSDN 문서, [창 클래스(영문)](https://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx)를 참조하십시오.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 창 클래스 데이터의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-2744 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744)가 지정되었습니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB981957$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/981957">Microsoft 기술 자료 문서 981957</a> 참조</td>
</tr>
<tr class="even">
...
-   Win32k 키보드 레이아웃 취약점(CVE-2010-2743)을 보고해 주신 [Kaspersky Lab](https://www.kaspersky.com)의 Sergey Golovanov, Alexander Gostev, Maxim Golovkin 및 Alexey Monastyrsky와 [Design and Test Lab](https://www.dnt-lab.com)의 Vitaly Kiktenko 및 Alexander Saprykin  
-   Win32k 키보드 레이아웃 취약점(CVE-2010-2743)을 보고해 주신 [Symantec](https://www.symantec.com/index.jsp)의 Joji Hamada  
-   Win32k 창 클래스 취약점(CVE-2010-2744)을 해결하기 위해 협력해 주신 [Norman](https://www.norman.com)의 Tarjei Mandt
