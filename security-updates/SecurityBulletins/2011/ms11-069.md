---
TOCTitle: 'MS11-069'
Title: 'Microsoft 보안 공지 MS11-069 - 보통'
ms:assetid: 'ms11-069'
ms:contentKeyID: 61230436
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-069(v=Security.10)'
---



Microsoft 보안 공지 MS11-069 - 보통
===================================

NET. Framework의 취약점으로 인한 정보 유출 문제점(2567951)
----------------------------------------------------------
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션에서 Microsoft .NET Framework 2.0 서비스 팩 2, Microsoft .NET Framework 3.5.1 및 Microsoft .NET Framework 4에 대해 보통입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 .NET Framework가 System.Net.Sockets 네임스페이스 내에서 신뢰 수준의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2567951](https://support.microsoft.com/kb/2567951)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=14fdbaa4-b42b-499c-819f-bb239b48a4cc&displaylang=ko)  
(KB2539631)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=e2069b12-d78b-420c-84b7-46bba12827c8&displaylang=ko)<sup>[1]</sup>
(KB2539636)
</td>
<td style="border:1px solid black;">
정보 유출
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2f7348c0-a036-4d86-b7bb-bd6810cdc834&displaylang=ko)  
(KB2539633)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=e2069b12-d78b-420c-84b7-46bba12827c8&displaylang=ko)<sup>[1]</sup>
(KB2539636)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/download/details.aspx?familyid=b8c628c6-5dcc-4c8f-b379-e2249a44f12c&displaylang=ko)  
(KB2539634)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=e2069b12-d78b-420c-84b7-46bba12827c8&displaylang=ko)<sup>[1]</sup>
(KB2539636)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/download/details.aspx?familyid=e1f84749-77bb-42bf-a539-fb647cacff8b&displaylang=ko)  
(KB2539635)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=e2069b12-d78b-420c-84b7-46bba12827c8&displaylang=ko)<sup>[1]</sup>
(KB2539636)
</td>
...
이 공지가 2011년 8월 23일에 개정된 이유는 무엇입니까?  
Microsoft는 패키지 메타데이터의 검색 변경 사항을 알리기 위해, 설치 반환 코드의 문제를 수정하는 KB2539636의 보안 공지를 개정하였습니다. 이 변경 사항은 검색에만 해당됩니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.

파일 정보 세부 사항은 어디에 있습니까?  
파일 정보 세부 사항의 위치에 대해서는 보안 업데이트 배포 섹션에서 참조 표를 참조하십시오.

설치 되어 있는 Microsoft .NET Framework의 버전은 어떻게 알 수 있습니까?  
...
.NET Framework 3.5 서비스 팩 1을 설치했습니다. 추가 업데이트 를 설치해야 합니까?  
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [8월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-aug)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/en-us/security/cc998259.aspx)를 참조하십시오.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용)에 설치된 Microsoft .NET Framework 4<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
보통   
정보 유출
...
System.Net.Sockets 네임스페이스 내의 신뢰 수준에 대한 .NET Framework의 부적절한 유효성 평가 방식에 정보 유출 취약점이 있습니다. 이 취약점을 성공적으로 악용한 공격자는 사용자가 노출하지 않으려는 정보에 액세스할 수 있습니다. 또한 이 취약점은 공격자가 피해자의 시스템에서 피해자가 액세스할 수 있는 다른 네트워크 리소스로 네트워크 트래픽을 보내도록 하는 데 악용될 수 있습니다. 이로 인해 공격자는 피해자 시스템에서 액세스할 수 있는 모든 시스템에 대해 서비스 공격을 수행하거나 피해자 시스템을 사용하여 피해자가 사용할 수 있는 네트워크 리소스를 검색할 수 있습니다. 이 취약점으로 인해 공격자가 직접 코드를 실행하거나 해당 사용자 권한을 상승시킬 수는 없지만 영향을 받는 시스템의 손상을 악화시키는 데 사용할 수 있는 정보를 생성할 수 있습니다.

이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1978(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978)을 참조하십시오.

#### 소켓 제한 우회 취약점(CVE-2011-1978)에 대한 완화 요소
...
-   기본적으로 Windows Server 2003, Windows Server 2008 및 Windows Server 2008 R2의 Internet Explorer는 보안 강화 구성으로 알려진 제한된 모드로 실행됩니다. 이 모드는 Windows Server 2008 및 Windows Server 2008 R2의 웹 기반 공격 시나리오에서만 이 취약점을 완화합니다. [Internet Explorer 보안 강화(영문)](https://go.microsoft.com/fwlink/?linkid=92039) 구성에 대한 자세한 내용은 이 취약점의 FAQ 섹션을 참조하십시오.
...
-   [KB2562394](https://support.microsoft.com/kb/2562394)를 설치한 고객은 사용자 조작 없이 악용될 수 없습니다.
-   [MS11-044](https://technet.microsoft.com/security/bulletin/ms11-044)를 통해 사용할 수 있는 이 업데이트는 인터넷 영역의 ClickOnce 응용 프로그램이 사용자의 확인 없이 실행되지 못하게 합니다.
-   [KB2562394](https://support.microsoft.com/kb/2562394)를 설치하지 않은 고객에게는 이 응용 프로그램이 인터넷 전용 권한 수준만 사용하는 경우 확인 대화 상자가 표시되지 않습니다. 이 기능에 대한 자세한 내용은 [KB2562394](https://support.microsoft.com/kb/2562394)를 참조하십시오.

#### 소켓 제한 우회 취약점(CVE-2011-1978)에 대한 대안
...
-   Internet Explorer에서 XAML 브라우저 응용 프로그램 사용 안 함
    ...
    2.  보안 설정을 지정할 웹 콘텐츠 영역 을 선택하십시오 상자에서 신뢰할 수 있는 사이트를 누른 다음 사이트를 누릅니다.
...
#### 소켓 제한 우회 취약점(CVE-2011-1978)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이는 정보 유출 취약점입니다. 이 취약점을 성공적으로 악용한 공격자는 사용자가 노출하지 않으려는 정보에 액세스할 수 있습니다. 또한 이 취약점은 공격자가 피해자의 시스템에서 피해자가 액세스할 수 있는 다른 네트워크 리소스로 네트워크 트래픽을 보내도록 하는 데 악용될 수 있습니다. 이로 인해 공격자는 피해자 시스템에서 액세스할 수 있는 모든 시스템에 대해 서비스 공격을 수행하거나 피해자 시스템을 사용하여 피해자가 사용할 수 있는 네트워크 리소스를 검색할 수 있습니다.

취약점의 원인은 무엇입니까?  
이 취약점은 .NET Framework가 System.Net.Sockets 네임스페이스 내의 신뢰 수준에 대해 제대로 유효성을 검사하지 못할 때 발생합니다.

System.Net.Sockets 네임스페이스란 무엇입니까?  
.NET Framework 내의 System.Net.Sockets 네임스페이스는 네트워크에 대한 액세스를 강력하게 제어해야 하는 개발자를 위한 관리되는 Winsock(Windows 소켓) 인터페이스 구현입니다. 자세한 내용은 MSDN 문서 [System.Net.Sockets 네임스페이스](https://msdn.microsoft.com/en-us/library/sb27wehh.aspx)를 참조하십시오.
...
이 취약점을 성공적으로 악용한 공격자는 사용자가 노출하지 않으려는 정보에 액세스할 수 있습니다. 또한 이 취약점은 공격자가 피해자의 시스템에서 피해자가 액세스할 수 있는 다른 네트워크 리소스로 네트워크 트래픽을 보내도록 하는 데 악용될 수 있습니다. 이로 인해 공격자는 피해자 시스템에서 액세스할 수 있는 모든 시스템에 대해 서비스 공격을 수행하거나 피해자 시스템을 사용하여 피해자가 사용할 수 있는 네트워크 리소스를 검색할 수 있습니다. 이 취약점으로 인해 공격자가 직접 코드를 실행하거나 해당 사용자 권한을 상승시킬 수는 없지만 영향을 받는 시스템의 손상을 악화시키는 데 사용할 수 있는 정보를 생성할 수 있습니다.
...
취약점으로 인 해 위험에 노출되는 시스템은 주로 무엇입니까?  
...
업데이트는 어떤 기능을 수행합니까?  
이 업데이트는 .NET Framework가 System.Net.Sockets 네임스페이스 내에서 신뢰 수준의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
...
SMS 2003의 경우 SMS 2003 Inventory Tool for Microsoft Updates(ITMU)를 사용하여 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)에서 제공하고 [Windows Server Update Services(영문)](https://go.microsoft.com/fwlink/?linkid=50120)에서 지원하는 보안 업데이트를 검색할 수 있습니다. SMS 2003 ITMU에 대한 자세한 내용은 [Microsoft Updates용 SMS 2003 Inventory Tool(영문)](https://technet.microsoft.com/ko-kr/sms/bb676783.aspx)을 참조하십시오. SMS 검사 도구에 대한 자세한 내용은 [SMS 2003 Software Update Scanning Tools(영문)](https://technet.microsoft.com/en-us/sms/bb676786.aspx)를 참조하십시오. [Systems Management Server 2003용 다운로드(영문)](https://technet.microsoft.com/ko-kr/sms/bb676766.aspx)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2567951">Microsoft 기술 자료 문서 2567951</a> 참조</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">  </td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2의 Microsoft .NET Framework 2.0 서비스 팩 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 2.0 Service Pack 2\SP2\KB2539631<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">  </td>
<td style="border:1px solid black;">x64 기반 시스템의 Microsoft .NET Framework 4:<br />
...
이 보안 업데이트는 Microsoft .NET Framework 3.5에 대해 다음 설치 스위치를 지원합니다.
...
이 보안 업데이트는 Microsoft .NET Framework 2.0 서비스 팩 2 및 Microsoft .NET Framework 4 제거를 위해 다음 설치 스위치를 지원합니다.
...
이 보안 업데이트는 Microsoft .NET Framework 3.5 제거를 위해 다음 설치 스위치를 지원합니다.
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">32비트 시스템의 Microsoft .NET Framework 4:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2539636<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">x64 기반 시스템 및 Itanium 기반 시스템의 Microsoft .NET Framework 4:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2539636<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
Microsoft .NET Framework 2.0 서비스 팩 2 및 Microsoft .NET Framework 3.5 보안 업데이트는 다음 설치 스위치를 지원합니다.
...
Microsoft .NET Framework 4 보안 업데이트는 다음 설치 스위치를 지원합니다.
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1에 설치된 Microsoft .NET Framework 4:<br />
NDP40-KB2539636-ia64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
...
-   소켓 제한 우회 취약점(CVE-2011-1978)을 보고해 주신 Michael J. Liu
...
-   V1.1(2011년 8월 23일): 설치 문제를 수정하는 KB2539636의 검색 변경 사항을 알리기 위해 업데이트 FAQ가 추가되었습니다. 이 변경 사항은 검색에만 해당됩니다. 보안 업데이트 파일에 대한 변경 사항은 없습니다. 이미 시스템을 성공적으로 업데이트한 고객은 추가 조치를 취할 필요가 없습니다.  
-   V1.2(2011년 10월 27일): Windows Server 2008 R2(x64 기반 시스템용)의 .NET Framework 4에 대한 Server Core 설치 적용 가능성이 수정되었습니다.
