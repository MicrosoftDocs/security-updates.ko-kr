...
ms:contentKeyID: 21743413
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Dd939818(v=WS.10)'
---
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Uninstalling Windows 내부 데이터베이스 is not recommended, because it may affect other applications that may be using the same database instance (such as Windows SharePoint Services).
</td>
</tr>
</tbody>
</table>
