---
TOCTitle: 'MS10-029'
Title: 'Microsoft 보안 공지 MS10-029 - 보통'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61230290
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-029(v=Security.10)'
---



Microsoft 보안 공지 MS10-029 - 보통
===================================
...
이 보안 업데이트는 비공개적으로 보고된 Microsoft Windows의 취약점 1건을 해결합니다. 이 보안 업데이트의 심각도는 Windows XP, Windows Server 2003, Windows Vista 및 Windows Server 2008에 대해 보통입니다. Windows 7 및 Windows Server 2008 R2에는 이 보안 업데이트에 의해 배포되는 기능이 포함되어 있지 않으므로 취약하지 않습니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 취약점으로 인해 공격자가 IPv4 주소를 스푸핑하여 소스 IPv4 주소를 사용하는 필터링 장치를 우회할 수 있습니다. 이 보안 업데이트는 Windows TCP/IP 스택이 터널링된 ISATAP 패킷에서 소스 IPv6 주소를 확인하는 방식을 변경하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613&displaylang=ko)                                                          | 스푸핑         | 보통        | 없음                                                                |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                                          | 스푸핑         | 보통        | 없음                                                                |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477&displaylang=ko)                                                                           | 스푸핑         | 보통        | 없음                                                                |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb&displaylang=ko)                                                               | 스푸핑         | 보통        | 없음                                                                |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                                           | 스푸핑         | 보통        | 없음                                                                |
| [Windows Vista, Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176&displaylang=ko)                                     | 스푸핑         | 보통        | [MS10-009](https://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36&displaylang=ko) | 스푸핑         | 보통        | [MS10-009](https://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be&displaylang=ko)\*                | 스푸핑         | 보통        | [MS10-009](https://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84&displaylang=ko)\*            | 스푸핑         | 보통        | [MS10-009](https://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842)                     | 스푸핑         | 보통        | [MS10-009](https://technet.microsoft.com/security/bulletin/ms10-009) |

**\*Server Core 설치가 영향을 받습니다.** 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 MSDN 문서, [Server Cor (영문)e](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교](https://www.microsoft.com/windowsserver2008/ko/kr/compare-core-installation.aspx)를 참조하십시오.
...
이 보안 업데이트는 새로운 두 보안 기능을 구현합니다.

-   **ISATAP 클라이언트의 PRL(Potential Router List):** PRL은 클라이언트가 들어오는 ISATAP 터널링 패킷에 대해 소스 주소 확인을 수행할 수 있도록 해줍니다. PRL은 이 보안 업데이트를 설치할 때 기본적으로 사용되며 CVE-2010-0812에 설명된 ISATAP IPv6 소스 주소 스푸핑 취약점을 해결하는 데 도움이 됩니다. PRL에 대한 자세한 내용은 [Microsoft 기술 자료 문서 978338](https://support.microsoft.com/kb/978338)을 참조하십시오.
-   **ISATAP 인터페이스의 NUD(Neighbor Unreachability Detection):** NUD는 인접 노드에 연결할 수 있는지 여부를 검증하는 데 사용됩니다. NUD는 ISATAP 패킷을 전달하기 전에 ISATAP 노드에 의해 수행됩니다. NUD는 기본적으로 사용되지 않으며 네트워크 관리자가 수동으로 구성해야 합니다. NUD에 대한 자세한 내용과 사용하는 방법은 [Microsoft 기술 자료 문서 978338](https://support.microsoft.com/kb/978338)을 참조하십시오.

**Microsoft Windows 2000이 이 취약점의 영향을 받지 않는 이유는 무엇입니까?**  
Microsoft Windows 2000 운영 체제는 IPv6에 대한 지원을 포함하고 있지 않기 때문에 취약하지 않습니다.

**Windows 7 및 Windows Server 2008 R2가 이 취약점의 영향을 받지 않는 이유는 무엇입니까?**  
Windows 7 및 Windows Server 2008 R2에는 이 보안 업데이트에 의해 배포되는 기능인 PRL(Potential Router List)과 NUD(Neighbor Unreachability Detection)가 이미 있습니다.

**참고** PRL은 이들 플랫폼에서 기본적으로 사용되지만, NUD는 그렇지 않으며 네트워크 관리자가 수동으로 구성해야 합니다. 이 기능에 대한 자세한 내용은 [Microsoft 기술 자료 문서 978338](https://support.microsoft.com/kb/978338)을 참조하십시오.

**IPv6을 사용하지 않는 경우에도 이 업데이트가 제공됩니까?**  
예, 이들 시스템 안에 취약한 코드가 존재하기 때문에 이 보안 업데이트는 자동 업데이트를 통해 제공됩니다. 향후 IPv6를 배포할 계획이면 보안 업데이트를 설치하는 것이 좋습니다.
...
<th style="border:1px solid black;" >ISATAP IPv6 소스 주소 스푸핑 취약점(CVE-2010-0812)</th>
...
**\*Server Core 설치가 영향을 받습니다.** 이 업데이트는 Server Core 설치 옵션의 사용 여부에 관계없이 동일한 심각도로 지원 대상인 Windows Server 2008 에디션에 적용됩니다. 이 설치 옵션에 대한 자세한 내용은 MSDN 문서, [Server Core (영문)](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)를 참조하십시오. 참고: Server Core 설치 옵션은 Windows Server 2008의 특정 에디션에 적용되지 않습니다. [Server Core 설치 옵션 비교](https://www.microsoft.com/windowsserver2008/ko/kr/compare-core-installation.aspx)를 참조하십시오.
  
ISATAP IPv6 소스 주소 스푸핑 취약점(CVE-2010-0812)  
--------------------------------------------------
  

Windows가 터널링된 ISATAP 패킷에서 내부 패킷의 IPv6 소스 주소를 확인하는 방식으로 인해 Microsoft Windows IPv6 스택에 스푸핑 취약점이 존재합니다. 취약점 악용에 성공한 공격자는 주소를 가장하여 에지 또는 호스트 방화벽을 우회할 수 있습니다. 또한 대상 컴퓨터가 공격자가 스푸핑한 소스 IPv6 주소를 사용하여 메시지에 회신하는 경우 정보가 노출될 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0812 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812)를 참조하십시오.
  
#### ISATAP IPv6 소스 주소 스푸핑 취약점(CVE-2010-0812)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점은 ISATAP 인터페이스가 구성된 Windows 시스템에만 영향을 줍니다.
  
#### ISATAP IPv6 소스 주소 스푸핑 취약점(CVE-2010-0812)에 대한 대안
...
-   **ISATAP IPv6 인터페이스 사용 안 함**
  
    ISATAP IPv6 인터페이스를 사용하지 않도록 설정하려면 상승된 권한의 명령 프롬프트에 다음 명령을 실행합니다.
  
    `netsh interface isatap set state disabled`
  
    **참고** 이 대안을 완료하려면 관리자로 로그인하거나 관리 자격 증명이 있어야 합니다.
  
    **대안의 영향.** ISATAP 인터페이스를 사용하지 않도록 설정하면 시스템이 ISATAP를 IPv6 터널링 메커니즘으로 사용할 수 없게 됩니다.
  
    **대안 실행 취소 방법.**
  
    ISATAP IPv6 인터페이스를 사용하도록 다시 설정하려면 상승된 권한의 명령 프롬프트에 다음 명령을 실행합니다.
  
    `netsh interface isatap set state enabled`
  
    **참고** 이 대안의 실행을 취소하려면 관리자로 로그인하거나 관리 자격 증명이 있어야 합니다.
  
#### ISATAP IPv6 소스 주소 스푸핑 취약점(CVE-2010-0812)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 스푸핑 취약점입니다. 이 취약점으로 인해 공격자가 IPv4 주소를 스푸핑하여 소스 IPv4 주소를 사용하는 필터링 장치를 우회할 수 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows TCP/IP 스택이 터널링된 ISATAP 패킷에서 소스 IPv6 주소를 올바르게 확인하지 못하기 때문에 취약점이 존재합니다.
  
**ISATAP란 무엇입니까?**    
ISATAP(Intra-Site Automatic Tunnel Addressing Protocol)는 IPv4 인트라넷 내에서 IPv6 연결을 제공합니다. ISATAP에 대한 자세한 내용은 [RFC5214: ISATAP(Intra-Site Automatic Tunnel Addressing Protocol) (영문)](https://www.ietf.org/rfc/rfc5214.txt)을 참조하십시오.
  
**공격자는 취약점을 악용하여 무엇을 할 수 있습니까?**    
공격자는 다른 사용자 또는 시스템을 가장하여 에지 또는 호스트 방화벽과 같은 소스 주소 필터를 우회할 수 있습니다.
  
**공격자는 이러한 취약점을 어떻게 악용합니까?**    
공격자는 해당하는 IPv4 소스 주소와 일치하지 않는 ISATAP 연결에서 특수하게 조작된 IPv6 소스 주소로 특수하게 조작된 네트워크 패킷을 만들어 취약점을 악용할 수 있습니다.
  
**취약점으로 인해 주로 공격받을 위험이 있는 시스템은 무엇입니까?**    
IPv6 ISATAP 기능을 사용하는 모든 운영 체제가 이 취약점으로 인한 위험에 노출됩니다.
  
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows TCP/IP 스택이 터널링된 ISATAP 패킷에서 소스 IPv6 주소를 확인하는 방식을 변경하여 이 취약점을 해결합니다.
...
WindowsXP-KB978338-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB978338-x64-kor /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3:<br />
WindowsXP-KB978338-x86-kor /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 서비스 팩 2:<br />
WindowsServer2003.WindowsXP-KB978338-x64-kor /norestart</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB978338$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/978338">Microsoft 기술 자료 문서 978338</a> 참조</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB978338-x86-kor /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">다시 시작하지 않고 설치</td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 32비트 에디션:<br />
WindowsServer2003-KB978338-x86-kor /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">지원 대상인 모든 Windows Server 2003 x64 기반 에디션:<br />
...
ISATAP IPv6 소스 주소 스푸핑 취약점(CVE-2010-0812)을 보고해 주신 National EW Research & Simulation Center(Rafael 소재)의 Gabi Nakibly
...
-   V1.1(2010년 4월 22일): 모든 Windows Vista 및 Windows Server 2008 업데이트 패키지에 대한 공지 교체 정보가 수정되었습니다.
