...
|------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|----------------|-------------|-----------------------------------------------------------|
| Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1                                       | [JScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=54a64215-e407-4b7b-8536-28817ef23bac)      | 정보 유출      | 중요        | 없음                                                      |
| Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1                                       | [VBScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=54a64215-e407-4b7b-8536-28817ef23bac)     | 정보 유출      | 중요        | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
| Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1                                   | [JScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=b854d76e-6891-426d-8c09-0ed8243a3b8d)      | 정보 유출      | 중요        | 없음                                                      |
| Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1                                   | [VBScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=b854d76e-6891-426d-8c09-0ed8243a3b8d)     | 정보 유출      | 중요        | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
| Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1         | [JScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=f482bd40-f0b9-4534-a768-45879f1e7285)\*\*  | 정보 유출      | 보통        | 없음                                                      |
| Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1         | [VBScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=f482bd40-f0b9-4534-a768-45879f1e7285)\*\* | 정보 유출      | 보통        | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
| Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1 | [JScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=f05a3de0-381c-4d17-83ee-ca4f6da1bdb0)      | 정보 유출      | 보통        | 없음                                                      |
| Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1 | [VBScript 5.8](http://www.microsoft.com/downloads/details.aspx?familyid=f05a3de0-381c-4d17-83ee-ca4f6da1bdb0)     | 정보 유출      | 보통        | [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779) |
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [2월 공지 요약](http://technet.microsoft.com/ko-kr/security/bulletin/ms11-feb)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](http://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0031)(영문)을 참조하십시오.
...
-   기본적으로 Windows 2008 및 Windows Server 2008 R2의 Internet Explorer는 [보안 강화 구성](http://technet.microsoft.com/ko-kr/library/dd883248(ws.10).aspx)으로 알려진 제한된 모드로 실행됩니다. 이 모드에서는 이 취약점이 완화됩니다. Internet Explorer 보안 강화 구성에 대한 자세한 내용은 이 취약점에 대한 FAQ 섹션을 참조하십시오.
...
JScript란 무엇입니까?   
JScript는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. JScript 스크립트는 ASP(Active Server Pages), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 좀 더 구체적으로 말하자면, JScript는 Microsoft에서 ECMA 262 언어 사양(ECMAScript Edition 3)을 구현한 것입니다. 자세한 내용은 MSDN 문서, [JScript 기본 정보](http://msdn.microsoft.com/ko-kr/library/6974wx4d(vs.85).aspx)(영문)를 참조하거나 웹 사이트, [ECMA International](http://www.ecma-international.org/)(영문)을 참조하십시오.
  
VBScript란 무엇입니까?   
VBScript(Visual Basic 스크립트)는 웹 사이트를 보다 유연하게 만들거나 보다 원활한 상호 작용을 위해 종종 사용되는 인터프리터 방식의 개체 기반 스크립트 언어입니다. VBScript 스크립트는 ASP(Active Server Page), Internet Explorer 또는 Windows 스크립트 호스트와 같은 호스트나 인터프리터가 있어야만 실행될 수 있습니다. 자세한 내용은 MSDN 문서, [VBScript 기본 사항](http://msdn.microsoft.com/ko-kr/library/0ad0dkea(vs.85).aspx)(영문)을 참조하십시오.
...
SMS 2.0 및 SMS 2003의 경우 SUIT(Security Update Inventory Tool)를 SMS와 함께 사용하여 보안 업데이트를 검색할 수 있습니다. [Systems Management Server 2.0용 다운로드](http://technet.microsoft.com/ko-kr/sms/bb676799.aspx)(영문)도 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2475792">Microsoft 기술 자료 문서 2475792</a> 참조</td>
</tr>
<tr class="odd">
...
-   스크립팅 엔진 정보 유출 취약점(CVE-2011-0031)을 보고해 주신 [Palo Alto Networks](http://www.paloaltonetworks.com/)의 Yamata Li
