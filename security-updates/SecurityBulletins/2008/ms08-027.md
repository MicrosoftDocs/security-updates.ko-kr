...
**알려진 문제점.** [Microsoft 기술 자료 문서 951208](http://support.microsoft.com/kb/951208)은 고객이 이 보안 업데이트를 설치할 때 겪을 수 있는 현재까지 알려진 문제점과 권장 해결 방법을 다룹니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 951208](http://support.microsoft.com/kb/951208)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-0119 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0119)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/951208">Microsoft 기술 자료 문서 951208</a>을 참조하십시오.</td>
</tr>
<tr class="even">
...
| **파일 정보**             | [Microsoft 기술 자료 문서 951208](http://support.microsoft.com/kb/951208)을 참조하십시오.                                                                                         |  
| **레지스트리 키 확인**    | 해당 사항 없음                                                                                                                                                                    |
...
-   Publisher 개체 처리기 유효성 검사 취약점(CVE-2008-0119)을 보고해 주신 [Fortinet Security Research (영문)](http://www.fortinet.com/)의 Cocoruder
