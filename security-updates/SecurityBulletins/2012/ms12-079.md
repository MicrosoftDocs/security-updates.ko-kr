---
TOCTitle: 'MS12-079'
Title: 'Microsoft 보안 공지 MS12-079 - 긴급'
ms:assetid: 'ms12-079'
ms:contentKeyID: 61230546
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms12-079(v=Security.10)'
---

Microsoft 보안 공지 MS12-079 - 긴급
===================================

Microsoft Word의 취약점으로 인한 원격 코드 실행 문제점 (2780642)
----------------------------------------------------------------

게시된 날짜: 2012년 12월 12일 수요일 | 업데이트된 날짜: 2013년 6월 27일 목요일
...
이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Word 2007 및 Microsoft Word 2010 에디션에 대해 긴급입니다. 지원 대상인 모든 Microsoft Word 2003 에디션과 지원 대상인 모든 Microsoft Word Viewer, Microsoft Office 호환 기능 팩 및 Microsoft Office Web Apps 버전에 대해서는 중요입니다. 자세한 내용은 이 섹션에서 영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어를 참조하십시오.

이 보안 업데이트는 Microsoft Office가 RTF 형식 데이터를 구문 분석하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 취약점 정보에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)을 참조하십시오.
...
알려진 문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2780642](https://support.microsoft.com/kb/2780642)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
<td style="border:1px solid black;">
[Microsoft Word 2003 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=6947d500-f197-4001-bb39-1c4221af1b36&displaylang=ko)   
(KB2760497)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-064](https://go.microsoft.com/fwlink/?linkid=260965)의 KB2687483은 KB2760497로 대체되었습니다.
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Word 2007 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=52aad8a5-14d9-4c02-828a-5c1164a01f27&displaylang=ko)<sup>[1]</sup>   
(KB2760421)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-064](https://go.microsoft.com/fwlink/?linkid=260965)의 KB2687315는 KB2760421로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Word 2007 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=52aad8a5-14d9-4c02-828a-5c1164a01f27&displaylang=ko)<sup>[1]</sup>   
(KB2760421)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[Microsoft Word 2010 서비스 팩 1(32비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=68c69b37-c544-4f24-8589-4212b868dd69&displaylang=ko)   
(KB2760410)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<td style="border:1px solid black;">
[MS12-064](https://go.microsoft.com/fwlink/?linkid=260965)의 KB2553488은 KB2760410으로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Word 2010 서비스 팩 1(64비트 에디션)](https://www.microsoft.com/download/details.aspx?familyid=9d776c2b-1a9a-4ccb-9e76-dd2cb0f9a80d&displaylang=ko)   
(KB2760410)
</td>
<td style="border:1px solid black;">
원격 코드 실행
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Word Viewer](https://www.microsoft.com/download/details.aspx?familyid=4ccaabd9-5128-4505-ba2f-20bcf02b97ec&displaylang=ko)   
(KB2760498)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<td style="border:1px solid black;">
[MS12-064](https://go.microsoft.com/fwlink/?linkid=260965)의 KB2687485는 KB2760498로 대체되었습니다.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Microsoft Office 호환 기능 팩 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c82de87d-3457-423e-9bfc-ec3f950049e7&displaylang=ko)   
(KB2760416)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<td style="border:1px solid black;">
[MS12-064](https://go.microsoft.com/fwlink/?linkid=260965)의 KB2687314는 KB2760416으로 대체되었습니다.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 호환 기능 팩 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=c82de87d-3457-423e-9bfc-ec3f950049e7&displaylang=ko)   
(KB2760416)
</td>
<td style="border:1px solid black;">
해당 사항 없음
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=62007dcd-80db-42e4-8478-9e81f89cab98&amp;displaylang=ko">Word Automation Services</a><br />
(KB2760405)</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=260965">MS12-064</a>의 KB2598237은 KB2760405로 대체되었습니다.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c98d8ef3-e9a8-4e7c-9e0a-02e192bab39c&amp;displaylang=ko">Microsoft Office Web Apps 2010 서비스 팩 1</a> <br />
(KB2687412)</td>
<td style="border:1px solid black;">해당 사항 없음</td>
<td style="border:1px solid black;">원격 코드 실행</td>
<td style="border:1px solid black;">중요</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=260965">MS12-064</a>의 KB2687401은 KB2687412로 대체되었습니다.</td>
</tr>
</tbody>
</table>
...
이 보안 업데이트의 SHA1 및 SHA2 해시는 다운로드한 보안 업데이트 패키지의 진위 여부를 검증하는 데 사용할 수 있습니다. 이 업데이트와 관련된 해시 정보는 [Microsoft 기술 자료 문서 2780642](https://support.microsoft.com/kb/2780642)를 참조하십시오.
  
Microsoft Outlook은 어떻게 이 취약점의 영향을 받습니까?  
이 취약점은 Microsoft Office Word에 존재하기 때문에 Outlook은 직접적인 영향을 받지 않습니다. 하지만 Word가 메일 리더로 선택되어 있는 경우(Microsoft Outlook 2007 및 Outlook 2010에서는 기본값임), 공격자는 특수하게 조작된 RTF 메일 메시지를 대상 사용자에게 보내 취약점을 악용하기 위한 메일 공격 경로로 Outlook을 활용할 수 있습니다.
  
Microsoft Office 독립 실행형 프로그램은 어떻게 이 취약점의 영향을 받습니까?  
Microsoft Word 독립 실행형 프로그램이 Microsoft Outlook에 대한 기본 전자 메일 읽기 프로그램일 때 심각도는 긴급입니다. 그렇지 않은 경우 Microsoft Word 독립 실행형 프로그램의 심각도는 중요입니다.
  
Word Automation Services란 무엇입니까?  
Word Automation Services는 SharePoint Server 2010의 서비스 응용 프로그램으로, 문서를 Microsoft Word 클라이언트 응용 프로그램에서 지원하는 형식으로 서버 쪽에서 자동 변환해 줍니다. 자세한 내용은 [Word Automation Services 개요](https://msdn.microsoft.com/library/ee558830)(영문)를 참조하십시오.
...
Microsoft Office 2007 서비스 팩 2를 사용하고 있습니다. 이 업데이트에 포함된 추가 보안 기능이 있습니까?  
예. Microsoft Office 2007 서비스 모델의 일부로 Microsoft Office 2007 서비스 팩 2 사용자가 이 업데이트를 설치하면 시스템이 Microsoft Office 2007 서비스 팩 3를 통해 최초로 출시된 보안 기능으로 업그레이드됩니다. 2011년 10월 25일 이후 출시된 모든 업데이트에는 [Microsoft Office 2007 서비스 팩 3](https://www.microsoft.com/ko-kr/download/details.aspx?id=27838)을 통해 소개된 이러한 보안 기능이 포함되어 있습니다. Microsoft에서 이 업데이트를 철저하게 테스트했지만, 모든 업데이트와 마찬가지로 사용자가 자신의 시스템 환경 및 구성에 따라 적절히 테스트하는 것이 좋습니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [12월 공지 요약](https://technet.microsoft.com/security/bulletin/ms12-dec)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2012-2539](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2539)(영문)를 참조하십시오.

#### Word RTF 'listoverridecount' 원격 코드 실행 취약점(CVE-2012-2539)에 대한 완화 요소
...
#### Word RTF 'listoverridecount' 원격 코드 실행 취약점(CVE-2012-2539)에 대한 대안
...
-   알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 RTF 문서를 열지 못하도록 Microsoft Office 파일 차단 정책 사용
    ...
    또는 그룹 정책을 사용하여 파일 차단을 적용할 수 있습니다. 자세한 내용은 TechNet 문서, [Office 2010의 파일 차단 설정 계획](https://technet.microsoft.com/ko-kr/library/cc179230.aspx)(영문)을 참조하십시오.
...
#### Word RTF 'listoverridecount' 원격 코드 실행 취약점(CVE-2012-2539)에 대한 FAQ

이 취약점을 악용하면 어느 작업까지 가능합니까?  
이 취약점은 원격 코드 실행 취약점입니다.

취약점의 원인은 무엇입니까?  
Microsoft Office 소프트웨어가 특수하게 조작된 RTF 형식 데이터를 구문 분석할 때 취약점이 발생하고 시스템 메모리가 손상되어 공격자가 임의 코드를 실행할 수 있게 될 수 있습니다.
...
| Microsoft SharePoint Server 2010 서비스 팩 1                                           | 예. 아래의 Microsoft Office SharePoint Server 2010에 대한 참고 사항을 참조하십시오. | 예. 아래의 Microsoft SharePoint Server 2010에 대한 참고 사항을 참조하십시오. |
...
Microsoft SharePoint Server 2010에 대한 참고 사항 위에 설명된 검색 테이블은 단일 서버를 이용한 Microsoft SharePoint Server 2010의 배포에 기초하고 있습니다. 검색 도구는 다중 시스템 SharePoint 서버 팜의 일부로 구성된 시스템에 대한 업데이트 적용 여부를 검색하지 않습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2760497">Microsoft 기술 자료 문서 2760497</a> 및 <a href="https://support.microsoft.com/kb/2760498">Microsoft 기술 자료 문서 2760498</a> 참조</td>
</tr>
<tr class="even">
...
참고 관리되는 환경에서 작업하는 관리자는 Office Admin 업데이트 센터에서 조직에 Office 업데이트를 배포하는 데 필요한 리소스를 찾을 수 있습니다. 해당 사이트에서 아래로 스크롤하여 업데이트 리소스 섹션에서 업데이트 대상 소프트웨어 버전을 찾으십시오. [Windows Installer 설명서](https://go.microsoft.com/fwlink/?linkid=21685)(영문)에서도 Windows Installer에서 지원하는 매개 변수에 대한 자세한 내용을 설명합니다.
...
-   [Windows Server 2008, Windows Vista, Windows Server 2003 및 Windows XP용 Windows Installer 4.5 재배포 가능 파일](https://www.microsoft.com/download/details.aspx?familyid=5a58b56f-60b6-4412-95b9-54d056d6f9f4&displaylang=en)(영문)  
...
-   [Microsoft Windows 2000 및 Windows NT 4.0용 Windows Installer 2.0 재배포 가능 파일](https://go.microsoft.com/fwlink/?linkid=33338)(영문)
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2760421">Microsoft 기술 자료 문서 2760421</a> 및 <a href="https://support.microsoft.com/kb/2760416">Microsoft 기술 자료 문서 2760416</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   파일 버전 확인
    ...
    6.  참고  
    7.  파일 버전 이외의 특성은 설치 중 변경될 수 있습니다. 다른 파일 특성과 파일 정보 표에 있는 정보를 비교하는 것은 지원되는 업데이트 적용 확인 방법이 아닙니다. 경우에 따라 파일 이름이 설치 도중 변경될 수도 있습니다. 파일 또는 버전 정보가 없으면 사용 가능한 다른 방법 중 하나를 사용하여 업데이트 설치를 확인하십시오.  
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2760410">Microsoft 기술 자료 문서 2760410</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2760405">Microsoft 기술 자료 문서 2760405</a> 및 <a href="https://support.microsoft.com/kb/2687412">Microsoft 기술 자료 문서 2687412</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   Word RTF 'listoverridecount' 원격 코드 실행 취약점(CVE-2012-2539)을 Beyond Security의 [SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html)(영문) 프로그램과 협력하여 보고해 주신 익명의 기고자
...
-   V1.1(2013년 6월 27일): 요약의 알려진 문제점에 Microsoft 기술 자료 문서 2780642 링크가 추가되었습니다.
