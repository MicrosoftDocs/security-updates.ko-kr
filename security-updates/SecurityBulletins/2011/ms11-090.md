---
TOCTitle: 'MS11-090'
Title: 'Microsoft 보안 공지 MS11-090 - 긴급'
ms:assetid: 'ms11-090'
ms:contentKeyID: 61230457
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms11-090(v=Security.10)'
---


Microsoft 보안 공지 MS11-090 - 긴급
===================================

ActiveX 킬(Kill) 비트 누적 보안 업데이트 (2618451)
--------------------------------------------------

게시된 날짜: 2011년 12월 15일 목요일
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|------------------|-----------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=21b4b999-2dbf-4921-80bd-cc7ab2cd1190&displaylang=ko)                                                                                 | 원격 코드 실행 | 긴급             | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=126e8092-980d-471a-867d-d5939671b7df)                                                                       | 원격 코드 실행 | 긴급             | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=dfb948c5-8aee-4bcd-babf-3564b78712dd&displaylang=ko)                                                                        | 원격 코드 실행 | 긴급             | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2d37a8cb-2316-4db4-980c-11b6dcbdc696&displaylang=ko)                                                            | 원격 코드 실행 | 긴급             | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=7726ddbe-0578-44fb-a40f-49b804a45989)                                                                        | 원격 코드 실행 | 긴급             | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1dd069a2-fb1a-4f31-88cc-bc031c3e2c80&displaylang=ko)                                                                              | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=60fd5bf6-e820-44f6-8081-b98c0103acc1&displaylang=ko)                                                                  | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=f485d4c3-a4af-4ae6-9404-e79afcbb4f6e&displaylang=ko)\*\*                                                   | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=28598ef6-13fb-44fd-8c76-599af7b0a01d&displaylang=ko)\*\*                                                 | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5915e19c-b576-453b-b621-5737774f5955)                                                                | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=d112623c-86ce-434a-8fe1-ec3e3e632763&displaylang=ko)                                   | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=81114ecd-0c73-4ca6-8a66-09c6c636a5db&displaylang=ko)                               | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=bc018647-08cb-431a-8e7c-5dc04980eaa9&displaylang=ko)\*\* | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=9323b9b9-e9b0-4941-afe0-196d22df9ab4)            | 없음           | 심각도 없음<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
...
이 ActiveX 킬(Kill) 비트 누적 보안 업데이트에는 새로운 킬(kill) 비트 그리고 이전에 ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS08-023](https://technet.microsoft.com/ko-kr/security/bulletin/ms08-023)), ActiveX 킬(Kill) 비트 보안 업데이트([MS08-032](https://technet.microsoft.com/ko-kr/security/bulletin/ms08-032)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS09-032](https://technet.microsoft.com/ko-kr/security/bulletin/ms09-032)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS09-055](https://technet.microsoft.com/ko-kr/security/bulletin/ms09-055)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS10-008](https://go.microsoft.com/fwlink/?linkid=179106)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS10-034](https://technet.microsoft.com/ko-kr/security/bulletin/ms10-034)), ActiveX 킬(Kill) 비트 누적 보안 업데이트([MS11-027](https://technet.microsoft.com/ko-kr/security/bulletin/ms11-027)) 및 ActiveX 킬(Kill) 비트용 업데이트 롤업이 제목인 [Microsoft 보안 권고 953839](https://technet.microsoft.com/security/advisory/953839), [Microsoft 보안 권고 956391](https://technet.microsoft.com/security/advisory/956391), [Microsoft 보안 권고 960715](https://technet.microsoft.com/security/advisory/960715) 및 [Microsoft 보안 권고 969898](https://technet.microsoft.com/security/advisory/969898) 및 [Microsoft 보안 권고 2562937](https://technet.microsoft.com/security/advisory/2562937)에 릴리스된 모든 킬(kill) 비트가 포함되어 있습니다.
...
<th style="border:1px solid black;" >Microsoft Time 원격 코드 실행 취약점(CVE-2011-3397)</th>
...
Microsoft Time 원격 코드 실행 취약점(CVE-2011-3397)  
---------------------------------------------------
  
Microsoft Time 구성 요소에 원격 코드 실행 취약점이 존재합니다. 공격자는 특수하게 조작된 웹 페이지를 구성하여 이러한 취약점을 악용할 수 있습니다. 사용자가 해당 웹 페이지를 볼 경우 취약점으로 인해 원격 코드 실행이 허용될 수 있습니다. 취약점 악용에 성공한 공격자는 로그온한 사용자와 동일한 권한을 얻을 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-3397(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3397)을 참조하십시오.
  
#### Microsoft Time 원격 코드 실행 취약점(CVE-2011-3397)에 대한 완화 요소
...
-   Internet Explorer 7, Internet Explorer 8 및 Internet Explorer 9는 이 취약점의 영향을 받지 않습니다.
  
#### Microsoft Time 원격 코드 실행 취약점(CVE-2011-3397)에 대한 대안
  
대안이란 기본적인 취약점을 수정하지는 않지만 업데이트를 적용하기 전에 알려진 공격 경로를 차단하는 데 유용한 설정 또는 구성 변경을 지칭합니다. Microsoft는 다음과 같은 대안을 테스트했으며, 대안으로 인한 기능 저하 여부를 해당 항목에서 설명합니다.
  
-   Windows XP 및 Windows Server 2003의  
-   시간 동작 비활성화
  
    경고 레지스트리 편집기를 잘못 사용하면 운영 체제를 다시 설치해야 할 만큼 심각한 문제가 발생할 수 있습니다. Microsoft는 레지스트리 편집기를 잘못 사용하여 발생하는 문제에 대한 해결 여부를 보장하지 않습니다. 레지스트리 편집기의 사용에 따른 모든 책임은 사용자에게 있습니다.
  
    1.  상승된 권한의 명령 프롬프트에서 다음 명령을 수행하여 레지스트리 키의 백업 사본을 만듭니다.  
        `Regedit.exe /e Disable_datime_backup1.reg HKEY_CLASSES_ROOT\CLSID\{33FDA1EA-80DF-11d2-B263-00A0C90D6111}`  
    2.  `Regedit.exe /e Disable_datime_backup2.reg HKEY_CLASSES_ROOT\CLSID\{476c391c-3e0d-11d2-b948-00c04fa32195}`  
    3.  다음 내용을 .REG 확장명의 파일(예: Disable\_Time.reg)로 저장합니다.  
        `Windows Registry Editor Version 5.00`  
    4.  `[-HKEY_CLASSES_ROOT\CLSID\{33FDA1EA-80DF-11d2-B263-00A0C90D6111}]`  
    5.  `[-HKEY_CLASSES_ROOT\CLSID\{476c391c-3e0d-11d2-b948-00c04fa32195}]`  
    6.  상승된 권한의 명령 프롬프트에서 다음 명령으로 Disable\_Time.reg를 실행합니다.  
        `Regedit.exe /s Disable_Time.reg`
  
    대안의 영향. 시간 동작이 작동하지 않습니다.
...
-   Internet Explorer에서 바이너리 동작이 사용되지 않도록 방지
    ...
    {33FDA1EA-80DF-11d2-B263-00A0C90D6111} 및 {476c391c-3e0d-11d2-b948-00c04fa32195} 값을 지닌 CLSIDs에 킬(kill) 비트를 설정하려면 다음 텍스트를 메모장과 같은 텍스트 편집기에 붙여 넣으십시오. 그런 다음 .reg 파일 이름 확장명을 사용하여 파일을 저장하십시오.
  
    ```
	Windows Registry Editor Version 5.00
	
	[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\ActiveX Compatibility\{33FDA1EA-80DF-11d2-B263-00A0C90D6111}]"Compatibility Flags"=dword:04000400
	
	[HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\ActiveX Compatibility\{33FDA1EA-80DF-11d2-B263-00A0C90D6111}]"Compatibility Flags"=dword:04000400

	[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\ActiveX Compatibility\{476c391c-3e0d-11d2-b948-00c04fa32195}]"Compatibility Flags"=dword:04000400

	[HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\ActiveX Compatibility\{476c391c-3e0d-11d2-b948-00c04fa32195}]"Compatibility Flags"=dword:04000400
	```
...
#### Microsoft Time 원격 코드 실행 취약점(CVE-2011-3397)에 대한 FAQ
...
취약점의 원인은 무엇입니까?   
Internet Explorer에서 바이너리 동작이 사용될 때 이 동작으로 인해 시스템 상태가 손상되어 공격자가 임의 코드를 실행할 수 있습니다.
...
이 Microsoft Time 구성 요소의 취약점을 이용하여 악의적인 작업을 수행하려면 사용자가 로그온하여 해당 웹 사이트를 방문해야 합니다. 따라서 Microsoft Time 구성 요소가 설치된 시스템이나, 워크스테이션 또는 터미널 서버와 같이 Internet Explorer를 빈번하게 사용하는 시스템은 이 취약점을 이용하는 공격을 받을 위험이 가장 큽니다.
  
업데이트는 어떤 기능을 수행합니까?   
이 업데이트는 아래의 라이브러리 파일에서 호스팅되는 클래스 식별자에 킬(kill) 비트를 설정하여 바이너리 동작을 비활성화합니다.
...
-    Dell IT Assistant. 다음 클래스 식별자는 Dell이 취약한 ActiveX 컨트롤에 대해 킬 비트를 설정하도록 요청한 것입니다. Dell IT Assistant ActiveX 컨트롤과 관련해서 질문이나 문제가 있는 경우  
-   [Dell](https://www.dell.com/)에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자는 다음과 같습니다.  
    -   {6286EF1A-B56E-48EF-90C3-743410657F3C}  
-   HP Easy Printer Care Software. 다음 클래스 식별자는 Hewlett Packard가 취약한 ActiveX 컨트롤에 대해 킬 비트를 설정하도록 요청한 것입니다. 자세한 내용은 [Hewlett Packard](https://www.hp.com)에서 발표한 [권고](https://h20000.www2.hp.com/bizsupport/techsupport/document.jsp?objectid=c02949847)를 참조하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
    -   {466576F3-19B6-4FF1-BD48-3E0E1BFB96E9}  
-   HP Photo Creative. 다음 클래스 식별자는 RocketLife이 취약한 ActiveX 컨트롤에 대해 킬 비트를 설정하도록 요청한 것입니다. HP Photo Creative ActiveX 컨트롤과 관련해서 질문이나 문제가 있는 경우  
-   -    RocketLife에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
...
-   Yahoo! CD Player.  
-    다음 클래스 식별자는 Yahoo!에서 취약한 ActiveX 컨트롤에 대해 킬 비트를 설정하도록 요청한 것입니다. Yahoo! CD Player ActiveX 컨트롤과 관련해서 질문이나 문제가 있는 경우  
-   [Yahoo!](https://www.yahoo.com)에 문의하십시오. 이 ActiveX 컨트롤의 클래스 식별자(CLSID)는 다음과 같습니다.  
...
<td style="border:1px solid black;">제어판의 프로그램 추가/제거 도구 또는 %Windir%\$NTUninstallKB2618451$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
...
-   와 협력하여 Microsoft Time 원격 코드 실행 취약점(CVE-2011-3397)을 보고해 주신 익명의 연구자
