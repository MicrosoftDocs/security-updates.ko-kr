...
**문제점.** 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975416](http://support.microsoft.com/kb/975416)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다. 현재 알려진 문제점 및 권장 해결 방법은 이 소프트웨어의 특정 릴리스에만 해당되나, 이 문서는 다른 문서에 대한 링크도 제공합니다.
...
이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 975416](http://support.microsoft.com/kb/975416)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
이는 PowerPoint Viewer 2003의 독립 실행형 설치가 [지원 기간이 끝나서 (영문)](http://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx) 이 업데이트가 제공되지 않기 때문입니다. 대신 이 업데이트는 현재 Microsoft Office PowerPoint 2003 고객에게 제공되어, 해당 고객들이 제작한 자체 프레젠테이션의 업데이트 버전을 PowerPoint Viewer 2003을 사용하는 PowerPoint의 [CD를 위한 프레젠테이션을 패키지로 만들기 기능](http://support.microsoft.com/kb/828504)을 통해 실행할 수 있도록 합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0029 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0030 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030)을 참조하십시오.
...
-   **Microsoft Office 파일 차단 정책을 사용하여 알 수 없거나 신뢰할 수 없는 출처 및 위치에서 받은 Office 2003 이전 문서를 열지 못하게 합니다.**
    ...
    **대안의 영향.** 파일 차단 정책은 구현했으나 Microsoft [기술 자료 문서 922847](http://support.microsoft.com/kb/922847)에서 설명한 특수 "면제 디렉터리(exempt directory)"는 구현하지 않은 사용자는 Office 2003 또는Office 2003 이전 버전의 파일을 열 수 없습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0031 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0032 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0033 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-0034 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/973143">Microsoft 기술 자료 문서 973143</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/976881">Microsoft 기술 자료 문서 976881</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>레지스트리 키 확인</strong></td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
-   PowerPoint 파일 경로 처리 버퍼 오버플로 취약점(CVE-2010-0029)을 보고해 주신 [Secunia (영문)](http://secunia.com/)의 Carsten Eiram  
-   PowerPoint LinkedSlideAtom 힙 오버플로 취약점(CVE-2010-0030)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   PowerPoint OEPlaceholderAtom 'placementId' 잘못된 배열 인덱싱 취약점(CVE-2010-0031)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   PowerPoint OEPlaceholderAtom 해제 후 사용 취약점(CVE-2010-0032)을 보고해 주신 [VeriSign iDefense Labs (영문)](http://labs.idefense.com/)의 Sean Larsson  
-   PowerPoint Viewer TextBytesAtom 레코드 스택 오버플로 취약점(CVE-2010-0033)을 [TippingPoint (영문)](http://www.tippingpoint.com/)의 [Zero Day Initiative (영문)](http://www.zerodayinitiative.com/)와 협력하여 보고해 주신 SkD  
-   Office PowerPoint Viewer TextCharsAtom 레코드 스택 오버플로 취약점(CVE-2010-0034)을 보고해 주신 [TippingPoint DVLabs (영문)](http://dvlabs.tippingpoint.com/)의 Cody Pierce
