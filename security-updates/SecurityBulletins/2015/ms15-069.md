...
<td style="border:1px solid black;">
[**Windows DLL 원격 코드 실행 취약성(CVE-2015-2368)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2368)

</td>
<td style="border:1px solid black;">
[**DLL 플랜팅 원격 코드 실행 취약성(CVE-2015-2369)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2369)
