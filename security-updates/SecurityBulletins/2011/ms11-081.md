...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1996(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1997(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1998(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-1999(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2000(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-2001(영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001)을 참조하십시오.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/2586448">Microsoft 기술 자료 문서 2586448</a> 참조</td>
</tr>
<tr class="even">
...
-   Option 요소 원격 코드 실행 취약점(CVE-2011-1996)을 [TippingPoint(영문)](http://www.tippingpoint.com)의 [Zero Day Initiative(영문)](http://www.zerodayinitiative.com)와 협력하여 보고해 주신 Ivan Fratric  
-   OnLoad 이벤트 원격 코드 실행 취약점(CVE-2011-1997)을 [VeriSign iDefense Labs(영문)](http://labs.idefense.com)와 협력하여 보고해 주신 [GWSlabs(영문)](http://www.gwslabs.com)  
-   Jscript9.dll 원격 코드 실행 취약점(CVE-2011-1998)을 보고해 주신 [Greplin(영문)](https://www.greplin.com)의 David Bloom  
-   Select 요소 원격 코드 실행 취약점(CVE-2011-1999)을 [TippingPoint(영문)](http://www.tippingpoint.com)의 [Zero Day Initiative(영문)](http://www.zerodayinitiative.com)와 협력하여 보고해 주신 Ivan Fratric  
-   Body 요소 원격 코드 실행 취약점(CVE-2011-2000)을 [TippingPoint(영문)](http://www.tippingpoint.com)의 [Zero Day Initiative(영문)](http://www.zerodayinitiative.com)와 협력하여 보고해 주신 Sebastian Apelt  
-   가상 함수 테이블 손상 원격 코드 실행 취약점(CVE-2011-2001)을 [TippingPoint(영문)](http://www.tippingpoint.com)의 [Zero Day Initiative(영문)](http://www.zerodayinitiative.com)와 협력하여 보고해 주신 익명 연구자  
-   이 공지에 포함된 심층 보안 변경 사항에 대해 협력해 주신 [Google Inc.](http://www.google.com/korea)의 Eduardo Vela Nava와 [Greplin(영문)](https://www.greplin.com)의 David Bloom  
-   이 공지에 포함된 심층 보안 변경 사항에 대해 협력해 주신 [Soroush Dalili(영문)](http://www.secproject.com)  
-   이 공지에 포함된 심층 보안 변경 사항에 대해 협력해 주신 [Google Inc.](http://www.google.com/korea)의 Billy Rios
