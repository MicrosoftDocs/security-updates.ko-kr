...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-0080 (영문)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0080)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/959454">Microsoft 기술 자료 문서 959454</a> 참조</td>
</tr>
<tr class="even">
...
-   Windows MSDTC 서비스 격리 취약점(CVE-2008-1436), Windows WMI 서비스 격리 취약점(CVE-2009-0078), Windows RPCSS 서비스 격리 취약점(CVE-2009-0079) 및 Windows 스레드 풀 ACL 약점 취약점(CVE-2009-0080)을 보고해 주신 [Argeniss (영문)](http://www.argeniss.com/)의 Cesar Cerrudo
