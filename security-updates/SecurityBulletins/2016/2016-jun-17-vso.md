...
ms.ContentId: 5803d31c-6dc2-4cbf-9f2f-3739e2decc51
...
![Ahead/behind](_img/06_17_01.png)
...
![Branch picker featuring Mine](_img/06_17_02.png)
...
![Path control in Explorer](_img/06_17_03.png)
...
![New file type icons](_img/06_17_04.png)
...
![Improved work item header](_img/06_17_05.png)
...
![Insights in exploratory testing](_img/06_17_06.png)
...
![automatically stop and attach a screen recording](_img/06_17_07.png)
...
![History tab in the result summary page](_img/06_17_08.png)
...
![Tests tab showing failing tests](_img/06_17_09.png)
...
![Running a PMD analysis in the Maven build task](_img/06_17_10.png)
...
![SonarQube analysis in the Gradle build task](_img/06_17_11.png)
...
![OAuth token option](_img/06_17_12.png)
...
![Enabling path filters for Git CI triggers](_img/06_17_13.png)
...
As always, if you have comments or questions, please reach out on Twitter ([@aaronbjork](https://twitter.com/aaronbjork)). If you have ideas on things you’d like to see us prioritize, head over to [UserVoice](https://visualstudio.uservoice.com/forums/330519-team-services) to add your idea or vote for an existing one.
