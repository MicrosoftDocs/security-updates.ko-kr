...
ms:contentKeyID: 18135535
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc708483(v=WS.10)'
---

Determine WSUS Capacity Requirements
====================================

적용 대상: Windows Server 2003, Windows Server 2003 R2, Windows Server 2003 with SP1, Windows Server 2003 with SP2, Windows Server 2008, Windows Server Update Services
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Cc708483.Important(WS.10).gif" />중요</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Cc708483.note(WS.10).gif" />참고</th>
</tr>
</thead>
<tbody>
<tr class="odd">
