...
<td style="border:1px solid black;">
[**Microsoft SharePoint 페이지 콘텐츠 취약성(CVE-2015-1700)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1700)
...
이 취약성을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2015-1700](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1700)을 참조하십시오.
