...
이 보안 업데이트는 [Microsoft 보안 권고 2847140](https://technet.microsoft.com/security/advisory/2847140)에서 처음 설명한 취약점도 해결합니다.
...
호환성 문제를 방지하기 위해 최신 Internet Explorer 누적 보안 업데이트 [MS13-037](https://go.microsoft.com/fwlink/?linkid=294283)이 설치되어 있는지 확인하십시오.
...
[Microsoft 보안 권고 2847140](https://technet.microsoft.com/security/advisory/2847140)의 Microsoft Fix it 솔루션 "CVE-2013-1347 MSHTML Shim 대안"을 구현한 고객은 이 업데이트를 적용하기 전에 Microsoft Fix it 솔루션을 취소할 필요가 없습니다.
...
<span></span>
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [5월 공지 요약](https://technet.microsoft.com/security/bulletin/ms13-may)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/ko-kr/security/cc998259.aspx)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-1347](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1347)(영문)을 참조하십시오.
...
-   이 문제점의 악용을 방지할 수 있는 Microsoft Fix it 솔루션 "CVE-2013-1347 MSHTML Shim 대안" 적용
    ...
    이 대안을 사용하거나 사용하지 않도록 설정하려면 [Microsoft 기술 자료 문서 2847204](https://support.microsoft.com/kb/2847204)를 참조하여 Microsoft Fix it 자동화 솔루션을 사용하십시오.
...
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2013-1347](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1347)(영문)이 지정되었습니다. 이 취약점은 [Microsoft 보안 권고 2847140](https://technet.microsoft.com/security/advisory/2847140)에서 처음 설명되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2847204">Microsoft 기술 자료 문서 2847204</a> 참조</td>
</tr>
<tr class="even">
