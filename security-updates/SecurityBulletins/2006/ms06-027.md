...
-   Microsoft Office 2000 서비스 팩 3
    -   Microsoft Word 2000 — [업데이트 다운로드(KB917345)](https://www.microsoft.com/download/details.aspx?familyid=507d97b5-8b20-41b2-ae8b-27f2bf5198cd&displaylang=ko)
-   Microsoft Office XP 서비스 팩 3
    -   Microsoft Word 2002 — [업데이트 다운로드(KB917335)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c&displaylang=ko)
-   Microsoft Office 2003 서비스 팩 1 또는 서비스 팩 2
    -   Microsoft Word 2003 — [업데이트 다운로드(KB917334)](https://www.microsoft.com/download/details.aspx?familyid=adea09b4-481a-4908-8b77-0630ac679cac)
    -   Microsoft Word Viewer 2003 - [업데이트 다운로드(KB917346)](https://www.microsoft.com/download/details.aspx?familyid=6089b843-61ff-469f-a38b-bd4ffeff0552&displaylang=ko)
-   Microsoft Works Suites:
    -   Microsoft Works Suite 2000 - [업데이트 다운로드(KB917345)(Microsoft Word 2000 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=507d97b5-8b20-41b2-ae8b-27f2bf5198cd)
    -   Microsoft Works Suite 2001 - [업데이트 다운로드(KB917345)(Microsoft Word 2000 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=507d97b5-8b20-41b2-ae8b-27f2bf5198cd)
    -   Microsoft Works Suite 2002 - [업데이트 다운로드(KB917335)(Microsoft Word 2002 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2003 - [업데이트 다운로드(KB917335)(Microsoft Word 2002 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2004 - [업데이트 다운로드(KB917335)(Microsoft Word 2002 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2005 - [업데이트 다운로드(KB917335)(Microsoft Word 2002 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2006 - [업데이트 다운로드(KB917335)(Microsoft Word 2002 업데이트와 동일)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
...
|------------------------------------------------------------------------------------------------------------------------------------|----------------------|---------------------|---------------------|-----------------------------------------|
| Microsoft Word 조작된 개체 포인터 취약점 - [CVE-2006-2492 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492) | 원격 코드 실행       | 긴급                | 중요                | 중요                                    |
...
|---------------------------------------------------------------------|---------------------|---------------------|---------------------------------|----------------------------|
| [MS06-012](https://technet.microsoft.com/security/bulletin/ms06-012) | 대체됨              | 대체됨              | 해당 사항 없음                  | 해당 사항 없음             |
| [MS05-023](https://technet.microsoft.com/security/bulletin/ms05-023) | 해당 사항 없음      | 해당 사항 없음      | 대체됨                          | 대체됨                     |

**참고** 지원되는 Microsoft Works는 모두 MS06-012로 교체됩니다.

**Microsoft Works Suite가 영향을 받는 소프트웨어 목록에 있는 이유는 무엇입니까?**  
Microsoft Works Suite는 Microsoft Word를 포함하고 있기 때문에 영향을 받는 소프트웨어 목록에 있습니다. Microsoft Works 사용자는 [Office 업데이트](https://office.microsoft.com/ko-kr/officeupdate/default.aspx)를 사용하여 적절한 업데이트를 찾아 설치해야 합니다.
...
-   **Microsoft Word를 항상 안전 모드로 사용하십시오.**
    ...
    **수동(사용자 개입)**
    ...
    전자 메일 편집기로 Word를 사용하거나 사용하지 않도록 설정하는 방법에 대한 자세한 내용은 [Turning Word on or off as your e-mail editor](https://office.microsoft.com/ko-kr/assistance/hp052428491042.aspx)를 참조하십시오.
    ...
    **기업 고객의 경우**
    ...
    모든 Word 버전에는 안전 모드에서 Word를 실행할 수 있는 응용 프로그램 복구 기능이 있습니다. 안전 모드에서는 이 기능을 사용하지 않도록 설정하여 취약한 코드가 악용되지 못하도록 방지합니다. 전체 제한 사항에 대한 내용은 다음 사이트에서 확인하실 수 있습니다. [https://office.microsoft.com/ko-kr/assistance/HP030823931042.aspx](https://office.microsoft.com/ko-kr/assistance/hp030823931042.aspx).
    ...
    **대안의 영향:** 안전 모드로 작업하는 사용자는 [About Office Safe Mode](https://office.microsoft.com/ko-kr/assistance/hp030823931042.aspx)에 요약된 제한 사항을 겪게 됩니다.
...
[Office 업데이트 웹 사이트](https://office.microsoft.com/ko-kr/officeupdate/default.aspx)를 사용하여 Microsoft Office 2000 클라이언트 업데이트를 설치할 것을 권장합니다. Office 업데이트 웹 사이트에서는 사용자 컴퓨터에 설치된 특정한 프로그램을 검색한 다음 프로그램을 최신으로 유지하기 위해 설치해야 할 항목을 자세히 알려줍니다.
...
1.  [이 보안 업데이트를 다운로드합니다.](https://download.microsoft.com/download/3/5/3/353ea965-4ce1-440a-947e-b3272578543c/office2000-kb917345-fullfile-enu.exe)
...
-   Office XP 서비스 팩 3(SP3)이 설치되어 있어야 합니다. 이 업데이트를 설치하기 전에 [Office XP SP3](https://www.microsoft.com/download/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e&displaylang=ko)을 설치하십시오. 또한 Office XP Multilingual User Interface Pack을 설치할 경우 [Multilingual User Interface Pack 서비스 팩 3(SP3)](https://www.microsoft.com/download/details.aspx?familyid=3c0a106c-fff1-4768-b3ab-483e46e73f7b&displaylang=ko)을 설치해야 합니다. Office XP SP3 설치 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 832671](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;832671)을 참조하십시오.
...
1.  [이 보안 업데이트를 다운로드합니다.](https://download.microsoft.com/download/3/2/1/32142319-d15c-4370-af74-bafd1422f94e/officexp-kb917335-fullfile-enu.exe)
2.  **이 프로그램을 디스크에 저장**을 클릭한 다음 **확인**을 클릭합니다.
3.  **저장**을 클릭합니다.
4.  Windows 탐색기를 사용하여 저장된 파일이 들어 있는 폴더를 찾아 저장된 파일을 두 번 클릭합니다.
5.  업데이트를 설치할지 묻는 메시지가 표시되면 **예**를 클릭합니다.
...
-   Word 2003을 업데이트하려면 Word 2003 서비스 팩 1 또는 Word 2003 서비스 팩 2가 설치되어 있어야 합니다. 이 업데이트를 설치하기 전에 [Office 2003 SP1](https://www.microsoft.com/download/details.aspx?familyid=9c51d3a6-7cb1-4f61-837e-5f938254fc47&displaylang=ko) 또는 [Office 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=57e27a97-2db6-4654-9db6-ec7d5b4dd867&displaylang=ko)를 설치하십시오.
-   Word Viewer 2003을 업데이트하려면 Word 2003 Viewer 최신 버전이 설치되어 있어야 합니다. [Word 2003 Viewer 최신 버전을 다운로드하십시오.](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf&displaylang=ko)
...
1.  [Word 2003용 보안 업데이트를 다운로드](https://download.microsoft.com/download/5/0/1/5018537a-628b-40d8-9d54-3fdbae8705a9/office2003-kb917334-fullfile-enu.exe)하거나 [Word 2003 Viewer용 보안 업데이트를 다운로드](https://download.microsoft.com/download/2/e/1/2e1188b9-3819-4bcf-9991-41013b6c7e24/office2003-kb917346-fullfile-enu.exe)하십시오.
2.  **이 프로그램을 디스크에 저장**을 클릭한 다음 **확인**을 클릭합니다.
3.  **저장**을 클릭합니다.
4.  Windows 탐색기를 사용하여 저장된 파일이 들어 있는 폴더를 찾아 저장된 파일을 두 번 클릭합니다.
5.  업데이트를 설치할지 묻는 메시지가 표시되면 **예**를 클릭합니다.
...
-   Microsoft Word 조작된 개체 포인터 취약점 - [CVE-2006-2492 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)를 보고해 주신 [Information & Communication Security Technology Center (중문)](https://www.icst.org.tw/)의 Shih-hao Weng.
-   Microsoft Word 조작된 개체 포인터 취약점 - [CVE-2006-2492 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)를 해결하기 위해 협력해 주신 [AV-Test.org (영문)](https://av-test.com/)의 Andreas Marx.
