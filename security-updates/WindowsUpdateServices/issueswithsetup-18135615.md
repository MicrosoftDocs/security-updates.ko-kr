...
ms:contentKeyID: 18135615
ms:mtpsurl: 'https://technet.microsoft.com/ko-kr/library/Cc708547(v=WS.10)'
---
...
-   WSUSWyukonSetup\_*timestamp*.log: This is the log file for Windows 내부 데이터베이스 setup. All Windows 내부 데이터베이스 installation/uninstallation information is logged to this file.
