...
이 보안 업데이트는 [Microsoft 보안 권고 975497](https://technet.microsoft.com/security/advisory/975497)에서 처음 설명한 취약점도 해결합니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2526 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2526)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-2532 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2532)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2009-3103 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3103)을 참조하십시오.
...
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2009-3103 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3103)이 지정되었습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/975517">Microsoft 기술 자료 문서 975517</a> 참조</td>
</tr>
<tr class="odd">
...
-   SMBv2 명령 값 취약점(CVE-2009-2532)을 보고해 주신 [Netherlands Forensics Institute (영문)](https://www.nederlandsforensischinstituut.nl/)의 [Matthieu Suiche (영문)](https://www.msuiche.net/)
