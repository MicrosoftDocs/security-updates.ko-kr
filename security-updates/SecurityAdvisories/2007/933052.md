...
Microsoft는 공개적으로 보고된 이 취약점에 대해 조사를 완료했습니다. 이 문제점을 해결하기 위해 [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024)가 게시되었습니다. 사용 가능한 보안 업데이트의 다운로드 링크를 포함하여, 이 문제점에 대한 자세한 내용은 [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024)를 검토하십시오. 해결된 취약점은 Word 문서 스트림 취약점 - [CVE-2007-0870 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0870)입니다.
