...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2013-1281](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281)(영문)을 참조하십시오.
...
NFS란 무엇입니까 ?  
NFS(Network File System)는 네트워크에서 공유 파일에 대한 투명한 원격 액세스를 제공하도록 [RFC 1094](https://www.ietf.org/rfc/rfc1094.txt?number=1094)에 정의된 업계 표준 프로토콜입니다. NFS(Network File System) 서비스에서는 Windows와 UNIX가 혼합된 기업 환경에 적합한 파일 공유 솔루션을 제공합니다. NFS 서비스를 사용하면 사용자가 NFS 프로토콜을 사용하여 Windows 운영 체제 및 UNIX 기반 컴퓨터 사이에서 파일을 전송할 수 있습니다.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2790978">Microsoft 기술 자료 문서 2790978</a> 참조</td>
</tr>
<tr class="odd">
