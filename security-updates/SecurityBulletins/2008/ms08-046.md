...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------|
| [Microsoft Windows 2000 서비스 팩 4](https://www.microsoft.com/download/details.aspx?familyid=db455d17-435f-46d7-b2dd-5babb5a1eeb3&displaylang=ko)                                                | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP 서비스 팩 2 및 Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=d313f42c-f43f-48ea-82ef-3bc33077c7fa&displaylang=ko)                                  | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows XP Professional x64 Edition 및 Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3150c6b8-f50b-4b84-a7ce-c8daf77c080c)           | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 서비스 팩 1 및 Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=828d8fdc-8534-4621-85a5-08aec255496f&displaylang=ko)                | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 x64 Edition 및 Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=0a13776f-d543-41df-b904-d51e368c81cc&displaylang=ko)    | 원격 코드 실행 | 긴급        | 없음                      |
| [Windows Server 2003 SP1(Itanium 기반 시스템용) 및 Windows Server 2003 SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=9566493f-4260-4072-947a-527887d2cd63) | 원격 코드 실행 | 긴급        | 없음                      |
...
파일 정보 세부 사항은 [Microsoft 기술 자료 문서 952954 (영문)](https://support.microsoft.com/kb/952954)에 나와 있습니다.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2008-2245 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2245)를 참조하십시오.
...
**ICM이란 무엇입니까?**    
ICM(이미지 색 관리)은 ICC 프로필의 데이터를 구문 분석하여 색 변환 작업을 수행하는 데 사용되는 색 관리 시스템입니다. 콘텐츠 제작자에게는 다양한 디스플레이와 출력 유형 간에서 일관된 색을 유지하는 것이 중요합니다. 예를 들어, 출판 산업의 경우 상업적 출판 과정 전체에서 일관된 색을 유지하는 것이 시간과 비용을 절약하는 방법입니다. 디자이너는 자신이 디자인한 고객의 인쇄물이 다른 서비스, 상품, 인쇄물로 활용될 때 동일한 결과로 나타나고 인터넷에서 사용할 때에도 멋지게 보이기를 바랍니다. 대부분의 경우 사용되는 장치와 매체의 제한 때문에 색 공간, 색 영역 범위 및 색 영역 곡선에 차이가 생기는 것은 어쩔 수 없습니다. 하지만 현재 시판되고 있는 많은 소프트웨어와 하드웨어 제품 중 하나를 사용하여 이러한 차이를 테스트하고 ICC 프로필에 기록할 수 있습니다. 이렇게 기록된 ICC 프로필은 다른 ICM 시스템에 정보를 전달하여 사용되는 장치에 관계없이 사용자에게 정확한 색이 표시되게 만듭니다. ICM에 대한 자세한 내용은 [Microsoft 웹 사이트 (영문)](https://www.microsoft.com/whdc/archive/icmwp.mspx)를 참조하십시오.
  
**ICC(International Color Consortium)란 무엇입니까?**  
ICC(International Color Consortium)는 공급업체간 호환성을 보장하기 위해 색상 관리를 구현하는 공급업체 간 표준을 제공하는 조직입니다. ICC(International Color Consortium)에 대한 자세한 내용을 보려면 다음 [웹 사이트 (영문)](https://www.color.org/)를 방문하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/952954">Microsoft 기술 자료 문서 952954 (영문)</a> 참조</td>
</tr>
<tr class="even">
...
-   Microsoft 색 관리 시스템 취약점(CVE-2008-2245)을 보고해 주신 [VeriSign iDefense Labs (영문)](https://labs.idefense.com/)의 Jun Mao
