...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=9080c5a1-e638-4047-a70a-9367f1acced7&displaylang=ko)                                                                               | 권한 상승      | 중요        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2374e09a-cb3e-4bc3-bb4b-53b611025121)                                                                     | 권한 상승      | 중요        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=5d71d3f5-fd6b-4f3b-8389-37c899748d4b&displaylang=ko)                                                                      | 권한 상승      | 중요        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=3a498ff0-21d9-493a-b127-6bc20f1baf95&displaylang=ko)                                                          | 권한 상승      | 중요        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=c71f4398-2e3b-4b81-a650-8806e618db7f)                                                                 | 권한 상승      | 중요        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=e7c4fc81-d1ef-4378-862b-e955d75fb2de&displaylang=ko)                                               | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=8d654a78-0e4f-452c-8874-fbf478813857&displaylang=ko)                       | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9105377e-83c7-4010-8fd6-26e42e98c2cc&displaylang=ko)\*           | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=060e8b20-edca-4427-9d60-eb57261eb668&displaylang=ko)\*       | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=2b8571cb-2dae-4bff-9f13-feb89840044c)                | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows 7(32비트 시스템용) 및 Windows 7(32비트 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=751c45ea-0943-4948-807f-8716c6ff9198&displaylang=ko)                                 | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows 7(x64 기반 시스템용) 및 Windows 7(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=976c882a-bc07-4128-927f-82a2df46cf45&displaylang=ko)                             | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2008 R2(x64 기반 시스템용) 및 Windows Server 2008 R2(x64 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=6f2a52cc-4833-448d-becc-2eac1a447410&displaylang=ko)\* | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
| [Windows Server 2008 R2(Itanium 기반 시스템용) 및 Windows Server 2008 R2(Itanium 기반 시스템용) 서비스 팩 1](https://www.microsoft.com/download/details.aspx?familyid=c6ca0b7c-8151-4d54-aa9b-5ec2b75d8ab6)          | 원격 코드 실행 | 긴급        | [MS11-007](https://technet.microsoft.com/security/bulletin/ms11-007) |
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-0034 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0034)를 참조하십시오.
...
OpenType CFF 글꼴은 PostScript Type 1 윤곽선이 포함된 OpenType 글꼴입니다. OpenType 글꼴에는 PostScript Type 1 또는 TrueType 윤곽선이 포함될 수 있습니다. 모든 Microsoft Windows 글꼴에는 트루타입 윤곽선이 포함됩니다. Adobe InDesign 및 QuarkXPress와 같은 전자 출판 응용 프로그램은 가장 많은 OpenType 기능을 지원합니다. Adobe Photoshop 및 Adobe Illustrator는 많은 기능을 지원합니다. 일반적인 OpenType 기능에 대한 지원은 Microsoft Office Publisher 및 Microsoft Office Word에도 추가되고 있습니다. 자세한 내용은 [Microsoft 입력 체계 OpenType FAQ (영문)](https://www.microsoft.com/typography/opentypefaq.mspx)를 참조하십시오.
...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2507618">Microsoft 기술 자료 문서 2507618</a> 참조</td>
</tr>
<tr class="even">
...
-   OpenType 글꼴 스택 오버플로 취약점(CVE-2011-0034)을 보고해 주신 [Fontlab Ltd. (영문)](https://www.fontlab.com/)의 Adam Twardoch
