---
TOCTitle: 'MS10-048'
Title: 'Microsoft 보안 공지 MS10-048 - 중요'
ms:assetid: 'ms10-048'
ms:contentKeyID: 61230309
ms:mtpsurl: 'https://technet.microsoft.com/ko-KR/library/ms10-048(v=Security.10)'
---



Microsoft 보안 공지 MS10-048 - 중요
===================================
...
이 보안 업데이트는 Windows 커널 모드 드라이버의 공개된 취약점 1건과 비공개적으로 보고된 취약점 4건을 해결합니다. 가장 위험한 취약점으로 인해 공격자가 영향을 받는 시스템에 로그온하여 특수하게 조작한 응용 프로그램을 실행할 경우 권한 상승이 허용될 수 있습니다. 이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.

이 보안 업데이트의 심각도는 지원 대상인 모든 Microsoft Windows 에디션에 대해 중요입니다. 자세한 내용은 이 섹션에서 **영향을 받는 소프트웨어 및 영향을 받지 않는 소프트웨어**를 참조하십시오.

이 보안 업데이트는 Windows 커널 모드 드라이버가 예외를 처리하고 메모리를 할당하고 시스템 호출 인수, 사용자 모드 입력 및 새로운 창 콜백 매개 변수의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다. 취약점에 대한 자세한 내용은 다음 섹션, **취약점 정보**에서 각 취약점 항목의 자주 제기되는 질문 사항(FAQ)를 참조하십시오.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-------------|---------------------------------------------------------------------|
| [Windows XP 서비스 팩 3](https://www.microsoft.com/download/details.aspx?familyid=deeac521-d3a2-4019-8176-c9228e733cf4&displaylang=ko)                                                                         | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows XP Professional x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=d6c5455e-bc31-4842-aef4-ebff92324323)                                                               | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2003 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=59395f00-90f4-4b68-8dd3-03ff611c1bc8&displaylang=ko)                                                                | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2003 x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=9ef1c600-bb93-4800-81b8-8c64b369c194&displaylang=ko)                                                    | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2003 with SP2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=f96b8154-9976-41b0-b9d7-d79887fe9364)                                                           | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Vista 서비스 팩 1 및 Windows Vista 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c9345207-7242-4b71-bf80-b52031e08f8c&displaylang=ko)                                         | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Vista x64 Edition 서비스 팩 1 및 Windows Vista x64 Edition 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=1620e7ac-3913-478d-8120-e9f46d98f453&displaylang=ko)                 | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008(32비트 시스템용) 및 Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=a8b1a3f7-7147-494e-bfc0-b1979b9578e6&displaylang=ko)\*     | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008(x64 기반 시스템용) 및 Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=c1c25cb7-7e82-4c14-9666-aff52dd308b4&displaylang=ko)\* | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008(Itanium 기반 시스템용) 및 Windows Server 2008(Itanium 기반 시스템용) 서비스 팩 2](https://www.microsoft.com/download/details.aspx?familyid=45fe5135-aa89-4f60-8cdb-ec0edc9a7e77)          | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows 7(32비트 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=68bddf4b-b597-477e-80e4-9293d7160496&displaylang=ko)                                                                     | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows 7(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=5ff09e03-d662-4b23-ab26-d25ca2ba58df&displaylang=ko)                                                                   | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 R2(x64 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=6bbc9cb1-0b59-4473-adf9-2ce2f0f94c0a&displaylang=ko)\*                                                    | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 R2(Itanium 기반 시스템용)](https://www.microsoft.com/download/details.aspx?familyid=2543191a-09cb-4417-bbb2-aac4d9a2a756)                                                                 | 권한 상승      | 중요        | [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) |
...
예. "취약점 세부 정보" 섹션에 나열된 변경 사항 외에도, 이 업데이트에는 메모리 제한으로 인한 비현실적 시나리오의 잠재적 정수 오버플로를 수정하는 심층 보안 정책도 포함되어 있습니다. 이러한 심층 보안 변경 사항은 64비트 시스템에만 적용됩니다. 공격자가 이러한 문제를 악용하는 데 필요한 조건을 충족할 수 있는 현실적인 방법이 없지만, Microsoft는 이러한 특정 상황에서 추가적인 문제가 발생하지 않도록 코드를 수정하고 있습니다.
...
<th style="border:1px solid black;" >Win32k 경계 검사 취약점(CVE-2010-1887)</th>
<th style="border:1px solid black;" >Win32k 예외 처리 취약점(CVE-2010-1894)</th>
<th style="border:1px solid black;" >Win32k 풀 오버플로 취약점(CVE-2010-1895)</th>
<th style="border:1px solid black;" >Win32k 사용자 입력 유효성 검사 취약점(CVE-2010-1896)</th>
<th style="border:1px solid black;" >Win32k 창 생성 취약점(CVE-2010-1897)</th>
...
Windows 커널 모드 드라이버에는 시스템 호출에 전달된 인수에 대한 부적절한 유효성 검사로 인한 서비스 공격 취약점이 존재합니다. 공격자는 특수하게 조작된 응용 프로그램을 실행하여 취약점을 악용함으로써 시스템이 응답하지 않거나 다시 시작되도록 할 수 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1887 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1887)을 참조하십시오.
  
#### Win32k 경계 검사 취약점(CVE-2010-1887)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 경계 검사 취약점(CVE-2010-1887)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 경계 검사 취약점(CVE-2010-1887)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버에서 시스템 호출에 전달된 인수의 유효성을 올바르게 검사하지 않습니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 시스템 호출에 전달되는 인수의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
...
Windows 커널 모드 드라이버가 특정 예외를 처리하는 방식 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1894 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1894)를 참조하십시오.
  
#### Win32k 예외 처리 취약점(CVE-2010-1894)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 예외 처리 취약점(CVE-2010-1894)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 예외 처리 취약점(CVE-2010-1894)에 대한 FAQ
...
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 특정 예외를 제대로 처리하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
이 업데이트는 Windows 커널 모드 드라이버가 예외를 올바르게 처리하도록 하여 취약점을 해결합니다.
  
**이 보안 공지를 게시했을 때 이 취약점이 공개되어 있었습니까?**    
예. 이 취약점은 공개되었습니다. 이 취약점에는 CVE(Common Vulnerability and Exposure) 번호 [CVE-2010-1894 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1894)가 지정되었습니다.
...
Windows 커널 모드 드라이버가 사용자 모드에서 복사할 때 메모리를 제대로 할당하지 못하기 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1895 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1895)를 참조하십시오.
  
#### Win32k 풀 오버플로 취약점(CVE-2010-1895)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 풀 오버플로 취약점(CVE-2010-1895)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 풀 오버플로 취약점(CVE-2010-1895)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 사용자 모드에서 데이터를 복사할 때 메모리를 제대로 할당하지 못합니다.
...
사용자 모드에서 전달된 입력의 부적절한 유효성 검사로 인해 Windows 커널 모드 드라이버에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1896 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1896)을 참조하십시오.
  
#### Win32k 사용자 입력 유효성 검사 취약점(CVE-2010-1896)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 사용자 입력 유효성 검사 취약점(CVE-2010-1896)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 사용자 입력 유효성 검사 취약점(CVE-2010-1896)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windo ws 커널 모드 드라이버가 사용자 모드에서 제공된 입력의 유효성을 제대로 검사하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 사용자 모드에서 제공된 입력의 유효성을 검사하는 방식을 수정하여 취약점을 해결합니다.
...
Windows 커널 모드 드라이버가 새 창을 만들 때 모든 매개 변수의 유효성을 적절히 검사하지 못하기 때문에 권한 상승 취약점이 존재합니다. 이 취약점 악용에 성공한 공격자는 커널 모드에서 임의 코드를 실행할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2010-1897 (영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1897)을 참조하십시오.
  
#### Win32k 창 생성 취약점(CVE-2010-1897)에 대한 완화 요소
  
완화란 취약점의 악용 심각도를 낮출 수 있는 설정, 일반적인 구성 또는 최선책, 기본 상태를 지칭합니다. 다음과 같은 완화 요소가 현재 상황에서 유용할 수 있습니다.
  
-   이 취약점을 악용하려면 공격자가 유효한 로그온 자격 증명을 가지고 로컬로 로그온할 수 있어야 합니다. 익명의 사용자에 의해서나 원격으로는 이 취약점을 악용할 수 없습니다.
  
#### Win32k 창 생성 취약점(CVE-2010-1897)에 대한 대안
  
이 취약점에 대한 대안을 확인하지 못했습니다.
  
#### Win32k 창 생성 취약점(CVE-2010-1897)에 대한 FAQ
  
**이 취약점을 악용하면 어느 작업까지 가능합니까?**    
이 취약점은 권한 상승 취약점입니다. 이 취약점 악용에 성공한 공격자는 임의 코드를 실행하여 영향을 받는 시스템을 완전히 제어할 수 있습니다. 이렇게 되면 공격자가 프로그램을 설치할 수 있을 뿐 아니라 데이터를 보거나 변경하거나 삭제할 수 있고 모든 사용자 권한이 있는 새 계정을 만들 수도 있습니다.
  
**취약점의 원인은 무엇입니까?**    
Windows 커널 모드 드라이버가 새 창을 생성할 때 일부 콜백 매개 변수 내에 있는 가상 핸들의 유효성을 제대로 검사하지 못합니다.
...
**업데이트는 어떤 기능을 수행합니까?**    
업데이트는 Windows 커널 모드 드라이버가 새 창을 생성할 때 콜백 매개 변수에 있는 가상 핸들의 유효성을 검사하는 방식을 수정하여 이 취약점을 해결합니다.
...
<td style="border:1px solid black;">제어판의 <strong>프로그램 추가/제거</strong> 도구 또는 %Windir%\$NTUninstallKB2160329$\Spuninst 폴더의 Spuninst.exe 유틸리티를 사용하십시오.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>파일 정보</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2160329">Microsoft 기술 자료 문서 2160329</a> 참조</td>
</tr>
<tr class="even">
...
-   Win32k 경계 검사 취약점(CVE-2010-1887)을 보고해 주신 [Google, Inc.](https://www.google.com/)의 Tavis Ormandy  
-   Win32k 풀 오버플로 취약점(CVE-2010-1895)을 보고해 주신 [MoonSols (영문)](https://moonsols.com/)의 Matthieu Suiche  
-   Win32k 사용자 입력 유효성 검사 취약점(CVE-2010-1896)을 보고해 주신 [MoonSols (영문)](https://moonsols.com/)의 Matthieu Suiche  
-   이 공지에서 해결된 심층 보안 변경을 위해 협력해 주신 [MoonSols (영문)](https://moonsols.com/)의 Matthieu Suiche  
-   Win32k 창 생성 취약점(CVE-2010-1897)을 보고해 주신 [Core Security Technologies (영문)](https://www.coresecurity.com/)의 Nicolas Economou
