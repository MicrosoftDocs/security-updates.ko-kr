...
문제점. 이 보안 업데이트를 설치할 때 고객이 겪을 수 있는 현재까지 알려진 문제점은 [Microsoft 기술 자료 문서 2639142](https://support.microsoft.com/kb/2639142)에 나와 있습니다. 이 문서는 이러한 문제점에 대한 권장 해결 방법도 소개합니다.
...
다음의 심각도는 취약점의 잠재적인 최대 영향을 가정합니다. 이 보안 공지 발표 후 30일 이내의 심각도 및 보안 영향과 관련된 취약점 악용 가능성에 대해서는 [12월 공지 요약](https://technet.microsoft.com/security/bulletin/ms11-dec)의 악용 가능성 인덱스를 참조하십시오. 자세한 내용은 [Microsoft 악용 가능성 인덱스](https://technet.microsoft.com/security/cc998259)를 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-3396(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3396)을 참조하십시오.
...
이 포트들은 영향을 받는 구성 요소와 연결을 시작하는 데 사용됩니다. 방화벽에서 TCP 포트 139 및 445를 차단하면 이 취약점을 악용한 방화벽 뒤의 시스템 공격을 막을 수 있습니다. 기타 포트를 악용할 수 있는 공격을 방지하려면 인터넷으로부터의 원치 않는 인바운드 통신을 모두 차단하는 것이 좋습니다. 포트에 대한 자세한 내용은 TechNet 문서, [TCP 및 UDP 포트 할당(영문)](https://technet.microsoft.com/ko-kr/library/cc977599(en-us).aspx)을 참조하십시오.
...
대안 실행 취소 방법. 방화벽에서 TCP 포트 139 및 445를 차단 해제합니다. 포트에 대한 자세한 내용은 [TCP 및 UDP 포트 할당(영문)](https://technet.microsoft.com/ko-kr/library/cc977599(en-us).aspx)을 참조하십시오.
...
이 취약점을 CVE(Common Vulnerabilities and Exposures) 목록의 표준 항목으로 보려면 [CVE-2011-3413(영문)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3413)을 참조하십시오.
...
-   지원되는 Microsoft Office XP 버전은 [Creating an Administrative Installation Point(관리 설치 지점 만들기) (영문)](https://office.microsoft.com/ko-kr/orkxp/ha011363091033.aspx)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office XP 원래 기준선으로 클라이언트 시스템에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 922665](https://support.microsoft.com/kb/922665)를 참조하십시오.
...
-   지원되는 Microsoft Office 2003 버전은 [Creating an Administrative Installation Point(관리 설치 지점 만들기) (영문)](https://office.microsoft.com/ko-kr/ork2003/ha011401931033.aspx)를 참조하십시오. 업데이트된 관리 설치 지점에서 Office 2003 원래 기준선 또는 서비스 팩 3(SP3)로 클라이언트 컴퓨터에 대한 원본을 변경하는 방법에 대한 자세한 내용은 [Microsoft 기술 자료 문서 902349](https://support.microsoft.com/kb/902349)를 참조하십시오.
...
<td style="border:1px solid black;">PowerPoint 2007 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/2596764">Microsoft 기술 자료 문서 2596764</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Word, Excel, PowerPoint 2007 파일 형식용 Microsoft Office 호환 기능 팩 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/2596843">Microsoft 기술 자료 문서 2596843</a> 참조</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint Viewer 2007 서비스 팩 2:<br />
<a href="https://support.microsoft.com/kb/2596912">Microsoft 기술 자료 문서 2596912</a> 참조</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">파일 정보</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/2553185">Microsoft 기술 자료 문서 2553185</a> 참조</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">레지스트리 키 확인</td>
<td style="border:1px solid black;">해당 사항 없음</td>
...
Microsoft Office 2008 for Mac 12.3.2 업데이트의 해당 언어 버전을 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?familyid=2c4d0381-f7ab-49ed-a0c0-b381387d1e68)에서 다운로드하여 설치하십시오.
...
-   PowerPoint의 안전하지 않은 라이브러리 로드 취약점(CVE-2011-3396)을 보고해 주신 [iSIGHT Partners Labs(영문)](https://www.isightpartners.com/)의 Greg MacManus  
-   OfficeArt Shape RCE 취약점(CVE-2011-3413)을 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative(영문)](https://www.zerodayinitiative.com/)와 협력하여 보고해 주신 익명 연구자
