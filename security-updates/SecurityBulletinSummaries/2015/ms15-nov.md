...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-6097">CVE-2015-6097(영문)</a></td>
<td style="border:1px solid black;">4 - 영향을 받지 않음</td>
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2478">CVE-2015-2478(영문)</a></td>
<td style="border:1px solid black;">2 - 악용 가능성 낮음</td>
<td style="border:1px solid black;">2 - 악용 가능성 낮음</td>
<td style="border:1px solid black;">해당 없음</td>
</tr>
...
<td style="border:1px solid black;">
[**MS15-116**](https://technet.microsoft.com/ko-kr/library/security/ms15-116)
...
(3085548)  
(중요)  
Microsoft Project Server 2007 서비스 팩 3  
(2596770)  
(중요)  
...
(3085552)  
(중요)  
Microsoft Office 2007 IME(일본어) 서비스 팩 3  
(2899473)  
(중요)
...
(3101529)  
(중요)  
Microsoft Access 2010 서비스 팩 2(32비트 버전)  
(3101544)  
(중요)  
...
(3101529)  
(중요)  
Microsoft Access 2010 서비스 팩 2(64비트 버전)  
(3101544)  
(중요)  
...
(3101506)  
(중요)  
Microsoft Publisher 2013 서비스 팩 1(32비트 버전)  
(3085561)  
(중요)  
...
(3101506)  
(중요)  
Microsoft Publisher 2013 서비스 팩 1(64비트 버전)  
(3085561)  
(중요)  
...
(2920698)  
(중요)  
Microsoft Publisher 2016(32비트 버전)  
(2920680)  
(중요)  
...
(2920698)  
(중요)  
Microsoft Publisher 2016(64비트 버전)  
(2920680)  
(중요)  
...
<td style="border:1px solid black;">
[**MS15-123**](https://technet.microsoft.com/ko-kr/library/security/ms15-123)
...
-   V1.0(2015년 11월 11일): 공지 요약이 게시되었습니다.
-   V1.1(2015년 11월 12일): MS15-115에서는 KB3097877의 알려진 문제가 추가되었습니다. Microsoft는 Windows 보안 업데이트 3097877이 설치된 후 특정 전자 메일을 보는 경우 발생하는 작동 중단과 관련하여 일부 고객이 보낸 보고서를 살펴보고 있습니다. 즉각적인 검토를 진행 중입니다.
-   V2.0(2015년 12월 10일): MS15-115에서는 일부 응용 프로그램이 예기치 않게 종료되게 할 수 있는 원래 업데이트의 문제를 해결하기 위해 Windows 7 및 Windows Server 2008 R2용 3097877 업데이트가 다시 릴리스되었음을 고객에게 알리려고 [Microsoft 기술 자료 문서 3097877](https://support.microsoft.com/ko-kr/kb/3097877)이 업데이트되었습니다. Windows 7 또는 Windows Server 2008 R2 시스템에서 이 업데이트를 이미 설치한 고객은 이 업데이트를 다시 설치해야 합니다.
-   V2.1(2015년 12월 10일): MS15-122에서는 공격자가 CVE-2015-6095를 악용하기 위해 대상 컴퓨터에 실제로 액세스할 수 있는 요구 사항에 대한 참조를 제거하기 위해 요약이 개정되었습니다. 이 변경 사항은 정보 제공용입니다. 이 업데이트를 이미 설치한 고객은 조치를 취할 필요가 없습니다.
-   V2.2(2015년 12월 18일): MS15-116 및 MS15-123에 대한 요약 표에 알려진 문제를 추가하기 위해 공지 요약이 개정되었습니다. 보안 업데이트 3101496을 설치한 후 "Lync"가 대화 상대 목록의 제목 표시줄에 나타납니다. Lync 2013(비즈니스용 Skype) 클라이언트에서 표시하기 위해 비즈니스용 Skype 사용자 인터페이스를 구성한 경우 이 문제가 발생합니다. Microsoft는 현재 이 문제에 대해 조사 중이며 새로운 정보가 나오는 대로 게시할 예정입니다.
-   V3.0(2016년 2월 10일): MS15-118에서는 Windows 8.1, Windows RT 또는 Windows Server 2012 R2를 실행하고 있는 고객이 완전히 업데이트된 버전의 .NET Framework 4.5.x가 이미 있는 컴퓨터에서 .NET Framework 4.6을 설치한 후 경험했을 수 있는 [Microsoft 기술 자료 문서 3318750](https://support.microsoft.com/ko-kr/kb/3318750)에 나오는 알려진 문제를 해결하도록 업데이트 3098785가 다시 릴리스되었음을 알리기 위해 공지 요약이 개정되었습니다. 고객들은 다운로드할 새 업데이트를 검색하고, 다시 릴리스된 업데이트 3098785를 설치하는 것이 좋습니다. 자세한 내용은 [Microsoft 기술 자료 문서 3318750](https://support.microsoft.com/ko-kr/kb/3318750)을 참조하십시오.

*2016-02-08 17:24-08:00에 페이지가 생성되었습니다.*
