...
<td style="border:1px solid black;">
[**Microsoft Active Directory Federation Services 정보 공개 취약성(CVE-2017-0043)(영문)**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0043)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(32비트 시스템용) 서비스 팩 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217882)  
(3217882)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008(x64 기반 시스템용) 서비스 팩 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217882)  
(3217882)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2016(x64 기반 시스템용)](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4013429)(Server Core 설치) <sup>[2]</sup>
(4013429)
...
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0043">CVE-2017-0043(영문)</a></td>
